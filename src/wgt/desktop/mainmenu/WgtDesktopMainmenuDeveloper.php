 ...
 * @licence WebFrap.net
 */
class WgtDesktopMainmenuDeveloper
  extends WgtDesktopMainmenuDefault
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
{$this->render_subtreeWebfrapAdminMega()}
...
HTML;
  ...
  * @return string
  */
  protected function render_subtreeWebfrapAdminMega( $class = null )
  {

    $html = <<<HTML
      <li>
       <a class="plain" >Admin</a>
        <ul class="sub subcnt" style="display:none;" >
          
      <li>
       <a class="plain" >Users &amp; Groups</a>
        <ul>
                <li>
        <a href="maintab.php?c=Wbfsys.RoleUser.listing" class="wcm wcm_req_mtab" >Users</a>
      </li>
      <li>
        <a href="maintab.php?c=Wbfsys.RoleGroup.listing" class="wcm wcm_req_mtab" >Groups</a>
      </li>
      <li>
        <a href="maintab.php?c=Wbfsys.Profile.listing" class="wcm wcm_req_mtab" >Profiles</a>
      </li>
      ...
      <li>
       <a class="plain" >Settings</a>
        <ul>
                <li>
        <a href="maintab.php?c=Wbfsys.Domain.listing" class="wcm wcm_req_mtab" >Domains</a>
      </li>
      <li>
        <a href="maintab.php?c=Wbfsys.Faq.listing" class="wcm wcm_req_mtab" >Faq</a>
      </li>
      <li>
        <a href="maintab.php?c=Wbfsys.Text.listing" class="wcm wcm_req_mtab" >Text</a>
      </li>
      ...
      <li>
       <a class="plain" >System</a>
        <ul>
                <li>
        <a href="maintab.php?c=Webfrap.Navigation.explorer" class="wcm wcm_req_mtab" >Explorer</a>
      </li>
      <li>
        <a href="maintab.php?c=Webfrap.Announcement.listing" class="wcm wcm_req_mtab" >Announcements</a>
      </li>
      ...
      <li>
       <a class="plain" >Maintenance</a>
        <ul>
                <li>
        <a href="ajax.php?c=Maintenance.Cache.CleanAll" class="wcm wcm_req_mtab" >Clean Cache</a>
      </li>
      <li>
        <a href="maintab.php?c=Maintenance.DbConsistency.table" class="wcm wcm_req_mtab" >Db Cosistency</a>
      </li>
      <li>
        <a href="maintab.php?c=Daidalos.Acl.form" class="wcm wcm_req_mtab" >ACL Management</a>
      </li>
      ...
      <li>
       <a class="plain" >Daidalos</a>
        <ul>
                <li>
        <a href="maintab.php?c=Daidalos.SupportUser.overview" class="wcm wcm_req_mtab" >Support User</a>
      </li>
      <li>
        <a href="maintab.php?c=Daidalos.Db.listing" class="wcm wcm_req_mtab" >Database Manager</a>
      </li>
      <li>
        <a href="maintab.php?c=Daidalos.System.statusEditior" class="wcm wcm_req_mtab" >Change User</a>
      </li>
      ...
      <li>
       <a class="plain" >Logs</a>
        <ul>
                <li>
        <a href="maintab.php?c=Wbfsys.MessageLog.listing" class="wcm wcm_req_mtab" >Message Log</a>
      </li>
      <li>
        <a href="maintab.php?c=Wbfsys.ProtocolUsage.listing" class="wcm wcm_req_mtab" >Login Log</a>
      </li>
...
HTML;
  ...
  }//end protected function render_subtreeWebfrapAdminMega */
...
} // end class WgtDesktopMainmenuDeveloper
