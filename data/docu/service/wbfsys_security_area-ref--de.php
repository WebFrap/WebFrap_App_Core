<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for service: wbfsys_security_area-ref
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$service = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-service-wbfsys_security_area-ref' AND id_lang=".$langNode->getId() ) )
    {
      $service = new WbfsysDocuTree_Entity();
      $service->access_key = 'wbf-service-wbfsys_security_area-ref';
      $service->id_lang     = $langNode->getId();
    }
    
    $service->m_parent = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-service' AND id_lang=".$langNode->getId() );

    $service->upgrade( 'title', 'Service Wbfsys Security Area-ref' );
    $service->upgrade( 'short_desc', '' );
    $service->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Service: Wbfsys Security Area-ref</h2>
</div>
