...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$profile = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-profile-employee' AND id_lang=".$langNode->getId() ) )
    {
      $profile = new WbfsysDocuTree_Entity();
      $profile->access_key = 'wbf-profile-employee';
      $profile->id_lang     = $langNode->getId();
    }


    $profile->upgrade( 'title', 'Profile Employee' );
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-profile-permission-employee" class="wcm wcm_ui_tree bw62" >
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-profile-backpath-employee" class="wcm wcm_ui_tree bw62" >
...
HTML;
    ...
    /*
    // plain role
    if( !$group = $orm->getByKey( 'WbfsysDocuTree', "wbf-role-employee" ) )
    {
      $group = new WbfsysDocuTree_Entity();
      $group->access_key = 'wbf-role-employee';
    }
    
    $group->upgrade( 'title', 'Role Employee' );
