...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-wbfsys_action_log' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-wbfsys_action_log';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Action Log' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Action Log</h2>
</div>
...
<div id="wgt-grid-docu-entity-wbfsys_action_log-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-wbfsys_action_log-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-content" >
        <td class="pos" >1</td>
        <td>content</td>
        <td>text</td>
        <td>400</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-vid" >
        <td class="pos" >2</td>
        <td>vid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-id_vid_entity" >
        <td class="pos" >3</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-rowid" >
        <td class="pos" >4</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_time_created" >
        <td class="pos" >5</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_role_create" >
        <td class="pos" >6</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_time_changed" >
        <td class="pos" >7</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_role_change" >
        <td class="pos" >8</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_version" >
        <td class="pos" >9</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_action_log-attr-m_uuid" >
        <td class="pos" >10</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
