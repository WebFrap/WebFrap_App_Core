...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-wbfsys_user_relation' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-wbfsys_user_relation';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Wbfsys User Relation' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Wbfsys User Relation</h2>
</div>
...
<div id="wgt-grid-docu-entity-wbfsys_user_relation-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-wbfsys_user_relation-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-id_user" >
        <td class="pos" >1</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-id_status" >
        <td class="pos" >2</td>
        <td>id_status::<a href="maintab.php?c=Webfrap.Docu.page&amp;page=wbf-entity-wbfsys_user_relation_status" class="wcm wcm_req_ajax" >wbfsys_user_relation_status</a></td>
        <td>eid</td>
        <td></td>
        <td><img src="xsmall/daidalos/table/key.png"  alt="Key"  class="icon xsmall" /></td>
        <td></td>
      </tr>
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-rowid" >
        <td class="pos" >3</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_time_created" >
        <td class="pos" >4</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_role_create" >
        <td class="pos" >5</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_time_changed" >
        <td class="pos" >6</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_role_change" >
        <td class="pos" >7</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_version" >
        <td class="pos" >8</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_user_relation-attr-m_uuid" >
        <td class="pos" >9</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
