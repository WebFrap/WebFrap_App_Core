...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-wbfsys_group_users' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-wbfsys_group_users';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Wbfsys Group Users' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Wbfsys Group Users</h2>
</div>
...
<div id="wgt-grid-docu-entity-wbfsys_group_users-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-wbfsys_group_users-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-id_user" >
        <td class="pos" >1</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-id_group" >
        <td class="pos" >2</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-id_area" >
        <td class="pos" >3</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-partial" >
        <td class="pos" >4</td>
        <td>partial</td>
        <td>int</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-ident_key" >
        <td class="pos" >5</td>
        <td>ident_key</td>
        <td>text</td>
        <td>120</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-vid" >
        <td class="pos" >6</td>
        <td>vid</td>
        <td>int</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-date_start" >
        <td class="pos" >7</td>
        <td>date_start</td>
        <td>date</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-description" >
        <td class="pos" >8</td>
        <td>description</td>
        <td>text</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-date_end" >
        <td class="pos" >9</td>
        <td>date_end</td>
        <td>date</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-rowid" >
        <td class="pos" >10</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_time_created" >
        <td class="pos" >11</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_role_create" >
        <td class="pos" >12</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_time_changed" >
        <td class="pos" >13</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_role_change" >
        <td class="pos" >14</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_version" >
        <td class="pos" >15</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_group_users-attr-m_uuid" >
        <td class="pos" >16</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
