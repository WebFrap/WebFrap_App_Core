<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for entity: crm_contact
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-crm_contact' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-crm_contact';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Crm Contact' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Crm Contact</h2>
</div>
...
<div id="wgt-grid-docu-entity-crm_contact-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-crm_contact-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-crm_contact-attr-rowid" >
        <td class="pos" >1</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_time_created" >
        <td class="pos" >2</td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_role_create" >
        <td class="pos" >3</td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_time_changed" >
        <td class="pos" >4</td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_role_change" >
        <td class="pos" >5</td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_version" >
        <td class="pos" >6</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-crm_contact-attr-m_uuid" >
        <td class="pos" >7</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
