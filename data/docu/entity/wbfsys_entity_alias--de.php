...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-wbfsys_entity_alias' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-wbfsys_entity_alias';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Entity Alias' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Entity Alias</h2>
</div>
...
<div id="wgt-grid-docu-entity-wbfsys_entity_alias-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-wbfsys_entity_alias-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-name" >
        <td class="pos" >1</td>
        <td>name</td>
        <td>text</td>
        <td>250</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-id_entity" >
        <td class="pos" >2</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-revision" >
        <td class="pos" >3</td>
        <td>revision</td>
        <td>int</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-rowid" >
        <td class="pos" >4</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_time_created" >
        <td class="pos" >5</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_role_create" >
        <td class="pos" >6</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_time_changed" >
        <td class="pos" >7</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_role_change" >
        <td class="pos" >8</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_version" >
        <td class="pos" >9</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_alias-attr-m_uuid" >
        <td class="pos" >10</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
