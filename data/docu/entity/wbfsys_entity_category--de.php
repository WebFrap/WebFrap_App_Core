...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$entity = $orm->get( 'WbfsysDocuTree', "access_key = 'wbf-entity-wbfsys_entity_category' AND id_lang=".$langNode->getId() ) )
    {
      $entity = new WbfsysDocuTree_Entity();
      $entity->access_key  = 'wbf-entity-wbfsys_entity_category';
      $entity->id_lang     = $langNode->getId();
    }

    $entity->upgrade( 'title', 'Entity Wbfsys Entity Category' );
    $entity->upgrade( 'short_desc', 'Entity ' );
    $entity->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Entity Wbfsys Entity Category</h2>
</div>
...
<div id="wgt-grid-docu-entity-wbfsys_entity_category-attributes" class="wgt-grid" >
  <var></var>
  <table id="wgt-grid-docu-entity-wbfsys_entity_category-attributes-table" class="wcm wcm_widget_grid hide-head full" >
    <thead>
      <tr>
        <th class="pos" >Pos:</th>
        <th>Name</th>
    ...
    <tbody>
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-name" >
        <td class="pos" >1</td>
        <td>name</td>
        <td>text</td>
        <td>250</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-access_key" >
        <td class="pos" >2</td>
        <td>access_key</td>
        <td>text</td>
        <td>120</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-id_entity" >
        <td class="pos" >3</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-description" >
        <td class="pos" >4</td>
        <td>description</td>
        <td>text</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-revision" >
        <td class="pos" >5</td>
        <td>revision</td>
        <td>int</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-rowid" >
        <td class="pos" >6</td>
        <td>rowid</td>
        <td>bigint</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_time_created" >
        <td class="pos" >7</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_role_create" >
        <td class="pos" >8</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_time_changed" >
        <td class="pos" >9</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_role_change" >
        <td class="pos" >10</td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_version" >
        <td class="pos" >11</td>
        <td>m_version</td>
        <td>integer</td>
        <td></td>
      ...
      <tr id="wgt-grid-docu-entity-wbfsys_entity_category-attr-m_uuid" >
        <td class="pos" >12</td>
        <td>m_uuid</td>
        <td>uuid</td>
        <td></td>
