<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for management: crm_contact
//////////////////////////////////////////////////////////////////////////////*/

    // first clean the old data
    $management = null;

    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-crm_contact' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-crm_contact';
    }

    $management->upgrade( 'title', 'Management Crm Contact' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Crm Contact</h2>
</div>
