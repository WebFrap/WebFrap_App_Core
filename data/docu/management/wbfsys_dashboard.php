...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-wbfsys_dashboard' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-wbfsys_dashboard';
    }

    $management->upgrade( 'title', 'Management Dashboard' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Dashboard</h2>
</div>
