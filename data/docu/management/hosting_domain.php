<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for management: hosting_domain
//////////////////////////////////////////////////////////////////////////////*/

    // first clean the old data
    $management = null;

    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-hosting_domain' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-hosting_domain';
    }

    $management->upgrade( 'title', 'Management Hosting Domain' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Hosting Domain</h2>
</div>
