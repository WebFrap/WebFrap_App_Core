...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-wbfsys_user_relation' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-wbfsys_user_relation';
    }

    $management->upgrade( 'title', 'Management Wbfsys User Relation' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Wbfsys User Relation</h2>
</div>
