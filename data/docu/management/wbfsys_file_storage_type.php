...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-wbfsys_file_storage_type' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-wbfsys_file_storage_type';
    }

    $management->upgrade( 'title', 'Management File Storage Type' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten File Storage Type</h2>
</div>
