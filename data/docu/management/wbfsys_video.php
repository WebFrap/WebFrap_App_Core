...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-wbfsys_video' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-wbfsys_video';
    }

    $management->upgrade( 'title', 'Management Video' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Video</h2>
</div>
