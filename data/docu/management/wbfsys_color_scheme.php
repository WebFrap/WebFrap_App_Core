...
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$management = $orm->getByKey( 'WbfsysDocuTree', 'wbf-management-wbfsys_color_scheme' ) )
    {
      $management = new WbfsysDocuTree_Entity();
      $management->access_key = 'wbf-management-wbfsys_color_scheme';
    }

    $management->upgrade( 'title', 'Management Color Scheme' );
    $management->upgrade( 'short_desc', 'Management ' );
    $management->content = <<<HTML
<div class="wgt-panel title" >
  <h2>Management Knoten Color Scheme</h2>
</div>
