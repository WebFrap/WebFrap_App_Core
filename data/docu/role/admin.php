<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for role: admin
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$role = $orm->getByKey( 'WbfsysDocuTree', 'wbf-role-admin' ) )
    {
      $role = new WbfsysDocuTree_Entity();
      $role->access_key = 'wbf-role-admin';
    }

    $role->upgrade( 'title', 'Role Admin' );
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-permission-admin" class="wcm wcm_ui_tree bw62" >
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-backpath-admin" class="wcm wcm_ui_tree bw62" >
