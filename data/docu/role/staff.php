<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for role: staff
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$role = $orm->getByKey( 'WbfsysDocuTree', 'wbf-role-staff' ) )
    {
      $role = new WbfsysDocuTree_Entity();
      $role->access_key = 'wbf-role-staff';
    }

    $role->upgrade( 'title', 'Role Staff' );
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-permission-staff" class="wcm wcm_ui_tree bw62" >
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-backpath-staff" class="wcm wcm_ui_tree bw62" >
...
HTML;
    ...
    /*
    // plain role
    if( !$group = $orm->getByKey( 'WbfsysDocuTree', "wbf-role-staff" ) )
    {
      $group = new WbfsysDocuTree_Entity();
      $group->access_key = 'wbf-role-staff';
    }
