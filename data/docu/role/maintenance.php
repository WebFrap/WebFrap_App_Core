<?php
/*//////////////////////////////////////////////////////////////////////////////
// create the metadata for role: maintenance
//////////////////////////////////////////////////////////////////////////////*/
    ...
    if( !$role = $orm->getByKey( 'WbfsysDocuTree', 'wbf-role-maintenance' ) )
    {
      $role = new WbfsysDocuTree_Entity();
      $role->access_key = 'wbf-role-maintenance';
    }

    $role->upgrade( 'title', 'Role Maintenance' );
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-permission-maintenance" class="wcm wcm_ui_tree bw62" >
...
<div class="wgt-space" >
  ...
  <ul id="wgt-list-daidalos-docu-role-backpath-maintenance" class="wcm wcm_ui_tree bw62" >
...
HTML;
    ...
    /*
    // plain role
    if( !$group = $orm->getByKey( 'WbfsysDocuTree', "wbf-role-maintenance" ) )
    {
      $group = new WbfsysDocuTree_Entity();
      $group->access_key = 'wbf-role-maintenance';
    }
