 ...
 * @licence WebFrap.net
 */
class SystemUser_Creation_Process_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_form( $request, $response )
  {
    ...
    // build process
    $process = new SystemUser_Creation_Process( $db );
      
    $process->loadByStatus( $statusId, $params );
    $process->fetchServiceRequest( );
    
    // benutzer zugriff laden
    $access = new SystemUser_Creation_Process_Access( null, null, $this );
    ...
    ( 
      'form-system_user-creation-process-'.$statusId, 
      'SystemUser_Creation_Process',
      'displayForm'
    );
  ...
  public function service_dropForm( $request, $response )
  {
    ...
    $entity = $orm->get( 'WbfsysRoleUser', $entityId );
    
    $process->load( $entity, $params );
    $process->fetchServiceRequest( );
    
    // benutzer zugriff laden
    $access = new SystemUser_Creation_Process_Access();
    $access->load( $user->getProfileName(), $params, $process->getEntity() );
    ...
    $view = $response->loadView
    ( 
      'dropform-system_user-creation-process-'.$entityId, 
      'SystemUser_Creation_Process',
      'displayDropForm'
    );
  ...
  public function service_switchStatus( $request, $response )
  {
    ...
    //Webfrap::getActive()->redirectByTripple( 'Wbfsys.RoleUser.edit' );
...
/**
  ...
  public function service_switchStatusForm( $request, $response )
  {
    ...
    $listModel->setEntityWbfsysRoleUser( $entity );
  ...
  public function service_showNodeGraph( $request, $response )
  {
    ...
    $view = $response->loadView
    ( 
      'form-system_user-creation-graph-'.$statusId, 
      'SystemUser_Creation_Process_Graph',
      'displayGraph',
      null,
      true
    );
  ...
  public function service_showResponsible( $request, $response )
  {
    ...
    $view = $response->loadView
    ( 
      'form-system_user-creation-receiver-'.$statusId, 
      'SystemUser_Creation_Process_Receiver',
      'displayReceiver',
      null,
      true
    );
...
} // end class SystemUser_Creation_Process_Controller */
