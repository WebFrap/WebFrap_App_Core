 ...
 * @licence WebFrap.net
 */
class SystemUser_Creation_Process_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Display Methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params
   */
  public function displayForm( $process, $params )
  {
    ...
    $this->setTemplate( 'system/system_user-creation-process/form' );
  ...
  public function addActions( $params )
  {
    ...
    self.getObject().find(".wgtac_process_history").click(function(){
      ...
      \$R.get('modal.php?c=Process.Base.showHistory&process={$params->process->activStatus}&objid={$params->entity}&entity=wbfsys_role_user');
    });
...
}//end class SystemUser_Creation_Process_Maintab_View
