 ...
 * @licence WebFrap.net
 */
class SystemUser_Creation_Process_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Der aktive Prozess
   * @var SystemUser_Creation_Process
   */
  public $process = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function loadProcess( $statusId, $params )
  {
    ...
    // build process
    $this->process = new SystemUser_Creation_Process( $db );
...
} // end class SystemUser_Creation_Process_Model */
