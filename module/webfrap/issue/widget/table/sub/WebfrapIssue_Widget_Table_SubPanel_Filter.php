 ...
 * @licence WebFrap.net
 */
class WebfrapIssue_Widget_Table_SubPanel_Filter
  extends WgtSubPanel
{    
  /**
   * @return string
    ...
    $controls .= <<<HTML
        <li>
          <a 
            ...
            <input 
              type="checkbox"  
              id="wgt-filter-webfrap_issue-new_issues"
    ...
    $controls .= <<<HTML
        <li>
          <a 
            ...
            <input 
              type="checkbox"  
              id="wgt-filter-webfrap_issue-closed_issues"
    ...
    $controls .= <<<HTML
        <li>
          <a 
            ...
            <input 
              type="checkbox"  
              id="wgt-filter-webfrap_issue-my_assigned_issued"
    ...
    $controls .= <<<HTML
        <li>
          <a 
            ...
            <input 
              type="checkbox"  
              id="wgt-filter-webfrap_issue-my_created_issued"
...
} // end class WebfrapIssue_Widget_Table_SubPanel_Filter */
