 ...
 * @licence WebFrap.net
 */
class WebfrapIssue_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public $namespace   = 'WebfrapIssue_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Issue.show&amp;target_mask=WebfrapIssue_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.issue.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Issue.edit&amp;target_mask=WebfrapIssue_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.issue.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Issue.delete&amp;target_mask=WebfrapIssue_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.issue.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:175px" >Type</th>'.NL;
    $html .= '<th style="width:175px" >Environment</th>'.NL;
    $html .= '<th style="width:175px" >Description</th>'.NL;
    $html .= '<th style="width:175px" >Created</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" ><em>Status: </em>'.Validator::sanitizeHtml($row['wbfsys_process_node_label']).'</td>'.NL;
      $body .= '<td valign="top" ><em>Type: </em><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueType.listing" >'.Validator::sanitizeHtml($row['wbfsys_issue_type_name']).'</a><br /><em>Category: </em><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Category.listing" >'.Validator::sanitizeHtml($row['wbfsys_category_name']).'</a><br /><em>Severity: </em><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueSeverity.listing" >'.Validator::sanitizeHtml($row['wbfsys_issue_severity_name']).'</a></td>'.NL;
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_issue_description']).'</td>'.NL;
      $body .= '<td valign="top" ><em>Creator: </em><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Issue.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['wbfsys_role_user_name']).'</a><br /><em>Created: </em>'.('' != trim($row['wbfsys_issue_m_time_created'])?$this->view->i18n->date($row['wbfsys_issue_m_time_created']):' ').'</td>'.NL;
      if( $this->enableNav )
      {
...
}// end class WebfrapIssue_Widget_Table_Element
