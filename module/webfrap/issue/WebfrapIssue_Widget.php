 ...
 *
 * @package WebFrap
 * @subpackage webfrap_issue
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapIssue_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapIssue_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapIssue_Widget' );
    ...
    $table = new WebfrapIssue_Widget_Table_Element( 'tableWebfrapIssueItem', $view );
    $table->setId( 'wgt-table-webfrap_issue-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_issue-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapIssue_Widget_Table_Panel( $table );
    $tabPanel->setAccess( $params->access );
      ...
      $filterSubPanel = new WebfrapIssue_Widget_Table_SubPanel_Filter( $this );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.Issue.create&amp;ltab=table&amp;target_mask=WebfrapIssue_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap Issue"  >
      <form
        id="wgt-form-webfrap_issue-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapIssue.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_issue-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapIssue_Widget_Table_Element
    (
      'tableWebfrapIssueItem',
      $view
    );
