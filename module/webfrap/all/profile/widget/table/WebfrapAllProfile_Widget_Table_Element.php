 ...
 * @licence WebFrap.net
 */
class WebfrapAllProfile_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_profile';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProfile_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WebfrapAllProfile_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Profile.show&amp;target_mask=WebfrapAllProfile_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Profile.edit&amp;target_mask=WebfrapAllProfile_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.profile.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Profile.delete&amp;target_mask=WebfrapAllProfile_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.profile.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.Profile_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.profile.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Profile.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['wbfsys_profile_name']).'</a></td>'.NL;
...
}// end class WebfrapAllProfile_Widget_Table_Element
