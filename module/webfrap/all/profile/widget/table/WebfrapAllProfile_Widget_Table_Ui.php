 ...
 * @licence WebFrap.net
 */
class WebfrapAllProfile_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapAllProfile_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapAllProfile', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysProfile_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapAllProfile_Widget_Table_Ui
