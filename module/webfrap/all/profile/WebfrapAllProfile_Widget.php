 ...
 *
 * @package WebFrap
 * @subpackage webfrap_all_profile
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapAllProfile_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapAllProfile_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapAllProfile_Widget' );
    ...
    $table = new WebfrapAllProfile_Widget_Table_Element( 'tableWebfrapAllProfileItem', $view );
    $table->setId( 'wgt-table-webfrap_all_profile-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_all_profile-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapAllProfile_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.Profile.create&amp;ltab=table&amp;target_mask=WebfrapAllProfile_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.Profile_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap All Profile"  >
      <form
        id="wgt-form-webfrap_all_profile-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapAllProfile.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_all_profile-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapAllProfile_Widget_Table_Element
    (
      'tableWebfrapAllProfileItem',
      $view
    );
...
}// end class WebfrapAllProfile_Widget
