 ...
 *
 * @package WebFrap
 * @subpackage webfrap_all_group
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapAllGroup_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapAllGroup_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapAllGroup_Widget' );
    ...
    $table = new WebfrapAllGroup_Widget_Table_Element( 'tableWebfrapAllGroupItem', $view );
    $table->setId( 'wgt-table-webfrap_all_group-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_all_group-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapAllGroup_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.RoleGroup.create&amp;ltab=table&amp;target_mask=WebfrapAllGroup_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.RoleGroup_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap All Group"  >
      <form
        id="wgt-form-webfrap_all_group-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapAllGroup.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_all_group-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapAllGroup_Widget_Table_Element
    (
      'tableWebfrapAllGroupItem',
      $view
    );
...
}// end class WebfrapAllGroup_Widget
