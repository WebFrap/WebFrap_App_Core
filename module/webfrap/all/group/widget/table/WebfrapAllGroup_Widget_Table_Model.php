 ...
 * @licence WebFrap.net
 */
class WebfrapAllGroup_Widget_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysRoleGroup_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysRoleGroup_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}// end class WebfrapAllGroup_Widget_Table_Model
