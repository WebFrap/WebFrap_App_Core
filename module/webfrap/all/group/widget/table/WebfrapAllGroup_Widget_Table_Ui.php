 ...
 * @licence WebFrap.net
 */
class WebfrapAllGroup_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapAllGroup_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapAllGroup', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysRoleGroup_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapAllGroup_Widget_Table_Ui
