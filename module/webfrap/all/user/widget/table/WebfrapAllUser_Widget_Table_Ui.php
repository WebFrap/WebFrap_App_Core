 ...
 * @licence WebFrap.net
 */
class WebfrapAllUser_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapAllUser_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapAllUser', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysRoleUser_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapAllUser_Widget_Table_Ui
