 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolAccess_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapProtocolAccess_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapProtocolAccess', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysProtocolAccess_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapProtocolAccess_Widget_Table_Ui
