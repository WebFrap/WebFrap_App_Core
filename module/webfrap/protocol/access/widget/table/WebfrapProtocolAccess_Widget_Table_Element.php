 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolAccess_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public $namespace   = 'WebfrapProtocolAccess_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolAccess.show&amp;target_mask=WebfrapProtocolAccess_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolAccess.edit&amp;target_mask=WebfrapProtocolAccess_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_access.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolAccess.delete&amp;target_mask=WebfrapProtocolAccess_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_access.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolAccess.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['wbfsys_protocol_access_label']).'</a></td>'.NL;
...
}// end class WebfrapProtocolAccess_Widget_Table_Element
