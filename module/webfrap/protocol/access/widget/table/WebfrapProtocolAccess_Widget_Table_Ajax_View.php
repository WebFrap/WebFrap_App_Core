 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolAccess_Widget_Table_Ajax_View
  extends LibTemplateAjaxView
{
  ...
  */
  public function displayInsert( $params )
  {
    ...
    $ui = $this->loadUi( 'WebfrapProtocolAccess_Widget_Table' );
...
}// end class WebfrapProtocolAccess_Widget_Table_Ajax_View
