 ...
 *
 * @package WebFrap
 * @subpackage webfrap_protocol_access
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapProtocolAccess_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapProtocolAccess_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapProtocolAccess_Widget' );
    ...
    $table = new WebfrapProtocolAccess_Widget_Table_Element( 'tableWebfrapProtocolAccessItem', $view );
    $table->setId( 'wgt-table-webfrap_protocol_access-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_protocol_access-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapProtocolAccess_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.ProtocolAccess.create&amp;ltab=table&amp;target_mask=WebfrapProtocolAccess_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.ProtocolAccess_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap Protocol Access"  >
      <form
        id="wgt-form-webfrap_protocol_access-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapProtocolAccess.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_protocol_access-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapProtocolAccess_Widget_Table_Element
    (
      'tableWebfrapProtocolAccessItem',
      $view
    );
...
}// end class WebfrapProtocolAccess_Widget
