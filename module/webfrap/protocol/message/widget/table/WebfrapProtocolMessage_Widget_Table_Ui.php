 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolMessage_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapProtocolMessage_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapProtocolMessage', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysProtocolMessage_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapProtocolMessage_Widget_Table_Ui
