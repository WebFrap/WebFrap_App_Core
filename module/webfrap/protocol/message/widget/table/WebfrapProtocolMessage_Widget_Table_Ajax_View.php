 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolMessage_Widget_Table_Ajax_View
  extends LibTemplateAjaxView
{
  ...
  */
  public function displayInsert( $params )
  {
    ...
    $ui = $this->loadUi( 'WebfrapProtocolMessage_Widget_Table' );
...
}// end class WebfrapProtocolMessage_Widget_Table_Ajax_View
