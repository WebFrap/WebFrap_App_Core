 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolMessage_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public $namespace   = 'WebfrapProtocolMessage_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolMessage.show&amp;target_mask=WebfrapProtocolMessage_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolMessage.edit&amp;target_mask=WebfrapProtocolMessage_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_message.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolMessage.delete&amp;target_mask=WebfrapProtocolMessage_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_message.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:80px" >Context</th>'.NL;
    $html .= '<th style="width:400px" >Message</th>'.NL;
    $html .= '<th style="width:75px" >Time</th>'.NL;
    $html .= '<th style="width:150px" >Role</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_protocol_message_m_time_created'])?$this->view->i18n->date($row['wbfsys_protocol_message_m_time_created']):' ').'</td>'.NL;
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_protocol_message_m_role_create']).'</td>'.NL;
...
}// end class WebfrapProtocolMessage_Widget_Table_Element
