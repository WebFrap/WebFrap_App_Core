 ...
 * @licence WebFrap.net
 */
class WebfrapProtocolMessage_Widget_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_protocol_message.context as "wbfsys_protocol_message_context"', // variant: field_mgmt-attr 
      'wbfsys_protocol_message.message as "wbfsys_protocol_message_message"', // variant: field_mgmt-attr 
      'wbfsys_protocol_message.m_time_created as "wbfsys_protocol_message_m_time_created"', // variant: field_mgmt-attr 
      'wbfsys_protocol_message.m_role_create as "wbfsys_protocol_message_m_role_create"', // variant: field_mgmt-attr 
    );
 ...
 wbfsys_protocol_message.rowid = \''.$part.'\' 
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
    ...
    if( $params->order )
    {
      ...
      if( in_array( 'm_time_created', $params->order ) )
      {
        $criteria->selectAlso( 'wbfsys_protocol_message.m_time_created as "wbfsys_protocol_message-m_time_created-order"' );
        ...
        $envelop->orderBy( 'inner_acl."wbfsys_protocol_message-m_time_created-order" desc' );
      }
...
}// end class WebfrapProtocolMessage_Widget_Query_Postgresql
