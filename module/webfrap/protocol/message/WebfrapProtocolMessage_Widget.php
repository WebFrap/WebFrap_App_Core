 ...
 *
 * @package WebFrap
 * @subpackage webfrap_protocol_message
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapProtocolMessage_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapProtocolMessage_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapProtocolMessage_Widget' );
    ...
    $table = new WebfrapProtocolMessage_Widget_Table_Element( 'tableWebfrapProtocolMessageItem', $view );
    $table->setId( 'wgt-table-webfrap_protocol_message-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_protocol_message-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapProtocolMessage_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.ProtocolMessage.create&amp;ltab=table&amp;target_mask=WebfrapProtocolMessage_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.ProtocolMessage_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap Protocol Message"  >
      <form
        id="wgt-form-webfrap_protocol_message-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapProtocolMessage.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_protocol_message-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapProtocolMessage_Widget_Table_Element
    (
      'tableWebfrapProtocolMessageItem',
      $view
    );
...
}// end class WebfrapProtocolMessage_Widget
