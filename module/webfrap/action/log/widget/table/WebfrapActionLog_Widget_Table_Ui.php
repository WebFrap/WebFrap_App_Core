 ...
 * @licence WebFrap.net
 */
class WebfrapActionLog_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WebfrapActionLog_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWebfrapActionLog', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysActionLog_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WebfrapActionLog_Widget_Table_Ui
