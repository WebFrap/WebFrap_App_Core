 ...
 * @licence WebFrap.net
 */
class WebfrapActionLog_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public $namespace   = 'WebfrapActionLog_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ActionLog.show&amp;target_mask=WebfrapActionLog_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ActionLog.edit&amp;target_mask=WebfrapActionLog_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.action_log.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ActionLog.delete&amp;target_mask=WebfrapActionLog_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.action_log.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >Action</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_action_log_m_time_created'])?$this->view->i18n->date($row['wbfsys_action_log_m_time_created']):' ').'</td>'.NL;
      if( $this->enableNav )
      {
...
}// end class WebfrapActionLog_Widget_Table_Element
