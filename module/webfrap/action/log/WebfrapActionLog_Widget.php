 ...
 *
 * @package WebFrap
 * @subpackage webfrap_action_log
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WebfrapActionLog_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WebfrapActionLog_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WebfrapActionLog_Widget' );
    ...
    $table = new WebfrapActionLog_Widget_Table_Element( 'tableWebfrapActionLogItem', $view );
    $table->setId( 'wgt-table-webfrap_action_log-widget' );
    ...
    $params->searchFormId = 'wgt-form-webfrap_action_log-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WebfrapActionLog_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.ActionLog.create&amp;ltab=table&amp;target_mask=WebfrapActionLog_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.ActionLog_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Webfrap Action Log"  >
      <form
        id="wgt-form-webfrap_action_log-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WebfrapActionLog.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-webfrap_action_log-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WebfrapActionLog_Widget_Table_Element
    (
      'tableWebfrapActionLogItem',
      $view
    );
...
}// end class WebfrapActionLog_Widget
