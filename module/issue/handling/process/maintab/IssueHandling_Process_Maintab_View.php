 ...
 * @licence WebFrap.net
 */
class IssueHandling_Process_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Display Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displayForm( $process, $params )
  {
    ...
    $this->setTemplate( 'issue/issue_handling-process/form' );
  ...
  public function addActions( $params )
  {
    ...
    self.getObject().find(".wgtac_process_history").click(function(){
      ...
      \$R.get('modal.php?c=Process.Base.showHistory&process={$params->process->activStatus}&objid={$params->entity}&entity=wbfsys_issue');
    });
...
}//end class IssueHandling_Process_Maintab_View
