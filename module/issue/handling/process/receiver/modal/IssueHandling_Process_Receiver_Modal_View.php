 ...
 * @licence WebFrap.net
 */
class IssueHandling_Process_Receiver_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Display Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displayReceiver( $process, $receiverKey, $params )
  {
    ...
    $this->setTemplate( 'issue/issue_handling-process/receiver_modal' );
...
}//end class IssueHandling_Process_Receiver_Modal_View
