...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param MyUserProfile_Entity $entityMyUserProfile
   * @param TArray $params
   */
  public function displayData( $entityMyUserProfile, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityMyUserProfile, $params );
    }
    else
    {
...
}//end class MyUserProfile_Ajax_View
