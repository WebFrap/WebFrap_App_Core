 ...
 * @licence WebFrap.net
 */
class MyUserProfile_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new MyUserProfile entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=My.UserProfile.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=My.UserProfile.insert';
    $params->formId       = 'wgt-form-my_user_profile';
    $params->namespace   = 'my_user_profile-create';
  ...
  $form->setEntityEmbedPerson( $this->model->getEntityEmbedPerson( $entity ) );
    ...
    $this->setTemplate( 'my/user_profile/modal/crud/form_create' );
...
}//end class MyUserProfile_Crud_Create_Modal_View
