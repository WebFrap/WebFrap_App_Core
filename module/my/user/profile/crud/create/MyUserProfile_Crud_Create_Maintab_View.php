 ...
 * @licence WebFrap.net
 */
class MyUserProfile_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des MyUserProfile Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-my_user_profile-create' );

    // set the form template
    $this->setTemplate( 'my/user_profile/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=My.UserProfile.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-my_user_profile';
    ...
    $form = $this->newForm( 'MyUserProfile_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=My.UserProfile.create');}});
});
...
}//end class MyUserProfile_Crud_Create_Maintab_View
