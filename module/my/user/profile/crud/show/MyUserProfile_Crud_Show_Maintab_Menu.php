 ...
 * @licence WebFrap.net
 */
class MyUserProfile_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
        ...
        <li>
          ...
          <span>
            <ul>
              <li>
                <a 
                  href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=my_user_profile&amp;objid={$objid}" 
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=my_user_profile-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class MyUserProfile_Crud_Show_Maintab_Menu
