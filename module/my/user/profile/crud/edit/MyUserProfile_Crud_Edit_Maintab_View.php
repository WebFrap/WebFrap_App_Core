 ...
 * @licence WebFrap.net
 */
class MyUserProfile_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der MyUserProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityMyUserProfile = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=My.UserProfile.edit&amp;utf8=✓&amp;objid='.$entityMyUserProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=My.UserProfile.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-my_user_profile-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'my/user_profile/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'MyUserProfile_Crud_Edit' );
...
}//end class MyUserProfile_Crud_Edit_Maintab_View
