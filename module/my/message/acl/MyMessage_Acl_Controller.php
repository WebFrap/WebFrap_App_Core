 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management MyMessage
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new MyMessage_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('MyMessage_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model MyMessage_Acl_Model */
    $model   = $this->loadModel( 'MyMessage_Acl' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'MyMessage_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'MyMessage_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model MyMessage_Acl_Qfdu_Model */
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model MyMessage_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'MyMessage_Acl_Qfdu' );
    $areaId = $model->getAreaId();
...
} // end class MyMessage_Acl_Controller */
