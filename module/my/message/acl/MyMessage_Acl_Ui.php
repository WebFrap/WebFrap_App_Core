...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return MyMessage_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new MyMessage_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'my_message-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'My Messages', 'my.message.label' )
      )
    );
    $tabPanel->searchKey  = 'my_message_acl';
