 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model MyMessage_Acl_Dset_Model  */
    $model = $this->loadModel( 'MyMessage_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityMyMessage = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view MyMessage_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'my_message-acl-dset-listing-'.$objid,
      'MyMessage_Acl_Dset',
      'displayListing'
    );
    ...
    $view->displayListing( $entityMyMessage, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view MyMessage_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'my_message-acl-dset', 
    	'MyMessage_Acl_Dset',
...
} // end class MyMessage_Acl_Dset_Controller */
