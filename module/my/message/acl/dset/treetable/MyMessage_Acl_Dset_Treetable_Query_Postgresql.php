 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(my_message.name) like upper(\''.$condition['free'].'%\') )
...
} // end class MyMessage_Acl_Dset_Treetable_Query_Postgresql */
