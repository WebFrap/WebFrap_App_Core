 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-my_message'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyMessage_Acl_Dset' );
    /* @var $query MyMessage_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyMessage_Acl_Dset_Treetable' );
    /* @var $query MyMessage_Acl_Dset_Treetable_Query  */
...
} // end class MyMessage_Acl_Dset_Model */
