...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyMessage_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityMyMessage, $areaId, $access, $params  )
  {

    $listObj = new MyMessage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-my_message-acl-dset' );
    ...
    else
    {
      ...
      (
        'My Messages "{@label@}" User Access',
        'my.message.label',
        array
        (
          'label' => $entityMyMessage->text()
        )
      );
      $tabPanel->searchKey  = 'my_message_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new MyMessage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class MyMessage_Acl_Dset_Ui */
