 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'MyMessage_Acl_Dset' );
    ...
    $entityMyMessage = $this->model->getEntity( $dsetId );
...
} // end class MyMessage_Acl_Dset_Ajax_View */
