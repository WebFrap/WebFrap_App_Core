 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=My.Message_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_message-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=My.Message_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'my_message-acl-update';
    ...
    $this->setTemplate( 'my/message/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'My Messages', 'my.message.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-my_message_acl_listing' );
...
} // end class MyMessage_Acl_Maintab_View */
