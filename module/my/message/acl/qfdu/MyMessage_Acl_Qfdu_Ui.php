...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyMessage_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new MyMessage_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for My Messages',
        'my.message.label'
      );
      $tabPanel->searchKey  = 'my_message_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new MyMessage_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class MyMessage_Acl_Qfdu_Ui */
