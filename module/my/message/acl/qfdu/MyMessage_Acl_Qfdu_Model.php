 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-my_message')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityMyMessage = $orm->get('WbfsysMessage', $data['wbfsys_group_users']->vid);
      $tabData['my_message_title']  = $refEntityMyMessage->title;

    }
    $tabData['my_message_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein MyMessage_Acl_Query Objekt
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyMessage_Acl_Qfdu_Treetable' );
    /* @var $query MyMessage_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyMessage_Acl_Qfdu' );
    /* @var $query MyMessage_Acl_Qfdu_Query  */
...
} // end class MyMessage_Acl_Qfdu_Model */
