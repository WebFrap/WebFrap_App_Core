 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view MyMessage_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'my_message-acl-qfdu-aAjax',
      'MyMessage_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class MyMessage_Acl_Qfdu_Controller */
