 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_message.title as "my_message_title"',
      'wbfsys_message.rowid as "my_message_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_message on wbfsys_group_users.vid = wbfsys_message.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_message.title) like upper(\''.$part.'%\') )
...
} // end class MyMessage_Acl_Qfdu_Treetable_Query_Postgresql */
