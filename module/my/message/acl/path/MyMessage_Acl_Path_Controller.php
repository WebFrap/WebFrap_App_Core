 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'MyMessage_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'MyMessage_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view MyMessage_Acl_Path_Maintab_View  */
...
} // end class MyMessage_Acl_Path_Controller */
