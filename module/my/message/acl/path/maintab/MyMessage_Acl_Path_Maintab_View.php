 ...
 * @licence WebFrap.net
 */
class MyMessage_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'my/message/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-my_message-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-my_message-acl-path-access_level',
      'class' => 'medium',
...
} // end class MyMessage_Acl_Path_Maintab_View */
