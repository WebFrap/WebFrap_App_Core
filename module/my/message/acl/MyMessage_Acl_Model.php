...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-my_message' )->getid();
  ...
  public function getEntityAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_message' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_message' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function pushMgmtConfigurationToEntity( $params )
  {
    ...
    $groupQuery   = $db->newQuery( 'MyMessage_Acl_SyncGroup' );
    /* @var $groupQuery MyMessage_Acl_SyncGroup_Query  */
    ...
    $assignmentQuery = $db->newQuery( 'MyMessage_Acl_SyncAssignment' );
    /* @var $assignmentQuery MyMessage_Acl_SyncAssignment_Query  */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyMessage_Acl' );
    /* @var $query MyMessage_Acl_Query  */
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'MyMessage_Acl_Table' );
    /* @var $query MyMessage_Acl_Table_Query  */
