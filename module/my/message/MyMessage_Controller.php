...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: my_message
  *
  ...
  *
  *   @url maintab.php?c=My.Message.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $access = new MyMessage_Crud_Access_Create( null, null, $this );
    ...
    /* @var $model MyMessage_Crud_Model */
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=My.Message.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'my_message:edit';

    $access = new MyMessage_Crud_Access_Edit( null, null, $this );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'my_message-edit',
          $entityMyMessage,
          'Edit My Messages :'.$entityMyMessage->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-my_message';
      $params->maskRoot      = 'my_message:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-my_message';
      $params->aclNode       = 'mgmt-my_message';
      $params->aclLevel      = 1;
    }
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'my_message-show',
          $entityMyMessage,
          'Show My Messages :'.$entityMyMessage->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: my_message
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=My.Message.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-insert';

    $access = new MyMessage_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityMyMessage = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'my_message-update-'.$entityMyMessage;
      ...
      // model wird benötigt
      /* @var $model MyMessage_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=My.Message.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-update-'.$objid;
  ...
  * @param MyMessage_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=My.Message.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-delete-'.$objid;

    $access = new MyMessage_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityMyMessage );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=My.Message.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=My.Message.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-listing';
    ...
    $containerClass = 'MyMessage_'.$listType.'_Access';
    ...
    /* @var $model MyMessage_Table_Model */
    $model = $this->loadModel( 'MyMessage_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'my_message-'.$params->ltype,
          'WbfsysMessage',
          'List of My Messagess'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  MyMessage
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new MyMessage_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $model = $this->loadModel( 'MyMessage_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=My.Message.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model MyMessage_Selection_Model */
    $model   = $this->loadModel( 'MyMessage_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'my_message-data-'.$objid;
    else
      $params->contextKey = 'my_message-data';
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-append-'.$objid;
    ...
    $ui = $this->loadUi( 'MyMessage_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new MyMessage_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_message-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'MyMessage_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'my_message' ); //def my_message
...
} // end class MyMessage_Controller */
