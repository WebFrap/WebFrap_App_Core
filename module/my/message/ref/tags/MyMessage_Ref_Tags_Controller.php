 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "MyMessage_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-my_message-ref-tags';
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'MyMessage_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'my_message-ref-tags-'.$listType.'-ajax',
    	'MyMessage_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a MyMessage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'MyMessage_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'MyMessage_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'MyMessage_Ref_Tags_'.$listType );
...
} // end MyMessage_Ref_Tags_Controller
