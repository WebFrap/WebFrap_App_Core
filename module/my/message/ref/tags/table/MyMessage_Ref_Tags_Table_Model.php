 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idMyMessage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'MyMessage_Ref_Tags_Table' );
    /* @var $query MyMessage_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idMyMessage );
...
}//end class MyMessage_Ref_Tags_Table_Model
