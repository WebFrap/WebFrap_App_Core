 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyMessage_Ref_Tags_Table_Element
   */
  public function createListItem( $idMyMessage, $data, $access, $params  )
  {
    ...
    $table = new MyMessage_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-my_message-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idMyMessage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_message-ref-tags-search-'
        .$idMyMessage;
    ...
    $tabPanel->searchKey = 'my_message-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=MyMessage_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idMyMessage );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=My.Message_Ref_Tags.search&amp;target_id='
...
}//end class MyMessage_Ref_Tags_Table_Ui
