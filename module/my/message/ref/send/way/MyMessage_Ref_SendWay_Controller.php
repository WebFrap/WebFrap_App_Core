 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_SendWay_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "MyMessage_Ref_SendWay_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-my_message-ref-send_way';
    ...
    (
      $params->tabId,
      'MyMessage_Ref_SendWay_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'MyMessage_Ref_SendWay_'.$listType );

    $view    = $response->loadView
    ( 
    	'my_message-ref-send_way-'.$listType.'-ajax',
    	'MyMessage_Ref_SendWay_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysMessageRepository to a MyMessage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'MyMessage_Ref_SendWay_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'MyMessage_Ref_SendWay_'.$listType );
      $listModel = $this->loadModel( 'MyMessage_Ref_SendWay_'.$listType );
...
} // end MyMessage_Ref_SendWay_Controller
