 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_SendWay_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idMyMessage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'MyMessage_Ref_SendWay_Table' );
    /* @var $query MyMessage_Ref_SendWay_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_message_sendway.id_message = '.$idMyMessage );
...
}//end class MyMessage_Ref_SendWay_Table_Model
