 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_SendWay_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyMessage_Ref_SendWay_Table_Element
   */
  public function createListItem( $idMyMessage, $data, $access, $params  )
  {
    ...
    $table = new MyMessage_Ref_SendWay_Table_Element
    (
      'tableSendWay',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-my_message-conref-send_way'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-send_way-'.$idMyMessage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_message-ref-send_way-search-'
        .$idMyMessage;
    ...
    $tabPanel->searchKey = 'my_message-ref-send_way';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.MessageSendway.create&refid='.$params->refId.'&target_mask=MyMessage_Ref_SendWay&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_message_sendway[id_message]\':\''.$params->refIdSendWay.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdSendWay', $idMyMessage );
    $view->addVar
    (
      'searchFormActionSendWay',
      'ajax.php?c=My.Message_Ref_SendWay.search&amp;target_id='
...
}//end class MyMessage_Ref_SendWay_Table_Ui
