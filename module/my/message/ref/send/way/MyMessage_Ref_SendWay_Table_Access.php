 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_SendWay_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-my_message-ref-send_way' );
  ...
  /**
   * @param MyMessage_Ref_SendWay_Table_Query $query
...
}//end class MyMessage_Ref_SendWay_Table_Access
