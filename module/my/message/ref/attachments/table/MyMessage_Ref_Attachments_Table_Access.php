 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Attachments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-my_message-ref-attachments' );
  ...
  /**
   * @param MyMessage_Ref_Attachments_Table_Query $query
...
}//end class MyMessage_Ref_Attachments_Table_Access
