 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Attachments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=My.Message_Ref_Attachments.search&amp;objid='.$objid,
        $params
      );
    }
    ...
    $ui  = $this->loadUi( 'MyMessage_Ref_Attachments_Table' );
...
}//end class MyMessage_Ref_Attachments_Table_Ajax_View
