 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Attachments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $this->setTemplate( 'my/message/ref_attachments/tab_table' );
...
}//end class MyMessage_Ref_Attachments_Table_Modal_View
