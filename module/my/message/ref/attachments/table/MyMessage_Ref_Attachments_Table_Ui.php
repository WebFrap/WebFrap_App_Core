 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Attachments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyMessage_Ref_Attachments_Table_Element
   */
  public function createListItem( $idMyMessage, $data, $access, $params  )
  {
    ...
    $table = new MyMessage_Ref_Attachments_Table_Element
    (
      'tableAttachments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-my_message-conref-attachments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-attachments-'.$idMyMessage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_message-ref-attachments-search-'
        .$idMyMessage;
    ...
    $tabPanel->searchKey = 'my_message-ref-attachments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new File',
            '$R.post(\'maintab.php?c=Wbfsys.EntityAttachment.create&refid='.$params->refId.'&target_mask=MyMessage_Ref_Attachments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_attachment[vid]\':\''.$params->refIdAttachments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdAttachments', $idMyMessage );
    $view->addVar
    (
      'searchFormActionAttachments',
      'ajax.php?c=My.Message_Ref_Attachments.search&amp;target_id='
...
}//end class MyMessage_Ref_Attachments_Table_Ui
