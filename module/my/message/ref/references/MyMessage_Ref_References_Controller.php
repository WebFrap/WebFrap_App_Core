 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_References_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "MyMessage_Ref_References_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-my_message-ref-references';
    ...
    (
      $params->tabId,
      'MyMessage_Ref_References_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'MyMessage_Ref_References_'.$listType );

    $view    = $response->loadView
    ( 
    	'my_message-ref-references-'.$listType.'-ajax',
    	'MyMessage_Ref_References_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysMessage to a MyMessage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-my_message-ref-references'
    );
    ...
    $model  = $this->loadModel( 'MyMessage_Ref_References_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'MyMessage_Ref_References_'.$listType );
      $listModel = $this->loadModel( 'MyMessage_Ref_References_'.$listType );
...
} // end MyMessage_Ref_References_Controller
