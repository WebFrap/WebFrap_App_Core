 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_References_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected MyMessage
   *
   * @param int $idMyMessage the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idMyMessage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'MyMessage_Ref_References_Table' );
    /* @var $query MyMessage_Ref_References_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_message_references.id_message = '.$idMyMessage );
...
}//end class MyMessage_Ref_References_Table_Model
