 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_References_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=My.Message_Ref_References.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class MyMessage_Ref_References_Table_Ajax_View
