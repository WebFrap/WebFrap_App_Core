 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_References_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-my_message-ref-references' );
  ...
  /**
   * @param MyMessage_Ref_References_Table_Query $query
...
}//end class MyMessage_Ref_References_Table_Access
