 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_References_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=My.Message_Ref_References.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-my_message-ref-references-search-'.$objid;
    ...
    $this->setTemplate( 'my/message/ref_references/tab_table' );

    $ui = $this->loadUi( 'MyMessage_Ref_References_Table' );
...
}//end class MyMessage_Ref_References_Table_Modal_View
