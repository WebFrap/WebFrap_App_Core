 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Link_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=My.Message_Ref_Link.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-my_message-ref-link-search-'.$objid;
    ...
    $this->setTemplate( 'my/message/ref_link/tab_table' );

    $ui = $this->loadUi( 'MyMessage_Ref_Link_Table' );
...
}//end class MyMessage_Ref_Link_Table_Modal_View
