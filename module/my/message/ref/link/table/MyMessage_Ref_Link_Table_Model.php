 ...
 * @licence WebFrap.net
 */
class MyMessage_Ref_Link_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idMyMessage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'MyMessage_Ref_Link_Table' );
    /* @var $query MyMessage_Ref_Link_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_data_link.id_message = '.$idMyMessage );
...
}//end class MyMessage_Ref_Link_Table_Model
