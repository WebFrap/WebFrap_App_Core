 ...
 * @licence WebFrap.net
 */
class MyMessage_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var MyMessage_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'MyMessage_Export_Listing_Access';
    ...
    $model = $this->loadModel( 'MyMessage_Export' );
...
} // end class MyMessage_Export_Controller_Genf
