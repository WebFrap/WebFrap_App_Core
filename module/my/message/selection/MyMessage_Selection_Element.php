 ...
 * @licence WebFrap.net
 */
class MyMessage_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-my_message';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=My.Message.show&amp;target_mask=MyMessage&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'my.message.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=My.Message.edit&amp;target_mask=MyMessage&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'my.message.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=My.Message.delete&amp;target_mask=MyMessage&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'my.message.label',
        Acl::DELETE
...
}//end class MyMessage_Selection_Element
