 ...
 * @licence WebFrap.net
 */
class MyMessage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param MyMessage_Selection_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message'), UPPER('mgmt-my_message') )
...
}//end class MyMessage_Selection_Access
