 ...
 * @licence WebFrap.net
 */
class MyMessage_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if( $params->loadFullSize )
      $this->calcQuery = $criteria->count( 'count(DISTINCT wbfsys_message.'.Db::PK.' ) as '.Db::Q_SIZE );
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    {
      $row['acl-level'] = $inKeys[$row['my_message_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function fetchWithAcls( $condition = null, $params = null )
  {
    ...
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys/mgmt-wbfsys_message>mgmt-my_message' );
    }
    else
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys/mgmt-wbfsys_message>mgmt-my_message', true, $params->access->level  );
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_message.rowid as "my_message_rowid"', // variant: def-rowid 
      'wbfsys_message.title as "my_message_title"', // variant: def-by-context 
    );
 ...
 /**
  ...
  public function checkConditions( $criteria, array $condition )
  {
    	...
    	if( isset($condition['ids']) && !empty( $condition['ids'] ) )
    	{
				$criteria->where
        (
          'wbfsys_message.rowid = IN( '. implode( ', ', $condition['ids'] ) .' ) ';
        );
    	}
 ...
 wbfsys_message.rowid = \''.$part.'\' 
      ...
      // search conditions for  my_message
      if( isset( $condition['my_message'] ) )
      {
        $whereCond = $condition['my_message'];
      ...
      }//end if( isset ($condition['my_message']) )
  ...
  public function checkLimitAndOrder( $criteria, $params  )
  {
     ...
     // inject the default order
      ...
      $criteria->orderBy( 'wbfsys_message.title' );
      $criteria->selectAlso( 'wbfsys_message.title as "wbfsys_message-title-order"' );
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
     ...
     // inject the default order
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_message-title-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_message-title-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_message-title-order"' );
...
}//end class MyMessage_Table_Query_Postgresql
