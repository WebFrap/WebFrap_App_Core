...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für My Messages
  *
  ...
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new MyMessage_Table_Element( 'tableMyMessage', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'My Messages', 'my.message.label' );
