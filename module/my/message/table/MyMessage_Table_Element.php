  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=My.Message.show&amp;target_mask=MyMessage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'my.message.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=My.Message.edit&amp;target_mask=MyMessage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'my.message.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=My.Message_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'my.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Send Ways',
            'modal.php?c=My.Message_Ref_SendWay.modal&amp;objid=',
            'control/table.png',
            '',
            'my.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Data Links',
            'modal.php?c=My.Message_Ref_Link.modal&amp;objid=',
            'control/table.png',
            '',
            'my.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'References',
            'modal.php?c=My.Message_Ref_References.modal&amp;objid=',
            'control/table.png',
            '',
            'my.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attachments',
            'modal.php?c=My.Message_Ref_Attachments.modal&amp;objid=',
            'control/table.png',
            '',
            'my.message.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=My.Message.delete&amp;target_mask=MyMessage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'my.message.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=my_message&amp;objid=',
        'control/rights.png',
        '',
        'my.message.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.message.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['my_message_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=My.Message_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected My Messages." >{$iconDelete} Delete selected My Messages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! My Messages. Please confirm that you really want to do that."
      	href="ajax.php?c=My.Message_Multi.deleteAll" >{$iconClean} Delete all My Messages</a></li>
  	</ul>
 	</div>
...
}//end class MyMessage_Table_Element
