 ...
 * @licence WebFrap.net
 */
class MyMessage_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function renderForm( $params = null  )
  {
    ...
    $this->input_MyMessage_IdSender( $params );
    $this->input_MyMessage_IdReceiver( $params );
    $this->input_MyMessage_IdAnswerTo( $params );
    $this->input_MyMessage_MessageId( $params );
    $this->input_MyMessage_IdRefer( $params );
    $this->input_MyMessage_Priority( $params );
    $this->input_MyMessage_DeliverDate( $params );
    $this->input_MyMessage_Title( $params );
    $this->input_MyMessage_Message( $params );
    $this->input_MyMessage_IdSenderStatus( $params );
    $this->input_MyMessage_IdReceiverStatus( $params );
    $this->input_MyMessage_FlagSenderDeleted( $params );
    $this->input_MyMessage_FlagReceiverDeleted( $params );
    $this->input_MyMessage_Rowid( $params );
    $this->input_MyMessage_MTimeCreated( $params );
    $this->input_MyMessage_MRoleCreate( $params );
    $this->input_MyMessage_MTimeChanged( $params );
    $this->input_MyMessage_MRoleChange( $params );
    $this->input_MyMessage_MVersion( $params );
    $this->input_MyMessage_MUuid( $params );
  ...
  * @return void
  */
  public function input_MyMessage_IdSender( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_IdSender */
  ...
  * @return void
  */
  public function input_MyMessage_IdReceiver( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputIdReceiver = $this->view->newInput( 'inputMyMessageIdReceiver', 'Window' );
      $this->items['my_message-id_receiver'] = $inputIdReceiver;
      $inputIdReceiver->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'my_message[id_receiver]',
        'id'        => 'wgt-input-my_message_id_receiver'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputIdReceiver->setReadonly( $this->fieldReadOnly( 'my_message', 'id_receiver' ) );
      $inputIdReceiver->setRequired( $this->fieldRequired( 'my_message', 'id_receiver' ) );
      $inputIdReceiver->setLabel( $i18n->l( 'Receiver', 'wbfsys.message.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=my_message_id_receiver'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdReceiver->buildJavascript( 'wgt-input-my_message_id_receiver'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_MyMessage_IdReceiver */
  ...
  * @return void
  */
  public function input_MyMessage_IdAnswerTo( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputIdAnswerTo = $this->view->newInput( 'inputMyMessageIdAnswerTo', 'Window' );
      $this->items['my_message-id_answer_to'] = $inputIdAnswerTo;
      $inputIdAnswerTo->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'my_message[id_answer_to]',
        'id'        => 'wgt-input-my_message_id_answer_to'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputIdAnswerTo->setReadonly( $this->fieldReadOnly( 'my_message', 'id_answer_to' ) );
      $inputIdAnswerTo->setRequired( $this->fieldRequired( 'my_message', 'id_answer_to' ) );
      $inputIdAnswerTo->setLabel( $i18n->l( 'Answer To', 'wbfsys.message.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=my_message_id_answer_to'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAnswerTo->buildJavascript( 'wgt-input-my_message_id_answer_to'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_MyMessage_IdAnswerTo */
  ...
  * @return void
  */
  public function input_MyMessage_MessageId( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:text
      $inputMessageId = $this->view->newInput( 'inputMyMessageMessageId' , 'Text' );
      $this->items['my_message-message_id'] = $inputMessageId;
      $inputMessageId->addAttributes
      (
        array
        (
          'name'      => 'my_message[message_id]',
          'id'        => 'wgt-input-my_message_message_id'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMessageId->setReadonly( $this->fieldReadOnly( 'my_message', 'message_id' ) );
      $inputMessageId->setRequired( $this->fieldRequired( 'my_message', 'message_id' ) );
  ...
  }//end public function input_MyMessage_MessageId */
  ...
  * @return void
  */
  public function input_MyMessage_IdRefer( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_IdRefer */
  ...
  * @return void
  */
  public function input_MyMessage_Priority( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_Priority */
  ...
  * @return void
  */
  public function input_MyMessage_DeliverDate( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:timestamp
      $inputDeliverDate = $this->view->newInput( 'inputMyMessageDeliverDate', 'Timestamp' );
  ...
  }//end public function input_MyMessage_DeliverDate */
  ...
  * @return void
  */
  public function input_MyMessage_Title( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_Title */
  ...
  * @return void
  */
  public function input_MyMessage_Message( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_Message */
  ...
  * @return void
  */
  public function input_MyMessage_IdSenderStatus( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:int
      $inputIdSenderStatus = $this->view->newInput( 'inputMyMessageIdSenderStatus', 'Int' );
      $this->items['my_message-id_sender_status'] = $inputIdSenderStatus;
      $inputIdSenderStatus->addAttributes
      (
        array
        (
          'name'      => 'my_message[id_sender_status]',
          'id'        => 'wgt-input-my_message_id_sender_status'.($this->suffix?'-'.$this->suffix:''),
...
$inputIdSenderStatus->setReadOnly( $this->fieldReadOnly( 'my_message', 'id_sender_status' ) );
      $inputIdSenderStatus->setRequired( $this->fieldRequired( 'my_message', 'id_sender_status' ) );
  ...
  }//end public function input_MyMessage_IdSenderStatus */
  ...
  * @return void
  */
  public function input_MyMessage_IdReceiverStatus( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:int
      $inputIdReceiverStatus = $this->view->newInput( 'inputMyMessageIdReceiverStatus', 'Int' );
      $this->items['my_message-id_receiver_status'] = $inputIdReceiverStatus;
      $inputIdReceiverStatus->addAttributes
      (
        array
        (
          'name'      => 'my_message[id_receiver_status]',
          'id'        => 'wgt-input-my_message_id_receiver_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip wcm_valid_int medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
...
$inputIdReceiverStatus->setReadOnly( $this->fieldReadOnly( 'my_message', 'id_receiver_status' ) );
      $inputIdReceiverStatus->setRequired( $this->fieldRequired( 'my_message', 'id_receiver_status' ) );
  ...
  }//end public function input_MyMessage_IdReceiverStatus */
  ...
  * @return void
  */
  public function input_MyMessage_FlagSenderDeleted( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:Checkbox
      $inputFlagSenderDeleted = $this->view->newInput( 'inputMyMessageFlagSenderDeleted', 'Checkbox' );
      $this->items['my_message-flag_sender_deleted'] = $inputFlagSenderDeleted;
      $inputFlagSenderDeleted->addAttributes
      (
        array
        (
          'name'      => 'my_message[flag_sender_deleted]',
          'id'        => 'wgt-input-my_message_flag_sender_deleted'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputFlagSenderDeleted->setReadonly( $this->fieldReadOnly( 'my_message', 'flag_sender_deleted' ) );
      $inputFlagSenderDeleted->setRequired( $this->fieldRequired( 'my_message', 'flag_sender_deleted' ) );
  ...
  }//end public function input_MyMessage_FlagSenderDeleted */
  ...
  * @return void
  */
  public function input_MyMessage_FlagReceiverDeleted( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:Checkbox
      $inputFlagReceiverDeleted = $this->view->newInput( 'inputMyMessageFlagReceiverDeleted', 'Checkbox' );
      $this->items['my_message-flag_receiver_deleted'] = $inputFlagReceiverDeleted;
      $inputFlagReceiverDeleted->addAttributes
      (
        array
        (
          'name'      => 'my_message[flag_receiver_deleted]',
          'id'        => 'wgt-input-my_message_flag_receiver_deleted'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputFlagReceiverDeleted->setReadonly( $this->fieldReadOnly( 'my_message', 'flag_receiver_deleted' ) );
      $inputFlagReceiverDeleted->setRequired( $this->fieldRequired( 'my_message', 'flag_receiver_deleted' ) );
  ...
  }//end public function input_MyMessage_FlagReceiverDeleted */
  ...
  * @return void
  */
  public function input_MyMessage_Rowid( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_Rowid */
  ...
  * @return void
  */
  public function input_MyMessage_MTimeCreated( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MTimeCreated */
  ...
  * @return void
  */
  public function input_MyMessage_MRoleCreate( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MRoleCreate */
  ...
  * @return void
  */
  public function input_MyMessage_MTimeChanged( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MTimeChanged */
  ...
  * @return void
  */
  public function input_MyMessage_MRoleChange( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MRoleChange */
  ...
  * @return void
  */
  public function input_MyMessage_MVersion( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MVersion */
  ...
  * @return void
  */
  public function input_MyMessage_MUuid( $params )
  {
    $i18n     = $this->view->i18n;
  ...
  }//end public function input_MyMessage_MUuid */
...
}//end class MyMessage_Crud_Create_Form */
