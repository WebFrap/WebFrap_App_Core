 ...
 * @licence WebFrap.net
 */
class MyMessage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new MyMessage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=My.Message.insert';
    $params->formId       = 'wgt-form-my_message';
    $params->namespace   = 'my_message-create';
    ...
    $this->setTemplate( 'my/message/modal/crud/form_create' );
...
}//end class MyMessage_Crud_Create_Modal_View
