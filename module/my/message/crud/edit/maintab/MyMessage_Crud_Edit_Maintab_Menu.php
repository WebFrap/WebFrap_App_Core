 ...
 * @licence WebFrap.net
 */
class MyMessage_Crud_Edit_Maintab_Menu
  extends WgtDropmenu
{
    ...
    <div class="wgt-dropdownbox" id="{$this->id}-cruddropbox" >
      <ul id="{$this->id}-cruddrop-menu"  >
        <li><a
          ...
          title="Save the My Messages and close the Tab after saving" >{$iconSaveUCl} {$view->i18n->l('Save &amp; Close','wbf.label')}</a></li>
      </ul>
...
HTML;
      ...
      if( $this->acl->access( 'mod-wbfsys>mgmt-wbfsys_message:access', $objid ) )
      {
...
}//end class MyMessage_Crud_Edit_Maintab_Menu
