 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Postgresql_Query
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    while( $children = $this->loadChildren( $ids, true ) )
    {
      ...
      {
        $this->childs[$child['my_wbfsys_task_m_parent']][] = $child;
        $ids[] = $child['my_wbfsys_task_rowid'];
      }
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $access, $condition, $params = null )
  {
    ...
    while( $childIds = $access->fetchChildrenIds( $pName, 'treetable', $this, $ids, $condition, $params ) )
    {
      ...
      foreach( $children as $child )
      {
        $child['acl-level'] = $childIds[$child['my_wbfsys_task_rowid']];
 ...
 /**
  ...
  public function loadChildren( $ids, $loadChildren = false )
  {
    ...
    if( $loadChildren )
      $criteria->where('wbfsys_task.m_parent in('.implode(',',$ids).')');
    else
      $criteria->where('wbfsys_task.rowid in('.implode(',',$ids).')');
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_task.m_parent as "my_wbfsys_task_m_parent"', // variant: def-additional 
    );
 ...
 /**
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    $criteria->where( ' wbfsys_task.m_parent is null ' );
...
}//end class MyWbfsysTask_Treetable_Postgresql_Query
