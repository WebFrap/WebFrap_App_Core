 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-my_wbfsys_task';
   ...
   *
   * @var MyWbfsysTask_Treetable_Query
   */
  public $data       = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=My.WbfsysTask.show&amp;ltype=treetable&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=My.WbfsysTask.edit&amp;ltype=treetable&amp;objid=',
        'control/edit.png',
        '',
        'my.wbfsys_task.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=My.WbfsysTask.delete&amp;ltype=treetable&amp;objid=',
        'control/delete.png',
        '',
        'my.wbfsys_task.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildAjaxTbody( $row  )
  {
    ...
    if( $this->insertMode )
    {
      ...
      if( $row['my_wbfsys_task_m_parent'] )
      {
        $pClass = 'child-of-'.$this->id.'_row_'.$row['my_wbfsys_task_m_parent'];
        $body = '<htmlArea selector="tr#'.$this->id.'_row_'
          .$row['my_wbfsys_task_m_parent'].'" action="after" >'
          .'<![CDATA[<tr id="'.$rowid.'" '
          .' wgt_context_menu="'.$this->id.'-cmenu" '
          .' wgt_eid="'.$objid.'" ' 
          .$rowParams
    ...
    if( $row['my_wbfsys_task_m_parent'] )
    {
      $prePos = $row['my_wbfsys_task_m_parent'].'.';
    }
    else
    {
      $prePos = '';
    ...
    if( !$this->appendMode && $row['my_wbfsys_task_m_parent'] )
    {
      $parentId = $this->id.'_row_'.$row['my_wbfsys_task_m_parent'];
...
HTML;
  ...
  protected function buildJavascript()
  {
    ...
    \$S('#{$this->id}').data('func_add',function( objid ){
      \$R.post('maintab.php?c=My.WbfsysTask.create&amp;ltype=treetable',{"my_wbfsys_task[m_parent]":objid});
    });
...
}//end class MyWbfsysTask_Treetable_Element
