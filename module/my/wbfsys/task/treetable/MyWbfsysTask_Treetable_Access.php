 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param MyWbfsysTask_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_task'), UPPER('mgmt-my_wbfsys_task') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_task.rowid ",
      'acls'
    );
...
}//end class MyWbfsysTask_Treetable_Access
