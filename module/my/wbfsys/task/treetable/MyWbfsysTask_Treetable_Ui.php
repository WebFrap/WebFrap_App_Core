 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new MyWbfsysTask_Treetable_Element
    (
      'treetableMyWbfsysTask',
      $view
    );
...
WGTJS;
   ...
   *
   * @return MyWbfsysTask_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowMyWbfsysTask', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param MyWbfsysTask_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class MyWbfsysTask_Treetable_Ui
