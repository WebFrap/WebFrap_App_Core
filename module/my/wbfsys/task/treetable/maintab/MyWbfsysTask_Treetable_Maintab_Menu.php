 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Maintab_Menu
  extends WgtDropmenu
{
  /**
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-my_wbfsys_task-treetable-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-my_wbfsys_task-treetable-help hidden" >
    	      
<p>This is the My Tasks treetable.</p>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=my_wbfsys_task-treetable" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class MyWbfsysTask_Treetable_Maintab_Menu
