 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var MyWbfsysTask_Treeable_Model
    */
    public $model = null;

    /**
    * @var MyWbfsysTask_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'my/wbfsys_task/maintab/treetable/listing' );
    ...
    (
      $i18nText,
      'maintab.php?c=My.WbfsysTask.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=My.WbfsysTask.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-my_wbfsys_task-search';
...
BUTTONJS;
    ...
    ///@var MyWbfsysTask_Treetable_Ui
    $ui = $this->loadUi( 'MyWbfsysTask_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var MyWbfsysTask_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'MyWbfsysTask_Table'
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=My.WbfsysTask.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=My.WbfsysTask.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=My.WbfsysTask.listing&amp;ltype=treetable');
    });
...
}//end class MyWbfsysTask_Treetable_Maintab_View
