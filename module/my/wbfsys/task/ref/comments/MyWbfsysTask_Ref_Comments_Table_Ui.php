 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyWbfsysTask_Ref_Comments_Table_Element
   */
  public function createListItem( $idMyWbfsysTask, $data, $access, $params  )
  {
    ...
    $table = new MyWbfsysTask_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-my_wbfsys_task-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idMyWbfsysTask;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_wbfsys_task-ref-comments-search-'
        .$idMyWbfsysTask;
    ...
    $tabPanel->searchKey = 'my_wbfsys_task-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=MyWbfsysTask_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idMyWbfsysTask );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=My.WbfsysTask_Ref_Comments.search&amp;target_id='
...
}//end class MyWbfsysTask_Ref_Comments_Table_Ui
