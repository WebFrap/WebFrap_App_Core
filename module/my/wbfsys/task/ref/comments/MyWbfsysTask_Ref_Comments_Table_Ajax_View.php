 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=My.WbfsysTask_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class MyWbfsysTask_Ref_Comments_Table_Ajax_View
