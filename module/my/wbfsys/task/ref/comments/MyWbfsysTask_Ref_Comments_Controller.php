 ...
 * If you want to extend this class write your coden in ControllerMyWbfsysTask
 *
 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den my_wbfsys_task management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "MyWbfsysTask_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-my_wbfsys_task-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-my_wbfsys_task-edit-'.$objid;
    ...
    (
      $params->tabId,
      'MyWbfsysTask_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'MyWbfsysTask_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'my_wbfsys_task-ref-comments-'.$listType.'-ajax',
    	'MyWbfsysTask_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a MyWbfsysTask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'MyWbfsysTask_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'MyWbfsysTask_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'MyWbfsysTask_Ref_Comments_'.$listType );
...
} // end MyWbfsysTask_Ref_Comments_Controller
