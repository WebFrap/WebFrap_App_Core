 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idMyWbfsysTask, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'MyWbfsysTask_Ref_Comments_Table' );
    /* @var $query MyWbfsysTask_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idMyWbfsysTask );
...
}//end class MyWbfsysTask_Ref_Comments_Table_Model
