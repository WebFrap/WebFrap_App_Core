 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Attachments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listAttachments as $entityMyWbfsysTask )
      {
        if(!$orm->save( $entityMyWbfsysTask) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save My Tasks '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved My Tasks '.$entityText,
              'my.wbfsys_task.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved My Tasks: '.$textSaved,
          'my.wbfsys_task.message',
          array($textSaved)
        )
      );
...
}//end class MyWbfsysTask_Ref_Attachments_Multi_Model
