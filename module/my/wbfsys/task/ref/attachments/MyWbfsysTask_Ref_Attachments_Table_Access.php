 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Attachments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-my_wbfsys_task-ref-attachments' );
  ...
  /**
   * @param MyWbfsysTask_Ref_Attachments_Table_Query $query
...
}//end class MyWbfsysTask_Ref_Attachments_Table_Access
