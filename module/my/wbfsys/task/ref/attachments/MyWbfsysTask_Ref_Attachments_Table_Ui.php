 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Attachments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idMyWbfsysTask
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return MyWbfsysTask_Ref_Attachments_Table_Element
   */
  public function createListItem( $idMyWbfsysTask, $data, $access, $params  )
  {
    ...
    $table = new MyWbfsysTask_Ref_Attachments_Table_Element
    (
      'tableAttachments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-my_wbfsys_task-conref-attachments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-attachments-'.$idMyWbfsysTask;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_wbfsys_task-ref-attachments-search-'
        .$idMyWbfsysTask;
    ...
    $tabPanel->searchKey = 'my_wbfsys_task-ref-attachments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new File',
            '$R.post(\'maintab.php?c=Wbfsys.EntityAttachment.create&refid='.$params->refId.'&target_mask=MyWbfsysTask_Ref_Attachments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_attachment[vid]\':\''.$params->refIdAttachments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdAttachments', $idMyWbfsysTask );
    $view->addVar
    (
      'searchFormActionAttachments',
      'ajax.php?c=My.WbfsysTask_Ref_Attachments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idMyWbfsysTask
    );
   ...
   * @return MyWbfsysTask_Ref_Attachments_Table_Element
   */
  public function getListItem( $idMyWbfsysTask, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param MyWbfsysTask_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class MyWbfsysTask_Ref_Attachments_Table_Ui
