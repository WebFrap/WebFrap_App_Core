 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Attachments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=My.WbfsysTask_Ref_Attachments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_wbfsys_task-ref-attachments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Attachments' );

    // set the default table template
    $this->setTemplate( 'my/wbfsys_task/ref_attachments/tab_table' );

    $ui = $this->loadUi( 'MyWbfsysTask_Ref_Attachments_Table' );
...
}//end class MyWbfsysTask_Ref_Attachments_Table_Modal_View
