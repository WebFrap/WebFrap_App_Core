 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Ref_Attachments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "MyWbfsysTask_Ref_Attachments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-my_wbfsys_task-ref-attachments';
    ...
    (
      $params->tabId,
      'MyWbfsysTask_Ref_Attachments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'MyWbfsysTask_Ref_Attachments_'.$listType );

    $view    = $response->loadView
    ( 
    	'my_wbfsys_task-ref-attachments-'.$listType.'-ajax',
    	'MyWbfsysTask_Ref_Attachments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysFile to a MyWbfsysTask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-my_wbfsys_task-ref-attachments'
    );
    ...
    $model  = $this->loadModel( 'MyWbfsysTask_Ref_Attachments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'MyWbfsysTask_Ref_Attachments_'.$listType );
      $listModel = $this->loadModel( 'MyWbfsysTask_Ref_Attachments_'.$listType );
...
} // end MyWbfsysTask_Ref_Attachments_Controller
