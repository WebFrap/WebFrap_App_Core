 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param MyWbfsysTask_Selection_Query $data
  ...
  *  }
  *
  * @return MyWbfsysTask_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new MyWbfsysTask_Selection_Element
    (
      'selectionMyWbfsysTask',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection My Tasks', 'my.wbfsys_task.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=My.WbfsysTask.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowMyWbfsysTask',
      'MyWbfsysTask_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param MyWbfsysTask_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class MyWbfsysTask_Selection_Ui
