 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-my_wbfsys_task';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=My.WbfsysTask.show&amp;target_mask=MyWbfsysTask&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=My.WbfsysTask.edit&amp;target_mask=MyWbfsysTask&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'my.wbfsys_task.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=My.WbfsysTask.delete&amp;target_mask=MyWbfsysTask&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'my.wbfsys_task.label',
        Acl::DELETE
...
}//end class MyWbfsysTask_Selection_Element
