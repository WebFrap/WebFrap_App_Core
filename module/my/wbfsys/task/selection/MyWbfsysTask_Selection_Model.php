 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['my_wbfsys_task']->id_status )
    {
      ...
      (
        'WbfsysProcessNode',
        'rowid = '.$data['my_wbfsys_task']->id_status,
        'label'
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'MyWbfsysTask_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'MyWbfsysTask_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class MyWbfsysTask_Selection_Model
