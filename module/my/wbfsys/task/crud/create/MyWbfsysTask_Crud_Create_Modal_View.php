 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new MyWbfsysTask entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=My.WbfsysTask.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=My.WbfsysTask.insert';
    $params->formId       = 'wgt-form-my_wbfsys_task';
    $params->namespace   = 'my_wbfsys_task-create';
    ...
    $this->setTemplate( 'my/wbfsys_task/modal/crud/form_create' );
...
}//end class MyWbfsysTask_Crud_Create_Modal_View
