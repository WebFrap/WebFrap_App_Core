 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des MyWbfsysTask Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-my_wbfsys_task-create' );

    // set the form template
    $this->setTemplate( 'my/wbfsys_task/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=My.WbfsysTask.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-my_wbfsys_task';
    ...
    $form = $this->newForm( 'MyWbfsysTask_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=My.WbfsysTask.create');}});
});
...
}//end class MyWbfsysTask_Crud_Create_Maintab_View
