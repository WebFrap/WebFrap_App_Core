 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityMyWbfsysTask = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=My.WbfsysTask.edit&amp;utf8=✓&amp;objid='.$entityMyWbfsysTask
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=My.WbfsysTask.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-my_wbfsys_task-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'my/wbfsys_task/maintab/crud/form_edit' );
...
$params->processForm_Flow = $processForm_Flow;
    ...
    $form = $this->newForm( 'MyWbfsysTask_Crud_Edit' );
    ...
    $params->process_Flow->injectValidationInForm( $form, 'my_wbfsys_task' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_task").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.Task.edit&objid={$objid}');
    });
...
}//end class MyWbfsysTask_Crud_Edit_Maintab_View
