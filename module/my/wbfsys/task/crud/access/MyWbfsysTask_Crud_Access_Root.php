 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTask_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysTask_Entity */
      $entity = $orm->get( 'WbfsysTask', $rootId );
    }
...
}//end class MyWbfsysTask_Crud_Access_Root
