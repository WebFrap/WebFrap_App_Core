 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var MyWbfsysTask_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'MyWbfsysTask_Export_Listing_Access';
    ...
    // create a new MyWbfsysTask window
    $view = $this->loadView
    (
    	'export-my_wbfsys_task',
    	'MyWbfsysTask_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'MyWbfsysTask_Export' );
...
} // end class MyWbfsysTask_Export_Controller_Genf
