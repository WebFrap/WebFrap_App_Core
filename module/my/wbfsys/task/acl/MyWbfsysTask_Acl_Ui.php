...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return MyWbfsysTask_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new MyWbfsysTask_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'my_wbfsys_task-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'My Tasks', 'my.wbfsys_task.label' )
      )
    );
    $tabPanel->searchKey  = 'my_wbfsys_task_acl';
