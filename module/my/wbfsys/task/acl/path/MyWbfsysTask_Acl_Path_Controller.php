 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'my_wbfsys_task_acl_graph', 
      'MyWbfsysTask_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'MyWbfsysTask_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'MyWbfsysTask_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view MyWbfsysTask_Acl_Path_Maintab_View  */
...
} // end class MyWbfsysTask_Acl_Path_Controller */
