 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'my/wbfsys_task/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-my_wbfsys_task-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-my_wbfsys_task-acl-path-access_level',
      'class' => 'medium',
...
} // end class MyWbfsysTask_Acl_Path_Maintab_View */
