 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'MyWbfsysTask_Acl_Path' );
    /* @var $query MyWbfsysTask_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('MyWbfsysTask_Acl_Path');
    /* @var $dropQuery MyWbfsysTask_Acl_Path_Query  */
...
} // end class MyWbfsysTask_Acl_Path_Model */
