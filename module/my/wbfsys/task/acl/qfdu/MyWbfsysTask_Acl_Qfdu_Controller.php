 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view MyWbfsysTask_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'my_wbfsys_task-acl-qfdu-aAjax',
      'MyWbfsysTask_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class MyWbfsysTask_Acl_Qfdu_Controller */
