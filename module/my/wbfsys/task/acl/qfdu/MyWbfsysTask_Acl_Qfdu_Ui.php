 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Qfdu_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var MyWbfsysTask_Acl_Qfdu_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyWbfsysTask_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new MyWbfsysTask_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for My Tasks',
        'my.wbfsys_task.label'
      );
      $tabPanel->searchKey  = 'my_wbfsys_task_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new MyWbfsysTask_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class MyWbfsysTask_Acl_Qfdu_Ui */
