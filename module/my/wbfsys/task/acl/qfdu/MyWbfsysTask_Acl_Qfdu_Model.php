 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-my_wbfsys_task')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityMyWbfsysTask = $orm->get('WbfsysTask', $data['wbfsys_group_users']->vid);
      $tabData['my_wbfsys_task_title']  = $refEntityMyWbfsysTask->title;

    }
    $tabData['my_wbfsys_task_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein MyWbfsysTask_Acl_Query Objekt
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyWbfsysTask_Acl_Qfdu_Treetable' );
    /* @var $query MyWbfsysTask_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyWbfsysTask_Acl_Qfdu' );
    /* @var $query MyWbfsysTask_Acl_Qfdu_Query  */
...
} // end class MyWbfsysTask_Acl_Qfdu_Model */
