 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_task.title as "my_wbfsys_task_title"',
      'wbfsys_task.rowid as "my_wbfsys_task_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_task on wbfsys_group_users.vid = wbfsys_task.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_task.title) like upper(\''.$part.'%\') )
...
} // end class MyWbfsysTask_Acl_Qfdu_Treetable_Query_Postgresql */
