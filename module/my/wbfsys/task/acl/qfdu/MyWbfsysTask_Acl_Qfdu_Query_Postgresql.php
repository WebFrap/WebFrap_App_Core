 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_task.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_task.rowid as id,
    wbfsys_task.title as value,
    wbfsys_task.title as label
  FROM
    wbfsys_task
  WHERE
    {$sqlWhere}
...
} // end class MyWbfsysTask_Acl_Qfdu_Query_Postgresql */
