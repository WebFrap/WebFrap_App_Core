...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-my_wbfsys_task' )->getid();
  ...
  public function getEntityAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_task' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialMod->id_area     = $orm->getByKey( 'WbfsysSecurityArea', 'mod-my' );
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_task' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function pushMgmtConfigurationToEntity( $params )
  {
    ...
    $groupQuery   = $db->newQuery( 'MyWbfsysTask_Acl_SyncGroup' );
    /* @var $groupQuery MyWbfsysTask_Acl_SyncGroup_Query  */
    ...
    $assignmentQuery = $db->newQuery( 'MyWbfsysTask_Acl_SyncAssignment' );
    /* @var $assignmentQuery MyWbfsysTask_Acl_SyncAssignment_Query  */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyWbfsysTask_Acl' );
    /* @var $query MyWbfsysTask_Acl_Query  */
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'MyWbfsysTask_Acl_Table' );
    /* @var $query MyWbfsysTask_Acl_Table_Query  */
...
} // end class MyWbfsysTask_Acl_Model */
