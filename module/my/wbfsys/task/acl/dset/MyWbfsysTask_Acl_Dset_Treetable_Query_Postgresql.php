 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(my_wbfsys_task.name) like upper(\''.$condition['free'].'%\') )
...
} // end class MyWbfsysTask_Acl_Dset_Treetable_Query_Postgresql */
