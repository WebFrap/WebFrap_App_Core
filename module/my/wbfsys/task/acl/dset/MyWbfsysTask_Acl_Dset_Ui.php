 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var MyWbfsysTask_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return MyWbfsysTask_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityMyWbfsysTask, $areaId, $access, $params  )
  {

    $listObj = new MyWbfsysTask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-my_wbfsys_task-acl-dset' );
    ...
    else
    {
      ...
      (
        'My Tasks "{@label@}" User Access',
        'my.wbfsys_task.label',
        array
        (
          'label' => $entityMyWbfsysTask->text()
        )
      );
      $tabPanel->searchKey  = 'my_wbfsys_task_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new MyWbfsysTask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class MyWbfsysTask_Acl_Dset_Ui */
