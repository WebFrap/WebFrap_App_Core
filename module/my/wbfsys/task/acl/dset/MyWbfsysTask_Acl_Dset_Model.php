 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-my_wbfsys_task'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyWbfsysTask_Acl_Dset' );
    /* @var $query MyWbfsysTask_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'MyWbfsysTask_Acl_Dset_Treetable' );
    /* @var $query MyWbfsysTask_Acl_Dset_Treetable_Query  */
...
} // end class MyWbfsysTask_Acl_Dset_Model */
