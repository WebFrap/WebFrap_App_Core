 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'MyWbfsysTask_Acl_Dset' );
    ...
    $entityMyWbfsysTask = $this->model->getEntity( $dsetId );
...
} // end class MyWbfsysTask_Acl_Dset_Ajax_View */
