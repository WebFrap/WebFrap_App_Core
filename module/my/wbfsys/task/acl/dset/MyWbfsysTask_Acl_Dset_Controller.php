 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model MyWbfsysTask_Acl_Dset_Model  */
    $model = $this->loadModel( 'MyWbfsysTask_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityMyWbfsysTask = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view MyWbfsysTask_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'my_wbfsys_task-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityMyWbfsysTask, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view MyWbfsysTask_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'my_wbfsys_task-acl-dset', 
    	'MyWbfsysTask_Acl_Dset',
...
} // end class MyWbfsysTask_Acl_Dset_Controller */
