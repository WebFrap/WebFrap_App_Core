 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management MyWbfsysTask
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new MyWbfsysTask_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('MyWbfsysTask_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model MyWbfsysTask_Acl_Model */
    $model   = $this->loadModel( 'MyWbfsysTask_Acl' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'MyWbfsysTask_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'MyWbfsysTask_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model MyWbfsysTask_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'MyWbfsysTask_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model MyWbfsysTask_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'MyWbfsysTask_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'my_wbfsys_task-acl-qfdu',
    	'MyWbfsysTask_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class MyWbfsysTask_Acl_Controller */
