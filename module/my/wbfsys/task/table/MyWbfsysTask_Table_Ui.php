...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für My Tasks
  *
  ...
  *  }
  *
  * @return MyWbfsysTask_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new MyWbfsysTask_Table_Element( 'tableMyWbfsysTask', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-my_wbfsys_task-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'My Tasks', 'my.wbfsys_task.label' );
      //$tabPanel->searchKey = 'my_wbfsys_task';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new MyWbfsysTask_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowMyWbfsysTask', $table->buildAjax() );
...
JSCODE;
   ...
   * die MyWbfsysTask listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityMyWbfsysTask  = $model->getEntityMyWbfsysTask();
    ...
    $formMyWbfsysTask->setKeyName( 'my_wbfsys_task' );
...
}//end class MyWbfsysTask_Table_Ui
