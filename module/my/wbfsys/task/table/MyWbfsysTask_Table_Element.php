 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-my_wbfsys_task';
  
  /**
   * the most likley class of a given query object
   *
   * @var MyWbfsysTask_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=My.WbfsysTask.show&amp;target_mask=MyWbfsysTask&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=My.WbfsysTask.edit&amp;target_mask=MyWbfsysTask&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'my.wbfsys_task.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=My.WbfsysTask_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'my.wbfsys_task.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attachements',
            'modal.php?c=My.WbfsysTask_Ref_Attachments.modal&amp;objid=',
            'control/table.png',
            '',
            'my.wbfsys_task.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=My.WbfsysTask.delete&amp;target_mask=MyWbfsysTask&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'my.wbfsys_task.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Process Status', 'wbfsys.task.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['my_wbfsys_task_rowid'];
      ...
      $body .= '<td valign="top" style="text-align:center;" >'.( trim( $row['my_wbfsys_task_http_url'] ) == '' ? ' ' : '<a target="extern" href="'.Wgt::renderUrl($row['my_wbfsys_task_http_url']).'">'.Validator::sanitizeHtml($row['my_wbfsys_task_http_url']).'</a>' ).'</td>'.NL;

      $body .= '<td valign="top" >
                      <div class="wcm wcm_ui_progress" >'.
                      (
                        !is_null($row['my_wbfsys_task_progress'])
                        ?$row['my_wbfsys_task_progress']
                        :0
                      ).'</div>
                      </td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.TaskType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_task_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=My.WbfsysTask_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected My Tasks." >{$iconDelete} Delete selected My Tasks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! My Tasks. Please confirm that you really want to do that."
      	href="ajax.php?c=My.WbfsysTask_Multi.deleteAll" >{$iconClean} Delete all My Tasks</a></li>
  	</ul>
 	</div>
...
}//end class MyWbfsysTask_Table_Element
