 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var MyWbfsysTask_Table_Model
    */
    public $model = null;

    /**
    * @var MyWbfsysTask_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'my/wbfsys_task/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=My.WbfsysTask.listing&amp;ltype=table'
    );
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'MyWbfsysTask_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=My.WbfsysTask.create&amp;ltype=table');
    });
...
}//end class MyWbfsysTask_Table_Maintab_View
