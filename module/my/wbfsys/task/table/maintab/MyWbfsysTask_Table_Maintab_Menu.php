 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new My Tasks"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-my_wbfsys_task-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-my_wbfsys_task-table-help hidden" >
    	      
<p>This is the My Tasks table.</p>
...
HTML;
  ...
  protected function switchListingType( $params )
  {
    ...
    $html = <<<HTML
  <div class="wgt-panel-control" >
    <div id="wgt-mentry-swlt-my_wbfsys_task" >
      <button 
        id="wgt-mentry-swlt-my_wbfsys_task-table" 
        class="wcm wcm_ui_tip wgtac_view_table wgt-button wgt-active"
        tooltip="Switch to the table view."  >
        {$iconMaTab}
      </button>
      <button 
        id="wgt-mentry-swlt-my_wbfsys_task-treetable" 
...
HTML;
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_task:listing' ) )
      {
...
}//end class MyWbfsysTask_Table_Maintab_Menu
