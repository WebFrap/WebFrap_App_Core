 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['my_wbfsys_task']->id_type )
    {
      $valWbfsysTaskType = $orm->getField
      (
        'WbfsysTaskType',
        'rowid = '.$data['my_wbfsys_task']->id_type,
        'name'
      );
      $tabData['wbfsys_task_type_name'] = $valWbfsysTaskType;
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'MyWbfsysTask_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'MyWbfsysTask_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class MyWbfsysTask_Table_Model
