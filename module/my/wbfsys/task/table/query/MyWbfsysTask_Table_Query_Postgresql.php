 ...
 * @licence WebFrap.net
 */
class MyWbfsysTask_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['my_wbfsys_task_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if( $params->loadFullSize )
      $this->calcQuery = $criteria->count( 'count(DISTINCT wbfsys_task.'.Db::PK.' ) as '.Db::Q_SIZE );
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    {
      $row['acl-level'] = $inKeys[$row['my_wbfsys_task_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function fetchWithAcls( $condition = null, $params = null )
  {
    ...
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys/mgmt-wbfsys_task>mgmt-my_wbfsys_task' );
    }
    else
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys/mgmt-wbfsys_task>mgmt-my_wbfsys_task', true, $params->access->level  );
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_task.rowid as "my_wbfsys_task_rowid"', // variant: def-rowid 
      'wbfsys_task.title as "my_wbfsys_task_title"', // variant: def-by-context 
      'wbfsys_task.http_url as "my_wbfsys_task_http_url"', // variant: def-by-context 
      'wbfsys_task.progress as "my_wbfsys_task_progress"', // variant: def-by-context 
      'wbfsys_task_type.name as "wbfsys_task_type_name"', // variant: def-by-context  used source field wbfsys_task_type
      'wbfsys_task.id_type as "my_wbfsys_task_id_type"', // ref my_wbfsys_task def-by-context 
      'wbfsys_process_node.label as "wbfsys_process_node_label"', // variant: def-by-context  used source field wbfsys_process_node
      'wbfsys_task.id_status as "my_wbfsys_task_id_status"', // ref my_wbfsys_task def-by-context 
  ...
  public function setTables( $criteria   )
  {
    ...
    (
      ...
      null,
      'wbfsys_task_type'
    );// wbfsys_task_type  by alias wbfsys_task_type
 ...
 wbfsys_task.rowid = \''.$part.'\' 
      ...
      // search conditions for  my_wbfsys_task
      if( isset( $condition['my_wbfsys_task'] ) )
      {
        $whereCond = $condition['my_wbfsys_task'];
      ...
      }//end if( isset ($condition['my_wbfsys_task']) )
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
    ...
    else // if not use the default
    {
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_task-title-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_task-title-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_task-title-order"' );
...
}//end class MyWbfsysTask_Table_Query_Postgresql
