...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: my_wbfsys_task
  *
  ...
  *
  *   @url maintab.php?c=My.WbfsysTask.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'my_wbfsys_task-create';

    $access = new MyWbfsysTask_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-my_wbfsys_task-create',
      'MyWbfsysTask_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model MyWbfsysTask_Crud_Model */
    $model = $this->loadModel( 'MyWbfsysTask_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=My.WbfsysTask.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityMyWbfsysTask = $model->getEntityMyWbfsysTask( $objid );
    ...
    $params->entity = $entityMyWbfsysTask;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'my_wbfsys_task:edit';

    $access = new MyWbfsysTask_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityMyWbfsysTask );
    ...
    $view = $response->loadView
    (
      'form-my_wbfsys_task-edit-'.$objid,
      'MyWbfsysTask_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    $params->process_Flow = $process_Flow;
    ...
    $error = $process_Flow->trigger( 'before', $params );
    ...
    if( $error )
    {
      ...
      $process_Flow->trigger( 'fail', $params );
          
    $process_Flow->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'my_wbfsys_task-edit',
          $entityMyWbfsysTask,
          'Edit My Tasks :'.$entityMyWbfsysTask->text()
        );

      
      $process_Flow->trigger( 'after', $params );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-my_wbfsys_task';
      $params->maskRoot      = 'my_wbfsys_task:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-my_wbfsys_task';
      $params->aclNode       = 'mgmt-my_wbfsys_task';
      $params->aclLevel      = 1;
    }
...
$process_Flow->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'my_wbfsys_task-show',
          $entityMyWbfsysTask,
          'Show My Tasks :'.$entityMyWbfsysTask->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: my_wbfsys_task
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=My.WbfsysTask.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-insert';

    $access = new MyWbfsysTask_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
...
$params->process_Flow = $process_Flow;
$process_Flow->setEntity( $model->getEntityMyWbfsysTask() );
...
$process_Flow->call( 'init', 'fail', $params );
    ...
    else
    {
    	...
    	$entityMyWbfsysTask = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'my_wbfsys_task-update-'.$entityMyWbfsysTask;
      ...
      {
        $access = new MyWbfsysTask_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityMyWbfsysTask );
      }
      $params->access = $access;
...
$process_Flow->call( 'init', 'sucess', $params );
      ...
      if( !$params->mask )
        $params->mask = 'MyWbfsysTask';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_my_wbfsys_task',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model MyWbfsysTask_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
...
$process_Flow->call( 'init', 'after', $params );
  ...
  *
  * @call POST ajax.php?c=My.WbfsysTask.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityMyWbfsysTask, $params, $process_Flow ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param MyWbfsysTask_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=My.WbfsysTask.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-delete-'.$objid;

    $access = new MyWbfsysTask_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityMyWbfsysTask );
...
if( $error )
{
  return $error;
    ...
    $error = $model->delete( $entityMyWbfsysTask, $params );
...
$process_Flow->call( 'delete', 'after', $params );
    ...
    $error = $view->displayDelete( $entityMyWbfsysTask, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=My.WbfsysTask.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=My.WbfsysTask.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-listing';
    ...
    $containerClass = 'MyWbfsysTask_'.$listType.'_Access';
    ...
    /* @var $model MyWbfsysTask_Table_Model */
    $model = $this->loadModel( 'MyWbfsysTask_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'my_wbfsys_task-'.$params->ltype,
          'WbfsysTask',
          'List of My Taskss'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  MyWbfsysTask
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new MyWbfsysTask_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_my_wbfsys_task',
      'MyWbfsysTask_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'MyWbfsysTask_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=My.WbfsysTask.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model MyWbfsysTask_Selection_Model */
    $model   = $this->loadModel( 'MyWbfsysTask_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'my_wbfsys_task-data-'.$objid;
    else
      $params->contextKey = 'my_wbfsys_task-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityMyWbfsysTask, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-append-'.$objid;
    ...
    // fetch the data from the http request and load it in the model registry
    // if fails stop here
    if( !$model->fetchUpdateData( $entityMyWbfsysTask, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
    ...
    $ui = $this->loadUi( 'MyWbfsysTask_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new MyWbfsysTask_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'my_wbfsys_task-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'my_wbfsys_task' ); //def my_wbfsys_task
...
} // end class MyWbfsysTask_Controller */
