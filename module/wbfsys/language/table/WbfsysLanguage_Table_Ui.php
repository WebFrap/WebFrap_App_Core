...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Languages
  *
  ...
  *  }
  *
  * @return WbfsysLanguage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysLanguage_Table_Element( 'tableWbfsysLanguage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_language-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Languages', 'wbfsys.language.label' );
      //$tabPanel->searchKey = 'wbfsys_language';
      ...
      $searchElement->searchKey = 'wbfsys_language';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysLanguage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysLanguage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysLanguage listing maske
   *
   * @param WbfsysLanguage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysLanguage  = $model->getEntityWbfsysLanguage();
    ...
    $formWbfsysLanguage->setKeyName( 'wbfsys_language' );
...
}//end class WbfsysLanguage_Table_Ui
