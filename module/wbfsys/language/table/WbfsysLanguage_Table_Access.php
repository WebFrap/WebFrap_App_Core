 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysLanguage_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_language.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_language.rowid ",
      'acls'
    );
...
}//end class WbfsysLanguage_Table_Access
