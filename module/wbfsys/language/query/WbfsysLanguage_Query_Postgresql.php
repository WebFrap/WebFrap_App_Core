 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_language where rowid > 0;
SQL;
  ...
  WHERE
    upper(wbfsys_language.name) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysLanguage_Query_Postgresql
