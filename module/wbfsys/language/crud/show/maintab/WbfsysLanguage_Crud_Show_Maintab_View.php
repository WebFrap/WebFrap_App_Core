 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysLanguage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysLanguage = $this->model->getEntityWbfsysLanguage();
    ...
    (
      ...
      array( 'text' => $entityWbfsysLanguage->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Language.show  &amp;objid='.$entityWbfsysLanguage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Language.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_language-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/language/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysLanguage_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Language.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_language' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_language a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Language.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Language.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysLanguage_Crud_Show_Maintab_View
