 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysLanguage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysLanguage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysLanguage_Entity */
      $entity = $orm->get( 'WbfsysLanguage', $rootId );
    }
...
}//end class WbfsysLanguage_Crud_Access_Root
