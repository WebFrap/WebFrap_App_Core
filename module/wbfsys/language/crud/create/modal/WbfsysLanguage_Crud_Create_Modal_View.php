 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysLanguage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Language.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Language.insert';
    $params->formId       = 'wgt-form-wbfsys_language';
    $params->namespace   = 'wbfsys_language-create';
    ...
    $this->setTemplate( 'wbfsys/language/modal/crud/form_create' );
...
}//end class WbfsysLanguage_Crud_Create_Modal_View
