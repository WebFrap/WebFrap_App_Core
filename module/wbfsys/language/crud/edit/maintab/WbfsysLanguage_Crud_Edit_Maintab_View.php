 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysLanguage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysLanguage = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Language.edit&amp;utf8=✓&amp;objid='.$entityWbfsysLanguage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Language.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_language-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/language/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysLanguage_Crud_Edit' );
...
}//end class WbfsysLanguage_Crud_Edit_Maintab_View
