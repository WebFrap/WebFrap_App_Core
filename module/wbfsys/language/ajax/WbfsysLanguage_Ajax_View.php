 ...
 * @licence WebFrap.net
 */
class WbfsysLanguage_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysLanguage, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysLanguage, $params );
    }
    else
    {
...
}//end class WbfsysLanguage_Ajax_View
