 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_custom_comment';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCustomComment_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CustomComment.show&amp;target_mask=WbfsysCustomComment&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CustomComment.edit&amp;target_mask=WbfsysCustomComment&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.custom_comment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CustomComment.delete&amp;target_mask=WbfsysCustomComment&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.custom_comment.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_custom_comment_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CustomComment_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Custom Comments." >{$iconDelete} Delete selected Custom Comments</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Custom Comments. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CustomComment_Multi.deleteAll" >{$iconClean} Delete all Custom Comments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCustomComment_Table_Element
