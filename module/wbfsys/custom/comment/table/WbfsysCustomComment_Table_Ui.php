 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Custom Comments
  *
  ...
  *  }
  *
  * @return WbfsysCustomComment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCustomComment_Table_Element( 'tableWbfsysCustomComment', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_custom_comment-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Custom Comments', 'wbfsys.custom_comment.label' );
      //$tabPanel->searchKey = 'wbfsys_custom_comment';
      ...
      $searchElement->searchKey = 'wbfsys_custom_comment';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCustomComment_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCustomComment', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCustomComment listing maske
   *
   * @param WbfsysCustomComment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCustomComment  = $model->getEntityWbfsysCustomComment();
    ...
    $formWbfsysCustomComment->setKeyName( 'wbfsys_custom_comment' );
...
}//end class WbfsysCustomComment_Table_Ui
