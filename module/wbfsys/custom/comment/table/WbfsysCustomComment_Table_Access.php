 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCustomComment_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_custom_comment.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_custom_comment.rowid ",
      'acls'
    );
...
}//end class WbfsysCustomComment_Table_Access
