 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCustomComment_'.$listType ) );
...
} // end class WbfsysCustomComment_Listing_Controller */
