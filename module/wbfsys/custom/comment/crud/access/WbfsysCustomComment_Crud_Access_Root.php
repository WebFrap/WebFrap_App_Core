 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCustomComment_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCustomComment_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCustomComment_Entity */
      $entity = $orm->get( 'WbfsysCustomComment', $rootId );
    }
...
}//end class WbfsysCustomComment_Crud_Access_Root
