 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCustomComment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CustomComment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomComment.insert';
    $params->formId       = 'wgt-form-wbfsys_custom_comment';
    $params->namespace   = 'wbfsys_custom_comment-create';
  ...
  $form->setEntityEmbedComment( $this->model->getEntityEmbedComment( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/custom_comment/modal/crud/form_create' );
...
}//end class WbfsysCustomComment_Crud_Create_Modal_View
