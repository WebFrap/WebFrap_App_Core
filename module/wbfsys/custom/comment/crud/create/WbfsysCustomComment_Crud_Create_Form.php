 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_EmbedComment_MParent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysComment_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Comment.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysCustomComment', array_keys( $this->fields['wbfsys_custom_comment']), true ),
...
}//end class WbfsysCustomComment_Crud_Create_Form */
