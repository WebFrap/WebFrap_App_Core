 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCustomComment Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_custom_comment-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/custom_comment/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomComment.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_custom_comment';
    ...
    $form = $this->newForm( 'WbfsysCustomComment_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CustomComment.create');}});
});
...
}//end class WbfsysCustomComment_Crud_Create_Maintab_View
