 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCustomComment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCustomComment = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Custom Comment: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CustomComment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCustomComment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CustomComment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_custom_comment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/custom_comment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCustomComment_Crud_Edit' );
...
}//end class WbfsysCustomComment_Crud_Edit_Maintab_View
