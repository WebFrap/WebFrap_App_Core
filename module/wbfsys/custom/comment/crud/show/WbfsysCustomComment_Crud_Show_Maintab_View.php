 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysCustomComment_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysCustomComment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCustomComment = $this->model->getEntityWbfsysCustomComment();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Custom Comment: {@text@}',
      'wbfsys.custom_comment.label',
      array( 'text' => $entityWbfsysCustomComment->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CustomComment.show  &amp;objid='.$entityWbfsysCustomComment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CustomComment.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_custom_comment-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/custom_comment/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysCustomComment_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.CustomComment.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_custom_comment' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_custom_comment a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.CustomComment.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.CustomComment.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysCustomComment_Crud_Show_Maintab_View
