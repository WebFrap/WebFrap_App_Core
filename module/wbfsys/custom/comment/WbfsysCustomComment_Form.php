 ...
 * @licence WebFrap.net
 */
class WbfsysCustomComment_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_custom_comment';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCustomComment';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCustomComment' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCustomComment entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Custom Comment)', 'wbfsys.custom_comment.label' ),
  ...
  public function input_id_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Custom Comment)', 'wbfsys.custom_comment.label' ),
  ...
  public function input_id_user( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for User (Custom Comment)', 'wbfsys.custom_comment.label' ),
  ...
  * @return void
  */
  public function input_id_comment( $params )
  {

      //tpl: class ui:hidden
      $inputIdComment = $this->view->newInput( 'input'.$this->prefix.'IdComment', 'Hidden' );
      $this->items['id_comment'] = $inputIdComment;
      $inputIdComment->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[id_comment]',
          'id'        => 'wgt-input-'.$this->keyName.'_id_comment'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Comment (Custom Comment)', 'wbfsys.custom_comment.label' ),
          'maxlength' => $this->entity->maxSize( 'id_comment' ),
        )
      );
      $inputIdComment->setWidth( 'medium' );

      $inputIdComment->setReadOnly( $this->isReadOnly( 'id_comment' ) );
  ...
  }//end public function input_id_comment */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Custom Comment)', 'wbfsys.custom_comment.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.custom_comment.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Custom Comment)', 'wbfsys.custom_comment.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.custom_comment.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Custom Comment)', 'wbfsys.custom_comment.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.custom_comment.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Custom Comment)', 'wbfsys.custom_comment.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.custom_comment.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Custom Comment)', 'wbfsys.custom_comment.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.custom_comment.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Custom Comment)', 'wbfsys.custom_comment.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.custom_comment.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Custom Comment)', 'wbfsys.custom_comment.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.custom_comment.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_custom_comment_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_custom_comment_m_role_change';
...
}//end class WbfsysCustomComment_Form */
