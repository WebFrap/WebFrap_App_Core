 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCustomAttachment_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_custom_attachment.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_custom_attachment.rowid ",
      'acls'
    );
...
}//end class WbfsysCustomAttachment_Table_Access
