 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Custom Attachments
  *
  ...
  *  }
  *
  * @return WbfsysCustomAttachment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCustomAttachment_Table_Element( 'tableWbfsysCustomAttachment', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_custom_attachment-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Custom Attachments', 'wbfsys.custom_attachment.label' );
      //$tabPanel->searchKey = 'wbfsys_custom_attachment';
      ...
      $searchElement->searchKey = 'wbfsys_custom_attachment';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCustomAttachment_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCustomAttachment', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCustomAttachment listing maske
   *
   * @param WbfsysCustomAttachment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCustomAttachment  = $model->getEntityWbfsysCustomAttachment();
    ...
    $formWbfsysCustomAttachment->setKeyName( 'wbfsys_custom_attachment' );
...
}//end class WbfsysCustomAttachment_Table_Ui
