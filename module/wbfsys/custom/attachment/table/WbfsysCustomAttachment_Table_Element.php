 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_custom_attachment';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCustomAttachment_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CustomAttachment.show&amp;target_mask=WbfsysCustomAttachment&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CustomAttachment.edit&amp;target_mask=WbfsysCustomAttachment&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.custom_attachment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CustomAttachment.delete&amp;target_mask=WbfsysCustomAttachment&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.custom_attachment.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_custom_attachment_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CustomAttachment_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Custom Attachments." >{$iconDelete} Delete selected Custom Attachments</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Custom Attachments. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CustomAttachment_Multi.deleteAll" >{$iconClean} Delete all Custom Attachments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCustomAttachment_Table_Element
