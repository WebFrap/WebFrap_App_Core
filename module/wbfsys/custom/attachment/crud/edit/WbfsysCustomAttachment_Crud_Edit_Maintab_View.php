 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCustomAttachment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCustomAttachment = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Custom Attachment: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CustomAttachment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCustomAttachment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CustomAttachment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_custom_attachment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/custom_attachment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCustomAttachment_Crud_Edit' );
...
}//end class WbfsysCustomAttachment_Crud_Edit_Maintab_View
