 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCustomAttachment_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCustomAttachment_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCustomAttachment_Entity */
      $entity = $orm->get( 'WbfsysCustomAttachment', $rootId );
    }
...
}//end class WbfsysCustomAttachment_Crud_Access_Root
