 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCustomAttachment Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Custom Attachment',
      'wbfsys.custom_attachment.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Custom Attachment',
      'wbfsys.custom_attachment.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_custom_attachment-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/custom_attachment/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomAttachment.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_custom_attachment';
    ...
    $form = $this->newForm( 'WbfsysCustomAttachment_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CustomAttachment.create');}});
});
...
}//end class WbfsysCustomAttachment_Crud_Create_Maintab_View
