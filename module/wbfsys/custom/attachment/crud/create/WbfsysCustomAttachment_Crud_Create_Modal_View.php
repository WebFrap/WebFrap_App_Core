 ...
 * @licence WebFrap.net
 */
class WbfsysCustomAttachment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCustomAttachment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CustomAttachment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomAttachment.insert';
    $params->formId       = 'wgt-form-wbfsys_custom_attachment';
    $params->namespace   = 'wbfsys_custom_attachment-create';
  ...
  $form->setEntityEntityFile( $this->model->getEntityEntityFile( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/custom_attachment/modal/crud/form_create' );
...
}//end class WbfsysCustomAttachment_Crud_Create_Modal_View
