 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCustomColorScheme entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CustomColorScheme.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomColorScheme.insert';
    $params->formId       = 'wgt-form-wbfsys_custom_color_scheme';
    $params->namespace   = 'wbfsys_custom_color_scheme-create';
    ...
    $this->setTemplate( 'wbfsys/custom_color_scheme/modal/crud/form_create' );
...
}//end class WbfsysCustomColorScheme_Crud_Create_Modal_View
