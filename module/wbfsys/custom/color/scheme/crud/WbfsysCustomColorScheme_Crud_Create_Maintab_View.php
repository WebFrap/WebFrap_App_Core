 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCustomColorScheme Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_custom_color_scheme-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/custom_color_scheme/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomColorScheme.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_custom_color_scheme';
    ...
    $form = $this->newForm( 'WbfsysCustomColorScheme_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CustomColorScheme.create');}});
});
...
}//end class WbfsysCustomColorScheme_Crud_Create_Maintab_View
