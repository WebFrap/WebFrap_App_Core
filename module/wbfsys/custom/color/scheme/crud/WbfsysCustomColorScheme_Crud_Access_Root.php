 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCustomColorScheme_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCustomColorScheme_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCustomColorScheme_Entity */
      $entity = $orm->get( 'WbfsysCustomColorScheme', $rootId );
    }
...
}//end class WbfsysCustomColorScheme_Crud_Access_Root
