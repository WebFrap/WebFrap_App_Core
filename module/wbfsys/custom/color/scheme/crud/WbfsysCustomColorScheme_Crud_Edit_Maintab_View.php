 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCustomColorScheme Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCustomColorScheme = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Custom Color Scheme: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CustomColorScheme.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCustomColorScheme
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CustomColorScheme.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_custom_color_scheme-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/custom_color_scheme/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCustomColorScheme_Crud_Edit' );
...
}//end class WbfsysCustomColorScheme_Crud_Edit_Maintab_View
