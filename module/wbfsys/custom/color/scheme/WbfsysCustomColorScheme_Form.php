 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_custom_color_scheme';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCustomColorScheme';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCustomColorScheme' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCustomColorScheme entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
  ...
  */
  public function input_id_entity( $params )
  {
      ...
      //tpl: class ui:hidden
      $inputIdEntity = $this->view->newInput( 'input'.$this->prefix.'IdEntity', 'Hidden' );
      $this->items['id_entity'] = $inputIdEntity;
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
  ...
  */
  public function input_id_user( $params )
  {
      ...
      //tpl: class ui:hidden
      $inputIdUser = $this->view->newInput( 'input'.$this->prefix.'IdUser', 'Hidden' );
      $this->items['id_user'] = $inputIdUser;
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for User (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysColorScheme_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_scheme'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Scheme (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
      ));
      ...
      $inputIdScheme->setLabel( $this->view->i18n->l( 'Scheme', 'wbfsys.custom_color_scheme.label' ) );
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.custom_color_scheme.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.custom_color_scheme.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.custom_color_scheme.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.custom_color_scheme.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.custom_color_scheme.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.custom_color_scheme.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Custom Color Scheme)', 'wbfsys.custom_color_scheme.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.custom_color_scheme.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_custom_color_scheme_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_custom_color_scheme_m_role_change';
...
}//end class WbfsysCustomColorScheme_Form */
