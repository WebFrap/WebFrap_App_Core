 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Custom Color Schemes
  *
  ...
  *  }
  *
  * @return WbfsysCustomColorScheme_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCustomColorScheme_Table_Element( 'tableWbfsysCustomColorScheme', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_custom_color_scheme-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Custom Color Schemes', 'wbfsys.custom_color_scheme.label' );
      //$tabPanel->searchKey = 'wbfsys_custom_color_scheme';
      ...
      $searchElement->searchKey = 'wbfsys_custom_color_scheme';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCustomColorScheme_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCustomColorScheme', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCustomColorScheme listing maske
   *
   * @param WbfsysCustomColorScheme_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCustomColorScheme  = $model->getEntityWbfsysCustomColorScheme();
    ...
    $formWbfsysCustomColorScheme->setKeyName( 'wbfsys_custom_color_scheme' );
...
}//end class WbfsysCustomColorScheme_Table_Ui
