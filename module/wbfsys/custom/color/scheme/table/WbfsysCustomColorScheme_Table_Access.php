 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCustomColorScheme_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_custom_color_scheme.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_custom_color_scheme.rowid ",
      'acls'
    );
...
}//end class WbfsysCustomColorScheme_Table_Access
