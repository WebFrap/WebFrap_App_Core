 ...
 * @licence WebFrap.net
 */
class WbfsysCustomColorScheme_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_custom_color_scheme';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCustomColorScheme_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CustomColorScheme.show&amp;target_mask=WbfsysCustomColorScheme&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CustomColorScheme.edit&amp;target_mask=WbfsysCustomColorScheme&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.custom_color_scheme.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CustomColorScheme.delete&amp;target_mask=WbfsysCustomColorScheme&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.custom_color_scheme.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_custom_color_scheme_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CustomColorScheme_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Custom Color Schemes." >{$iconDelete} Delete selected Custom Color Schemes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Custom Color Schemes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CustomColorScheme_Multi.deleteAll" >{$iconClean} Delete all Custom Color Schemes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCustomColorScheme_Table_Element
