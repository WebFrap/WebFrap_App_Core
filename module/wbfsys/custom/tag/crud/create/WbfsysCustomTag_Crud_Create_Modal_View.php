 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCustomTag entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CustomTag.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomTag.insert';
    $params->formId       = 'wgt-form-wbfsys_custom_tag';
    $params->namespace   = 'wbfsys_custom_tag-create';
  ...
  $form->setEntityEmbedTag( $this->model->getEntityEmbedTag( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/custom_tag/modal/crud/form_create' );
...
}//end class WbfsysCustomTag_Crud_Create_Modal_View
