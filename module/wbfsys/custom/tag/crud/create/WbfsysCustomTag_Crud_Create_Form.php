 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysCustomTag';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysCustomTag entity
  *
  ...
  */
  public function renderForm( $params = null  )
  {
    ...
    $this->view->addVar( 'entityWbfsysCustomTag', $this->entity );
  $this->view->addVar( 'entityEmbedTag',  $this->entityEmbedTag ) ;
    ...
    if( $this->target )
      ...
      $sendTo = 'wgt-input-wbfsys_custom_tag'.($this->suffix?'-'.$this->suffix:'').'-tostring';
    ...
    (
      array
      (
        'name'  => 'wbfsys_custom_tag[id_wbfsys_custom_tag-tostring]',
        'id'    => $sendTo,
    ...
    $this->input_WbfsysCustomTag_Vid( $params );
    $this->input_WbfsysCustomTag_IdEntity( $params );
    $this->input_WbfsysCustomTag_IdUser( $params );
    $this->input_WbfsysCustomTag_IdTag( $params );
    $this->input_WbfsysCustomTag_Rowid( $params );
    $this->input_WbfsysCustomTag_MTimeCreated( $params );
    $this->input_WbfsysCustomTag_MRoleCreate( $params );
    $this->input_WbfsysCustomTag_MTimeChanged( $params );
    $this->input_WbfsysCustomTag_MRoleChange( $params );
    $this->input_WbfsysCustomTag_MVersion( $params );
    $this->input_WbfsysCustomTag_MUuid( $params );
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_Vid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputVid = $this->view->newInput( 'inputWbfsysCustomTagVid', 'Hidden' );
      $this->items['wbfsys_custom_tag-vid'] = $inputVid;
      $inputVid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[vid]',
          'id'        => 'wgt-input-wbfsys_custom_tag_vid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Vid', 'src' => 'Custom Tag' ) ),
  ...
  }//end public function input_WbfsysCustomTag_Vid */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_IdEntity( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdEntity = $this->view->newInput( 'inputWbfsysCustomTagIdEntity', 'Hidden' );
      $this->items['wbfsys_custom_tag-id_entity'] = $inputIdEntity;
      $inputIdEntity->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[id_entity]',
          'id'        => 'wgt-input-wbfsys_custom_tag_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Entity', 'src' => 'Custom Tag' ) ),
  ...
  }//end public function input_WbfsysCustomTag_IdEntity */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_IdUser( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdUser = $this->view->newInput( 'inputWbfsysCustomTagIdUser', 'Hidden' );
      $this->items['wbfsys_custom_tag-id_user'] = $inputIdUser;
      $inputIdUser->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[id_user]',
          'id'        => 'wgt-input-wbfsys_custom_tag_id_user'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'User', 'src' => 'Custom Tag' ) ),
  ...
  }//end public function input_WbfsysCustomTag_IdUser */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_IdTag( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysTag_Entity' ) )
    {
      ...
      $inputIdTag = $this->view->newInput( 'inputWbfsysCustomTagIdTag', 'Window' );
      $this->items['wbfsys_custom_tag-id_tag'] = $inputIdTag;
      $inputIdTag->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_custom_tag[id_tag]',
        'id'        => 'wgt-input-wbfsys_custom_tag_id_tag'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Tag', 'src' => 'Custom Tag' ) ),
      ));
      ...
      $inputIdTag->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'id_tag' ) );
      $inputIdTag->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'id_tag' ) );
      $inputIdTag->setLabel( $i18n->l( 'Tag', 'wbfsys.custom_tag.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Tag.selection&amp;full_load=true&amp;context=create'
        .'&amp;key_name=embed_tag&amp;suffix='.$this->suffix.'&amp;input=wbfsys_custom_tag_id_tag'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdTag->buildJavascript( 'wgt-input-wbfsys_custom_tag_id_tag'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysCustomTag_IdTag */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_Rowid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputRowid = $this->view->newInput( 'inputWbfsysCustomTagRowid' , 'int' );
      $this->items['wbfsys_custom_tag-rowid'] = $inputRowid;
      $inputRowid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[rowid]',
          'id'        => 'wgt-input-wbfsys_custom_tag_rowid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip wcm_valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Rowid', 'src' => 'Custom Tag' ) ),
        )
      );
      $inputRowid->setWidth( 'medium' );

      $inputRowid->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'rowid' ) );
      $inputRowid->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'rowid' ) );
      $inputRowid->setData( $this->entity->getId() );
      $inputRowid->setLabel( $i18n->l( 'Rowid', 'wbfsys.custom_tag.label' ) );
  ...
  }//end public function input_WbfsysCustomTag_Rowid */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MTimeCreated( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeCreated = $this->view->newInput( 'inputWbfsysCustomTagMTimeCreated' , 'Date' );
      $this->items['wbfsys_custom_tag-m_time_created'] = $inputMTimeCreated;
      $inputMTimeCreated->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[m_time_created]',
          'id'        => 'wgt-input-wbfsys_custom_tag_m_time_created'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Time Created', 'src' => 'Custom Tag' ) ),
          'maxlength' => $this->entity->maxSize( 'm_time_created' ),
        )
      );
      $inputMTimeCreated->setWidth( 'small' );

      $inputMTimeCreated->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_time_created' ) );
      $inputMTimeCreated->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_time_created' ) );
      $inputMTimeCreated->setData( $this->entity->getDate( 'm_time_created' ) );
      $inputMTimeCreated->setLabel( $i18n->l( 'Time Created', 'wbfsys.custom_tag.label' ) );
  ...
  }//end public function input_WbfsysCustomTag_MTimeCreated */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MRoleCreate( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleCreate = $this->view->newInput( 'inputWbfsysCustomTagMRoleCreate', 'Window' );
      $this->items['wbfsys_custom_tag-m_role_create'] = $inputMRoleCreate;
      $inputMRoleCreate->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_custom_tag[m_role_create]',
        'id'        => 'wgt-input-wbfsys_custom_tag_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Role Create', 'src' => 'Custom Tag' ) ),
      ));
      ...
      $inputMRoleCreate->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_role_create' ) );
      $inputMRoleCreate->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_role_create' ) );
      $inputMRoleCreate->setLabel( $i18n->l( 'Role Create', 'wbfsys.custom_tag.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_custom_tag_m_role_create'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleCreate->buildJavascript( 'wgt-input-wbfsys_custom_tag_m_role_create'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysCustomTag_MRoleCreate */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MTimeChanged( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeChanged = $this->view->newInput( 'inputWbfsysCustomTagMTimeChanged' , 'Date' );
      $this->items['wbfsys_custom_tag-m_time_changed'] = $inputMTimeChanged;
      $inputMTimeChanged->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[m_time_changed]',
          'id'        => 'wgt-input-wbfsys_custom_tag_m_time_changed'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Time Changed', 'src' => 'Custom Tag' ) ),
          'maxlength' => $this->entity->maxSize( 'm_time_changed' ),
        )
      );
      $inputMTimeChanged->setWidth( 'small' );

      $inputMTimeChanged->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_time_changed' ) );
      $inputMTimeChanged->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_time_changed' ) );
      $inputMTimeChanged->setData( $this->entity->getDate( 'm_time_changed' ) );
      $inputMTimeChanged->setLabel( $i18n->l( 'Time Changed', 'wbfsys.custom_tag.label' ) );
  ...
  }//end public function input_WbfsysCustomTag_MTimeChanged */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MRoleChange( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleChange = $this->view->newInput( 'inputWbfsysCustomTagMRoleChange', 'Window' );
      $this->items['wbfsys_custom_tag-m_role_change'] = $inputMRoleChange;
      $inputMRoleChange->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_custom_tag[m_role_change]',
        'id'        => 'wgt-input-wbfsys_custom_tag_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Role Change', 'src' => 'Custom Tag' ) ),
      ));
      ...
      $inputMRoleChange->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_role_change' ) );
      $inputMRoleChange->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_role_change' ) );
      $inputMRoleChange->setLabel( $i18n->l( 'Role Change', 'wbfsys.custom_tag.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_custom_tag_m_role_change'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleChange->buildJavascript( 'wgt-input-wbfsys_custom_tag_m_role_change'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysCustomTag_MRoleChange */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MVersion( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMVersion = $this->view->newInput( 'inputWbfsysCustomTagMVersion' , 'int' );
      $this->items['wbfsys_custom_tag-m_version'] = $inputMVersion;
      $inputMVersion->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[m_version]',
          'id'        => 'wgt-input-wbfsys_custom_tag_m_version'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip wcm_valid_int medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Version', 'src' => 'Custom Tag' ) ),
        )
      );
      $inputMVersion->setWidth( 'medium' );

      $inputMVersion->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_version' ) );
      $inputMVersion->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_version' ) );
      $inputMVersion->setData( $this->entity->getSecure( 'm_version' ) );
      $inputMVersion->setLabel( $i18n->l( 'Version', 'wbfsys.custom_tag.label' ) );
  ...
  }//end public function input_WbfsysCustomTag_MVersion */
  ...
  * @return void
  */
  public function input_WbfsysCustomTag_MUuid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMUuid = $this->view->newInput( 'inputWbfsysCustomTagMUuid' , 'Text' );
      $this->items['wbfsys_custom_tag-m_uuid'] = $inputMUuid;
      $inputMUuid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_custom_tag[m_uuid]',
          'id'        => 'wgt-input-wbfsys_custom_tag_m_uuid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Uuid', 'src' => 'Custom Tag' ) ),
        )
      );
      $inputMUuid->setWidth( 'medium' );

      $inputMUuid->setReadonly( $this->fieldReadOnly( 'wbfsys_custom_tag', 'm_uuid' ) );
      $inputMUuid->setRequired( $this->fieldRequired( 'wbfsys_custom_tag', 'm_uuid' ) );
      $inputMUuid->setData( $this->entity->getSecure( 'm_uuid' ) );
      $inputMUuid->setLabel( $i18n->l( 'Uuid', 'wbfsys.custom_tag.label' ) );
  ...
  }//end public function input_WbfsysCustomTag_MUuid */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysCustomTag', array_keys( $this->fields['wbfsys_custom_tag']), true ),
    ...
    // Extrahieren der Daten für die embed_tag Referenz
    $filterEmbedTag = $request->checkFormInput
    (
      $orm->getValidationData( 'WbfsysTag', array_keys( $this->fields['embed_tag'] ), true ),
      $orm->getErrorMessages( 'WbfsysTag' ),
      'embed_tag'
    );
    
    $tmpEmbedTag  = $filterEmbedTag->getData();
    $dataEmbedTag = array();
    
    // es werden nur daten gesetzt die tatsächlich übergeben wurden, sonst
    // würden default werte in den entities überschrieben werden
    foreach( $tmpEmbedTag as $key => $value   )
    {
      if( !is_null( $value ) )
        $dataEmbedTag[$key] = $value;
    }

    $this->entityEmbedTag->addData( $dataEmbedTag );
...
}//end class WbfsysCustomTag_Crud_Create_Form */
