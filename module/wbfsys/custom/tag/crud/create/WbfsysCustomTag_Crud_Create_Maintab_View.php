 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCustomTag Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_custom_tag-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/custom_tag/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CustomTag.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_custom_tag';
    ...
    $form = $this->newForm( 'WbfsysCustomTag_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CustomTag.create');}});
});
...
}//end class WbfsysCustomTag_Crud_Create_Maintab_View
