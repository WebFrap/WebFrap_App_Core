 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCustomTag Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCustomTag = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Custom Tag: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CustomTag.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCustomTag
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CustomTag.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_custom_tag-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/custom_tag/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCustomTag_Crud_Edit' );
...
}//end class WbfsysCustomTag_Crud_Edit_Maintab_View
