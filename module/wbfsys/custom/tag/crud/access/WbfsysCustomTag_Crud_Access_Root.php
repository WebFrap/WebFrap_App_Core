 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCustomTag_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCustomTag_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCustomTag_Entity */
      $entity = $orm->get( 'WbfsysCustomTag', $rootId );
    }
...
}//end class WbfsysCustomTag_Crud_Access_Root
