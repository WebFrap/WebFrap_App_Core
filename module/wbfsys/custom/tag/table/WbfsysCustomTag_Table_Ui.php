 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Custom Tags
  *
  ...
  *  }
  *
  * @return WbfsysCustomTag_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCustomTag_Table_Element( 'tableWbfsysCustomTag', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_custom_tag-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Custom Tags', 'wbfsys.custom_tag.label' );
      //$tabPanel->searchKey = 'wbfsys_custom_tag';
      ...
      $searchElement->searchKey = 'wbfsys_custom_tag';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCustomTag_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCustomTag', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCustomTag listing maske
   *
   * @param WbfsysCustomTag_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCustomTag  = $model->getEntityWbfsysCustomTag();
    ...
    $formWbfsysCustomTag->setKeyName( 'wbfsys_custom_tag' );
...
}//end class WbfsysCustomTag_Table_Ui
