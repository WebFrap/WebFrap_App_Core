 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCustomTag_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_custom_tag.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_custom_tag.rowid ",
      'acls'
    );
...
}//end class WbfsysCustomTag_Table_Access
