 ...
 * @licence WebFrap.net
 */
class WbfsysCustomTag_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_custom_tag';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCustomTag_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CustomTag.show&amp;target_mask=WbfsysCustomTag&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CustomTag.edit&amp;target_mask=WbfsysCustomTag&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.custom_tag.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CustomTag.delete&amp;target_mask=WbfsysCustomTag&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.custom_tag.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.tag.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_custom_tag_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.CustomTag.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_tag_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CustomTag_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Custom Tags." >{$iconDelete} Delete selected Custom Tags</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Custom Tags. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CustomTag_Multi.deleteAll" >{$iconClean} Delete all Custom Tags</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCustomTag_Table_Element
