 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_content_licence';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysContentLicence';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysContentLicence' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysContentLicence entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Content Licence)', 'wbfsys.content_licence.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.content_licence.label' ),
  ...
  * @return void
  */
  public function input_shortname( $params )
  {

      //tpl: class ui:text
      $inputShortname = $this->view->newInput( 'input'.$this->prefix.'Shortname' , 'Text' );
      $this->items['shortname'] = $inputShortname;
      $inputShortname->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[shortname]',
          'id'        => 'wgt-input-'.$this->keyName.'_shortname'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Shortname (Content Licence)', 'wbfsys.content_licence.label' ),
          'maxlength' => $this->entity->maxSize( 'shortname' ),
        )
      );
      $inputShortname->setWidth( 'medium' );

      $inputShortname->setReadOnly( $this->isReadOnly( 'shortname' ) );
      $inputShortname->setData( $this->entity->getSecure('shortname') );
      $inputShortname->setLabel
      (
        $this->view->i18n->l( 'Shortname', 'wbfsys.content_licence.label' ),
        $this->entity->required( 'shortname' )
      );
  ...
  }//end public function input_shortname */
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Content Licence)', 'wbfsys.content_licence.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.content_licence.label' ),
  ...
  */
  public function input_content( $params )
  {
      ...
      //p: textarea
      $inputContent = $this->view->newInput( 'input'.$this->prefix.'Content', 'Wysiwyg' );
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Content (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Content', 'wbfsys.content_licence.label' ),
  ...
  */
  public function input_description( $params )
  {
      ...
      //p: textarea
      $inputDescription = $this->view->newInput( 'input'.$this->prefix.'Description', 'Wysiwyg' );
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.content_licence.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.content_licence.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Content Licence)', 'wbfsys.content_licence.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.content_licence.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Content Licence)', 'wbfsys.content_licence.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.content_licence.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Content Licence)', 'wbfsys.content_licence.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.content_licence.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Content Licence)', 'wbfsys.content_licence.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.content_licence.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.content_licence.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.content_licence.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Content Licence)', 'wbfsys.content_licence.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
 ...
 /**
  * create the search element for field shortname
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_shortname( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_shortname'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Shortname (Content Licence)', 'wbfsys.content_licence.label' ),
          'maxlength' => $this->entity->maxSize( 'shortname' ),
        )
      );
      $inputShortname->setWidth( 'medium' );
  ...
  }//end public function search_shortname */
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_access_key'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Access Key (Content Licence)', 'wbfsys.content_licence.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_content( $params )
  {
      ...
      $inputContent = $this->view->newInput( 'input'.$this->prefix.'Content' , 'Text' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Content (Content Licence)', 'wbfsys.content_licence.label' ),
        )
      );
      $inputContent->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_content_licence_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_content_licence_m_role_change';
...
}//end class WbfsysContentLicence_Form */
