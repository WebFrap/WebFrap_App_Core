 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysContentLicence_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_content_licence.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_content_licence.rowid ",
      'acls'
    );
...
}//end class WbfsysContentLicence_Table_Access
