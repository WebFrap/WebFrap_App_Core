 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_content_licence';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysContentLicence_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ContentLicence.show&amp;target_mask=WbfsysContentLicence&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ContentLicence.edit&amp;target_mask=WbfsysContentLicence&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.content_licence.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ContentLicence.delete&amp;target_mask=WbfsysContentLicence&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.content_licence.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.content_licence.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Shortname', 'wbfsys.content_licence.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.content_licence.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.content_licence.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_content_licence_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ContentLicence.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_content_licence_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_content_licence_shortname'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_content_licence_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" >'.$row['wbfsys_content_licence_description'].'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ContentLicence_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Content Licences." >{$iconDelete} Delete selected Content Licences</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Content Licences. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ContentLicence_Multi.deleteAll" >{$iconClean} Delete all Content Licences</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysContentLicence_Table_Element
