 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Content Licences
  *
  ...
  *  }
  *
  * @return WbfsysContentLicence_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysContentLicence_Table_Element( 'tableWbfsysContentLicence', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_content_licence-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Content Licences', 'wbfsys.content_licence.label' );
      //$tabPanel->searchKey = 'wbfsys_content_licence';
      ...
      $searchElement->searchKey = 'wbfsys_content_licence';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysContentLicence_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysContentLicence', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysContentLicence listing maske
   *
   * @param WbfsysContentLicence_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysContentLicence  = $model->getEntityWbfsysContentLicence();
    ...
    $formWbfsysContentLicence->setKeyName( 'wbfsys_content_licence' );
...
}//end class WbfsysContentLicence_Table_Ui
