 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysContentLicence entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ContentLicence.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ContentLicence.insert';
    $params->formId       = 'wgt-form-wbfsys_content_licence';
    $params->namespace   = 'wbfsys_content_licence-create';
    ...
    $this->setTemplate( 'wbfsys/content_licence/modal/crud/form_create' );
...
}//end class WbfsysContentLicence_Crud_Create_Modal_View
