 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysContentLicence Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_content_licence-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/content_licence/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ContentLicence.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_content_licence';
    ...
    $form = $this->newForm( 'WbfsysContentLicence_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ContentLicence.create');}});
});
...
}//end class WbfsysContentLicence_Crud_Create_Maintab_View
