 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysContentLicence_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysContentLicence_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysContentLicence_Entity */
      $entity = $orm->get( 'WbfsysContentLicence', $rootId );
    }
...
}//end class WbfsysContentLicence_Crud_Access_Root
