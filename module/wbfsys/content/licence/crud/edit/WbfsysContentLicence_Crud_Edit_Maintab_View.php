 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysContentLicence Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysContentLicence = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Content Licence: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ContentLicence.edit&amp;utf8=✓&amp;objid='.$entityWbfsysContentLicence
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ContentLicence.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_content_licence-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/content_licence/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysContentLicence_Crud_Edit' );
...
}//end class WbfsysContentLicence_Crud_Edit_Maintab_View
