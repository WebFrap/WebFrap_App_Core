 ...
 * @licence WebFrap.net
 */
class WbfsysContentLicence_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysContentLicence_'.$listType ) );
...
} // end class WbfsysContentLicence_Listing_Controller */
