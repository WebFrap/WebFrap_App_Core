 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDomainAlias Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDomainAlias = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Domain Alias: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DomainAlias.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDomainAlias
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DomainAlias.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_domain_alias-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/domain_alias/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDomainAlias_Crud_Edit' );
...
}//end class WbfsysDomainAlias_Crud_Edit_Maintab_View
