 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDomainAlias Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_domain_alias-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/domain_alias/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DomainAlias.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_domain_alias';
    ...
    $form = $this->newForm( 'WbfsysDomainAlias_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.DomainAlias.create');}});
});
...
}//end class WbfsysDomainAlias_Crud_Create_Maintab_View
