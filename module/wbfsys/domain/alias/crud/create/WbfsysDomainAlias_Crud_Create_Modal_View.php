 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDomainAlias entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DomainAlias.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DomainAlias.insert';
    $params->formId       = 'wgt-form-wbfsys_domain_alias';
    $params->namespace   = 'wbfsys_domain_alias-create';
    ...
    $this->setTemplate( 'wbfsys/domain_alias/modal/crud/form_create' );
...
}//end class WbfsysDomainAlias_Crud_Create_Modal_View
