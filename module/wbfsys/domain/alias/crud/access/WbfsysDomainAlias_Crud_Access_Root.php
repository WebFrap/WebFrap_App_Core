 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDomainAlias_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDomainAlias_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDomainAlias_Entity */
      $entity = $orm->get( 'WbfsysDomainAlias', $rootId );
    }
...
}//end class WbfsysDomainAlias_Crud_Access_Root
