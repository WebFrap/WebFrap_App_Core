 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Domain Alias
  *
  ...
  *  }
  *
  * @return WbfsysDomainAlias_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDomainAlias_Table_Element( 'tableWbfsysDomainAlias', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_domain_alias-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Domain Alias', 'wbfsys.domain_alias.label' );
      //$tabPanel->searchKey = 'wbfsys_domain_alias';
      ...
      $searchElement->searchKey = 'wbfsys_domain_alias';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDomainAlias_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDomainAlias', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDomainAlias listing maske
   *
   * @param WbfsysDomainAlias_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDomainAlias  = $model->getEntityWbfsysDomainAlias();
    ...
    $formWbfsysDomainAlias->setKeyName( 'wbfsys_domain_alias' );
...
}//end class WbfsysDomainAlias_Table_Ui
