 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysDomainAlias_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysDomainAlias_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysDomainAlias_Table_Model
