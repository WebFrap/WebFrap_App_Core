 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_domain_alias';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDomainAlias_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DomainAlias.show&amp;target_mask=WbfsysDomainAlias&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DomainAlias.edit&amp;target_mask=WbfsysDomainAlias&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.domain_alias.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DomainAlias.delete&amp;target_mask=WbfsysDomainAlias&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.domain_alias.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Address', 'wbfsys.domain_alias.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Destination', 'wbfsys.domain_alias.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_domain_alias_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.DomainAlias.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_alias_address'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.DomainAlias.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_alias_destination'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DomainAlias_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Domain Alias." >{$iconDelete} Delete selected Domain Alias</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Domain Alias. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DomainAlias_Multi.deleteAll" >{$iconClean} Delete all Domain Alias</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDomainAlias_Table_Element
