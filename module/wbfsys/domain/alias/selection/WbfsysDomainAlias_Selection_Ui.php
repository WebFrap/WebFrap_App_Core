 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDomainAlias_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDomainAlias_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDomainAlias_Selection_Element
    (
      'selectionWbfsysDomainAlias',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Domain Alias', 'wbfsys.domain_alias.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DomainAlias.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDomainAlias',
      'WbfsysDomainAlias_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDomainAlias_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDomainAlias_Selection_Ui
