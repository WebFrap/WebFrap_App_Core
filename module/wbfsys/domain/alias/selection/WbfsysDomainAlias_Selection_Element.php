 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_domain_alias';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DomainAlias.show&amp;target_mask=WbfsysDomainAlias&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DomainAlias.edit&amp;target_mask=WbfsysDomainAlias&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.domain_alias.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DomainAlias.delete&amp;target_mask=WbfsysDomainAlias&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.domain_alias.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_alias_address'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_alias_destination'])).'</td>'.NL;
...
}//end class WbfsysDomainAlias_Selection_Element
