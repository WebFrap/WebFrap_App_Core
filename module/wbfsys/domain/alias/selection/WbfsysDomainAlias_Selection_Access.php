 ...
 * @licence WebFrap.net
 */
class WbfsysDomainAlias_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDomainAlias_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_domain_alias.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_domain_alias.rowid ",
      'acls'
    );
...
}//end class WbfsysDomainAlias_Selection_Access
