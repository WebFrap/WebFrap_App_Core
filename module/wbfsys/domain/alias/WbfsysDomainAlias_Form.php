...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_domain_alias';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDomainAlias';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDomainAlias' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDomainAlias entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
// field methodes
////////////////////////////////////////////////////////////////////////////////
    /// windowref to nonexisting wbfsys_mailmanagement_domain_data in LibGenfTreeRootEntity
 /**
  ...
  */
  public function input_address( $params )
  {
      ...
      //tpl: class ui:text
      $inputAddress = $this->view->newInput( 'input'.$this->prefix.'Address' , 'Text' );
      $this->items['address'] = $inputAddress;
      $inputAddress->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[address]',
          'id'        => 'wgt-input-'.$this->keyName.'_address'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Address (Domain Alias)', 'wbfsys.domain_alias.label' ),
          'maxlength' => $this->entity->maxSize( 'address' ),
        )
      );
      $inputAddress->setWidth( 'medium' );

      $inputAddress->setReadOnly( $this->isReadOnly( 'address' ) );
      $inputAddress->setData( $this->entity->getSecure('address') );
      $inputAddress->setLabel
      (
        $this->view->i18n->l( 'Address', 'wbfsys.domain_alias.label' ),
        $this->entity->required( 'address' )
      );
  ...
  }//end public function input_address */
  ...
  * @return void
  */
  public function input_destination( $params )
  {

      //tpl: class ui:text
      $inputDestination = $this->view->newInput( 'input'.$this->prefix.'Destination' , 'Text' );
      $this->items['destination'] = $inputDestination;
      $inputDestination->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[destination]',
          'id'        => 'wgt-input-'.$this->keyName.'_destination'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Destination (Domain Alias)', 'wbfsys.domain_alias.label' ),
          'maxlength' => $this->entity->maxSize( 'destination' ),
        )
      );
      $inputDestination->setWidth( 'medium' );

      $inputDestination->setReadOnly( $this->isReadOnly( 'destination' ) );
      $inputDestination->setData( $this->entity->getSecure('destination') );
      $inputDestination->setLabel
      (
        $this->view->i18n->l( 'Destination', 'wbfsys.domain_alias.label' ),
        $this->entity->required( 'destination' )
      );
  ...
  }//end public function input_destination */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Domain Alias)', 'wbfsys.domain_alias.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.domain_alias.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Domain Alias)', 'wbfsys.domain_alias.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.domain_alias.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Domain Alias)', 'wbfsys.domain_alias.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.domain_alias.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Domain Alias)', 'wbfsys.domain_alias.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.domain_alias.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Domain Alias)', 'wbfsys.domain_alias.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.domain_alias.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Domain Alias)', 'wbfsys.domain_alias.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.domain_alias.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Domain Alias)', 'wbfsys.domain_alias.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.domain_alias.label' ),
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the search element for field address
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_address( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Address (Domain Alias)', 'wbfsys.domain_alias.label' ),
          'maxlength' => $this->entity->maxSize( 'address' ),
        )
      );
      $inputAddress->setWidth( 'medium' );
  ...
  }//end public function search_address */

 /**
  * create the search element for field destination
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_destination( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_destination'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Destination (Domain Alias)', 'wbfsys.domain_alias.label' ),
          'maxlength' => $this->entity->maxSize( 'destination' ),
        )
      );
      $inputDestination->setWidth( 'medium' );
  ...
  }//end public function search_destination */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_domain_alias_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_domain_alias_m_role_change';
...
}//end class WbfsysDomainAlias_Form */
