 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_domain';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDomain_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Domain.show&amp;target_mask=WbfsysDomain&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.domain.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Domain.edit&amp;target_mask=WbfsysDomain&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.domain.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Subdomains',
            'modal.php?c=Wbfsys.Domain_Ref_Subdomain.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.domain.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Domain.delete&amp;target_mask=WbfsysDomain&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.domain.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.domain.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Domain.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Domain_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Domains." >{$iconDelete} Delete selected Domains</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Domains. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Domain_Multi.deleteAll" >{$iconClean} Delete all Domains</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDomain_Table_Element
