 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysDomain_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysDomain_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysDomain_Table_Model
