...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Domains
  *
  ...
  *  }
  *
  * @return WbfsysDomain_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDomain_Table_Element( 'tableWbfsysDomain', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_domain-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Domains', 'wbfsys.domain.label' );
      ...
      $searchElement->searchKey = 'wbfsys_domain';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDomain_Table_Element( null,$view );
...
}//end class WbfsysDomain_Table_Ui
