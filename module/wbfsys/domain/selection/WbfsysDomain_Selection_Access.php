 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDomain_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_domain.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_domain.rowid ",
      'acls'
    );
...
}//end class WbfsysDomain_Selection_Access
