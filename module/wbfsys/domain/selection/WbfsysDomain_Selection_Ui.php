 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDomain_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDomain_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDomain_Selection_Element
    (
      'selectionWbfsysDomain',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Domains', 'wbfsys.domain.label' ) ;
      $tabPanel->searchKey = 'wbfsys_domain';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Domain.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysDomain',
      'WbfsysDomain_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDomain' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysDomain listing maske
   *
   * @param WbfsysDomain_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDomain  = $model->getEntityWbfsysDomain();
    ...
    $formWbfsysDomain->setKeyName( 'wbfsys_domain' );
...
}//end class WbfsysDomain_Selection_Ui
