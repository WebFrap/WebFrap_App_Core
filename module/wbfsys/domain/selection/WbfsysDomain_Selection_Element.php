 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_domain';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Domain.show&amp;target_mask=WbfsysDomain&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.domain.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Domain.edit&amp;target_mask=WbfsysDomain&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.domain.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Domain.delete&amp;target_mask=WbfsysDomain&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.domain.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_domain_name'])).'</td>'.NL;
...
}//end class WbfsysDomain_Selection_Element
