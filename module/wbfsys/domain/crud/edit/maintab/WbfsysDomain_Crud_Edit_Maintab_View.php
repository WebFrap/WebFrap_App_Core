 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDomain Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDomain = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Domain.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDomain
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Domain.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_domain-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/domain/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDomain_Crud_Edit' );
...
}//end class WbfsysDomain_Crud_Edit_Maintab_View
