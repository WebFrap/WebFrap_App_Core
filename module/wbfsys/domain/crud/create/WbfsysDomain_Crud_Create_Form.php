 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDomain', array_keys( $this->fields['wbfsys_domain']), true ),
...
}//end class WbfsysDomain_Crud_Create_Form */
