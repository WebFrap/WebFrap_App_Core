 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDomain entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Domain.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Domain.insert';
    $params->formId       = 'wgt-form-wbfsys_domain';
    $params->namespace   = 'wbfsys_domain-create';
    ...
    $this->setTemplate( 'wbfsys/domain/modal/crud/form_create' );
...
}//end class WbfsysDomain_Crud_Create_Modal_View
