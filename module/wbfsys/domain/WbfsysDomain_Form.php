...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDomain';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDomain' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDomain entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Domain)', 'wbfsys.domain.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.domain.label' ),
...
/// windowref to nonexisting cms_project in LibGenfTreeRootEntity
 /**
  * create the ui element for field id_owner
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_owner( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CorePerson_Entity' ) )
    {
      ...
      $inputIdOwner = $this->view->newInput( 'input'.$this->prefix.'IdOwner', 'Window' );
      $inputIdOwner->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_owner]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_owner'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Owner (Domain)', 'wbfsys.domain.label' ),
      ));
      ...
      $inputIdOwner->setReadOnly( $this->isReadOnly( 'id_owner' ) );
      $inputIdOwner->setLabel( $this->view->i18n->l( 'Owner', 'wbfsys.domain.label' ) );


      $listUrl = 'modal.php?c=Core.Person.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_owner'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdOwner->buildJavascript( 'wgt-input-'.$this->keyName.'_id_owner'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_owner */
/// windowref to nonexisting enterprise_customer in LibGenfTreeRootEntity
 /**
  * create the ui element for field id_techc
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_techc( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CorePerson_Entity' ) )
    {
      ...
      $inputIdTechc = $this->view->newInput( 'input'.$this->prefix.'IdTechc', 'Window' );
      $inputIdTechc->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_techc]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_techc'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Techc (Domain)', 'wbfsys.domain.label' ),
      ));
      ...
      $inputIdTechc->setReadOnly( $this->isReadOnly( 'id_techc' ) );
      $inputIdTechc->setLabel( $this->view->i18n->l( 'Techc', 'wbfsys.domain.label' ) );


      $listUrl = 'modal.php?c=Core.Person.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_techc'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdTechc->buildJavascript( 'wgt-input-'.$this->keyName.'_id_techc'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_techc */
  ...
  * @return void
  */
  public function input_id_adminc( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CorePerson_Entity' ) )
    {
      ...
      $inputIdAdminc = $this->view->newInput( 'input'.$this->prefix.'IdAdminc', 'Window' );
      $inputIdAdminc->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_adminc]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_adminc'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Adminc (Domain)', 'wbfsys.domain.label' ),
      ));
      ...
      $inputIdAdminc->setReadOnly( $this->isReadOnly( 'id_adminc' ) );
      $inputIdAdminc->setLabel( $this->view->i18n->l( 'Adminc', 'wbfsys.domain.label' ) );


      $listUrl = 'modal.php?c=Core.Person.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_adminc'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAdminc->buildJavascript( 'wgt-input-'.$this->keyName.'_id_adminc'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_adminc */
/// windowref to nonexisting hosting_provider in LibGenfTreeRootEntity/// windowref to nonexisting hosting_service in LibGenfTreeRootEntity/// windowref to nonexisting hosting_service in LibGenfTreeRootEntity/// windowref to nonexisting hosting_dns_zone in LibGenfTreeRootEntity
 /**
  * create the ui element for field is_primary
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_is_primary( $params )
  {

      //tpl: class ui:Checkbox
      $inputIsPrimary = $this->view->newInput( 'input'.$this->prefix.'IsPrimary' , 'Checkbox' );
      $this->items['is_primary'] = $inputIsPrimary;
      $inputIsPrimary->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[is_primary]',
          'id'        => 'wgt-input-'.$this->keyName.'_is_primary'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Is Primary (Domain)', 'wbfsys.domain.label' ),
        )
      );
      $inputIsPrimary->setWidth( 'medium' );

      $inputIsPrimary->setReadOnly( $this->isReadOnly( 'is_primary' ) );
      $inputIsPrimary->setActive( $this->entity->getBoolean( 'is_primary' ) );
      $inputIsPrimary->setLabel
      (
        $this->view->i18n->l( 'Is Primary', 'wbfsys.domain.label' ),
        $this->entity->required( 'is_primary' )
      );
  ...
  }//end public function input_is_primary */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Domain)', 'wbfsys.domain.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.domain.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Domain)', 'wbfsys.domain.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.domain.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Domain)', 'wbfsys.domain.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.domain.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Domain)', 'wbfsys.domain.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.domain.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Domain)', 'wbfsys.domain.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.domain.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Domain)', 'wbfsys.domain.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.domain.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Domain)', 'wbfsys.domain.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.domain.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Domain)', 'wbfsys.domain.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.domain.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Domain)', 'wbfsys.domain.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_domain_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_domain_m_role_change';
