 ...
 * If you want to extend this class write your coden in ControllerWbfsysDomain
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Ref_Subdomain_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des subdomain Referenztabs
  * für den wbfsys_domain management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysDomain_Ref_Subdomain_".$listType."_Access";
    ...
    $accessSubdomain = new $containerClass( );
    $accessSubdomain->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-subdomain';

    $params->accessSubdomain = $accessSubdomain;
    $params->paramsSubdomain = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessSubdomain->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_domain-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysDomain_Ref_Subdomain_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelSubdomain = $this->loadModel
    (
      'WbfsysDomain_Ref_Subdomain_'.$listType
    );
    $modelSubdomain->setAccess( $accessSubdomain );
    
    $view->setModel( $modelSubdomain );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdSubdomain = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysDomain_Ref_Subdomain_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_domain-ref-subdomain-'.$listType.'-ajax',
    	'WbfsysDomain_Ref_Subdomain_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a HostingSubdomain by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'hosting_subdomain' ); //def hosting_subdomain


  } // end public function cleanPost */

} // end WbfsysDomain_Ref_Subdomain_Controller
