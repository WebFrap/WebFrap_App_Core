 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Ref_Subdomain_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: hosting_subdomain Attributes: rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-subdomain',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-subdomain' );
  ...
  /**
   * @param WbfsysDomain_Ref_Subdomain_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'hosting_subdomain.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-hosting'), UPPER('mgmt-hosting_subdomain') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = hosting_subdomain.rowid ",
      'acls'
    );
...
}//end class WbfsysDomain_Ref_Subdomain_Table_Access
