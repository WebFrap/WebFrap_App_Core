 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Ref_Subdomain_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_domain-subdomain';
  
  /**
   * the most likley class of a given query object
   *
   * @var HostingSubdomain_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysDomain_Ref_Subdomain';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Hosting.Subdomain.show&amp;target_mask=WbfsysDomain_Ref_Subdomain&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Hosting.Subdomain.edit&amp;target_mask=WbfsysDomain_Ref_Subdomain&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'hosting.subdomain.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Hosting.Subdomain.delete&amp;target_mask=WbfsysDomain_Ref_Subdomain&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'hosting.subdomain.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['hosting_subdomain_rowid'];
...
}//end class WbfsysDomain_Ref_Subdomain_Table_Element
