 ...
 * @licence WebFrap.net
 */
class WbfsysDomain_Ref_Subdomain_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Domain_Ref_Subdomain.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysDomain_Ref_Subdomain_Table_Ajax_View
