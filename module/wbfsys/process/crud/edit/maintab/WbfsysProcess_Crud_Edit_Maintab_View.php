 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcess Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcess = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Process.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcess
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Process.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcess_Crud_Edit' );
...
}//end class WbfsysProcess_Crud_Edit_Maintab_View
