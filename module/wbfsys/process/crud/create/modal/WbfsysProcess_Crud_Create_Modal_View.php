 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcess entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Process.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Process.insert';
    $params->formId       = 'wgt-form-wbfsys_process';
    $params->namespace   = 'wbfsys_process-create';
    ...
    $this->setTemplate( 'wbfsys/process/modal/crud/form_create' );
...
}//end class WbfsysProcess_Crud_Create_Modal_View
