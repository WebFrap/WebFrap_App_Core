 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process States
  *
  ...
  *  }
  *
  * @return WbfsysProcessState_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessState_Table_Element( 'tableWbfsysProcessState', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_state-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process States', 'wbfsys.process_state.label' );
      //$tabPanel->searchKey = 'wbfsys_process_state';
      ...
      $searchElement->searchKey = 'wbfsys_process_state';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessState_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessState', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessState listing maske
   *
   * @param WbfsysProcessState_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcessState  = $model->getEntityWbfsysProcessState();
    ...
    $formWbfsysProcessState->setKeyName( 'wbfsys_process_state' );
...
}//end class WbfsysProcessState_Table_Ui
