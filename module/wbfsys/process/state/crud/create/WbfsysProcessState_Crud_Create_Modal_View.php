 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessState entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessState.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessState.insert';
    $params->formId       = 'wgt-form-wbfsys_process_state';
    $params->namespace   = 'wbfsys_process_state-create';
    ...
    $this->setTemplate( 'wbfsys/process_state/modal/crud/form_create' );
...
}//end class WbfsysProcessState_Crud_Create_Modal_View
