 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProcessState', array_keys( $this->fields['wbfsys_process_state']), true ),
...
}//end class WbfsysProcessState_Crud_Create_Form */
