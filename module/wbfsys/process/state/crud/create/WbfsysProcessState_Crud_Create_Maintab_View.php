 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProcessState Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_process_state-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/process_state/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessState.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_process_state';
    ...
    $form = $this->newForm( 'WbfsysProcessState_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProcessState.create');}});
});
...
}//end class WbfsysProcessState_Crud_Create_Maintab_View
