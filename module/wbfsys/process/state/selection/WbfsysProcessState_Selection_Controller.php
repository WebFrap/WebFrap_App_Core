 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProcessState_Selection' ) );
...
} // end class WbfsysProcessState_Selection_Controller */
