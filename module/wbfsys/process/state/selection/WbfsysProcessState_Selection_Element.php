 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_process_state';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessState.show&amp;target_mask=WbfsysProcessState&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessState.edit&amp;target_mask=WbfsysProcessState&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_state.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessState.delete&amp;target_mask=WbfsysProcessState&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_state.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_state_label'])).'</td>'.NL;
...
}//end class WbfsysProcessState_Selection_Element
