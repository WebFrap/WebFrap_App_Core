 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcessState_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcessState_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessState_Selection_Element
    (
      'selectionWbfsysProcessState',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Process States', 'wbfsys.process_state.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProcessState.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProcessState',
      'WbfsysProcessState_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcessState_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessState_Selection_Ui
