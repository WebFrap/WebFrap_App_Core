 ...
 * @licence WebFrap.net
 */
class WbfsysProcessState_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcessState_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_process_state.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process_state.rowid ",
      'acls'
    );
...
}//end class WbfsysProcessState_Selection_Access
