 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcessStepType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcessStepType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit process step Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProcessStepType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcessStepType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProcessStepType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process_step_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process_step_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcessStepType_Crud_Edit' );
...
}//end class WbfsysProcessStepType_Crud_Edit_Maintab_View
