 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProcessStepType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProcessStepType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProcessStepType_Entity */
      $entity = $orm->get( 'WbfsysProcessStepType', $rootId );
    }
...
}//end class WbfsysProcessStepType_Crud_Access_Root
