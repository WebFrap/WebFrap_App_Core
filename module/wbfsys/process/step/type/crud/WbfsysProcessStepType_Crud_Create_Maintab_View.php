 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProcessStepType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new process step Type',
      'wbfsys.process_step_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New process step Type',
      'wbfsys.process_step_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_process_step_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/process_step_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStepType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_process_step_type';
    ...
    $form = $this->newForm( 'WbfsysProcessStepType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProcessStepType.create');}});
});
...
}//end class WbfsysProcessStepType_Crud_Create_Maintab_View
