 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessStepType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessStepType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStepType.insert';
    $params->formId       = 'wgt-form-wbfsys_process_step_type';
    $params->namespace   = 'wbfsys_process_step_type-create';
    ...
    $this->setTemplate( 'wbfsys/process_step_type/modal/crud/form_create' );
...
}//end class WbfsysProcessStepType_Crud_Create_Modal_View
