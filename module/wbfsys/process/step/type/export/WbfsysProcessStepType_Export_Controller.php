 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysProcessStepType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysProcessStepType_Export_Listing_Access';
    ...
    // create a new WbfsysProcessStepType window
    $view = $this->loadView
    (
    	'export-wbfsys_process_step_type',
    	'WbfsysProcessStepType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysProcessStepType_Export' );
...
} // end class WbfsysProcessStepType_Export_Controller_Genf
