 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysProcessStepType_Acl_Path' );
    /* @var $query WbfsysProcessStepType_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysProcessStepType_Acl_Path');
    /* @var $dropQuery WbfsysProcessStepType_Acl_Path_Query  */
...
} // end class WbfsysProcessStepType_Acl_Path_Model */
