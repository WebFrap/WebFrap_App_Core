 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysProcessStepType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysProcessStepType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysProcessStepType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysProcessStepType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_process_step_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'process step Type "{@label@}" User Access',
        'wbfsys.process_step_type.label',
        array
        (
          'label' => $entityWbfsysProcessStepType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_process_step_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysProcessStepType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysProcessStepType_Acl_Dset_Ui */
