 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_process_step_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_process_step_type.rowid as id,
    wbfsys_process_step_type.name as value,
    wbfsys_process_step_type.name as label
  FROM
...
} // end class WbfsysProcessStepType_Acl_Qfdu_Query_Postgresql */
