 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysProcessStepType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysProcessStepType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysProcessStepType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysProcessStepType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_process_step_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysProcessStepType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_process_step_type-acl-dset', 
    	'WbfsysProcessStepType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysProcessStepType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_process_step_type-acl-dset', 
    	'WbfsysProcessStepType_Acl_Dset',
...
} // end class WbfsysProcessStepType_Acl_Dset_Controller */
