 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysProcessStepType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ProcessStepType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_step_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.ProcessStepType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_process_step_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/process_step_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'process step Type', 'wbfsys.process_step_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_process_step_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysProcessStepType_Acl' );
...
} // end class WbfsysProcessStepType_Acl_Maintab_View */
