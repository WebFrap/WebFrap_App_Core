 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysProcessStepType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_process_step_type-acl-qfdu-aAjax',
      'WbfsysProcessStepType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysProcessStepType_Acl_Qfdu_Controller */
