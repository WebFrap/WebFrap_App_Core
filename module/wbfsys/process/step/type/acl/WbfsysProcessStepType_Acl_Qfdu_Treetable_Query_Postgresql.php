 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_process_step_type.name as "wbfsys_process_step_type_name"',
      'wbfsys_process_step_type.rowid as "wbfsys_process_step_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_process_step_type on wbfsys_group_users.vid = wbfsys_process_step_type.rowid'
    );
...
} // end class WbfsysProcessStepType_Acl_Qfdu_Treetable_Query_Postgresql */
