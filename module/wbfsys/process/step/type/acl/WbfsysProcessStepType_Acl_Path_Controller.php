 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_process_step_type_acl_graph', 
      'WbfsysProcessStepType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysProcessStepType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysProcessStepType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysProcessStepType_Acl_Path_Maintab_View  */
...
} // end class WbfsysProcessStepType_Acl_Path_Controller */
