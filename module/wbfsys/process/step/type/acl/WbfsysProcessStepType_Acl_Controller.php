 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysProcessStepType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysProcessStepType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_process_step_type_acl_listing',
      'WbfsysProcessStepType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysProcessStepType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysProcessStepType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysProcessStepType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_process_step_type-acl',
    	'WbfsysProcessStepType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_process_step_type_acl_masks_listing',
      'WbfsysProcessStepType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysProcessStepType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysProcessStepType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysProcessStepType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysProcessStepType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysProcessStepType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysProcessStepType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_process_step_type-acl-qfdu',
    	'WbfsysProcessStepType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysProcessStepType_Acl_Controller */
