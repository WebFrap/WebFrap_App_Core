 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_process_step_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysProcessStepType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProcessStepType_Acl_Dset' );
    /* @var $query WbfsysProcessStepType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProcessStepType_Acl_Dset_Treetable' );
    /* @var $query WbfsysProcessStepType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysProcessStepType_Acl_Dset_Model */
