 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_process_step_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysProcessStepType = $orm->get('WbfsysProcessStepType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_process_step_type_name']  = $refEntityWbfsysProcessStepType->name;

    }
    $tabData['wbfsys_process_step_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysProcessStepType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProcessStepType_Acl' );
    /* @var $query WbfsysProcessStepType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProcessStepType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysProcessStepType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProcessStepType_Acl_Qfdu' );
    /* @var $query WbfsysProcessStepType_Acl_Qfdu_Query  */
...
} // end class WbfsysProcessStepType_Acl_Qfdu_Model */
