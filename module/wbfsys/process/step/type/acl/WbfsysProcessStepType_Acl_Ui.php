 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysProcessStepType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStepType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL process step Type', 
        'wbfsys.process_step_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_process_step_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'process step Type', 'wbfsys.process_step_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_process_step_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysProcessStepType_Acl_Table'
    );
...
} // end class WbfsysProcessStepType_Acl_Ui */
