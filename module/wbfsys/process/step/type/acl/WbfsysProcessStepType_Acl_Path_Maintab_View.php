 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/process_step_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'process step Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_process_step_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_process_step_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysProcessStepType_Acl_Path_Maintab_View */
