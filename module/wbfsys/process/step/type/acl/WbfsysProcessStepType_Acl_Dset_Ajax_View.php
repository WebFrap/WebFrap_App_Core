 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysProcessStepType_Acl_Dset' );
    ...
    $entityWbfsysProcessStepType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysProcessStepType_Acl_Dset_Ajax_View */
