 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_process_step_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysProcessStepType_Acl_Dset_Treetable_Query_Postgresql */
