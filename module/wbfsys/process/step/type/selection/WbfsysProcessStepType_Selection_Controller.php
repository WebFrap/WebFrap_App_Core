 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProcessStepType_Selection' ) );
...
} // end class WbfsysProcessStepType_Selection_Controller */
