 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcessStepType_Selection_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_process_step_type') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_process_step_type.rowid ",
      'acls'
    );
...
}//end class WbfsysProcessStepType_Selection_Access
