 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcessStepType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcessStepType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStepType_Selection_Element
    (
      'selectionWbfsysProcessStepType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection process step Types', 'wbfsys.process_step_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProcessStepType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProcessStepType',
      'WbfsysProcessStepType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcessStepType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessStepType_Selection_Ui
