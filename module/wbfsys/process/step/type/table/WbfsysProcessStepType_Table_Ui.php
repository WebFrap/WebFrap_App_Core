 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für process step Types
  *
  ...
  *  }
  *
  * @return WbfsysProcessStepType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStepType_Table_Element( 'tableWbfsysProcessStepType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_step_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'process step Types', 'wbfsys.process_step_type.label' );
      //$tabPanel->searchKey = 'wbfsys_process_step_type';
      ...
      $searchElement->searchKey = 'wbfsys_process_step_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessStepType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessStepType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessStepType listing maske
   *
   * @param WbfsysProcessStepType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcessStepType  = $model->getEntityWbfsysProcessStepType();
    ...
    $formWbfsysProcessStepType->setKeyName( 'wbfsys_process_step_type' );
...
}//end class WbfsysProcessStepType_Table_Ui
