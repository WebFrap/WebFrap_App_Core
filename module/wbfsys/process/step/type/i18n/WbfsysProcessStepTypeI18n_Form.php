 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_process_step_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysProcessStepTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysProcessStepTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysProcessStepTypeI18n';
   ...
   *
   * @var WbfsysProcessStepTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysProcessStepTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysProcessStepTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysProcessStepTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.process_step_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_process_step_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_process_step_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysProcessStepType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysProcessStepType not exists' );

      Log::warn('Looks like the Entity: WbfsysProcessStepType is missing');
      ...
      //p: Window
      $objidWbfsysProcessStepType = $this->entity->getData('id_wbfsys_process_step_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysProcessStepType
          || !$entityWbfsysProcessStepType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysProcessStepType = $this->db->orm->newEntity( 'WbfsysProcessStepType' );
      }

      $inputIdWbfsysProcessStepType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysProcessStepType', 'Window' );
      $inputIdWbfsysProcessStepType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_process_step_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_process_step_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Process Step Type (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysProcessStepType->assignedForm = $this->assignedForm;

      $inputIdWbfsysProcessStepType->setWidth( 'medium' );

      $inputIdWbfsysProcessStepType->setData( $this->entity->getData( 'id_wbfsys_process_step_type' )  );
      $inputIdWbfsysProcessStepType->setReadOnly( $this->isReadOnly( 'id_wbfsys_process_step_type' ) );
      $inputIdWbfsysProcessStepType->setLabel( $this->view->i18n->l( 'Wbfsys Process Step Type', 'wbfsys.process_step_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.ProcessStepType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_process_step_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysProcessStepType->setListUrl ( $listUrl );
      $inputIdWbfsysProcessStepType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysProcessStepType->setEntityUrl( 'maintab.php?c=Wbfsys.ProcessStepType.edit' );
      $inputIdWbfsysProcessStepType->conEntity         = $entityWbfsysProcessStepType;
      $inputIdWbfsysProcessStepType->refresh           = $this->refresh;
      $inputIdWbfsysProcessStepType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysProcessStepType->view = $this->view;
      $inputIdWbfsysProcessStepType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_process_step_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysProcessStepType );
  ...
  }//end public function input_id_wbfsys_process_step_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.process_step_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.process_step_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.process_step_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.process_step_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.process_step_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.process_step_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.process_step_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.process_step_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.process_step_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Process Step Type I18n)', 'wbfsys.process_step_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_process_step_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_process_step_type_i18n_m_role_change';
...
}//end class WbfsysProcessStepTypeI18n_Form */
