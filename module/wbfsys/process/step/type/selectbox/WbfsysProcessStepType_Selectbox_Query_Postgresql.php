 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysProcessStepType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_process_step_type.rowid as id',
      'wbfsys_process_step_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_process_step_type.m_order as "wbfsys_process_step_type-m_order-order"' );

    $criteria->from( 'wbfsys_process_step_type' );



      $criteria->orderBy( 'wbfsys_process_step_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_process_step_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_process_step_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysProcessStepType_Selectbox_Query_Postgresql
