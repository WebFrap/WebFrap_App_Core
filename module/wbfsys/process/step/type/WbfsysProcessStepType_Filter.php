 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_process_step_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_process_step_type.{$fieldName}
...
}//end class WbfsysProcessStepType_Filter
