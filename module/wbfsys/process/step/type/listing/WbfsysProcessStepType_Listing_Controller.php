 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStepType_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProcessStepType_'.$listType ) );
...
} // end class WbfsysProcessStepType_Listing_Controller */
