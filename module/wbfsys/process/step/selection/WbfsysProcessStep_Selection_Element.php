 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_process_step';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessStep.show&amp;target_mask=WbfsysProcessStep&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessStep.edit&amp;target_mask=WbfsysProcessStep&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_step.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessStep.delete&amp;target_mask=WbfsysProcessStep&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_step.label',
        Acl::DELETE
...
}//end class WbfsysProcessStep_Selection_Element
