 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcessStep_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcessStep_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStep_Selection_Element
    (
      'selectionWbfsysProcessStep',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Process Steps', 'wbfsys.process_step.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProcessStep.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProcessStep',
      'WbfsysProcessStep_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcessStep_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessStep_Selection_Ui
