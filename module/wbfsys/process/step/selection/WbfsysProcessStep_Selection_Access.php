 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcessStep_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_process_step.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process_step.rowid ",
      'acls'
    );
...
}//end class WbfsysProcessStep_Selection_Access
