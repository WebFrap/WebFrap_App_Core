 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessStep entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessStep.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStep.insert';
    $params->formId       = 'wgt-form-wbfsys_process_step';
    $params->namespace   = 'wbfsys_process_step-create';
    ...
    $this->setTemplate( 'wbfsys/process_step/modal/crud/form_create' );
...
}//end class WbfsysProcessStep_Crud_Create_Modal_View
