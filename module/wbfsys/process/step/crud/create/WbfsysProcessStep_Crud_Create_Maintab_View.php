 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProcessStep Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_process_step-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/process_step/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStep.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_process_step';
    ...
    $form = $this->newForm( 'WbfsysProcessStep_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProcessStep.create');}});
});
...
}//end class WbfsysProcessStep_Crud_Create_Maintab_View
