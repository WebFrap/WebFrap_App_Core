 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProcessStep_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProcessStep_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProcessStep_Entity */
      $entity = $orm->get( 'WbfsysProcessStep', $rootId );
    }
...
}//end class WbfsysProcessStep_Crud_Access_Root
