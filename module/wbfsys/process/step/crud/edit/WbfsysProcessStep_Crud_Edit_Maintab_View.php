 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcessStep Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcessStep = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Process Step: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProcessStep.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcessStep
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProcessStep.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process_step-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process_step/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcessStep_Crud_Edit' );
...
}//end class WbfsysProcessStep_Crud_Edit_Maintab_View
