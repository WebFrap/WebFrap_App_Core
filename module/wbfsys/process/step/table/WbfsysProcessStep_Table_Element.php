 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_process_step';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProcessStep_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessStep.show&amp;target_mask=WbfsysProcessStep&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessStep.edit&amp;target_mask=WbfsysProcessStep&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_step.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessStep.delete&amp;target_mask=WbfsysProcessStep&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_step.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.process_step.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Comment', 'wbfsys.process_step.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Rating', 'wbfsys.process_step.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_process_step_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.ProcessStepType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_step_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_process_step_comment']).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:right;" >'.(!is_null($row['wbfsys_process_step_rate'])?$row['wbfsys_process_step_rate']:' ').'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProcessStep_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Process Steps." >{$iconDelete} Delete selected Process Steps</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Process Steps. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProcessStep_Multi.deleteAll" >{$iconClean} Delete all Process Steps</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProcessStep_Table_Element
