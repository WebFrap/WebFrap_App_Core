...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.ProcessStepType.listing" >'.Validator::sanitizeHtml($row['wbfsys_process_step_type_name']).'</a></td>'.NL;
