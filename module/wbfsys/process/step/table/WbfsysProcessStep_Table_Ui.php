 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process Steps
  *
  ...
  *  }
  *
  * @return WbfsysProcessStep_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStep_Table_Element( 'tableWbfsysProcessStep', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_step-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process Steps', 'wbfsys.process_step.label' );
      //$tabPanel->searchKey = 'wbfsys_process_step';
      ...
      $searchElement->searchKey = 'wbfsys_process_step';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessStep_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessStep', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessStep listing maske
   *
   * @param WbfsysProcessStep_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcessStep  = $model->getEntityWbfsysProcessStep();
    ...
    $formWbfsysProcessStep->setKeyName( 'wbfsys_process_step' );
...
}//end class WbfsysProcessStep_Table_Ui
