 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStep_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_process_step']->id_type )
    {
      $valWbfsysProcessStepType = $orm->getField
      (
        'WbfsysProcessStepType',
        'rowid = '.$data['wbfsys_process_step']->id_type,
        'name'
      );
      $tabData['wbfsys_process_step_type_name'] = $valWbfsysProcessStepType;
    }
    else
    {
      // else just set an empty string, fastest way ;-)
      $tabData['wbfsys_process_step_type_name'] = '';
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysProcessStep_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysProcessStep_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysProcessStep_Table_Model
