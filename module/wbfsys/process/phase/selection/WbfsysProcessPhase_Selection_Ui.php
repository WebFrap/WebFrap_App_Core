 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcessPhase_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcessPhase_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessPhase_Selection_Element
    (
      'selectionWbfsysProcessPhase',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Process Phases', 'wbfsys.process_phase.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProcessPhase.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProcessPhase',
      'WbfsysProcessPhase_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcessPhase_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessPhase_Selection_Ui
