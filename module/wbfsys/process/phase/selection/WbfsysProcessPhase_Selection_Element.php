 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_process_phase';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessPhase.show&amp;target_mask=WbfsysProcessPhase&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessPhase.edit&amp;target_mask=WbfsysProcessPhase&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_phase.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessPhase.delete&amp;target_mask=WbfsysProcessPhase&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_phase.label',
        Acl::DELETE
...
}//end class WbfsysProcessPhase_Selection_Element
