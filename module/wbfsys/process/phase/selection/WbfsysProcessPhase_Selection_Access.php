 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcessPhase_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_process_phase.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process_phase.rowid ",
      'acls'
    );
...
}//end class WbfsysProcessPhase_Selection_Access
