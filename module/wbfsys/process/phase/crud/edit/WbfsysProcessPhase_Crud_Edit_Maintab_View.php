 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcessPhase Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcessPhase = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Process Phase: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProcessPhase.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcessPhase
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProcessPhase.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process_phase-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process_phase/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcessPhase_Crud_Edit' );
...
}//end class WbfsysProcessPhase_Crud_Edit_Maintab_View
