 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessPhase entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessPhase.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessPhase.insert';
    $params->formId       = 'wgt-form-wbfsys_process_phase';
    $params->namespace   = 'wbfsys_process_phase-create';
    ...
    $this->setTemplate( 'wbfsys/process_phase/modal/crud/form_create' );
...
}//end class WbfsysProcessPhase_Crud_Create_Modal_View
