 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProcessPhase', array_keys( $this->fields['wbfsys_process_phase']), true ),
...
}//end class WbfsysProcessPhase_Crud_Create_Form */
