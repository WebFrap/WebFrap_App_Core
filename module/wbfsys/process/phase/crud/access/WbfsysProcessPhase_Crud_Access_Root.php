 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProcessPhase_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProcessPhase_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProcessPhase_Entity */
      $entity = $orm->get( 'WbfsysProcessPhase', $rootId );
    }
...
}//end class WbfsysProcessPhase_Crud_Access_Root
