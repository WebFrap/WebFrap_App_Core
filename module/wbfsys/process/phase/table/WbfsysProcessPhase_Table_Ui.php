 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process Phases
  *
  ...
  *  }
  *
  * @return WbfsysProcessPhase_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessPhase_Table_Element( 'tableWbfsysProcessPhase', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_phase-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process Phases', 'wbfsys.process_phase.label' );
      //$tabPanel->searchKey = 'wbfsys_process_phase';
      ...
      $searchElement->searchKey = 'wbfsys_process_phase';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessPhase_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessPhase', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessPhase listing maske
   *
   * @param WbfsysProcessPhase_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcessPhase  = $model->getEntityWbfsysProcessPhase();
    ...
    $formWbfsysProcessPhase->setKeyName( 'wbfsys_process_phase' );
...
}//end class WbfsysProcessPhase_Table_Ui
