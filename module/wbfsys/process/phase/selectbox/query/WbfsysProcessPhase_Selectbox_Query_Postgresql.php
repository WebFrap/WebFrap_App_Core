 ...
 * @licence WebFrap.net
 */
class WbfsysProcessPhase_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysProcessPhase Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_process_phase.rowid as id',
      'wbfsys_process_phase.label as value'
     ));
    ...
    $criteria->from( 'wbfsys_process_phase' );
      ...
      $criteria->orderBy( 'wbfsys_process_phase.label ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_process_phase.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_process_phase.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysProcessPhase_Selectbox_Query_Postgresql
