 ...
 * If you want to extend this class write your coden in ControllerWbfsysProcess
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Ref_Nodes_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des nodes Referenztabs
  * für den wbfsys_process management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysProcess_Ref_Nodes_".$listType."_Access";
    ...
    $accessNodes = new $containerClass( );
    $accessNodes->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-nodes';

    $params->accessNodes = $accessNodes;
    $params->paramsNodes = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessNodes->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_process-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysProcess_Ref_Nodes_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelNodes = $this->loadModel
    (
      'WbfsysProcess_Ref_Nodes_'.$listType
    );
    $modelNodes->setAccess( $accessNodes );
    
    $view->setModel( $modelNodes );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdNodes = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysProcess_Ref_Nodes_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_process-ref-nodes-'.$listType.'-ajax',
    	'WbfsysProcess_Ref_Nodes_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysProcessNode by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_process_node' ); //def wbfsys_process_node


  } // end public function cleanPost */

} // end WbfsysProcess_Ref_Nodes_Controller
