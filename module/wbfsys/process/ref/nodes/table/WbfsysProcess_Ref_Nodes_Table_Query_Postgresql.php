 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Ref_Nodes_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_process_node.rowid as "wbfsys_process_node_rowid"', // variant:  
      'wbfsys_process_node.label as "wbfsys_process_node_label"', // variant:  
      'wbfsys_process_node.description as "wbfsys_process_node_description"', // variant:  
    );
...
}//end class WbfsysProcess_Ref_Nodes_Table_Query_Postgresql
