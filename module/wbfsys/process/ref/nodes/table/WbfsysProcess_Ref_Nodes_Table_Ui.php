 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Ref_Nodes_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysProcess
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysProcess_Ref_Nodes_Table_Element
   */
  public function createListItem( $idWbfsysProcess, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysProcess_Ref_Nodes_Table_Element
    (
      'tableNodes',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-nodes-'.$idWbfsysProcess;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process-ref-nodes-search-'
        .$idWbfsysProcess;
    ...
    $tabPanel->searchKey = 'wbfsys_process-ref-nodes';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.ProcessNode.create&refid='.$params->refId.'&target_mask=WbfsysProcess_Ref_Nodes&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_process_node[id_process]\':\''.$params->refIdNodes.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabNodes', true );
    $view->addVar( 'refIdNodes', $idWbfsysProcess );
    $view->addVar
    (
      'searchFormActionNodes',
      'ajax.php?c=Wbfsys.Process_Ref_Nodes.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysProcess
    );
   ...
   * @return WbfsysProcess_Ref_Nodes_Table_Element
   */
  public function getListItem( $idWbfsysProcess, $data, $access, $params  )
  {
   ...
   * @return WbfsysProcess_Ref_Nodes_Table_Element
   */
  public function listEntry( $idWbfsysProcess, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowNodes' , $table->buildAjax() );
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysProcess_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysProcessNode  = $model->getEntityWbfsysProcessNode();
    ...
    $formWbfsysProcessNode->setKeyName( 'wbfsys_process_node' );
...
}//end class WbfsysProcess_Ref_Nodes_Table_Ui
