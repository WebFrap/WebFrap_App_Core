 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Ref_Nodes_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Process_Ref_Nodes.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysProcess_Ref_Nodes_Table_Ajax_View
