 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Ref_Nodes_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_process_node Attributes: label; access_key; phase_key; is_start_node; is_end_node; id_process; id_phase; description; bg_color; text_color; border_color; icon; revision; m_order; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-nodes',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-nodes' );
  ...
  /**
   * @param WbfsysProcess_Ref_Nodes_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process_node.rowid ",
      'acls'
    );
...
}//end class WbfsysProcess_Ref_Nodes_Table_Access
