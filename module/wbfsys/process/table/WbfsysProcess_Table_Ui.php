...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process
  *
  ...
  *  }
  *
  * @return WbfsysProcess_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcess_Table_Element( 'tableWbfsysProcess', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process', 'wbfsys.process.label' );
      //$tabPanel->searchKey = 'wbfsys_process';
      ...
      $searchElement->searchKey = 'wbfsys_process';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcess_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcess', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcess listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcess  = $model->getEntityWbfsysProcess();
    ...
    $formWbfsysProcess->setKeyName( 'wbfsys_process' );
...
}//end class WbfsysProcess_Table_Ui
