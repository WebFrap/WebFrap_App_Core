 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_process';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProcess_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Process.show&amp;target_mask=WbfsysProcess&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Process.edit&amp;target_mask=WbfsysProcess&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Nodes',
            'modal.php?c=Wbfsys.Process_Ref_Nodes.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.process.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Process.delete&amp;target_mask=WbfsysProcess&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.process.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.process.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_process_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Process.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_process_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Process_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Process." >{$iconDelete} Delete selected Process</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Process. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Process_Multi.deleteAll" >{$iconClean} Delete all Process</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProcess_Table_Element
