 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProcessNode_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProcessNode_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProcessNode_Entity */
      $entity = $orm->get( 'WbfsysProcessNode', $rootId );
    }
...
}//end class WbfsysProcessNode_Crud_Access_Root
