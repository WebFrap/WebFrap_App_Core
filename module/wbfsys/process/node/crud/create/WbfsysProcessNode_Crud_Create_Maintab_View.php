 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProcessNode Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_process_node-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/process_node/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessNode.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_process_node';
    ...
    $form = $this->newForm( 'WbfsysProcessNode_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProcessNode.create');}});
});
...
}//end class WbfsysProcessNode_Crud_Create_Maintab_View
