 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessNode entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessNode.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessNode.insert';
    $params->formId       = 'wgt-form-wbfsys_process_node';
    $params->namespace   = 'wbfsys_process_node-create';
    ...
    $this->setTemplate( 'wbfsys/process_node/modal/crud/form_create' );
...
}//end class WbfsysProcessNode_Crud_Create_Modal_View
