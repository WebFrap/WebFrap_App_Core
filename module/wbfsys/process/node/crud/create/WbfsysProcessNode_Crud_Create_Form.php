 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProcessNode', array_keys( $this->fields['wbfsys_process_node']), true ),
...
}//end class WbfsysProcessNode_Crud_Create_Form */
