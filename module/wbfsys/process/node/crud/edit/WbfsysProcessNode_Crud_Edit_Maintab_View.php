 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcessNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcessNode = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Process Node: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProcessNode.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcessNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProcessNode.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process_node-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process_node/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcessNode_Crud_Edit' );
...
}//end class WbfsysProcessNode_Crud_Edit_Maintab_View
