 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcessNode_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcessNode_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessNode_Selection_Element
    (
      'selectionWbfsysProcessNode',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Process Nodes', 'wbfsys.process_node.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProcessNode.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProcessNode',
      'WbfsysProcessNode_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcessNode_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessNode_Selection_Ui
