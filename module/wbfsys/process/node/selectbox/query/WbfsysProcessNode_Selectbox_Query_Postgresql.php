 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysProcessNode Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_process_node.rowid as id',
    ...
    $criteria->from( 'wbfsys_process_node' );
      ...
      $criteria->orderBy( 'wbfsys_process_node.label ' );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_process_node.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysProcessNode_Selectbox_Query_Postgresql
