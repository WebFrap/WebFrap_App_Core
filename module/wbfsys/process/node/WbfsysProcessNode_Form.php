...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_process_node';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysProcessNode';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysProcessNode' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysProcessNode entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Label (Process Node)', 'wbfsys.process_node.label' ),
      ...
      $inputLabel->setLabel
      (
        $this->view->i18n->l( 'Label', 'wbfsys.process_node.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.process_node.label' ),
  ...
  * @return void
  */
  public function input_phase_key( $params )
  {

      //tpl: class ui:text
      $inputPhaseKey = $this->view->newInput( 'input'.$this->prefix.'PhaseKey' , 'Text' );
      $this->items['phase_key'] = $inputPhaseKey;
      $inputPhaseKey->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[phase_key]',
          'id'        => 'wgt-input-'.$this->keyName.'_phase_key'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_cname medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Phase key (Process Node)', 'wbfsys.process_node.label' ),
          'maxlength' => $this->entity->maxSize( 'phase_key' ),
        )
      );
      $inputPhaseKey->setWidth( 'medium' );

      $inputPhaseKey->setReadOnly( $this->isReadOnly( 'phase_key' ) );
      $inputPhaseKey->setData( $this->entity->getSecure('phase_key') );
      $inputPhaseKey->setLabel
      (
        $this->view->i18n->l( 'Phase key', 'wbfsys.process_node.label' ),
        $this->entity->required( 'phase_key' )
      );
  ...
  }//end public function input_phase_key */
  ...
  * @return void
  */
  public function input_is_start_node( $params )
  {

      //tpl: class ui:Checkbox
      $inputIsStartNode = $this->view->newInput( 'input'.$this->prefix.'IsStartNode' , 'Checkbox' );
      $this->items['is_start_node'] = $inputIsStartNode;
      $inputIsStartNode->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[is_start_node]',
          'id'        => 'wgt-input-'.$this->keyName.'_is_start_node'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Is Start Node (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      $inputIsStartNode->setWidth( 'medium' );

      $inputIsStartNode->setReadOnly( $this->isReadOnly( 'is_start_node' ) );
      $inputIsStartNode->setActive( $this->entity->getBoolean( 'is_start_node' ) );
      $inputIsStartNode->setLabel
      (
        $this->view->i18n->l( 'Is Start Node', 'wbfsys.process_node.label' ),
        $this->entity->required( 'is_start_node' )
      );
  ...
  }//end public function input_is_start_node */
  ...
  * @return void
  */
  public function input_is_end_node( $params )
  {

      //tpl: class ui:Checkbox
      $inputIsEndNode = $this->view->newInput( 'input'.$this->prefix.'IsEndNode' , 'Checkbox' );
      $this->items['is_end_node'] = $inputIsEndNode;
      $inputIsEndNode->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[is_end_node]',
          'id'        => 'wgt-input-'.$this->keyName.'_is_end_node'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Is End Node (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      $inputIsEndNode->setWidth( 'medium' );

      $inputIsEndNode->setReadOnly( $this->isReadOnly( 'is_end_node' ) );
      $inputIsEndNode->setActive( $this->entity->getBoolean( 'is_end_node' ) );
      $inputIsEndNode->setLabel
      (
        $this->view->i18n->l( 'Is End Node', 'wbfsys.process_node.label' ),
        $this->entity->required( 'is_end_node' )
      );
  ...
  }//end public function input_is_end_node */
    ...
    if( !Webfrap::classLoadable( 'WbfsysProcess_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_process'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Process (Process Node)', 'wbfsys.process_node.label' ),
      ));
      ...
      $inputIdProcess->setLabel( $this->view->i18n->l( 'Process', 'wbfsys.process_node.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysProcessPhase_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_phase'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Phase (Process Node)', 'wbfsys.process_node.label' ),
      ));
      ...
      $inputIdPhase->setLabel( $this->view->i18n->l( 'Phase', 'wbfsys.process_node.label' ) );
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.process_node.label' ),
  ...
  public function input_bg_color( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Bg color (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Bg color', 'wbfsys.process_node.label' ),
  ...
  public function input_text_color( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Text color (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Text color', 'wbfsys.process_node.label' ),
  ...
  public function input_border_color( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Border color (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Border color', 'wbfsys.process_node.label' ),
  ...
  public function input_icon( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Icon (Process Node)', 'wbfsys.process_node.label' ),
      ...
      $inputIcon->setLabel
      (
        $this->view->i18n->l( 'Icon', 'wbfsys.process_node.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.process_node.label' ),
  ...
  public function input_m_order( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Order (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Order', 'wbfsys.process_node.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.process_node.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.process_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Process Node)', 'wbfsys.process_node.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.process_node.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Process Node)', 'wbfsys.process_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.process_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Process Node)', 'wbfsys.process_node.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.process_node.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.process_node.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Process Node)', 'wbfsys.process_node.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.process_node.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Label (Process Node)', 'wbfsys.process_node.label' ),
          'maxlength' => $this->entity->maxSize( 'label' ),
        )
      );
      $inputLabel->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Process Node)', 'wbfsys.process_node.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
 ...
 /**
  * create the search element for field phase_key
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_phase_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_phase_key'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_cname medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Phase key (Process Node)', 'wbfsys.process_node.label' ),
          'maxlength' => $this->entity->maxSize( 'phase_key' ),
        )
      );
      $inputPhaseKey->setWidth( 'medium' );
  ...
  }//end public function search_phase_key */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_process_node_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_process_node_m_role_change';
...
}//end class WbfsysProcessNode_Form */
