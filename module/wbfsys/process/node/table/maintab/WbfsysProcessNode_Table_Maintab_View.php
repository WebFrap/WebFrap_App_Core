 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProcessNode_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysProcessNode_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/process_node/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.ProcessNode.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ProcessNode.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysProcessNode_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.ProcessNode.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.ProcessNode.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.ProcessNode.create&amp;ltype=table');
    });
...
}//end class WbfsysProcessNode_Table_Maintab_View
