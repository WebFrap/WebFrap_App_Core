 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_process_node';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProcessNode_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessNode.show&amp;target_mask=WbfsysProcessNode&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessNode.edit&amp;target_mask=WbfsysProcessNode&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_node.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessNode.delete&amp;target_mask=WbfsysProcessNode&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_node.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.ProcessNode.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.process_node.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.process_node.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_process_node_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProcessNode.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_node_label'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_process_node_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProcessNode_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Process Nodes." >{$iconDelete} Delete selected Process Nodes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Process Nodes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProcessNode_Multi.deleteAll" >{$iconClean} Delete all Process Nodes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProcessNode_Table_Element
