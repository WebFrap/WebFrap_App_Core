 ...
 * @licence WebFrap.net
 */
class WbfsysProcessNode_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process Nodes
  *
  ...
  *  }
  *
  * @return WbfsysProcessNode_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessNode_Table_Element( 'tableWbfsysProcessNode', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_node-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process Nodes', 'wbfsys.process_node.label' );
      //$tabPanel->searchKey = 'wbfsys_process_node';
      ...
      $searchElement->searchKey = 'wbfsys_process_node';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessNode_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessNode', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessNode listing maske
   *
   * @param WbfsysProcessNode_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcessNode_Table_Ui
