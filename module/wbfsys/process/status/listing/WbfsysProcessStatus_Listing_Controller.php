 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProcessStatus_'.$listType ) );
...
} // end class WbfsysProcessStatus_Listing_Controller */
