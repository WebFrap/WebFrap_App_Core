 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_process_status';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProcessStatus_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProcessStatus.show&amp;target_mask=WbfsysProcessStatus&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProcessStatus.edit&amp;target_mask=WbfsysProcessStatus&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process_status.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProcessStatus.delete&amp;target_mask=WbfsysProcessStatus&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process_status.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_process_status_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProcessStatus_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Process Status." >{$iconDelete} Delete selected Process Status</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Process Status. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProcessStatus_Multi.deleteAll" >{$iconClean} Delete all Process Status</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProcessStatus_Table_Element
