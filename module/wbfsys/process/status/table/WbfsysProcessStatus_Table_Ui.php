 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Process Status
  *
  ...
  *  }
  *
  * @return WbfsysProcessStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcessStatus_Table_Element( 'tableWbfsysProcessStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_process_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Process Status', 'wbfsys.process_status.label' );
      //$tabPanel->searchKey = 'wbfsys_process_status';
      ...
      $searchElement->searchKey = 'wbfsys_process_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProcessStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProcessStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProcessStatus listing maske
   *
   * @param WbfsysProcessStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProcessStatus  = $model->getEntityWbfsysProcessStatus();
    ...
    $formWbfsysProcessStatus->setKeyName( 'wbfsys_process_status' );
...
}//end class WbfsysProcessStatus_Table_Ui
