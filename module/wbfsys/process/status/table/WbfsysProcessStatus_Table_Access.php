 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcessStatus_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_process_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process_status.rowid ",
      'acls'
    );
...
}//end class WbfsysProcessStatus_Table_Access
