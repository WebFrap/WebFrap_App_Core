 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProcessStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProcessStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProcessStatus_Entity */
      $entity = $orm->get( 'WbfsysProcessStatus', $rootId );
    }
...
}//end class WbfsysProcessStatus_Crud_Access_Root
