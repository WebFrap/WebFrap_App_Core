 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProcessStatus Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_process_status-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/process_status/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStatus.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_process_status';
    ...
    $form = $this->newForm( 'WbfsysProcessStatus_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProcessStatus.create');}});
});
...
}//end class WbfsysProcessStatus_Crud_Create_Maintab_View
