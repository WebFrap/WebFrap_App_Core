 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProcessStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProcessStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProcessStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_process_status';
    $params->namespace   = 'wbfsys_process_status-create';
    ...
    $this->setTemplate( 'wbfsys/process_status/modal/crud/form_create' );
...
}//end class WbfsysProcessStatus_Crud_Create_Modal_View
