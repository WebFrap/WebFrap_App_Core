 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysProcessStatus_IdProcess( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysProcess_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Process.selection&amp;context=create'
  ...
  */
  public function input_WbfsysProcessStatus_IdPhase( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysProcessPhase_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.ProcessPhase.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProcessStatus', array_keys( $this->fields['wbfsys_process_status']), true ),
...
}//end class WbfsysProcessStatus_Crud_Create_Form */
