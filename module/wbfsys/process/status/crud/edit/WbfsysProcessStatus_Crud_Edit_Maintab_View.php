 ...
 * @licence WebFrap.net
 */
class WbfsysProcessStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProcessStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProcessStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Process Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProcessStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProcessStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProcessStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_process_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/process_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProcessStatus_Crud_Edit' );
...
}//end class WbfsysProcessStatus_Crud_Edit_Maintab_View
