 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProcess_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProcess_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProcess_Selection_Element
    (
      'selectionWbfsysProcess',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Process', 'wbfsys.process.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Process.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysProcess',
      'WbfsysProcess_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProcess_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProcess_Selection_Ui
