 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_process';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Process.show&amp;target_mask=WbfsysProcess&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Process.edit&amp;target_mask=WbfsysProcess&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.process.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Process.delete&amp;target_mask=WbfsysProcess&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.process.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_name'])).'</td>'.NL;
...
}//end class WbfsysProcess_Selection_Element
