 ...
 * @licence WebFrap.net
 */
class WbfsysProcess_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProcess_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_process.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_process.rowid ",
      'acls'
    );
...
}//end class WbfsysProcess_Selection_Access
