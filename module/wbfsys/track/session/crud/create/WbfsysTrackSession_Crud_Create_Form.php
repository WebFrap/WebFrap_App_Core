 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysTrackSession_IdSession( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTrackSession_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.TrackSession.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysTrackSession', array_keys( $this->fields['wbfsys_track_session']), true ),
...
}//end class WbfsysTrackSession_Crud_Create_Form */
