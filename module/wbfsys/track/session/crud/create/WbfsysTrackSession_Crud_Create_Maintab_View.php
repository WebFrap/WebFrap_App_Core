 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTrackSession Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_track_session-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/track_session/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TrackSession.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_track_session';
    ...
    $form = $this->newForm( 'WbfsysTrackSession_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TrackSession.create');}});
});
...
}//end class WbfsysTrackSession_Crud_Create_Maintab_View
