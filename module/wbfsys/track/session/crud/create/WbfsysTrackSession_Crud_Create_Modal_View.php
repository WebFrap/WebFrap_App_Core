 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTrackSession entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TrackSession.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TrackSession.insert';
    $params->formId       = 'wgt-form-wbfsys_track_session';
    $params->namespace   = 'wbfsys_track_session-create';
    ...
    $this->setTemplate( 'wbfsys/track_session/modal/crud/form_create' );
...
}//end class WbfsysTrackSession_Crud_Create_Modal_View
