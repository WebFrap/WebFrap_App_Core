 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTrackSession Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTrackSession = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Track Session: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TrackSession.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTrackSession
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TrackSession.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_track_session-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/track_session/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTrackSession_Crud_Edit' );
...
}//end class WbfsysTrackSession_Crud_Edit_Maintab_View
