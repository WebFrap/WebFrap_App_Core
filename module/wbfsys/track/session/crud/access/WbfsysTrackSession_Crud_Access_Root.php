 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTrackSession_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTrackSession_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTrackSession_Entity */
      $entity = $orm->get( 'WbfsysTrackSession', $rootId );
    }
...
}//end class WbfsysTrackSession_Crud_Access_Root
