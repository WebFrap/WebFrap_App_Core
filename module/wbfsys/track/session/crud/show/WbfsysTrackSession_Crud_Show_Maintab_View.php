 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysTrackSession_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTrackSession Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTrackSession = $this->model->getEntityWbfsysTrackSession();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Track Session: {@text@}',
      'wbfsys.track_session.label',
      array( 'text' => $entityWbfsysTrackSession->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TrackSession.show  &amp;objid='.$entityWbfsysTrackSession
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TrackSession.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_track_session-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/track_session/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTrackSession_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.TrackSession.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_track_session' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_track_session a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.TrackSession.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.TrackSession.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTrackSession_Crud_Show_Maintab_View
