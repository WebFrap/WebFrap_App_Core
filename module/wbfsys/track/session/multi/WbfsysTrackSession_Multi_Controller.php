 ...
 * If you want to extend this class write your coden in ControllerWbfsysTrackSession
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Multi_Controller
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysTrackSession_Multi_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_save( $request, $response )
  {
    ...
    $access = new WbfsysTrackSession_Multi_Access_Save( null, null, $this );
    $access->load( $user->getProfileName(), $params );

    // der Access Container des Users für die Resource wird als flag übergeben
    $params->access = $access;
    
    $model = $this->loadModel( 'WbfsysTrackSession_Multi' );
  ...
  * ControllerWbfsysTrackSessionGenf::multiSave
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    $access = new WbfsysTrackSession_Multi_Access_Update( null, null, $this );
    $access->load( $user->getProfileName(), $params );
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    $access = new WbfsysTrackSession_Multi_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(), $params );
  ...
  * a valid rowid in the given data
  * if you want to have create or update functions use class:
  * ControllerWbfsysTrackSessionGenf::multiDelete
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    $access = new WbfsysTrackSession_Multi_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params );
...
}//end class WbfsysTrackSession_Multi_Controller
