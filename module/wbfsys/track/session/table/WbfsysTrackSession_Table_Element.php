 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_track_session';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTrackSession_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TrackSession.show&amp;target_mask=WbfsysTrackSession&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TrackSession.edit&amp;target_mask=WbfsysTrackSession&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.track_session.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TrackSession.delete&amp;target_mask=WbfsysTrackSession&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.track_session.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Service', 'wbfsys.track_session.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Refer', 'wbfsys.track_session.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Session', 'wbfsys.track_session.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Browser', 'wbfsys.track_session.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Os', 'wbfsys.track_session.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_track_session_rowid'];
      ...
      $body .= '<td valign="top" style="text-align:center;" >'.( trim( $row['wbfsys_track_session_service'] ) == '' ? ' ' : '<a target="extern" href="'.Wgt::renderUrl($row['wbfsys_track_session_service']).'">'.Validator::sanitizeHtml($row['wbfsys_track_session_service']).'</a>' ).'</td>'.NL;
...
}//end class WbfsysTrackSession_Table_Element
