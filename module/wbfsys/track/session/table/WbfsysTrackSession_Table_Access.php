 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysTrackSession_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_track_session.rowid ",
      'acls'
    );
...
}//end class WbfsysTrackSession_Table_Access
