 ...
 * @licence WebFrap.net
 */
class WbfsysTrackSession_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Track Sessions
  *
  ...
  *  }
  *
  * @return WbfsysTrackSession_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTrackSession_Table_Element( 'tableWbfsysTrackSession', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_track_session-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Track Sessions', 'wbfsys.track_session.label' );
      //$tabPanel->searchKey = 'wbfsys_track_session';
      ...
      $searchElement->searchKey = 'wbfsys_track_session';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTrackSession_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTrackSession', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTrackSession listing maske
   *
   * @param WbfsysTrackSession_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTrackSession  = $model->getEntityWbfsysTrackSession();
    ...
    $formWbfsysTrackSession->setKeyName( 'wbfsys_track_session' );
...
}//end class WbfsysTrackSession_Table_Ui
