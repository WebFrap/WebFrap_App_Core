 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysHelpPage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysHelpPage = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.HelpPage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysHelpPage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.HelpPage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_help_page-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/help_page/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysHelpPage_Crud_Edit' );
...
}//end class WbfsysHelpPage_Crud_Edit_Maintab_View
