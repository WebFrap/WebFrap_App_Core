 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysHelpPage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_help_page-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/help_page/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.HelpPage.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_help_page';
    ...
    $form = $this->newForm( 'WbfsysHelpPage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.HelpPage.create');}});
});
...
}//end class WbfsysHelpPage_Crud_Create_Maintab_View
