 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysHelpPage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.HelpPage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.HelpPage.insert';
    $params->formId       = 'wgt-form-wbfsys_help_page';
    $params->namespace   = 'wbfsys_help_page-create';
    ...
    $this->setTemplate( 'wbfsys/help_page/modal/crud/form_create' );
...
}//end class WbfsysHelpPage_Crud_Create_Modal_View
