 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysHelpPage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysHelpPage = $this->model->getEntityWbfsysHelpPage();
    ...
    (
      ...
      array( 'text' => $entityWbfsysHelpPage->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.HelpPage.show  &amp;objid='.$entityWbfsysHelpPage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.HelpPage.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_help_page-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/help_page/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysHelpPage_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.HelpPage.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_help_page' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_help_page a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.HelpPage.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.HelpPage.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysHelpPage_Crud_Show_Maintab_View
