 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysHelpPage_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_help_page.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_help_page.rowid ",
      'acls'
    );
...
}//end class WbfsysHelpPage_Table_Access
