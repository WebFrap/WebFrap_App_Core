...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Help Pages
  *
  ...
  *  }
  *
  * @return WbfsysHelpPage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysHelpPage_Table_Element( 'tableWbfsysHelpPage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_help_page-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Help Pages', 'wbfsys.help_page.label' );
      //$tabPanel->searchKey = 'wbfsys_help_page';
      ...
      $searchElement->searchKey = 'wbfsys_help_page';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysHelpPage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysHelpPage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysHelpPage listing maske
   *
   * @param WbfsysHelpPage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysHelpPage  = $model->getEntityWbfsysHelpPage();
    ...
    $formWbfsysHelpPage->setKeyName( 'wbfsys_help_page' );
...
}//end class WbfsysHelpPage_Table_Ui
