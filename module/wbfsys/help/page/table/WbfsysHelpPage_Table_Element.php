 ...
 * @licence WebFrap.net
 */
class WbfsysHelpPage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_help_page';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysHelpPage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.HelpPage.show&amp;target_mask=WbfsysHelpPage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.HelpPage.edit&amp;target_mask=WbfsysHelpPage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.help_page.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.HelpPage.delete&amp;target_mask=WbfsysHelpPage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.help_page.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.help_page.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_help_page_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_help_page_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.HelpPage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Help Pages." >{$iconDelete} Delete selected Help Pages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Help Pages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.HelpPage_Multi.deleteAll" >{$iconClean} Delete all Help Pages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysHelpPage_Table_Element
