 ...
 *
 * Entity Class for the Database Table wbfsys_help_page
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_help_page';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.HelpPage.show';
  ...
  */
  public static $entityName  = 'WbfsysHelpPage';
  ...
  */
  ...
  (
    'title' => array
    (
      'default' => 'wbfsys.help_page.message.error_def_title',
      'wrong'   => 'wbfsys.help_page.message.error_wrong_title',
      'max'     => 'wbfsys.help_page.message.error_max_title',
      'min'     => 'wbfsys.help_page.message.error_min_title',
    ),

    'vid' => array
    (
      'default' => 'wbfsys.help_page.message.error_def_vid',
      'wrong'   => 'wbfsys.help_page.message.error_wrong_vid',
      'max'     => 'wbfsys.help_page.message.error_max_vid',
      'min'     => 'wbfsys.help_page.message.error_min_vid',
    ),

    'id_vid_entity' => array
    (
      'default' => 'wbfsys.help_page.message.error_def_id_vid_entity',
      'wrong'   => 'wbfsys.help_page.message.error_wrong_id_vid_entity',
      'max'     => 'wbfsys.help_page.message.error_max_id_vid_entity',
      'min'     => 'wbfsys.help_page.message.error_min_id_vid_entity',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.help_page.message.error_def_rowid',
      'wrong'   => 'wbfsys.help_page.message.error_wrong_rowid',
      'empty'   => 'wbfsys.help_page.message.error_empty_rowid',
      'max'     => 'wbfsys.help_page.message.error_max_rowid',
      'min'     => 'wbfsys.help_page.message.error_min_rowid',
    ),
  );

}//end class WbfsysHelpPage_Entity
