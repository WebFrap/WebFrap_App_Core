 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysHelpEntry Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysHelpEntry = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Help Entry: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.HelpEntry.edit&amp;utf8=✓&amp;objid='.$entityWbfsysHelpEntry
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.HelpEntry.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_help_entry-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/help_entry/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysHelpEntry_Crud_Edit' );
...
}//end class WbfsysHelpEntry_Crud_Edit_Maintab_View
