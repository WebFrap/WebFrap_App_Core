 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysHelpEntry entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.HelpEntry.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.HelpEntry.insert';
    $params->formId       = 'wgt-form-wbfsys_help_entry';
    $params->namespace   = 'wbfsys_help_entry-create';
    ...
    $this->setTemplate( 'wbfsys/help_entry/modal/crud/form_create' );
...
}//end class WbfsysHelpEntry_Crud_Create_Modal_View
