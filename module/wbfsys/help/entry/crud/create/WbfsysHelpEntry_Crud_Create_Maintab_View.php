 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysHelpEntry Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_help_entry-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/help_entry/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.HelpEntry.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_help_entry';
    ...
    $form = $this->newForm( 'WbfsysHelpEntry_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.HelpEntry.create');}});
});
...
}//end class WbfsysHelpEntry_Crud_Create_Maintab_View
