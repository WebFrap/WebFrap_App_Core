 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysHelpEntry_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysHelpEntry_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysHelpEntry_Entity */
      $entity = $orm->get( 'WbfsysHelpEntry', $rootId );
    }
...
}//end class WbfsysHelpEntry_Crud_Access_Root
