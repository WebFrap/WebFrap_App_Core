 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_help_entry';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysHelpEntry_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.HelpEntry.show&amp;target_mask=WbfsysHelpEntry&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.HelpEntry.edit&amp;target_mask=WbfsysHelpEntry&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.help_entry.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.HelpEntry.delete&amp;target_mask=WbfsysHelpEntry&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.help_entry.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.help_entry.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_help_entry_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_help_entry_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.HelpEntry_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Help Entrys." >{$iconDelete} Delete selected Help Entrys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Help Entrys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.HelpEntry_Multi.deleteAll" >{$iconClean} Delete all Help Entrys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysHelpEntry_Table_Element
