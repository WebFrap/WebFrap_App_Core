 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysHelpEntry_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_help_entry.rowid ",
      'acls'
    );
...
}//end class WbfsysHelpEntry_Table_Access
