 ...
 * @licence WebFrap.net
 */
class WbfsysHelpEntry_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Help Entrys
  *
  ...
  *  }
  *
  * @return WbfsysHelpEntry_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysHelpEntry_Table_Element( 'tableWbfsysHelpEntry', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_help_entry-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Help Entrys', 'wbfsys.help_entry.label' );
      //$tabPanel->searchKey = 'wbfsys_help_entry';
      ...
      $searchElement->searchKey = 'wbfsys_help_entry';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysHelpEntry_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysHelpEntry', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysHelpEntry listing maske
   *
   * @param WbfsysHelpEntry_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysHelpEntry  = $model->getEntityWbfsysHelpEntry();
    ...
    $formWbfsysHelpEntry->setKeyName( 'wbfsys_help_entry' );
...
}//end class WbfsysHelpEntry_Table_Ui
