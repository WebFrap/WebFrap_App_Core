...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_help_entry';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysHelpEntry';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysHelpEntry' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysHelpEntry entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_page( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysHelpPage_Entity' ) )
    {
      ...
      $inputIdPage = $this->view->newInput( 'input'.$this->prefix.'IdPage', 'Window' );
      $inputIdPage->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_page]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_page'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Page (Help Entry)', 'wbfsys.help_entry.label' ),
      ));
      ...
      $inputIdPage->setReadOnly( $this->isReadOnly( 'id_page' ) );
      $inputIdPage->setLabel( $this->view->i18n->l( 'Page', 'wbfsys.help_entry.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.HelpPage.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_page'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdPage->buildJavascript( 'wgt-input-'.$this->keyName.'_id_page'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_page */
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Help Entry)', 'wbfsys.help_entry.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.help_entry.label' ),
  ...
  public function input_content( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Content (Help Entry)', 'wbfsys.help_entry.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Content', 'wbfsys.help_entry.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Help Entry)', 'wbfsys.help_entry.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.help_entry.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Help Entry)', 'wbfsys.help_entry.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.help_entry.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Help Entry)', 'wbfsys.help_entry.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.help_entry.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Help Entry)', 'wbfsys.help_entry.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.help_entry.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Help Entry)', 'wbfsys.help_entry.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.help_entry.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Help Entry)', 'wbfsys.help_entry.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.help_entry.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Help Entry)', 'wbfsys.help_entry.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.help_entry.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Help Entry)', 'wbfsys.help_entry.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  public function search_content( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Content (Help Entry)', 'wbfsys.help_entry.label' ),
        )
      );
      $inputContent->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_help_entry_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_help_entry_m_role_change';
...
}//end class WbfsysHelpEntry_Form */
