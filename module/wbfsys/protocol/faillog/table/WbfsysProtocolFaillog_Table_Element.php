 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_protocol_faillog';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProtocolFaillog_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolFaillog.show&amp;target_mask=WbfsysProtocolFaillog&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolFaillog.edit&amp;target_mask=WbfsysProtocolFaillog&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_faillog.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolFaillog.delete&amp;target_mask=WbfsysProtocolFaillog&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_faillog.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'User name', 'wbfsys.protocol_faillog.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_protocol_faillog_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolFaillog.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_protocol_faillog_user_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProtocolFaillog_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Protocol Faillogs." >{$iconDelete} Delete selected Protocol Faillogs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Protocol Faillogs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProtocolFaillog_Multi.deleteAll" >{$iconClean} Delete all Protocol Faillogs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProtocolFaillog_Table_Element
