 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProtocolFaillog_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_protocol_faillog.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_protocol_faillog.rowid ",
      'acls'
    );
...
}//end class WbfsysProtocolFaillog_Table_Access
