 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Protocol Faillogs
  *
  ...
  *  }
  *
  * @return WbfsysProtocolFaillog_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProtocolFaillog_Table_Element( 'tableWbfsysProtocolFaillog', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_protocol_faillog-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Protocol Faillogs', 'wbfsys.protocol_faillog.label' );
      //$tabPanel->searchKey = 'wbfsys_protocol_faillog';
      ...
      $searchElement->searchKey = 'wbfsys_protocol_faillog';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProtocolFaillog_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProtocolFaillog', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProtocolFaillog listing maske
   *
   * @param WbfsysProtocolFaillog_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProtocolFaillog  = $model->getEntityWbfsysProtocolFaillog();
    ...
    $formWbfsysProtocolFaillog->setKeyName( 'wbfsys_protocol_faillog' );
...
}//end class WbfsysProtocolFaillog_Table_Ui
