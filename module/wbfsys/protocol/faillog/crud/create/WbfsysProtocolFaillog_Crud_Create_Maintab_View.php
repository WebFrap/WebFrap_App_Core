 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProtocolFaillog Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Protocol Faillog',
      'wbfsys.protocol_faillog.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Protocol Faillog',
      'wbfsys.protocol_faillog.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_protocol_faillog-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/protocol_faillog/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolFaillog.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_protocol_faillog';
    ...
    $form = $this->newForm( 'WbfsysProtocolFaillog_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProtocolFaillog.create');}});
});
...
}//end class WbfsysProtocolFaillog_Crud_Create_Maintab_View
