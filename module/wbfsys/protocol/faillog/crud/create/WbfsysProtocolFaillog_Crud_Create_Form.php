 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProtocolFaillog', array_keys( $this->fields['wbfsys_protocol_faillog']), true ),
...
}//end class WbfsysProtocolFaillog_Crud_Create_Form */
