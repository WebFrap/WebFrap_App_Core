 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProtocolFaillog entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProtocolFaillog.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolFaillog.insert';
    $params->formId       = 'wgt-form-wbfsys_protocol_faillog';
    $params->namespace   = 'wbfsys_protocol_faillog-create';
    ...
    $this->setTemplate( 'wbfsys/protocol_faillog/modal/crud/form_create' );
...
}//end class WbfsysProtocolFaillog_Crud_Create_Modal_View
