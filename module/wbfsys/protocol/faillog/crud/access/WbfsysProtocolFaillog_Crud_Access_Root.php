 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProtocolFaillog_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProtocolFaillog_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProtocolFaillog_Entity */
      $entity = $orm->get( 'WbfsysProtocolFaillog', $rootId );
    }
...
}//end class WbfsysProtocolFaillog_Crud_Access_Root
