 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolFaillog_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProtocolFaillog Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolFaillog = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Protocol Faillog: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolFaillog.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProtocolFaillog
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolFaillog.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_faillog-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_faillog/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProtocolFaillog_Crud_Edit' );
...
}//end class WbfsysProtocolFaillog_Crud_Edit_Maintab_View
