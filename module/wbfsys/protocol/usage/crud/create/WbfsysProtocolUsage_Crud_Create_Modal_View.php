 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProtocolUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProtocolUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_protocol_usage';
    $params->namespace   = 'wbfsys_protocol_usage-create';
    ...
    $this->setTemplate( 'wbfsys/protocol_usage/modal/crud/form_create' );
...
}//end class WbfsysProtocolUsage_Crud_Create_Modal_View
