 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysProtocolUsage_IdBrowser( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysBrowser_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Browser.selection&amp;context=create'
  ...
  */
  public function input_WbfsysProtocolUsage_IdBrowserVersion( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysBrowserVersion_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.BrowserVersion.selection&amp;context=create'
  ...
  */
  public function input_WbfsysProtocolUsage_IdOs( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysOs_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Os.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProtocolUsage', array_keys( $this->fields['wbfsys_protocol_usage']), true ),
...
}//end class WbfsysProtocolUsage_Crud_Create_Form */
