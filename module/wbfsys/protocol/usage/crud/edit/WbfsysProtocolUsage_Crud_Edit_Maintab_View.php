 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProtocolUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolUsage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Protocol Usage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolUsage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProtocolUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolUsage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_usage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_usage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProtocolUsage_Crud_Edit' );
...
}//end class WbfsysProtocolUsage_Crud_Edit_Maintab_View
