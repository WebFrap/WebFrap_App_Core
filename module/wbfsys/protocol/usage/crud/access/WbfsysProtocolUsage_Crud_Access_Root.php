 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProtocolUsage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProtocolUsage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProtocolUsage_Entity */
      $entity = $orm->get( 'WbfsysProtocolUsage', $rootId );
    }
...
}//end class WbfsysProtocolUsage_Crud_Access_Root
