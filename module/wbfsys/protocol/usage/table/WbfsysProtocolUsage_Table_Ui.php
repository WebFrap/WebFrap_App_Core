 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Protocol Usages
  *
  ...
  *  }
  *
  * @return WbfsysProtocolUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProtocolUsage_Table_Element( 'tableWbfsysProtocolUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_protocol_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Protocol Usages', 'wbfsys.protocol_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_protocol_usage';
      ...
      $searchElement->searchKey = 'wbfsys_protocol_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProtocolUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProtocolUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProtocolUsage listing maske
   *
   * @param WbfsysProtocolUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProtocolUsage  = $model->getEntityWbfsysProtocolUsage();
    ...
    $formWbfsysProtocolUsage->setKeyName( 'wbfsys_protocol_usage' );
...
}//end class WbfsysProtocolUsage_Table_Ui
