 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_protocol_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProtocolUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolUsage.show&amp;target_mask=WbfsysProtocolUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolUsage.edit&amp;target_mask=WbfsysProtocolUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolUsage.delete&amp;target_mask=WbfsysProtocolUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:150px" >User</th>'.NL;
    $html .= '<th style="width:150px" >Browser</th>'.NL;
    $html .= '<th style="width:150px" >OS</th>'.NL;
    $html .= '<th style="width:150px" >Language</th>'.NL;
    $html .= '<th style="width:150px" >IP</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $objid       = $row['wbfsys_protocol_usage_rowid'];
      ...
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_protocol_usage_m_time_created'])?$this->view->i18n->date($row['wbfsys_protocol_usage_m_time_created']):' ').'</td>'.NL;
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolUsage.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolUsage.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_browser_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolUsage.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolUsage.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_language_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_protocol_usage_ip_address'])).'</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProtocolUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Protocol Usages." >{$iconDelete} Delete selected Protocol Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Protocol Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProtocolUsage_Multi.deleteAll" >{$iconClean} Delete all Protocol Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProtocolUsage_Table_Element
