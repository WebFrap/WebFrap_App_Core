 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProtocolUsage_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_protocol_usage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_protocol_usage.rowid ",
      'acls'
    );
...
}//end class WbfsysProtocolUsage_Table_Access
