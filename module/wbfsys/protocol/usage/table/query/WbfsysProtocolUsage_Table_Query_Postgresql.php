 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolUsage_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_protocol_usage_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if( $params->loadFullSize )
      $this->calcQuery = $criteria->count( 'count(DISTINCT wbfsys_protocol_usage.'.Db::PK.' ) as '.Db::Q_SIZE );
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    $criteria->where
    (
      " wbfsys_protocol_usage.rowid  IN( ". implode( ', ', array_keys($inKeys) ) ." )"
    );
    ...
    {
      $row['acl-level'] = $inKeys[$row['wbfsys_protocol_usage_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_protocol_usage.rowid as "wbfsys_protocol_usage_rowid"', // variant: def-rowid 
      'wbfsys_protocol_usage.m_time_created as "wbfsys_protocol_usage_m_time_created"', // variant: field_mgmt-attr 
      ...
      'wbfsys_protocol_usage.m_role_create as "wbfsys_protocol_usage_m_role_create"', // ref wbfsys_protocol_usage field_mgmt-field 
      'wbfsys_browser.name as "wbfsys_browser_name"', // variant: field_mgmt-field_attr 
      'wbfsys_browser.name as "wbfsys_browser_name"', // variant: field_mgmt-field  used source field wbfsys_browser
      'wbfsys_protocol_usage.id_browser as "wbfsys_protocol_usage_id_browser"', // ref wbfsys_protocol_usage field_mgmt-field 
      'wbfsys_os.name as "wbfsys_os_name"', // variant: field_mgmt-field_attr 
      'wbfsys_os.name as "wbfsys_os_name"', // variant: field_mgmt-field  used source field wbfsys_os
      'wbfsys_protocol_usage.id_os as "wbfsys_protocol_usage_id_os"', // ref wbfsys_protocol_usage field_mgmt-field 
      'wbfsys_language.name as "wbfsys_language_name"', // variant: field_mgmt-field_attr 
      'wbfsys_language.name as "wbfsys_language_name"', // variant: field_mgmt-field  used source field wbfsys_language
      'wbfsys_protocol_usage.id_main_language as "wbfsys_protocol_usage_id_main_language"', // ref wbfsys_protocol_usage field_mgmt-field 
      'wbfsys_protocol_usage.ip_address as "wbfsys_protocol_usage_ip_address"', // variant: field_mgmt-attr 
    );
  ...
  public function setTables( $criteria   )
  {
    ...
    $criteria->from( 'wbfsys_protocol_usage' );
    ...
    (
      ...
      null,
      'wbfsys_language'
    );// wbfsys_language  by alias wbfsys_language
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_protocol_usage.rowid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition) )
      {
        ...
        {
          $criteria->where( 'wbfsys_protocol_usage.rowid = '.$condition );
        }
        else
        {
 ...
 /**
  ...
  public function checkConditions( $criteria, array $condition )
  {
    	...
    	if( isset($condition['ids']) && !empty( $condition['ids'] ) )
    	{
				$criteria->where
        (
          'wbfsys_protocol_usage.rowid = IN( '. implode( ', ', $condition['ids'] ) .' ) ';
        );
    	}
      ...
      if( isset($condition['free']) && trim( $condition['free'] ) != ''  )
      {
         ...
         )
         {
            ...
            (
              '(
 wbfsys_protocol_usage.rowid = \''.$part.'\' 
              )'
            );
         }
  ...
  public function checkCharBegin( $criteria, $params )
  {
      ...
      if( $params->begin )
      {
        ...
        if( '?' == $params->begin  )
        {
          $criteria->where( "wbfsys_protocol_usage.id_browser ~* '^[^a-zA-Z]'" );
        }
        else
        {
          $criteria->where( "upper(substr(wbfsys_protocol_usage.id_browser,1,1)) = '".strtoupper($params->begin)."'" );
        }
  ...
  public function checkLimitAndOrder( $criteria, $params  )
  {
     ...
     // inject the default order
      ...
      $criteria->orderBy( 'wbfsys_protocol_usage.rowid' );
      $criteria->selectAlso( 'wbfsys_protocol_usage.rowid as "wbfsys_protocol_usage-rowid-order"' );
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
     ...
     // inject the default order
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_protocol_usage-rowid-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_protocol_usage-rowid-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_protocol_usage-rowid-order"' );
...
}//end class WbfsysProtocolUsage_Table_Query_Postgresql
