 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Protocol Access
  *
  ...
  *  }
  *
  * @return WbfsysProtocolAccess_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProtocolAccess_Table_Element( 'tableWbfsysProtocolAccess', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_protocol_access-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Protocol Access', 'wbfsys.protocol_access.label' );
      //$tabPanel->searchKey = 'wbfsys_protocol_access';
      ...
      $searchElement->searchKey = 'wbfsys_protocol_access';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProtocolAccess_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProtocolAccess', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProtocolAccess listing maske
   *
   * @param WbfsysProtocolAccess_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProtocolAccess  = $model->getEntityWbfsysProtocolAccess();
    ...
    $formWbfsysProtocolAccess->setKeyName( 'wbfsys_protocol_access' );
...
}//end class WbfsysProtocolAccess_Table_Ui
