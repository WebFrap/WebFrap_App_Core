 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_protocol_access';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolAccess.show&amp;target_mask=WbfsysProtocolAccess&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolAccess.edit&amp;target_mask=WbfsysProtocolAccess&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_access.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolAccess.delete&amp;target_mask=WbfsysProtocolAccess&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_access.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.protocol_access.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_protocol_access_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProtocolAccess.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_protocol_access_label'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProtocolAccess_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Protocol Access." >{$iconDelete} Delete selected Protocol Access</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Protocol Access. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProtocolAccess_Multi.deleteAll" >{$iconClean} Delete all Protocol Access</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProtocolAccess_Table_Element
