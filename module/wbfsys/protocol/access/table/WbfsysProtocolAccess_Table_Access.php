 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProtocolAccess_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_protocol_access.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_protocol_access.rowid ",
      'acls'
    );
...
}//end class WbfsysProtocolAccess_Table_Access
