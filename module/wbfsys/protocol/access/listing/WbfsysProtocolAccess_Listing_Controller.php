 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProtocolAccess_'.$listType ) );
...
} // end class WbfsysProtocolAccess_Listing_Controller */
