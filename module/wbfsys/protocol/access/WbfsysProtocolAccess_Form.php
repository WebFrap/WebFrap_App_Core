 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_protocol_access';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysProtocolAccess';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysProtocolAccess' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysProtocolAccess entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Protocol Access)', 'wbfsys.protocol_access.label' ),
  ...
  public function input_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Label (Protocol Access)', 'wbfsys.protocol_access.label' ),
      ...
      $inputLabel->setLabel
      (
        $this->view->i18n->l( 'Label', 'wbfsys.protocol_access.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysMask_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_mask'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Mask (Protocol Access)', 'wbfsys.protocol_access.label' ),
      ));
      ...
      $inputIdMask->setLabel( $this->view->i18n->l( 'Mask', 'wbfsys.protocol_access.label' ) );
  ...
  * @return void
  */
  public function input_counter( $params )
  {

      //tpl: class ui:int
      $inputCounter = $this->view->newInput( 'input'.$this->prefix.'Counter' , 'Int' );
      $this->items['counter'] = $inputCounter;
      $inputCounter->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[counter]',
          'id'        => 'wgt-input-'.$this->keyName.'_counter'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Counter (Protocol Access)', 'wbfsys.protocol_access.label' ),
        )
      );
      $inputCounter->setWidth( 'medium' );

      $inputCounter->setReadOnly( $this->isReadOnly( 'counter' ) );
      $inputCounter->setData( $this->entity->getData( 'counter' ) );
      $inputCounter->setLabel
      (
        $this->view->i18n->l( 'Counter', 'wbfsys.protocol_access.label' ),
        $this->entity->required( 'counter' )
      );
  ...
  }//end public function input_counter */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Protocol Access)', 'wbfsys.protocol_access.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Protocol Access)', 'wbfsys.protocol_access.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.protocol_access.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Protocol Access)', 'wbfsys.protocol_access.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.protocol_access.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Protocol Access)', 'wbfsys.protocol_access.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.protocol_access.label' ) );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Label (Protocol Access)', 'wbfsys.protocol_access.label' ),
          'maxlength' => $this->entity->maxSize( 'label' ),
        )
      );
      $inputLabel->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_protocol_access_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_protocol_access_m_role_change';
...
}//end class WbfsysProtocolAccess_Form */
