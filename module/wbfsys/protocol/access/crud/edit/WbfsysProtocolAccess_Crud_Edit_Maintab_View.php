 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProtocolAccess Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolAccess = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Protocol Access: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolAccess.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProtocolAccess
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolAccess.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_access-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_access/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProtocolAccess_Crud_Edit' );
...
}//end class WbfsysProtocolAccess_Crud_Edit_Maintab_View
