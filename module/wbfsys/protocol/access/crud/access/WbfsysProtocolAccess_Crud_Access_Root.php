 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProtocolAccess_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProtocolAccess_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProtocolAccess_Entity */
      $entity = $orm->get( 'WbfsysProtocolAccess', $rootId );
    }
...
}//end class WbfsysProtocolAccess_Crud_Access_Root
