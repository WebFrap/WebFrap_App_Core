 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProtocolAccess', array_keys( $this->fields['wbfsys_protocol_access']), true ),
...
}//end class WbfsysProtocolAccess_Crud_Create_Form */
