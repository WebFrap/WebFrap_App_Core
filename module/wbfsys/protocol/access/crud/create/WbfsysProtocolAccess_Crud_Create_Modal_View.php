 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProtocolAccess entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProtocolAccess.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolAccess.insert';
    $params->formId       = 'wgt-form-wbfsys_protocol_access';
    $params->namespace   = 'wbfsys_protocol_access-create';
    ...
    $this->setTemplate( 'wbfsys/protocol_access/modal/crud/form_create' );
...
}//end class WbfsysProtocolAccess_Crud_Create_Modal_View
