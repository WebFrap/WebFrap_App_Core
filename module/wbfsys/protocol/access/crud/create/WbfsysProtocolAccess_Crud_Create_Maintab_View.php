 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProtocolAccess Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_protocol_access-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/protocol_access/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolAccess.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_protocol_access';
    ...
    $form = $this->newForm( 'WbfsysProtocolAccess_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProtocolAccess.create');}});
});
...
}//end class WbfsysProtocolAccess_Crud_Create_Maintab_View
