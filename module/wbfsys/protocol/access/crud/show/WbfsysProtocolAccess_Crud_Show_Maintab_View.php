 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolAccess_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProtocolAccess_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysProtocolAccess Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolAccess = $this->model->getEntityWbfsysProtocolAccess();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Protocol Access: {@text@}',
      'wbfsys.protocol_access.label',
      array( 'text' => $entityWbfsysProtocolAccess->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Protocol Access: {@text@}',
      'wbfsys.protocol_access.label',
      array( 'text' => $entityWbfsysProtocolAccess->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolAccess.show  &amp;objid='.$entityWbfsysProtocolAccess
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolAccess.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_access-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_access/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysProtocolAccess_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ProtocolAccess.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_protocol_access' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_protocol_access a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ProtocolAccess.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ProtocolAccess.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysProtocolAccess_Crud_Show_Maintab_View
