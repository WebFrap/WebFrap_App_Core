 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_protocol_message';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysProtocolMessage';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysProtocolMessage' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysProtocolMessage entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Protocol Message)', 'wbfsys.protocol_message.label' ),
  ...
  */
  public function input_message( $params )
  {
      ...
      //p: textarea
      $inputMessage = $this->view->newInput( 'input'.$this->prefix.'Message', 'Textarea' );
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Message (Protocol Message)', 'wbfsys.protocol_message.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Message', 'wbfsys.protocol_message.label' ),
  ...
  public function input_context( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Context (Protocol Message)', 'wbfsys.protocol_message.label' ),
      ...
      (
        $this->view->i18n->l( 'Context', 'wbfsys.protocol_message.label' ),
  ...
  * @return void
  */
  public function input_mask( $params )
  {

      //tpl: class ui:text
      $inputMask = $this->view->newInput( 'input'.$this->prefix.'Mask' , 'Text' );
      $this->items['mask'] = $inputMask;
      $inputMask->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[mask]',
          'id'        => 'wgt-input-'.$this->keyName.'_mask'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_cname medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mask (Protocol Message)', 'wbfsys.protocol_message.label' ),
          'maxlength' => $this->entity->maxSize( 'mask' ),
        )
      );
      $inputMask->setWidth( 'medium' );

      $inputMask->setReadOnly( $this->isReadOnly( 'mask' ) );
      $inputMask->setData( $this->entity->getSecure('mask') );
      $inputMask->setLabel
      (
        $this->view->i18n->l( 'Mask', 'wbfsys.protocol_message.label' ),
        $this->entity->required( 'mask' )
      );
  ...
  }//end public function input_mask */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Protocol Message)', 'wbfsys.protocol_message.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Protocol Message)', 'wbfsys.protocol_message.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.protocol_message.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Protocol Message)', 'wbfsys.protocol_message.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.protocol_message.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Protocol Message)', 'wbfsys.protocol_message.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.protocol_message.label' ) );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the search element for field mask
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_mask( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Mask (Protocol Message)', 'wbfsys.protocol_message.label' ),
          'maxlength' => $this->entity->maxSize( 'mask' ),
        )
      );
      $inputMask->setWidth( 'medium' );
  ...
  }//end public function search_mask */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_protocol_message_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_protocol_message_m_role_change';
...
}//end class WbfsysProtocolMessage_Form */
