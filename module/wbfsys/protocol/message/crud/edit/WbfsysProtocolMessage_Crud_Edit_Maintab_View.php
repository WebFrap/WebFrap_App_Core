 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProtocolMessage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolMessage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Protocol Message: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolMessage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProtocolMessage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolMessage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_message-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_message/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProtocolMessage_Crud_Edit' );
...
}//end class WbfsysProtocolMessage_Crud_Edit_Maintab_View
