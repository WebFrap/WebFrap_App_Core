 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProtocolMessage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_protocol_message-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/protocol_message/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolMessage.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_protocol_message';
    ...
    $form = $this->newForm( 'WbfsysProtocolMessage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProtocolMessage.create');}});
});
...
}//end class WbfsysProtocolMessage_Crud_Create_Maintab_View
