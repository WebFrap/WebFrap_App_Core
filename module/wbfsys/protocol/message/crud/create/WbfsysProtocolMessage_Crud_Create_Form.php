 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysProtocolMessage', array_keys( $this->fields['wbfsys_protocol_message']), true ),
...
}//end class WbfsysProtocolMessage_Crud_Create_Form */
