 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProtocolMessage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProtocolMessage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProtocolMessage.insert';
    $params->formId       = 'wgt-form-wbfsys_protocol_message';
    $params->namespace   = 'wbfsys_protocol_message-create';
    ...
    $this->setTemplate( 'wbfsys/protocol_message/modal/crud/form_create' );
...
}//end class WbfsysProtocolMessage_Crud_Create_Modal_View
