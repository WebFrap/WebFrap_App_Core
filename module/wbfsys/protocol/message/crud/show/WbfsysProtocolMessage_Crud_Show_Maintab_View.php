 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProtocolMessage_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysProtocolMessage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProtocolMessage = $this->model->getEntityWbfsysProtocolMessage();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Protocol Message: {@text@}',
      'wbfsys.protocol_message.label',
      array( 'text' => $entityWbfsysProtocolMessage->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProtocolMessage.show  &amp;objid='.$entityWbfsysProtocolMessage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProtocolMessage.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_protocol_message-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/protocol_message/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysProtocolMessage_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ProtocolMessage.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_protocol_message' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_protocol_message a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ProtocolMessage.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ProtocolMessage.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysProtocolMessage_Crud_Show_Maintab_View
