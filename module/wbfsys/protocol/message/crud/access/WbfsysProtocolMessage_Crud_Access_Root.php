 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProtocolMessage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProtocolMessage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProtocolMessage_Entity */
      $entity = $orm->get( 'WbfsysProtocolMessage', $rootId );
    }
...
}//end class WbfsysProtocolMessage_Crud_Access_Root
