 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProtocolMessage_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_protocol_message.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_protocol_message.rowid ",
      'acls'
    );
...
}//end class WbfsysProtocolMessage_Table_Access
