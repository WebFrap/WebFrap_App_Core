 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_protocol_message';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProtocolMessage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProtocolMessage.show&amp;target_mask=WbfsysProtocolMessage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProtocolMessage.edit&amp;target_mask=WbfsysProtocolMessage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.protocol_message.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProtocolMessage.delete&amp;target_mask=WbfsysProtocolMessage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.protocol_message.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Message', 'wbfsys.protocol_message.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Context', 'wbfsys.protocol_message.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Mask', 'wbfsys.protocol_message.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_protocol_message_message']).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_protocol_message_context'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_protocol_message_mask'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProtocolMessage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Protocol Messages." >{$iconDelete} Delete selected Protocol Messages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Protocol Messages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProtocolMessage_Multi.deleteAll" >{$iconClean} Delete all Protocol Messages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProtocolMessage_Table_Element
