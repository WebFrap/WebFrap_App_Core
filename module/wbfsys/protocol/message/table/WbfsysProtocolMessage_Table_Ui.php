 ...
 * @licence WebFrap.net
 */
class WbfsysProtocolMessage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Protocol Messages
  *
  ...
  *  }
  *
  * @return WbfsysProtocolMessage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProtocolMessage_Table_Element( 'tableWbfsysProtocolMessage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_protocol_message-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Protocol Messages', 'wbfsys.protocol_message.label' );
      //$tabPanel->searchKey = 'wbfsys_protocol_message';
      ...
      $searchElement->searchKey = 'wbfsys_protocol_message';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProtocolMessage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProtocolMessage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProtocolMessage listing maske
   *
   * @param WbfsysProtocolMessage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProtocolMessage  = $model->getEntityWbfsysProtocolMessage();
    ...
    $formWbfsysProtocolMessage->setKeyName( 'wbfsys_protocol_message' );
...
}//end class WbfsysProtocolMessage_Table_Ui
