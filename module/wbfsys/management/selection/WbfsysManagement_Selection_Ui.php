 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysManagement_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysManagement_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysManagement_Selection_Element
    (
      'selectionWbfsysManagement',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Management Nodes', 'wbfsys.management.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Management.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysManagement',
      'WbfsysManagement_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysManagement_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysManagement_Selection_Ui
