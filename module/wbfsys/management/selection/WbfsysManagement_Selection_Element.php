 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_management';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Management.show&amp;target_mask=WbfsysManagement&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Management.edit&amp;target_mask=WbfsysManagement&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.management.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Management.delete&amp;target_mask=WbfsysManagement&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.management.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_management_name'])).'</td>'.NL;
...
}//end class WbfsysManagement_Selection_Element
