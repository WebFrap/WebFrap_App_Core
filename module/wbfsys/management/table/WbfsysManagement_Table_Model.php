 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysManagement_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysManagement_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysManagement_Table_Model
