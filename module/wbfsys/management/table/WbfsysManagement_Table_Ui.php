 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Management Nodes
  *
  ...
  *  }
  *
  * @return WbfsysManagement_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysManagement_Table_Element( 'tableWbfsysManagement', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_management-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Management Nodes', 'wbfsys.management.label' );
      //$tabPanel->searchKey = 'wbfsys_management';
      ...
      $searchElement->searchKey = 'wbfsys_management';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysManagement_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysManagement', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysManagement listing maske
   *
...
}//end class WbfsysManagement_Table_Ui
