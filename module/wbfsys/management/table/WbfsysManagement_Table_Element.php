 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_management';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Management.show&amp;target_mask=WbfsysManagement&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Management.edit&amp;target_mask=WbfsysManagement&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.management.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Management.delete&amp;target_mask=WbfsysManagement&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.management.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Management_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Management Nodes." >{$iconDelete} Delete selected Management Nodes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Management Nodes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Management_Multi.deleteAll" >{$iconClean} Delete all Management Nodes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysManagement_Table_Element
