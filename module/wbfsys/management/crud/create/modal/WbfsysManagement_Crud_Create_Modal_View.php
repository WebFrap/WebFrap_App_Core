 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysManagement entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Management.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Management.insert';
    $params->formId       = 'wgt-form-wbfsys_management';
    $params->namespace   = 'wbfsys_management-create';
    ...
    $this->setTemplate( 'wbfsys/management/modal/crud/form_create' );
...
}//end class WbfsysManagement_Crud_Create_Modal_View
