 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysManagement', array_keys( $this->fields['wbfsys_management']), true ),
...
}//end class WbfsysManagement_Crud_Create_Form */
