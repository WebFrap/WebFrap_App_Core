 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysManagement Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysManagement = $this->model->getEntityWbfsysManagement();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Management Node: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Management.show  &amp;objid='.$entityWbfsysManagement
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Management.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_management-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/management/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysManagement_Crud_Show' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Management.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysManagement_Crud_Show_Maintab_View
