 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_management_reference';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysManagementReference';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysManagementReference' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysManagementReference entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Management Reference)', 'wbfsys.management_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.management_reference.label' ),
  ...
  public function input_id_from( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysManagement_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for From (Management Reference)', 'wbfsys.management_reference.label' ),
      ));
      ...
      $inputIdFrom->setLabel( $this->view->i18n->l( 'From', 'wbfsys.management_reference.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysManagement_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_to'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for To (Management Reference)', 'wbfsys.management_reference.label' ),
      ));
      ...
      $inputIdTo->setLabel( $this->view->i18n->l( 'To', 'wbfsys.management_reference.label' ) );
  ...
  * @return void
  */
  public function input_id_reference( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityReference_Entity' ) )
    {
      ...
      $inputIdReference = $this->view->newInput( 'input'.$this->prefix.'IdReference', 'Window' );
      $inputIdReference->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_reference]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_reference'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Reference (Management Reference)', 'wbfsys.management_reference.label' ),
      ));
      ...
      $inputIdReference->setReadOnly( $this->isReadOnly( 'id_reference' ) );
      $inputIdReference->setLabel( $this->view->i18n->l( 'Reference', 'wbfsys.management_reference.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityReference.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_reference'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdReference->buildJavascript( 'wgt-input-'.$this->keyName.'_id_reference'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_reference */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Management Reference)', 'wbfsys.management_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.management_reference.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Management Reference)', 'wbfsys.management_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.management_reference.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Management Reference)', 'wbfsys.management_reference.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.management_reference.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Management Reference)', 'wbfsys.management_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.management_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Management Reference)', 'wbfsys.management_reference.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.management_reference.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Management Reference)', 'wbfsys.management_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.management_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Management Reference)', 'wbfsys.management_reference.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.management_reference.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Management Reference)', 'wbfsys.management_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.management_reference.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Management Reference)', 'wbfsys.management_reference.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.management_reference.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Management Reference)', 'wbfsys.management_reference.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_management_reference_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_management_reference_m_role_change';
...
}//end class WbfsysManagementReference_Form */
