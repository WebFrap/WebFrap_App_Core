 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysManagementReference_Selection' ) );
...
} // end class WbfsysManagementReference_Selection_Controller */
