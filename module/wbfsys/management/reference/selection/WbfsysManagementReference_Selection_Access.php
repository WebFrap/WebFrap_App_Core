 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysManagementReference_Selection_Query $query
...
}//end class WbfsysManagementReference_Selection_Access
