 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_management_reference', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
    ...
    if( $objid )
    {
      $searchId = $objid;
      $keyType  = 'rowid';
      $entity   = $orm->get( 'WbfsysManagementReference', $objid );
    }
    else if( $uuid )
    {
      $searchId = $uuid;
      $keyType  = 'uuid';
      $entity   = $orm->getByUuid( 'WbfsysManagementReference', $uuid );
    }
    else if( $accessKey )
    {
      $searchId = $accessKey;
      $keyType  = 'access_key';
      $entity   = $orm->getByKey( 'WbfsysManagementReference', $accessKey );
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    try
    {
      if( !$entityWbfsysManagementReference = $this->getRegisterd( 'entityWbfsysManagementReference' ) )
      {
        ...
        (
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysManagementReference' )
          )
        );
      }
      ...
      if( !$orm->insert( $entityWbfsysManagementReference ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to create Management Reference {@label@}',
            'wbfsys.management_reference.message',
            array
            (
              'label' => $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully created Management Reference {@label@}',
            'wbfsys.management_reference.message',
        ...
        $this->protocol
        (
          'Created New Management Reference: '.$entityText,
          'create',
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysManagementReference );
      }
    ...
    try
    {
      ...
      if( !$orm->update( $entityWbfsysManagementReference ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to update Management Reference {@label@}',
            'wbfsys.management_reference.message',
            array
            (
              'label' =>  $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully updated Management Reference {@label@}',
            'wbfsys.management_reference.message',
            array
            (
              'label' =>  $entityText
        ...
        $this->protocol
        (
          'edited Management Reference: '.$entityText,
          'edit',
          $entityWbfsysManagementReference
        );
   ...
   */
  public function delete( $entityWbfsysManagementReference, $params  )
  {
    ...
    $delId     = $entityWbfsysManagementReference->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysManagementReference );

      $response->addMessage
      (
        $response->i18n->l
        (
          'Successfully deleted Management Reference {@label@}',
          'wbfsys.management_reference.message',
          array( 'label' => $entityText )
        )
      );
        ...
        $this->protocol
        (
          'Deleted Management Reference: '.$entityText,
          'delete',
          array( 'WbfsysManagementReference', $delId )
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      //management  wbfsys_management_reference source wbfsys_management_reference
      $entityWbfsysManagementReference = $orm->newEntity( 'WbfsysManagementReference' );
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysManagementReference, $params )
  {
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysManagementReference = $orm->get( 'WbfsysManagementReference',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
          (
            'There is no Management Reference with the id: {@id@}',
            'wbfsys.management_reference.message',
            array
            (
              'id' => $id
    ...
    if( !$params->fieldsWbfsysManagementReference )
      $params->fieldsWbfsysManagementReference  = $entityWbfsysManagementReference->getCols
      (
        $params->categories
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_management_reference'] = array();
    $saveFields['wbfsys_management_reference'][] = 'access_key';
        $saveFields['wbfsys_management_reference'][] = 'id_from';
        $saveFields['wbfsys_management_reference'][] = 'id_to';
        $saveFields['wbfsys_management_reference'][] = 'id_reference';
        $saveFields['wbfsys_management_reference'][] = 'description';
        $saveFields['wbfsys_management_reference'][] = 'revision';
        $saveFields['wbfsys_management_reference'][] = 'm_version';
...
}//end WbfsysManagementReference_Crud_Model
