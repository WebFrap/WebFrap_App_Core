 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysManagementReference_IdReference( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityReference_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.EntityReference.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysManagementReference', array_keys( $this->fields['wbfsys_management_reference']), true ),
...
}//end class WbfsysManagementReference_Crud_Create_Form */
