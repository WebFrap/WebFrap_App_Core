 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysManagementReference Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Management Reference',
      'wbfsys.management_reference.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Management Reference',
      'wbfsys.management_reference.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_management_reference-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/management_reference/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ManagementReference.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_management_reference';
    ...
    $form = $this->newForm( 'WbfsysManagementReference_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ManagementReference.create');}});
});
...
}//end class WbfsysManagementReference_Crud_Create_Maintab_View
