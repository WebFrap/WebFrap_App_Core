 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysManagementReference entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ManagementReference.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ManagementReference.insert';
    $params->formId       = 'wgt-form-wbfsys_management_reference';
    $params->namespace   = 'wbfsys_management_reference-create';
    ...
    $this->setTemplate( 'wbfsys/management_reference/modal/crud/form_create' );
...
}//end class WbfsysManagementReference_Crud_Create_Modal_View
