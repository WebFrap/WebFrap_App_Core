 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysManagementReference Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysManagementReference = $this->model->getEntityWbfsysManagementReference();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Management Reference: {@text@}',
      'wbfsys.management_reference.label',
      array( 'text' => $entityWbfsysManagementReference->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Management Reference: {@text@}',
      'wbfsys.management_reference.label',
      array( 'text' => $entityWbfsysManagementReference->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ManagementReference.show  &amp;objid='.$entityWbfsysManagementReference
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ManagementReference.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_management_reference-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/management_reference/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysManagementReference_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ManagementReference.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_management_reference' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_management_reference a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ManagementReference.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ManagementReference.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysManagementReference_Crud_Show_Maintab_View
