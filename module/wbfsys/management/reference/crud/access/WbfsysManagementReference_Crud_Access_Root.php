 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysManagementReference_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysManagementReference_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysManagementReference_Entity */
      $entity = $orm->get( 'WbfsysManagementReference', $rootId );
    }
...
}//end class WbfsysManagementReference_Crud_Access_Root
