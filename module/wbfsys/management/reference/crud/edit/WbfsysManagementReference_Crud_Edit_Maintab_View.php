 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysManagementReference Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysManagementReference = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Management Reference: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ManagementReference.edit&amp;utf8=✓&amp;objid='.$entityWbfsysManagementReference
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ManagementReference.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_management_reference-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/management_reference/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysManagementReference_Crud_Edit' );
...
}//end class WbfsysManagementReference_Crud_Edit_Maintab_View
