 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_management_reference';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysManagementReference_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ManagementReference.show&amp;target_mask=WbfsysManagementReference&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ManagementReference.edit&amp;target_mask=WbfsysManagementReference&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.management_reference.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ManagementReference.delete&amp;target_mask=WbfsysManagementReference&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.management_reference.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_management_reference_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ManagementReference_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Management References." >{$iconDelete} Delete selected Management References</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Management References. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ManagementReference_Multi.deleteAll" >{$iconClean} Delete all Management References</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysManagementReference_Table_Element
