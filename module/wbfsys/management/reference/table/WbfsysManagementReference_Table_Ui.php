 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Management References
  *
  ...
  *  }
  *
  * @return WbfsysManagementReference_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysManagementReference_Table_Element( 'tableWbfsysManagementReference', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Management References', 'wbfsys.management_reference.label' );
      ...
      $searchElement->searchKey = 'wbfsys_management_reference';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysManagementReference_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param WbfsysManagementReference_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysManagementReference_Table_Ui
