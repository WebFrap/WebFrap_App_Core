 ...
 * @licence WebFrap.net
 */
class WbfsysManagementReference_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysManagementReference_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysManagementReference_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysManagementReference_Table_Model
