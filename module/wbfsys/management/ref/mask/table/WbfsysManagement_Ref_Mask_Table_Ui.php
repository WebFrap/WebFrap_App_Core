 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Mask_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysManagement_Ref_Mask_Table_Element
   */
  public function createListItem( $idWbfsysManagement, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysManagement_Ref_Mask_Table_Element
    (
      'tableMask',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-mask-'.$idWbfsysManagement;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_management-ref-mask-search-'
        .$idWbfsysManagement;
    ...
    $tabPanel->searchKey = 'wbfsys_management-ref-mask';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Mask',
            '$R.post(\'maintab.php?c=Wbfsys.Mask.create&refid='.$params->refId.'&target_mask=WbfsysManagement_Ref_Mask&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_mask[id_management]\':\''.$params->refIdMask.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabMask', true );
    $view->addVar( 'refIdMask', $idWbfsysManagement );
    $view->addVar
    (
      'searchFormActionMask',
      'ajax.php?c=Wbfsys.Management_Ref_Mask.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysManagement, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowMask' , $table->buildAjax() );
...
}//end class WbfsysManagement_Ref_Mask_Table_Ui
