 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Mask_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Management_Ref_Mask.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysManagement_Ref_Mask_Table_Ajax_View
