 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Mask_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des mask Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysManagement_Ref_Mask_".$listType."_Access";
    ...
    $accessMask = new $containerClass( );
    $accessMask->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-mask';

    $params->accessMask = $accessMask;
    $params->paramsMask = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessMask->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysManagement_Ref_Mask_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelMask = $this->loadModel
    (
      'WbfsysManagement_Ref_Mask_'.$listType
    );
    $modelMask->setAccess( $accessMask );
    
    $view->setModel( $modelMask );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdMask = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysManagement_Ref_Mask_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_management-ref-mask-'.$listType.'-ajax',
    	'WbfsysManagement_Ref_Mask_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysMask by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_mask' ); //def wbfsys_mask


  } // end public function cleanPost */

} // end WbfsysManagement_Ref_Mask_Controller
