 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_FileType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysManagement_Ref_FileType_Table_Element
   */
  public function createListItem( $idWbfsysManagement, $data, $access, $params  )
  {
    ...
    $table = new WbfsysManagement_Ref_FileType_Table_Element
    (
      'tableFileType',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-file_type-'.$idWbfsysManagement;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_management-ref-file_type-search-'
        .$idWbfsysManagement;
    ...
    $tabPanel->searchKey = 'wbfsys_management-ref-file_type';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.get(\'modal.php?c=Wbfsys.FileType.selection&exclude=wbfsys_vref_file_type-vid-id_type&objid='.$params->refId.'&target_mask=WbfsysManagement_Ref_FileType&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdFileType', $idWbfsysManagement );
    $view->addVar
    (
      'searchFormActionFileType',
      'ajax.php?c=Wbfsys.Management_Ref_FileType.search&amp;target_id='
...
}//end class WbfsysManagement_Ref_FileType_Table_Ui
