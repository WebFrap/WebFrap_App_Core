 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_FileType_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysManagement, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysManagement_Ref_FileType_Table' );
    /* @var $query WbfsysManagement_Ref_FileType_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_vref_file_type.vid = '.$idWbfsysManagement );
...
}//end class WbfsysManagement_Ref_FileType_Table_Model
