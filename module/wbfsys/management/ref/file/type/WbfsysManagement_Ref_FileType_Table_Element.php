 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_FileType_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_management-file_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysVrefFileType_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysManagement_Ref_FileType';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VrefFileType.show&amp;target_mask=WbfsysManagement_Ref_FileType&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VrefFileType.delete&amp;target_mask=WbfsysManagement_Ref_FileType&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.vref_file_type.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Mimetype', 'wbfsys.file_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Ending', 'wbfsys.file_type.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_vref_file_type_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.VrefFileType.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_file_type_name'])).'</a></td>'.NL;
...
}//end class WbfsysManagement_Ref_FileType_Table_Element
