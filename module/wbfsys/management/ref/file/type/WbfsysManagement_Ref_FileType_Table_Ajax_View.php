 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_FileType_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Management_Ref_FileType.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysManagement_Ref_FileType_Table_Ajax_View
