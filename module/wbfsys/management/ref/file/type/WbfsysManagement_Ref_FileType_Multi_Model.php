 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_FileType_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listFileType = $this->getRegisterd('listRefFileType'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listFileType was not registered'
        );
      }

      foreach( $listFileType as $entityWbfsysManagement )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefFileType',$listWbfsysVrefFileType);
      return true;
...
}//end class WbfsysManagement_Ref_FileType_Multi_Model
