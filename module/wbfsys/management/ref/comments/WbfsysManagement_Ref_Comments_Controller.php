 ...
 * If you want to extend this class write your coden in ControllerWbfsysManagement
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_management management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysManagement_Ref_Comments_".$listType."_Access";
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_management-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysManagement_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysManagement_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_management-ref-comments-'.$listType.'-ajax',
    	'WbfsysManagement_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysManagement
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysManagement_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysManagement_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysManagement_Ref_Comments_'.$listType );
...
} // end WbfsysManagement_Ref_Comments_Controller
