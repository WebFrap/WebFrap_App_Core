 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Management_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysManagement_Ref_Comments_Table_Ajax_View
