 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysManagement_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysManagement, $data, $access, $params  )
  {
    ...
    $table = new WbfsysManagement_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysManagement;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_management-ref-comments-search-'
        .$idWbfsysManagement;
    ...
    $tabPanel->searchKey = 'wbfsys_management-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Comment',
            '$R.get(\'modal.php?c=Wbfsys.Comment.selection&exclude=wbfsys_entity_comment-vid-id_comment&objid='.$params->refId.'&target_mask=WbfsysManagement_Ref_Comments&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysManagement );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Management_Ref_Comments.search&amp;target_id='
...
}//end class WbfsysManagement_Ref_Comments_Table_Ui
