 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.Management_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_management-ref-comments-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/management/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysManagement_Ref_Comments_Table' );
...
}//end class WbfsysManagement_Ref_Comments_Table_Modal_View
