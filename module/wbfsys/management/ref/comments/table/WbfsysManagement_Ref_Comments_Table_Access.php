 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysManagement_Ref_Comments_Table_Query $query
...
}//end class WbfsysManagement_Ref_Comments_Table_Access
