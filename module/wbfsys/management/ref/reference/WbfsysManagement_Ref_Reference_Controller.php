 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Reference_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des reference Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysManagement_Ref_Reference_".$listType."_Access";
    ...
    $accessReference = new $containerClass( );
    $accessReference->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-reference';

    $params->accessReference = $accessReference;
    $params->paramsReference = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessReference->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysManagement_Ref_Reference_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelReference = $this->loadModel
    (
      'WbfsysManagement_Ref_Reference_'.$listType
    );
    $modelReference->setAccess( $accessReference );
    
    $view->setModel( $modelReference );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdReference = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysManagement_Ref_Reference_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_management-ref-reference-'.$listType.'-ajax',
    	'WbfsysManagement_Ref_Reference_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysManagementReference by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_management_reference' ); //def wbfsys_management_reference


  } // end public function cleanPost */

} // end WbfsysManagement_Ref_Reference_Controller
