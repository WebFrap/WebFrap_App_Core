 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Reference_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysManagement
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysManagement_Ref_Reference_Table_Element
   */
  public function createListItem( $idWbfsysManagement, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysManagement_Ref_Reference_Table_Element
    (
      'tableReference',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-reference-'.$idWbfsysManagement;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_management-ref-reference-search-'
        .$idWbfsysManagement;
    ...
    $tabPanel->searchKey = 'wbfsys_management-ref-reference';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Management Reference',
            '$R.post(\'maintab.php?c=Wbfsys.ManagementReference.create&refid='.$params->refId.'&target_mask=WbfsysManagement_Ref_Reference&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_management_reference[id_from]\':\''.$params->refIdReference.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabReference', true );
    $view->addVar( 'refIdReference', $idWbfsysManagement );
    $view->addVar
    (
      'searchFormActionReference',
      'ajax.php?c=Wbfsys.Management_Ref_Reference.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysManagement
    );
   ...
   * @return WbfsysManagement_Ref_Reference_Table_Element
   */
  public function getListItem( $idWbfsysManagement, $data, $access, $params  )
  {
   ...
   * @return WbfsysManagement_Ref_Reference_Table_Element
   */
  public function listEntry( $idWbfsysManagement, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowReference' , $table->buildAjax() );
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysManagement_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysManagement_Ref_Reference_Table_Ui
