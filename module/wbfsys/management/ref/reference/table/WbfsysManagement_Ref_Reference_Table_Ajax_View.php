 ...
 * @licence WebFrap.net
 */
class WbfsysManagement_Ref_Reference_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Management_Ref_Reference.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysManagement_Ref_Reference_Table_Ajax_View
