...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_theme_layout';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysThemeLayout';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysThemeLayout' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysThemeLayout entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.theme_layout.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.theme_layout.label' ),
  ...
  * @return void
  */
  public function input_path( $params )
  {

      //tpl: class ui:text
      $inputPath = $this->view->newInput( 'input'.$this->prefix.'Path' , 'Text' );
      $this->items['path'] = $inputPath;
      $inputPath->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[path]',
          'id'        => 'wgt-input-'.$this->keyName.'_path'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Path (Theme Layout)', 'wbfsys.theme_layout.label' ),
          'maxlength' => $this->entity->maxSize( 'path' ),
        )
      );
      $inputPath->setWidth( 'medium' );

      $inputPath->setReadOnly( $this->isReadOnly( 'path' ) );
      $inputPath->setData( $this->entity->getSecure('path') );
      $inputPath->setLabel
      (
        $this->view->i18n->l( 'Path', 'wbfsys.theme_layout.label' ),
        $this->entity->required( 'path' )
      );
  ...
  }//end public function input_path */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Theme Layout)', 'wbfsys.theme_layout.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.theme_layout.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Theme Layout)', 'wbfsys.theme_layout.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.theme_layout.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.theme_layout.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.theme_layout.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.theme_layout.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Theme Layout)', 'wbfsys.theme_layout.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.theme_layout.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Theme Layout)', 'wbfsys.theme_layout.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.theme_layout.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Theme Layout)', 'wbfsys.theme_layout.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.theme_layout.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Theme Layout)', 'wbfsys.theme_layout.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Theme Layout)', 'wbfsys.theme_layout.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_theme_layout_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_theme_layout_m_role_change';
...
}//end class WbfsysThemeLayout_Form */
