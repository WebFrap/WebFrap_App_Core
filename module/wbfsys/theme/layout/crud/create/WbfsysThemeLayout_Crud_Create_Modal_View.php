 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysThemeLayout entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ThemeLayout.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ThemeLayout.insert';
    $params->formId       = 'wgt-form-wbfsys_theme_layout';
    $params->namespace   = 'wbfsys_theme_layout-create';
    ...
    $this->setTemplate( 'wbfsys/theme_layout/modal/crud/form_create' );
...
}//end class WbfsysThemeLayout_Crud_Create_Modal_View
