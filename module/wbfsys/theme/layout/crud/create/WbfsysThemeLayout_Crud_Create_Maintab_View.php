 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysThemeLayout Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_theme_layout-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/theme_layout/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ThemeLayout.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_theme_layout';
    ...
    $form = $this->newForm( 'WbfsysThemeLayout_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ThemeLayout.create');}});
});
...
}//end class WbfsysThemeLayout_Crud_Create_Maintab_View
