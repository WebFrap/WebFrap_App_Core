 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysThemeLayout_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysThemeLayout_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysThemeLayout_Entity */
      $entity = $orm->get( 'WbfsysThemeLayout', $rootId );
    }
...
}//end class WbfsysThemeLayout_Crud_Access_Root
