 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysThemeLayout Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysThemeLayout = $this->model->getEntityWbfsysThemeLayout();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Layout Themes: {@text@}',
      'wbfsys.theme_layout.label',
      array( 'text' => $entityWbfsysThemeLayout->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ThemeLayout.show  &amp;objid='.$entityWbfsysThemeLayout
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ThemeLayout.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_theme_layout-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/theme_layout/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysThemeLayout_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ThemeLayout.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_theme_layout' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_theme_layout a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ThemeLayout.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ThemeLayout.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysThemeLayout_Crud_Show_Maintab_View
