 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysThemeLayout Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysThemeLayout = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Layout Themes: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ThemeLayout.edit&amp;utf8=✓&amp;objid='.$entityWbfsysThemeLayout
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ThemeLayout.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_theme_layout-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/theme_layout/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysThemeLayout_Crud_Edit' );
...
}//end class WbfsysThemeLayout_Crud_Edit_Maintab_View
