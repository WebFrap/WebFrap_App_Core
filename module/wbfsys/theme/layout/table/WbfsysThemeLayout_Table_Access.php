 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysThemeLayout_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_theme_layout.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_theme_layout.rowid ",
      'acls'
    );
...
}//end class WbfsysThemeLayout_Table_Access
