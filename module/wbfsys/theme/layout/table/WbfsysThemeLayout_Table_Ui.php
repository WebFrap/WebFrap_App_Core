 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Layout Themes
  *
  ...
  *  }
  *
  * @return WbfsysThemeLayout_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysThemeLayout_Table_Element( 'tableWbfsysThemeLayout', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_theme_layout-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Layout Themes', 'wbfsys.theme_layout.label' );
      //$tabPanel->searchKey = 'wbfsys_theme_layout';
      ...
      $searchElement->searchKey = 'wbfsys_theme_layout';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysThemeLayout_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysThemeLayout', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysThemeLayout listing maske
   *
   * @param WbfsysThemeLayout_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysThemeLayout  = $model->getEntityWbfsysThemeLayout();
    ...
    $formWbfsysThemeLayout->setKeyName( 'wbfsys_theme_layout' );
...
}//end class WbfsysThemeLayout_Table_Ui
