 ...
 * @licence WebFrap.net
 */
class WbfsysThemeLayout_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_theme_layout';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysThemeLayout_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ThemeLayout.show&amp;target_mask=WbfsysThemeLayout&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ThemeLayout.edit&amp;target_mask=WbfsysThemeLayout&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.theme_layout.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ThemeLayout.delete&amp;target_mask=WbfsysThemeLayout&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.theme_layout.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.theme_layout.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_theme_layout_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ThemeLayout.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_theme_layout_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ThemeLayout_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Layout Themes." >{$iconDelete} Delete selected Layout Themes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Layout Themes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ThemeLayout_Multi.deleteAll" >{$iconClean} Delete all Layout Themes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysThemeLayout_Table_Element
