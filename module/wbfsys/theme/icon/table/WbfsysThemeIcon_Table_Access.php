 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysThemeIcon_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_theme_icon.rowid ",
      'acls'
    );
...
}//end class WbfsysThemeIcon_Table_Access
