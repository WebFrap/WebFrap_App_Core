 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Icon Themes
  *
  ...
  *  }
  *
  * @return WbfsysThemeIcon_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysThemeIcon_Table_Element( 'tableWbfsysThemeIcon', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_theme_icon-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Icon Themes', 'wbfsys.theme_icon.label' );
      //$tabPanel->searchKey = 'wbfsys_theme_icon';
      ...
      $searchElement->searchKey = 'wbfsys_theme_icon';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysThemeIcon_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysThemeIcon', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysThemeIcon listing maske
   *
   * @param WbfsysThemeIcon_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysThemeIcon  = $model->getEntityWbfsysThemeIcon();
    ...
    $formWbfsysThemeIcon->setKeyName( 'wbfsys_theme_icon' );
...
}//end class WbfsysThemeIcon_Table_Ui
