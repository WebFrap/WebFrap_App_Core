 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_theme_icon';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysThemeIcon_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ThemeIcon.show&amp;target_mask=WbfsysThemeIcon&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ThemeIcon.edit&amp;target_mask=WbfsysThemeIcon&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.theme_icon.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ThemeIcon.delete&amp;target_mask=WbfsysThemeIcon&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.theme_icon.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.theme_icon.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_theme_icon_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ThemeIcon.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_theme_icon_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ThemeIcon_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Icon Themes." >{$iconDelete} Delete selected Icon Themes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Icon Themes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ThemeIcon_Multi.deleteAll" >{$iconClean} Delete all Icon Themes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysThemeIcon_Table_Element
