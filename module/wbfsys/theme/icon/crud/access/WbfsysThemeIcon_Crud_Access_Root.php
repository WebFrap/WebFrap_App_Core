 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysThemeIcon_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysThemeIcon_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysThemeIcon_Entity */
      $entity = $orm->get( 'WbfsysThemeIcon', $rootId );
    }
...
}//end class WbfsysThemeIcon_Crud_Access_Root
