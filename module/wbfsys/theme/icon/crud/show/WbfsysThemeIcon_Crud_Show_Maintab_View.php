 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysThemeIcon Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysThemeIcon = $this->model->getEntityWbfsysThemeIcon();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Icon Themes: {@text@}',
      'wbfsys.theme_icon.label',
      array( 'text' => $entityWbfsysThemeIcon->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ThemeIcon.show  &amp;objid='.$entityWbfsysThemeIcon
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ThemeIcon.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_theme_icon-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/theme_icon/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysThemeIcon_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ThemeIcon.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_theme_icon' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_theme_icon a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ThemeIcon.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ThemeIcon.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysThemeIcon_Crud_Show_Maintab_View
