 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysThemeIcon entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ThemeIcon.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ThemeIcon.insert';
    $params->formId       = 'wgt-form-wbfsys_theme_icon';
    $params->namespace   = 'wbfsys_theme_icon-create';
    ...
    $this->setTemplate( 'wbfsys/theme_icon/modal/crud/form_create' );
...
}//end class WbfsysThemeIcon_Crud_Create_Modal_View
