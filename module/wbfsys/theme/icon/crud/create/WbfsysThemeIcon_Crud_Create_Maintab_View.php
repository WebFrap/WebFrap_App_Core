 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysThemeIcon Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_theme_icon-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/theme_icon/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ThemeIcon.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_theme_icon';
    ...
    $form = $this->newForm( 'WbfsysThemeIcon_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ThemeIcon.create');}});
});
...
}//end class WbfsysThemeIcon_Crud_Create_Maintab_View
