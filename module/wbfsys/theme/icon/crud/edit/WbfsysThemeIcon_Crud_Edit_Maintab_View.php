 ...
 * @licence WebFrap.net
 */
class WbfsysThemeIcon_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysThemeIcon Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysThemeIcon = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Icon Themes: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ThemeIcon.edit&amp;utf8=✓&amp;objid='.$entityWbfsysThemeIcon
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ThemeIcon.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_theme_icon-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/theme_icon/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysThemeIcon_Crud_Edit' );
...
}//end class WbfsysThemeIcon_Crud_Edit_Maintab_View
