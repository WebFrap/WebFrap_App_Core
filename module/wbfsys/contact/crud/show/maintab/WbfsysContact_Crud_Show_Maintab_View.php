 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysContact Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysContact = $this->model->getEntityWbfsysContact();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Contact.show  &amp;objid='.$entityWbfsysContact
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Contact.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_contact-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/contact/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysContact_Crud_Show' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Contact.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysContact_Crud_Show_Maintab_View
