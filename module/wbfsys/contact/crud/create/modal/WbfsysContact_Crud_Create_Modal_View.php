 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysContact entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Contact.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Contact.insert';
    $params->formId       = 'wgt-form-wbfsys_contact';
    $params->namespace   = 'wbfsys_contact-create';
    ...
    $this->setTemplate( 'wbfsys/contact/modal/crud/form_create' );
...
}//end class WbfsysContact_Crud_Create_Modal_View
