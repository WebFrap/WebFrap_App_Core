 ...
 *
 * Entity Class for the Database Table wbfsys_contact
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_contact';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Contact.show';
  ...
  */
  public static $entityName  = 'WbfsysContact';
  ...
  */
  ...
  (
    'id_person' => array
    (
      'default' => 'wbfsys.contact.message.error_def_id_person',
      'wrong'   => 'wbfsys.contact.message.error_wrong_id_person',
      'max'     => 'wbfsys.contact.message.error_max_id_person',
      'min'     => 'wbfsys.contact.message.error_min_id_person',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.contact.message.error_def_rowid',
      'wrong'   => 'wbfsys.contact.message.error_wrong_rowid',
      'empty'   => 'wbfsys.contact.message.error_empty_rowid',
      'max'     => 'wbfsys.contact.message.error_max_rowid',
      'min'     => 'wbfsys.contact.message.error_min_rowid',
    ),
  );

}//end class WbfsysContact_Entity
