 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Ref_AddressItem_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysContact
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysContact_Ref_AddressItem_Table_Element
   */
  public function createListItem( $idWbfsysContact, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysContact_Ref_AddressItem_Table_Element
    (
      'tableAddressItem',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-address_item-'.$idWbfsysContact;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_contact-ref-address_item-search-'
        .$idWbfsysContact;
    ...
    $tabPanel->searchKey = 'wbfsys_contact-ref-address_item';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.AddressItem.create&refid='.$params->refId.'&target_mask=WbfsysContact_Ref_AddressItem&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_address_item[vid]\':\''.$params->refIdAddressItem.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdAddressItem', $idWbfsysContact );
    $view->addVar
    (
      'searchFormActionAddressItem',
      'ajax.php?c=Wbfsys.Contact_Ref_AddressItem.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysContact
    );
   ...
   * @return WbfsysContact_Ref_AddressItem_Table_Element
   */
  public function getListItem( $idWbfsysContact, $data, $access, $params  )
  {
   ...
   * @return WbfsysContact_Ref_AddressItem_Table_Element
   */
  public function listEntry( $idWbfsysContact, $access, $params, $insertMode )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysContact_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysContact_Ref_AddressItem_Table_Ui
