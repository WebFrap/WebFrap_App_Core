 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Ref_AddressItem_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysContact_Ref_AddressItem_Table_Query $query
...
}//end class WbfsysContact_Ref_AddressItem_Table_Access
