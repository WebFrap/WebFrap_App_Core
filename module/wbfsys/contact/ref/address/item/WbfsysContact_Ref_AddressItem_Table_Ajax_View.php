 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Ref_AddressItem_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Contact_Ref_AddressItem.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysContact_Ref_AddressItem_Table_Ajax_View
