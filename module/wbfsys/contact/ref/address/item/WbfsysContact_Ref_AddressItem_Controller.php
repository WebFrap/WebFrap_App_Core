 ...
 * If you want to extend this class write your coden in ControllerWbfsysContact
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Ref_AddressItem_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des address_item Referenztabs
  * für den wbfsys_contact management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysContact_Ref_AddressItem_".$listType."_Access";
    ...
    $accessAddressItem = new $containerClass( );
    $accessAddressItem->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-address_item';

    $params->accessAddressItem = $accessAddressItem;
    $params->paramsAddressItem = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessAddressItem->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_contact-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysContact_Ref_AddressItem_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelAddressItem = $this->loadModel
    (
      'WbfsysContact_Ref_AddressItem_'.$listType
    );
    $modelAddressItem->setAccess( $accessAddressItem );
    
    $view->setModel( $modelAddressItem );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdAddressItem = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysContact_Ref_AddressItem_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_contact-ref-address_item-'.$listType.'-ajax',
    	'WbfsysContact_Ref_AddressItem_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysAddressItem by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_address_item' ); //def wbfsys_address_item


  } // end public function cleanPost */

} // end WbfsysContact_Ref_AddressItem_Controller
