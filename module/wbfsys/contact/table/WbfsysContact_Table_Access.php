 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysContact_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_contact.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_contact.rowid ",
      'acls'
    );
...
}//end class WbfsysContact_Table_Access
