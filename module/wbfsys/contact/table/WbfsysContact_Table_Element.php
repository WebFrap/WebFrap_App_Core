 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_contact';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysContact_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Contact.show&amp;target_mask=WbfsysContact&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Contact.edit&amp;target_mask=WbfsysContact&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.contact.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Message Items',
            'modal.php?c=Wbfsys.Contact_Ref_AddressItem.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.contact.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Contact.delete&amp;target_mask=WbfsysContact&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.contact.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_contact_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Contact_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Contacts." >{$iconDelete} Delete selected Contacts</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Contacts. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Contact_Multi.deleteAll" >{$iconClean} Delete all Contacts</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysContact_Table_Element
