...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Contacts
  *
  ...
  *  }
  *
  * @return WbfsysContact_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysContact_Table_Element( 'tableWbfsysContact', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_contact-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Contacts', 'wbfsys.contact.label' );
      //$tabPanel->searchKey = 'wbfsys_contact';
      ...
      $searchElement->searchKey = 'wbfsys_contact';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysContact_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysContact', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysContact listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysContact  = $model->getEntityWbfsysContact();
    ...
    $formWbfsysContact->setKeyName( 'wbfsys_contact' );
...
}//end class WbfsysContact_Table_Ui
