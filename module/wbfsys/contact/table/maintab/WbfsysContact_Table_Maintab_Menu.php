 ...
 * @licence WebFrap.net
 */
class WbfsysContact_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new Contact"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_contact-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_contact-table-help hidden" >
    	      
<p>This is the Contact table.</p>
...
HTML;
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolEntity&dkey=wbfsys_contact" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
      </li>


      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsEntity&dkey=wbfsys_contact" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
      </li>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_contact-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysContact_Table_Maintab_Menu
