 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysModule entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Module.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Module.insert';
    $params->formId       = 'wgt-form-wbfsys_module';
    $params->namespace   = 'wbfsys_module-create';
    ...
    $this->setTemplate( 'wbfsys/module/modal/crud/form_create' );
...
}//end class WbfsysModule_Crud_Create_Modal_View
