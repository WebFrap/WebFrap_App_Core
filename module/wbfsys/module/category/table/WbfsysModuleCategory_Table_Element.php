 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_module_category';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysModuleCategory_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ModuleCategory.show&amp;target_mask=WbfsysModuleCategory&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ModuleCategory.edit&amp;target_mask=WbfsysModuleCategory&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.module_category.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ModuleCategory.delete&amp;target_mask=WbfsysModuleCategory&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.module_category.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.module_category.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_module_category_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ModuleCategory.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_category_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ModuleCategory_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Module Categorys." >{$iconDelete} Delete selected Module Categorys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Module Categorys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ModuleCategory_Multi.deleteAll" >{$iconClean} Delete all Module Categorys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysModuleCategory_Table_Element
