 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysModuleCategory_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysModuleCategory_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysModuleCategory_Table_Model
