 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Module Categorys
  *
  ...
  *  }
  *
  * @return WbfsysModuleCategory_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysModuleCategory_Table_Element( 'tableWbfsysModuleCategory', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_module_category-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Module Categorys', 'wbfsys.module_category.label' );
      //$tabPanel->searchKey = 'wbfsys_module_category';
      ...
      $searchElement->searchKey = 'wbfsys_module_category';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysModuleCategory_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysModuleCategory', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysModuleCategory listing maske
   *
   * @param WbfsysModuleCategory_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysModuleCategory  = $model->getEntityWbfsysModuleCategory();
    ...
    $formWbfsysModuleCategory->setKeyName( 'wbfsys_module_category' );
...
}//end class WbfsysModuleCategory_Table_Ui
