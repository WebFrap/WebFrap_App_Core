 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_module_category';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ModuleCategory.show&amp;target_mask=WbfsysModuleCategory&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ModuleCategory.edit&amp;target_mask=WbfsysModuleCategory&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.module_category.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ModuleCategory.delete&amp;target_mask=WbfsysModuleCategory&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.module_category.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_category_name'])).'</td>'.NL;
...
}//end class WbfsysModuleCategory_Selection_Element
