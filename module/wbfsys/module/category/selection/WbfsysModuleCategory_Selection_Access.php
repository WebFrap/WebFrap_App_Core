 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysModuleCategory_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_module_category.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_module_category.rowid ",
      'acls'
    );
...
}//end class WbfsysModuleCategory_Selection_Access
