 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysModuleCategory_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysModuleCategory_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysModuleCategory_Selection_Element
    (
      'selectionWbfsysModuleCategory',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Module Categorys', 'wbfsys.module_category.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ModuleCategory.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysModuleCategory',
      'WbfsysModuleCategory_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysModuleCategory_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysModuleCategory_Selection_Ui
