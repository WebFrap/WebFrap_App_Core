 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysModuleCategory_Selection' ) );
...
} // end class WbfsysModuleCategory_Selection_Controller */
