 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysModuleCategory Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_module_category-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/module_category/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ModuleCategory.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_module_category';
    ...
    $form = $this->newForm( 'WbfsysModuleCategory_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ModuleCategory.create');}});
});
...
}//end class WbfsysModuleCategory_Crud_Create_Maintab_View
