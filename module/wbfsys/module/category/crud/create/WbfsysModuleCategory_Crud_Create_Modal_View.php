 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysModuleCategory entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ModuleCategory.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ModuleCategory.insert';
    $params->formId       = 'wgt-form-wbfsys_module_category';
    $params->namespace   = 'wbfsys_module_category-create';
    ...
    $this->setTemplate( 'wbfsys/module_category/modal/crud/form_create' );
...
}//end class WbfsysModuleCategory_Crud_Create_Modal_View
