 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysModuleCategory Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysModuleCategory = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Module Category: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ModuleCategory.edit&amp;utf8=✓&amp;objid='.$entityWbfsysModuleCategory
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ModuleCategory.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_module_category-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/module_category/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysModuleCategory_Crud_Edit' );
...
}//end class WbfsysModuleCategory_Crud_Edit_Maintab_View
