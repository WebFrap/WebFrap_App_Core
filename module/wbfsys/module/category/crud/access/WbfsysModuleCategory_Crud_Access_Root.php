 ...
 * @licence WebFrap.net
 */
class WbfsysModuleCategory_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysModuleCategory_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysModuleCategory_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysModuleCategory_Entity */
      $entity = $orm->get( 'WbfsysModuleCategory', $rootId );
    }
...
}//end class WbfsysModuleCategory_Crud_Access_Root
