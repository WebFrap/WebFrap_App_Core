 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_module_setting';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysModuleSetting_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ModuleSetting.show&amp;target_mask=WbfsysModuleSetting&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ModuleSetting.edit&amp;target_mask=WbfsysModuleSetting&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.module_setting.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ModuleSetting.delete&amp;target_mask=WbfsysModuleSetting&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.module_setting.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.module_setting.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Module', 'wbfsys.module_setting.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Value', 'wbfsys.module_setting.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.module_setting.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_module_setting_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_setting_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_setting_value'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_module_setting_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ModuleSetting_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Module Settings." >{$iconDelete} Delete selected Module Settings</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Module Settings. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ModuleSetting_Multi.deleteAll" >{$iconClean} Delete all Module Settings</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysModuleSetting_Table_Element
