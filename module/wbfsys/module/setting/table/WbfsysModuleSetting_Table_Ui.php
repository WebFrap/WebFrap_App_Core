 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Module Settings
  *
  ...
  *  }
  *
  * @return WbfsysModuleSetting_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysModuleSetting_Table_Element( 'tableWbfsysModuleSetting', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_module_setting-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Module Settings', 'wbfsys.module_setting.label' );
      //$tabPanel->searchKey = 'wbfsys_module_setting';
      ...
      $searchElement->searchKey = 'wbfsys_module_setting';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysModuleSetting_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysModuleSetting', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysModuleSetting listing maske
   *
   * @param WbfsysModuleSetting_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysModuleSetting  = $model->getEntityWbfsysModuleSetting();
    ...
    $formWbfsysModuleSetting->setKeyName( 'wbfsys_module_setting' );
...
}//end class WbfsysModuleSetting_Table_Ui
