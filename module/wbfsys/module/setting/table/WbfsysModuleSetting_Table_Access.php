 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysModuleSetting_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_module_setting.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_module_setting.rowid ",
      'acls'
    );
...
}//end class WbfsysModuleSetting_Table_Access
