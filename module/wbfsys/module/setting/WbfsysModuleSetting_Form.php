 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_module_setting';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysModuleSetting';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysModuleSetting' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysModuleSetting entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Module Setting)', 'wbfsys.module_setting.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.module_setting.label' ),
  ...
  */
  public function input_id_module( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysModule_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdModule = $this->view->newItem( 'input'.$this->prefix.'IdModule' , 'WbfsysModule_Selectbox' );
      $this->items['id_module'] = $inputIdModule;
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Module (Module Setting)', 'wbfsys.module_setting.label' ),
        )
      );
      ...
      $inputIdModule->setLabel
      (
        $this->view->i18n->l( 'Module', 'wbfsys.module_setting.label' ),
        $this->entity->required( 'id_module' )
      );
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputIdModule->editUrl = 'index.php?c=Wbfsys.Module.listing&amp;target='.$this->namespace.'&amp;field=id_module&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_module'.$this->suffix;
      }
  ...
  public function input_value( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Value (Module Setting)', 'wbfsys.module_setting.label' ),
      ...
      $inputValue->setLabel
      (
        $this->view->i18n->l( 'Value', 'wbfsys.module_setting.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Module Setting)', 'wbfsys.module_setting.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.module_setting.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Module Setting)', 'wbfsys.module_setting.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.module_setting.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Module Setting)', 'wbfsys.module_setting.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.module_setting.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Module Setting)', 'wbfsys.module_setting.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.module_setting.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Module Setting)', 'wbfsys.module_setting.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.module_setting.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Module Setting)', 'wbfsys.module_setting.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.module_setting.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Module Setting)', 'wbfsys.module_setting.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.module_setting.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Module Setting)', 'wbfsys.module_setting.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.module_setting.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Module Setting)', 'wbfsys.module_setting.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_module_setting_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_module_setting_m_role_change';
...
}//end class WbfsysModuleSetting_Form */
