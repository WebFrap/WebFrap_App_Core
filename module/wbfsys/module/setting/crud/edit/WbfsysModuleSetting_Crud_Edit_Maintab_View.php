 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysModuleSetting Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysModuleSetting = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Module Setting: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ModuleSetting.edit&amp;utf8=✓&amp;objid='.$entityWbfsysModuleSetting
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ModuleSetting.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_module_setting-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/module_setting/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysModuleSetting_Crud_Edit' );
...
}//end class WbfsysModuleSetting_Crud_Edit_Maintab_View
