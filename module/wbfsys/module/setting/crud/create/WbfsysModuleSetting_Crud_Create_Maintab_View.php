 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysModuleSetting Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_module_setting-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/module_setting/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ModuleSetting.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_module_setting';
    ...
    $form = $this->newForm( 'WbfsysModuleSetting_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ModuleSetting.create');}});
});
...
}//end class WbfsysModuleSetting_Crud_Create_Maintab_View
