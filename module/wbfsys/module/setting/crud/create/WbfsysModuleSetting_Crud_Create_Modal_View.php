 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysModuleSetting entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ModuleSetting.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ModuleSetting.insert';
    $params->formId       = 'wgt-form-wbfsys_module_setting';
    $params->namespace   = 'wbfsys_module_setting-create';
    ...
    $this->setTemplate( 'wbfsys/module_setting/modal/crud/form_create' );
...
}//end class WbfsysModuleSetting_Crud_Create_Modal_View
