 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysModuleSetting', array_keys( $this->fields['wbfsys_module_setting']), true ),
...
}//end class WbfsysModuleSetting_Crud_Create_Form */
