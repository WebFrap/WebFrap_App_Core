 ...
 * @licence WebFrap.net
 */
class WbfsysModuleSetting_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysModuleSetting_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysModuleSetting_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysModuleSetting_Entity */
      $entity = $orm->get( 'WbfsysModuleSetting', $rootId );
    }
...
}//end class WbfsysModuleSetting_Crud_Access_Root
