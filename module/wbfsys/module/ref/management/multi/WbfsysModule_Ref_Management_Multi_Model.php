 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Management_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listManagement = $this->getRegisterd('listRefManagement'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listManagement was not registered'
        );
      }

      foreach( $listManagement as $entityWbfsysModule )
      {
        if(!$orm->save( $entityWbfsysModule) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Module '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Module '.$entityText,
              'wbfsys.module.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listManagement as $entityWbfsysModule )
      {
        ...
        {
          $entityTexts[] = $entityText = $entityWbfsysModule->text();
        }
      }
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Module: '.$textSaved,
          'wbfsys.module.message',
          array($textSaved)
        )
      );
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefManagement',$listWbfsysManagement);
      return true;
...
}//end class WbfsysModule_Ref_Management_Multi_Model
