 ...
 * If you want to extend this class write your coden in ControllerWbfsysModule
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Management_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des management Referenztabs
  * für den wbfsys_module management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysModule_Ref_Management_".$listType."_Access";
    ...
    $accessManagement = new $containerClass( );
    $accessManagement->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-management';

    $params->accessManagement = $accessManagement;
    $params->paramsManagement = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessManagement->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_module-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysModule_Ref_Management_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelManagement = $this->loadModel
    (
      'WbfsysModule_Ref_Management_'.$listType
    );
    $modelManagement->setAccess( $accessManagement );
    
    $view->setModel( $modelManagement );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdManagement = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysModule_Ref_Management_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_module-ref-management-'.$listType.'-ajax',
    	'WbfsysModule_Ref_Management_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysManagement by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_management' ); //def wbfsys_management


  } // end public function cleanPost */

} // end WbfsysModule_Ref_Management_Controller
