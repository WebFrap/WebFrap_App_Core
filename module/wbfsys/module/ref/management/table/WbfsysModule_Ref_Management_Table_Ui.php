 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Management_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysModule
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysModule_Ref_Management_Table_Element
   */
  public function createListItem( $idWbfsysModule, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysModule_Ref_Management_Table_Element
    (
      'tableManagement',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-management-'.$idWbfsysModule;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_module-ref-management-search-'
        .$idWbfsysModule;
    ...
    $tabPanel->searchKey = 'wbfsys_module-ref-management';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.Management.create&refid='.$params->refId.'&target_mask=WbfsysModule_Ref_Management&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_management[id_module]\':\''.$params->refIdManagement.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabManagement', true );
    $view->addVar( 'refIdManagement', $idWbfsysModule );
    $view->addVar
    (
      'searchFormActionManagement',
      'ajax.php?c=Wbfsys.Module_Ref_Management.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysModule
    );
   ...
   * @return WbfsysModule_Ref_Management_Table_Element
   */
  public function getListItem( $idWbfsysModule, $data, $access, $params  )
  {
   ...
   * @return WbfsysModule_Ref_Management_Table_Element
   */
  public function listEntry( $idWbfsysModule, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowManagement' , $table->buildAjax() );
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysModule_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysManagement  = $model->getEntityWbfsysManagement();
    ...
    $formWbfsysManagement->setKeyName( 'wbfsys_management' );
...
}//end class WbfsysModule_Ref_Management_Table_Ui
