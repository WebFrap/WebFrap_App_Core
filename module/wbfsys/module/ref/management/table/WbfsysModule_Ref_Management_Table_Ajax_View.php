 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Management_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Module_Ref_Management.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysModule_Ref_Management_Table_Ajax_View
