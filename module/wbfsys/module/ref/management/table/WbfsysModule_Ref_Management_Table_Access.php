 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Management_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-management',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-management' );
  ...
  /**
   * @param WbfsysModule_Ref_Management_Table_Query $query
...
}//end class WbfsysModule_Ref_Management_Table_Access
