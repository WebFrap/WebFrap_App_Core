 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Entity_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des entity Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysModule_Ref_Entity_".$listType."_Access";
    ...
    $accessEntity = new $containerClass( );
    $accessEntity->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-entity';

    $params->accessEntity = $accessEntity;
    $params->paramsEntity = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessEntity->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysModule_Ref_Entity_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelEntity = $this->loadModel
    (
      'WbfsysModule_Ref_Entity_'.$listType
    );
    $modelEntity->setAccess( $accessEntity );
    
    $view->setModel( $modelEntity );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdEntity = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysModule_Ref_Entity_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_module-ref-entity-'.$listType.'-ajax',
    	'WbfsysModule_Ref_Entity_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysEntity by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_entity' ); //def wbfsys_entity


  } // end public function cleanPost */

} // end WbfsysModule_Ref_Entity_Controller
