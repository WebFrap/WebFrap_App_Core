 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Entity_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listEntity = $this->getRegisterd('listRefEntity'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listEntity was not registered'
        );
      }

      foreach( $listEntity as $entityWbfsysModule )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefEntity',$listWbfsysEntity);
      return true;
...
}//end class WbfsysModule_Ref_Entity_Multi_Model
