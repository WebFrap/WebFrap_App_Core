 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Entity_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysModule_Ref_Entity_Table_Element
   */
  public function createListItem( $idWbfsysModule, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysModule_Ref_Entity_Table_Element
    (
      'tableEntity',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-entity-'.$idWbfsysModule;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_module-ref-entity-search-'
        .$idWbfsysModule;
    ...
    $tabPanel->searchKey = 'wbfsys_module-ref-entity';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Entity',
            '$R.post(\'maintab.php?c=Wbfsys.Entity.create&refid='.$params->refId.'&target_mask=WbfsysModule_Ref_Entity&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity[id_module]\':\''.$params->refIdEntity.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabEntity', true );
    $view->addVar( 'refIdEntity', $idWbfsysModule );
    $view->addVar
    (
      'searchFormActionEntity',
      'ajax.php?c=Wbfsys.Module_Ref_Entity.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysModule, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowEntity' , $table->buildAjax() );
...
JSCODE;
  ...
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysEntity  = $model->getEntityWbfsysEntity();
    ...
    $formWbfsysEntity->setKeyName( 'wbfsys_entity' );
...
}//end class WbfsysModule_Ref_Entity_Table_Ui
