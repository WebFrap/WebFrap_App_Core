 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Ref_Entity_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Module_Ref_Entity.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysModule_Ref_Entity_Table_Ajax_View
