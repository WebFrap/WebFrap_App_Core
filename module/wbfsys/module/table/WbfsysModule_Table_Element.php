 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_module';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysModule_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Module.show&amp;target_mask=WbfsysModule&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.module.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Module.edit&amp;target_mask=WbfsysModule&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.module.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Entities',
            'modal.php?c=Wbfsys.Module_Ref_Entity.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.module.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Managements',
            'modal.php?c=Wbfsys.Module_Ref_Management.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.module.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Module.delete&amp;target_mask=WbfsysModule&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.module.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.module.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Module.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Module_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Modules." >{$iconDelete} Delete selected Modules</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Modules. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Module_Multi.deleteAll" >{$iconClean} Delete all Modules</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysModule_Table_Element
