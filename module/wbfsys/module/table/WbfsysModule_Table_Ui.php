...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Modules
  *
  ...
  *  }
  *
  * @return WbfsysModule_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysModule_Table_Element( 'tableWbfsysModule', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_module-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Modules', 'wbfsys.module.label' );
      //$tabPanel->searchKey = 'wbfsys_module';
      ...
      $searchElement->searchKey = 'wbfsys_module';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysModule_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysModule', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysModule listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysModule  = $model->getEntityWbfsysModule();
    ...
    $formWbfsysModule->setKeyName( 'wbfsys_module' );
...
}//end class WbfsysModule_Table_Ui
