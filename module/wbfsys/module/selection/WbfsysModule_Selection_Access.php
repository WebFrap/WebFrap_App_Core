 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysModule_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_module.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_module.rowid ",
      'acls'
    );
...
}//end class WbfsysModule_Selection_Access
