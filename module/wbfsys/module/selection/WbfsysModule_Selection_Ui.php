 ...
 * @licence WebFrap.net
 */
class WbfsysModule_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysModule_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysModule_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysModule_Selection_Element
    (
      'selectionWbfsysModule',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Modules', 'wbfsys.module.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Module.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysModule',
      'WbfsysModule_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysModule_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysModule_Selection_Ui
