 ...
 *
 * Entity Class for the Database Table wbfsys_menu
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_menu';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Menu.show';
  ...
  */
  public static $entityName  = 'WbfsysMenu';
  ...
  */
  ...
  (
    'access_key' => array
    (
      'default' => 'wbfsys.menu.message.error_def_access_key',
      'wrong'   => 'wbfsys.menu.message.error_wrong_access_key',
      'max'     => 'wbfsys.menu.message.error_max_access_key',
      'min'     => 'wbfsys.menu.message.error_min_access_key',
    ),

    'id_mask' => array
    (
      'default' => 'wbfsys.menu.message.error_def_id_mask',
      'wrong'   => 'wbfsys.menu.message.error_wrong_id_mask',
      'max'     => 'wbfsys.menu.message.error_max_id_mask',
      'min'     => 'wbfsys.menu.message.error_min_id_mask',
    ),

    'description' => array
    (
      'default' => 'wbfsys.menu.message.error_def_description',
      'wrong'   => 'wbfsys.menu.message.error_wrong_description',
      'max'     => 'wbfsys.menu.message.error_max_description',
      'min'     => 'wbfsys.menu.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.menu.message.error_def_rowid',
      'wrong'   => 'wbfsys.menu.message.error_wrong_rowid',
      'empty'   => 'wbfsys.menu.message.error_empty_rowid',
      'max'     => 'wbfsys.menu.message.error_max_rowid',
      'min'     => 'wbfsys.menu.message.error_min_rowid',
    ),
  );

}//end class WbfsysMenu_Entity
