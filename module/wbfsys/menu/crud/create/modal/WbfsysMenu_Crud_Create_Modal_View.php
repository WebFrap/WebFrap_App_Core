 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMenu entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Menu.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Menu.insert';
    $params->formId       = 'wgt-form-wbfsys_menu';
    $params->namespace   = 'wbfsys_menu-create';
    ...
    $this->setTemplate( 'wbfsys/menu/modal/crud/form_create' );
...
}//end class WbfsysMenu_Crud_Create_Modal_View
