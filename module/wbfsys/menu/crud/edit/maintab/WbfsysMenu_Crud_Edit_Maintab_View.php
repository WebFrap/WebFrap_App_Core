 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMenu Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMenu = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Menu.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMenu
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Menu.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_menu-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/menu/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMenu_Crud_Edit' );
...
}//end class WbfsysMenu_Crud_Edit_Maintab_View
