 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMenu Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMenu = $this->model->getEntityWbfsysMenu();
    ...
    (
      'Show Menus: {@text@}',
      'wbfsys.menu.label',
      array( 'text' => $entityWbfsysMenu->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Menu.show  &amp;objid='.$entityWbfsysMenu
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Menu.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_menu-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/menu/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMenu_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Menu.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_menu' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_menu a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Menu.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Menu.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMenu_Crud_Show_Maintab_View
