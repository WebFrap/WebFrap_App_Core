...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Menus
  *
  ...
  *  }
  *
  * @return WbfsysMenu_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMenu_Table_Element( 'tableWbfsysMenu', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_menu-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Menus', 'wbfsys.menu.label' );
      //$tabPanel->searchKey = 'wbfsys_menu';
      ...
      $searchElement->searchKey = 'wbfsys_menu';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMenu_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMenu', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMenu listing maske
   *
   * @param WbfsysMenu_Table_Model $model
   * @param TFlag $params
   * @return void
   */
