 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_menu';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMenu_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Menu.show&amp;target_mask=WbfsysMenu&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.menu.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Menu.edit&amp;target_mask=WbfsysMenu&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.menu.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Menu.delete&amp;target_mask=WbfsysMenu&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.menu.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Menu_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Menus." >{$iconDelete} Delete selected Menus</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Menus. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Menu_Multi.deleteAll" >{$iconClean} Delete all Menus</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMenu_Table_Element
