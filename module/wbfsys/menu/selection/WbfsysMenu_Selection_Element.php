 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_menu';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Menu.show&amp;target_mask=WbfsysMenu&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.menu.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Menu.edit&amp;target_mask=WbfsysMenu&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.menu.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Menu.delete&amp;target_mask=WbfsysMenu&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.menu.label',
        Acl::DELETE
...
}//end class WbfsysMenu_Selection_Element
