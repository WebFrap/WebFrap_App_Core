...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMenu_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMenu_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMenu_Selection_Element
    (
      'selectionWbfsysMenu',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Menus', 'wbfsys.menu.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Menu.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysMenu_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMenu_Selection_Ui
