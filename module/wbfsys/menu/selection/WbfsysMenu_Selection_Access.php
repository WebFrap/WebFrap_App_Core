 ...
 * @licence WebFrap.net
 */
class WbfsysMenu_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMenu_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_menu.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_menu.rowid ",
      'acls'
    );
...
}//end class WbfsysMenu_Selection_Access
