 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMenuEntry_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMenuEntry_Export_Listing_Access';
    ...
    // create a new WbfsysMenuEntry window
    $view = $this->loadView
    (
    	'export-wbfsys_menu_entry',
    	'WbfsysMenuEntry_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMenuEntry_Export' );
...
} // end class WbfsysMenuEntry_Export_Controller_Genf
