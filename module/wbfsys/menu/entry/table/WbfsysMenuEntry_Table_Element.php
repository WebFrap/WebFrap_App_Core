 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_menu_entry';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMenuEntry_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MenuEntry.show&amp;target_mask=WbfsysMenuEntry&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MenuEntry.edit&amp;target_mask=WbfsysMenuEntry&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MenuEntry.delete&amp;target_mask=WbfsysMenuEntry&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_menu_entry&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'URL', 'wbfsys.menu_entry.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" style="text-align:center;" >'.( trim( $row['wbfsys_menu_entry_http_url'] ) == '' ? ' ' : '<a target="extern" href="'.Wgt::renderUrl($row['wbfsys_menu_entry_http_url']).'">'.Validator::sanitizeHtml($row['wbfsys_menu_entry_http_url']).'</a>' ).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MenuEntry_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Menu Entrys." >{$iconDelete} Delete selected Menu Entrys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Menu Entrys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MenuEntry_Multi.deleteAll" >{$iconClean} Delete all Menu Entrys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMenuEntry_Table_Element
