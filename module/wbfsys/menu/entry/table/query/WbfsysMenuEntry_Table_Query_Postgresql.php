 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_menu_entry_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetchWithAcls( $condition = null, $params = null )
  {
    ...
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys>mgmt-wbfsys_menu_entry' );
    }
    else
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys>mgmt-wbfsys_menu_entry', true, $params->access->level  );
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_menu_entry.rowid as "wbfsys_menu_entry_rowid"', // variant: def-rowid 
      'wbfsys_menu_entry.label as "wbfsys_menu_entry_label"', // variant: def-by-context 
      'wbfsys_menu_entry.http_url as "wbfsys_menu_entry_http_url"', // variant: def-by-context 
    );
...
}//end class WbfsysMenuEntry_Table_Query_Postgresql
