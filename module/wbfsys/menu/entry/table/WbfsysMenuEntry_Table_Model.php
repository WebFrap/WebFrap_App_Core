 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMenuEntry_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMenuEntry_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysMenuEntry_Table_Model
