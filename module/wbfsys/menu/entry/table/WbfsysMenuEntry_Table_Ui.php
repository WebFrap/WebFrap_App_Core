 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Menu Entrys
  *
  ...
  *  }
  *
  * @return WbfsysMenuEntry_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMenuEntry_Table_Element( 'tableWbfsysMenuEntry', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Menu Entrys', 'wbfsys.menu_entry.label' );
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMenuEntry_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param WbfsysMenuEntry_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMenuEntry_Table_Ui
