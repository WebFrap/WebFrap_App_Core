 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMenuEntry_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysMenuEntry_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/menu_entry/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.MenuEntry.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_menu_entry-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysMenuEntry_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.MenuEntry.create&amp;ltype=table');
    });
...
}//end class WbfsysMenuEntry_Table_Maintab_View
