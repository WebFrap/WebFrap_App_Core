 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMenuEntry entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MenuEntry.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MenuEntry.insert';
    $params->formId       = 'wgt-form-wbfsys_menu_entry';
    $params->namespace   = 'wbfsys_menu_entry-create';
    ...
    $this->setTemplate( 'wbfsys/menu_entry/modal/crud/form_create' );
...
}//end class WbfsysMenuEntry_Crud_Create_Modal_View
