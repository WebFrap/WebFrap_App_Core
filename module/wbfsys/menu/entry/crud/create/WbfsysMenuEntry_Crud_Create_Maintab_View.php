 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMenuEntry Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_menu_entry-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/menu_entry/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MenuEntry.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_menu_entry';
    ...
    $form = $this->newForm( 'WbfsysMenuEntry_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MenuEntry.create');}});
});
...
}//end class WbfsysMenuEntry_Crud_Create_Maintab_View
