 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMenuEntry Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMenuEntry = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MenuEntry.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMenuEntry
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MenuEntry.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_menu_entry-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/menu_entry/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMenuEntry_Crud_Edit' );
...
}//end class WbfsysMenuEntry_Crud_Edit_Maintab_View
