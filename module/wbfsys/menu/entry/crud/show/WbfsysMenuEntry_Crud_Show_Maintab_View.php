 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMenuEntry_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMenuEntry Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMenuEntry = $this->model->getEntityWbfsysMenuEntry();
    ...
    (
      ...
      array( 'text' => $entityWbfsysMenuEntry->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MenuEntry.show  &amp;objid='.$entityWbfsysMenuEntry
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MenuEntry.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_menu_entry-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/menu_entry/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMenuEntry_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MenuEntry.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_menu_entry' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_menu_entry a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MenuEntry.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MenuEntry.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMenuEntry_Crud_Show_Maintab_View
