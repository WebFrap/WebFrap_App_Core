 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMenuEntry
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMenuEntry_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysMenuEntry_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMenuEntry_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMenuEntry_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_menu_entry-acl',
    	'WbfsysMenuEntry_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_menu_entry_acl_masks_listing',
      'WbfsysMenuEntry_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMenuEntry_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMenuEntry_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMenuEntry_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMenuEntry_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMenuEntry_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMenuEntry_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_menu_entry-acl-qfdu',
    	'WbfsysMenuEntry_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMenuEntry_Acl_Controller */
