 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MenuEntry_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_menu_entry-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MenuEntry_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_menu_entry-acl-update';
    ...
    $this->setTemplate( 'wbfsys/menu_entry/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Menu Entry', 'wbfsys.menu_entry.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_menu_entry_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMenuEntry_Acl' );
...
} // end class WbfsysMenuEntry_Acl_Maintab_View */
