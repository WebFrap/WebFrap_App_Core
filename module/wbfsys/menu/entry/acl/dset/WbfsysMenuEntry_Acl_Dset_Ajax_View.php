 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMenuEntry_Acl_Dset' );
    ...
    $entityWbfsysMenuEntry = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMenuEntry_Acl_Dset_Ajax_View */
