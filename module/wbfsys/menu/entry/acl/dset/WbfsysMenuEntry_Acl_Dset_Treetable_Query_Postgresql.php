 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_menu_entry.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMenuEntry_Acl_Dset_Treetable_Query_Postgresql */
