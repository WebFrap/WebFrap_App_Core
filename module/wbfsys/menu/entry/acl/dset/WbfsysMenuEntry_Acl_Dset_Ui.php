 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMenuEntry_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMenuEntry_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMenuEntry, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMenuEntry_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_menu_entry-acl-dset' );
    ...
    else
    {
      ...
      (
        'Menu Entry "{@label@}" User Access',
        'wbfsys.menu_entry.label',
        array
        (
          'label' => $entityWbfsysMenuEntry->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_menu_entry_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMenuEntry_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMenuEntry_Acl_Dset_Ui */
