 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMenuEntry_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMenuEntry_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMenuEntry = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMenuEntry_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_menu_entry-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMenuEntry, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMenuEntry_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_menu_entry-acl-dset', 
    	'WbfsysMenuEntry_Acl_Dset',
...
} // end class WbfsysMenuEntry_Acl_Dset_Controller */
