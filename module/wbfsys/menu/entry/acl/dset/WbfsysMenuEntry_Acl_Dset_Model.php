 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_menu_entry'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMenuEntry', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMenuEntry_Acl_Dset' );
    /* @var $query WbfsysMenuEntry_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMenuEntry_Acl_Dset_Treetable' );
    /* @var $query WbfsysMenuEntry_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMenuEntry_Acl_Dset_Model */
