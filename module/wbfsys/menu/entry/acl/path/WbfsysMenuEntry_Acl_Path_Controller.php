 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_menu_entry_acl_graph', 
      'WbfsysMenuEntry_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMenuEntry_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMenuEntry_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMenuEntry_Acl_Path_Maintab_View  */
...
} // end class WbfsysMenuEntry_Acl_Path_Controller */
