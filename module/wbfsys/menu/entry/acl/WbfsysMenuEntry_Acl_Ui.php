...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMenuEntry_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMenuEntry_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_menu_entry-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Menu Entry', 'wbfsys.menu_entry.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_menu_entry_acl';
...
} // end class WbfsysMenuEntry_Acl_Ui */
