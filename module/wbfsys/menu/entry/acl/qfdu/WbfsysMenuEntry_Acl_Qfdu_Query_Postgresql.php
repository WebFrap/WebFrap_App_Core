 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_menu_entry.label) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_menu_entry.rowid as id,
    wbfsys_menu_entry.label as value,
    wbfsys_menu_entry.label as label
  FROM
    wbfsys_menu_entry
  WHERE
    {$sqlWhere}
...
} // end class WbfsysMenuEntry_Acl_Qfdu_Query_Postgresql */
