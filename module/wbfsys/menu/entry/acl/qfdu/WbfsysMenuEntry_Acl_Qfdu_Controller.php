 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMenuEntry_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_menu_entry-acl-qfdu-aAjax',
      'WbfsysMenuEntry_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMenuEntry_Acl_Qfdu_Controller */
