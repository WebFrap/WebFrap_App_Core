...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_menu_entry';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMenuEntry';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMenuEntry' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMenuEntry entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_m_parent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMenuEntry_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Parent Node (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ));
      ...
      $inputMParent->setLabel( $this->view->i18n->l( 'Parent Node', 'wbfsys.menu_entry.label' ) );
  ...
  public function input_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Label (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ...
      $inputLabel->setLabel
      (
        $this->view->i18n->l( 'Label', 'wbfsys.menu_entry.label' ),
  ...
  */
  public function input_icon( $params )
  {
      ...
      //p: input file image
      $inputIcon = $this->view->newInput( 'input'.$this->prefix.'Icon', 'FileImage' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Icon (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      $inputIcon->setWidth( 'medium' );

      if( ( $objid = $this->entity->getId() ) && $this->entity->icon )
      {
        $inputIcon->setSource('thumb.php?f=wbfsys_menu_entry-icon-'.$objid.'&amp;n='.base64_encode($this->entity->icon));
        $inputIcon->setLink('image.php?f=wbfsys_menu_entry-icon-'.$objid.'&amp;n='.base64_encode($this->entity->icon));
      }
      ...
      $inputIcon->setLabel
      (
        $this->view->i18n->l( 'Icon', 'wbfsys.menu_entry.label' ) ,
  ...
  * @return void
  */
  public function input_http_url( $params )
  {

      //tpl: class ui: guess
      $inputHttpUrl = $this->view->newInput( 'input'.$this->prefix.'HttpUrl' , 'text' );
      $this->items['http_url'] = $inputHttpUrl;
      $inputHttpUrl->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[http_url]',
          'id'        => 'wgt-input-'.$this->keyName.'_http_url'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for URL (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      $inputHttpUrl->setWidth( 'medium' );

      $inputHttpUrl->setReadOnly( $this->isReadOnly( 'http_url' ) );
      $inputHttpUrl->setData( $this->entity->getSecure('http_url') );
      $inputHttpUrl->setLabel
      (
        $this->view->i18n->l( 'URL', 'wbfsys.menu_entry.label' ),
        $this->entity->required( 'http_url' )
      );
  ...
  }//end public function input_http_url */
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.menu_entry.label' ),
  ...
  * @return void
  */
  public function input_id_menu( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMenu_Entity' ) )
    {
      ...
      $inputIdMenu = $this->view->newInput( 'input'.$this->prefix.'IdMenu', 'Window' );
      $inputIdMenu->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_menu]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_menu'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Menu (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ));
      ...
      $inputIdMenu->setReadOnly( $this->isReadOnly( 'id_menu' ) );
      $inputIdMenu->setLabel( $this->view->i18n->l( 'Menu', 'wbfsys.menu_entry.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Menu.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_menu'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMenu->buildJavascript( 'wgt-input-'.$this->keyName.'_id_menu'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_menu */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.menu_entry.label' ),
  ...
  public function input_mimetype( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (Menu Entry)', 'wbfsys.menu_entry.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.menu_entry.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.menu_entry.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.menu_entry.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.menu_entry.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Menu Entry)', 'wbfsys.menu_entry.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.menu_entry.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.menu_entry.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.menu_entry.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Label (Menu Entry)', 'wbfsys.menu_entry.label' ),
          'maxlength' => $this->entity->maxSize( 'label' ),
        )
      );
      $inputLabel->setWidth( 'medium' );
 ...
 /**
  * create the search element for field http_url
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_http_url( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for URL (Menu Entry)', 'wbfsys.menu_entry.label' ),
        )
      );
      $inputHttpUrl->setWidth( 'medium' );
  ...
  }//end public function search_http_url */
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Menu Entry)', 'wbfsys.menu_entry.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_menu_entry_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_menu_entry_m_role_change';
...
}//end class WbfsysMenuEntry_Form */
