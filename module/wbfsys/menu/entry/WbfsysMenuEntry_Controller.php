 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_menu_entry
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MenuEntry.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_menu_entry-create';

    $access = new WbfsysMenuEntry_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_menu_entry-create',
      'WbfsysMenuEntry_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysMenuEntry_Crud_Model */
    $model = $this->loadModel( 'WbfsysMenuEntry_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MenuEntry.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMenuEntry = $model->getEntityWbfsysMenuEntry( $objid );
    ...
    $params->entity = $entityWbfsysMenuEntry;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_menu_entry:edit';

    $access = new WbfsysMenuEntry_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMenuEntry );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_menu_entry-edit-'.$objid,
      'WbfsysMenuEntry_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_menu_entry-edit',
          $entityWbfsysMenuEntry,
          'Edit Menu Entry :'.$entityWbfsysMenuEntry->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_menu_entry';
      $params->maskRoot      = 'wbfsys_menu_entry:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_menu_entry';
      $params->aclNode       = 'mgmt-wbfsys_menu_entry';
      $params->aclLevel      = 1;
    }
    ...
    if( $params->isAclRoot )
    {
      ...
      (
        'mod-wbfsys>mgmt-wbfsys_menu_entry',
        $entityWbfsysMenuEntry
      );
    }
    else
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_menu_entry-show',
          $entityWbfsysMenuEntry,
          'Show Menu Entry :'.$entityWbfsysMenuEntry->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_menu_entry
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MenuEntry.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-insert';

    $access = new WbfsysMenuEntry_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysMenuEntry = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_menu_entry-update-'.$entityWbfsysMenuEntry;
      ...
      {
        $access = new WbfsysMenuEntry_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysMenuEntry );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysMenuEntry';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_menu_entry',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysMenuEntry_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MenuEntry.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMenuEntry, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMenuEntry_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.MenuEntry.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-delete-'.$objid;

    $access = new WbfsysMenuEntry_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMenuEntry );
    ...
    $error = $model->delete( $entityWbfsysMenuEntry, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMenuEntry, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.MenuEntry.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MenuEntry.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-listing';
    ...
    $containerClass = 'WbfsysMenuEntry_'.$listType.'_Access';
    ...
    /* @var $model WbfsysMenuEntry_Table_Model */
    $model = $this->loadModel( 'WbfsysMenuEntry_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_menu_entry-'.$params->ltype,
          'WbfsysMenuEntry',
          'List of Menu Entrys'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMenuEntry
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMenuEntry_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_menu_entry',
      'WbfsysMenuEntry_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMenuEntry_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MenuEntry.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMenuEntry_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMenuEntry_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_menu_entry-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_menu_entry-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_menu_entry',
      'WbfsysMenuEntry',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMenuEntry, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysMenuEntry_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMenuEntry_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_menu_entry-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_menu_entry' );
...
} // end class WbfsysMenuEntry_Controller */
