 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMenuEntry_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMenuEntry_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMenuEntry_Selection_Element
    (
      'selectionWbfsysMenuEntry',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Menu Entrys', 'wbfsys.menu_entry.label' ) ;
      $tabPanel->searchKey = 'wbfsys_menu_entry';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MenuEntry.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMenuEntry',
      'WbfsysMenuEntry_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMenuEntry' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysMenuEntry listing maske
   *
   * @param WbfsysMenuEntry_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMenuEntry_Selection_Ui
