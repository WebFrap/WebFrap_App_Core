 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMenuEntry_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMenuEntry_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysMenuEntry_Selection_Model
