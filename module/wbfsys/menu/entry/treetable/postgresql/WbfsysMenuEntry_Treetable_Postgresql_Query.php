 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Treetable_Postgresql_Query
  extends LibSqlQuery
{
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_menu_entry.m_parent as "wbfsys_menu_entry_m_parent"', // variant: def-additional 
    );
...
}//end class WbfsysMenuEntry_Treetable_Postgresql_Query
