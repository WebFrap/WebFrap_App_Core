 ...
 * @licence WebFrap.net
 */
class WbfsysMenuEntry_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMenuEntry_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysMenuEntry_Treetable_Element
    (
      'treetableWbfsysMenuEntry',
      $view
    );
...
WGTJS;
   ...
   *
   * @return WbfsysMenuEntry_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMenuEntry', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysMenuEntry_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMenuEntry_Treetable_Ui
