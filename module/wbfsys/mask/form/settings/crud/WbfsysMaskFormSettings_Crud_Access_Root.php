 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMaskFormSettings_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMaskFormSettings_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMaskFormSettings_Entity */
      $entity = $orm->get( 'WbfsysMaskFormSettings', $rootId );
    }
...
}//end class WbfsysMaskFormSettings_Crud_Access_Root
