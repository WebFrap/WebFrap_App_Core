 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMaskFormSettings entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MaskFormSettings.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskFormSettings.insert';
    $params->formId       = 'wgt-form-wbfsys_mask_form_settings';
    $params->namespace   = 'wbfsys_mask_form_settings-create';
    ...
    $this->setTemplate( 'wbfsys/mask_form_settings/modal/crud/form_create' );
...
}//end class WbfsysMaskFormSettings_Crud_Create_Modal_View
