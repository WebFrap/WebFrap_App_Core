 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMaskFormSettings Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMaskFormSettings = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Mask Form Settings: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MaskFormSettings.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMaskFormSettings
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MaskFormSettings.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mask_form_settings-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mask_form_settings/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMaskFormSettings_Crud_Edit' );
...
}//end class WbfsysMaskFormSettings_Crud_Edit_Maintab_View
