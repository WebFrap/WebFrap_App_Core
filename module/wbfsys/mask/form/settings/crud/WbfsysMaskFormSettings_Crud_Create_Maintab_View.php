 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMaskFormSettings Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Mask Form Settings',
      'wbfsys.mask_form_settings.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Mask Form Settings',
      'wbfsys.mask_form_settings.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_mask_form_settings-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/mask_form_settings/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskFormSettings.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_mask_form_settings';
    ...
    $form = $this->newForm( 'WbfsysMaskFormSettings_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MaskFormSettings.create');}});
});
...
}//end class WbfsysMaskFormSettings_Crud_Create_Maintab_View
