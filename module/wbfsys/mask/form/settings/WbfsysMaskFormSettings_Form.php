 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_mask_form_settings';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMaskFormSettings';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMaskFormSettings' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMaskFormSettings entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_col_settings( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Col Settings (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Col Settings', 'wbfsys.mask_form_settings.label' ),
  ...
  * @return void
  */
  public function input_reference_settings( $params )
  {

      //p: textarea
      $inputReferenceSettings = $this->view->newInput( 'input'.$this->prefix.'ReferenceSettings', 'Textarea' );
      $this->items['reference_settings'] = $inputReferenceSettings;
      $inputReferenceSettings->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[reference_settings]',
          'id'    => 'wgt-input-'.$this->keyName.'_reference_settings'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip large medium-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Reference Settings (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      $inputReferenceSettings->setReadOnly( $this->isReadOnly( 'reference_settings' ) );
      $inputReferenceSettings->setLabel
      (
        $this->view->i18n->l( 'Reference Settings', 'wbfsys.mask_form_settings.label' ),
        $this->entity->required( 'reference_settings' )
      );
  ...
  }//end public function input_reference_settings */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.mask_form_settings.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.mask_form_settings.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.mask_form_settings.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.mask_form_settings.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.mask_form_settings.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.mask_form_settings.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Mask Form Settings)', 'wbfsys.mask_form_settings.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_form_settings_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_form_settings_m_role_change';
...
}//end class WbfsysMaskFormSettings_Form */
