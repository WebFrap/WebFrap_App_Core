 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Mask Form Settings
  *
  ...
  *  }
  *
  * @return WbfsysMaskFormSettings_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMaskFormSettings_Table_Element( 'tableWbfsysMaskFormSettings', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask_form_settings-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Mask Form Settings', 'wbfsys.mask_form_settings.label' );
      //$tabPanel->searchKey = 'wbfsys_mask_form_settings';
      ...
      $searchElement->searchKey = 'wbfsys_mask_form_settings';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMaskFormSettings_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMaskFormSettings', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMaskFormSettings listing maske
   *
   * @param WbfsysMaskFormSettings_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMaskFormSettings  = $model->getEntityWbfsysMaskFormSettings();
    ...
    $formWbfsysMaskFormSettings->setKeyName( 'wbfsys_mask_form_settings' );
...
}//end class WbfsysMaskFormSettings_Table_Ui
