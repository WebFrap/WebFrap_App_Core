 ...
 * @licence WebFrap.net
 */
class WbfsysMaskFormSettings_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMaskFormSettings_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_mask_form_settings.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_mask_form_settings.rowid ",
      'acls'
    );
...
}//end class WbfsysMaskFormSettings_Table_Access
