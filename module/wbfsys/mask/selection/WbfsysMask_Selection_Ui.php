...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMask_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMask_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMask_Selection_Element
    (
      'selectionWbfsysMask',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Masks', 'wbfsys.mask.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Mask.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysMask_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMask_Selection_Ui
