 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_mask';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Mask.show&amp;target_mask=WbfsysMask&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.mask.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Mask.edit&amp;target_mask=WbfsysMask&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mask.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mask.delete&amp;target_mask=WbfsysMask&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mask.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_mask_name'])).'</td>'.NL;
...
}//end class WbfsysMask_Selection_Element
