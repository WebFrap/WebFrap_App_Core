 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMask Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_mask-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/mask/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Mask.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_mask';
    ...
    $form = $this->newForm( 'WbfsysMask_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Mask.create');}});
});
...
}//end class WbfsysMask_Crud_Create_Maintab_View
