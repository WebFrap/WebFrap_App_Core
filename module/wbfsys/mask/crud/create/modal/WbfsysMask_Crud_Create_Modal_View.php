 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMask entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Mask.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Mask.insert';
    $params->formId       = 'wgt-form-wbfsys_mask';
    $params->namespace   = 'wbfsys_mask-create';
    ...
    $this->setTemplate( 'wbfsys/mask/modal/crud/form_create' );
...
}//end class WbfsysMask_Crud_Create_Modal_View
