 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMask Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMask = $this->model->getEntityWbfsysMask();
    ...
    (
      'Show Mask: {@text@}',
      'wbfsys.mask.label',
      array( 'text' => $entityWbfsysMask->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Mask.show  &amp;objid='.$entityWbfsysMask
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Mask.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mask-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mask/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMask_Crud_Show' );
    ...
    if( $params->access->getPathLevel( 'mgmt-wbfsys_mask-ref-tags' ) )
    {
    ...
    if( $params->access->getPathLevel( 'mgmt-wbfsys_mask-ref-comments' ) )
    {
      // many to many reference
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Mask.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mask' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mask a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Mask.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Mask.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMask_Crud_Show_Maintab_View
