 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMask_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMask_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMask_Acl_Path_Maintab_View  */
...
} // end class WbfsysMask_Acl_Path_Controller */
