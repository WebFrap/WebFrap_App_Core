 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Mask_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Mask_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_mask-acl-update';
    ...
    $this->setTemplate( 'wbfsys/mask/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Mask', 'wbfsys.mask.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_mask_acl_listing' );
...
} // end class WbfsysMask_Acl_Maintab_View */
