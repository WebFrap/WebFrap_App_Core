...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMask_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMask_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_mask-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Mask', 'wbfsys.mask.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_mask_acl';
