 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_mask'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMask_Acl_Dset' );
    /* @var $query WbfsysMask_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMask_Acl_Dset_Treetable' );
    /* @var $query WbfsysMask_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMask_Acl_Dset_Model */
