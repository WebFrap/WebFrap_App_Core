 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMask_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMask_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMask = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMask_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_mask-acl-dset-listing-'.$objid,
      'WbfsysMask_Acl_Dset',
      'displayListing'
    );
    ...
    $view->displayListing( $entityWbfsysMask, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMask_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_mask-acl-dset', 
    	'WbfsysMask_Acl_Dset',
...
} // end class WbfsysMask_Acl_Dset_Controller */
