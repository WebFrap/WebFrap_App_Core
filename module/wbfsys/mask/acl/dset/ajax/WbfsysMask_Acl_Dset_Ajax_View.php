 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMask_Acl_Dset' );
    ...
    $entityWbfsysMask = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMask_Acl_Dset_Ajax_View */
