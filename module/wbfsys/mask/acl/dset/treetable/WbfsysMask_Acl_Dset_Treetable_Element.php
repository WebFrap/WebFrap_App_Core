 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Dset_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_mask-acl-dset';
   ...
   *
   * @var WbfsysMask_Acl_Dset_Treetable_Query
   */
  public $data        = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mask_Acl_Dset.cleanGroup&amp;objid=',
        'control/clean.png',
        '',
        'wbf.label',
        Acl::ADMIN
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mask_Acl_Dset.deleteUser&amp;objid=',
        'control/delete.png',
        '',
        'wbf.label',
        Acl::ADMIN
    ...
    foreach( $this->data as $row   )
    {
      ...
      $body .= '<td valign="top" >'
        .'<input
          ...
          id="wgt-input-acl-wbfsys_mask-dset-'.$objid.'-date_start"
      ...
      $body .= '<td valign="top" >'
        .'<input
          type="text"
          class="'.$this->editForm.' wcm wcm_ui_date show small"
          id="wgt-input-acl-wbfsys_mask-dset-'.$objid.'-date_end"
...
} // end class WbfsysMask_Acl_Dset_Treetable_Element */
