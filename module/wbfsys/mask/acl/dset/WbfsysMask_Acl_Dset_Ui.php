...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMask_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMask, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_mask-acl-dset' );
    ...
    else
    {
      ...
      (
        'Mask "{@label@}" User Access',
        'wbfsys.mask.label',
        array
        (
          'label' => $entityWbfsysMask->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_mask_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMask_Acl_Dset_Ui */
