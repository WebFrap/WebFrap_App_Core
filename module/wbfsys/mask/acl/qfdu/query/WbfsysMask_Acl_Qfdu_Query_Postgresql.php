 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_mask.name) like upper('{$safeVal}%') ";
    }
...
} // end class WbfsysMask_Acl_Qfdu_Query_Postgresql */
