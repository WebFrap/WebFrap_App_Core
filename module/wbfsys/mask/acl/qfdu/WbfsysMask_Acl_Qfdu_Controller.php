 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMask_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_mask-acl-qfdu-aAjax',
      'WbfsysMask_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMask_Acl_Qfdu_Controller */
