...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMask_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMask_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Mask',
        'wbfsys.mask.label'
      );
      $tabPanel->searchKey  = 'wbfsys_mask_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new WbfsysMask_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class WbfsysMask_Acl_Qfdu_Ui */
