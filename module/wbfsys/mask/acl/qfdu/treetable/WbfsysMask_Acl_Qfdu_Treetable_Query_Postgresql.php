 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_mask.name as "wbfsys_mask_name"',
      'wbfsys_mask.rowid as "wbfsys_mask_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_mask on wbfsys_group_users.vid = wbfsys_mask.rowid'
    );
...
} // end class WbfsysMask_Acl_Qfdu_Treetable_Query_Postgresql */
