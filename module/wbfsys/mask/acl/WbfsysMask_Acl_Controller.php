 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMask
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMask_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysMask_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMask_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMask_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_mask_acl_masks_listing',
      'WbfsysMask_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMask_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMask_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMask_Acl_Qfdu_Model */
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMask_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMask_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_mask-acl-qfdu',
    	'WbfsysMask_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMask_Acl_Controller */
