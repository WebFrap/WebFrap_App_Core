 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMask_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMask_Export_Listing_Access';
    ...
    // create a new WbfsysMask window
    $view = $this->loadView
    (
    	'export-wbfsys_mask',
    	'WbfsysMask_Export',
    ...
    $model = $this->loadModel( 'WbfsysMask_Export' );
...
} // end class WbfsysMask_Export_Controller_Genf
