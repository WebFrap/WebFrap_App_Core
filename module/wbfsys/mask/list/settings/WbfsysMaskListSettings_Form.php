 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_mask_list_settings';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMaskListSettings';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMaskListSettings' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMaskListSettings entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.mask_list_settings.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.mask_list_settings.label' ),
  ...
  * @return void
  */
  public function input_id_mask( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMask_Entity' ) )
    {
      ...
      $inputIdMask = $this->view->newInput( 'input'.$this->prefix.'IdMask', 'Window' );
      $inputIdMask->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_mask]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_mask'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Mask (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ));
      ...
      $inputIdMask->setReadOnly( $this->isReadOnly( 'id_mask' ) );
      $inputIdMask->setLabel( $this->view->i18n->l( 'Mask', 'wbfsys.mask_list_settings.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Mask.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_mask'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMask->buildJavascript( 'wgt-input-'.$this->keyName.'_id_mask'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_mask */
  ...
  * @return void
  */
  public function input_col_settings( $params )
  {

      //p: textarea
      $inputColSettings = $this->view->newInput( 'input'.$this->prefix.'ColSettings', 'Textarea' );
      $this->items['col_settings'] = $inputColSettings;
      $inputColSettings->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[col_settings]',
          'id'    => 'wgt-input-'.$this->keyName.'_col_settings'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip large medium-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Col Settings (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      $inputColSettings->setReadOnly( $this->isReadOnly( 'col_settings' ) );
      $inputColSettings->setLabel
      (
        $this->view->i18n->l( 'Col Settings', 'wbfsys.mask_list_settings.label' ),
        $this->entity->required( 'col_settings' )
      );
  ...
  }//end public function input_col_settings */
  ...
  * @return void
  */
  public function input_filter_settings( $params )
  {

      //p: textarea
      $inputFilterSettings = $this->view->newInput( 'input'.$this->prefix.'FilterSettings', 'Textarea' );
      $this->items['filter_settings'] = $inputFilterSettings;
      $inputFilterSettings->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[filter_settings]',
          'id'    => 'wgt-input-'.$this->keyName.'_filter_settings'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip large medium-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Filter Settings (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      $inputFilterSettings->setReadOnly( $this->isReadOnly( 'filter_settings' ) );
      $inputFilterSettings->setLabel
      (
        $this->view->i18n->l( 'Filter Settings', 'wbfsys.mask_list_settings.label' ),
        $this->entity->required( 'filter_settings' )
      );
  ...
  }//end public function input_filter_settings */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.mask_list_settings.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.mask_list_settings.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.mask_list_settings.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.mask_list_settings.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.mask_list_settings.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.mask_list_settings.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.mask_list_settings.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.mask_list_settings.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.mask_list_settings.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Mask List Settings)', 'wbfsys.mask_list_settings.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_list_settings_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_list_settings_m_role_change';
...
}//end class WbfsysMaskListSettings_Form */
