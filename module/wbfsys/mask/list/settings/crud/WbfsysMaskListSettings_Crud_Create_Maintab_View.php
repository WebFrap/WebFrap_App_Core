 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMaskListSettings Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Mask List Settings',
      'wbfsys.mask_list_settings.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Mask List Settings',
      'wbfsys.mask_list_settings.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_mask_list_settings-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/mask_list_settings/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskListSettings.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_mask_list_settings';
    ...
    $form = $this->newForm( 'WbfsysMaskListSettings_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MaskListSettings.create');}});
});
...
}//end class WbfsysMaskListSettings_Crud_Create_Maintab_View
