 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysMaskListSettings', array_keys( $this->fields['wbfsys_mask_list_settings']), true ),
...
}//end class WbfsysMaskListSettings_Crud_Create_Form */
