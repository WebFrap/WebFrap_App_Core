 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMaskListSettings_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMaskListSettings_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMaskListSettings_Entity */
      $entity = $orm->get( 'WbfsysMaskListSettings', $rootId );
    }
...
}//end class WbfsysMaskListSettings_Crud_Access_Root
