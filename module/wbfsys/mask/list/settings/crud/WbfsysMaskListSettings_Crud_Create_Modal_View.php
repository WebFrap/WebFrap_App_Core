 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMaskListSettings entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MaskListSettings.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskListSettings.insert';
    $params->formId       = 'wgt-form-wbfsys_mask_list_settings';
    $params->namespace   = 'wbfsys_mask_list_settings-create';
    ...
    $this->setTemplate( 'wbfsys/mask_list_settings/modal/crud/form_create' );
...
}//end class WbfsysMaskListSettings_Crud_Create_Modal_View
