 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMaskListSettings Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMaskListSettings = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Mask List Settings: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MaskListSettings.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMaskListSettings
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MaskListSettings.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mask_list_settings-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mask_list_settings/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMaskListSettings_Crud_Edit' );
...
}//end class WbfsysMaskListSettings_Crud_Edit_Maintab_View
