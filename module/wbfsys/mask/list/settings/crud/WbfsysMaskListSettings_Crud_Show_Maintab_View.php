 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMaskListSettings_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMaskListSettings Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMaskListSettings = $this->model->getEntityWbfsysMaskListSettings();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Mask List Settings: {@text@}',
      'wbfsys.mask_list_settings.label',
      array( 'text' => $entityWbfsysMaskListSettings->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Mask List Settings: {@text@}',
      'wbfsys.mask_list_settings.label',
      array( 'text' => $entityWbfsysMaskListSettings->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MaskListSettings.show  &amp;objid='.$entityWbfsysMaskListSettings
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MaskListSettings.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mask_list_settings-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mask_list_settings/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMaskListSettings_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MaskListSettings.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mask_list_settings' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mask_list_settings a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MaskListSettings.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MaskListSettings.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMaskListSettings_Crud_Show_Maintab_View
