 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_mask_list_settings';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMaskListSettings_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MaskListSettings.show&amp;target_mask=WbfsysMaskListSettings&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MaskListSettings.edit&amp;target_mask=WbfsysMaskListSettings&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mask_list_settings.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MaskListSettings.delete&amp;target_mask=WbfsysMaskListSettings&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mask_list_settings.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.mask_list_settings.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_mask_list_settings_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_mask_list_settings_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MaskListSettings_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Mask List Settings." >{$iconDelete} Delete selected Mask List Settings</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Mask List Settings. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MaskListSettings_Multi.deleteAll" >{$iconClean} Delete all Mask List Settings</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMaskListSettings_Table_Element
