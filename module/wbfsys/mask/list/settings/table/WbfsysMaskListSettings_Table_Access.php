 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMaskListSettings_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_mask_list_settings.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_mask_list_settings.rowid ",
      'acls'
    );
...
}//end class WbfsysMaskListSettings_Table_Access
