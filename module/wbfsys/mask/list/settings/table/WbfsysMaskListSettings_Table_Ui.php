 ...
 * @licence WebFrap.net
 */
class WbfsysMaskListSettings_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Mask List Settings
  *
  ...
  *  }
  *
  * @return WbfsysMaskListSettings_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMaskListSettings_Table_Element( 'tableWbfsysMaskListSettings', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask_list_settings-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Mask List Settings', 'wbfsys.mask_list_settings.label' );
      //$tabPanel->searchKey = 'wbfsys_mask_list_settings';
      ...
      $searchElement->searchKey = 'wbfsys_mask_list_settings';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMaskListSettings_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMaskListSettings', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMaskListSettings listing maske
   *
   * @param WbfsysMaskListSettings_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMaskListSettings  = $model->getEntityWbfsysMaskListSettings();
    ...
    $formWbfsysMaskListSettings->setKeyName( 'wbfsys_mask_list_settings' );
...
}//end class WbfsysMaskListSettings_Table_Ui
