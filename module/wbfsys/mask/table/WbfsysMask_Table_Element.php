 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_mask';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMask_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Mask.show&amp;target_mask=WbfsysMask&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.mask.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Mask.edit&amp;target_mask=WbfsysMask&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mask.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=Wbfsys.Mask_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.mask.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.Mask_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.mask.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mask.delete&amp;target_mask=WbfsysMask&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mask.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_mask&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.mask.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.mask.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Mask.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_mask_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Mask_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Masks." >{$iconDelete} Delete selected Masks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Masks. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Mask_Multi.deleteAll" >{$iconClean} Delete all Masks</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMask_Table_Element
