...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMask' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMask entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Mask)', 'wbfsys.mask.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.mask.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Mask)', 'wbfsys.mask.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.mask.label' ),
  ...
  * @return void
  */
  public function input_access_url( $params )
  {

      //tpl: class ui:text
      $inputAccessUrl = $this->view->newInput( 'input'.$this->prefix.'AccessUrl' , 'Text' );
      $this->items['access_url'] = $inputAccessUrl;
      $inputAccessUrl->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[access_url]',
          'id'        => 'wgt-input-'.$this->keyName.'_access_url'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Access Url (Mask)', 'wbfsys.mask.label' ),
          'maxlength' => $this->entity->maxSize( 'access_url' ),
        )
      );
      $inputAccessUrl->setWidth( 'medium' );

      $inputAccessUrl->setReadOnly( $this->isReadOnly( 'access_url' ) );
      $inputAccessUrl->setData( $this->entity->getSecure('access_url') );
      $inputAccessUrl->setLabel
      (
        $this->view->i18n->l( 'Access Url', 'wbfsys.mask.label' ),
        $this->entity->required( 'access_url' )
      );
  ...
  }//end public function input_access_url */
  ...
  * @return void
  */
  public function input_dset_mask( $params )
  {

      //tpl: class ui:Checkbox
      $inputDsetMask = $this->view->newInput( 'input'.$this->prefix.'DsetMask' , 'Checkbox' );
      $this->items['dset_mask'] = $inputDsetMask;
      $inputDsetMask->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[dset_mask]',
          'id'        => 'wgt-input-'.$this->keyName.'_dset_mask'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Dset Mask (Mask)', 'wbfsys.mask.label' ),
        )
      );
      $inputDsetMask->setWidth( 'medium' );

      $inputDsetMask->setReadOnly( $this->isReadOnly( 'dset_mask' ) );
      $inputDsetMask->setActive( $this->entity->getBoolean( 'dset_mask' ) );
      $inputDsetMask->setLabel
      (
        $this->view->i18n->l( 'Dset Mask', 'wbfsys.mask.label' ),
        $this->entity->required( 'dset_mask' )
      );
  ...
  }//end public function input_dset_mask */
  ...
  * @return void
  */
  public function input_context( $params )
  {

      //tpl: class ui:text
      $inputContext = $this->view->newInput( 'input'.$this->prefix.'Context' , 'Text' );
      $this->items['context'] = $inputContext;
      $inputContext->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[context]',
          'id'        => 'wgt-input-'.$this->keyName.'_context'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Context (Mask)', 'wbfsys.mask.label' ),
          'maxlength' => $this->entity->maxSize( 'context' ),
        )
      );
      $inputContext->setWidth( 'medium' );

      $inputContext->setReadOnly( $this->isReadOnly( 'context' ) );
      $inputContext->setData( $this->entity->getSecure('context') );
      $inputContext->setLabel
      (
        $this->view->i18n->l( 'Context', 'wbfsys.mask.label' ),
        $this->entity->required( 'context' )
      );
  ...
  }//end public function input_context */
    ...
    if( !Webfrap::classLoadable( 'WbfsysModule_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_module'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Module (Mask)', 'wbfsys.mask.label' ),
      ));
      ...
      $inputIdModule->setLabel( $this->view->i18n->l( 'Module', 'wbfsys.mask.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysManagement_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_management'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Management (Mask)', 'wbfsys.mask.label' ),
      ));
      ...
      $inputIdManagement->setLabel( $this->view->i18n->l( 'Management', 'wbfsys.mask.label' ) );
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Mask)', 'wbfsys.mask.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.mask.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Mask)', 'wbfsys.mask.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.mask.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Mask)', 'wbfsys.mask.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.mask.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Mask)', 'wbfsys.mask.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.mask.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Mask)', 'wbfsys.mask.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.mask.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Mask)', 'wbfsys.mask.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.mask.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Mask)', 'wbfsys.mask.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.mask.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Mask)', 'wbfsys.mask.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.mask.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Mask)', 'wbfsys.mask.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.mask.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Mask)', 'wbfsys.mask.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Mask)', 'wbfsys.mask.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_m_role_change';
