 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMask_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysMask, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMask_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_mask-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysMask;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask-ref-tags-search-'
        .$idWbfsysMask;
    ...
    $tabPanel->searchKey = 'wbfsys_mask-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysMask_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysMask );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.Mask_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysMask_Ref_Tags_Table_Ui
