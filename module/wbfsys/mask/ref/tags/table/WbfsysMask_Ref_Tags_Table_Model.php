 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysMask, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMask_Ref_Tags_Table' );
    /* @var $query WbfsysMask_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysMask );
...
}//end class WbfsysMask_Ref_Tags_Table_Model
