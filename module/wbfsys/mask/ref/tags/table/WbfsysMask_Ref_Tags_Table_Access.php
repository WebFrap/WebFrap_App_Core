 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_mask-ref-tags' );
  ...
  /**
   * @param WbfsysMask_Ref_Tags_Table_Query $query
...
}//end class WbfsysMask_Ref_Tags_Table_Access
