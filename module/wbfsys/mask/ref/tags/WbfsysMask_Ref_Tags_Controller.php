 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMask_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_mask-ref-tags';
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMask_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_mask-ref-tags-'.$listType.'-ajax',
    	'WbfsysMask_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysMask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysMask_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMask_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMask_Ref_Tags_'.$listType );
...
} // end WbfsysMask_Ref_Tags_Controller
