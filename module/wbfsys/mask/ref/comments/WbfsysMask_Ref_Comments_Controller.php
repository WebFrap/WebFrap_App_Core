 ...
 * If you want to extend this class write your coden in ControllerWbfsysMask
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_mask management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMask_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_mask-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_mask-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysMask_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMask_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_mask-ref-comments-'.$listType.'-ajax',
    	'WbfsysMask_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysMask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysMask_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMask_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMask_Ref_Comments_'.$listType );
...
} // end WbfsysMask_Ref_Comments_Controller
