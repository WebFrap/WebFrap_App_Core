 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysMask
   *
   * @param int $idWbfsysMask the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysMask, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMask_Ref_Comments_Table' );
    /* @var $query WbfsysMask_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysMask );
...
}//end class WbfsysMask_Ref_Comments_Table_Model
