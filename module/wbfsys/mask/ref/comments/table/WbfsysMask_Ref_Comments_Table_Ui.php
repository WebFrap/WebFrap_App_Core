 ...
 * @licence WebFrap.net
 */
class WbfsysMask_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysMask
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysMask_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysMask, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMask_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_mask-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysMask;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask-ref-comments-search-'
        .$idWbfsysMask;
    ...
    $tabPanel->searchKey = 'wbfsys_mask-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysMask_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysMask );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Mask_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysMask
    );
   ...
   * @return WbfsysMask_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysMask, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysMask_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysMask_Ref_Comments_Table_Ui
