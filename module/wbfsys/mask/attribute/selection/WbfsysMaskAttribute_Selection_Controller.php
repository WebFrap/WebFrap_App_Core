 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMaskAttribute_Selection' ) );
...
} // end class WbfsysMaskAttribute_Selection_Controller */
