 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMaskAttribute_Selection_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_mask_attribute.rowid ",
      'acls'
    );
...
}//end class WbfsysMaskAttribute_Selection_Access
