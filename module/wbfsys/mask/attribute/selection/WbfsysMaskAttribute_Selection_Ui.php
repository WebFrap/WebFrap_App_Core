 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMaskAttribute_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMaskAttribute_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMaskAttribute_Selection_Element
    (
      'selectionWbfsysMaskAttribute',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Mask Attributes', 'wbfsys.mask_attribute.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MaskAttribute.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMaskAttribute',
      'WbfsysMaskAttribute_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMaskAttribute_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMaskAttribute_Selection_Ui
