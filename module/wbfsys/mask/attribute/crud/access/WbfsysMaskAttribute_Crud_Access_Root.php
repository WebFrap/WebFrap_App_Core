 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMaskAttribute_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMaskAttribute_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMaskAttribute_Entity */
      $entity = $orm->get( 'WbfsysMaskAttribute', $rootId );
    }
...
}//end class WbfsysMaskAttribute_Crud_Access_Root
