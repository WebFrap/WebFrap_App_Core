 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMaskAttribute Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMaskAttribute = $this->model->getEntityWbfsysMaskAttribute();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Mask Attribute: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MaskAttribute.show  &amp;objid='.$entityWbfsysMaskAttribute
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MaskAttribute.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mask_attribute-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mask_attribute/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMaskAttribute_Crud_Show' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MaskAttribute.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMaskAttribute_Crud_Show_Maintab_View
