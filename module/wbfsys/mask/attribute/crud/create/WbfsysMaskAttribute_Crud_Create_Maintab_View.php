 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMaskAttribute Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_mask_attribute-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/mask_attribute/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskAttribute.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_mask_attribute';
    ...
    $form = $this->newForm( 'WbfsysMaskAttribute_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MaskAttribute.create');}});
});
...
}//end class WbfsysMaskAttribute_Crud_Create_Maintab_View
