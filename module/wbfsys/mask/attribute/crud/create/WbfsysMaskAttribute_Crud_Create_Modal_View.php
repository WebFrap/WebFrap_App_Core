 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMaskAttribute entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MaskAttribute.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MaskAttribute.insert';
    $params->formId       = 'wgt-form-wbfsys_mask_attribute';
    $params->namespace   = 'wbfsys_mask_attribute-create';
    ...
    $this->setTemplate( 'wbfsys/mask_attribute/modal/crud/form_create' );
...
}//end class WbfsysMaskAttribute_Crud_Create_Modal_View
