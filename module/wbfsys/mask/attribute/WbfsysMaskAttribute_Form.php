 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_mask_attribute';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMaskAttribute';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMaskAttribute' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMaskAttribute entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_attribute( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityAttribute_Entity' ) )
    {
      ...
      $inputIdAttribute = $this->view->newInput( 'input'.$this->prefix.'IdAttribute', 'Window' );
      $inputIdAttribute->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_attribute]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_attribute'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Attribute (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ));
      ...
      $inputIdAttribute->setReadOnly( $this->isReadOnly( 'id_attribute' ) );
      $inputIdAttribute->setLabel( $this->view->i18n->l( 'Attribute', 'wbfsys.mask_attribute.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityAttribute.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_attribute'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAttribute->buildJavascript( 'wgt-input-'.$this->keyName.'_id_attribute'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_attribute */
  ...
  public function input_id_mask( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMask_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Mask (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ));
      ...
      $inputIdMask->setLabel( $this->view->i18n->l( 'Mask', 'wbfsys.mask_attribute.label' ) );
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.mask_attribute.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.mask_attribute.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.mask_attribute.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.mask_attribute.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.mask_attribute.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.mask_attribute.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.mask_attribute.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.mask_attribute.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Mask Attribute)', 'wbfsys.mask_attribute.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.mask_attribute.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_attribute_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_mask_attribute_m_role_change';
...
}//end class WbfsysMaskAttribute_Form */
