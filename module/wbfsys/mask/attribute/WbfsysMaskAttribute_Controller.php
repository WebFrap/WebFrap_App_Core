 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_mask_attribute
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MaskAttribute.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_mask_attribute-create';

    $access = new WbfsysMaskAttribute_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_mask_attribute-create',
      'WbfsysMaskAttribute_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysMaskAttribute_Crud_Model */
    $model = $this->loadModel( 'WbfsysMaskAttribute_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MaskAttribute.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMaskAttribute = $model->getEntityWbfsysMaskAttribute( $objid );
    ...
    if( !$entityWbfsysMaskAttribute )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Mask Attribute', 'wbfsys.mask_attribute.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysMaskAttribute;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_mask_attribute:edit';

    $access = new WbfsysMaskAttribute_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMaskAttribute );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_mask_attribute-edit-'.$objid,
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_mask_attribute:show';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_mask_attribute
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MaskAttribute.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-insert';

    $access = new WbfsysMaskAttribute_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysMaskAttribute = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_mask_attribute-update-'.$entityWbfsysMaskAttribute;
      ...
      {
        $access = new WbfsysMaskAttribute_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysMaskAttribute );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysMaskAttribute';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_mask_attribute',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysMaskAttribute_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MaskAttribute.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMaskAttribute, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMaskAttribute_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.MaskAttribute.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-delete-'.$objid;

    $access = new WbfsysMaskAttribute_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMaskAttribute );
    ...
    $error = $model->delete( $entityWbfsysMaskAttribute, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMaskAttribute, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.MaskAttribute.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MaskAttribute.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-listing';
    ...
    $containerClass = 'WbfsysMaskAttribute_'.$listType.'_Access';
    ...
    /* @var $model WbfsysMaskAttribute_Table_Model */
    $model = $this->loadModel( 'WbfsysMaskAttribute_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_mask_attribute-'.$params->ltype,
          'WbfsysMaskAttribute',
          'List of Mask Attributes'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMaskAttribute
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMaskAttribute_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_mask_attribute',
      'WbfsysMaskAttribute_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMaskAttribute_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MaskAttribute.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMaskAttribute_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMaskAttribute_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_mask_attribute-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_mask_attribute-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_mask_attribute',
      'WbfsysMaskAttribute',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMaskAttribute, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysMaskAttribute_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMaskAttribute_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_mask_attribute-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_mask_attribute' ); //def wbfsys_mask_attribute
...
} // end class WbfsysMaskAttribute_Controller */
