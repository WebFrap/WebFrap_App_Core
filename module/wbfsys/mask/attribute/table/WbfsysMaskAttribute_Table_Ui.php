 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Mask Attributes
  *
  ...
  *  }
  *
  * @return WbfsysMaskAttribute_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMaskAttribute_Table_Element( 'tableWbfsysMaskAttribute', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask_attribute-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Mask Attributes', 'wbfsys.mask_attribute.label' );
      //$tabPanel->searchKey = 'wbfsys_mask_attribute';
      ...
      $searchElement->searchKey = 'wbfsys_mask_attribute';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMaskAttribute_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMaskAttribute', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMaskAttribute listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMaskAttribute  = $model->getEntityWbfsysMaskAttribute();
    ...
    $formWbfsysMaskAttribute->setKeyName( 'wbfsys_mask_attribute' );
...
}//end class WbfsysMaskAttribute_Table_Ui
