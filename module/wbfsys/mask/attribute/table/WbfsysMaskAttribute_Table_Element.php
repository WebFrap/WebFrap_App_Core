 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_mask_attribute';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMaskAttribute_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MaskAttribute.show&amp;target_mask=WbfsysMaskAttribute&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MaskAttribute.edit&amp;target_mask=WbfsysMaskAttribute&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mask_attribute.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.MaskAttribute_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.mask_attribute.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MaskAttribute.delete&amp;target_mask=WbfsysMaskAttribute&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mask_attribute.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_mask_attribute_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MaskAttribute_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Mask Attributes." >{$iconDelete} Delete selected Mask Attributes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Mask Attributes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MaskAttribute_Multi.deleteAll" >{$iconClean} Delete all Mask Attributes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMaskAttribute_Table_Element
