 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.MaskAttribute_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysMaskAttribute_Ref_Comments_Table_Ajax_View
