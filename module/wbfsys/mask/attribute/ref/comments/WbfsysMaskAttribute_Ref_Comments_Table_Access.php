 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMaskAttribute_Ref_Comments_Table_Query $query
...
}//end class WbfsysMaskAttribute_Ref_Comments_Table_Access
