 ...
 * If you want to extend this class write your coden in ControllerWbfsysMaskAttribute
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_mask_attribute management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMaskAttribute_Ref_Comments_".$listType."_Access";
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_mask_attribute-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysMaskAttribute_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMaskAttribute_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_mask_attribute-ref-comments-'.$listType.'-ajax',
    	'WbfsysMaskAttribute_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysMaskAttribute
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysMaskAttribute_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMaskAttribute_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMaskAttribute_Ref_Comments_'.$listType );
...
} // end WbfsysMaskAttribute_Ref_Comments_Controller
