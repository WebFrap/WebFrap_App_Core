 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysMaskAttribute
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysMaskAttribute_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysMaskAttribute, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMaskAttribute_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysMaskAttribute;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mask_attribute-ref-comments-search-'
        .$idWbfsysMaskAttribute;
    ...
    $tabPanel->searchKey = 'wbfsys_mask_attribute-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Comment',
            '$R.get(\'modal.php?c=Wbfsys.Comment.selection&exclude=wbfsys_entity_comment-vid-id_comment&objid='.$params->refId.'&target_mask=WbfsysMaskAttribute_Ref_Comments&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysMaskAttribute );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.MaskAttribute_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysMaskAttribute
    );
   ...
   * @return WbfsysMaskAttribute_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysMaskAttribute, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysMaskAttribute_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysMaskAttribute_Ref_Comments_Table_Ui
