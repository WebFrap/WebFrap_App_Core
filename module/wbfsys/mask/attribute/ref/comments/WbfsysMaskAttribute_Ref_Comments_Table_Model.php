 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysMaskAttribute
   *
   * @param int $idWbfsysMaskAttribute the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysMaskAttribute, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMaskAttribute_Ref_Comments_Table' );
    /* @var $query WbfsysMaskAttribute_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysMaskAttribute );
...
}//end class WbfsysMaskAttribute_Ref_Comments_Table_Model
