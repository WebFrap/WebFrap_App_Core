 ...
 * @licence WebFrap.net
 */
class WbfsysMaskAttribute_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.MaskAttribute_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_mask_attribute-ref-comments-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/mask_attribute/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysMaskAttribute_Ref_Comments_Table' );
...
}//end class WbfsysMaskAttribute_Ref_Comments_Table_Modal_View
