...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Videos
  *
  ...
  *  }
  *
  * @return WbfsysVideo_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideo_Table_Element( 'tableWbfsysVideo', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Videos', 'wbfsys.video.label' );
      //$tabPanel->searchKey = 'wbfsys_video';
      ...
      $searchElement->searchKey = 'wbfsys_video';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysVideo_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysVideo', $table->buildAjax() );
...
}//end class WbfsysVideo_Table_Ui
