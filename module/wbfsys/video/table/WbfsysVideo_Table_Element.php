  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.Video_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.video.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_video_title']).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.VideoCodec.listing" >'.Validator::sanitizeHtml($row['wbfsys_video_codec_name']).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.AudioCodec.listing" >'.Validator::sanitizeHtml($row['wbfsys_audio_codec_name']).'</a></td>'.NL;
