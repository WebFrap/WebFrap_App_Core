 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_video';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysVideo_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Video.show&amp;target_mask=WbfsysVideo&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.video.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Video.edit&amp;target_mask=WbfsysVideo&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.video.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.Video_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.video.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=Wbfsys.Video_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.video.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Video.delete&amp;target_mask=WbfsysVideo&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.video.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_video&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.video.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.video.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Video codec', 'wbfsys.video.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Audio codec', 'wbfsys.video.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_video_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.VideoCodec.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_video_codec_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Video_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Videos." >{$iconDelete} Delete selected Videos</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Videos. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Video_Multi.deleteAll" >{$iconClean} Delete all Videos</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysVideo_Table_Element
