 ...
 * If you want to extend this class write your coden in ControllerWbfsysVideo
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_video management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysVideo_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_video-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_video-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysVideo_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysVideo_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_video-ref-comments-'.$listType.'-ajax',
    	'WbfsysVideo_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysVideo
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_video-ref-comments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysVideo_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysVideo_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysVideo_Ref_Comments_'.$listType );
...
} // end WbfsysVideo_Ref_Comments_Controller
