 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysVideo
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysVideo_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysVideo, $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideo_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_video-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysVideo;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video-ref-comments-search-'
        .$idWbfsysVideo;
    ...
    $tabPanel->searchKey = 'wbfsys_video-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysVideo_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysVideo );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Video_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysVideo
    );
   ...
   * @return WbfsysVideo_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysVideo, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysVideo_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysVideo_Ref_Comments_Table_Ui
