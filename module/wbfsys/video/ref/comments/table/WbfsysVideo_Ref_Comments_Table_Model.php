 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysVideo, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysVideo_Ref_Comments_Table' );
    /* @var $query WbfsysVideo_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysVideo );
...
}//end class WbfsysVideo_Ref_Comments_Table_Model
