 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_video-comments';
   ...
   */
  public $namespace   = 'WbfsysVideo_Ref_Comments';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityComment.show&amp;target_mask=WbfsysVideo_Ref_Comments&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityComment.edit&amp;target_mask=WbfsysVideo_Ref_Comments&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_comment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityComment.delete&amp;target_mask=WbfsysVideo_Ref_Comments&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_comment.label',
        Acl::DELETE
...
}//end class WbfsysVideo_Ref_Comments_Table_Element
