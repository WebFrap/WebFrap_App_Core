 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Video_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysVideo_Ref_Comments_Table_Ajax_View
