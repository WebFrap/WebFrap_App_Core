 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_video-ref-comments' );
  ...
  /**
   * @param WbfsysVideo_Ref_Comments_Table_Query $query
...
}//end class WbfsysVideo_Ref_Comments_Table_Access
