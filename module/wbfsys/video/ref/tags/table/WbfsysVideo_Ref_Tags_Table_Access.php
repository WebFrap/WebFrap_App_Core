 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_video-ref-tags' );
  ...
  /**
   * @param WbfsysVideo_Ref_Tags_Table_Query $query
...
}//end class WbfsysVideo_Ref_Tags_Table_Access
