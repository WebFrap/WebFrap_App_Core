 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Tags_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.Video_Ref_Tags.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video-ref-tags-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Tags' );

    // set the default table template
    $this->setTemplate( 'wbfsys/video/ref_tags/tab_table' );

    $ui = $this->loadUi( 'WbfsysVideo_Ref_Tags_Table' );
...
}//end class WbfsysVideo_Ref_Tags_Table_Modal_View
