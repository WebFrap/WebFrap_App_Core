 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysVideo_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysVideo, $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideo_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_video-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysVideo;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video-ref-tags-search-'
        .$idWbfsysVideo;
    ...
    $tabPanel->searchKey = 'wbfsys_video-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysVideo_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysVideo );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.Video_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysVideo_Ref_Tags_Table_Ui
