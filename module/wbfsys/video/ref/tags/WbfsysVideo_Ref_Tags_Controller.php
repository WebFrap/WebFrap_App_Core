 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysVideo_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_video-ref-tags';
    ...
    (
      $params->tabId,
      'WbfsysVideo_Ref_Tags_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysVideo_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_video-ref-tags-'.$listType.'-ajax',
    	'WbfsysVideo_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysVideo
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysVideo_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysVideo_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysVideo_Ref_Tags_'.$listType );
...
} // end WbfsysVideo_Ref_Tags_Controller
