...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysVideo' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysVideo entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Video)', 'wbfsys.video.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.video.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Video)', 'wbfsys.video.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.video.label' ),
  ...
  public function input_id_mediathek( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMediathek_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Mediathek (Video)', 'wbfsys.video.label' ),
      ));
      ...
      $inputIdMediathek->setLabel( $this->view->i18n->l( 'Mediathek', 'wbfsys.video.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysContentLicence_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_licence'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Licence (Video)', 'wbfsys.video.label' ),
      ));
      ...
      $inputIdLicence->setLabel( $this->view->i18n->l( 'Licence', 'wbfsys.video.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysConfidentialityLevel_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Confidentiality (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Confidentiality', 'wbfsys.video.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysVideoCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Video codec (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Video codec', 'wbfsys.video.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysAudioCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Audio codec (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Audio codec', 'wbfsys.video.label' ),
  ...
  public function input_width( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Width (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      $inputWidth->setLabel
      (
        $this->view->i18n->l( 'Width', 'wbfsys.video.label' ),
  ...
  public function input_height( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Height (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Height', 'wbfsys.video.label' ),
  ...
  public function input_length( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Length (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Length', 'wbfsys.video.label' ),
  ...
  public function input_flag_color( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Color (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Color', 'wbfsys.video.label' ),
  ...
  * @return void
  */
  public function input_flag_sound( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagSound = $this->view->newInput( 'input'.$this->prefix.'FlagSound' , 'Checkbox' );
      $this->items['flag_sound'] = $inputFlagSound;
      $inputFlagSound->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_sound]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_sound'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Sound (Video)', 'wbfsys.video.label' ),
        )
      );
      $inputFlagSound->setWidth( 'medium' );

      $inputFlagSound->setReadOnly( $this->isReadOnly( 'flag_sound' ) );
      $inputFlagSound->setActive( $this->entity->getBoolean( 'flag_sound' ) );
      $inputFlagSound->setLabel
      (
        $this->view->i18n->l( 'Sound', 'wbfsys.video.label' ),
        $this->entity->required( 'flag_sound' )
      );
  ...
  }//end public function input_flag_sound */
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_lang'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Language (Video)', 'wbfsys.video.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Language', 'wbfsys.video.label' ) );
  ...
  public function input_file( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for File (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      if( ( $objid = $this->entity->getId() ) && $this->entity->file )
        $inputFile->setLink('file.php?f=wbfsys_video-file-'.$objid.'&amp;n='.base64_encode($this->entity->file));

      $inputFile->setLabel
      (
        $this->view->i18n->l( 'File', 'wbfsys.video.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.video.label' ),
  ...
  public function input_mimetype( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (Video)', 'wbfsys.video.label' ),
  ...
  public function input_file_size( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Size (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'File Size', 'wbfsys.video.label' ),
  ...
  public function input_file_hash( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Hash (Video)', 'wbfsys.video.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.video.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Video)', 'wbfsys.video.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.video.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Video)', 'wbfsys.video.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.video.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Video)', 'wbfsys.video.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.video.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Video)', 'wbfsys.video.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.video.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.video.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Video)', 'wbfsys.video.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.video.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Video)', 'wbfsys.video.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Video)', 'wbfsys.video.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
    ...
    if( !Webfrap::classLoadable( 'WbfsysVideoCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Video codec (Video)', 'wbfsys.video.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
    ...
    if( !Webfrap::classLoadable( 'WbfsysAudioCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_id_audio_codec'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Audio codec (Video)', 'wbfsys.video.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_video_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_video_m_role_change';
