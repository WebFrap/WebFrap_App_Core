 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysVideoCodec Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_video_codec.rowid as id',
      'wbfsys_video_codec.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_video_codec.m_order as "wbfsys_video_codec-m_order-order"' );

    $criteria->from( 'wbfsys_video_codec' );



      $criteria->orderBy( 'wbfsys_video_codec.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_video_codec.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_video_codec.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysVideoCodec_Selectbox_Query_Postgresql
