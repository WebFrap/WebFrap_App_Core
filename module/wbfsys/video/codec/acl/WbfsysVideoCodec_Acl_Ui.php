...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysVideoCodec_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoCodec_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL video video codec', 
        'wbfsys.video_codec.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_video_codec-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'video video codec', 'wbfsys.video_codec.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_video_codec_acl';
...
} // end class WbfsysVideoCodec_Acl_Ui */
