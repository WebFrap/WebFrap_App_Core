 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_video_codec.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysVideoCodec_Acl_Dset_Treetable_Query_Postgresql */
