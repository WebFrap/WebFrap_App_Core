 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysVideoCodec_Acl_Dset' );
    ...
    $entityWbfsysVideoCodec = $this->model->getEntity( $dsetId );
...
} // end class WbfsysVideoCodec_Acl_Dset_Ajax_View */
