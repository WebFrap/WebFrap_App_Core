 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysVideoCodec_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysVideoCodec_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysVideoCodec, $areaId, $access, $params  )
  {

    $listObj = new WbfsysVideoCodec_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_video_codec-acl-dset' );
    ...
    else
    {
      ...
      (
        'video video codec "{@label@}" User Access',
        'wbfsys.video_codec.label',
        array
        (
          'label' => $entityWbfsysVideoCodec->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_video_codec_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysVideoCodec_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysVideoCodec_Acl_Dset_Ui */
