 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_video_codec'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysVideoCodec', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideoCodec_Acl_Dset' );
    /* @var $query WbfsysVideoCodec_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideoCodec_Acl_Dset_Treetable' );
    /* @var $query WbfsysVideoCodec_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysVideoCodec_Acl_Dset_Model */
