 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.VideoCodec_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video_codec-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.VideoCodec_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_video_codec-acl-update';
    ...
    $this->setTemplate( 'wbfsys/video_codec/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'video video codec', 'wbfsys.video_codec.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_video_codec_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysVideoCodec_Acl' );
...
} // end class WbfsysVideoCodec_Acl_Maintab_View */
