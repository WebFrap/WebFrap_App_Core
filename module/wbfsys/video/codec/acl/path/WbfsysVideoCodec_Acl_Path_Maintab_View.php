 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/video_codec/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'video video codecs' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_video_codec-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_video_codec-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysVideoCodec_Acl_Path_Maintab_View */
