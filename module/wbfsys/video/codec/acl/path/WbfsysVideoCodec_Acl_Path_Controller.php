 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysVideoCodec_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysVideoCodec_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysVideoCodec_Acl_Path_Maintab_View  */
...
} // end class WbfsysVideoCodec_Acl_Path_Controller */
