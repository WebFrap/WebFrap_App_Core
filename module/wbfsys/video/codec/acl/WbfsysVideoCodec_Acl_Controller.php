 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    (
      'wbfsys_video_codec_acl_listing',
    ...
    $view->setModel( $this->loadModel('WbfsysVideoCodec_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysVideoCodec_Acl_Model */
    $model   = $this->loadModel( 'WbfsysVideoCodec_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_video_codec-acl',
    	'WbfsysVideoCodec_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_video_codec_acl_masks_listing',
      'WbfsysVideoCodec_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysVideoCodec_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysVideoCodec_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysVideoCodec_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysVideoCodec_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysVideoCodec_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysVideoCodec_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_video_codec-acl-qfdu',
    	'WbfsysVideoCodec_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysVideoCodec_Acl_Controller */
