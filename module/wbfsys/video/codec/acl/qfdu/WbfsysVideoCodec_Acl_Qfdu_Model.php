 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_video_codec')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysVideoCodec = $orm->get('WbfsysVideoCodec', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_video_codec_name']  = $refEntityWbfsysVideoCodec->name;

    }
    $tabData['wbfsys_video_codec_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysVideoCodec_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideoCodec_Acl' );
    /* @var $query WbfsysVideoCodec_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideoCodec_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysVideoCodec_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideoCodec_Acl_Qfdu' );
    /* @var $query WbfsysVideoCodec_Acl_Qfdu_Query  */
...
} // end class WbfsysVideoCodec_Acl_Qfdu_Model */
