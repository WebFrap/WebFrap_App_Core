 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_video_codec.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_video_codec.rowid as id,
    wbfsys_video_codec.name as value,
    wbfsys_video_codec.name as label
  FROM
    wbfsys_video_codec
  WHERE
    {$sqlWhere}
...
} // end class WbfsysVideoCodec_Acl_Qfdu_Query_Postgresql */
