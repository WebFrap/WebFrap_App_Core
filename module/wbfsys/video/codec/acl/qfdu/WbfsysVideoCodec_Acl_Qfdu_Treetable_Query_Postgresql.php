 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_video_codec.name as "wbfsys_video_codec_name"',
      'wbfsys_video_codec.rowid as "wbfsys_video_codec_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_video_codec on wbfsys_group_users.vid = wbfsys_video_codec.rowid'
    );
...
} // end class WbfsysVideoCodec_Acl_Qfdu_Treetable_Query_Postgresql */
