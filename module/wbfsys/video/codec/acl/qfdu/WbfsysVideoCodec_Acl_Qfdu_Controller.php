 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysVideoCodec_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_video_codec-acl-qfdu-aAjax',
      'WbfsysVideoCodec_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysVideoCodec_Acl_Qfdu_Controller */
