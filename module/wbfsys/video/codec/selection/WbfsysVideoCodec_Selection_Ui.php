 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysVideoCodec_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysVideoCodec_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoCodec_Selection_Element
    (
      'selectionWbfsysVideoCodec',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection video video codecs', 'wbfsys.video_codec.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.VideoCodec.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysVideoCodec',
      'WbfsysVideoCodec_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysVideoCodec_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVideoCodec_Selection_Ui
