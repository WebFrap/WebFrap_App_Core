 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysVideoCodec_Selection_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_video_codec') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_video_codec.rowid ",
      'acls'
    );
...
}//end class WbfsysVideoCodec_Selection_Access
