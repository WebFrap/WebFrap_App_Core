 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_video_codec';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysVideoCodec_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VideoCodec.show&amp;target_mask=WbfsysVideoCodec&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.VideoCodec.edit&amp;target_mask=WbfsysVideoCodec&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.video_codec.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VideoCodec.delete&amp;target_mask=WbfsysVideoCodec&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.video_codec.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_video_codec&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.video_codec.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.VideoCodec.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.video_codec.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.video_codec.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_video_codec_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_video_codec_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_video_codec_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.VideoCodec_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected video video codecs." >{$iconDelete} Delete selected video video codecs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! video video codecs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.VideoCodec_Multi.deleteAll" >{$iconClean} Delete all video video codecs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysVideoCodec_Selection_Element
