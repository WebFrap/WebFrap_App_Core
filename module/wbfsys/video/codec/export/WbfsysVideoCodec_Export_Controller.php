 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysVideoCodec_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysVideoCodec_Export_Listing_Access';
    ...
    // create a new WbfsysVideoCodec window
    $view = $this->loadView
    (
    	'export-wbfsys_video_codec',
    	'WbfsysVideoCodec_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysVideoCodec_Export' );
...
} // end class WbfsysVideoCodec_Export_Controller_Genf
