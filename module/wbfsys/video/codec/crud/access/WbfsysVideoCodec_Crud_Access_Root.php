 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysVideoCodec_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysVideoCodec_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysVideoCodec_Entity */
      $entity = $orm->get( 'WbfsysVideoCodec', $rootId );
    }
...
}//end class WbfsysVideoCodec_Crud_Access_Root
