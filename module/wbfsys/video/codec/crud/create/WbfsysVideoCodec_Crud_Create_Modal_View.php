 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysVideoCodec entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.VideoCodec.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VideoCodec.insert';
    $params->formId       = 'wgt-form-wbfsys_video_codec';
    $params->namespace   = 'wbfsys_video_codec-create';
    ...
    $this->setTemplate( 'wbfsys/video_codec/modal/crud/form_create' );
...
}//end class WbfsysVideoCodec_Crud_Create_Modal_View
