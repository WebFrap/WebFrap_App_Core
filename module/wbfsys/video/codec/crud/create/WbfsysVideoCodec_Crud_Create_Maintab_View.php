 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysVideoCodec Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new video video codec',
      'wbfsys.video_codec.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New video video codec',
      'wbfsys.video_codec.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_video_codec-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/video_codec/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VideoCodec.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_video_codec';
    ...
    $form = $this->newForm( 'WbfsysVideoCodec_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.VideoCodec.create');}});
});
...
}//end class WbfsysVideoCodec_Crud_Create_Maintab_View
