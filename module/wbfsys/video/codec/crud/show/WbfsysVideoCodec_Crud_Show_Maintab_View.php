 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysVideoCodec_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysVideoCodec Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideoCodec = $this->model->getEntityWbfsysVideoCodec();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show video video codec: {@text@}',
      'wbfsys.video_codec.label',
      array( 'text' => $entityWbfsysVideoCodec->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'video video codec: {@text@}',
      'wbfsys.video_codec.label',
      array( 'text' => $entityWbfsysVideoCodec->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VideoCodec.show  &amp;objid='.$entityWbfsysVideoCodec
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VideoCodec.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video_codec-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video_codec/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysVideoCodec_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.VideoCodec.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_video_codec' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_video_codec a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.VideoCodec.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.VideoCodec.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysVideoCodec_Crud_Show_Maintab_View
