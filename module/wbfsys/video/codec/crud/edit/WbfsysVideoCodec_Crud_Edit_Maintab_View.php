 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysVideoCodec Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideoCodec = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit video video codec: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VideoCodec.edit&amp;utf8=✓&amp;objid='.$entityWbfsysVideoCodec
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VideoCodec.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video_codec-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video_codec/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysVideoCodec_Crud_Edit' );
...
}//end class WbfsysVideoCodec_Crud_Edit_Maintab_View
