 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodecI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_video_codec_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysVideoCodecI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysVideoCodecI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysVideoCodecI18n';
   ...
   *
   * @var WbfsysVideoCodecI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysVideoCodecI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysVideoCodecI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysVideoCodecI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.video_codec_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_video_codec
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_video_codec( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysVideoCodec_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysVideoCodec not exists' );

      Log::warn('Looks like the Entity: WbfsysVideoCodec is missing');
      ...
      //p: Window
      $objidWbfsysVideoCodec = $this->entity->getData('id_wbfsys_video_codec') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysVideoCodec
          || !$entityWbfsysVideoCodec = $this->db->orm->get
          (
            'WbfsysVideoCodec',
            $objidWbfsysVideoCodec
          )
      ...
      {
        $entityWbfsysVideoCodec = $this->db->orm->newEntity( 'WbfsysVideoCodec' );
      }

      $inputIdWbfsysVideoCodec = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysVideoCodec', 'Window' );
      $inputIdWbfsysVideoCodec->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_video_codec]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_video_codec'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Video Codec (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysVideoCodec->assignedForm = $this->assignedForm;

      $inputIdWbfsysVideoCodec->setWidth( 'medium' );

      $inputIdWbfsysVideoCodec->setData( $this->entity->getData( 'id_wbfsys_video_codec' )  );
      $inputIdWbfsysVideoCodec->setReadOnly( $this->isReadOnly( 'id_wbfsys_video_codec' ) );
      $inputIdWbfsysVideoCodec->setLabel( $this->view->i18n->l( 'Wbfsys Video Codec', 'wbfsys.video_codec_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.VideoCodec.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_video_codec'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysVideoCodec->setListUrl ( $listUrl );
      $inputIdWbfsysVideoCodec->setListIcon( 'control/connect.png' );
      $inputIdWbfsysVideoCodec->setEntityUrl( 'maintab.php?c=Wbfsys.VideoCodec.edit' );
      $inputIdWbfsysVideoCodec->conEntity         = $entityWbfsysVideoCodec;
      $inputIdWbfsysVideoCodec->refresh           = $this->refresh;
      $inputIdWbfsysVideoCodec->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysVideoCodec->view = $this->view;
      $inputIdWbfsysVideoCodec->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_video_codec'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysVideoCodec );
  ...
  }//end public function input_id_wbfsys_video_codec */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.video_codec_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.video_codec_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.video_codec_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.video_codec_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.video_codec_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.video_codec_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.video_codec_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.video_codec_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.video_codec_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Video Codec I18n)', 'wbfsys.video_codec_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_video_codec_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_video_codec_i18n_m_role_change';
...
}//end class WbfsysVideoCodecI18n_Form */
