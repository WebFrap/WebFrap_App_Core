 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_video_codec';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VideoCodec.show&amp;target_mask=WbfsysVideoCodec&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.VideoCodec.edit&amp;target_mask=WbfsysVideoCodec&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.video_codec.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VideoCodec.delete&amp;target_mask=WbfsysVideoCodec&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.video_codec.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.VideoCodec.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_video_codec_name'])).'</a></td>'.NL;
...
}//end class WbfsysVideoCodec_Table_Element
