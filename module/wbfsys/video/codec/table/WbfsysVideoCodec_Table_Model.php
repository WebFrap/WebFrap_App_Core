 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysVideoCodec_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysVideoCodec_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function changeOrder( $orders )
  {
    ...
    try
    {
      ...
      {
        $orm->update( "WbfsysVideoCodec", $id, array( 'm_order' =>  $order ) );
      }
    }
    catch( LibDb_Exception $e )
    {
...
}//end class WbfsysVideoCodec_Table_Model
