 ...
 * @licence WebFrap.net
 */
class WbfsysVideoCodec_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für video video codecs
  *
  ...
  *  }
  *
  * @return WbfsysVideoCodec_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoCodec_Table_Element( 'tableWbfsysVideoCodec', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video_codec-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'video video codecs', 'wbfsys.video_codec.label' );
      //$tabPanel->searchKey = 'wbfsys_video_codec';
      ...
      $searchElement->searchKey = 'wbfsys_video_codec';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysVideoCodec_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysVideoCodec', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysVideoCodec listing maske
   *
   * @param WbfsysVideoCodec_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysVideoCodec  = $model->getEntityWbfsysVideoCodec();
    ...
    $formWbfsysVideoCodec->setKeyName( 'wbfsys_video_codec' );
...
}//end class WbfsysVideoCodec_Table_Ui
