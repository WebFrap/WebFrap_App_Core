 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysVideo
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysVideo_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysVideo_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysVideo_Acl_Model */
    $model   = $this->loadModel( 'WbfsysVideo_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_video_acl_masks_listing',
      'WbfsysVideo_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysVideo_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysVideo_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysVideo_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysVideo_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysVideo_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysVideo_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_video-acl-qfdu',
    	'WbfsysVideo_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysVideo_Acl_Controller */
