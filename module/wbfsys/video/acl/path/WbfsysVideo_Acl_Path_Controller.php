 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_video_acl_graph', 
      'WbfsysVideo_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysVideo_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysVideo_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysVideo_Acl_Path_Maintab_View  */
...
} // end class WbfsysVideo_Acl_Path_Controller */
