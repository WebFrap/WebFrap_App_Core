 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysVideo_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysVideo_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysVideo = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysVideo_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_video-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysVideo, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysVideo_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_video-acl-dset', 
    	'WbfsysVideo_Acl_Dset',
...
} // end class WbfsysVideo_Acl_Dset_Controller */
