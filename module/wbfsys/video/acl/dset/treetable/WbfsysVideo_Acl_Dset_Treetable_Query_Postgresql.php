 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_video.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysVideo_Acl_Dset_Treetable_Query_Postgresql */
