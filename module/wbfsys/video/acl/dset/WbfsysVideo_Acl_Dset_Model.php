 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_video'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideo_Acl_Dset' );
    /* @var $query WbfsysVideo_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideo_Acl_Dset_Treetable' );
    /* @var $query WbfsysVideo_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysVideo_Acl_Dset_Model */
