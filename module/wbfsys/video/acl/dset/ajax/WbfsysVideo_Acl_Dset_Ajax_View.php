 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysVideo_Acl_Dset' );
    ...
    $entityWbfsysVideo = $this->model->getEntity( $dsetId );
...
} // end class WbfsysVideo_Acl_Dset_Ajax_View */
