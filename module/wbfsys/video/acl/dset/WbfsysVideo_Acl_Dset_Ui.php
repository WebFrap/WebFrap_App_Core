...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysVideo_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysVideo_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysVideo, $areaId, $access, $params  )
  {

    $listObj = new WbfsysVideo_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_video-acl-dset' );
    ...
    else
    {
      ...
      (
        'Video "{@label@}" User Access',
        'wbfsys.video.label',
        array
        (
          'label' => $entityWbfsysVideo->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_video_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysVideo_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysVideo_Acl_Dset_Ui */
