...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysVideo_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideo_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_video-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Video', 'wbfsys.video.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_video_acl';
