 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysVideo_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_video-acl-qfdu-aAjax',
      'WbfsysVideo_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysVideo_Acl_Qfdu_Controller */
