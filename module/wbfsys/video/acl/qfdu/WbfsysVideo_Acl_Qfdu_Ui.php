...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysVideo_Acl_Qfdu_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysVideo_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new WbfsysVideo_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Video',
        'wbfsys.video.label'
      );
      $tabPanel->searchKey  = 'wbfsys_video_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new WbfsysVideo_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class WbfsysVideo_Acl_Qfdu_Ui */
