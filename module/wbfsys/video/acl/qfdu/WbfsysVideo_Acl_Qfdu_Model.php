 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_video')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysVideo = $orm->get('WbfsysVideo', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_video_title']  = $refEntityWbfsysVideo->title;

    }
    $tabData['wbfsys_video_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysVideo_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideo_Acl' );
    /* @var $query WbfsysVideo_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideo_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysVideo_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVideo_Acl_Qfdu' );
    /* @var $query WbfsysVideo_Acl_Qfdu_Query  */
...
} // end class WbfsysVideo_Acl_Qfdu_Model */
