 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_video.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_video.rowid as id,
    wbfsys_video.title as value,
    wbfsys_video.title as label
  FROM
    wbfsys_video
  WHERE
    {$sqlWhere}
...
} // end class WbfsysVideo_Acl_Qfdu_Query_Postgresql */
