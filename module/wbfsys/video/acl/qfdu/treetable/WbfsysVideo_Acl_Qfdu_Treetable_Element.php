 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Qfdu_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_video-acl-qfdu';
   ...
   *
   * @var WbfsysVideo_Acl_Table_Query
   */
  public $data        = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Video_Acl.cleanQfduGroup&amp;objid=',
        'control/clean.png',
        '',
        'wbf.label',
        Acl::ADMIN
      ...
      (
        ...
        'Inherit Rights',
        'maintab.php?c=Wbfsys.Video_Acl_Path.showGraph&amp;objid=',
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Video_Acl.deleteQfdUser&amp;objid=',
        'control/delete.png',
        '',
        'wbf.label',
        Acl::ADMIN
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Video_Acl.cleanQfdUser&amp;objid=',
        'control/clean.png',
        '',
        'wbf.label',
        Acl::ADMIN
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Video_Acl.deleteQfduDataset&amp;objid=',
        'control/delete.png',
        '',
        'wbf.label',
        Acl::ADMIN
 ...
 /**
      ...
      else
      {
        ...
        $body .= '<td valign="top" >'
          .'<input
            ...
            id="wgt-input-acl-wbfsys_video-qfdu-'.$objid.'-date_start"
        ...
        $body .= '<td valign="top" >'
          .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
            id="wgt-input-acl-wbfsys_video-qfdu-'.$objid.'-date_end"
  ...
  public function buildDatasetNode( $groupId, $userId, $groupPos, $userPos  )
  {
    ...
    foreach( $childs as $row )
    {
      ...
      $body .= '<td valign="top" class="ind2" >'.$this->icon( 'control/entity.png', 'Entity' ).' <a href="maintab.php?c=Wbfsys.Video.edit&amp;objid='.$row['wbfsys_video_rowid'].'" class="wcm wcm_req_ajax" >'.$row['wbfsys_video_title'].'<a></td>'.NL;
      $body .= '<td valign="top" >'
        .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
...
} // end class WbfsysVideo_Acl_Qfdu_Treetable_Element */
