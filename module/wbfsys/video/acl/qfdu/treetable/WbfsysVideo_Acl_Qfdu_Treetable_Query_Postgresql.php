 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_video.title as "wbfsys_video_title"',
      'wbfsys_video.rowid as "wbfsys_video_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_video on wbfsys_group_users.vid = wbfsys_video.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_video.title) like upper(\''.$part.'%\') )
...
} // end class WbfsysVideo_Acl_Qfdu_Treetable_Query_Postgresql */
