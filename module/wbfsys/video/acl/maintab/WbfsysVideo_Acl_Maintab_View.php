 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Video_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Video_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_video-acl-update';
    ...
    $this->setTemplate( 'wbfsys/video/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Video', 'wbfsys.video.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_video_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysVideo_Acl' );
...
} // end class WbfsysVideo_Acl_Maintab_View */
