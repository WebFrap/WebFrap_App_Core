 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysVideo Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideo = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Video.edit&amp;utf8=✓&amp;objid='.$entityWbfsysVideo
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Video.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysVideo_Crud_Edit' );
...
}//end class WbfsysVideo_Crud_Edit_Maintab_View
