 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysVideo entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Video.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Video.insert';
    $params->formId       = 'wgt-form-wbfsys_video';
    $params->namespace   = 'wbfsys_video-create';
    ...
    $this->setTemplate( 'wbfsys/video/modal/crud/form_create' );
...
}//end class WbfsysVideo_Crud_Create_Modal_View
