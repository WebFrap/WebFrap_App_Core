 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysVideo_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysVideo_Entity */
      $entity = $orm->get( 'WbfsysVideo', $rootId );
    }
...
}//end class WbfsysVideo_Crud_Access_Root
