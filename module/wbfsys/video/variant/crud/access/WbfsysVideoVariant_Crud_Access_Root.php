 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysVideoVariant_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysVideoVariant_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysVideoVariant_Entity */
      $entity = $orm->get( 'WbfsysVideoVariant', $rootId );
    }
...
}//end class WbfsysVideoVariant_Crud_Access_Root
