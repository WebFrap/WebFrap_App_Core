 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysVideoVariant_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysVideoVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideoVariant = $this->model->getEntityWbfsysVideoVariant();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Video Variant: {@text@}',
      'wbfsys.video_variant.label',
      array( 'text' => $entityWbfsysVideoVariant->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VideoVariant.show  &amp;objid='.$entityWbfsysVideoVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VideoVariant.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video_variant-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video_variant/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysVideoVariant_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.VideoVariant.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_video_variant' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_video_variant a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.VideoVariant.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.VideoVariant.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysVideoVariant_Crud_Show_Maintab_View
