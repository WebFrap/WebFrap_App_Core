 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysVideoVariant entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.VideoVariant.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VideoVariant.insert';
    $params->formId       = 'wgt-form-wbfsys_video_variant';
    $params->namespace   = 'wbfsys_video_variant-create';
    ...
    $this->setTemplate( 'wbfsys/video_variant/modal/crud/form_create' );
...
}//end class WbfsysVideoVariant_Crud_Create_Modal_View
