 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysVideoVariant Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_video_variant-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/video_variant/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VideoVariant.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_video_variant';
    ...
    $form = $this->newForm( 'WbfsysVideoVariant_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.VideoVariant.create');}});
});
...
}//end class WbfsysVideoVariant_Crud_Create_Maintab_View
