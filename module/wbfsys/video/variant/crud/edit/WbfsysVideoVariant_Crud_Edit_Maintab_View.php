 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysVideoVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideoVariant = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Video Variant: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VideoVariant.edit&amp;utf8=✓&amp;objid='.$entityWbfsysVideoVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VideoVariant.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video_variant-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video_variant/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysVideoVariant_Crud_Edit' );
...
}//end class WbfsysVideoVariant_Crud_Edit_Maintab_View
