 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysVideoVariant_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_video_variant.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_video_variant.rowid ",
      'acls'
    );
...
}//end class WbfsysVideoVariant_Selection_Access
