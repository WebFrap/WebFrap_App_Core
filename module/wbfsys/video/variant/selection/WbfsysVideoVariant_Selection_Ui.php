 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysVideoVariant_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysVideoVariant_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoVariant_Selection_Element
    (
      'selectionWbfsysVideoVariant',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Video Variants', 'wbfsys.video_variant.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.VideoVariant.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysVideoVariant',
      'WbfsysVideoVariant_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysVideoVariant_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVideoVariant_Selection_Ui
