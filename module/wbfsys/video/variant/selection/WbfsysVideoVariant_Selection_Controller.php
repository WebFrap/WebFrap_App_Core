 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysVideoVariant_Selection' ) );
...
} // end class WbfsysVideoVariant_Selection_Controller */
