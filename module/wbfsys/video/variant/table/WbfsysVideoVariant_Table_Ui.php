 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Video Variants
  *
  ...
  *  }
  *
  * @return WbfsysVideoVariant_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoVariant_Table_Element( 'tableWbfsysVideoVariant', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video_variant-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Video Variants', 'wbfsys.video_variant.label' );
      //$tabPanel->searchKey = 'wbfsys_video_variant';
      ...
      $searchElement->searchKey = 'wbfsys_video_variant';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysVideoVariant_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysVideoVariant', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysVideoVariant listing maske
   *
   * @param WbfsysVideoVariant_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysVideoVariant  = $model->getEntityWbfsysVideoVariant();
    ...
    $formWbfsysVideoVariant->setKeyName( 'wbfsys_video_variant' );
...
}//end class WbfsysVideoVariant_Table_Ui
