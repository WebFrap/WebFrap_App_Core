 ...
 * @licence WebFrap.net
 */
class WbfsysVideoVariant_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_video_variant';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysVideoVariant_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VideoVariant.show&amp;target_mask=WbfsysVideoVariant&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.VideoVariant.edit&amp;target_mask=WbfsysVideoVariant&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.video_variant.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VideoVariant.delete&amp;target_mask=WbfsysVideoVariant&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.video_variant.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Video codec', 'wbfsys.video_variant.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Audio codec', 'wbfsys.video_variant.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_video_variant_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.VideoVariant_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Video Variants." >{$iconDelete} Delete selected Video Variants</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Video Variants. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.VideoVariant_Multi.deleteAll" >{$iconClean} Delete all Video Variants</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysVideoVariant_Table_Element
