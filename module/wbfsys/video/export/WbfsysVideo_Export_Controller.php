 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysVideo_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysVideo_Export_Listing_Access';
    ...
    // create a new WbfsysVideo window
    $view = $this->loadView
    (
    	'export-wbfsys_video',
    	'WbfsysVideo_Export',
    ...
    $model = $this->loadModel( 'WbfsysVideo_Export' );
...
} // end class WbfsysVideo_Export_Controller_Genf
