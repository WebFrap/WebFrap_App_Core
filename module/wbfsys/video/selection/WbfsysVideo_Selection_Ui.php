 ...
 * @licence WebFrap.net
 */
class WbfsysVideo_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysVideo_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysVideo_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideo_Selection_Element
    (
      'selectionWbfsysVideo',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Videos', 'wbfsys.video.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Video.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysVideo_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVideo_Selection_Ui
