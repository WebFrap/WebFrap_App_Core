 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysVideoUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.VideoUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VideoUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_video_usage';
    $params->namespace   = 'wbfsys_video_usage-create';
    ...
    $this->setTemplate( 'wbfsys/video_usage/modal/crud/form_create' );
...
}//end class WbfsysVideoUsage_Crud_Create_Modal_View
