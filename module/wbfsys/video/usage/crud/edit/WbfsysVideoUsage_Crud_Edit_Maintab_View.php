 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysVideoUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVideoUsage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Video Usage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VideoUsage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysVideoUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VideoUsage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_video_usage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/video_usage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysVideoUsage_Crud_Edit' );
...
}//end class WbfsysVideoUsage_Crud_Edit_Maintab_View
