 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysVideoUsage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysVideoUsage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysVideoUsage_Entity */
      $entity = $orm->get( 'WbfsysVideoUsage', $rootId );
    }
...
}//end class WbfsysVideoUsage_Crud_Access_Root
