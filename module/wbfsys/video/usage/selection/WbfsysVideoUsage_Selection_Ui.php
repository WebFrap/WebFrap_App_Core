 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysVideoUsage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysVideoUsage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoUsage_Selection_Element
    (
      'selectionWbfsysVideoUsage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Video Usages', 'wbfsys.video_usage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.VideoUsage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysVideoUsage',
      'WbfsysVideoUsage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysVideoUsage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVideoUsage_Selection_Ui
