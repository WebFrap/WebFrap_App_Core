 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Video Usages
  *
  ...
  *  }
  *
  * @return WbfsysVideoUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVideoUsage_Table_Element( 'tableWbfsysVideoUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_video_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Video Usages', 'wbfsys.video_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_video_usage';
      ...
      $searchElement->searchKey = 'wbfsys_video_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysVideoUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysVideoUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysVideoUsage listing maske
   *
   * @param WbfsysVideoUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysVideoUsage  = $model->getEntityWbfsysVideoUsage();
    ...
    $formWbfsysVideoUsage->setKeyName( 'wbfsys_video_usage' );
...
}//end class WbfsysVideoUsage_Table_Ui
