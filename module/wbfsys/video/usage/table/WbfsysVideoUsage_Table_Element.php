 ...
 * @licence WebFrap.net
 */
class WbfsysVideoUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_video_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysVideoUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VideoUsage.show&amp;target_mask=WbfsysVideoUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.VideoUsage.edit&amp;target_mask=WbfsysVideoUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.video_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VideoUsage.delete&amp;target_mask=WbfsysVideoUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.video_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_video_usage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.VideoUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Video Usages." >{$iconDelete} Delete selected Video Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Video Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.VideoUsage_Multi.deleteAll" >{$iconClean} Delete all Video Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysVideoUsage_Table_Element
