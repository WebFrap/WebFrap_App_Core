...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_net_protocol';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysNetProtocol';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysNetProtocol' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysNetProtocol entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.net_protocol.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.net_protocol.label' ),
  ...
  * @return void
  */
  public function input_flag_encrypted( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagEncrypted = $this->view->newInput( 'input'.$this->prefix.'FlagEncrypted' , 'Checkbox' );
      $this->items['flag_encrypted'] = $inputFlagEncrypted;
      $inputFlagEncrypted->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_encrypted]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_encrypted'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Encrypted (Net Protocol)', 'wbfsys.net_protocol.label' ),
        )
      );
      $inputFlagEncrypted->setWidth( 'medium' );

      $inputFlagEncrypted->setReadOnly( $this->isReadOnly( 'flag_encrypted' ) );
      $inputFlagEncrypted->setActive( $this->entity->getBoolean( 'flag_encrypted' ) );
      $inputFlagEncrypted->setLabel
      (
        $this->view->i18n->l( 'Encrypted', 'wbfsys.net_protocol.label' ),
        $this->entity->required( 'flag_encrypted' )
      );
  ...
  }//end public function input_flag_encrypted */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Net Protocol)', 'wbfsys.net_protocol.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.net_protocol.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Net Protocol)', 'wbfsys.net_protocol.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.net_protocol.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.net_protocol.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.net_protocol.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.net_protocol.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Net Protocol)', 'wbfsys.net_protocol.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.net_protocol.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Net Protocol)', 'wbfsys.net_protocol.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.net_protocol.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Net Protocol)', 'wbfsys.net_protocol.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.net_protocol.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Net Protocol)', 'wbfsys.net_protocol.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Net Protocol)', 'wbfsys.net_protocol.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_net_protocol_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_net_protocol_m_role_change';
...
}//end class WbfsysNetProtocol_Form */
