 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_net_protocol';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysNetProtocol_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.NetProtocol.show&amp;target_mask=WbfsysNetProtocol&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.NetProtocol.edit&amp;target_mask=WbfsysNetProtocol&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.net_protocol.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.NetProtocol.delete&amp;target_mask=WbfsysNetProtocol&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.net_protocol.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.net_protocol.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_net_protocol_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.NetProtocol.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_net_protocol_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.NetProtocol_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Network Protocols." >{$iconDelete} Delete selected Network Protocols</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Network Protocols. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.NetProtocol_Multi.deleteAll" >{$iconClean} Delete all Network Protocols</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysNetProtocol_Table_Element
