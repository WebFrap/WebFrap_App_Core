 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysNetProtocol_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_net_protocol.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_net_protocol.rowid ",
      'acls'
    );
...
}//end class WbfsysNetProtocol_Table_Access
