 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Network Protocols
  *
  ...
  *  }
  *
  * @return WbfsysNetProtocol_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysNetProtocol_Table_Element( 'tableWbfsysNetProtocol', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_net_protocol-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Network Protocols', 'wbfsys.net_protocol.label' );
      //$tabPanel->searchKey = 'wbfsys_net_protocol';
      ...
      $searchElement->searchKey = 'wbfsys_net_protocol';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysNetProtocol_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysNetProtocol', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysNetProtocol listing maske
   *
   * @param WbfsysNetProtocol_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysNetProtocol  = $model->getEntityWbfsysNetProtocol();
    ...
    $formWbfsysNetProtocol->setKeyName( 'wbfsys_net_protocol' );
...
}//end class WbfsysNetProtocol_Table_Ui
