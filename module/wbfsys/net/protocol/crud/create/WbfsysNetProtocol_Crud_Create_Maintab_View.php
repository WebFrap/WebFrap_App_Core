 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysNetProtocol Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_net_protocol-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/net_protocol/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.NetProtocol.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_net_protocol';
    ...
    $form = $this->newForm( 'WbfsysNetProtocol_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.NetProtocol.create');}});
});
...
}//end class WbfsysNetProtocol_Crud_Create_Maintab_View
