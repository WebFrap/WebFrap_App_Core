 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysNetProtocol entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.NetProtocol.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.NetProtocol.insert';
    $params->formId       = 'wgt-form-wbfsys_net_protocol';
    $params->namespace   = 'wbfsys_net_protocol-create';
    ...
    $this->setTemplate( 'wbfsys/net_protocol/modal/crud/form_create' );
...
}//end class WbfsysNetProtocol_Crud_Create_Modal_View
