 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysNetProtocol_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysNetProtocol_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysNetProtocol_Entity */
      $entity = $orm->get( 'WbfsysNetProtocol', $rootId );
    }
...
}//end class WbfsysNetProtocol_Crud_Access_Root
