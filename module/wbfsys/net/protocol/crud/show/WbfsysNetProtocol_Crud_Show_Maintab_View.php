 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysNetProtocol_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysNetProtocol Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysNetProtocol = $this->model->getEntityWbfsysNetProtocol();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Network Protocol: {@text@}',
      'wbfsys.net_protocol.label',
      array( 'text' => $entityWbfsysNetProtocol->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.NetProtocol.show  &amp;objid='.$entityWbfsysNetProtocol
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.NetProtocol.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_net_protocol-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/net_protocol/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysNetProtocol_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.NetProtocol.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_net_protocol' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_net_protocol a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.NetProtocol.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.NetProtocol.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysNetProtocol_Crud_Show_Maintab_View
