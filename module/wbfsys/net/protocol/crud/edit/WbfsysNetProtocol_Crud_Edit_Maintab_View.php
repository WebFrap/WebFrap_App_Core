 ...
 * @licence WebFrap.net
 */
class WbfsysNetProtocol_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysNetProtocol Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysNetProtocol = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Network Protocol: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.NetProtocol.edit&amp;utf8=✓&amp;objid='.$entityWbfsysNetProtocol
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.NetProtocol.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_net_protocol-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/net_protocol/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysNetProtocol_Crud_Edit' );
...
}//end class WbfsysNetProtocol_Crud_Edit_Maintab_View
