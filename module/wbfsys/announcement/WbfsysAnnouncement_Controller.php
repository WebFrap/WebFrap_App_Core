 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_announcement-create';

    $access = new WbfsysAnnouncement_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_announcement-create',
    ...
    /* @var $model WbfsysAnnouncement_Crud_Model */
    $model = $this->loadModel( 'WbfsysAnnouncement_Crud' );
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysAnnouncement = $model->getEntityWbfsysAnnouncement( $objid );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_announcement:edit';

    $access = new WbfsysAnnouncement_Crud_Access_Edit( null, null, $this );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_announcement-edit',
          $entityWbfsysAnnouncement,
          'Edit Announcement :'.$entityWbfsysAnnouncement->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_announcement:show';
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_announcement-show',
          $entityWbfsysAnnouncement,
          'Show Announcement :'.$entityWbfsysAnnouncement->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-insert';

    $access = new WbfsysAnnouncement_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysAnnouncement = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_announcement-update-'.$entityWbfsysAnnouncement;
      ...
      {
        $access = new WbfsysAnnouncement_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysAnnouncement );
      }
      $params->access = $access;
      ...
      // model wird benötigt
      /* @var $model WbfsysAnnouncement_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-update-'.$objid;
  ...
  * @param WbfsysAnnouncement_Crud_Model $model the model
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    $access = new WbfsysAnnouncement_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysAnnouncement );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.Announcement.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-listing';
    ...
    $containerClass = 'WbfsysAnnouncement_'.$listType.'_Access';
    ...
    /* @var $model WbfsysAnnouncement_Table_Model */
    $model = $this->loadModel( 'WbfsysAnnouncement_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_announcement-'.$params->ltype,
          'WbfsysAnnouncement',
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysAnnouncement
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysAnnouncement_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_announcement',
      'WbfsysAnnouncement_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysAnnouncement_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.Announcement.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncement_Selection_Model */
    $model   = $this->loadModel( 'WbfsysAnnouncement_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_announcement-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_announcement-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_announcement',
      'WbfsysAnnouncement',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysAnnouncement, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysAnnouncement_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysAnnouncement_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysAnnouncement_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysAnnouncement, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_announcement' ); //def wbfsys_announcement
