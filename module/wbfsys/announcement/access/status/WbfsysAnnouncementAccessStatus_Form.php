 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementAccessStatus_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_announcement_access_status';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAnnouncementAccessStatus';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysAnnouncementAccessStatus';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysAnnouncementAccessStatus';
   ...
   *
   * @var WbfsysAnnouncementAccessStatus_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysAnnouncementAccessStatus entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAnnouncementAccessStatus' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAnnouncementAccessStatus entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_user( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for User (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.announcement_access_status.label' ) );
  ...
  * @return void
  */
  public function input_id_announcement( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAnnouncement_Entity' ) )
    {
      ...
      $inputIdAnnouncement = $this->view->newInput( 'input'.$this->prefix.'IdAnnouncement', 'Window' );
      $inputIdAnnouncement->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_announcement]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_announcement'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Announcement (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ));
      ...
      $inputIdAnnouncement->setReadOnly( $this->isReadOnly( 'id_announcement' ) );
      $inputIdAnnouncement->setLabel( $this->view->i18n->l( 'Announcement', 'wbfsys.announcement_access_status.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Announcement.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_announcement'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAnnouncement->buildJavascript( 'wgt-input-'.$this->keyName.'_id_announcement'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_announcement */
  ...
  * @return void
  */
  public function input_value( $params )
  {

      //tpl: class ui:int
      $inputValue = $this->view->newInput( 'input'.$this->prefix.'Value' , 'Int' );
      $this->items['value'] = $inputValue;
      $inputValue->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[value]',
          'id'        => 'wgt-input-'.$this->keyName.'_value'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Value (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
        )
      );
      $inputValue->setWidth( 'medium' );

      $inputValue->setReadOnly( $this->isReadOnly( 'value' ) );
      $inputValue->setData( $this->entity->getData( 'value' ) );
      $inputValue->setLabel
      (
        $this->view->i18n->l( 'Value', 'wbfsys.announcement_access_status.label' ),
        $this->entity->required( 'value' )
      );
  ...
  }//end public function input_value */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.announcement_access_status.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.announcement_access_status.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.announcement_access_status.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.announcement_access_status.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.announcement_access_status.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.announcement_access_status.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Announcement Access Status)', 'wbfsys.announcement_access_status.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.announcement_access_status.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_access_status_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_access_status_m_role_change';
...
}//end class WbfsysAnnouncementAccessStatus_Form */
