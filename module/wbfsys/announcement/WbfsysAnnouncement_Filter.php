 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_announcement') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_announcement.{$fieldName}
...
}//end class WbfsysAnnouncement_Filter
