 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Widget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   */
  public $namespace   = 'WbfsysAnnouncement_Widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Announcement.show&amp;target_mask=WbfsysAnnouncement_Widget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Announcement.edit&amp;target_mask=WbfsysAnnouncement_Widget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.announcement.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Announcement.delete&amp;target_mask=WbfsysAnnouncement_Widget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.announcement.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.Announcement_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.announcement.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.AnnouncementType.listing" >'.Validator::sanitizeHtml($row['wbfsys_announcement_type_name']).'</a></td>'.NL;
