 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WbfsysAnnouncement_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WbfsysAnnouncement_Widget' );
    ...
    $table = new WbfsysAnnouncement_Widget_Table_Element( 'tableWbfsysAnnouncementItem', $view );
    $table->setId( 'wgt-table-wbfsys_announcement-widget' );
    ...
    $params->searchFormId = 'wgt-form-wbfsys_announcement-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WbfsysAnnouncement_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.Announcement.create&amp;ltab=table&amp;target_mask=WbfsysAnnouncement_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.Announcement_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Wbfsys Announcement"  >
      <form
        id="wgt-form-wbfsys_announcement-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WbfsysAnnouncement.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-wbfsys_announcement-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WbfsysAnnouncement_Widget_Table_Element
    (
      'tableWbfsysAnnouncementItem',
      $view
    );
...
}// end class WbfsysAnnouncement_Widget
