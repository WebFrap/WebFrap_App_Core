 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAnnouncementType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL announcement Type', 
        'wbfsys.announcement_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_announcement_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'announcement Type', 'wbfsys.announcement_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_announcement_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysAnnouncementType_Acl_Table'
    );
...
} // end class WbfsysAnnouncementType_Acl_Ui */
