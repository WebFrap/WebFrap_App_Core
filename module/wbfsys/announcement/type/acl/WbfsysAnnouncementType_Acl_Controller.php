 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAnnouncementType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAnnouncementType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_announcement_type_acl_listing',
      'WbfsysAnnouncementType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysAnnouncementType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncementType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAnnouncementType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_announcement_type-acl',
    	'WbfsysAnnouncementType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_announcement_type_acl_masks_listing',
      'WbfsysAnnouncementType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAnnouncementType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAnnouncementType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncementType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAnnouncementType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAnnouncementType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAnnouncementType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_announcement_type-acl-qfdu',
    	'WbfsysAnnouncementType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAnnouncementType_Acl_Controller */
