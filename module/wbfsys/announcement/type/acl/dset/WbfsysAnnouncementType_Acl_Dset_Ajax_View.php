 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAnnouncementType_Acl_Dset' );
    ...
    $entityWbfsysAnnouncementType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAnnouncementType_Acl_Dset_Ajax_View */
