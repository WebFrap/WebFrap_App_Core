 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAnnouncementType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAnnouncementType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAnnouncementType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAnnouncementType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_announcement_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'announcement Type "{@label@}" User Access',
        'wbfsys.announcement_type.label',
        array
        (
          'label' => $entityWbfsysAnnouncementType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_announcement_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAnnouncementType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAnnouncementType_Acl_Dset_Ui */
