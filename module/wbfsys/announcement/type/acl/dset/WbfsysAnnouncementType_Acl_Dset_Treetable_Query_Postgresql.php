 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_announcement_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAnnouncementType_Acl_Dset_Treetable_Query_Postgresql */
