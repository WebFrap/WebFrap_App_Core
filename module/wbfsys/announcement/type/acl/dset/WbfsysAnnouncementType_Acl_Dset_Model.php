 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_announcement_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAnnouncementType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncementType_Acl_Dset' );
    /* @var $query WbfsysAnnouncementType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncementType_Acl_Dset_Treetable' );
    /* @var $query WbfsysAnnouncementType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAnnouncementType_Acl_Dset_Model */
