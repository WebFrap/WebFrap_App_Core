 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncementType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAnnouncementType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAnnouncementType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAnnouncementType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_announcement_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAnnouncementType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_announcement_type-acl-dset', 
    	'WbfsysAnnouncementType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAnnouncementType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_announcement_type-acl-dset', 
    	'WbfsysAnnouncementType_Acl_Dset',
...
} // end class WbfsysAnnouncementType_Acl_Dset_Controller */
