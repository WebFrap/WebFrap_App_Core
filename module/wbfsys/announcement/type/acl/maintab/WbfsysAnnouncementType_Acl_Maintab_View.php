 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysAnnouncementType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.AnnouncementType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.AnnouncementType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_announcement_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/announcement_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'announcement Type', 'wbfsys.announcement_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_announcement_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAnnouncementType_Acl' );
...
} // end class WbfsysAnnouncementType_Acl_Maintab_View */
