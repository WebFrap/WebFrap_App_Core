 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/announcement_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'announcement Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_announcement_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_announcement_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysAnnouncementType_Acl_Path_Maintab_View */
