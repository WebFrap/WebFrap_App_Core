 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_announcement_type_acl_graph', 
      'WbfsysAnnouncementType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAnnouncementType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAnnouncementType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAnnouncementType_Acl_Path_Maintab_View  */
...
} // end class WbfsysAnnouncementType_Acl_Path_Controller */
