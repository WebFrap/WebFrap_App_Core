 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAnnouncementType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_announcement_type-acl-qfdu-aAjax',
      'WbfsysAnnouncementType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAnnouncementType_Acl_Qfdu_Controller */
