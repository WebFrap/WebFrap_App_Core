 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_announcement_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_announcement_type.rowid as id,
    wbfsys_announcement_type.name as value,
    wbfsys_announcement_type.name as label
  FROM
...
} // end class WbfsysAnnouncementType_Acl_Qfdu_Query_Postgresql */
