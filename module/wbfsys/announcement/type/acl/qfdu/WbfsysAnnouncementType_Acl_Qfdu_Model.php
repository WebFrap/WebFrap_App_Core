 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_announcement_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysAnnouncementType = $orm->get('WbfsysAnnouncementType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_announcement_type_name']  = $refEntityWbfsysAnnouncementType->name;

    }
    $tabData['wbfsys_announcement_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysAnnouncementType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncementType_Acl' );
    /* @var $query WbfsysAnnouncementType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncementType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysAnnouncementType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncementType_Acl_Qfdu' );
    /* @var $query WbfsysAnnouncementType_Acl_Qfdu_Query  */
...
} // end class WbfsysAnnouncementType_Acl_Qfdu_Model */
