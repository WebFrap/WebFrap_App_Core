 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAnnouncementType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAnnouncementType_Export_Listing_Access';
    ...
    // create a new WbfsysAnnouncementType window
    $view = $this->loadView
    (
    	'export-wbfsys_announcement_type',
    	'WbfsysAnnouncementType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysAnnouncementType_Export' );
...
} // end class WbfsysAnnouncementType_Export_Controller_Genf
