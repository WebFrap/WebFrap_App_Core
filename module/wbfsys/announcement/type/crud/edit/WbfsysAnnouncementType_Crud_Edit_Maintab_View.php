 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAnnouncementType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAnnouncementType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit announcement Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AnnouncementType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAnnouncementType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AnnouncementType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_announcement_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/announcement_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAnnouncementType_Crud_Edit' );
...
}//end class WbfsysAnnouncementType_Crud_Edit_Maintab_View
