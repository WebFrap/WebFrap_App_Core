 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAnnouncementType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AnnouncementType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AnnouncementType.insert';
    $params->formId       = 'wgt-form-wbfsys_announcement_type';
    $params->namespace   = 'wbfsys_announcement_type-create';
    ...
    $this->setTemplate( 'wbfsys/announcement_type/modal/crud/form_create' );
...
}//end class WbfsysAnnouncementType_Crud_Create_Modal_View
