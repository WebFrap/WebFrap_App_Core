 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAnnouncementType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAnnouncementType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAnnouncementType_Entity */
      $entity = $orm->get( 'WbfsysAnnouncementType', $rootId );
    }
...
}//end class WbfsysAnnouncementType_Crud_Access_Root
