 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAnnouncementType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAnnouncementType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementType_Selection_Element
    (
      'selectionWbfsysAnnouncementType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection announcement Types', 'wbfsys.announcement_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AnnouncementType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAnnouncementType',
      'WbfsysAnnouncementType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAnnouncementType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAnnouncementType_Selection_Ui
