 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysAnnouncementType_Selection' ) );
...
} // end class WbfsysAnnouncementType_Selection_Controller */
