 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysAnnouncementType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_announcement_type.rowid as id',
      'wbfsys_announcement_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_announcement_type.m_order as "wbfsys_announcement_type-m_order-order"' );

    $criteria->from( 'wbfsys_announcement_type' );



      $criteria->orderBy( 'wbfsys_announcement_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_announcement_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_announcement_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysAnnouncementType_Selectbox_Query_Postgresql
