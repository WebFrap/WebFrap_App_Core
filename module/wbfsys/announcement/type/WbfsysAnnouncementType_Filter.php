 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_announcement_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_announcement_type.{$fieldName}
...
}//end class WbfsysAnnouncementType_Filter
