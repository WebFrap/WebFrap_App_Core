 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_announcement_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAnnouncementTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysAnnouncementTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysAnnouncementTypeI18n';
   ...
   *
   * @var WbfsysAnnouncementTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysAnnouncementTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAnnouncementTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAnnouncementTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.announcement_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_announcement_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_announcement_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysAnnouncementType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysAnnouncementType not exists' );

      Log::warn('Looks like the Entity: WbfsysAnnouncementType is missing');
      ...
      //p: Window
      $objidWbfsysAnnouncementType = $this->entity->getData('id_wbfsys_announcement_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysAnnouncementType
          || !$entityWbfsysAnnouncementType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysAnnouncementType = $this->db->orm->newEntity( 'WbfsysAnnouncementType' );
      }

      $inputIdWbfsysAnnouncementType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysAnnouncementType', 'Window' );
      $inputIdWbfsysAnnouncementType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_announcement_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_announcement_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Announcement Type (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysAnnouncementType->assignedForm = $this->assignedForm;

      $inputIdWbfsysAnnouncementType->setWidth( 'medium' );

      $inputIdWbfsysAnnouncementType->setData( $this->entity->getData( 'id_wbfsys_announcement_type' )  );
      $inputIdWbfsysAnnouncementType->setReadOnly( $this->isReadOnly( 'id_wbfsys_announcement_type' ) );
      $inputIdWbfsysAnnouncementType->setLabel( $this->view->i18n->l( 'Wbfsys Announcement Type', 'wbfsys.announcement_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.AnnouncementType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_announcement_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysAnnouncementType->setListUrl ( $listUrl );
      $inputIdWbfsysAnnouncementType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysAnnouncementType->setEntityUrl( 'maintab.php?c=Wbfsys.AnnouncementType.edit' );
      $inputIdWbfsysAnnouncementType->conEntity         = $entityWbfsysAnnouncementType;
      $inputIdWbfsysAnnouncementType->refresh           = $this->refresh;
      $inputIdWbfsysAnnouncementType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysAnnouncementType->view = $this->view;
      $inputIdWbfsysAnnouncementType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_announcement_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysAnnouncementType );
  ...
  }//end public function input_id_wbfsys_announcement_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.announcement_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.announcement_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.announcement_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.announcement_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.announcement_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.announcement_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.announcement_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.announcement_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.announcement_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Announcement Type I18n)', 'wbfsys.announcement_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_type_i18n_m_role_change';
...
}//end class WbfsysAnnouncementTypeI18n_Form */
