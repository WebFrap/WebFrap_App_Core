 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für announcement Types
  *
  ...
  *  }
  *
  * @return WbfsysAnnouncementType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementType_Table_Element( 'tableWbfsysAnnouncementType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'announcement Types', 'wbfsys.announcement_type.label' );
      //$tabPanel->searchKey = 'wbfsys_announcement_type';
      ...
      $searchElement->searchKey = 'wbfsys_announcement_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAnnouncementType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAnnouncementType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAnnouncementType listing maske
   *
   * @param WbfsysAnnouncementType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAnnouncementType  = $model->getEntityWbfsysAnnouncementType();
    ...
    $formWbfsysAnnouncementType->setKeyName( 'wbfsys_announcement_type' );
...
}//end class WbfsysAnnouncementType_Table_Ui
