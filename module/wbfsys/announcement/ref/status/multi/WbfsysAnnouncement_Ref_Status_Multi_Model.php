 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Status_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listStatus = $this->getRegisterd('listRefStatus'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listStatus was not registered'
        );
      }

      foreach( $listStatus as $entityWbfsysAnnouncement )
      {
        if(!$orm->save( $entityWbfsysAnnouncement) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Announcement '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Announcement '.$entityText,
              'wbfsys.announcement.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Announcement: '.$textSaved,
          'wbfsys.announcement.message',
          array($textSaved)
        )
      );
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefStatus',$listWbfsysUserAnnouncement);
      return true;
...
}//end class WbfsysAnnouncement_Ref_Status_Multi_Model
