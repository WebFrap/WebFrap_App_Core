 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Status_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Announcement_Ref_Status.search&amp;objid='.$objid,
        $params
      );
    }
    ...
    $ui  = $this->loadUi( 'WbfsysAnnouncement_Ref_Status_Table' );
...
}//end class WbfsysAnnouncement_Ref_Status_Table_Ajax_View
