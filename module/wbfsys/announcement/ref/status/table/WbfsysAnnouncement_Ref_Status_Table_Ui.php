 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Status_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAnnouncement_Ref_Status_Table_Element
   */
  public function createListItem( $idWbfsysAnnouncement, $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncement_Ref_Status_Table_Element
    (
      'tableStatus',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_announcement-conref-status'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-status-'.$idWbfsysAnnouncement;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement-ref-status-search-'
    ...
    $tabPanel->searchKey = 'wbfsys_announcement-ref-status';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.get(\'modal.php?c=Wbfsys.RoleUser.selection&exclude=wbfsys_user_announcement-id_announcement-id_user&objid='.$params->refId.'&target_mask=WbfsysAnnouncement_Ref_Status&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabStatus', true );
    $view->addVar( 'refIdStatus', $idWbfsysAnnouncement );
    $view->addVar
    (
      'searchFormActionStatus',
      'ajax.php?c=Wbfsys.Announcement_Ref_Status.search&amp;target_id='
   ...
   * @return WbfsysAnnouncement_Ref_Status_Table_Element
   */
  public function listEntry( $idStatus, $access, $params, $insertMode )
  {
    ...
    // if a table id is given use it for the table
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-status-'.$idStatus;
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowStatus', $table->buildAjax() );
...
JSCODE;
  ...
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysUserAnnouncement  = $model->getEntityWbfsysUserAnnouncement();
    ...
    $formWbfsysUserAnnouncement->setKeyName( 'wbfsys_user_announcement' );
...
}//end class WbfsysAnnouncement_Ref_Status_Table_Ui
