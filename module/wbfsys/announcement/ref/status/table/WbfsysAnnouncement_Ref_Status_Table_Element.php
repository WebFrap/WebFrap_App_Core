 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Status_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_announcement-status';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserAnnouncement_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysAnnouncement_Ref_Status';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserAnnouncement.show&amp;target_mask=WbfsysAnnouncement_Ref_Status&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserAnnouncement.edit&amp;target_mask=WbfsysAnnouncement_Ref_Status&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_announcement.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserAnnouncement.delete&amp;target_mask=WbfsysAnnouncement_Ref_Status&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_announcement.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.user_announcement.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_announcement_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.UserAnnouncementStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_announcement_status_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.UserAnnouncement.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_name'])).'</a></td>'.NL;
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.UserAnnouncement.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_firstname'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.UserAnnouncement.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_lastname'])).'</a></td>'.NL;
...
}//end class WbfsysAnnouncement_Ref_Status_Table_Element
