 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Attachments_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_entity_attachment.rowid as "wbfsys_entity_attachment_rowid"', // variant:  
      'wbfsys_file.name as "wbfsys_file_name"', // variant:  
      'wbfsys_file.link as "wbfsys_file_link"', // variant:  
      'wbfsys_file_type.name as "wbfsys_file_type_name"', // variant:   used source field wbfsys_file_type
      'wbfsys_file.id_type as "wbfsys_file_id_type"', // ref wbfsys_file  
      'wbfsys_file.flag_versioning as "wbfsys_file_flag_versioning"', // variant:  
      'wbfsys_file.description as "wbfsys_file_description"', // variant:  
      'wbfsys_file.rowid as "wbfsys_file_rowid"', // variant:  
    );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_attachment.vid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_attachment.vid = '.$condition );
        }
        else
        {
...
}//end class WbfsysAnnouncement_Ref_Attachments_Table_Query_Postgresql
