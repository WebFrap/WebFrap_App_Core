 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Attachments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysAnnouncement, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysAnnouncement_Ref_Attachments_Table' );
    /* @var $query WbfsysAnnouncement_Ref_Attachments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_attachment.vid = '.$idWbfsysAnnouncement );
...
}//end class WbfsysAnnouncement_Ref_Attachments_Table_Model
