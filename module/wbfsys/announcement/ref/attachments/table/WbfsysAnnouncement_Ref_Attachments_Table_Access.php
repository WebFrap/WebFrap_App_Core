 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Attachments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_announcement-ref-attachments' );
  ...
  /**
   * @param WbfsysAnnouncement_Ref_Attachments_Table_Query $query
...
}//end class WbfsysAnnouncement_Ref_Attachments_Table_Access
