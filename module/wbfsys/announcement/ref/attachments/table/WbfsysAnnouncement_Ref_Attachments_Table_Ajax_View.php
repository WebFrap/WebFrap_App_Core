 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Attachments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Announcement_Ref_Attachments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysAnnouncement_Ref_Attachments_Table_Ajax_View
