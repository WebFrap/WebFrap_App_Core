 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Ref_Attachments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.Announcement_Ref_Attachments.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_announcement-ref-attachments-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/announcement/ref_attachments/tab_table' );

    $ui = $this->loadUi( 'WbfsysAnnouncement_Ref_Attachments_Table' );
...
}//end class WbfsysAnnouncement_Ref_Attachments_Table_Modal_View
