 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAnnouncement_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAnnouncement_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncement_Selection_Element
    (
      'selectionWbfsysAnnouncement',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Announcements', 'wbfsys.announcement.label' ) ;
      $tabPanel->searchKey = 'wbfsys_announcement';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Announcement.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAnnouncement',
      'WbfsysAnnouncement_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAnnouncement_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAnnouncement_Selection_Ui
