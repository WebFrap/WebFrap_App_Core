 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    if( $free = $httpRequest->param( 'free_search' , Validator::TEXT ) )
      ...
      if( $mRoleCreate = $httpRequest->param( 'search_wbfsys_announcement', Validator::EID, 'm_role_create'   ) )
        $condition['wbfsys_announcement']['m_role_create'] = $mRoleCreate;

      if( $mRoleChange = $httpRequest->param( 'search_wbfsys_announcement', Validator::EID, 'm_role_change'   ) )
        $condition['wbfsys_announcement']['m_role_change'] = $mRoleChange;

      if( $mTimeCreatedBefore = $httpRequest->param( 'search_wbfsys_announcement', Validator::DATE, 'm_time_created_before'   ) )
        $condition['wbfsys_announcement']['m_time_created_before'] = $mTimeCreatedBefore;

      if( $mTimeCreatedAfter = $httpRequest->param( 'search_wbfsys_announcement', Validator::DATE, 'm_time_created_after'   ) )
        $condition['wbfsys_announcement']['m_time_created_after'] = $mTimeCreatedAfter;

      if( $mTimeChangedBefore = $httpRequest->param( 'search_wbfsys_announcement', Validator::DATE, 'm_time_changed_before'   ) )
        $condition['wbfsys_announcement']['m_time_changed_before'] = $mTimeChangedBefore;

      if( $mTimeChangedAfter = $httpRequest->param( 'search_wbfsys_announcement}', Validator::DATE, 'm_time_changed_after'   ) )
        $condition['wbfsys_announcement']['m_time_changed_after'] = $mTimeChangedAfter;

      if( $mRowid = $httpRequest->param( 'search_wbfsys_announcement', Validator::EID, 'm_rowid'   ) )
        $condition['wbfsys_announcement']['m_rowid'] = $mRowid;

      if( $mUuid = $httpRequest->param( 'search_wbfsys_announcement', Validator::TEXT, 'm_uuid'    ) )
    ...
    $query = $db->newQuery( 'WbfsysAnnouncement_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysAnnouncement_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysAnnouncement_Selection_Model
