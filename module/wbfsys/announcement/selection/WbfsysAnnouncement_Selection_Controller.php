 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysAnnouncement_Selection' ) );
...
} // end class WbfsysAnnouncement_Selection_Controller */
