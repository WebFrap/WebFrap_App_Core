 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Announcements
  *
  ...
  *  }
  *
  * @return WbfsysAnnouncement_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncement_Table_Element( 'tableWbfsysAnnouncement', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Announcements', 'wbfsys.announcement.label' );
      ...
      $searchElement->searchKey = 'wbfsys_announcement';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAnnouncement_Table_Element( null,$view );
...
}//end class WbfsysAnnouncement_Table_Ui
