 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_announcement';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Announcement.show&amp;target_mask=WbfsysAnnouncement&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Announcement.edit&amp;target_mask=WbfsysAnnouncement&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.announcement.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attachments',
            'modal.php?c=Wbfsys.Announcement_Ref_Attachments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.announcement.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'User Status',
            'modal.php?c=Wbfsys.Announcement_Ref_Status.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.announcement.label',
          ),
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_announcement&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.announcement.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.announcement.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.announcement.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_announcement_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.AnnouncementType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_announcement_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Announcement_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Announcements." >{$iconDelete} Delete selected Announcements</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Announcements. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Announcement_Multi.deleteAll" >{$iconClean} Delete all Announcements</a></li>
  	</ul>
 	</div>
