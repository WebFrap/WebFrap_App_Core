 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_announcement', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      if( !$entityWbfsysAnnouncement = $this->getRegisterd( 'entityWbfsysAnnouncement' ) )
      {
        ...
        (
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysAnnouncement' )
          )
        );
      }
      ...
      else
      {
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysAnnouncement );
      }
   ...
   */
  public function delete( $entityWbfsysAnnouncement, $params  )
  {
    ...
    $delId     = $entityWbfsysAnnouncement->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysAnnouncement );
      ...
      (
        ...
        $this->protocol
        (
          'Deleted Announcement: '.$entityText,
          'delete',
          array( 'WbfsysAnnouncement', $delId )
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      {
        if( isset( $fields['wbfsys_announcement'] )  )
          $params->fieldsWbfsysAnnouncement  = $fields['wbfsys_announcement'];
        else
          $params->fieldsWbfsysAnnouncement  = array();
      }
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysAnnouncement, $params )
  {
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysAnnouncement = $orm->get( 'WbfsysAnnouncement',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_announcement'] = array();
    $saveFields['wbfsys_announcement'][] = 'title';
        $saveFields['wbfsys_announcement'][] = 'date_start';
        $saveFields['wbfsys_announcement'][] = 'vid';
        $saveFields['wbfsys_announcement'][] = 'id_user';
        $saveFields['wbfsys_announcement'][] = 'id_channel';
        $saveFields['wbfsys_announcement'][] = 'id_process_status';
        $saveFields['wbfsys_announcement'][] = 'id_type';
        $saveFields['wbfsys_announcement'][] = 'importance';
        $saveFields['wbfsys_announcement'][] = 'message';
        $saveFields['wbfsys_announcement'][] = 'date_end';
        $saveFields['wbfsys_announcement'][] = 'id_vid_entity';
        $saveFields['wbfsys_announcement'][] = 'm_version';
...
}//end WbfsysAnnouncement_Crud_Model
