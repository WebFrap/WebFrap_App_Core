 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAnnouncement_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAnnouncement_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAnnouncement_Entity */
      $entity = $orm->get( 'WbfsysAnnouncement', $rootId );
    }
...
}//end class WbfsysAnnouncement_Crud_Access_Root
