 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAnnouncement Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAnnouncement = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Announcement.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAnnouncement
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Announcement.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_announcement-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/announcement/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAnnouncement_Crud_Edit' );
...
}//end class WbfsysAnnouncement_Crud_Edit_Maintab_View
