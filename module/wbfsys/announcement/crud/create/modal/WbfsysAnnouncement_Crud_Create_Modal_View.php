 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAnnouncement entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Announcement.create'
    );
    ...
    $params->namespace   = 'wbfsys_announcement-create';
    ...
    $this->setTemplate( 'wbfsys/announcement/modal/crud/form_create' );
...
}//end class WbfsysAnnouncement_Crud_Create_Modal_View
