 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_announcement_channel_subscription', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
    ...
    if( $objid )
    {
      $searchId = $objid;
      $keyType  = 'rowid';
      $entity   = $orm->get( 'WbfsysAnnouncementChannelSubscription', $objid );
    }
    else if( $uuid )
    {
      $searchId = $uuid;
      $keyType  = 'uuid';
      $entity   = $orm->getByUuid( 'WbfsysAnnouncementChannelSubscription', $uuid );
    }
    else if( $accessKey )
    {
      $searchId = $accessKey;
      $keyType  = 'access_key';
      $entity   = $orm->getByKey( 'WbfsysAnnouncementChannelSubscription', $accessKey );
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      if( !$entityWbfsysAnnouncementChannelSubscription = $this->getRegisterd( 'entityWbfsysAnnouncementChannelSubscription' ) )
      {
        return new Error
        (
          $response->i18n->l
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysAnnouncementChannelSubscription' )
          )
        );
      }
      ...
      else
      {
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysAnnouncementChannelSubscription );
      }
    ...
    try
    {
      ...
      if( !$orm->update( $entityWbfsysAnnouncementChannelSubscription ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to update Announcement Subscription {@label@}',
            'wbfsys.announcement_channel_subscription.message',
            array
            (
              'label' =>  $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully updated Announcement Subscription {@label@}',
            'wbfsys.announcement_channel_subscription.message',
            array
            (
              'label' =>  $entityText
        ...
        $this->protocol
        (
          'edited Announcement Subscription: '.$entityText,
          'edit',
          $entityWbfsysAnnouncementChannelSubscription
        );
   ...
   */
  public function delete( $entityWbfsysAnnouncementChannelSubscription, $params  )
  {
    ...
    $delId     = $entityWbfsysAnnouncementChannelSubscription->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysAnnouncementChannelSubscription );

      $response->addMessage
      (
        $response->i18n->l
        (
          'Successfully deleted Announcement Subscription {@label@}',
          'wbfsys.announcement_channel_subscription.message',
          array( 'label' => $entityText )
        )
      );
        ...
        $this->protocol
        (
          'Deleted Announcement Subscription: '.$entityText,
          'delete',
          array( 'WbfsysAnnouncementChannelSubscription', $delId )
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      {
        if( isset( $fields['wbfsys_announcement_channel_subscription'] )  )
          $params->fieldsWbfsysAnnouncementChannelSubscription  = $fields['wbfsys_announcement_channel_subscription'];
        else
          $params->fieldsWbfsysAnnouncementChannelSubscription  = array();
      }
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysAnnouncementChannelSubscription, $params )
  {
    ...
    //entity WbfsysAnnouncementChannelSubscription
    if( !$params->fieldsWbfsysAnnouncementChannelSubscription )
    {
      if( isset( $fields['wbfsys_announcement_channel_subscription'] ) )
        $params->fieldsWbfsysAnnouncementChannelSubscription = $fields['wbfsys_announcement_channel_subscription'];
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysAnnouncementChannelSubscription = $orm->get( 'WbfsysAnnouncementChannelSubscription',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
          (
            'There is no Announcement Subscription with the id: {@id@}',
            'wbfsys.announcement_channel_subscription.message',
            array
            (
              'id' => $id
    ...
    if( !$params->fieldsWbfsysAnnouncementChannelSubscription )
      $params->fieldsWbfsysAnnouncementChannelSubscription  = $entityWbfsysAnnouncementChannelSubscription->getCols
      (
        $params->categories
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_announcement_channel_subscription'] = array();
    $saveFields['wbfsys_announcement_channel_subscription'][] = 'id_channel';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'id_role';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'date_start';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'vid';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'date_end';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'id_vid_entity';
        $saveFields['wbfsys_announcement_channel_subscription'][] = 'm_version';
...
}//end WbfsysAnnouncementChannelSubscription_Crud_Model
