 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAnnouncementChannelSubscription entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AnnouncementChannelSubscription.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AnnouncementChannelSubscription.insert';
    $params->formId       = 'wgt-form-wbfsys_announcement_channel_subscription';
    $params->namespace   = 'wbfsys_announcement_channel_subscription-create';
    ...
    $this->setTemplate( 'wbfsys/announcement_channel_subscription/modal/crud/form_create' );
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Create_Modal_View
