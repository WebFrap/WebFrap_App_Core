 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysAnnouncementChannelSubscription_IdChannel( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAnnouncementChannel_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.AnnouncementChannel.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysAnnouncementChannelSubscription', array_keys( $this->fields['wbfsys_announcement_channel_subscription']), true ),
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Create_Form */
