 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
...
BUTTON;
    ...
    if( $params->access->admin )
    {
      ...
      $entries->entryAcls = <<<HTML
          ...
          <li>
            <a 
              href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_announcement_channel_subscription&amp;objid={$objid}" 
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_announcement_channel_subscription-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Show_Maintab_Menu
