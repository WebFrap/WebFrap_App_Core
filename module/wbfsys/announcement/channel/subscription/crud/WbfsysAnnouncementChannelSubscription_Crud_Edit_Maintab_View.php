 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAnnouncementChannelSubscription Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAnnouncementChannelSubscription = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Announcement Subscription: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAnnouncementChannelSubscription
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AnnouncementChannelSubscription.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_announcement_channel_subscription-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/announcement_channel_subscription/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAnnouncementChannelSubscription_Crud_Edit' );
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Edit_Maintab_View
