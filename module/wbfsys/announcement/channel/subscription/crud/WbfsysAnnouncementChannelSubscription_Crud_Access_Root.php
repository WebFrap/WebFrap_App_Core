 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAnnouncementChannelSubscription_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAnnouncementChannelSubscription_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAnnouncementChannelSubscription_Entity */
      $entity = $orm->get( 'WbfsysAnnouncementChannelSubscription', $rootId );
    }
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Access_Root
