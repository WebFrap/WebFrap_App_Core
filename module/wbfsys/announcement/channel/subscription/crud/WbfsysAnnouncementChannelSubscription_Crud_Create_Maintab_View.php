 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAnnouncementChannelSubscription Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Announcement Subscription',
      'wbfsys.announcement_channel_subscription.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Announcement Subscription',
      'wbfsys.announcement_channel_subscription.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_announcement_channel_subscription-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/announcement_channel_subscription/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AnnouncementChannelSubscription.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_announcement_channel_subscription';
    ...
    $form = $this->newForm( 'WbfsysAnnouncementChannelSubscription_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AnnouncementChannelSubscription.create');}});
});
...
}//end class WbfsysAnnouncementChannelSubscription_Crud_Create_Maintab_View
