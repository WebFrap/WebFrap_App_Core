 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysAnnouncementChannelSubscription_'.$listType ) );
...
} // end class WbfsysAnnouncementChannelSubscription_Listing_Controller */
