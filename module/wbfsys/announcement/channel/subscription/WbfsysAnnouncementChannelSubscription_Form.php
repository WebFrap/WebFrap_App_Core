 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_announcement_channel_subscription';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAnnouncementChannelSubscription';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAnnouncementChannelSubscription' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAnnouncementChannelSubscription entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_channel( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAnnouncementChannel_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Channel (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ));
      ...
      $inputIdChannel->setLabel( $this->view->i18n->l( 'Channel', 'wbfsys.announcement_channel_subscription.label' ) );
  ...
  * @return void
  */
  public function input_id_role( $params )
  {

      //tpl: class ui:int
      $inputIdRole = $this->view->newInput( 'input'.$this->prefix.'IdRole' , 'Int' );
      $this->items['id_role'] = $inputIdRole;
      $inputIdRole->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[id_role]',
          'id'        => 'wgt-input-'.$this->keyName.'_id_role'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Role (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
        )
      );
      $inputIdRole->setWidth( 'medium' );

      $inputIdRole->setReadOnly( $this->isReadOnly( 'id_role' ) );
      $inputIdRole->setData( $this->entity->getData( 'id_role' ) );
      $inputIdRole->setLabel
      (
        $this->view->i18n->l( 'Role', 'wbfsys.announcement_channel_subscription.label' ),
        $this->entity->required( 'id_role' )
      );
  ...
  }//end public function input_id_role */
  ...
  public function input_date_start( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Start Date (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'Start Date', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_date_end( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for End Date (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'End Date', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.announcement_channel_subscription.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.announcement_channel_subscription.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.announcement_channel_subscription.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.announcement_channel_subscription.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.announcement_channel_subscription.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.announcement_channel_subscription.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_date_start( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Start Date (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
          'maxlength' => $this->entity->maxSize( 'date_start' ),
        )
      );
      $inputDateStart->setWidth( 'small' );
  ...
  public function search_date_end( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_date_end'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for End Date (Announcement Channel Subscription)', 'wbfsys.announcement_channel_subscription.label' ),
          'maxlength' => $this->entity->maxSize( 'date_end' ),
        )
      );
      $inputDateEnd->setWidth( 'small' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_channel_subscription_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_channel_subscription_m_role_change';
...
}//end class WbfsysAnnouncementChannelSubscription_Form */
