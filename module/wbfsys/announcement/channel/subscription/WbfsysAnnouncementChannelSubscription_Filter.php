 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Filter
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
        ...
        AND filter_area_{$key}."acl-vid" = wbfsys_announcement_channel_subscription.{$fieldName}
...
}//end class WbfsysAnnouncementChannelSubscription_Filter
