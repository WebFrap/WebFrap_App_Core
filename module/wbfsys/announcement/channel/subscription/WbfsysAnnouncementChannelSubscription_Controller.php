 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_announcement_channel_subscription
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.AnnouncementChannelSubscription.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_announcement_channel_subscription-create';

    $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_announcement_channel_subscription-create',
      'WbfsysAnnouncementChannelSubscription_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysAnnouncementChannelSubscription_Crud_Model */
    $model = $this->loadModel( 'WbfsysAnnouncementChannelSubscription_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.AnnouncementChannelSubscription.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysAnnouncementChannelSubscription = $model->getEntityWbfsysAnnouncementChannelSubscription( $objid );
    ...
    if( !$entityWbfsysAnnouncementChannelSubscription )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Announcement Subscription', 'wbfsys.announcement_channel_subscription.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysAnnouncementChannelSubscription;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_announcement_channel_subscription:edit';

    $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysAnnouncementChannelSubscription );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_announcement_channel_subscription-edit-'.$objid,
      'WbfsysAnnouncementChannelSubscription_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_announcement_channel_subscription:show';
    ...
    (
      'form-wbfsys_announcement_channel_subscription-edit-'.$objid,
      'WbfsysAnnouncementChannelSubscription_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_announcement_channel_subscription
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.AnnouncementChannelSubscription.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-insert';

    $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysAnnouncementChannelSubscription = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_announcement_channel_subscription-update-'.$entityWbfsysAnnouncementChannelSubscription;
      ...
      {
        $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysAnnouncementChannelSubscription );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysAnnouncementChannelSubscription';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_announcement_channel_subscription',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysAnnouncementChannelSubscription_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.AnnouncementChannelSubscription.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysAnnouncementChannelSubscription, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysAnnouncementChannelSubscription_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.AnnouncementChannelSubscription.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-delete-'.$objid;

    $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysAnnouncementChannelSubscription );
    ...
    $error = $model->delete( $entityWbfsysAnnouncementChannelSubscription, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysAnnouncementChannelSubscription, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.AnnouncementChannelSubscription.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.AnnouncementChannelSubscription.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-listing';
    ...
    $containerClass = 'WbfsysAnnouncementChannelSubscription_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_announcement_channel_subscription',
      'WbfsysAnnouncementChannelSubscription_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysAnnouncementChannelSubscription_Table_Model */
    $model = $this->loadModel( 'WbfsysAnnouncementChannelSubscription_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysAnnouncementChannelSubscription
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysAnnouncementChannelSubscription_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_announcement_channel_subscription',
      'WbfsysAnnouncementChannelSubscription_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysAnnouncementChannelSubscription_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.AnnouncementChannelSubscription.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncementChannelSubscription_Selection_Model */
    $model   = $this->loadModel( 'WbfsysAnnouncementChannelSubscription_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_announcement_channel_subscription-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_announcement_channel_subscription-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_announcement_channel_subscription',
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysAnnouncementChannelSubscription, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysAnnouncementChannelSubscription_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysAnnouncementChannelSubscription_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_announcement_channel_subscription-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysAnnouncementChannelSubscription_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysAnnouncementChannelSubscription, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_announcement_channel_subscription' );
...
} // end class WbfsysAnnouncementChannelSubscription_Controller */
