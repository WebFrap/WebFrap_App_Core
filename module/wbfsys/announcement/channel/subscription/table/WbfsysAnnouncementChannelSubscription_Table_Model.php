 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    if( $free = $httpRequest->param( 'free_search' , Validator::TEXT ) )
      ...
      if( $mRoleCreate = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::EID, 'm_role_create'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_role_create'] = $mRoleCreate;

      if( $mRoleChange = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::EID, 'm_role_change'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_role_change'] = $mRoleChange;

      if( $mTimeCreatedBefore = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::DATE, 'm_time_created_before'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_time_created_before'] = $mTimeCreatedBefore;

      if( $mTimeCreatedAfter = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::DATE, 'm_time_created_after'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_time_created_after'] = $mTimeCreatedAfter;

      if( $mTimeChangedBefore = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::DATE, 'm_time_changed_before'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_time_changed_before'] = $mTimeChangedBefore;

      if( $mTimeChangedAfter = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription}', Validator::DATE, 'm_time_changed_after'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_time_changed_after'] = $mTimeChangedAfter;

      if( $mRowid = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::EID, 'm_rowid'   ) )
        $condition['wbfsys_announcement_channel_subscription']['m_rowid'] = $mRowid;

      if( $mUuid = $httpRequest->param( 'search_wbfsys_announcement_channel_subscription', Validator::TEXT, 'm_uuid'    ) )
        $condition['wbfsys_announcement_channel_subscription']['m_uuid'] = $mUuid;
    ...
    $query = $db->newQuery( 'WbfsysAnnouncementChannelSubscription_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysAnnouncementChannelSubscription_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
    ...
    if( $params->exclude )
    {
      ...
      $excludeCond = ' wbfsys_announcement_channel_subscription.rowid NOT IN '
...
}//end class WbfsysAnnouncementChannelSubscription_Table_Model
