 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysAnnouncementChannelSubscription_Table_Query $query
...
}//end class WbfsysAnnouncementChannelSubscription_Table_Access
