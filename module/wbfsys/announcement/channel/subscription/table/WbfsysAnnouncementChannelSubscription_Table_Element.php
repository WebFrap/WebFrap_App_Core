 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_announcement_channel_subscription';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.show&amp;target_mask=WbfsysAnnouncementChannelSubscription&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.edit&amp;target_mask=WbfsysAnnouncementChannelSubscription&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.announcement_channel_subscription.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AnnouncementChannelSubscription.delete&amp;target_mask=WbfsysAnnouncementChannelSubscription&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.announcement_channel_subscription.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AnnouncementChannelSubscription_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Announcement Subscriptions." >{$iconDelete} Delete selected Announcement Subscriptions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Announcement Subscriptions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AnnouncementChannelSubscription_Multi.deleteAll" >{$iconClean} Delete all Announcement Subscriptions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAnnouncementChannelSubscription_Table_Element
