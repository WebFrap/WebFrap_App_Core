 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Announcement Subscriptions
  *
  ...
  *  }
  *
  * @return WbfsysAnnouncementChannelSubscription_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementChannelSubscription_Table_Element( 'tableWbfsysAnnouncementChannelSubscription', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Announcement Subscriptions', 'wbfsys.announcement_channel_subscription.label' );
      //$tabPanel->searchKey = 'wbfsys_announcement_channel_subscription';
      ...
      $searchElement->searchKey = 'wbfsys_announcement_channel_subscription';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAnnouncementChannelSubscription_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAnnouncementChannelSubscription', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAnnouncementChannelSubscription listing maske
   *
   * @param WbfsysAnnouncementChannelSubscription_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAnnouncementChannelSubscription_Table_Ui
