 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannelSubscription_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAnnouncementChannelSubscription_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysAnnouncementChannelSubscription_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/announcement_channel_subscription/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Announcement Subscriptions',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.AnnouncementChannelSubscription.search';

    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement_channel_subscription-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysAnnouncementChannelSubscription_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysAnnouncementChannelSubscription_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.AnnouncementChannelSubscription.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.AnnouncementChannelSubscription.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.AnnouncementChannelSubscription.create&amp;ltype=table');
    });
...
}//end class WbfsysAnnouncementChannelSubscription_Table_Maintab_View
