 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_announcement_channel';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAnnouncementChannel';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAnnouncementChannel' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAnnouncementChannel entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.announcement_channel.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.announcement_channel.label' ),
  ...
  * @return void
  */
  public function input_flag_public( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagPublic = $this->view->newInput( 'input'.$this->prefix.'FlagPublic' , 'Checkbox' );
      $this->items['flag_public'] = $inputFlagPublic;
      $inputFlagPublic->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_public]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_public'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Public (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
        )
      );
      $inputFlagPublic->setWidth( 'medium' );

      $inputFlagPublic->setReadOnly( $this->isReadOnly( 'flag_public' ) );
      $inputFlagPublic->setActive( $this->entity->getBoolean( 'flag_public' ) );
      $inputFlagPublic->setLabel
      (
        $this->view->i18n->l( 'Public', 'wbfsys.announcement_channel.label' ),
        $this->entity->required( 'flag_public' )
      );
  ...
  }//end public function input_flag_public */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.announcement_channel.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.announcement_channel.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.announcement_channel.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.announcement_channel.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.announcement_channel.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.announcement_channel.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.announcement_channel.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.announcement_channel.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Announcement Channel)', 'wbfsys.announcement_channel.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_channel_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_announcement_channel_m_role_change';
...
}//end class WbfsysAnnouncementChannel_Form */
