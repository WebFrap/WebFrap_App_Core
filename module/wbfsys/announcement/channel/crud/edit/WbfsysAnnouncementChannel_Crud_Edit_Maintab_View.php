 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAnnouncementChannel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAnnouncementChannel = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Announcement Channel: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AnnouncementChannel.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAnnouncementChannel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AnnouncementChannel.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_announcement_channel-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/announcement_channel/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAnnouncementChannel_Crud_Edit' );
...
}//end class WbfsysAnnouncementChannel_Crud_Edit_Maintab_View
