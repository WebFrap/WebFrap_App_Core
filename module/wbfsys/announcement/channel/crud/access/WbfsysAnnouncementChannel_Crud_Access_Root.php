 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAnnouncementChannel_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAnnouncementChannel_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAnnouncementChannel_Entity */
      $entity = $orm->get( 'WbfsysAnnouncementChannel', $rootId );
    }
...
}//end class WbfsysAnnouncementChannel_Crud_Access_Root
