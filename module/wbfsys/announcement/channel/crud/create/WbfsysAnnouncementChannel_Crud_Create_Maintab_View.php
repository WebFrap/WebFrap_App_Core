 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAnnouncementChannel Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_announcement_channel-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/announcement_channel/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AnnouncementChannel.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_announcement_channel';
    ...
    $form = $this->newForm( 'WbfsysAnnouncementChannel_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AnnouncementChannel.create');}});
});
...
}//end class WbfsysAnnouncementChannel_Crud_Create_Maintab_View
