 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAnnouncementChannel entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AnnouncementChannel.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AnnouncementChannel.insert';
    $params->formId       = 'wgt-form-wbfsys_announcement_channel';
    $params->namespace   = 'wbfsys_announcement_channel-create';
    ...
    $this->setTemplate( 'wbfsys/announcement_channel/modal/crud/form_create' );
...
}//end class WbfsysAnnouncementChannel_Crud_Create_Modal_View
