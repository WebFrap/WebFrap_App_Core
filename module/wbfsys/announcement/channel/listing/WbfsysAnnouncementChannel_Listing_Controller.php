 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysAnnouncementChannel_'.$listType ) );
...
} // end class WbfsysAnnouncementChannel_Listing_Controller */
