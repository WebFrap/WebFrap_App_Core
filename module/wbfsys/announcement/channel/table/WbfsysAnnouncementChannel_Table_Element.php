 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_announcement_channel';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAnnouncementChannel_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AnnouncementChannel.show&amp;target_mask=WbfsysAnnouncementChannel&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AnnouncementChannel.edit&amp;target_mask=WbfsysAnnouncementChannel&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.announcement_channel.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'User Subscriptions',
            'modal.php?c=Wbfsys.AnnouncementChannel_Ref_UserSubscriptions.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.announcement_channel.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Group Subscriptions',
            'modal.php?c=Wbfsys.AnnouncementChannel_Ref_GroupSubscriptions.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.announcement_channel.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AnnouncementChannel.delete&amp;target_mask=WbfsysAnnouncementChannel&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.announcement_channel.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.announcement_channel.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_announcement_channel_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AnnouncementChannel.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_announcement_channel_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AnnouncementChannel_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Announcement Channels." >{$iconDelete} Delete selected Announcement Channels</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Announcement Channels. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AnnouncementChannel_Multi.deleteAll" >{$iconClean} Delete all Announcement Channels</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAnnouncementChannel_Table_Element
