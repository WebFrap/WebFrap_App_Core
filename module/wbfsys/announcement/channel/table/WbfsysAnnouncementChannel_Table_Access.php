 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysAnnouncementChannel_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_announcement_channel.rowid ",
      'acls'
    );
...
}//end class WbfsysAnnouncementChannel_Table_Access
