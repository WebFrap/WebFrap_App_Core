 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Announcement Channels
  *
  ...
  *  }
  *
  * @return WbfsysAnnouncementChannel_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementChannel_Table_Element( 'tableWbfsysAnnouncementChannel', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement_channel-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Announcement Channels', 'wbfsys.announcement_channel.label' );
      //$tabPanel->searchKey = 'wbfsys_announcement_channel';
      ...
      $searchElement->searchKey = 'wbfsys_announcement_channel';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAnnouncementChannel_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAnnouncementChannel', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAnnouncementChannel listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAnnouncementChannel  = $model->getEntityWbfsysAnnouncementChannel();
    ...
    $formWbfsysAnnouncementChannel->setKeyName( 'wbfsys_announcement_channel' );
...
}//end class WbfsysAnnouncementChannel_Table_Ui
