 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.AnnouncementChannel_Ref_GroupSubscriptions.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Ajax_View
