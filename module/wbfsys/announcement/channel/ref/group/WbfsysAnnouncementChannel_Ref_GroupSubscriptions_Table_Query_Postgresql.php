 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_announcement_channel_subscription_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if( $params->loadFullSize )
      $this->calcQuery = $criteria->count( 'count(DISTINCT wbfsys_announcement_channel_subscription.'.Db::PK.' ) as '.Db::Q_SIZE );
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    $criteria->where
    (
      " wbfsys_announcement_channel_subscription.rowid  IN( ". implode( ', ', array_keys($inKeys) ) ." )"
    );
    ...
    {
      $row['acl-level'] = $inKeys[$row['wbfsys_announcement_channel_subscription_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_announcement_channel_subscription.rowid as "wbfsys_announcement_channel_subscription_rowid"', // variant:  
      'wbfsys_role_group.name as "wbfsys_role_group_name"', // variant:  
      'wbfsys_role_group.access_key as "wbfsys_role_group_access_key"', // variant:  
      'wbfsys_role_mandant.name as "wbfsys_role_mandant_name"', // variant:   used source field wbfsys_role_mandant
      'wbfsys_role_group.id_mandant as "wbfsys_role_group_id_mandant"', // ref wbfsys_role_group  
      'wbfsys_role_group_type.name as "wbfsys_role_group_type_name"', // variant:   used source field wbfsys_role_group_type
      'wbfsys_role_group.id_type as "wbfsys_role_group_id_type"', // ref wbfsys_role_group  
      'wbfsys_role_group.description as "wbfsys_role_group_description"', // variant:  
      'wbfsys_role_group.rowid as "wbfsys_role_group_rowid"', // variant:  
    );
  ...
  public function setTables( $criteria   )
  {
    ...
    $criteria->from( 'wbfsys_announcement_channel_subscription' );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_announcement_channel_subscription.id_channel = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_announcement_channel_subscription.id_channel = '.$condition );
        }
        else
        {
  ...
  public function checkConditions( $criteria, array $condition )
  {
      ...
      if( isset($condition['free']) && trim( $condition['free'] ) != ''  )
      {
         ...
         )
         {
            ...
            (
              '(
 wbfsys_announcement_channel_subscription.rowid = \''.$part.'\'  or 
      ...
      if( isset( $condition['wbfsys_role_group'] ) )
      {
        ...
        if( !$criteria->isJoined( 'wbfsys_role_group' ) )
        {
  ...
  public function checkCharBegin( $criteria, $params )
  {
      ...
      if( $params->begin )
      {
        ...
        if( '?' == $params->begin  )
        {
          $criteria->where( "wbfsys_announcement_channel_subscription.id_channel ~* '^[^a-zA-Z]'" );
        }
        else
        {
          $criteria->where( "upper(substr(wbfsys_announcement_channel_subscription.id_channel,1,1)) = '".strtoupper($params->begin)."'" );
        }
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
     ...
     // inject the default order
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_announcement_channel_subscription-rowid-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_announcement_channel_subscription-rowid-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_announcement_channel_subscription-rowid-order"' );
...
}//end class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Query_Postgresql
