 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    (
      'Table {@label@}',
      'wbf.label',
      array( 'label' => 'Group Subscriptions' )
    );
    ...
    $this->setTemplate( 'wbfsys/announcement_channel/ref_group_subscriptions/tab_table' );

    $ui = $this->loadUi( 'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table' );
...
}//end class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Table_Modal_View
