 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des group_subscriptions Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $params->refId = $objid;
    $params->refIdGroupSubscriptions = $objid;
    ...
    $containerClass = "WbfsysAnnouncementChannel_Ref_GroupSubscriptions_".$listType."_Access";
    ...
    $accessGroupSubscriptions = new $containerClass( );
    $accessGroupSubscriptions->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-group_subscriptions';

    $params->accessGroupSubscriptions = $accessGroupSubscriptions;
    $params->paramsGroupSubscriptions = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessGroupSubscriptions->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelGroupSubscriptions = $this->loadModel
    (
      'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType
    );
    $modelGroupSubscriptions->setAccess( $accessGroupSubscriptions );
    
    $view->setModel( $modelGroupSubscriptions );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_announcement_channel-ref-group_subscriptions-'.$listType.'-ajax',
    	'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysRoleGroup to a WbfsysAnnouncementChannel
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-group_subscriptions'
    );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-group_subscriptions';

    $params->accessGroupSubscriptions = $access;
    $params->paramsGroupSubscriptions = $params;

    $model  = $this->loadModel( 'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType );
      $listModel = $this->loadModel( 'WbfsysAnnouncementChannel_Ref_GroupSubscriptions_'.$listType );
...
} // end WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Controller
