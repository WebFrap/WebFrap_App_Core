 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listGroupSubscriptions = $this->getRegisterd('listRefGroupSubscriptions'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listGroupSubscriptions was not registered'
        );
      }

      foreach( $listGroupSubscriptions as $entityWbfsysAnnouncementChannel )
      {
        if(!$orm->save( $entityWbfsysAnnouncementChannel) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Announcement Channel '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Announcement Channel '.$entityText,
              'wbfsys.announcement_channel.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Announcement Channel: '.$textSaved,
          'wbfsys.announcement_channel.message',
          array($textSaved)
        )
      );
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefGroupSubscriptions',$listWbfsysAnnouncementChannelSubscription);
      return true;
...
}//end class WbfsysAnnouncementChannel_Ref_GroupSubscriptions_Multi_Model
