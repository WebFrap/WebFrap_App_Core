 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listUserSubscriptions = $this->getRegisterd('listRefUserSubscriptions'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listUserSubscriptions was not registered'
        );
      }

      foreach( $listUserSubscriptions as $entityWbfsysAnnouncementChannel )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefUserSubscriptions',$listWbfsysAnnouncementChannelSubscription);
      return true;
...
}//end class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Multi_Model
