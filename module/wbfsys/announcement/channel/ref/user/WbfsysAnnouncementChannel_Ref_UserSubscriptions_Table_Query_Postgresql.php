 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Query_Postgresql
  extends LibSqlQuery
{
...
}//end class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Query_Postgresql
