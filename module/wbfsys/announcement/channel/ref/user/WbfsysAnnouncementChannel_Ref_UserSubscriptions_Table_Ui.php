 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Element
   */
  public function createListItem( $idWbfsysAnnouncementChannel, $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Element
    (
      'tableUserSubscriptions',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mod-wbfsys-cat-core_data-conref-user_subscriptions'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-user_subscriptions-'.$idWbfsysAnnouncementChannel;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement_channel-ref-user_subscriptions-search-'
    ...
    $tabPanel->searchKey = 'wbfsys_announcement_channel-ref-user_subscriptions';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.get(\'modal.php?c=Wbfsys.RoleUser.selection&exclude=wbfsys_announcement_channel_subscription-id_channel-id_role&objid='.$params->refId.'&target_mask=WbfsysAnnouncementChannel_Ref_UserSubscriptions&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabUserSubscriptions', true );
    $view->addVar( 'refIdUserSubscriptions', $idWbfsysAnnouncementChannel );
    $view->addVar
    (
      'searchFormActionUserSubscriptions',
      'ajax.php?c=Wbfsys.AnnouncementChannel_Ref_UserSubscriptions.search&amp;target_id='
   ...
   * @return WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Element
   */
  public function listEntry( $idUserSubscriptions, $access, $params, $insertMode )
  {
    ...
    // if a table id is given use it for the table
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-user_subscriptions-'.$idUserSubscriptions;
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowUserSubscriptions', $table->buildAjax() );
...
}//end class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Ui
