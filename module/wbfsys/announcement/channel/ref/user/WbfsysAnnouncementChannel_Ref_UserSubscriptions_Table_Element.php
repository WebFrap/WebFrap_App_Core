 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_announcement_channel-user_subscriptions';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAnnouncementChannelSubscription_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysAnnouncementChannel_Ref_UserSubscriptions';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.show&amp;target_mask=WbfsysAnnouncementChannel_Ref_UserSubscriptions&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AnnouncementChannelSubscription.edit&amp;target_mask=WbfsysAnnouncementChannel_Ref_UserSubscriptions&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.announcement_channel_subscription.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AnnouncementChannelSubscription.delete&amp;target_mask=WbfsysAnnouncementChannel_Ref_UserSubscriptions&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.announcement_channel_subscription.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_announcement_channel_subscription_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AnnouncementChannelSubscription.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_name'])).'</a></td>'.NL;
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AnnouncementChannelSubscription.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_firstname'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AnnouncementChannelSubscription.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_lastname'])).'</a></td>'.NL;
...
}//end class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Element
