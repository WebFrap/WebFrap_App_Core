 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-user_subscriptions' );
  ...
  /**
   * @param WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Query $query
...
}//end class WbfsysAnnouncementChannel_Ref_UserSubscriptions_Table_Access
