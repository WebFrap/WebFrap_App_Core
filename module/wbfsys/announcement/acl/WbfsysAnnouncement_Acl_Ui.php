 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAnnouncement_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAnnouncement_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_announcement-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Announcement', 'wbfsys.announcement.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_announcement_acl';
...
} // end class WbfsysAnnouncement_Acl_Ui */
