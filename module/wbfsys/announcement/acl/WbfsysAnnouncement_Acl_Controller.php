 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAnnouncement_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_announcement_acl_listing',
      'WbfsysAnnouncement_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysAnnouncement_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncement_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAnnouncement_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_announcement-acl',
    	'WbfsysAnnouncement_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_announcement_acl_masks_listing',
      'WbfsysAnnouncement_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAnnouncement_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAnnouncement_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncement_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAnnouncement_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAnnouncement_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAnnouncement_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_announcement-acl-qfdu',
    	'WbfsysAnnouncement_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAnnouncement_Acl_Controller */
