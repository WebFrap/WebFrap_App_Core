 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_announcement'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAnnouncement', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncement_Acl_Dset' );
    /* @var $query WbfsysAnnouncement_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncement_Acl_Dset_Treetable' );
    /* @var $query WbfsysAnnouncement_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAnnouncement_Acl_Dset_Model */
