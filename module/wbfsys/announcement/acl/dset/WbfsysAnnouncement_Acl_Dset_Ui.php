 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAnnouncement_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAnnouncement_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAnnouncement, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAnnouncement_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_announcement-acl-dset' );
    ...
    else
    {
      ...
      (
        'Announcement "{@label@}" User Access',
        'wbfsys.announcement.label',
        array
        (
          'label' => $entityWbfsysAnnouncement->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_announcement_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAnnouncement_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAnnouncement_Acl_Dset_Ui */
