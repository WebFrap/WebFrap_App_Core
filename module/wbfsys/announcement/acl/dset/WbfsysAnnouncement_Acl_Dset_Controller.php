 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAnnouncement_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAnnouncement_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAnnouncement = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAnnouncement_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_announcement-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAnnouncement, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAnnouncement_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_announcement-acl-dset', 
    	'WbfsysAnnouncement_Acl_Dset',
...
} // end class WbfsysAnnouncement_Acl_Dset_Controller */
