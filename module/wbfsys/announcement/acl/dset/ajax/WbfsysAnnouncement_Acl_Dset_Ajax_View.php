 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAnnouncement_Acl_Dset' );
    ...
    $entityWbfsysAnnouncement = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAnnouncement_Acl_Dset_Ajax_View */
