 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_announcement.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAnnouncement_Acl_Dset_Treetable_Query_Postgresql */
