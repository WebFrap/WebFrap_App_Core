 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_announcement')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysAnnouncement = $orm->get('WbfsysAnnouncement', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_announcement_title']  = $refEntityWbfsysAnnouncement->title;

    }
    $tabData['wbfsys_announcement_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncement_Acl' );
    /* @var $query WbfsysAnnouncement_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncement_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysAnnouncement_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAnnouncement_Acl_Qfdu' );
    /* @var $query WbfsysAnnouncement_Acl_Qfdu_Query  */
...
} // end class WbfsysAnnouncement_Acl_Qfdu_Model */
