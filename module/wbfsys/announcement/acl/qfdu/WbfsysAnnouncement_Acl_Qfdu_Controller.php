 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAnnouncement_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_announcement-acl-qfdu-aAjax',
      'WbfsysAnnouncement_Acl_Qfdu_Ajax',
      'displaySearch'
    );
