 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_announcement.rowid as "wbfsys_announcement_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_announcement on wbfsys_group_users.vid = wbfsys_announcement.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_announcement.title) like upper(\''.$part.'%\') )
...
} // end class WbfsysAnnouncement_Acl_Qfdu_Treetable_Query_Postgresql */
