 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_announcement.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_announcement.rowid as id,
    wbfsys_announcement.title as value,
    wbfsys_announcement.title as label
  FROM
    wbfsys_announcement
  WHERE
    {$sqlWhere}
...
} // end class WbfsysAnnouncement_Acl_Qfdu_Query_Postgresql */
