 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysAnnouncement_Acl_Path' );
    /* @var $query WbfsysAnnouncement_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysAnnouncement_Acl_Path');
    /* @var $dropQuery WbfsysAnnouncement_Acl_Path_Query  */
...
} // end class WbfsysAnnouncement_Acl_Path_Model */
