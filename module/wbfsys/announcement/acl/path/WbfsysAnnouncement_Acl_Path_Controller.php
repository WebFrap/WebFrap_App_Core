 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_announcement_acl_graph', 
      'WbfsysAnnouncement_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAnnouncement_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAnnouncement_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAnnouncement_Acl_Path_Maintab_View  */
...
} // end class WbfsysAnnouncement_Acl_Path_Controller */
