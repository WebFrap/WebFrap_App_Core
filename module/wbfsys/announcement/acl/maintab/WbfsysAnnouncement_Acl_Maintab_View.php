 ...
 * @licence WebFrap.net
 */
class WbfsysAnnouncement_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Announcement_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_announcement-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Announcement_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_announcement-acl-update';
    ...
    $this->setTemplate( 'wbfsys/announcement/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Announcement', 'wbfsys.announcement.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_announcement_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAnnouncement_Acl' );
...
} // end class WbfsysAnnouncement_Acl_Maintab_View */
