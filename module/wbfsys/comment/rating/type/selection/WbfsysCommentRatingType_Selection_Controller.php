 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCommentRatingType_Selection' ) );
...
} // end class WbfsysCommentRatingType_Selection_Controller */
