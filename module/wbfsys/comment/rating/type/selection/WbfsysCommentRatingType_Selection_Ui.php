 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysCommentRatingType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysCommentRatingType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCommentRatingType_Selection_Element
    (
      'selectionWbfsysCommentRatingType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection comment rating Types', 'wbfsys.comment_rating_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.CommentRatingType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysCommentRatingType',
      'WbfsysCommentRatingType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysCommentRatingType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysCommentRatingType_Selection_Ui
