 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysCommentRatingType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysCommentRatingType_Export_Listing_Access';
    ...
    // create a new WbfsysCommentRatingType window
    $view = $this->loadView
    (
    	'export-wbfsys_comment_rating_type',
    	'WbfsysCommentRatingType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysCommentRatingType_Export' );
...
} // end class WbfsysCommentRatingType_Export_Controller_Genf
