 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCommentRatingType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new comment rating Type',
      'wbfsys.comment_rating_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New comment rating Type',
      'wbfsys.comment_rating_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_comment_rating_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/comment_rating_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CommentRatingType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_comment_rating_type';
    ...
    $form = $this->newForm( 'WbfsysCommentRatingType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CommentRatingType.create');}});
});
...
}//end class WbfsysCommentRatingType_Crud_Create_Maintab_View
