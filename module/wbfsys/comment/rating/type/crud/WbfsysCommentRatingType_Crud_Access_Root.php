 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCommentRatingType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCommentRatingType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCommentRatingType_Entity */
      $entity = $orm->get( 'WbfsysCommentRatingType', $rootId );
    }
...
}//end class WbfsysCommentRatingType_Crud_Access_Root
