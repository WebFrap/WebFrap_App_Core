 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCommentRatingType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCommentRatingType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit comment rating Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CommentRatingType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCommentRatingType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CommentRatingType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_comment_rating_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/comment_rating_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCommentRatingType_Crud_Edit' );
...
}//end class WbfsysCommentRatingType_Crud_Edit_Maintab_View
