 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_comment_rating_type-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysCommentRatingType_Crud_Show_Maintab_Menu
