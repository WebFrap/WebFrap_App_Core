 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCommentRatingType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CommentRatingType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CommentRatingType.insert';
    $params->formId       = 'wgt-form-wbfsys_comment_rating_type';
    $params->namespace   = 'wbfsys_comment_rating_type-create';
    ...
    $this->setTemplate( 'wbfsys/comment_rating_type/modal/crud/form_create' );
...
}//end class WbfsysCommentRatingType_Crud_Create_Modal_View
