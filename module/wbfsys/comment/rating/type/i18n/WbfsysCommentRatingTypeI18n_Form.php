 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_comment_rating_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCommentRatingTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysCommentRatingTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysCommentRatingTypeI18n';
   ...
   *
   * @var WbfsysCommentRatingTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysCommentRatingTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCommentRatingTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCommentRatingTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.comment_rating_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_comment_rating_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_comment_rating_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysCommentRatingType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysCommentRatingType not exists' );

      Log::warn('Looks like the Entity: WbfsysCommentRatingType is missing');
      ...
      //p: Window
      $objidWbfsysCommentRatingType = $this->entity->getData('id_wbfsys_comment_rating_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysCommentRatingType
          || !$entityWbfsysCommentRatingType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysCommentRatingType = $this->db->orm->newEntity( 'WbfsysCommentRatingType' );
      }

      $inputIdWbfsysCommentRatingType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysCommentRatingType', 'Window' );
      $inputIdWbfsysCommentRatingType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_comment_rating_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_comment_rating_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Comment Rating Type (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysCommentRatingType->assignedForm = $this->assignedForm;

      $inputIdWbfsysCommentRatingType->setWidth( 'medium' );

      $inputIdWbfsysCommentRatingType->setData( $this->entity->getData( 'id_wbfsys_comment_rating_type' )  );
      $inputIdWbfsysCommentRatingType->setReadOnly( $this->isReadOnly( 'id_wbfsys_comment_rating_type' ) );
      $inputIdWbfsysCommentRatingType->setLabel( $this->view->i18n->l( 'Wbfsys Comment Rating Type', 'wbfsys.comment_rating_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.CommentRatingType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_comment_rating_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysCommentRatingType->setListUrl ( $listUrl );
      $inputIdWbfsysCommentRatingType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysCommentRatingType->setEntityUrl( 'maintab.php?c=Wbfsys.CommentRatingType.edit' );
      $inputIdWbfsysCommentRatingType->conEntity         = $entityWbfsysCommentRatingType;
      $inputIdWbfsysCommentRatingType->refresh           = $this->refresh;
      $inputIdWbfsysCommentRatingType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysCommentRatingType->view = $this->view;
      $inputIdWbfsysCommentRatingType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_comment_rating_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysCommentRatingType );
  ...
  }//end public function input_id_wbfsys_comment_rating_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.comment_rating_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.comment_rating_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.comment_rating_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.comment_rating_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.comment_rating_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.comment_rating_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.comment_rating_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.comment_rating_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.comment_rating_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Comment Rating Type I18n)', 'wbfsys.comment_rating_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_comment_rating_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_comment_rating_type_i18n_m_role_change';
...
}//end class WbfsysCommentRatingTypeI18n_Form */
