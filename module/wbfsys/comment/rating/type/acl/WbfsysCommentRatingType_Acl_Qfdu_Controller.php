 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysCommentRatingType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_comment_rating_type-acl-qfdu-aAjax',
      'WbfsysCommentRatingType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysCommentRatingType_Acl_Qfdu_Controller */
