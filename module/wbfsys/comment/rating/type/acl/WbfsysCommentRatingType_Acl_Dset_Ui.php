 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysCommentRatingType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysCommentRatingType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysCommentRatingType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysCommentRatingType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_comment_rating_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'comment rating Type "{@label@}" User Access',
        'wbfsys.comment_rating_type.label',
        array
        (
          'label' => $entityWbfsysCommentRatingType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_comment_rating_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysCommentRatingType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysCommentRatingType_Acl_Dset_Ui */
