 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysCommentRatingType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysCommentRatingType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_comment_rating_type_acl_listing',
      'WbfsysCommentRatingType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysCommentRatingType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysCommentRatingType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysCommentRatingType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_comment_rating_type-acl',
    	'WbfsysCommentRatingType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_comment_rating_type_acl_masks_listing',
      'WbfsysCommentRatingType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysCommentRatingType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysCommentRatingType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysCommentRatingType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysCommentRatingType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysCommentRatingType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysCommentRatingType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_comment_rating_type-acl-qfdu',
    	'WbfsysCommentRatingType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysCommentRatingType_Acl_Controller */
