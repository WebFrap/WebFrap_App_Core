 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysCommentRatingType_Acl_Path' );
    /* @var $query WbfsysCommentRatingType_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysCommentRatingType_Acl_Path');
    /* @var $dropQuery WbfsysCommentRatingType_Acl_Path_Query  */
...
} // end class WbfsysCommentRatingType_Acl_Path_Model */
