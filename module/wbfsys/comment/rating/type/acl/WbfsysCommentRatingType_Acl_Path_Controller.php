 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_comment_rating_type_acl_graph', 
      'WbfsysCommentRatingType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysCommentRatingType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysCommentRatingType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysCommentRatingType_Acl_Path_Maintab_View  */
...
} // end class WbfsysCommentRatingType_Acl_Path_Controller */
