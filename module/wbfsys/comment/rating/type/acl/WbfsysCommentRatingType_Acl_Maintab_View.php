 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysCommentRatingType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.CommentRatingType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_comment_rating_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.CommentRatingType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_comment_rating_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/comment_rating_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'comment rating Type', 'wbfsys.comment_rating_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_comment_rating_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysCommentRatingType_Acl' );
...
} // end class WbfsysCommentRatingType_Acl_Maintab_View */
