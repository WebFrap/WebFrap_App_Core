 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_comment_rating_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_comment_rating_type.rowid as id,
    wbfsys_comment_rating_type.name as value,
    wbfsys_comment_rating_type.name as label
  FROM
...
} // end class WbfsysCommentRatingType_Acl_Qfdu_Query_Postgresql */
