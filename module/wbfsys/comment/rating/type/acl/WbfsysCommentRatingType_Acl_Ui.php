 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysCommentRatingType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCommentRatingType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL comment rating Type', 
        'wbfsys.comment_rating_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_comment_rating_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'comment rating Type', 'wbfsys.comment_rating_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_comment_rating_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysCommentRatingType_Acl_Table'
    );
...
} // end class WbfsysCommentRatingType_Acl_Ui */
