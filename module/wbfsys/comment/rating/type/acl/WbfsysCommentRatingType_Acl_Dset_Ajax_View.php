 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysCommentRatingType_Acl_Dset' );
    ...
    $entityWbfsysCommentRatingType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysCommentRatingType_Acl_Dset_Ajax_View */
