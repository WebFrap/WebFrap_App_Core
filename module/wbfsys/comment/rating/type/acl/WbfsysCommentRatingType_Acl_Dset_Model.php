 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_comment_rating_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysCommentRatingType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCommentRatingType_Acl_Dset' );
    /* @var $query WbfsysCommentRatingType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCommentRatingType_Acl_Dset_Treetable' );
    /* @var $query WbfsysCommentRatingType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysCommentRatingType_Acl_Dset_Model */
