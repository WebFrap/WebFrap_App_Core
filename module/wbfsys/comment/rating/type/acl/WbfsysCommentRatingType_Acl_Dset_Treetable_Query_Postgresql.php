 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_comment_rating_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysCommentRatingType_Acl_Dset_Treetable_Query_Postgresql */
