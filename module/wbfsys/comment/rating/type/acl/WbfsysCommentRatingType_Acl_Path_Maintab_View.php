 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/comment_rating_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'comment rating Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_comment_rating_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_comment_rating_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysCommentRatingType_Acl_Path_Maintab_View */
