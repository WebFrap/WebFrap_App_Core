 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysCommentRatingType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysCommentRatingType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysCommentRatingType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCommentRatingType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_comment_rating_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysCommentRatingType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_comment_rating_type-acl-dset', 
    	'WbfsysCommentRatingType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCommentRatingType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_comment_rating_type-acl-dset', 
    	'WbfsysCommentRatingType_Acl_Dset',
...
} // end class WbfsysCommentRatingType_Acl_Dset_Controller */
