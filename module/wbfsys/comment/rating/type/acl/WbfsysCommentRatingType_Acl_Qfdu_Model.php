 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_comment_rating_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysCommentRatingType = $orm->get('WbfsysCommentRatingType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_comment_rating_type_name']  = $refEntityWbfsysCommentRatingType->name;

    }
    $tabData['wbfsys_comment_rating_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysCommentRatingType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCommentRatingType_Acl' );
    /* @var $query WbfsysCommentRatingType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCommentRatingType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysCommentRatingType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCommentRatingType_Acl_Qfdu' );
    /* @var $query WbfsysCommentRatingType_Acl_Qfdu_Query  */
...
} // end class WbfsysCommentRatingType_Acl_Qfdu_Model */
