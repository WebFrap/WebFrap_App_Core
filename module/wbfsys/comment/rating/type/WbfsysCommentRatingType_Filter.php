 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_comment_rating_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_comment_rating_type.{$fieldName}
...
}//end class WbfsysCommentRatingType_Filter
