 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_comment_rating_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.CommentRatingType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_comment_rating_type-create';

    $access = new WbfsysCommentRatingType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_comment_rating_type-create',
      'WbfsysCommentRatingType_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysCommentRatingType_Crud_Model */
    $model = $this->loadModel( 'WbfsysCommentRatingType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.CommentRatingType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysCommentRatingType = $model->getEntityWbfsysCommentRatingType( $objid );
    ...
    $params->entity = $entityWbfsysCommentRatingType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_comment_rating_type:edit';

    $access = new WbfsysCommentRatingType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCommentRatingType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_comment_rating_type-edit-'.$objid,
      'WbfsysCommentRatingType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_comment_rating_type-edit',
          $entityWbfsysCommentRatingType,
          'Edit comment rating Type :'.$entityWbfsysCommentRatingType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_comment_rating_type';
      $params->maskRoot      = 'wbfsys_comment_rating_type:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_comment_rating_type';
      $params->aclNode       = 'mgmt-wbfsys_comment_rating_type';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_comment_rating_type-edit-'.$objid,
      'WbfsysCommentRatingType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_comment_rating_type-show',
          $entityWbfsysCommentRatingType,
          'Show comment rating Type :'.$entityWbfsysCommentRatingType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_comment_rating_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.CommentRatingType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-insert';

    $access = new WbfsysCommentRatingType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysCommentRatingType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_comment_rating_type-update-'.$entityWbfsysCommentRatingType;
      ...
      {
        $access = new WbfsysCommentRatingType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysCommentRatingType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysCommentRatingType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_comment_rating_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysCommentRatingType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.CommentRatingType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysCommentRatingType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysCommentRatingType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.CommentRatingType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-delete-'.$objid;

    $access = new WbfsysCommentRatingType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCommentRatingType );
    ...
    $error = $model->delete( $entityWbfsysCommentRatingType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysCommentRatingType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.CommentRatingType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.CommentRatingType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-listing';
    ...
    $containerClass = 'WbfsysCommentRatingType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_comment_rating_type',
      'WbfsysCommentRatingType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysCommentRatingType_Table_Model */
    $model = $this->loadModel( 'WbfsysCommentRatingType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_comment_rating_type-'.$params->ltype,
          'WbfsysCommentRatingType',
          'List of comment rating Types'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysCommentRatingType
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysCommentRatingType_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_comment_rating_type',
      'WbfsysCommentRatingType_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysCommentRatingType_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.CommentRatingType.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysCommentRatingType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysCommentRatingType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_comment_rating_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_comment_rating_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_comment_rating_type',
      'WbfsysCommentRatingType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysCommentRatingType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysCommentRatingType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysCommentRatingType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_comment_rating_type-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysCommentRatingType_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysCommentRatingType, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_comment_rating_type' );
...
} // end class WbfsysCommentRatingType_Controller */
