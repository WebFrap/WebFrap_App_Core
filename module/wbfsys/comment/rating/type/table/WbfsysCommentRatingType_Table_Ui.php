 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für comment rating Types
  *
  ...
  *  }
  *
  * @return WbfsysCommentRatingType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCommentRatingType_Table_Element( 'tableWbfsysCommentRatingType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_comment_rating_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'comment rating Types', 'wbfsys.comment_rating_type.label' );
      //$tabPanel->searchKey = 'wbfsys_comment_rating_type';
      ...
      $searchElement->searchKey = 'wbfsys_comment_rating_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCommentRatingType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCommentRatingType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCommentRatingType listing maske
   *
   * @param WbfsysCommentRatingType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCommentRatingType  = $model->getEntityWbfsysCommentRatingType();
    ...
    $formWbfsysCommentRatingType->setKeyName( 'wbfsys_comment_rating_type' );
...
}//end class WbfsysCommentRatingType_Table_Ui
