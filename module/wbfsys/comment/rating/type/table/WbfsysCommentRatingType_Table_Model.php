 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRatingType_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysCommentRatingType_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysCommentRatingType_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function changeOrder( $orders )
  {
    ...
    try
    {
      ...
      {
        $orm->update( "WbfsysCommentRatingType", $id, array( 'm_order' =>  $order ) );
      }
    }
    catch( LibDb_Exception $e )
    {
...
}//end class WbfsysCommentRatingType_Table_Model
