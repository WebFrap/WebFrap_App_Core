 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysCommentRating_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysCommentRating Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCommentRating = $this->model->getEntityWbfsysCommentRating();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Comment Rating: {@text@}',
      'wbfsys.comment_rating.label',
      array( 'text' => $entityWbfsysCommentRating->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CommentRating.show  &amp;objid='.$entityWbfsysCommentRating
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CommentRating.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_comment_rating-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/comment_rating/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysCommentRating_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.CommentRating.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_comment_rating' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_comment_rating a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.CommentRating.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.CommentRating.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysCommentRating_Crud_Show_Maintab_View
