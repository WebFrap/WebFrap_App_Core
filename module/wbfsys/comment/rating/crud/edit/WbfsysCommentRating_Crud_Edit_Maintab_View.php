 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCommentRating Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCommentRating = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Comment Rating: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CommentRating.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCommentRating
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CommentRating.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_comment_rating-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/comment_rating/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCommentRating_Crud_Edit' );
...
}//end class WbfsysCommentRating_Crud_Edit_Maintab_View
