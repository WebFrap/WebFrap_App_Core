 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCommentRating_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCommentRating_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCommentRating_Entity */
      $entity = $orm->get( 'WbfsysCommentRating', $rootId );
    }
...
}//end class WbfsysCommentRating_Crud_Access_Root
