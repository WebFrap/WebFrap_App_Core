 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCommentRating entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CommentRating.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CommentRating.insert';
    $params->formId       = 'wgt-form-wbfsys_comment_rating';
    $params->namespace   = 'wbfsys_comment_rating-create';
    ...
    $this->setTemplate( 'wbfsys/comment_rating/modal/crud/form_create' );
...
}//end class WbfsysCommentRating_Crud_Create_Modal_View
