 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysCommentRating', array_keys( $this->fields['wbfsys_comment_rating']), true ),
  ...
  public function setDefaultData( )
  {
    ...
    // ui: int
    if( is_null( $this->entity->ugly_level ) )
      $this->entity->ugly_level = '0';


  }//end public function setDefaultData */


}//end class WbfsysCommentRating_Crud_Create_Form */
