 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCommentRating Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_comment_rating-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/comment_rating/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CommentRating.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_comment_rating';
    ...
    $form = $this->newForm( 'WbfsysCommentRating_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CommentRating.create');}});
});
...
}//end class WbfsysCommentRating_Crud_Create_Maintab_View
