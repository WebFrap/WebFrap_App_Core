 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_comment_rating';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCommentRating';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCommentRating' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCommentRating entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function input_id_comment( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysComment_Entity' ) )
    {
      ...
      $inputIdComment = $this->view->newInput( 'input'.$this->prefix.'IdComment', 'Window' );
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Comment (Comment Rating)', 'wbfsys.comment_rating.label' ),
      ));
      ...
      $inputIdComment->setLabel( $this->view->i18n->l( 'Comment', 'wbfsys.comment_rating.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Comment.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_comment'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdComment->buildJavascript( 'wgt-input-'.$this->keyName.'_id_comment'.($this->suffix?'-'.$this->suffix:'') );
  ...
  * @return void
  */
  public function input_ugly_level( $params )
  {

      //tpl: class ui:int
      $inputUglyLevel = $this->view->newInput( 'input'.$this->prefix.'UglyLevel' , 'Int' );
      $this->items['ugly_level'] = $inputUglyLevel;
      $inputUglyLevel->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[ugly_level]',
          'id'        => 'wgt-input-'.$this->keyName.'_ugly_level'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Ugly Level (Comment Rating)', 'wbfsys.comment_rating.label' ),
        )
      );
      $inputUglyLevel->setWidth( 'medium' );

      $inputUglyLevel->setReadOnly( $this->isReadOnly( 'ugly_level' ) );
      $inputUglyLevel->setData( $this->entity->getData( 'ugly_level' ) );
      $inputUglyLevel->setLabel
      (
        $this->view->i18n->l( 'Ugly Level', 'wbfsys.comment_rating.label' ),
        $this->entity->required( 'ugly_level' )
      );
  ...
  }//end public function input_ugly_level */
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysCommentRatingType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysCommentRatingType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (Comment Rating)', 'wbfsys.comment_rating.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.comment_rating.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_comment_rating_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.CommentRatingType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Comment Rating)', 'wbfsys.comment_rating.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.comment_rating.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Comment Rating)', 'wbfsys.comment_rating.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.comment_rating.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Comment Rating)', 'wbfsys.comment_rating.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.comment_rating.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Comment Rating)', 'wbfsys.comment_rating.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.comment_rating.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Comment Rating)', 'wbfsys.comment_rating.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.comment_rating.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Comment Rating)', 'wbfsys.comment_rating.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.comment_rating.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Comment Rating)', 'wbfsys.comment_rating.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.comment_rating.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysCommentRatingType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Type (Comment Rating)', 'wbfsys.comment_rating.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_comment_rating_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_comment_rating_m_role_change';
...
}//end class WbfsysCommentRating_Form */
