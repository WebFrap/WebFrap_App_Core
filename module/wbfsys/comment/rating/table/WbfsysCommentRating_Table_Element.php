 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_comment_rating';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCommentRating_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CommentRating.show&amp;target_mask=WbfsysCommentRating&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CommentRating.edit&amp;target_mask=WbfsysCommentRating&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.comment_rating.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CommentRating.delete&amp;target_mask=WbfsysCommentRating&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.comment_rating.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.comment_rating.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_comment_rating_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.CommentRatingType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_comment_rating_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CommentRating_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Comment Ratings." >{$iconDelete} Delete selected Comment Ratings</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Comment Ratings. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CommentRating_Multi.deleteAll" >{$iconClean} Delete all Comment Ratings</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCommentRating_Table_Element
