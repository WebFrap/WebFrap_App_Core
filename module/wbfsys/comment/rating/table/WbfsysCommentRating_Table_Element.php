...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.CommentRatingType.listing" >'.Validator::sanitizeHtml($row['wbfsys_comment_rating_type_name']).'</a></td>'.NL;
