 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Comment Ratings
  *
  ...
  *  }
  *
  * @return WbfsysCommentRating_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCommentRating_Table_Element( 'tableWbfsysCommentRating', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_comment_rating-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Comment Ratings', 'wbfsys.comment_rating.label' );
      //$tabPanel->searchKey = 'wbfsys_comment_rating';
      ...
      $searchElement->searchKey = 'wbfsys_comment_rating';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCommentRating_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCommentRating', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCommentRating listing maske
   *
   * @param WbfsysCommentRating_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCommentRating  = $model->getEntityWbfsysCommentRating();
    ...
    $formWbfsysCommentRating->setKeyName( 'wbfsys_comment_rating' );
...
}//end class WbfsysCommentRating_Table_Ui
