 ...
 * @licence WebFrap.net
 */
class WbfsysCommentRating_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCommentRating_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_comment_rating.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_comment_rating.rowid ",
      'acls'
    );
...
}//end class WbfsysCommentRating_Table_Access
