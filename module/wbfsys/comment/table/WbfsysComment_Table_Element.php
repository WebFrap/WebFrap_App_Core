 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_comment';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysComment_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Comment.show&amp;target_mask=WbfsysComment&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Comment.edit&amp;target_mask=WbfsysComment&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.comment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Comment.delete&amp;target_mask=WbfsysComment&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.comment.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_comment&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.comment.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_comment_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_comment_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Comment_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.Comment_Multi.deleteAll" >{$iconClean} Delete all Comments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysComment_Table_Element
