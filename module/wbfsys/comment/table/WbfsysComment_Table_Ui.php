...
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysComment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysComment_Table_Element( 'tableWbfsysComment', $view );
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysComment_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param WbfsysComment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysComment_Table_Ui
