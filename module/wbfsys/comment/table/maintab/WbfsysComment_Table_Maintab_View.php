 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysComment_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysComment_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/comment/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.Comment.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_comment-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysComment_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.Comment.create&amp;ltype=table');
    });
...
}//end class WbfsysComment_Table_Maintab_View
