 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_comment.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysComment_Acl_Dset_Treetable_Query_Postgresql */
