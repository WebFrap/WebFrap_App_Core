 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_comment'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysComment', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysComment_Acl_Dset' );
    /* @var $query WbfsysComment_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysComment_Acl_Dset_Treetable' );
    /* @var $query WbfsysComment_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysComment_Acl_Dset_Model */
