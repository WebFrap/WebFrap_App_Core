 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysComment_Acl_Dset' );
    ...
    $entityWbfsysComment = $this->model->getEntity( $dsetId );
...
} // end class WbfsysComment_Acl_Dset_Ajax_View */
