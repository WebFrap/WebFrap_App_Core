 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysComment_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysComment_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysComment, $areaId, $access, $params  )
  {

    $listObj = new WbfsysComment_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_comment-acl-dset' );
    ...
    else
    {
      ...
      (
        'Comment "{@label@}" User Access',
        'wbfsys.comment.label',
        array
        (
          'label' => $entityWbfsysComment->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_comment_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysComment_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysComment_Acl_Dset_Ui */
