 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysComment_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysComment_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysComment = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysComment_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_comment-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysComment, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysComment_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_comment-acl-dset', 
    	'WbfsysComment_Acl_Dset',
...
} // end class WbfsysComment_Acl_Dset_Controller */
