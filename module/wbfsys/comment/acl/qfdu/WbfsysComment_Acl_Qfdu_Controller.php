 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysComment_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_comment-acl-qfdu-aAjax',
      'WbfsysComment_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysComment_Acl_Qfdu_Controller */
