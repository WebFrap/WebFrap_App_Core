 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_comment.title as "wbfsys_comment_title"',
      'wbfsys_comment.rowid as "wbfsys_comment_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_comment on wbfsys_group_users.vid = wbfsys_comment.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_comment.title) like upper(\''.$part.'%\') )
...
} // end class WbfsysComment_Acl_Qfdu_Treetable_Query_Postgresql */
