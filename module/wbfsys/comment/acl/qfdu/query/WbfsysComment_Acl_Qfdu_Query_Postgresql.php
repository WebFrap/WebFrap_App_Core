 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_comment.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_comment.rowid as id,
    wbfsys_comment.title as value,
    wbfsys_comment.title as label
  FROM
    wbfsys_comment
  WHERE
    {$sqlWhere}
...
} // end class WbfsysComment_Acl_Qfdu_Query_Postgresql */
