 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_comment')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysComment = $orm->get('WbfsysComment', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_comment_title']  = $refEntityWbfsysComment->title;

    }
    $tabData['wbfsys_comment_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysComment_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysComment_Acl' );
    /* @var $query WbfsysComment_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysComment_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysComment_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysComment_Acl_Qfdu' );
    /* @var $query WbfsysComment_Acl_Qfdu_Query  */
...
} // end class WbfsysComment_Acl_Qfdu_Model */
