 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Comment_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_comment-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Comment_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_comment-acl-update';
    ...
    $this->setTemplate( 'wbfsys/comment/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Comment', 'wbfsys.comment.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_comment_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysComment_Acl' );
...
} // end class WbfsysComment_Acl_Maintab_View */
