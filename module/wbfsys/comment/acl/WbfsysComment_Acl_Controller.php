 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysComment
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysComment_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysComment_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysComment_Acl_Model */
    $model   = $this->loadModel( 'WbfsysComment_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_comment_acl_masks_listing',
      'WbfsysComment_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysComment_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysComment_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysComment_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysComment_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysComment_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysComment_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_comment-acl-qfdu',
    	'WbfsysComment_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysComment_Acl_Controller */
