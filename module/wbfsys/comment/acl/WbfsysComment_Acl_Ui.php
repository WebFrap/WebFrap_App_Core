...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysComment_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysComment_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_comment-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Comment', 'wbfsys.comment.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_comment_acl';
...
} // end class WbfsysComment_Acl_Ui */
