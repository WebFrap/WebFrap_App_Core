 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysComment_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_comment') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_comment.rowid ",
      'acls'
    );
...
}//end class WbfsysComment_Treetable_Access
