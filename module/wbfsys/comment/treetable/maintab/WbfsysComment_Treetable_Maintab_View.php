 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysComment_Treeable_Model
    */
    public $model = null;

    /**
    * @var WbfsysComment_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/comment/maintab/treetable/listing' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.Comment.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Comment.search';
...
BUTTONJS;
    ...
    ///@var WbfsysComment_Treetable_Ui
    $ui = $this->loadUi( 'WbfsysComment_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var WbfsysComment_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'WbfsysComment_Table'
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Comment.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.Comment.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.Comment.listing&amp;ltype=treetable');
    });
...
}//end class WbfsysComment_Treetable_Maintab_View
