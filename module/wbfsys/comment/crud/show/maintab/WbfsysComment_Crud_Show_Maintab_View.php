 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysComment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysComment = $this->model->getEntityWbfsysComment();
    ...
    (
      ...
      array( 'text' => $entityWbfsysComment->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Comment.show  &amp;objid='.$entityWbfsysComment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Comment.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_comment-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/comment/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysComment_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Comment.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_comment' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_comment a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Comment.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Comment.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysComment_Crud_Show_Maintab_View
