 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysComment', array_keys( $this->fields['wbfsys_comment']), true ),
...
}//end class WbfsysComment_Crud_Create_Form */
