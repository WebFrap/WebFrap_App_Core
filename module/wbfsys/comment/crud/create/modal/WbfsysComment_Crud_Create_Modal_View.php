 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysComment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Comment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Comment.insert';
    $params->formId       = 'wgt-form-wbfsys_comment';
    $params->namespace   = 'wbfsys_comment-create';
    ...
    $this->setTemplate( 'wbfsys/comment/modal/crud/form_create' );
...
}//end class WbfsysComment_Crud_Create_Modal_View
