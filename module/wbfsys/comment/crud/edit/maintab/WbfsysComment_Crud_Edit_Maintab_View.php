 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysComment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysComment = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Comment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysComment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Comment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_comment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/comment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysComment_Crud_Edit' );
...
}//end class WbfsysComment_Crud_Edit_Maintab_View
