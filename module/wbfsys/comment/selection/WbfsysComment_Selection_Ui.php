 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysComment_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysComment_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysComment_Selection_Element
    (
      'selectionWbfsysComment',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Comments', 'wbfsys.comment.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Comment.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysComment',
      'WbfsysComment_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysComment' , $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysComment_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysComment_Selection_Ui
