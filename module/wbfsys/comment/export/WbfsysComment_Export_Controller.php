 ...
 * @licence WebFrap.net
 */
class WbfsysComment_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysComment_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysComment_Export_Listing_Access';
    ...
    // create a new WbfsysComment window
    $view = $this->loadView
    (
    	'export-wbfsys_comment',
    	'WbfsysComment_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysComment_Export' );
...
} // end class WbfsysComment_Export_Controller_Genf
