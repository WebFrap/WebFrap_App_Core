 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Audio_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysAudio_Ref_Comments_Table_Ajax_View
