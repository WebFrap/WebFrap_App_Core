 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_audio-ref-comments' );
  ...
  /**
   * @param WbfsysAudio_Ref_Comments_Table_Query $query
...
}//end class WbfsysAudio_Ref_Comments_Table_Access
