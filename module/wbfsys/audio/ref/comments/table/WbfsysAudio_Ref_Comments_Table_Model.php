 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysAudio
   *
   * @param int $idWbfsysAudio the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysAudio, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysAudio_Ref_Comments_Table' );
    /* @var $query WbfsysAudio_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysAudio );
...
}//end class WbfsysAudio_Ref_Comments_Table_Model
