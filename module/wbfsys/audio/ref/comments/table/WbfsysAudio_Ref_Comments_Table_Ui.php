 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAudio_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysAudio, $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudio_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_audio-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysAudio;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio-ref-comments-search-'
        .$idWbfsysAudio;
    ...
    $tabPanel->searchKey = 'wbfsys_audio-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysAudio_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysAudio );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Audio_Ref_Comments.search&amp;target_id='
...
}//end class WbfsysAudio_Ref_Comments_Table_Ui
