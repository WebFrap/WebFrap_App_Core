 ...
 * If you want to extend this class write your coden in ControllerWbfsysAudio
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_audio management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysAudio_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_audio-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_audio-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysAudio_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysAudio_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_audio-ref-comments-'.$listType.'-ajax',
    	'WbfsysAudio_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysAudio
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_audio-ref-comments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysAudio_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysAudio_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysAudio_Ref_Comments_'.$listType );
...
} // end WbfsysAudio_Ref_Comments_Controller
