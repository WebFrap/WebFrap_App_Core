 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Comments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listComments as $entityWbfsysAudio )
      {
        if(!$orm->save( $entityWbfsysAudio) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Audio '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Audio '.$entityText,
              'wbfsys.audio.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Audio: '.$textSaved,
          'wbfsys.audio.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysAudio_Ref_Comments_Multi_Model
