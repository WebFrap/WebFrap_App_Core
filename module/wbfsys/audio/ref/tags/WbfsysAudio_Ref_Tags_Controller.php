 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysAudio_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_audio-ref-tags';
    ...
    (
      $params->tabId,
      'WbfsysAudio_Ref_Tags_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysAudio_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_audio-ref-tags-'.$listType.'-ajax',
    	'WbfsysAudio_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysAudio
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysAudio_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysAudio_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysAudio_Ref_Tags_'.$listType );
...
} // end WbfsysAudio_Ref_Tags_Controller
