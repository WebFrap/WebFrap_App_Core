 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Tags_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Audio_Ref_Tags.search&amp;objid='.$objid,
        $params
      );
    }
    ...
    $ui  = $this->loadUi( 'WbfsysAudio_Ref_Tags_Table' );
...
}//end class WbfsysAudio_Ref_Tags_Table_Ajax_View
