 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysAudio, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysAudio_Ref_Tags_Table' );
    /* @var $query WbfsysAudio_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysAudio );
...
}//end class WbfsysAudio_Ref_Tags_Table_Model
