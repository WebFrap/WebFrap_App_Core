 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAudioCodec_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAudioCodec_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAudioCodec_Entity */
      $entity = $orm->get( 'WbfsysAudioCodec', $rootId );
    }
...
}//end class WbfsysAudioCodec_Crud_Access_Root
