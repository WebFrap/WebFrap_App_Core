 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAudioCodec Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioCodec = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit audio codec: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioCodec.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAudioCodec
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioCodec.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_codec-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_codec/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAudioCodec_Crud_Edit' );
...
}//end class WbfsysAudioCodec_Crud_Edit_Maintab_View
