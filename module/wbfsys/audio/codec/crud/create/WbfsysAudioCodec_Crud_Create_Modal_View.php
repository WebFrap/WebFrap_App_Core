 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAudioCodec entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AudioCodec.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AudioCodec.insert';
    $params->formId       = 'wgt-form-wbfsys_audio_codec';
    $params->namespace   = 'wbfsys_audio_codec-create';
    ...
    $this->setTemplate( 'wbfsys/audio_codec/modal/crud/form_create' );
...
}//end class WbfsysAudioCodec_Crud_Create_Modal_View
