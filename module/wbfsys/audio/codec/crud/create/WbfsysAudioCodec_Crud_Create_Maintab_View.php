 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAudioCodec Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_audio_codec-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/audio_codec/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AudioCodec.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_audio_codec';
    ...
    $form = $this->newForm( 'WbfsysAudioCodec_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AudioCodec.create');}});
});
...
}//end class WbfsysAudioCodec_Crud_Create_Maintab_View
