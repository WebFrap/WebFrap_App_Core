 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAudioCodec_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAudioCodec Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioCodec = $this->model->getEntityWbfsysAudioCodec();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show audio codec: {@text@}',
      'wbfsys.audio_codec.label',
      array( 'text' => $entityWbfsysAudioCodec->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioCodec.show  &amp;objid='.$entityWbfsysAudioCodec
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioCodec.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_codec-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_codec/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAudioCodec_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AudioCodec.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_codec' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_codec a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AudioCodec.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AudioCodec.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAudioCodec_Crud_Show_Maintab_View
