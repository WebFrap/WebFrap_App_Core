 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAudioCodec_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAudioCodec_Export_Listing_Access';
    ...
    // create a new WbfsysAudioCodec window
    $view = $this->loadView
    (
    	'export-wbfsys_audio_codec',
    	'WbfsysAudioCodec_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysAudioCodec_Export' );
...
} // end class WbfsysAudioCodec_Export_Controller_Genf
