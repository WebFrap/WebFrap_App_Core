 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAudioCodec_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAudioCodec_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioCodec_Selection_Element
    (
      'selectionWbfsysAudioCodec',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection audio codecs', 'wbfsys.audio_codec.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AudioCodec.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAudioCodec',
      'WbfsysAudioCodec_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAudioCodec_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAudioCodec_Selection_Ui
