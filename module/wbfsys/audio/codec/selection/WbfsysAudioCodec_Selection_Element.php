 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_audio_codec';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAudioCodec_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AudioCodec.show&amp;target_mask=WbfsysAudioCodec&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AudioCodec.edit&amp;target_mask=WbfsysAudioCodec&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.audio_codec.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AudioCodec.delete&amp;target_mask=WbfsysAudioCodec&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.audio_codec.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_audio_codec&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.audio_codec.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.AudioCodec.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.audio_codec.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.audio_codec.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_audio_codec_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_audio_codec_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_audio_codec_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AudioCodec_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected audio codecs." >{$iconDelete} Delete selected audio codecs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! audio codecs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AudioCodec_Multi.deleteAll" >{$iconClean} Delete all audio codecs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAudioCodec_Selection_Element
