 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für audio codecs
  *
  ...
  *  }
  *
  * @return WbfsysAudioCodec_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioCodec_Table_Element( 'tableWbfsysAudioCodec', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio_codec-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'audio codecs', 'wbfsys.audio_codec.label' );
      //$tabPanel->searchKey = 'wbfsys_audio_codec';
      ...
      $searchElement->searchKey = 'wbfsys_audio_codec';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAudioCodec_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAudioCodec', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAudioCodec listing maske
   *
   * @param WbfsysAudioCodec_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAudioCodec  = $model->getEntityWbfsysAudioCodec();
    ...
    $formWbfsysAudioCodec->setKeyName( 'wbfsys_audio_codec' );
...
}//end class WbfsysAudioCodec_Table_Ui
