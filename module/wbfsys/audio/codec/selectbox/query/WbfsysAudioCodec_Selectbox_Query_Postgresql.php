 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysAudioCodec Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_audio_codec.rowid as id',
      'wbfsys_audio_codec.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_audio_codec.m_order as "wbfsys_audio_codec-m_order-order"' );

    $criteria->from( 'wbfsys_audio_codec' );



      $criteria->orderBy( 'wbfsys_audio_codec.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_audio_codec.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_audio_codec.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysAudioCodec_Selectbox_Query_Postgresql
