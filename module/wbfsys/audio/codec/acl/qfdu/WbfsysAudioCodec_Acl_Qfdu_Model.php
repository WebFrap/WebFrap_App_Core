 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_audio_codec')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysAudioCodec = $orm->get('WbfsysAudioCodec', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_audio_codec_name']  = $refEntityWbfsysAudioCodec->name;

    }
    $tabData['wbfsys_audio_codec_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysAudioCodec_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudioCodec_Acl' );
    /* @var $query WbfsysAudioCodec_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudioCodec_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysAudioCodec_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudioCodec_Acl_Qfdu' );
    /* @var $query WbfsysAudioCodec_Acl_Qfdu_Query  */
...
} // end class WbfsysAudioCodec_Acl_Qfdu_Model */
