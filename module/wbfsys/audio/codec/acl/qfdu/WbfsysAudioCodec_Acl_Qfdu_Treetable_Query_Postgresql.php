 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_audio_codec.name as "wbfsys_audio_codec_name"',
      'wbfsys_audio_codec.rowid as "wbfsys_audio_codec_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_audio_codec on wbfsys_group_users.vid = wbfsys_audio_codec.rowid'
    );
...
} // end class WbfsysAudioCodec_Acl_Qfdu_Treetable_Query_Postgresql */
