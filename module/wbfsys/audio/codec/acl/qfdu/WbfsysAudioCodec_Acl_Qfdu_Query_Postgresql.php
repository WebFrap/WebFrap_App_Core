 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_audio_codec.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_audio_codec.rowid as id,
    wbfsys_audio_codec.name as value,
    wbfsys_audio_codec.name as label
  FROM
    wbfsys_audio_codec
  WHERE
    {$sqlWhere}
...
} // end class WbfsysAudioCodec_Acl_Qfdu_Query_Postgresql */
