 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAudioCodec_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_audio_codec-acl-qfdu-aAjax',
      'WbfsysAudioCodec_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAudioCodec_Acl_Qfdu_Controller */
