 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_audio_codec_acl_graph', 
      'WbfsysAudioCodec_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAudioCodec_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAudioCodec_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAudioCodec_Acl_Path_Maintab_View  */
...
} // end class WbfsysAudioCodec_Acl_Path_Controller */
