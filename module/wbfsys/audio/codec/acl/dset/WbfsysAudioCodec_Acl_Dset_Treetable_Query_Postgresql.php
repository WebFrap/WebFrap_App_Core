 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_audio_codec.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAudioCodec_Acl_Dset_Treetable_Query_Postgresql */
