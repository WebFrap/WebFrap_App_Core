 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAudioCodec_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAudioCodec_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAudioCodec, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAudioCodec_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_audio_codec-acl-dset' );
    ...
    else
    {
      ...
      (
        'audio codec "{@label@}" User Access',
        'wbfsys.audio_codec.label',
        array
        (
          'label' => $entityWbfsysAudioCodec->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_audio_codec_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAudioCodec_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAudioCodec_Acl_Dset_Ui */
