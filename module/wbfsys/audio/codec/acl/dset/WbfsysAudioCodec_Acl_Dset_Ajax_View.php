 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAudioCodec_Acl_Dset' );
    ...
    $entityWbfsysAudioCodec = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAudioCodec_Acl_Dset_Ajax_View */
