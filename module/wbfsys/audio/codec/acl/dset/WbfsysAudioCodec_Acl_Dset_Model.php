 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_audio_codec'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAudioCodec', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudioCodec_Acl_Dset' );
    /* @var $query WbfsysAudioCodec_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudioCodec_Acl_Dset_Treetable' );
    /* @var $query WbfsysAudioCodec_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAudioCodec_Acl_Dset_Model */
