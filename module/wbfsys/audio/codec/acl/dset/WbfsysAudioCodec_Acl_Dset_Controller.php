 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAudioCodec_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAudioCodec_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAudioCodec = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAudioCodec_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_audio_codec-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAudioCodec, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAudioCodec_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_audio_codec-acl-dset', 
    	'WbfsysAudioCodec_Acl_Dset',
...
} // end class WbfsysAudioCodec_Acl_Dset_Controller */
