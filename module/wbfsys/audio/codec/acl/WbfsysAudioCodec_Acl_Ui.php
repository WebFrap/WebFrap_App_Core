...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAudioCodec_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioCodec_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_audio_codec-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'audio codec', 'wbfsys.audio_codec.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_audio_codec_acl';
...
} // end class WbfsysAudioCodec_Acl_Ui */
