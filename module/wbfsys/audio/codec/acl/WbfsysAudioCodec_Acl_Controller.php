 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAudioCodec
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAudioCodec_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_audio_codec_acl_listing',
      'WbfsysAudioCodec_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysAudioCodec_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAudioCodec_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAudioCodec_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_audio_codec-acl',
    	'WbfsysAudioCodec_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_audio_codec_acl_masks_listing',
      'WbfsysAudioCodec_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAudioCodec_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAudioCodec_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAudioCodec_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAudioCodec_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAudioCodec_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAudioCodec_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_audio_codec-acl-qfdu',
    	'WbfsysAudioCodec_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAudioCodec_Acl_Controller */
