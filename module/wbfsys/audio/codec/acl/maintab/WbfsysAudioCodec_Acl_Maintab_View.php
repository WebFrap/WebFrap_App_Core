 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodec_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.AudioCodec_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio_codec-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.AudioCodec_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_audio_codec-acl-update';
    ...
    $this->setTemplate( 'wbfsys/audio_codec/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'audio codec', 'wbfsys.audio_codec.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_audio_codec_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAudioCodec_Acl' );
...
} // end class WbfsysAudioCodec_Acl_Maintab_View */
