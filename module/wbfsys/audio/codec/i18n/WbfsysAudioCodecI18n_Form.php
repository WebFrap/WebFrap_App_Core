 ...
 * @licence WebFrap.net
 */
class WbfsysAudioCodecI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_audio_codec_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAudioCodecI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysAudioCodecI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysAudioCodecI18n';
   ...
   *
   * @var WbfsysAudioCodecI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysAudioCodecI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAudioCodecI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAudioCodecI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.audio_codec_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_audio_codec
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_audio_codec( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysAudioCodec_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysAudioCodec not exists' );

      Log::warn('Looks like the Entity: WbfsysAudioCodec is missing');
      ...
      //p: Window
      $objidWbfsysAudioCodec = $this->entity->getData('id_wbfsys_audio_codec') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysAudioCodec
          || !$entityWbfsysAudioCodec = $this->db->orm->get
          (
            'WbfsysAudioCodec',
            $objidWbfsysAudioCodec
          )
      ...
      {
        $entityWbfsysAudioCodec = $this->db->orm->newEntity( 'WbfsysAudioCodec' );
      }

      $inputIdWbfsysAudioCodec = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysAudioCodec', 'Window' );
      $inputIdWbfsysAudioCodec->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_audio_codec]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_audio_codec'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Audio Codec (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysAudioCodec->assignedForm = $this->assignedForm;

      $inputIdWbfsysAudioCodec->setWidth( 'medium' );

      $inputIdWbfsysAudioCodec->setData( $this->entity->getData( 'id_wbfsys_audio_codec' )  );
      $inputIdWbfsysAudioCodec->setReadOnly( $this->isReadOnly( 'id_wbfsys_audio_codec' ) );
      $inputIdWbfsysAudioCodec->setLabel( $this->view->i18n->l( 'Wbfsys Audio Codec', 'wbfsys.audio_codec_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.AudioCodec.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_audio_codec'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysAudioCodec->setListUrl ( $listUrl );
      $inputIdWbfsysAudioCodec->setListIcon( 'control/connect.png' );
      $inputIdWbfsysAudioCodec->setEntityUrl( 'maintab.php?c=Wbfsys.AudioCodec.edit' );
      $inputIdWbfsysAudioCodec->conEntity         = $entityWbfsysAudioCodec;
      $inputIdWbfsysAudioCodec->refresh           = $this->refresh;
      $inputIdWbfsysAudioCodec->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysAudioCodec->view = $this->view;
      $inputIdWbfsysAudioCodec->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_audio_codec'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysAudioCodec );
  ...
  }//end public function input_id_wbfsys_audio_codec */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.audio_codec_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.audio_codec_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.audio_codec_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.audio_codec_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.audio_codec_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.audio_codec_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.audio_codec_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.audio_codec_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.audio_codec_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Audio Codec I18n)', 'wbfsys.audio_codec_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_audio_codec_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_audio_codec_i18n_m_role_change';
...
}//end class WbfsysAudioCodecI18n_Form */
