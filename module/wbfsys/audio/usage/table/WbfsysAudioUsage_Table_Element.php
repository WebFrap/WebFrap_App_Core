 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_audio_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAudioUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AudioUsage.show&amp;target_mask=WbfsysAudioUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AudioUsage.edit&amp;target_mask=WbfsysAudioUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.audio_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AudioUsage.delete&amp;target_mask=WbfsysAudioUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.audio_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_audio_usage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AudioUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Audio Usages." >{$iconDelete} Delete selected Audio Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Audio Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AudioUsage_Multi.deleteAll" >{$iconClean} Delete all Audio Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAudioUsage_Table_Element
