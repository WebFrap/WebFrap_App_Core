 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Audio Usages
  *
  ...
  *  }
  *
  * @return WbfsysAudioUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioUsage_Table_Element( 'tableWbfsysAudioUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Audio Usages', 'wbfsys.audio_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_audio_usage';
      ...
      $searchElement->searchKey = 'wbfsys_audio_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAudioUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAudioUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAudioUsage listing maske
   *
   * @param WbfsysAudioUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAudioUsage  = $model->getEntityWbfsysAudioUsage();
    ...
    $formWbfsysAudioUsage->setKeyName( 'wbfsys_audio_usage' );
...
}//end class WbfsysAudioUsage_Table_Ui
