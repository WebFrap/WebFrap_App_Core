 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAudioUsage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAudioUsage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioUsage_Selection_Element
    (
      'selectionWbfsysAudioUsage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Audio Usages', 'wbfsys.audio_usage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AudioUsage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAudioUsage',
      'WbfsysAudioUsage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAudioUsage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAudioUsage_Selection_Ui
