 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysAudioUsage_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_audio_usage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_audio_usage.rowid ",
      'acls'
    );
...
}//end class WbfsysAudioUsage_Selection_Access
