 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAudioUsage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAudioUsage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAudioUsage_Entity */
      $entity = $orm->get( 'WbfsysAudioUsage', $rootId );
    }
...
}//end class WbfsysAudioUsage_Crud_Access_Root
