 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAudioUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioUsage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Audio Usage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioUsage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAudioUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioUsage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_usage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_usage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAudioUsage_Crud_Edit' );
...
}//end class WbfsysAudioUsage_Crud_Edit_Maintab_View
