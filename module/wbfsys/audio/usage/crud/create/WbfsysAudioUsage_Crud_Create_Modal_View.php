 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAudioUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AudioUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AudioUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_audio_usage';
    $params->namespace   = 'wbfsys_audio_usage-create';
    ...
    $this->setTemplate( 'wbfsys/audio_usage/modal/crud/form_create' );
...
}//end class WbfsysAudioUsage_Crud_Create_Modal_View
