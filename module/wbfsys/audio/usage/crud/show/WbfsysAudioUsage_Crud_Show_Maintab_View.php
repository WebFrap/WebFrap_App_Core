 ...
 * @licence WebFrap.net
 */
class WbfsysAudioUsage_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAudioUsage_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAudioUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioUsage = $this->model->getEntityWbfsysAudioUsage();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Audio Usage: {@text@}',
      'wbfsys.audio_usage.label',
      array( 'text' => $entityWbfsysAudioUsage->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioUsage.show  &amp;objid='.$entityWbfsysAudioUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioUsage.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_usage-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_usage/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAudioUsage_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AudioUsage.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_usage' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_usage a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AudioUsage.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AudioUsage.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAudioUsage_Crud_Show_Maintab_View
