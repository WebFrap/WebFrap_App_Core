...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Audios
  *
  ...
  *  }
  *
  * @return WbfsysAudio_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudio_Table_Element( 'tableWbfsysAudio', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Audios', 'wbfsys.audio.label' );
      ...
      $searchElement->searchKey = 'wbfsys_audio';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAudio_Table_Element( null,$view );
...
}//end class WbfsysAudio_Table_Ui
