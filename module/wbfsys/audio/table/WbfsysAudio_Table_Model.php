...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_audio']->id_codec )
    {
      $valWbfsysAudioCodec = $orm->getField
      (
        'WbfsysAudioCodec',
        'rowid = '.$data['wbfsys_audio']->id_codec,
        'name'
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysAudio_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysAudio_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysAudio_Table_Model
