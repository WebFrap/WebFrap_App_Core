 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Audio Variants
  *
  ...
  *  }
  *
  * @return WbfsysAudioVariant_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioVariant_Table_Element( 'tableWbfsysAudioVariant', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio_variant-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Audio Variants', 'wbfsys.audio_variant.label' );
      //$tabPanel->searchKey = 'wbfsys_audio_variant';
      ...
      $searchElement->searchKey = 'wbfsys_audio_variant';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAudioVariant_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAudioVariant', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAudioVariant listing maske
   *
   * @param WbfsysAudioVariant_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAudioVariant  = $model->getEntityWbfsysAudioVariant();
    ...
    $formWbfsysAudioVariant->setKeyName( 'wbfsys_audio_variant' );
...
}//end class WbfsysAudioVariant_Table_Ui
