 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_audio_variant';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAudioVariant_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AudioVariant.show&amp;target_mask=WbfsysAudioVariant&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AudioVariant.edit&amp;target_mask=WbfsysAudioVariant&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.audio_variant.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AudioVariant.delete&amp;target_mask=WbfsysAudioVariant&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.audio_variant.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Audio codec', 'wbfsys.audio_variant.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_audio_variant_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AudioVariant_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Audio Variants." >{$iconDelete} Delete selected Audio Variants</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Audio Variants. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AudioVariant_Multi.deleteAll" >{$iconClean} Delete all Audio Variants</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAudioVariant_Table_Element
