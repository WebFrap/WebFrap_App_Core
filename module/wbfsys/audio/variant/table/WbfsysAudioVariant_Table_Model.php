 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_audio_variant']->id_audio_codec )
    {
      $valWbfsysAudioCodec = $orm->getField
      (
        'WbfsysAudioCodec',
        'rowid = '.$data['wbfsys_audio_variant']->id_audio_codec,
        'name'
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysAudioVariant_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysAudioVariant_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysAudioVariant_Table_Model
