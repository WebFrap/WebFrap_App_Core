...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_audio_variant';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAudioVariant';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAudioVariant' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAudioVariant entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_audio( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAudio_Entity' ) )
    {
      ...
      $inputIdAudio = $this->view->newInput( 'input'.$this->prefix.'IdAudio', 'Window' );
      $inputIdAudio->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_audio]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_audio'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Audio (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ));
      ...
      $inputIdAudio->setReadOnly( $this->isReadOnly( 'id_audio' ) );
      $inputIdAudio->setLabel( $this->view->i18n->l( 'Audio', 'wbfsys.audio_variant.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Audio.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_audio'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAudio->buildJavascript( 'wgt-input-'.$this->keyName.'_id_audio'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_audio */
    ...
    if( !Webfrap::classLoadable( 'WbfsysAudioCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Audio codec (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Audio codec', 'wbfsys.audio_variant.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysContentLicence_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_licence'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Licence (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ));
      ...
      $inputIdLicence->setLabel( $this->view->i18n->l( 'Licence', 'wbfsys.audio_variant.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_lang'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Language (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Language', 'wbfsys.audio_variant.label' ) );
  ...
  public function input_file( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for File (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      if( ( $objid = $this->entity->getId() ) && $this->entity->file )
        $inputFile->setLink('file.php?f=wbfsys_audio_variant-file-'.$objid.'&amp;n='.base64_encode($this->entity->file));

      $inputFile->setLabel
      (
        $this->view->i18n->l( 'File', 'wbfsys.audio_variant.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.audio_variant.label' ),
  ...
  public function input_mimetype( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (Audio Variant)', 'wbfsys.audio_variant.label' ),
  ...
  public function input_file_size( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Size (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'File Size', 'wbfsys.audio_variant.label' ),
  ...
  public function input_file_hash( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Hash (Audio Variant)', 'wbfsys.audio_variant.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.audio_variant.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.audio_variant.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.audio_variant.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.audio_variant.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Audio Variant)', 'wbfsys.audio_variant.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.audio_variant.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.audio_variant.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Audio Variant)', 'wbfsys.audio_variant.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.audio_variant.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysAudioCodec_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Audio codec (Audio Variant)', 'wbfsys.audio_variant.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_audio_variant_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_audio_variant_m_role_change';
...
}//end class WbfsysAudioVariant_Form */
