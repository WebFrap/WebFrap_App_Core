 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysAudioVariant_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_audio_variant.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_audio_variant.rowid ",
      'acls'
    );
...
}//end class WbfsysAudioVariant_Selection_Access
