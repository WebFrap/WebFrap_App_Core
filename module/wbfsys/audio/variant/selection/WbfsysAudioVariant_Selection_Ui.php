 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAudioVariant_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAudioVariant_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudioVariant_Selection_Element
    (
      'selectionWbfsysAudioVariant',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Audio Variants', 'wbfsys.audio_variant.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AudioVariant.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAudioVariant',
      'WbfsysAudioVariant_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAudioVariant_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAudioVariant_Selection_Ui
