 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAudioVariant Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_audio_variant-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/audio_variant/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AudioVariant.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_audio_variant';
    ...
    $form = $this->newForm( 'WbfsysAudioVariant_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AudioVariant.create');}});
});
...
}//end class WbfsysAudioVariant_Crud_Create_Maintab_View
