 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAudioVariant entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AudioVariant.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AudioVariant.insert';
    $params->formId       = 'wgt-form-wbfsys_audio_variant';
    $params->namespace   = 'wbfsys_audio_variant-create';
    ...
    $this->setTemplate( 'wbfsys/audio_variant/modal/crud/form_create' );
...
}//end class WbfsysAudioVariant_Crud_Create_Modal_View
