 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAudioVariant_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAudioVariant_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAudioVariant_Entity */
      $entity = $orm->get( 'WbfsysAudioVariant', $rootId );
    }
...
}//end class WbfsysAudioVariant_Crud_Access_Root
