 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAudioVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioVariant = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Audio Variant: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioVariant.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAudioVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioVariant.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_variant-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_variant/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAudioVariant_Crud_Edit' );
...
}//end class WbfsysAudioVariant_Crud_Edit_Maintab_View
