 ...
 * @licence WebFrap.net
 */
class WbfsysAudioVariant_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAudioVariant_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAudioVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudioVariant = $this->model->getEntityWbfsysAudioVariant();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Audio Variant: {@text@}',
      'wbfsys.audio_variant.label',
      array( 'text' => $entityWbfsysAudioVariant->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AudioVariant.show  &amp;objid='.$entityWbfsysAudioVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AudioVariant.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio_variant-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio_variant/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAudioVariant_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AudioVariant.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_variant' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio_variant a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AudioVariant.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AudioVariant.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAudioVariant_Crud_Show_Maintab_View
