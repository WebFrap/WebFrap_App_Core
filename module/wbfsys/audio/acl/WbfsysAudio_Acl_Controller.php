 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAudio
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAudio_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysAudio_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAudio_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAudio_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_audio_acl_masks_listing',
      'WbfsysAudio_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAudio_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAudio_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAudio_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAudio_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAudio_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAudio_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_audio-acl-qfdu',
    	'WbfsysAudio_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAudio_Acl_Controller */
