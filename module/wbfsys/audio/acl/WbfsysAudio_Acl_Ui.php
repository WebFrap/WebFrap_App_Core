...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAudio_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudio_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_audio-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Audio', 'wbfsys.audio.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_audio_acl';
