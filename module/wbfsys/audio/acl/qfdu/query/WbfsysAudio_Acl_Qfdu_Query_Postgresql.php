 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_audio.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_audio.rowid as id,
    wbfsys_audio.title as value,
    wbfsys_audio.title as label
  FROM
    wbfsys_audio
  WHERE
    {$sqlWhere}
...
} // end class WbfsysAudio_Acl_Qfdu_Query_Postgresql */
