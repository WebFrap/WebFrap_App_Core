 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAudio_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_audio-acl-qfdu-aAjax',
      'WbfsysAudio_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAudio_Acl_Qfdu_Controller */
