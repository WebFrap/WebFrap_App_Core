 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_audio.title as "wbfsys_audio_title"',
      'wbfsys_audio.rowid as "wbfsys_audio_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_audio on wbfsys_group_users.vid = wbfsys_audio.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_audio.title) like upper(\''.$part.'%\') )
...
} // end class WbfsysAudio_Acl_Qfdu_Treetable_Query_Postgresql */
