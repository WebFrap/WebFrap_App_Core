 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_audio')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysAudio = $orm->get('WbfsysAudio', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_audio_title']  = $refEntityWbfsysAudio->title;

    }
    $tabData['wbfsys_audio_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysAudio_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudio_Acl' );
    /* @var $query WbfsysAudio_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudio_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysAudio_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudio_Acl_Qfdu' );
    /* @var $query WbfsysAudio_Acl_Qfdu_Query  */
...
} // end class WbfsysAudio_Acl_Qfdu_Model */
