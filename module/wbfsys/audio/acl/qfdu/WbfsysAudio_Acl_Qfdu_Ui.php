...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAudio_Acl_Qfdu_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAudio_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAudio_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Audio',
        'wbfsys.audio.label'
      );
      $tabPanel->searchKey  = 'wbfsys_audio_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new WbfsysAudio_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class WbfsysAudio_Acl_Qfdu_Ui */
