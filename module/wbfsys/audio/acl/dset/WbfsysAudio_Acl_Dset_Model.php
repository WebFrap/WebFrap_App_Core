 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_audio'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudio_Acl_Dset' );
    /* @var $query WbfsysAudio_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAudio_Acl_Dset_Treetable' );
    /* @var $query WbfsysAudio_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAudio_Acl_Dset_Model */
