 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAudio_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAudio_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAudio = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAudio_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_audio-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAudio, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAudio_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_audio-acl-dset', 
    	'WbfsysAudio_Acl_Dset',
...
} // end class WbfsysAudio_Acl_Dset_Controller */
