...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAudio_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAudio_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAudio, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAudio_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_audio-acl-dset' );
    ...
    else
    {
      ...
      (
        'Audio "{@label@}" User Access',
        'wbfsys.audio.label',
        array
        (
          'label' => $entityWbfsysAudio->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_audio_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAudio_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAudio_Acl_Dset_Ui */
