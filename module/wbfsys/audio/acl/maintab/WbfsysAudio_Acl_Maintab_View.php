 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Audio_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_audio-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Audio_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_audio-acl-update';
    ...
    $this->setTemplate( 'wbfsys/audio/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Audio', 'wbfsys.audio.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_audio_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAudio_Acl' );
...
} // end class WbfsysAudio_Acl_Maintab_View */
