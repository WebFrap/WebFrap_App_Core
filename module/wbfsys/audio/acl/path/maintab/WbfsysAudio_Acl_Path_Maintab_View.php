 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/audio/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_audio-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_audio-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysAudio_Acl_Path_Maintab_View */
