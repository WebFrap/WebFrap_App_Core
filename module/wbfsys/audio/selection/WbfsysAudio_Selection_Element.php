 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_audio';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Audio.show&amp;target_mask=WbfsysAudio&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.audio.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Audio.edit&amp;target_mask=WbfsysAudio&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.audio.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Audio.delete&amp;target_mask=WbfsysAudio&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.audio.label',
        Acl::DELETE
...
}//end class WbfsysAudio_Selection_Element
