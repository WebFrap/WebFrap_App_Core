 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAudio_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysAudio_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/audio/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Audio.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_audio-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysAudio_Selection' );
...
}//end class WbfsysAudio_Selection_Modal_View
