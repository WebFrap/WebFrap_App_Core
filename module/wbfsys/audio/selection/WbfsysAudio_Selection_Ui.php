 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAudio_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAudio_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAudio_Selection_Element
    (
      'selectionWbfsysAudio',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Audios', 'wbfsys.audio.label' ) ;
      $tabPanel->searchKey = 'wbfsys_audio';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Audio.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAudio' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysAudio listing maske
   *
   * @param WbfsysAudio_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAudio_Selection_Ui
