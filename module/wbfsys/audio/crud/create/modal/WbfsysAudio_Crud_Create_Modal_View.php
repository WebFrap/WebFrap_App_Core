 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAudio entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Audio.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Audio.insert';
    $params->formId       = 'wgt-form-wbfsys_audio';
    $params->namespace   = 'wbfsys_audio-create';
    ...
    $this->setTemplate( 'wbfsys/audio/modal/crud/form_create' );
...
}//end class WbfsysAudio_Crud_Create_Modal_View
