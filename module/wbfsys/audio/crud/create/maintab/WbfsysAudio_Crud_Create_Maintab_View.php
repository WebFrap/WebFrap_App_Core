 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAudio Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_audio-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/audio/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Audio.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_audio';
    ...
    $form = $this->newForm( 'WbfsysAudio_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Audio.create');}});
});
...
}//end class WbfsysAudio_Crud_Create_Maintab_View
