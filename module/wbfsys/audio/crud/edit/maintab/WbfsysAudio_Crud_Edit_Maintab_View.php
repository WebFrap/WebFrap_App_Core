 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAudio Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudio = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Audio.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAudio
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Audio.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAudio_Crud_Edit' );
...
}//end class WbfsysAudio_Crud_Edit_Maintab_View
