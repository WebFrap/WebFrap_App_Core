 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAudio_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysAudio_Entity */
      $entity = $orm->get( 'WbfsysAudio', $rootId );
    }
...
}//end class WbfsysAudio_Crud_Access_Root
