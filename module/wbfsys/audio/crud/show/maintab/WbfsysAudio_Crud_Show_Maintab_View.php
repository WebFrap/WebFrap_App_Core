 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAudio Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAudio = $this->model->getEntityWbfsysAudio();
    ...
    (
      'Show Audio: {@text@}',
      'wbfsys.audio.label',
      array( 'text' => $entityWbfsysAudio->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Audio.show  &amp;objid='.$entityWbfsysAudio
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Audio.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_audio-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/audio/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAudio_Crud_Show' );
    ...
    if( $params->access->getPathLevel( 'mgmt-wbfsys_audio-ref-comments' ) )
    {
    ...
    if( $params->access->getPathLevel( 'mgmt-wbfsys_audio-ref-tags' ) )
    {
      // many to many reference
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Audio.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_audio a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Audio.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Audio.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAudio_Crud_Show_Maintab_View
