 ...
 * @licence WebFrap.net
 */
class WbfsysAudio_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAudio_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAudio_Export_Listing_Access';
    ...
    // create a new WbfsysAudio window
    $view = $this->loadView
    (
    	'export-wbfsys_audio',
    	'WbfsysAudio_Export',
    ...
    $model = $this->loadModel( 'WbfsysAudio_Export' );
...
} // end class WbfsysAudio_Export_Controller_Genf
