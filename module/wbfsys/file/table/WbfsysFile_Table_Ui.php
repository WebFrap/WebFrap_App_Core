...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Files
  *
  ...
  *  }
  *
  * @return WbfsysFile_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFile_Table_Element( 'tableWbfsysFile', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Files', 'wbfsys.file.label' );
      //$tabPanel->searchKey = 'wbfsys_file';
      ...
      $searchElement->searchKey = 'wbfsys_file';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFile_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFile', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFile listing maske
   *
   * @param WbfsysFile_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFile  = $model->getEntityWbfsysFile();
