 ...
 * @licence WebFrap.net
 */
class WbfsysFile_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_file';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFile_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.File.show&amp;target_mask=WbfsysFile&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.file.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.File.edit&amp;target_mask=WbfsysFile&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.File.delete&amp;target_mask=WbfsysFile&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      if( $row['wbfsys_file_name'] )
      {
        $body .= '<td valign="top" ><a href="file.php?f=wbfsys_file-name-'.$row['wbfsys_file_rowid'].'&amp;n='.base64_encode($row['wbfsys_file_name']).'" target="new_download" >'.Validator::sanitizeHtml($row['wbfsys_file_name']).'</a></td>'.NL;
      }
      else
      {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_file_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.File_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Files." >{$iconDelete} Delete selected Files</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Files. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.File_Multi.deleteAll" >{$iconClean} Delete all Files</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFile_Table_Element
