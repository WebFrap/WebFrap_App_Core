 ...
 * @licence WebFrap.net
 */
class WbfsysFile_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFile = $this->model->getEntityWbfsysFile();
    ...
    (
      'Show File: {@text@}',
      'wbfsys.file.label',
      array( 'text' => $entityWbfsysFile->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.File.show  &amp;objid='.$entityWbfsysFile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.File.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFile_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.File.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.File.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.File.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFile_Crud_Show_Maintab_View
