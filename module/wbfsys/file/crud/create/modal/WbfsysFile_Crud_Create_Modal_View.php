 ...
 * @licence WebFrap.net
 */
class WbfsysFile_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFile entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.File.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.File.insert';
    $params->formId       = 'wgt-form-wbfsys_file';
    $params->namespace   = 'wbfsys_file-create';
    ...
    $this->setTemplate( 'wbfsys/file/modal/crud/form_create' );
...
}//end class WbfsysFile_Crud_Create_Modal_View
