...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFile_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFile_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFile_Selection_Element
    (
      'selectionWbfsysFile',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Files', 'wbfsys.file.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.File.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysFile_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFile_Selection_Ui
