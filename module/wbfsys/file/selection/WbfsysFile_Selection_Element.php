 ...
 * @licence WebFrap.net
 */
class WbfsysFile_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_file';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.File.show&amp;target_mask=WbfsysFile&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.file.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.File.edit&amp;target_mask=WbfsysFile&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.File.delete&amp;target_mask=WbfsysFile&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file.label',
        Acl::DELETE
...
}//end class WbfsysFile_Selection_Element
