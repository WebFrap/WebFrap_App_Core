 ...
 * @licence WebFrap.net
 */
class WbfsysFile_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFile_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_file.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_file.rowid ",
      'acls'
    );
...
}//end class WbfsysFile_Selection_Access
