 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysFileVersion', array_keys( $this->fields['wbfsys_file_version']), true ),
...
}//end class WbfsysFileVersion_Crud_Create_Form */
