 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysFileVersion Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_file_version-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/file_version/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileVersion.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_file_version';
    ...
    $form = $this->newForm( 'WbfsysFileVersion_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.FileVersion.create');}});
});
...
}//end class WbfsysFileVersion_Crud_Create_Maintab_View
