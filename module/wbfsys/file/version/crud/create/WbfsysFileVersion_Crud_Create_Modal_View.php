 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFileVersion entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FileVersion.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileVersion.insert';
    $params->formId       = 'wgt-form-wbfsys_file_version';
    $params->namespace   = 'wbfsys_file_version-create';
    ...
    $this->setTemplate( 'wbfsys/file_version/modal/crud/form_create' );
...
}//end class WbfsysFileVersion_Crud_Create_Modal_View
