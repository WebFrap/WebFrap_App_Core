 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysFileVersion_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysFileVersion_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysFileVersion_Entity */
      $entity = $orm->get( 'WbfsysFileVersion', $rootId );
    }
...
}//end class WbfsysFileVersion_Crud_Access_Root
