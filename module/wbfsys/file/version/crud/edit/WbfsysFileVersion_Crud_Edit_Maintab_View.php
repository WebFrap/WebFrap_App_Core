 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysFileVersion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileVersion = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit File Version: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileVersion.edit&amp;utf8=✓&amp;objid='.$entityWbfsysFileVersion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileVersion.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_version-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_version/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysFileVersion_Crud_Edit' );
...
}//end class WbfsysFileVersion_Crud_Edit_Maintab_View
