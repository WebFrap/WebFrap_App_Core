 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFileVersion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileVersion = $this->model->getEntityWbfsysFileVersion();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show File Version: {@text@}',
      'wbfsys.file_version.label',
      array( 'text' => $entityWbfsysFileVersion->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileVersion.show  &amp;objid='.$entityWbfsysFileVersion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileVersion.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_version-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_version/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFileVersion_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.FileVersion.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_version' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_version a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.FileVersion.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.FileVersion.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFileVersion_Crud_Show_Maintab_View
