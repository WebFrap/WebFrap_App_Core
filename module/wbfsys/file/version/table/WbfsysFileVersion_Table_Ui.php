 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für File Versions
  *
  ...
  *  }
  *
  * @return WbfsysFileVersion_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileVersion_Table_Element( 'tableWbfsysFileVersion', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_version-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'File Versions', 'wbfsys.file_version.label' );
      //$tabPanel->searchKey = 'wbfsys_file_version';
      ...
      $searchElement->searchKey = 'wbfsys_file_version';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFileVersion_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFileVersion', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFileVersion listing maske
   *
   * @param WbfsysFileVersion_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFileVersion  = $model->getEntityWbfsysFileVersion();
    ...
    $formWbfsysFileVersion->setKeyName( 'wbfsys_file_version' );
...
}//end class WbfsysFileVersion_Table_Ui
