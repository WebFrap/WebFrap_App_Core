 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_file_version';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFileVersion_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FileVersion.show&amp;target_mask=WbfsysFileVersion&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FileVersion.edit&amp;target_mask=WbfsysFileVersion&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file_version.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FileVersion.delete&amp;target_mask=WbfsysFileVersion&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file_version.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.file_version.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.file_version.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_file_version_rowid'];
      ...
      if( $row['wbfsys_file_version_name'] )
      {
        $body .= '<td valign="top" ><a href="file.php?f=wbfsys_file_version-name-'.$row['wbfsys_file_version_rowid'].'&amp;n='.base64_encode($row['wbfsys_file_version_name']).'" target="new_download" >'.Validator::sanitizeHtml($row['wbfsys_file_version_name']).'</a></td>'.NL;
      }
      else
      {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_file_version_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.FileVersion_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected File Versions." >{$iconDelete} Delete selected File Versions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! File Versions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.FileVersion_Multi.deleteAll" >{$iconClean} Delete all File Versions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFileVersion_Table_Element
