 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFileVersion_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFileVersion_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileVersion_Selection_Element
    (
      'selectionWbfsysFileVersion',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection File Versions', 'wbfsys.file_version.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.FileVersion.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysFileVersion',
      'WbfsysFileVersion_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysFileVersion_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFileVersion_Selection_Ui
