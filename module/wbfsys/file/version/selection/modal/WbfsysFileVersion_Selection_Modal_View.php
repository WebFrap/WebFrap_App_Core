 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysFileVersion_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysFileVersion_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/file_version/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'File Version', 'wbfsys.file_version.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.FileVersion.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_file_version-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysFileVersion_Selection' );
...
}//end class WbfsysFileVersion_Selection_Modal_View
