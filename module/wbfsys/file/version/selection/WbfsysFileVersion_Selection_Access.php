 ...
 * @licence WebFrap.net
 */
class WbfsysFileVersion_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFileVersion_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_file_version.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_file_version.rowid ",
      'acls'
    );
...
}//end class WbfsysFileVersion_Selection_Access
