...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_file_version';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysFileVersion';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysFileVersion' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysFileVersion entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      if( ( $objid = $this->entity->getId() ) && $this->entity->name )
        $inputName->setLink('file.php?f=wbfsys_file_version-name-'.$objid.'&amp;n='.base64_encode($this->entity->name));

      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.file_version.label' ),
  ...
  * @return void
  */
  public function input_id_file( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysFile_Entity' ) )
    {
      ...
      $inputIdFile = $this->view->newInput( 'input'.$this->prefix.'IdFile', 'Window' );
      $inputIdFile->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_file]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_file'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for File (File Version)', 'wbfsys.file_version.label' ),
      ));
      ...
      $inputIdFile->setReadOnly( $this->isReadOnly( 'id_file' ) );
      $inputIdFile->setLabel( $this->view->i18n->l( 'File', 'wbfsys.file_version.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.File.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_file'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdFile->buildJavascript( 'wgt-input-'.$this->keyName.'_id_file'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_file */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.file_version.label' ),
  ...
  public function input_mimetype( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (File Version)', 'wbfsys.file_version.label' ),
  ...
  public function input_file_size( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Size (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'File Size', 'wbfsys.file_version.label' ),
  ...
  public function input_file_hash( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Hash (File Version)', 'wbfsys.file_version.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.file_version.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (File Version)', 'wbfsys.file_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.file_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (File Version)', 'wbfsys.file_version.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.file_version.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (File Version)', 'wbfsys.file_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.file_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (File Version)', 'wbfsys.file_version.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.file_version.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.file_version.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (File Version)', 'wbfsys.file_version.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.file_version.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_version_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_version_m_role_change';
...
}//end class WbfsysFileVersion_Form */
