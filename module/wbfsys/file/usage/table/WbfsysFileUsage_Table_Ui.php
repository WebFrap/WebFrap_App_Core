 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für File Usages
  *
  ...
  *  }
  *
  * @return WbfsysFileUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileUsage_Table_Element( 'tableWbfsysFileUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'File Usages', 'wbfsys.file_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_file_usage';
      ...
      $searchElement->searchKey = 'wbfsys_file_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFileUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFileUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFileUsage listing maske
   *
   * @param WbfsysFileUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFileUsage  = $model->getEntityWbfsysFileUsage();
    ...
    $formWbfsysFileUsage->setKeyName( 'wbfsys_file_usage' );
...
}//end class WbfsysFileUsage_Table_Ui
