 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_file_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFileUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FileUsage.show&amp;target_mask=WbfsysFileUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FileUsage.edit&amp;target_mask=WbfsysFileUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FileUsage.delete&amp;target_mask=WbfsysFileUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_file_usage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.FileUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected File Usages." >{$iconDelete} Delete selected File Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! File Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.FileUsage_Multi.deleteAll" >{$iconClean} Delete all File Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFileUsage_Table_Element
