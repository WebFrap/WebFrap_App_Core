 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFileUsage_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_file_usage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_file_usage.rowid ",
      'acls'
    );
...
}//end class WbfsysFileUsage_Selection_Access
