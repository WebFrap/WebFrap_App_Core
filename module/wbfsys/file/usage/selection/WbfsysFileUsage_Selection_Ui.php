 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFileUsage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFileUsage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileUsage_Selection_Element
    (
      'selectionWbfsysFileUsage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection File Usages', 'wbfsys.file_usage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.FileUsage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysFileUsage',
      'WbfsysFileUsage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysFileUsage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFileUsage_Selection_Ui
