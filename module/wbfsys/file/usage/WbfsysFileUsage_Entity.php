 ...
 *
 * Entity Class for the Database Table wbfsys_file_usage
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_file_usage';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.FileUsage.show';
  ...
  */
  public static $entityName  = 'WbfsysFileUsage';
  ...
  * @var string
  */
  public static $label  = 'File Usage';
  ...
  */
  ...
  (
    'id_file' => array
    (
      'default' => 'wbfsys.file_usage.message.error_def_id_file',
      'wrong'   => 'wbfsys.file_usage.message.error_wrong_id_file',
      'max'     => 'wbfsys.file_usage.message.error_max_id_file',
      'min'     => 'wbfsys.file_usage.message.error_min_id_file',
    ),

    'vid' => array
    (
      'default' => 'wbfsys.file_usage.message.error_def_vid',
      'wrong'   => 'wbfsys.file_usage.message.error_wrong_vid',
      'max'     => 'wbfsys.file_usage.message.error_max_vid',
      'min'     => 'wbfsys.file_usage.message.error_min_vid',
    ),

    'id_vid_entity' => array
    (
      'default' => 'wbfsys.file_usage.message.error_def_id_vid_entity',
      'wrong'   => 'wbfsys.file_usage.message.error_wrong_id_vid_entity',
      'max'     => 'wbfsys.file_usage.message.error_max_id_vid_entity',
      'min'     => 'wbfsys.file_usage.message.error_min_id_vid_entity',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.file_usage.message.error_def_rowid',
      'wrong'   => 'wbfsys.file_usage.message.error_wrong_rowid',
      'empty'   => 'wbfsys.file_usage.message.error_empty_rowid',
      'max'     => 'wbfsys.file_usage.message.error_max_rowid',
      'min'     => 'wbfsys.file_usage.message.error_min_rowid',
    ),
  );

}//end class WbfsysFileUsage_Entity
