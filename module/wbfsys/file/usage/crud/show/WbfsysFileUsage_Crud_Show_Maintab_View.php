 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysFileUsage_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFileUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileUsage = $this->model->getEntityWbfsysFileUsage();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show File Usage: {@text@}',
      'wbfsys.file_usage.label',
      array( 'text' => $entityWbfsysFileUsage->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileUsage.show  &amp;objid='.$entityWbfsysFileUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileUsage.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_usage-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_usage/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFileUsage_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.FileUsage.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_usage' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_usage a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.FileUsage.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.FileUsage.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFileUsage_Crud_Show_Maintab_View
