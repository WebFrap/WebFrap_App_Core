 ...
 * @licence WebFrap.net
 */
class WbfsysFileUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFileUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FileUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_file_usage';
    $params->namespace   = 'wbfsys_file_usage-create';
    ...
    $this->setTemplate( 'wbfsys/file_usage/modal/crud/form_create' );
...
}//end class WbfsysFileUsage_Crud_Create_Modal_View
