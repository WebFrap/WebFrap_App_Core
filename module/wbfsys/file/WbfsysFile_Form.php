...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysFile' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysFile entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (File)', 'wbfsys.file.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.file.label' ),
  ...
  */
  public function input_name( $params )
  {
      ...
      //p: input file
      $inputName = $this->view->newInput( 'input'.$this->prefix.'Name' , 'File' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      if( ( $objid = $this->entity->getId() ) && $this->entity->name )
        $inputName->setLink('file.php?f=wbfsys_file-name-'.$objid.'&amp;n='.base64_encode($this->entity->name));

      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.file.label' ),
  ...
  * @return void
  */
  public function input_link( $params )
  {

      //tpl: class ui: guess
      $inputLink = $this->view->newInput( 'input'.$this->prefix.'Link' , 'text' );
      $this->items['link'] = $inputLink;
      $inputLink->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[link]',
          'id'        => 'wgt-input-'.$this->keyName.'_link'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Link (File)', 'wbfsys.file.label' ),
        )
      );
      $inputLink->setWidth( 'medium' );

      $inputLink->setReadOnly( $this->isReadOnly( 'link' ) );
      $inputLink->setData( $this->entity->getSecure('link') );
      $inputLink->setLabel
      (
        $this->view->i18n->l( 'Link', 'wbfsys.file.label' ),
        $this->entity->required( 'link' )
      );
  ...
  }//end public function input_link */
  ...
  * @return void
  */
  public function input_activ( $params )
  {

      //tpl: class ui:Checkbox
      $inputActiv = $this->view->newInput( 'input'.$this->prefix.'Activ' , 'Checkbox' );
      $this->items['activ'] = $inputActiv;
      $inputActiv->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[activ]',
          'id'        => 'wgt-input-'.$this->keyName.'_activ'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Activ (File)', 'wbfsys.file.label' ),
        )
      );
      $inputActiv->setWidth( 'medium' );

      $inputActiv->setReadOnly( $this->isReadOnly( 'activ' ) );
      $inputActiv->setActive( $this->entity->getBoolean( 'activ' ) );
      $inputActiv->setLabel
      (
        $this->view->i18n->l( 'Activ', 'wbfsys.file.label' ),
        $this->entity->required( 'activ' )
      );
  ...
  }//end public function input_activ */
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysFileType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysFileType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.file.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_file_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.FileType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
    ...
    if( !Webfrap::classLoadable( 'WbfsysConfidentialityLevel_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Confidentiality (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Confidentiality', 'wbfsys.file.label' ),
  ...
  * @return void
  */
  public function input_flag_local( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagLocal = $this->view->newInput( 'input'.$this->prefix.'FlagLocal' , 'Checkbox' );
      $this->items['flag_local'] = $inputFlagLocal;
      $inputFlagLocal->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_local]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_local'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Local (File)', 'wbfsys.file.label' ),
        )
      );
      $inputFlagLocal->setWidth( 'medium' );

      $inputFlagLocal->setReadOnly( $this->isReadOnly( 'flag_local' ) );
      $inputFlagLocal->setActive( $this->entity->getBoolean( 'flag_local' ) );
      $inputFlagLocal->setLabel
      (
        $this->view->i18n->l( 'Local', 'wbfsys.file.label' ),
        $this->entity->required( 'flag_local' )
      );
  ...
  }//end public function input_flag_local */
    ...
    if( !Webfrap::classLoadable( 'WbfsysContentLicence_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_licence'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Licence (File)', 'wbfsys.file.label' ),
      ));
      ...
      $inputIdLicence->setLabel( $this->view->i18n->l( 'Licence', 'wbfsys.file.label' ) );
  ...
  * @return void
  */
  public function input_flag_versioning( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagVersioning = $this->view->newInput( 'input'.$this->prefix.'FlagVersioning' , 'Checkbox' );
      $this->items['flag_versioning'] = $inputFlagVersioning;
      $inputFlagVersioning->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_versioning]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_versioning'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Versioning (File)', 'wbfsys.file.label' ),
        )
      );
      $inputFlagVersioning->setWidth( 'medium' );

      $inputFlagVersioning->setReadOnly( $this->isReadOnly( 'flag_versioning' ) );
      $inputFlagVersioning->setActive( $this->entity->getBoolean( 'flag_versioning' ) );
      $inputFlagVersioning->setLabel
      (
        $this->view->i18n->l( 'Versioning', 'wbfsys.file.label' ),
        $this->entity->required( 'flag_versioning' )
      );
  ...
  }//end public function input_flag_versioning */
    ...
    if( !Webfrap::classLoadable( 'WbfsysMediathek_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_mediathek'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Mediathek (File)', 'wbfsys.file.label' ),
      ));
      ...
      $inputIdMediathek->setLabel( $this->view->i18n->l( 'Mediathek', 'wbfsys.file.label' ) );
  ...
  * @return void
  */
  public function input_id_storage( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysFileStorage_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdStorage = $this->view->newItem( 'input'.$this->prefix.'IdStorage' , 'WbfsysFileStorage_Selectbox' );
      $this->items['id_storage'] = $inputIdStorage;
      $inputIdStorage->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[id_storage]',
          'id'        => 'wgt-input-'.$this->keyName.'_id_storage'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Storage (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      $inputIdStorage->setReadOnly( $this->isReadOnly( 'id_storage' ) );
      $inputIdStorage->setLabel
      (
        $this->view->i18n->l( 'Storage', 'wbfsys.file.label' ),
        $this->entity->required( 'id_storage' )
      );
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputIdStorage->editUrl = 'index.php?c=Wbfsys.FileStorage.listing&amp;target='.$this->namespace.'&amp;field=id_storage&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_storage'.$this->suffix;
      }
      // set an empty first entry
  ...
  }//end public function input_id_storage */
  ...
  * @return void
  */
  public function input_max_version( $params )
  {

      //tpl: class ui:hidden
      $inputMaxVersion = $this->view->newInput( 'input'.$this->prefix.'MaxVersion', 'Hidden' );
      $this->items['max_version'] = $inputMaxVersion;
      $inputMaxVersion->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[max_version]',
          'id'        => 'wgt-input-'.$this->keyName.'_max_version'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Max Version (File)', 'wbfsys.file.label' ),
          'maxlength' => $this->entity->maxSize( 'max_version' ),
        )
      );
      $inputMaxVersion->setWidth( 'medium' );

      $inputMaxVersion->setReadOnly( $this->isReadOnly( 'max_version' ) );
  ...
  }//end public function input_max_version */
  ...
  */
  public function input_id_visibility( $params )
  {
      ...
      //tpl: class ui:hidden
      $inputIdVisibility = $this->view->newInput( 'input'.$this->prefix.'IdVisibility', 'Hidden' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Visibility (File)', 'wbfsys.file.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.file.label' ),
  ...
  public function input_mimetype( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (File)', 'wbfsys.file.label' ),
  ...
  public function input_file_size( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Size (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'File Size', 'wbfsys.file.label' ),
  ...
  public function input_file_hash( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for File Hash (File)', 'wbfsys.file.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.file.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (File)', 'wbfsys.file.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.file.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (File)', 'wbfsys.file.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.file.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (File)', 'wbfsys.file.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.file.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (File)', 'wbfsys.file.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.file.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.file.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (File)', 'wbfsys.file.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.file.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (File)', 'wbfsys.file.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
 ...
 /**
  * create the search element for field link
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_link( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Link (File)', 'wbfsys.file.label' ),
        )
      );
      $inputLink->setWidth( 'medium' );
  ...
  }//end public function search_link */

 /**
  * create the search element for field activ
  *@param TFlag $params named parameters
  * @return void
  */
  public function search_activ( $params )
  {

      //tpl: class ui:Checkbox
      $inputActiv = $this->view->newInput( 'input'.$this->prefix.'Activ' , 'SearchCheckbox' );
      $this->items['activ'] = $inputActiv;
      $inputActiv->addAttributes
      (
        array
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_activ'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Activ (File)', 'wbfsys.file.label' ),
        )
      );
      $inputActiv->setWidth( 'medium' );
  ...
  }//end public function search_activ */
    ...
    if( !Webfrap::classLoadable( 'WbfsysFileType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Type (File)', 'wbfsys.file.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_m_role_change';
