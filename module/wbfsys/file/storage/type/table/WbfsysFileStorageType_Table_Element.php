 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_file_storage_type';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FileStorageType.show&amp;target_mask=WbfsysFileStorageType&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FileStorageType.edit&amp;target_mask=WbfsysFileStorageType&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file_storage_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FileStorageType.delete&amp;target_mask=WbfsysFileStorageType&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file_storage_type.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.FileStorageType.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_file_storage_type_name'])).'</a></td>'.NL;
...
}//end class WbfsysFileStorageType_Table_Element
