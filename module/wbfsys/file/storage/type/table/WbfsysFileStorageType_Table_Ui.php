 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für file storage Types
  *
  ...
  *  }
  *
  * @return WbfsysFileStorageType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileStorageType_Table_Element( 'tableWbfsysFileStorageType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_storage_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'file storage Types', 'wbfsys.file_storage_type.label' );
      //$tabPanel->searchKey = 'wbfsys_file_storage_type';
      ...
      $searchElement->searchKey = 'wbfsys_file_storage_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFileStorageType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFileStorageType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFileStorageType listing maske
   *
   * @param WbfsysFileStorageType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFileStorageType  = $model->getEntityWbfsysFileStorageType();
    ...
    $formWbfsysFileStorageType->setKeyName( 'wbfsys_file_storage_type' );
...
}//end class WbfsysFileStorageType_Table_Ui
