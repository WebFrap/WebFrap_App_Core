 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_file_storage_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.FileStorageType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_file_storage_type-create';

    $access = new WbfsysFileStorageType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_file_storage_type-create',
      'WbfsysFileStorageType_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysFileStorageType_Crud_Model */
    $model = $this->loadModel( 'WbfsysFileStorageType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.FileStorageType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysFileStorageType = $model->getEntityWbfsysFileStorageType( $objid );
    ...
    $params->entity = $entityWbfsysFileStorageType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_file_storage_type:edit';

    $access = new WbfsysFileStorageType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysFileStorageType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_file_storage_type-edit-'.$objid,
      'WbfsysFileStorageType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_file_storage_type-edit',
          $entityWbfsysFileStorageType,
          'Edit file storage Type :'.$entityWbfsysFileStorageType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_file_storage_type';
      $params->maskRoot      = 'wbfsys_file_storage_type:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_file_storage_type';
      $params->aclNode       = 'mgmt-wbfsys_file_storage_type';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_file_storage_type-edit-'.$objid,
      'WbfsysFileStorageType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_file_storage_type-show',
          $entityWbfsysFileStorageType,
          'Show file storage Type :'.$entityWbfsysFileStorageType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_file_storage_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.FileStorageType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-insert';

    $access = new WbfsysFileStorageType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysFileStorageType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_file_storage_type-update-'.$entityWbfsysFileStorageType;
      ...
      {
        $access = new WbfsysFileStorageType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysFileStorageType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysFileStorageType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_file_storage_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysFileStorageType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.FileStorageType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysFileStorageType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysFileStorageType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.FileStorageType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-delete-'.$objid;

    $access = new WbfsysFileStorageType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysFileStorageType );
    ...
    $error = $model->delete( $entityWbfsysFileStorageType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysFileStorageType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.FileStorageType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.FileStorageType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-listing';
    ...
    $containerClass = 'WbfsysFileStorageType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_file_storage_type',
      'WbfsysFileStorageType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysFileStorageType_Table_Model */
    $model = $this->loadModel( 'WbfsysFileStorageType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_file_storage_type-'.$params->ltype,
          'WbfsysFileStorageType',
          'List of file storage Types'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysFileStorageType
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysFileStorageType_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_file_storage_type',
      'WbfsysFileStorageType_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysFileStorageType_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.FileStorageType.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysFileStorageType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysFileStorageType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_file_storage_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_file_storage_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_file_storage_type',
      'WbfsysFileStorageType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysFileStorageType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysFileStorageType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysFileStorageType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_file_storage_type-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysFileStorageType_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysFileStorageType, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_file_storage_type' );
...
} // end class WbfsysFileStorageType_Controller */
