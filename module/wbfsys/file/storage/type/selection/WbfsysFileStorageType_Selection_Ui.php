 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFileStorageType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFileStorageType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileStorageType_Selection_Element
    (
      'selectionWbfsysFileStorageType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection file storage Types', 'wbfsys.file_storage_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.FileStorageType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysFileStorageType',
      'WbfsysFileStorageType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysFileStorageType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFileStorageType_Selection_Ui
