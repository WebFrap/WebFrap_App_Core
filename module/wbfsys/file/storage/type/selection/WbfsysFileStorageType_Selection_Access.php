 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFileStorageType_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_file_storage_type.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_file_storage_type') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_file_storage_type.rowid ",
      'acls'
    );
...
}//end class WbfsysFileStorageType_Selection_Access
