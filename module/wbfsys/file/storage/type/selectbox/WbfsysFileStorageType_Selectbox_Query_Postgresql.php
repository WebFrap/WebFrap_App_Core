 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysFileStorageType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_file_storage_type.rowid as id',
      'wbfsys_file_storage_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_file_storage_type.m_order as "wbfsys_file_storage_type-m_order-order"' );

    $criteria->from( 'wbfsys_file_storage_type' );



      $criteria->orderBy( 'wbfsys_file_storage_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_file_storage_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_file_storage_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysFileStorageType_Selectbox_Query_Postgresql
