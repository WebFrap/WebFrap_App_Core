 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFileStorageType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FileStorageType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileStorageType.insert';
    $params->formId       = 'wgt-form-wbfsys_file_storage_type';
    $params->namespace   = 'wbfsys_file_storage_type-create';
    ...
    $this->setTemplate( 'wbfsys/file_storage_type/modal/crud/form_create' );
...
}//end class WbfsysFileStorageType_Crud_Create_Modal_View
