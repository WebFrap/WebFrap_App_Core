 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysFileStorageType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysFileStorageType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysFileStorageType_Entity */
      $entity = $orm->get( 'WbfsysFileStorageType', $rootId );
    }
...
}//end class WbfsysFileStorageType_Crud_Access_Root
