 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysFileStorageType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new file storage Type',
      'wbfsys.file_storage_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New file storage Type',
      'wbfsys.file_storage_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_file_storage_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/file_storage_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileStorageType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_file_storage_type';
    ...
    $form = $this->newForm( 'WbfsysFileStorageType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.FileStorageType.create');}});
});
...
}//end class WbfsysFileStorageType_Crud_Create_Maintab_View
