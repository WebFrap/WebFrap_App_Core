 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysFileStorageType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileStorageType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit file storage Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileStorageType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysFileStorageType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileStorageType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_storage_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_storage_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysFileStorageType_Crud_Edit' );
...
}//end class WbfsysFileStorageType_Crud_Edit_Maintab_View
