 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_file_storage_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_file_storage_type.{$fieldName}
...
}//end class WbfsysFileStorageType_Filter
