 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_file_storage_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysFileStorageTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysFileStorageTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysFileStorageTypeI18n';
   ...
   *
   * @var WbfsysFileStorageTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysFileStorageTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysFileStorageTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysFileStorageTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.file_storage_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_file_storage_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_file_storage_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysFileStorageType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysFileStorageType not exists' );

      Log::warn('Looks like the Entity: WbfsysFileStorageType is missing');
      ...
      //p: Window
      $objidWbfsysFileStorageType = $this->entity->getData('id_wbfsys_file_storage_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysFileStorageType
          || !$entityWbfsysFileStorageType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysFileStorageType = $this->db->orm->newEntity( 'WbfsysFileStorageType' );
      }

      $inputIdWbfsysFileStorageType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysFileStorageType', 'Window' );
      $inputIdWbfsysFileStorageType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_file_storage_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_file_storage_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys File Storage Type (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysFileStorageType->assignedForm = $this->assignedForm;

      $inputIdWbfsysFileStorageType->setWidth( 'medium' );

      $inputIdWbfsysFileStorageType->setData( $this->entity->getData( 'id_wbfsys_file_storage_type' )  );
      $inputIdWbfsysFileStorageType->setReadOnly( $this->isReadOnly( 'id_wbfsys_file_storage_type' ) );
      $inputIdWbfsysFileStorageType->setLabel( $this->view->i18n->l( 'Wbfsys File Storage Type', 'wbfsys.file_storage_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.FileStorageType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_file_storage_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysFileStorageType->setListUrl ( $listUrl );
      $inputIdWbfsysFileStorageType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysFileStorageType->setEntityUrl( 'maintab.php?c=Wbfsys.FileStorageType.edit' );
      $inputIdWbfsysFileStorageType->conEntity         = $entityWbfsysFileStorageType;
      $inputIdWbfsysFileStorageType->refresh           = $this->refresh;
      $inputIdWbfsysFileStorageType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysFileStorageType->view = $this->view;
      $inputIdWbfsysFileStorageType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_file_storage_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysFileStorageType );
  ...
  }//end public function input_id_wbfsys_file_storage_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.file_storage_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.file_storage_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.file_storage_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.file_storage_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.file_storage_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.file_storage_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.file_storage_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.file_storage_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.file_storage_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (File Storage Type I18n)', 'wbfsys.file_storage_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_storage_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_storage_type_i18n_m_role_change';
...
}//end class WbfsysFileStorageTypeI18n_Form */
