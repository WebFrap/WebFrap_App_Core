 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_file_storage_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysFileStorageType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileStorageType_Acl_Dset' );
    /* @var $query WbfsysFileStorageType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileStorageType_Acl_Dset_Treetable' );
    /* @var $query WbfsysFileStorageType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysFileStorageType_Acl_Dset_Model */
