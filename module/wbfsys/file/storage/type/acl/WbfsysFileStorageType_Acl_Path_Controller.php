 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_file_storage_type_acl_graph', 
      'WbfsysFileStorageType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysFileStorageType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysFileStorageType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysFileStorageType_Acl_Path_Maintab_View  */
...
} // end class WbfsysFileStorageType_Acl_Path_Controller */
