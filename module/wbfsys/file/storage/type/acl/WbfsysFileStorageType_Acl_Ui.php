 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysFileStorageType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileStorageType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL file storage Type', 
        'wbfsys.file_storage_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_file_storage_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'file storage Type', 'wbfsys.file_storage_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_file_storage_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysFileStorageType_Acl_Table'
    );
...
} // end class WbfsysFileStorageType_Acl_Ui */
