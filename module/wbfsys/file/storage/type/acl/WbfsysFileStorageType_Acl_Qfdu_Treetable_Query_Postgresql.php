 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_file_storage_type.name as "wbfsys_file_storage_type_name"',
      'wbfsys_file_storage_type.rowid as "wbfsys_file_storage_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_file_storage_type on wbfsys_group_users.vid = wbfsys_file_storage_type.rowid'
    );
...
} // end class WbfsysFileStorageType_Acl_Qfdu_Treetable_Query_Postgresql */
