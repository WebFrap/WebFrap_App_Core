 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysFileStorageType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_file_storage_type-acl-qfdu-aAjax',
      'WbfsysFileStorageType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysFileStorageType_Acl_Qfdu_Controller */
