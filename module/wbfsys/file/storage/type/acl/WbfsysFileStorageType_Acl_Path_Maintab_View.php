 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/file_storage_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'file storage Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_file_storage_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_file_storage_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysFileStorageType_Acl_Path_Maintab_View */
