 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysFileStorageType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.FileStorageType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_storage_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.FileStorageType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_file_storage_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/file_storage_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'file storage Type', 'wbfsys.file_storage_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_file_storage_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysFileStorageType_Acl' );
...
} // end class WbfsysFileStorageType_Acl_Maintab_View */
