 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_file_storage_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysFileStorageType = $orm->get('WbfsysFileStorageType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_file_storage_type_name']  = $refEntityWbfsysFileStorageType->name;

    }
    $tabData['wbfsys_file_storage_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysFileStorageType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileStorageType_Acl' );
    /* @var $query WbfsysFileStorageType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileStorageType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysFileStorageType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileStorageType_Acl_Qfdu' );
    /* @var $query WbfsysFileStorageType_Acl_Qfdu_Query  */
...
} // end class WbfsysFileStorageType_Acl_Qfdu_Model */
