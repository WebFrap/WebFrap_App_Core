 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysFileStorageType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysFileStorageType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_file_storage_type_acl_listing',
      'WbfsysFileStorageType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysFileStorageType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysFileStorageType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysFileStorageType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_file_storage_type-acl',
    	'WbfsysFileStorageType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_file_storage_type_acl_masks_listing',
      'WbfsysFileStorageType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysFileStorageType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysFileStorageType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysFileStorageType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysFileStorageType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysFileStorageType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysFileStorageType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_file_storage_type-acl-qfdu',
    	'WbfsysFileStorageType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysFileStorageType_Acl_Controller */
