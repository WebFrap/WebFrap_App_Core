 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysFileStorageType_Acl_Dset' );
    ...
    $entityWbfsysFileStorageType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysFileStorageType_Acl_Dset_Ajax_View */
