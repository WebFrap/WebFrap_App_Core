 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysFileStorageType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysFileStorageType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysFileStorageType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysFileStorageType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_file_storage_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'file storage Type "{@label@}" User Access',
        'wbfsys.file_storage_type.label',
        array
        (
          'label' => $entityWbfsysFileStorageType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_file_storage_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysFileStorageType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysFileStorageType_Acl_Dset_Ui */
