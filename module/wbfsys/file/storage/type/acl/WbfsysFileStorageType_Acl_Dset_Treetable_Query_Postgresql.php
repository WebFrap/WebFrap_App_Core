 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_file_storage_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysFileStorageType_Acl_Dset_Treetable_Query_Postgresql */
