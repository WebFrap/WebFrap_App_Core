 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysFileStorageType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysFileStorageType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysFileStorageType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysFileStorageType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_file_storage_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysFileStorageType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_file_storage_type-acl-dset', 
    	'WbfsysFileStorageType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysFileStorageType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_file_storage_type-acl-dset', 
    	'WbfsysFileStorageType_Acl_Dset',
...
} // end class WbfsysFileStorageType_Acl_Dset_Controller */
