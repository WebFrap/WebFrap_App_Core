 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorageType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysFileStorageType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysFileStorageType_Export_Listing_Access';
    ...
    // create a new WbfsysFileStorageType window
    $view = $this->loadView
    (
    	'export-wbfsys_file_storage_type',
    	'WbfsysFileStorageType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysFileStorageType_Export' );
...
} // end class WbfsysFileStorageType_Export_Controller_Genf
