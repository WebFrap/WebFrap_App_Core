 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für File Storages
  *
  ...
  *  }
  *
  * @return WbfsysFileStorage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileStorage_Table_Element( 'tableWbfsysFileStorage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_storage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'File Storages', 'wbfsys.file_storage.label' );
      //$tabPanel->searchKey = 'wbfsys_file_storage';
      ...
      $searchElement->searchKey = 'wbfsys_file_storage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFileStorage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFileStorage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFileStorage listing maske
   *
   * @param WbfsysFileStorage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFileStorage  = $model->getEntityWbfsysFileStorage();
    ...
    $formWbfsysFileStorage->setKeyName( 'wbfsys_file_storage' );
...
}//end class WbfsysFileStorage_Table_Ui
