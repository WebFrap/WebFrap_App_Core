 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_file_storage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFileStorage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FileStorage.show&amp;target_mask=WbfsysFileStorage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FileStorage.edit&amp;target_mask=WbfsysFileStorage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file_storage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FileStorage.delete&amp;target_mask=WbfsysFileStorage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file_storage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.file_storage.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.file_storage.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Link', 'wbfsys.file_storage.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.file_storage.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_file_storage_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.FileStorage.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_file_storage_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.FileStorageType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_file_storage_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" style="text-align:center;" >'.( trim( $row['wbfsys_file_storage_link'] ) == '' ? ' ' : '<a href="'.Wgt::renderUrl($row['wbfsys_file_storage_link']).'">'.Validator::sanitizeHtml($row['wbfsys_file_storage_link']).'</a>' ).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_file_storage_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.FileStorage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected File Storages." >{$iconDelete} Delete selected File Storages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! File Storages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.FileStorage_Multi.deleteAll" >{$iconClean} Delete all File Storages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFileStorage_Table_Element
