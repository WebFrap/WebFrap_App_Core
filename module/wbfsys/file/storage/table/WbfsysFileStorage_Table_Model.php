 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_file_storage']->id_type )
    {
      $valWbfsysFileStorageType = $orm->getField
      (
        'WbfsysFileStorageType',
        'rowid = '.$data['wbfsys_file_storage']->id_type,
        'name'
      );
      $tabData['wbfsys_file_storage_type_name'] = $valWbfsysFileStorageType;
    }
    else
    {
      // else just set an empty string, fastest way ;-)
      $tabData['wbfsys_file_storage_type_name'] = '';
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysFileStorage_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysFileStorage_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysFileStorage_Table_Model
