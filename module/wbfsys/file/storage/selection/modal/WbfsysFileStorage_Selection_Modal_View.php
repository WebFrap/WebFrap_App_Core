 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysFileStorage_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysFileStorage_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/file_storage/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'File Storage', 'wbfsys.file_storage.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.FileStorage.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_file_storage-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysFileStorage_Selection' );
...
}//end class WbfsysFileStorage_Selection_Modal_View
