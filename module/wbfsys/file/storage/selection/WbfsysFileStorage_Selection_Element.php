 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_file_storage';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FileStorage.show&amp;target_mask=WbfsysFileStorage&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FileStorage.edit&amp;target_mask=WbfsysFileStorage&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.file_storage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FileStorage.delete&amp;target_mask=WbfsysFileStorage&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.file_storage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_file_storage_name'])).'</td>'.NL;
...
}//end class WbfsysFileStorage_Selection_Element
