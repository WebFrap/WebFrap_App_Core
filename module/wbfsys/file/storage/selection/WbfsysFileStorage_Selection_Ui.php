 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFileStorage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFileStorage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileStorage_Selection_Element
    (
      'selectionWbfsysFileStorage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection File Storages', 'wbfsys.file_storage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.FileStorage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysFileStorage',
      'WbfsysFileStorage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysFileStorage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFileStorage_Selection_Ui
