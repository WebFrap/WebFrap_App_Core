 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFileStorage_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_file_storage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_file_storage.rowid ",
      'acls'
    );
...
}//end class WbfsysFileStorage_Selection_Access
