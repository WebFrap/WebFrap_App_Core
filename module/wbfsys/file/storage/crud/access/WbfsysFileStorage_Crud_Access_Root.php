 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysFileStorage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysFileStorage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysFileStorage_Entity */
      $entity = $orm->get( 'WbfsysFileStorage', $rootId );
    }
...
}//end class WbfsysFileStorage_Crud_Access_Root
