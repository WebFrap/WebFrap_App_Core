 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysFileStorage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileStorage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit File Storage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileStorage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysFileStorage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileStorage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_storage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_storage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysFileStorage_Crud_Edit' );
...
}//end class WbfsysFileStorage_Crud_Edit_Maintab_View
