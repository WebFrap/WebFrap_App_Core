 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFileStorage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FileStorage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileStorage.insert';
    $params->formId       = 'wgt-form-wbfsys_file_storage';
    $params->namespace   = 'wbfsys_file_storage-create';
    ...
    $this->setTemplate( 'wbfsys/file_storage/modal/crud/form_create' );
...
}//end class WbfsysFileStorage_Crud_Create_Modal_View
