 ...
 * @licence WebFrap.net
 */
class WbfsysFileStorage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysFileStorage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_file_storage-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/file_storage/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileStorage.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_file_storage';
    ...
    $form = $this->newForm( 'WbfsysFileStorage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.FileStorage.create');}});
});
...
}//end class WbfsysFileStorage_Crud_Create_Maintab_View
