 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.FileType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.FileType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_file_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/file_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'file Type', 'wbfsys.file_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_file_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysFileType_Acl' );
...
} // end class WbfsysFileType_Acl_Maintab_View */
