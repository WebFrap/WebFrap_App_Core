 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_file_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysFileType_Acl_Dset_Treetable_Query_Postgresql */
