 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_file_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysFileType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileType_Acl_Dset' );
    /* @var $query WbfsysFileType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileType_Acl_Dset_Treetable' );
    /* @var $query WbfsysFileType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysFileType_Acl_Dset_Model */
