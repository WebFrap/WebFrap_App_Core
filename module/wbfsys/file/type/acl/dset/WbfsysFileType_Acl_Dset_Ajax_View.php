 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysFileType_Acl_Dset' );
    ...
    $entityWbfsysFileType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysFileType_Acl_Dset_Ajax_View */
