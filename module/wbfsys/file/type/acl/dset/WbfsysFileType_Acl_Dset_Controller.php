 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysFileType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysFileType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysFileType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysFileType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_file_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysFileType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysFileType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_file_type-acl-dset', 
    	'WbfsysFileType_Acl_Dset',
...
} // end class WbfsysFileType_Acl_Dset_Controller */
