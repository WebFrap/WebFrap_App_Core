 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysFileType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysFileType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysFileType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysFileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_file_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'file Type "{@label@}" User Access',
        'wbfsys.file_type.label',
        array
        (
          'label' => $entityWbfsysFileType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_file_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysFileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysFileType_Acl_Dset_Ui */
