...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysFileType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_file_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'file Type', 'wbfsys.file_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_file_type_acl';
...
} // end class WbfsysFileType_Acl_Ui */
