 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_file_type' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_file_type' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysFileType_Acl_Table' );
    /* @var $query WbfsysFileType_Acl_Table_Query  */
...
} // end class WbfsysFileType_Acl_Model */
