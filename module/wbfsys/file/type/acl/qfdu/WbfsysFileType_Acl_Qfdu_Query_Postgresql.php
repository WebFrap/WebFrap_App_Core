 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_file_type.name) like upper('{$safeVal}%') ";
    }
  ...
  SELECT
    ...
    wbfsys_file_type.name as label
  FROM
    wbfsys_file_type
  WHERE
    {$sqlWhere}
...
} // end class WbfsysFileType_Acl_Qfdu_Query_Postgresql */
