 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysFileType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_file_type-acl-qfdu-aAjax',
      'WbfsysFileType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysFileType_Acl_Qfdu_Controller */
