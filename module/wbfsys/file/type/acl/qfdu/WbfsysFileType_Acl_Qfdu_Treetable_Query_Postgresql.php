 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_file_type.name as "wbfsys_file_type_name"',
      'wbfsys_file_type.rowid as "wbfsys_file_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_file_type on wbfsys_group_users.vid = wbfsys_file_type.rowid'
    );
...
} // end class WbfsysFileType_Acl_Qfdu_Treetable_Query_Postgresql */
