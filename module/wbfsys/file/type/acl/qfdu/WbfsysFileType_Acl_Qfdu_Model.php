 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_file_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysFileType = $orm->get('WbfsysFileType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_file_type_name']  = $refEntityWbfsysFileType->name;

    }
    $tabData['wbfsys_file_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysFileType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileType_Acl' );
    /* @var $query WbfsysFileType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysFileType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysFileType_Acl_Qfdu' );
    /* @var $query WbfsysFileType_Acl_Qfdu_Query  */
...
} // end class WbfsysFileType_Acl_Qfdu_Model */
