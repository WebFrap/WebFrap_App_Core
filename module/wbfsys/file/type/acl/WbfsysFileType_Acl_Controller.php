 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysFileType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysFileType_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysFileType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysFileType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysFileType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_file_type-acl',
    	'WbfsysFileType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_file_type_acl_masks_listing',
      'WbfsysFileType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysFileType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysFileType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysFileType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysFileType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysFileType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysFileType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_file_type-acl-qfdu',
    	'WbfsysFileType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysFileType_Acl_Controller */
