 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFileType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFileType = $this->model->getEntityWbfsysFileType();
    ...
    (
      ...
      array( 'text' => $entityWbfsysFileType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FileType.show  &amp;objid='.$entityWbfsysFileType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FileType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_file_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/file_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFileType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.FileType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_file_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.FileType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.FileType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFileType_Crud_Show_Maintab_View
