 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysFileType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_file_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/file_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_file_type';
    ...
    $form = $this->newForm( 'WbfsysFileType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.FileType.create');}});
});
...
}//end class WbfsysFileType_Crud_Create_Maintab_View
