 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFileType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FileType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FileType.insert';
    $params->formId       = 'wgt-form-wbfsys_file_type';
    $params->namespace   = 'wbfsys_file_type-create';
    ...
    $this->setTemplate( 'wbfsys/file_type/modal/crud/form_create' );
...
}//end class WbfsysFileType_Crud_Create_Modal_View
