...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_file_type';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysFileType';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysFileType' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysFileType entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_m_order( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Order (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Order', 'wbfsys.file_type.label' ),
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (File Type)', 'wbfsys.file_type.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.file_type.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (File Type)', 'wbfsys.file_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.file_type.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.file_type.label' ),
  ...
  */
  public function input_mimetype( $params )
  {
      ...
      //tpl: class ui:text
      $inputMimetype = $this->view->newInput( 'input'.$this->prefix.'Mimetype' , 'Text' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Mimetype (File Type)', 'wbfsys.file_type.label' ),
      ...
      $inputMimetype->setLabel
      (
        $this->view->i18n->l( 'Mimetype', 'wbfsys.file_type.label' ),
        $this->entity->required( 'mimetype' )
      );
  ...
  * @return void
  */
  public function input_ending( $params )
  {

      //tpl: class ui:text
      $inputEnding = $this->view->newInput( 'input'.$this->prefix.'Ending' , 'Text' );
      $this->items['ending'] = $inputEnding;
      $inputEnding->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[ending]',
          'id'        => 'wgt-input-'.$this->keyName.'_ending'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Ending (File Type)', 'wbfsys.file_type.label' ),
          'maxlength' => $this->entity->maxSize( 'ending' ),
        )
      );
      $inputEnding->setWidth( 'medium' );

      $inputEnding->setReadOnly( $this->isReadOnly( 'ending' ) );
      $inputEnding->setData( $this->entity->getSecure('ending') );
      $inputEnding->setLabel
      (
        $this->view->i18n->l( 'Ending', 'wbfsys.file_type.label' ),
        $this->entity->required( 'ending' )
      );
  ...
  }//end public function input_ending */
  ...
  * @return void
  */
  public function input_id_mgmt( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysManagement_Entity' ) )
    {
      ...
      $inputIdMgmt = $this->view->newInput( 'input'.$this->prefix.'IdMgmt', 'Window' );
      $inputIdMgmt->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_mgmt]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_mgmt'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Mgmt (File Type)', 'wbfsys.file_type.label' ),
      ));
      ...
      $inputIdMgmt->setReadOnly( $this->isReadOnly( 'id_mgmt' ) );
      $inputIdMgmt->setLabel( $this->view->i18n->l( 'Mgmt', 'wbfsys.file_type.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Management.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_mgmt'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMgmt->buildJavascript( 'wgt-input-'.$this->keyName.'_id_mgmt'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_mgmt */
  ...
  * @return void
  */
  public function input_flag_global( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagGlobal = $this->view->newInput( 'input'.$this->prefix.'FlagGlobal' , 'Checkbox' );
      $this->items['flag_global'] = $inputFlagGlobal;
      $inputFlagGlobal->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_global]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_global'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Global (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      $inputFlagGlobal->setWidth( 'medium' );

      $inputFlagGlobal->setReadOnly( $this->isReadOnly( 'flag_global' ) );
      $inputFlagGlobal->setActive( $this->entity->getBoolean( 'flag_global' ) );
      $inputFlagGlobal->setLabel
      (
        $this->view->i18n->l( 'Global', 'wbfsys.file_type.label' ),
        $this->entity->required( 'flag_global' )
      );
  ...
  }//end public function input_flag_global */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.file_type.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (File Type)', 'wbfsys.file_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.file_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (File Type)', 'wbfsys.file_type.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.file_type.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (File Type)', 'wbfsys.file_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.file_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (File Type)', 'wbfsys.file_type.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.file_type.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.file_type.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.file_type.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (File Type)', 'wbfsys.file_type.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (File Type)', 'wbfsys.file_type.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (File Type)', 'wbfsys.file_type.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_type_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_type_m_role_change';
