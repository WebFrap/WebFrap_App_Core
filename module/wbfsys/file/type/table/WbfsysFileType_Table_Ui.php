...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für file Types
  *
  ...
  *  }
  *
  * @return WbfsysFileType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFileType_Table_Element( 'tableWbfsysFileType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_file_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'file Types', 'wbfsys.file_type.label' );
      //$tabPanel->searchKey = 'wbfsys_file_type';
      ...
      $searchElement->searchKey = 'wbfsys_file_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFileType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFileType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFileType listing maske
   *
   * @param WbfsysFileType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysFileType  = $model->getEntityWbfsysFileType();
    ...
    $formWbfsysFileType->setKeyName( 'wbfsys_file_type' );
...
}//end class WbfsysFileType_Table_Ui
