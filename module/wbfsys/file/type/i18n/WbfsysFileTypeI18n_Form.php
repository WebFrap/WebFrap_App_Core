...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_file_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysFileTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysFileTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysFileTypeI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysFileTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysFileTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysFileTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.file_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_file_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_file_type( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysFileType_Entity' ) )
    {
      ...
      //p: Window
      $objidWbfsysFileType = $this->entity->getData('id_wbfsys_file_type') ;
      ...
      $inputIdWbfsysFileType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysFileType', 'Window' );
      $inputIdWbfsysFileType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_file_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_file_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys File Type (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysFileType->assignedForm = $this->assignedForm;

      $inputIdWbfsysFileType->setWidth( 'medium' );

      $inputIdWbfsysFileType->setData( $this->entity->getData( 'id_wbfsys_file_type' )  );
      $inputIdWbfsysFileType->setReadOnly( $this->isReadOnly( 'id_wbfsys_file_type' ) );
      $inputIdWbfsysFileType->setLabel( $this->view->i18n->l( 'Wbfsys File Type', 'wbfsys.file_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.FileType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_file_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysFileType->setListUrl ( $listUrl );
      $inputIdWbfsysFileType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysFileType->setEntityUrl( 'maintab.php?c=Wbfsys.FileType.edit' );
      $inputIdWbfsysFileType->conEntity         = $entityWbfsysFileType;
      $inputIdWbfsysFileType->refresh           = $this->refresh;
      $inputIdWbfsysFileType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysFileType->view = $this->view;
      $inputIdWbfsysFileType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_file_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysFileType );
  ...
  }//end public function input_id_wbfsys_file_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.file_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.file_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.file_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.file_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.file_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.file_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.file_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.file_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.file_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (File Type I18n)', 'wbfsys.file_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_file_type_i18n_m_role_change';
...
}//end class WbfsysFileTypeI18n_Form */
