 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysFileType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysFileType_Export_Listing_Access';
    ...
    // create a new WbfsysFileType window
    $view = $this->loadView
    (
    	'export-wbfsys_file_type',
    	'WbfsysFileType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysFileType_Export' );
...
} // end class WbfsysFileType_Export_Controller_Genf
