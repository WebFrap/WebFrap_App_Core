 ...
 * @licence WebFrap.net
 */
class WbfsysFileType_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFileType_Selection_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_file_type') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_file_type.rowid ",
      'acls'
    );
...
}//end class WbfsysFileType_Selection_Access
