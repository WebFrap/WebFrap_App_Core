 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysPersonDuplicateSuspicion_'.$listType ) );
...
} // end class WbfsysPersonDuplicateSuspicion_Listing_Controller */
