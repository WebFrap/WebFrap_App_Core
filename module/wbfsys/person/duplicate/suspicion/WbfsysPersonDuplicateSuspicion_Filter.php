 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Filter
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
        ...
        AND filter_area_{$key}."acl-vid" = wbfsys_person_duplicate_suspicion.{$fieldName}
...
}//end class WbfsysPersonDuplicateSuspicion_Filter
