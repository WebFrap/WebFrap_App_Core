 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_person_duplicate_suspicion
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.PersonDuplicateSuspicion.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-create';

    $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Create( null, null, $this );
      ...
      (
        ...
        (
          ...
          (
            ...
            (
              'Person Duplicate',
              'wbfsys.person_duplicate_suspicion.label'
            )
          )
        ),
        Response::FORBIDDEN
    ...
    (
      'form-wbfsys_person_duplicate_suspicion-create',
      'WbfsysPersonDuplicateSuspicion_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysPersonDuplicateSuspicion_Crud_Model */
    $model = $this->loadModel( 'WbfsysPersonDuplicateSuspicion_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.PersonDuplicateSuspicion.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysPersonDuplicateSuspicion = $model->getEntityWbfsysPersonDuplicateSuspicion( $objid );

    // wenn null zurückgegeben wurde existiert der datensatz nicht
    // daher muss das System eine 404 Meldung zurückgeben
    if( !$entityWbfsysPersonDuplicateSuspicion )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Person Duplicate', 'wbfsys.person_duplicate_suspicion.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysPersonDuplicateSuspicion;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_person_duplicate_suspicion:edit';

    $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysPersonDuplicateSuspicion );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_person_duplicate_suspicion-edit-'.$objid,
      'WbfsysPersonDuplicateSuspicion_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_person_duplicate_suspicion:show';
    ...
    (
      'form-wbfsys_person_duplicate_suspicion-edit-'.$objid,
      'WbfsysPersonDuplicateSuspicion_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_person_duplicate_suspicion
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.PersonDuplicateSuspicion.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-insert';

    $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysPersonDuplicateSuspicion = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_person_duplicate_suspicion-update-'.$entityWbfsysPersonDuplicateSuspicion;
      ...
      {
        $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysPersonDuplicateSuspicion );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysPersonDuplicateSuspicion';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_person_duplicate_suspicion',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysPersonDuplicateSuspicion_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.PersonDuplicateSuspicion.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysPersonDuplicateSuspicion, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysPersonDuplicateSuspicion_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.PersonDuplicateSuspicion.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-delete-'.$objid;

    $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysPersonDuplicateSuspicion );
    ...
    $error = $model->delete( $entityWbfsysPersonDuplicateSuspicion, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysPersonDuplicateSuspicion, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.PersonDuplicateSuspicion.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.PersonDuplicateSuspicion.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-listing';
    ...
    $containerClass = 'WbfsysPersonDuplicateSuspicion_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_person_duplicate_suspicion',
      'WbfsysPersonDuplicateSuspicion_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysPersonDuplicateSuspicion_Table_Model */
    $model = $this->loadModel( 'WbfsysPersonDuplicateSuspicion_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysPersonDuplicateSuspicion
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysPersonDuplicateSuspicion_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_person_duplicate_suspicion',
      'WbfsysPersonDuplicateSuspicion_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysPersonDuplicateSuspicion_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.PersonDuplicateSuspicion.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysPersonDuplicateSuspicion_Selection_Model */
    $model   = $this->loadModel( 'WbfsysPersonDuplicateSuspicion_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_person_duplicate_suspicion-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_person_duplicate_suspicion-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_person_duplicate_suspicion',
      'WbfsysPersonDuplicateSuspicion',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysPersonDuplicateSuspicion, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysPersonDuplicateSuspicion_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysPersonDuplicateSuspicion_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_person_duplicate_suspicion-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysPersonDuplicateSuspicion_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysPersonDuplicateSuspicion, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_person_duplicate_suspicion' );
...
} // end class WbfsysPersonDuplicateSuspicion_Controller */
