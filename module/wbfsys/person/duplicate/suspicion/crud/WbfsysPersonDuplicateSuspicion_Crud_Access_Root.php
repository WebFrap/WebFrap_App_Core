 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysPersonDuplicateSuspicion_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysPersonDuplicateSuspicion_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysPersonDuplicateSuspicion_Entity */
      $entity = $orm->get( 'WbfsysPersonDuplicateSuspicion', $rootId );
    }
...
}//end class WbfsysPersonDuplicateSuspicion_Crud_Access_Root
