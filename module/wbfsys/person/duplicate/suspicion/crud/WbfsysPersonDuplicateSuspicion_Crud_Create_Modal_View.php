 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPersonDuplicateSuspicion entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.PersonDuplicateSuspicion.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PersonDuplicateSuspicion.insert';
    $params->formId       = 'wgt-form-wbfsys_person_duplicate_suspicion';
    $params->namespace   = 'wbfsys_person_duplicate_suspicion-create';
    ...
    $this->setTemplate( 'wbfsys/person_duplicate_suspicion/modal/crud/form_create' );
...
}//end class WbfsysPersonDuplicateSuspicion_Crud_Create_Modal_View
