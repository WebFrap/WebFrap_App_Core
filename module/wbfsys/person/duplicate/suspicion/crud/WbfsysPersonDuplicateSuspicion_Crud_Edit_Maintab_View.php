 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysPersonDuplicateSuspicion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPersonDuplicateSuspicion = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Person Duplicate: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.PersonDuplicateSuspicion.edit&amp;utf8=✓&amp;objid='.$entityWbfsysPersonDuplicateSuspicion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.PersonDuplicateSuspicion.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_person_duplicate_suspicion-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/person_duplicate_suspicion/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysPersonDuplicateSuspicion_Crud_Edit' );
...
}//end class WbfsysPersonDuplicateSuspicion_Crud_Edit_Maintab_View
