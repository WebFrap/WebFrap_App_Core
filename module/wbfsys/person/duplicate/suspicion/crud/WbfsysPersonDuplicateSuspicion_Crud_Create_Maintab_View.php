 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysPersonDuplicateSuspicion Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_person_duplicate_suspicion-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/person_duplicate_suspicion/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PersonDuplicateSuspicion.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_person_duplicate_suspicion';
    ...
    $form = $this->newForm( 'WbfsysPersonDuplicateSuspicion_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.PersonDuplicateSuspicion.create');}});
});
...
}//end class WbfsysPersonDuplicateSuspicion_Crud_Create_Maintab_View
