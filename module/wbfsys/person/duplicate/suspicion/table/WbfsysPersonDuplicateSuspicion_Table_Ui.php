 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Person Duplicates
  *
  ...
  *  }
  *
  * @return WbfsysPersonDuplicateSuspicion_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPersonDuplicateSuspicion_Table_Element( 'tableWbfsysPersonDuplicateSuspicion', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_person_duplicate_suspicion-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Person Duplicates', 'wbfsys.person_duplicate_suspicion.label' );
      //$tabPanel->searchKey = 'wbfsys_person_duplicate_suspicion';
      ...
      $searchElement->searchKey = 'wbfsys_person_duplicate_suspicion';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPersonDuplicateSuspicion_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPersonDuplicateSuspicion', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysPersonDuplicateSuspicion listing maske
   *
   * @param WbfsysPersonDuplicateSuspicion_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysPersonDuplicateSuspicion  = $model->getEntityWbfsysPersonDuplicateSuspicion();
    ...
    $formWbfsysPersonDuplicateSuspicion->setKeyName( 'wbfsys_person_duplicate_suspicion' );
...
}//end class WbfsysPersonDuplicateSuspicion_Table_Ui
