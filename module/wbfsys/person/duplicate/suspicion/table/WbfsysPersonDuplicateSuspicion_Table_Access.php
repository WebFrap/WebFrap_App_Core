 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysPersonDuplicateSuspicion_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_person_duplicate_suspicion.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_person_duplicate_suspicion.rowid ",
      'acls'
    );
...
}//end class WbfsysPersonDuplicateSuspicion_Table_Access
