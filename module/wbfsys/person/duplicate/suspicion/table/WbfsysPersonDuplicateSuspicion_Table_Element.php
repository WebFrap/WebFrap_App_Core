 ...
 * @licence WebFrap.net
 */
class WbfsysPersonDuplicateSuspicion_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_person_duplicate_suspicion';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysPersonDuplicateSuspicion_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.PersonDuplicateSuspicion.show&amp;target_mask=WbfsysPersonDuplicateSuspicion&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.PersonDuplicateSuspicion.edit&amp;target_mask=WbfsysPersonDuplicateSuspicion&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.person_duplicate_suspicion.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.PersonDuplicateSuspicion.delete&amp;target_mask=WbfsysPersonDuplicateSuspicion&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.person_duplicate_suspicion.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Propability', 'wbfsys.person_duplicate_suspicion.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_person_duplicate_suspicion_rowid'];
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_person_duplicate_suspicion_id_propability']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.PersonDuplicateSuspicion_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Person Duplicates." >{$iconDelete} Delete selected Person Duplicates</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Person Duplicates. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.PersonDuplicateSuspicion_Multi.deleteAll" >{$iconClean} Delete all Person Duplicates</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysPersonDuplicateSuspicion_Table_Element
