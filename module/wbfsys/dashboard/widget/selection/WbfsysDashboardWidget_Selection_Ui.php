 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDashboardWidget_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDashboardWidget_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDashboardWidget_Selection_Element
    (
      'selectionWbfsysDashboardWidget',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Dashboard Widgets', 'wbfsys.dashboard_widget.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DashboardWidget.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDashboardWidget',
      'WbfsysDashboardWidget_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDashboardWidget_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDashboardWidget_Selection_Ui
