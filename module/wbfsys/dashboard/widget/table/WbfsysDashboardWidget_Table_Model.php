 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysDashboardWidget_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysDashboardWidget_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysDashboardWidget_Table_Model
