 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_dashboard_widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DashboardWidget.show&amp;target_mask=WbfsysDashboardWidget&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DashboardWidget.edit&amp;target_mask=WbfsysDashboardWidget&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.dashboard_widget.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DashboardWidget.delete&amp;target_mask=WbfsysDashboardWidget&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.dashboard_widget.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DashboardWidget_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Dashboard Widgets." >{$iconDelete} Delete selected Dashboard Widgets</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Dashboard Widgets. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DashboardWidget_Multi.deleteAll" >{$iconClean} Delete all Dashboard Widgets</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDashboardWidget_Table_Element
