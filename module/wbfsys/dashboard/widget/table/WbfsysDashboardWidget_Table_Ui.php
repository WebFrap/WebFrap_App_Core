 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Dashboard Widgets
  *
  ...
  *  }
  *
  * @return WbfsysDashboardWidget_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDashboardWidget_Table_Element( 'tableWbfsysDashboardWidget', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Dashboard Widgets', 'wbfsys.dashboard_widget.label' );
      //$tabPanel->searchKey = 'wbfsys_dashboard_widget';
      ...
      $searchElement->searchKey = 'wbfsys_dashboard_widget';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDashboardWidget_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDashboardWidget', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDashboardWidget listing maske
   *
   * @param WbfsysDashboardWidget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDashboardWidget_Table_Ui
