 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysDashboardWidget_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysDashboardWidget_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/dashboard_widget/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.DashboardWidget.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DashboardWidget.search';

    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_dashboard_widget-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysDashboardWidget_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.DashboardWidget.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.DashboardWidget.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.DashboardWidget.create&amp;ltype=table');
    });
...
}//end class WbfsysDashboardWidget_Table_Maintab_View
