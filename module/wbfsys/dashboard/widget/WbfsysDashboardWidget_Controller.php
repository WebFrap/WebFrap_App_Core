 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_dashboard_widget
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.DashboardWidget.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_dashboard_widget-create';

    $access = new WbfsysDashboardWidget_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_dashboard_widget-create',
      'WbfsysDashboardWidget_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysDashboardWidget_Crud_Model */
    $model = $this->loadModel( 'WbfsysDashboardWidget_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.DashboardWidget.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysDashboardWidget = $model->getEntityWbfsysDashboardWidget( $objid );
    ...
    if( !$entityWbfsysDashboardWidget )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Dashboard Widget', 'wbfsys.dashboard_widget.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysDashboardWidget;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_dashboard_widget:edit';

    $access = new WbfsysDashboardWidget_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysDashboardWidget );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_dashboard_widget-edit-'.$objid,
      'WbfsysDashboardWidget_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_dashboard_widget:show';
    ...
    (
      'form-wbfsys_dashboard_widget-edit-'.$objid,
      'WbfsysDashboardWidget_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_dashboard_widget
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.DashboardWidget.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-insert';

    $access = new WbfsysDashboardWidget_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysDashboardWidget = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_dashboard_widget-update-'.$entityWbfsysDashboardWidget;
      ...
      {
        $access = new WbfsysDashboardWidget_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysDashboardWidget );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysDashboardWidget';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_dashboard_widget',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysDashboardWidget_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.DashboardWidget.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysDashboardWidget, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysDashboardWidget_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.DashboardWidget.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-delete-'.$objid;

    $access = new WbfsysDashboardWidget_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysDashboardWidget );
    ...
    $error = $model->delete( $entityWbfsysDashboardWidget, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysDashboardWidget, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.DashboardWidget.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.DashboardWidget.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-listing';
    ...
    $containerClass = 'WbfsysDashboardWidget_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_dashboard_widget',
      'WbfsysDashboardWidget_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysDashboardWidget_Table_Model */
    $model = $this->loadModel( 'WbfsysDashboardWidget_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_dashboard_widget-'.$params->ltype,
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysDashboardWidget
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysDashboardWidget_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_dashboard_widget',
      'WbfsysDashboardWidget_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysDashboardWidget_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.DashboardWidget.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysDashboardWidget_Selection_Model */
    $model   = $this->loadModel( 'WbfsysDashboardWidget_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_dashboard_widget-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_dashboard_widget-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_dashboard_widget',
      'WbfsysDashboardWidget',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysDashboardWidget, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysDashboardWidget_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysDashboardWidget_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_dashboard_widget-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysDashboardWidget_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysDashboardWidget, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_dashboard_widget' );
...
} // end class WbfsysDashboardWidget_Controller */
