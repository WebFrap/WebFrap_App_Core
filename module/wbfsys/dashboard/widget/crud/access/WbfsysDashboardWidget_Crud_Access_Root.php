 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDashboardWidget_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDashboardWidget_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDashboardWidget_Entity */
      $entity = $orm->get( 'WbfsysDashboardWidget', $rootId );
    }
...
}//end class WbfsysDashboardWidget_Crud_Access_Root
