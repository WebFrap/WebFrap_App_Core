 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDashboardWidget entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DashboardWidget.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DashboardWidget.insert';
    $params->formId       = 'wgt-form-wbfsys_dashboard_widget';
    $params->namespace   = 'wbfsys_dashboard_widget-create';
    ...
    $this->setTemplate( 'wbfsys/dashboard_widget/modal/crud/form_create' );
...
}//end class WbfsysDashboardWidget_Crud_Create_Modal_View
