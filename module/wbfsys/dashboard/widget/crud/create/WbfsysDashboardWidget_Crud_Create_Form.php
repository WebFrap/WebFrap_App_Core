 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysDashboardWidget_IdDashboard( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDashboard_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Dashboard.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDashboardWidget', array_keys( $this->fields['wbfsys_dashboard_widget']), true ),
...
}//end class WbfsysDashboardWidget_Crud_Create_Form */
