 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDashboardWidget Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDashboardWidget = $this->model->getEntityWbfsysDashboardWidget();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Dashboard Widget: {@text@}',
      'wbfsys.dashboard_widget.label',
      array( 'text' => $entityWbfsysDashboardWidget->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DashboardWidget.show  &amp;objid='.$entityWbfsysDashboardWidget
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DashboardWidget.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_dashboard_widget-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/dashboard_widget/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDashboardWidget_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DashboardWidget.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_dashboard_widget' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_dashboard_widget a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DashboardWidget.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DashboardWidget.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDashboardWidget_Crud_Show_Maintab_View
