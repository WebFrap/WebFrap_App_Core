 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDashboardWidget Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDashboardWidget = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Dashboard Widget: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DashboardWidget.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDashboardWidget
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DashboardWidget.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_dashboard_widget-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/dashboard_widget/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDashboardWidget_Crud_Edit' );
...
}//end class WbfsysDashboardWidget_Crud_Edit_Maintab_View
