 ...
 * @licence WebFrap.net
 */
class WbfsysDashboardWidget_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_dashboard_widget';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDashboardWidget';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDashboardWidget' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDashboardWidget entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
  ...
  * @return void
  */
  public function input_pos_x( $params )
  {

      //tpl: class ui:int
      $inputPosX = $this->view->newInput( 'input'.$this->prefix.'PosX' , 'Int' );
      $this->items['pos_x'] = $inputPosX;
      $inputPosX->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[pos_x]',
          'id'        => 'wgt-input-'.$this->keyName.'_pos_x'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Pos X (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      $inputPosX->setWidth( 'medium' );

      $inputPosX->setReadOnly( $this->isReadOnly( 'pos_x' ) );
      $inputPosX->setData( $this->entity->getData( 'pos_x' ) );
      $inputPosX->setLabel
      (
        $this->view->i18n->l( 'Pos X', 'wbfsys.dashboard_widget.label' ),
        $this->entity->required( 'pos_x' )
      );
  ...
  }//end public function input_pos_x */
  ...
  * @return void
  */
  public function input_pos_y( $params )
  {

      //tpl: class ui:int
      $inputPosY = $this->view->newInput( 'input'.$this->prefix.'PosY' , 'Int' );
      $this->items['pos_y'] = $inputPosY;
      $inputPosY->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[pos_y]',
          'id'        => 'wgt-input-'.$this->keyName.'_pos_y'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Pos Y (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      $inputPosY->setWidth( 'medium' );

      $inputPosY->setReadOnly( $this->isReadOnly( 'pos_y' ) );
      $inputPosY->setData( $this->entity->getData( 'pos_y' ) );
      $inputPosY->setLabel
      (
        $this->view->i18n->l( 'Pos Y', 'wbfsys.dashboard_widget.label' ),
        $this->entity->required( 'pos_y' )
      );
  ...
  }//end public function input_pos_y */
  ...
  * @return void
  */
  public function input_num_entries( $params )
  {

      //tpl: class ui:int
      $inputNumEntries = $this->view->newInput( 'input'.$this->prefix.'NumEntries' , 'Int' );
      $this->items['num_entries'] = $inputNumEntries;
      $inputNumEntries->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[num_entries]',
          'id'        => 'wgt-input-'.$this->keyName.'_num_entries'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Num Entries (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      $inputNumEntries->setWidth( 'medium' );

      $inputNumEntries->setReadOnly( $this->isReadOnly( 'num_entries' ) );
      $inputNumEntries->setData( $this->entity->getData( 'num_entries' ) );
      $inputNumEntries->setLabel
      (
        $this->view->i18n->l( 'Num Entries', 'wbfsys.dashboard_widget.label' ),
        $this->entity->required( 'num_entries' )
      );
  ...
  }//end public function input_num_entries */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
  ...
  * @return void
  */
  public function input_id_dashboard( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDashboard_Entity' ) )
    {
      ...
      $inputIdDashboard = $this->view->newInput( 'input'.$this->prefix.'IdDashboard', 'Window' );
      $inputIdDashboard->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_dashboard]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_dashboard'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Dashboard (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ));
      ...
      $inputIdDashboard->setReadOnly( $this->isReadOnly( 'id_dashboard' ) );
      $inputIdDashboard->setLabel( $this->view->i18n->l( 'Dashboard', 'wbfsys.dashboard_widget.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Dashboard.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_dashboard'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdDashboard->buildJavascript( 'wgt-input-'.$this->keyName.'_id_dashboard'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_dashboard */
  ...
  * @return void
  */
  public function input_id_widget( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMenuEntry_Entity' ) )
    {
      ...
      $inputIdWidget = $this->view->newInput( 'input'.$this->prefix.'IdWidget', 'Window' );
      $inputIdWidget->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_widget]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_widget'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Widget (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ));
      ...
      $inputIdWidget->setReadOnly( $this->isReadOnly( 'id_widget' ) );
      $inputIdWidget->setLabel( $this->view->i18n->l( 'Widget', 'wbfsys.dashboard_widget.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.MenuEntry.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_widget'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdWidget->buildJavascript( 'wgt-input-'.$this->keyName.'_id_widget'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_widget */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.dashboard_widget.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.dashboard_widget.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.dashboard_widget.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.dashboard_widget.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.dashboard_widget.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.dashboard_widget.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Dashboard Widget)', 'wbfsys.dashboard_widget.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.dashboard_widget.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_dashboard_widget_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_dashboard_widget_m_role_change';
...
}//end class WbfsysDashboardWidget_Form */
