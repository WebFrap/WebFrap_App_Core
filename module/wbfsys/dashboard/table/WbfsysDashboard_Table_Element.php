 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_dashboard';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDashboard_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Dashboard.show&amp;target_mask=WbfsysDashboard&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Dashboard.edit&amp;target_mask=WbfsysDashboard&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.dashboard.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Widgets',
            'modal.php?c=Wbfsys.Dashboard_Ref_Widgets.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.dashboard.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Dashboard.delete&amp;target_mask=WbfsysDashboard&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.dashboard.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_dashboard_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Dashboard_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Dashboards." >{$iconDelete} Delete selected Dashboards</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Dashboards. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Dashboard_Multi.deleteAll" >{$iconClean} Delete all Dashboards</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDashboard_Table_Element
