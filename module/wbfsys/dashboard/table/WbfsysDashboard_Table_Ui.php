 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Dashboards
  *
  ...
  *  }
  *
  * @return WbfsysDashboard_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDashboard_Table_Element( 'tableWbfsysDashboard', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_dashboard-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Dashboards', 'wbfsys.dashboard.label' );
      ...
      $searchElement->searchKey = 'wbfsys_dashboard';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDashboard_Table_Element( null,$view );
...
}//end class WbfsysDashboard_Table_Ui
