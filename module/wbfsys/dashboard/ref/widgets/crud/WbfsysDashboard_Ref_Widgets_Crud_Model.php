 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Ref_Widgets_Crud_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      if( !$entityWbfsysDashboardWidget = $this->getEntityWbfsysDashboardWidget() )
      {
        throw new Model_Exception
        (
          'Internal Error',
          'entityWbfsysDashboardWidget was not registered'
        );
      }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function checkUnique( $entity = null )
  {
    ...
    if(!$entity)
      $entity =  $this->getRegisterd('entityWbfsysDashboardWidget');
...
}//end class WbfsysDashboard_Ref_Widgets_Crud_Model
