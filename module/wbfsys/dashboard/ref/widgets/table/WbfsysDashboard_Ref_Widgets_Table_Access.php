 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Ref_Widgets_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_dashboard_widget Attributes: vid; pos_x; pos_y; num_entries; id_vid_entity; id_dashboard; id_widget; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-widgets' );
  ...
  /**
   * @param WbfsysDashboard_Ref_Widgets_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_dashboard_widget.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_dashboard_widget.rowid ",
      'acls'
    );
...
}//end class WbfsysDashboard_Ref_Widgets_Table_Access
