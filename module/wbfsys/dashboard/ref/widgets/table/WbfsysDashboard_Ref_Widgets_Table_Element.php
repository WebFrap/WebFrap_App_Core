 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Ref_Widgets_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_dashboard-widgets';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDashboardWidget_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysDashboard_Ref_Widgets';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DashboardWidget.show&amp;target_mask=WbfsysDashboard_Ref_Widgets&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DashboardWidget.edit&amp;target_mask=WbfsysDashboard_Ref_Widgets&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.dashboard_widget.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DashboardWidget.delete&amp;target_mask=WbfsysDashboard_Ref_Widgets&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.dashboard_widget.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_dashboard_widget_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.DashboardWidget.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_menu_entry_label'])).'</a></td>'.NL;
...
}//end class WbfsysDashboard_Ref_Widgets_Table_Element
