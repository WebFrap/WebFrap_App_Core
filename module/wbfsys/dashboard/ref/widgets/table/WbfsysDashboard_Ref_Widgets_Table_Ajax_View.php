 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Ref_Widgets_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Dashboard_Ref_Widgets.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysDashboard_Ref_Widgets_Table_Ajax_View
