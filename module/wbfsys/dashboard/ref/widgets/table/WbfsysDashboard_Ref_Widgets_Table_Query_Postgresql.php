 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Ref_Widgets_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_dashboard_widget_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_dashboard_widget.rowid as "wbfsys_dashboard_widget_rowid"', // variant:  
      'wbfsys_menu_entry.label as "wbfsys_menu_entry_label"', // variant:  
      'wbfsys_menu_entry.http_url as "wbfsys_menu_entry_http_url"', // variant:  
      'wbfsys_menu_entry.rowid as "wbfsys_menu_entry_rowid"', // variant:  
    );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_dashboard_widget.id_dashboard = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_dashboard_widget.id_dashboard = '.$condition );
        }
        else
        {
 ...
 /**
  ...
  public function checkConditions( $criteria, array $condition )
  {
    	...
    	if( isset($condition['ids']) && !empty( $condition['ids'] ) )
    	{
				$criteria->where
        (
          'wbfsys_dashboard_widget.rowid = IN( '. implode( ', ', $condition['ids'] ) .' ) ';
        );
    	}
 ...
 wbfsys_dashboard_widget.rowid = \''.$part.'\' 
      ...
      if( isset( $condition['wbfsys_menu_entry'] ) )
      {
        ...
        if( !$criteria->isJoined( 'wbfsys_menu_entry' ) )
        {
    ...
    (
      ...
      'wbfsys_menu_entry'
        ...
        if( isset( $whereCond['http_url']) && trim( $whereCond['http_url'] ) != ''  )
          $criteria->where( ' wbfsys_menu_entry.http_url = \''.$whereCond['http_url'].'\' ');
...
}//end class WbfsysDashboard_Ref_Widgets_Table_Query_Postgresql
