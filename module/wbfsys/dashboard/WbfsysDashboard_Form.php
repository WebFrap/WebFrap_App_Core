...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_dashboard';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDashboard';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDashboard' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDashboard entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_user( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for User (Dashboard)', 'wbfsys.dashboard.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.dashboard.label' ) );
  ...
  * @return void
  */
  public function input_layout( $params )
  {

      //tpl: class ui:text
      $inputLayout = $this->view->newInput( 'input'.$this->prefix.'Layout' , 'Text' );
      $this->items['layout'] = $inputLayout;
      $inputLayout->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[layout]',
          'id'        => 'wgt-input-'.$this->keyName.'_layout'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Layout (Dashboard)', 'wbfsys.dashboard.label' ),
          'maxlength' => $this->entity->maxSize( 'layout' ),
        )
      );
      $inputLayout->setWidth( 'medium' );

      $inputLayout->setReadOnly( $this->isReadOnly( 'layout' ) );
      $inputLayout->setData( $this->entity->getSecure('layout') );
      $inputLayout->setLabel
      (
        $this->view->i18n->l( 'Layout', 'wbfsys.dashboard.label' ),
        $this->entity->required( 'layout' )
      );
  ...
  }//end public function input_layout */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Dashboard)', 'wbfsys.dashboard.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.dashboard.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Dashboard)', 'wbfsys.dashboard.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.dashboard.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Dashboard)', 'wbfsys.dashboard.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.dashboard.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Dashboard)', 'wbfsys.dashboard.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.dashboard.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Dashboard)', 'wbfsys.dashboard.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.dashboard.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Dashboard)', 'wbfsys.dashboard.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.dashboard.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Dashboard)', 'wbfsys.dashboard.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.dashboard.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_dashboard_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_dashboard_m_role_change';
...
}//end class WbfsysDashboard_Form */
