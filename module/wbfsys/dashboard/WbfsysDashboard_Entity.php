 ...
 *
 * Entity Class for the Database Table wbfsys_dashboard
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_dashboard';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Dashboard.show';
  ...
  */
  public static $entityName  = 'WbfsysDashboard';
  ...
  */
  ...
  (
    'id_user' => array
    (
      'default' => 'wbfsys.dashboard.message.error_def_id_user',
      'wrong'   => 'wbfsys.dashboard.message.error_wrong_id_user',
      'max'     => 'wbfsys.dashboard.message.error_max_id_user',
      'min'     => 'wbfsys.dashboard.message.error_min_id_user',
    ),

    'layout' => array
    (
      'default' => 'wbfsys.dashboard.message.error_def_layout',
      'wrong'   => 'wbfsys.dashboard.message.error_wrong_layout',
      'max'     => 'wbfsys.dashboard.message.error_max_layout',
      'min'     => 'wbfsys.dashboard.message.error_min_layout',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.dashboard.message.error_def_rowid',
      'wrong'   => 'wbfsys.dashboard.message.error_wrong_rowid',
      'empty'   => 'wbfsys.dashboard.message.error_empty_rowid',
      'max'     => 'wbfsys.dashboard.message.error_max_rowid',
      'min'     => 'wbfsys.dashboard.message.error_min_rowid',
    ),
  );

}//end class WbfsysDashboard_Entity
