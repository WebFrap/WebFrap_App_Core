 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDashboard_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDashboard_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDashboard_Entity */
      $entity = $orm->get( 'WbfsysDashboard', $rootId );
    }
...
}//end class WbfsysDashboard_Crud_Access_Root
