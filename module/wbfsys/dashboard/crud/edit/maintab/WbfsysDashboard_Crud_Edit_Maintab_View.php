 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDashboard Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDashboard = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Dashboard.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDashboard
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Dashboard.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_dashboard-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/dashboard/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDashboard_Crud_Edit' );
...
}//end class WbfsysDashboard_Crud_Edit_Maintab_View
