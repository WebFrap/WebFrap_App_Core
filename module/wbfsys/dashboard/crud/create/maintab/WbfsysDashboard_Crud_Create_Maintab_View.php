 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDashboard Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_dashboard-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/dashboard/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Dashboard.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_dashboard';
    ...
    $form = $this->newForm( 'WbfsysDashboard_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Dashboard.create');}});
});
...
}//end class WbfsysDashboard_Crud_Create_Maintab_View
