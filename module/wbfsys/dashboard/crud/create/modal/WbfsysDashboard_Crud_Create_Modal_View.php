 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDashboard entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Dashboard.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Dashboard.insert';
    $params->formId       = 'wgt-form-wbfsys_dashboard';
    $params->namespace   = 'wbfsys_dashboard-create';
    ...
    $this->setTemplate( 'wbfsys/dashboard/modal/crud/form_create' );
...
}//end class WbfsysDashboard_Crud_Create_Modal_View
