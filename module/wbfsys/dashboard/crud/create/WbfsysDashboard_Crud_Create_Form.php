 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDashboard', array_keys( $this->fields['wbfsys_dashboard']), true ),
...
}//end class WbfsysDashboard_Crud_Create_Form */
