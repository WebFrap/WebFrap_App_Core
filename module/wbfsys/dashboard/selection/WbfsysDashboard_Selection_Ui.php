 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDashboard_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDashboard_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDashboard_Selection_Element
    (
      'selectionWbfsysDashboard',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Dashboards', 'wbfsys.dashboard.label' ) ;
      $tabPanel->searchKey = 'wbfsys_dashboard';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Dashboard.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDashboard',
      'WbfsysDashboard_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDashboard' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysDashboard listing maske
   *
   * @param WbfsysDashboard_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDashboard  = $model->getEntityWbfsysDashboard();
    ...
    $formWbfsysDashboard->setKeyName( 'wbfsys_dashboard' );
...
}//end class WbfsysDashboard_Selection_Ui
