 ...
 * @licence WebFrap.net
 */
class WbfsysDashboard_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDashboard_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_dashboard.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_dashboard.rowid ",
      'acls'
    );
...
}//end class WbfsysDashboard_Selection_Access
