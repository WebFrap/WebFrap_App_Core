 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_confidentiality_level
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.ConfidentialityLevel.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_confidentiality_level-create';

    $access = new WbfsysConfidentialityLevel_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_confidentiality_level-create',
      'WbfsysConfidentialityLevel_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysConfidentialityLevel_Crud_Model */
    $model = $this->loadModel( 'WbfsysConfidentialityLevel_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.ConfidentialityLevel.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysConfidentialityLevel = $model->getEntityWbfsysConfidentialityLevel( $objid );
    ...
    if( !$entityWbfsysConfidentialityLevel )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Confidentiality Level', 'wbfsys.confidentiality_level.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysConfidentialityLevel;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_confidentiality_level:edit';

    $access = new WbfsysConfidentialityLevel_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysConfidentialityLevel );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_confidentiality_level-edit-'.$objid,
      'WbfsysConfidentialityLevel_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_confidentiality_level:show';
    ...
    (
      'form-wbfsys_confidentiality_level-edit-'.$objid,
      'WbfsysConfidentialityLevel_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_confidentiality_level
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.ConfidentialityLevel.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-insert';

    $access = new WbfsysConfidentialityLevel_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysConfidentialityLevel = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_confidentiality_level-update-'.$entityWbfsysConfidentialityLevel;
      ...
      {
        $access = new WbfsysConfidentialityLevel_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysConfidentialityLevel );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysConfidentialityLevel';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_confidentiality_level',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysConfidentialityLevel_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.ConfidentialityLevel.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysConfidentialityLevel, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysConfidentialityLevel_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.ConfidentialityLevel.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-delete-'.$objid;

    $access = new WbfsysConfidentialityLevel_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysConfidentialityLevel );
    ...
    $error = $model->delete( $entityWbfsysConfidentialityLevel, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysConfidentialityLevel, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.ConfidentialityLevel.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.ConfidentialityLevel.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-listing';
    ...
    $containerClass = 'WbfsysConfidentialityLevel_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_confidentiality_level',
      'WbfsysConfidentialityLevel_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysConfidentialityLevel_Table_Model */
    $model = $this->loadModel( 'WbfsysConfidentialityLevel_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysConfidentialityLevel
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysConfidentialityLevel_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_confidentiality_level',
      'WbfsysConfidentialityLevel_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysConfidentialityLevel_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.ConfidentialityLevel.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysConfidentialityLevel_Selection_Model */
    $model   = $this->loadModel( 'WbfsysConfidentialityLevel_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_confidentiality_level-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_confidentiality_level-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_confidentiality_level',
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysConfidentialityLevel, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysConfidentialityLevel_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysConfidentialityLevel_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-text_by_key_'.$objid;
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_confidentiality_level-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_confidentiality_level-ajax', 
    	'WbfsysConfidentialityLevel',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_confidentiality_level' );
...
} // end class WbfsysConfidentialityLevel_Controller */
