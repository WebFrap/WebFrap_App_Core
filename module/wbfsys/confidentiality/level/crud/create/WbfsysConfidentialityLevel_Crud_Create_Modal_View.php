 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysConfidentialityLevel entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ConfidentialityLevel.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ConfidentialityLevel.insert';
    $params->formId       = 'wgt-form-wbfsys_confidentiality_level';
    $params->namespace   = 'wbfsys_confidentiality_level-create';
    ...
    $this->setTemplate( 'wbfsys/confidentiality_level/modal/crud/form_create' );
...
}//end class WbfsysConfidentialityLevel_Crud_Create_Modal_View
