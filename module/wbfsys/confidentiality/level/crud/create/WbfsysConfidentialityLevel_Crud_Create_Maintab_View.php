 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysConfidentialityLevel Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_confidentiality_level-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/confidentiality_level/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ConfidentialityLevel.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_confidentiality_level';
    ...
    $form = $this->newForm( 'WbfsysConfidentialityLevel_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ConfidentialityLevel.create');}});
});
...
}//end class WbfsysConfidentialityLevel_Crud_Create_Maintab_View
