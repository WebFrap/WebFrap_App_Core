 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysConfidentialityLevel_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysConfidentialityLevel_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysConfidentialityLevel_Entity */
      $entity = $orm->get( 'WbfsysConfidentialityLevel', $rootId );
    }
...
}//end class WbfsysConfidentialityLevel_Crud_Access_Root
