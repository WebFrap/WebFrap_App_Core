 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysConfidentialityLevel_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysConfidentialityLevel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysConfidentialityLevel = $this->model->getEntityWbfsysConfidentialityLevel();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Confidentiality Level: {@text@}',
      'wbfsys.confidentiality_level.label',
      array( 'text' => $entityWbfsysConfidentialityLevel->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Confidentiality Level: {@text@}',
      'wbfsys.confidentiality_level.label',
      array( 'text' => $entityWbfsysConfidentialityLevel->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ConfidentialityLevel.show  &amp;objid='.$entityWbfsysConfidentialityLevel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ConfidentialityLevel.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_confidentiality_level-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/confidentiality_level/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysConfidentialityLevel_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ConfidentialityLevel.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_confidentiality_level' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_confidentiality_level a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ConfidentialityLevel.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ConfidentialityLevel.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysConfidentialityLevel_Crud_Show_Maintab_View
