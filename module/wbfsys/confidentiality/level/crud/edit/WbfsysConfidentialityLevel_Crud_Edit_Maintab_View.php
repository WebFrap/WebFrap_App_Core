 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysConfidentialityLevel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysConfidentialityLevel = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Confidentiality Level: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ConfidentialityLevel.edit&amp;utf8=✓&amp;objid='.$entityWbfsysConfidentialityLevel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ConfidentialityLevel.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_confidentiality_level-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/confidentiality_level/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysConfidentialityLevel_Crud_Edit' );
...
}//end class WbfsysConfidentialityLevel_Crud_Edit_Maintab_View
