 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_confidentiality_level';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysConfidentialityLevel';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysConfidentialityLevel' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysConfidentialityLevel entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  public function input_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Label (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
      ...
      $inputLabel->setLabel
      (
        $this->view->i18n->l( 'Label', 'wbfsys.confidentiality_level.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.confidentiality_level.label' ),
  ...
  public function input_level( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Level (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
        )
      );
      ...
      $inputLevel->setLabel
      (
        $this->view->i18n->l( 'Level', 'wbfsys.confidentiality_level.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.confidentiality_level.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.confidentiality_level.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.confidentiality_level.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.confidentiality_level.label' ) );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Label (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
          'maxlength' => $this->entity->maxSize( 'label' ),
        )
      );
      $inputLabel->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Confidentiality Level)', 'wbfsys.confidentiality_level.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_confidentiality_level_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_confidentiality_level_m_role_change';
...
}//end class WbfsysConfidentialityLevel_Form */
