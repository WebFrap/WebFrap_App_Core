 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysConfidentialityLevel_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_confidentiality_level.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_confidentiality_level.rowid ",
      'acls'
    );
...
}//end class WbfsysConfidentialityLevel_Table_Access
