 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Confidentiality Levels
  *
  ...
  *  }
  *
  * @return WbfsysConfidentialityLevel_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysConfidentialityLevel_Table_Element( 'tableWbfsysConfidentialityLevel', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_confidentiality_level-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Confidentiality Levels', 'wbfsys.confidentiality_level.label' );
      //$tabPanel->searchKey = 'wbfsys_confidentiality_level';
      ...
      $searchElement->searchKey = 'wbfsys_confidentiality_level';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysConfidentialityLevel_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysConfidentialityLevel', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysConfidentialityLevel listing maske
   *
   * @param WbfsysConfidentialityLevel_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysConfidentialityLevel  = $model->getEntityWbfsysConfidentialityLevel();
    ...
    $formWbfsysConfidentialityLevel->setKeyName( 'wbfsys_confidentiality_level' );
...
}//end class WbfsysConfidentialityLevel_Table_Ui
