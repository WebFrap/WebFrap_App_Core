 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_confidentiality_level';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysConfidentialityLevel_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ConfidentialityLevel.show&amp;target_mask=WbfsysConfidentialityLevel&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ConfidentialityLevel.edit&amp;target_mask=WbfsysConfidentialityLevel&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.confidentiality_level.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ConfidentialityLevel.delete&amp;target_mask=WbfsysConfidentialityLevel&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.confidentiality_level.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.confidentiality_level.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.confidentiality_level.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.confidentiality_level.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_confidentiality_level_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ConfidentialityLevel.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_confidentiality_level_label'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_confidentiality_level_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_confidentiality_level_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ConfidentialityLevel_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Confidentiality Levels." >{$iconDelete} Delete selected Confidentiality Levels</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Confidentiality Levels. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ConfidentialityLevel_Multi.deleteAll" >{$iconClean} Delete all Confidentiality Levels</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysConfidentialityLevel_Table_Element
