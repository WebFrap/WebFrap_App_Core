 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysConfidentialityLevel_'.$listType ) );
...
} // end class WbfsysConfidentialityLevel_Listing_Controller */
