 ...
 * @licence WebFrap.net
 */
class WbfsysConfidentialityLevel_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysConfidentialityLevel Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_confidentiality_level.rowid as id',
      'wbfsys_confidentiality_level.label as value'
     ));
    ...
    $criteria->from( 'wbfsys_confidentiality_level' );
      ...
      $criteria->orderBy( 'wbfsys_confidentiality_level.label ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_confidentiality_level.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_confidentiality_level.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysConfidentialityLevel_Selectbox_Query_Postgresql
