 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_mandant';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysRoleMandant_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleMandant.show&amp;target_mask=WbfsysRoleMandant&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleMandant.edit&amp;target_mask=WbfsysRoleMandant&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_mandant.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleMandant.delete&amp;target_mask=WbfsysRoleMandant&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_mandant.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.role_mandant.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Inactive', 'wbfsys.role_mandant.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'No Cert required', 'wbfsys.role_mandant.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Profile', 'wbfsys.role_mandant.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_role_mandant_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleMandant.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_mandant_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" style="text-align:center;"  >'.WgtRndForm::checkbox( 'wbfsys_role_mandant[inactive]', $row['wbfsys_role_mandant_inactive'] , array() , true ).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:center;"  >'.WgtRndForm::checkbox( 'wbfsys_role_mandant[non_cert_login]', $row['wbfsys_role_mandant_non_cert_login'] , array() , true ).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.RoleMandant_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Mandants." >{$iconDelete} Delete selected Mandants</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Mandants. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.RoleMandant_Multi.deleteAll" >{$iconClean} Delete all Mandants</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleMandant_Table_Element
