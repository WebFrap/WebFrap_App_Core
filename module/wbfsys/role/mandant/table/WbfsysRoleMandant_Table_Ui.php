 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Mandants
  *
  ...
  *  }
  *
  * @return WbfsysRoleMandant_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleMandant_Table_Element( 'tableWbfsysRoleMandant', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_mandant-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Mandants', 'wbfsys.role_mandant.label' );
      //$tabPanel->searchKey = 'wbfsys_role_mandant';
      ...
      $searchElement->searchKey = 'wbfsys_role_mandant';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleMandant_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleMandant', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysRoleMandant listing maske
   *
   * @param WbfsysRoleMandant_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleMandant  = $model->getEntityWbfsysRoleMandant();
    ...
    $formWbfsysRoleMandant->setKeyName( 'wbfsys_role_mandant' );
...
}//end class WbfsysRoleMandant_Table_Ui
