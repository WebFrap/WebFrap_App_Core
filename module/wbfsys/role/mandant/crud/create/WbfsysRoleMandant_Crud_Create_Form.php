 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysRoleMandant', array_keys( $this->fields['wbfsys_role_mandant']), true ),
...
}//end class WbfsysRoleMandant_Crud_Create_Form */
