 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleMandant entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleMandant.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleMandant.insert';
    $params->formId       = 'wgt-form-wbfsys_role_mandant';
    $params->namespace   = 'wbfsys_role_mandant-create';
    ...
    $this->setTemplate( 'wbfsys/role_mandant/modal/crud/form_create' );
...
}//end class WbfsysRoleMandant_Crud_Create_Modal_View
