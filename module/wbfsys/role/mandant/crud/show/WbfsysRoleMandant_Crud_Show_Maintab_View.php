 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysRoleMandant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleMandant = $this->model->getEntityWbfsysRoleMandant();
    ...
    (
      ...
      array( 'text' => $entityWbfsysRoleMandant->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleMandant.show  &amp;objid='.$entityWbfsysRoleMandant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleMandant.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_mandant-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_mandant/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysRoleMandant_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.RoleMandant.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_role_mandant' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_role_mandant a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.RoleMandant.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.RoleMandant.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysRoleMandant_Crud_Show_Maintab_View
