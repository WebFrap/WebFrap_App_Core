 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRoleMandant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleMandant = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleMandant.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRoleMandant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleMandant.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_mandant-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_mandant/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRoleMandant_Crud_Edit' );
...
}//end class WbfsysRoleMandant_Crud_Edit_Maintab_View
