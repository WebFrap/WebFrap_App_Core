 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysRoleMandant_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysRoleMandant_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysRoleMandant_Entity */
      $entity = $orm->get( 'WbfsysRoleMandant', $rootId );
    }
...
}//end class WbfsysRoleMandant_Crud_Access_Root
