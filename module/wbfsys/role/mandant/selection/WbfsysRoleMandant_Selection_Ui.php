 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysRoleMandant_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysRoleMandant_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleMandant_Selection_Element
    (
      'selectionWbfsysRoleMandant',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Mandants', 'wbfsys.role_mandant.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.RoleMandant.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysRoleMandant',
      'WbfsysRoleMandant_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysRoleMandant_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysRoleMandant_Selection_Ui
