 ...
 * @licence WebFrap.net
 */
class WbfsysRoleMandant_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysRoleMandant_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_role_mandant.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_role_mandant.rowid ",
      'acls'
    );
...
}//end class WbfsysRoleMandant_Selection_Access
