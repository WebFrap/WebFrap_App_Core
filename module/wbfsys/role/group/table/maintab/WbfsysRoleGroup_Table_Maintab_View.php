 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysRoleGroup_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysRoleGroup_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_group/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.RoleGroup.listing&amp;ltype=table'
    );
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysRoleGroup_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.RoleGroup.create&amp;ltype=table');
    });
...
}//end class WbfsysRoleGroup_Table_Maintab_View
