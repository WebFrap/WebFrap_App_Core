 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_group';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysRoleGroup_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleGroup.show&amp;target_mask=WbfsysRoleGroup&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleGroup.edit&amp;target_mask=WbfsysRoleGroup&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_group.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Members',
            'modal.php?c=Wbfsys.RoleGroup_Ref_GroupUsers.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.role_group.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Profiles',
            'modal.php?c=Wbfsys.RoleGroup_Ref_GroupProfiles.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.role_group.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Access',
            'modal.php?c=Wbfsys.RoleGroup_Ref_Access.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.role_group.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleGroup.delete&amp;target_mask=WbfsysRoleGroup&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_group.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_role_group_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.RoleGroup_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected User Roles." >{$iconDelete} Delete selected User Roles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! User Roles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.RoleGroup_Multi.deleteAll" >{$iconClean} Delete all User Roles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleGroup_Table_Element
