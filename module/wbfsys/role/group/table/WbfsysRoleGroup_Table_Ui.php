 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für User Roles
  *
  ...
  *  }
  *
  * @return WbfsysRoleGroup_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroup_Table_Element( 'tableWbfsysRoleGroup', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_group-search';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleGroup_Table_Element( null,$view );
...
}//end class WbfsysRoleGroup_Table_Ui
