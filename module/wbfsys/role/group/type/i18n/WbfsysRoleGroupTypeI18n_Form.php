 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_role_group_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysRoleGroupTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysRoleGroupTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysRoleGroupTypeI18n';
   ...
   *
   * @var WbfsysRoleGroupTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysRoleGroupTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysRoleGroupTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysRoleGroupTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.role_group_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_role_group_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_role_group_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysRoleGroupType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysRoleGroupType not exists' );

      Log::warn('Looks like the Entity: WbfsysRoleGroupType is missing');
      ...
      //p: Window
      $objidWbfsysRoleGroupType = $this->entity->getData('id_wbfsys_role_group_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysRoleGroupType
          || !$entityWbfsysRoleGroupType = $this->db->orm->get
          (
            'WbfsysRoleGroupType',
            $objidWbfsysRoleGroupType
          )
      ...
      {
        $entityWbfsysRoleGroupType = $this->db->orm->newEntity( 'WbfsysRoleGroupType' );
      }

      $inputIdWbfsysRoleGroupType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysRoleGroupType', 'Window' );
      $inputIdWbfsysRoleGroupType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_role_group_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_role_group_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Role Group Type (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysRoleGroupType->assignedForm = $this->assignedForm;

      $inputIdWbfsysRoleGroupType->setWidth( 'medium' );

      $inputIdWbfsysRoleGroupType->setData( $this->entity->getData( 'id_wbfsys_role_group_type' )  );
      $inputIdWbfsysRoleGroupType->setReadOnly( $this->isReadOnly( 'id_wbfsys_role_group_type' ) );
      $inputIdWbfsysRoleGroupType->setLabel( $this->view->i18n->l( 'Wbfsys Role Group Type', 'wbfsys.role_group_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleGroupType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_role_group_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysRoleGroupType->setListUrl ( $listUrl );
      $inputIdWbfsysRoleGroupType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysRoleGroupType->setEntityUrl( 'maintab.php?c=Wbfsys.RoleGroupType.edit' );
      $inputIdWbfsysRoleGroupType->conEntity         = $entityWbfsysRoleGroupType;
      $inputIdWbfsysRoleGroupType->refresh           = $this->refresh;
      $inputIdWbfsysRoleGroupType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysRoleGroupType->view = $this->view;
      $inputIdWbfsysRoleGroupType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_role_group_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysRoleGroupType );
  ...
  }//end public function input_id_wbfsys_role_group_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.role_group_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.role_group_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.role_group_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.role_group_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.role_group_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.role_group_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.role_group_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.role_group_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.role_group_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Role Group Type I18n)', 'wbfsys.role_group_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_role_group_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_role_group_type_i18n_m_role_change';
...
}//end class WbfsysRoleGroupTypeI18n_Form */
