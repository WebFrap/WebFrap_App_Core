 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für role group Types
  *
  ...
  *  }
  *
  * @return WbfsysRoleGroupType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroupType_Table_Element( 'tableWbfsysRoleGroupType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_group_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'role group Types', 'wbfsys.role_group_type.label' );
      //$tabPanel->searchKey = 'wbfsys_role_group_type';
      ...
      $searchElement->searchKey = 'wbfsys_role_group_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleGroupType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleGroupType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysRoleGroupType listing maske
   *
   * @param WbfsysRoleGroupType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleGroupType  = $model->getEntityWbfsysRoleGroupType();
    ...
    $formWbfsysRoleGroupType->setKeyName( 'wbfsys_role_group_type' );
...
}//end class WbfsysRoleGroupType_Table_Ui
