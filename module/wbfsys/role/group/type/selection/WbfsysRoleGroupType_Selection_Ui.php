 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysRoleGroupType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysRoleGroupType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroupType_Selection_Element
    (
      'selectionWbfsysRoleGroupType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection role group Types', 'wbfsys.role_group_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.RoleGroupType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysRoleGroupType',
      'WbfsysRoleGroupType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysRoleGroupType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysRoleGroupType_Selection_Ui
