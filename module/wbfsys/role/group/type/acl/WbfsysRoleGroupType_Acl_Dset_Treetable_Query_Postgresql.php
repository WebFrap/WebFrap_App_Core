 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_role_group_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysRoleGroupType_Acl_Dset_Treetable_Query_Postgresql */
