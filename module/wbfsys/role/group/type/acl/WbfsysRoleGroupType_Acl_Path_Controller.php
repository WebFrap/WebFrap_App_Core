 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_role_group_type_acl_graph', 
      'WbfsysRoleGroupType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysRoleGroupType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysRoleGroupType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysRoleGroupType_Acl_Path_Maintab_View  */
...
} // end class WbfsysRoleGroupType_Acl_Path_Controller */
