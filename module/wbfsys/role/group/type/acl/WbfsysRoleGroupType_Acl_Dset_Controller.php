 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroupType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysRoleGroupType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysRoleGroupType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysRoleGroupType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_role_group_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysRoleGroupType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_role_group_type-acl-dset', 
    	'WbfsysRoleGroupType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysRoleGroupType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_role_group_type-acl-dset', 
    	'WbfsysRoleGroupType_Acl_Dset',
...
} // end class WbfsysRoleGroupType_Acl_Dset_Controller */
