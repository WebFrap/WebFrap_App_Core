 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_role_group_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysRoleGroupType = $orm->get('WbfsysRoleGroupType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_role_group_type_name']  = $refEntityWbfsysRoleGroupType->name;

    }
    $tabData['wbfsys_role_group_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysRoleGroupType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroupType_Acl' );
    /* @var $query WbfsysRoleGroupType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroupType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysRoleGroupType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroupType_Acl_Qfdu' );
    /* @var $query WbfsysRoleGroupType_Acl_Qfdu_Query  */
...
} // end class WbfsysRoleGroupType_Acl_Qfdu_Model */
