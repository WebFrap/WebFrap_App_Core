 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysRoleGroupType_Acl_Dset' );
    ...
    $entityWbfsysRoleGroupType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysRoleGroupType_Acl_Dset_Ajax_View */
