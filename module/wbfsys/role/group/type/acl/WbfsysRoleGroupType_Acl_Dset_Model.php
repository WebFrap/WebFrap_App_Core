 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_role_group_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysRoleGroupType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroupType_Acl_Dset' );
    /* @var $query WbfsysRoleGroupType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroupType_Acl_Dset_Treetable' );
    /* @var $query WbfsysRoleGroupType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysRoleGroupType_Acl_Dset_Model */
