 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysRoleGroupType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.RoleGroupType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_group_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.RoleGroupType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_role_group_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/role_group_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'role group Type', 'wbfsys.role_group_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_role_group_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysRoleGroupType_Acl' );
...
} // end class WbfsysRoleGroupType_Acl_Maintab_View */
