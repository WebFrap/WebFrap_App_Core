 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysRoleGroupType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysRoleGroupType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysRoleGroupType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysRoleGroupType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_role_group_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'role group Type "{@label@}" User Access',
        'wbfsys.role_group_type.label',
        array
        (
          'label' => $entityWbfsysRoleGroupType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_role_group_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysRoleGroupType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysRoleGroupType_Acl_Dset_Ui */
