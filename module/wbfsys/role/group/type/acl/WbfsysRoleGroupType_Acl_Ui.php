 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysRoleGroupType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroupType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_role_group_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'role group Type', 'wbfsys.role_group_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_role_group_type_acl';
...
} // end class WbfsysRoleGroupType_Acl_Ui */
