 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysRoleGroupType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysRoleGroupType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_role_group_type_acl_listing',
      'WbfsysRoleGroupType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysRoleGroupType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroupType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysRoleGroupType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_role_group_type-acl',
    	'WbfsysRoleGroupType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_role_group_type_acl_masks_listing',
      'WbfsysRoleGroupType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysRoleGroupType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysRoleGroupType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroupType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysRoleGroupType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysRoleGroupType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysRoleGroupType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_role_group_type-acl-qfdu',
    	'WbfsysRoleGroupType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysRoleGroupType_Acl_Controller */
