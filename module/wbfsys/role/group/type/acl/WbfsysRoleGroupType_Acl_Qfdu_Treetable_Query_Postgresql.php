 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_role_group_type.name as "wbfsys_role_group_type_name"',
      'wbfsys_role_group_type.rowid as "wbfsys_role_group_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_role_group_type on wbfsys_group_users.vid = wbfsys_role_group_type.rowid'
    );
...
} // end class WbfsysRoleGroupType_Acl_Qfdu_Treetable_Query_Postgresql */
