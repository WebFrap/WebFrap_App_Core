 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysRoleGroupType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_role_group_type-acl-qfdu-aAjax',
      'WbfsysRoleGroupType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysRoleGroupType_Acl_Qfdu_Controller */
