 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRoleGroupType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleGroupType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit role group Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleGroupType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRoleGroupType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleGroupType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_group_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_group_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRoleGroupType_Crud_Edit' );
...
}//end class WbfsysRoleGroupType_Crud_Edit_Maintab_View
