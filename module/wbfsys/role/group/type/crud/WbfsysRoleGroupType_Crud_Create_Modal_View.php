 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleGroupType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleGroupType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleGroupType.insert';
    $params->formId       = 'wgt-form-wbfsys_role_group_type';
    $params->namespace   = 'wbfsys_role_group_type-create';
    ...
    $this->setTemplate( 'wbfsys/role_group_type/modal/crud/form_create' );
...
}//end class WbfsysRoleGroupType_Crud_Create_Modal_View
