 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysRoleGroupType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleGroupType = $this->model->getEntityWbfsysRoleGroupType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show role group Type: {@text@}',
      'wbfsys.role_group_type.label',
      array( 'text' => $entityWbfsysRoleGroupType->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'role group Type: {@text@}',
      'wbfsys.role_group_type.label',
      array( 'text' => $entityWbfsysRoleGroupType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleGroupType.show  &amp;objid='.$entityWbfsysRoleGroupType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleGroupType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_group_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_group_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysRoleGroupType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.RoleGroupType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_role_group_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_role_group_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.RoleGroupType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.RoleGroupType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysRoleGroupType_Crud_Show_Maintab_View
