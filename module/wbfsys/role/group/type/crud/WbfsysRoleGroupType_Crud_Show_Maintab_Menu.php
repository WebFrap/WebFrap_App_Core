 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_role_group_type-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysRoleGroupType_Crud_Show_Maintab_Menu
