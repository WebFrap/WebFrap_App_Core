 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysRoleGroupType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysRoleGroupType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysRoleGroupType_Entity */
      $entity = $orm->get( 'WbfsysRoleGroupType', $rootId );
    }
...
}//end class WbfsysRoleGroupType_Crud_Access_Root
