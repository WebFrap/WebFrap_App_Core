 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysRoleGroupType_'.$listType ) );
...
} // end class WbfsysRoleGroupType_Listing_Controller */
