 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysRoleGroupType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysRoleGroupType_Export_Listing_Access';
    ...
    // create a new WbfsysRoleGroupType window
    $view = $this->loadView
    (
    	'export-wbfsys_role_group_type',
    	'WbfsysRoleGroupType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysRoleGroupType_Export' );
...
} // end class WbfsysRoleGroupType_Export_Controller_Genf
