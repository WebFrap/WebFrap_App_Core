 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroupType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysRoleGroupType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_role_group_type.rowid as id',
      'wbfsys_role_group_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_role_group_type.m_order as "wbfsys_role_group_type-m_order-order"' );

    $criteria->from( 'wbfsys_role_group_type' );



      $criteria->orderBy( 'wbfsys_role_group_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_role_group_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_role_group_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysRoleGroupType_Selectbox_Query_Postgresql
