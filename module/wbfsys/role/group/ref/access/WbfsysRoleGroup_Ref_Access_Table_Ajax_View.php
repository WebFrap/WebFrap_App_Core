 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_Access_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.RoleGroup_Ref_Access.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysRoleGroup_Ref_Access_Table_Ajax_View
