 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_Access_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleGroup_Ref_Access_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_role_group-ref-access';
    ...
    (
      $params->tabId,
      'WbfsysRoleGroup_Ref_Access_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleGroup_Ref_Access_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_group-ref-access-'.$listType.'-ajax',
    	'WbfsysRoleGroup_Ref_Access_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
} // end WbfsysRoleGroup_Ref_Access_Controller
