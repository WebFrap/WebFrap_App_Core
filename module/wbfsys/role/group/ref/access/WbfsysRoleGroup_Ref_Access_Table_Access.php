 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_Access_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_role_group-ref-access',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_role_group-ref-access' );
  ...
  /**
   * @param WbfsysRoleGroup_Ref_Access_Table_Query $query
...
}//end class WbfsysRoleGroup_Ref_Access_Table_Access
