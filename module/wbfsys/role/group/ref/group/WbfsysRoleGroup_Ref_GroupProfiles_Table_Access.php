 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupProfiles_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_group_profiles Attributes: id_group; id_profile; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_role_group-ref-group_profiles' );
  ...
  /**
   * @param WbfsysRoleGroup_Ref_GroupProfiles_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_group_profiles.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_group_profiles') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_group_profiles.rowid ",
      'acls'
    );
...
}//end class WbfsysRoleGroup_Ref_GroupProfiles_Table_Access
