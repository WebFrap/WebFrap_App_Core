 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupUsers_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_group-group_users';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysGroupUsers_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysRoleGroup_Ref_GroupUsers';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.GroupUsers.show&amp;target_mask=WbfsysRoleGroup_Ref_GroupUsers&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.GroupUsers.edit&amp;target_mask=WbfsysRoleGroup_Ref_GroupUsers&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.group_users.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.GroupUsers.delete&amp;target_mask=WbfsysRoleGroup_Ref_GroupUsers&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.group_users.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'E-Mail', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Mandant', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Inactive', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'No Cert required', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Profile', 'wbfsys.role_user.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Last Login', 'wbfsys.role_user.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.GroupUsers.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" style="text-align:center;" >'.( trim( $row['wbfsys_role_user_email'] ) == '' ? ' ' : '<a href="mailto:'.Validator::sanitizeHtml($row['wbfsys_role_user_email']).'">'.Validator::sanitizeHtml($row['wbfsys_role_user_email']).'</a>' ).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_mandant_name'])).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:center;"  >'.WgtRndForm::checkbox( 'wbfsys_role_user[inactive]', $row['wbfsys_role_user_inactive'] , array() , true ).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:center;"  >'.WgtRndForm::checkbox( 'wbfsys_role_user[non_cert_login]', $row['wbfsys_role_user_non_cert_login'] , array() , true ).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:right;" >'.(!is_null($row['wbfsys_role_user_last_login'])?$this->view->i18n->timestamp($row['wbfsys_role_user_last_login']):' ').'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.GroupUsers.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_firstname'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.GroupUsers.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_person_lastname'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.GroupUsers_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Group Users." >{$iconDelete} Delete selected Group Users</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Group Users. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.GroupUsers_Multi.deleteAll" >{$iconClean} Delete all Group Users</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleGroup_Ref_GroupUsers_Table_Element
