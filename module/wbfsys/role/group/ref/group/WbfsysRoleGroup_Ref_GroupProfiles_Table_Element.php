 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupProfiles_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_group-group_profiles';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysGroupProfiles_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysRoleGroup_Ref_GroupProfiles';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.GroupProfiles.show&amp;target_mask=WbfsysRoleGroup_Ref_GroupProfiles&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.GroupProfiles.delete&amp;target_mask=WbfsysRoleGroup_Ref_GroupProfiles&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.group_profiles.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_group_profiles_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.GroupProfiles.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.GroupProfiles_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Group Profiles." >{$iconDelete} Delete selected Group Profiles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Group Profiles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.GroupProfiles_Multi.deleteAll" >{$iconClean} Delete all Group Profiles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleGroup_Ref_GroupProfiles_Table_Element
