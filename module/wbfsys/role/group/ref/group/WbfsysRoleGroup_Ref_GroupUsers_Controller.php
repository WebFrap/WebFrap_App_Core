 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupUsers_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des group_users Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleGroup_Ref_GroupUsers_".$listType."_Access";
    ...
    $accessGroupUsers = new $containerClass( );
    $accessGroupUsers->load( $user->getProfileName(), $params );

    $params->aclNode = 'mgmt-wbfsys_role_group-ref-group_users';

    $params->accessGroupUsers = $accessGroupUsers;
    $params->paramsGroupUsers = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessGroupUsers->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysRoleGroup_Ref_GroupUsers_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelGroupUsers = $this->loadModel
    (
      'WbfsysRoleGroup_Ref_GroupUsers_'.$listType
    );
    $modelGroupUsers->setAccess( $accessGroupUsers );
    
    $view->setModel( $modelGroupUsers );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupUsers_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_group-ref-group_users-'.$listType.'-ajax',
    	'WbfsysRoleGroup_Ref_GroupUsers_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysRoleUser to a WbfsysRoleGroup
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_role_group-ref-group_users'
    );

    $params->aclNode = 'mgmt-wbfsys_role_group-ref-group_users';

    $params->accessGroupUsers = $access;
    $params->paramsGroupUsers = $params;

    $model  = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupUsers_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysRoleGroup_Ref_GroupUsers_'.$listType );
      $listModel = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupUsers_'.$listType );
      $listModel->setAccess( $access );
      $ui->setModel( $listModel );

      if( !$ui->listEntry
      ( 
        $conEntiy->getData( 'id_user' ), 
        $access, 
        $params, 
        true 
      ))
...
} // end WbfsysRoleGroup_Ref_GroupUsers_Controller
