 ...
 * If you want to extend this class write your coden in ControllerWbfsysRoleGroup
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupProfiles_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des group_profiles Referenztabs
  * für den wbfsys_role_group management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $params->refId = $objid;
    $params->refIdGroupProfiles = $objid;
    ...
    $containerClass = "WbfsysRoleGroup_Ref_GroupProfiles_".$listType."_Access";
    ...
    $accessGroupProfiles = new $containerClass( );
    $accessGroupProfiles->load( $user->getProfileName(), $params );

    $params->aclNode = 'mgmt-wbfsys_role_group-ref-group_profiles';

    $params->accessGroupProfiles = $accessGroupProfiles;
    $params->paramsGroupProfiles = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessGroupProfiles->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_role_group-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelGroupProfiles = $this->loadModel
    (
      'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType
    );
    $modelGroupProfiles->setAccess( $accessGroupProfiles );
    
    $view->setModel( $modelGroupProfiles );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_group-ref-group_profiles-'.$listType.'-ajax',
    	'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysGroupProfiles by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_profile' ); //def wbfsys_profile
    $this->request->removePost( 'wbfsys_group_profiles' ); //def wbfsys_group_profiles


  } // end public function cleanPost */

 /**
  * connect existining WbfsysProfile to a WbfsysRoleGroup
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_role_group-ref-group_profiles'
    );

    $params->aclNode = 'mgmt-wbfsys_role_group-ref-group_profiles';

    $params->accessGroupProfiles = $access;
    $params->paramsGroupProfiles = $params;

    $model  = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupProfiles_Crud' );
    ...
    $entityWbfsysProfile = $orm->get( 'WbfsysProfile', $refId );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType );
      $listModel = $this->loadModel( 'WbfsysRoleGroup_Ref_GroupProfiles_'.$listType );
      $listModel->setAccess( $access );
      $ui->setModel( $listModel );

      if( !$ui->listEntry
      ( 
        $conEntiy->getData( 'id_profile' ), 
        $access, 
        $params, 
        true 
      ))
...
} // end WbfsysRoleGroup_Ref_GroupProfiles_Controller
