 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Ref_GroupUsers_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listGroupUsers = $this->getRegisterd('listRefGroupUsers'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listGroupUsers was not registered'
        );
      }

      foreach( $listGroupUsers as $entityWbfsysRoleGroup )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefGroupUsers',$listWbfsysGroupUsers);
      return true;
...
}//end class WbfsysRoleGroup_Ref_GroupUsers_Multi_Model
