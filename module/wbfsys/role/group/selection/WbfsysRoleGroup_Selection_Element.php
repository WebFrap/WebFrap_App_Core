 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_role_group';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleGroup.show&amp;target_mask=WbfsysRoleGroup&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleGroup.edit&amp;target_mask=WbfsysRoleGroup&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_group.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleGroup.delete&amp;target_mask=WbfsysRoleGroup&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_group.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_role_group_name']).'</td>'.NL;
...
}//end class WbfsysRoleGroup_Selection_Element
