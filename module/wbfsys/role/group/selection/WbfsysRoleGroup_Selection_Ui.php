 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysRoleGroup_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysRoleGroup_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroup_Selection_Element
    (
      'selectionWbfsysRoleGroup',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Roles', 'wbfsys.role_group.label' ) ;
      $tabPanel->searchKey = 'wbfsys_role_group';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.RoleGroup.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysRoleGroup',
      'WbfsysRoleGroup_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleGroup' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysRoleGroup listing maske
   *
   * @param WbfsysRoleGroup_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleGroup  = $model->getEntityWbfsysRoleGroup();
    ...
    $formWbfsysRoleGroup->setKeyName( 'wbfsys_role_group' );
...
}//end class WbfsysRoleGroup_Selection_Ui
