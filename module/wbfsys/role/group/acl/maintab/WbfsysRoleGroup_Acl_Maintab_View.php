 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.RoleGroup_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_group-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.RoleGroup_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_role_group-acl-update';
    ...
    $this->setTemplate( 'wbfsys/role_group/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Roles', 'wbfsys.role_group.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_role_group_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysRoleGroup_Acl' );
...
} // end class WbfsysRoleGroup_Acl_Maintab_View */
