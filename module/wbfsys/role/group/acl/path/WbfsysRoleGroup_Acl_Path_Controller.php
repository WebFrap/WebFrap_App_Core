 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_role_group_acl_graph', 
      'WbfsysRoleGroup_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysRoleGroup_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysRoleGroup_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysRoleGroup_Acl_Path_Maintab_View  */
...
} // end class WbfsysRoleGroup_Acl_Path_Controller */
