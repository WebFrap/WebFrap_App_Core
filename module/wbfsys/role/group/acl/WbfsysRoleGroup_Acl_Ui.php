...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysRoleGroup_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleGroup_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_role_group-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'User Roles', 'wbfsys.role_group.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_role_group_acl';
...
} // end class WbfsysRoleGroup_Acl_Ui */
