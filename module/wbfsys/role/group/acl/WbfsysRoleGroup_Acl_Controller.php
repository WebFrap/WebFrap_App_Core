 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysRoleGroup
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysRoleGroup_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysRoleGroup_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroup_Acl_Model */
    $model   = $this->loadModel( 'WbfsysRoleGroup_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_role_group-acl',
    	'WbfsysRoleGroup_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_role_group_acl_masks_listing',
      'WbfsysRoleGroup_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysRoleGroup_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysRoleGroup_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroup_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysRoleGroup_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysRoleGroup_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysRoleGroup_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_role_group-acl-qfdu',
    	'WbfsysRoleGroup_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysRoleGroup_Acl_Controller */
