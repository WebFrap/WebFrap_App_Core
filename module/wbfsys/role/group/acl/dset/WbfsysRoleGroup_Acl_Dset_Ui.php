 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysRoleGroup_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysRoleGroup_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysRoleGroup, $areaId, $access, $params  )
  {

    $listObj = new WbfsysRoleGroup_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_role_group-acl-dset' );
    ...
    else
    {
      ...
      (
        'User Roles "{@label@}" User Access',
        'wbfsys.role_group.label',
        array
        (
          'label' => $entityWbfsysRoleGroup->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_role_group_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysRoleGroup_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysRoleGroup_Acl_Dset_Ui */
