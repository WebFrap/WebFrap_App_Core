 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_role_group'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysRoleGroup', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroup_Acl_Dset' );
    /* @var $query WbfsysRoleGroup_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroup_Acl_Dset_Treetable' );
    /* @var $query WbfsysRoleGroup_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysRoleGroup_Acl_Dset_Model */
