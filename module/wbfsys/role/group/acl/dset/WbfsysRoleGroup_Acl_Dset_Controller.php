 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleGroup_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysRoleGroup_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysRoleGroup = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysRoleGroup_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_role_group-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysRoleGroup, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysRoleGroup_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_role_group-acl-dset', 
    	'WbfsysRoleGroup_Acl_Dset',
...
} // end class WbfsysRoleGroup_Acl_Dset_Controller */
