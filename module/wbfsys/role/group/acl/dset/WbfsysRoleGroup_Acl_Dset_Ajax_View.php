 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysRoleGroup_Acl_Dset' );
    ...
    $entityWbfsysRoleGroup = $this->model->getEntity( $dsetId );
...
} // end class WbfsysRoleGroup_Acl_Dset_Ajax_View */
