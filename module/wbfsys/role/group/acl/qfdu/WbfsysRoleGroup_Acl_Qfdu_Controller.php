 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysRoleGroup_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_role_group-acl-qfdu-aAjax',
      'WbfsysRoleGroup_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysRoleGroup_Acl_Qfdu_Controller */
