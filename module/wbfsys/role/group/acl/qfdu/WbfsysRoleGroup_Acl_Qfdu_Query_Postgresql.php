 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_role_group.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_role_group.rowid as id,
    wbfsys_role_group.name as value,
    wbfsys_role_group.name as label
  FROM
    wbfsys_role_group
  WHERE
    {$sqlWhere}
...
} // end class WbfsysRoleGroup_Acl_Qfdu_Query_Postgresql */
