 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_role_group')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysRoleGroup = $orm->get('WbfsysRoleGroup', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_role_group_name']  = $refEntityWbfsysRoleGroup->name;
      $tabData['wbfsys_role_group_id_mandant']  = $refEntityWbfsysRoleGroup->id_mandant;

    }
    $tabData['wbfsys_role_group_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysRoleGroup_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroup_Acl' );
    /* @var $query WbfsysRoleGroup_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroup_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysRoleGroup_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleGroup_Acl_Qfdu' );
    /* @var $query WbfsysRoleGroup_Acl_Qfdu_Query  */
...
} // end class WbfsysRoleGroup_Acl_Qfdu_Model */
