 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_role_group.name as "wbfsys_role_group_name"',
      'wbfsys_role_group.id_mandant as "wbfsys_role_group_id_mandant"',
      'wbfsys_role_group.rowid as "wbfsys_role_group_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_role_group on wbfsys_group_users.vid = wbfsys_role_group.rowid'
    );
      ...
      else
      {
        ...
        if( strpos( $condition['free'], ',' ) )
        {
          ...
          foreach( $parts as $part )
          {
            ...
            (  upper(wbfsys_role_group.name) like upper(\''.$part.'%\') )
            OR 
            (  upper(wbfsys_role_group.id_mandant) like upper(\''.$part.'%\') )
...
} // end class WbfsysRoleGroup_Acl_Qfdu_Treetable_Query_Postgresql */
