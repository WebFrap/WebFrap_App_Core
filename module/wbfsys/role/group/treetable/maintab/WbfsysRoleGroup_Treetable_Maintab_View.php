 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysRoleGroup_Treeable_Model
    */
    public $model = null;

    /**
    * @var WbfsysRoleGroup_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_group/maintab/treetable/listing' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Treetable User Roles',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.RoleGroup.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.RoleGroup.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-wbfsys_role_group-search';
...
BUTTONJS;
    ...
    ///@var WbfsysRoleGroup_Treetable_Ui
    $ui = $this->loadUi( 'WbfsysRoleGroup_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var WbfsysRoleGroup_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'WbfsysRoleGroup_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=Wbfsys.RoleGroup.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.RoleGroup.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.RoleGroup.listing&amp;ltype=treetable');
    });
...
}//end class WbfsysRoleGroup_Treetable_Maintab_View
