 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Treetable_Maintab_Menu
  extends WgtDropmenu
{
  /**
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_role_group-treetable-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_role_group-treetable-help hidden" >
    	      
<p>This is the User Roles treetable.</p>
...
}//end class WbfsysRoleGroup_Treetable_Maintab_Menu
