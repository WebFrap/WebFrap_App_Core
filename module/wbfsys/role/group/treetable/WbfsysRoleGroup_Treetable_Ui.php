 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysRoleGroup_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysRoleGroup_Treetable_Element
    (
      'treetableWbfsysRoleGroup',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Roles', 'wbfsys.role_group.label' );
...
WGTJS;
   ...
   *
   * @return WbfsysRoleGroup_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleGroup', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysRoleGroup_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysRoleGroup_Treetable_Ui
