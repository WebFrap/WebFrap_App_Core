 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysRoleGroup_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_role_group') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_role_group.rowid ",
      'acls'
    );
...
}//end class WbfsysRoleGroup_Treetable_Access
