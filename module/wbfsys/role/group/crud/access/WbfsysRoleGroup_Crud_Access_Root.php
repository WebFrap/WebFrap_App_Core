 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysRoleGroup_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysRoleGroup_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysRoleGroup_Entity */
      $entity = $orm->get( 'WbfsysRoleGroup', $rootId );
    }
...
}//end class WbfsysRoleGroup_Crud_Access_Root
