 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRoleGroup Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleGroup = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit User Roles: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleGroup.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRoleGroup
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleGroup.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_group-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_group/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRoleGroup_Crud_Edit' );
...
}//end class WbfsysRoleGroup_Crud_Edit_Maintab_View
