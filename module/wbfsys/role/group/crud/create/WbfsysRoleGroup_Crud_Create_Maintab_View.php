 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysRoleGroup Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_role_group-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/role_group/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleGroup.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_role_group';
    ...
    $form = $this->newForm( 'WbfsysRoleGroup_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.RoleGroup.create');}});
});
...
}//end class WbfsysRoleGroup_Crud_Create_Maintab_View
