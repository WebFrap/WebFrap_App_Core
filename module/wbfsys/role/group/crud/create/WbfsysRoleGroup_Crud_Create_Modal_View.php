 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleGroup entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleGroup.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleGroup.insert';
    $params->formId       = 'wgt-form-wbfsys_role_group';
    $params->namespace   = 'wbfsys_role_group-create';
    ...
    $this->setTemplate( 'wbfsys/role_group/modal/crud/form_create' );
...
}//end class WbfsysRoleGroup_Crud_Create_Modal_View
