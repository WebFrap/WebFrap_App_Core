 ...
 * @licence WebFrap.net
 */
class WbfsysRoleGroup_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysRoleGroup_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysRoleGroup_Export_Listing_Access';
    ...
    // create a new WbfsysRoleGroup window
    $view = $this->loadView
    (
    	'export-wbfsys_role_group',
    	'WbfsysRoleGroup_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysRoleGroup_Export' );
...
} // end class WbfsysRoleGroup_Export_Controller_Genf
