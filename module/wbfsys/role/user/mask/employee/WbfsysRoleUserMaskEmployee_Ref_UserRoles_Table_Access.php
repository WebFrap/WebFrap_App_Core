 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-user_roles' );
  ...
  /**
   * @param WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Query $query
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Access
