 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_role_user where rowid > 0;
SQL;
  ...
  SELECT
    ...
    wbfsys_role_user.name as value

  FROM
    wbfsys_role_user

  WHERE
    upper(wbfsys_role_user.name) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysRoleUserMaskEmployee_Query_Postgresql
