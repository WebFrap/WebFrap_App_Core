 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Employees
  *
  ...
  *  }
  *
  * @return WbfsysRoleUserMaskEmployee_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUserMaskEmployee_Table_Element( 'tableWbfsysRoleUserMaskEmployee', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_user_mask_employee-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Employees', 'wbfsys.role_user_mask_employee.label' );
      ...
      $searchElement->searchKey = 'wbfsys_role_user_mask_employee';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleUserMaskEmployee_Table_Element( null,$view );
...
}//end class WbfsysRoleUserMaskEmployee_Table_Ui
