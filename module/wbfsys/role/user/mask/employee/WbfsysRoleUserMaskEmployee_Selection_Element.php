...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_role_user_mask_employee_name']).'<br />'.Validator::sanitizeHtml($row['embed_person_lastname']).'<span>, </span>'.Validator::sanitizeHtml($row['embed_person_firstname']).'</td>'.NL;
      $body .= '<td valign="top" ><span>Profile: </span>'.Validator::sanitizeHtml($row['wbfsys_profile_name']).'</td>'.NL;
