 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_role_user_mask_employee';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleUserMaskEmployee.show&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleUserMaskEmployee.edit&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_user_mask_employee.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleUserMaskEmployee.delete&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_user_mask_employee.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_mask_employee_name'])).'<br />'.nl2br(Validator::sanitizeHtml($row['embed_person_lastname'])).'<span>, </span>'.nl2br(Validator::sanitizeHtml($row['embed_person_firstname'])).'</td>'.NL;
      $body .= '<td valign="top" ><span>Profile: </span>'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'</td>'.NL;
...
}//end class WbfsysRoleUserMaskEmployee_Selection_Element
