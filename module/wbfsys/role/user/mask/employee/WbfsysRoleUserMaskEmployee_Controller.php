 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_role_user_mask_employee
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.RoleUserMaskEmployee.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_role_user_mask_employee-create';

    $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_role_user_mask_employee-create',
      'WbfsysRoleUserMaskEmployee_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysRoleUserMaskEmployee_Crud_Model */
    $model = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.RoleUserMaskEmployee.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysRoleUserMaskEmployee = $model->getEntityWbfsysRoleUserMaskEmployee( $objid );
    ...
    $params->entity = $entityWbfsysRoleUserMaskEmployee;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_role_user_mask_employee:edit';

    $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUserMaskEmployee );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_role_user_mask_employee-edit-'.$objid,
      'WbfsysRoleUserMaskEmployee_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_role_user_mask_employee-edit',
          $entityWbfsysRoleUserMaskEmployee,
          'Edit Employee :'.$entityWbfsysRoleUserMaskEmployee->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_role_user_mask_employee:show';
    ...
    (
      'form-wbfsys_role_user_mask_employee-edit-'.$objid,
      'WbfsysRoleUserMaskEmployee_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_role_user_mask_employee-show',
          $entityWbfsysRoleUserMaskEmployee,
          'Show Employee :'.$entityWbfsysRoleUserMaskEmployee->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_role_user_mask_employee
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.RoleUserMaskEmployee.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-insert';

    $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysRoleUserMaskEmployee = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_role_user_mask_employee-update-'.$entityWbfsysRoleUserMaskEmployee;
      ...
      {
        $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUserMaskEmployee );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysRoleUserMaskEmployee';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_role_user_mask_employee',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysRoleUserMaskEmployee_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.RoleUserMaskEmployee.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysRoleUserMaskEmployee, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysRoleUserMaskEmployee_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUserMaskEmployee.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-delete-'.$objid;

    $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUserMaskEmployee );
    ...
    $error = $model->delete( $entityWbfsysRoleUserMaskEmployee, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysRoleUserMaskEmployee, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUserMaskEmployee.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.RoleUserMaskEmployee.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-listing';
    ...
    $containerClass = 'WbfsysRoleUserMaskEmployee_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_role_user_mask_employee',
      'WbfsysRoleUserMaskEmployee_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysRoleUserMaskEmployee_Table_Model */
    $model = $this->loadModel( 'WbfsysRoleUserMaskEmployee_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_role_user_mask_employee-'.$params->ltype,
          'WbfsysRoleUser',
          'List of Employees'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysRoleUserMaskEmployee
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysRoleUserMaskEmployee_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_role_user_mask_employee',
      'WbfsysRoleUserMaskEmployee_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.RoleUserMaskEmployee.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleUserMaskEmployee_Selection_Model */
    $model   = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_role_user_mask_employee-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_role_user_mask_employee-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_role_user_mask_employee',
      'WbfsysRoleUserMaskEmployee',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysRoleUserMaskEmployee, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysRoleUserMaskEmployee_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysRoleUserMaskEmployee_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysRoleUserMaskEmployee_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysRoleUserMaskEmployee, $params );
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user_mask_employee-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_role_user_mask_employee-ajax', 
    	'WbfsysRoleUserMaskEmployee',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_role_user_mask_employee' ); //def wbfsys_role_user_mask_employee
...
} // end class WbfsysRoleUserMaskEmployee_Controller */
