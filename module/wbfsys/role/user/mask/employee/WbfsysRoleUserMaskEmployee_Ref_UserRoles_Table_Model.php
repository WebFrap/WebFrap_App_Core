 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysRoleUserMaskEmployee, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table' );
    /* @var $query WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_group_users.id_user = '.$idWbfsysRoleUserMaskEmployee );
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Model
