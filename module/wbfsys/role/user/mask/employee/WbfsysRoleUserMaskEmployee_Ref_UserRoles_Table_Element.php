 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_user_mask_employee-user_roles';
   ...
   */
  public $namespace   = 'WbfsysRoleUserMaskEmployee_Ref_UserRoles';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.GroupUsers.show&amp;target_mask=WbfsysRoleUserMaskEmployee_Ref_UserRoles&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.GroupUsers.edit&amp;target_mask=WbfsysRoleUserMaskEmployee_Ref_UserRoles&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.group_users.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.GroupUsers.delete&amp;target_mask=WbfsysRoleUserMaskEmployee_Ref_UserRoles&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.group_users.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.role_group.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.role_group.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Mandant', 'wbfsys.role_group.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.role_group.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.role_group.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.GroupUsers.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_group_name'])).'</a></td>'.NL;
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Element
