 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleUserMaskEmployee entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleUserMaskEmployee.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleUserMaskEmployee.insert';
    $params->formId       = 'wgt-form-wbfsys_role_user_mask_employee';
    $params->namespace   = 'wbfsys_role_user_mask_employee-create';
  ...
  $form->setEntityEmbedPerson( $this->model->getEntityEmbedPerson( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/role_user_mask_employee/modal/crud/form_create' );
...
}//end class WbfsysRoleUserMaskEmployee_Crud_Create_Modal_View
