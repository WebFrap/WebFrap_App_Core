 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_user_mask_employee';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysRoleUserMaskEmployee_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleUserMaskEmployee.show&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleUserMaskEmployee.edit&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_user_mask_employee.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'User Roles',
            'modal.php?c=Wbfsys.RoleUserMaskEmployee_Ref_UserRoles.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.role_user_mask_employee.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Profiles',
            'modal.php?c=Wbfsys.RoleUserMaskEmployee_Ref_UserProfiles.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.role_user_mask_employee.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleUserMaskEmployee.delete&amp;target_mask=WbfsysRoleUserMaskEmployee&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_user_mask_employee.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:175px" >Name</th>'.NL;
    $html .= '<th style="width:175px" >Role</th>'.NL;
    $html .= '<th style="width:175px" >Meta</th>'.NL;
    $html .= '<th style="width:175px" >Activ</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $objid       = $row['wbfsys_role_user_mask_employee_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_mask_employee_name'])).'</a><br /><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_person_lastname'])).'</a><span>, </span><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_person_firstname'])).'</a></td>'.NL;
      $body .= '<td valign="top" ><span>Profile: </span>'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'<br /></td>'.NL;
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_role_user_mask_employee_m_time_created'])?$this->view->i18n->date($row['wbfsys_role_user_mask_employee_m_time_created']):' ').'</td>'.NL;
      $body .= '<td valign="top" >'.WgtRndForm::checkbox( 'wbfsys_role_user_mask_employee[inactive]', $row['wbfsys_role_user_mask_employee_inactive'] , array() , true ).'</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.RoleUserMaskEmployee_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Employees." >{$iconDelete} Delete selected Employees</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Employees. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.RoleUserMaskEmployee_Multi.deleteAll" >{$iconClean} Delete all Employees</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleUserMaskEmployee_Table_Element
