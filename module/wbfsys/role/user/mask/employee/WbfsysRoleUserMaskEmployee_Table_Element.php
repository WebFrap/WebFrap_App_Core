...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['wbfsys_role_user_mask_employee_name']).'</a><br /><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['embed_person_lastname']).'</a><span>, </span><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUserMaskEmployee.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['embed_person_firstname']).'</a></td>'.NL;
      $body .= '<td valign="top" ><span>Profile: </span>'.Validator::sanitizeHtml($row['wbfsys_profile_name']).'<br /></td>'.NL;
