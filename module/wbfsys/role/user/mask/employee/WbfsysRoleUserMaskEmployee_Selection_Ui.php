 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysRoleUserMaskEmployee_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysRoleUserMaskEmployee_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUserMaskEmployee_Selection_Element
    (
      'selectionWbfsysRoleUserMaskEmployee',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Employees', 'wbfsys.role_user_mask_employee.label' ) ;
      $tabPanel->searchKey = 'wbfsys_role_user_mask_employee';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.RoleUserMaskEmployee.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysRoleUserMaskEmployee',
      'WbfsysRoleUserMaskEmployee_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleUserMaskEmployee' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysRoleUserMaskEmployee listing maske
   *
   * @param WbfsysRoleUserMaskEmployee_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleUserMaskEmployee  = $model->getEntityWbfsysRoleUserMaskEmployee();
    ...
    $formWbfsysRoleUserMaskEmployee->setKeyName( 'wbfsys_role_user_mask_employee' );
...
}//end class WbfsysRoleUserMaskEmployee_Selection_Ui
