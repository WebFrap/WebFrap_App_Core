 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysRoleUserMaskEmployee_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysRoleUserMaskEmployee_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_role_user_mask_employee
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_user_mask_employee/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Employee', 'wbfsys.role_user_mask_employee.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.RoleUserMaskEmployee.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_role_user_mask_employee-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysRoleUserMaskEmployee_Selection' );
...
}//end class WbfsysRoleUserMaskEmployee_Selection_Modal_View
