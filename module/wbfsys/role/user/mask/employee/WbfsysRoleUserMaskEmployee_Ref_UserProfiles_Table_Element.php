 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_user_mask_employee-user_profiles';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserProfiles_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysRoleUserMaskEmployee_Ref_UserProfiles';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserProfiles.show&amp;target_mask=WbfsysRoleUserMaskEmployee_Ref_UserProfiles&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserProfiles.delete&amp;target_mask=WbfsysRoleUserMaskEmployee_Ref_UserProfiles&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_profiles.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_profiles_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.UserProfiles.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserProfiles_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected User Profiles." >{$iconDelete} Delete selected User Profiles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! User Profiles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.UserProfiles_Multi.deleteAll" >{$iconClean} Delete all User Profiles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Table_Element
