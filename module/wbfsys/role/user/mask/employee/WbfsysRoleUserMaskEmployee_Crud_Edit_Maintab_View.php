 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRoleUserMaskEmployee Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleUserMaskEmployee = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleUserMaskEmployee.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRoleUserMaskEmployee
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleUserMaskEmployee.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_user_mask_employee-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_user_mask_employee/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRoleUserMaskEmployee_Crud_Edit' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_role_user").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.RoleUser.edit&objid={$objid}');
    });
...
}//end class WbfsysRoleUserMaskEmployee_Crud_Edit_Maintab_View
