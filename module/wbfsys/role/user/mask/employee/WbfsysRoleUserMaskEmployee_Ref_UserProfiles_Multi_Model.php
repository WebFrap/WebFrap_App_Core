 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listUserProfiles as $entityWbfsysRoleUserMaskEmployee )
      {
        if(!$orm->save( $entityWbfsysRoleUserMaskEmployee) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Employee '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Employee '.$entityText,
              'wbfsys.role_user_mask_employee.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Employee: '.$textSaved,
          'wbfsys.role_user_mask_employee.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Multi_Model
