 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysRoleUserMaskEmployee, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysRoleUserMaskEmployee, $params );
    }
    else
    {
...
}//end class WbfsysRoleUserMaskEmployee_Ajax_View
