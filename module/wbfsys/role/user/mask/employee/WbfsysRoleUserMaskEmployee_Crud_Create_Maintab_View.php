 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysRoleUserMaskEmployee Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_role_user_mask_employee-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/role_user_mask_employee/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleUserMaskEmployee.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_role_user_mask_employee';
    ...
    $form = $this->newForm( 'WbfsysRoleUserMaskEmployee_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.RoleUserMaskEmployee.create');}});
});
...
}//end class WbfsysRoleUserMaskEmployee_Crud_Create_Maintab_View
