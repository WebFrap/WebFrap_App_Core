 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysRoleUserMaskEmployee_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysRoleUserMaskEmployee_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysRoleUserMaskEmployee_Selection_Model
