 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Tab_Default_Controller
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * open tab default for management view  wbfsys_role_user_mask_employee
  ...
  */
  public function service_load( $request, $response )
  {
    ...
    (
      $params->tabId,
      'WbfsysRoleUserMaskEmployee_Tab_Default',
      'displayTab',
      View::AREA
    );
...
} // end WbfsysRoleUserMaskEmployee_Tab_Default_Controller */
