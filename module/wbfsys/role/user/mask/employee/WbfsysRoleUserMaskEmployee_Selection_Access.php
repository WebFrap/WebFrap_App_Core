 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysRoleUserMaskEmployee_Selection_Query $query
...
}//end class WbfsysRoleUserMaskEmployee_Selection_Access
