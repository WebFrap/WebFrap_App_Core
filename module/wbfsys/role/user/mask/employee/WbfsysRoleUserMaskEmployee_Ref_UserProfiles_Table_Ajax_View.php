 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.RoleUserMaskEmployee_Ref_UserProfiles.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Table_Ajax_View
