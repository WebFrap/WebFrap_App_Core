 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des user_profiles Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleUserMaskEmployee_Ref_UserProfiles_".$listType."_Access";
    ...
    $accessUserProfiles = new $containerClass( );
    $accessUserProfiles->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-user_profiles';

    $params->accessUserProfiles = $accessUserProfiles;
    $params->paramsUserProfiles = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessUserProfiles->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelUserProfiles = $this->loadModel
    (
      'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType
    );
    $modelUserProfiles->setAccess( $accessUserProfiles );
    
    $view->setModel( $modelUserProfiles );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_user_mask_employee-ref-user_profiles-'.$listType.'-ajax',
    	'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysUserProfiles by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {
    ...
    $this->request->removePost( 'wbfsys_user_profiles' ); //def wbfsys_user_profiles


  } // end public function cleanPost */

 /**
  * connect existining WbfsysProfile to a WbfsysRoleUserMaskEmployee
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-user_profiles'
    );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-user_profiles';

    $params->accessUserProfiles = $access;
    $params->paramsUserProfiles = $params;

    $model  = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType );
      $listModel = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Ref_UserProfiles_'.$listType );
...
} // end WbfsysRoleUserMaskEmployee_Ref_UserProfiles_Controller
