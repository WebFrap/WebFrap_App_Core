 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Multi_Controller
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysRoleUserMaskEmployee_Multi_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_save( $request, $response )
  {
    ...
    $access = new WbfsysRoleUserMaskEmployee_Multi_Access_Save( null, null, $this );
    $access->load( $user->getProfileName(), $params );

    // der Access Container des Users für die Resource wird als flag übergeben
    $params->access = $access;
    
    $model = $this->loadModel( 'WbfsysRoleUserMaskEmployee_Multi' );
  ...
  * ControllerWbfsysRoleUserMaskEmployeeGenf::multiSave
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    $access = new WbfsysRoleUserMaskEmployee_Multi_Access_Update( null, null, $this );
    $access->load( $user->getProfileName(), $params );
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    $access = new WbfsysRoleUserMaskEmployee_Multi_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(), $params );
  ...
  * a valid rowid in the given data
  * if you want to have create or update functions use class:
  * ControllerWbfsysRoleUserMaskEmployeeGenf::multiDelete
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    $access = new WbfsysRoleUserMaskEmployee_Multi_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params );
...
}//end class WbfsysRoleUserMaskEmployee_Multi_Controller
