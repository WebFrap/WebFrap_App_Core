 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Query_Postgresql
  extends LibSqlQuery
{
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_group_users.id_user = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_group_users.id_user = '.$condition );
        }
        else
        {
...
}//end class WbfsysRoleUserMaskEmployee_Ref_UserRoles_Table_Query_Postgresql
