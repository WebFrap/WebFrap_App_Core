 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_role_user-viewer
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.RoleUser_Viewer.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_role_user-viewer-create';

    $access = new WbfsysRoleUser_Viewer_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_role_user-viewer-create',
      'WbfsysRoleUser_Viewer_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysRoleUser_Viewer_Crud_Model */
    $model = $this->loadModel( 'WbfsysRoleUser_Viewer_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.RoleUser_Viewer.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysRoleUser_Viewer = $model->getEntityWbfsysRoleUser_Viewer( $objid );
    ...
    $params->entity = $entityWbfsysRoleUser_Viewer;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_role_user-viewer:edit';

    $access = new WbfsysRoleUser_Viewer_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser_Viewer );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_role_user-viewer-edit-'.$objid,
      'WbfsysRoleUser_Viewer_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_role_user-viewer:show';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_role_user-viewer
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.RoleUser_Viewer.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-insert';

    $access = new WbfsysRoleUser_Viewer_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysRoleUser_Viewer = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_role_user-viewer-update-'.$entityWbfsysRoleUser_Viewer;
      ...
      {
        $access = new WbfsysRoleUser_Viewer_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser_Viewer );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysRoleUser_Viewer';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_role_user-viewer',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysRoleUser_Viewer_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.RoleUser_Viewer.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysRoleUser_Viewer, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysRoleUser_Viewer_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUser_Viewer.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-delete-'.$objid;

    $access = new WbfsysRoleUser_Viewer_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser_Viewer );
    ...
    $error = $model->delete( $entityWbfsysRoleUser_Viewer, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysRoleUser_Viewer, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUser_Viewer.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.RoleUser_Viewer.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-listing';
    ...
    $containerClass = 'WbfsysRoleUser_Viewer_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_role_user-viewer',
      'WbfsysRoleUser_Viewer_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysRoleUser_Viewer_Table_Model */
    $model = $this->loadModel( 'WbfsysRoleUser_Viewer_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysRoleUser_Viewer
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysRoleUser_Viewer_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_role_user-viewer',
      'WbfsysRoleUser_Viewer_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysRoleUser_Viewer_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.RoleUser_Viewer.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleUser_Viewer_Selection_Model */
    $model   = $this->loadModel( 'WbfsysRoleUser_Viewer_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_role_user-viewer-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_role_user-viewer-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_role_user-viewer',
      'WbfsysRoleUser_Viewer',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysRoleUser_Viewer, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysRoleUser_Viewer_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysRoleUser_Viewer_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-text_by_key_'.$objid;
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-viewer-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_role_user-viewer-ajax', 
    	'WbfsysRoleUser_Viewer',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_role_user-viewer' );
...
} // end class WbfsysRoleUser_Viewer_Controller */
