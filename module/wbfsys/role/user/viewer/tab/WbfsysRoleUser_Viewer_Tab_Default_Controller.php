 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Tab_Default_Controller
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * open tab default for management view  wbfsys_role_user-viewer
  ...
  */
  public function service_load( $request, $response )
  {
    ...
    $access = new WbfsysRoleUser_Viewer_Crud_Access_Tab( null, null, $this );
    ...
    (
      $params->tabId,
      'WbfsysRoleUser_Viewer_Tab_Default',
      'displayTab',
      View::AREA
    );
    $view->setPosition( '#'.$params->tabId );
    $view->setModel( $this->loadModel( 'WbfsysRoleUser_Viewer_Crud' ) );
...
} // end WbfsysRoleUser_Viewer_Tab_Default_Controller */
