 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
        ...
        <li>
          ...
          <span>
            <ul>
              <li>
                <a 
                  href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_role_user-viewer&amp;objid={$objid}" 
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_role_user-viewer-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
HTML;
      ...
      {
        $html .= '<li><a class="wgtac_mask_wbfsys_role_user_mask_employee" >'.$iconMask.' '.$this->view->i18n->l('Employee','wbfsys.role_user_mask_employee.label').'</a></li>'.NL;
        ++ $numEntries;
      }
...
}//end class WbfsysRoleUser_Viewer_Crud_Show_Maintab_Menu
