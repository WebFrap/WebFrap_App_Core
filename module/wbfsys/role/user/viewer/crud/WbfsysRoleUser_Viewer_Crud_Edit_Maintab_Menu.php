 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Crud_Edit_Maintab_Menu
  extends WgtDropmenu
{
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_role_user-viewer-edit" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysRoleUser_Viewer_Crud_Edit_Maintab_Menu
