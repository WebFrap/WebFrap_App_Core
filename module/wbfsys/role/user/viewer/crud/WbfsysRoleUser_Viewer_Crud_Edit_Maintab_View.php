 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRoleUser_Viewer Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleUser_Viewer = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleUser_Viewer.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRoleUser_Viewer
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleUser_Viewer.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_user-viewer-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_user-viewer/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRoleUser_Viewer_Crud_Edit' );
...
}//end class WbfsysRoleUser_Viewer_Crud_Edit_Maintab_View
