 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleUser_Viewer entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleUser_Viewer.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleUser_Viewer.insert';
    $params->formId       = 'wgt-form-wbfsys_role_user-viewer';
    $params->namespace   = 'wbfsys_role_user-viewer-create';
  ...
  $form->setEntityEmbedPerson( $this->model->getEntityEmbedPerson( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/role_user-viewer/modal/crud/form_create' );
...
}//end class WbfsysRoleUser_Viewer_Crud_Create_Modal_View
