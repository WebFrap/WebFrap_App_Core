 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysRoleUser_Viewer_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUser_Viewer_Table_Element( 'tableWbfsysRoleUser_Viewer', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_user-viewer-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Employees', 'wbfsys.role_user_viewer.label' );
      //$tabPanel->searchKey = 'wbfsys_role_user-viewer';
      ...
      $searchElement->searchKey = 'wbfsys_role_user-viewer';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleUser_Viewer_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleUser_Viewer', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysRoleUser_Viewer listing maske
   *
   * @param WbfsysRoleUser_Viewer_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleUser_Viewer  = $model->getEntityWbfsysRoleUser_Viewer();
    ...
    $formWbfsysRoleUser_Viewer->setKeyName( 'wbfsys_role_user-viewer' );
...
}//end class WbfsysRoleUser_Viewer_Table_Ui
