 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_role_user-viewer_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    {
      $row['acl-level'] = $inKeys[$row['wbfsys_role_user-viewer_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_role_user.rowid as "wbfsys_role_user-viewer_rowid"', // variant: def-rowid 
      'wbfsys_role_user.name as "wbfsys_role_user-viewer_name"', // variant: field_mgmt-attr 
      'core_person.lastname as "core_person_lastname"', // variant: def-by-context  used source field core_person
      'wbfsys_role_user.id_person as "wbfsys_role_user-viewer_id_person"', // ref wbfsys_role_user-viewer def-by-context 
      'wbfsys_role_mandant.name as "wbfsys_role_mandant_name"', // variant: def-by-context  used source field wbfsys_role_mandant
      'wbfsys_role_user.id_mandant as "wbfsys_role_user-viewer_id_mandant"', // ref wbfsys_role_user-viewer def-by-context 
      ...
      'wbfsys_role_user.profile as "wbfsys_role_user-viewer_profile"', // ref wbfsys_role_user-viewer field_mgmt-attr 
      'wbfsys_role_user.m_time_created as "wbfsys_role_user-viewer_m_time_created"', // variant: field_mgmt-attr 
      'wbfsys_role_user.inactive as "wbfsys_role_user-viewer_inactive"', // variant: field_mgmt-attr 
    );
 ...
 wbfsys_role_user.rowid = \''.$part.'\'  or 
      ...
      // search conditions for  wbfsys_role_user-viewer
      if( isset( $condition['wbfsys_role_user-viewer'] ) )
      {
        $whereCond = $condition['wbfsys_role_user-viewer'];
      ...
      }//end if( isset ($condition['wbfsys_role_user-viewer']) )
...
}//end class WbfsysRoleUser_Viewer_Table_Query_Postgresql
