 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_role_user-viewer';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysRoleUser_Viewer_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.RoleUser_Viewer.show&amp;target_mask=WbfsysRoleUser_Viewer&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.RoleUser_Viewer.edit&amp;target_mask=WbfsysRoleUser_Viewer&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.role_user_viewer.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleUser_Viewer.delete&amp;target_mask=WbfsysRoleUser_Viewer&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_user_viewer.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $objid       = $row['wbfsys_role_user-viewer_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUser_Viewer.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user-viewer_name'])).'</a><br /><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUser_Viewer.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_person_lastname'])).'</a><span>, </span><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.RoleUser_Viewer.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_person_firstname'])).'</a></td>'.NL;
      $body .= '<td valign="top" ><span>Profile: </span>'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_name'])).'<br /></td>'.NL;
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_role_user-viewer_m_time_created'])?$this->view->i18n->date($row['wbfsys_role_user-viewer_m_time_created']):' ').'</td>'.NL;
      $body .= '<td valign="top" >'.WgtRndForm::checkbox( 'wbfsys_role_user-viewer[inactive]', $row['wbfsys_role_user-viewer_inactive'] , array() , true ).'</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.RoleUser_Viewer_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.RoleUser_Viewer_Multi.deleteAll" >{$iconClean} Delete all Employees</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysRoleUser_Viewer_Table_Element
