 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Viewer_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_role_user-viewer-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_role_user-viewer-table-help hidden" >
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_role_user-viewer-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysRoleUser_Viewer_Table_Maintab_Menu
