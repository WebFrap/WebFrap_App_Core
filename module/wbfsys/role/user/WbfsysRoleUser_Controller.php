 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_role_user
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.RoleUser.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_role_user-create';

    $access = new WbfsysRoleUser_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_role_user-create',
      'WbfsysRoleUser_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysRoleUser_Crud_Model */
    $model = $this->loadModel( 'WbfsysRoleUser_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.RoleUser.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysRoleUser = $model->getEntityWbfsysRoleUser( $objid );
    ...
    $params->entity = $entityWbfsysRoleUser;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_role_user:edit';

    $access = new WbfsysRoleUser_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser );
    ...
    $paramsAddressItem->aclLevel = (int)$paramsAddressItem->aclLevel + 1;
    ...
    $view = $response->loadView
    (
      'form-wbfsys_role_user-edit-'.$objid,
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_role_user-edit',
          $entityWbfsysRoleUser,
          'Edit System User :'.$entityWbfsysRoleUser->text()
        );
  ...
  * }
  */
  public function service_editWhere( $request, $response )
  {
    ...
    $attrName = $request->param( 'attr', Validator::CNAME ) ;
    if( !$attrName )
    {
      // Ok wir haben keine id bekommen, also ist hier schluss
      throw new InvalidRequest_Exception
      (
        $response->i18n->l
        (
          'The Request for Service: {@service@} was invalid. Reference Name was missing!',
          'wbf.message',
          array
          (
            'service' => 'editWhere'
    ...
    /* @var $model WbfsysRoleUser_Crud_Selection_Model */
    $modelSelection = $this->loadModel( 'WbfsysRoleUser_Crud_Selection' );
    

    // laden des containers zum prüfen der zugriffsrechte
    $accessSelection = new WbfsysRoleUser_Crud_Selection_Access( null, null, $this );
    $accessSelection->load( $user->getProfileName(), $params );
    
    $foundEntries = $modelSelection->getEntryEditListWhere( $objid, $attrName, $accessSelection, $params  );
    
    $numEntries = $foundEntries->count();
    ...
    if( !$numEntries )
    {
      ...
      (
        $response->i18n->l
        (
          'Found no Dataset that matched to the requested parameters',
          'wbf.message',
          array
          (
            'service' => 'editWhere'
    ...
    if( $numEntries != 1 )
    {
      ...
      $view = $response->loadView
      (
        'selection-wbfsys_role_user-'.$attrName.'-'.$objid,
      ...
      $error = $view->displayListing( $foundEntries, $accessSelection, $params );
    ...
    $objid = $foundEntries->getField( 'wbfsys_role_user_rowid' );
  ...
  }//end public function service_editWhere */
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_role_user:show';
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_role_user-show',
          $entityWbfsysRoleUser,
          'Show System User :'.$entityWbfsysRoleUser->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_role_user
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.RoleUser.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-insert';

    $access = new WbfsysRoleUser_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysRoleUser = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_role_user-update-'.$entityWbfsysRoleUser;
      ...
      {
        $access = new WbfsysRoleUser_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysRoleUser';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_role_user',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysRoleUser_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.RoleUser.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysRoleUser, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysRoleUser_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUser.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-delete-'.$objid;

    $access = new WbfsysRoleUser_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysRoleUser );
    ...
    $error = $model->delete( $entityWbfsysRoleUser, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysRoleUser, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.RoleUser.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.RoleUser.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-listing';
    ...
    $containerClass = 'WbfsysRoleUser_'.$listType.'_Access';
    ...
    /* @var $model WbfsysRoleUser_Table_Model */
    $model = $this->loadModel( 'WbfsysRoleUser_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_role_user-'.$params->ltype,
          'WbfsysRoleUser',
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysRoleUser
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysRoleUser_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_role_user',
      'WbfsysRoleUser_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysRoleUser_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.RoleUser.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysRoleUser_Selection_Model */
    $model   = $this->loadModel( 'WbfsysRoleUser_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_role_user-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_role_user-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_role_user',
      'WbfsysRoleUser',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysRoleUser, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysRoleUser_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysRoleUser_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysRoleUser_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysRoleUser, $params );
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_role_user-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_role_user-ajax', 
    	'WbfsysRoleUser',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_role_user' ); //def wbfsys_role_user
...
} // end class WbfsysRoleUser_Controller */
