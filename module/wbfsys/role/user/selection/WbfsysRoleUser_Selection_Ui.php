 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysRoleUser_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysRoleUser_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUser_Selection_Element
    (
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection System Users', 'wbfsys.role_user.label' ) ;
      $tabPanel->searchKey = 'wbfsys_role_user';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.RoleUser.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysRoleUser',
      'WbfsysRoleUser_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRoleUser' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysRoleUser listing maske
   *
   * @param WbfsysRoleUser_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRoleUser  = $model->getEntityWbfsysRoleUser();
    ...
    $formWbfsysRoleUser->setKeyName( 'wbfsys_role_user' );
...
}//end class WbfsysRoleUser_Selection_Ui
