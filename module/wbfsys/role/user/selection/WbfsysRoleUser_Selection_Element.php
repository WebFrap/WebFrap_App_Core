 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.RoleUser.delete&amp;target_mask=WbfsysRoleUser&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.role_user.label',
        Acl::DELETE
...
}//end class WbfsysRoleUser_Selection_Element
