 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysRoleUser_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysRoleUser_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysRoleUser_Selection_Model
