 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysRoleUser_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysRoleUser_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_user/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'System User', 'wbfsys.role_user.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.RoleUser.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_role_user-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysRoleUser_Selection' );
...
}//end class WbfsysRoleUser_Selection_Modal_View
