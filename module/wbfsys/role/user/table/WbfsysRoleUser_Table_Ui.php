...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für System Users
  *
  ...
  *  }
  *
  * @return WbfsysRoleUser_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'System Users', 'wbfsys.role_user.label' );
      ...
      $searchElement->searchKey = 'wbfsys_role_user';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRoleUser_Table_Element( null,$view );
...
}//end class WbfsysRoleUser_Table_Ui
