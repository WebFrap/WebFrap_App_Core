 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * storage variable for the reference  address_item
    * @var array
    */
    protected $storageAddressItem = array();

  /**
  * get the data for a reference node
  * @param int $id
  */
  public function getRefAddressItem( $id )
  {

    return isset( $this->storageAddressItem[$id] )
      ? $this->storageAddressItem[$id]
      : array();

  }//end public function getRefAddressItem */
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_role_user_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'core_person.photo as "embed_person_photo"', // variant: field_ref-ref-mgmt  used refname embed_person
      'core_person.rowid as "embed_person_rowid"', // variant: field_ref-ref-mgmt_rowid  used refname embed_person
      ...
      'wbfsys_profile.name as "wbfsys_profile_name"', // variant: field_mgmt-field_attr 
      'wbfsys_profile.name as "wbfsys_profile_name"', // variant: field_mgmt-field  used source field wbfsys_profile
      'wbfsys_role_user.profile as "wbfsys_role_user_profile"', // ref wbfsys_role_user field_mgmt-field 
 ...
 wbfsys_role_user.rowid = \''.$part.'\'  or 
   ...
   * @param array $ids
   */
  public function fetchReferenceAddressItem( $ids = null )
  {
    ...
    if( is_null( $ids ) )
    {
      ...
      else 
      {
        ...
        if( is_null( $ids ) )
        {
          ...
          foreach( $this->data as $row )
          {
            if($row['wbfsys_role_user_rowid'])
              $ids[] = $row['wbfsys_role_user_rowid'];
          }
...
SELECT
  ...
  wbfsys_address_item.rowid as "wbfsys_address_item_rowid",
  wbfsys_address_item.id_user as "wbfsys_address_item_id_user"
FROM
  wbfsys_address_item

WHERE
  wbfsys_address_item.id_user IN ( {$inIds} )
...
SQL;
    ...
    foreach ($res as $row )
    {
      $this->storageAddressItem[$row['wbfsys_address_item_id_user']][] = $row;
    }

  }//end public function fetchReferenceAddressItem */

}//end class WbfsysRoleUser_Table_Query_Postgresql
