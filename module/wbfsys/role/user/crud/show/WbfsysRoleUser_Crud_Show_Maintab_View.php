 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysRoleUser Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRoleUser = $this->model->getEntityWbfsysRoleUser();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show System User: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.RoleUser.show  &amp;objid='.$entityWbfsysRoleUser
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.RoleUser.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_role_user-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/role_user/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysRoleUser_Crud_Show' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.RoleUser.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysRoleUser_Crud_Show_Maintab_View
