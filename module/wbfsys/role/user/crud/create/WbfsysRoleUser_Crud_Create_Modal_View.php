 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRoleUser entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.RoleUser.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleUser.insert';
    $params->formId       = 'wgt-form-wbfsys_role_user';
    $params->namespace   = 'wbfsys_role_user-create';
  ...
  $form->setEntityEmbedPerson( $this->model->getEntityEmbedPerson( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/role_user/modal/crud/form_create' );
...
}//end class WbfsysRoleUser_Crud_Create_Modal_View
