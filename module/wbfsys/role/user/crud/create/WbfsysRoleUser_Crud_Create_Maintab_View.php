 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysRoleUser Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_role_user-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/role_user/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.RoleUser.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_role_user';
    ...
    $form = $this->newForm( 'WbfsysRoleUser_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.RoleUser.create');}});
});
...
}//end class WbfsysRoleUser_Crud_Create_Maintab_View
