 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Crud_Edit_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function renderForm( $params = null  )
  {
    ...
    $this->view->addVar( 'entityWbfsysRoleUser', $this->entity );
  $this->view->addVar( 'entityEmbedPerson',  $this->entityEmbedPerson ) ;
    ...
    (
      array
      (
        'name'  => 'wbfsys_role_user[id_wbfsys_role_user-tostring]',
        'id'    => $sendTo,
    ...
    $this->input_WbfsysRoleUser_Name( $params );
    $this->input_WbfsysRoleUser_IdPerson( $params );
    $this->input_WbfsysRoleUser_IdMandant( $params );
    $this->input_WbfsysRoleUser_Rowid( $params );
    $this->input_WbfsysRoleUser_MTimeCreated( $params );
    $this->input_WbfsysRoleUser_MRoleCreate( $params );
    $this->input_WbfsysRoleUser_MTimeChanged( $params );
    $this->input_WbfsysRoleUser_MRoleChange( $params );
    $this->input_WbfsysRoleUser_MVersion( $params );
    $this->input_WbfsysRoleUser_MUuid( $params );
    ...
    $this->input_WbfsysRoleUser_IdEmployee( $params );
    $this->input_WbfsysRoleUser_Password( $params );
    $this->input_WbfsysRoleUser_Level( $params );
    $this->input_WbfsysRoleUser_Profile( $params );
    $this->input_WbfsysRoleUser_Inactive( $params );
    $this->input_WbfsysRoleUser_NonCertLogin( $params );
    $this->input_WbfsysRoleUser_Description( $params );
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Name( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:text
      $inputName = $this->view->newInput( 'inputWbfsysRoleUserName' , 'Text' );
      $this->items['wbfsys_role_user-name'] = $inputName;
      $inputName->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[name]',
          'id'        => 'wgt-input-wbfsys_role_user_name'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_Name */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_IdPerson( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'CorePerson_Entity' ) )
    {
      ...
      $inputIdPerson = $this->view->newInput( 'inputWbfsysRoleUserIdPerson', 'Window' );
      $this->items['wbfsys_role_user-id_person'] = $inputIdPerson;
      $inputIdPerson->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_role_user[id_person]',
        'id'        => 'wgt-input-wbfsys_role_user_id_person'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputIdPerson->buildJavascript( 'wgt-input-wbfsys_role_user_id_person'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysRoleUser_IdPerson */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_IdMandant( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleMandant_Entity' ) )
    {
      ...
      $inputIdMandant = $this->view->newInput( 'inputWbfsysRoleUserIdMandant', 'Window' );
      $this->items['wbfsys_role_user-id_mandant'] = $inputIdMandant;
      $inputIdMandant->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_role_user[id_mandant]',
        'id'        => 'wgt-input-wbfsys_role_user_id_mandant'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputIdMandant->setReadonly( $this->fieldReadOnly( 'wbfsys_role_user', 'id_mandant' ) );
      $inputIdMandant->setRequired( $this->fieldRequired( 'wbfsys_role_user', 'id_mandant' ) );
      $inputIdMandant->setLabel( $i18n->l( 'Mandant', 'wbfsys.role_user.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleMandant.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_role_user_id_mandant'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMandant->buildJavascript( 'wgt-input-wbfsys_role_user_id_mandant'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysRoleUser_IdMandant */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Rowid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputRowid = $this->view->newInput( 'inputWbfsysRoleUserRowid' , 'int' );
      $this->items['wbfsys_role_user-rowid'] = $inputRowid;
      $inputRowid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[rowid]',
          'id'        => 'wgt-input-wbfsys_role_user_rowid'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_Rowid */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MTimeCreated( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeCreated = $this->view->newInput( 'inputWbfsysRoleUserMTimeCreated' , 'Date' );
      $this->items['wbfsys_role_user-m_time_created'] = $inputMTimeCreated;
      $inputMTimeCreated->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[m_time_created]',
          'id'        => 'wgt-input-wbfsys_role_user_m_time_created'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_MTimeCreated */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MRoleCreate( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $this->items['wbfsys_role_user-m_role_create'] = $inputMRoleCreate;
      $inputMRoleCreate->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_role_user[m_role_create]',
        'id'        => 'wgt-input-wbfsys_role_user_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMRoleCreate->buildJavascript( 'wgt-input-wbfsys_role_user_m_role_create'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysRoleUser_MRoleCreate */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MTimeChanged( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeChanged = $this->view->newInput( 'inputWbfsysRoleUserMTimeChanged' , 'Date' );
      $this->items['wbfsys_role_user-m_time_changed'] = $inputMTimeChanged;
      $inputMTimeChanged->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[m_time_changed]',
          'id'        => 'wgt-input-wbfsys_role_user_m_time_changed'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
  ...
  }//end public function input_WbfsysRoleUser_MTimeChanged */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MRoleChange( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $this->items['wbfsys_role_user-m_role_change'] = $inputMRoleChange;
      $inputMRoleChange->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_role_user[m_role_change]',
        'id'        => 'wgt-input-wbfsys_role_user_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMRoleChange->buildJavascript( 'wgt-input-wbfsys_role_user_m_role_change'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysRoleUser_MRoleChange */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MVersion( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMVersion = $this->view->newInput( 'inputWbfsysRoleUserMVersion' , 'int' );
      $this->items['wbfsys_role_user-m_version'] = $inputMVersion;
      $inputMVersion->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[m_version]',
          'id'        => 'wgt-input-wbfsys_role_user_m_version'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_MVersion */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_MUuid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMUuid = $this->view->newInput( 'inputWbfsysRoleUserMUuid' , 'Text' );
      $this->items['wbfsys_role_user-m_uuid'] = $inputMUuid;
      $inputMUuid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[m_uuid]',
          'id'        => 'wgt-input-wbfsys_role_user_m_uuid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
  ...
  }//end public function input_WbfsysRoleUser_MUuid */
...
/// windowref to nonexisting hr_employee in LibGeneratorWbfFieldWindow
 /**
  * create the ui element for field password
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_WbfsysRoleUser_Password( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:password
      $inputPassword = $this->view->newInput( 'inputWbfsysRoleUserPassword', 'Password' );
      $this->items['wbfsys_role_user-password'] = $inputPassword;
      $inputPassword->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[password]',
          'id'        => 'wgt-input-wbfsys_role_user_password'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_Password */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Level( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !isset( $this->listElementData['wbfsys_role_user_level'] ) )
    {
      ...
      $this->items['wbfsys_role_user-level'] = $inputLevel;
      $inputLevel->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[level]',
          'id'        => 'wgt-input-wbfsys_role_user_level'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputLevel->editUrl = 'index.php?c=Wbfsys.SecurityLevel.listing&amp;target='.$this->namespace.'&amp;field=level&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-wbfsys_role_user_level'.$this->suffix;
      }
  ...
  }//end public function input_WbfsysRoleUser_Level */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Profile( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !isset( $this->listElementData['wbfsys_role_user_profile'] ) )
    {
      ...
      $this->items['wbfsys_role_user-profile'] = $inputProfile;
      $inputProfile->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[profile]',
          'id'        => 'wgt-input-wbfsys_role_user_profile'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_profile:insert' ) )
      {
        ...
        $inputProfile->editUrl = 'index.php?c=Wbfsys.Profile.listing&amp;target='.$this->namespace.'&amp;field=profile&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-wbfsys_role_user_profile'.$this->suffix;
      }
      // set an empty first entry
  ...
  }//end public function input_WbfsysRoleUser_Profile */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Inactive( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:Checkbox
      $inputInactive = $this->view->newInput( 'inputWbfsysRoleUserInactive', 'Checkbox' );
      $this->items['wbfsys_role_user-inactive'] = $inputInactive;
      $inputInactive->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[inactive]',
          'id'        => 'wgt-input-wbfsys_role_user_inactive'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Inactive', 'src' => 'Role User' ) ),
        )
      );
  ...
  }//end public function input_WbfsysRoleUser_Inactive */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_NonCertLogin( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:Checkbox
      $inputNonCertLogin = $this->view->newInput( 'inputWbfsysRoleUserNonCertLogin', 'Checkbox' );
      $this->items['wbfsys_role_user-non_cert_login'] = $inputNonCertLogin;
      $inputNonCertLogin->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_role_user[non_cert_login]',
          'id'        => 'wgt-input-wbfsys_role_user_non_cert_login'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'No Cert required', 'src' => 'Role User' ) ),
        )
      );
  ...
  }//end public function input_WbfsysRoleUser_NonCertLogin */
  ...
  * @return void
  */
  public function input_WbfsysRoleUser_Description( $params )
  {
    $i18n     = $this->view->i18n;

      //p: textarea
      $inputDescription = $this->view->newInput( 'inputWbfsysRoleUserDescription', 'Textarea' );
      $this->items['wbfsys_role_user-description'] = $inputDescription;
      $inputDescription->addAttributes
      (
        array
        (
          'name'  => 'wbfsys_role_user[description]',
          'id'    => 'wgt-input-wbfsys_role_user_description'.($this->suffix?'-'.$this->suffix:''),
  ...
  }//end public function input_WbfsysRoleUser_Description */
...
}//end class WbfsysRoleUser_Crud_Edit_Form */
