 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_role_user', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    try
    {
      if( !$entityWbfsysRoleUser = $this->getRegisterd( 'entityWbfsysRoleUser' ) )
      {
        ...
        (
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysRoleUser' )
          )
        );
      }
      ...
      if( !$orm->insert( $entityWbfsysRoleUser ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to create System User {@label@}',
            'wbfsys.role_user.message',
            array
            (
              'label' => $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully created System User {@label@}',
            'wbfsys.role_user.message',
        ...
        $this->protocol
        (
          'Created New System User: '.$entityText,
          'create',
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysRoleUser );
      }
    ...
    try
    {
      ...
      if( !$orm->update( $entityWbfsysRoleUser ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to update System User {@label@}',
            'wbfsys.role_user.message',
            array
            (
              'label' =>  $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully updated System User {@label@}',
            'wbfsys.role_user.message',
            array
            (
              'label' =>  $entityText
   ...
   */
  public function delete( $entityWbfsysRoleUser, $params  )
  {
    ...
    $delId     = $entityWbfsysRoleUser->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysRoleUser );

      $response->addMessage
      (
        $response->i18n->l
        (
          'Successfully deleted System User {@label@}',
          'wbfsys.role_user.message',
          array( 'label' => $entityText )
        )
      );
        ...
        $this->protocol
        (
          'Deleted System User: '.$entityText,
          'delete',
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      //management  wbfsys_role_user source wbfsys_role_user
      $entityWbfsysRoleUser = $orm->newEntity( 'WbfsysRoleUser' );

      if( !$params->fieldsWbfsysRoleUser )
      {
        if( isset( $fields['wbfsys_role_user'] )  )
          $params->fieldsWbfsysRoleUser  = $fields['wbfsys_role_user'];
        else
          $params->fieldsWbfsysRoleUser  = array();
      }
     ...
     $entityWbfsysRoleUser->id_person = $entityEmbedPerson; //src is saved after target
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysRoleUser, $params )
  {
    ...
    if( !$idEmbedPerson = $httpRequest->data( 'embed_person', Validator::EID, 'rowid' ) )
      $idEmbedPerson = $entityWbfsysRoleUser->id_person;
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysRoleUser = $orm->get( 'WbfsysRoleUser',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
          (
            'There is no System User with the id: {@id@}',
            'wbfsys.role_user.message',
            array
            (
              'id' => $id
    ...
    if( !$params->fieldsWbfsysRoleUser )
      $params->fieldsWbfsysRoleUser  = $entityWbfsysRoleUser->getCols
      (
        $params->categories
      );
  ...
  public function getAutolistByKey( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysRoleUser' );
    /* @var $query WbfsysRoleUser_Query  */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_role_user'] = array();
    $saveFields['wbfsys_role_user'][] = 'name';
        $saveFields['wbfsys_role_user'][] = 'id_person';
        $saveFields['wbfsys_role_user'][] = 'id_mandant';
        $saveFields['wbfsys_role_user'][] = 'm_version';
        $saveFields['wbfsys_role_user'][] = 'id_employee';
        $saveFields['wbfsys_role_user'][] = 'password';
        $saveFields['wbfsys_role_user'][] = 'level';
        $saveFields['wbfsys_role_user'][] = 'profile';
        $saveFields['wbfsys_role_user'][] = 'inactive';
        $saveFields['wbfsys_role_user'][] = 'non_cert_login';
        $saveFields['wbfsys_role_user'][] = 'description';
