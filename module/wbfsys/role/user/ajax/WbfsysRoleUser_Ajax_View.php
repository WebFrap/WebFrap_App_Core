 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysRoleUser, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysRoleUser, $params );
    }
    else
    {
...
}//end class WbfsysRoleUser_Ajax_View
