 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_AddressItem_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.RoleUser_Ref_AddressItem.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysRoleUser_Ref_AddressItem_Table_Ajax_View
