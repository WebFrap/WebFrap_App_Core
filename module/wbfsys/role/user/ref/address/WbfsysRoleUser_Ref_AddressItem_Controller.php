 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_AddressItem_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleUser_Ref_AddressItem_".$listType."_Access";
    ...
    (
      $params->tabId,
      'WbfsysRoleUser_Ref_AddressItem_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleUser_Ref_AddressItem_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_user-ref-address_item-'.$listType.'-ajax',
    	'WbfsysRoleUser_Ref_AddressItem_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
} // end WbfsysRoleUser_Ref_AddressItem_Controller
