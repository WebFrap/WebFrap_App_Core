 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_AddressItem_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  { 
    ...
    $query = $db->newQuery( 'WbfsysRoleUser_Ref_AddressItem_Table' );
    /* @var $query WbfsysRoleUser_Ref_AddressItem_Table_Query  */

    // hard condition
    $query->setCondition( 'wbfsys_address_item.id_user = '.$idWbfsysRoleUser );
...
}//end class WbfsysRoleUser_Ref_AddressItem_Table_Model
