 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_AddressItem_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_address_item.rowid as "wbfsys_address_item_rowid"', // variant:  
      'wbfsys_address_item.name as "wbfsys_address_item_name"', // variant:  
      'wbfsys_address_item.address_value as "wbfsys_address_item_address_value"', // variant:  
      'wbfsys_address_item_type.name as "wbfsys_address_item_type_name"', // variant:   used source field wbfsys_address_item_type
      'wbfsys_address_item.id_type as "wbfsys_address_item_id_type"', // ref wbfsys_address_item  
      'wbfsys_address_item.use_for_contact as "wbfsys_address_item_use_for_contact"', // variant:  
      'wbfsys_address_item.description as "wbfsys_address_item_description"', // variant:  
    );
...
}//end class WbfsysRoleUser_Ref_AddressItem_Table_Query_Postgresql
