 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_AddressItem_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'index.php?c=Wbfsys.RoleUser_Ref_AddressItem.search&amp;objid='.$params->refId;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_role_user-ref-address_item-search-'.$objid;
      
    // fix the target id
		$params->targetId = 'wgt-table-modal-ref-address_item-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'AddressItem' );

    // set the default table template
    $this->setTemplate( 'wbfsys/role_user/ref_address_item/tab_table' );
...
}//end class WbfsysRoleUser_Ref_AddressItem_Table_Modal_View
