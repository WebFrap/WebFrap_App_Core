 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserRoles_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_user/ref_user_roles/tab_table' );
...
}//end class WbfsysRoleUser_Ref_UserRoles_Table_Modal_View
