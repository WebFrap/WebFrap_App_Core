 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.RoleUser_Ref_UserProfiles.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_role_user-ref-user_profiles-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/role_user/ref_user_profiles/tab_table' );
...
}//end class WbfsysRoleUser_Ref_UserProfiles_Table_Modal_View
