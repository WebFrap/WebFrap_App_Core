 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysRoleUser_Ref_UserProfiles_Table_Query $query
...
}//end class WbfsysRoleUser_Ref_UserProfiles_Table_Access
