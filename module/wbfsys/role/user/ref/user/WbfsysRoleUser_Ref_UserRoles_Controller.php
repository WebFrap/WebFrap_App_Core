 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserRoles_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleUser_Ref_UserRoles_".$listType."_Access";
    ...
    (
      $params->tabId,
      'WbfsysRoleUser_Ref_UserRoles_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleUser_Ref_UserRoles_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_user-ref-user_roles-'.$listType.'-ajax',
    	'WbfsysRoleUser_Ref_UserRoles_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysRoleGroup to a WbfsysRoleUser
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysRoleUser_Ref_UserRoles_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysRoleUser_Ref_UserRoles_'.$listType );
      $listModel = $this->loadModel( 'WbfsysRoleUser_Ref_UserRoles_'.$listType );
...
} // end WbfsysRoleUser_Ref_UserRoles_Controller
