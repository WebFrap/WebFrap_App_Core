 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserRoles_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysRoleUser_Ref_UserRoles_Table_Element
   */
  public function createListItem( $idWbfsysRoleUser, $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUser_Ref_UserRoles_Table_Element
    (
      'tableUserRoles',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-user_roles-'.$idWbfsysRoleUser;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_user-ref-user_roles-search-'
        .$idWbfsysRoleUser;
...
// liste der im menü anzuzeigende entries
    ...
    $tabPanel->searchKey = 'wbfsys_role_user-ref-user_roles';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.get(\'modal.php?c=Wbfsys.RoleGroup.selection&exclude=wbfsys_group_users-id_user-id_group&objid='.$params->refId.'&target_mask=WbfsysRoleUser_Ref_UserRoles&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdUserRoles', $idWbfsysRoleUser );
    $view->addVar
    (
      'searchFormActionUserRoles',
      'ajax.php?c=Wbfsys.RoleUser_Ref_UserRoles.search&amp;target_id='
...
}//end class WbfsysRoleUser_Ref_UserRoles_Table_Ui
