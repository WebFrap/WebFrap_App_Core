 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserRoles_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.RoleUser_Ref_UserRoles.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysRoleUser_Ref_UserRoles_Table_Ajax_View
