 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysRoleUser, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysRoleUser_Ref_UserProfiles_Table' );
    /* @var $query WbfsysRoleUser_Ref_UserProfiles_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_user_profiles.id_user = '.$idWbfsysRoleUser );
...
}//end class WbfsysRoleUser_Ref_UserProfiles_Table_Model
