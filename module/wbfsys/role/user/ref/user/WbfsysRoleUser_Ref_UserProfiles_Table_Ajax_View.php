 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.RoleUser_Ref_UserProfiles.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysRoleUser_Ref_UserProfiles_Table_Ajax_View
