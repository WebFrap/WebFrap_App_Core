 ...
 * If you want to extend this class write your coden in ControllerWbfsysRoleUser
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_role_user management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysRoleUser_Ref_UserProfiles_".$listType."_Access";
    ...
    (
      $params->tabId,
      'WbfsysRoleUser_Ref_UserProfiles_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysRoleUser_Ref_UserProfiles_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_role_user-ref-user_profiles-'.$listType.'-ajax',
    	'WbfsysRoleUser_Ref_UserProfiles_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysProfile to a WbfsysRoleUser
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysRoleUser_Ref_UserProfiles_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysRoleUser_Ref_UserProfiles_'.$listType );
      $listModel = $this->loadModel( 'WbfsysRoleUser_Ref_UserProfiles_'.$listType );
...
} // end WbfsysRoleUser_Ref_UserProfiles_Controller
