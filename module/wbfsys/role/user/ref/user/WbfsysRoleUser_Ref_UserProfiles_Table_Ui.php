 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Ref_UserProfiles_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysRoleUser_Ref_UserProfiles_Table_Element
   */
  public function createListItem( $idWbfsysRoleUser, $data, $access, $params  )
  {
    ...
    $table = new WbfsysRoleUser_Ref_UserProfiles_Table_Element
    (
      'tableUserProfiles',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-user_profiles-'.$idWbfsysRoleUser;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_role_user-ref-user_profiles-search-'
        .$idWbfsysRoleUser;
...
// liste der im menü anzuzeigende entries
    ...
    $tabPanel->searchKey = 'wbfsys_role_user-ref-user_profiles';
    $tabPanel->searchFieldSize = 'medium';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Profiles',
            '$R.get(\'modal.php?c=Wbfsys.Profile.selection&exclude=wbfsys_user_profiles-id_user-id_profile&objid='.$params->refId.'&target_mask=WbfsysRoleUser_Ref_UserProfiles&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdUserProfiles', $idWbfsysRoleUser );
    $view->addVar
    (
      'searchFormActionUserProfiles',
      'ajax.php?c=Wbfsys.RoleUser_Ref_UserProfiles.search&amp;target_id='
...
}//end class WbfsysRoleUser_Ref_UserProfiles_Table_Ui
