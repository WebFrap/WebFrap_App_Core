 ...
 * @licence WebFrap.net
 */
class WbfsysRoleUser_Tab_Default_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/role_user/tabs/default' );
    ...
    $item_Skill->setData( $tagModel->getDatasetTaglist( $objid ) );
    $item_Skill->refId = $objid;
    $item_Skill->render();
    //##############################################################################
...
}//end class WbfsysRoleUser_Tab_Default_Modal_View
