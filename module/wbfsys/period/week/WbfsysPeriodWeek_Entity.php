 ...
 *
 * Entity Class for the Database Table wbfsys_period_week
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_period_week';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.PeriodWeek.show';
  ...
  */
  public static $entityName  = 'WbfsysPeriodWeek';
  ...
  * @var string
  */
  public static $label  = 'Period Week';
  ...
  */
  ...
  (
    'p_week' => array
    (
      'default' => 'wbfsys.period_week.message.error_def_p_week',
      'wrong'   => 'wbfsys.period_week.message.error_wrong_p_week',
      'max'     => 'wbfsys.period_week.message.error_max_p_week',
      'min'     => 'wbfsys.period_week.message.error_min_p_week',
    ),
  );

}//end class WbfsysPeriodWeek_Entity
