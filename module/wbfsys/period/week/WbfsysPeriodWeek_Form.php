...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_period_week';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPeriodWeek';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPeriodWeek';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysPeriodWeek';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPeriodWeek entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPeriodWeek' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPeriodWeek entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the ui element for field p_week
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_p_week( $params )
  {

      //tpl: class ui:date
      $inputPWeek = $this->view->newInput( 'input'.$this->prefix.'PWeek' , 'Date' );
      $this->items['p_week'] = $inputPWeek;
      $inputPWeek->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[p_week]',
          'id'        => 'wgt-input-'.$this->keyName.'_p_week'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for P Week (Period Week)', 'wbfsys.period_week.label' ),
          'maxlength' => $this->entity->maxSize( 'p_week' ),
        )
      );
      $inputPWeek->setWidth( 'small' );

      $inputPWeek->setReadOnly( $this->isReadOnly( 'p_week' ) );
      $inputPWeek->setData( $this->entity->getDate( 'p_week' ) );
      $inputPWeek->setLabel
      (
        $this->view->i18n->l( 'P Week', 'wbfsys.period_week.label' ),
        $this->entity->required( 'p_week' )
      );

      $inputPWeek->refresh           = $this->refresh;
      $inputPWeek->serializeElement  = $this->sendElement;
  ...
  }//end public function input_p_week */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_week_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_week_m_role_change';
...
}//end class WbfsysPeriodWeek_Form */
