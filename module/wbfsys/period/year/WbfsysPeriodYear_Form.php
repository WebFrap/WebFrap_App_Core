...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_period_year';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPeriodYear';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPeriodYear';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysPeriodYear';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPeriodYear entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPeriodYear' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPeriodYear entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the ui element for field p_year
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_p_year( $params )
  {

      //tpl: class ui:date
      $inputPYear = $this->view->newInput( 'input'.$this->prefix.'PYear' , 'Date' );
      $this->items['p_year'] = $inputPYear;
      $inputPYear->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[p_year]',
          'id'        => 'wgt-input-'.$this->keyName.'_p_year'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for P Year (Period Year)', 'wbfsys.period_year.label' ),
          'maxlength' => $this->entity->maxSize( 'p_year' ),
        )
      );
      $inputPYear->setWidth( 'small' );

      $inputPYear->setReadOnly( $this->isReadOnly( 'p_year' ) );
      $inputPYear->setData( $this->entity->getDate( 'p_year' ) );
      $inputPYear->setLabel
      (
        $this->view->i18n->l( 'P Year', 'wbfsys.period_year.label' ),
        $this->entity->required( 'p_year' )
      );

      $inputPYear->refresh           = $this->refresh;
      $inputPYear->serializeElement  = $this->sendElement;
  ...
  }//end public function input_p_year */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_year_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_year_m_role_change';
...
}//end class WbfsysPeriodYear_Form */
