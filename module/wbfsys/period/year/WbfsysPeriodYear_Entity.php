 ...
 *
 * Entity Class for the Database Table wbfsys_period_year
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_period_year';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.PeriodYear.show';
  ...
  */
  public static $entityName  = 'WbfsysPeriodYear';
  ...
  * @var string
  */
  public static $label  = 'Period Year';
  ...
  */
  ...
  (
    'p_year' => array
    (
      'default' => 'wbfsys.period_year.message.error_def_p_year',
      'wrong'   => 'wbfsys.period_year.message.error_wrong_p_year',
      'max'     => 'wbfsys.period_year.message.error_max_p_year',
      'min'     => 'wbfsys.period_year.message.error_min_p_year',
    ),
  );

}//end class WbfsysPeriodYear_Entity
