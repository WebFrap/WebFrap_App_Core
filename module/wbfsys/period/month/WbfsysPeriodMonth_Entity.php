 ...
 *
 * Entity Class for the Database Table wbfsys_period_month
 * 
 * @package WebFrap
 ...
 * @licence WebFrap.net
 */
class WbfsysPeriodMonth_Entity
  extends Entity
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_period_month';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.PeriodMonth.show';
  ...
  */
  public static $entityName  = 'WbfsysPeriodMonth';
  ...
  * @var string
  */
  public static $label  = 'Period Month';
  ...
  */
  ...
  (
    'p_month' => array
    (
      'default' => 'wbfsys.period_month.message.error_def_p_month',
      'wrong'   => 'wbfsys.period_month.message.error_wrong_p_month',
      'max'     => 'wbfsys.period_month.message.error_max_p_month',
      'min'     => 'wbfsys.period_month.message.error_min_p_month',
    ),
  );

}//end class WbfsysPeriodMonth_Entity
