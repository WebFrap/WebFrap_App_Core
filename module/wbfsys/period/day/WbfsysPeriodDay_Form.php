...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_period_day';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPeriodDay';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPeriodDay';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPeriodDay entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPeriodDay' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPeriodDay entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the ui element for field p_day
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_p_day( $params )
  {

      //tpl: class ui:date
      $inputPDay = $this->view->newInput( 'input'.$this->prefix.'PDay' , 'Date' );
      $this->items['p_day'] = $inputPDay;
      $inputPDay->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[p_day]',
          'id'        => 'wgt-input-'.$this->keyName.'_p_day'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for P Day (Period Day)', 'wbfsys.period_day.label' ),
          'maxlength' => $this->entity->maxSize( 'p_day' ),
        )
      );
      $inputPDay->setWidth( 'small' );

      $inputPDay->setReadOnly( $this->isReadOnly( 'p_day' ) );
      $inputPDay->setData( $this->entity->getDate( 'p_day' ) );
      $inputPDay->setLabel
      (
        $this->view->i18n->l( 'P Day', 'wbfsys.period_day.label' ),
        $this->entity->required( 'p_day' )
      );

      $inputPDay->refresh           = $this->refresh;
      $inputPDay->serializeElement  = $this->sendElement;
  ...
  }//end public function input_p_day */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_day_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_period_day_m_role_change';
...
}//end class WbfsysPeriodDay_Form */
