 ...
 *
 * Entity Class for the Database Table wbfsys_period_day
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_period_day';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.PeriodDay.show';
  ...
  */
  public static $entityName  = 'WbfsysPeriodDay';
  ...
  * @var string
  */
  public static $label  = 'Period Day';
  ...
  */
  ...
  (
    'p_day' => array
    (
      'default' => 'wbfsys.period_day.message.error_def_p_day',
      'wrong'   => 'wbfsys.period_day.message.error_wrong_p_day',
      'max'     => 'wbfsys.period_day.message.error_max_p_day',
      'min'     => 'wbfsys.period_day.message.error_min_p_day',
    ),
  );

}//end class WbfsysPeriodDay_Entity
