 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_gateway';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysGateway_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Gateway.show&amp;target_mask=WbfsysGateway&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Gateway.edit&amp;target_mask=WbfsysGateway&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.gateway.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Gateway.delete&amp;target_mask=WbfsysGateway&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.gateway.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.gateway.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_gateway_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Gateway.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_gateway_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Gateway_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Gateways." >{$iconDelete} Delete selected Gateways</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Gateways. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Gateway_Multi.deleteAll" >{$iconClean} Delete all Gateways</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysGateway_Table_Element
