...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Gateways
  *
  ...
  *  }
  *
  * @return WbfsysGateway_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGateway_Table_Element( 'tableWbfsysGateway', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_gateway-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Gateways', 'wbfsys.gateway.label' );
      //$tabPanel->searchKey = 'wbfsys_gateway';
      ...
      $searchElement->searchKey = 'wbfsys_gateway';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysGateway_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysGateway', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysGateway listing maske
   *
   * @param WbfsysGateway_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysGateway  = $model->getEntityWbfsysGateway();
    ...
    $formWbfsysGateway->setKeyName( 'wbfsys_gateway' );
...
}//end class WbfsysGateway_Table_Ui
