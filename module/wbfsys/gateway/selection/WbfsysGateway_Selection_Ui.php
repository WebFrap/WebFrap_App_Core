 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysGateway_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysGateway_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGateway_Selection_Element
    (
      'selectionWbfsysGateway',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Gateways', 'wbfsys.gateway.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Gateway.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysGateway',
      'WbfsysGateway_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysGateway_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysGateway_Selection_Ui
