 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysGateway_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysGateway_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/gateway/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Gateway', 'wbfsys.gateway.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Gateway.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_gateway-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysGateway_Selection' );
...
}//end class WbfsysGateway_Selection_Modal_View
