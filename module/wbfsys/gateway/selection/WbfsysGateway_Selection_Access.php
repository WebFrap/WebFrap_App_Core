 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysGateway_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_gateway.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_gateway.rowid ",
      'acls'
    );
...
}//end class WbfsysGateway_Selection_Access
