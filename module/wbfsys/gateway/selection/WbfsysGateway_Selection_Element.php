 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_gateway';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Gateway.show&amp;target_mask=WbfsysGateway&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Gateway.edit&amp;target_mask=WbfsysGateway&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.gateway.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Gateway.delete&amp;target_mask=WbfsysGateway&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.gateway.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_gateway_name'])).'</td>'.NL;
...
}//end class WbfsysGateway_Selection_Element
