 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysGateway Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysGateway = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Gateway.edit&amp;utf8=✓&amp;objid='.$entityWbfsysGateway
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Gateway.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_gateway-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/gateway/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysGateway_Crud_Edit' );
...
}//end class WbfsysGateway_Crud_Edit_Maintab_View
