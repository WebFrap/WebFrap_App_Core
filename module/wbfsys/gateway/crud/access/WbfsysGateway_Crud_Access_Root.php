 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysGateway_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysGateway_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysGateway_Entity */
      $entity = $orm->get( 'WbfsysGateway', $rootId );
    }
...
}//end class WbfsysGateway_Crud_Access_Root
