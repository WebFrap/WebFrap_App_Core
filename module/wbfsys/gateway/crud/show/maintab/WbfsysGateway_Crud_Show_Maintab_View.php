 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysGateway Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysGateway = $this->model->getEntityWbfsysGateway();
    ...
    (
      ...
      array( 'text' => $entityWbfsysGateway->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Gateway.show  &amp;objid='.$entityWbfsysGateway
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Gateway.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_gateway-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/gateway/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysGateway_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Gateway.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_gateway' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_gateway a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Gateway.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Gateway.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysGateway_Crud_Show_Maintab_View
