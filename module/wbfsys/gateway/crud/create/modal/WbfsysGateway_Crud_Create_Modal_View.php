 ...
 * @licence WebFrap.net
 */
class WbfsysGateway_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysGateway entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Gateway.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Gateway.insert';
    $params->formId       = 'wgt-form-wbfsys_gateway';
    $params->namespace   = 'wbfsys_gateway-create';
    ...
    $this->setTemplate( 'wbfsys/gateway/modal/crud/form_create' );
...
}//end class WbfsysGateway_Crud_Create_Modal_View
