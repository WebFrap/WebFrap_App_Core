 ...
 * @licence WebFrap.net
 */
class WbfsysMyTasks_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMyTasks_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMyTasks', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysTask_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WbfsysMyTasks_Widget_Table_Ui
