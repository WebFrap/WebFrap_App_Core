 ...
 * @licence WebFrap.net
 */
class WbfsysMyTasks_Widget_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    {
      $entityWbfsysProcessNode = $orm->get( 'WbfsysProcessNode', 'rowid = '.$data['wbfsys_task']->id_status );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysTask_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysTask_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}// end class WbfsysMyTasks_Widget_Table_Model
