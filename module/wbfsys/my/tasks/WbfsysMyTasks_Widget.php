 ...
 *
 * @package WebFrap
 * @subpackage wbfsys_my_tasks
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WbfsysMyTasks_Widget
  extends WgtWidget
{
  /**
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WbfsysMyTasks_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WbfsysMyTasks_Widget' );
    ...
    $table = new WbfsysMyTasks_Widget_Table_Element( 'tableWbfsysMyTasksItem', $view );
    $table->setId( 'wgt-table-wbfsys_my_tasks-widget' );
    ...
    $params->searchFormId = 'wgt-form-wbfsys_my_tasks-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WbfsysMyTasks_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.Task.create&amp;ltab=table&amp;target_mask=WbfsysMyTasks_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.Task_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Wbfsys My Tasks"  >
      <form
        id="wgt-form-wbfsys_my_tasks-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WbfsysMyTasks.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-wbfsys_my_tasks-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WbfsysMyTasks_Widget_Table_Element
    (
      'tableWbfsysMyTasksItem',
      $view
    );
...
}// end class WbfsysMyTasks_Widget
