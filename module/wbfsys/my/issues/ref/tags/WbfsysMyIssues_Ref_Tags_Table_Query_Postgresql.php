 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Tags_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_entity_tag.rowid as "wbfsys_entity_tag_rowid"', // variant:  
      'wbfsys_tag.name as "wbfsys_tag_name"', // variant:  
      'wbfsys_tag.rowid as "wbfsys_tag_rowid"', // variant:  
    );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_tag.vid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_tag.vid = '.$condition );
        }
        else
        {
...
}//end class WbfsysMyIssues_Ref_Tags_Table_Query_Postgresql
