 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysMyIssues, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMyIssues_Ref_Tags_Table' );
    /* @var $query WbfsysMyIssues_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysMyIssues );
...
}//end class WbfsysMyIssues_Ref_Tags_Table_Model
