 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Tags_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_my_issues-tags';
   ...
   */
  public $namespace   = 'WbfsysMyIssues_Ref_Tags';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityTag.show&amp;target_mask=WbfsysMyIssues_Ref_Tags&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityTag.edit&amp;target_mask=WbfsysMyIssues_Ref_Tags&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_tag.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityTag.delete&amp;target_mask=WbfsysMyIssues_Ref_Tags&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_tag.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.EntityTag.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_tag_name'])).'</a></td>'.NL;
...
}//end class WbfsysMyIssues_Ref_Tags_Table_Element
