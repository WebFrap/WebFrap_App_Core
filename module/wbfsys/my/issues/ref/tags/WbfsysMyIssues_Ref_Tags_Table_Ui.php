 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMyIssues_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysMyIssues, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMyIssues_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_my_issues-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysMyIssues;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_my_issues-ref-tags-search-'
        .$idWbfsysMyIssues;
    ...
    $tabPanel->searchKey = 'wbfsys_my_issues-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysMyIssues_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysMyIssues );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.MyIssues_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysMyIssues_Ref_Tags_Table_Ui
