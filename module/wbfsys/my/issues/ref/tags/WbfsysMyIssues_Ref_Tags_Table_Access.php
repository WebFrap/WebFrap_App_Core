 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_my_issues-ref-tags' );
  ...
  /**
   * @param WbfsysMyIssues_Ref_Tags_Table_Query $query
...
}//end class WbfsysMyIssues_Ref_Tags_Table_Access
