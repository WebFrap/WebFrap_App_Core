 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.MyIssues_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_my_issues-ref-comments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Comments' );

    // set the default table template
    $this->setTemplate( 'wbfsys/my_issues/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysMyIssues_Ref_Comments_Table' );
...
}//end class WbfsysMyIssues_Ref_Comments_Table_Modal_View
