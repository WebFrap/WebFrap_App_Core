 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.MyIssues_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysMyIssues_Ref_Comments_Table_Ajax_View
