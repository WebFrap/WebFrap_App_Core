 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMyIssues_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_my_issues-ref-comments';
    ...
    (
      $params->tabId,
      'WbfsysMyIssues_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMyIssues_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_my_issues-ref-comments-'.$listType.'-ajax',
    	'WbfsysMyIssues_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysMyIssues
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_my_issues-ref-comments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysMyIssues_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMyIssues_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMyIssues_Ref_Comments_'.$listType );
...
} // end WbfsysMyIssues_Ref_Comments_Controller
