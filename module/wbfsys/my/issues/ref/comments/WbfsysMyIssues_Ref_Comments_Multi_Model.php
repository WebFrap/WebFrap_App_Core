 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Comments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listComments as $entityWbfsysMyIssues )
      {
        if(!$orm->save( $entityWbfsysMyIssues) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save My Issues '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved My Issues '.$entityText,
              'wbfsys.my_issues.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved My Issues: '.$textSaved,
          'wbfsys.my_issues.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysMyIssues_Ref_Comments_Multi_Model
