 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysMyIssues
   *
   * @param int $idWbfsysMyIssues the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysMyIssues, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMyIssues_Ref_Comments_Table' );
    /* @var $query WbfsysMyIssues_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysMyIssues );
...
}//end class WbfsysMyIssues_Ref_Comments_Table_Model
