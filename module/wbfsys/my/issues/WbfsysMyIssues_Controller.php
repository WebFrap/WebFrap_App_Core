 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_my_issues
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MyIssues.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_my_issues-create';

    $access = new WbfsysMyIssues_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_my_issues-create',
      'WbfsysMyIssues_Crud_Create',
      'displayForm',
      null,
      true
    );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MyIssues.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMyIssues = $model->getEntityWbfsysMyIssues( $objid );
    ...
    $params->entity = $entityWbfsysMyIssues;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_my_issues:edit';
    ...
    $view = $response->loadView
    (
      'form-wbfsys_my_issues-edit-'.$objid,
      'WbfsysMyIssues_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    $process_Handling->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'wbfsys_my_issues-edit',
          $entityWbfsysMyIssues,
          'Edit My Issues :'.$entityWbfsysMyIssues->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_my_issues';
      $params->maskRoot      = 'wbfsys_my_issues:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_my_issues';
      $params->aclNode       = 'mgmt-wbfsys_my_issues';
      $params->aclLevel      = 1;
    }
...
$process_Handling->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_my_issues-show',
          $entityWbfsysMyIssues,
          'Show My Issues :'.$entityWbfsysMyIssues->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_my_issues
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MyIssues.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-insert';

    $access = new WbfsysMyIssues_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
...
$params->process_Handling = $process_Handling;
$process_Handling->setEntity( $model->getEntityWbfsysMyIssues() );
...
$process_Handling->call( 'init', 'fail', $params );
    ...
    else
    {
    	...
    	$entityWbfsysMyIssues = $model->getEntity();
...
$process_Handling->call( 'init', 'sucess', $params );
      ...
      // model wird benötigt
      /* @var $model WbfsysMyIssues_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
...
$process_Handling->call( 'init', 'after', $params );
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MyIssues.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMyIssues, $params, $process_Handling ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMyIssues_Crud_Model $model the model
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-delete-'.$objid;
...
if( $error )
{
  return $error;
    ...
    $error = $model->delete( $entityWbfsysMyIssues, $params );
...
$process_Handling->call( 'delete', 'after', $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMyIssues, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MyIssues.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-listing';
    ...
    $containerClass = 'WbfsysMyIssues_'.$listType.'_Access';
    ...
    /* @var $model WbfsysMyIssues_Table_Model */
    $model = $this->loadModel( 'WbfsysMyIssues_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_my_issues-'.$params->ltype,
          'WbfsysIssue',
          'List of My Issuess'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMyIssues
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMyIssues_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_my_issues',
      'WbfsysMyIssues_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMyIssues_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MyIssues.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMyIssues_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMyIssues_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_my_issues-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_my_issues-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_my_issues',
      'WbfsysMyIssues',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMyIssues, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-append-'.$objid;
    ...
    // fetch the data from the http request and load it in the model registry
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMyIssues, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
    ...
    $ui = $this->loadUi( 'WbfsysMyIssues_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMyIssues_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_my_issues-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysMyIssues_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysMyIssues, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_my_issues' ); //def wbfsys_my_issues
...
} // end class WbfsysMyIssues_Controller */
