 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_my_issues']->id_status )
    {
      ...
      (
        'WbfsysProcessNode',
        'rowid = '.$data['wbfsys_my_issues']->id_status,
        'label'
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMyIssues_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMyIssues_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysMyIssues_Selection_Model
