 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMyIssues_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMyIssues_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMyIssues_Selection_Element
    (
      'selectionWbfsysMyIssues',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection My Issues', 'wbfsys.my_issues.label' ) ;
      $tabPanel->searchKey = 'wbfsys_my_issues';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MyIssues.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMyIssues',
      'WbfsysMyIssues_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMyIssues' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysMyIssues listing maske
   *
   * @param WbfsysMyIssues_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMyIssues  = $model->getEntityWbfsysMyIssues();
    ...
    $formWbfsysMyIssues->setKeyName( 'wbfsys_my_issues' );
...
}//end class WbfsysMyIssues_Selection_Ui
