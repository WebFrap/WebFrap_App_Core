...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für My Issues
  *
  ...
  *  }
  *
  * @return WbfsysMyIssues_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMyIssues_Table_Element( 'tableWbfsysMyIssues', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_my_issues-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'My Issues', 'wbfsys.my_issues.label' );
      ...
      $searchElement->searchKey = 'wbfsys_my_issues';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMyIssues_Table_Element( null,$view );
...
}//end class WbfsysMyIssues_Table_Ui
