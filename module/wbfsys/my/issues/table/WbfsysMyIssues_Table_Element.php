  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.MyIssues_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.my_issues.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_my_issues_title']).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueType.listing" >'.Validator::sanitizeHtml($row['wbfsys_issue_type_name']).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Category.listing" >'.Validator::sanitizeHtml($row['wbfsys_category_name']).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_process_node_label']).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueSeverity.listing" >'.Validator::sanitizeHtml($row['wbfsys_issue_severity_name']).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Os.listing" >'.Validator::sanitizeHtml($row['wbfsys_os_name']).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Priority.listing" >'.Validator::sanitizeHtml($row['wbfsys_priority_name']).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Browser.listing" >'.Validator::sanitizeHtml($row['wbfsys_browser_name']).'</a></td>'.NL;
