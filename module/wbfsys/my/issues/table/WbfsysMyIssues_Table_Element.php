 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_my_issues';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMyIssues_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MyIssues.show&amp;target_mask=WbfsysMyIssues&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MyIssues.edit&amp;target_mask=WbfsysMyIssues&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.my_issues.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.MyIssues_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.my_issues.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=Wbfsys.MyIssues_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.my_issues.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MyIssues.delete&amp;target_mask=WbfsysMyIssues&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.my_issues.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_my_issues&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.my_issues.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Category', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Process Status', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Severity', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Os', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Priority', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Browser', 'wbfsys.issue.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Progress', 'wbfsys.issue.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_my_issues_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_my_issues_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_issue_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Category.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_category_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_process_node_label'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.IssueSeverity.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_issue_severity_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Os.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Priority.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_priority_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Browser.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_browser_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >
                      <div class="wcm wcm_ui_progress" >'.
                      (
                        !is_null($row['wbfsys_my_issues_progress'])
                        ?$row['wbfsys_my_issues_progress']
                        :0
                      ).'</div>
                      </td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MyIssues_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected My Issues." >{$iconDelete} Delete selected My Issues</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! My Issues. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MyIssues_Multi.deleteAll" >{$iconClean} Delete all My Issues</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMyIssues_Table_Element
