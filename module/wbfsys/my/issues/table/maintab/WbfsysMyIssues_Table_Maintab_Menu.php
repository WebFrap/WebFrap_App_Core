...
HTML;
  ...
  protected function entriesAcl( $params )
  {
    ...
    <li>
      ...
      <span>
      <ul>
                  <li><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MyIssues_Acl.listing" >{$iconMgmt} {$this->view->i18n->l( 'ACLs Management', 'wbf.label' )}</a></li>
          <li><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.Issue_Acl.listing" >{$iconEntity} {$this->view->i18n->l( 'ACLs Entity', 'wbf.label' )}</a></li>
      </ul>
      </span>
    </li>
