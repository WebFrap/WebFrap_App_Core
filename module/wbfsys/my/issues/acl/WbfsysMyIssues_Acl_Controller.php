 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMyIssues
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMyIssues_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysMyIssues_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMyIssues_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMyIssues_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_my_issues-acl',
    	'WbfsysMyIssues_Acl',
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMyIssues_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMyIssues_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMyIssues_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMyIssues_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMyIssues_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMyIssues_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_my_issues-acl-qfdu',
    	'WbfsysMyIssues_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMyIssues_Acl_Controller */
