 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_my_issues' )->getid();

  }//end public function getAreaId */

  /**
   * request the id of the activ entity area
   * @return int
   *
   */
  public function getEntityAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_issue' )->getid();

  }//end public function getEntityAreaId */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryDataAccess( $view,  $params )
  {
    ...
    $tabData['wbfsys_role_group_name'] = $orm->getField( 'WbfsysRoleGroup', $data['wbfsys_security_access']->id_group , 'name' );
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialMod->id_area     = $orm->getByKey( 'WbfsysSecurityArea', 'mod-wbfsys' );
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_issue' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function pushMgmtConfigurationToEntity( $params )
  {
    ...
    $groupQuery   = $db->newQuery( 'WbfsysMyIssues_Acl_SyncGroup' );
    /* @var $groupQuery WbfsysMyIssues_Acl_SyncGroup_Query  */
    ...
    foreach( $groupQuery as $entry )
    {
      ...
      $partialEntity->id_group   = $entry['wbfsys_security_access_id_group'];
      $partialEntity->partial        = 0;
      $partialEntity->access_level   = $entry['wbfsys_security_access_access_level'];
    ...
    $assignmentQuery = $db->newQuery( 'WbfsysMyIssues_Acl_SyncAssignment' );
    /* @var $assignmentQuery WbfsysMyIssues_Acl_SyncAssignment_Query  */
    ...
    foreach( $assignmentQuery as $entry )
    {
      ...
      $partUser->id_user    = $entry['wbfsys_group_users_id_user'];
      $partUser->id_group   = $entry['wbfsys_group_users_id_group'];
      
      if( $entry['wbfsys_group_users_vid'] )
        $partUser->vid = $entry['wbfsys_group_users_vid'];
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMyIssues_Acl' );
    /* @var $query WbfsysMyIssues_Acl_Query  */
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysMyIssues_Acl_Table' );
    /* @var $query WbfsysMyIssues_Acl_Table_Query  */
...
} // end class WbfsysMyIssues_Acl_Model */
