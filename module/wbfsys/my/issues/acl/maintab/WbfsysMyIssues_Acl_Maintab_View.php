 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MyIssues_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_my_issues-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MyIssues_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_my_issues-acl-update';
    ...
    $this->setTemplate( 'wbfsys/my_issues/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'My Issues', 'wbfsys.my_issues.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_my_issues_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMyIssues_Acl' );
...
} // end class WbfsysMyIssues_Acl_Maintab_View */
