 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_my_issues_acl_graph', 
      'WbfsysMyIssues_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMyIssues_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMyIssues_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMyIssues_Acl_Path_Maintab_View  */
...
} // end class WbfsysMyIssues_Acl_Path_Controller */
