 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMyIssues_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMyIssues_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMyIssues, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMyIssues_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_my_issues-acl-dset' );
    ...
    else
    {
      ...
      (
        'My Issues "{@label@}" User Access',
        'wbfsys.my_issues.label',
        array
        (
          'label' => $entityWbfsysMyIssues->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_my_issues_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMyIssues_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMyIssues_Acl_Dset_Ui */
