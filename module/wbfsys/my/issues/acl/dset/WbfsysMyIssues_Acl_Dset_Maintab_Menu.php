 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Dset_Maintab_Menu
  extends WgtDropmenu
{////////////////////////////////////////////////////////////////////////////////
// build methodes
////////////////////////////////////////////////////////////////////////////////
    ...
    <span>
      <ul>
        <li><a 
          ...
          href="modal.php?c=Wbfsys.SecurityArea_Maintenance.help&amp;refer=wbfsys_my_issues-acl-dset" >{$iconHelp} Help</a>
        </li>
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Issue.create&amp;refer=wbfsys_my_issues-acl-dset" >{$iconBug} Bug</a>
        </li>
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Faq.create&amp;refer=wbfsys_my_issues-acl-dset" >{$iconFaq} Faq</a>
        </li>
      </ul>
    </span>
  </li>
...
HTML;
  ...
  public function addMenuLogic( $view, $objid, $params  )
  {
    ...
    self.getObject().find(".wgtac_mask_entity_rights").click(function(){
      ...
      self.close( );
      \$R.get( 'maintab.php?c=Wbfsys.Issue_Acl_Dset.listing&objid={$objid}' );
    });
    ...
    self.getObject().find('#wgt-button-wbfsys_my_issues-acl-form-append').click(function(){
    
      if(\$S('#wgt-input-wbfsys_my_issues-acl-id_group').val()==''){
      
        \$D.errorWindow('Error','Please select a group first');
        return false;
      }

      \$R.form('wgt-form-wbfsys_my_issues-acl-append');
      \$S('#wgt-form-wbfsys_my_issues-acl-append').get(0).reset();
      return false;
...
} // end class WbfsysMyIssues_Acl_Dset_Maintab_Menu */
