 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_my_issues'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMyIssues_Acl_Dset' );
    /* @var $query WbfsysMyIssues_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMyIssues_Acl_Dset_Treetable' );
    /* @var $query WbfsysMyIssues_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMyIssues_Acl_Dset_Model */
