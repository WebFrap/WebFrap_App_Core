 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMyIssues_Acl_Dset' );
    ...
    $entityWbfsysMyIssues = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMyIssues_Acl_Dset_Ajax_View */
