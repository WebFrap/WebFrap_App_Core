 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_my_issues.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMyIssues_Acl_Dset_Treetable_Query_Postgresql */
