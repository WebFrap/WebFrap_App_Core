 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_issue.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_issue.rowid as id,
    wbfsys_issue.title as value,
    wbfsys_issue.title as label
  FROM
    wbfsys_issue
  WHERE
    {$sqlWhere}
...
} // end class WbfsysMyIssues_Acl_Qfdu_Query_Postgresql */
