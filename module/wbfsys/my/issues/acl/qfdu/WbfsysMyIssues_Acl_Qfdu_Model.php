 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_my_issues')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMyIssues = $orm->get('WbfsysIssue', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_my_issues_title']  = $refEntityWbfsysMyIssues->title;

    }
    $tabData['wbfsys_my_issues_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMyIssues_Acl_Query Objekt
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMyIssues_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMyIssues_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMyIssues_Acl_Qfdu' );
    /* @var $query WbfsysMyIssues_Acl_Qfdu_Query  */
...
} // end class WbfsysMyIssues_Acl_Qfdu_Model */
