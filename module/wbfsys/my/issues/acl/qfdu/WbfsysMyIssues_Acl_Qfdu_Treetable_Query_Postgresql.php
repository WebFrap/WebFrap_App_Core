 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_issue.title as "wbfsys_my_issues_title"',
      'wbfsys_issue.rowid as "wbfsys_my_issues_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_issue on wbfsys_group_users.vid = wbfsys_issue.rowid'
    );
...
} // end class WbfsysMyIssues_Acl_Qfdu_Treetable_Query_Postgresql */
