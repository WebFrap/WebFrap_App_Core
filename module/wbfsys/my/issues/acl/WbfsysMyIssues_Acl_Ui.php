...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMyIssues_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMyIssues_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_my_issues-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'My Issues', 'wbfsys.my_issues.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_my_issues_acl';
...
} // end class WbfsysMyIssues_Acl_Ui */
