 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysIssue', array_keys( $this->fields['wbfsys_my_issues']), true ),
...
}//end class WbfsysMyIssues_Crud_Create_Form */
