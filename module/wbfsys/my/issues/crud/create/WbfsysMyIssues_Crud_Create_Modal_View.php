 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMyIssues entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MyIssues.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MyIssues.insert';
    $params->formId       = 'wgt-form-wbfsys_my_issues';
    $params->namespace   = 'wbfsys_my_issues-create';
    ...
    $this->setTemplate( 'wbfsys/my_issues/modal/crud/form_create' );
...
}//end class WbfsysMyIssues_Crud_Create_Modal_View
