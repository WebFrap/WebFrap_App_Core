 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMyIssues Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_my_issues-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/my_issues/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MyIssues.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_my_issues';
    ...
    $form = $this->newForm( 'WbfsysMyIssues_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MyIssues.create');}});
});
...
}//end class WbfsysMyIssues_Crud_Create_Maintab_View
