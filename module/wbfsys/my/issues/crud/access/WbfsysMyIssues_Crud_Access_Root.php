 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysIssue_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysIssue_Entity */
      $entity = $orm->get( 'WbfsysIssue', $rootId );
    }
...
}//end class WbfsysMyIssues_Crud_Access_Root
