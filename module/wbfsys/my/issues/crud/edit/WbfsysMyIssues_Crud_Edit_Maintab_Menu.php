 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Edit_Maintab_Menu
  extends WgtDropmenu
{
    ...
    <div class="wgt-dropdownbox" id="{$this->id}-cruddropbox" >
      <ul id="{$this->id}-cruddrop-menu"  >
        <li><a
          ...
          title="Save the My Issues and close the Tab after saving" >{$iconSaveUCl} {$view->i18n->l('Save &amp; Close','wbf.label')}</a></li>
      </ul>
        ...
        <li>
          ...
          <span>
            <ul>
              <li>
                <a 
                  href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_my_issues&amp;objid={$objid}" 
                  class="wcm wcm_req_ajax" >{$iconMgmt} {$view->i18n->l( 'ACLs Management', 'wbf.label' )}</a>
              </li>
              <li>
                <a 
                  href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_issue&amp;objid={$objid}" 
...
$entries->entryProcess_Handling = $params->processForm_Handling->render( $params );
...
HTML;
  ...
  <div class="wgt-panel-control" >
    <button
      class="wcm wcm_ui_button wgtac_back_to_list wcm_ui_tip-top"
      title="Go back to the My Issues list" >{$iconBack} {$view->i18n->l('Back to the list','wbf.label')}</button>
  </div>
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_my_issues-edit" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
HTML;
      ...
      if( $this->acl->access( 'mod-wbfsys>mgmt-wbfsys_issue:access', $objid ) )
      {
        $html .= '<li><a class="wgtac_mask_wbfsys_issue" >'.$iconMask.' '.$this->view->i18n->l('Issue','wbfsys.issue.label').'</a></li>'.NL;
        ++ $numEntries;
      }
    ...
    $html = <<<HTML
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolDataset&dkey=wbfsys_issue&amp;objid={$objid}" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
          </li>


          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsDataset&dkey=wbfsys_issue&amp;objid={$objid}" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
          </li>


          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.showMeta&dkey=wbfsys_issue&amp;objid={$objid}" >{$iconMetaData} {$this->view->i18n->l( 'Meta Data', 'wbf.label' )}</a>
          </li>
...
}//end class WbfsysMyIssues_Crud_Edit_Maintab_Menu
