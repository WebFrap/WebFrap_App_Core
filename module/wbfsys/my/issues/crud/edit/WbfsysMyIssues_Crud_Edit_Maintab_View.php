 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMyIssues Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMyIssues = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MyIssues.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMyIssues
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MyIssues.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_my_issues-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/my_issues/maintab/crud/form_edit' );
...
$params->processForm_Handling = $processForm_Handling;
    ...
    $form = $this->newForm( 'WbfsysMyIssues_Crud_Edit' );
    ...
    $params->process_Handling->injectValidationInForm( $form, 'wbfsys_my_issues' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_issue").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.Issue.edit&objid={$objid}');
    });
...
}//end class WbfsysMyIssues_Crud_Edit_Maintab_View
