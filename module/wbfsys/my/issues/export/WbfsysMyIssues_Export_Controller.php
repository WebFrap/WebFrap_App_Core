 ...
 * @licence WebFrap.net
 */
class WbfsysMyIssues_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMyIssues_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMyIssues_Export_Listing_Access';
    ...
    // create a new WbfsysMyIssues window
    $view = $this->loadView
    (
    	'export-wbfsys_my_issues',
    	'WbfsysMyIssues_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMyIssues_Export' );
...
} // end class WbfsysMyIssues_Export_Controller_Genf
