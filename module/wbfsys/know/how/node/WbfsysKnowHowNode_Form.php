...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_know_how_node';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysKnowHowNode';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysKnowHowNode' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysKnowHowNode entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Know How Node)', 'wbfsys.know_how_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.know_how_node.label' ),
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Know How Node)', 'wbfsys.know_how_node.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.know_how_node.label' ),
  ...
  * @return void
  */
  public function input_id_repository( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysKnowHowRepository_Entity' ) )
    {
      ...
      $inputIdRepository = $this->view->newInput( 'input'.$this->prefix.'IdRepository', 'Window' );
      $inputIdRepository->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_repository]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_repository'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Repository (Know How Node)', 'wbfsys.know_how_node.label' ),
      ));
      ...
      $inputIdRepository->setReadOnly( $this->isReadOnly( 'id_repository' ) );
      $inputIdRepository->setLabel( $this->view->i18n->l( 'Repository', 'wbfsys.know_how_node.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.KnowHowRepository.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_repository'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdRepository->buildJavascript( 'wgt-input-'.$this->keyName.'_id_repository'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_repository */
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_lang'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Language (Know How Node)', 'wbfsys.know_how_node.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Language', 'wbfsys.know_how_node.label' ) );
  ...
  * @return void
  */
  public function input_raw_content( $params )
  {

      //p: textarea
      $inputRawContent = $this->view->newInput( 'input'.$this->prefix.'RawContent', 'Wysiwyg' );
      $inputRawContent->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[raw_content]',
          'id'    => 'wgt-input-'.$this->keyName.'_raw_content'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip full large-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Raw content (Know How Node)', 'wbfsys.know_how_node.label' ),
        )
      );
      ...
      $inputRawContent->setReadOnly( $this->isReadOnly( 'raw_content' ) );
      $inputRawContent->setLabel
      (
        $this->view->i18n->l( 'Raw content', 'wbfsys.know_how_node.label' ),
        $this->entity->required('raw_content')
      );
  ...
  }//end public function input_raw_content */
  ...
  */
  public function input_content( $params )
  {
      ...
      //tpl: class ui:hidden
      $inputContent = $this->view->newInput( 'input'.$this->prefix.'Content', 'Hidden' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Content (Know How Node)', 'wbfsys.know_how_node.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Know How Node)', 'wbfsys.know_how_node.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.know_how_node.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Know How Node)', 'wbfsys.know_how_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.know_how_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Know How Node)', 'wbfsys.know_how_node.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.know_how_node.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Know How Node)', 'wbfsys.know_how_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.know_how_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Know How Node)', 'wbfsys.know_how_node.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.know_how_node.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Know How Node)', 'wbfsys.know_how_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.know_how_node.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Know How Node)', 'wbfsys.know_how_node.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.know_how_node.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Know How Node)', 'wbfsys.know_how_node.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Know How Node)', 'wbfsys.know_how_node.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
 ...
 /**
  * create the search element for field raw_content
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_raw_content( $params )
  {

      //tpl: Wysiwyg search class ui:text
      $inputRawContent = $this->view->newInput( 'input'.$this->prefix.'RawContent' , 'Text' );
      $this->items['raw_content'] = $inputRawContent;
      $inputRawContent->addAttributes
      (
        array
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Raw content (Know How Node)', 'wbfsys.know_how_node.label' ),
        )
      );
      $inputRawContent->setWidth( 'full' );

      $inputRawContent->setReadOnly( $this->isReadOnly( 'raw_content' ) );
      $inputRawContent->setData( $this->entity->getSecure( 'raw_content') );
      $inputRawContent->setLabel
      (
        $this->view->i18n->l( 'Raw content', 'wbfsys.know_how_node.label' ),
        $this->entity->required( 'raw_content' )
  ...
  }//end public function search_raw_content */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_know_how_node_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_know_how_node_m_role_change';
...
}//end class WbfsysKnowHowNode_Form */
