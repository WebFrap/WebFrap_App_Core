 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysKnowHowNode Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_know_how_node-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/know_how_node/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.KnowHowNode.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_know_how_node';
    ...
    $form = $this->newForm( 'WbfsysKnowHowNode_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.KnowHowNode.create');}});
});
...
}//end class WbfsysKnowHowNode_Crud_Create_Maintab_View
