 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysKnowHowNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysKnowHowNode = $this->model->getEntityWbfsysKnowHowNode();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Know How Node: {@text@}',
      'wbfsys.know_how_node.label',
      array( 'text' => $entityWbfsysKnowHowNode->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.KnowHowNode.show  &amp;objid='.$entityWbfsysKnowHowNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.KnowHowNode.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_know_how_node-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/know_how_node/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysKnowHowNode_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.KnowHowNode.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_know_how_node' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_know_how_node a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.KnowHowNode.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.KnowHowNode.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysKnowHowNode_Crud_Show_Maintab_View
