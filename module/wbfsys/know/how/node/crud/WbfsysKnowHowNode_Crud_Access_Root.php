 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysKnowHowNode_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysKnowHowNode_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysKnowHowNode_Entity */
      $entity = $orm->get( 'WbfsysKnowHowNode', $rootId );
    }
...
}//end class WbfsysKnowHowNode_Crud_Access_Root
