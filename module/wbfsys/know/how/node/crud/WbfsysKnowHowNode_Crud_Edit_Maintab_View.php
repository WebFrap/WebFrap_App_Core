 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysKnowHowNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysKnowHowNode = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Know How Node: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.KnowHowNode.edit&amp;utf8=✓&amp;objid='.$entityWbfsysKnowHowNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.KnowHowNode.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_know_how_node-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/know_how_node/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysKnowHowNode_Crud_Edit' );
...
}//end class WbfsysKnowHowNode_Crud_Edit_Maintab_View
