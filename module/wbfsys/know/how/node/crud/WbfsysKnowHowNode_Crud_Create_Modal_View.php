 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysKnowHowNode entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.KnowHowNode.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.KnowHowNode.insert';
    $params->formId       = 'wgt-form-wbfsys_know_how_node';
    $params->namespace   = 'wbfsys_know_how_node-create';
    ...
    $this->setTemplate( 'wbfsys/know_how_node/modal/crud/form_create' );
...
}//end class WbfsysKnowHowNode_Crud_Create_Modal_View
