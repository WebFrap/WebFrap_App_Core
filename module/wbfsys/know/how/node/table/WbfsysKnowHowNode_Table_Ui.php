 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Know How Nodes
  *
  ...
  *  }
  *
  * @return WbfsysKnowHowNode_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysKnowHowNode_Table_Element( 'tableWbfsysKnowHowNode', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_know_how_node-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Know How Nodes', 'wbfsys.know_how_node.label' );
      //$tabPanel->searchKey = 'wbfsys_know_how_node';
      ...
      $searchElement->searchKey = 'wbfsys_know_how_node';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysKnowHowNode_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysKnowHowNode', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysKnowHowNode listing maske
   *
   * @param WbfsysKnowHowNode_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysKnowHowNode  = $model->getEntityWbfsysKnowHowNode();
    ...
    $formWbfsysKnowHowNode->setKeyName( 'wbfsys_know_how_node' );
...
}//end class WbfsysKnowHowNode_Table_Ui
