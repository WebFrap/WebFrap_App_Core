 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysKnowHowNode_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_know_how_node.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_know_how_node.rowid ",
      'acls'
    );
...
}//end class WbfsysKnowHowNode_Table_Access
