 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_know_how_node';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysKnowHowNode_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.KnowHowNode.show&amp;target_mask=WbfsysKnowHowNode&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.KnowHowNode.edit&amp;target_mask=WbfsysKnowHowNode&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.know_how_node.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.KnowHowNode.delete&amp;target_mask=WbfsysKnowHowNode&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.know_how_node.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.know_how_node.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_know_how_node_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_know_how_node_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.KnowHowNode_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Know How Nodes." >{$iconDelete} Delete selected Know How Nodes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Know How Nodes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.KnowHowNode_Multi.deleteAll" >{$iconClean} Delete all Know How Nodes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysKnowHowNode_Table_Element
