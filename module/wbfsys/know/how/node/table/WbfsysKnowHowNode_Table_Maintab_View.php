 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowNode_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysKnowHowNode_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysKnowHowNode_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/know_how_node/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Know How Nodes',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.KnowHowNode.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.KnowHowNode.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysKnowHowNode_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.KnowHowNode.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.KnowHowNode.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.KnowHowNode.create&amp;ltype=table');
    });
...
}//end class WbfsysKnowHowNode_Table_Maintab_View
