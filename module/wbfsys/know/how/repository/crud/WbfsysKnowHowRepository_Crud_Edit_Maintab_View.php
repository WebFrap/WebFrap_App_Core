 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysKnowHowRepository Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysKnowHowRepository = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Know How Repository: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.KnowHowRepository.edit&amp;utf8=✓&amp;objid='.$entityWbfsysKnowHowRepository
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.KnowHowRepository.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_know_how_repository-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/know_how_repository/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysKnowHowRepository_Crud_Edit' );
...
}//end class WbfsysKnowHowRepository_Crud_Edit_Maintab_View
