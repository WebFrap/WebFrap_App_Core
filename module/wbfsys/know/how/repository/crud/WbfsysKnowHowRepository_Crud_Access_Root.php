 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysKnowHowRepository_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysKnowHowRepository_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysKnowHowRepository_Entity */
      $entity = $orm->get( 'WbfsysKnowHowRepository', $rootId );
    }
...
}//end class WbfsysKnowHowRepository_Crud_Access_Root
