 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysKnowHowRepository Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_know_how_repository-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/know_how_repository/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.KnowHowRepository.insert&amp;utf8=✓';
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.KnowHowRepository.create');}});
});
...
}//end class WbfsysKnowHowRepository_Crud_Create_Maintab_View
