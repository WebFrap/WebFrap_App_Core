 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_know_how_repository';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysKnowHowRepository_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.KnowHowRepository.show&amp;target_mask=WbfsysKnowHowRepository&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.KnowHowRepository.edit&amp;target_mask=WbfsysKnowHowRepository&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.know_how_repository.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.KnowHowRepository.delete&amp;target_mask=WbfsysKnowHowRepository&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.know_how_repository.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.know_how_repository.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_know_how_repository_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_know_how_repository_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.KnowHowRepository_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Know How Repositorys." >{$iconDelete} Delete selected Know How Repositorys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Know How Repositorys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.KnowHowRepository_Multi.deleteAll" >{$iconClean} Delete all Know How Repositorys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysKnowHowRepository_Table_Element
