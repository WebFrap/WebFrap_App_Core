 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysKnowHowRepository_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_know_how_repository.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_know_how_repository.rowid ",
      'acls'
    );
...
}//end class WbfsysKnowHowRepository_Table_Access
