 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Know How Repositorys
  *
  ...
  *  }
  *
  * @return WbfsysKnowHowRepository_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysKnowHowRepository_Table_Element( 'tableWbfsysKnowHowRepository', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_know_how_repository-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Know How Repositorys', 'wbfsys.know_how_repository.label' );
      //$tabPanel->searchKey = 'wbfsys_know_how_repository';
      ...
      $searchElement->searchKey = 'wbfsys_know_how_repository';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysKnowHowRepository_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysKnowHowRepository', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysKnowHowRepository listing maske
   *
   * @param WbfsysKnowHowRepository_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysKnowHowRepository  = $model->getEntityWbfsysKnowHowRepository();
    ...
    $formWbfsysKnowHowRepository->setKeyName( 'wbfsys_know_how_repository' );
...
}//end class WbfsysKnowHowRepository_Table_Ui
