 ...
 * @licence WebFrap.net
 */
class WbfsysKnowHowRepository_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_know_how_repository
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.KnowHowRepository.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_know_how_repository-create';

    $access = new WbfsysKnowHowRepository_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_know_how_repository-create',
      'WbfsysKnowHowRepository_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysKnowHowRepository_Crud_Model */
    $model = $this->loadModel( 'WbfsysKnowHowRepository_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.KnowHowRepository.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysKnowHowRepository = $model->getEntityWbfsysKnowHowRepository( $objid );
    ...
    $params->entity = $entityWbfsysKnowHowRepository;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_know_how_repository:edit';

    $access = new WbfsysKnowHowRepository_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysKnowHowRepository );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_know_how_repository-edit-'.$objid,
      'WbfsysKnowHowRepository_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_know_how_repository:show';
    ...
    (
      'form-wbfsys_know_how_repository-edit-'.$objid,
      'WbfsysKnowHowRepository_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_know_how_repository
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.KnowHowRepository.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-insert';

    $access = new WbfsysKnowHowRepository_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysKnowHowRepository = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_know_how_repository-update-'.$entityWbfsysKnowHowRepository;
      ...
      {
        $access = new WbfsysKnowHowRepository_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysKnowHowRepository );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysKnowHowRepository';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_know_how_repository',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysKnowHowRepository_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.KnowHowRepository.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysKnowHowRepository, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysKnowHowRepository_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.KnowHowRepository.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-delete-'.$objid;

    $access = new WbfsysKnowHowRepository_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysKnowHowRepository );
    ...
    $error = $model->delete( $entityWbfsysKnowHowRepository, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysKnowHowRepository, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.KnowHowRepository.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.KnowHowRepository.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-listing';
    ...
    $containerClass = 'WbfsysKnowHowRepository_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_know_how_repository',
      'WbfsysKnowHowRepository_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysKnowHowRepository_Table_Model */
    $model = $this->loadModel( 'WbfsysKnowHowRepository_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysKnowHowRepository
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysKnowHowRepository_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_know_how_repository',
      'WbfsysKnowHowRepository_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysKnowHowRepository_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.KnowHowRepository.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysKnowHowRepository_Selection_Model */
    $model   = $this->loadModel( 'WbfsysKnowHowRepository_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_know_how_repository-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_know_how_repository-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_know_how_repository',
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysKnowHowRepository, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysKnowHowRepository_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysKnowHowRepository_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_know_how_repository-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysKnowHowRepository_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysKnowHowRepository, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_know_how_repository' );
...
} // end class WbfsysKnowHowRepository_Controller */
