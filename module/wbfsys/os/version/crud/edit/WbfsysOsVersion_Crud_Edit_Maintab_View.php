 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysOsVersion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysOsVersion = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit OS Version: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.OsVersion.edit&amp;utf8=✓&amp;objid='.$entityWbfsysOsVersion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.OsVersion.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_os_version-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/os_version/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysOsVersion_Crud_Edit' );
...
}//end class WbfsysOsVersion_Crud_Edit_Maintab_View
