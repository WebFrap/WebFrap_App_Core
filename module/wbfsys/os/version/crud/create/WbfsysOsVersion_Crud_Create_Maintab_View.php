 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysOsVersion Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_os_version-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/os_version/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.OsVersion.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_os_version';
    ...
    $form = $this->newForm( 'WbfsysOsVersion_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.OsVersion.create');}});
});
...
}//end class WbfsysOsVersion_Crud_Create_Maintab_View
