 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysOsVersion entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.OsVersion.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.OsVersion.insert';
    $params->formId       = 'wgt-form-wbfsys_os_version';
    $params->namespace   = 'wbfsys_os_version-create';
    ...
    $this->setTemplate( 'wbfsys/os_version/modal/crud/form_create' );
...
}//end class WbfsysOsVersion_Crud_Create_Modal_View
