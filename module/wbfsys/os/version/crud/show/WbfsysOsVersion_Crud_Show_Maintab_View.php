 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysOsVersion_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysOsVersion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysOsVersion = $this->model->getEntityWbfsysOsVersion();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show OS Version: {@text@}',
      'wbfsys.os_version.label',
      array( 'text' => $entityWbfsysOsVersion->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.OsVersion.show  &amp;objid='.$entityWbfsysOsVersion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.OsVersion.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_os_version-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/os_version/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysOsVersion_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.OsVersion.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_os_version' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_os_version a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.OsVersion.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.OsVersion.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysOsVersion_Crud_Show_Maintab_View
