 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysOsVersion_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysOsVersion_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysOsVersion_Entity */
      $entity = $orm->get( 'WbfsysOsVersion', $rootId );
    }
...
}//end class WbfsysOsVersion_Crud_Access_Root
