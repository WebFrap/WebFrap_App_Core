 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_os_version';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysOsVersion_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.OsVersion.show&amp;target_mask=WbfsysOsVersion&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.OsVersion.edit&amp;target_mask=WbfsysOsVersion&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.os_version.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.OsVersion.delete&amp;target_mask=WbfsysOsVersion&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.os_version.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.os_version.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Code name', 'wbfsys.os_version.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_os_version_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.OsVersion.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_version_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.OsVersion.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_version_code_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.OsVersion_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected OS Versions." >{$iconDelete} Delete selected OS Versions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! OS Versions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.OsVersion_Multi.deleteAll" >{$iconClean} Delete all OS Versions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysOsVersion_Table_Element
