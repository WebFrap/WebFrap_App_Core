 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für OS Versions
  *
  ...
  *  }
  *
  * @return WbfsysOsVersion_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysOsVersion_Table_Element( 'tableWbfsysOsVersion', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_os_version-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'OS Versions', 'wbfsys.os_version.label' );
      //$tabPanel->searchKey = 'wbfsys_os_version';
      ...
      $searchElement->searchKey = 'wbfsys_os_version';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysOsVersion_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysOsVersion', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysOsVersion listing maske
   *
   * @param WbfsysOsVersion_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysOsVersion_Table_Ui
