...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_os_version';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysOsVersion';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysOsVersion' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysOsVersion entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Os Version)', 'wbfsys.os_version.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.os_version.label' ),
  ...
  * @return void
  */
  public function input_code_name( $params )
  {

      //tpl: class ui:text
      $inputCodeName = $this->view->newInput( 'input'.$this->prefix.'CodeName' , 'Text' );
      $this->items['code_name'] = $inputCodeName;
      $inputCodeName->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[code_name]',
          'id'        => 'wgt-input-'.$this->keyName.'_code_name'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Code name (Os Version)', 'wbfsys.os_version.label' ),
          'maxlength' => $this->entity->maxSize( 'code_name' ),
        )
      );
      $inputCodeName->setWidth( 'medium' );

      $inputCodeName->setReadOnly( $this->isReadOnly( 'code_name' ) );
      $inputCodeName->setData( $this->entity->getSecure('code_name') );
      $inputCodeName->setLabel
      (
        $this->view->i18n->l( 'Code name', 'wbfsys.os_version.label' ),
        $this->entity->required( 'code_name' )
      );
  ...
  }//end public function input_code_name */
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Os Version)', 'wbfsys.os_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.os_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysOs_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Os (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      ...
      $inputIdOs->setLabel
      (
        $this->view->i18n->l( 'Os', 'wbfsys.os_version.label' ),
  ...
  * @return void
  */
  public function input_server_supported( $params )
  {

      //tpl: class ui:Checkbox
      $inputServerSupported = $this->view->newInput( 'input'.$this->prefix.'ServerSupported' , 'Checkbox' );
      $this->items['server_supported'] = $inputServerSupported;
      $inputServerSupported->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[server_supported]',
          'id'        => 'wgt-input-'.$this->keyName.'_server_supported'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Server Supported (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      $inputServerSupported->setWidth( 'medium' );

      $inputServerSupported->setReadOnly( $this->isReadOnly( 'server_supported' ) );
      $inputServerSupported->setActive( $this->entity->getBoolean( 'server_supported' ) );
      $inputServerSupported->setLabel
      (
        $this->view->i18n->l( 'Server Supported', 'wbfsys.os_version.label' ),
        $this->entity->required( 'server_supported' )
      );
  ...
  }//end public function input_server_supported */
  ...
  * @return void
  */
  public function input_released( $params )
  {

      //tpl: class ui:date
      $inputReleased = $this->view->newInput( 'input'.$this->prefix.'Released' , 'Date' );
      $this->items['released'] = $inputReleased;
      $inputReleased->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[released]',
          'id'        => 'wgt-input-'.$this->keyName.'_released'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Released (Os Version)', 'wbfsys.os_version.label' ),
          'maxlength' => $this->entity->maxSize( 'released' ),
        )
      );
      $inputReleased->setWidth( 'small' );

      $inputReleased->setReadOnly( $this->isReadOnly( 'released' ) );
      $inputReleased->setData( $this->entity->getDate( 'released' ) );
      $inputReleased->setLabel
      (
        $this->view->i18n->l( 'Released', 'wbfsys.os_version.label' ),
        $this->entity->required( 'released' )
      );
  ...
  }//end public function input_released */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.os_version.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.os_version.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Os Version)', 'wbfsys.os_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.os_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Os Version)', 'wbfsys.os_version.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.os_version.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Os Version)', 'wbfsys.os_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.os_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Os Version)', 'wbfsys.os_version.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.os_version.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.os_version.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Os Version)', 'wbfsys.os_version.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.os_version.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Os Version)', 'wbfsys.os_version.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
 ...
 /**
  * create the search element for field code_name
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_code_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_code_name'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Code name (Os Version)', 'wbfsys.os_version.label' ),
          'maxlength' => $this->entity->maxSize( 'code_name' ),
        )
      );
      $inputCodeName->setWidth( 'medium' );
  ...
  }//end public function search_code_name */
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Os Version)', 'wbfsys.os_version.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_os_version_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_os_version_m_role_change';
...
}//end class WbfsysOsVersion_Form */
