 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_os_version';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.OsVersion.show&amp;target_mask=WbfsysOsVersion&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.OsVersion.edit&amp;target_mask=WbfsysOsVersion&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.os_version.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.OsVersion.delete&amp;target_mask=WbfsysOsVersion&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.os_version.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_version_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_os_version_code_name'])).'</td>'.NL;
...
}//end class WbfsysOsVersion_Selection_Element
