 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysOsVersion_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysOsVersion_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/os_version/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'OS Version', 'wbfsys.os_version.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.OsVersion.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_os_version-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysOsVersion_Selection' );
...
}//end class WbfsysOsVersion_Selection_Modal_View
