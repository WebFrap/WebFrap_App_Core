 ...
 * @licence WebFrap.net
 */
class WbfsysOsVersion_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysOsVersion_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysOsVersion_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysOsVersion_Selection_Element
    (
      'selectionWbfsysOsVersion',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection OS Versions', 'wbfsys.os_version.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.OsVersion.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysOsVersion',
      'WbfsysOsVersion_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysOsVersion_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysOsVersion_Selection_Ui
