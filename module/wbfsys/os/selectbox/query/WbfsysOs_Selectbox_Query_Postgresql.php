 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysOs Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_os.rowid as id',
      'wbfsys_os.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_os.m_order as "wbfsys_os-m_order-order"' );

    $criteria->from( 'wbfsys_os' );



      $criteria->orderBy( 'wbfsys_os.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_os.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_os.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysOs_Selectbox_Query_Postgresql
