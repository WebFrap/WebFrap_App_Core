...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Operating Systems
  *
  ...
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysOs_Table_Element( 'tableWbfsysOs', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_os-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Operating Systems', 'wbfsys.os.label' );
      //$tabPanel->searchKey = 'wbfsys_os';
      ...
      $searchElement->searchKey = 'wbfsys_os';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysOs_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysOs', $table->buildAjax() );
