 ...
 * If you want to extend this class write your coden in ControllerWbfsysOs
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Ref_Version_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_os management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysOs_Ref_Version_".$listType."_Access";
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_os-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysOs_Ref_Version_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysOs_Ref_Version_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_os-ref-version-'.$listType.'-ajax',
    	'WbfsysOs_Ref_Version_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysOsVersion by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_os_version' ); //def wbfsys_os_version


  } // end public function cleanPost */

} // end WbfsysOs_Ref_Version_Controller
