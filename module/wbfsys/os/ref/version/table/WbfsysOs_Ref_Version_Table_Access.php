 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Ref_Version_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_os_version Attributes: name; code_name; access_key; id_os; server_supported; released; description; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  ...
  /**
   * @param WbfsysOs_Ref_Version_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_os_version.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_os_version.rowid ",
      'acls'
    );
...
}//end class WbfsysOs_Ref_Version_Table_Access
