 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Ref_Version_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_os_version.rowid as "wbfsys_os_version_rowid"', // variant:  
      'wbfsys_os_version.name as "wbfsys_os_version_name"', // variant:  
      'wbfsys_os_version.code_name as "wbfsys_os_version_code_name"', // variant:  
    );
...
}//end class WbfsysOs_Ref_Version_Table_Query_Postgresql
