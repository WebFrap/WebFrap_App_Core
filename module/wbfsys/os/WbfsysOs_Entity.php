 ...
 *
 * Entity Class for the Database Table wbfsys_os
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Os.show';
  ...
  */
  public static $entityName  = 'WbfsysOs';

 /**
  * the description
  * @var string $description
  */
  public static $description  = 'issue os';

 /**
  * the default lable
  * @var string
  */
  public static $label  = 'Os';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'wbfsys.os.message.error_def_name',
      'wrong'   => 'wbfsys.os.message.error_wrong_name',
      'max'     => 'wbfsys.os.message.error_max_name',
      'min'     => 'wbfsys.os.message.error_min_name',
    ),

    'access_key' => array
    (
      'default' => 'wbfsys.os.message.error_def_access_key',
      'wrong'   => 'wbfsys.os.message.error_wrong_access_key',
      'max'     => 'wbfsys.os.message.error_max_access_key',
      'min'     => 'wbfsys.os.message.error_min_access_key',
    ),

    'description' => array
    (
      'default' => 'wbfsys.os.message.error_def_description',
      'wrong'   => 'wbfsys.os.message.error_wrong_description',
      'max'     => 'wbfsys.os.message.error_max_description',
      'min'     => 'wbfsys.os.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.os.message.error_def_rowid',
      'wrong'   => 'wbfsys.os.message.error_wrong_rowid',
      'empty'   => 'wbfsys.os.message.error_empty_rowid',
      'max'     => 'wbfsys.os.message.error_max_rowid',
      'min'     => 'wbfsys.os.message.error_min_rowid',
    ),
  );

}//end class WbfsysOs_Entity
