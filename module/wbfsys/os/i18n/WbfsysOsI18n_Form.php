...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysOsI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysOsI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysOsI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysOsI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Os I18n)', 'wbfsys.os_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.os_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_os
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_os( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysOs_Entity' ) )
    {
      ...
      //p: Window
      $objidWbfsysOs = $this->entity->getData('id_wbfsys_os') ;
      ...
      $inputIdWbfsysOs = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysOs', 'Window' );
      $inputIdWbfsysOs->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_os]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_os'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Os (Os I18n)', 'wbfsys.os_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysOs->assignedForm = $this->assignedForm;

      $inputIdWbfsysOs->setWidth( 'medium' );

      $inputIdWbfsysOs->setData( $this->entity->getData( 'id_wbfsys_os' )  );
      $inputIdWbfsysOs->setReadOnly( $this->isReadOnly( 'id_wbfsys_os' ) );
      $inputIdWbfsysOs->setLabel( $this->view->i18n->l( 'Wbfsys Os', 'wbfsys.os_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Os.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_os'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysOs->setListUrl ( $listUrl );
      $inputIdWbfsysOs->setListIcon( 'control/connect.png' );
      $inputIdWbfsysOs->setEntityUrl( 'maintab.php?c=Wbfsys.Os.edit' );
      $inputIdWbfsysOs->conEntity         = $entityWbfsysOs;
      $inputIdWbfsysOs->refresh           = $this->refresh;
      $inputIdWbfsysOs->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysOs->view = $this->view;
      $inputIdWbfsysOs->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_os'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysOs );
  ...
  }//end public function input_id_wbfsys_os */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Os I18n)', 'wbfsys.os_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.os_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Os I18n)', 'wbfsys.os_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.os_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Os I18n)', 'wbfsys.os_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.os_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Os I18n)', 'wbfsys.os_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.os_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Os I18n)', 'wbfsys.os_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.os_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Os I18n)', 'wbfsys.os_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.os_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Os I18n)', 'wbfsys.os_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.os_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Os I18n)', 'wbfsys.os_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.os_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Os I18n)', 'wbfsys.os_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.os_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Os I18n)', 'wbfsys.os_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Os I18n)', 'wbfsys.os_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_os_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_os_i18n_m_role_change';
