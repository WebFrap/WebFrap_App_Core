 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysOs entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Os.insert';
    $params->formId       = 'wgt-form-wbfsys_os';
    $params->namespace   = 'wbfsys_os-create';
    ...
    $this->setTemplate( 'wbfsys/os/modal/crud/form_create' );
...
}//end class WbfsysOs_Crud_Create_Modal_View
