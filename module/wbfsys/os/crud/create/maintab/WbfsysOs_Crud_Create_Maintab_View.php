 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysOs Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_os-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/os/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Os.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_os';
    ...
    $form = $this->newForm( 'WbfsysOs_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Os.create');}});
});
...
}//end class WbfsysOs_Crud_Create_Maintab_View
