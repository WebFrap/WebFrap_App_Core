 ...
 * @licence WebFrap.net
 */
class WbfsysOs_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysOs Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysOs = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Operating System: {@text@}',
      'wbfsys.os.label',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Os.edit&amp;utf8=✓&amp;objid='.$entityWbfsysOs
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Os.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_os-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/os/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysOs_Crud_Edit' );
...
}//end class WbfsysOs_Crud_Edit_Maintab_View
