 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_tags_related';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTagsRelated_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TagsRelated.show&amp;target_mask=WbfsysTagsRelated&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TagsRelated.edit&amp;target_mask=WbfsysTagsRelated&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tags_related.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TagsRelated.delete&amp;target_mask=WbfsysTagsRelated&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tags_related.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_tags_related_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.TagsRelated_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Tags Relateds." >{$iconDelete} Delete selected Tags Relateds</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Tags Relateds. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.TagsRelated_Multi.deleteAll" >{$iconClean} Delete all Tags Relateds</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTagsRelated_Table_Element
