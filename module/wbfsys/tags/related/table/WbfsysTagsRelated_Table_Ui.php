 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Tags Relateds
  *
  ...
  *  }
  *
  * @return WbfsysTagsRelated_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTagsRelated_Table_Element( 'tableWbfsysTagsRelated', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tags_related-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Tags Relateds', 'wbfsys.tags_related.label' );
      //$tabPanel->searchKey = 'wbfsys_tags_related';
      ...
      $searchElement->searchKey = 'wbfsys_tags_related';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTagsRelated_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTagsRelated', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTagsRelated listing maske
   *
   * @param WbfsysTagsRelated_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTagsRelated  = $model->getEntityWbfsysTagsRelated();
    ...
    $formWbfsysTagsRelated->setKeyName( 'wbfsys_tags_related' );
...
}//end class WbfsysTagsRelated_Table_Ui
