 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysTagsRelated_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_tags_related.rowid ",
      'acls'
    );
...
}//end class WbfsysTagsRelated_Table_Access
