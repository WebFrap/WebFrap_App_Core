 ...
 *
 * Entity Class for the Database Table wbfsys_tags_related
 * 
 * @package WebFrap
 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Entity
  extends Entity
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_tags_related';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.TagsRelated.show';
  ...
  */
  public static $entityName  = 'WbfsysTagsRelated';
  ...
  * @var string
  */
  public static $label  = 'Tags Related';
  ...
  */
  ...
  (
    'id_tag' => array
    (
      'default' => 'wbfsys.tags_related.message.error_def_id_tag',
      'wrong'   => 'wbfsys.tags_related.message.error_wrong_id_tag',
      'max'     => 'wbfsys.tags_related.message.error_max_id_tag',
      'min'     => 'wbfsys.tags_related.message.error_min_id_tag',
    ),

    'id_related' => array
    (
      'default' => 'wbfsys.tags_related.message.error_def_id_related',
      'wrong'   => 'wbfsys.tags_related.message.error_wrong_id_related',
      'max'     => 'wbfsys.tags_related.message.error_max_id_related',
      'min'     => 'wbfsys.tags_related.message.error_min_id_related',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.tags_related.message.error_def_rowid',
      'wrong'   => 'wbfsys.tags_related.message.error_wrong_rowid',
      'empty'   => 'wbfsys.tags_related.message.error_empty_rowid',
      'max'     => 'wbfsys.tags_related.message.error_max_rowid',
      'min'     => 'wbfsys.tags_related.message.error_min_rowid',
    ),
  );

}//end class WbfsysTagsRelated_Entity
