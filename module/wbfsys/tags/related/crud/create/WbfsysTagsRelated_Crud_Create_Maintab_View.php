 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTagsRelated Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_tags_related-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/tags_related/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TagsRelated.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_tags_related';
    ...
    $form = $this->newForm( 'WbfsysTagsRelated_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TagsRelated.create');}});
});
...
}//end class WbfsysTagsRelated_Crud_Create_Maintab_View
