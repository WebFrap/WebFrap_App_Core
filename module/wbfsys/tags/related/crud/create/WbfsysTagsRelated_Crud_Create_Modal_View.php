 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTagsRelated entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TagsRelated.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TagsRelated.insert';
    $params->formId       = 'wgt-form-wbfsys_tags_related';
    $params->namespace   = 'wbfsys_tags_related-create';
    ...
    $this->setTemplate( 'wbfsys/tags_related/modal/crud/form_create' );
...
}//end class WbfsysTagsRelated_Crud_Create_Modal_View
