 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTagsRelated Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTagsRelated = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Tags Related: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TagsRelated.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTagsRelated
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TagsRelated.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tags_related-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tags_related/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTagsRelated_Crud_Edit' );
...
}//end class WbfsysTagsRelated_Crud_Edit_Maintab_View
