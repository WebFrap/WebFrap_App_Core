 ...
 * @licence WebFrap.net
 */
class WbfsysTagsRelated_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTagsRelated_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTagsRelated_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTagsRelated_Entity */
      $entity = $orm->get( 'WbfsysTagsRelated', $rootId );
    }
...
}//end class WbfsysTagsRelated_Crud_Access_Root
