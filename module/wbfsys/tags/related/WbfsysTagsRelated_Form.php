...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_tags_related';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysTagsRelated';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysTagsRelated' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysTagsRelated entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_tag( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTag_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Tag (Tags Related)', 'wbfsys.tags_related.label' ),
      ));
      ...
      $inputIdTag->setLabel( $this->view->i18n->l( 'Tag', 'wbfsys.tags_related.label' ) );
  ...
  * @return void
  */
  public function input_id_related( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTag_Entity' ) )
    {
      ...
      $inputIdRelated = $this->view->newInput( 'input'.$this->prefix.'IdRelated', 'Window' );
      $inputIdRelated->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_related]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_related'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Related (Tags Related)', 'wbfsys.tags_related.label' ),
      ));
      ...
      $inputIdRelated->setReadOnly( $this->isReadOnly( 'id_related' ) );
      $inputIdRelated->setLabel( $this->view->i18n->l( 'Related', 'wbfsys.tags_related.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Tag.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_related'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdRelated->buildJavascript( 'wgt-input-'.$this->keyName.'_id_related'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_related */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Tags Related)', 'wbfsys.tags_related.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.tags_related.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Tags Related)', 'wbfsys.tags_related.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.tags_related.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Tags Related)', 'wbfsys.tags_related.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.tags_related.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Tags Related)', 'wbfsys.tags_related.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.tags_related.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Tags Related)', 'wbfsys.tags_related.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.tags_related.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Tags Related)', 'wbfsys.tags_related.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.tags_related.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Tags Related)', 'wbfsys.tags_related.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.tags_related.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tags_related_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tags_related_m_role_change';
...
}//end class WbfsysTagsRelated_Form */
