 ...
 *
 * Entity Class for the Database Table wbfsys_app
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_app';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.App.show';
  ...
  */
  public static $entityName  = 'WbfsysApp';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'wbfsys.app.message.error_def_name',
      'wrong'   => 'wbfsys.app.message.error_wrong_name',
      'max'     => 'wbfsys.app.message.error_max_name',
      'min'     => 'wbfsys.app.message.error_min_name',
    ),

    'id_def_desktop' => array
    (
      'default' => 'wbfsys.app.message.error_def_id_def_desktop',
      'wrong'   => 'wbfsys.app.message.error_wrong_id_def_desktop',
      'max'     => 'wbfsys.app.message.error_max_id_def_desktop',
      'min'     => 'wbfsys.app.message.error_min_id_def_desktop',
    ),

    'description' => array
    (
      'default' => 'wbfsys.app.message.error_def_description',
      'wrong'   => 'wbfsys.app.message.error_wrong_description',
      'max'     => 'wbfsys.app.message.error_max_description',
      'min'     => 'wbfsys.app.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.app.message.error_def_rowid',
      'wrong'   => 'wbfsys.app.message.error_wrong_rowid',
      'empty'   => 'wbfsys.app.message.error_empty_rowid',
      'max'     => 'wbfsys.app.message.error_max_rowid',
      'min'     => 'wbfsys.app.message.error_min_rowid',
    ),
  );

}//end class WbfsysApp_Entity
