 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysApp Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysApp = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.App.edit&amp;utf8=✓&amp;objid='.$entityWbfsysApp
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.App.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_app-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/app/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysApp_Crud_Edit' );
...
}//end class WbfsysApp_Crud_Edit_Maintab_View
