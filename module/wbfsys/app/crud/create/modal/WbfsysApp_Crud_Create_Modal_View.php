 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysApp entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.App.insert';
    $params->formId       = 'wgt-form-wbfsys_app';
    $params->namespace   = 'wbfsys_app-create';
    ...
    $this->setTemplate( 'wbfsys/app/modal/crud/form_create' );
...
}//end class WbfsysApp_Crud_Create_Modal_View
