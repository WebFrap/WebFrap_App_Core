 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_app';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.App.show&amp;target_mask=WbfsysApp&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.app.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.App.edit&amp;target_mask=WbfsysApp&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.app.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.App.delete&amp;target_mask=WbfsysApp&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.app.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_app_name'])).'</td>'.NL;
...
}//end class WbfsysApp_Selection_Element
