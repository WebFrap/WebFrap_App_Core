...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysApp_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysApp_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysApp_Selection_Element
    (
      'selectionWbfsysApp',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Apps', 'wbfsys.app.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.App.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysApp_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysApp_Selection_Ui
