 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysApp_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_app.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_app.rowid ",
      'acls'
    );
...
}//end class WbfsysApp_Selection_Access
