 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAppModules_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAppModules_Export_Listing_Access';
    ...
    // create a new WbfsysAppModules window
    $view = $this->loadView
    (
    	'export-wbfsys_app_modules',
    	'WbfsysAppModules_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysAppModules_Export' );
...
} // end class WbfsysAppModules_Export_Controller_Genf
