 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAppModules_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAppModules_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAppModules_Selection_Element
    (
      'selectionWbfsysAppModules',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection App Modules', 'wbfsys.app_modules.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AppModules.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAppModules',
      'WbfsysAppModules_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAppModules_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAppModules_Selection_Ui
