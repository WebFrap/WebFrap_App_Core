 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysAppModules_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysAppModules_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysAppModules_Selection_Model
