 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAppModules Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_app_modules-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/app_modules/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AppModules.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_app_modules';
    ...
    $form = $this->newForm( 'WbfsysAppModules_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AppModules.create');}});
});
...
}//end class WbfsysAppModules_Crud_Create_Maintab_View
