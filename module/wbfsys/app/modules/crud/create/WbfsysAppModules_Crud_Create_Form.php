 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysAppModules_IdApp( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysApp_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.App.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysAppModules', array_keys( $this->fields['wbfsys_app_modules']), true ),
...
}//end class WbfsysAppModules_Crud_Create_Form */
