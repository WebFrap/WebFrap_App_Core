 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAppModules entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AppModules.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AppModules.insert';
    $params->formId       = 'wgt-form-wbfsys_app_modules';
    $params->namespace   = 'wbfsys_app_modules-create';
    ...
    $this->setTemplate( 'wbfsys/app_modules/modal/crud/form_create' );
...
}//end class WbfsysAppModules_Crud_Create_Modal_View
