 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAppModules Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAppModules = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit App Modules: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AppModules.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAppModules
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AppModules.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_app_modules-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/app_modules/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAppModules_Crud_Edit' );
...
}//end class WbfsysAppModules_Crud_Edit_Maintab_View
