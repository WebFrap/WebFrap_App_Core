 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAppModules_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAppModules_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAppModules_Entity */
      $entity = $orm->get( 'WbfsysAppModules', $rootId );
    }
...
}//end class WbfsysAppModules_Crud_Access_Root
