 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_app_modules';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAppModules_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AppModules.show&amp;target_mask=WbfsysAppModules&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AppModules.edit&amp;target_mask=WbfsysAppModules&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.app_modules.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AppModules.delete&amp;target_mask=WbfsysAppModules&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.app_modules.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_app_modules&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.app_modules.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_app_modules_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AppModules_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected App Modules." >{$iconDelete} Delete selected App Modules</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! App Modules. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AppModules_Multi.deleteAll" >{$iconClean} Delete all App Modules</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAppModules_Table_Element
