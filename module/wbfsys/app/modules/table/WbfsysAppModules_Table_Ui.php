 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für App Modules
  *
  ...
  *  }
  *
  * @return WbfsysAppModules_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAppModules_Table_Element( 'tableWbfsysAppModules', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_app_modules-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'App Modules', 'wbfsys.app_modules.label' );
      //$tabPanel->searchKey = 'wbfsys_app_modules';
      ...
      $searchElement->searchKey = 'wbfsys_app_modules';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAppModules_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAppModules', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAppModules listing maske
   *
   * @param WbfsysAppModules_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAppModules_Table_Ui
