 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_app_modules_acl_graph', 
      'WbfsysAppModules_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAppModules_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAppModules_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAppModules_Acl_Path_Maintab_View  */
...
} // end class WbfsysAppModules_Acl_Path_Controller */
