 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.AppModules_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_app_modules-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.AppModules_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_app_modules-acl-update';
    ...
    $this->setTemplate( 'wbfsys/app_modules/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'App Modules', 'wbfsys.app_modules.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_app_modules_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAppModules_Acl' );
...
} // end class WbfsysAppModules_Acl_Maintab_View */
