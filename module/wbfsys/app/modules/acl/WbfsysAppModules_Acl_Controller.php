 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAppModules
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAppModules_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_app_modules_acl_listing',
      'WbfsysAppModules_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysAppModules_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAppModules_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAppModules_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_app_modules-acl',
    	'WbfsysAppModules_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_app_modules_acl_masks_listing',
      'WbfsysAppModules_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAppModules_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAppModules_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAppModules_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAppModules_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAppModules_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAppModules_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_app_modules-acl-qfdu',
    	'WbfsysAppModules_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAppModules_Acl_Controller */
