...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAppModules_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAppModules_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_app_modules-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'App Modules', 'wbfsys.app_modules.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_app_modules_acl';
...
} // end class WbfsysAppModules_Acl_Ui */
