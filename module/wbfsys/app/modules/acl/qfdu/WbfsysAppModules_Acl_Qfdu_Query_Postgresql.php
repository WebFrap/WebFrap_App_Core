 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_app_modules.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_app_modules.rowid as id,
    wbfsys_app_modules.rowid as value,
    wbfsys_app_modules.rowid as label
  FROM
    wbfsys_app_modules
  WHERE
    {$sqlWhere}
...
} // end class WbfsysAppModules_Acl_Qfdu_Query_Postgresql */
