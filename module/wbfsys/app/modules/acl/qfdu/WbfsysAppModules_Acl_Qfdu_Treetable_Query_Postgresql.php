 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_app_modules.rowid as "wbfsys_app_modules_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_app_modules on wbfsys_group_users.vid = wbfsys_app_modules.rowid'
    );
...
} // end class WbfsysAppModules_Acl_Qfdu_Treetable_Query_Postgresql */
