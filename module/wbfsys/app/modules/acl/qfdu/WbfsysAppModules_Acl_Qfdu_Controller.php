 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAppModules_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_app_modules-acl-qfdu-aAjax',
      'WbfsysAppModules_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAppModules_Acl_Qfdu_Controller */
