 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_app_modules'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAppModules', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAppModules_Acl_Dset' );
    /* @var $query WbfsysAppModules_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAppModules_Acl_Dset_Treetable' );
    /* @var $query WbfsysAppModules_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAppModules_Acl_Dset_Model */
