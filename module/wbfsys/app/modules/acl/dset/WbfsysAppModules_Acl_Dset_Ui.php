 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAppModules_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAppModules_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAppModules, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAppModules_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_app_modules-acl-dset' );
    ...
    else
    {
      ...
      (
        'App Modules "{@label@}" User Access',
        'wbfsys.app_modules.label',
        array
        (
          'label' => $entityWbfsysAppModules->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_app_modules_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAppModules_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAppModules_Acl_Dset_Ui */
