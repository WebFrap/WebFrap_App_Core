 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAppModules_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAppModules_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAppModules = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAppModules_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_app_modules-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAppModules, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAppModules_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_app_modules-acl-dset', 
    	'WbfsysAppModules_Acl_Dset',
...
} // end class WbfsysAppModules_Acl_Dset_Controller */
