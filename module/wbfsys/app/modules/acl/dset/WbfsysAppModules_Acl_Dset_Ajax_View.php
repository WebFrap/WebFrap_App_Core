 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAppModules_Acl_Dset' );
    ...
    $entityWbfsysAppModules = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAppModules_Acl_Dset_Ajax_View */
