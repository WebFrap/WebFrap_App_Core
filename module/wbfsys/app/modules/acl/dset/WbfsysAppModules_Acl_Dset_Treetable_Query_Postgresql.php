 ...
 * @licence WebFrap.net
 */
class WbfsysAppModules_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_app_modules.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAppModules_Acl_Dset_Treetable_Query_Postgresql */
