...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_app';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysApp_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.App.show&amp;target_mask=WbfsysApp&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.app.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.App.edit&amp;target_mask=WbfsysApp&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.app.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Modules',
            'modal.php?c=Wbfsys.App_Ref_AppModules.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.app.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Desktops',
            'modal.php?c=Wbfsys.App_Ref_Desktops.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.app.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.App.delete&amp;target_mask=WbfsysApp&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.app.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.app.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.App.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_app_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.App_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Apps." >{$iconDelete} Delete selected Apps</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Apps. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.App_Multi.deleteAll" >{$iconClean} Delete all Apps</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysApp_Table_Element
