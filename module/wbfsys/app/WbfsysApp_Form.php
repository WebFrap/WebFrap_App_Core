...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysApp' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysApp entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (App)', 'wbfsys.app.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.app.label' ),
  ...
  * @return void
  */
  public function input_id_def_desktop( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDesktop_Entity' ) )
    {
      ...
      $inputIdDefDesktop = $this->view->newInput( 'input'.$this->prefix.'IdDefDesktop', 'Window' );
      $inputIdDefDesktop->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_def_desktop]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_def_desktop'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Def Desktop (App)', 'wbfsys.app.label' ),
      ));
      ...
      $inputIdDefDesktop->setReadOnly( $this->isReadOnly( 'id_def_desktop' ) );
      $inputIdDefDesktop->setLabel( $this->view->i18n->l( 'Def Desktop', 'wbfsys.app.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Desktop.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_def_desktop'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdDefDesktop->buildJavascript( 'wgt-input-'.$this->keyName.'_id_def_desktop'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_def_desktop */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (App)', 'wbfsys.app.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.app.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (App)', 'wbfsys.app.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.app.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (App)', 'wbfsys.app.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.app.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (App)', 'wbfsys.app.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.app.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (App)', 'wbfsys.app.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.app.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (App)', 'wbfsys.app.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.app.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (App)', 'wbfsys.app.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.app.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (App)', 'wbfsys.app.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.app.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (App)', 'wbfsys.app.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_app_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_app_m_role_change';
