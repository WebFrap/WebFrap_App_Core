 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_AppModules_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_app_modules Attributes: id_app; id_module; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-app_modules' );
  ...
  /**
   * @param WbfsysApp_Ref_AppModules_Table_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_app_modules') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_app_modules.rowid ",
      'acls'
    );
...
}//end class WbfsysApp_Ref_AppModules_Table_Access
