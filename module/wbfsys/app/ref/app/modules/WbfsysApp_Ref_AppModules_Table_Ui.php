 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_AppModules_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysApp_Ref_AppModules_Table_Element
   */
  public function createListItem( $idWbfsysApp, $data, $access, $params  )
  {
    ...
    $table = new WbfsysApp_Ref_AppModules_Table_Element
    (
      'tableAppModules',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mod-wbfsys-cat-core_data-conref-app_modules'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-app_modules-'.$idWbfsysApp;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_app-ref-app_modules-search-'
        .$idWbfsysApp;
    ...
    $tabPanel->searchKey = 'wbfsys_app-ref-app_modules';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Module',
            '$R.get(\'modal.php?c=Wbfsys.Module.selection&exclude=wbfsys_app_modules-id_app-id_module&objid='.$params->refId.'&target_mask=WbfsysApp_Ref_AppModules&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabAppModules', true );
    $view->addVar( 'refIdAppModules', $idWbfsysApp );
    $view->addVar
    (
      'searchFormActionAppModules',
      'ajax.php?c=Wbfsys.App_Ref_AppModules.search&amp;target_id='
   ...
   * @return WbfsysApp_Ref_AppModules_Table_Element
   */
  public function listEntry( $idAppModules, $access, $params, $insertMode )
  {
    ...
    // if a table id is given use it for the table
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-app_modules-'.$idAppModules;
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowAppModules', $table->buildAjax() );
...
JSCODE;
  ...
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysAppModules  = $model->getEntityWbfsysAppModules();
    ...
    $formWbfsysAppModules->setKeyName( 'wbfsys_app_modules' );
...
}//end class WbfsysApp_Ref_AppModules_Table_Ui
