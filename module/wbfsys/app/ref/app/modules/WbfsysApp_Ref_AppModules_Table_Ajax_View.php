 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_AppModules_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.App_Ref_AppModules.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysApp_Ref_AppModules_Table_Ajax_View
