 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_AppModules_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_app-app_modules';
   ...
   */
  public $namespace   = 'WbfsysApp_Ref_AppModules';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AppModules.show&amp;target_mask=WbfsysApp_Ref_AppModules&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AppModules.delete&amp;target_mask=WbfsysApp_Ref_AppModules&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.app_modules.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AppModules.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_name'])).'</a></td>'.NL;
...
}//end class WbfsysApp_Ref_AppModules_Table_Element
