 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_Desktops_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des desktops Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysApp_Ref_Desktops_".$listType."_Access";
    ...
    $accessDesktops = new $containerClass( );
    $accessDesktops->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-desktops';

    $params->accessDesktops = $accessDesktops;
    $params->paramsDesktops = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessDesktops->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysApp_Ref_Desktops_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelDesktops = $this->loadModel
    (
      'WbfsysApp_Ref_Desktops_'.$listType
    );
    $modelDesktops->setAccess( $accessDesktops );
    
    $view->setModel( $modelDesktops );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdDesktops = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysApp_Ref_Desktops_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_app-ref-desktops-'.$listType.'-ajax',
    	'WbfsysApp_Ref_Desktops_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysDesktop by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_desktop' ); //def wbfsys_desktop


  } // end public function cleanPost */

} // end WbfsysApp_Ref_Desktops_Controller
