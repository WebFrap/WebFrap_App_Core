 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_Desktops_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysApp
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysApp_Ref_Desktops_Table_Element
   */
  public function createListItem( $idWbfsysApp, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysApp_Ref_Desktops_Table_Element
    (
      'tableDesktops',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-desktops-'.$idWbfsysApp;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_app-ref-desktops-search-'
        .$idWbfsysApp;
    ...
    $tabPanel->searchKey = 'wbfsys_app-ref-desktops';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Desktop',
            '$R.post(\'maintab.php?c=Wbfsys.Desktop.create&refid='.$params->refId.'&target_mask=WbfsysApp_Ref_Desktops&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_desktop[id_app]\':\''.$params->refIdDesktops.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabDesktops', true );
    $view->addVar( 'refIdDesktops', $idWbfsysApp );
    $view->addVar
    (
      'searchFormActionDesktops',
      'ajax.php?c=Wbfsys.App_Ref_Desktops.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysApp
    );
   ...
   * @return WbfsysApp_Ref_Desktops_Table_Element
   */
  public function getListItem( $idWbfsysApp, $data, $access, $params  )
  {
   ...
   * @return WbfsysApp_Ref_Desktops_Table_Element
   */
  public function listEntry( $idWbfsysApp, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowDesktops' , $table->buildAjax() );
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysApp_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysDesktop  = $model->getEntityWbfsysDesktop();
    ...
    $formWbfsysDesktop->setKeyName( 'wbfsys_desktop' );
...
}//end class WbfsysApp_Ref_Desktops_Table_Ui
