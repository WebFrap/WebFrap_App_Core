 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_Desktops_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.App_Ref_Desktops.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysApp_Ref_Desktops_Table_Ajax_View
