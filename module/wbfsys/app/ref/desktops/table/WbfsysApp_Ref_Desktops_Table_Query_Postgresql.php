 ...
 * @licence WebFrap.net
 */
class WbfsysApp_Ref_Desktops_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_desktop.rowid as "wbfsys_desktop_rowid"', // variant:  
      'wbfsys_desktop.name as "wbfsys_desktop_name"', // variant:  
    );
...
}//end class WbfsysApp_Ref_Desktops_Table_Query_Postgresql
