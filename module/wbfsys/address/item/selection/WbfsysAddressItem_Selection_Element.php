 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_address_item';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AddressItem.show&amp;target_mask=WbfsysAddressItem&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AddressItem.edit&amp;target_mask=WbfsysAddressItem&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.address_item.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AddressItem.delete&amp;target_mask=WbfsysAddressItem&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.address_item.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_address_item_name'])).'</td>'.NL;
...
}//end class WbfsysAddressItem_Selection_Element
