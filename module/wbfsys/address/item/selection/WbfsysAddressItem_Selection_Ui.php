 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAddressItem_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAddressItem_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressItem_Selection_Element
    (
      'selectionWbfsysAddressItem',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Address Items', 'wbfsys.address_item.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AddressItem.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAddressItem',
      'WbfsysAddressItem_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAddressItem_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAddressItem_Selection_Ui
