 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_address_item_type';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAddressItemType';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAddressItemType' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAddressItemType entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_m_order( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Order (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Order', 'wbfsys.address_item_type.label' ),
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.address_item_type.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.address_item_type.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.address_item_type.label' ),
  ...
  public function input_icon( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Icon (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ...
      $inputIcon->setLabel
      (
        $this->view->i18n->l( 'Icon', 'wbfsys.address_item_type.label' ),
  ...
  * @return void
  */
  public function input_flag_msg_supported( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagMsgSupported = $this->view->newInput( 'input'.$this->prefix.'FlagMsgSupported' , 'Checkbox' );
      $this->items['flag_msg_supported'] = $inputFlagMsgSupported;
      $inputFlagMsgSupported->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_msg_supported]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_msg_supported'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Msg Supported (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      $inputFlagMsgSupported->setWidth( 'medium' );

      $inputFlagMsgSupported->setReadOnly( $this->isReadOnly( 'flag_msg_supported' ) );
      $inputFlagMsgSupported->setActive( $this->entity->getBoolean( 'flag_msg_supported' ) );
      $inputFlagMsgSupported->setLabel
      (
        $this->view->i18n->l( 'Msg Supported', 'wbfsys.address_item_type.label' ),
        $this->entity->required( 'flag_msg_supported' )
      );
  ...
  }//end public function input_flag_msg_supported */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.address_item_type.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.address_item_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.address_item_type.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.address_item_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Address Item Type)', 'wbfsys.address_item_type.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.address_item_type.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.address_item_type.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.address_item_type.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Address Item Type)', 'wbfsys.address_item_type.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Address Item Type)', 'wbfsys.address_item_type.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Address Item Type)', 'wbfsys.address_item_type.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_type_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_type_m_role_change';
...
}//end class WbfsysAddressItemType_Form */
