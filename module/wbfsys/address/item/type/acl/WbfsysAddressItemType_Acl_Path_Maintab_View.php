 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/address_item_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'address item Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_address_item_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_address_item_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysAddressItemType_Acl_Path_Maintab_View */
