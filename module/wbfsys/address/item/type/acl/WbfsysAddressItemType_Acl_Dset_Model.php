 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_address_item_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAddressItemType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAddressItemType_Acl_Dset' );
    /* @var $query WbfsysAddressItemType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAddressItemType_Acl_Dset_Treetable' );
    /* @var $query WbfsysAddressItemType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAddressItemType_Acl_Dset_Model */
