 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAddressItemType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAddressItemType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_address_item_type_acl_listing',
    ...
    $view->setModel( $this->loadModel('WbfsysAddressItemType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAddressItemType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAddressItemType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_address_item_type-acl',
    	'WbfsysAddressItemType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_address_item_type_acl_masks_listing',
      'WbfsysAddressItemType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAddressItemType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAddressItemType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAddressItemType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAddressItemType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAddressItemType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAddressItemType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_address_item_type-acl-qfdu',
    	'WbfsysAddressItemType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAddressItemType_Acl_Controller */
