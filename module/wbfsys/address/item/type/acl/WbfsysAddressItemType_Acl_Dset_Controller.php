 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAddressItemType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAddressItemType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAddressItemType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAddressItemType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_address_item_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAddressItemType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_address_item_type-acl-dset', 
    	'WbfsysAddressItemType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAddressItemType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_address_item_type-acl-dset', 
    	'WbfsysAddressItemType_Acl_Dset',
...
} // end class WbfsysAddressItemType_Acl_Dset_Controller */
