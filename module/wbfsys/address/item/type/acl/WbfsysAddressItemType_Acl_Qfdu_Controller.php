 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAddressItemType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_address_item_type-acl-qfdu-aAjax',
      'WbfsysAddressItemType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAddressItemType_Acl_Qfdu_Controller */
