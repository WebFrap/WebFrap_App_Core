 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_address_item_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysAddressItemType = $orm->get('WbfsysAddressItemType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_address_item_type_name']  = $refEntityWbfsysAddressItemType->name;

    }
    $tabData['wbfsys_address_item_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysAddressItemType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAddressItemType_Acl' );
    /* @var $query WbfsysAddressItemType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAddressItemType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysAddressItemType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAddressItemType_Acl_Qfdu' );
    /* @var $query WbfsysAddressItemType_Acl_Qfdu_Query  */
...
} // end class WbfsysAddressItemType_Acl_Qfdu_Model */
