 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAddressItemType_Acl_Dset' );
    ...
    $entityWbfsysAddressItemType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAddressItemType_Acl_Dset_Ajax_View */
