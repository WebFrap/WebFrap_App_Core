 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_address_item_type.rowid as "wbfsys_address_item_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_address_item_type on wbfsys_group_users.vid = wbfsys_address_item_type.rowid'
    );
...
} // end class WbfsysAddressItemType_Acl_Qfdu_Treetable_Query_Postgresql */
