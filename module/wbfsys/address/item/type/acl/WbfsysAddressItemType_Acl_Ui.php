 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAddressItemType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressItemType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL address item Type', 
        'wbfsys.address_item_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_address_item_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'address item Type', 'wbfsys.address_item_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_address_item_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysAddressItemType_Acl_Table'
    );
...
} // end class WbfsysAddressItemType_Acl_Ui */
