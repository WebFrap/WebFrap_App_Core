 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_address_item_type_acl_graph', 
      'WbfsysAddressItemType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAddressItemType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAddressItemType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAddressItemType_Acl_Path_Maintab_View  */
...
} // end class WbfsysAddressItemType_Acl_Path_Controller */
