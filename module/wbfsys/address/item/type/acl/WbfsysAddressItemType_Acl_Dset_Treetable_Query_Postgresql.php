 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_address_item_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAddressItemType_Acl_Dset_Treetable_Query_Postgresql */
