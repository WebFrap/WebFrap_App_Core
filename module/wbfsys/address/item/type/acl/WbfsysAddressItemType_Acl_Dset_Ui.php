 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAddressItemType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAddressItemType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAddressItemType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAddressItemType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_address_item_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'address item Type "{@label@}" User Access',
        'wbfsys.address_item_type.label',
        array
        (
          'label' => $entityWbfsysAddressItemType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_address_item_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAddressItemType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAddressItemType_Acl_Dset_Ui */
