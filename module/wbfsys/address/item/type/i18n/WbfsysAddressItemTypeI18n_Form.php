 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_address_item_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAddressItemTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysAddressItemTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysAddressItemTypeI18n';
   ...
   *
   * @var WbfsysAddressItemTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysAddressItemTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAddressItemTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAddressItemTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.address_item_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_address_item_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_address_item_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysAddressItemType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysAddressItemType not exists' );

      Log::warn('Looks like the Entity: WbfsysAddressItemType is missing');
      ...
      //p: Window
      $objidWbfsysAddressItemType = $this->entity->getData('id_wbfsys_address_item_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysAddressItemType
          || !$entityWbfsysAddressItemType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysAddressItemType = $this->db->orm->newEntity( 'WbfsysAddressItemType' );
      }

      $inputIdWbfsysAddressItemType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysAddressItemType', 'Window' );
      $inputIdWbfsysAddressItemType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_address_item_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_address_item_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Address Item Type (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysAddressItemType->assignedForm = $this->assignedForm;

      $inputIdWbfsysAddressItemType->setWidth( 'medium' );

      $inputIdWbfsysAddressItemType->setData( $this->entity->getData( 'id_wbfsys_address_item_type' )  );
      $inputIdWbfsysAddressItemType->setReadOnly( $this->isReadOnly( 'id_wbfsys_address_item_type' ) );
      $inputIdWbfsysAddressItemType->setLabel( $this->view->i18n->l( 'Wbfsys Address Item Type', 'wbfsys.address_item_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.AddressItemType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_address_item_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysAddressItemType->setListUrl ( $listUrl );
      $inputIdWbfsysAddressItemType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysAddressItemType->setEntityUrl( 'maintab.php?c=Wbfsys.AddressItemType.edit' );
      $inputIdWbfsysAddressItemType->conEntity         = $entityWbfsysAddressItemType;
      $inputIdWbfsysAddressItemType->refresh           = $this->refresh;
      $inputIdWbfsysAddressItemType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysAddressItemType->view = $this->view;
      $inputIdWbfsysAddressItemType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_address_item_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysAddressItemType );
  ...
  }//end public function input_id_wbfsys_address_item_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.address_item_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.address_item_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.address_item_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.address_item_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.address_item_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.address_item_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.address_item_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.address_item_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.address_item_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Address Item Type I18n)', 'wbfsys.address_item_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_type_i18n_m_role_change';
...
}//end class WbfsysAddressItemTypeI18n_Form */
