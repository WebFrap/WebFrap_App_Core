 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_address_item_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_address_item_type.{$fieldName}
...
}//end class WbfsysAddressItemType_Filter
