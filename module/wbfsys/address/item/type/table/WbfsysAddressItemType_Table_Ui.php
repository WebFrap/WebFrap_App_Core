 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für address item Types
  *
  ...
  *  }
  *
  * @return WbfsysAddressItemType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressItemType_Table_Element( 'tableWbfsysAddressItemType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_address_item_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'address item Types', 'wbfsys.address_item_type.label' );
      //$tabPanel->searchKey = 'wbfsys_address_item_type';
      ...
      $searchElement->searchKey = 'wbfsys_address_item_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAddressItemType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAddressItemType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAddressItemType listing maske
   *
   * @param WbfsysAddressItemType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAddressItemType  = $model->getEntityWbfsysAddressItemType();
    ...
    $formWbfsysAddressItemType->setKeyName( 'wbfsys_address_item_type' );
...
}//end class WbfsysAddressItemType_Table_Ui
