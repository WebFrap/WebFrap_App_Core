 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAddressItemType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAddressItemType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit address item Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AddressItemType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAddressItemType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AddressItemType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_address_item_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/address_item_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAddressItemType_Crud_Edit' );
...
}//end class WbfsysAddressItemType_Crud_Edit_Maintab_View
