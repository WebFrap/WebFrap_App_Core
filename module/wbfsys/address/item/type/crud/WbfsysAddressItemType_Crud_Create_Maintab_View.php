 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAddressItemType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new address item Type',
      'wbfsys.address_item_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New address item Type',
      'wbfsys.address_item_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_address_item_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/address_item_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressItemType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_address_item_type';
    ...
    $form = $this->newForm( 'WbfsysAddressItemType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AddressItemType.create');}});
});
...
}//end class WbfsysAddressItemType_Crud_Create_Maintab_View
