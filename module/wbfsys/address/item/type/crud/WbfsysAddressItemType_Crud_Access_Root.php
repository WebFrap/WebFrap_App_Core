 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAddressItemType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAddressItemType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAddressItemType_Entity */
      $entity = $orm->get( 'WbfsysAddressItemType', $rootId );
    }
...
}//end class WbfsysAddressItemType_Crud_Access_Root
