 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAddressItemType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AddressItemType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressItemType.insert';
    $params->formId       = 'wgt-form-wbfsys_address_item_type';
    $params->namespace   = 'wbfsys_address_item_type-create';
    ...
    $this->setTemplate( 'wbfsys/address_item_type/modal/crud/form_create' );
...
}//end class WbfsysAddressItemType_Crud_Create_Modal_View
