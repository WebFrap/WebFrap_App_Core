 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysAddressItemType_Selection' ) );
...
} // end class WbfsysAddressItemType_Selection_Controller */
