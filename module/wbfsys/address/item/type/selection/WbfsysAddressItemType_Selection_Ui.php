 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAddressItemType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAddressItemType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressItemType_Selection_Element
    (
      'selectionWbfsysAddressItemType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection address item Types', 'wbfsys.address_item_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AddressItemType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAddressItemType',
      'WbfsysAddressItemType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAddressItemType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAddressItemType_Selection_Ui
