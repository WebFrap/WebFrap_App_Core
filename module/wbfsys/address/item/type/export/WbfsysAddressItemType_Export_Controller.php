 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItemType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAddressItemType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAddressItemType_Export_Listing_Access';
    ...
    // create a new WbfsysAddressItemType window
    $view = $this->loadView
    (
    	'export-wbfsys_address_item_type',
    	'WbfsysAddressItemType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysAddressItemType_Export' );
...
} // end class WbfsysAddressItemType_Export_Controller_Genf
