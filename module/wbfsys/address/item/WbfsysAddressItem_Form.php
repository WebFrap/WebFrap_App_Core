...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_address_item';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysAddressItem';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysAddressItem' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysAddressItem entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Address Item)', 'wbfsys.address_item.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.address_item.label' ),
  ...
  * @return void
  */
  public function input_address_value( $params )
  {

      //tpl: class ui:text
      $inputAddressValue = $this->view->newInput( 'input'.$this->prefix.'AddressValue' , 'Text' );
      $this->items['address_value'] = $inputAddressValue;
      $inputAddressValue->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[address_value]',
          'id'        => 'wgt-input-'.$this->keyName.'_address_value'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required xxlarge'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Address value (Address Item)', 'wbfsys.address_item.label' ),
          'maxlength' => $this->entity->maxSize( 'address_value' ),
        )
      );
      $inputAddressValue->setWidth( 'xxlarge' );

      $inputAddressValue->setReadOnly( $this->isReadOnly( 'address_value' ) );
      $inputAddressValue->setData( $this->entity->getSecure('address_value') );
      $inputAddressValue->setLabel
      (
        $this->view->i18n->l( 'Address value', 'wbfsys.address_item.label' ),
        $this->entity->required( 'address_value' )
      );
  ...
  }//end public function input_address_value */
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Address Item)', 'wbfsys.address_item.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_user'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for User (Address Item)', 'wbfsys.address_item.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.address_item.label' ) );
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysAddressItemType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysAddressItemType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Type (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.address_item.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_address_item_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.AddressItemType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
  ...
  * @return void
  */
  public function input_flag_private( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagPrivate = $this->view->newInput( 'input'.$this->prefix.'FlagPrivate' , 'Checkbox' );
      $this->items['flag_private'] = $inputFlagPrivate;
      $inputFlagPrivate->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_private]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_private'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Private (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      $inputFlagPrivate->setWidth( 'medium' );

      $inputFlagPrivate->setReadOnly( $this->isReadOnly( 'flag_private' ) );
      $inputFlagPrivate->setActive( $this->entity->getBoolean( 'flag_private' ) );
      $inputFlagPrivate->setLabel
      (
        $this->view->i18n->l( 'Private', 'wbfsys.address_item.label' ),
        $this->entity->required( 'flag_private' )
      );
  ...
  }//end public function input_flag_private */
  ...
  * @return void
  */
  public function input_use_for_contact( $params )
  {

      //tpl: class ui:Checkbox
      $inputUseForContact = $this->view->newInput( 'input'.$this->prefix.'UseForContact' , 'Checkbox' );
      $this->items['use_for_contact'] = $inputUseForContact;
      $inputUseForContact->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[use_for_contact]',
          'id'        => 'wgt-input-'.$this->keyName.'_use_for_contact'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Use For Contact (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      $inputUseForContact->setWidth( 'medium' );

      $inputUseForContact->setReadOnly( $this->isReadOnly( 'use_for_contact' ) );
      $inputUseForContact->setActive( $this->entity->getBoolean( 'use_for_contact' ) );
      $inputUseForContact->setLabel
      (
        $this->view->i18n->l( 'Use For Contact', 'wbfsys.address_item.label' ),
        $this->entity->required( 'use_for_contact' )
      );
  ...
  }//end public function input_use_for_contact */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.address_item.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Address Item)', 'wbfsys.address_item.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.address_item.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Address Item)', 'wbfsys.address_item.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.address_item.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Address Item)', 'wbfsys.address_item.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.address_item.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Address Item)', 'wbfsys.address_item.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.address_item.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Address Item)', 'wbfsys.address_item.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.address_item.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.address_item.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Address Item)', 'wbfsys.address_item.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.address_item.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Address Item)', 'wbfsys.address_item.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
    ...
    if( !Webfrap::classLoadable( 'WbfsysAddressItemType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Type (Address Item)', 'wbfsys.address_item.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_address_item_m_role_change';
...
}//end class WbfsysAddressItem_Form */
