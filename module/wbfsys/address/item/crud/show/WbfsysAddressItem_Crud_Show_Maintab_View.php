 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAddressItem_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAddressItem Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAddressItem = $this->model->getEntityWbfsysAddressItem();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Address Item: {@text@}',
      'wbfsys.address_item.label',
      array( 'text' => $entityWbfsysAddressItem->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AddressItem.show  &amp;objid='.$entityWbfsysAddressItem
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AddressItem.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_address_item-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/address_item/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAddressItem_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AddressItem.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_address_item' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_address_item a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AddressItem.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AddressItem.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAddressItem_Crud_Show_Maintab_View
