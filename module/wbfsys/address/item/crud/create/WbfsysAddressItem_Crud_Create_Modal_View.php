 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAddressItem entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AddressItem.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressItem.insert';
    $params->formId       = 'wgt-form-wbfsys_address_item';
    $params->namespace   = 'wbfsys_address_item-create';
    ...
    $this->setTemplate( 'wbfsys/address_item/modal/crud/form_create' );
...
}//end class WbfsysAddressItem_Crud_Create_Modal_View
