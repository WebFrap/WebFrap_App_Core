 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAddressItem Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_address_item-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/address_item/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressItem.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_address_item';
    ...
    $form = $this->newForm( 'WbfsysAddressItem_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AddressItem.create');}});
});
...
}//end class WbfsysAddressItem_Crud_Create_Maintab_View
