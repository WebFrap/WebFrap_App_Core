 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAddressItem_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAddressItem_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAddressItem_Entity */
      $entity = $orm->get( 'WbfsysAddressItem', $rootId );
    }
...
}//end class WbfsysAddressItem_Crud_Access_Root
