 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAddressItem Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAddressItem = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Address Item: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AddressItem.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAddressItem
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AddressItem.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_address_item-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/address_item/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAddressItem_Crud_Edit' );
...
}//end class WbfsysAddressItem_Crud_Edit_Maintab_View
