 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_address_item';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAddressItem_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AddressItem.show&amp;target_mask=WbfsysAddressItem&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AddressItem.edit&amp;target_mask=WbfsysAddressItem&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.address_item.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AddressItem.delete&amp;target_mask=WbfsysAddressItem&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.address_item.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.address_item.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Address value', 'wbfsys.address_item.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.address_item.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Use For Contact', 'wbfsys.address_item.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.address_item.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_address_item_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AddressItem.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_address_item_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_address_item_address_value'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.AddressItemType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_address_item_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" style="text-align:center;"  >'.WgtRndForm::checkbox( 'wbfsys_address_item[use_for_contact]', $row['wbfsys_address_item_use_for_contact'] , array() , true ).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_address_item_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AddressItem_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Address Items." >{$iconDelete} Delete selected Address Items</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Address Items. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AddressItem_Multi.deleteAll" >{$iconClean} Delete all Address Items</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAddressItem_Table_Element
