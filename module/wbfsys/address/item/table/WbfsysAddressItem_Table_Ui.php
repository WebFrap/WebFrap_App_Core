 ...
 * @licence WebFrap.net
 */
class WbfsysAddressItem_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Address Items
  *
  ...
  *  }
  *
  * @return WbfsysAddressItem_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressItem_Table_Element( 'tableWbfsysAddressItem', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_address_item-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Address Items', 'wbfsys.address_item.label' );
      //$tabPanel->searchKey = 'wbfsys_address_item';
      ...
      $searchElement->searchKey = 'wbfsys_address_item';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAddressItem_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAddressItem', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAddressItem listing maske
   *
   * @param WbfsysAddressItem_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAddressItem_Table_Ui
