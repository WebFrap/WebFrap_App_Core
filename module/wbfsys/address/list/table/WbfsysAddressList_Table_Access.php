 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysAddressList_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_address_list.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_address_list.rowid ",
      'acls'
    );
...
}//end class WbfsysAddressList_Table_Access
