 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_address_list';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAddressList_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AddressList.show&amp;target_mask=WbfsysAddressList&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AddressList.edit&amp;target_mask=WbfsysAddressList&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.address_list.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AddressList.delete&amp;target_mask=WbfsysAddressList&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.address_list.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.address_list.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.address_list.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_address_list_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.AddressList.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_address_list_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_address_list_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AddressList_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Address Lists." >{$iconDelete} Delete selected Address Lists</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Address Lists. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AddressList_Multi.deleteAll" >{$iconClean} Delete all Address Lists</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAddressList_Table_Element
