 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Address Lists
  *
  ...
  *  }
  *
  * @return WbfsysAddressList_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAddressList_Table_Element( 'tableWbfsysAddressList', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_address_list-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Address Lists', 'wbfsys.address_list.label' );
      //$tabPanel->searchKey = 'wbfsys_address_list';
      ...
      $searchElement->searchKey = 'wbfsys_address_list';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAddressList_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAddressList', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAddressList listing maske
   *
   * @param WbfsysAddressList_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAddressList  = $model->getEntityWbfsysAddressList();
    ...
    $formWbfsysAddressList->setKeyName( 'wbfsys_address_list' );
...
}//end class WbfsysAddressList_Table_Ui
