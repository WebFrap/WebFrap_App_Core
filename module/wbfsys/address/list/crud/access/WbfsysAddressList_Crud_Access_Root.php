 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAddressList_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAddressList_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAddressList_Entity */
      $entity = $orm->get( 'WbfsysAddressList', $rootId );
    }
...
}//end class WbfsysAddressList_Crud_Access_Root
