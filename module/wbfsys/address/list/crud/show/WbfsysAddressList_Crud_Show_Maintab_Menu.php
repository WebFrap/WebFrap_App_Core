 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
...
BUTTON;
    ...
    if( $params->access->admin )
    {
      ...
      $entries->entryAcls = <<<HTML
          ...
          <li>
            <a 
              href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_address_list&amp;objid={$objid}" 
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_address_list-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysAddressList_Crud_Show_Maintab_Menu
