 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAddressList Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAddressList = $this->model->getEntityWbfsysAddressList();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Address List: {@text@}',
      'wbfsys.address_list.label',
      array( 'text' => $entityWbfsysAddressList->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AddressList.show  &amp;objid='.$entityWbfsysAddressList
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AddressList.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_address_list-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/address_list/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAddressList_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AddressList.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_address_list' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_address_list a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AddressList.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AddressList.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAddressList_Crud_Show_Maintab_View
