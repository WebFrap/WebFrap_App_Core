 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAddressList Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_address_list-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/address_list/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressList.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_address_list';
    ...
    $form = $this->newForm( 'WbfsysAddressList_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AddressList.create');}});
});
...
}//end class WbfsysAddressList_Crud_Create_Maintab_View
