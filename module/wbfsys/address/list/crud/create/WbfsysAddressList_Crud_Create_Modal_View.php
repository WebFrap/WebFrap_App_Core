 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAddressList entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AddressList.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AddressList.insert';
    $params->formId       = 'wgt-form-wbfsys_address_list';
    $params->namespace   = 'wbfsys_address_list-create';
    ...
    $this->setTemplate( 'wbfsys/address_list/modal/crud/form_create' );
...
}//end class WbfsysAddressList_Crud_Create_Modal_View
