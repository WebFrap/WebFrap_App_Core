 ...
 * @licence WebFrap.net
 */
class WbfsysAddressList_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAddressList Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAddressList = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Address List: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AddressList.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAddressList
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AddressList.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_address_list-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/address_list/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAddressList_Crud_Edit' );
...
}//end class WbfsysAddressList_Crud_Edit_Maintab_View
