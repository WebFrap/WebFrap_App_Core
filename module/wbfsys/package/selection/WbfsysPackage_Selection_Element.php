 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_package';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Package.show&amp;target_mask=WbfsysPackage&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Package.edit&amp;target_mask=WbfsysPackage&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.package.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Package.delete&amp;target_mask=WbfsysPackage&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.package.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_package_name'])).'</td>'.NL;
...
}//end class WbfsysPackage_Selection_Element
