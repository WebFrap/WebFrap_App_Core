 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysPackage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysPackage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackage_Selection_Element
    (
      'selectionWbfsysPackage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Packages', 'wbfsys.package.label' ) ;
      $tabPanel->searchKey = 'wbfsys_package';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Package.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysPackage',
      'WbfsysPackage_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPackage' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysPackage listing maske
   *
   * @param WbfsysPackage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysPackage  = $model->getEntityWbfsysPackage();
    ...
    $formWbfsysPackage->setKeyName( 'wbfsys_package' );
...
}//end class WbfsysPackage_Selection_Ui
