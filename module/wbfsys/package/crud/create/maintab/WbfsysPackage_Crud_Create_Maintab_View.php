 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysPackage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_package-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/package/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Package.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_package';
    ...
    $form = $this->newForm( 'WbfsysPackage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Package.create');}});
});
...
}//end class WbfsysPackage_Crud_Create_Maintab_View
