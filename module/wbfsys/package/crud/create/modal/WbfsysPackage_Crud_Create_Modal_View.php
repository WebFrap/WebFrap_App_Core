 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPackage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Package.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Package.insert';
    $params->formId       = 'wgt-form-wbfsys_package';
    $params->namespace   = 'wbfsys_package-create';
    ...
    $this->setTemplate( 'wbfsys/package/modal/crud/form_create' );
...
}//end class WbfsysPackage_Crud_Create_Modal_View
