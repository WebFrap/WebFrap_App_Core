 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_package';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysPackage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Package.show&amp;target_mask=WbfsysPackage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Package.edit&amp;target_mask=WbfsysPackage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.package.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Modules',
            'modal.php?c=Wbfsys.Package_Ref_PackageModules.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.package.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Package.delete&amp;target_mask=WbfsysPackage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.package.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.package.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.package.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.package.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_package_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Package.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_package_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.PackageType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_package_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.PackageStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_package_status_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Package_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Packages." >{$iconDelete} Delete selected Packages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Packages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Package_Multi.deleteAll" >{$iconClean} Delete all Packages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysPackage_Table_Element
