...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Packages
  *
  ...
  *  }
  *
  * @return WbfsysPackage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackage_Table_Element( 'tableWbfsysPackage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Packages', 'wbfsys.package.label' );
      ...
      $searchElement->searchKey = 'wbfsys_package';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPackage_Table_Element( null,$view );
...
}//end class WbfsysPackage_Table_Ui
