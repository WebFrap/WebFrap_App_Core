 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_package']->id_type )
    {
      $valWbfsysPackageType = $orm->getField
      (
        'WbfsysPackageType',
        'rowid = '.$data['wbfsys_package']->id_type,
        'name'
      );
      $tabData['wbfsys_package_type_name'] = $valWbfsysPackageType;
    }
    else
    {
      // else just set an empty string, fastest way ;-)
      $tabData['wbfsys_package_type_name'] = '';
    }

    // if we have a value, try to load the display field (codeTableRefFields 4)
    if( $data['wbfsys_package']->id_status )
    {
      $valWbfsysPackageStatus = $orm->getField
      (
        'WbfsysPackageStatus',
        'rowid = '.$data['wbfsys_package']->id_status,
        'name'
      );
      $tabData['wbfsys_package_status_name'] = $valWbfsysPackageStatus;
    }
    else
    {
      // else just set an empty string, fastest way ;-)
      $tabData['wbfsys_package_status_name'] = '';
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysPackage_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysPackage_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysPackage_Table_Model
