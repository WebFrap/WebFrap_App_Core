 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysPackageType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysPackageType_Export_Listing_Access';
    ...
    // create a new WbfsysPackageType window
    $view = $this->loadView
    (
    	'export-wbfsys_package_type',
    	'WbfsysPackageType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysPackageType_Export' );
...
} // end class WbfsysPackageType_Export_Controller_Genf
