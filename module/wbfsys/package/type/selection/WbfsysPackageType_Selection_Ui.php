 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysPackageType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysPackageType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageType_Selection_Element
    (
      'selectionWbfsysPackageType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection package Types', 'wbfsys.package_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.PackageType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysPackageType',
      'WbfsysPackageType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysPackageType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysPackageType_Selection_Ui
