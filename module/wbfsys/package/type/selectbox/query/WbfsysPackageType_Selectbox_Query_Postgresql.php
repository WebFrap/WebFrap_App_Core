 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysPackageType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_package_type.rowid as id',
      'wbfsys_package_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_package_type.m_order as "wbfsys_package_type-m_order-order"' );

    $criteria->from( 'wbfsys_package_type' );



      $criteria->orderBy( 'wbfsys_package_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_package_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_package_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysPackageType_Selectbox_Query_Postgresql
