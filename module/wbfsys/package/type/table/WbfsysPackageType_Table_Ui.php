 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für package Types
  *
  ...
  *  }
  *
  * @return WbfsysPackageType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageType_Table_Element( 'tableWbfsysPackageType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'package Types', 'wbfsys.package_type.label' );
      //$tabPanel->searchKey = 'wbfsys_package_type';
      ...
      $searchElement->searchKey = 'wbfsys_package_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPackageType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPackageType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysPackageType listing maske
   *
   * @param WbfsysPackageType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysPackageType  = $model->getEntityWbfsysPackageType();
    ...
    $formWbfsysPackageType->setKeyName( 'wbfsys_package_type' );
...
}//end class WbfsysPackageType_Table_Ui
