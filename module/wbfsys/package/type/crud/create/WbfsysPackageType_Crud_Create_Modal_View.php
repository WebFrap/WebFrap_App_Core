 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPackageType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.PackageType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PackageType.insert';
    $params->formId       = 'wgt-form-wbfsys_package_type';
    $params->namespace   = 'wbfsys_package_type-create';
    ...
    $this->setTemplate( 'wbfsys/package_type/modal/crud/form_create' );
...
}//end class WbfsysPackageType_Crud_Create_Modal_View
