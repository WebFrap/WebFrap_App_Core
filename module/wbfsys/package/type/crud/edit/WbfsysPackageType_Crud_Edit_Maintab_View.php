 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysPackageType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPackageType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit package Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.PackageType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysPackageType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.PackageType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_package_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/package_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysPackageType_Crud_Edit' );
...
}//end class WbfsysPackageType_Crud_Edit_Maintab_View
