 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysPackageType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysPackageType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysPackageType_Entity */
      $entity = $orm->get( 'WbfsysPackageType', $rootId );
    }
...
}//end class WbfsysPackageType_Crud_Access_Root
