 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysPackageType_Acl_Dset' );
    ...
    $entityWbfsysPackageType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysPackageType_Acl_Dset_Ajax_View */
