 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysPackageType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysPackageType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPackageType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_package_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysPackageType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPackageType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_package_type-acl-dset', 
    	'WbfsysPackageType_Acl_Dset',
...
} // end class WbfsysPackageType_Acl_Dset_Controller */
