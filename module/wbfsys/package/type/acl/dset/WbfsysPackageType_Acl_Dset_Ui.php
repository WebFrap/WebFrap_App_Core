 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysPackageType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysPackageType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysPackageType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysPackageType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_package_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'package Type "{@label@}" User Access',
        'wbfsys.package_type.label',
        array
        (
          'label' => $entityWbfsysPackageType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_package_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysPackageType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysPackageType_Acl_Dset_Ui */
