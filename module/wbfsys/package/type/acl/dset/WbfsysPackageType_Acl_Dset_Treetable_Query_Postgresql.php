 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_package_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysPackageType_Acl_Dset_Treetable_Query_Postgresql */
