 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_package_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysPackageType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageType_Acl_Dset' );
    /* @var $query WbfsysPackageType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageType_Acl_Dset_Treetable' );
    /* @var $query WbfsysPackageType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysPackageType_Acl_Dset_Model */
