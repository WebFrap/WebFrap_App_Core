 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_package_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysPackageType = $orm->get('WbfsysPackageType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_package_type_name']  = $refEntityWbfsysPackageType->name;

    }
    $tabData['wbfsys_package_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysPackageType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageType_Acl' );
    /* @var $query WbfsysPackageType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysPackageType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageType_Acl_Qfdu' );
    /* @var $query WbfsysPackageType_Acl_Qfdu_Query  */
...
} // end class WbfsysPackageType_Acl_Qfdu_Model */
