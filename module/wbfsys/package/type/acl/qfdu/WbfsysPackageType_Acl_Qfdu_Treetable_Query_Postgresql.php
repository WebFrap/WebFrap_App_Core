 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_package_type.name as "wbfsys_package_type_name"',
      'wbfsys_package_type.rowid as "wbfsys_package_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_package_type on wbfsys_group_users.vid = wbfsys_package_type.rowid'
    );
...
} // end class WbfsysPackageType_Acl_Qfdu_Treetable_Query_Postgresql */
