 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Qfdu_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_package_type-acl-qfdu';
   ...
   *
   * @var WbfsysPackageType_Acl_Table_Query
   */
  public $data        = null;
 ...
 /**
  ...
  public function buildDatasetNode( $groupId, $userId, $groupPos, $userPos  )
  {
    ...
    foreach( $childs as $row )
    {
      ...
      $body .= '<td valign="top" class="ind2" >'.$this->icon( 'control/entity.png', 'Entity' ).' <a href="maintab.php?c=Wbfsys.PackageType.edit&amp;objid='.$row['wbfsys_package_type_rowid'].'" class="wcm wcm_req_ajax" >'.$row['wbfsys_package_type_name'].'<a></td>'.NL;
      $body .= '<td valign="top" >'
        .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
...
} // end class WbfsysPackageType_Acl_Qfdu_Treetable_Element */
