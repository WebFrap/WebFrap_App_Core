 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_package_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_package_type.rowid as id,
    wbfsys_package_type.name as value,
    wbfsys_package_type.name as label
  FROM
    wbfsys_package_type
  WHERE
    {$sqlWhere}
...
} // end class WbfsysPackageType_Acl_Qfdu_Query_Postgresql */
