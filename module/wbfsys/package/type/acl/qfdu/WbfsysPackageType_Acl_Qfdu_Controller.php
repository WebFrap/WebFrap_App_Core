 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysPackageType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_package_type-acl-qfdu-aAjax',
      'WbfsysPackageType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysPackageType_Acl_Qfdu_Controller */
