 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysPackageType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_package_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'package Type', 'wbfsys.package_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_package_type_acl';
...
} // end class WbfsysPackageType_Acl_Ui */
