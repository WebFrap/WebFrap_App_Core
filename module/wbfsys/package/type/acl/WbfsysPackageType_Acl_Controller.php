 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysPackageType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysPackageType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_package_type_acl_listing',
      'WbfsysPackageType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysPackageType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysPackageType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_package_type-acl',
    	'WbfsysPackageType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_package_type_acl_masks_listing',
      'WbfsysPackageType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysPackageType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysPackageType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysPackageType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysPackageType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysPackageType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_package_type-acl-qfdu',
    	'WbfsysPackageType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysPackageType_Acl_Controller */
