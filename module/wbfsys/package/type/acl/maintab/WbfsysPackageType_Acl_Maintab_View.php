 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.PackageType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.PackageType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_package_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/package_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'package Type', 'wbfsys.package_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_package_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysPackageType_Acl' );
...
} // end class WbfsysPackageType_Acl_Maintab_View */
