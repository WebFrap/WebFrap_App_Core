 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysPackageType_Acl_Path' );
    /* @var $query WbfsysPackageType_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysPackageType_Acl_Path');
    /* @var $dropQuery WbfsysPackageType_Acl_Path_Query  */
...
} // end class WbfsysPackageType_Acl_Path_Model */
