 ...
 * @licence WebFrap.net
 */
class WbfsysPackageType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_package_type_acl_graph', 
      'WbfsysPackageType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysPackageType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysPackageType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysPackageType_Acl_Path_Maintab_View  */
...
} // end class WbfsysPackageType_Acl_Path_Controller */
