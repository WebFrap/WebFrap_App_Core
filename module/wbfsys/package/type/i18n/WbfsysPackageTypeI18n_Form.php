 ...
 * @licence WebFrap.net
 */
class WbfsysPackageTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_package_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPackageTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPackageTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysPackageTypeI18n';
   ...
   *
   * @var WbfsysPackageTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPackageTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPackageTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPackageTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.package_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_package_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_package_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysPackageType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysPackageType not exists' );

      Log::warn('Looks like the Entity: WbfsysPackageType is missing');
      ...
      //p: Window
      $objidWbfsysPackageType = $this->entity->getData('id_wbfsys_package_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysPackageType
          || !$entityWbfsysPackageType = $this->db->orm->get
          (
            'WbfsysPackageType',
            $objidWbfsysPackageType
          )
      ...
      {
        $entityWbfsysPackageType = $this->db->orm->newEntity( 'WbfsysPackageType' );
      }

      $inputIdWbfsysPackageType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysPackageType', 'Window' );
      $inputIdWbfsysPackageType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_package_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_package_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Package Type (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysPackageType->assignedForm = $this->assignedForm;

      $inputIdWbfsysPackageType->setWidth( 'medium' );

      $inputIdWbfsysPackageType->setData( $this->entity->getData( 'id_wbfsys_package_type' )  );
      $inputIdWbfsysPackageType->setReadOnly( $this->isReadOnly( 'id_wbfsys_package_type' ) );
      $inputIdWbfsysPackageType->setLabel( $this->view->i18n->l( 'Wbfsys Package Type', 'wbfsys.package_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.PackageType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_package_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysPackageType->setListUrl ( $listUrl );
      $inputIdWbfsysPackageType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysPackageType->setEntityUrl( 'maintab.php?c=Wbfsys.PackageType.edit' );
      $inputIdWbfsysPackageType->conEntity         = $entityWbfsysPackageType;
      $inputIdWbfsysPackageType->refresh           = $this->refresh;
      $inputIdWbfsysPackageType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysPackageType->view = $this->view;
      $inputIdWbfsysPackageType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_package_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysPackageType );
  ...
  }//end public function input_id_wbfsys_package_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.package_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.package_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.package_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.package_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.package_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.package_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.package_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.package_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.package_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Package Type I18n)', 'wbfsys.package_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_type_i18n_m_role_change';
...
}//end class WbfsysPackageTypeI18n_Form */
