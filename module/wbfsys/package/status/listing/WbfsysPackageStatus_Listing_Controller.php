 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysPackageStatus_'.$listType ) );
...
} // end class WbfsysPackageStatus_Listing_Controller */
