 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_package_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPackageStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPackageStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysPackageStatusI18n';
   ...
   *
   * @var WbfsysPackageStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPackageStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPackageStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPackageStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.package_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_package_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_package_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysPackageStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysPackageStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysPackageStatus is missing');
      ...
      //p: Window
      $objidWbfsysPackageStatus = $this->entity->getData('id_wbfsys_package_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysPackageStatus
          || !$entityWbfsysPackageStatus = $this->db->orm->get
          (
            'WbfsysPackageStatus',
            $objidWbfsysPackageStatus
          )
      ...
      {
        $entityWbfsysPackageStatus = $this->db->orm->newEntity( 'WbfsysPackageStatus' );
      }

      $inputIdWbfsysPackageStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysPackageStatus', 'Window' );
      $inputIdWbfsysPackageStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_package_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_package_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Package Status (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysPackageStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysPackageStatus->setWidth( 'medium' );

      $inputIdWbfsysPackageStatus->setData( $this->entity->getData( 'id_wbfsys_package_status' )  );
      $inputIdWbfsysPackageStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_package_status' ) );
      $inputIdWbfsysPackageStatus->setLabel( $this->view->i18n->l( 'Wbfsys Package Status', 'wbfsys.package_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.PackageStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_package_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysPackageStatus->setListUrl ( $listUrl );
      $inputIdWbfsysPackageStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysPackageStatus->setEntityUrl( 'maintab.php?c=Wbfsys.PackageStatus.edit' );
      $inputIdWbfsysPackageStatus->conEntity         = $entityWbfsysPackageStatus;
      $inputIdWbfsysPackageStatus->refresh           = $this->refresh;
      $inputIdWbfsysPackageStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysPackageStatus->view = $this->view;
      $inputIdWbfsysPackageStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_package_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysPackageStatus );
  ...
  }//end public function input_id_wbfsys_package_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.package_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.package_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.package_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.package_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.package_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.package_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.package_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.package_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.package_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Package Status I18n)', 'wbfsys.package_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_status_i18n_m_role_change';
...
}//end class WbfsysPackageStatusI18n_Form */
