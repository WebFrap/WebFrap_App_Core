 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysPackageStatus_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_package_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_package_status.rowid ",
      'acls'
    );
...
}//end class WbfsysPackageStatus_Selection_Access
