 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für package Status
  *
  ...
  *  }
  *
  * @return WbfsysPackageStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageStatus_Table_Element( 'tableWbfsysPackageStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'package Status', 'wbfsys.package_status.label' );
      //$tabPanel->searchKey = 'wbfsys_package_status';
      ...
      $searchElement->searchKey = 'wbfsys_package_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPackageStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPackageStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysPackageStatus listing maske
   *
   * @param WbfsysPackageStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysPackageStatus  = $model->getEntityWbfsysPackageStatus();
    ...
    $formWbfsysPackageStatus->setKeyName( 'wbfsys_package_status' );
...
}//end class WbfsysPackageStatus_Table_Ui
