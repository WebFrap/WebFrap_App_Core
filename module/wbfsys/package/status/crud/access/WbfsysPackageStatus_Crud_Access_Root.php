 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysPackageStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysPackageStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysPackageStatus_Entity */
      $entity = $orm->get( 'WbfsysPackageStatus', $rootId );
    }
...
}//end class WbfsysPackageStatus_Crud_Access_Root
