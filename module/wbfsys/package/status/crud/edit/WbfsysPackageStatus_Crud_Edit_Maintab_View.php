 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysPackageStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPackageStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit package Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.PackageStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysPackageStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.PackageStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_package_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/package_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysPackageStatus_Crud_Edit' );
...
}//end class WbfsysPackageStatus_Crud_Edit_Maintab_View
