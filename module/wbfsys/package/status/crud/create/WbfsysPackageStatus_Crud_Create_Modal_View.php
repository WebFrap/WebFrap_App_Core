 ...
 * @licence WebFrap.net
 */
class WbfsysPackageStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPackageStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.PackageStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PackageStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_package_status';
    $params->namespace   = 'wbfsys_package_status-create';
    ...
    $this->setTemplate( 'wbfsys/package_status/modal/crud/form_create' );
...
}//end class WbfsysPackageStatus_Crud_Create_Modal_View
