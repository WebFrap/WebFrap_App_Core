 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Package Modules
  *
  ...
  *  }
  *
  * @return WbfsysPackageModules_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageModules_Table_Element( 'tableWbfsysPackageModules', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package_modules-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Package Modules', 'wbfsys.package_modules.label' );
      //$tabPanel->searchKey = 'wbfsys_package_modules';
      ...
      $searchElement->searchKey = 'wbfsys_package_modules';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPackageModules_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPackageModules', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysPackageModules listing maske
   *
   * @param WbfsysPackageModules_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysPackageModules_Table_Ui
