 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_package_modules';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysPackageModules_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.PackageModules.show&amp;target_mask=WbfsysPackageModules&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.PackageModules.edit&amp;target_mask=WbfsysPackageModules&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.package_modules.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.PackageModules.delete&amp;target_mask=WbfsysPackageModules&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.package_modules.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_package_modules&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.package_modules.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_package_modules_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.PackageModules_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Package Modules." >{$iconDelete} Delete selected Package Modules</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Package Modules. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.PackageModules_Multi.deleteAll" >{$iconClean} Delete all Package Modules</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysPackageModules_Table_Element
