 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysPackageModules_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysPackageModules_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysPackageModules_Table_Model
