 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysPackageModules_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.PackageModules_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_package_modules-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.PackageModules_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_package_modules-acl-update';
    ...
    $this->setTemplate( 'wbfsys/package_modules/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Package Modules', 'wbfsys.package_modules.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_package_modules_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysPackageModules_Acl' );
...
} // end class WbfsysPackageModules_Acl_Maintab_View */
