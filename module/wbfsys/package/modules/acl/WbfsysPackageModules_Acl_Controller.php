 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysPackageModules
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysPackageModules_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_package_modules_acl_listing',
      'WbfsysPackageModules_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysPackageModules_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageModules_Acl_Model */
    $model   = $this->loadModel( 'WbfsysPackageModules_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_package_modules-acl',
    	'WbfsysPackageModules_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_package_modules_acl_masks_listing',
      'WbfsysPackageModules_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysPackageModules_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysPackageModules_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageModules_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysPackageModules_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysPackageModules_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysPackageModules_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_package_modules-acl-qfdu',
    	'WbfsysPackageModules_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_cleanQfduGroup( $request, $response )
  {
    ...
    if( $model->cleanQfduGroup( $objid, $areaId, $params ) )
    {
      ...
      if( $params->targetId )
      {
        $ui = $this->loadUi( 'WbfsysPackageModules_Acl_Qfdu' );
...
} // end class WbfsysPackageModules_Acl_Controller */
