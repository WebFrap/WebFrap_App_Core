 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_package_modules.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysPackageModules_Acl_Dset_Treetable_Query_Postgresql */
