 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_package_modules'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysPackageModules', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageModules_Acl_Dset' );
    /* @var $query WbfsysPackageModules_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageModules_Acl_Dset_Treetable' );
    /* @var $query WbfsysPackageModules_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysPackageModules_Acl_Dset_Model */
