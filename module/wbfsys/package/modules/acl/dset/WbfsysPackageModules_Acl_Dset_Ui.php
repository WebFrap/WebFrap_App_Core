 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysPackageModules_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysPackageModules_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysPackageModules, $areaId, $access, $params  )
  {

    $listObj = new WbfsysPackageModules_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_package_modules-acl-dset' );
    ...
    else
    {
      ...
      (
        'Package Modules "{@label@}" User Access',
        'wbfsys.package_modules.label',
        array
        (
          'label' => $entityWbfsysPackageModules->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_package_modules_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysPackageModules_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysPackageModules_Acl_Dset_Ui */
