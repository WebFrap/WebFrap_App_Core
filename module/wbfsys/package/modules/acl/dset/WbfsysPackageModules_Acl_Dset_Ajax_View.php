 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysPackageModules_Acl_Dset' );
    ...
    $entityWbfsysPackageModules = $this->model->getEntity( $dsetId );
...
} // end class WbfsysPackageModules_Acl_Dset_Ajax_View */
