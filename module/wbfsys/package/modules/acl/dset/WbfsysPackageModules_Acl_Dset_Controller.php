 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageModules_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysPackageModules_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysPackageModules = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPackageModules_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_package_modules-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysPackageModules, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_package_modules-acl-dset', 
    	'WbfsysPackageModules_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPackageModules_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_package_modules-acl-dset', 
    	'WbfsysPackageModules_Acl_Dset',
...
} // end class WbfsysPackageModules_Acl_Dset_Controller */
