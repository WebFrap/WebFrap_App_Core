 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysPackageModules_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_package_modules-acl-qfdu-aAjax',
      'WbfsysPackageModules_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysPackageModules_Acl_Qfdu_Controller */
