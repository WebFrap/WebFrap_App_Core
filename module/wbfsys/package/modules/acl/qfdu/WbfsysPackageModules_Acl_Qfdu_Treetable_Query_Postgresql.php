 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_package_modules.rowid as "wbfsys_package_modules_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_package_modules on wbfsys_group_users.vid = wbfsys_package_modules.rowid'
    );
...
} // end class WbfsysPackageModules_Acl_Qfdu_Treetable_Query_Postgresql */
