 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_package_modules')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysPackageModules = $orm->get('WbfsysPackageModules', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_package_modules_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysPackageModules_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageModules_Acl' );
    /* @var $query WbfsysPackageModules_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageModules_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysPackageModules_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPackageModules_Acl_Qfdu' );
    /* @var $query WbfsysPackageModules_Acl_Qfdu_Query  */
...
} // end class WbfsysPackageModules_Acl_Qfdu_Model */
