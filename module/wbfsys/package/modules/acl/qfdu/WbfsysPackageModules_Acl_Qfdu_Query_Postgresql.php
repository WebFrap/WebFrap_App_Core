 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_package_modules.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_package_modules.rowid as id,
    wbfsys_package_modules.rowid as value,
    wbfsys_package_modules.rowid as label
  FROM
...
} // end class WbfsysPackageModules_Acl_Qfdu_Query_Postgresql */
