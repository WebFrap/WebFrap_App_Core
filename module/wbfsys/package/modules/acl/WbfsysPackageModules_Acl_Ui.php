 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysPackageModules_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageModules_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_package_modules-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Package Modules', 'wbfsys.package_modules.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_package_modules_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysPackageModules_Acl_Table'
    );
...
} // end class WbfsysPackageModules_Acl_Ui */
