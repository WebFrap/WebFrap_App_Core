 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/package_modules/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_package_modules-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_package_modules-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysPackageModules_Acl_Path_Maintab_View */
