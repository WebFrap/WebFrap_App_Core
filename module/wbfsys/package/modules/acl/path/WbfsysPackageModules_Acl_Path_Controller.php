 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_package_modules_acl_graph', 
      'WbfsysPackageModules_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysPackageModules_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysPackageModules_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysPackageModules_Acl_Path_Maintab_View  */
...
} // end class WbfsysPackageModules_Acl_Path_Controller */
