 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysPackageModules_'.$listType ) );
...
} // end class WbfsysPackageModules_Listing_Controller */
