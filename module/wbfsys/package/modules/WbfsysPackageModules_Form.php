 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_package_modules';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPackageModules';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPackageModules' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPackageModules entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_package( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysPackage_Entity' ) )
    {
      ...
      $inputIdPackage = $this->view->newInput( 'input'.$this->prefix.'IdPackage', 'Window' );
      $inputIdPackage->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_package]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_package'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Package (Package Modules)', 'wbfsys.package_modules.label' ),
      ));
      ...
      $inputIdPackage->setReadOnly( $this->isReadOnly( 'id_package' ) );
      $inputIdPackage->setLabel( $this->view->i18n->l( 'Package', 'wbfsys.package_modules.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Package.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_package'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdPackage->buildJavascript( 'wgt-input-'.$this->keyName.'_id_package'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_package */
    ...
    if( !Webfrap::classLoadable( 'WbfsysModule_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_module'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Module (Package Modules)', 'wbfsys.package_modules.label' ),
      ));
      ...
      $inputIdModule->setLabel( $this->view->i18n->l( 'Module', 'wbfsys.package_modules.label' ) );
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Package Modules)', 'wbfsys.package_modules.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.package_modules.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Package Modules)', 'wbfsys.package_modules.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.package_modules.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Package Modules)', 'wbfsys.package_modules.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.package_modules.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Package Modules)', 'wbfsys.package_modules.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.package_modules.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Package Modules)', 'wbfsys.package_modules.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.package_modules.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Package Modules)', 'wbfsys.package_modules.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.package_modules.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Package Modules)', 'wbfsys.package_modules.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.package_modules.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_modules_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_package_modules_m_role_change';
...
}//end class WbfsysPackageModules_Form */
