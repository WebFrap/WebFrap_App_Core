 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_package_modules
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.PackageModules.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_package_modules-create';

    $access = new WbfsysPackageModules_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_package_modules-create',
      'WbfsysPackageModules_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysPackageModules_Crud_Model */
    $model = $this->loadModel( 'WbfsysPackageModules_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.PackageModules.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysPackageModules = $model->getEntityWbfsysPackageModules( $objid );
    ...
    if( !$entityWbfsysPackageModules )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Package Modules', 'wbfsys.package_modules.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysPackageModules;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_package_modules:edit';

    $access = new WbfsysPackageModules_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysPackageModules );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_package_modules-edit-'.$objid,
      'WbfsysPackageModules_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_package_modules-edit',
          $entityWbfsysPackageModules,
          'Edit Package Modules :'.$entityWbfsysPackageModules->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_package_modules';
      $params->maskRoot      = 'wbfsys_package_modules:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_package_modules';
      $params->aclNode       = 'mgmt-wbfsys_package_modules';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_package_modules-edit-'.$objid,
      'WbfsysPackageModules_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_package_modules-show',
          $entityWbfsysPackageModules,
          'Show Package Modules :'.$entityWbfsysPackageModules->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_package_modules
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.PackageModules.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-insert';

    $access = new WbfsysPackageModules_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysPackageModules = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_package_modules-update-'.$entityWbfsysPackageModules;
      ...
      {
        $access = new WbfsysPackageModules_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysPackageModules );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysPackageModules';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_package_modules',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysPackageModules_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.PackageModules.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysPackageModules, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysPackageModules_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.PackageModules.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-delete-'.$objid;

    $access = new WbfsysPackageModules_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysPackageModules );
    ...
    $error = $model->delete( $entityWbfsysPackageModules, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysPackageModules, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.PackageModules.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.PackageModules.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-listing';
    ...
    $containerClass = 'WbfsysPackageModules_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_package_modules',
      'WbfsysPackageModules_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysPackageModules_Table_Model */
    $model = $this->loadModel( 'WbfsysPackageModules_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_package_modules-'.$params->ltype,
          'WbfsysPackageModules',
          'List of Package Moduless'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysPackageModules
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysPackageModules_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_package_modules',
      'WbfsysPackageModules_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysPackageModules_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.PackageModules.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysPackageModules_Selection_Model */
    $model   = $this->loadModel( 'WbfsysPackageModules_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_package_modules-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_package_modules-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_package_modules',
      'WbfsysPackageModules',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysPackageModules, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysPackageModules_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysPackageModules_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_package_modules-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_package_modules' );
...
} // end class WbfsysPackageModules_Controller */
