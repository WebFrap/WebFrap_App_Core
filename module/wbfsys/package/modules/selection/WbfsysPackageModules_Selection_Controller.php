 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysPackageModules_Selection' ) );
...
} // end class WbfsysPackageModules_Selection_Controller */
