 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysPackageModules_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysPackageModules_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPackageModules_Selection_Element
    (
      'selectionWbfsysPackageModules',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Package Modules', 'wbfsys.package_modules.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.PackageModules.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysPackageModules',
      'WbfsysPackageModules_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysPackageModules_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysPackageModules_Selection_Ui
