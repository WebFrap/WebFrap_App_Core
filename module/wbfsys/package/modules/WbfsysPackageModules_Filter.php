 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_package_modules') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_package_modules.{$fieldName}
...
}//end class WbfsysPackageModules_Filter
