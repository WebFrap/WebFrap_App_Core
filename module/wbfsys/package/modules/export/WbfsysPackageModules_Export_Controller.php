 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysPackageModules_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysPackageModules_Export_Listing_Access';
    ...
    // create a new WbfsysPackageModules window
    $view = $this->loadView
    (
    	'export-wbfsys_package_modules',
    	'WbfsysPackageModules_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysPackageModules_Export' );
...
} // end class WbfsysPackageModules_Export_Controller_Genf
