 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysPackageModules_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysPackageModules Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPackageModules = $this->model->getEntityWbfsysPackageModules();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Package Modules: {@text@}',
      'wbfsys.package_modules.label',
      array( 'text' => $entityWbfsysPackageModules->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.PackageModules.show  &amp;objid='.$entityWbfsysPackageModules
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.PackageModules.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_package_modules-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/package_modules/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysPackageModules_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.PackageModules.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_package_modules' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_package_modules a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.PackageModules.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.PackageModules.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysPackageModules_Crud_Show_Maintab_View
