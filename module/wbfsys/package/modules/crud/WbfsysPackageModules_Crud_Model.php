 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_package_modules', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
    ...
    if( $objid )
    {
      $searchId = $objid;
      $keyType  = 'rowid';
      $entity   = $orm->get( 'WbfsysPackageModules', $objid );
    }
    else if( $uuid )
    {
      $searchId = $uuid;
      $keyType  = 'uuid';
      $entity   = $orm->getByUuid( 'WbfsysPackageModules', $uuid );
    }
    else if( $accessKey )
    {
      $searchId = $accessKey;
      $keyType  = 'access_key';
      $entity   = $orm->getByKey( 'WbfsysPackageModules', $accessKey );
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      if( !$entityWbfsysPackageModules = $this->getRegisterd( 'entityWbfsysPackageModules' ) )
      {
        ...
        (
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysPackageModules' )
          )
        );
      }
      ...
      else
      {
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysPackageModules );
      }
    ...
    try
    {
      ...
      if( !$orm->update( $entityWbfsysPackageModules ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to update Package Modules {@label@}',
            'wbfsys.package_modules.message',
            array
            (
              'label' =>  $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully updated Package Modules {@label@}',
            'wbfsys.package_modules.message',
            array
            (
              'label' =>  $entityText
        ...
        $this->protocol
        (
          'edited Package Modules: '.$entityText,
          'edit',
          $entityWbfsysPackageModules
        );
   ...
   */
  public function delete( $entityWbfsysPackageModules, $params  )
  {
    ...
    $delId     = $entityWbfsysPackageModules->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysPackageModules );

      $response->addMessage
      (
        $response->i18n->l
        (
          'Successfully deleted Package Modules {@label@}',
          'wbfsys.package_modules.message',
          array( 'label' => $entityText )
        )
      );
        ...
        $this->protocol
        (
          'Deleted Package Modules: '.$entityText,
          'delete',
          array( 'WbfsysPackageModules', $delId )
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      {
        if( isset( $fields['wbfsys_package_modules'] )  )
          $params->fieldsWbfsysPackageModules  = $fields['wbfsys_package_modules'];
        else
          $params->fieldsWbfsysPackageModules  = array();
      }
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysPackageModules, $params )
  {
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysPackageModules = $orm->get( 'WbfsysPackageModules',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
          (
            'There is no Package Modules with the id: {@id@}',
            'wbfsys.package_modules.message',
            array
            (
              'id' => $id
    ...
    if( !$params->fieldsWbfsysPackageModules )
      $params->fieldsWbfsysPackageModules  = $entityWbfsysPackageModules->getCols
      (
        $params->categories
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_package_modules'] = array();
    $saveFields['wbfsys_package_modules'][] = 'id_package';
        $saveFields['wbfsys_package_modules'][] = 'id_module';
        $saveFields['wbfsys_package_modules'][] = 'm_version';
...
}//end WbfsysPackageModules_Crud_Model
