 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysPackageModules_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysPackageModules_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysPackageModules_Entity */
      $entity = $orm->get( 'WbfsysPackageModules', $rootId );
    }
...
}//end class WbfsysPackageModules_Crud_Access_Root
