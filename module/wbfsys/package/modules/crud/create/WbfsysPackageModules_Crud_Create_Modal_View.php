 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPackageModules entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.PackageModules.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PackageModules.insert';
    $params->formId       = 'wgt-form-wbfsys_package_modules';
    $params->namespace   = 'wbfsys_package_modules-create';
    ...
    $this->setTemplate( 'wbfsys/package_modules/modal/crud/form_create' );
...
}//end class WbfsysPackageModules_Crud_Create_Modal_View
