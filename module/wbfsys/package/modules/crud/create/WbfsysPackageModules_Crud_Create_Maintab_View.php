 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysPackageModules Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_package_modules-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/package_modules/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.PackageModules.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_package_modules';
    ...
    $form = $this->newForm( 'WbfsysPackageModules_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.PackageModules.create');}});
});
...
}//end class WbfsysPackageModules_Crud_Create_Maintab_View
