 ...
 * @licence WebFrap.net
 */
class WbfsysPackageModules_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysPackageModules Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPackageModules = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Package Modules: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.PackageModules.edit&amp;utf8=✓&amp;objid='.$entityWbfsysPackageModules
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.PackageModules.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_package_modules-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/package_modules/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysPackageModules_Crud_Edit' );
...
}//end class WbfsysPackageModules_Crud_Edit_Maintab_View
