 ...
 * If you want to extend this class write your coden in ControllerWbfsysPackage
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Ref_PackageModules_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des package_modules Referenztabs
  * für den wbfsys_package management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $params->refId = $objid;
    $params->refIdPackageModules = $objid;
    ...
    $containerClass = "WbfsysPackage_Ref_PackageModules_".$listType."_Access";
    ...
    $accessPackageModules = new $containerClass( );
    $accessPackageModules->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-package_modules';

    $params->accessPackageModules = $accessPackageModules;
    $params->paramsPackageModules = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessPackageModules->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_package-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysPackage_Ref_PackageModules_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelPackageModules = $this->loadModel
    (
      'WbfsysPackage_Ref_PackageModules_'.$listType
    );
    $modelPackageModules->setAccess( $accessPackageModules );
    
    $view->setModel( $modelPackageModules );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysPackage_Ref_PackageModules_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_package-ref-package_modules-'.$listType.'-ajax',
    	'WbfsysPackage_Ref_PackageModules_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysPackageModules by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {
    ...
    $this->request->removePost( 'wbfsys_package_modules' ); //def wbfsys_package_modules


  } // end public function cleanPost */

 /**
  * connect existining WbfsysModule to a WbfsysPackage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-package_modules'
    );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-package_modules';

    $params->accessPackageModules = $access;
    $params->paramsPackageModules = $params;

    $model  = $this->loadModel( 'WbfsysPackage_Ref_PackageModules_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysPackage_Ref_PackageModules_'.$listType );
      $listModel = $this->loadModel( 'WbfsysPackage_Ref_PackageModules_'.$listType );
...
} // end WbfsysPackage_Ref_PackageModules_Controller
