 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Ref_PackageModules_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_package-package_modules';
   ...
   */
  public $namespace   = 'WbfsysPackage_Ref_PackageModules';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.PackageModules.show&amp;target_mask=WbfsysPackage_Ref_PackageModules&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.PackageModules.delete&amp;target_mask=WbfsysPackage_Ref_PackageModules&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.package_modules.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.PackageModules.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_module_name'])).'</a></td>'.NL;
...
}//end class WbfsysPackage_Ref_PackageModules_Table_Element
