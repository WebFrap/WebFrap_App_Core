 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Ref_PackageModules_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/package/ref_package_modules/tab_table' );

    $ui = $this->loadUi( 'WbfsysPackage_Ref_PackageModules_Table' );
...
}//end class WbfsysPackage_Ref_PackageModules_Table_Modal_View
