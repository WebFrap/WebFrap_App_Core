 ...
 * @licence WebFrap.net
 */
class WbfsysPackage_Ref_PackageModules_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Package_Ref_PackageModules.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysPackage_Ref_PackageModules_Table_Ajax_View
