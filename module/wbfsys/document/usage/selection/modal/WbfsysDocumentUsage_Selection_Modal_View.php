 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysDocumentUsage_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysDocumentUsage_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/document_usage/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Document Usage', 'wbfsys.document_usage.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DocumentUsage.filter';
...
}//end class WbfsysDocumentUsage_Selection_Modal_View
