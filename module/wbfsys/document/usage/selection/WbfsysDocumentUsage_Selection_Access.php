 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDocumentUsage_Selection_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_document_usage.rowid ",
      'acls'
    );
...
}//end class WbfsysDocumentUsage_Selection_Access
