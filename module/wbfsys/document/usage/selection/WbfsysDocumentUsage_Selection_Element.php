 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_document_usage';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocumentUsage.show&amp;target_mask=WbfsysDocumentUsage&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocumentUsage.edit&amp;target_mask=WbfsysDocumentUsage&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.document_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocumentUsage.delete&amp;target_mask=WbfsysDocumentUsage&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.document_usage.label',
        Acl::DELETE
...
}//end class WbfsysDocumentUsage_Selection_Element
