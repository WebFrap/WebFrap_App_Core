 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocumentUsage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocumentUsage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocumentUsage_Selection_Element
    (
      'selectionWbfsysDocumentUsage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Document Usages', 'wbfsys.document_usage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DocumentUsage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDocumentUsage',
      'WbfsysDocumentUsage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocumentUsage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocumentUsage_Selection_Ui
