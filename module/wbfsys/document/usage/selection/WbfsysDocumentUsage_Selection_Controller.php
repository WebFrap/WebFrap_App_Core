 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysDocumentUsage_Selection' ) );
...
} // end class WbfsysDocumentUsage_Selection_Controller */
