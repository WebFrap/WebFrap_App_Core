 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysDocumentUsage_'.$listType ) );
...
} // end class WbfsysDocumentUsage_Listing_Controller */
