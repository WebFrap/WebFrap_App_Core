 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Document Usages
  *
  ...
  *  }
  *
  * @return WbfsysDocumentUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocumentUsage_Table_Element( 'tableWbfsysDocumentUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_document_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Document Usages', 'wbfsys.document_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_document_usage';
      ...
      $searchElement->searchKey = 'wbfsys_document_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDocumentUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocumentUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDocumentUsage listing maske
   *
   * @param WbfsysDocumentUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDocumentUsage  = $model->getEntityWbfsysDocumentUsage();
    ...
    $formWbfsysDocumentUsage->setKeyName( 'wbfsys_document_usage' );
...
}//end class WbfsysDocumentUsage_Table_Ui
