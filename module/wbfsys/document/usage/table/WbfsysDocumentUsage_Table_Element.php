 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_document_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDocumentUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocumentUsage.show&amp;target_mask=WbfsysDocumentUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocumentUsage.edit&amp;target_mask=WbfsysDocumentUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.document_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocumentUsage.delete&amp;target_mask=WbfsysDocumentUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.document_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_document_usage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DocumentUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Document Usages." >{$iconDelete} Delete selected Document Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Document Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DocumentUsage_Multi.deleteAll" >{$iconClean} Delete all Document Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDocumentUsage_Table_Element
