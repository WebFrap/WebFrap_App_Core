 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_document_usage';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDocumentUsage';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDocumentUsage' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDocumentUsage entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_document( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDocument_Entity' ) )
    {
      ...
      $inputIdDocument = $this->view->newInput( 'input'.$this->prefix.'IdDocument', 'Window' );
      $inputIdDocument->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_document]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_document'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Document (Document Usage)', 'wbfsys.document_usage.label' ),
      ));
      ...
      $inputIdDocument->setReadOnly( $this->isReadOnly( 'id_document' ) );
      $inputIdDocument->setLabel( $this->view->i18n->l( 'Document', 'wbfsys.document_usage.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Document.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_document'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdDocument->buildJavascript( 'wgt-input-'.$this->keyName.'_id_document'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_document */
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Document Usage)', 'wbfsys.document_usage.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Document Usage)', 'wbfsys.document_usage.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Document Usage)', 'wbfsys.document_usage.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.document_usage.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Document Usage)', 'wbfsys.document_usage.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.document_usage.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Document Usage)', 'wbfsys.document_usage.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.document_usage.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Document Usage)', 'wbfsys.document_usage.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.document_usage.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Document Usage)', 'wbfsys.document_usage.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.document_usage.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Document Usage)', 'wbfsys.document_usage.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.document_usage.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Document Usage)', 'wbfsys.document_usage.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.document_usage.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_document_usage_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_document_usage_m_role_change';
...
}//end class WbfsysDocumentUsage_Form */
