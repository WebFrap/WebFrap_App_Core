 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysDocumentUsage_IdDocument( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDocument_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Document.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDocumentUsage', array_keys( $this->fields['wbfsys_document_usage']), true ),
...
}//end class WbfsysDocumentUsage_Crud_Create_Form */
