 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocumentUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DocumentUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocumentUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_document_usage';
    $params->namespace   = 'wbfsys_document_usage-create';
    ...
    $this->setTemplate( 'wbfsys/document_usage/modal/crud/form_create' );
...
}//end class WbfsysDocumentUsage_Crud_Create_Modal_View
