 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDocumentUsage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDocumentUsage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDocumentUsage_Entity */
      $entity = $orm->get( 'WbfsysDocumentUsage', $rootId );
    }
...
}//end class WbfsysDocumentUsage_Crud_Access_Root
