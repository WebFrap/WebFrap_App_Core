 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentUsage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocumentUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocumentUsage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Document Usage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocumentUsage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocumentUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocumentUsage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_document_usage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/document_usage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocumentUsage_Crud_Edit' );
...
}//end class WbfsysDocumentUsage_Crud_Edit_Maintab_View
