 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocument entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Document.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Document.insert';
    $params->formId       = 'wgt-form-wbfsys_document';
    $params->namespace   = 'wbfsys_document-create';
    ...
    $this->setTemplate( 'wbfsys/document/modal/crud/form_create' );
...
}//end class WbfsysDocument_Crud_Create_Modal_View
