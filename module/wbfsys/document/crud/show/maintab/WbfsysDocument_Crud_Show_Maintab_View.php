 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDocument Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocument = $this->model->getEntityWbfsysDocument();
    ...
    (
      ...
      array( 'text' => $entityWbfsysDocument->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Document.show  &amp;objid='.$entityWbfsysDocument
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Document.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_document-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/document/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDocument_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Document.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_document' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_document a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Document.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Document.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDocument_Crud_Show_Maintab_View
