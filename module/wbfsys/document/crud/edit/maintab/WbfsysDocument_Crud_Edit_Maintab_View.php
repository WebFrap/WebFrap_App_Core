 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocument Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocument = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Document.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocument
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Document.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_document-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/document/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocument_Crud_Edit' );
...
}//end class WbfsysDocument_Crud_Edit_Maintab_View
