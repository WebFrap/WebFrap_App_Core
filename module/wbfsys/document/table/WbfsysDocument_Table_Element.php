 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_document';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDocument_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Document.show&amp;target_mask=WbfsysDocument&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Document.edit&amp;target_mask=WbfsysDocument&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.document.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Document.delete&amp;target_mask=WbfsysDocument&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.document.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.document.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.document.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.document.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_document_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Document.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_document_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_document_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.DocumentType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_document_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Document_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Documents." >{$iconDelete} Delete selected Documents</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Documents. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Document_Multi.deleteAll" >{$iconClean} Delete all Documents</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDocument_Table_Element
