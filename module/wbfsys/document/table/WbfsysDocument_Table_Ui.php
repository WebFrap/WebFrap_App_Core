...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Documents
  *
  ...
  *  }
  *
  * @return WbfsysDocument_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocument_Table_Element( 'tableWbfsysDocument', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_document-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Documents', 'wbfsys.document.label' );
      //$tabPanel->searchKey = 'wbfsys_document';
      ...
      $searchElement->searchKey = 'wbfsys_document';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDocument_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocument', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDocument listing maske
   *
   * @param WbfsysDocument_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDocument  = $model->getEntityWbfsysDocument();
    ...
    $formWbfsysDocument->setKeyName( 'wbfsys_document' );
...
}//end class WbfsysDocument_Table_Ui
