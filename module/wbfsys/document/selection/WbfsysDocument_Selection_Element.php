 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_document';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Document.show&amp;target_mask=WbfsysDocument&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Document.edit&amp;target_mask=WbfsysDocument&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.document.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Document.delete&amp;target_mask=WbfsysDocument&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.document.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_document_name'])).'</td>'.NL;
...
}//end class WbfsysDocument_Selection_Element
