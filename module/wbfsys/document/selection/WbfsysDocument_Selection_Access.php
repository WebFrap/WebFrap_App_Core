 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDocument_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_document.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_document.rowid ",
      'acls'
    );
...
}//end class WbfsysDocument_Selection_Access
