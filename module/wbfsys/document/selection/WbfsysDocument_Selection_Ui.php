 ...
 * @licence WebFrap.net
 */
class WbfsysDocument_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocument_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocument_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocument_Selection_Element
    (
      'selectionWbfsysDocument',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Documents', 'wbfsys.document.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Document.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDocument',
      'WbfsysDocument_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocument_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocument_Selection_Ui
