 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_document_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDocumentTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysDocumentTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysDocumentTypeI18n';
   ...
   *
   * @var WbfsysDocumentTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysDocumentTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDocumentTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDocumentTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.document_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_document_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_document_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysDocumentType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysDocumentType not exists' );

      Log::warn('Looks like the Entity: WbfsysDocumentType is missing');
      ...
      //p: Window
      $objidWbfsysDocumentType = $this->entity->getData('id_wbfsys_document_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysDocumentType
          || !$entityWbfsysDocumentType = $this->db->orm->get
          (
            'WbfsysDocumentType',
            $objidWbfsysDocumentType
          )
      ...
      {
        $entityWbfsysDocumentType = $this->db->orm->newEntity( 'WbfsysDocumentType' );
      }

      $inputIdWbfsysDocumentType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysDocumentType', 'Window' );
      $inputIdWbfsysDocumentType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_document_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_document_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Document Type (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysDocumentType->assignedForm = $this->assignedForm;

      $inputIdWbfsysDocumentType->setWidth( 'medium' );

      $inputIdWbfsysDocumentType->setData( $this->entity->getData( 'id_wbfsys_document_type' )  );
      $inputIdWbfsysDocumentType->setReadOnly( $this->isReadOnly( 'id_wbfsys_document_type' ) );
      $inputIdWbfsysDocumentType->setLabel( $this->view->i18n->l( 'Wbfsys Document Type', 'wbfsys.document_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.DocumentType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_document_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysDocumentType->setListUrl ( $listUrl );
      $inputIdWbfsysDocumentType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysDocumentType->setEntityUrl( 'maintab.php?c=Wbfsys.DocumentType.edit' );
      $inputIdWbfsysDocumentType->conEntity         = $entityWbfsysDocumentType;
      $inputIdWbfsysDocumentType->refresh           = $this->refresh;
      $inputIdWbfsysDocumentType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysDocumentType->view = $this->view;
      $inputIdWbfsysDocumentType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_document_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysDocumentType );
  ...
  }//end public function input_id_wbfsys_document_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.document_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.document_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.document_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.document_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.document_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.document_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.document_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.document_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.document_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Document Type I18n)', 'wbfsys.document_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_document_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_document_type_i18n_m_role_change';
...
}//end class WbfsysDocumentTypeI18n_Form */
