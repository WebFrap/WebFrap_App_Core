 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysDocumentType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysDocumentType_Export_Listing_Access';
    ...
    // create a new WbfsysDocumentType window
    $view = $this->loadView
    (
    	'export-wbfsys_document_type',
    	'WbfsysDocumentType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysDocumentType_Export' );
...
} // end class WbfsysDocumentType_Export_Controller_Genf
