 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_document_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysDocumentType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocumentType_Acl_Dset' );
    /* @var $query WbfsysDocumentType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocumentType_Acl_Dset_Treetable' );
    /* @var $query WbfsysDocumentType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysDocumentType_Acl_Dset_Model */
