 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysDocumentType_Acl_Dset' );
    ...
    $entityWbfsysDocumentType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysDocumentType_Acl_Dset_Ajax_View */
