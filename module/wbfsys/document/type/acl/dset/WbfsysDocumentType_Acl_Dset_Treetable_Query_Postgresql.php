 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_document_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysDocumentType_Acl_Dset_Treetable_Query_Postgresql */
