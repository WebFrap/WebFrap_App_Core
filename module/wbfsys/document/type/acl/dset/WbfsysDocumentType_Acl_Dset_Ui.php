 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysDocumentType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysDocumentType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysDocumentType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysDocumentType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_document_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'document Type "{@label@}" User Access',
        'wbfsys.document_type.label',
        array
        (
          'label' => $entityWbfsysDocumentType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_document_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysDocumentType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysDocumentType_Acl_Dset_Ui */
