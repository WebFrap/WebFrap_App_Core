 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysDocumentType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysDocumentType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysDocumentType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDocumentType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_document_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysDocumentType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDocumentType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_document_type-acl-dset', 
    	'WbfsysDocumentType_Acl_Dset',
...
} // end class WbfsysDocumentType_Acl_Dset_Controller */
