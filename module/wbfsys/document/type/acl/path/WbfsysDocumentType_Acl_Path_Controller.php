 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_document_type_acl_graph', 
      'WbfsysDocumentType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysDocumentType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysDocumentType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysDocumentType_Acl_Path_Maintab_View  */
...
} // end class WbfsysDocumentType_Acl_Path_Controller */
