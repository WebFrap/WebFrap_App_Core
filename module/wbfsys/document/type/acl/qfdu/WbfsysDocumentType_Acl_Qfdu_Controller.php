 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysDocumentType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_document_type-acl-qfdu-aAjax',
      'WbfsysDocumentType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysDocumentType_Acl_Qfdu_Controller */
