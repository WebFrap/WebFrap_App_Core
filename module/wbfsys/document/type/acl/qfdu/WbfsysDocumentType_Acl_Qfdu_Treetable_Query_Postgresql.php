 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_document_type.name as "wbfsys_document_type_name"',
      'wbfsys_document_type.rowid as "wbfsys_document_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_document_type on wbfsys_group_users.vid = wbfsys_document_type.rowid'
    );
...
} // end class WbfsysDocumentType_Acl_Qfdu_Treetable_Query_Postgresql */
