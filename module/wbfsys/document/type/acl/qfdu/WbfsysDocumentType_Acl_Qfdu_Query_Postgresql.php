 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_document_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_document_type.rowid as id,
    wbfsys_document_type.name as value,
    wbfsys_document_type.name as label
  FROM
...
} // end class WbfsysDocumentType_Acl_Qfdu_Query_Postgresql */
