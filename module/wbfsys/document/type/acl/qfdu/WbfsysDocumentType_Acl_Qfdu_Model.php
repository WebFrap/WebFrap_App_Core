 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_document_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysDocumentType = $orm->get('WbfsysDocumentType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_document_type_name']  = $refEntityWbfsysDocumentType->name;

    }
    $tabData['wbfsys_document_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysDocumentType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocumentType_Acl' );
    /* @var $query WbfsysDocumentType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocumentType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysDocumentType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocumentType_Acl_Qfdu' );
    /* @var $query WbfsysDocumentType_Acl_Qfdu_Query  */
...
} // end class WbfsysDocumentType_Acl_Qfdu_Model */
