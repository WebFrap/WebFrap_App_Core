 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysDocumentType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocumentType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_document_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'document Type', 'wbfsys.document_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_document_type_acl';
...
} // end class WbfsysDocumentType_Acl_Ui */
