 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DocumentType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_document_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.DocumentType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_document_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/document_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'document Type', 'wbfsys.document_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_document_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysDocumentType_Acl' );
...
} // end class WbfsysDocumentType_Acl_Maintab_View */
