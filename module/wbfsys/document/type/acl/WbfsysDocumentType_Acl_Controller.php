 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysDocumentType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysDocumentType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_document_type_acl_listing',
      'WbfsysDocumentType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysDocumentType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysDocumentType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysDocumentType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_document_type-acl',
    	'WbfsysDocumentType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_document_type_acl_masks_listing',
      'WbfsysDocumentType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysDocumentType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysDocumentType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysDocumentType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysDocumentType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysDocumentType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysDocumentType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_document_type-acl-qfdu',
    	'WbfsysDocumentType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysDocumentType_Acl_Controller */
