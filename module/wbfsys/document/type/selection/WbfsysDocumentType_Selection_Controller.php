 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysDocumentType_Selection' ) );
...
} // end class WbfsysDocumentType_Selection_Controller */
