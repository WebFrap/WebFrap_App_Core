 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocumentType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocumentType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocumentType_Selection_Element
    (
      'selectionWbfsysDocumentType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection document Types', 'wbfsys.document_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DocumentType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDocumentType',
      'WbfsysDocumentType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocumentType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocumentType_Selection_Ui
