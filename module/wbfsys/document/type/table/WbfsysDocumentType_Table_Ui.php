 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für document Types
  *
  ...
  *  }
  *
  * @return WbfsysDocumentType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocumentType_Table_Element( 'tableWbfsysDocumentType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_document_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'document Types', 'wbfsys.document_type.label' );
      //$tabPanel->searchKey = 'wbfsys_document_type';
      ...
      $searchElement->searchKey = 'wbfsys_document_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDocumentType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocumentType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDocumentType listing maske
   *
   * @param WbfsysDocumentType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDocumentType  = $model->getEntityWbfsysDocumentType();
    ...
    $formWbfsysDocumentType->setKeyName( 'wbfsys_document_type' );
...
}//end class WbfsysDocumentType_Table_Ui
