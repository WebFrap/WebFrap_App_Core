 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysDocumentType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_document_type.rowid as id',
      'wbfsys_document_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_document_type.m_order as "wbfsys_document_type-m_order-order"' );

    $criteria->from( 'wbfsys_document_type' );



      $criteria->orderBy( 'wbfsys_document_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_document_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_document_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysDocumentType_Selectbox_Query_Postgresql
