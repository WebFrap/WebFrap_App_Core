 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocumentType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DocumentType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocumentType.insert';
    $params->formId       = 'wgt-form-wbfsys_document_type';
    $params->namespace   = 'wbfsys_document_type-create';
    ...
    $this->setTemplate( 'wbfsys/document_type/modal/crud/form_create' );
...
}//end class WbfsysDocumentType_Crud_Create_Modal_View
