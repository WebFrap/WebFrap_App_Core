 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDocumentType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDocumentType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDocumentType_Entity */
      $entity = $orm->get( 'WbfsysDocumentType', $rootId );
    }
...
}//end class WbfsysDocumentType_Crud_Access_Root
