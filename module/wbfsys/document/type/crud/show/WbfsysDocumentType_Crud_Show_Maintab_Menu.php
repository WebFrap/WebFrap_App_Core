 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Crud_Show_Maintab_Menu
  extends WgtDropmenu
{
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_document_type-show" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysDocumentType_Crud_Show_Maintab_Menu
