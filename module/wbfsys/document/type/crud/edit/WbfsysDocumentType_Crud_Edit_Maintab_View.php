 ...
 * @licence WebFrap.net
 */
class WbfsysDocumentType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocumentType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocumentType = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocumentType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocumentType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocumentType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_document_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/document_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocumentType_Crud_Edit' );
...
}//end class WbfsysDocumentType_Crud_Edit_Maintab_View
