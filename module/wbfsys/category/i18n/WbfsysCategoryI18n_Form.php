...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_category_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCategoryI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysCategoryI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysCategoryI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysCategoryI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCategoryI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCategoryI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Category I18n)', 'wbfsys.category_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.category_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_category
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_category( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysCategory_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysCategory not exists' );

      Log::warn('Looks like the Entity: WbfsysCategory is missing');
      ...
      //p: Window
      $objidWbfsysCategory = $this->entity->getData('id_wbfsys_category') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysCategory
          || !$entityWbfsysCategory = $this->db->orm->get
          (
            'WbfsysCategory',
            $objidWbfsysCategory
          )
      ...
      {
        $entityWbfsysCategory = $this->db->orm->newEntity( 'WbfsysCategory' );
      }

      $inputIdWbfsysCategory = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysCategory', 'Window' );
      $inputIdWbfsysCategory->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_category]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_category'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Category (Category I18n)', 'wbfsys.category_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysCategory->assignedForm = $this->assignedForm;

      $inputIdWbfsysCategory->setWidth( 'medium' );

      $inputIdWbfsysCategory->setData( $this->entity->getData( 'id_wbfsys_category' )  );
      $inputIdWbfsysCategory->setReadOnly( $this->isReadOnly( 'id_wbfsys_category' ) );
      $inputIdWbfsysCategory->setLabel( $this->view->i18n->l( 'Wbfsys Category', 'wbfsys.category_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Category.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_category'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysCategory->setListUrl ( $listUrl );
      $inputIdWbfsysCategory->setListIcon( 'control/connect.png' );
      $inputIdWbfsysCategory->setEntityUrl( 'maintab.php?c=Wbfsys.Category.edit' );
      $inputIdWbfsysCategory->conEntity         = $entityWbfsysCategory;
      $inputIdWbfsysCategory->refresh           = $this->refresh;
      $inputIdWbfsysCategory->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysCategory->view = $this->view;
      $inputIdWbfsysCategory->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_category'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysCategory );
  ...
  }//end public function input_id_wbfsys_category */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Category I18n)', 'wbfsys.category_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.category_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Category I18n)', 'wbfsys.category_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.category_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Category I18n)', 'wbfsys.category_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.category_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Category I18n)', 'wbfsys.category_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.category_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Category I18n)', 'wbfsys.category_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.category_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Category I18n)', 'wbfsys.category_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.category_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Category I18n)', 'wbfsys.category_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.category_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Category I18n)', 'wbfsys.category_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.category_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Category I18n)', 'wbfsys.category_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.category_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Category I18n)', 'wbfsys.category_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Category I18n)', 'wbfsys.category_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_category_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_category_i18n_m_role_change';
...
}//end class WbfsysCategoryI18n_Form */
