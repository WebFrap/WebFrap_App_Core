 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysCategory_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysCategory_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCategory_Selection_Element
    (
      'selectionWbfsysCategory',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection issue categorys', 'wbfsys.category.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Category.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysCategory',
      'WbfsysCategory_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysCategory_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysCategory_Selection_Ui
