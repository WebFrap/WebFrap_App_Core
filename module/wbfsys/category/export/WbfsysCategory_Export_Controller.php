 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysCategory_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysCategory_Export_Listing_Access';
    ...
    // create a new WbfsysCategory window
    $view = $this->loadView
    (
    	'export-wbfsys_category',
    	'WbfsysCategory_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysCategory_Export' );
...
} // end class WbfsysCategory_Export_Controller_Genf
