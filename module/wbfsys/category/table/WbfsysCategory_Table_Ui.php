...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für issue categorys
  *
  ...
  *  }
  *
  * @return WbfsysCategory_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCategory_Table_Element( 'tableWbfsysCategory', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_category-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'issue categorys', 'wbfsys.category.label' );
      //$tabPanel->searchKey = 'wbfsys_category';
      ...
      $searchElement->searchKey = 'wbfsys_category';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCategory_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCategory', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCategory listing maske
   *
   * @param WbfsysCategory_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCategory  = $model->getEntityWbfsysCategory();
    ...
    $formWbfsysCategory->setKeyName( 'wbfsys_category' );
...
}//end class WbfsysCategory_Table_Ui
