 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCategory Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCategory = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit issue category: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Category.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCategory
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Category.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_category-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/category/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCategory_Crud_Edit' );
...
}//end class WbfsysCategory_Crud_Edit_Maintab_View
