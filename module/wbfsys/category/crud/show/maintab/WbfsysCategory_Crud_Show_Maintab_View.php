 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysCategory Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCategory = $this->model->getEntityWbfsysCategory();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show issue category: {@text@}',
      'wbfsys.category.label',
      array( 'text' => $entityWbfsysCategory->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Category.show  &amp;objid='.$entityWbfsysCategory
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Category.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_category-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/category/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysCategory_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Category.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_category' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_category a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Category.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Category.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysCategory_Crud_Show_Maintab_View
