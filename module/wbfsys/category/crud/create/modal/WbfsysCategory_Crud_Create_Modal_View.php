 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCategory entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Category.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Category.insert';
    $params->formId       = 'wgt-form-wbfsys_category';
    $params->namespace   = 'wbfsys_category-create';
    ...
    $this->setTemplate( 'wbfsys/category/modal/crud/form_create' );
...
}//end class WbfsysCategory_Crud_Create_Modal_View
