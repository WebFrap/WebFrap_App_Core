 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Category_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_category-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Category_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_category-acl-update';
    ...
    $this->setTemplate( 'wbfsys/category/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'issue category', 'wbfsys.category.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_category_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysCategory_Acl' );
...
} // end class WbfsysCategory_Acl_Maintab_View */
