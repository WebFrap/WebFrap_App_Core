 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_category')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysCategory = $orm->get('WbfsysCategory', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_category_name']  = $refEntityWbfsysCategory->name;

    }
    $tabData['wbfsys_category_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysCategory_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCategory_Acl' );
    /* @var $query WbfsysCategory_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCategory_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysCategory_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCategory_Acl_Qfdu' );
    /* @var $query WbfsysCategory_Acl_Qfdu_Query  */
...
} // end class WbfsysCategory_Acl_Qfdu_Model */
