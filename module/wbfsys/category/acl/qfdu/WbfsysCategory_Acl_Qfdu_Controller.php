 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysCategory_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_category-acl-qfdu-aAjax',
      'WbfsysCategory_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysCategory_Acl_Qfdu_Controller */
