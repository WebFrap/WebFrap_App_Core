 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_category.name as "wbfsys_category_name"',
      'wbfsys_category.rowid as "wbfsys_category_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_category on wbfsys_group_users.vid = wbfsys_category.rowid'
    );
...
} // end class WbfsysCategory_Acl_Qfdu_Treetable_Query_Postgresql */
