 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_category.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_category.rowid as id,
    wbfsys_category.name as value,
    wbfsys_category.name as label
  FROM
    wbfsys_category
  WHERE
    {$sqlWhere}
...
} // end class WbfsysCategory_Acl_Qfdu_Query_Postgresql */
