 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysCategory
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysCategory_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysCategory_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysCategory_Acl_Model */
    $model   = $this->loadModel( 'WbfsysCategory_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_category_acl_masks_listing',
      'WbfsysCategory_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysCategory_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysCategory_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysCategory_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysCategory_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysCategory_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysCategory_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_category-acl-qfdu',
    	'WbfsysCategory_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysCategory_Acl_Controller */
