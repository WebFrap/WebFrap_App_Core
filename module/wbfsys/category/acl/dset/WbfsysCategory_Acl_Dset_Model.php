 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_category'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysCategory', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCategory_Acl_Dset' );
    /* @var $query WbfsysCategory_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCategory_Acl_Dset_Treetable' );
    /* @var $query WbfsysCategory_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysCategory_Acl_Dset_Model */
