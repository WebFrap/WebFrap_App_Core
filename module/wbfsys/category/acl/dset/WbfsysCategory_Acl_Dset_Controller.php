 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysCategory_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysCategory_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysCategory = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCategory_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_category-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysCategory, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCategory_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_category-acl-dset', 
    	'WbfsysCategory_Acl_Dset',
...
} // end class WbfsysCategory_Acl_Dset_Controller */
