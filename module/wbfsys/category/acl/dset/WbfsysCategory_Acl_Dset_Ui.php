 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysCategory_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysCategory_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysCategory, $areaId, $access, $params  )
  {

    $listObj = new WbfsysCategory_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_category-acl-dset' );
    ...
    else
    {
      ...
      (
        'issue category "{@label@}" User Access',
        'wbfsys.category.label',
        array
        (
          'label' => $entityWbfsysCategory->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_category_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysCategory_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysCategory_Acl_Dset_Ui */
