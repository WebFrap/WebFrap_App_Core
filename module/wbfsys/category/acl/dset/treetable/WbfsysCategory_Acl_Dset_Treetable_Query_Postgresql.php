 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_category.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysCategory_Acl_Dset_Treetable_Query_Postgresql */
