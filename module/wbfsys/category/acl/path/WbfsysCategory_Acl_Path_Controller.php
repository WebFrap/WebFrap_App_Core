 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_category_acl_graph', 
      'WbfsysCategory_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysCategory_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysCategory_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysCategory_Acl_Path_Maintab_View  */
...
} // end class WbfsysCategory_Acl_Path_Controller */
