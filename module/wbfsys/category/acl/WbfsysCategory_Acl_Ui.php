...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysCategory_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCategory_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_category-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'issue category', 'wbfsys.category.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_category_acl';
...
} // end class WbfsysCategory_Acl_Ui */
