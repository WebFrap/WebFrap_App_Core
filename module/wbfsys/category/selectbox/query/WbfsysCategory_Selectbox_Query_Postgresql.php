 ...
 * @licence WebFrap.net
 */
class WbfsysCategory_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysCategory Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_category.rowid as id',
      'wbfsys_category.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_category.m_order as "wbfsys_category-m_order-order"' );

    $criteria->from( 'wbfsys_category' );



      $criteria->orderBy( 'wbfsys_category.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_category.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_category.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysCategory_Selectbox_Query_Postgresql
