 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysWidget_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysWidget_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysWidget_Entity */
      $entity = $orm->get( 'WbfsysWidget', $rootId );
    }
...
}//end class WbfsysWidget_Crud_Access_Root
