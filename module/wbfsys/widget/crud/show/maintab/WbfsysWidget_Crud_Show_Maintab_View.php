 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysWidget Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysWidget = $this->model->getEntityWbfsysWidget();
    ...
    (
      'Show Widget: {@text@}',
      'wbfsys.widget.label',
      array( 'text' => $entityWbfsysWidget->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Widget.show  &amp;objid='.$entityWbfsysWidget
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Widget.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_widget-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/widget/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysWidget_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Widget.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_widget' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_widget a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Widget.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Widget.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysWidget_Crud_Show_Maintab_View
