 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysWidget entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Widget.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Widget.insert';
    $params->formId       = 'wgt-form-wbfsys_widget';
    $params->namespace   = 'wbfsys_widget-create';
    ...
    $this->setTemplate( 'wbfsys/widget/modal/crud/form_create' );
...
}//end class WbfsysWidget_Crud_Create_Modal_View
