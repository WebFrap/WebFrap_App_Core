 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysWidget Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysWidget = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Widget.edit&amp;utf8=✓&amp;objid='.$entityWbfsysWidget
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Widget.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_widget-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/widget/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysWidget_Crud_Edit' );
...
}//end class WbfsysWidget_Crud_Edit_Maintab_View
