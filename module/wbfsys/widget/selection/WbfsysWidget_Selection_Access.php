 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysWidget_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_widget.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_widget.rowid ",
      'acls'
    );
...
}//end class WbfsysWidget_Selection_Access
