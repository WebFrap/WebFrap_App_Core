 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_widget';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Widget.show&amp;target_mask=WbfsysWidget&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.widget.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Widget.edit&amp;target_mask=WbfsysWidget&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.widget.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Widget.delete&amp;target_mask=WbfsysWidget&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.widget.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_widget_name'])).'</td>'.NL;
...
}//end class WbfsysWidget_Selection_Element
