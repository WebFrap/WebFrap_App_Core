 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Selection_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
          ...
          if( strpos( $condition['free'], ',' ) )
          {
            ...
            foreach( $parts as $part )
            {
              ...
              ('(
                ...
                UPPER(wbfsys_widget.name) like UPPER(\'%'.$part.'%\')
              )');
...
}//end class WbfsysWidget_Selection_Query_Postgresql
