 ...
 * @licence WebFrap.net
 */
class WbfsysWidget_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysWidget_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysWidget_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysWidget_Selection_Element
    (
      'selectionWbfsysWidget',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Widgets', 'wbfsys.widget.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Widget.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysWidget',
      'WbfsysWidget_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysWidget_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysWidget_Selection_Ui
