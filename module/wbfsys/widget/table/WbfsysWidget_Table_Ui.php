...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Widgets
  *
  ...
  *  }
  *
  * @return WbfsysWidget_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysWidget_Table_Element( 'tableWbfsysWidget', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_widget-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Widgets', 'wbfsys.widget.label' );
      //$tabPanel->searchKey = 'wbfsys_widget';
      ...
      $searchElement->searchKey = 'wbfsys_widget';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysWidget_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysWidget', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysWidget listing maske
   *
   * @param WbfsysWidget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysWidget  = $model->getEntityWbfsysWidget();
    ...
    $formWbfsysWidget->setKeyName( 'wbfsys_widget' );
...
}//end class WbfsysWidget_Table_Ui
