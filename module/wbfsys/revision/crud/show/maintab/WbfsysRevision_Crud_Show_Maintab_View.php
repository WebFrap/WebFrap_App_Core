 ...
 * @licence WebFrap.net
 */
class WbfsysRevision_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysRevision Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRevision = $this->model->getEntityWbfsysRevision();
    ...
    (
      ...
      array( 'text' => $entityWbfsysRevision->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Revision.show  &amp;objid='.$entityWbfsysRevision
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Revision.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_revision-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/revision/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysRevision_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Revision.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_revision' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_revision a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Revision.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Revision.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysRevision_Crud_Show_Maintab_View
