 ...
 * @licence WebFrap.net
 */
class WbfsysRevision_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysRevision_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysRevision_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysRevision_Entity */
      $entity = $orm->get( 'WbfsysRevision', $rootId );
    }
...
}//end class WbfsysRevision_Crud_Access_Root
