 ...
 * @licence WebFrap.net
 */
class WbfsysRevision_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysRevision entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Revision.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Revision.insert';
    $params->formId       = 'wgt-form-wbfsys_revision';
    $params->namespace   = 'wbfsys_revision-create';
    ...
    $this->setTemplate( 'wbfsys/revision/modal/crud/form_create' );
...
}//end class WbfsysRevision_Crud_Create_Modal_View
