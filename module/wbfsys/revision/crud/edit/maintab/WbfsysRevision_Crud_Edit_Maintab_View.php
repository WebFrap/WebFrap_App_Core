 ...
 * @licence WebFrap.net
 */
class WbfsysRevision_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysRevision Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysRevision = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Revision.edit&amp;utf8=✓&amp;objid='.$entityWbfsysRevision
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Revision.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_revision-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/revision/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysRevision_Crud_Edit' );
...
}//end class WbfsysRevision_Crud_Edit_Maintab_View
