...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Revisions
  *
  ...
  *  }
  *
  * @return WbfsysRevision_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysRevision_Table_Element( 'tableWbfsysRevision', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_revision-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Revisions', 'wbfsys.revision.label' );
      //$tabPanel->searchKey = 'wbfsys_revision';
      ...
      $searchElement->searchKey = 'wbfsys_revision';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysRevision_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysRevision', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysRevision listing maske
   *
   * @param WbfsysRevision_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysRevision  = $model->getEntityWbfsysRevision();
    ...
    $formWbfsysRevision->setKeyName( 'wbfsys_revision' );
...
}//end class WbfsysRevision_Table_Ui
