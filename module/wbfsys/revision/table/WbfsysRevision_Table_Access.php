 ...
 * @licence WebFrap.net
 */
class WbfsysRevision_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysRevision_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_revision.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_revision.rowid ",
      'acls'
    );
...
}//end class WbfsysRevision_Table_Access
