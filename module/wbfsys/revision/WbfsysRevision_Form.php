...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_revision';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysRevision';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysRevision' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysRevision entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Revision)', 'wbfsys.revision.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.revision.label' ),
  ...
  * @return void
  */
  public function input_release_date( $params )
  {

      //tpl: class ui:date
      $inputReleaseDate = $this->view->newInput( 'input'.$this->prefix.'ReleaseDate' , 'Date' );
      $this->items['release_date'] = $inputReleaseDate;
      $inputReleaseDate->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[release_date]',
          'id'        => 'wgt-input-'.$this->keyName.'_release_date'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Release Date (Revision)', 'wbfsys.revision.label' ),
          'maxlength' => $this->entity->maxSize( 'release_date' ),
        )
      );
      $inputReleaseDate->setWidth( 'small' );

      $inputReleaseDate->setReadOnly( $this->isReadOnly( 'release_date' ) );
      $inputReleaseDate->setData( $this->entity->getDate( 'release_date' ) );
      $inputReleaseDate->setLabel
      (
        $this->view->i18n->l( 'Release Date', 'wbfsys.revision.label' ),
        $this->entity->required( 'release_date' )
      );
  ...
  }//end public function input_release_date */
  ...
  * @return void
  */
  public function input_change_log( $params )
  {

      //p: textarea
      $inputChangeLog = $this->view->newInput( 'input'.$this->prefix.'ChangeLog', 'Textarea' );
      $this->items['change_log'] = $inputChangeLog;
      $inputChangeLog->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[change_log]',
          'id'    => 'wgt-input-'.$this->keyName.'_change_log'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip full medium-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Change log (Revision)', 'wbfsys.revision.label' ),
        )
      );
      ...
      $inputChangeLog->setReadOnly( $this->isReadOnly( 'change_log' ) );
      $inputChangeLog->setLabel
      (
        $this->view->i18n->l( 'Change log', 'wbfsys.revision.label' ),
        $this->entity->required( 'change_log' )
      );
  ...
  }//end public function input_change_log */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Revision)', 'wbfsys.revision.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.revision.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Revision)', 'wbfsys.revision.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.revision.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Revision)', 'wbfsys.revision.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.revision.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Revision)', 'wbfsys.revision.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.revision.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Revision)', 'wbfsys.revision.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.revision.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Revision)', 'wbfsys.revision.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.revision.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Revision)', 'wbfsys.revision.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.revision.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Revision)', 'wbfsys.revision.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_revision_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_revision_m_role_change';
