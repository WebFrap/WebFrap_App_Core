 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysProbability Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_probability.rowid as id',
      'wbfsys_probability.name as value'
     ));
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_probability.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_probability.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysProbability_Selectbox_Query_Postgresql
