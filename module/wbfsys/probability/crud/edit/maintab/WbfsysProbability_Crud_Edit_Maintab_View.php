 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProbability Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProbability = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Probability: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Probability.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProbability
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Probability.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_probability-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/probability/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProbability_Crud_Edit' );
...
}//end class WbfsysProbability_Crud_Edit_Maintab_View
