 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysProbability Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProbability = $this->model->getEntityWbfsysProbability();
    ...
    (
      ...
      array( 'text' => $entityWbfsysProbability->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Probability.show  &amp;objid='.$entityWbfsysProbability
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Probability.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_probability-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/probability/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysProbability_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Probability.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_probability' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_probability a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Probability.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Probability.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysProbability_Crud_Show_Maintab_View
