 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProbability entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Probability.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Probability.insert';
    $params->formId       = 'wgt-form-wbfsys_probability';
    $params->namespace   = 'wbfsys_probability-create';
    ...
    $this->setTemplate( 'wbfsys/probability/modal/crud/form_create' );
...
}//end class WbfsysProbability_Crud_Create_Modal_View
