 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProbability Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_probability-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/probability/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Probability.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_probability';
    ...
    $form = $this->newForm( 'WbfsysProbability_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Probability.create');}});
});
...
}//end class WbfsysProbability_Crud_Create_Maintab_View
