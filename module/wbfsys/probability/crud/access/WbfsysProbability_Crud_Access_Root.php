 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProbability_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProbability_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProbability_Entity */
      $entity = $orm->get( 'WbfsysProbability', $rootId );
    }
...
}//end class WbfsysProbability_Crud_Access_Root
