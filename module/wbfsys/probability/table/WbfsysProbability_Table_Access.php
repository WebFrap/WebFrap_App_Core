 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProbability_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_probability.rowid ",
      'acls'
    );
...
}//end class WbfsysProbability_Table_Access
