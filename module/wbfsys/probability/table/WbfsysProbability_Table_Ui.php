 ...
 * @licence WebFrap.net
 */
class WbfsysProbability_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Probabilitys
  *
  ...
  *  }
  *
  * @return WbfsysProbability_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProbability_Table_Element( 'tableWbfsysProbability', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_probability-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Probabilitys', 'wbfsys.probability.label' );
      //$tabPanel->searchKey = 'wbfsys_probability';
      ...
      $searchElement->searchKey = 'wbfsys_probability';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProbability_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProbability', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProbability listing maske
   *
   * @param WbfsysProbability_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProbability  = $model->getEntityWbfsysProbability();
    ...
    $formWbfsysProbability->setKeyName( 'wbfsys_probability' );
...
}//end class WbfsysProbability_Table_Ui
