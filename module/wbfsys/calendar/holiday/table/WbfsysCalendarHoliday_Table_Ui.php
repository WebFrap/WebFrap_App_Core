 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Holidays
  *
  ...
  *  }
  *
  * @return WbfsysCalendarHoliday_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarHoliday_Table_Element( 'tableWbfsysCalendarHoliday', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar_holiday-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Holidays', 'wbfsys.calendar_holiday.label' );
      //$tabPanel->searchKey = 'wbfsys_calendar_holiday';
      ...
      $searchElement->searchKey = 'wbfsys_calendar_holiday';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCalendarHoliday_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCalendarHoliday', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCalendarHoliday listing maske
   *
   * @param WbfsysCalendarHoliday_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCalendarHoliday  = $model->getEntityWbfsysCalendarHoliday();
    ...
    $formWbfsysCalendarHoliday->setKeyName( 'wbfsys_calendar_holiday' );
...
}//end class WbfsysCalendarHoliday_Table_Ui
