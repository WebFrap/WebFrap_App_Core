 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCalendarHoliday Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCalendarHoliday = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CalendarHoliday.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCalendarHoliday
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CalendarHoliday.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_calendar_holiday-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/calendar_holiday/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCalendarHoliday_Crud_Edit' );
...
}//end class WbfsysCalendarHoliday_Crud_Edit_Maintab_View
