 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCalendarHoliday_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCalendarHoliday_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCalendarHoliday_Entity */
      $entity = $orm->get( 'WbfsysCalendarHoliday', $rootId );
    }
...
}//end class WbfsysCalendarHoliday_Crud_Access_Root
