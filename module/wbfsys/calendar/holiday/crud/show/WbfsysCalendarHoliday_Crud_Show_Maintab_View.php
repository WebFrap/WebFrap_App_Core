 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysCalendarHoliday Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCalendarHoliday = $this->model->getEntityWbfsysCalendarHoliday();
    ...
    (
      ...
      array( 'text' => $entityWbfsysCalendarHoliday->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CalendarHoliday.show  &amp;objid='.$entityWbfsysCalendarHoliday
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CalendarHoliday.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_calendar_holiday-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/calendar_holiday/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysCalendarHoliday_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.CalendarHoliday.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_calendar_holiday' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_calendar_holiday a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.CalendarHoliday.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.CalendarHoliday.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysCalendarHoliday_Crud_Show_Maintab_View
