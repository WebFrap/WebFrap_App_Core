 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysCalendarHoliday_IdCalendarType( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysCalendarType_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.CalendarType.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysCalendarHoliday', array_keys( $this->fields['wbfsys_calendar_holiday']), true ),
...
}//end class WbfsysCalendarHoliday_Crud_Create_Form */
