 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCalendarHoliday entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CalendarHoliday.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CalendarHoliday.insert';
    $params->formId       = 'wgt-form-wbfsys_calendar_holiday';
    $params->namespace   = 'wbfsys_calendar_holiday-create';
    ...
    $this->setTemplate( 'wbfsys/calendar_holiday/modal/crud/form_create' );
...
}//end class WbfsysCalendarHoliday_Crud_Create_Modal_View
