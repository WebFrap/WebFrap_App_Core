 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_calendar_holiday
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.CalendarHoliday.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_calendar_holiday-create';

    $access = new WbfsysCalendarHoliday_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_calendar_holiday-create',
      'WbfsysCalendarHoliday_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysCalendarHoliday_Crud_Model */
    $model = $this->loadModel( 'WbfsysCalendarHoliday_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.CalendarHoliday.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysCalendarHoliday = $model->getEntityWbfsysCalendarHoliday( $objid );
    ...
    if( !$entityWbfsysCalendarHoliday )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Holiday', 'wbfsys.calendar_holiday.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysCalendarHoliday;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_calendar_holiday:edit';

    $access = new WbfsysCalendarHoliday_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarHoliday );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_calendar_holiday-edit-'.$objid,
      'WbfsysCalendarHoliday_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_calendar_holiday-edit',
          $entityWbfsysCalendarHoliday,
          'Edit Holiday :'.$entityWbfsysCalendarHoliday->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_calendar_holiday:show';
    ...
    (
      'form-wbfsys_calendar_holiday-edit-'.$objid,
      'WbfsysCalendarHoliday_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_calendar_holiday-show',
          $entityWbfsysCalendarHoliday,
          'Show Holiday :'.$entityWbfsysCalendarHoliday->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_calendar_holiday
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.CalendarHoliday.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-insert';

    $access = new WbfsysCalendarHoliday_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysCalendarHoliday = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_calendar_holiday-update-'.$entityWbfsysCalendarHoliday;
      ...
      {
        $access = new WbfsysCalendarHoliday_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarHoliday );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysCalendarHoliday';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_calendar_holiday',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysCalendarHoliday_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.CalendarHoliday.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysCalendarHoliday, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysCalendarHoliday_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.CalendarHoliday.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-delete-'.$objid;

    $access = new WbfsysCalendarHoliday_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarHoliday );
    ...
    $error = $model->delete( $entityWbfsysCalendarHoliday, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysCalendarHoliday, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.CalendarHoliday.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.CalendarHoliday.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-listing';
    ...
    $containerClass = 'WbfsysCalendarHoliday_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_calendar_holiday',
      'WbfsysCalendarHoliday_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysCalendarHoliday_Table_Model */
    $model = $this->loadModel( 'WbfsysCalendarHoliday_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_calendar_holiday-'.$params->ltype,
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysCalendarHoliday
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysCalendarHoliday_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_calendar_holiday',
      'WbfsysCalendarHoliday_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysCalendarHoliday_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.CalendarHoliday.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarHoliday_Selection_Model */
    $model   = $this->loadModel( 'WbfsysCalendarHoliday_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_calendar_holiday-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_calendar_holiday-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_calendar_holiday',
      'WbfsysCalendarHoliday',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysCalendarHoliday, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysCalendarHoliday_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysCalendarHoliday_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_holiday-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_calendar_holiday' );
...
} // end class WbfsysCalendarHoliday_Controller */
