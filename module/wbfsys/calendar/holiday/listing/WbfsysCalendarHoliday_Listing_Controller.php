 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCalendarHoliday_'.$listType ) );
...
} // end class WbfsysCalendarHoliday_Listing_Controller */
