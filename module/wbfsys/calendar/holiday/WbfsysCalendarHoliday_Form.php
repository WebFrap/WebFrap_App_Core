 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_calendar_holiday';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCalendarHoliday';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCalendarHoliday' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCalendarHoliday entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.calendar_holiday.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.calendar_holiday.label' ),
  ...
  * @return void
  */
  public function input_the_day( $params )
  {

      //tpl: class ui:date
      $inputTheDay = $this->view->newInput( 'input'.$this->prefix.'TheDay' , 'Date' );
      $this->items['the_day'] = $inputTheDay;
      $inputTheDay->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[the_day]',
          'id'        => 'wgt-input-'.$this->keyName.'_the_day'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for The Day (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
          'maxlength' => $this->entity->maxSize( 'the_day' ),
        )
      );
      $inputTheDay->setWidth( 'small' );

      $inputTheDay->setReadOnly( $this->isReadOnly( 'the_day' ) );
      $inputTheDay->setData( $this->entity->getDate( 'the_day' ) );
      $inputTheDay->setLabel
      (
        $this->view->i18n->l( 'The Day', 'wbfsys.calendar_holiday.label' ),
        $this->entity->required( 'the_day' )
      );
  ...
  }//end public function input_the_day */
  ...
  */
  public function input_level( $params )
  {
      ...
      $inputLevel = $this->view->newInput( 'input'.$this->prefix.'Level', 'Numeric' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Level (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ...
      $inputLevel->setLabel
      (
        $this->view->i18n->l( 'Level', 'wbfsys.calendar_holiday.label' ) ,
  ...
  * @return void
  */
  public function input_id_calendar_type( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysCalendarType_Entity' ) )
    {
      ...
      $inputIdCalendarType = $this->view->newInput( 'input'.$this->prefix.'IdCalendarType', 'Window' );
      $inputIdCalendarType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_calendar_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_calendar_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Calendar Type (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ));
      ...
      $inputIdCalendarType->setReadOnly( $this->isReadOnly( 'id_calendar_type' ) );
      $inputIdCalendarType->setLabel( $this->view->i18n->l( 'Calendar Type', 'wbfsys.calendar_holiday.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.CalendarType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_calendar_type'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdCalendarType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_calendar_type'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_calendar_type */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.calendar_holiday.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.calendar_holiday.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.calendar_holiday.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.calendar_holiday.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.calendar_holiday.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.calendar_holiday.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.calendar_holiday.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.calendar_holiday.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Calendar Holiday)', 'wbfsys.calendar_holiday.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_holiday_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_holiday_m_role_change';
...
}//end class WbfsysCalendarHoliday_Form */
