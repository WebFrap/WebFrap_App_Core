 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysCalendarHoliday_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysCalendarHoliday_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysCalendarHoliday_Selection_Model
