 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarHoliday_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCalendarHoliday_Selection' ) );
...
} // end class WbfsysCalendarHoliday_Selection_Controller */
