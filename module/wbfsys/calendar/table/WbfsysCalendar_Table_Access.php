 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCalendar_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_calendar.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_calendar.rowid ",
      'acls'
    );
...
}//end class WbfsysCalendar_Table_Access
