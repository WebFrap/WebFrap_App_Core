...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Calendars
  *
  ...
  *  }
  *
  * @return WbfsysCalendar_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendar_Table_Element( 'tableWbfsysCalendar', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Calendars', 'wbfsys.calendar.label' );
      //$tabPanel->searchKey = 'wbfsys_calendar';
      ...
      $searchElement->searchKey = 'wbfsys_calendar';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCalendar_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCalendar', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCalendar listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCalendar  = $model->getEntityWbfsysCalendar();
    ...
    $formWbfsysCalendar->setKeyName( 'wbfsys_calendar' );
...
}//end class WbfsysCalendar_Table_Ui
