 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_calendar';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCalendar_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Calendar.show&amp;target_mask=WbfsysCalendar&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Calendar.edit&amp;target_mask=WbfsysCalendar&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.calendar.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Appointments',
            'modal.php?c=Wbfsys.Calendar_Ref_Appointments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.calendar.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Calendar.delete&amp;target_mask=WbfsysCalendar&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.calendar.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.calendar.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.calendar.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_calendar_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_calendar_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.CalendarType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_calendar_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Calendar_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Calendars." >{$iconDelete} Delete selected Calendars</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Calendars. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Calendar_Multi.deleteAll" >{$iconClean} Delete all Calendars</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCalendar_Table_Element
