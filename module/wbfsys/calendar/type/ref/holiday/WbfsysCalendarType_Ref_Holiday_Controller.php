 ...
 * If you want to extend this class write your coden in ControllerWbfsysCalendarType
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des holiday Referenztabs
  * für den wbfsys_calendar_type management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysCalendarType_Ref_Holiday_".$listType."_Access";
    ...
    $accessHoliday = new $containerClass( );
    $accessHoliday->load( $user->getProfileName(), $params );

    $params->aclNode = 'mgmt-wbfsys_calendar_type-ref-holiday';

    $params->accessHoliday = $accessHoliday;
    $params->paramsHoliday = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessHoliday->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_calendar_type-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysCalendarType_Ref_Holiday_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelHoliday = $this->loadModel
    (
      'WbfsysCalendarType_Ref_Holiday_'.$listType
    );
    $modelHoliday->setAccess( $accessHoliday );
    
    $view->setModel( $modelHoliday );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdHoliday = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysCalendarType_Ref_Holiday_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_calendar_type-ref-holiday-'.$listType.'-ajax',
    	'WbfsysCalendarType_Ref_Holiday_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysCalendarHoliday by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_calendar_holiday' ); //def wbfsys_calendar_holiday


  } // end public function cleanPost */

} // end WbfsysCalendarType_Ref_Holiday_Controller
