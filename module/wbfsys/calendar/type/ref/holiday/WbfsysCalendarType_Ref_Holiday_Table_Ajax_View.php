 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.CalendarType_Ref_Holiday.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysCalendarType_Ref_Holiday_Table_Ajax_View
