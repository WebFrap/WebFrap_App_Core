 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listHoliday = $this->getRegisterd('listRefHoliday'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listHoliday was not registered'
        );
      }

      foreach( $listHoliday as $entityWbfsysCalendarType )
      {
        if(!$orm->save( $entityWbfsysCalendarType) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save calendar Type '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved calendar Type '.$entityText,
              'wbfsys.calendar_type.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listHoliday as $entityWbfsysCalendarType )
      {
        ...
        {
          $entityTexts[] = $entityText = $entityWbfsysCalendarType->text();
        }
      }
      ...
      (
        $view->i18n->l
        (
          'Successfully saved calendar Type: '.$textSaved,
          'wbfsys.calendar_type.message',
          array($textSaved)
        )
      );
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefHoliday',$listWbfsysCalendarHoliday);
      return true;
...
}//end class WbfsysCalendarType_Ref_Holiday_Multi_Model
