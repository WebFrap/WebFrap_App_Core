 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_calendar_holiday Attributes: name; access_key; the_day; level; id_calendar_type; description; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_calendar_type-ref-holiday',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_calendar_type-ref-holiday' );
  ...
  /**
   * @param WbfsysCalendarType_Ref_Holiday_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_calendar_holiday.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_calendar_holiday.rowid ",
      'acls'
    );
...
}//end class WbfsysCalendarType_Ref_Holiday_Table_Access
