 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_calendar_holiday.rowid as "wbfsys_calendar_holiday_rowid"', // variant:  
      'wbfsys_calendar_holiday.name as "wbfsys_calendar_holiday_name"', // variant:  
    );
...
}//end class WbfsysCalendarType_Ref_Holiday_Table_Query_Postgresql
