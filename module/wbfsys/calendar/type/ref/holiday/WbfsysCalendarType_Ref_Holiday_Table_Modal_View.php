 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Ref_Holiday_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    // fix the target id
		$params->targetId = 'wgt-table-modal-ref-holiday-'.$objid;
...
}//end class WbfsysCalendarType_Ref_Holiday_Table_Modal_View
