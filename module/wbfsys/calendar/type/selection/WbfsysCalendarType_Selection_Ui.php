 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysCalendarType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysCalendarType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarType_Selection_Element
    (
      'selectionWbfsysCalendarType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection calendar Types', 'wbfsys.calendar_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.CalendarType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysCalendarType',
      'WbfsysCalendarType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysCalendarType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysCalendarType_Selection_Ui
