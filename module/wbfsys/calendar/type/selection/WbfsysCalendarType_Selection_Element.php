 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_calendar_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCalendarType_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CalendarType.show&amp;target_mask=WbfsysCalendarType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CalendarType.edit&amp;target_mask=WbfsysCalendarType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.calendar_type.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Holidays',
            'modal.php?c=Wbfsys.CalendarType_Ref_Holiday.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.calendar_type.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CalendarType.delete&amp;target_mask=WbfsysCalendarType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.calendar_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_calendar_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.calendar_type.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.CalendarType.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.calendar_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.calendar_type.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_calendar_type_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_calendar_type_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_calendar_type_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CalendarType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected calendar Types." >{$iconDelete} Delete selected calendar Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! calendar Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CalendarType_Multi.deleteAll" >{$iconClean} Delete all calendar Types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCalendarType_Selection_Element
