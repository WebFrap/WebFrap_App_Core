 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCalendarType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CalendarType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CalendarType.insert';
    $params->formId       = 'wgt-form-wbfsys_calendar_type';
    $params->namespace   = 'wbfsys_calendar_type-create';
    ...
    $this->setTemplate( 'wbfsys/calendar_type/modal/crud/form_create' );
...
}//end class WbfsysCalendarType_Crud_Create_Modal_View
