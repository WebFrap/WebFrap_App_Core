 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCalendarType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCalendarType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCalendarType_Entity */
      $entity = $orm->get( 'WbfsysCalendarType', $rootId );
    }
...
}//end class WbfsysCalendarType_Crud_Access_Root
