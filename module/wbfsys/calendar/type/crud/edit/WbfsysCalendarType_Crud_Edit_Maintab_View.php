 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCalendarType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCalendarType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit calendar Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CalendarType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCalendarType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CalendarType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_calendar_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/calendar_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCalendarType_Crud_Edit' );
...
}//end class WbfsysCalendarType_Crud_Edit_Maintab_View
