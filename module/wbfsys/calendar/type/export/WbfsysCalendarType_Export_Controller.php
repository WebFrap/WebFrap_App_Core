 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysCalendarType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysCalendarType_Export_Listing_Access';
    ...
    // create a new WbfsysCalendarType window
    $view = $this->loadView
    (
    	'export-wbfsys_calendar_type',
    	'WbfsysCalendarType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysCalendarType_Export' );
...
} // end class WbfsysCalendarType_Export_Controller_Genf
