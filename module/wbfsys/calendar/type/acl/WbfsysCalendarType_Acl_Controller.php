 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysCalendarType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysCalendarType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_calendar_type_acl_listing',
      'WbfsysCalendarType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysCalendarType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysCalendarType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_calendar_type-acl',
    	'WbfsysCalendarType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_calendar_type_acl_masks_listing',
      'WbfsysCalendarType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysCalendarType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysCalendarType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysCalendarType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysCalendarType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysCalendarType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_calendar_type-acl-qfdu',
    	'WbfsysCalendarType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysCalendarType_Acl_Controller */
