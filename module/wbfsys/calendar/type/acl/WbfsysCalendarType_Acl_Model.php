 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_calendar_type' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_calendar_type' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysCalendarType_Acl_Table' );
    /* @var $query WbfsysCalendarType_Acl_Table_Query  */
...
} // end class WbfsysCalendarType_Acl_Model */
