 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysCalendarType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_calendar_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'calendar Type', 'wbfsys.calendar_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_calendar_type_acl';
...
} // end class WbfsysCalendarType_Acl_Ui */
