 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_calendar_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_calendar_type.rowid as id,
    wbfsys_calendar_type.name as value,
    wbfsys_calendar_type.name as label
  FROM
...
} // end class WbfsysCalendarType_Acl_Qfdu_Query_Postgresql */
