 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysCalendarType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_calendar_type-acl-qfdu-aAjax',
      'WbfsysCalendarType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysCalendarType_Acl_Qfdu_Controller */
