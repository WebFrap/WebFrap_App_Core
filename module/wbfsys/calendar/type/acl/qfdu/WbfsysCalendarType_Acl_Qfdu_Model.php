 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_calendar_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysCalendarType = $orm->get('WbfsysCalendarType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_calendar_type_name']  = $refEntityWbfsysCalendarType->name;

    }
    $tabData['wbfsys_calendar_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysCalendarType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarType_Acl' );
    /* @var $query WbfsysCalendarType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysCalendarType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarType_Acl_Qfdu' );
    /* @var $query WbfsysCalendarType_Acl_Qfdu_Query  */
...
} // end class WbfsysCalendarType_Acl_Qfdu_Model */
