 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_calendar_type.name as "wbfsys_calendar_type_name"',
      'wbfsys_calendar_type.rowid as "wbfsys_calendar_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_calendar_type on wbfsys_group_users.vid = wbfsys_calendar_type.rowid'
    );
...
} // end class WbfsysCalendarType_Acl_Qfdu_Treetable_Query_Postgresql */
