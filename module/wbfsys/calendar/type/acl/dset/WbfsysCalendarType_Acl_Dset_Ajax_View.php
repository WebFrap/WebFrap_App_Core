 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysCalendarType_Acl_Dset' );
    ...
    $entityWbfsysCalendarType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysCalendarType_Acl_Dset_Ajax_View */
