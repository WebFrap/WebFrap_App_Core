 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_calendar_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysCalendarType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarType_Acl_Dset' );
    /* @var $query WbfsysCalendarType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarType_Acl_Dset_Treetable' );
    /* @var $query WbfsysCalendarType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysCalendarType_Acl_Dset_Model */
