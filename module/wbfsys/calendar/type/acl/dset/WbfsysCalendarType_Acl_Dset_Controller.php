 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysCalendarType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysCalendarType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCalendarType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_calendar_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysCalendarType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCalendarType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_calendar_type-acl-dset', 
    	'WbfsysCalendarType_Acl_Dset',
...
} // end class WbfsysCalendarType_Acl_Dset_Controller */
