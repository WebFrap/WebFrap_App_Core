 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysCalendarType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysCalendarType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysCalendarType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysCalendarType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_calendar_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'calendar Type "{@label@}" User Access',
        'wbfsys.calendar_type.label',
        array
        (
          'label' => $entityWbfsysCalendarType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_calendar_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysCalendarType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysCalendarType_Acl_Dset_Ui */
