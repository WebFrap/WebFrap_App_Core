 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_calendar_type_acl_graph', 
      'WbfsysCalendarType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysCalendarType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysCalendarType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysCalendarType_Acl_Path_Maintab_View  */
...
} // end class WbfsysCalendarType_Acl_Path_Controller */
