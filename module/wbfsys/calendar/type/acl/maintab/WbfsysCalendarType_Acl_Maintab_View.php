 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.CalendarType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.CalendarType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_calendar_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/calendar_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'calendar Type', 'wbfsys.calendar_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_calendar_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysCalendarType_Acl' );
...
} // end class WbfsysCalendarType_Acl_Maintab_View */
