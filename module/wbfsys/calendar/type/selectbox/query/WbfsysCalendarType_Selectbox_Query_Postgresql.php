 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysCalendarType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_calendar_type.rowid as id',
      'wbfsys_calendar_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_calendar_type.m_order as "wbfsys_calendar_type-m_order-order"' );

    $criteria->from( 'wbfsys_calendar_type' );



      $criteria->orderBy( 'wbfsys_calendar_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_calendar_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_calendar_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysCalendarType_Selectbox_Query_Postgresql
