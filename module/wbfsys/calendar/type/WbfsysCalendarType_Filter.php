 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_calendar_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_calendar_type.{$fieldName}
...
}//end class WbfsysCalendarType_Filter
