 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysCalendarType_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysCalendarType_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function changeOrder( $orders )
  {
    ...
    try
    {
      ...
      {
        $orm->update( "WbfsysCalendarType", $id, array( 'm_order' =>  $order ) );
      }
    }
    catch( LibDb_Exception $e )
    {
...
}//end class WbfsysCalendarType_Table_Model
