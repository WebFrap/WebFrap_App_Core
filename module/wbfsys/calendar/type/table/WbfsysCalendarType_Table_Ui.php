 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für calendar Types
  *
  ...
  *  }
  *
  * @return WbfsysCalendarType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarType_Table_Element( 'tableWbfsysCalendarType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'calendar Types', 'wbfsys.calendar_type.label' );
      //$tabPanel->searchKey = 'wbfsys_calendar_type';
      ...
      $searchElement->searchKey = 'wbfsys_calendar_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCalendarType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCalendarType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCalendarType listing maske
   *
   * @param WbfsysCalendarType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysCalendarType  = $model->getEntityWbfsysCalendarType();
    ...
    $formWbfsysCalendarType->setKeyName( 'wbfsys_calendar_type' );
...
}//end class WbfsysCalendarType_Table_Ui
