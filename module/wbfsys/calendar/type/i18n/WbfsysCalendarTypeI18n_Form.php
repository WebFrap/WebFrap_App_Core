 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_calendar_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCalendarTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysCalendarTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysCalendarTypeI18n';
   ...
   *
   * @var WbfsysCalendarTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysCalendarTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCalendarTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCalendarTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.calendar_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_calendar_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_calendar_type( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysCalendarType_Entity' ) )
    {
      ...
      //p: Window
      $objidWbfsysCalendarType = $this->entity->getData('id_wbfsys_calendar_type') ;
      ...
      $inputIdWbfsysCalendarType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysCalendarType', 'Window' );
      $inputIdWbfsysCalendarType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_calendar_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_calendar_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Calendar Type (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysCalendarType->assignedForm = $this->assignedForm;

      $inputIdWbfsysCalendarType->setWidth( 'medium' );

      $inputIdWbfsysCalendarType->setData( $this->entity->getData( 'id_wbfsys_calendar_type' )  );
      $inputIdWbfsysCalendarType->setReadOnly( $this->isReadOnly( 'id_wbfsys_calendar_type' ) );
      $inputIdWbfsysCalendarType->setLabel( $this->view->i18n->l( 'Wbfsys Calendar Type', 'wbfsys.calendar_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.CalendarType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_calendar_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysCalendarType->setListUrl ( $listUrl );
      $inputIdWbfsysCalendarType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysCalendarType->setEntityUrl( 'maintab.php?c=Wbfsys.CalendarType.edit' );
      $inputIdWbfsysCalendarType->conEntity         = $entityWbfsysCalendarType;
      $inputIdWbfsysCalendarType->refresh           = $this->refresh;
      $inputIdWbfsysCalendarType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysCalendarType->view = $this->view;
      $inputIdWbfsysCalendarType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_calendar_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysCalendarType );
  ...
  }//end public function input_id_wbfsys_calendar_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.calendar_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.calendar_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.calendar_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.calendar_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.calendar_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.calendar_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.calendar_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.calendar_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.calendar_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Calendar Type I18n)', 'wbfsys.calendar_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_type_i18n_m_role_change';
...
}//end class WbfsysCalendarTypeI18n_Form */
