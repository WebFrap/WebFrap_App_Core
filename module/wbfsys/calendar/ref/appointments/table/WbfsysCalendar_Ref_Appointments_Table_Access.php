 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Ref_Appointments_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_calendar_appointment Attributes: rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-appointments',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-appointments' );
  ...
  /**
   * @param WbfsysCalendar_Ref_Appointments_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_calendar_appointment.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_calendar_appointment') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_calendar_appointment.rowid ",
      'acls'
    );
...
}//end class WbfsysCalendar_Ref_Appointments_Table_Access
