 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Ref_Appointments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Calendar_Ref_Appointments.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysCalendar_Ref_Appointments_Table_Ajax_View
