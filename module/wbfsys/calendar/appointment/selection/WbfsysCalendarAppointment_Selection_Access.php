 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysCalendarAppointment_Selection_Query $query
...
}//end class WbfsysCalendarAppointment_Selection_Access
