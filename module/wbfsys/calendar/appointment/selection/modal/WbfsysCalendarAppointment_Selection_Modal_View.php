 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysCalendarAppointment_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysCalendarAppointment_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_calendar_appointment
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/calendar_appointment/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.CalendarAppointment.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_calendar_appointment-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysCalendarAppointment_Selection' );
...
}//end class WbfsysCalendarAppointment_Selection_Modal_View
