 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysCalendarAppointment_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysCalendarAppointment_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarAppointment_Selection_Element
    (
      'selectionWbfsysCalendarAppointment',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Calendar Appointments', 'wbfsys.calendar_appointment.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.CalendarAppointment.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysCalendarAppointment',
      'WbfsysCalendarAppointment_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysCalendarAppointment_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysCalendarAppointment_Selection_Ui
