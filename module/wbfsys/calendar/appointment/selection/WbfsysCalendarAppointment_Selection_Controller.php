 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCalendarAppointment_Selection' ) );
...
} // end class WbfsysCalendarAppointment_Selection_Controller */
