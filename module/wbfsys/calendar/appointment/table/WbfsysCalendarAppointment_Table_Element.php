 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_calendar_appointment';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysCalendarAppointment_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.CalendarAppointment.show&amp;target_mask=WbfsysCalendarAppointment&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.CalendarAppointment.edit&amp;target_mask=WbfsysCalendarAppointment&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.calendar_appointment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.CalendarAppointment.delete&amp;target_mask=WbfsysCalendarAppointment&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.calendar_appointment.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_calendar_appointment&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.calendar_appointment.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_calendar_appointment_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.CalendarAppointment_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Calendar Appointments." >{$iconDelete} Delete selected Calendar Appointments</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Calendar Appointments. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.CalendarAppointment_Multi.deleteAll" >{$iconClean} Delete all Calendar Appointments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysCalendarAppointment_Table_Element
