 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Calendar Appointments
  *
  ...
  *  }
  *
  * @return WbfsysCalendarAppointment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarAppointment_Table_Element( 'tableWbfsysCalendarAppointment', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar_appointment-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Calendar Appointments', 'wbfsys.calendar_appointment.label' );
      //$tabPanel->searchKey = 'wbfsys_calendar_appointment';
      ...
      $searchElement->searchKey = 'wbfsys_calendar_appointment';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysCalendarAppointment_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysCalendarAppointment', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysCalendarAppointment listing maske
   *
   * @param WbfsysCalendarAppointment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysCalendarAppointment_Table_Ui
