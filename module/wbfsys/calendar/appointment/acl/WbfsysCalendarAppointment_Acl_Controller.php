 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysCalendarAppointment
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysCalendarAppointment_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_calendar_appointment_acl_listing',
      'WbfsysCalendarAppointment_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysCalendarAppointment_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarAppointment_Acl_Model */
    $model   = $this->loadModel( 'WbfsysCalendarAppointment_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_calendar_appointment-acl',
    	'WbfsysCalendarAppointment_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_calendar_appointment_acl_masks_listing',
      'WbfsysCalendarAppointment_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysCalendarAppointment_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysCalendarAppointment_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarAppointment_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysCalendarAppointment_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysCalendarAppointment_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysCalendarAppointment_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_calendar_appointment-acl-qfdu',
    	'WbfsysCalendarAppointment_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysCalendarAppointment_Acl_Controller */
