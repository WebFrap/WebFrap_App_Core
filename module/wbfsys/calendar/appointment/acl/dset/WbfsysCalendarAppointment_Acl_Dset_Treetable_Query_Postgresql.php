 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_calendar_appointment.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysCalendarAppointment_Acl_Dset_Treetable_Query_Postgresql */
