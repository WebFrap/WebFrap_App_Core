 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_calendar_appointment'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysCalendarAppointment', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarAppointment_Acl_Dset' );
    /* @var $query WbfsysCalendarAppointment_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarAppointment_Acl_Dset_Treetable' );
    /* @var $query WbfsysCalendarAppointment_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysCalendarAppointment_Acl_Dset_Model */
