 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarAppointment_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysCalendarAppointment_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysCalendarAppointment = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCalendarAppointment_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_calendar_appointment-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysCalendarAppointment, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_calendar_appointment-acl-dset', 
    	'WbfsysCalendarAppointment_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysCalendarAppointment_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_calendar_appointment-acl-dset', 
    	'WbfsysCalendarAppointment_Acl_Dset',
...
} // end class WbfsysCalendarAppointment_Acl_Dset_Controller */
