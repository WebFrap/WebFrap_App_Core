 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysCalendarAppointment_Acl_Dset' );
    ...
    $entityWbfsysCalendarAppointment = $this->model->getEntity( $dsetId );
...
} // end class WbfsysCalendarAppointment_Acl_Dset_Ajax_View */
