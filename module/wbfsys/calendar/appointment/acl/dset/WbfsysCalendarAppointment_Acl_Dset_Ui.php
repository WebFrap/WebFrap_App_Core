 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysCalendarAppointment_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysCalendarAppointment_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysCalendarAppointment, $areaId, $access, $params  )
  {

    $listObj = new WbfsysCalendarAppointment_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_calendar_appointment-acl-dset' );
    ...
    else
    {
      ...
      (
        'Calendar Appointment "{@label@}" User Access',
        'wbfsys.calendar_appointment.label',
        array
        (
          'label' => $entityWbfsysCalendarAppointment->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_calendar_appointment_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysCalendarAppointment_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysCalendarAppointment_Acl_Dset_Ui */
