 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysCalendarAppointment_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysCalendarAppointment_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL Calendar Appointment', 
        'wbfsys.calendar_appointment.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_calendar_appointment-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Calendar Appointment', 'wbfsys.calendar_appointment.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_calendar_appointment_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysCalendarAppointment_Acl_Table'
    );
...
} // end class WbfsysCalendarAppointment_Acl_Ui */
