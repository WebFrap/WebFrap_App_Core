 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_calendar_appointment.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_calendar_appointment.rowid as id,
    wbfsys_calendar_appointment.rowid as value,
    wbfsys_calendar_appointment.rowid as label
  FROM
...
} // end class WbfsysCalendarAppointment_Acl_Qfdu_Query_Postgresql */
