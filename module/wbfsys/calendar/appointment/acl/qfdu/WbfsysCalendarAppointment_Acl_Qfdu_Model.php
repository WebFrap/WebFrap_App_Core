 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_calendar_appointment')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysCalendarAppointment = $orm->get('WbfsysCalendarAppointment', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_calendar_appointment_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysCalendarAppointment_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarAppointment_Acl' );
    /* @var $query WbfsysCalendarAppointment_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarAppointment_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysCalendarAppointment_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysCalendarAppointment_Acl_Qfdu' );
    /* @var $query WbfsysCalendarAppointment_Acl_Qfdu_Query  */
...
} // end class WbfsysCalendarAppointment_Acl_Qfdu_Model */
