 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_calendar_appointment.rowid as "wbfsys_calendar_appointment_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_calendar_appointment on wbfsys_group_users.vid = wbfsys_calendar_appointment.rowid'
    );
...
} // end class WbfsysCalendarAppointment_Acl_Qfdu_Treetable_Query_Postgresql */
