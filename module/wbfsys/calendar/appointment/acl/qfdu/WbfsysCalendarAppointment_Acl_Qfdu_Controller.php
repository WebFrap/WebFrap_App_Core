 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysCalendarAppointment_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_calendar_appointment-acl-qfdu-aAjax',
      'WbfsysCalendarAppointment_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysCalendarAppointment_Acl_Qfdu_Controller */
