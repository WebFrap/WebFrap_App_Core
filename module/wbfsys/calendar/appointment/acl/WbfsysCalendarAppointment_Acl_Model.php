 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_calendar_appointment' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_calendar_appointment' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysCalendarAppointment_Acl_Table' );
    /* @var $query WbfsysCalendarAppointment_Acl_Table_Query  */
...
} // end class WbfsysCalendarAppointment_Acl_Model */
