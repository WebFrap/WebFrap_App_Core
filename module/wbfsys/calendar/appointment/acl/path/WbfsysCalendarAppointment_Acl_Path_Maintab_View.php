 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/calendar_appointment/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'Calendar Appointments' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_calendar_appointment-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_calendar_appointment-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysCalendarAppointment_Acl_Path_Maintab_View */
