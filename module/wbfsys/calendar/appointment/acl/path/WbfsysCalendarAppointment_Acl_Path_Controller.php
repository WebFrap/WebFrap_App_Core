 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_calendar_appointment_acl_graph', 
      'WbfsysCalendarAppointment_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysCalendarAppointment_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysCalendarAppointment_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysCalendarAppointment_Acl_Path_Maintab_View  */
...
} // end class WbfsysCalendarAppointment_Acl_Path_Controller */
