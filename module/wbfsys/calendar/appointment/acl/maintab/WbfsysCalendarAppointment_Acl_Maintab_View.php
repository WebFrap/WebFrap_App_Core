 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysCalendarAppointment_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.CalendarAppointment_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_calendar_appointment-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.CalendarAppointment_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_calendar_appointment-acl-update';
    ...
    $this->setTemplate( 'wbfsys/calendar_appointment/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Calendar Appointment', 'wbfsys.calendar_appointment.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_calendar_appointment_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysCalendarAppointment_Acl' );
...
} // end class WbfsysCalendarAppointment_Acl_Maintab_View */
