 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysCalendarAppointment_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysCalendarAppointment_Export_Listing_Access';
    ...
    // create a new WbfsysCalendarAppointment window
    $view = $this->loadView
    (
    	'export-wbfsys_calendar_appointment',
    	'WbfsysCalendarAppointment_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysCalendarAppointment_Export' );
...
} // end class WbfsysCalendarAppointment_Export_Controller_Genf
