 ...
 *
 * @package WebFrap
 * @subpackage ModCalendarAppointment
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_calendar_appointment
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.CalendarAppointment.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_calendar_appointment-create';

    $access = new WbfsysCalendarAppointment_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_calendar_appointment-create',
      'WbfsysCalendarAppointment_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysCalendarAppointment_Crud_Model */
    $model = $this->loadModel( 'WbfsysCalendarAppointment_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.CalendarAppointment.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysCalendarAppointment = $model->getEntityWbfsysCalendarAppointment( $objid );
    ...
    if( !$entityWbfsysCalendarAppointment )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Calendar Appointment', 'wbfsys.calendar_appointment.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysCalendarAppointment;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_calendar_appointment:edit';

    $access = new WbfsysCalendarAppointment_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarAppointment );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_calendar_appointment-edit-'.$objid,
      'WbfsysCalendarAppointment_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_calendar_appointment-edit',
          $entityWbfsysCalendarAppointment,
          'Edit Calendar Appointment :'.$entityWbfsysCalendarAppointment->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_calendar_appointment';
      $params->maskRoot      = 'wbfsys_calendar_appointment:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_calendar_appointment';
      $params->aclNode       = 'mgmt-wbfsys_calendar_appointment';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_calendar_appointment-edit-'.$objid,
      'WbfsysCalendarAppointment_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_calendar_appointment-show',
          $entityWbfsysCalendarAppointment,
          'Show Calendar Appointment :'.$entityWbfsysCalendarAppointment->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_calendar_appointment
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.CalendarAppointment.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-insert';

    $access = new WbfsysCalendarAppointment_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysCalendarAppointment = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_calendar_appointment-update-'.$entityWbfsysCalendarAppointment;
      ...
      {
        $access = new WbfsysCalendarAppointment_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarAppointment );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysCalendarAppointment';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_calendar_appointment',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysCalendarAppointment_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.CalendarAppointment.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysCalendarAppointment, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysCalendarAppointment_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.CalendarAppointment.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-delete-'.$objid;

    $access = new WbfsysCalendarAppointment_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysCalendarAppointment );
    ...
    $error = $model->delete( $entityWbfsysCalendarAppointment, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysCalendarAppointment, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.CalendarAppointment.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.CalendarAppointment.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-listing';
    ...
    $containerClass = 'WbfsysCalendarAppointment_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_calendar_appointment',
      'WbfsysCalendarAppointment_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysCalendarAppointment_Table_Model */
    $model = $this->loadModel( 'WbfsysCalendarAppointment_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_calendar_appointment-'.$params->ltype,
          'WbfsysCalendarAppointment',
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysCalendarAppointment
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysCalendarAppointment_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_calendar_appointment',
      'WbfsysCalendarAppointment_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysCalendarAppointment_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.CalendarAppointment.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysCalendarAppointment_Selection_Model */
    $model   = $this->loadModel( 'WbfsysCalendarAppointment_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_calendar_appointment-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_calendar_appointment-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_calendar_appointment',
      'WbfsysCalendarAppointment',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysCalendarAppointment, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysCalendarAppointment_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysCalendarAppointment_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_calendar_appointment-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysCalendarAppointment_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysCalendarAppointment, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_calendar_appointment' );
...
} // end class WbfsysCalendarAppointment_Controller */
