 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysCalendarAppointment_'.$listType ) );
...
} // end class WbfsysCalendarAppointment_Listing_Controller */
