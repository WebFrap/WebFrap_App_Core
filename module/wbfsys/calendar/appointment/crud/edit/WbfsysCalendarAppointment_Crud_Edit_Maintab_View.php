 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCalendarAppointment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCalendarAppointment = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Calendar Appointment: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.CalendarAppointment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCalendarAppointment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.CalendarAppointment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_calendar_appointment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/calendar_appointment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCalendarAppointment_Crud_Edit' );
...
}//end class WbfsysCalendarAppointment_Crud_Edit_Maintab_View
