 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCalendarAppointment_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCalendarAppointment_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCalendarAppointment_Entity */
      $entity = $orm->get( 'WbfsysCalendarAppointment', $rootId );
    }
...
}//end class WbfsysCalendarAppointment_Crud_Access_Root
