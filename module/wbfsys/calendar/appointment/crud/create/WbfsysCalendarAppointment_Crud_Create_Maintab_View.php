 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysCalendarAppointment Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_calendar_appointment-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/calendar_appointment/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CalendarAppointment.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_calendar_appointment';
    ...
    $form = $this->newForm( 'WbfsysCalendarAppointment_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.CalendarAppointment.create');}});
});
...
}//end class WbfsysCalendarAppointment_Crud_Create_Maintab_View
