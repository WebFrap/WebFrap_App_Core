 ...
 * @licence WebFrap.net
 */
class WbfsysCalendarAppointment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCalendarAppointment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.CalendarAppointment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.CalendarAppointment.insert';
    $params->formId       = 'wgt-form-wbfsys_calendar_appointment';
    $params->namespace   = 'wbfsys_calendar_appointment-create';
    ...
    $this->setTemplate( 'wbfsys/calendar_appointment/modal/crud/form_create' );
...
}//end class WbfsysCalendarAppointment_Crud_Create_Modal_View
