...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_calendar';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysCalendar';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysCalendar' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysCalendar entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Calendar)', 'wbfsys.calendar.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.calendar.label' ),
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Calendar)', 'wbfsys.calendar.label' ),
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysCalendarType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysCalendarType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (Calendar)', 'wbfsys.calendar.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.calendar.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_calendar_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.CalendarType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Calendar)', 'wbfsys.calendar.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.calendar.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Calendar)', 'wbfsys.calendar.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.calendar.label' ),
  ...
  * @return void
  */
  public function input_id_color_scheme( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysColorScheme_Entity' ) )
    {
      ...
      $inputIdColorScheme = $this->view->newInput( 'input'.$this->prefix.'IdColorScheme', 'Window' );
      $inputIdColorScheme->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_color_scheme]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_color_scheme'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Color Scheme (Calendar)', 'wbfsys.calendar.label' ),
      ));
      ...
      $inputIdColorScheme->setReadOnly( $this->isReadOnly( 'id_color_scheme' ) );
      $inputIdColorScheme->setLabel( $this->view->i18n->l( 'Color Scheme', 'wbfsys.calendar.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.ColorScheme.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_color_scheme'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdColorScheme->buildJavascript( 'wgt-input-'.$this->keyName.'_id_color_scheme'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_color_scheme */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Calendar)', 'wbfsys.calendar.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Calendar)', 'wbfsys.calendar.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.calendar.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Calendar)', 'wbfsys.calendar.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.calendar.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Calendar)', 'wbfsys.calendar.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.calendar.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Calendar)', 'wbfsys.calendar.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.calendar.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Calendar)', 'wbfsys.calendar.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.calendar.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Calendar)', 'wbfsys.calendar.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.calendar.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Calendar)', 'wbfsys.calendar.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.calendar.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Calendar)', 'wbfsys.calendar.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
    ...
    if( !Webfrap::classLoadable( 'WbfsysCalendarType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Type (Calendar)', 'wbfsys.calendar.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Calendar)', 'wbfsys.calendar.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_calendar_m_role_change';
