 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysCalendar Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysCalendar = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Calendar.edit&amp;utf8=✓&amp;objid='.$entityWbfsysCalendar
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Calendar.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_calendar-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/calendar/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysCalendar_Crud_Edit' );
...
}//end class WbfsysCalendar_Crud_Edit_Maintab_View
