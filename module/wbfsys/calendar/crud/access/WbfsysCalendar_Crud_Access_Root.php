 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysCalendar_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysCalendar_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysCalendar_Entity */
      $entity = $orm->get( 'WbfsysCalendar', $rootId );
    }
...
}//end class WbfsysCalendar_Crud_Access_Root
