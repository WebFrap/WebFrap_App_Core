 ...
 * @licence WebFrap.net
 */
class WbfsysCalendar_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysCalendar entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Calendar.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Calendar.insert';
    $params->formId       = 'wgt-form-wbfsys_calendar';
    $params->namespace   = 'wbfsys_calendar-create';
    ...
    $this->setTemplate( 'wbfsys/calendar/modal/crud/form_create' );
...
}//end class WbfsysCalendar_Crud_Create_Modal_View
