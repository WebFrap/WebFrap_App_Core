 ...
 * @licence WebFrap.net
 */
class WbfsysGroupUsers_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysGroupUsers Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_group_users-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/group_users/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.GroupUsers.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_group_users';
    ...
    $form = $this->newForm( 'WbfsysGroupUsers_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.GroupUsers.create');}});
});
...
}//end class WbfsysGroupUsers_Crud_Create_Maintab_View
