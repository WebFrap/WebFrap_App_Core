 ...
 * @licence WebFrap.net
 */
class WbfsysGroupUsers_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysGroupUsers entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.GroupUsers.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.GroupUsers.insert';
    $params->formId       = 'wgt-form-wbfsys_group_users';
    $params->namespace   = 'wbfsys_group_users-create';
    ...
    $this->setTemplate( 'wbfsys/group_users/modal/crud/form_create' );
...
}//end class WbfsysGroupUsers_Crud_Create_Modal_View
