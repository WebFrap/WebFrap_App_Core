 ...
 * @licence WebFrap.net
 */
class WbfsysGroupUsers_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysGroupUsers Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysGroupUsers = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Group Users: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.GroupUsers.edit&amp;utf8=✓&amp;objid='.$entityWbfsysGroupUsers
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.GroupUsers.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_group_users-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/group_users/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysGroupUsers_Crud_Edit' );
...
}//end class WbfsysGroupUsers_Crud_Edit_Maintab_View
