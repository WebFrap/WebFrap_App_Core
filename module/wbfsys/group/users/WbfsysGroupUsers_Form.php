...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_group_users';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysGroupUsers';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysGroupUsers' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysGroupUsers entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_user( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for User (Group Users)', 'wbfsys.group_users.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.group_users.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleGroup_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_group'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Group (Group Users)', 'wbfsys.group_users.label' ),
      ));
      ...
      $inputIdGroup->setLabel( $this->view->i18n->l( 'Group', 'wbfsys.group_users.label' ) );
  ...
  public function input_id_area( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Area (Group Users)', 'wbfsys.group_users.label' ),
      ));
      ...
      $inputIdArea->setLabel( $this->view->i18n->l( 'Area', 'wbfsys.group_users.label' ) );
  ...
  public function input_partial( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Partial (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Partial', 'wbfsys.group_users.label' ),
  ...
  * @return void
  */
  public function input_ident_key( $params )
  {

      //tpl: class ui:text
      $inputIdentKey = $this->view->newInput( 'input'.$this->prefix.'IdentKey' , 'Text' );
      $this->items['ident_key'] = $inputIdentKey;
      $inputIdentKey->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[ident_key]',
          'id'        => 'wgt-input-'.$this->keyName.'_ident_key'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_cname medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Ident key (Group Users)', 'wbfsys.group_users.label' ),
          'maxlength' => $this->entity->maxSize( 'ident_key' ),
        )
      );
      $inputIdentKey->setWidth( 'medium' );

      $inputIdentKey->setReadOnly( $this->isReadOnly( 'ident_key' ) );
      $inputIdentKey->setData( $this->entity->getSecure('ident_key') );
      $inputIdentKey->setLabel
      (
        $this->view->i18n->l( 'Ident key', 'wbfsys.group_users.label' ),
        $this->entity->required( 'ident_key' )
      );
  ...
  }//end public function input_ident_key */
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      $inputVid->setLabel
      (
        $this->view->i18n->l( 'Vid', 'wbfsys.group_users.label' ),
  ...
  public function input_date_start( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Start Date (Group Users)', 'wbfsys.group_users.label' ),
      ...
      (
        $this->view->i18n->l( 'Start Date', 'wbfsys.group_users.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.group_users.label' ),
  ...
  public function input_date_end( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for End Date (Group Users)', 'wbfsys.group_users.label' ),
      ...
      (
        $this->view->i18n->l( 'End Date', 'wbfsys.group_users.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.group_users.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Group Users)', 'wbfsys.group_users.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.group_users.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Group Users)', 'wbfsys.group_users.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.group_users.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Group Users)', 'wbfsys.group_users.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.group_users.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Group Users)', 'wbfsys.group_users.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.group_users.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.group_users.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Group Users)', 'wbfsys.group_users.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.group_users.label' ),
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the search element for field ident_key
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_ident_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Ident key (Group Users)', 'wbfsys.group_users.label' ),
          'maxlength' => $this->entity->maxSize( 'ident_key' ),
        )
      );
      $inputIdentKey->setWidth( 'medium' );
  ...
  }//end public function search_ident_key */
  ...
  public function search_date_start( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Start Date (Group Users)', 'wbfsys.group_users.label' ),
          'maxlength' => $this->entity->maxSize( 'date_start' ),
        )
      );
      $inputDateStart->setWidth( 'small' );
  ...
  public function search_date_end( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_date_end'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for End Date (Group Users)', 'wbfsys.group_users.label' ),
          'maxlength' => $this->entity->maxSize( 'date_end' ),
        )
      );
      $inputDateEnd->setWidth( 'small' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_group_users_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_group_users_m_role_change';
...
}//end class WbfsysGroupUsers_Form */
