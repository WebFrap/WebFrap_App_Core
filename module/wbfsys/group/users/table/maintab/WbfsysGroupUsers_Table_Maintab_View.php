 ...
 * @licence WebFrap.net
 */
class WbfsysGroupUsers_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysGroupUsers_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysGroupUsers_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/group_users/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.GroupUsers.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.GroupUsers.search';

    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_group_users-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysGroupUsers_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.GroupUsers.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.GroupUsers.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.GroupUsers.create&amp;ltype=table');
    });
...
}//end class WbfsysGroupUsers_Table_Maintab_View
