 ...
 * @licence WebFrap.net
 */
class WbfsysGroupUsers_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Group Users
  *
  ...
  *  }
  *
  * @return WbfsysGroupUsers_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGroupUsers_Table_Element( 'tableWbfsysGroupUsers', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Group Users', 'wbfsys.group_users.label' );
      //$tabPanel->searchKey = 'wbfsys_group_users';
      ...
      $searchElement->searchKey = 'wbfsys_group_users';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysGroupUsers_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysGroupUsers', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysGroupUsers listing maske
   *
   * @param WbfsysGroupUsers_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysGroupUsers_Table_Ui
