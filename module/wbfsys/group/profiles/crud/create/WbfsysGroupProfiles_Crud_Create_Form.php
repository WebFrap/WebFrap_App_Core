 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysGroupProfiles', array_keys( $this->fields['wbfsys_group_profiles']), true ),
...
}//end class WbfsysGroupProfiles_Crud_Create_Form */
