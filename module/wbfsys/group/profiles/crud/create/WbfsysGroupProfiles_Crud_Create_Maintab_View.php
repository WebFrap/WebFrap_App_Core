 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysGroupProfiles Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_group_profiles-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/group_profiles/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.GroupProfiles.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_group_profiles';
    ...
    $form = $this->newForm( 'WbfsysGroupProfiles_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.GroupProfiles.create');}});
});
...
}//end class WbfsysGroupProfiles_Crud_Create_Maintab_View
