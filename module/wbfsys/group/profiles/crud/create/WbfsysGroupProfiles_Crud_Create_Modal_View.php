 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysGroupProfiles entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.GroupProfiles.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.GroupProfiles.insert';
    $params->formId       = 'wgt-form-wbfsys_group_profiles';
    $params->namespace   = 'wbfsys_group_profiles-create';
    ...
    $this->setTemplate( 'wbfsys/group_profiles/modal/crud/form_create' );
...
}//end class WbfsysGroupProfiles_Crud_Create_Modal_View
