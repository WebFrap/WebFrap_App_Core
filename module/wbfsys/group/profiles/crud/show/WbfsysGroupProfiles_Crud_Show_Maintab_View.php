 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysGroupProfiles Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysGroupProfiles = $this->model->getEntityWbfsysGroupProfiles();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Group Profiles: {@text@}',
      'wbfsys.group_profiles.label',
      array( 'text' => $entityWbfsysGroupProfiles->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.GroupProfiles.show  &amp;objid='.$entityWbfsysGroupProfiles
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.GroupProfiles.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_group_profiles-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/group_profiles/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysGroupProfiles_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.GroupProfiles.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_group_profiles' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_group_profiles a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.GroupProfiles.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.GroupProfiles.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysGroupProfiles_Crud_Show_Maintab_View
