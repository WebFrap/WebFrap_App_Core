 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysGroupProfiles_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysGroupProfiles_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysGroupProfiles_Entity */
      $entity = $orm->get( 'WbfsysGroupProfiles', $rootId );
    }
...
}//end class WbfsysGroupProfiles_Crud_Access_Root
