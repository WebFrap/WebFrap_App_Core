 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysGroupProfiles Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysGroupProfiles = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Group Profiles: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.GroupProfiles.edit&amp;utf8=✓&amp;objid='.$entityWbfsysGroupProfiles
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.GroupProfiles.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_group_profiles-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/group_profiles/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysGroupProfiles_Crud_Edit' );
...
}//end class WbfsysGroupProfiles_Crud_Edit_Maintab_View
