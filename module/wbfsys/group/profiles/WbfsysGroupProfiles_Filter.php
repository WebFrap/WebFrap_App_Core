 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_group_profiles') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_group_profiles.{$fieldName}
...
}//end class WbfsysGroupProfiles_Filter
