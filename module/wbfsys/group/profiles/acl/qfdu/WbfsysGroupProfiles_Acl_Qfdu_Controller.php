 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysGroupProfiles_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_group_profiles-acl-qfdu-aAjax',
      'WbfsysGroupProfiles_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysGroupProfiles_Acl_Qfdu_Controller */
