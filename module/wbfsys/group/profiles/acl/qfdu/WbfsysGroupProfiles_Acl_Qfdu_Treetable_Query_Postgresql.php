 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_group_profiles.rowid as "wbfsys_group_profiles_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_group_profiles on wbfsys_group_users.vid = wbfsys_group_profiles.rowid'
    );
...
} // end class WbfsysGroupProfiles_Acl_Qfdu_Treetable_Query_Postgresql */
