 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_group_profiles.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_group_profiles.rowid as id,
    wbfsys_group_profiles.rowid as value,
    wbfsys_group_profiles.rowid as label
  FROM
...
} // end class WbfsysGroupProfiles_Acl_Qfdu_Query_Postgresql */
