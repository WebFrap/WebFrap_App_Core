 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_group_profiles')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysGroupProfiles = $orm->get('WbfsysGroupProfiles', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_group_profiles_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysGroupProfiles_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysGroupProfiles_Acl' );
    /* @var $query WbfsysGroupProfiles_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysGroupProfiles_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysGroupProfiles_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysGroupProfiles_Acl_Qfdu' );
    /* @var $query WbfsysGroupProfiles_Acl_Qfdu_Query  */
...
} // end class WbfsysGroupProfiles_Acl_Qfdu_Model */
