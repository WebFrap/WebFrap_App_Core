 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_group_profiles.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysGroupProfiles_Acl_Dset_Treetable_Query_Postgresql */
