 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_group_profiles'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysGroupProfiles', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysGroupProfiles_Acl_Dset' );
    /* @var $query WbfsysGroupProfiles_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysGroupProfiles_Acl_Dset_Treetable' );
    /* @var $query WbfsysGroupProfiles_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysGroupProfiles_Acl_Dset_Model */
