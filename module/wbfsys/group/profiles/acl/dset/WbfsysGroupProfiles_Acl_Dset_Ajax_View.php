 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysGroupProfiles_Acl_Dset' );
    ...
    $entityWbfsysGroupProfiles = $this->model->getEntity( $dsetId );
...
} // end class WbfsysGroupProfiles_Acl_Dset_Ajax_View */
