 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysGroupProfiles_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysGroupProfiles_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysGroupProfiles = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysGroupProfiles_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_group_profiles-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysGroupProfiles, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_group_profiles-acl-dset', 
    	'WbfsysGroupProfiles_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysGroupProfiles_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_group_profiles-acl-dset', 
    	'WbfsysGroupProfiles_Acl_Dset',
...
} // end class WbfsysGroupProfiles_Acl_Dset_Controller */
