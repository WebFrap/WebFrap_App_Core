 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysGroupProfiles_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysGroupProfiles_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysGroupProfiles, $areaId, $access, $params  )
  {

    $listObj = new WbfsysGroupProfiles_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_group_profiles-acl-dset' );
    ...
    else
    {
      ...
      (
        'Group Profiles "{@label@}" User Access',
        'wbfsys.group_profiles.label',
        array
        (
          'label' => $entityWbfsysGroupProfiles->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_group_profiles_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysGroupProfiles_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysGroupProfiles_Acl_Dset_Ui */
