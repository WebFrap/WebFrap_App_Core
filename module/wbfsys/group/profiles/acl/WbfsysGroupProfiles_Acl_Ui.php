 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysGroupProfiles_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGroupProfiles_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_group_profiles-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Group Profiles', 'wbfsys.group_profiles.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_group_profiles_acl';
...
} // end class WbfsysGroupProfiles_Acl_Ui */
