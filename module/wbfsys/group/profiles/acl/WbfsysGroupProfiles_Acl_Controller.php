 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysGroupProfiles
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysGroupProfiles_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_group_profiles_acl_listing',
      'WbfsysGroupProfiles_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysGroupProfiles_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysGroupProfiles_Acl_Model */
    $model   = $this->loadModel( 'WbfsysGroupProfiles_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_group_profiles-acl',
    	'WbfsysGroupProfiles_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_group_profiles_acl_masks_listing',
      'WbfsysGroupProfiles_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysGroupProfiles_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysGroupProfiles_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysGroupProfiles_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysGroupProfiles_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysGroupProfiles_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysGroupProfiles_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_group_profiles-acl-qfdu',
    	'WbfsysGroupProfiles_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysGroupProfiles_Acl_Controller */
