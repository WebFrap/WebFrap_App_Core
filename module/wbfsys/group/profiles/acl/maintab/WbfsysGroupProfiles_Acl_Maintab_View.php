 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysGroupProfiles_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.GroupProfiles_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_group_profiles-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.GroupProfiles_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_group_profiles-acl-update';
    ...
    $this->setTemplate( 'wbfsys/group_profiles/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Group Profiles', 'wbfsys.group_profiles.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_group_profiles_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysGroupProfiles_Acl' );
...
} // end class WbfsysGroupProfiles_Acl_Maintab_View */
