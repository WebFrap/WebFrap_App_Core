 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/group_profiles/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_group_profiles-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_group_profiles-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysGroupProfiles_Acl_Path_Maintab_View */
