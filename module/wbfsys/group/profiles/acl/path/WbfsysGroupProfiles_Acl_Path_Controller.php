 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_group_profiles_acl_graph', 
      'WbfsysGroupProfiles_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysGroupProfiles_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysGroupProfiles_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysGroupProfiles_Acl_Path_Maintab_View  */
...
} // end class WbfsysGroupProfiles_Acl_Path_Controller */
