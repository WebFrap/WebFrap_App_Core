 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysGroupProfiles_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysGroupProfiles_Export_Listing_Access';
    ...
    // create a new WbfsysGroupProfiles window
    $view = $this->loadView
    (
    	'export-wbfsys_group_profiles',
    	'WbfsysGroupProfiles_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysGroupProfiles_Export' );
...
} // end class WbfsysGroupProfiles_Export_Controller_Genf
