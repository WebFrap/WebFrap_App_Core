 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Group Profiles
  *
  ...
  *  }
  *
  * @return WbfsysGroupProfiles_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGroupProfiles_Table_Element( 'tableWbfsysGroupProfiles', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Group Profiles', 'wbfsys.group_profiles.label' );
      //$tabPanel->searchKey = 'wbfsys_group_profiles';
      ...
      $searchElement->searchKey = 'wbfsys_group_profiles';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysGroupProfiles_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysGroupProfiles', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysGroupProfiles listing maske
   *
   * @param WbfsysGroupProfiles_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysGroupProfiles_Table_Ui
