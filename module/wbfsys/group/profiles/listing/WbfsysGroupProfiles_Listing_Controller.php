 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysGroupProfiles_'.$listType ) );
...
} // end class WbfsysGroupProfiles_Listing_Controller */
