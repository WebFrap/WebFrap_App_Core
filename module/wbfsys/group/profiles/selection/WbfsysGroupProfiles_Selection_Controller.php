 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysGroupProfiles_Selection' ) );
...
} // end class WbfsysGroupProfiles_Selection_Controller */
