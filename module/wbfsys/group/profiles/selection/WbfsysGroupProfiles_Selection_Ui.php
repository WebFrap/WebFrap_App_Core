 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysGroupProfiles_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysGroupProfiles_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysGroupProfiles_Selection_Element
    (
      'selectionWbfsysGroupProfiles',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Group Profiles', 'wbfsys.group_profiles.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.GroupProfiles.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysGroupProfiles',
      'WbfsysGroupProfiles_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysGroupProfiles_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysGroupProfiles_Selection_Ui
