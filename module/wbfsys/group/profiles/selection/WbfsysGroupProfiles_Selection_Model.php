 ...
 * @licence WebFrap.net
 */
class WbfsysGroupProfiles_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysGroupProfiles_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysGroupProfiles_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysGroupProfiles_Selection_Model
