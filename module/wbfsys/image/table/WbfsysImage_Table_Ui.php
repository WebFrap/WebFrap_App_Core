...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Images
  *
  ...
  *  }
  *
  * @return WbfsysImage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImage_Table_Element( 'tableWbfsysImage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Images', 'wbfsys.image.label' );
      //$tabPanel->searchKey = 'wbfsys_image';
      ...
      $searchElement->searchKey = 'wbfsys_image';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysImage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysImage', $table->buildAjax() );
...
}//end class WbfsysImage_Table_Ui
