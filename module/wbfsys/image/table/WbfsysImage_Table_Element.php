 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_image';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysImage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Image.show&amp;target_mask=WbfsysImage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.image.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Image.edit&amp;target_mask=WbfsysImage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.image.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.Image_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.image.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=Wbfsys.Image_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.image.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Image.delete&amp;target_mask=WbfsysImage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.image.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_image&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.image.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.image.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Format', 'wbfsys.image.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_image_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.ImageFormat.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_image_format_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Image_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Images." >{$iconDelete} Delete selected Images</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Images. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Image_Multi.deleteAll" >{$iconClean} Delete all Images</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysImage_Table_Element
