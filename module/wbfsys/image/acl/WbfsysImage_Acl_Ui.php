...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysImage_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImage_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_image-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Image', 'wbfsys.image.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_image_acl';
