...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysImage_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysImage_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysImage, $areaId, $access, $params  )
  {

    $listObj = new WbfsysImage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_image-acl-dset' );
    ...
    else
    {
      ...
      (
        'Image "{@label@}" User Access',
        'wbfsys.image.label',
        array
        (
          'label' => $entityWbfsysImage->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_image_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysImage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysImage_Acl_Dset_Ui */
