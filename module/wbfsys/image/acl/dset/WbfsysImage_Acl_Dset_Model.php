 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_image'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImage_Acl_Dset' );
    /* @var $query WbfsysImage_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImage_Acl_Dset_Treetable' );
    /* @var $query WbfsysImage_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysImage_Acl_Dset_Model */
