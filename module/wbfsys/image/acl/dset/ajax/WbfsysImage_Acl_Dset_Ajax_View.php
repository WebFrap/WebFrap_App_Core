 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysImage_Acl_Dset' );
    ...
    $entityWbfsysImage = $this->model->getEntity( $dsetId );
...
} // end class WbfsysImage_Acl_Dset_Ajax_View */
