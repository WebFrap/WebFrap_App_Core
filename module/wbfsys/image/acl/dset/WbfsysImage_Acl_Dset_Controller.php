 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysImage_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysImage_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysImage = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysImage_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_image-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysImage, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysImage_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_image-acl-dset', 
    	'WbfsysImage_Acl_Dset',
...
} // end class WbfsysImage_Acl_Dset_Controller */
