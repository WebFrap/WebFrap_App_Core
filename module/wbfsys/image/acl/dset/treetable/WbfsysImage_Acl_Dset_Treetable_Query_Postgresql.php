 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_image.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysImage_Acl_Dset_Treetable_Query_Postgresql */
