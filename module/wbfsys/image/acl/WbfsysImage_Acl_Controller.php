 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysImage
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysImage_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysImage_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysImage_Acl_Model */
    $model   = $this->loadModel( 'WbfsysImage_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_image_acl_masks_listing',
      'WbfsysImage_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysImage_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysImage_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysImage_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysImage_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysImage_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysImage_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_image-acl-qfdu',
    	'WbfsysImage_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysImage_Acl_Controller */
