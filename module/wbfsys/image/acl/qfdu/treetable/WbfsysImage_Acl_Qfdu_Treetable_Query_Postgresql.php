 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_image.title as "wbfsys_image_title"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_image on wbfsys_group_users.vid = wbfsys_image.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_image.title) like upper(\''.$part.'%\') )
...
} // end class WbfsysImage_Acl_Qfdu_Treetable_Query_Postgresql */
