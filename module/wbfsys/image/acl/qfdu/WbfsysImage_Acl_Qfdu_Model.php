 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_image')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysImage = $orm->get('WbfsysImage', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_image_title']  = $refEntityWbfsysImage->title;

    }
    $tabData['wbfsys_image_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysImage_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImage_Acl' );
    /* @var $query WbfsysImage_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImage_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysImage_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImage_Acl_Qfdu' );
    /* @var $query WbfsysImage_Acl_Qfdu_Query  */
...
} // end class WbfsysImage_Acl_Qfdu_Model */
