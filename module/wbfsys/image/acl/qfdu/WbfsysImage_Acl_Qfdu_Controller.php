 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysImage_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_image-acl-qfdu-aAjax',
      'WbfsysImage_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysImage_Acl_Qfdu_Controller */
