 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_image.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_image.rowid as id,
    wbfsys_image.title as value,
    wbfsys_image.title as label
  FROM
    wbfsys_image
  WHERE
    {$sqlWhere}
...
} // end class WbfsysImage_Acl_Qfdu_Query_Postgresql */
