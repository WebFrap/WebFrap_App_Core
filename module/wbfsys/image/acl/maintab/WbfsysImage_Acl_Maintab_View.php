 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Image_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Image_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_image-acl-update';
    ...
    $this->setTemplate( 'wbfsys/image/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Image', 'wbfsys.image.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_image_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysImage_Acl' );
...
} // end class WbfsysImage_Acl_Maintab_View */
