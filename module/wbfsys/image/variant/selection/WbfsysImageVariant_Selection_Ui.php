 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysImageVariant_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysImageVariant_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageVariant_Selection_Element
    (
      'selectionWbfsysImageVariant',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Image Variants', 'wbfsys.image_variant.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ImageVariant.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysImageVariant',
      'WbfsysImageVariant_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysImageVariant_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysImageVariant_Selection_Ui
