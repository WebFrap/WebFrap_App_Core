 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysImageVariant_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_image_variant.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_image_variant.rowid ",
      'acls'
    );
...
}//end class WbfsysImageVariant_Selection_Access
