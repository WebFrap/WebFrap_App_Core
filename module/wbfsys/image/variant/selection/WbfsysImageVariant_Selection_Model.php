 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysImageVariant_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysImageVariant_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysImageVariant_Selection_Model
