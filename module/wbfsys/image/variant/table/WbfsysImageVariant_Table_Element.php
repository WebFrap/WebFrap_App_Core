 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_image_variant';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysImageVariant_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ImageVariant.show&amp;target_mask=WbfsysImageVariant&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ImageVariant.edit&amp;target_mask=WbfsysImageVariant&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.image_variant.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ImageVariant.delete&amp;target_mask=WbfsysImageVariant&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.image_variant.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Format', 'wbfsys.image_variant.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_image_variant_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ImageVariant_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Image Variants." >{$iconDelete} Delete selected Image Variants</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Image Variants. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ImageVariant_Multi.deleteAll" >{$iconClean} Delete all Image Variants</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysImageVariant_Table_Element
