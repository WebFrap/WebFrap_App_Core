 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Image Variants
  *
  ...
  *  }
  *
  * @return WbfsysImageVariant_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageVariant_Table_Element( 'tableWbfsysImageVariant', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image_variant-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Image Variants', 'wbfsys.image_variant.label' );
      //$tabPanel->searchKey = 'wbfsys_image_variant';
      ...
      $searchElement->searchKey = 'wbfsys_image_variant';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysImageVariant_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysImageVariant', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysImageVariant listing maske
   *
   * @param WbfsysImageVariant_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysImageVariant  = $model->getEntityWbfsysImageVariant();
    ...
    $formWbfsysImageVariant->setKeyName( 'wbfsys_image_variant' );
...
}//end class WbfsysImageVariant_Table_Ui
