 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysImageVariant entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ImageVariant.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ImageVariant.insert';
    $params->formId       = 'wgt-form-wbfsys_image_variant';
    $params->namespace   = 'wbfsys_image_variant-create';
    ...
    $this->setTemplate( 'wbfsys/image_variant/modal/crud/form_create' );
...
}//end class WbfsysImageVariant_Crud_Create_Modal_View
