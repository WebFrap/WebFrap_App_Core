 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysImageVariant Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_image_variant-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/image_variant/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ImageVariant.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_image_variant';
    ...
    $form = $this->newForm( 'WbfsysImageVariant_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ImageVariant.create');}});
});
...
}//end class WbfsysImageVariant_Crud_Create_Maintab_View
