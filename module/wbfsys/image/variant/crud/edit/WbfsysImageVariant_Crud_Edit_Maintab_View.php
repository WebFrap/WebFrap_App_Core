 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysImageVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysImageVariant = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Image Variant: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ImageVariant.edit&amp;utf8=✓&amp;objid='.$entityWbfsysImageVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ImageVariant.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_image_variant-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/image_variant/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysImageVariant_Crud_Edit' );
...
}//end class WbfsysImageVariant_Crud_Edit_Maintab_View
