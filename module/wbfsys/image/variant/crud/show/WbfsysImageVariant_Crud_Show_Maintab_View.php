 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysImageVariant Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysImageVariant = $this->model->getEntityWbfsysImageVariant();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Image Variant: {@text@}',
      'wbfsys.image_variant.label',
      array( 'text' => $entityWbfsysImageVariant->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ImageVariant.show  &amp;objid='.$entityWbfsysImageVariant
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ImageVariant.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_image_variant-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/image_variant/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysImageVariant_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ImageVariant.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_image_variant' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_image_variant a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ImageVariant.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ImageVariant.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysImageVariant_Crud_Show_Maintab_View
