 ...
 * @licence WebFrap.net
 */
class WbfsysImageVariant_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysImageVariant_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysImageVariant_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysImageVariant_Entity */
      $entity = $orm->get( 'WbfsysImageVariant', $rootId );
    }
...
}//end class WbfsysImageVariant_Crud_Access_Root
