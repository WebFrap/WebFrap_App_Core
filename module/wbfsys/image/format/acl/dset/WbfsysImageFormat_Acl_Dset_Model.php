 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_image_format'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysImageFormat', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImageFormat_Acl_Dset' );
    /* @var $query WbfsysImageFormat_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImageFormat_Acl_Dset_Treetable' );
    /* @var $query WbfsysImageFormat_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysImageFormat_Acl_Dset_Model */
