 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysImageFormat_Acl_Dset' );
    ...
    $entityWbfsysImageFormat = $this->model->getEntity( $dsetId );
...
} // end class WbfsysImageFormat_Acl_Dset_Ajax_View */
