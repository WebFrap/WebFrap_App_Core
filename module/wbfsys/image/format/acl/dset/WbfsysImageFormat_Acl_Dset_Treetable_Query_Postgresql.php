 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_image_format.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysImageFormat_Acl_Dset_Treetable_Query_Postgresql */
