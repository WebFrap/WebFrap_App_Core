 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysImageFormat_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysImageFormat_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysImageFormat = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysImageFormat_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_image_format-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysImageFormat, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysImageFormat_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_image_format-acl-dset', 
    	'WbfsysImageFormat_Acl_Dset',
...
} // end class WbfsysImageFormat_Acl_Dset_Controller */
