 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysImageFormat_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysImageFormat_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysImageFormat, $areaId, $access, $params  )
  {

    $listObj = new WbfsysImageFormat_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_image_format-acl-dset' );
    ...
    else
    {
      ...
      (
        'image format "{@label@}" User Access',
        'wbfsys.image_format.label',
        array
        (
          'label' => $entityWbfsysImageFormat->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_image_format_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysImageFormat_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysImageFormat_Acl_Dset_Ui */
