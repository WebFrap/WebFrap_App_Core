 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysImageFormat
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysImageFormat_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_image_format_acl_listing',
      'WbfsysImageFormat_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysImageFormat_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysImageFormat_Acl_Model */
    $model   = $this->loadModel( 'WbfsysImageFormat_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_image_format-acl',
    	'WbfsysImageFormat_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_image_format_acl_masks_listing',
      'WbfsysImageFormat_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysImageFormat_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysImageFormat_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysImageFormat_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysImageFormat_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysImageFormat_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysImageFormat_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_image_format-acl-qfdu',
    	'WbfsysImageFormat_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysImageFormat_Acl_Controller */
