 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_image_format_acl_graph', 
      'WbfsysImageFormat_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysImageFormat_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysImageFormat_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysImageFormat_Acl_Path_Maintab_View  */
...
} // end class WbfsysImageFormat_Acl_Path_Controller */
