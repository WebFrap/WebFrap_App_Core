 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ImageFormat_Acl.search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.ImageFormat_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_image_format-acl-update';
    ...
    $this->setTemplate( 'wbfsys/image_format/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'image format', 'wbfsys.image_format.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_image_format_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysImageFormat_Acl' );
...
} // end class WbfsysImageFormat_Acl_Maintab_View */
