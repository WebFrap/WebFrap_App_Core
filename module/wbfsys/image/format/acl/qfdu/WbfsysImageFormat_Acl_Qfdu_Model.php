 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_image_format')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysImageFormat = $orm->get('WbfsysImageFormat', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_image_format_name']  = $refEntityWbfsysImageFormat->name;

    }
    $tabData['wbfsys_image_format_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysImageFormat_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImageFormat_Acl' );
    /* @var $query WbfsysImageFormat_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImageFormat_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysImageFormat_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysImageFormat_Acl_Qfdu' );
    /* @var $query WbfsysImageFormat_Acl_Qfdu_Query  */
...
} // end class WbfsysImageFormat_Acl_Qfdu_Model */
