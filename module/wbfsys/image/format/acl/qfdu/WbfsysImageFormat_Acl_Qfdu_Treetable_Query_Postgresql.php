 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_image_format.rowid as "wbfsys_image_format_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_image_format on wbfsys_group_users.vid = wbfsys_image_format.rowid'
    );
...
} // end class WbfsysImageFormat_Acl_Qfdu_Treetable_Query_Postgresql */
