 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysImageFormat_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_image_format-acl-qfdu-aAjax',
      'WbfsysImageFormat_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysImageFormat_Acl_Qfdu_Controller */
