 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_image_format.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_image_format.rowid as id,
    wbfsys_image_format.name as value,
    wbfsys_image_format.name as label
  FROM
    wbfsys_image_format
  WHERE
    {$sqlWhere}
...
} // end class WbfsysImageFormat_Acl_Qfdu_Query_Postgresql */
