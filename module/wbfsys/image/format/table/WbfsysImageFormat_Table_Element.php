 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_image_format';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ImageFormat.show&amp;target_mask=WbfsysImageFormat&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ImageFormat.edit&amp;target_mask=WbfsysImageFormat&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.image_format.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ImageFormat.delete&amp;target_mask=WbfsysImageFormat&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.image_format.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ImageFormat.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_image_format_name'])).'</a></td>'.NL;
...
}//end class WbfsysImageFormat_Table_Element
