 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für image formats
  *
  ...
  *  }
  *
  * @return WbfsysImageFormat_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageFormat_Table_Element( 'tableWbfsysImageFormat', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image_format-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'image formats', 'wbfsys.image_format.label' );
      //$tabPanel->searchKey = 'wbfsys_image_format';
      ...
      $searchElement->searchKey = 'wbfsys_image_format';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysImageFormat_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysImageFormat', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysImageFormat listing maske
   *
   * @param WbfsysImageFormat_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysImageFormat  = $model->getEntityWbfsysImageFormat();
    ...
    $formWbfsysImageFormat->setKeyName( 'wbfsys_image_format' );
...
}//end class WbfsysImageFormat_Table_Ui
