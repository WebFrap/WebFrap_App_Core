 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormatI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_image_format_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysImageFormatI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysImageFormatI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysImageFormatI18n';
   ...
   *
   * @var WbfsysImageFormatI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysImageFormatI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysImageFormatI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysImageFormatI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.image_format_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_image_format
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_image_format( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysImageFormat_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysImageFormat not exists' );

      Log::warn('Looks like the Entity: WbfsysImageFormat is missing');
      ...
      //p: Window
      $objidWbfsysImageFormat = $this->entity->getData('id_wbfsys_image_format') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysImageFormat
          || !$entityWbfsysImageFormat = $this->db->orm->get
          (
            'WbfsysImageFormat',
            $objidWbfsysImageFormat
          )
      ...
      {
        $entityWbfsysImageFormat = $this->db->orm->newEntity( 'WbfsysImageFormat' );
      }

      $inputIdWbfsysImageFormat = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysImageFormat', 'Window' );
      $inputIdWbfsysImageFormat->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_image_format]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_image_format'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Image Format (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysImageFormat->assignedForm = $this->assignedForm;

      $inputIdWbfsysImageFormat->setWidth( 'medium' );

      $inputIdWbfsysImageFormat->setData( $this->entity->getData( 'id_wbfsys_image_format' )  );
      $inputIdWbfsysImageFormat->setReadOnly( $this->isReadOnly( 'id_wbfsys_image_format' ) );
      $inputIdWbfsysImageFormat->setLabel( $this->view->i18n->l( 'Wbfsys Image Format', 'wbfsys.image_format_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.ImageFormat.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_image_format'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysImageFormat->setListUrl ( $listUrl );
      $inputIdWbfsysImageFormat->setListIcon( 'control/connect.png' );
      $inputIdWbfsysImageFormat->setEntityUrl( 'maintab.php?c=Wbfsys.ImageFormat.edit' );
      $inputIdWbfsysImageFormat->conEntity         = $entityWbfsysImageFormat;
      $inputIdWbfsysImageFormat->refresh           = $this->refresh;
      $inputIdWbfsysImageFormat->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysImageFormat->view = $this->view;
      $inputIdWbfsysImageFormat->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_image_format'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysImageFormat );
  ...
  }//end public function input_id_wbfsys_image_format */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.image_format_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.image_format_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.image_format_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.image_format_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.image_format_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.image_format_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.image_format_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.image_format_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.image_format_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Image Format I18n)', 'wbfsys.image_format_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_image_format_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_image_format_i18n_m_role_change';
...
}//end class WbfsysImageFormatI18n_Form */
