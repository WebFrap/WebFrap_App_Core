 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysImageFormat_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysImageFormat_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysImageFormat_Entity */
      $entity = $orm->get( 'WbfsysImageFormat', $rootId );
    }
...
}//end class WbfsysImageFormat_Crud_Access_Root
