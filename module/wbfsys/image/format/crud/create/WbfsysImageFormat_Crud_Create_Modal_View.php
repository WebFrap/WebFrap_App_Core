 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysImageFormat entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ImageFormat.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ImageFormat.insert';
    $params->formId       = 'wgt-form-wbfsys_image_format';
    $params->namespace   = 'wbfsys_image_format-create';
    ...
    $this->setTemplate( 'wbfsys/image_format/modal/crud/form_create' );
...
}//end class WbfsysImageFormat_Crud_Create_Modal_View
