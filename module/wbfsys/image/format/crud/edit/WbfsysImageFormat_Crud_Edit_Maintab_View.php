 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysImageFormat Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysImageFormat = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit image format: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ImageFormat.edit&amp;utf8=✓&amp;objid='.$entityWbfsysImageFormat
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ImageFormat.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_image_format-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/image_format/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysImageFormat_Crud_Edit' );
...
}//end class WbfsysImageFormat_Crud_Edit_Maintab_View
