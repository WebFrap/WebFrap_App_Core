 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysImageFormat_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysImageFormat Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysImageFormat = $this->model->getEntityWbfsysImageFormat();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show image format: {@text@}',
      'wbfsys.image_format.label',
      array( 'text' => $entityWbfsysImageFormat->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ImageFormat.show  &amp;objid='.$entityWbfsysImageFormat
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ImageFormat.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_image_format-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/image_format/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysImageFormat_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ImageFormat.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_image_format' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_image_format a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ImageFormat.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ImageFormat.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysImageFormat_Crud_Show_Maintab_View
