 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysImageFormat_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysImageFormat_Export_Listing_Access';
    ...
    // create a new WbfsysImageFormat window
    $view = $this->loadView
    (
    	'export-wbfsys_image_format',
    	'WbfsysImageFormat_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysImageFormat_Export' );
...
} // end class WbfsysImageFormat_Export_Controller_Genf
