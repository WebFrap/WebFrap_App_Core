 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysImageFormat_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysImageFormat_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageFormat_Selection_Element
    (
      'selectionWbfsysImageFormat',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection image formats', 'wbfsys.image_format.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ImageFormat.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysImageFormat',
      'WbfsysImageFormat_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysImageFormat_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysImageFormat_Selection_Ui
