 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_image_format';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysImageFormat_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ImageFormat.show&amp;target_mask=WbfsysImageFormat&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ImageFormat.edit&amp;target_mask=WbfsysImageFormat&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.image_format.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ImageFormat.delete&amp;target_mask=WbfsysImageFormat&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.image_format.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_image_format&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.image_format.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.ImageFormat.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.image_format.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.image_format.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_image_format_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_image_format_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_image_format_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ImageFormat_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected image formats." >{$iconDelete} Delete selected image formats</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! image formats. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ImageFormat_Multi.deleteAll" >{$iconClean} Delete all image formats</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysImageFormat_Selection_Element
