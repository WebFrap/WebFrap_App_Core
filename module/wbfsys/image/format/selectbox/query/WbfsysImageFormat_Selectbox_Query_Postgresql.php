 ...
 * @licence WebFrap.net
 */
class WbfsysImageFormat_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysImageFormat Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_image_format.rowid as id',
      'wbfsys_image_format.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_image_format.m_order as "wbfsys_image_format-m_order-order"' );

    $criteria->from( 'wbfsys_image_format' );



      $criteria->orderBy( 'wbfsys_image_format.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_image_format.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_image_format.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysImageFormat_Selectbox_Query_Postgresql
