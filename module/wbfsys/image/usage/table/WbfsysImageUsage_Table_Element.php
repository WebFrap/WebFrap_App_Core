 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_image_usage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysImageUsage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ImageUsage.show&amp;target_mask=WbfsysImageUsage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ImageUsage.edit&amp;target_mask=WbfsysImageUsage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.image_usage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ImageUsage.delete&amp;target_mask=WbfsysImageUsage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.image_usage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_image_usage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ImageUsage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Image Usages." >{$iconDelete} Delete selected Image Usages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Image Usages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ImageUsage_Multi.deleteAll" >{$iconClean} Delete all Image Usages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysImageUsage_Table_Element
