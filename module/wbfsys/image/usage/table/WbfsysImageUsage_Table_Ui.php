 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Image Usages
  *
  ...
  *  }
  *
  * @return WbfsysImageUsage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageUsage_Table_Element( 'tableWbfsysImageUsage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image_usage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Image Usages', 'wbfsys.image_usage.label' );
      //$tabPanel->searchKey = 'wbfsys_image_usage';
      ...
      $searchElement->searchKey = 'wbfsys_image_usage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysImageUsage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysImageUsage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysImageUsage listing maske
   *
   * @param WbfsysImageUsage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysImageUsage  = $model->getEntityWbfsysImageUsage();
    ...
    $formWbfsysImageUsage->setKeyName( 'wbfsys_image_usage' );
...
}//end class WbfsysImageUsage_Table_Ui
