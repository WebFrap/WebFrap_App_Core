 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysImageUsage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysImageUsage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImageUsage_Selection_Element
    (
      'selectionWbfsysImageUsage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Image Usages', 'wbfsys.image_usage.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ImageUsage.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysImageUsage',
      'WbfsysImageUsage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysImageUsage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysImageUsage_Selection_Ui
