 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysImageUsage_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_image_usage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_image_usage.rowid ",
      'acls'
    );
...
}//end class WbfsysImageUsage_Selection_Access
