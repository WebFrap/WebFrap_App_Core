 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysImageUsage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_image_usage-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/image_usage/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ImageUsage.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_image_usage';
    ...
    $form = $this->newForm( 'WbfsysImageUsage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ImageUsage.create');}});
});
...
}//end class WbfsysImageUsage_Crud_Create_Maintab_View
