 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysImageUsage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ImageUsage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ImageUsage.insert';
    $params->formId       = 'wgt-form-wbfsys_image_usage';
    $params->namespace   = 'wbfsys_image_usage-create';
    ...
    $this->setTemplate( 'wbfsys/image_usage/modal/crud/form_create' );
...
}//end class WbfsysImageUsage_Crud_Create_Modal_View
