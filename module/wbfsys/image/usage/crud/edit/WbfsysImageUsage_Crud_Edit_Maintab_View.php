 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysImageUsage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysImageUsage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Image Usage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ImageUsage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysImageUsage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ImageUsage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_image_usage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/image_usage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysImageUsage_Crud_Edit' );
...
}//end class WbfsysImageUsage_Crud_Edit_Maintab_View
