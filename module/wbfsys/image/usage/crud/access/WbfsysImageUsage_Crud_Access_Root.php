 ...
 * @licence WebFrap.net
 */
class WbfsysImageUsage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysImageUsage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysImageUsage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysImageUsage_Entity */
      $entity = $orm->get( 'WbfsysImageUsage', $rootId );
    }
...
}//end class WbfsysImageUsage_Crud_Access_Root
