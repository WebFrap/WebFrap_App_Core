 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysImage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysImage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysImage_Selection_Element
    (
      'selectionWbfsysImage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Images', 'wbfsys.image.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Image.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysImage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysImage_Selection_Ui
