 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysImage_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysImage_Export_Listing_Access';
    ...
    // create a new WbfsysImage window
    $view = $this->loadView
    (
    	'export-wbfsys_image',
    	'WbfsysImage_Export',
    ...
    $model = $this->loadModel( 'WbfsysImage_Export' );
...
} // end class WbfsysImage_Export_Controller_Genf
