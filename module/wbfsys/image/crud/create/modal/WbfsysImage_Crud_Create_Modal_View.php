 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysImage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Image.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Image.insert';
    $params->formId       = 'wgt-form-wbfsys_image';
    $params->namespace   = 'wbfsys_image-create';
    ...
    $this->setTemplate( 'wbfsys/image/modal/crud/form_create' );
...
}//end class WbfsysImage_Crud_Create_Modal_View
