 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Comments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listComments as $entityWbfsysImage )
      {
        if(!$orm->save( $entityWbfsysImage) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Image '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Image '.$entityText,
              'wbfsys.image.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Image: '.$textSaved,
          'wbfsys.image.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysImage_Ref_Comments_Multi_Model
