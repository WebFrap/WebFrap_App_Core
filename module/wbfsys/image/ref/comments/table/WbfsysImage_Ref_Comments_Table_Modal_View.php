 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.Image_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_image-ref-comments-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/image/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysImage_Ref_Comments_Table' );
...
}//end class WbfsysImage_Ref_Comments_Table_Modal_View
