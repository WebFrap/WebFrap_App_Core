 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Image_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysImage_Ref_Comments_Table_Ajax_View
