 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysImage
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysImage_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysImage, $data, $access, $params  )
  {
    ...
    $table = new WbfsysImage_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_image-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysImage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image-ref-comments-search-'
        .$idWbfsysImage;
    ...
    $tabPanel->searchKey = 'wbfsys_image-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysImage_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysImage );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Image_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysImage
    );
   ...
   * @return WbfsysImage_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysImage, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysImage_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysImage_Ref_Comments_Table_Ui
