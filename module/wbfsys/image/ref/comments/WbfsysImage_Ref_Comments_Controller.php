 ...
 * If you want to extend this class write your coden in ControllerWbfsysImage
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_image management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysImage_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_image-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_image-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysImage_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysImage_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_image-ref-comments-'.$listType.'-ajax',
    	'WbfsysImage_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysImage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_image-ref-comments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysImage_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysImage_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysImage_Ref_Comments_'.$listType );
...
} // end WbfsysImage_Ref_Comments_Controller
