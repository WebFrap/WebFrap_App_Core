 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysImage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysImage_Ref_Tags_Table' );
    /* @var $query WbfsysImage_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysImage );
...
}//end class WbfsysImage_Ref_Tags_Table_Model
