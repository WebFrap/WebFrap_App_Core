 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysImage_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysImage, $data, $access, $params  )
  {
    ...
    $table = new WbfsysImage_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_image-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysImage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_image-ref-tags-search-'
        .$idWbfsysImage;
    ...
    $tabPanel->searchKey = 'wbfsys_image-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysImage_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysImage );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.Image_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysImage_Ref_Tags_Table_Ui
