 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_image-ref-tags' );
  ...
  /**
   * @param WbfsysImage_Ref_Tags_Table_Query $query
...
}//end class WbfsysImage_Ref_Tags_Table_Access
