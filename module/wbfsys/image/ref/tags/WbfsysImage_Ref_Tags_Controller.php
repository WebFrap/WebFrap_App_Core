 ...
 * @licence WebFrap.net
 */
class WbfsysImage_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysImage_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_image-ref-tags';
    ...
    (
      $params->tabId,
      'WbfsysImage_Ref_Tags_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysImage_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_image-ref-tags-'.$listType.'-ajax',
    	'WbfsysImage_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysImage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysImage_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysImage_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysImage_Ref_Tags_'.$listType );
...
} // end WbfsysImage_Ref_Tags_Controller
