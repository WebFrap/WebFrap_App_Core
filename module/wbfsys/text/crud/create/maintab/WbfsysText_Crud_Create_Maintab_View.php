 ...
 * @licence WebFrap.net
 */
class WbfsysText_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysText Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_text-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/text/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Text.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_text';
    ...
    $form = $this->newForm( 'WbfsysText_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Text.create');}});
});
...
}//end class WbfsysText_Crud_Create_Maintab_View
