 ...
 * @licence WebFrap.net
 */
class WbfsysText_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysText entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Text.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Text.insert';
    $params->formId       = 'wgt-form-wbfsys_text';
    $params->namespace   = 'wbfsys_text-create';
    ...
    $this->setTemplate( 'wbfsys/text/modal/crud/form_create' );
...
}//end class WbfsysText_Crud_Create_Modal_View
