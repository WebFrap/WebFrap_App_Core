 ...
 * @licence WebFrap.net
 */
class WbfsysText_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysText Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysText = $this->model->getEntityWbfsysText();
    ...
    (
      'Show Text: {@text@}',
      'wbfsys.text.label',
      array( 'text' => $entityWbfsysText->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Text.show  &amp;objid='.$entityWbfsysText
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Text.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_text-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/text/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysText_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Text.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_text' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_text a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Text.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Text.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysText_Crud_Show_Maintab_View
