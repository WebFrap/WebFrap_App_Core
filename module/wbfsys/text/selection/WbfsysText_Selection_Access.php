 ...
 * @licence WebFrap.net
 */
class WbfsysText_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysText_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_text.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_text.rowid ",
      'acls'
    );
...
}//end class WbfsysText_Selection_Access
