...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysText_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysText_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysText_Selection_Element
    (
      'selectionWbfsysText',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Texts', 'wbfsys.text.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Text.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysText_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysText_Selection_Ui
