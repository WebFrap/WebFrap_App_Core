 ...
 *
 * Entity Class for the Database Table wbfsys_text
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_text';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Text.show';
  ...
  */
  public static $entityName  = 'WbfsysText';
  ...
  */
  ...
  (
    'access_key' => array
    (
      'default' => 'wbfsys.text.message.error_def_access_key',
      'wrong'   => 'wbfsys.text.message.error_wrong_access_key',
      'empty'   => 'wbfsys.text.message.error_empty_access_key',
      'max'     => 'wbfsys.text.message.error_max_access_key',
      'min'     => 'wbfsys.text.message.error_min_access_key',
    ),

    'id_lang' => array
    (
      'default' => 'wbfsys.text.message.error_def_id_lang',
      'wrong'   => 'wbfsys.text.message.error_wrong_id_lang',
      'max'     => 'wbfsys.text.message.error_max_id_lang',
      'min'     => 'wbfsys.text.message.error_min_id_lang',
    ),

    'content' => array
    (
      'default' => 'wbfsys.text.message.error_def_content',
      'wrong'   => 'wbfsys.text.message.error_wrong_content',
      'empty'   => 'wbfsys.text.message.error_empty_content',
      'max'     => 'wbfsys.text.message.error_max_content',
      'min'     => 'wbfsys.text.message.error_min_content',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.text.message.error_def_rowid',
      'wrong'   => 'wbfsys.text.message.error_wrong_rowid',
      'empty'   => 'wbfsys.text.message.error_empty_rowid',
      'max'     => 'wbfsys.text.message.error_max_rowid',
      'min'     => 'wbfsys.text.message.error_min_rowid',
    ),
  );

}//end class WbfsysText_Entity
