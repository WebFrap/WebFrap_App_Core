...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Texts
  *
  ...
  *  }
  *
  * @return WbfsysText_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysText_Table_Element( 'tableWbfsysText', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_text-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Texts', 'wbfsys.text.label' );
      //$tabPanel->searchKey = 'wbfsys_text';
      ...
      $searchElement->searchKey = 'wbfsys_text';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysText_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysText', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysText listing maske
   *
   * @param WbfsysText_Table_Model $model
   * @param TFlag $params
   * @return void
   */
