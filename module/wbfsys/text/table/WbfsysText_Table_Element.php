 ...
 * @licence WebFrap.net
 */
class WbfsysText_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_text';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysText_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Text.show&amp;target_mask=WbfsysText&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.text.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Text.edit&amp;target_mask=WbfsysText&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.text.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Text.delete&amp;target_mask=WbfsysText&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.text.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.text.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Content', 'wbfsys.text.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_text_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" >'.$row['wbfsys_text_content'].'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Text_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Texts." >{$iconDelete} Delete selected Texts</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Texts. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Text_Multi.deleteAll" >{$iconClean} Delete all Texts</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysText_Table_Element
