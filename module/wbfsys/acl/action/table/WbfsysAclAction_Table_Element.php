 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_acl_action';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysAclAction_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.AclAction.show&amp;target_mask=WbfsysAclAction&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.AclAction.edit&amp;target_mask=WbfsysAclAction&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.acl_action.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.AclAction.delete&amp;target_mask=WbfsysAclAction&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.acl_action.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_acl_action&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.acl_action.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_acl_action_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.AclAction_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Acl Actions." >{$iconDelete} Delete selected Acl Actions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Acl Actions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.AclAction_Multi.deleteAll" >{$iconClean} Delete all Acl Actions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysAclAction_Table_Element
