 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Acl Actions
  *
  ...
  *  }
  *
  * @return WbfsysAclAction_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAclAction_Table_Element( 'tableWbfsysAclAction', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_acl_action-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Acl Actions', 'wbfsys.acl_action.label' );
      //$tabPanel->searchKey = 'wbfsys_acl_action';
      ...
      $searchElement->searchKey = 'wbfsys_acl_action';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysAclAction_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysAclAction', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysAclAction listing maske
   *
   * @param WbfsysAclAction_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysAclAction  = $model->getEntityWbfsysAclAction();
    ...
    $formWbfsysAclAction->setKeyName( 'wbfsys_acl_action' );
...
}//end class WbfsysAclAction_Table_Ui
