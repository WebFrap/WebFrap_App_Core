 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysAclAction_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysAclAction_Export_Listing_Access';
    ...
    // create a new WbfsysAclAction window
    $view = $this->loadView
    (
    	'export-wbfsys_acl_action',
    	'WbfsysAclAction_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysAclAction_Export' );
...
} // end class WbfsysAclAction_Export_Controller_Genf
