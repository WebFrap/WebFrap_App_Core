 ...
 *
 * Entity Class for the Database Table wbfsys_acl_action
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_acl_action';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.AclAction.show';
  ...
  */
  public static $entityName  = 'WbfsysAclAction';
  ...
  * @var string
  */
  public static $label  = 'Acl Action';
  ...
  */
  ...
  (
    'rowid' => array
    (
      'default' => 'wbfsys.acl_action.message.error_def_rowid',
      'wrong'   => 'wbfsys.acl_action.message.error_wrong_rowid',
      'empty'   => 'wbfsys.acl_action.message.error_empty_rowid',
      'max'     => 'wbfsys.acl_action.message.error_max_rowid',
      'min'     => 'wbfsys.acl_action.message.error_min_rowid',
    ),
  );

}//end class WbfsysAclAction_Entity
