 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysAclAction Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAclAction = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Acl Action: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AclAction.edit&amp;utf8=✓&amp;objid='.$entityWbfsysAclAction
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AclAction.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_acl_action-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/acl_action/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysAclAction_Crud_Edit' );
...
}//end class WbfsysAclAction_Crud_Edit_Maintab_View
