 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysAclAction_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysAclAction Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysAclAction = $this->model->getEntityWbfsysAclAction();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Acl Action: {@text@}',
      'wbfsys.acl_action.label',
      array( 'text' => $entityWbfsysAclAction->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.AclAction.show  &amp;objid='.$entityWbfsysAclAction
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.AclAction.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_acl_action-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/acl_action/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysAclAction_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.AclAction.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_acl_action' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_acl_action a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.AclAction.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.AclAction.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysAclAction_Crud_Show_Maintab_View
