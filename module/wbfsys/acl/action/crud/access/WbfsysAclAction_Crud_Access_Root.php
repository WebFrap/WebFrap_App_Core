 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysAclAction_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysAclAction_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysAclAction_Entity */
      $entity = $orm->get( 'WbfsysAclAction', $rootId );
    }
...
}//end class WbfsysAclAction_Crud_Access_Root
