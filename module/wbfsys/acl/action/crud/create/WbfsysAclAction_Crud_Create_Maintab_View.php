 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysAclAction Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_acl_action-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/acl_action/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AclAction.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_acl_action';
    ...
    $form = $this->newForm( 'WbfsysAclAction_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.AclAction.create');}});
});
...
}//end class WbfsysAclAction_Crud_Create_Maintab_View
