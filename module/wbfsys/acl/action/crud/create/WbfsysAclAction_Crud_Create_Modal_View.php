 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysAclAction entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.AclAction.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.AclAction.insert';
    $params->formId       = 'wgt-form-wbfsys_acl_action';
    $params->namespace   = 'wbfsys_acl_action-create';
    ...
    $this->setTemplate( 'wbfsys/acl_action/modal/crud/form_create' );
...
}//end class WbfsysAclAction_Crud_Create_Modal_View
