 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysAclAction_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysAclAction_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAclAction_Selection_Element
    (
      'selectionWbfsysAclAction',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Acl Actions', 'wbfsys.acl_action.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.AclAction.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysAclAction',
      'WbfsysAclAction_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysAclAction_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysAclAction_Selection_Ui
