 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysAclAction_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_acl_action-acl-qfdu-aAjax',
      'WbfsysAclAction_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysAclAction_Acl_Qfdu_Controller */
