 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Qfdu_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAclAction_Acl_Qfdu_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAclAction_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAclAction_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Acl Action',
        'wbfsys.acl_action.label'
      );
      $tabPanel->searchKey  = 'wbfsys_acl_action_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new WbfsysAclAction_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class WbfsysAclAction_Acl_Qfdu_Ui */
