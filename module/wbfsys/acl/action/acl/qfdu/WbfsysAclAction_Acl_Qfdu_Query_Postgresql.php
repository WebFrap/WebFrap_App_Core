 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_acl_action.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_acl_action.rowid as id,
    wbfsys_acl_action.rowid as value,
    wbfsys_acl_action.rowid as label
  FROM
    wbfsys_acl_action
  WHERE
    {$sqlWhere}
...
} // end class WbfsysAclAction_Acl_Qfdu_Query_Postgresql */
