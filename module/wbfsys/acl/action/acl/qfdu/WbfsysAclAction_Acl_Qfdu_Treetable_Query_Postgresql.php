 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_acl_action.rowid as "wbfsys_acl_action_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_acl_action on wbfsys_group_users.vid = wbfsys_acl_action.rowid'
    );
...
} // end class WbfsysAclAction_Acl_Qfdu_Treetable_Query_Postgresql */
