 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_acl_action'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysAclAction', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAclAction_Acl_Dset' );
    /* @var $query WbfsysAclAction_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysAclAction_Acl_Dset_Treetable' );
    /* @var $query WbfsysAclAction_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysAclAction_Acl_Dset_Model */
