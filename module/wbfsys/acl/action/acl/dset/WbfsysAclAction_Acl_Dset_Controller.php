 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysAclAction_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysAclAction_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysAclAction = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAclAction_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_acl_action-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysAclAction, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysAclAction_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_acl_action-acl-dset', 
    	'WbfsysAclAction_Acl_Dset',
...
} // end class WbfsysAclAction_Acl_Dset_Controller */
