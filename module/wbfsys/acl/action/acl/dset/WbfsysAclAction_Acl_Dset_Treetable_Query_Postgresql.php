 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_acl_action.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysAclAction_Acl_Dset_Treetable_Query_Postgresql */
