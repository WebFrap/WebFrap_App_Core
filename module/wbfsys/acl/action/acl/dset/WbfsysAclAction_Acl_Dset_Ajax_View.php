 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysAclAction_Acl_Dset' );
    ...
    $entityWbfsysAclAction = $this->model->getEntity( $dsetId );
...
} // end class WbfsysAclAction_Acl_Dset_Ajax_View */
