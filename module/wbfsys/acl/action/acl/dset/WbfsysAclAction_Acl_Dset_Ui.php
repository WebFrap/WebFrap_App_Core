 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysAclAction_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysAclAction_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysAclAction, $areaId, $access, $params  )
  {

    $listObj = new WbfsysAclAction_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_acl_action-acl-dset' );
    ...
    else
    {
      ...
      (
        'Acl Action "{@label@}" User Access',
        'wbfsys.acl_action.label',
        array
        (
          'label' => $entityWbfsysAclAction->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_acl_action_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysAclAction_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysAclAction_Acl_Dset_Ui */
