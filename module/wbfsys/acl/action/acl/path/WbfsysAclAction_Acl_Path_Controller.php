 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_acl_action_acl_graph', 
      'WbfsysAclAction_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysAclAction_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysAclAction_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysAclAction_Acl_Path_Maintab_View  */
...
} // end class WbfsysAclAction_Acl_Path_Controller */
