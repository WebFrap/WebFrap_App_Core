 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.AclAction_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_acl_action-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.AclAction_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_acl_action-acl-update';
    ...
    $this->setTemplate( 'wbfsys/acl_action/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Acl Action', 'wbfsys.acl_action.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_acl_action_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysAclAction_Acl' );
...
} // end class WbfsysAclAction_Acl_Maintab_View */
