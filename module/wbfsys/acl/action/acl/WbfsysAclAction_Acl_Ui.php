...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysAclAction_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysAclAction_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_acl_action-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Acl Action', 'wbfsys.acl_action.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_acl_action_acl';
...
} // end class WbfsysAclAction_Acl_Ui */
