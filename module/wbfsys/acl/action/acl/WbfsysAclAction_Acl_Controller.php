 ...
 * @licence WebFrap.net
 */
class WbfsysAclAction_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysAclAction
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysAclAction_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysAclAction_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysAclAction_Acl_Model */
    $model   = $this->loadModel( 'WbfsysAclAction_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_acl_action-acl',
    	'WbfsysAclAction_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_acl_action_acl_masks_listing',
      'WbfsysAclAction_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysAclAction_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysAclAction_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysAclAction_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysAclAction_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysAclAction_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysAclAction_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_acl_action-acl-qfdu',
    	'WbfsysAclAction_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysAclAction_Acl_Controller */
