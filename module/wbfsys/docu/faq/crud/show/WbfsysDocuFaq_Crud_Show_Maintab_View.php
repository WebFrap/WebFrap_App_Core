 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDocuFaq Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuFaq = $this->model->getEntityWbfsysDocuFaq();
    ...
    (
      ...
      array( 'text' => $entityWbfsysDocuFaq->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuFaq.show  &amp;objid='.$entityWbfsysDocuFaq
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuFaq.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_faq-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_faq/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDocuFaq_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DocuFaq.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_faq' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_faq a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DocuFaq.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DocuFaq.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDocuFaq_Crud_Show_Maintab_View
