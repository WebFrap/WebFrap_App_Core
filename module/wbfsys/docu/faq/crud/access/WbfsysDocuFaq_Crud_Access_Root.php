 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDocuFaq_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDocuFaq_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDocuFaq_Entity */
      $entity = $orm->get( 'WbfsysDocuFaq', $rootId );
    }
...
}//end class WbfsysDocuFaq_Crud_Access_Root
