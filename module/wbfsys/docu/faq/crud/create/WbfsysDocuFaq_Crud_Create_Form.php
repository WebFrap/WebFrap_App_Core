 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDocuFaq', array_keys( $this->fields['wbfsys_docu_faq']), true ),
...
}//end class WbfsysDocuFaq_Crud_Create_Form */
