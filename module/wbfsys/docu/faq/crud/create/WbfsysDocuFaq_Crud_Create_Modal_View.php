 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocuFaq entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DocuFaq.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocuFaq.insert';
    $params->formId       = 'wgt-form-wbfsys_docu_faq';
    $params->namespace   = 'wbfsys_docu_faq-create';
    ...
    $this->setTemplate( 'wbfsys/docu_faq/modal/crud/form_create' );
...
}//end class WbfsysDocuFaq_Crud_Create_Modal_View
