 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_docu_faq', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
    ...
    if( $objid )
    {
      $searchId = $objid;
      $keyType  = 'rowid';
      $entity   = $orm->get( 'WbfsysDocuFaq', $objid );
    }
    else if( $uuid )
    {
      $searchId = $uuid;
      $keyType  = 'uuid';
      $entity   = $orm->getByUuid( 'WbfsysDocuFaq', $uuid );
    }
    else if( $accessKey )
    {
      $searchId = $accessKey;
      $keyType  = 'access_key';
      $entity   = $orm->getByKey( 'WbfsysDocuFaq', $accessKey );
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysDocuFaq );
      }
   ...
   */
  public function delete( $entityWbfsysDocuFaq, $params  )
  {
    ...
    $delId     = $entityWbfsysDocuFaq->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysDocuFaq );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      //management  wbfsys_docu_faq source wbfsys_docu_faq
      $entityWbfsysDocuFaq = $orm->newEntity( 'WbfsysDocuFaq' );

      if( !$params->fieldsWbfsysDocuFaq )
      {
        if( isset( $fields['wbfsys_docu_faq'] )  )
          $params->fieldsWbfsysDocuFaq  = $fields['wbfsys_docu_faq'];
        else
          $params->fieldsWbfsysDocuFaq  = array();
      }
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysDocuFaq, $params )
  {
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysDocuFaq = $orm->get( 'WbfsysDocuFaq',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
    ...
    if( !$params->fieldsWbfsysDocuFaq )
      $params->fieldsWbfsysDocuFaq  = $entityWbfsysDocuFaq->getCols
      (
        $params->categories
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_docu_faq'] = array();
    $saveFields['wbfsys_docu_faq'][] = 'question';
        $saveFields['wbfsys_docu_faq'][] = 'vid';
        $saveFields['wbfsys_docu_faq'][] = 'answer';
        $saveFields['wbfsys_docu_faq'][] = 'id_vid_entity';
        $saveFields['wbfsys_docu_faq'][] = 'm_version';
