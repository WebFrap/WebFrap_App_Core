 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocuFaq Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuFaq = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuFaq.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocuFaq
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuFaq.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_faq-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_faq/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocuFaq_Crud_Edit' );
...
}//end class WbfsysDocuFaq_Crud_Edit_Maintab_View
