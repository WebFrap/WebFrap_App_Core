...
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysDocuFaq_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuFaq_Table_Element( 'tableWbfsysDocuFaq', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_docu_faq-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'FAQs', 'wbfsys.docu_faq.label' );
      //$tabPanel->searchKey = 'wbfsys_docu_faq';
      ...
      $searchElement->searchKey = 'wbfsys_docu_faq';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDocuFaq_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocuFaq', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDocuFaq listing maske
   *
   * @param WbfsysDocuFaq_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDocuFaq  = $model->getEntityWbfsysDocuFaq();
    ...
    $formWbfsysDocuFaq->setKeyName( 'wbfsys_docu_faq' );
...
}//end class WbfsysDocuFaq_Table_Ui
