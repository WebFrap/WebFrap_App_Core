 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_docu_faq';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDocuFaq_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocuFaq.show&amp;target_mask=WbfsysDocuFaq&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocuFaq.edit&amp;target_mask=WbfsysDocuFaq&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.docu_faq.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocuFaq.delete&amp;target_mask=WbfsysDocuFaq&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.docu_faq.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Question', 'wbfsys.docu_faq.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_docu_faq_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DocuFaq_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.DocuFaq_Multi.deleteAll" >{$iconClean} Delete all FAQs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDocuFaq_Table_Element
