 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocuFaq_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocuFaq_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuFaq_Selection_Element
    (
      'selectionWbfsysDocuFaq',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection FAQs', 'wbfsys.docu_faq.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DocuFaq.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysDocuFaq',
      'WbfsysDocuFaq_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocuFaq_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocuFaq_Selection_Ui
