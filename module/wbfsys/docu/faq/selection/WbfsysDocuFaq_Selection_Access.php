 ...
 * @licence WebFrap.net
 */
class WbfsysDocuFaq_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDocuFaq_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_docu_faq.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_docu_faq.rowid ",
      'acls'
    );
...
}//end class WbfsysDocuFaq_Selection_Access
