...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_docu_faq';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDocuFaq';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDocuFaq' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDocuFaq entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_question( $params )
  {

      //tpl: class ui:text
      $inputQuestion = $this->view->newInput( 'input'.$this->prefix.'Question' , 'Text' );
      $this->items['question'] = $inputQuestion;
      $inputQuestion->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[question]',
          'id'        => 'wgt-input-'.$this->keyName.'_question'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip xxlarge'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Question (Docu Faq)', 'wbfsys.docu_faq.label' ),
          'maxlength' => $this->entity->maxSize( 'question' ),
        )
      );
      $inputQuestion->setWidth( 'xxlarge' );

      $inputQuestion->setReadOnly( $this->isReadOnly( 'question' ) );
      $inputQuestion->setData( $this->entity->getSecure('question') );
      $inputQuestion->setLabel
      (
        $this->view->i18n->l( 'Question', 'wbfsys.docu_faq.label' ),
        $this->entity->required( 'question' )
      );
  ...
  }//end public function input_question */
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Docu Faq)', 'wbfsys.docu_faq.label' ),
  ...
  * @return void
  */
  public function input_answer( $params )
  {

      //p: textarea
      $inputAnswer = $this->view->newInput( 'input'.$this->prefix.'Answer', 'Textarea' );
      $this->items['answer'] = $inputAnswer;
      $inputAnswer->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[answer]',
          'id'    => 'wgt-input-'.$this->keyName.'_answer'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip full large-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Answer (Docu Faq)', 'wbfsys.docu_faq.label' ),
        )
      );
      ...
      $inputAnswer->setReadOnly( $this->isReadOnly( 'answer' ) );
      $inputAnswer->setLabel
      (
        $this->view->i18n->l( 'Answer', 'wbfsys.docu_faq.label' ),
        $this->entity->required( 'answer' )
      );
  ...
  }//end public function input_answer */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Docu Faq)', 'wbfsys.docu_faq.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Docu Faq)', 'wbfsys.docu_faq.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.docu_faq.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Docu Faq)', 'wbfsys.docu_faq.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.docu_faq.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Docu Faq)', 'wbfsys.docu_faq.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.docu_faq.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Docu Faq)', 'wbfsys.docu_faq.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.docu_faq.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Docu Faq)', 'wbfsys.docu_faq.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.docu_faq.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Docu Faq)', 'wbfsys.docu_faq.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.docu_faq.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Docu Faq)', 'wbfsys.docu_faq.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.docu_faq.label' ),
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the search element for field question
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_question( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Question (Docu Faq)', 'wbfsys.docu_faq.label' ),
          'maxlength' => $this->entity->maxSize( 'question' ),
        )
      );
      $inputQuestion->setWidth( 'xxlarge' );
  ...
  }//end public function search_question */

 /**
  * create the search element for field answer
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_answer( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Answer (Docu Faq)', 'wbfsys.docu_faq.label' ),
        )
      );
      $inputAnswer->setWidth( 'full' );
  ...
  }//end public function search_answer */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_docu_faq_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_docu_faq_m_role_change';
