 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysDocuTree
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysDocuTree_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysDocuTree_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysDocuTree_Acl_Model */
    $model   = $this->loadModel( 'WbfsysDocuTree_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_docu_tree-acl',
    	'WbfsysDocuTree_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_docu_tree_acl_masks_listing',
      'WbfsysDocuTree_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysDocuTree_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysDocuTree_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysDocuTree_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysDocuTree_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysDocuTree_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysDocuTree_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_docu_tree-acl-qfdu',
    	'WbfsysDocuTree_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysDocuTree_Acl_Controller */
