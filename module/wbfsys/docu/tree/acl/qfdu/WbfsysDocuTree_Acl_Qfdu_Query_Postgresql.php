 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_docu_tree.title) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_docu_tree.rowid as id,
    wbfsys_docu_tree.title as value,
    wbfsys_docu_tree.title as label
  FROM
    wbfsys_docu_tree
  WHERE
    {$sqlWhere}
...
} // end class WbfsysDocuTree_Acl_Qfdu_Query_Postgresql */
