 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_docu_tree')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysDocuTree = $orm->get('WbfsysDocuTree', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_docu_tree_title']  = $refEntityWbfsysDocuTree->title;
      $tabData['wbfsys_docu_tree_short_desc']  = $refEntityWbfsysDocuTree->short_desc;

    }
    $tabData['wbfsys_docu_tree_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysDocuTree_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocuTree_Acl' );
    /* @var $query WbfsysDocuTree_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocuTree_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysDocuTree_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocuTree_Acl_Qfdu' );
    /* @var $query WbfsysDocuTree_Acl_Qfdu_Query  */
...
} // end class WbfsysDocuTree_Acl_Qfdu_Model */
