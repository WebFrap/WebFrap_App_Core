 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_docu_tree.title as "wbfsys_docu_tree_title"',
      'wbfsys_docu_tree.short_desc as "wbfsys_docu_tree_short_desc"',
      'wbfsys_docu_tree.rowid as "wbfsys_docu_tree_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_docu_tree on wbfsys_group_users.vid = wbfsys_docu_tree.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_docu_tree.title) like upper(\''.$part.'%\') )
            OR 
            (  upper(wbfsys_docu_tree.short_desc) like upper(\''.$part.'%\') )
...
} // end class WbfsysDocuTree_Acl_Qfdu_Treetable_Query_Postgresql */
