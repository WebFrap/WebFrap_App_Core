 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysDocuTree_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_docu_tree-acl-qfdu-aAjax',
      'WbfsysDocuTree_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysDocuTree_Acl_Qfdu_Controller */
