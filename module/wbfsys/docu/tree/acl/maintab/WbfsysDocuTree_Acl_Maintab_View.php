 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DocuTree_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_docu_tree-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.DocuTree_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_docu_tree-acl-update';
    ...
    $this->setTemplate( 'wbfsys/docu_tree/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Docu Tree', 'wbfsys.docu_tree.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_docu_tree_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysDocuTree_Acl' );
...
} // end class WbfsysDocuTree_Acl_Maintab_View */
