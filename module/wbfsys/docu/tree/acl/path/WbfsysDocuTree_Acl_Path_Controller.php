 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_docu_tree_acl_graph', 
      'WbfsysDocuTree_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysDocuTree_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysDocuTree_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysDocuTree_Acl_Path_Maintab_View  */
...
} // end class WbfsysDocuTree_Acl_Path_Controller */
