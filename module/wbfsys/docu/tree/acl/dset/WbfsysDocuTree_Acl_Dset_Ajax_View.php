 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysDocuTree_Acl_Dset' );
    ...
    $entityWbfsysDocuTree = $this->model->getEntity( $dsetId );
...
} // end class WbfsysDocuTree_Acl_Dset_Ajax_View */
