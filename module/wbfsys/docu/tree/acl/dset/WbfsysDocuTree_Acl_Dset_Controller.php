 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysDocuTree_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysDocuTree_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysDocuTree = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDocuTree_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_docu_tree-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysDocuTree, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDocuTree_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_docu_tree-acl-dset', 
    	'WbfsysDocuTree_Acl_Dset',
...
} // end class WbfsysDocuTree_Acl_Dset_Controller */
