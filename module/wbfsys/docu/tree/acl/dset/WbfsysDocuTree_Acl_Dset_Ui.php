 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysDocuTree_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysDocuTree_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysDocuTree, $areaId, $access, $params  )
  {

    $listObj = new WbfsysDocuTree_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_docu_tree-acl-dset' );
    ...
    else
    {
      ...
      (
        'Docu Tree "{@label@}" User Access',
        'wbfsys.docu_tree.label',
        array
        (
          'label' => $entityWbfsysDocuTree->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_docu_tree_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysDocuTree_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysDocuTree_Acl_Dset_Ui */
