 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_docu_tree'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysDocuTree', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocuTree_Acl_Dset' );
    /* @var $query WbfsysDocuTree_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDocuTree_Acl_Dset_Treetable' );
    /* @var $query WbfsysDocuTree_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysDocuTree_Acl_Dset_Model */
