...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysDocuTree_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuTree_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_docu_tree-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Docu Tree', 'wbfsys.docu_tree.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_docu_tree_acl';
...
} // end class WbfsysDocuTree_Acl_Ui */
