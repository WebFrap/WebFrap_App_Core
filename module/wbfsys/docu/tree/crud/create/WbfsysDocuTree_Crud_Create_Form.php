 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysDocuTree_MParent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDocuTree_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.DocuTree.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDocuTree', array_keys( $this->fields['wbfsys_docu_tree']), true ),
...
}//end class WbfsysDocuTree_Crud_Create_Form */
