 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocuTree entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DocuTree.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocuTree.insert';
    $params->formId       = 'wgt-form-wbfsys_docu_tree';
    $params->namespace   = 'wbfsys_docu_tree-create';
    ...
    $this->setTemplate( 'wbfsys/docu_tree/modal/crud/form_create' );
...
}//end class WbfsysDocuTree_Crud_Create_Modal_View
