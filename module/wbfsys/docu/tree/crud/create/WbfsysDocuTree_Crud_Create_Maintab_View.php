 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDocuTree Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_docu_tree-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/docu_tree/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocuTree.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_docu_tree';
    ...
    $form = $this->newForm( 'WbfsysDocuTree_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.DocuTree.create');}});
});
...
}//end class WbfsysDocuTree_Crud_Create_Maintab_View
