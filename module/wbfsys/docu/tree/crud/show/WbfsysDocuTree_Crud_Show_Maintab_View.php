 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDocuTree Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuTree = $this->model->getEntityWbfsysDocuTree();
    ...
    (
      ...
      array( 'text' => $entityWbfsysDocuTree->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuTree.show  &amp;objid='.$entityWbfsysDocuTree
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuTree.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_tree-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_tree/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDocuTree_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DocuTree.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_tree' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_tree a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DocuTree.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DocuTree.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDocuTree_Crud_Show_Maintab_View
