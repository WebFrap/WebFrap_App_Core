 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocuTree Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuTree = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuTree.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocuTree
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuTree.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_tree-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_tree/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocuTree_Crud_Edit' );
...
}//end class WbfsysDocuTree_Crud_Edit_Maintab_View
