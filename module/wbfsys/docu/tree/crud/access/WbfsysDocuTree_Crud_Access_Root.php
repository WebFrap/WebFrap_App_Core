 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDocuTree_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDocuTree_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDocuTree_Entity */
      $entity = $orm->get( 'WbfsysDocuTree', $rootId );
    }
...
}//end class WbfsysDocuTree_Crud_Access_Root
