 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysDocuTree_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysDocuTree_Export_Listing_Access';
    ...
    // create a new WbfsysDocuTree window
    $view = $this->loadView
    (
    	'export-wbfsys_docu_tree',
    	'WbfsysDocuTree_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysDocuTree_Export' );
...
} // end class WbfsysDocuTree_Export_Controller_Genf
