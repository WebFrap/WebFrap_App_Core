 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocuTree_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocuTree_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuTree_Selection_Element
    (
      'selectionWbfsysDocuTree',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Docu Trees', 'wbfsys.docu_tree.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DocuTree.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDocuTree',
      'WbfsysDocuTree_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocuTree_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocuTree_Selection_Ui
