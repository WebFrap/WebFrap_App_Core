 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysDocuTree_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysDocuTree_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysDocuTree_Table_Model
