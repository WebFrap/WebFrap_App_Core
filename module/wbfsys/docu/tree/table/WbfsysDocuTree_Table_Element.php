 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_docu_tree';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDocuTree_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocuTree.show&amp;target_mask=WbfsysDocuTree&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocuTree.edit&amp;target_mask=WbfsysDocuTree&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.docu_tree.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocuTree.delete&amp;target_mask=WbfsysDocuTree&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.docu_tree.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.docu_tree.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Short Description', 'wbfsys.docu_tree.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_docu_tree_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DocuTree_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Docu Trees." >{$iconDelete} Delete selected Docu Trees</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Docu Trees. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DocuTree_Multi.deleteAll" >{$iconClean} Delete all Docu Trees</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDocuTree_Table_Element
