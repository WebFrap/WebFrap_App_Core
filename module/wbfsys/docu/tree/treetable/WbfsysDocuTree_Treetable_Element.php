 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_docu_tree';
   ...
   *
   * @var WbfsysDocuTree_Treetable_Query
   */
  public $data       = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocuTree.show&amp;ltype=treetable&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocuTree.edit&amp;ltype=treetable&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.docu_tree.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocuTree.delete&amp;ltype=treetable&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.docu_tree.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildAjaxTbody( $row  )
  {
    ...
    if( $this->insertMode )
    {
      ...
      if( $row['wbfsys_docu_tree_m_parent'] )
      {
        $pClass = 'child-of-'.$this->id.'_row_'.$row['wbfsys_docu_tree_m_parent'];
        $body = '<htmlArea selector="tr#'.$this->id.'_row_'
          .$row['wbfsys_docu_tree_m_parent'].'" action="after" >'
          .'<![CDATA[<tr id="'.$rowid.'" '
          .' wgt_context_menu="'.$this->id.'-cmenu" '
          .' wgt_eid="'.$objid.'" ' 
          .$rowParams
    ...
    if( $row['wbfsys_docu_tree_m_parent'] )
    {
      $prePos = $row['wbfsys_docu_tree_m_parent'].'.';
    }
    else
    {
      $prePos = '';
    ...
    if( !$this->appendMode && $row['wbfsys_docu_tree_m_parent'] )
    {
      $parentId = $this->id.'_row_'.$row['wbfsys_docu_tree_m_parent'];
...
HTML;
  ...
  protected function buildJavascript()
  {
    ...
    \$S('#{$this->id}').data('func_add',function( objid ){
      \$R.post('maintab.php?c=Wbfsys.DocuTree.create&amp;ltype=treetable',{"wbfsys_docu_tree[m_parent]":objid});
    });
...
}//end class WbfsysDocuTree_Treetable_Element
