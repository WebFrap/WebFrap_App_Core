 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysDocuTree_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysDocuTree_Treetable_Element
    (
      'treetableWbfsysDocuTree',
      $view
    );
...
WGTJS;
   ...
   *
   * @return WbfsysDocuTree_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocuTree', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysDocuTree_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocuTree_Treetable_Ui
