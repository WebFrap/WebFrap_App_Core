 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysDocuTree_Treeable_Model
    */
    public $model = null;

    /**
    * @var WbfsysDocuTree_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/docu_tree/maintab/treetable/listing' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Treetable Docu Trees',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.DocuTree.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DocuTree.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-wbfsys_docu_tree-search';
...
BUTTONJS;
    ...
    ///@var WbfsysDocuTree_Treetable_Ui
    $ui = $this->loadUi( 'WbfsysDocuTree_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var WbfsysDocuTree_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'WbfsysDocuTree_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DocuTree.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.DocuTree.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.DocuTree.listing&amp;ltype=treetable');
    });
...
}//end class WbfsysDocuTree_Treetable_Maintab_View
