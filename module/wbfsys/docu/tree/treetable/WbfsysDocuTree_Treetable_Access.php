 ...
 * @licence WebFrap.net
 */
class WbfsysDocuTree_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDocuTree_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_docu_tree') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_docu_tree.rowid ",
      'acls'
    );
...
}//end class WbfsysDocuTree_Treetable_Access
