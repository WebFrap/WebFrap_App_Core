 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDocuHelp Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuHelp = $this->model->getEntityWbfsysDocuHelp();
    ...
    (
      ...
      array( 'text' => $entityWbfsysDocuHelp->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuHelp.show  &amp;objid='.$entityWbfsysDocuHelp
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuHelp.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_help-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_help/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDocuHelp_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DocuHelp.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_help' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_docu_help a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DocuHelp.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DocuHelp.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDocuHelp_Crud_Show_Maintab_View
