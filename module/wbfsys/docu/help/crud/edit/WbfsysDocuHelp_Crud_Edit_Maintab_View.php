 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDocuHelp Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDocuHelp = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DocuHelp.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDocuHelp
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DocuHelp.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_docu_help-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/docu_help/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDocuHelp_Crud_Edit' );
...
}//end class WbfsysDocuHelp_Crud_Edit_Maintab_View
