 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDocuHelp Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_docu_help-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/docu_help/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocuHelp.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_docu_help';
    ...
    $form = $this->newForm( 'WbfsysDocuHelp_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.DocuHelp.create');}});
});
...
}//end class WbfsysDocuHelp_Crud_Create_Maintab_View
