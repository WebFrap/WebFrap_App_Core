 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDocuHelp entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DocuHelp.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DocuHelp.insert';
    $params->formId       = 'wgt-form-wbfsys_docu_help';
    $params->namespace   = 'wbfsys_docu_help-create';
    ...
    $this->setTemplate( 'wbfsys/docu_help/modal/crud/form_create' );
...
}//end class WbfsysDocuHelp_Crud_Create_Modal_View
