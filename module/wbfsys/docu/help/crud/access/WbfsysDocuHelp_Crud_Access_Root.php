 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDocuHelp_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDocuHelp_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDocuHelp_Entity */
      $entity = $orm->get( 'WbfsysDocuHelp', $rootId );
    }
...
}//end class WbfsysDocuHelp_Crud_Access_Root
