...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Helps
  *
  ...
  *  }
  *
  * @return WbfsysDocuHelp_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuHelp_Table_Element( 'tableWbfsysDocuHelp', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_docu_help-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Helps', 'wbfsys.docu_help.label' );
      //$tabPanel->searchKey = 'wbfsys_docu_help';
      ...
      $searchElement->searchKey = 'wbfsys_docu_help';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDocuHelp_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDocuHelp', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDocuHelp listing maske
   *
   * @param WbfsysDocuHelp_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDocuHelp  = $model->getEntityWbfsysDocuHelp();
    ...
    $formWbfsysDocuHelp->setKeyName( 'wbfsys_docu_help' );
...
}//end class WbfsysDocuHelp_Table_Ui
