 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_docu_help';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDocuHelp_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DocuHelp.show&amp;target_mask=WbfsysDocuHelp&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DocuHelp.edit&amp;target_mask=WbfsysDocuHelp&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.docu_help.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DocuHelp.delete&amp;target_mask=WbfsysDocuHelp&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.docu_help.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.docu_help.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_docu_help_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_docu_help_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DocuHelp_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Helps." >{$iconDelete} Delete selected Helps</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Helps. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DocuHelp_Multi.deleteAll" >{$iconClean} Delete all Helps</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDocuHelp_Table_Element
