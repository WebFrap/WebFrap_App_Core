 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDocuHelp_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDocuHelp_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDocuHelp_Selection_Element
    (
      'selectionWbfsysDocuHelp',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Helps', 'wbfsys.docu_help.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DocuHelp.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDocuHelp',
      'WbfsysDocuHelp_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDocuHelp_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDocuHelp_Selection_Ui
