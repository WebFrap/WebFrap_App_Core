 ...
 * @licence WebFrap.net
 */
class WbfsysDocuHelp_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDocuHelp_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_docu_help.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_docu_help.rowid ",
      'acls'
    );
...
}//end class WbfsysDocuHelp_Selection_Access
