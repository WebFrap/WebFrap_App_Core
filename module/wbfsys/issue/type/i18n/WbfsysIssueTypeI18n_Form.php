 ...
 * @licence WebFrap.net
 */
class WbfsysIssueTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_issue_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysIssueTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysIssueTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysIssueTypeI18n';
   ...
   *
   * @var WbfsysIssueTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysIssueTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysIssueTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysIssueTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.issue_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_issue_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_issue_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysIssueType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysIssueType not exists' );

      Log::warn('Looks like the Entity: WbfsysIssueType is missing');
      ...
      //p: Window
      $objidWbfsysIssueType = $this->entity->getData('id_wbfsys_issue_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysIssueType
          || !$entityWbfsysIssueType = $this->db->orm->get
          (
            'WbfsysIssueType',
            $objidWbfsysIssueType
          )
      ...
      {
        $entityWbfsysIssueType = $this->db->orm->newEntity( 'WbfsysIssueType' );
      }

      $inputIdWbfsysIssueType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysIssueType', 'Window' );
      $inputIdWbfsysIssueType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_issue_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_issue_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Issue Type (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysIssueType->assignedForm = $this->assignedForm;

      $inputIdWbfsysIssueType->setWidth( 'medium' );

      $inputIdWbfsysIssueType->setData( $this->entity->getData( 'id_wbfsys_issue_type' )  );
      $inputIdWbfsysIssueType->setReadOnly( $this->isReadOnly( 'id_wbfsys_issue_type' ) );
      $inputIdWbfsysIssueType->setLabel( $this->view->i18n->l( 'Wbfsys Issue Type', 'wbfsys.issue_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.IssueType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_issue_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysIssueType->setListUrl ( $listUrl );
      $inputIdWbfsysIssueType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysIssueType->setEntityUrl( 'maintab.php?c=Wbfsys.IssueType.edit' );
      $inputIdWbfsysIssueType->conEntity         = $entityWbfsysIssueType;
      $inputIdWbfsysIssueType->refresh           = $this->refresh;
      $inputIdWbfsysIssueType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysIssueType->view = $this->view;
      $inputIdWbfsysIssueType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_issue_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysIssueType );
  ...
  }//end public function input_id_wbfsys_issue_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.issue_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.issue_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.issue_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.issue_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.issue_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.issue_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.issue_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.issue_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.issue_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Issue Type I18n)', 'wbfsys.issue_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_issue_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_issue_type_i18n_m_role_change';
...
}//end class WbfsysIssueTypeI18n_Form */
