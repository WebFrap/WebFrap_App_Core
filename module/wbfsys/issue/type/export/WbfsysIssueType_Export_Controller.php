 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysIssueType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysIssueType_Export_Listing_Access';
    ...
    // create a new WbfsysIssueType window
    $view = $this->loadView
    (
    	'export-wbfsys_issue_type',
    	'WbfsysIssueType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysIssueType_Export' );
...
} // end class WbfsysIssueType_Export_Controller_Genf
