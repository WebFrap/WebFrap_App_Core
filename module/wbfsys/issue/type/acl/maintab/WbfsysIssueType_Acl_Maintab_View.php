 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.IssueType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.IssueType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_issue_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/issue_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'issue Type', 'wbfsys.issue_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_issue_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysIssueType_Acl' );
...
} // end class WbfsysIssueType_Acl_Maintab_View */
