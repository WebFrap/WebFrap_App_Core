...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysIssueType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_issue_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'issue Type', 'wbfsys.issue_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_issue_type_acl';
...
} // end class WbfsysIssueType_Acl_Ui */
