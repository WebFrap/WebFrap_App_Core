 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysIssueType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysIssueType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysIssueType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysIssueType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_issue_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'issue Type "{@label@}" User Access',
        'wbfsys.issue_type.label',
        array
        (
          'label' => $entityWbfsysIssueType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_issue_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysIssueType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysIssueType_Acl_Dset_Ui */
