 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysIssueType_Acl_Dset' );
    ...
    $entityWbfsysIssueType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysIssueType_Acl_Dset_Ajax_View */
