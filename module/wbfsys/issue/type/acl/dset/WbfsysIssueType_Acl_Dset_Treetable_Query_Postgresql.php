 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_issue_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysIssueType_Acl_Dset_Treetable_Query_Postgresql */
