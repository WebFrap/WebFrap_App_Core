 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_issue_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysIssueType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueType_Acl_Dset' );
    /* @var $query WbfsysIssueType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueType_Acl_Dset_Treetable' );
    /* @var $query WbfsysIssueType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysIssueType_Acl_Dset_Model */
