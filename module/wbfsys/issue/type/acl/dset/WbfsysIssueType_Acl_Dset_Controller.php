 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysIssueType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysIssueType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssueType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_issue_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysIssueType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssueType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_issue_type-acl-dset', 
    	'WbfsysIssueType_Acl_Dset',
...
} // end class WbfsysIssueType_Acl_Dset_Controller */
