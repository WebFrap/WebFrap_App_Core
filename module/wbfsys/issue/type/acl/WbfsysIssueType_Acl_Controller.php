 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysIssueType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysIssueType_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysIssueType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysIssueType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_issue_type-acl',
    	'WbfsysIssueType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_issue_type_acl_masks_listing',
      'WbfsysIssueType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysIssueType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysIssueType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysIssueType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysIssueType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysIssueType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_issue_type-acl-qfdu',
    	'WbfsysIssueType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysIssueType_Acl_Controller */
