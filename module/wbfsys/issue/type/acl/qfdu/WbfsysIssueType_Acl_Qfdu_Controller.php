 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysIssueType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_issue_type-acl-qfdu-aAjax',
      'WbfsysIssueType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysIssueType_Acl_Qfdu_Controller */
