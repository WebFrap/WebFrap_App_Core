 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_issue_type.name as "wbfsys_issue_type_name"',
      'wbfsys_issue_type.rowid as "wbfsys_issue_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_issue_type on wbfsys_group_users.vid = wbfsys_issue_type.rowid'
    );
...
} // end class WbfsysIssueType_Acl_Qfdu_Treetable_Query_Postgresql */
