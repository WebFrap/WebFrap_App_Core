 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_issue_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_issue_type.rowid as id,
    wbfsys_issue_type.name as value,
    wbfsys_issue_type.name as label
  FROM
    wbfsys_issue_type
  WHERE
    {$sqlWhere}
...
} // end class WbfsysIssueType_Acl_Qfdu_Query_Postgresql */
