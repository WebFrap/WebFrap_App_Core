 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_issue_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysIssueType = $orm->get('WbfsysIssueType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_issue_type_name']  = $refEntityWbfsysIssueType->name;

    }
    $tabData['wbfsys_issue_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysIssueType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueType_Acl' );
    /* @var $query WbfsysIssueType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysIssueType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueType_Acl_Qfdu' );
    /* @var $query WbfsysIssueType_Acl_Qfdu_Query  */
...
} // end class WbfsysIssueType_Acl_Qfdu_Model */
