 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysIssueType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_issue_type.rowid as id',
      'wbfsys_issue_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_issue_type.m_order as "wbfsys_issue_type-m_order-order"' );

    $criteria->from( 'wbfsys_issue_type' );



      $criteria->orderBy( 'wbfsys_issue_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_issue_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_issue_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysIssueType_Selectbox_Query_Postgresql
