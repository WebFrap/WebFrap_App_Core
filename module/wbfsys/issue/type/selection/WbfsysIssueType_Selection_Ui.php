 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysIssueType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysIssueType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueType_Selection_Element
    (
      'selectionWbfsysIssueType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection issue Types', 'wbfsys.issue_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.IssueType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysIssueType',
      'WbfsysIssueType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysIssueType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysIssueType_Selection_Ui
