 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für issue Types
  *
  ...
  *  }
  *
  * @return WbfsysIssueType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueType_Table_Element( 'tableWbfsysIssueType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'issue Types', 'wbfsys.issue_type.label' );
      //$tabPanel->searchKey = 'wbfsys_issue_type';
      ...
      $searchElement->searchKey = 'wbfsys_issue_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysIssueType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysIssueType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysIssueType listing maske
   *
   * @param WbfsysIssueType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysIssueType  = $model->getEntityWbfsysIssueType();
    ...
    $formWbfsysIssueType->setKeyName( 'wbfsys_issue_type' );
...
}//end class WbfsysIssueType_Table_Ui
