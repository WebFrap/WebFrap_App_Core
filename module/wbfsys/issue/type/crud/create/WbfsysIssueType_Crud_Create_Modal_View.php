 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysIssueType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.IssueType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.IssueType.insert';
    $params->formId       = 'wgt-form-wbfsys_issue_type';
    $params->namespace   = 'wbfsys_issue_type-create';
    ...
    $this->setTemplate( 'wbfsys/issue_type/modal/crud/form_create' );
...
}//end class WbfsysIssueType_Crud_Create_Modal_View
