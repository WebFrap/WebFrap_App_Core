 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysIssueType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIssueType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit issue Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.IssueType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysIssueType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.IssueType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_issue_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/issue_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysIssueType_Crud_Edit' );
...
}//end class WbfsysIssueType_Crud_Edit_Maintab_View
