 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysIssueType_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysIssueType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIssueType = $this->model->getEntityWbfsysIssueType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show issue Type: {@text@}',
      'wbfsys.issue_type.label',
      array( 'text' => $entityWbfsysIssueType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.IssueType.show  &amp;objid='.$entityWbfsysIssueType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.IssueType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_issue_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/issue_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysIssueType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.IssueType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_issue_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_issue_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.IssueType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.IssueType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysIssueType_Crud_Show_Maintab_View
