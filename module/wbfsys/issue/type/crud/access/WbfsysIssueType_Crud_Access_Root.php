 ...
 * @licence WebFrap.net
 */
class WbfsysIssueType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysIssueType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysIssueType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysIssueType_Entity */
      $entity = $orm->get( 'WbfsysIssueType', $rootId );
    }
...
}//end class WbfsysIssueType_Crud_Access_Root
