 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysIssueSeverity_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueSeverity_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_issue_severity-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'issue severity', 'wbfsys.issue_severity.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_issue_severity_acl';
...
} // end class WbfsysIssueSeverity_Acl_Ui */
