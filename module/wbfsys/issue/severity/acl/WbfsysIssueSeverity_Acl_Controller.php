 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysIssueSeverity
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysIssueSeverity_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_issue_severity_acl_listing',
      'WbfsysIssueSeverity_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysIssueSeverity_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueSeverity_Acl_Model */
    $model   = $this->loadModel( 'WbfsysIssueSeverity_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_issue_severity-acl',
    	'WbfsysIssueSeverity_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_issue_severity_acl_masks_listing',
      'WbfsysIssueSeverity_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysIssueSeverity_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysIssueSeverity_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueSeverity_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysIssueSeverity_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysIssueSeverity_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysIssueSeverity_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_issue_severity-acl-qfdu',
    	'WbfsysIssueSeverity_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysIssueSeverity_Acl_Controller */
