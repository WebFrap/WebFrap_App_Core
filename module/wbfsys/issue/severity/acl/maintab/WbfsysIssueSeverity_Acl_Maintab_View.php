 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysIssueSeverity_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.IssueSeverity_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue_severity-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.IssueSeverity_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_issue_severity-acl-update';
    ...
    $this->setTemplate( 'wbfsys/issue_severity/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'issue severity', 'wbfsys.issue_severity.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_issue_severity_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysIssueSeverity_Acl' );
...
} // end class WbfsysIssueSeverity_Acl_Maintab_View */
