 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysIssueSeverity_Acl_Dset' );
    ...
    $entityWbfsysIssueSeverity = $this->model->getEntity( $dsetId );
...
} // end class WbfsysIssueSeverity_Acl_Dset_Ajax_View */
