 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_issue_severity'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysIssueSeverity', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueSeverity_Acl_Dset' );
    /* @var $query WbfsysIssueSeverity_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueSeverity_Acl_Dset_Treetable' );
    /* @var $query WbfsysIssueSeverity_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysIssueSeverity_Acl_Dset_Model */
