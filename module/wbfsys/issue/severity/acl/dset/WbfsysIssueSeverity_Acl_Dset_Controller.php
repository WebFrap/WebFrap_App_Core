 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueSeverity_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysIssueSeverity_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysIssueSeverity = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssueSeverity_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_issue_severity-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysIssueSeverity, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_issue_severity-acl-dset', 
    	'WbfsysIssueSeverity_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssueSeverity_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_issue_severity-acl-dset', 
    	'WbfsysIssueSeverity_Acl_Dset',
...
} // end class WbfsysIssueSeverity_Acl_Dset_Controller */
