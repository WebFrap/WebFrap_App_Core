 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_issue_severity.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysIssueSeverity_Acl_Dset_Treetable_Query_Postgresql */
