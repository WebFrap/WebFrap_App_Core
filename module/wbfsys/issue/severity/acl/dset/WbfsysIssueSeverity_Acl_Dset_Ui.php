 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysIssueSeverity_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysIssueSeverity_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysIssueSeverity, $areaId, $access, $params  )
  {

    $listObj = new WbfsysIssueSeverity_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_issue_severity-acl-dset' );
    ...
    else
    {
      ...
      (
        'issue severity "{@label@}" User Access',
        'wbfsys.issue_severity.label',
        array
        (
          'label' => $entityWbfsysIssueSeverity->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_issue_severity_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysIssueSeverity_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysIssueSeverity_Acl_Dset_Ui */
