 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_issue_severity_acl_graph', 
      'WbfsysIssueSeverity_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysIssueSeverity_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysIssueSeverity_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysIssueSeverity_Acl_Path_Maintab_View  */
...
} // end class WbfsysIssueSeverity_Acl_Path_Controller */
