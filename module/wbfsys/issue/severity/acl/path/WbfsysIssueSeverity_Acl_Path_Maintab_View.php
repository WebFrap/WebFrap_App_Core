 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/issue_severity/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_issue_severity-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_issue_severity-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysIssueSeverity_Acl_Path_Maintab_View */
