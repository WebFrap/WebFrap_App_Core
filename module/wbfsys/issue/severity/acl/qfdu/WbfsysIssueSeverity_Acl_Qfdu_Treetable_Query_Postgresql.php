 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_issue_severity.name as "wbfsys_issue_severity_name"',
      'wbfsys_issue_severity.rowid as "wbfsys_issue_severity_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_issue_severity on wbfsys_group_users.vid = wbfsys_issue_severity.rowid'
    );
...
} // end class WbfsysIssueSeverity_Acl_Qfdu_Treetable_Query_Postgresql */
