 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_issue_severity')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysIssueSeverity = $orm->get('WbfsysIssueSeverity', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_issue_severity_name']  = $refEntityWbfsysIssueSeverity->name;

    }
    $tabData['wbfsys_issue_severity_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysIssueSeverity_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueSeverity_Acl' );
    /* @var $query WbfsysIssueSeverity_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueSeverity_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysIssueSeverity_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssueSeverity_Acl_Qfdu' );
    /* @var $query WbfsysIssueSeverity_Acl_Qfdu_Query  */
...
} // end class WbfsysIssueSeverity_Acl_Qfdu_Model */
