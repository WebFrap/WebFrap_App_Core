 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysIssueSeverity_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_issue_severity-acl-qfdu-aAjax',
      'WbfsysIssueSeverity_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysIssueSeverity_Acl_Qfdu_Controller */
