 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_issue_severity.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_issue_severity.rowid as id,
    wbfsys_issue_severity.name as value,
    wbfsys_issue_severity.name as label
  FROM
...
} // end class WbfsysIssueSeverity_Acl_Qfdu_Query_Postgresql */
