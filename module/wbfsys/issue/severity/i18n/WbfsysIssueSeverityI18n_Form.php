 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverityI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_issue_severity_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysIssueSeverityI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysIssueSeverityI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysIssueSeverityI18n';
   ...
   *
   * @var WbfsysIssueSeverityI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysIssueSeverityI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysIssueSeverityI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysIssueSeverityI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.issue_severity_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_issue_severity
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_issue_severity( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysIssueSeverity_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysIssueSeverity not exists' );

      Log::warn('Looks like the Entity: WbfsysIssueSeverity is missing');
      ...
      //p: Window
      $objidWbfsysIssueSeverity = $this->entity->getData('id_wbfsys_issue_severity') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysIssueSeverity
          || !$entityWbfsysIssueSeverity = $this->db->orm->get
          (
            'WbfsysIssueSeverity',
            $objidWbfsysIssueSeverity
          )
      ...
      {
        $entityWbfsysIssueSeverity = $this->db->orm->newEntity( 'WbfsysIssueSeverity' );
      }

      $inputIdWbfsysIssueSeverity = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysIssueSeverity', 'Window' );
      $inputIdWbfsysIssueSeverity->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_issue_severity]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_issue_severity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Issue Severity (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysIssueSeverity->assignedForm = $this->assignedForm;

      $inputIdWbfsysIssueSeverity->setWidth( 'medium' );

      $inputIdWbfsysIssueSeverity->setData( $this->entity->getData( 'id_wbfsys_issue_severity' )  );
      $inputIdWbfsysIssueSeverity->setReadOnly( $this->isReadOnly( 'id_wbfsys_issue_severity' ) );
      $inputIdWbfsysIssueSeverity->setLabel( $this->view->i18n->l( 'Wbfsys Issue Severity', 'wbfsys.issue_severity_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.IssueSeverity.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_issue_severity'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysIssueSeverity->setListUrl ( $listUrl );
      $inputIdWbfsysIssueSeverity->setListIcon( 'control/connect.png' );
      $inputIdWbfsysIssueSeverity->setEntityUrl( 'maintab.php?c=Wbfsys.IssueSeverity.edit' );
      $inputIdWbfsysIssueSeverity->conEntity         = $entityWbfsysIssueSeverity;
      $inputIdWbfsysIssueSeverity->refresh           = $this->refresh;
      $inputIdWbfsysIssueSeverity->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysIssueSeverity->view = $this->view;
      $inputIdWbfsysIssueSeverity->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_issue_severity'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysIssueSeverity );
  ...
  }//end public function input_id_wbfsys_issue_severity */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.issue_severity_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.issue_severity_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.issue_severity_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.issue_severity_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.issue_severity_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.issue_severity_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.issue_severity_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.issue_severity_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.issue_severity_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Issue Severity I18n)', 'wbfsys.issue_severity_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_issue_severity_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_issue_severity_i18n_m_role_change';
...
}//end class WbfsysIssueSeverityI18n_Form */
