 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_issue_severity
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.IssueSeverity.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_issue_severity-create';

    $access = new WbfsysIssueSeverity_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_issue_severity-create',
      'WbfsysIssueSeverity_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysIssueSeverity_Crud_Model */
    $model = $this->loadModel( 'WbfsysIssueSeverity_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.IssueSeverity.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysIssueSeverity = $model->getEntityWbfsysIssueSeverity( $objid );
    ...
    $params->entity = $entityWbfsysIssueSeverity;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_issue_severity:edit';

    $access = new WbfsysIssueSeverity_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysIssueSeverity );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_issue_severity-edit-'.$objid,
      'WbfsysIssueSeverity_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_issue_severity-edit',
          $entityWbfsysIssueSeverity,
          'Edit issue severity :'.$entityWbfsysIssueSeverity->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_issue_severity';
      $params->maskRoot      = 'wbfsys_issue_severity:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_issue_severity';
      $params->aclNode       = 'mgmt-wbfsys_issue_severity';
      $params->aclLevel      = 1;
    }
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_issue_severity-show',
          $entityWbfsysIssueSeverity,
          'Show issue severity :'.$entityWbfsysIssueSeverity->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_issue_severity
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.IssueSeverity.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-insert';

    $access = new WbfsysIssueSeverity_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysIssueSeverity = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_issue_severity-update-'.$entityWbfsysIssueSeverity;
      ...
      {
        $access = new WbfsysIssueSeverity_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysIssueSeverity );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysIssueSeverity';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_issue_severity',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysIssueSeverity_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.IssueSeverity.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysIssueSeverity, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysIssueSeverity_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.IssueSeverity.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-delete-'.$objid;

    $access = new WbfsysIssueSeverity_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysIssueSeverity );
    ...
    $error = $model->delete( $entityWbfsysIssueSeverity, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysIssueSeverity, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.IssueSeverity.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.IssueSeverity.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-listing';
    ...
    $containerClass = 'WbfsysIssueSeverity_'.$listType.'_Access';
    ...
    /* @var $model WbfsysIssueSeverity_Table_Model */
    $model = $this->loadModel( 'WbfsysIssueSeverity_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_issue_severity-'.$params->ltype,
          'WbfsysIssueSeverity',
          'List of issue severitys'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysIssueSeverity
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysIssueSeverity_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_issue_severity',
      'WbfsysIssueSeverity_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysIssueSeverity_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.IssueSeverity.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysIssueSeverity_Selection_Model */
    $model   = $this->loadModel( 'WbfsysIssueSeverity_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_issue_severity-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_issue_severity-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_issue_severity',
      'WbfsysIssueSeverity',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysIssueSeverity, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysIssueSeverity_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysIssueSeverity_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue_severity-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_issue_severity' );
...
} // end class WbfsysIssueSeverity_Controller */
