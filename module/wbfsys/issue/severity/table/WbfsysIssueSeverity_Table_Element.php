 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_issue_severity';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.IssueSeverity.show&amp;target_mask=WbfsysIssueSeverity&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.IssueSeverity.edit&amp;target_mask=WbfsysIssueSeverity&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.issue_severity.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.IssueSeverity.delete&amp;target_mask=WbfsysIssueSeverity&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.issue_severity.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.IssueSeverity.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_issue_severity_name'])).'</a></td>'.NL;
...
}//end class WbfsysIssueSeverity_Table_Element
