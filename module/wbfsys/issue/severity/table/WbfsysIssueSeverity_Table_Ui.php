 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für issue severitys
  *
  ...
  *  }
  *
  * @return WbfsysIssueSeverity_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueSeverity_Table_Element( 'tableWbfsysIssueSeverity', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue_severity-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'issue severitys', 'wbfsys.issue_severity.label' );
      //$tabPanel->searchKey = 'wbfsys_issue_severity';
      ...
      $searchElement->searchKey = 'wbfsys_issue_severity';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysIssueSeverity_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysIssueSeverity', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysIssueSeverity listing maske
   *
   * @param WbfsysIssueSeverity_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysIssueSeverity  = $model->getEntityWbfsysIssueSeverity();
    ...
    $formWbfsysIssueSeverity->setKeyName( 'wbfsys_issue_severity' );
...
}//end class WbfsysIssueSeverity_Table_Ui
