 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysIssueSeverity Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_issue_severity.rowid as id',
      'wbfsys_issue_severity.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_issue_severity.m_order as "wbfsys_issue_severity-m_order-order"' );

    $criteria->from( 'wbfsys_issue_severity' );



      $criteria->orderBy( 'wbfsys_issue_severity.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_issue_severity.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_issue_severity.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysIssueSeverity_Selectbox_Query_Postgresql
