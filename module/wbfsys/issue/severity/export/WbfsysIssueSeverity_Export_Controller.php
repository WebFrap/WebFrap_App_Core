 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysIssueSeverity_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysIssueSeverity_Export_Listing_Access';
    ...
    // create a new WbfsysIssueSeverity window
    $view = $this->loadView
    (
    	'export-wbfsys_issue_severity',
    	'WbfsysIssueSeverity_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysIssueSeverity_Export' );
...
} // end class WbfsysIssueSeverity_Export_Controller_Genf
