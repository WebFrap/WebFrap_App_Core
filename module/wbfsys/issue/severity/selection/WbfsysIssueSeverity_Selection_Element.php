 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_issue_severity';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysIssueSeverity_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.IssueSeverity.show&amp;target_mask=WbfsysIssueSeverity&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.IssueSeverity.edit&amp;target_mask=WbfsysIssueSeverity&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.issue_severity.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.IssueSeverity.delete&amp;target_mask=WbfsysIssueSeverity&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.issue_severity.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_issue_severity&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.issue_severity.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.IssueSeverity.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.issue_severity.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.issue_severity.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_issue_severity_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_issue_severity_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_issue_severity_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.IssueSeverity_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected issue severitys." >{$iconDelete} Delete selected issue severitys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! issue severitys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.IssueSeverity_Multi.deleteAll" >{$iconClean} Delete all issue severitys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysIssueSeverity_Selection_Element
