 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysIssueSeverity_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysIssueSeverity_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssueSeverity_Selection_Element
    (
      'selectionWbfsysIssueSeverity',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection issue severitys', 'wbfsys.issue_severity.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.IssueSeverity.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysIssueSeverity',
      'WbfsysIssueSeverity_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysIssueSeverity_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysIssueSeverity_Selection_Ui
