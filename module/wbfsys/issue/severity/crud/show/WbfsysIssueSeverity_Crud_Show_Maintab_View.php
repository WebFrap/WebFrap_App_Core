 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysIssueSeverity Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIssueSeverity = $this->model->getEntityWbfsysIssueSeverity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show issue severity: {@text@}',
      'wbfsys.issue_severity.label',
      array( 'text' => $entityWbfsysIssueSeverity->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.IssueSeverity.show  &amp;objid='.$entityWbfsysIssueSeverity
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.IssueSeverity.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_issue_severity-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/issue_severity/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysIssueSeverity_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.IssueSeverity.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_issue_severity' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_issue_severity a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.IssueSeverity.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.IssueSeverity.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysIssueSeverity_Crud_Show_Maintab_View
