 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysIssueSeverity entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.IssueSeverity.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.IssueSeverity.insert';
    $params->formId       = 'wgt-form-wbfsys_issue_severity';
    $params->namespace   = 'wbfsys_issue_severity-create';
    ...
    $this->setTemplate( 'wbfsys/issue_severity/modal/crud/form_create' );
...
}//end class WbfsysIssueSeverity_Crud_Create_Modal_View
