 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysIssueSeverity Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_issue_severity-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/issue_severity/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.IssueSeverity.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_issue_severity';
    ...
    $form = $this->newForm( 'WbfsysIssueSeverity_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.IssueSeverity.create');}});
});
...
}//end class WbfsysIssueSeverity_Crud_Create_Maintab_View
