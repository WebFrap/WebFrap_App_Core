 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysIssueSeverity Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIssueSeverity = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit issue severity: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.IssueSeverity.edit&amp;utf8=✓&amp;objid='.$entityWbfsysIssueSeverity
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.IssueSeverity.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_issue_severity-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/issue_severity/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysIssueSeverity_Crud_Edit' );
...
}//end class WbfsysIssueSeverity_Crud_Edit_Maintab_View
