 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysIssueSeverity_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysIssueSeverity_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysIssueSeverity_Entity */
      $entity = $orm->get( 'WbfsysIssueSeverity', $rootId );
    }
...
}//end class WbfsysIssueSeverity_Crud_Access_Root
