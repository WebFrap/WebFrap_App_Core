 ...
 * @licence WebFrap.net
 */
class WbfsysIssueSeverity_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_issue_severity') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_issue_severity.{$fieldName}
...
}//end class WbfsysIssueSeverity_Filter
