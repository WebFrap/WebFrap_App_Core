 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysIssue_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysIssue_Export_Listing_Access';
    ...
    // create a new WbfsysIssue window
    $view = $this->loadView
    (
    	'export-wbfsys_issue',
    	'WbfsysIssue_Export',
    ...
    $model = $this->loadModel( 'WbfsysIssue_Export' );
...
} // end class WbfsysIssue_Export_Controller_Genf
