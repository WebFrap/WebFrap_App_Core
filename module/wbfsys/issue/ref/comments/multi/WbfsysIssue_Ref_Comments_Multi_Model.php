 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listComments as $entityWbfsysIssue )
      {
        if(!$orm->save( $entityWbfsysIssue) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Issue '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Issue '.$entityText,
              'wbfsys.issue.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Issue: '.$textSaved,
          'wbfsys.issue.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysIssue_Ref_Comments_Multi_Model
