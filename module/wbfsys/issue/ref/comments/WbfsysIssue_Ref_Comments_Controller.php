 ...
 * If you want to extend this class write your coden in ControllerWbfsysIssue
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_issue management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysIssue_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_issue-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_issue-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysIssue_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysIssue_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_issue-ref-comments-'.$listType.'-ajax',
    	'WbfsysIssue_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysIssue
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_issue-ref-comments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysIssue_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysIssue_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysIssue_Ref_Comments_'.$listType );
...
} // end WbfsysIssue_Ref_Comments_Controller
