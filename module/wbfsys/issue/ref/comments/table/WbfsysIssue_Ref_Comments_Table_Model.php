 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysIssue
   *
   * @param int $idWbfsysIssue the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysIssue, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysIssue_Ref_Comments_Table' );
    /* @var $query WbfsysIssue_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysIssue );
...
}//end class WbfsysIssue_Ref_Comments_Table_Model
