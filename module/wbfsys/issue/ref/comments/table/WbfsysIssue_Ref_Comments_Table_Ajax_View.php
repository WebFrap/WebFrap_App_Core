 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Issue_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysIssue_Ref_Comments_Table_Ajax_View
