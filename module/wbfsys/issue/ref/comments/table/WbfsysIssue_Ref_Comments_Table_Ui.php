 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysIssue
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysIssue_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysIssue, $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssue_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_issue-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysIssue;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue-ref-comments-search-'
        .$idWbfsysIssue;
    ...
    $tabPanel->searchKey = 'wbfsys_issue-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysIssue_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysIssue );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Issue_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysIssue
    );
   ...
   * @return WbfsysIssue_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysIssue, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysIssue_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysIssue_Ref_Comments_Table_Ui
