 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_issue-ref-comments' );
  ...
  /**
   * @param WbfsysIssue_Ref_Comments_Table_Query $query
...
}//end class WbfsysIssue_Ref_Comments_Table_Access
