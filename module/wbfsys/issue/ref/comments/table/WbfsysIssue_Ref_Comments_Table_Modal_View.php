 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.Issue_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue-ref-comments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Comments' );

    // set the default table template
    $this->setTemplate( 'wbfsys/issue/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysIssue_Ref_Comments_Table' );
...
}//end class WbfsysIssue_Ref_Comments_Table_Modal_View
