 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysIssue, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysIssue_Ref_Tags_Table' );
    /* @var $query WbfsysIssue_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysIssue );
...
}//end class WbfsysIssue_Ref_Tags_Table_Model
