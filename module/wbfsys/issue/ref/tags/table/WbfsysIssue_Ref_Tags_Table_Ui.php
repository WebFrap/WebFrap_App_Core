 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysIssue_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysIssue, $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssue_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_issue-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysIssue;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue-ref-tags-search-'
        .$idWbfsysIssue;
    ...
    $tabPanel->searchKey = 'wbfsys_issue-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysIssue_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysIssue );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.Issue_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysIssue_Ref_Tags_Table_Ui
