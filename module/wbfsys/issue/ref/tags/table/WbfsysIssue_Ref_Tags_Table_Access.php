 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_issue-ref-tags' );
  ...
  /**
   * @param WbfsysIssue_Ref_Tags_Table_Query $query
...
}//end class WbfsysIssue_Ref_Tags_Table_Access
