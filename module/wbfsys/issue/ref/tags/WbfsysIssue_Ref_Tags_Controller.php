 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysIssue_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_issue-ref-tags';
    ...
    (
      $params->tabId,
      'WbfsysIssue_Ref_Tags_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysIssue_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_issue-ref-tags-'.$listType.'-ajax',
    	'WbfsysIssue_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysIssue
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysIssue_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysIssue_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysIssue_Ref_Tags_'.$listType );
...
} // end WbfsysIssue_Ref_Tags_Controller
