 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Issue_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Issue_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_issue-acl-update';
    ...
    $this->setTemplate( 'wbfsys/issue/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Issue', 'wbfsys.issue.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_issue_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysIssue_Acl' );
...
} // end class WbfsysIssue_Acl_Maintab_View */
