 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysIssue
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysIssue_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysIssue_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysIssue_Acl_Model */
    $model   = $this->loadModel( 'WbfsysIssue_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_issue_acl_masks_listing',
      'WbfsysIssue_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysIssue_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysIssue_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysIssue_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysIssue_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysIssue_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysIssue_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_issue-acl-qfdu',
    	'WbfsysIssue_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysIssue_Acl_Controller */
