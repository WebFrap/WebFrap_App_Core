 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_issue.title as "wbfsys_issue_title"',
      'wbfsys_issue.rowid as "wbfsys_issue_rowid"',
...
} // end class WbfsysIssue_Acl_Qfdu_Treetable_Query_Postgresql */
