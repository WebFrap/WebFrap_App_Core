 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysIssue_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_issue-acl-qfdu-aAjax',
      'WbfsysIssue_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysIssue_Acl_Qfdu_Controller */
