 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_issue')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysIssue = $orm->get('WbfsysIssue', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_issue_title']  = $refEntityWbfsysIssue->title;

    }
    $tabData['wbfsys_issue_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysIssue_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssue_Acl' );
    /* @var $query WbfsysIssue_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssue_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysIssue_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssue_Acl_Qfdu' );
    /* @var $query WbfsysIssue_Acl_Qfdu_Query  */
...
} // end class WbfsysIssue_Acl_Qfdu_Model */
