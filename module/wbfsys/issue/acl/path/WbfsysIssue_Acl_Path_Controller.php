 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_issue_acl_graph', 
      'WbfsysIssue_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysIssue_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysIssue_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysIssue_Acl_Path_Maintab_View  */
...
} // end class WbfsysIssue_Acl_Path_Controller */
