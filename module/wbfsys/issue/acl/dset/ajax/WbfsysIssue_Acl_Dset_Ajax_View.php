 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysIssue_Acl_Dset' );
    ...
    $entityWbfsysIssue = $this->model->getEntity( $dsetId );
...
} // end class WbfsysIssue_Acl_Dset_Ajax_View */
