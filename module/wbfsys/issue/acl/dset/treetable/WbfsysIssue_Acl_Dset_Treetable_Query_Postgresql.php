 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_issue.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysIssue_Acl_Dset_Treetable_Query_Postgresql */
