...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysIssue_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysIssue_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysIssue, $areaId, $access, $params  )
  {

    $listObj = new WbfsysIssue_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_issue-acl-dset' );
    ...
    else
    {
      ...
      (
        'Issue "{@label@}" User Access',
        'wbfsys.issue.label',
        array
        (
          'label' => $entityWbfsysIssue->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_issue_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysIssue_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysIssue_Acl_Dset_Ui */
