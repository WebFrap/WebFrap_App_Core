 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_issue'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssue_Acl_Dset' );
    /* @var $query WbfsysIssue_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysIssue_Acl_Dset_Treetable' );
    /* @var $query WbfsysIssue_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysIssue_Acl_Dset_Model */
