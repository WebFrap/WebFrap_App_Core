 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysIssue_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysIssue_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysIssue = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssue_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_issue-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysIssue, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysIssue_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_issue-acl-dset', 
    	'WbfsysIssue_Acl_Dset',
...
} // end class WbfsysIssue_Acl_Dset_Controller */
