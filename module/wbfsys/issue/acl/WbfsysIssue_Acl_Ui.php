...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysIssue_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssue_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_issue-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Issue', 'wbfsys.issue.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_issue_acl';
