 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysIssue Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_issue-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/issue/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Issue.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_issue';
    ...
    $form = $this->newForm( 'WbfsysIssue_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Issue.create');}});
});
...
}//end class WbfsysIssue_Crud_Create_Maintab_View
