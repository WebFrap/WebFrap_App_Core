 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysIssue entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Issue.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Issue.insert';
    $params->formId       = 'wgt-form-wbfsys_issue';
    $params->namespace   = 'wbfsys_issue-create';
    ...
    $this->setTemplate( 'wbfsys/issue/modal/crud/form_create' );
...
}//end class WbfsysIssue_Crud_Create_Modal_View
