 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysIssue Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIssue = $this->model->getEntityWbfsysIssue();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Issue.show  &amp;objid='.$entityWbfsysIssue
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Issue.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_issue-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/issue/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysIssue_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_my_issues").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.MyIssues.show&objid={$objid}');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Issue.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysIssue_Crud_Show_Maintab_View
