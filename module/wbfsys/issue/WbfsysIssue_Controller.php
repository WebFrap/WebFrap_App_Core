...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_issue
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.Issue.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_issue-create';

    $access = new WbfsysIssue_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_issue-create',
      'WbfsysIssue_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysIssue_Crud_Model */
    $model = $this->loadModel( 'WbfsysIssue_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.Issue.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysIssue = $model->getEntityWbfsysIssue( $objid );
    ...
    $params->entity = $entityWbfsysIssue;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_issue:edit';

    $access = new WbfsysIssue_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysIssue );
    ...
    $params->process_Handling = $process_Handling;
    ...
    $error = $process_Handling->trigger( 'before', $params );
    ...
    if( $error )
    {
      ...
      $process_Handling->trigger( 'fail', $params );
          
    $process_Handling->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'wbfsys_issue-edit',
          $entityWbfsysIssue,
          'Edit Issue :'.$entityWbfsysIssue->text()
        );

      
      $process_Handling->trigger( 'after', $params );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_issue:show';
...
$process_Handling->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'wbfsys_issue-show',
          $entityWbfsysIssue,
          'Show Issue :'.$entityWbfsysIssue->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_issue
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.Issue.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-insert';

    $access = new WbfsysIssue_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
...
$params->process_Handling = $process_Handling;
$process_Handling->setEntity( $model->getEntityWbfsysIssue() );
...
$process_Handling->call( 'init', 'fail', $params );
    ...
    else
    {
    	...
    	$entityWbfsysIssue = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_issue-update-'.$entityWbfsysIssue;
      ...
      {
        $access = new WbfsysIssue_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysIssue );
      }
      $params->access = $access;
...
$process_Handling->call( 'init', 'sucess', $params );
      ...
      // model wird benötigt
      /* @var $model WbfsysIssue_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
...
$process_Handling->call( 'init', 'after', $params );
  ...
  *
  * @call POST ajax.php?c=Wbfsys.Issue.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysIssue, $params, $process_Handling ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysIssue_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.Issue.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-delete-'.$objid;

    $access = new WbfsysIssue_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysIssue );
...
if( $error )
{
  return $error;
    ...
    $error = $model->delete( $entityWbfsysIssue, $params );
...
$process_Handling->call( 'delete', 'after', $params );
    ...
    $error = $view->displayDelete( $entityWbfsysIssue, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.Issue.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.Issue.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-listing';
    ...
    $containerClass = 'WbfsysIssue_'.$listType.'_Access';
    ...
    /* @var $model WbfsysIssue_Table_Model */
    $model = $this->loadModel( 'WbfsysIssue_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_issue-'.$params->ltype,
          'WbfsysIssue',
          'List of Issues'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysIssue
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysIssue_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_issue',
      'WbfsysIssue_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysIssue_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.Issue.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysIssue_Selection_Model */
    $model   = $this->loadModel( 'WbfsysIssue_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_issue-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_issue-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysIssue, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-append-'.$objid;
    ...
    // fetch the data from the http request and load it in the model registry
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysIssue, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
    ...
    $ui = $this->loadUi( 'WbfsysIssue_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysIssue_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_issue-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysIssue_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysIssue, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_issue' ); //def wbfsys_issue
...
} // end class WbfsysIssue_Controller */
