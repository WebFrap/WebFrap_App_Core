...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Issues
  *
  ...
  *  }
  *
  * @return WbfsysIssue_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssue_Table_Element( 'tableWbfsysIssue', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_issue-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Issues', 'wbfsys.issue.label' );
      ...
      $filterSubPanel = new WbfsysIssue_Table_SubPanel_Filter( $this );
      ...
      $filterSubPanel->searchKey = 'wbfsys_issue';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysIssue_Table_Element( null,$view );
...
}//end class WbfsysIssue_Table_Ui
