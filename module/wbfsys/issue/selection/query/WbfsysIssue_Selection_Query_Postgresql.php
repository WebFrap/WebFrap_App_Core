 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Selection_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_issue.title as "wbfsys_issue_title"', // variant: def-by-context 
      'wbfsys_process_node.label as "wbfsys_process_node_label"', // variant: def-by-context  used source field wbfsys_process_node
      'wbfsys_issue.id_status as "wbfsys_issue_id_status"', // ref wbfsys_issue def-by-context 
      ...
      'wbfsys_process_node.bg_color as "wbfsys_process_node_bg_color"', // variant: def-additional 
      'wbfsys_process_node.text_color as "wbfsys_process_node_text_color"', // variant: def-additional 
    );
 ...
 wbfsys_issue.rowid = \''.$part.'\'  or 
  ...
  public function appendFilter( $criteria, $condition, $params  )
  {
    ...
    if( isset( $condition['filters']['new_issues'] ) )
    {
      ...
      ( 
        'WbfsysIssue_Selection_NewIssues' 
      );
    ...
    if( isset( $condition['filters']['closed_issues'] ) )
    {
      ...
      ( 
        'WbfsysIssue_Selection_ClosedIssues' 
      );
    ...
    if( isset( $condition['filters']['my_assigned_issued'] ) )
    {
      ...
      ( 
        'WbfsysIssue_Selection_MyAssignedIssued' 
      );
    ...
    if( isset( $condition['filters']['my_created_issued'] ) )
    {
      ...
      ( 
        'WbfsysIssue_Selection_MyCreatedIssued' 
      );
...
}//end class WbfsysIssue_Selection_Query_Postgresql
