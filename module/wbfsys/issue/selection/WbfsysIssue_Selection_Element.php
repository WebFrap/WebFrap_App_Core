 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_issue';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Issue.show&amp;target_mask=WbfsysIssue&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.issue.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Issue.edit&amp;target_mask=WbfsysIssue&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.issue.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Issue.delete&amp;target_mask=WbfsysIssue&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.issue.label',
        Acl::DELETE
  ...
  public function buildAjaxTbody( $row  )
  {
    ...
    else if( $this->appendMode )
    {
      $body = '<tr id="'.$rowid.'" '
        ...
        .$rowParams
        .' wgt_context_menu="'.$this->id.'-cmenu" '
        .' class="wcm wcm_ui_highlight wcm_control_access_dataset '.$classContext.' node-'.$objid.'" style="'.$style.'" >'.NL;
    }
    else
    {
...
}//end class WbfsysIssue_Selection_Element
