 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysIssue_Selection_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_issue') )
...
}//end class WbfsysIssue_Selection_Access
