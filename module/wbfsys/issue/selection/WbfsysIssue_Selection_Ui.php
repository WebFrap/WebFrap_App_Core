 ...
 * @licence WebFrap.net
 */
class WbfsysIssue_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysIssue_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysIssue_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIssue_Selection_Element
    (
      'selectionWbfsysIssue',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Issues', 'wbfsys.issue.label' ) ;
      $tabPanel->searchKey = 'wbfsys_issue';
      ...
      $filterSubPanel = new WbfsysIssue_Selection_SubPanel_Filter( $this );
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Issue.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysIssue' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysIssue listing maske
   *
   * @param WbfsysIssue_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysIssue_Selection_Ui
