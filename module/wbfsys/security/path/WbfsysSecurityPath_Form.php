...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_security_path';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysSecurityPath';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysSecurityPath' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysSecurityPath entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_group( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleGroup_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Group (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputIdGroup->setLabel( $this->view->i18n->l( 'Group', 'wbfsys.security_path.label' ) );
  ...
  * @return void
  */
  public function input_id_root( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      $inputIdRoot = $this->view->newInput( 'input'.$this->prefix.'IdRoot', 'Window' );
      $inputIdRoot->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_root]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_root'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Root (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputIdRoot->setReadOnly( $this->isReadOnly( 'id_root' ) );
      $inputIdRoot->setLabel( $this->view->i18n->l( 'Root', 'wbfsys.security_path.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.SecurityArea.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_root'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdRoot->buildJavascript( 'wgt-input-'.$this->keyName.'_id_root'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_root */
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_area'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Area (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputIdArea->setLabel( $this->view->i18n->l( 'Area', 'wbfsys.security_path.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_reference'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Reference (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputIdReference->setLabel( $this->view->i18n->l( 'Reference', 'wbfsys.security_path.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityPath_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_parent'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Parent (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputMParent->setLabel( $this->view->i18n->l( 'Parent', 'wbfsys.security_path.label' ) );
  ...
  public function input_access_level( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Level (Security Path)', 'wbfsys.security_path.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Access Level', 'wbfsys.security_path.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Security Path)', 'wbfsys.security_path.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.security_path.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Security Path)', 'wbfsys.security_path.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.security_path.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Security Path)', 'wbfsys.security_path.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.security_path.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.security_path.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Security Path)', 'wbfsys.security_path.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.security_path.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Security Path)', 'wbfsys.security_path.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.security_path.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_int medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Version (Security Path)', 'wbfsys.security_path.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.security_path.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Security Path)', 'wbfsys.security_path.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.security_path.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_security_path_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_security_path_m_role_change';
...
}//end class WbfsysSecurityPath_Form */
