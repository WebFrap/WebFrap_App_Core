 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_path';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysSecurityPath_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityPath.show&amp;target_mask=WbfsysSecurityPath&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityPath.edit&amp;target_mask=WbfsysSecurityPath&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_path.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityPath.delete&amp;target_mask=WbfsysSecurityPath&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_path.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Level', 'wbfsys.security_path.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_security_path_rowid'];
      ...
      $body .= '<td valign="top" style="text-align:right;" >'.(!is_null($row['wbfsys_security_path_access_level'])?$row['wbfsys_security_path_access_level']:' ').'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.SecurityPath_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Security Paths." >{$iconDelete} Delete selected Security Paths</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Security Paths. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.SecurityPath_Multi.deleteAll" >{$iconClean} Delete all Security Paths</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysSecurityPath_Table_Element
