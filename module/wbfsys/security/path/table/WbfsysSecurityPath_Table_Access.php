 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysSecurityPath_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_security_path.rowid ",
      'acls'
    );
...
}//end class WbfsysSecurityPath_Table_Access
