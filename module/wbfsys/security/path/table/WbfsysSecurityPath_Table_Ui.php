 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Security Paths
  *
  ...
  *  }
  *
  * @return WbfsysSecurityPath_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityPath_Table_Element( 'tableWbfsysSecurityPath', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_path-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Security Paths', 'wbfsys.security_path.label' );
      //$tabPanel->searchKey = 'wbfsys_security_path';
      ...
      $searchElement->searchKey = 'wbfsys_security_path';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysSecurityPath_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityPath', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysSecurityPath listing maske
   *
   * @param WbfsysSecurityPath_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysSecurityPath  = $model->getEntityWbfsysSecurityPath();
    ...
    $formWbfsysSecurityPath->setKeyName( 'wbfsys_security_path' );
...
}//end class WbfsysSecurityPath_Table_Ui
