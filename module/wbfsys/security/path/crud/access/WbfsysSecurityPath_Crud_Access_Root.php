 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysSecurityPath_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysSecurityPath_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysSecurityPath_Entity */
      $entity = $orm->get( 'WbfsysSecurityPath', $rootId );
    }
...
}//end class WbfsysSecurityPath_Crud_Access_Root
