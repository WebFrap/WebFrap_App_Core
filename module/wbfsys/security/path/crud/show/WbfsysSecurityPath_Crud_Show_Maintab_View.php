 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityPath_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysSecurityPath Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityPath = $this->model->getEntityWbfsysSecurityPath();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Security Path: {@text@}',
      'wbfsys.security_path.label',
      array( 'text' => $entityWbfsysSecurityPath->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityPath.show  &amp;objid='.$entityWbfsysSecurityPath
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityPath.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_path-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_path/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysSecurityPath_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.SecurityPath.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_path' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_path a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.SecurityPath.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityPath.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysSecurityPath_Crud_Show_Maintab_View
