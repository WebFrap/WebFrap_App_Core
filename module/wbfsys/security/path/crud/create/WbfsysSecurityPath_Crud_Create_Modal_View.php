 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysSecurityPath entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.SecurityPath.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityPath.insert';
    $params->formId       = 'wgt-form-wbfsys_security_path';
    $params->namespace   = 'wbfsys_security_path-create';
    ...
    $this->setTemplate( 'wbfsys/security_path/modal/crud/form_create' );
...
}//end class WbfsysSecurityPath_Crud_Create_Modal_View
