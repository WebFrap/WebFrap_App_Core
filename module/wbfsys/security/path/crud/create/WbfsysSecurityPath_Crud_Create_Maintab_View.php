 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysSecurityPath Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_security_path-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/security_path/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityPath.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_security_path';
    ...
    $form = $this->newForm( 'WbfsysSecurityPath_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.SecurityPath.create');}});
});
...
}//end class WbfsysSecurityPath_Crud_Create_Maintab_View
