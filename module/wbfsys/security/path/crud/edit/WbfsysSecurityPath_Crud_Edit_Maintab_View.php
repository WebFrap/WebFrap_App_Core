 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityPath_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysSecurityPath Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityPath = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Security Path: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityPath.edit&amp;utf8=✓&amp;objid='.$entityWbfsysSecurityPath
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityPath.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_path-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_path/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysSecurityPath_Crud_Edit' );
...
}//end class WbfsysSecurityPath_Crud_Edit_Maintab_View
