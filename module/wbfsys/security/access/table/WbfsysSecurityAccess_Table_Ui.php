 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Access
  *
  ...
  *  }
  *
  * @return WbfsysSecurityAccess_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityAccess_Table_Element( 'tableWbfsysSecurityAccess', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Access', 'wbfsys.security_access.label' );
      //$tabPanel->searchKey = 'wbfsys_security_access';
      ...
      $searchElement->searchKey = 'wbfsys_security_access';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysSecurityAccess_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityAccess', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysSecurityAccess listing maske
   *
   * @param WbfsysSecurityAccess_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysSecurityAccess_Table_Ui
