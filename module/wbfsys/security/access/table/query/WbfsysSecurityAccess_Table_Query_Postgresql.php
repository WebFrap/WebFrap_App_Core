 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_security_access_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    $criteria->where
    (
      " wbfsys_security_access.rowid  IN( ". implode( ', ', array_keys($inKeys) ) ." )"
    );
    ...
    {
      $row['acl-level'] = $inKeys[$row['wbfsys_security_access_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_security_access.rowid as "wbfsys_security_access_rowid"', // variant: def-rowid 
      'wbfsys_role_group.access_key as "wbfsys_role_group_access_key"', // variant: def-by-context  used source field wbfsys_role_group
      'wbfsys_security_access.id_group as "wbfsys_security_access_id_group"', // ref wbfsys_security_access def-by-context 
      'wbfsys_security_area.access_key as "wbfsys_security_area_access_key"', // variant: def-by-context  used source field wbfsys_security_area
      'wbfsys_security_access.id_area as "wbfsys_security_access_id_area"', // ref wbfsys_security_access def-by-context 
      'wbfsys_security_access.access_level as "wbfsys_security_access_access_level"', // variant: def-by-context 
      'wbfsys_security_access.ref_access_level as "wbfsys_security_access_ref_access_level"', // variant: def-by-context 
    );
  ...
  public function setTables( $criteria   )
  {
    ...
    (
      ...
      null,
      'wbfsys_role_group'
    );// wbfsys_role_group  by alias wbfsys_role_group
  ...
  public function checkConditions( $criteria, array $condition )
  {
      ...
      if( isset($condition['free']) && trim( $condition['free'] ) != ''  )
      {
         ...
         )
         {
            ...
            (
              '(
 wbfsys_security_access.rowid = \''.$part.'\' 
              )'
            );
         }
  ...
  public function checkCharBegin( $criteria, $params )
  {
      ...
      if( $params->begin )
      {
        ...
        if( '?' == $params->begin  )
        {
          $criteria->where( "wbfsys_security_access.id_group ~* '^[^a-zA-Z]'" );
        }
        else
        {
          $criteria->where( "upper(substr(wbfsys_security_access.id_group,1,1)) = '".strtoupper($params->begin)."'" );
        }
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
    ...
    else // if not use the default
    {
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_security_access-rowid-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_security_access-rowid-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_security_access-rowid-order"' );
...
}//end class WbfsysSecurityAccess_Table_Query_Postgresql
