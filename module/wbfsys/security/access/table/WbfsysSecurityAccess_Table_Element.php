 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_access';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityAccess.show&amp;target_mask=WbfsysSecurityAccess&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityAccess.edit&amp;target_mask=WbfsysSecurityAccess&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_access.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityAccess.delete&amp;target_mask=WbfsysSecurityAccess&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_access.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Group', 'wbfsys.security_access.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Area', 'wbfsys.security_access.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Level', 'wbfsys.security_access.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Ref Access Level', 'wbfsys.security_access.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" style="text-align:right;" >'.(!is_null($row['wbfsys_security_access_access_level'])?$row['wbfsys_security_access_access_level']:' ').'</td>'.NL;

      $body .= '<td valign="top" style="text-align:right;" >'.(!is_null($row['wbfsys_security_access_ref_access_level'])?$row['wbfsys_security_access_ref_access_level']:' ').'</td>'.NL;
...
}//end class WbfsysSecurityAccess_Table_Element
