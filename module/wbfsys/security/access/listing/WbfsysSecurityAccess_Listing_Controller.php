 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysSecurityAccess_'.$listType ) );
...
} // end class WbfsysSecurityAccess_Listing_Controller */
