 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysSecurityAccess_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysSecurityAccess_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysSecurityAccess_Entity */
      $entity = $orm->get( 'WbfsysSecurityAccess', $rootId );
    }
...
}//end class WbfsysSecurityAccess_Crud_Access_Root
