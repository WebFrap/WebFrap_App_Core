 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysSecurityAccess entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.SecurityAccess.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityAccess.insert';
    $params->formId       = 'wgt-form-wbfsys_security_access';
    $params->namespace   = 'wbfsys_security_access-create';
    ...
    $this->setTemplate( 'wbfsys/security_access/modal/crud/form_create' );
...
}//end class WbfsysSecurityAccess_Crud_Create_Modal_View
