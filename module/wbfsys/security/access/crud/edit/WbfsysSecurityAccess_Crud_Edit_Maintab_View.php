 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysSecurityAccess Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityAccess = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityAccess.edit&amp;utf8=✓&amp;objid='.$entityWbfsysSecurityAccess
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityAccess.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_access-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_access/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysSecurityAccess_Crud_Edit' );
...
}//end class WbfsysSecurityAccess_Crud_Edit_Maintab_View
