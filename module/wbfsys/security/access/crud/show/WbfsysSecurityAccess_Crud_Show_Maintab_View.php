 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAccess_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysSecurityAccess Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    (
      ...
      array( 'text' => $entityWbfsysSecurityAccess->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityAccess.show  &amp;objid='.$entityWbfsysSecurityAccess
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityAccess.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_access-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_access/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysSecurityAccess_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.SecurityAccess.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_access' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_access a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.SecurityAccess.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityAccess.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysSecurityAccess_Crud_Show_Maintab_View
