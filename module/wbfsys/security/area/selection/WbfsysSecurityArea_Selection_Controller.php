 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysSecurityArea_Selection' ) );
...
} // end class WbfsysSecurityArea_Selection_Controller */
