 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysSecurityArea_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysSecurityArea_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityArea_Selection_Element
    (
      'selectionWbfsysSecurityArea',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Security Areas', 'wbfsys.security_area.label' ) ;
      $tabPanel->searchKey = 'wbfsys_security_area';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.SecurityArea.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysSecurityArea',
      'WbfsysSecurityArea_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityArea' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysSecurityArea listing maske
   *
   * @param WbfsysSecurityArea_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysSecurityArea  = $model->getEntityWbfsysSecurityArea();
...
}//end class WbfsysSecurityArea_Selection_Ui
