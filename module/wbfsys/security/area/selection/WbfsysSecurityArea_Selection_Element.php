 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_security_area';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityArea.show&amp;target_mask=WbfsysSecurityArea&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityArea.edit&amp;target_mask=WbfsysSecurityArea&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_area.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityArea.delete&amp;target_mask=WbfsysSecurityArea&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_area.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_label'])).'</td>'.NL;
...
}//end class WbfsysSecurityArea_Selection_Element
