 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysSecurityArea, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysSecurityArea, $params );
    }
    else
    {
...
}//end class WbfsysSecurityArea_Ajax_View
