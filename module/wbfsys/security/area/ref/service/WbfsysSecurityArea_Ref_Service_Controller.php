 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Service_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    ( 
    	'wbfsys_security_area-service',
    	'WbfsysSecurityArea_Service',
    	'displayAutocomplete',
    	View::AJAX 
    );
...
}//end class WbfsysSecurityArea_Ref_Service_Controller
