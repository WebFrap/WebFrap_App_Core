 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_area-access';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysSecurityAccess_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysSecurityArea_Ref_Access';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityAccess.show&amp;target_mask=WbfsysSecurityArea_Ref_Access&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityAccess.edit&amp;target_mask=WbfsysSecurityArea_Ref_Access&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_access.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityAccess.delete&amp;target_mask=WbfsysSecurityArea_Ref_Access&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_access.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:175px" >Group</th>'.NL;
    $html .= '<th style="width:175px" >Access</th>'.NL;
    $html .= '<th style="width:175px" >Period</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.SecurityAccess.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_group_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" >'.(!is_null($row['wbfsys_security_access_access_level'])?$row['wbfsys_security_access_access_level']:' ').'</td>'.NL;
      $body .= '<td valign="top" ><span>From: </span>'.('' != trim($row['wbfsys_security_access_date_start'])?$this->view->i18n->date($row['wbfsys_security_access_date_start']):' ').'<br /><span>Till: </span>'.('' != trim($row['wbfsys_security_access_date_end'])?$this->view->i18n->date($row['wbfsys_security_access_date_end']):' ').'</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.SecurityAccess_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Access." >{$iconDelete} Delete selected Access</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Access. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.SecurityAccess_Multi.deleteAll" >{$iconClean} Delete all Access</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysSecurityArea_Ref_Access_Table_Element
