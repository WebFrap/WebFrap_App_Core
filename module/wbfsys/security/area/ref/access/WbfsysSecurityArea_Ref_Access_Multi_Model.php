 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listAccess = $this->getRegisterd('listRefAccess'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listAccess was not registered'
        );
      }

      foreach( $listAccess as $entityWbfsysSecurityArea )
      {
        if(!$orm->save( $entityWbfsysSecurityArea) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Security Area '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Security Area '.$entityText,
              'wbfsys.security_area.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listAccess as $entityWbfsysSecurityArea )
      {
        ...
        {
          $entityTexts[] = $entityText = $entityWbfsysSecurityArea->text();
        }
      }
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Security Area: '.$textSaved,
          'wbfsys.security_area.message',
          array($textSaved)
        )
      );
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefAccess',$listWbfsysSecurityAccess);
      return true;
...
}//end class WbfsysSecurityArea_Ref_Access_Multi_Model
