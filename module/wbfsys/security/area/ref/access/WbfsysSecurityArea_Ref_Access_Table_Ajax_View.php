 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.SecurityArea_Ref_Access.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysSecurityArea_Ref_Access_Table_Ajax_View
