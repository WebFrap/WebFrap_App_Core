 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Table_Query_Postgresql
  extends LibSqlQuery
{
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_security_access.date_start as "wbfsys_security_access_date_start"', // variant:  
      'wbfsys_security_access.date_end as "wbfsys_security_access_date_end"', // variant:  
    );
...
}//end class WbfsysSecurityArea_Ref_Access_Table_Query_Postgresql
