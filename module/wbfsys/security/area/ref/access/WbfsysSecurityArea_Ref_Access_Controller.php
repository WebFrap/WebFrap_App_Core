 ...
 * If you want to extend this class write your coden in ControllerWbfsysSecurityArea
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des access Referenztabs
  * für den wbfsys_security_area management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysSecurityArea_Ref_Access_".$listType."_Access";
    ...
    $accessAccess = new $containerClass( );
    $accessAccess->load( $user->getProfileName(), $params );

    $params->aclNode = 'mgmt-wbfsys_security_area-ref-access';

    $params->accessAccess = $accessAccess;
    $params->paramsAccess = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessAccess->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_security_area-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysSecurityArea_Ref_Access_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelAccess = $this->loadModel
    (
      'WbfsysSecurityArea_Ref_Access_'.$listType
    );
    $modelAccess->setAccess( $accessAccess );
    
    $view->setModel( $modelAccess );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdAccess = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysSecurityArea_Ref_Access_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_security_area-ref-access-'.$listType.'-ajax',
    	'WbfsysSecurityArea_Ref_Access_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysSecurityAccess by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_security_access' ); //def wbfsys_security_access


  } // end public function cleanPost */

} // end WbfsysSecurityArea_Ref_Access_Controller
