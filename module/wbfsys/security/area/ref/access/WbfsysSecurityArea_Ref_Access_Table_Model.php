 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Ref_Access_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysSecurityArea
   *
   * @param int $idWbfsysSecurityArea the id for the reference entity
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysSecurityArea, $access, $params  )
  { 
    ...
    $query = $db->newQuery( 'WbfsysSecurityArea_Ref_Access_Table' );
    /* @var $query WbfsysSecurityArea_Ref_Access_Table_Query  */

    // hard condition
    $query->setCondition( 'wbfsys_security_access.id_area = '.$idWbfsysSecurityArea );
...
}//end class WbfsysSecurityArea_Ref_Access_Table_Model
