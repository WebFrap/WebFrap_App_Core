 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_security_area_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysSecurityAreaTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysSecurityAreaTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysSecurityAreaTypeI18n';
   ...
   *
   * @var WbfsysSecurityAreaTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysSecurityAreaTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysSecurityAreaTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysSecurityAreaTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.security_area_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_security_area_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_security_area_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysSecurityAreaType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysSecurityAreaType not exists' );

      Log::warn('Looks like the Entity: WbfsysSecurityAreaType is missing');
      ...
      //p: Window
      $objidWbfsysSecurityAreaType = $this->entity->getData('id_wbfsys_security_area_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysSecurityAreaType
          || !$entityWbfsysSecurityAreaType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysSecurityAreaType = $this->db->orm->newEntity( 'WbfsysSecurityAreaType' );
      }

      $inputIdWbfsysSecurityAreaType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysSecurityAreaType', 'Window' );
      $inputIdWbfsysSecurityAreaType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_security_area_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_security_area_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Security Area Type (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysSecurityAreaType->assignedForm = $this->assignedForm;

      $inputIdWbfsysSecurityAreaType->setWidth( 'medium' );

      $inputIdWbfsysSecurityAreaType->setData( $this->entity->getData( 'id_wbfsys_security_area_type' )  );
      $inputIdWbfsysSecurityAreaType->setReadOnly( $this->isReadOnly( 'id_wbfsys_security_area_type' ) );
      $inputIdWbfsysSecurityAreaType->setLabel( $this->view->i18n->l( 'Wbfsys Security Area Type', 'wbfsys.security_area_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.SecurityAreaType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_security_area_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysSecurityAreaType->setListUrl ( $listUrl );
      $inputIdWbfsysSecurityAreaType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysSecurityAreaType->setEntityUrl( 'maintab.php?c=Wbfsys.SecurityAreaType.edit' );
      $inputIdWbfsysSecurityAreaType->conEntity         = $entityWbfsysSecurityAreaType;
      $inputIdWbfsysSecurityAreaType->refresh           = $this->refresh;
      $inputIdWbfsysSecurityAreaType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysSecurityAreaType->view = $this->view;
      $inputIdWbfsysSecurityAreaType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_security_area_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysSecurityAreaType );
  ...
  }//end public function input_id_wbfsys_security_area_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.security_area_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.security_area_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.security_area_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.security_area_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.security_area_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.security_area_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.security_area_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.security_area_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.security_area_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Security Area Type I18n)', 'wbfsys.security_area_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_security_area_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_security_area_type_i18n_m_role_change';
...
}//end class WbfsysSecurityAreaTypeI18n_Form */
