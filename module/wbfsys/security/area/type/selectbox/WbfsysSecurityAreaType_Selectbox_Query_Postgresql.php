 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysSecurityAreaType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_security_area_type.rowid as id',
      'wbfsys_security_area_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_security_area_type.m_order as "wbfsys_security_area_type-m_order-order"' );

    $criteria->from( 'wbfsys_security_area_type' );



      $criteria->orderBy( 'wbfsys_security_area_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_security_area_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_security_area_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysSecurityAreaType_Selectbox_Query_Postgresql
