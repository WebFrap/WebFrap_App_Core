 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysSecurityAreaType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.SecurityAreaType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityAreaType.insert';
    $params->formId       = 'wgt-form-wbfsys_security_area_type';
    $params->namespace   = 'wbfsys_security_area_type-create';
    ...
    $this->setTemplate( 'wbfsys/security_area_type/modal/crud/form_create' );
...
}//end class WbfsysSecurityAreaType_Crud_Create_Modal_View
