 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysSecurityAreaType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityAreaType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit security area Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityAreaType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysSecurityAreaType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityAreaType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_area_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_area_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysSecurityAreaType_Crud_Edit' );
...
}//end class WbfsysSecurityAreaType_Crud_Edit_Maintab_View
