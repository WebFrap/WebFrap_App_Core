 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityAreaType_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysSecurityAreaType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityAreaType = $this->model->getEntityWbfsysSecurityAreaType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show security area Type: {@text@}',
      'wbfsys.security_area_type.label',
      array( 'text' => $entityWbfsysSecurityAreaType->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'security area Type: {@text@}',
      'wbfsys.security_area_type.label',
      array( 'text' => $entityWbfsysSecurityAreaType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityAreaType.show  &amp;objid='.$entityWbfsysSecurityAreaType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityAreaType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_area_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_area_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysSecurityAreaType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.SecurityAreaType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_area_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_area_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.SecurityAreaType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityAreaType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysSecurityAreaType_Crud_Show_Maintab_View
