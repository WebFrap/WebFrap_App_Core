 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysSecurityAreaType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new security area Type',
      'wbfsys.security_area_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New security area Type',
      'wbfsys.security_area_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_security_area_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/security_area_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityAreaType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_security_area_type';
    ...
    $form = $this->newForm( 'WbfsysSecurityAreaType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.SecurityAreaType.create');}});
});
...
}//end class WbfsysSecurityAreaType_Crud_Create_Maintab_View
