 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysSecurityAreaType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysSecurityAreaType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysSecurityAreaType_Entity */
      $entity = $orm->get( 'WbfsysSecurityAreaType', $rootId );
    }
...
}//end class WbfsysSecurityAreaType_Crud_Access_Root
