 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für security area Types
  *
  ...
  *  }
  *
  * @return WbfsysSecurityAreaType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityAreaType_Table_Element( 'tableWbfsysSecurityAreaType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_area_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'security area Types', 'wbfsys.security_area_type.label' );
      //$tabPanel->searchKey = 'wbfsys_security_area_type';
      ...
      $searchElement->searchKey = 'wbfsys_security_area_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysSecurityAreaType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityAreaType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysSecurityAreaType listing maske
   *
   * @param WbfsysSecurityAreaType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysSecurityAreaType  = $model->getEntityWbfsysSecurityAreaType();
    ...
    $formWbfsysSecurityAreaType->setKeyName( 'wbfsys_security_area_type' );
...
}//end class WbfsysSecurityAreaType_Table_Ui
