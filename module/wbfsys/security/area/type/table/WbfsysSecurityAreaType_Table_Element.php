 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_area_type';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityAreaType.show&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityAreaType.edit&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_area_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityAreaType.delete&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_area_type.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.SecurityAreaType.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_type_name'])).'</a></td>'.NL;
...
}//end class WbfsysSecurityAreaType_Table_Element
