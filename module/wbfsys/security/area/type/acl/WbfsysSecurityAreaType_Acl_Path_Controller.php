 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_security_area_type_acl_graph', 
      'WbfsysSecurityAreaType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysSecurityAreaType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysSecurityAreaType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysSecurityAreaType_Acl_Path_Maintab_View  */
...
} // end class WbfsysSecurityAreaType_Acl_Path_Controller */
