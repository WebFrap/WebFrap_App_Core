 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysSecurityAreaType_Acl_Dset' );
    ...
    $entityWbfsysSecurityAreaType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysSecurityAreaType_Acl_Dset_Ajax_View */
