 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysSecurityAreaType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityAreaType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL security area Type', 
        'wbfsys.security_area_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_security_area_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'security area Type', 'wbfsys.security_area_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_security_area_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysSecurityAreaType_Acl_Table'
    );
...
} // end class WbfsysSecurityAreaType_Acl_Ui */
