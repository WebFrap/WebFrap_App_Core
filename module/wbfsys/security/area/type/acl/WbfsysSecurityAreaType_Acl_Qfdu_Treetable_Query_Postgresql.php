 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_security_area_type.name as "wbfsys_security_area_type_name"',
      'wbfsys_security_area_type.rowid as "wbfsys_security_area_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_security_area_type on wbfsys_group_users.vid = wbfsys_security_area_type.rowid'
    );
...
} // end class WbfsysSecurityAreaType_Acl_Qfdu_Treetable_Query_Postgresql */
