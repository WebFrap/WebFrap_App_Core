 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysSecurityAreaType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.SecurityAreaType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_area_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.SecurityAreaType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_security_area_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/security_area_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'security area Type', 'wbfsys.security_area_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_security_area_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysSecurityAreaType_Acl' );
...
} // end class WbfsysSecurityAreaType_Acl_Maintab_View */
