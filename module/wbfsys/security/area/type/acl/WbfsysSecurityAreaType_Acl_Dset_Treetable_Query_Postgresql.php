 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_security_area_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysSecurityAreaType_Acl_Dset_Treetable_Query_Postgresql */
