 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysSecurityAreaType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysSecurityAreaType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysSecurityAreaType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysSecurityAreaType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_security_area_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'security area Type "{@label@}" User Access',
        'wbfsys.security_area_type.label',
        array
        (
          'label' => $entityWbfsysSecurityAreaType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_security_area_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysSecurityAreaType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysSecurityAreaType_Acl_Dset_Ui */
