 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_security_area_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_security_area_type.rowid as id,
    wbfsys_security_area_type.name as value,
    wbfsys_security_area_type.name as label
  FROM
...
} // end class WbfsysSecurityAreaType_Acl_Qfdu_Query_Postgresql */
