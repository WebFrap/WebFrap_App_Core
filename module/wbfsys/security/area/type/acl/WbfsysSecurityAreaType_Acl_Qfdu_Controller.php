 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysSecurityAreaType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_security_area_type-acl-qfdu-aAjax',
      'WbfsysSecurityAreaType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysSecurityAreaType_Acl_Qfdu_Controller */
