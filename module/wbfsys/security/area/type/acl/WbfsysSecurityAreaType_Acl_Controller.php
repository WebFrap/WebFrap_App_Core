 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysSecurityAreaType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysSecurityAreaType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_security_area_type_acl_listing',
      'WbfsysSecurityAreaType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysSecurityAreaType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityAreaType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysSecurityAreaType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_security_area_type-acl',
    	'WbfsysSecurityAreaType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_security_area_type_acl_masks_listing',
      'WbfsysSecurityAreaType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysSecurityAreaType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysSecurityAreaType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityAreaType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysSecurityAreaType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysSecurityAreaType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysSecurityAreaType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_security_area_type-acl-qfdu',
    	'WbfsysSecurityAreaType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysSecurityAreaType_Acl_Controller */
