 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityAreaType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysSecurityAreaType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysSecurityAreaType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysSecurityAreaType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_security_area_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysSecurityAreaType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_security_area_type-acl-dset', 
    	'WbfsysSecurityAreaType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysSecurityAreaType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_security_area_type-acl-dset', 
    	'WbfsysSecurityAreaType_Acl_Dset',
...
} // end class WbfsysSecurityAreaType_Acl_Dset_Controller */
