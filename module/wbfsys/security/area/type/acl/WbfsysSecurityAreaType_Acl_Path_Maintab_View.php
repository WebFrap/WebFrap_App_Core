 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/security_area_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'security area Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_security_area_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_security_area_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysSecurityAreaType_Acl_Path_Maintab_View */
