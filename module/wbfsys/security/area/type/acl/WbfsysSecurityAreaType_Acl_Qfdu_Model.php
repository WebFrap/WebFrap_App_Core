 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_security_area_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysSecurityAreaType = $orm->get('WbfsysSecurityAreaType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_security_area_type_name']  = $refEntityWbfsysSecurityAreaType->name;

    }
    $tabData['wbfsys_security_area_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysSecurityAreaType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityAreaType_Acl' );
    /* @var $query WbfsysSecurityAreaType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityAreaType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysSecurityAreaType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityAreaType_Acl_Qfdu' );
    /* @var $query WbfsysSecurityAreaType_Acl_Qfdu_Query  */
...
} // end class WbfsysSecurityAreaType_Acl_Qfdu_Model */
