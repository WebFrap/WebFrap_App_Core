 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_security_area_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysSecurityAreaType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityAreaType_Acl_Dset' );
    /* @var $query WbfsysSecurityAreaType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityAreaType_Acl_Dset_Treetable' );
    /* @var $query WbfsysSecurityAreaType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysSecurityAreaType_Acl_Dset_Model */
