 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysSecurityAreaType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysSecurityAreaType_Export_Listing_Access';
    ...
    // create a new WbfsysSecurityAreaType window
    $view = $this->loadView
    (
    	'export-wbfsys_security_area_type',
    	'WbfsysSecurityAreaType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysSecurityAreaType_Export' );
...
} // end class WbfsysSecurityAreaType_Export_Controller_Genf
