 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysSecurityAreaType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysSecurityAreaType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityAreaType_Selection_Element
    (
      'selectionWbfsysSecurityAreaType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection security area Types', 'wbfsys.security_area_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.SecurityAreaType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysSecurityAreaType',
      'WbfsysSecurityAreaType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysSecurityAreaType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysSecurityAreaType_Selection_Ui
