 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysSecurityAreaType_Selection' ) );
...
} // end class WbfsysSecurityAreaType_Selection_Controller */
