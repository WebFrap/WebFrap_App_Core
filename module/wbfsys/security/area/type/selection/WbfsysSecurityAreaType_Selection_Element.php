 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_security_area_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysSecurityAreaType_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityAreaType.show&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityAreaType.edit&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_area_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityAreaType.delete&amp;target_mask=WbfsysSecurityAreaType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_area_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_security_area_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.security_area_type.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.SecurityAreaType.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.security_area_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.security_area_type.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_security_area_type_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_type_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_security_area_type_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.SecurityAreaType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected security area Types." >{$iconDelete} Delete selected security area Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! security area Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.SecurityAreaType_Multi.deleteAll" >{$iconClean} Delete all security area Types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysSecurityAreaType_Selection_Element
