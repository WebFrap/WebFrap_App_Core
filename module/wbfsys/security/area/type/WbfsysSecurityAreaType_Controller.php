 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityAreaType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_security_area_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.SecurityAreaType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_security_area_type-create';

    $access = new WbfsysSecurityAreaType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_security_area_type-create',
      'WbfsysSecurityAreaType_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysSecurityAreaType_Crud_Model */
    $model = $this->loadModel( 'WbfsysSecurityAreaType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.SecurityAreaType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysSecurityAreaType = $model->getEntityWbfsysSecurityAreaType( $objid );
    ...
    $params->entity = $entityWbfsysSecurityAreaType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_security_area_type:edit';

    $access = new WbfsysSecurityAreaType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityAreaType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_security_area_type-edit-'.$objid,
      'WbfsysSecurityAreaType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_security_area_type-edit',
          $entityWbfsysSecurityAreaType,
          'Edit security area Type :'.$entityWbfsysSecurityAreaType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_security_area_type';
      $params->maskRoot      = 'wbfsys_security_area_type:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_security_area_type';
      $params->aclNode       = 'mgmt-wbfsys_security_area_type';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_security_area_type-edit-'.$objid,
      'WbfsysSecurityAreaType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_security_area_type-show',
          $entityWbfsysSecurityAreaType,
          'Show security area Type :'.$entityWbfsysSecurityAreaType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_security_area_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.SecurityAreaType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-insert';

    $access = new WbfsysSecurityAreaType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysSecurityAreaType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_security_area_type-update-'.$entityWbfsysSecurityAreaType;
      ...
      {
        $access = new WbfsysSecurityAreaType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityAreaType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysSecurityAreaType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_security_area_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysSecurityAreaType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.SecurityAreaType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysSecurityAreaType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysSecurityAreaType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.SecurityAreaType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-delete-'.$objid;

    $access = new WbfsysSecurityAreaType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityAreaType );
    ...
    $error = $model->delete( $entityWbfsysSecurityAreaType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysSecurityAreaType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.SecurityAreaType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.SecurityAreaType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-listing';
    ...
    $containerClass = 'WbfsysSecurityAreaType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_security_area_type',
      'WbfsysSecurityAreaType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysSecurityAreaType_Table_Model */
    $model = $this->loadModel( 'WbfsysSecurityAreaType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_security_area_type-'.$params->ltype,
          'WbfsysSecurityAreaType',
          'List of security area Types'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysSecurityAreaType
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysSecurityAreaType_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_security_area_type',
      'WbfsysSecurityAreaType_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysSecurityAreaType_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.SecurityAreaType.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityAreaType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysSecurityAreaType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_security_area_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_security_area_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_security_area_type',
      'WbfsysSecurityAreaType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysSecurityAreaType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysSecurityAreaType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysSecurityAreaType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area_type-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_security_area_type' );
...
} // end class WbfsysSecurityAreaType_Controller */
