 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityArea_Treeable_Model
    */
    public $model = null;

    /**
    * @var WbfsysSecurityArea_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/security_area/maintab/treetable/listing' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Treetable Security Areas',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.SecurityArea.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.SecurityArea.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-wbfsys_security_area-search';
...
BUTTONJS;
    ...
    ///@var WbfsysSecurityArea_Treetable_Ui
    $ui = $this->loadUi( 'WbfsysSecurityArea_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var WbfsysSecurityArea_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'WbfsysSecurityArea_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityArea.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.SecurityArea.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=Wbfsys.SecurityArea.listing&amp;ltype=treetable');
    });
...
}//end class WbfsysSecurityArea_Treetable_Maintab_View
