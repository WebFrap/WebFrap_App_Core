 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysSecurityArea_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysSecurityArea_Treetable_Element
    (
      'treetableWbfsysSecurityArea',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Security Areas', 'wbfsys.security_area.label' );
...
WGTJS;
   ...
   *
   * @return WbfsysSecurityArea_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityArea', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysSecurityArea_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysSecurityArea_Treetable_Ui
