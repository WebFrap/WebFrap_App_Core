 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Treetable_Postgresql_Query
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if($params->loadFullSize)
      $this->calcQuery = $criteria->count( 'count(wbfsys_security_area.'.Db::PK.') as '.Db::Q_SIZE );
    ...
    {
      $this->data[] = $row;
      $ids[] = $row['wbfsys_security_area_rowid'];
    }
    ...
    while( $children = $this->loadChildren( $ids, true ) )
    {
      ...
      {
        $this->childs[$child['wbfsys_security_area_m_parent']][] = $child;
        $ids[] = $child['wbfsys_security_area_rowid'];
      }
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $access, $condition, $params = null )
  {
    ...
    while( $childIds = $access->fetchChildrenIds( $pName, 'treetable', $this, $ids, $condition, $params ) )
    {
      ...
      foreach( $children as $child )
      {
        $child['acl-level'] = $childIds[$child['wbfsys_security_area_rowid']];
 ...
 /**
  ...
  public function loadChildren( $ids, $loadChildren = false )
  {
    ...
    if( $loadChildren )
      $criteria->where('wbfsys_security_area.m_parent in('.implode(',',$ids).')');
    else
      $criteria->where('wbfsys_security_area.rowid in('.implode(',',$ids).')');
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_security_area.m_parent as "wbfsys_security_area_m_parent"', // variant: def-additional 
    );
 ...
 /**
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    $criteria->where( ' wbfsys_security_area.m_parent is null ' );
...
}//end class WbfsysSecurityArea_Treetable_Postgresql_Query
