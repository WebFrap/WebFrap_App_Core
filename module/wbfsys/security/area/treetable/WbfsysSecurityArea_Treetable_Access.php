 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysSecurityArea_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_security_area') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_security_area.rowid ",
      'acls'
    );
...
}//end class WbfsysSecurityArea_Treetable_Access
