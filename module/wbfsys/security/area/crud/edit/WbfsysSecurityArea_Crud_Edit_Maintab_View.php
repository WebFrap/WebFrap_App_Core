 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysSecurityArea Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityArea = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Security Area: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityArea.edit&amp;utf8=✓&amp;objid='.$entityWbfsysSecurityArea
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityArea.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_area-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_area/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysSecurityArea_Crud_Edit' );
...
}//end class WbfsysSecurityArea_Crud_Edit_Maintab_View
