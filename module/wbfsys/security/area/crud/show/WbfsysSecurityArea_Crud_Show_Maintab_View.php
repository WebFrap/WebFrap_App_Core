 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityArea_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysSecurityArea Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityArea = $this->model->getEntityWbfsysSecurityArea();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Security Area: {@text@}',
      'wbfsys.security_area.label',
      array( 'text' => $entityWbfsysSecurityArea->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityArea.show  &amp;objid='.$entityWbfsysSecurityArea
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityArea.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_area-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_area/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysSecurityArea_Crud_Show' );
    ...
    if( $params->access->getPathLevel( 'mgmt-wbfsys_security_area-ref-access' ) )
    {
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.SecurityArea.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_area' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_area a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.SecurityArea.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityArea.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysSecurityArea_Crud_Show_Maintab_View
