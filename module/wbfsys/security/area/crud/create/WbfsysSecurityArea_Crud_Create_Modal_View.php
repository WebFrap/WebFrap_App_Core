 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysSecurityArea entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.SecurityArea.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityArea.insert';
    $params->formId       = 'wgt-form-wbfsys_security_area';
    $params->namespace   = 'wbfsys_security_area-create';
    ...
    $this->setTemplate( 'wbfsys/security_area/modal/crud/form_create' );
...
}//end class WbfsysSecurityArea_Crud_Create_Modal_View
