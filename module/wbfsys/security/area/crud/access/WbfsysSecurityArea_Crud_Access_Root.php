 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysSecurityArea_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysSecurityArea_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysSecurityArea_Entity */
      $entity = $orm->get( 'WbfsysSecurityArea', $rootId );
    }
...
}//end class WbfsysSecurityArea_Crud_Access_Root
