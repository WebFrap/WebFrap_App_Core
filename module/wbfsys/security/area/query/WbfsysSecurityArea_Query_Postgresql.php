 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_security_area where rowid > 0;
SQL;
  ...
  WHERE
    upper(wbfsys_security_area.label) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysSecurityArea_Query_Postgresql
