 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysSecurityArea_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysSecurityArea_Export_Listing_Access';
    ...
    // create a new WbfsysSecurityArea window
    $view = $this->loadView
    (
    	'export-wbfsys_security_area',
    	'WbfsysSecurityArea_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysSecurityArea_Export' );
...
} // end class WbfsysSecurityArea_Export_Controller_Genf
