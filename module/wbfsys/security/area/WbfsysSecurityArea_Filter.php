 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_security_area') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_security_area.{$fieldName}
...
}//end class WbfsysSecurityArea_Filter
