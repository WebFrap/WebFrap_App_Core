 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityArea_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysSecurityArea_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/security_area/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Security Areas',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.SecurityArea.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_area-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysSecurityArea_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.SecurityArea.create&amp;ltype=table');
    });
...
}//end class WbfsysSecurityArea_Table_Maintab_View
