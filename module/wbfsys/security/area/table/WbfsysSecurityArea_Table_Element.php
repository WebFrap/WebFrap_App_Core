  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.SecurityArea_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.security_area.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.SecurityAreaType.listing" >'.Validator::sanitizeHtml($row['wbfsys_security_area_type_name']).'</a></td>'.NL;
