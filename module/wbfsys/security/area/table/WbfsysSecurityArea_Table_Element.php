 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_area';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysSecurityArea_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityArea.show&amp;target_mask=WbfsysSecurityArea&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityArea.edit&amp;target_mask=WbfsysSecurityArea&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_area.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Access',
            'modal.php?c=Wbfsys.SecurityArea_Ref_Access.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.security_area.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityArea.delete&amp;target_mask=WbfsysSecurityArea&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_area.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_security_area&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.security_area.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.security_area.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.security_area.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_security_area_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.SecurityArea.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_label'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.SecurityAreaType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_area_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.SecurityArea_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Security Areas." >{$iconDelete} Delete selected Security Areas</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Security Areas. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.SecurityArea_Multi.deleteAll" >{$iconClean} Delete all Security Areas</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysSecurityArea_Table_Element
