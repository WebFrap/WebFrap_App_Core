 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Security Areas
  *
  ...
  *  }
  *
  * @return WbfsysSecurityArea_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityArea_Table_Element( 'tableWbfsysSecurityArea', $view );
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysSecurityArea_Table_Element( null,$view );
...
}//end class WbfsysSecurityArea_Table_Ui
