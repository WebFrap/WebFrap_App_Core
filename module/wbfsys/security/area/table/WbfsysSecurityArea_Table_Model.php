 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    if( $data['wbfsys_security_area']->id_type )
    {
      $valWbfsysSecurityAreaType = $orm->getField
      (
        'WbfsysSecurityAreaType',
        'rowid = '.$data['wbfsys_security_area']->id_type,
        'name'
      );
      $tabData['wbfsys_security_area_type_name'] = $valWbfsysSecurityAreaType;
    }
    else
    {
      // else just set an empty string, fastest way ;-)
      $tabData['wbfsys_security_area_type_name'] = '';
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysSecurityArea_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysSecurityArea_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysSecurityArea_Table_Model
