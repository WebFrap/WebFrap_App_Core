 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_security_area
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.SecurityArea.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_security_area-create';

    $access = new WbfsysSecurityArea_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_security_area-create',
      'WbfsysSecurityArea_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysSecurityArea_Crud_Model */
    $model = $this->loadModel( 'WbfsysSecurityArea_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.SecurityArea.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysSecurityArea = $model->getEntityWbfsysSecurityArea( $objid );
    ...
    $params->entity = $entityWbfsysSecurityArea;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_security_area:edit';

    $access = new WbfsysSecurityArea_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityArea );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_security_area-edit-'.$objid,
      'WbfsysSecurityArea_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_security_area-edit',
          $entityWbfsysSecurityArea,
          'Edit Security Area :'.$entityWbfsysSecurityArea->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_security_area';
      $params->maskRoot      = 'wbfsys_security_area:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_security_area';
      $params->aclNode       = 'mgmt-wbfsys_security_area';
      $params->aclLevel      = 1;
    }
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_security_area-show',
          $entityWbfsysSecurityArea,
          'Show Security Area :'.$entityWbfsysSecurityArea->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_security_area
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.SecurityArea.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-insert';

    $access = new WbfsysSecurityArea_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysSecurityArea = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_security_area-update-'.$entityWbfsysSecurityArea;
      ...
      {
        $access = new WbfsysSecurityArea_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityArea );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysSecurityArea';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_security_area',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysSecurityArea_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.SecurityArea.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysSecurityArea, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysSecurityArea_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.SecurityArea.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-delete-'.$objid;

    $access = new WbfsysSecurityArea_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysSecurityArea );
    ...
    $error = $model->delete( $entityWbfsysSecurityArea, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysSecurityArea, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.SecurityArea.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.SecurityArea.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-listing';
    ...
    $containerClass = 'WbfsysSecurityArea_'.$listType.'_Access';
    ...
    /* @var $model WbfsysSecurityArea_Table_Model */
    $model = $this->loadModel( 'WbfsysSecurityArea_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_security_area-'.$params->ltype,
          'WbfsysSecurityArea',
          'List of Security Areas'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysSecurityArea
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysSecurityArea_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_security_area',
      'WbfsysSecurityArea_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysSecurityArea_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.SecurityArea.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityArea_Selection_Model */
    $model   = $this->loadModel( 'WbfsysSecurityArea_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_security_area-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_security_area-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_security_area',
      'WbfsysSecurityArea',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysSecurityArea, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysSecurityArea_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysSecurityArea_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysSecurityArea_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysSecurityArea, $params );
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    if( !$acl->access( 'mod-wbfsys>mgmt-wbfsys_security_area:listing'  ) )
    {
      // ausgabe einer fehlerseite und adieu
      throw new InvalidRequest_Exception
      (
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_security_area-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_security_area-ajax', 
    	'WbfsysSecurityArea',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_security_area' ); //def wbfsys_security_area
...
} // end class WbfsysSecurityArea_Controller */
