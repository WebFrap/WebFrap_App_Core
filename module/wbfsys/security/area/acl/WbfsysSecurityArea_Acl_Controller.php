 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysSecurityArea
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysSecurityArea_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_security_area_acl_listing',
      'WbfsysSecurityArea_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysSecurityArea_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityArea_Acl_Model */
    $model   = $this->loadModel( 'WbfsysSecurityArea_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_security_area-acl',
    	'WbfsysSecurityArea_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_security_area_acl_masks_listing',
      'WbfsysSecurityArea_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysSecurityArea_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysSecurityArea_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityArea_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysSecurityArea_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysSecurityArea_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysSecurityArea_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_security_area-acl-qfdu',
    	'WbfsysSecurityArea_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysSecurityArea_Acl_Controller */
