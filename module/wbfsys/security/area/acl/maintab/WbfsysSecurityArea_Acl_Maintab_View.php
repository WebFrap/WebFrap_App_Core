 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.SecurityArea_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_area-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.SecurityArea_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_security_area-acl-update';
    ...
    $this->setTemplate( 'wbfsys/security_area/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Security Area', 'wbfsys.security_area.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_security_area_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysSecurityArea_Acl' );
...
} // end class WbfsysSecurityArea_Acl_Maintab_View */
