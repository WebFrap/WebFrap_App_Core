 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_security_area_acl_graph', 
      'WbfsysSecurityArea_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysSecurityArea_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysSecurityArea_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysSecurityArea_Acl_Path_Maintab_View  */
...
} // end class WbfsysSecurityArea_Acl_Path_Controller */
