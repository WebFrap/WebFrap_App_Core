 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_security_area.label) like upper('{$safeVal}%') ";
    }
  ...
  SELECT
    ...
    wbfsys_security_area.label as value,
    wbfsys_security_area.label as label
  FROM
...
} // end class WbfsysSecurityArea_Acl_Qfdu_Query_Postgresql */
