 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_security_area.label as "wbfsys_security_area_label"',
      'wbfsys_security_area.rowid as "wbfsys_security_area_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_security_area on wbfsys_group_users.vid = wbfsys_security_area.rowid'
    );
          ...
          foreach( $parts as $part )
          {
            ...
            (
              '(
                ...
                OR
            (  upper(wbfsys_security_area.label) like upper(\''.$part.'%\') )
...
} // end class WbfsysSecurityArea_Acl_Qfdu_Treetable_Query_Postgresql */
