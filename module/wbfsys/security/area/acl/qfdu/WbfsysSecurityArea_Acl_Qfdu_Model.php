 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_security_area')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysSecurityArea = $orm->get('WbfsysSecurityArea', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_security_area_label']  = $refEntityWbfsysSecurityArea->label;

    }
    $tabData['wbfsys_security_area_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysSecurityArea_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityArea_Acl' );
    /* @var $query WbfsysSecurityArea_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityArea_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysSecurityArea_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityArea_Acl_Qfdu' );
    /* @var $query WbfsysSecurityArea_Acl_Qfdu_Query  */
...
} // end class WbfsysSecurityArea_Acl_Qfdu_Model */
