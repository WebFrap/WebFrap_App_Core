 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysSecurityArea_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_security_area-acl-qfdu-aAjax',
      'WbfsysSecurityArea_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysSecurityArea_Acl_Qfdu_Controller */
