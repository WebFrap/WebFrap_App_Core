 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Maintab_Menu
  extends WgtDropmenu
{////////////////////////////////////////////////////////////////////////////////
// build methodes
////////////////////////////////////////////////////////////////////////////////
    ...
    <span>
      <ul>
        <li><a 
          ...
          href="modal.php?c=Wbfsys.SecurityArea_Maintenance.help&amp;refer=wbfsys_security_area-acl-dset" >{$iconHelp} Help</a>
        </li>
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Issue.create&amp;refer=wbfsys_security_area-acl-dset" >{$iconBug} Bug</a>
        </li>
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Faq.create&amp;refer=wbfsys_security_area-acl-dset" >{$iconFaq} Faq</a>
        </li>
      </ul>
    </span>
  </li>
...
HTML;
  ...
  public function addMenuLogic( $view, $objid, $params  )
  {
    ...
    self.getObject().find(".wgtac_mask_entity_rights").click(function(){
      ...
      self.close( );
      \$R.get( 'maintab.php?c=Wbfsys.SecurityArea_Acl_Dset.listing&objid={$objid}' );
    });
...
} // end class WbfsysSecurityArea_Acl_Dset_Maintab_Menu */
