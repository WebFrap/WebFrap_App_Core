 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysSecurityArea_Acl_Dset' );
    ...
    $entityWbfsysSecurityArea = $this->model->getEntity( $dsetId );
...
} // end class WbfsysSecurityArea_Acl_Dset_Ajax_View */
