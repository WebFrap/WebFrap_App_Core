 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysSecurityArea_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysSecurityArea_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysSecurityArea, $areaId, $access, $params  )
  {

    $listObj = new WbfsysSecurityArea_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_security_area-acl-dset' );
    ...
    else
    {
      ...
      (
        'Security Area "{@label@}" User Access',
        'wbfsys.security_area.label',
        array
        (
          'label' => $entityWbfsysSecurityArea->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_security_area_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysSecurityArea_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysSecurityArea_Acl_Dset_Ui */
