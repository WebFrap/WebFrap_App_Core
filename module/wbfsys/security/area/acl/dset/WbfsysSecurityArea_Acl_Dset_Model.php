 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_security_area'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysSecurityArea', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityArea_Acl_Dset' );
    /* @var $query WbfsysSecurityArea_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysSecurityArea_Acl_Dset_Treetable' );
    /* @var $query WbfsysSecurityArea_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysSecurityArea_Acl_Dset_Model */
