 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_security_area.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysSecurityArea_Acl_Dset_Treetable_Query_Postgresql */
