 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysSecurityArea_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysSecurityArea_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysSecurityArea = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysSecurityArea_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_security_area-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysSecurityArea, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysSecurityArea_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_security_area-acl-dset', 
    	'WbfsysSecurityArea_Acl_Dset',
...
} // end class WbfsysSecurityArea_Acl_Dset_Controller */
