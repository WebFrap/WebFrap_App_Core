 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityArea_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysSecurityArea_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityArea_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_security_area-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Security Area', 'wbfsys.security_area.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_security_area_acl';
...
} // end class WbfsysSecurityArea_Acl_Ui */
