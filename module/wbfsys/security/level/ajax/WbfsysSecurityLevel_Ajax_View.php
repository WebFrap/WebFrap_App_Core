 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysSecurityLevel, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysSecurityLevel, $params );
    }
    else
    {
...
}//end class WbfsysSecurityLevel_Ajax_View
