 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevelValue_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysSecurityLevelValue Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_security_level.level as id',
      'wbfsys_security_level.label as value'
     ));
      $criteria->selectAlso( 'wbfsys_security_level.level as "wbfsys_security_level-level-order"' );

    $criteria->from( 'wbfsys_security_level' );



      $criteria->orderBy( 'wbfsys_security_level.level ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_security_level.level = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_security_level.level IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysSecurityLevelValue_Selectbox_Query_Postgresql
