 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_security_level';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysSecurityLevel_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.SecurityLevel.show&amp;target_mask=WbfsysSecurityLevel&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.SecurityLevel.edit&amp;target_mask=WbfsysSecurityLevel&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.security_level.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.SecurityLevel.delete&amp;target_mask=WbfsysSecurityLevel&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.security_level.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.security_level.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_security_level_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.SecurityLevel.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_security_level_label'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.SecurityLevel_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Security Levels." >{$iconDelete} Delete selected Security Levels</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Security Levels. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.SecurityLevel_Multi.deleteAll" >{$iconClean} Delete all Security Levels</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysSecurityLevel_Table_Element
