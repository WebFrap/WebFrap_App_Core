 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysSecurityLevel_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_security_level.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_security_level.rowid ",
      'acls'
    );
...
}//end class WbfsysSecurityLevel_Table_Access
