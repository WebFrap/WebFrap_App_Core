 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Security Levels
  *
  ...
  *  }
  *
  * @return WbfsysSecurityLevel_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysSecurityLevel_Table_Element( 'tableWbfsysSecurityLevel', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_security_level-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Security Levels', 'wbfsys.security_level.label' );
      //$tabPanel->searchKey = 'wbfsys_security_level';
      ...
      $searchElement->searchKey = 'wbfsys_security_level';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysSecurityLevel_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysSecurityLevel', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysSecurityLevel listing maske
   *
   * @param WbfsysSecurityLevel_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysSecurityLevel  = $model->getEntityWbfsysSecurityLevel();
    ...
    $formWbfsysSecurityLevel->setKeyName( 'wbfsys_security_level' );
...
}//end class WbfsysSecurityLevel_Table_Ui
