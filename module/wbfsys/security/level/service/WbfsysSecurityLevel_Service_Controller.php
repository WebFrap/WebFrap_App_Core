 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Service_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    if( !$this->acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:listing'  ) )
    {
    ...
    $params->contextKey = 'wbfsys_security_level-service-autocomplete';

    $view  = $response->loadView
    ( 
    	'wbfsys_security_level-service',
    	'WbfsysSecurityLevel_Service',
    	'displayAutocomplete',
    	View::AJAX 
    );
    
    
    $model  = $this->loadModel( 'WbfsysSecurityLevel_Service' );
...
}//end class WbfsysSecurityLevel_Service_Controller
