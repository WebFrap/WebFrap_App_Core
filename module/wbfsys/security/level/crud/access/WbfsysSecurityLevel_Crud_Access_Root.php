 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysSecurityLevel_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysSecurityLevel_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysSecurityLevel_Entity */
      $entity = $orm->get( 'WbfsysSecurityLevel', $rootId );
    }
...
}//end class WbfsysSecurityLevel_Crud_Access_Root
