 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysSecurityLevel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityLevel = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Security Level: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityLevel.edit&amp;utf8=✓&amp;objid='.$entityWbfsysSecurityLevel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityLevel.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_level-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_level/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysSecurityLevel_Crud_Edit' );
...
}//end class WbfsysSecurityLevel_Crud_Edit_Maintab_View
