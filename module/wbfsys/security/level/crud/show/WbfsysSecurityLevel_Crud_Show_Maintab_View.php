 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysSecurityLevel_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysSecurityLevel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysSecurityLevel = $this->model->getEntityWbfsysSecurityLevel();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Security Level: {@text@}',
      'wbfsys.security_level.label',
      array( 'text' => $entityWbfsysSecurityLevel->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.SecurityLevel.show  &amp;objid='.$entityWbfsysSecurityLevel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.SecurityLevel.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_security_level-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/security_level/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysSecurityLevel_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.SecurityLevel.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_level' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_security_level a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.SecurityLevel.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.SecurityLevel.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysSecurityLevel_Crud_Show_Maintab_View
