 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysSecurityLevel entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.SecurityLevel.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityLevel.insert';
    $params->formId       = 'wgt-form-wbfsys_security_level';
    $params->namespace   = 'wbfsys_security_level-create';
    ...
    $this->setTemplate( 'wbfsys/security_level/modal/crud/form_create' );
...
}//end class WbfsysSecurityLevel_Crud_Create_Modal_View
