 ...
 * @licence WebFrap.net
 */
class WbfsysSecurityLevel_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysSecurityLevel Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_security_level-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/security_level/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.SecurityLevel.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_security_level';
    ...
    $form = $this->newForm( 'WbfsysSecurityLevel_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.SecurityLevel.create');}});
});
...
}//end class WbfsysSecurityLevel_Crud_Create_Maintab_View
