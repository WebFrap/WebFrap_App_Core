 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUniverse_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUniverse_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUniverse_Selection_Element
    (
      'selectionWbfsysUniverse',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Universes', 'wbfsys.universe.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Universe.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUniverse',
      'WbfsysUniverse_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUniverse_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUniverse_Selection_Ui
