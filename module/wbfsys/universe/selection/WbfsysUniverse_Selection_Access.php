 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUniverse_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_universe.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_universe.rowid ",
      'acls'
    );
...
}//end class WbfsysUniverse_Selection_Access
