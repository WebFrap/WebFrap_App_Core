 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_universe';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Universe.show&amp;target_mask=WbfsysUniverse&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Universe.edit&amp;target_mask=WbfsysUniverse&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.universe.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Universe.delete&amp;target_mask=WbfsysUniverse&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.universe.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_universe_name'])).'</td>'.NL;
...
}//end class WbfsysUniverse_Selection_Element
