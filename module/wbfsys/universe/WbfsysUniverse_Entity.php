 ...
 *
 * Entity Class for the Database Table wbfsys_universe
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_universe';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Universe.show';
  ...
  */
  public static $entityName  = 'WbfsysUniverse';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'wbfsys.universe.message.error_def_name',
      'wrong'   => 'wbfsys.universe.message.error_wrong_name',
      'max'     => 'wbfsys.universe.message.error_max_name',
      'min'     => 'wbfsys.universe.message.error_min_name',
    ),

    'description' => array
    (
      'default' => 'wbfsys.universe.message.error_def_description',
      'wrong'   => 'wbfsys.universe.message.error_wrong_description',
      'max'     => 'wbfsys.universe.message.error_max_description',
      'min'     => 'wbfsys.universe.message.error_min_description',
    ),

    'id_mandant' => array
    (
      'default' => 'wbfsys.universe.message.error_def_id_mandant',
      'wrong'   => 'wbfsys.universe.message.error_wrong_id_mandant',
      'max'     => 'wbfsys.universe.message.error_max_id_mandant',
      'min'     => 'wbfsys.universe.message.error_min_id_mandant',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.universe.message.error_def_rowid',
      'wrong'   => 'wbfsys.universe.message.error_wrong_rowid',
      'empty'   => 'wbfsys.universe.message.error_empty_rowid',
      'max'     => 'wbfsys.universe.message.error_max_rowid',
      'min'     => 'wbfsys.universe.message.error_min_rowid',
    ),
  );

}//end class WbfsysUniverse_Entity
