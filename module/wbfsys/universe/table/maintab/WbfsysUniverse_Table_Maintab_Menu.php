 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new Universe"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_universe-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_universe-table-help hidden" >
    	      
<p>This is the Universe table.</p>
...
HTML;
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolEntity&dkey=wbfsys_universe" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
      </li>


      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsEntity&dkey=wbfsys_universe" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
      </li>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_universe-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysUniverse_Table_Maintab_Menu
