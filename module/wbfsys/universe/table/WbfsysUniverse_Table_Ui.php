...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Universes
  *
  ...
  *  }
  *
  * @return WbfsysUniverse_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUniverse_Table_Element( 'tableWbfsysUniverse', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_universe-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Universes', 'wbfsys.universe.label' );
      //$tabPanel->searchKey = 'wbfsys_universe';
      ...
      $searchElement->searchKey = 'wbfsys_universe';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUniverse_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUniverse', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUniverse listing maske
   *
   * @param WbfsysUniverse_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUniverse  = $model->getEntityWbfsysUniverse();
    ...
    $formWbfsysUniverse->setKeyName( 'wbfsys_universe' );
...
}//end class WbfsysUniverse_Table_Ui
