 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUniverse_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUniverse_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUniverse_Entity */
      $entity = $orm->get( 'WbfsysUniverse', $rootId );
    }
...
}//end class WbfsysUniverse_Crud_Access_Root
