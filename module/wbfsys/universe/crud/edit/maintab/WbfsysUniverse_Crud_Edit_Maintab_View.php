 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUniverse Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUniverse = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Universe.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUniverse
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Universe.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_universe-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/universe/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUniverse_Crud_Edit' );
...
}//end class WbfsysUniverse_Crud_Edit_Maintab_View
