 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUniverse Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUniverse = $this->model->getEntityWbfsysUniverse();
    ...
    (
      ...
      array( 'text' => $entityWbfsysUniverse->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Universe.show  &amp;objid='.$entityWbfsysUniverse
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Universe.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_universe-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/universe/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUniverse_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Universe.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_universe' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_universe a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Universe.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Universe.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUniverse_Crud_Show_Maintab_View
