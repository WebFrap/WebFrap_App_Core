 ...
 * @licence WebFrap.net
 */
class WbfsysUniverse_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUniverse entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Universe.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Universe.insert';
    $params->formId       = 'wgt-form-wbfsys_universe';
    $params->namespace   = 'wbfsys_universe-create';
    ...
    $this->setTemplate( 'wbfsys/universe/modal/crud/form_create' );
...
}//end class WbfsysUniverse_Crud_Create_Modal_View
