...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Bans
  *
  ...
  *  }
  *
  * @return WbfsysBan_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBan_Table_Element( 'tableWbfsysBan', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_ban-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Bans', 'wbfsys.ban.label' );
      //$tabPanel->searchKey = 'wbfsys_ban';
      ...
      $searchElement->searchKey = 'wbfsys_ban';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysBan_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysBan', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysBan listing maske
   *
   * @param WbfsysBan_Table_Model $model
   * @param TFlag $params
   * @return void
   */
