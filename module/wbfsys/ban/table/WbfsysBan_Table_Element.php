...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_ban';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysBan_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Ban.show&amp;target_mask=WbfsysBan&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.ban.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Ban.edit&amp;target_mask=WbfsysBan&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.ban.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Ban.delete&amp;target_mask=WbfsysBan&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.ban.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.ban.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.BanStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_ban_status_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Ban_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Bans." >{$iconDelete} Delete selected Bans</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Bans. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Ban_Multi.deleteAll" >{$iconClean} Delete all Bans</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysBan_Table_Element
