 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für ban Status
  *
  ...
  *  }
  *
  * @return WbfsysBanStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBanStatus_Table_Element( 'tableWbfsysBanStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_ban_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'ban Status', 'wbfsys.ban_status.label' );
      //$tabPanel->searchKey = 'wbfsys_ban_status';
      ...
      $searchElement->searchKey = 'wbfsys_ban_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysBanStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysBanStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysBanStatus listing maske
   *
   * @param WbfsysBanStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysBanStatus  = $model->getEntityWbfsysBanStatus();
    ...
    $formWbfsysBanStatus->setKeyName( 'wbfsys_ban_status' );
...
}//end class WbfsysBanStatus_Table_Ui
