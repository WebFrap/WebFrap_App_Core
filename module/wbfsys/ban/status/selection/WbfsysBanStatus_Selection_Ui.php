 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysBanStatus_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysBanStatus_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBanStatus_Selection_Element
    (
      'selectionWbfsysBanStatus',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection ban Status', 'wbfsys.ban_status.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.BanStatus.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysBanStatus',
      'WbfsysBanStatus_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysBanStatus_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysBanStatus_Selection_Ui
