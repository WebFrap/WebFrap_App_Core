 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysBanStatus_Selection_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_ban_status.rowid ",
      'acls'
    );
...
}//end class WbfsysBanStatus_Selection_Access
