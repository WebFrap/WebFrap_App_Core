 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysBanStatus_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysBanStatus_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/ban_status/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'ban Status', 'wbfsys.ban_status.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.BanStatus.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_ban_status-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysBanStatus_Selection' );
...
}//end class WbfsysBanStatus_Selection_Modal_View
