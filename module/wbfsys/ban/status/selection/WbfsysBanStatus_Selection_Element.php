 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_ban_status';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.BanStatus.show&amp;target_mask=WbfsysBanStatus&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.BanStatus.edit&amp;target_mask=WbfsysBanStatus&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.ban_status.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.BanStatus.delete&amp;target_mask=WbfsysBanStatus&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.ban_status.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_ban_status_name'])).'</td>'.NL;
...
}//end class WbfsysBanStatus_Selection_Element
