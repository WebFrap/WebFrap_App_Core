 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_ban_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysBanStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysBanStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysBanStatusI18n';
   ...
   *
   * @var WbfsysBanStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysBanStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysBanStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysBanStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.ban_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_ban_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_ban_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysBanStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysBanStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysBanStatus is missing');
      ...
      //p: Window
      $objidWbfsysBanStatus = $this->entity->getData('id_wbfsys_ban_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysBanStatus
          || !$entityWbfsysBanStatus = $this->db->orm->get
          (
            'WbfsysBanStatus',
            $objidWbfsysBanStatus
          )
      ...
      {
        $entityWbfsysBanStatus = $this->db->orm->newEntity( 'WbfsysBanStatus' );
      }

      $inputIdWbfsysBanStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysBanStatus', 'Window' );
      $inputIdWbfsysBanStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_ban_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_ban_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Ban Status (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysBanStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysBanStatus->setWidth( 'medium' );

      $inputIdWbfsysBanStatus->setData( $this->entity->getData( 'id_wbfsys_ban_status' )  );
      $inputIdWbfsysBanStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_ban_status' ) );
      $inputIdWbfsysBanStatus->setLabel( $this->view->i18n->l( 'Wbfsys Ban Status', 'wbfsys.ban_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.BanStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_ban_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysBanStatus->setListUrl ( $listUrl );
      $inputIdWbfsysBanStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysBanStatus->setEntityUrl( 'maintab.php?c=Wbfsys.BanStatus.edit' );
      $inputIdWbfsysBanStatus->conEntity         = $entityWbfsysBanStatus;
      $inputIdWbfsysBanStatus->refresh           = $this->refresh;
      $inputIdWbfsysBanStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysBanStatus->view = $this->view;
      $inputIdWbfsysBanStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_ban_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysBanStatus );
  ...
  }//end public function input_id_wbfsys_ban_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.ban_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.ban_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.ban_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.ban_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.ban_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.ban_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.ban_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.ban_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.ban_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Ban Status I18n)', 'wbfsys.ban_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_ban_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_ban_status_i18n_m_role_change';
...
}//end class WbfsysBanStatusI18n_Form */
