 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysBanStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBanStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit ban Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.BanStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysBanStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.BanStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ban_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ban_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysBanStatus_Crud_Edit' );
...
}//end class WbfsysBanStatus_Crud_Edit_Maintab_View
