 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysBanStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysBanStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysBanStatus_Entity */
      $entity = $orm->get( 'WbfsysBanStatus', $rootId );
    }
...
}//end class WbfsysBanStatus_Crud_Access_Root
