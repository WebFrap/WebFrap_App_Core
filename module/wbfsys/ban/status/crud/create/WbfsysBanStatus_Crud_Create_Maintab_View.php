 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysBanStatus Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_ban_status-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/ban_status/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.BanStatus.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_ban_status';
    ...
    $form = $this->newForm( 'WbfsysBanStatus_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.BanStatus.create');}});
});
...
}//end class WbfsysBanStatus_Crud_Create_Maintab_View
