 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysBanStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.BanStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.BanStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_ban_status';
    $params->namespace   = 'wbfsys_ban_status-create';
    ...
    $this->setTemplate( 'wbfsys/ban_status/modal/crud/form_create' );
...
}//end class WbfsysBanStatus_Crud_Create_Modal_View
