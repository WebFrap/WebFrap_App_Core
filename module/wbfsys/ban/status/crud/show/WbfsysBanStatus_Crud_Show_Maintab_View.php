 ...
 * @licence WebFrap.net
 */
class WbfsysBanStatus_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysBanStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBanStatus = $this->model->getEntityWbfsysBanStatus();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show ban Status: {@text@}',
      'wbfsys.ban_status.label',
      array( 'text' => $entityWbfsysBanStatus->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.BanStatus.show  &amp;objid='.$entityWbfsysBanStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.BanStatus.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ban_status-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ban_status/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysBanStatus_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.BanStatus.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ban_status' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ban_status a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.BanStatus.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.BanStatus.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysBanStatus_Crud_Show_Maintab_View
