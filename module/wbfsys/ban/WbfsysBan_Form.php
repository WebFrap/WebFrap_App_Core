...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysBan' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysBan entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function input_id_role( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputIdRole = $this->view->newInput( 'input'.$this->prefix.'IdRole', 'Window' );
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Role (Ban)', 'wbfsys.ban.label' ),
      ));
      ...
      $inputIdRole->setLabel( $this->view->i18n->l( 'Role', 'wbfsys.ban.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_role'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdRole->buildJavascript( 'wgt-input-'.$this->keyName.'_id_role'.($this->suffix?'-'.$this->suffix:'') );
  ...
  */
  public function input_id_status( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysBanStatus_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdStatus = $this->view->newItem( 'input'.$this->prefix.'IdStatus' , 'WbfsysBanStatus_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Status (Ban)', 'wbfsys.ban.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Status', 'wbfsys.ban.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputIdStatus->editUrl = 'index.php?c=Wbfsys.BanStatus.listing&amp;target='.$this->namespace.'&amp;field=id_status&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_status'.$this->suffix;
      }
  ...
  * @return void
  */
  public function input_ban_from( $params )
  {

      //tpl: class ui:timestamp
      $inputBanFrom = $this->view->newInput( 'input'.$this->prefix.'BanFrom' , 'Timestamp' );
      $this->items['ban_from'] = $inputBanFrom;
      $inputBanFrom->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[ban_from]',
          'id'        => 'wgt-input-'.$this->keyName.'_ban_from'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Ban From (Ban)', 'wbfsys.ban.label' ),
          'maxlength' => $this->entity->maxSize( 'ban_from' ),
        )
      );
      $inputBanFrom->setWidth( 'medium' );

      $inputBanFrom->setReadOnly( $this->isReadOnly( 'ban_from' ) );
      $inputBanFrom->setData( $this->entity->getTimestamp( 'ban_from' ) );
      $inputBanFrom->setLabel
      (
        $this->view->i18n->l( 'Ban From', 'wbfsys.ban.label' ),
        $this->entity->required( 'ban_from' )
      );
  ...
  }//end public function input_ban_from */
  ...
  * @return void
  */
  public function input_ban_till( $params )
  {

      //tpl: class ui:timestamp
      $inputBanTill = $this->view->newInput( 'input'.$this->prefix.'BanTill' , 'Timestamp' );
      $this->items['ban_till'] = $inputBanTill;
      $inputBanTill->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[ban_till]',
          'id'        => 'wgt-input-'.$this->keyName.'_ban_till'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Ban Till (Ban)', 'wbfsys.ban.label' ),
          'maxlength' => $this->entity->maxSize( 'ban_till' ),
        )
      );
      $inputBanTill->setWidth( 'medium' );

      $inputBanTill->setReadOnly( $this->isReadOnly( 'ban_till' ) );
      $inputBanTill->setData( $this->entity->getTimestamp( 'ban_till' ) );
      $inputBanTill->setLabel
      (
        $this->view->i18n->l( 'Ban Till', 'wbfsys.ban.label' ),
        $this->entity->required( 'ban_till' )
      );
  ...
  }//end public function input_ban_till */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Ban)', 'wbfsys.ban.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.ban.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Ban)', 'wbfsys.ban.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.ban.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Ban)', 'wbfsys.ban.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.ban.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Ban)', 'wbfsys.ban.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.ban.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Ban)', 'wbfsys.ban.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.ban.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Ban)', 'wbfsys.ban.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.ban.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Ban)', 'wbfsys.ban.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.ban.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysBanStatus_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Status (Ban)', 'wbfsys.ban.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_ban_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_ban_m_role_change';
