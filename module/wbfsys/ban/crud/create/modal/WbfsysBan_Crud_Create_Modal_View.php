 ...
 * @licence WebFrap.net
 */
class WbfsysBan_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysBan entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Ban.insert';
    $params->formId       = 'wgt-form-wbfsys_ban';
    $params->namespace   = 'wbfsys_ban-create';
    ...
    $this->setTemplate( 'wbfsys/ban/modal/crud/form_create' );
...
}//end class WbfsysBan_Crud_Create_Modal_View
