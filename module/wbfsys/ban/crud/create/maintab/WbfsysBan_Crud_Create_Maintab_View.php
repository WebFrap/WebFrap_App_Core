 ...
 * @licence WebFrap.net
 */
class WbfsysBan_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysBan Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_ban-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/ban/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Ban.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_ban';
    ...
    $form = $this->newForm( 'WbfsysBan_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Ban.create');}});
});
...
}//end class WbfsysBan_Crud_Create_Maintab_View
