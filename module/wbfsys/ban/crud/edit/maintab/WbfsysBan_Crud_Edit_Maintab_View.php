 ...
 * @licence WebFrap.net
 */
class WbfsysBan_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysBan Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBan = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Ban.edit&amp;utf8=✓&amp;objid='.$entityWbfsysBan
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Ban.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ban-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ban/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysBan_Crud_Edit' );
...
}//end class WbfsysBan_Crud_Edit_Maintab_View
