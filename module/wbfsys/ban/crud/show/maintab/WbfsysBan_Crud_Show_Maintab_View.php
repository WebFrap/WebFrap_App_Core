 ...
 * @licence WebFrap.net
 */
class WbfsysBan_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysBan Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBan = $this->model->getEntityWbfsysBan();
    ...
    (
      'Show Ban: {@text@}',
      'wbfsys.ban.label',
      array( 'text' => $entityWbfsysBan->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Ban.show  &amp;objid='.$entityWbfsysBan
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Ban.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ban-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ban/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysBan_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Ban.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ban' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ban a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Ban.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Ban.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysBan_Crud_Show_Maintab_View
