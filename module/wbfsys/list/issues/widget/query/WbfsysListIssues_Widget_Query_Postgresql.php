 ...
 * @licence WebFrap.net
 */
class WbfsysListIssues_Widget_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
 ...
 wbfsys_issue.rowid = \''.$part.'\'  or 
  ...
  public function appendFilter( $criteria, $condition, $params  )
  {
    ...
    if( isset( $condition['filters']['new_issues'] ) )
    {
      ...
      ( 
        'WbfsysListIssues_Widget_Table_NewIssues' 
      );
    ...
    if( isset( $condition['filters']['closed_issues'] ) )
    {
      ...
      ( 
        'WbfsysListIssues_Widget_Table_ClosedIssues' 
      );
    ...
    if( isset( $condition['filters']['my_assigned_issued'] ) )
    {
      ...
      ( 
        'WbfsysListIssues_Widget_Table_MyAssignedIssued' 
      );
    ...
    if( isset( $condition['filters']['my_created_issued'] ) )
    {
      ...
      ( 
        'WbfsysListIssues_Widget_Table_MyCreatedIssued' 
      );
...
}// end class WbfsysListIssues_Widget_Query_Postgresql
