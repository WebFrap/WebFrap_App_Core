 ...
 * @licence WebFrap.net
 */
class WbfsysListIssues_Widget_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryData( $params )
  {
    ...
    // if we have a value, try to load the display field (codeTableRefFields 4)
    if( $data['wbfsys_issue']->id_priority )
    {
      $valWbfsysPriority = $orm->getField
      (
        'WbfsysPriority',
        'rowid = '.$data['wbfsys_issue']->id_priority,
        'name'
      );
...
}// end class WbfsysListIssues_Widget_Table_Model
