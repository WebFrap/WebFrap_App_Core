 ...
 * @licence WebFrap.net
 */
class WbfsysListIssues_Widget_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysListIssues_Widget_Table_Element( null, $view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysListIssues', $table->buildAjax() );
...
WGTJS;
   ...
   *
   * @param WbfsysIssue_Widget_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}// end class WbfsysListIssues_Widget_Table_Ui
