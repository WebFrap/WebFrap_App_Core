 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysVrefFileType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysVrefFileType_Export_Listing_Access';
    ...
    // create a new WbfsysVrefFileType window
    $view = $this->loadView
    (
    	'export-wbfsys_vref_file_type',
    	'WbfsysVrefFileType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysVrefFileType_Export' );
...
} // end class WbfsysVrefFileType_Export_Controller_Genf
