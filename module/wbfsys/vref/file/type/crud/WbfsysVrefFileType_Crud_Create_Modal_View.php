 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysVrefFileType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.VrefFileType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VrefFileType.insert';
    $params->formId       = 'wgt-form-wbfsys_vref_file_type';
    $params->namespace   = 'wbfsys_vref_file_type-create';
    ...
    $this->setTemplate( 'wbfsys/vref_file_type/modal/crud/form_create' );
...
}//end class WbfsysVrefFileType_Crud_Create_Modal_View
