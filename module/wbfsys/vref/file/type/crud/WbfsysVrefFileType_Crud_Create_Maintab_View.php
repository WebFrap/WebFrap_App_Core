 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysVrefFileType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_vref_file_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/vref_file_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.VrefFileType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_vref_file_type';
    ...
    $form = $this->newForm( 'WbfsysVrefFileType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.VrefFileType.create');}});
});
...
}//end class WbfsysVrefFileType_Crud_Create_Maintab_View
