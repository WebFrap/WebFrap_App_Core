 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysVrefFileType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysVrefFileType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysVrefFileType_Entity */
      $entity = $orm->get( 'WbfsysVrefFileType', $rootId );
    }
...
}//end class WbfsysVrefFileType_Crud_Access_Root
