 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysVrefFileType_IdType( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysFileType_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.FileType.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysVrefFileType', array_keys( $this->fields['wbfsys_vref_file_type']), true ),
...
}//end class WbfsysVrefFileType_Crud_Create_Form */
