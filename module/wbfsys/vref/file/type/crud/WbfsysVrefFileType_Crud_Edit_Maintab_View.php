 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysVrefFileType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysVrefFileType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Vref File Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.VrefFileType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysVrefFileType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.VrefFileType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_vref_file_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/vref_file_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysVrefFileType_Crud_Edit' );
...
}//end class WbfsysVrefFileType_Crud_Edit_Maintab_View
