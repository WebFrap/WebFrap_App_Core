 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysVrefFileType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysVrefFileType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVrefFileType_Selection_Element
    (
      'selectionWbfsysVrefFileType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Vref File Types', 'wbfsys.vref_file_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.VrefFileType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysVrefFileType',
      'WbfsysVrefFileType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysVrefFileType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVrefFileType_Selection_Ui
