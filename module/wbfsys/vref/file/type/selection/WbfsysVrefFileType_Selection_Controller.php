 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysVrefFileType_Selection' ) );
...
} // end class WbfsysVrefFileType_Selection_Controller */
