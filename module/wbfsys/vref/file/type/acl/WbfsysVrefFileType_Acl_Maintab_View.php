 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.VrefFileType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_vref_file_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.VrefFileType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_vref_file_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/vref_file_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Vref File Type', 'wbfsys.vref_file_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_vref_file_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysVrefFileType_Acl' );
...
} // end class WbfsysVrefFileType_Acl_Maintab_View */
