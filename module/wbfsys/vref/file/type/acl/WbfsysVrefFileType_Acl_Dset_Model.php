 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_vref_file_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysVrefFileType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVrefFileType_Acl_Dset' );
    /* @var $query WbfsysVrefFileType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysVrefFileType_Acl_Dset_Treetable' );
    /* @var $query WbfsysVrefFileType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysVrefFileType_Acl_Dset_Model */
