 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_vref_file_type.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_vref_file_type.rowid as id,
    wbfsys_vref_file_type.rowid as value,
    wbfsys_vref_file_type.rowid as label
  FROM
...
} // end class WbfsysVrefFileType_Acl_Qfdu_Query_Postgresql */
