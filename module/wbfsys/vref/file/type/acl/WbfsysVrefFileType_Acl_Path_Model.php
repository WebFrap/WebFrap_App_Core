 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysVrefFileType_Acl_Path' );
    /* @var $query WbfsysVrefFileType_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysVrefFileType_Acl_Path');
    /* @var $dropQuery WbfsysVrefFileType_Acl_Path_Query  */
...
} // end class WbfsysVrefFileType_Acl_Path_Model */
