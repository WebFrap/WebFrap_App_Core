 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_vref_file_type_acl_graph', 
      'WbfsysVrefFileType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysVrefFileType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysVrefFileType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysVrefFileType_Acl_Path_Maintab_View  */
...
} // end class WbfsysVrefFileType_Acl_Path_Controller */
