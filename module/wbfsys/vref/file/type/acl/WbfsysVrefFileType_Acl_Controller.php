 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysVrefFileType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysVrefFileType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_vref_file_type_acl_listing',
      'WbfsysVrefFileType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysVrefFileType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysVrefFileType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysVrefFileType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_vref_file_type-acl',
    	'WbfsysVrefFileType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_vref_file_type_acl_masks_listing',
      'WbfsysVrefFileType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysVrefFileType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysVrefFileType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysVrefFileType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysVrefFileType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysVrefFileType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysVrefFileType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_vref_file_type-acl-qfdu',
    	'WbfsysVrefFileType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysVrefFileType_Acl_Controller */
