 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysVrefFileType_Acl_Dset' );
    ...
    $entityWbfsysVrefFileType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysVrefFileType_Acl_Dset_Ajax_View */
