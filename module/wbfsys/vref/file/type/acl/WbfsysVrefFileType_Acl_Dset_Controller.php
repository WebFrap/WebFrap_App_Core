 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysVrefFileType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysVrefFileType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysVrefFileType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysVrefFileType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_vref_file_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysVrefFileType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_vref_file_type-acl-dset', 
    	'WbfsysVrefFileType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysVrefFileType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_vref_file_type-acl-dset', 
    	'WbfsysVrefFileType_Acl_Dset',
...
} // end class WbfsysVrefFileType_Acl_Dset_Controller */
