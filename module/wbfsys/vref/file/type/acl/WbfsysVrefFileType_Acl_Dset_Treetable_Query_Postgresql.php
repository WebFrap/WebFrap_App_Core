 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_vref_file_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysVrefFileType_Acl_Dset_Treetable_Query_Postgresql */
