 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysVrefFileType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_vref_file_type-acl-qfdu-aAjax',
      'WbfsysVrefFileType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysVrefFileType_Acl_Qfdu_Controller */
