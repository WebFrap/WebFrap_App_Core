 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysVrefFileType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVrefFileType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_vref_file_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Vref File Type', 'wbfsys.vref_file_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_vref_file_type_acl';
...
} // end class WbfsysVrefFileType_Acl_Ui */
