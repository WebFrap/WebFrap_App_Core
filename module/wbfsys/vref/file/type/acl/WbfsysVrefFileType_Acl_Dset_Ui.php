 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysVrefFileType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysVrefFileType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysVrefFileType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysVrefFileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_vref_file_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'Vref File Type "{@label@}" User Access',
        'wbfsys.vref_file_type.label',
        array
        (
          'label' => $entityWbfsysVrefFileType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_vref_file_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysVrefFileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysVrefFileType_Acl_Dset_Ui */
