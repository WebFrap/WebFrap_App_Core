 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_vref_file_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_vref_file_type.{$fieldName}
...
}//end class WbfsysVrefFileType_Filter
