...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_vref_file_type';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysVrefFileType';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysVrefFileType' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysVrefFileType entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  */
  public function input_vid( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      $inputVid = $this->view->newInput( 'input'.$this->prefix.'Vid', 'Window' );
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Vid (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ));
      ...
      $inputVid->setLabel( $this->view->i18n->l( 'Vid', 'wbfsys.vref_file_type.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Entity.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_vid'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputVid->buildJavascript( 'wgt-input-'.$this->keyName.'_vid'.($this->suffix?'-'.$this->suffix:'') );
  ...
  */
  public function input_id_type( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysFileType_Entity' ) )
    {
      ...
      $inputIdType = $this->view->newInput( 'input'.$this->prefix.'IdType', 'Window' );
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Type (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ));
      ...
      $inputIdType->setLabel( $this->view->i18n->l( 'Type', 'wbfsys.vref_file_type.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.FileType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:'') );
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Vref File Type)', 'wbfsys.vref_file_type.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.vref_file_type.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.vref_file_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.vref_file_type.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.vref_file_type.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Vref File Type)', 'wbfsys.vref_file_type.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.vref_file_type.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Vref File Type)', 'wbfsys.vref_file_type.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.vref_file_type.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Vref File Type)', 'wbfsys.vref_file_type.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.vref_file_type.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_vref_file_type_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_vref_file_type_m_role_change';
...
}//end class WbfsysVrefFileType_Form */
