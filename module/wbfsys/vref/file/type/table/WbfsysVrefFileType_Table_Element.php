 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_vref_file_type';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.VrefFileType.show&amp;target_mask=WbfsysVrefFileType&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.VrefFileType.edit&amp;target_mask=WbfsysVrefFileType&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.vref_file_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.VrefFileType.delete&amp;target_mask=WbfsysVrefFileType&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.vref_file_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_vref_file_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.vref_file_type.label',
        Acl::ADMIN
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.VrefFileType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Vref File Types." >{$iconDelete} Delete selected Vref File Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Vref File Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.VrefFileType_Multi.deleteAll" >{$iconClean} Delete all Vref File Types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysVrefFileType_Table_Element
