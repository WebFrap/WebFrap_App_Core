 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysVrefFileType_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysVrefFileType_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/vref_file_type/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Vref File Types',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.VrefFileType.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.VrefFileType.search';

    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_vref_file_type-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysVrefFileType_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.VrefFileType.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.VrefFileType.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.VrefFileType.create&amp;ltype=table');
    });
...
}//end class WbfsysVrefFileType_Table_Maintab_View
