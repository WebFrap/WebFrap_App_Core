 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Vref File Types
  *
  ...
  *  }
  *
  * @return WbfsysVrefFileType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysVrefFileType_Table_Element( 'tableWbfsysVrefFileType', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Vref File Types', 'wbfsys.vref_file_type.label' );
      //$tabPanel->searchKey = 'wbfsys_vref_file_type';
      ...
      $searchElement->searchKey = 'wbfsys_vref_file_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysVrefFileType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysVrefFileType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysVrefFileType listing maske
   *
   * @param WbfsysVrefFileType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysVrefFileType_Table_Ui
