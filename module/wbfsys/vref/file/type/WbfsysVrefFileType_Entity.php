 ...
 *
 * Entity Class for the Database Table wbfsys_vref_file_type
 * 
 * @package WebFrap
 ...
 * @licence WebFrap.net
 */
class WbfsysVrefFileType_Entity
  extends Entity
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_vref_file_type';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.VrefFileType.show';
  ...
  */
  public static $entityName  = 'WbfsysVrefFileType';
  ...
  * @var string
  */
  public static $label  = 'Vref File Type';
  ...
  */
  ...
  (
    'vid' => array
    (
      'default' => 'wbfsys.vref_file_type.message.error_def_vid',
      'wrong'   => 'wbfsys.vref_file_type.message.error_wrong_vid',
      'max'     => 'wbfsys.vref_file_type.message.error_max_vid',
      'min'     => 'wbfsys.vref_file_type.message.error_min_vid',
    ),

    'id_type' => array
    (
      'default' => 'wbfsys.vref_file_type.message.error_def_id_type',
      'wrong'   => 'wbfsys.vref_file_type.message.error_wrong_id_type',
      'max'     => 'wbfsys.vref_file_type.message.error_max_id_type',
      'min'     => 'wbfsys.vref_file_type.message.error_min_id_type',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.vref_file_type.message.error_def_rowid',
      'wrong'   => 'wbfsys.vref_file_type.message.error_wrong_rowid',
      'empty'   => 'wbfsys.vref_file_type.message.error_empty_rowid',
      'max'     => 'wbfsys.vref_file_type.message.error_max_rowid',
      'min'     => 'wbfsys.vref_file_type.message.error_min_rowid',
    ),
  );

}//end class WbfsysVrefFileType_Entity
