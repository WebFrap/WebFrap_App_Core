 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysActionLogSubscription Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Action Log Subscription',
      'wbfsys.action_log_subscription.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Action Log Subscription',
      'wbfsys.action_log_subscription.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_action_log_subscription-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/action_log_subscription/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ActionLogSubscription.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_action_log_subscription';
    ...
    $form = $this->newForm( 'WbfsysActionLogSubscription_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ActionLogSubscription.create');}});
});
...
}//end class WbfsysActionLogSubscription_Crud_Create_Maintab_View
