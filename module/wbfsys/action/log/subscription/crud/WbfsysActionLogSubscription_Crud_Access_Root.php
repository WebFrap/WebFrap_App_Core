 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysActionLogSubscription_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysActionLogSubscription_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysActionLogSubscription_Entity */
      $entity = $orm->get( 'WbfsysActionLogSubscription', $rootId );
    }
...
}//end class WbfsysActionLogSubscription_Crud_Access_Root
