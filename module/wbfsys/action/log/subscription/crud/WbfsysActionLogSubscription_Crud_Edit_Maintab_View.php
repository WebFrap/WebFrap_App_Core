 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysActionLogSubscription Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysActionLogSubscription = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Action Log Subscription: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ActionLogSubscription.edit&amp;utf8=✓&amp;objid='.$entityWbfsysActionLogSubscription
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ActionLogSubscription.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_action_log_subscription-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/action_log_subscription/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysActionLogSubscription_Crud_Edit' );
...
}//end class WbfsysActionLogSubscription_Crud_Edit_Maintab_View
