 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysActionLogSubscription entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ActionLogSubscription.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ActionLogSubscription.insert';
    $params->formId       = 'wgt-form-wbfsys_action_log_subscription';
    $params->namespace   = 'wbfsys_action_log_subscription-create';
    ...
    $this->setTemplate( 'wbfsys/action_log_subscription/modal/crud/form_create' );
...
}//end class WbfsysActionLogSubscription_Crud_Create_Modal_View
