 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Filter
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
        ...
        AND filter_area_{$key}."acl-vid" = wbfsys_action_log_subscription.{$fieldName}
...
}//end class WbfsysActionLogSubscription_Filter
