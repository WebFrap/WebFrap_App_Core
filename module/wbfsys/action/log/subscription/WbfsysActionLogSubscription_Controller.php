 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_action_log_subscription
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.ActionLogSubscription.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_action_log_subscription-create';

    $access = new WbfsysActionLogSubscription_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_action_log_subscription-create',
      'WbfsysActionLogSubscription_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysActionLogSubscription_Crud_Model */
    $model = $this->loadModel( 'WbfsysActionLogSubscription_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.ActionLogSubscription.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysActionLogSubscription = $model->getEntityWbfsysActionLogSubscription( $objid );
    ...
    $params->entity = $entityWbfsysActionLogSubscription;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_action_log_subscription:edit';

    $access = new WbfsysActionLogSubscription_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysActionLogSubscription );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_action_log_subscription-edit-'.$objid,
      'WbfsysActionLogSubscription_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_action_log_subscription:show';
    ...
    (
      'form-wbfsys_action_log_subscription-edit-'.$objid,
      'WbfsysActionLogSubscription_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_action_log_subscription
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.ActionLogSubscription.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-insert';

    $access = new WbfsysActionLogSubscription_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysActionLogSubscription = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_action_log_subscription-update-'.$entityWbfsysActionLogSubscription;
      ...
      {
        $access = new WbfsysActionLogSubscription_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysActionLogSubscription );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysActionLogSubscription';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_action_log_subscription',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysActionLogSubscription_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.ActionLogSubscription.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysActionLogSubscription, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysActionLogSubscription_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.ActionLogSubscription.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-delete-'.$objid;

    $access = new WbfsysActionLogSubscription_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysActionLogSubscription );
    ...
    $error = $model->delete( $entityWbfsysActionLogSubscription, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysActionLogSubscription, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.ActionLogSubscription.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.ActionLogSubscription.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-listing';
    ...
    $containerClass = 'WbfsysActionLogSubscription_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_action_log_subscription',
      'WbfsysActionLogSubscription_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysActionLogSubscription_Table_Model */
    $model = $this->loadModel( 'WbfsysActionLogSubscription_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysActionLogSubscription
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysActionLogSubscription_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_action_log_subscription',
      'WbfsysActionLogSubscription_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysActionLogSubscription_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.ActionLogSubscription.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysActionLogSubscription_Selection_Model */
    $model   = $this->loadModel( 'WbfsysActionLogSubscription_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_action_log_subscription-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_action_log_subscription-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_action_log_subscription',
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysActionLogSubscription, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysActionLogSubscription_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysActionLogSubscription_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_action_log_subscription-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysActionLogSubscription_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysActionLogSubscription, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_action_log_subscription' );
...
} // end class WbfsysActionLogSubscription_Controller */
