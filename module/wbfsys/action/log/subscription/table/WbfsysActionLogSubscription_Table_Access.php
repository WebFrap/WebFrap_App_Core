 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysActionLogSubscription_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_action_log_subscription.rowid ",
      'acls'
    );
...
}//end class WbfsysActionLogSubscription_Table_Access
