 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_action_log_subscription';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysActionLogSubscription_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ActionLogSubscription.show&amp;target_mask=WbfsysActionLogSubscription&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ActionLogSubscription.edit&amp;target_mask=WbfsysActionLogSubscription&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.action_log_subscription.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ActionLogSubscription.delete&amp;target_mask=WbfsysActionLogSubscription&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.action_log_subscription.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_action_log_subscription_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ActionLogSubscription_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Action Log Subscriptions." >{$iconDelete} Delete selected Action Log Subscriptions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Action Log Subscriptions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ActionLogSubscription_Multi.deleteAll" >{$iconClean} Delete all Action Log Subscriptions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysActionLogSubscription_Table_Element
