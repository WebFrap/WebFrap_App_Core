 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Action Log Subscriptions
  *
  ...
  *  }
  *
  * @return WbfsysActionLogSubscription_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysActionLogSubscription_Table_Element( 'tableWbfsysActionLogSubscription', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_action_log_subscription-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Action Log Subscriptions', 'wbfsys.action_log_subscription.label' );
      //$tabPanel->searchKey = 'wbfsys_action_log_subscription';
      ...
      $searchElement->searchKey = 'wbfsys_action_log_subscription';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysActionLogSubscription_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysActionLogSubscription', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysActionLogSubscription listing maske
   *
   * @param WbfsysActionLogSubscription_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysActionLogSubscription  = $model->getEntityWbfsysActionLogSubscription();
    ...
    $formWbfsysActionLogSubscription->setKeyName( 'wbfsys_action_log_subscription' );
...
}//end class WbfsysActionLogSubscription_Table_Ui
