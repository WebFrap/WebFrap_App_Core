 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysActionLogSubscription_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysActionLogSubscription_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/action_log_subscription/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Action Log Subscriptions',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.ActionLogSubscription.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ActionLogSubscription.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysActionLogSubscription_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysActionLogSubscription_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.ActionLogSubscription.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.ActionLogSubscription.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.ActionLogSubscription.create&amp;ltype=table');
    });
...
}//end class WbfsysActionLogSubscription_Table_Maintab_View
