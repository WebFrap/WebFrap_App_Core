 ...
 * @licence WebFrap.net
 */
class WbfsysActionLogSubscription_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_action_log_subscription';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysActionLogSubscription';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysActionLogSubscription' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysActionLogSubscription entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function input_id_user( $params )
  {
      ...
      //tpl: class ui:int
      $inputIdUser = $this->view->newInput( 'input'.$this->prefix.'IdUser' , 'Int' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for User (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
        )
      );
      ...
      $inputIdUser->setLabel
      (
        $this->view->i18n->l( 'User', 'wbfsys.action_log_subscription.label' ),
        $this->entity->required( 'id_user' )
      );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.action_log_subscription.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.action_log_subscription.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.action_log_subscription.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.action_log_subscription.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.action_log_subscription.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.action_log_subscription.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Action Log Subscription)', 'wbfsys.action_log_subscription.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.action_log_subscription.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_action_log_subscription_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_action_log_subscription_m_role_change';
...
}//end class WbfsysActionLogSubscription_Form */
