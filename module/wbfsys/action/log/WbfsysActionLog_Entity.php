 ...
 *
 * Entity Class for the Database Table wbfsys_action_log
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_action_log';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.ActionLog.show';
  ...
  */
  public static $entityName  = 'WbfsysActionLog';
  ...
  * @var string
  */
  public static $label  = 'Action Log';
  ...
  */
  ...
  (
    'content' => array
    (
      'default' => 'wbfsys.action_log.message.error_def_content',
      'wrong'   => 'wbfsys.action_log.message.error_wrong_content',
      'max'     => 'wbfsys.action_log.message.error_max_content',
      'min'     => 'wbfsys.action_log.message.error_min_content',
    ),

    'vid' => array
    (
      'default' => 'wbfsys.action_log.message.error_def_vid',
      'wrong'   => 'wbfsys.action_log.message.error_wrong_vid',
      'max'     => 'wbfsys.action_log.message.error_max_vid',
      'min'     => 'wbfsys.action_log.message.error_min_vid',
    ),

    'id_vid_entity' => array
    (
      'default' => 'wbfsys.action_log.message.error_def_id_vid_entity',
      'wrong'   => 'wbfsys.action_log.message.error_wrong_id_vid_entity',
      'max'     => 'wbfsys.action_log.message.error_max_id_vid_entity',
      'min'     => 'wbfsys.action_log.message.error_min_id_vid_entity',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.action_log.message.error_def_rowid',
      'wrong'   => 'wbfsys.action_log.message.error_wrong_rowid',
      'empty'   => 'wbfsys.action_log.message.error_empty_rowid',
      'max'     => 'wbfsys.action_log.message.error_max_rowid',
      'min'     => 'wbfsys.action_log.message.error_min_rowid',
    ),
  );

}//end class WbfsysActionLog_Entity
