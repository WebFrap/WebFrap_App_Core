 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysActionLog entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ActionLog.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ActionLog.insert';
    $params->formId       = 'wgt-form-wbfsys_action_log';
    $params->namespace   = 'wbfsys_action_log-create';
    ...
    $this->setTemplate( 'wbfsys/action_log/modal/crud/form_create' );
...
}//end class WbfsysActionLog_Crud_Create_Modal_View
