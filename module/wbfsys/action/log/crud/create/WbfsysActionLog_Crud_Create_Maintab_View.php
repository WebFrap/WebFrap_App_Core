 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysActionLog Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_action_log-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/action_log/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ActionLog.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_action_log';
    ...
    $form = $this->newForm( 'WbfsysActionLog_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ActionLog.create');}});
});
...
}//end class WbfsysActionLog_Crud_Create_Maintab_View
