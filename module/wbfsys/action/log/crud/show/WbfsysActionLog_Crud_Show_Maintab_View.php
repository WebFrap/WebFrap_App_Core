 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysActionLog Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysActionLog = $this->model->getEntityWbfsysActionLog();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Action Log: {@text@}',
      'wbfsys.action_log.label',
      array( 'text' => $entityWbfsysActionLog->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ActionLog.show  &amp;objid='.$entityWbfsysActionLog
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ActionLog.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_action_log-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/action_log/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysActionLog_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ActionLog.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_action_log' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_action_log a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ActionLog.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ActionLog.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysActionLog_Crud_Show_Maintab_View
