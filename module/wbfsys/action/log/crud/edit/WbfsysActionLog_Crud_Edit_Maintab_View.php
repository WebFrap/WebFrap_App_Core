 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysActionLog Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysActionLog = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Action Log: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ActionLog.edit&amp;utf8=✓&amp;objid='.$entityWbfsysActionLog
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ActionLog.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_action_log-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/action_log/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysActionLog_Crud_Edit' );
...
}//end class WbfsysActionLog_Crud_Edit_Maintab_View
