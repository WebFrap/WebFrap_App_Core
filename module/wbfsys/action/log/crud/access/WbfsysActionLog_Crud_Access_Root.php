 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysActionLog_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysActionLog_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysActionLog_Entity */
      $entity = $orm->get( 'WbfsysActionLog', $rootId );
    }
...
}//end class WbfsysActionLog_Crud_Access_Root
