 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysActionLog_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_action_log.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_action_log.rowid ",
      'acls'
    );
...
}//end class WbfsysActionLog_Table_Access
