 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_action_log';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysActionLog_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ActionLog.show&amp;target_mask=WbfsysActionLog&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ActionLog.edit&amp;target_mask=WbfsysActionLog&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.action_log.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ActionLog.delete&amp;target_mask=WbfsysActionLog&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.action_log.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Content', 'wbfsys.action_log.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_action_log_rowid'];
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_action_log_content']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ActionLog_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Action Logs." >{$iconDelete} Delete selected Action Logs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Action Logs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ActionLog_Multi.deleteAll" >{$iconClean} Delete all Action Logs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysActionLog_Table_Element
