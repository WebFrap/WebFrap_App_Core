 ...
 * @licence WebFrap.net
 */
class WbfsysActionLog_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Action Logs
  *
  ...
  *  }
  *
  * @return WbfsysActionLog_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysActionLog_Table_Element( 'tableWbfsysActionLog', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_action_log-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Action Logs', 'wbfsys.action_log.label' );
      //$tabPanel->searchKey = 'wbfsys_action_log';
      ...
      $searchElement->searchKey = 'wbfsys_action_log';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysActionLog_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysActionLog', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysActionLog listing maske
   *
   * @param WbfsysActionLog_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysActionLog  = $model->getEntityWbfsysActionLog();
    ...
    $formWbfsysActionLog->setKeyName( 'wbfsys_action_log' );
...
}//end class WbfsysActionLog_Table_Ui
