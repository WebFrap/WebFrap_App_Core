 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFaq_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_faq.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_faq.rowid ",
      'acls'
    );
...
}//end class WbfsysFaq_Selection_Access
