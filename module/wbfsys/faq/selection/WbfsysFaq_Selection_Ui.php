...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysFaq_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysFaq_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFaq_Selection_Element
    (
      'selectionWbfsysFaq',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection FAQs', 'wbfsys.faq.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Faq.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysFaq_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFaq_Selection_Ui
