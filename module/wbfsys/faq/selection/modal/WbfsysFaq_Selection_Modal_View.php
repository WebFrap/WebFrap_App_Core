 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysFaq_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysFaq_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/faq/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'FAQ', 'wbfsys.faq.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Faq.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_faq-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysFaq_Selection' );
...
}//end class WbfsysFaq_Selection_Modal_View
