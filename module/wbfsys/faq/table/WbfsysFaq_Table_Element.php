...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_faq';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFaq_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Faq.show&amp;target_mask=WbfsysFaq&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.faq.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Faq.edit&amp;target_mask=WbfsysFaq&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.faq.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Faq.delete&amp;target_mask=WbfsysFaq&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.faq.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Question', 'wbfsys.faq.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_faq_question'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Faq_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected FAQs." >{$iconDelete} Delete selected FAQs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! FAQs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Faq_Multi.deleteAll" >{$iconClean} Delete all FAQs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFaq_Table_Element
