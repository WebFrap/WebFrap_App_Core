...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für FAQs
  *
  ...
  *  }
  *
  * @return WbfsysFaq_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFaq_Table_Element( 'tableWbfsysFaq', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_faq-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'FAQs', 'wbfsys.faq.label' );
      //$tabPanel->searchKey = 'wbfsys_faq';
      ...
      $searchElement->searchKey = 'wbfsys_faq';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFaq_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFaq', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFaq listing maske
   *
   * @param WbfsysFaq_Table_Model $model
   * @param TFlag $params
   * @return void
   */
