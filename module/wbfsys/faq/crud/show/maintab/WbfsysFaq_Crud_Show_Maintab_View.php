 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFaq Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFaq = $this->model->getEntityWbfsysFaq();
    ...
    (
      'Show FAQ: {@text@}',
      'wbfsys.faq.label',
      array( 'text' => $entityWbfsysFaq->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Faq.show  &amp;objid='.$entityWbfsysFaq
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Faq.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_faq-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/faq/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFaq_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Faq.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_faq' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_faq a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Faq.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Faq.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFaq_Crud_Show_Maintab_View
