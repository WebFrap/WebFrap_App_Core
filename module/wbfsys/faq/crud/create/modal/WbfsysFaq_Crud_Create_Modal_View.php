 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFaq entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Faq.insert';
    $params->formId       = 'wgt-form-wbfsys_faq';
    $params->namespace   = 'wbfsys_faq-create';
    ...
    $this->setTemplate( 'wbfsys/faq/modal/crud/form_create' );
...
}//end class WbfsysFaq_Crud_Create_Modal_View
