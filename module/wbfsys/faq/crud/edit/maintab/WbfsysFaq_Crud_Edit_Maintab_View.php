 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysFaq Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFaq = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Faq.edit&amp;utf8=✓&amp;objid='.$entityWbfsysFaq
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Faq.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_faq-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/faq/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysFaq_Crud_Edit' );
...
}//end class WbfsysFaq_Crud_Edit_Maintab_View
