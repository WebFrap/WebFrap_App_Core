 ...
 * @licence WebFrap.net
 */
class WbfsysFaq_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysFaq_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysFaq_Entity */
      $entity = $orm->get( 'WbfsysFaq', $rootId );
    }
...
}//end class WbfsysFaq_Crud_Access_Root
