 ...
 *
 * Entity Class for the Database Table wbfsys_faq
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_faq';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Faq.show';
  ...
  */
  public static $entityName  = 'WbfsysFaq';
  ...
  */
  ...
  (
    'question' => array
    (
      'default' => 'wbfsys.faq.message.error_def_question',
      'wrong'   => 'wbfsys.faq.message.error_wrong_question',
      'max'     => 'wbfsys.faq.message.error_max_question',
      'min'     => 'wbfsys.faq.message.error_min_question',
    ),

    'vid' => array
    (
      'default' => 'wbfsys.faq.message.error_def_vid',
      'wrong'   => 'wbfsys.faq.message.error_wrong_vid',
      'max'     => 'wbfsys.faq.message.error_max_vid',
      'min'     => 'wbfsys.faq.message.error_min_vid',
    ),

    'answer' => array
    (
      'default' => 'wbfsys.faq.message.error_def_answer',
      'wrong'   => 'wbfsys.faq.message.error_wrong_answer',
      'max'     => 'wbfsys.faq.message.error_max_answer',
      'min'     => 'wbfsys.faq.message.error_min_answer',
    ),

    'id_vid_entity' => array
    (
      'default' => 'wbfsys.faq.message.error_def_id_vid_entity',
      'wrong'   => 'wbfsys.faq.message.error_wrong_id_vid_entity',
      'max'     => 'wbfsys.faq.message.error_max_id_vid_entity',
      'min'     => 'wbfsys.faq.message.error_min_id_vid_entity',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.faq.message.error_def_rowid',
      'wrong'   => 'wbfsys.faq.message.error_wrong_rowid',
      'empty'   => 'wbfsys.faq.message.error_empty_rowid',
      'max'     => 'wbfsys.faq.message.error_max_rowid',
      'min'     => 'wbfsys.faq.message.error_min_rowid',
    ),
  );

}//end class WbfsysFaq_Entity
