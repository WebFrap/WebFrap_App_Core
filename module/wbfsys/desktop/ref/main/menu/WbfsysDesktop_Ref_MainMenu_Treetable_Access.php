 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Treetable_Access
  extends LibAclPermissionTree
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      'mod-wbfsys-cat-core_data-ref-main_menu', // der aktuelle knotenpunkt
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-main_menu' );
  ...
  /**
   * @param WbfsysDesktop_Ref_MainMenu_Treetable_Query $query
...
SQL;
  ...
  /**
   * @param WbfsysMenuEntry_Ref_MainMenu_Treetable_Query $query
...
}//end class WbfsysDesktop_Ref_MainMenu_Treetable_Access
