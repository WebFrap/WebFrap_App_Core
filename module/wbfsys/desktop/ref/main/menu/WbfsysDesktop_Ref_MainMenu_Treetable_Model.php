 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Treetable_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param WbfsysDesktop_Ref_MainMenu_Treetable_Access $access
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysDesktop, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysDesktop_Ref_MainMenu_Treetable' );
    /* @var $query WbfsysDesktop_Ref_MainMenu_Treetable_Query  */
...
}//end class WbfsysDesktop_Ref_MainMenu_Treetable_Model
