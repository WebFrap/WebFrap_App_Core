 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Desktop_Ref_MainMenu.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysDesktop_Ref_MainMenu_Table_Ajax_View
