 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'index.php?c=Wbfsys.Desktop_Ref_MainMenu.search&amp;objid='.$params->refId;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_desktop-ref-main_menu-search-'.$objid;
      
    // fix the target id
		$params->targetId = 'wgt-table-modal-ref-main_menu-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'MainMenu' );

    // set the default table template
    $this->setTemplate( 'wbfsys/desktop/ref_main_menu/tab_table' );

    $ui = $this->loadUi( 'WbfsysDesktop_Ref_MainMenu_Table' );
...
}//end class WbfsysDesktop_Ref_MainMenu_Table_Modal_View
