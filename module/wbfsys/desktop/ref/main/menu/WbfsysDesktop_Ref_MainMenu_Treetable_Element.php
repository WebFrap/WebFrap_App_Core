 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_desktop-main_menu';
   ...
   * @var string
   */
  public $namespace = 'WbfsysDesktop_Ref_MainMenu';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MenuEntry.show&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainMenu&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MenuEntry.edit&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainMenu&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MenuEntry.delete&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainMenu&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::DELETE
...
HTML;
  ...
  protected function buildJavascript()
  {
    ...
    \$S('#{$this->id}').data('func_add',function( objid ){
      ...
      \$R.post('maintab.php?c=Wbfsys.MenuEntry.create&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainMenu&amp;target_id={$this->id}&refid='+objid,params);
    });
...
}//end class WbfsysDesktop_Ref_MainMenu_Treetable_Element
