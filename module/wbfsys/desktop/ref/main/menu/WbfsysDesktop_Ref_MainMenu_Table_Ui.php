 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysDesktop_Ref_MainMenu_Table_Element
   */
  public function createListItem( $idWbfsysDesktop, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysDesktop_Ref_MainMenu_Table_Element
    (
      'tableMainMenu',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-main_menu-'.$idWbfsysDesktop;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_desktop-ref-main_menu-search-'
        .$idWbfsysDesktop;
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.MenuEntry.create&refid='.$params->refId.'&target_mask=WbfsysDesktop_Ref_MainMenu&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_menu_entry[id_menu]\':\''.$params->refIdMainMenu.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    (
      ...
      'ajax.php?c=Wbfsys.Desktop_Ref_MainMenu.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysDesktop, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowMainMenu' , $table->buildAjax() );
...
}//end class WbfsysDesktop_Ref_MainMenu_Table_Ui
