 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainMenu_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-main_menu',
      null,
  ...
  /**
   * @param WbfsysDesktop_Ref_MainMenu_Table_Query $query
...
}//end class WbfsysDesktop_Ref_MainMenu_Table_Access
