 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainTree_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listMainTree = $this->getRegisterd('listRefMainTree'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listMainTree was not registered'
        );
      }

      foreach( $listMainTree as $entityWbfsysDesktop )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefMainTree',$listWbfsysMenuEntry);
      return true;
...
}//end class WbfsysDesktop_Ref_MainTree_Multi_Model
