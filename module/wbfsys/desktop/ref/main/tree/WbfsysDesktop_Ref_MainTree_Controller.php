 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainTree_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des main_tree Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysDesktop_Ref_MainTree_".$listType."_Access";
    ...
    $accessMainTree = new $containerClass( );
    $accessMainTree->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-main_tree';

    $params->accessMainTree = $accessMainTree;
    $params->paramsMainTree = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessMainTree->listing  )
    {
    ...
    $params->loadFullSize = true;
      ...
      if( !$refField = $orm->getField( 'WbfsysDesktop', $objid, 'id_main_tree' ) )
      {
    ...
    (
      $params->tabId,
      'WbfsysDesktop_Ref_MainTree_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelMainTree = $this->loadModel
    (
      'WbfsysDesktop_Ref_MainTree_'.$listType
    );
    $modelMainTree->setAccess( $accessMainTree );
    
    $view->setModel( $modelMainTree );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdMainTree = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysDesktop_Ref_MainTree_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_desktop-ref-main_tree-'.$listType.'-ajax',
    	'WbfsysDesktop_Ref_MainTree_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
} // end WbfsysDesktop_Ref_MainTree_Controller
