 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainTree_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function createListItem( $idWbfsysDesktop, $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysDesktop_Ref_MainTree_Treetable_Element
    (
      'treetableMainTree',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-treetable-wbfsys_desktop-ref-main_tree-'
        .$idWbfsysDesktop;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-wbfsys_desktop-ref-main_tree-search-'
        .$idWbfsysDesktop;
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.MenuEntry.create&refid='.$params->refId.'&target_mask=WbfsysDesktop_Ref_MainTree&target_id='.$treetable->id.$treetable->accessPath.'\',{\'wbfsys_menu_entry[id_menu]\':\''.$params->refIdMainTree.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    (
      ...
      'ajax.php?c=Wbfsys.Desktop_Ref_MainTree.search'
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysDesktop_Ref_MainTree_Treetable_Element
   */
  public function getListItem( $idWbfsysDesktop, $data, $access, $params  )
  {
    ...
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-treetable-wbfsys_desktop-ref-main_tree-'.$idWbfsysDesktop;
  ...
  public function listEntry( $idWbfsysDesktop, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowMainTree', $treetable->buildAjax() );
...
}//end class WbfsysDesktop_Ref_MainTree_Treetable_Ui
