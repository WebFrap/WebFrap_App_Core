 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Ref_MainTree_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_desktop-main_tree';


  /**
   * the reference id to the source table
   * @var string $refId
   */
  public $refId       = null;
   ...
   *
   * @var WbfsysMenuEntry_Treetable_Query
   */
  public $data       = null;
   ...
   * @var string
   */
  public $namespace = 'WbfsysDesktop_Ref_MainTree';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MenuEntry.show&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainTree&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MenuEntry.edit&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainTree&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MenuEntry.delete&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainTree&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.menu_entry.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l('Label','wbfsys.menu_entry.label').'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    {
      $objid       = $row['wbfsys_menu_entry_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MenuEntry.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_menu_entry_label'])).'</a></td>'.NL;
  ...
  public function buildAjaxTbody( $row  )
  {
    ...
    if( $this->insertMode )
    {
      ...
      if( $row['wbfsys_menu_entry_m_parent'] )
      {
        $pClass = 'child-of-'.$this->id.'_row_'.$row['wbfsys_menu_entry_m_parent'];
        $body = '<htmlArea selector="tr#'.$this->id.'_row_'
          .$row['wbfsys_menu_entry_m_parent'].'" action="after" >'
          .'<![CDATA[<tr id="'.$rowid.'" '
          .' wgt_context_menu="'.$this->id.'-cmenu" '
          .' wgt_eid="'.$objid.'" ' 
          .$rowParams
    ...
    if( $row['wbfsys_menu_entry_m_parent'] )
    {
      $prePos = $row['wbfsys_menu_entry_m_parent'].'.';
    }
    else
    {
      $prePos = '';
    ...
    if( !$this->appendMode && $row['wbfsys_menu_entry_m_parent'] )
    {
      $parentId = $this->id.'_row_'.$row['wbfsys_menu_entry_m_parent'];
...
HTML;
  ...
  /**
   * this method contains the javascript logic for this ui element
   * func_add is used to append append new grouproles tho the security area
   * @return string
   */
  protected function buildJavascript()
  {
    ...
    \$S('#{$this->id}').data('func_add',function( objid ){
      var params = {
        "wbfsys_menu_entry[m_parent]":objid,
        "wbfsys_menu_entry[id_menu]":{$this->refId}
      };
      \$R.post('maintab.php?c=Wbfsys.MenuEntry.create&amp;ltype=treetable&amp;target_mask=WbfsysDesktop_Ref_MainTree&amp;target_id={$this->id}&refid='+objid,params);
    });
...
}//end class WbfsysDesktop_Ref_MainTree_Treetable_Element
