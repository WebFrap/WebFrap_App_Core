 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_desktop';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDesktop_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Desktop.show&amp;target_mask=WbfsysDesktop&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Desktop.edit&amp;target_mask=WbfsysDesktop&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.desktop.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Main Menus',
            'modal.php?c=Wbfsys.Desktop_Ref_MainMenu.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.desktop.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Main Trees',
            'modal.php?c=Wbfsys.Desktop_Ref_MainTree.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.desktop.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Desktop.delete&amp;target_mask=WbfsysDesktop&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.desktop.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.desktop.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_desktop_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Desktop.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_desktop_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Desktop_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Desktops." >{$iconDelete} Delete selected Desktops</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Desktops. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Desktop_Multi.deleteAll" >{$iconClean} Delete all Desktops</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDesktop_Table_Element
