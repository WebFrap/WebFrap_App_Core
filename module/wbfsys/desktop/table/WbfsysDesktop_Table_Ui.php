...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Desktops
  *
  ...
  *  }
  *
  * @return WbfsysDesktop_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDesktop_Table_Element( 'tableWbfsysDesktop', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_desktop-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Desktops', 'wbfsys.desktop.label' );
      ...
      $searchElement->searchKey = 'wbfsys_desktop';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDesktop_Table_Element( null,$view );
...
}//end class WbfsysDesktop_Table_Ui
