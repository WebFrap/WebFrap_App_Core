...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDesktop';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDesktop' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDesktop entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Desktop)', 'wbfsys.desktop.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.desktop.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Desktop)', 'wbfsys.desktop.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.desktop.label' ),
  ...
  * @return void
  */
  public function input_id_app( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysApp_Entity' ) )
    {
      ...
      $inputIdApp = $this->view->newInput( 'input'.$this->prefix.'IdApp', 'Window' );
      $inputIdApp->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_app]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_app'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for App (Desktop)', 'wbfsys.desktop.label' ),
      ));
      ...
      $inputIdApp->setReadOnly( $this->isReadOnly( 'id_app' ) );
      $inputIdApp->setLabel( $this->view->i18n->l( 'App', 'wbfsys.desktop.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.App.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_app'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdApp->buildJavascript( 'wgt-input-'.$this->keyName.'_id_app'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_app */
  ...
  * @return void
  */
  public function input_id_main_menu( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMenu_Entity' ) )
    {
      ...
      $inputIdMainMenu = $this->view->newInput( 'input'.$this->prefix.'IdMainMenu', 'Window' );
      $inputIdMainMenu->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_main_menu]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_main_menu'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Main Menu (Desktop)', 'wbfsys.desktop.label' ),
      ));
      ...
      $inputIdMainMenu->setReadOnly( $this->isReadOnly( 'id_main_menu' ) );
      $inputIdMainMenu->setLabel( $this->view->i18n->l( 'Main Menu', 'wbfsys.desktop.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Menu.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_main_menu'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMainMenu->buildJavascript( 'wgt-input-'.$this->keyName.'_id_main_menu'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_main_menu */
  ...
  * @return void
  */
  public function input_id_main_tree( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMenu_Entity' ) )
    {
      ...
      $inputIdMainTree = $this->view->newInput( 'input'.$this->prefix.'IdMainTree', 'Window' );
      $inputIdMainTree->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_main_tree]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_main_tree'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Main Tree (Desktop)', 'wbfsys.desktop.label' ),
      ));
      ...
      $inputIdMainTree->setReadOnly( $this->isReadOnly( 'id_main_tree' ) );
      $inputIdMainTree->setLabel( $this->view->i18n->l( 'Main Tree', 'wbfsys.desktop.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Menu.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_main_tree'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMainTree->buildJavascript( 'wgt-input-'.$this->keyName.'_id_main_tree'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_main_tree */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Desktop)', 'wbfsys.desktop.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.desktop.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Desktop)', 'wbfsys.desktop.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.desktop.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Desktop)', 'wbfsys.desktop.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.desktop.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Desktop)', 'wbfsys.desktop.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.desktop.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Desktop)', 'wbfsys.desktop.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.desktop.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Desktop)', 'wbfsys.desktop.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.desktop.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Desktop)', 'wbfsys.desktop.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.desktop.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Desktop)', 'wbfsys.desktop.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.desktop.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Desktop)', 'wbfsys.desktop.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.desktop.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Desktop)', 'wbfsys.desktop.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Desktop)', 'wbfsys.desktop.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_desktop_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_desktop_m_role_change';
