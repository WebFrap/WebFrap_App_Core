 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_desktop';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Desktop.show&amp;target_mask=WbfsysDesktop&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Desktop.edit&amp;target_mask=WbfsysDesktop&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.desktop.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Desktop.delete&amp;target_mask=WbfsysDesktop&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.desktop.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_desktop_name'])).'</td>'.NL;
...
}//end class WbfsysDesktop_Selection_Element
