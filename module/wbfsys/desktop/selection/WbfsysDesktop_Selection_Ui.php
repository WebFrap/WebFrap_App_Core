 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDesktop_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDesktop_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDesktop_Selection_Element
    (
      'selectionWbfsysDesktop',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Desktops', 'wbfsys.desktop.label' ) ;
      $tabPanel->searchKey = 'wbfsys_desktop';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Desktop.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysDesktop',
      'WbfsysDesktop_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDesktop' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysDesktop listing maske
   *
   * @param WbfsysDesktop_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDesktop_Selection_Ui
