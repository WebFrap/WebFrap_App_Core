 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDesktop', array_keys( $this->fields['wbfsys_desktop']), true ),
...
}//end class WbfsysDesktop_Crud_Create_Form */
