 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDesktop entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Desktop.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Desktop.insert';
    $params->formId       = 'wgt-form-wbfsys_desktop';
    $params->namespace   = 'wbfsys_desktop-create';
    ...
    $this->setTemplate( 'wbfsys/desktop/modal/crud/form_create' );
...
}//end class WbfsysDesktop_Crud_Create_Modal_View
