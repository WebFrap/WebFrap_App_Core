 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDesktop_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDesktop_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDesktop_Entity */
      $entity = $orm->get( 'WbfsysDesktop', $rootId );
    }
...
}//end class WbfsysDesktop_Crud_Access_Root
