 ...
 * @licence WebFrap.net
 */
class WbfsysDesktop_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDesktop Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDesktop = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Desktop.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDesktop
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Desktop.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_desktop-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/desktop/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDesktop_Crud_Edit' );
...
}//end class WbfsysDesktop_Crud_Edit_Maintab_View
