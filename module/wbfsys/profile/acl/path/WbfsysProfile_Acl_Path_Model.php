 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysProfile_Acl_Path' );
    /* @var $query WbfsysProfile_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysProfile_Acl_Path');
    /* @var $dropQuery WbfsysProfile_Acl_Path_Query  */
...
} // end class WbfsysProfile_Acl_Path_Model */
