 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_profile_acl_graph', 
      'WbfsysProfile_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysProfile_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysProfile_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysProfile_Acl_Path_Maintab_View  */
...
} // end class WbfsysProfile_Acl_Path_Controller */
