 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysProfile_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysProfile_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysProfile = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysProfile_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_profile-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysProfile, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysProfile_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_profile-acl-dset', 
    	'WbfsysProfile_Acl_Dset',
...
} // end class WbfsysProfile_Acl_Dset_Controller */
