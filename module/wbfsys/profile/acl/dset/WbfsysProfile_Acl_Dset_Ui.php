 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysProfile_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysProfile_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysProfile, $areaId, $access, $params  )
  {

    $listObj = new WbfsysProfile_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_profile-acl-dset' );
    ...
    else
    {
      ...
      (
        'Profiles "{@label@}" User Access',
        'wbfsys.profile.label',
        array
        (
          'label' => $entityWbfsysProfile->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_profile_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysProfile_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysProfile_Acl_Dset_Ui */
