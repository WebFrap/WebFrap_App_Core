 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysProfile_Acl_Dset' );
    ...
    $entityWbfsysProfile = $this->model->getEntity( $dsetId );
...
} // end class WbfsysProfile_Acl_Dset_Ajax_View */
