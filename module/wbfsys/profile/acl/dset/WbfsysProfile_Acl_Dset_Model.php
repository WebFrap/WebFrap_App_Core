 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_profile'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysProfile', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProfile_Acl_Dset' );
    /* @var $query WbfsysProfile_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProfile_Acl_Dset_Treetable' );
    /* @var $query WbfsysProfile_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysProfile_Acl_Dset_Model */
