...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysProfile_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProfile_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_profile-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Profiles', 'wbfsys.profile.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_profile_acl';
...
} // end class WbfsysProfile_Acl_Ui */
