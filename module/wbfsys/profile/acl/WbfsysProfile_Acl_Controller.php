 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysProfile
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysProfile_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysProfile_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysProfile_Acl_Model */
    $model   = $this->loadModel( 'WbfsysProfile_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_profile_acl_masks_listing',
      'WbfsysProfile_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysProfile_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysProfile_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysProfile_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysProfile_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysProfile_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysProfile_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_profile-acl-qfdu',
    	'WbfsysProfile_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysProfile_Acl_Controller */
