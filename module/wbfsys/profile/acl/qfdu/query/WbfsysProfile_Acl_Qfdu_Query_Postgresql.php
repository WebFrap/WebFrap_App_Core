 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_profile.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_profile.rowid as id,
    wbfsys_profile.name as value,
    wbfsys_profile.name as label
  FROM
    wbfsys_profile
  WHERE
    {$sqlWhere}
...
} // end class WbfsysProfile_Acl_Qfdu_Query_Postgresql */
