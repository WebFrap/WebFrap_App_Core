 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_profile')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysProfile = $orm->get('WbfsysProfile', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_profile_name']  = $refEntityWbfsysProfile->name;

    }
    $tabData['wbfsys_profile_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysProfile_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProfile_Acl' );
    /* @var $query WbfsysProfile_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProfile_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysProfile_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysProfile_Acl_Qfdu' );
    /* @var $query WbfsysProfile_Acl_Qfdu_Query  */
...
} // end class WbfsysProfile_Acl_Qfdu_Model */
