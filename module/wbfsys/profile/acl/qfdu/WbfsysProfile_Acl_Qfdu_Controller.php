 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysProfile_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_profile-acl-qfdu-aAjax',
      'WbfsysProfile_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysProfile_Acl_Qfdu_Controller */
