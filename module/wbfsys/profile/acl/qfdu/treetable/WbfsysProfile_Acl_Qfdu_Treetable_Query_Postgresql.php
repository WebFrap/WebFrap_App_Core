 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_profile.name as "wbfsys_profile_name"',
      'wbfsys_profile.rowid as "wbfsys_profile_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_profile on wbfsys_group_users.vid = wbfsys_profile.rowid'
    );
...
} // end class WbfsysProfile_Acl_Qfdu_Treetable_Query_Postgresql */
