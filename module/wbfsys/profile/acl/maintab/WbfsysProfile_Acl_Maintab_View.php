 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Profile_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_profile-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Profile_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_profile-acl-update';
    ...
    $this->setTemplate( 'wbfsys/profile/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Profiles', 'wbfsys.profile.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_profile_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysProfile_Acl' );
...
} // end class WbfsysProfile_Acl_Maintab_View */
