 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Treetable_Maintab_Menu
  extends WgtDropmenu
{
  /**
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_profile-treetable-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_profile-treetable-help hidden" >
    	      
<p>This is the Profiles treetable.</p>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_profile-treetable" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysProfile_Treetable_Maintab_Menu
