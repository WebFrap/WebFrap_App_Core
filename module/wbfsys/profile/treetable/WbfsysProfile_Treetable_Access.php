 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysProfile_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_profile') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_profile.rowid ",
      'acls'
    );
...
}//end class WbfsysProfile_Treetable_Access
