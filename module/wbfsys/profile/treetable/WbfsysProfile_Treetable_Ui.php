 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysProfile_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysProfile_Treetable_Element
    (
      'treetableWbfsysProfile',
      $view
    );
...
WGTJS;
   ...
   *
   * @return WbfsysProfile_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProfile', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysProfile_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProfile_Treetable_Ui
