 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Treetable_Postgresql_Query
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if($params->loadFullSize)
      $this->calcQuery = $criteria->count( 'count(wbfsys_profile.'.Db::PK.') as '.Db::Q_SIZE );
    ...
    while( $children = $this->loadChildren( $ids, true ) )
    {
      ...
      {
        $this->childs[$child['wbfsys_profile_m_parent']][] = $child;
        $ids[] = $child['wbfsys_profile_rowid'];
      }
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $access, $condition, $params = null )
  {
    ...
    while( $childIds = $access->fetchChildrenIds( $pName, 'treetable', $this, $ids, $condition, $params ) )
    {
      ...
      foreach( $children as $child )
      {
        $child['acl-level'] = $childIds[$child['wbfsys_profile_rowid']];
 ...
 /**
  ...
  public function loadChildren( $ids, $loadChildren = false )
  {
    ...
    if( $loadChildren )
      $criteria->where('wbfsys_profile.m_parent in('.implode(',',$ids).')');
    else
      $criteria->where('wbfsys_profile.rowid in('.implode(',',$ids).')');
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_profile.access_key as "wbfsys_profile_access_key"', // variant: def-by-context 
      'wbfsys_profile.description as "wbfsys_profile_description"', // variant: def-by-context 
      'wbfsys_profile.m_parent as "wbfsys_profile_m_parent"', // variant: def-additional 
    );
 ...
 /**
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    $criteria->where( ' wbfsys_profile.m_parent is null ' );
...
}//end class WbfsysProfile_Treetable_Postgresql_Query
