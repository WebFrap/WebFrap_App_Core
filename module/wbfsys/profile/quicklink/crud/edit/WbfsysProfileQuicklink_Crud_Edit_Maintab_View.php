 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProfileQuicklink Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProfileQuicklink = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Profile Quicklink: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProfileQuicklink.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProfileQuicklink
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProfileQuicklink.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_profile_quicklink-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/profile_quicklink/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProfileQuicklink_Crud_Edit' );
...
}//end class WbfsysProfileQuicklink_Crud_Edit_Maintab_View
