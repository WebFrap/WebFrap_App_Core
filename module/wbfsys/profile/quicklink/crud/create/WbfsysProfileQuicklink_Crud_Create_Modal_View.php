 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProfileQuicklink entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ProfileQuicklink.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProfileQuicklink.insert';
    $params->formId       = 'wgt-form-wbfsys_profile_quicklink';
    $params->namespace   = 'wbfsys_profile_quicklink-create';
    ...
    $this->setTemplate( 'wbfsys/profile_quicklink/modal/crud/form_create' );
...
}//end class WbfsysProfileQuicklink_Crud_Create_Modal_View
