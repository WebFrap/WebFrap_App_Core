 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysProfileQuicklink Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Profile Quicklink',
      'wbfsys.profile_quicklink.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Profile Quicklink',
      'wbfsys.profile_quicklink.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_profile_quicklink-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/profile_quicklink/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ProfileQuicklink.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_profile_quicklink';
    ...
    $form = $this->newForm( 'WbfsysProfileQuicklink_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ProfileQuicklink.create');}});
});
...
}//end class WbfsysProfileQuicklink_Crud_Create_Maintab_View
