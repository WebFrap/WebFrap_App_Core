 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProfileQuicklink_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysProfileQuicklink Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProfileQuicklink = $this->model->getEntityWbfsysProfileQuicklink();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Profile Quicklink: {@text@}',
      'wbfsys.profile_quicklink.label',
      array( 'text' => $entityWbfsysProfileQuicklink->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ProfileQuicklink.show  &amp;objid='.$entityWbfsysProfileQuicklink
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ProfileQuicklink.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_profile_quicklink-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/profile_quicklink/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysProfileQuicklink_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ProfileQuicklink.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_profile_quicklink' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_profile_quicklink a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ProfileQuicklink.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ProfileQuicklink.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysProfileQuicklink_Crud_Show_Maintab_View
