 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysProfileQuicklink_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysProfileQuicklink_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysProfileQuicklink_Entity */
      $entity = $orm->get( 'WbfsysProfileQuicklink', $rootId );
    }
...
}//end class WbfsysProfileQuicklink_Crud_Access_Root
