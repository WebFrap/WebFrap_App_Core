 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProfileQuicklink_Selection' ) );
...
} // end class WbfsysProfileQuicklink_Selection_Controller */
