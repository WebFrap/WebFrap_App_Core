 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProfileQuicklink_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysProfileQuicklink_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/profile_quicklink/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Profile Quicklink', 'wbfsys.profile_quicklink.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ProfileQuicklink.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_profile_quicklink-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysProfileQuicklink_Selection' );
...
}//end class WbfsysProfileQuicklink_Selection_Modal_View
