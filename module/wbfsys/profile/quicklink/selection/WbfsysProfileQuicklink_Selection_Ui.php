 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProfileQuicklink_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProfileQuicklink_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProfileQuicklink_Selection_Element
    (
      'selectionWbfsysProfileQuicklink',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Profile Quicklinks', 'wbfsys.profile_quicklink.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ProfileQuicklink.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysProfileQuicklink',
      'WbfsysProfileQuicklink_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysProfileQuicklink_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProfileQuicklink_Selection_Ui
