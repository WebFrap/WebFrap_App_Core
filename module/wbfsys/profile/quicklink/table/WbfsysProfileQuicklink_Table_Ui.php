 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Profile Quicklinks
  *
  ...
  *  }
  *
  * @return WbfsysProfileQuicklink_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProfileQuicklink_Table_Element( 'tableWbfsysProfileQuicklink', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Profile Quicklinks', 'wbfsys.profile_quicklink.label' );
      //$tabPanel->searchKey = 'wbfsys_profile_quicklink';
      ...
      $searchElement->searchKey = 'wbfsys_profile_quicklink';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysProfileQuicklink_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProfileQuicklink', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysProfileQuicklink listing maske
   *
   * @param WbfsysProfileQuicklink_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysProfileQuicklink_Table_Ui
