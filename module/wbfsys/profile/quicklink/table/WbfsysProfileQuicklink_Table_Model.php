 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysProfileQuicklink_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysProfileQuicklink_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysProfileQuicklink_Table_Model
