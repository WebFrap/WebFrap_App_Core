 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_profile_quicklink';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysProfileQuicklink_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ProfileQuicklink.show&amp;target_mask=WbfsysProfileQuicklink&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ProfileQuicklink.edit&amp;target_mask=WbfsysProfileQuicklink&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.profile_quicklink.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ProfileQuicklink.delete&amp;target_mask=WbfsysProfileQuicklink&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.profile_quicklink.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Label', 'wbfsys.profile_quicklink.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'URL', 'wbfsys.profile_quicklink.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Short desc', 'wbfsys.profile_quicklink.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_profile_quicklink_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ProfileQuicklink.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_quicklink_label'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_quicklink_http_url'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_profile_quicklink_short_desc'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ProfileQuicklink_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Profile Quicklinks." >{$iconDelete} Delete selected Profile Quicklinks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Profile Quicklinks. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ProfileQuicklink_Multi.deleteAll" >{$iconClean} Delete all Profile Quicklinks</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProfileQuicklink_Table_Element
