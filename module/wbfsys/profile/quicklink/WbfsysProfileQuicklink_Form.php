 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_profile_quicklink';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysProfileQuicklink';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysProfileQuicklink' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysProfileQuicklink entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_profile( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysProfile_Entity' ) )
    {
      ...
      $inputIdProfile = $this->view->newInput( 'input'.$this->prefix.'IdProfile', 'Window' );
      $inputIdProfile->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_profile]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_profile'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Profile (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
      ));
      ...
      $inputIdProfile->setReadOnly( $this->isReadOnly( 'id_profile' ) );
      $inputIdProfile->setLabel( $this->view->i18n->l( 'Profile', 'wbfsys.profile_quicklink.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Profile.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_profile'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdProfile->buildJavascript( 'wgt-input-'.$this->keyName.'_id_profile'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_profile */
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.profile_quicklink.label' ),
  ...
  public function input_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Label (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
      ...
      $inputLabel->setLabel
      (
        $this->view->i18n->l( 'Label', 'wbfsys.profile_quicklink.label' ),
  ...
  public function input_http_url( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for URL (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'URL', 'wbfsys.profile_quicklink.label' ),
  ...
  * @return void
  */
  public function input_short_desc( $params )
  {

      //tpl: class ui:text
      $inputShortDesc = $this->view->newInput( 'input'.$this->prefix.'ShortDesc' , 'Text' );
      $this->items['short_desc'] = $inputShortDesc;
      $inputShortDesc->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[short_desc]',
          'id'        => 'wgt-input-'.$this->keyName.'_short_desc'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Short desc (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
          'maxlength' => $this->entity->maxSize( 'short_desc' ),
        )
      );
      $inputShortDesc->setWidth( 'medium' );

      $inputShortDesc->setReadOnly( $this->isReadOnly( 'short_desc' ) );
      $inputShortDesc->setData( $this->entity->getSecure('short_desc') );
      $inputShortDesc->setLabel
      (
        $this->view->i18n->l( 'Short desc', 'wbfsys.profile_quicklink.label' ),
        $this->entity->required( 'short_desc' )
      );
  ...
  }//end public function input_short_desc */
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.profile_quicklink.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.profile_quicklink.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.profile_quicklink.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.profile_quicklink.label' ) );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  public function search_label( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Label (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
          'maxlength' => $this->entity->maxSize( 'label' ),
        )
      );
      $inputLabel->setWidth( 'medium' );
  ...
  public function search_http_url( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_http_url'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for URL (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
        )
      );
      $inputHttpUrl->setWidth( 'medium' );
 ...
 /**
  * create the search element for field short_desc
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_short_desc( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_short_desc'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Short desc (Profile Quicklink)', 'wbfsys.profile_quicklink.label' ),
          'maxlength' => $this->entity->maxSize( 'short_desc' ),
        )
      );
      $inputShortDesc->setWidth( 'medium' );
  ...
  }//end public function search_short_desc */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_profile_quicklink_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_profile_quicklink_m_role_change';
...
}//end class WbfsysProfileQuicklink_Form */
