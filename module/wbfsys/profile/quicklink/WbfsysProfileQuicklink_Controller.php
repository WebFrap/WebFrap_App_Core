 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_profile_quicklink
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.ProfileQuicklink.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_profile_quicklink-create';

    $access = new WbfsysProfileQuicklink_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_profile_quicklink-create',
      'WbfsysProfileQuicklink_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysProfileQuicklink_Crud_Model */
    $model = $this->loadModel( 'WbfsysProfileQuicklink_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.ProfileQuicklink.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysProfileQuicklink = $model->getEntityWbfsysProfileQuicklink( $objid );
    ...
    $params->entity = $entityWbfsysProfileQuicklink;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_profile_quicklink:edit';

    $access = new WbfsysProfileQuicklink_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysProfileQuicklink );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_profile_quicklink-edit-'.$objid,
      'WbfsysProfileQuicklink_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_profile_quicklink:show';
    ...
    (
      'form-wbfsys_profile_quicklink-edit-'.$objid,
      'WbfsysProfileQuicklink_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_profile_quicklink
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.ProfileQuicklink.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-insert';

    $access = new WbfsysProfileQuicklink_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysProfileQuicklink = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_profile_quicklink-update-'.$entityWbfsysProfileQuicklink;
      ...
      {
        $access = new WbfsysProfileQuicklink_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysProfileQuicklink );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysProfileQuicklink';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_profile_quicklink',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysProfileQuicklink_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.ProfileQuicklink.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysProfileQuicklink, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysProfileQuicklink_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.ProfileQuicklink.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-delete-'.$objid;

    $access = new WbfsysProfileQuicklink_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysProfileQuicklink );
    ...
    $error = $model->delete( $entityWbfsysProfileQuicklink, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysProfileQuicklink, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.ProfileQuicklink.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.ProfileQuicklink.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-listing';
    ...
    $containerClass = 'WbfsysProfileQuicklink_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_profile_quicklink',
      'WbfsysProfileQuicklink_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysProfileQuicklink_Table_Model */
    $model = $this->loadModel( 'WbfsysProfileQuicklink_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_profile_quicklink-'.$params->ltype,
          'WbfsysProfileQuicklink',
          'List of Profile Quicklinks'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysProfileQuicklink
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysProfileQuicklink_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_profile_quicklink',
      'WbfsysProfileQuicklink_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysProfileQuicklink_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.ProfileQuicklink.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysProfileQuicklink_Selection_Model */
    $model   = $this->loadModel( 'WbfsysProfileQuicklink_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_profile_quicklink-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_profile_quicklink-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_profile_quicklink',
      'WbfsysProfileQuicklink',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysProfileQuicklink, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysProfileQuicklink_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysProfileQuicklink_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_profile_quicklink-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysProfileQuicklink_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysProfileQuicklink, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_profile_quicklink' );
...
} // end class WbfsysProfileQuicklink_Controller */
