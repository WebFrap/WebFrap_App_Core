 ...
 * @licence WebFrap.net
 */
class WbfsysProfileQuicklink_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysProfileQuicklink_'.$listType ) );
...
} // end class WbfsysProfileQuicklink_Listing_Controller */
