 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysProfile entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Profile.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Profile.insert';
    $params->formId       = 'wgt-form-wbfsys_profile';
    $params->namespace   = 'wbfsys_profile-create';
    ...
    $this->setTemplate( 'wbfsys/profile/modal/crud/form_create' );
...
}//end class WbfsysProfile_Crud_Create_Modal_View
