 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysProfile = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Profile.edit&amp;utf8=✓&amp;objid='.$entityWbfsysProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Profile.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_profile-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/profile/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysProfile_Crud_Edit' );
...
}//end class WbfsysProfile_Crud_Edit_Maintab_View
