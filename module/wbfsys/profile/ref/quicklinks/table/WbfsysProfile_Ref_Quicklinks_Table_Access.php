 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Ref_Quicklinks_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_profile_quicklink Attributes: id_profile; access_key; label; http_url; short_desc; revision; rowid; m_time_created; m_role_create_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_profile-ref-quicklinks',
      null,
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_profile-ref-quicklinks' );
  ...
  /**
   * @param WbfsysProfile_Ref_Quicklinks_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_profile_quicklink.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_profile_quicklink.rowid ",
      'acls'
    );
...
}//end class WbfsysProfile_Ref_Quicklinks_Table_Access
