 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Ref_Quicklinks_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Profile_Ref_Quicklinks.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysProfile_Ref_Quicklinks_Table_Ajax_View
