 ...
 * If you want to extend this class write your coden in ControllerWbfsysProfile
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Ref_Quicklinks_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des quicklinks Referenztabs
  * für den wbfsys_profile management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysProfile_Ref_Quicklinks_".$listType."_Access";
    ...
    $accessQuicklinks = new $containerClass( );
    $accessQuicklinks->load( $user->getProfileName(), $params );

    $params->aclNode = 'mgmt-wbfsys_profile-ref-quicklinks';

    $params->accessQuicklinks = $accessQuicklinks;
    $params->paramsQuicklinks = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessQuicklinks->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_profile-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysProfile_Ref_Quicklinks_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelQuicklinks = $this->loadModel
    (
      'WbfsysProfile_Ref_Quicklinks_'.$listType
    );
    $modelQuicklinks->setAccess( $accessQuicklinks );
    
    $view->setModel( $modelQuicklinks );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdQuicklinks = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysProfile_Ref_Quicklinks_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_profile-ref-quicklinks-'.$listType.'-ajax',
    	'WbfsysProfile_Ref_Quicklinks_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysProfileQuicklink by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_profile_quicklink' ); //def wbfsys_profile_quicklink


  } // end public function cleanPost */

} // end WbfsysProfile_Ref_Quicklinks_Controller
