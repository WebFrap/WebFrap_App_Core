 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysProfile_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysProfile_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysProfile_Selection_Element
    (
      'selectionWbfsysProfile',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Profiles', 'wbfsys.profile.label' ) ;
      $tabPanel->searchKey = 'wbfsys_profile';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Profile.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysProfile',
      'WbfsysProfile_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysProfile' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysProfile listing maske
   *
   * @param WbfsysProfile_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysProfile  = $model->getEntityWbfsysProfile();
    ...
    $formWbfsysProfile->setKeyName( 'wbfsys_profile' );
...
}//end class WbfsysProfile_Selection_Ui
