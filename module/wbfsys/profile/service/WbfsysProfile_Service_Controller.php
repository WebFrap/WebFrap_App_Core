 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Service_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    if( !$this->acl->access( 'mod-wbfsys>mgmt-wbfsys_profile:listing'  ) )
    {
    ...
    $params->contextKey = 'wbfsys_profile-service-autocomplete';

    $view  = $response->loadView
    ( 
    	'wbfsys_profile-service',
    	'WbfsysProfile_Service',
    	'displayAutocomplete',
    	View::AJAX 
    );
    
    
    $model  = $this->loadModel( 'WbfsysProfile_Service' );
...
}//end class WbfsysProfile_Service_Controller
