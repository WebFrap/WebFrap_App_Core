 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysProfile_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysProfile_Export_Listing_Access';
    ...
    // create a new WbfsysProfile window
    $view = $this->loadView
    (
    	'export-wbfsys_profile',
    	'WbfsysProfile_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysProfile_Export' );
...
} // end class WbfsysProfile_Export_Controller_Genf
