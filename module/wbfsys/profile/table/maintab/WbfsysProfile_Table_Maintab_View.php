 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysProfile_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysProfile_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/profile/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.Profile.listing&amp;ltype=table'
    );
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysProfile_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.Profile.create&amp;ltype=table');
    });
...
}//end class WbfsysProfile_Table_Maintab_View
