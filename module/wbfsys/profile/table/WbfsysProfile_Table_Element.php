 ...
 * @licence WebFrap.net
 */
class WbfsysProfile_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Profile.show&amp;target_mask=WbfsysProfile&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Profile.edit&amp;target_mask=WbfsysProfile&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.profile.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Profile.delete&amp;target_mask=WbfsysProfile&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.profile.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Profile_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Profiles." >{$iconDelete} Delete selected Profiles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Profiles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Profile_Multi.deleteAll" >{$iconClean} Delete all Profiles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysProfile_Table_Element
