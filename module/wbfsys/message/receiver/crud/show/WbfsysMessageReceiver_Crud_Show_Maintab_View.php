 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageReceiver_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageReceiver Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageReceiver = $this->model->getEntityWbfsysMessageReceiver();
    ...
    (
      ...
      array( 'text' => $entityWbfsysMessageReceiver->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageReceiver.show  &amp;objid='.$entityWbfsysMessageReceiver
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageReceiver.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_receiver-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_receiver/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageReceiver_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MessageReceiver.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_receiver' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_receiver a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MessageReceiver.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageReceiver.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageReceiver_Crud_Show_Maintab_View
