 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageReceiver Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageReceiver = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageReceiver.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageReceiver
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageReceiver.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_receiver-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_receiver/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageReceiver_Crud_Edit' );
...
}//end class WbfsysMessageReceiver_Crud_Edit_Maintab_View
