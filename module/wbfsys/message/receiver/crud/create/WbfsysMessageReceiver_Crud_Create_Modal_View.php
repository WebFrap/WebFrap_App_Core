 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageReceiver entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageReceiver.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageReceiver.insert';
    $params->formId       = 'wgt-form-wbfsys_message_receiver';
    $params->namespace   = 'wbfsys_message_receiver-create';
    ...
    $this->setTemplate( 'wbfsys/message_receiver/modal/crud/form_create' );
...
}//end class WbfsysMessageReceiver_Crud_Create_Modal_View
