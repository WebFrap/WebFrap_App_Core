 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysMessageReceiver', array_keys( $this->fields['wbfsys_message_receiver']), true ),
...
}//end class WbfsysMessageReceiver_Crud_Create_Form */
