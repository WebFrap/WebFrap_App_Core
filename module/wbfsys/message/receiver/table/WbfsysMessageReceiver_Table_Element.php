...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MessageStatus.listing" >'.Validator::sanitizeHtml($row['wbfsys_message_status_name']).'</a></td>'.NL;
