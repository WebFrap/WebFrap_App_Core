 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_receiver';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageReceiver_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageReceiver.show&amp;target_mask=WbfsysMessageReceiver&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageReceiver.edit&amp;target_mask=WbfsysMessageReceiver&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_receiver.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageReceiver.delete&amp;target_mask=WbfsysMessageReceiver&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_receiver.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.message_receiver.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_receiver_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MessageStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_status_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageReceiver_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Empfängers." >{$iconDelete} Delete selected Empfängers</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Empfängers. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageReceiver_Multi.deleteAll" >{$iconClean} Delete all Empfängers</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageReceiver_Table_Element
