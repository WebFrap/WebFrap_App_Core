 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Empfängers
  *
  ...
  *  }
  *
  * @return WbfsysMessageReceiver_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageReceiver_Table_Element( 'tableWbfsysMessageReceiver', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_receiver-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Empfängers', 'wbfsys.message_receiver.label' );
      //$tabPanel->searchKey = 'wbfsys_message_receiver';
      ...
      $searchElement->searchKey = 'wbfsys_message_receiver';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageReceiver_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageReceiver', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageReceiver listing maske
   *
   * @param WbfsysMessageReceiver_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageReceiver  = $model->getEntityWbfsysMessageReceiver();
    ...
    $formWbfsysMessageReceiver->setKeyName( 'wbfsys_message_receiver' );
...
}//end class WbfsysMessageReceiver_Table_Ui
