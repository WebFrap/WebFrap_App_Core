 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageReceiver_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_message_receiver.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_receiver.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageReceiver_Table_Access
