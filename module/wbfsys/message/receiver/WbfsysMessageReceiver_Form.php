 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_receiver';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageReceiver';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageReceiver' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageReceiver entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function input_id_status( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysMessageStatus_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdStatus = $this->view->newItem( 'input'.$this->prefix.'IdStatus' , 'WbfsysMessageStatus_Selectbox' );
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Status (Message Receiver)', 'wbfsys.message_receiver.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Status', 'wbfsys.message_receiver.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputIdStatus->editUrl = 'index.php?c=Wbfsys.MessageStatus.listing&amp;target='.$this->namespace.'&amp;field=id_status&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_status'.$this->suffix;
      }
  ...
  * @return void
  */
  public function input_visible( $params )
  {

      //tpl: class ui:Checkbox
      $inputVisible = $this->view->newInput( 'input'.$this->prefix.'Visible' , 'Checkbox' );
      $this->items['visible'] = $inputVisible;
      $inputVisible->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[visible]',
          'id'        => 'wgt-input-'.$this->keyName.'_visible'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Visible (Message Receiver)', 'wbfsys.message_receiver.label' ),
        )
      );
      $inputVisible->setWidth( 'medium' );

      $inputVisible->setReadOnly( $this->isReadOnly( 'visible' ) );
      $inputVisible->setActive( $this->entity->getBoolean( 'visible' ) );
      $inputVisible->setLabel
      (
        $this->view->i18n->l( 'Visible', 'wbfsys.message_receiver.label' ),
        $this->entity->required( 'visible' )
      );
  ...
  }//end public function input_visible */
  ...
  * @return void
  */
  public function input_opened( $params )
  {

      //tpl: class ui:timestamp
      $inputOpened = $this->view->newInput( 'input'.$this->prefix.'Opened' , 'Timestamp' );
      $this->items['opened'] = $inputOpened;
      $inputOpened->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[opened]',
          'id'        => 'wgt-input-'.$this->keyName.'_opened'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Opened (Message Receiver)', 'wbfsys.message_receiver.label' ),
          'maxlength' => $this->entity->maxSize( 'opened' ),
        )
      );
      $inputOpened->setWidth( 'medium' );

      $inputOpened->setReadOnly( $this->isReadOnly( 'opened' ) );
      $inputOpened->setData( $this->entity->getTimestamp( 'opened' ) );
      $inputOpened->setLabel
      (
        $this->view->i18n->l( 'Opened', 'wbfsys.message_receiver.label' ),
        $this->entity->required( 'opened' )
      );
  ...
  }//end public function input_opened */
  ...
  * @return void
  */
  public function input_id_message( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMessage_Entity' ) )
    {
      ...
      $inputIdMessage = $this->view->newInput( 'input'.$this->prefix.'IdMessage', 'Window' );
      $inputIdMessage->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_message]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_message'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Message (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ));
      ...
      $inputIdMessage->setReadOnly( $this->isReadOnly( 'id_message' ) );
      $inputIdMessage->setLabel( $this->view->i18n->l( 'Message', 'wbfsys.message_receiver.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Message.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_message'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdMessage->buildJavascript( 'wgt-input-'.$this->keyName.'_id_message'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_message */
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_receiver'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Receiver (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ));
      ...
      $inputIdReceiver->setLabel( $this->view->i18n->l( 'Receiver', 'wbfsys.message_receiver.label' ) );
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Receiver)', 'wbfsys.message_receiver.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_receiver.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_receiver.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_receiver.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_receiver.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Receiver)', 'wbfsys.message_receiver.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_receiver.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Receiver)', 'wbfsys.message_receiver.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_receiver.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Receiver)', 'wbfsys.message_receiver.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_receiver.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysMessageStatus_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Status (Message Receiver)', 'wbfsys.message_receiver.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_receiver_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_receiver_m_role_change';
...
}//end class WbfsysMessageReceiver_Form */
