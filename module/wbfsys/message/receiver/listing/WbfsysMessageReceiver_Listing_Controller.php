 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReceiver_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageReceiver_'.$listType ) );
...
} // end class WbfsysMessageReceiver_Listing_Controller */
