 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_log';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageLog_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageLog.show&amp;target_mask=WbfsysMessageLog&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageLog.edit&amp;target_mask=WbfsysMessageLog&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_log.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageLog.delete&amp;target_mask=WbfsysMessageLog&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_log.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:150px" >Title</th>'.NL;
    $html .= '<th style="width:150px" >Address</th>'.NL;
    $html .= '<th style="width:150px" >Sender</th>'.NL;
    $html .= '<th style="width:150px"  wgt_sort="desc"  wgt_sort_name="order-wbfsys_message_log[m_time_created]" >Time</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $objid       = $row['wbfsys_message_log_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_log_title'])).'</td>'.NL;
      $body .= '<td valign="top" >'.( trim( $row['wbfsys_message_log_email'] ) == '' ? ' ' : '<a href="mailto:'.Validator::sanitizeHtml($row['wbfsys_message_log_email']).'">'.Validator::sanitizeHtml($row['wbfsys_message_log_email']).'</a>' ).'</td>'.NL;
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MessageLog.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_role_user_name'])).'</a></td>'.NL;
      $body .= '<td valign="top" >'.('' != trim($row['wbfsys_message_log_m_time_created'])?$this->view->i18n->date($row['wbfsys_message_log_m_time_created']):' ').'</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageLog_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Message Logs." >{$iconDelete} Delete selected Message Logs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Message Logs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageLog_Multi.deleteAll" >{$iconClean} Delete all Message Logs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageLog_Table_Element
