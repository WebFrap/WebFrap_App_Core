 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageLog_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_log.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageLog_Table_Access
