 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Message Logs
  *
  ...
  *  }
  *
  * @return WbfsysMessageLog_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageLog_Table_Element( 'tableWbfsysMessageLog', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_log-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Message Logs', 'wbfsys.message_log.label' );
      //$tabPanel->searchKey = 'wbfsys_message_log';
      ...
      $searchElement->searchKey = 'wbfsys_message_log';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageLog_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageLog', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageLog listing maske
   *
   * @param WbfsysMessageLog_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageLog  = $model->getEntityWbfsysMessageLog();
    ...
    $formWbfsysMessageLog->setKeyName( 'wbfsys_message_log' );
...
}//end class WbfsysMessageLog_Table_Ui
