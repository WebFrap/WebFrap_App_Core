 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageLog_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageLog_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageLog_Entity */
      $entity = $orm->get( 'WbfsysMessageLog', $rootId );
    }
...
}//end class WbfsysMessageLog_Crud_Access_Root
