 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageLog entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageLog.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageLog.insert';
    $params->formId       = 'wgt-form-wbfsys_message_log';
    $params->namespace   = 'wbfsys_message_log-create';
    ...
    $this->setTemplate( 'wbfsys/message_log/modal/crud/form_create' );
...
}//end class WbfsysMessageLog_Crud_Create_Modal_View
