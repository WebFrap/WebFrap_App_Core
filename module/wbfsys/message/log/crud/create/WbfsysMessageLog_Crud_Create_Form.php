 ...
 * @licence WebFrap.net
 */
class WbfsysMessageLog_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysMessageLog', array_keys( $this->fields['wbfsys_message_log']), true ),
...
}//end class WbfsysMessageLog_Crud_Create_Form */
