 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Crud_Model */
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMessage = $model->getEntityWbfsysMessage( $objid );
    ...
    $params->entity = $entityWbfsysMessage;
    ...
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_message:edit';

    $access = new WbfsysMessage_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessage );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_message-edit',
          $entityWbfsysMessage,
          'Edit Message :'.$entityWbfsysMessage->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_message:show';
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_message-show',
          $entityWbfsysMessage,
          'Show Message :'.$entityWbfsysMessage->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    else
    {
    	...
    	$entityWbfsysMessage = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_message-update-'.$entityWbfsysMessage;
      ...
      // model wird benötigt
      /* @var $model WbfsysMessage_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMessage, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    $error = $model->delete( $entityWbfsysMessage, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMessage, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.Message.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Table_Model */
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMessage_Selection' );
    $model->setAccess( $access );
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      ...
      $params->contextKey = 'wbfsys_message-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMessage, $params );
