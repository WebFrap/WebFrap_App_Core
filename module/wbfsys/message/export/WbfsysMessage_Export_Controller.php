 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessage_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessage_Export_Listing_Access';
    ...
    // create a new WbfsysMessage window
    $view = $this->loadView
    (
    	'export-wbfsys_message',
    	'WbfsysMessage_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessage_Export' );
...
} // end class WbfsysMessage_Export_Controller_Genf
