 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message_sendway')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessageSendway = $orm->get('WbfsysMessageSendway', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_message_sendway_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessageSendway_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageSendway_Acl' );
    /* @var $query WbfsysMessageSendway_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageSendway_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessageSendway_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageSendway_Acl_Qfdu' );
    /* @var $query WbfsysMessageSendway_Acl_Qfdu_Query  */
...
} // end class WbfsysMessageSendway_Acl_Qfdu_Model */
