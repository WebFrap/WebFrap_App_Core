 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_message_sendway.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_message_sendway.rowid as id,
    wbfsys_message_sendway.rowid as value,
    wbfsys_message_sendway.rowid as label
  FROM
...
} // end class WbfsysMessageSendway_Acl_Qfdu_Query_Postgresql */
