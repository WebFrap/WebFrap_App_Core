 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessageSendway_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message_sendway-acl-qfdu-aAjax',
      'WbfsysMessageSendway_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessageSendway_Acl_Qfdu_Controller */
