 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_message_sendway.rowid as "wbfsys_message_sendway_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_message_sendway on wbfsys_group_users.vid = wbfsys_message_sendway.rowid'
    );
...
} // end class WbfsysMessageSendway_Acl_Qfdu_Treetable_Query_Postgresql */
