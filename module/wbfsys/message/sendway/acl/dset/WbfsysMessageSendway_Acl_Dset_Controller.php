 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageSendway_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessageSendway_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessageSendway = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageSendway_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message_sendway-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessageSendway, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_message_sendway-acl-dset', 
    	'WbfsysMessageSendway_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageSendway_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message_sendway-acl-dset', 
    	'WbfsysMessageSendway_Acl_Dset',
...
} // end class WbfsysMessageSendway_Acl_Dset_Controller */
