 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message_sendway'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessageSendway', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageSendway_Acl_Dset' );
    /* @var $query WbfsysMessageSendway_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageSendway_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessageSendway_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessageSendway_Acl_Dset_Model */
