 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessageSendway_Acl_Dset' );
    ...
    $entityWbfsysMessageSendway = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessageSendway_Acl_Dset_Ajax_View */
