 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessageSendway_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessageSendway_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessageSendway, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessageSendway_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message_sendway-acl-dset' );
    ...
    else
    {
      ...
      (
        'Message Sendway "{@label@}" User Access',
        'wbfsys.message_sendway.label',
        array
        (
          'label' => $entityWbfsysMessageSendway->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_sendway_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessageSendway_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessageSendway_Acl_Dset_Ui */
