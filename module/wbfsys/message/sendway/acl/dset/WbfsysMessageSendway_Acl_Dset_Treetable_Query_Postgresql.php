 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message_sendway.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessageSendway_Acl_Dset_Treetable_Query_Postgresql */
