 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessageSendway_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageSendway_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_message_sendway-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Message Sendway', 'wbfsys.message_sendway.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_sendway_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysMessageSendway_Acl_Table'
    );
...
} // end class WbfsysMessageSendway_Acl_Ui */
