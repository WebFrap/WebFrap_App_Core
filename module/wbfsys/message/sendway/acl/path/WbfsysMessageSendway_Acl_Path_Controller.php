 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_message_sendway_acl_graph', 
      'WbfsysMessageSendway_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMessageSendway_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMessageSendway_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMessageSendway_Acl_Path_Maintab_View  */
...
} // end class WbfsysMessageSendway_Acl_Path_Controller */
