 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessageSendway
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessageSendway_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_message_sendway_acl_listing',
      'WbfsysMessageSendway_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysMessageSendway_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageSendway_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessageSendway_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_sendway-acl',
    	'WbfsysMessageSendway_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_sendway_acl_masks_listing',
      'WbfsysMessageSendway_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessageSendway_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessageSendway_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageSendway_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessageSendway_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessageSendway_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessageSendway_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_sendway-acl-qfdu',
    	'WbfsysMessageSendway_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessageSendway_Acl_Controller */
