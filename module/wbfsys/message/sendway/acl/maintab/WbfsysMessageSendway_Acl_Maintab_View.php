 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysMessageSendway_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageSendway_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_sendway-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MessageSendway_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message_sendway-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message_sendway/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Message Sendway', 'wbfsys.message_sendway.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_sendway_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessageSendway_Acl' );
...
} // end class WbfsysMessageSendway_Acl_Maintab_View */
