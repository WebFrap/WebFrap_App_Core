 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message_sendway') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_message_sendway.{$fieldName}
...
}//end class WbfsysMessageSendway_Filter
