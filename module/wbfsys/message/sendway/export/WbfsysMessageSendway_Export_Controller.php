 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessageSendway_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessageSendway_Export_Listing_Access';
    ...
    // create a new WbfsysMessageSendway window
    $view = $this->loadView
    (
    	'export-wbfsys_message_sendway',
    	'WbfsysMessageSendway_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessageSendway_Export' );
...
} // end class WbfsysMessageSendway_Export_Controller_Genf
