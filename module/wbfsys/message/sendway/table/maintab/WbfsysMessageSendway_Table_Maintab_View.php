 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageSendway_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysMessageSendway_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_sendway/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Message Sendways',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.MessageSendway.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageSendway.search';

    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_sendway-search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysMessageSendway_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.MessageSendway.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.MessageSendway.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.MessageSendway.create&amp;ltype=table');
    });
...
}//end class WbfsysMessageSendway_Table_Maintab_View
