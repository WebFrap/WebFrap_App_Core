 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Message Sendways
  *
  ...
  *  }
  *
  * @return WbfsysMessageSendway_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageSendway_Table_Element( 'tableWbfsysMessageSendway', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Message Sendways', 'wbfsys.message_sendway.label' );
      //$tabPanel->searchKey = 'wbfsys_message_sendway';
      ...
      $searchElement->searchKey = 'wbfsys_message_sendway';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageSendway_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageSendway', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageSendway listing maske
   *
   * @param WbfsysMessageSendway_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageSendway_Table_Ui
