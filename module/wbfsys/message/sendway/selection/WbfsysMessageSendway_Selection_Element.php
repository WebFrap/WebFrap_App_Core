 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_message_sendway';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageSendway_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageSendway.show&amp;target_mask=WbfsysMessageSendway&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageSendway.edit&amp;target_mask=WbfsysMessageSendway&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_sendway.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageSendway.delete&amp;target_mask=WbfsysMessageSendway&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_sendway.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_sendway_rowid'];
...
}//end class WbfsysMessageSendway_Selection_Element
