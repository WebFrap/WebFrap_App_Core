 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageSendway_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageSendway_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageSendway_Selection_Element
    (
      'selectionWbfsysMessageSendway',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Message Sendways', 'wbfsys.message_sendway.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageSendway.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageSendway',
      'WbfsysMessageSendway_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageSendway_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageSendway_Selection_Ui
