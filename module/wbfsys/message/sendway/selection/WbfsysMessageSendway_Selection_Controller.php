 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageSendway_Selection' ) );
...
} // end class WbfsysMessageSendway_Selection_Controller */
