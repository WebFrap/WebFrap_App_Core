 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageSendway Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_sendway-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_sendway/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageSendway.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_sendway';
    ...
    $form = $this->newForm( 'WbfsysMessageSendway_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageSendway.create');}});
});
...
}//end class WbfsysMessageSendway_Crud_Create_Maintab_View
