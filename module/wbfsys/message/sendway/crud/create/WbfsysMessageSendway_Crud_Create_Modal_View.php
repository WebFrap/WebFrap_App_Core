 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageSendway entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageSendway.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageSendway.insert';
    $params->formId       = 'wgt-form-wbfsys_message_sendway';
    $params->namespace   = 'wbfsys_message_sendway-create';
    ...
    $this->setTemplate( 'wbfsys/message_sendway/modal/crud/form_create' );
...
}//end class WbfsysMessageSendway_Crud_Create_Modal_View
