 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageSendway_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageSendway_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageSendway_Entity */
      $entity = $orm->get( 'WbfsysMessageSendway', $rootId );
    }
...
}//end class WbfsysMessageSendway_Crud_Access_Root
