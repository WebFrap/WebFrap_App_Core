 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageSendway Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageSendway = $this->model->getEntityWbfsysMessageSendway();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Message Sendway: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageSendway.show  &amp;objid='.$entityWbfsysMessageSendway
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageSendway.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_sendway-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_sendway/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageSendway_Crud_Show' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageSendway.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageSendway_Crud_Show_Maintab_View
