 ...
 * @licence WebFrap.net
 */
class WbfsysMessageSendway_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_message_sendway
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MessageSendway.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_message_sendway-create';

    $access = new WbfsysMessageSendway_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_message_sendway-create',
      'WbfsysMessageSendway_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysMessageSendway_Crud_Model */
    $model = $this->loadModel( 'WbfsysMessageSendway_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MessageSendway.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMessageSendway = $model->getEntityWbfsysMessageSendway( $objid );
    ...
    $params->entity = $entityWbfsysMessageSendway;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_message_sendway:edit';

    $access = new WbfsysMessageSendway_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageSendway );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_message_sendway-edit-'.$objid,
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_message_sendway-edit',
          $entityWbfsysMessageSendway,
          'Edit Message Sendway :'.$entityWbfsysMessageSendway->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_message_sendway';
      $params->maskRoot      = 'wbfsys_message_sendway:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_message_sendway';
      $params->aclNode       = 'mgmt-wbfsys_message_sendway';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_message_sendway-edit-'.$objid,
      'WbfsysMessageSendway_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_message_sendway-show',
          $entityWbfsysMessageSendway,
          'Show Message Sendway :'.$entityWbfsysMessageSendway->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_message_sendway
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MessageSendway.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-insert';

    $access = new WbfsysMessageSendway_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysMessageSendway = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_message_sendway-update-'.$entityWbfsysMessageSendway;
      ...
      {
        $access = new WbfsysMessageSendway_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysMessageSendway );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysMessageSendway';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_message_sendway',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysMessageSendway_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MessageSendway.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMessageSendway, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMessageSendway_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageSendway.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-delete-'.$objid;

    $access = new WbfsysMessageSendway_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageSendway );
    ...
    $error = $model->delete( $entityWbfsysMessageSendway, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMessageSendway, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageSendway.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MessageSendway.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-listing';
    ...
    $containerClass = 'WbfsysMessageSendway_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_message_sendway',
      'WbfsysMessageSendway_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysMessageSendway_Table_Model */
    $model = $this->loadModel( 'WbfsysMessageSendway_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_message_sendway-'.$params->ltype,
          'WbfsysMessageSendway',
          'List of Message Sendways'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMessageSendway
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMessageSendway_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_message_sendway',
      'WbfsysMessageSendway_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMessageSendway_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MessageSendway.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageSendway_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMessageSendway_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_message_sendway-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_message_sendway-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_message_sendway',
      'WbfsysMessageSendway',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMessageSendway, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysMessageSendway_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMessageSendway_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_sendway-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_message_sendway' );
...
} // end class WbfsysMessageSendway_Controller */
