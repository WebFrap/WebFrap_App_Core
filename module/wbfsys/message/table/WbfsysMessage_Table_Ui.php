...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Messages
  *
  ...
  *  }
  *
  * @return WbfsysMessage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessage_Table_Element( 'tableWbfsysMessage', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Messages', 'wbfsys.message.label' );
      ...
      $searchElement->searchKey = 'wbfsys_message';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessage_Table_Element( null,$view );
...
}//end class WbfsysMessage_Table_Ui
