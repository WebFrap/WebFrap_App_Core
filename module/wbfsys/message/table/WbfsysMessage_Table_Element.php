 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Message.show&amp;target_mask=WbfsysMessage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Message.edit&amp;target_mask=WbfsysMessage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Tags',
            'modal.php?c=Wbfsys.Message_Ref_Tags.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Send Ways',
            'modal.php?c=Wbfsys.Message_Ref_SendWay.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Data Links',
            'modal.php?c=Wbfsys.Message_Ref_Link.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'References',
            'modal.php?c=Wbfsys.Message_Ref_References.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.message.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attachments',
            'modal.php?c=Wbfsys.Message_Ref_Attachments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.message.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Message.delete&amp;target_mask=WbfsysMessage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_message&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.message.label',
        Acl::ADMIN
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Message_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Messages." >{$iconDelete} Delete selected Messages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Messages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Message_Multi.deleteAll" >{$iconClean} Delete all Messages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessage_Table_Element
