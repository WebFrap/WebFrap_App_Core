 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysMessageProfile', array_keys( $this->fields['wbfsys_message_profile']), true ),
...
}//end class WbfsysMessageProfile_Crud_Create_Form */
