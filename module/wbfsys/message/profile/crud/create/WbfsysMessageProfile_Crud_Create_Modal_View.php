 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageProfile entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageProfile.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageProfile.insert';
    $params->formId       = 'wgt-form-wbfsys_message_profile';
    $params->namespace   = 'wbfsys_message_profile-create';
    ...
    $this->setTemplate( 'wbfsys/message_profile/modal/crud/form_create' );
...
}//end class WbfsysMessageProfile_Crud_Create_Modal_View
