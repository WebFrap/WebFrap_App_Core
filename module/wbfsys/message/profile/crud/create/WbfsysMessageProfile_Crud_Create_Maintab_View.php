 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageProfile Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_profile-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_profile/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageProfile.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_profile';
    ...
    $form = $this->newForm( 'WbfsysMessageProfile_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageProfile.create');}});
});
...
}//end class WbfsysMessageProfile_Crud_Create_Maintab_View
