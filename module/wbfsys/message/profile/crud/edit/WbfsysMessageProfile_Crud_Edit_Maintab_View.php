 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageProfile = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageProfile.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageProfile.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_profile-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_profile/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageProfile_Crud_Edit' );
...
}//end class WbfsysMessageProfile_Crud_Edit_Maintab_View
