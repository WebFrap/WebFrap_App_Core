 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageProfile_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageProfile_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageProfile_Entity */
      $entity = $orm->get( 'WbfsysMessageProfile', $rootId );
    }
...
}//end class WbfsysMessageProfile_Crud_Access_Root
