 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageProfile = $this->model->getEntityWbfsysMessageProfile();
    ...
    (
      ...
      array( 'text' => $entityWbfsysMessageProfile->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageProfile.show  &amp;objid='.$entityWbfsysMessageProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageProfile.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_profile-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_profile/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageProfile_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MessageProfile.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_profile' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_profile a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MessageProfile.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageProfile.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageProfile_Crud_Show_Maintab_View
