 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_profile';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageProfile_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageProfile.show&amp;target_mask=WbfsysMessageProfile&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageProfile.edit&amp;target_mask=WbfsysMessageProfile&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_profile.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageProfile.delete&amp;target_mask=WbfsysMessageProfile&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_profile.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.message_profile.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.message_profile.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Visibility', 'wbfsys.message_profile.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'User name', 'wbfsys.message_profile.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_profile_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MessageProfile.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_profile_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MessageProfileType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_profile_type_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.UserContactVisibility.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_contact_visibility_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MessageProfile.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_profile_user_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageProfile_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Nachrichten Quelles." >{$iconDelete} Delete selected Nachrichten Quelles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Nachrichten Quelles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageProfile_Multi.deleteAll" >{$iconClean} Delete all Nachrichten Quelles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageProfile_Table_Element
