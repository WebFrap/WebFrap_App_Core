 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageProfile_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_profile.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageProfile_Table_Access
