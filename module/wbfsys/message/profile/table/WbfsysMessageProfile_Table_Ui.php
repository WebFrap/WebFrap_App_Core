 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfile_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Nachrichten Quelles
  *
  ...
  *  }
  *
  * @return WbfsysMessageProfile_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageProfile_Table_Element( 'tableWbfsysMessageProfile', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_profile-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Nachrichten Quelles', 'wbfsys.message_profile.label' );
      //$tabPanel->searchKey = 'wbfsys_message_profile';
      ...
      $searchElement->searchKey = 'wbfsys_message_profile';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageProfile_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageProfile', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageProfile listing maske
   *
   * @param WbfsysMessageProfile_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageProfile  = $model->getEntityWbfsysMessageProfile();
    ...
    $formWbfsysMessageProfile->setKeyName( 'wbfsys_message_profile' );
...
}//end class WbfsysMessageProfile_Table_Ui
