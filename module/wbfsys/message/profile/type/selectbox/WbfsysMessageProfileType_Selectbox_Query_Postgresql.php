 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysMessageProfileType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_message_profile_type.rowid as id',
      'wbfsys_message_profile_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_message_profile_type.m_order as "wbfsys_message_profile_type-m_order-order"' );

    $criteria->from( 'wbfsys_message_profile_type' );



      $criteria->orderBy( 'wbfsys_message_profile_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_message_profile_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_message_profile_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysMessageProfileType_Selectbox_Query_Postgresql
