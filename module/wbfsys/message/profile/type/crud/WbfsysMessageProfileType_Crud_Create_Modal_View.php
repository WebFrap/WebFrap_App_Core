 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageProfileType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageProfileType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageProfileType.insert';
    $params->formId       = 'wgt-form-wbfsys_message_profile_type';
    $params->namespace   = 'wbfsys_message_profile_type-create';
    ...
    $this->setTemplate( 'wbfsys/message_profile_type/modal/crud/form_create' );
...
}//end class WbfsysMessageProfileType_Crud_Create_Modal_View
