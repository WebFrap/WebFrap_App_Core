 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageProfileType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageProfileType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit message profile Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageProfileType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageProfileType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageProfileType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_profile_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_profile_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageProfileType_Crud_Edit' );
...
}//end class WbfsysMessageProfileType_Crud_Edit_Maintab_View
