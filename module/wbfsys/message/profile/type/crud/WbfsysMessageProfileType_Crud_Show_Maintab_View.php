 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageProfileType_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageProfileType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageProfileType = $this->model->getEntityWbfsysMessageProfileType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show message profile Type: {@text@}',
      'wbfsys.message_profile_type.label',
      array( 'text' => $entityWbfsysMessageProfileType->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'message profile Type: {@text@}',
      'wbfsys.message_profile_type.label',
      array( 'text' => $entityWbfsysMessageProfileType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageProfileType.show  &amp;objid='.$entityWbfsysMessageProfileType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageProfileType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_profile_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_profile_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageProfileType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MessageProfileType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_profile_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_profile_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MessageProfileType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageProfileType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageProfileType_Crud_Show_Maintab_View
