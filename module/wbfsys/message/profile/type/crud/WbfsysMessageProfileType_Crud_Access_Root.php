 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageProfileType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageProfileType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageProfileType_Entity */
      $entity = $orm->get( 'WbfsysMessageProfileType', $rootId );
    }
...
}//end class WbfsysMessageProfileType_Crud_Access_Root
