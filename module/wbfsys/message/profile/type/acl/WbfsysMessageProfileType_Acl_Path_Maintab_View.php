 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_profile_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'message profile Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_profile_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_message_profile_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysMessageProfileType_Acl_Path_Maintab_View */
