 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message_profile_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessageProfileType_Acl_Dset_Treetable_Query_Postgresql */
