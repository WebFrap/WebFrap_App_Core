 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessageProfileType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessageProfileType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessageProfileType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessageProfileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message_profile_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'message profile Type "{@label@}" User Access',
        'wbfsys.message_profile_type.label',
        array
        (
          'label' => $entityWbfsysMessageProfileType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_profile_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessageProfileType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessageProfileType_Acl_Dset_Ui */
