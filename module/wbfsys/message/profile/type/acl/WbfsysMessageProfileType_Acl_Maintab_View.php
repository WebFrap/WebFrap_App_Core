 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysMessageProfileType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageProfileType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_profile_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MessageProfileType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message_profile_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message_profile_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'message profile Type', 'wbfsys.message_profile_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_profile_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessageProfileType_Acl' );
...
} // end class WbfsysMessageProfileType_Acl_Maintab_View */
