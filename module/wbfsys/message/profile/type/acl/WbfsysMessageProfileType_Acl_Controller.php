 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessageProfileType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessageProfileType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_message_profile_type_acl_listing',
      'WbfsysMessageProfileType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysMessageProfileType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageProfileType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessageProfileType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_profile_type-acl',
    	'WbfsysMessageProfileType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_profile_type_acl_masks_listing',
      'WbfsysMessageProfileType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessageProfileType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessageProfileType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageProfileType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessageProfileType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessageProfileType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessageProfileType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_profile_type-acl-qfdu',
    	'WbfsysMessageProfileType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessageProfileType_Acl_Controller */
