 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessageProfileType_Acl_Dset' );
    ...
    $entityWbfsysMessageProfileType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessageProfileType_Acl_Dset_Ajax_View */
