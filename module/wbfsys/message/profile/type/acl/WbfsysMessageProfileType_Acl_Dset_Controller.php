 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageProfileType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessageProfileType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessageProfileType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageProfileType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message_profile_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessageProfileType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_message_profile_type-acl-dset', 
    	'WbfsysMessageProfileType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageProfileType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message_profile_type-acl-dset', 
    	'WbfsysMessageProfileType_Acl_Dset',
...
} // end class WbfsysMessageProfileType_Acl_Dset_Controller */
