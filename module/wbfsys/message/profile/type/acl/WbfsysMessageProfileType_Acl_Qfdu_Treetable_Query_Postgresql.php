 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_message_profile_type.name as "wbfsys_message_profile_type_name"',
      'wbfsys_message_profile_type.rowid as "wbfsys_message_profile_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_message_profile_type on wbfsys_group_users.vid = wbfsys_message_profile_type.rowid'
    );
...
} // end class WbfsysMessageProfileType_Acl_Qfdu_Treetable_Query_Postgresql */
