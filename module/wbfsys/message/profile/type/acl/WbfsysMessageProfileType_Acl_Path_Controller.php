 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_message_profile_type_acl_graph', 
      'WbfsysMessageProfileType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMessageProfileType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMessageProfileType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMessageProfileType_Acl_Path_Maintab_View  */
...
} // end class WbfsysMessageProfileType_Acl_Path_Controller */
