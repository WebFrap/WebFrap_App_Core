 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message_profile_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessageProfileType = $orm->get('WbfsysMessageProfileType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_message_profile_type_name']  = $refEntityWbfsysMessageProfileType->name;

    }
    $tabData['wbfsys_message_profile_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessageProfileType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageProfileType_Acl' );
    /* @var $query WbfsysMessageProfileType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageProfileType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessageProfileType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageProfileType_Acl_Qfdu' );
    /* @var $query WbfsysMessageProfileType_Acl_Qfdu_Query  */
...
} // end class WbfsysMessageProfileType_Acl_Qfdu_Model */
