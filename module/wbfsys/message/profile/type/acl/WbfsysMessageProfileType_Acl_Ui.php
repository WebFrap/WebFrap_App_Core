 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessageProfileType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageProfileType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL message profile Type', 
        'wbfsys.message_profile_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_message_profile_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'message profile Type', 'wbfsys.message_profile_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_profile_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysMessageProfileType_Acl_Table'
    );
...
} // end class WbfsysMessageProfileType_Acl_Ui */
