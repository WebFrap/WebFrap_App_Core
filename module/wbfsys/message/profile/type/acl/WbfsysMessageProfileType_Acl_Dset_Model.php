 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message_profile_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessageProfileType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageProfileType_Acl_Dset' );
    /* @var $query WbfsysMessageProfileType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageProfileType_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessageProfileType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessageProfileType_Acl_Dset_Model */
