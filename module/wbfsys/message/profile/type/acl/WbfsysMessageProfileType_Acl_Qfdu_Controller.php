 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessageProfileType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message_profile_type-acl-qfdu-aAjax',
      'WbfsysMessageProfileType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessageProfileType_Acl_Qfdu_Controller */
