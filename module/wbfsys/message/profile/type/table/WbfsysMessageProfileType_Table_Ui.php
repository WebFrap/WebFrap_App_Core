 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für message profile Types
  *
  ...
  *  }
  *
  * @return WbfsysMessageProfileType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageProfileType_Table_Element( 'tableWbfsysMessageProfileType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_profile_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'message profile Types', 'wbfsys.message_profile_type.label' );
      //$tabPanel->searchKey = 'wbfsys_message_profile_type';
      ...
      $searchElement->searchKey = 'wbfsys_message_profile_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageProfileType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageProfileType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageProfileType listing maske
   *
   * @param WbfsysMessageProfileType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageProfileType  = $model->getEntityWbfsysMessageProfileType();
    ...
    $formWbfsysMessageProfileType->setKeyName( 'wbfsys_message_profile_type' );
...
}//end class WbfsysMessageProfileType_Table_Ui
