 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_profile_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageProfileTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysMessageProfileTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysMessageProfileTypeI18n';
   ...
   *
   * @var WbfsysMessageProfileTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysMessageProfileTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageProfileTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageProfileTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.message_profile_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_message_profile_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_message_profile_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysMessageProfileType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysMessageProfileType not exists' );

      Log::warn('Looks like the Entity: WbfsysMessageProfileType is missing');
      ...
      //p: Window
      $objidWbfsysMessageProfileType = $this->entity->getData('id_wbfsys_message_profile_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysMessageProfileType
          || !$entityWbfsysMessageProfileType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysMessageProfileType = $this->db->orm->newEntity( 'WbfsysMessageProfileType' );
      }

      $inputIdWbfsysMessageProfileType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysMessageProfileType', 'Window' );
      $inputIdWbfsysMessageProfileType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_message_profile_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_message_profile_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Message Profile Type (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysMessageProfileType->assignedForm = $this->assignedForm;

      $inputIdWbfsysMessageProfileType->setWidth( 'medium' );

      $inputIdWbfsysMessageProfileType->setData( $this->entity->getData( 'id_wbfsys_message_profile_type' )  );
      $inputIdWbfsysMessageProfileType->setReadOnly( $this->isReadOnly( 'id_wbfsys_message_profile_type' ) );
      $inputIdWbfsysMessageProfileType->setLabel( $this->view->i18n->l( 'Wbfsys Message Profile Type', 'wbfsys.message_profile_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.MessageProfileType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_message_profile_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysMessageProfileType->setListUrl ( $listUrl );
      $inputIdWbfsysMessageProfileType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysMessageProfileType->setEntityUrl( 'maintab.php?c=Wbfsys.MessageProfileType.edit' );
      $inputIdWbfsysMessageProfileType->conEntity         = $entityWbfsysMessageProfileType;
      $inputIdWbfsysMessageProfileType->refresh           = $this->refresh;
      $inputIdWbfsysMessageProfileType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysMessageProfileType->view = $this->view;
      $inputIdWbfsysMessageProfileType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_message_profile_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysMessageProfileType );
  ...
  }//end public function input_id_wbfsys_message_profile_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.message_profile_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.message_profile_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_profile_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_profile_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_profile_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_profile_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_profile_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_profile_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_profile_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Message Profile Type I18n)', 'wbfsys.message_profile_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_profile_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_profile_type_i18n_m_role_change';
...
}//end class WbfsysMessageProfileTypeI18n_Form */
