 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMessageProfileType_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMessageProfileType_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysMessageProfileType_Selection_Model
