 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageProfileType_Selection' ) );
...
} // end class WbfsysMessageProfileType_Selection_Controller */
