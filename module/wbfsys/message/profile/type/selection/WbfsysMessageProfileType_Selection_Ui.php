 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageProfileType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageProfileType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageProfileType_Selection_Element
    (
      'selectionWbfsysMessageProfileType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection message profile Types', 'wbfsys.message_profile_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageProfileType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageProfileType',
      'WbfsysMessageProfileType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageProfileType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageProfileType_Selection_Ui
