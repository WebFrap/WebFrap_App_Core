 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message_profile_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_message_profile_type.{$fieldName}
...
}//end class WbfsysMessageProfileType_Filter
