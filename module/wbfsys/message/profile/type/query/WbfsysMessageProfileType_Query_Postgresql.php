 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_message_profile_type where rowid > 0;
SQL;
...
}//end class WbfsysMessageProfileType_Query_Postgresql
