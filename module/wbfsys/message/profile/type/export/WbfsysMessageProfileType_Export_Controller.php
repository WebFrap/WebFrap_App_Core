 ...
 * @licence WebFrap.net
 */
class WbfsysMessageProfileType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessageProfileType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessageProfileType_Export_Listing_Access';
    ...
    // create a new WbfsysMessageProfileType window
    $view = $this->loadView
    (
    	'export-wbfsys_message_profile_type',
    	'WbfsysMessageProfileType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessageProfileType_Export' );
...
} // end class WbfsysMessageProfileType_Export_Controller_Genf
