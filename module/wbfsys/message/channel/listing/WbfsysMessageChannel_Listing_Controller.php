 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageChannel_'.$listType ) );
...
} // end class WbfsysMessageChannel_Listing_Controller */
