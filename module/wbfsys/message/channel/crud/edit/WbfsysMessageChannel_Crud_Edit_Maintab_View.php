 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageChannel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageChannel = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Message Channel: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageChannel.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageChannel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageChannel.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_channel-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_channel/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageChannel_Crud_Edit' );
...
}//end class WbfsysMessageChannel_Crud_Edit_Maintab_View
