 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageChannel_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageChannel_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageChannel_Entity */
      $entity = $orm->get( 'WbfsysMessageChannel', $rootId );
    }
...
}//end class WbfsysMessageChannel_Crud_Access_Root
