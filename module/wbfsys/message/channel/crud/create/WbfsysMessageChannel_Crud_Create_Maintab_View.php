 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageChannel Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_channel-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_channel/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageChannel.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_channel';
    ...
    $form = $this->newForm( 'WbfsysMessageChannel_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageChannel.create');}});
});
...
}//end class WbfsysMessageChannel_Crud_Create_Maintab_View
