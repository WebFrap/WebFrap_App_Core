 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageChannel entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageChannel.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageChannel.insert';
    $params->formId       = 'wgt-form-wbfsys_message_channel';
    $params->namespace   = 'wbfsys_message_channel-create';
    ...
    $this->setTemplate( 'wbfsys/message_channel/modal/crud/form_create' );
...
}//end class WbfsysMessageChannel_Crud_Create_Modal_View
