 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageChannel_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_message_channel.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_channel.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageChannel_Table_Access
