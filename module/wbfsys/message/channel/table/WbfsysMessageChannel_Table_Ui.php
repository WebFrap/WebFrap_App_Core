 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Message Channels
  *
  ...
  *  }
  *
  * @return WbfsysMessageChannel_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageChannel_Table_Element( 'tableWbfsysMessageChannel', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_channel-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Message Channels', 'wbfsys.message_channel.label' );
      //$tabPanel->searchKey = 'wbfsys_message_channel';
      ...
      $searchElement->searchKey = 'wbfsys_message_channel';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageChannel_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageChannel', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageChannel listing maske
   *
   * @param WbfsysMessageChannel_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageChannel  = $model->getEntityWbfsysMessageChannel();
    ...
    $formWbfsysMessageChannel->setKeyName( 'wbfsys_message_channel' );
...
}//end class WbfsysMessageChannel_Table_Ui
