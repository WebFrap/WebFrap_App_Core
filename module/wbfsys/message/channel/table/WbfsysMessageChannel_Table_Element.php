 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannel_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_channel';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageChannel_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageChannel.show&amp;target_mask=WbfsysMessageChannel&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageChannel.edit&amp;target_mask=WbfsysMessageChannel&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_channel.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageChannel.delete&amp;target_mask=WbfsysMessageChannel&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_channel.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.message_channel.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.message_channel.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_channel_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MessageChannel.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_channel_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MessageChannelType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_channel_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageChannel_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Message Channels." >{$iconDelete} Delete selected Message Channels</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Message Channels. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageChannel_Multi.deleteAll" >{$iconClean} Delete all Message Channels</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageChannel_Table_Element
