 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessageChannelType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessageChannelType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessageChannelType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessageChannelType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message_channel_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'message channel Type "{@label@}" User Access',
        'wbfsys.message_channel_type.label',
        array
        (
          'label' => $entityWbfsysMessageChannelType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_channel_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessageChannelType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessageChannelType_Acl_Dset_Ui */
