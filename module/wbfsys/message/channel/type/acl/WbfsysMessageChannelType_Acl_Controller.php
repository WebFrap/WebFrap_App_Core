 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessageChannelType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessageChannelType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_message_channel_type_acl_listing',
      'WbfsysMessageChannelType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysMessageChannelType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageChannelType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessageChannelType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_channel_type-acl',
    	'WbfsysMessageChannelType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_channel_type_acl_masks_listing',
      'WbfsysMessageChannelType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessageChannelType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessageChannelType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageChannelType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessageChannelType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessageChannelType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessageChannelType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_channel_type-acl-qfdu',
    	'WbfsysMessageChannelType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessageChannelType_Acl_Controller */
