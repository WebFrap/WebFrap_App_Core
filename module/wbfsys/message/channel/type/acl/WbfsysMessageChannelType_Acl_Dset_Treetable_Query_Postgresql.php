 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message_channel_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessageChannelType_Acl_Dset_Treetable_Query_Postgresql */
