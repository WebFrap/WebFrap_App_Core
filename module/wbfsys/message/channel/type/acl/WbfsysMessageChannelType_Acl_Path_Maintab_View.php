 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_channel_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'message channel Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_channel_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_message_channel_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysMessageChannelType_Acl_Path_Maintab_View */
