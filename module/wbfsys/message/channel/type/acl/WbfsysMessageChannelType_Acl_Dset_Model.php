 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message_channel_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessageChannelType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageChannelType_Acl_Dset' );
    /* @var $query WbfsysMessageChannelType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageChannelType_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessageChannelType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessageChannelType_Acl_Dset_Model */
