 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_message_channel_type_acl_graph', 
      'WbfsysMessageChannelType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMessageChannelType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMessageChannelType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMessageChannelType_Acl_Path_Maintab_View  */
...
} // end class WbfsysMessageChannelType_Acl_Path_Controller */
