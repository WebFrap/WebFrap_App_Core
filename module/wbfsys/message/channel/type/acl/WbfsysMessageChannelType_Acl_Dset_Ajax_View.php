 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessageChannelType_Acl_Dset' );
    ...
    $entityWbfsysMessageChannelType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessageChannelType_Acl_Dset_Ajax_View */
