 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message_channel_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessageChannelType = $orm->get('WbfsysMessageChannelType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_message_channel_type_name']  = $refEntityWbfsysMessageChannelType->name;

    }
    $tabData['wbfsys_message_channel_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessageChannelType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageChannelType_Acl' );
    /* @var $query WbfsysMessageChannelType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageChannelType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessageChannelType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageChannelType_Acl_Qfdu' );
    /* @var $query WbfsysMessageChannelType_Acl_Qfdu_Query  */
...
} // end class WbfsysMessageChannelType_Acl_Qfdu_Model */
