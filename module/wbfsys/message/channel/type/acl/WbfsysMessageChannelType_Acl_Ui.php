 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessageChannelType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageChannelType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL message channel Type', 
        'wbfsys.message_channel_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_message_channel_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'message channel Type', 'wbfsys.message_channel_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_channel_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysMessageChannelType_Acl_Table'
    );
...
} // end class WbfsysMessageChannelType_Acl_Ui */
