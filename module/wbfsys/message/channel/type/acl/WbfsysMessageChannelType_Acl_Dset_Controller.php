 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageChannelType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessageChannelType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessageChannelType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageChannelType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message_channel_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessageChannelType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_message_channel_type-acl-dset', 
    	'WbfsysMessageChannelType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageChannelType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message_channel_type-acl-dset', 
    	'WbfsysMessageChannelType_Acl_Dset',
...
} // end class WbfsysMessageChannelType_Acl_Dset_Controller */
