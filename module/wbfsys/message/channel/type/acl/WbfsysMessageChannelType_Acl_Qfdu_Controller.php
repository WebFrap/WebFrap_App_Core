 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessageChannelType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message_channel_type-acl-qfdu-aAjax',
      'WbfsysMessageChannelType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessageChannelType_Acl_Qfdu_Controller */
