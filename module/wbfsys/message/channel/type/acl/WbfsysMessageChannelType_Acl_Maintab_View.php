 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysMessageChannelType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageChannelType_Acl.search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MessageChannelType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message_channel_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message_channel_type/maintab/acl/main_group_rights' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_channel_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessageChannelType_Acl' );
...
} // end class WbfsysMessageChannelType_Acl_Maintab_View */
