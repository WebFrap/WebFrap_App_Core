 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_message_channel_type where rowid > 0;
SQL;
...
}//end class WbfsysMessageChannelType_Query_Postgresql
