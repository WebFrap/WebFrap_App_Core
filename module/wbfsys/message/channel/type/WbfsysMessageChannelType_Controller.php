 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_message_channel_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MessageChannelType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_message_channel_type-create';

    $access = new WbfsysMessageChannelType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_message_channel_type-create',
    ...
    /* @var $model WbfsysMessageChannelType_Crud_Model */
    $model = $this->loadModel( 'WbfsysMessageChannelType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MessageChannelType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMessageChannelType = $model->getEntityWbfsysMessageChannelType( $objid );
    ...
    $params->entity = $entityWbfsysMessageChannelType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_message_channel_type:edit';

    $access = new WbfsysMessageChannelType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageChannelType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_message_channel_type-edit-'.$objid,
      'WbfsysMessageChannelType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_message_channel_type-edit',
          $entityWbfsysMessageChannelType,
          'Edit message channel Type :'.$entityWbfsysMessageChannelType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_message_channel_type:show';
    ...
    (
      'form-wbfsys_message_channel_type-edit-'.$objid,
      'WbfsysMessageChannelType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_message_channel_type-show',
          $entityWbfsysMessageChannelType,
          'Show message channel Type :'.$entityWbfsysMessageChannelType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_message_channel_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MessageChannelType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-insert';

    $access = new WbfsysMessageChannelType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysMessageChannelType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_message_channel_type-update-'.$entityWbfsysMessageChannelType;
      ...
      {
        $access = new WbfsysMessageChannelType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysMessageChannelType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysMessageChannelType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_message_channel_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysMessageChannelType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MessageChannelType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMessageChannelType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMessageChannelType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageChannelType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-delete-'.$objid;

    $access = new WbfsysMessageChannelType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageChannelType );
    ...
    $error = $model->delete( $entityWbfsysMessageChannelType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMessageChannelType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageChannelType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MessageChannelType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-listing';
    ...
    $containerClass = 'WbfsysMessageChannelType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_message_channel_type',
      'WbfsysMessageChannelType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysMessageChannelType_Table_Model */
    $model = $this->loadModel( 'WbfsysMessageChannelType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_message_channel_type-'.$params->ltype,
          'WbfsysMessageChannelType',
          'List of message channel Types'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMessageChannelType
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMessageChannelType_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_message_channel_type',
      'WbfsysMessageChannelType_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMessageChannelType_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MessageChannelType.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageChannelType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMessageChannelType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_message_channel_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_message_channel_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_message_channel_type',
      'WbfsysMessageChannelType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMessageChannelType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysMessageChannelType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMessageChannelType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_channel_type-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysMessageChannelType_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysMessageChannelType, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_message_channel_type' );
...
} // end class WbfsysMessageChannelType_Controller */
