 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new message channel Type"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_message_channel_type-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_message_channel_type-table-help hidden" >
    	      
<p>This is the message channel Type table.</p>
...
HTML;
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolEntity&dkey=wbfsys_message_channel_type" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
      </li>


      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsEntity&dkey=wbfsys_message_channel_type" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
      </li>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_message_channel_type-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
HTML;
  ...
  protected function entriesAcl( $params )
  {
    ...
    <li>
      ...
      <span>
      <ul>
                  <li><a class="wcm wcm_req_ajax" href="maintab.php?c=Acl.Mgmt.listing&amp;dkey=wbfsys_message_channel_type" >{$iconMgmt} {$this->view->i18n->l( 'ACLs Entity', 'wbf.label' )}</a></li>
      </ul>
      </span>
    </li>
...
}//end class WbfsysMessageChannelType_Table_Maintab_Menu
