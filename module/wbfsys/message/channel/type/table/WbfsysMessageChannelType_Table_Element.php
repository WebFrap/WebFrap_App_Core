 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_channel_type';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageChannelType.show&amp;target_mask=WbfsysMessageChannelType&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageChannelType.edit&amp;target_mask=WbfsysMessageChannelType&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_channel_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageChannelType.delete&amp;target_mask=WbfsysMessageChannelType&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_channel_type.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.MessageChannelType.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_channel_type_name'])).'</a></td>'.NL;
...
}//end class WbfsysMessageChannelType_Table_Element
