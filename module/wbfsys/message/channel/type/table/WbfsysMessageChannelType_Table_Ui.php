 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für message channel Types
  *
  ...
  *  }
  *
  * @return WbfsysMessageChannelType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageChannelType_Table_Element( 'tableWbfsysMessageChannelType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_channel_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'message channel Types', 'wbfsys.message_channel_type.label' );
      //$tabPanel->searchKey = 'wbfsys_message_channel_type';
      ...
      $searchElement->searchKey = 'wbfsys_message_channel_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageChannelType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageChannelType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageChannelType listing maske
   *
   * @param WbfsysMessageChannelType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageChannelType  = $model->getEntityWbfsysMessageChannelType();
    ...
    $formWbfsysMessageChannelType->setKeyName( 'wbfsys_message_channel_type' );
...
}//end class WbfsysMessageChannelType_Table_Ui
