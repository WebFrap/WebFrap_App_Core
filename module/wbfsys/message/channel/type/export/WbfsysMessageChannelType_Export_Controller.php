 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessageChannelType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessageChannelType_Export_Listing_Access';
    ...
    // create a new WbfsysMessageChannelType window
    $view = $this->loadView
    (
    	'export-wbfsys_message_channel_type',
    	'WbfsysMessageChannelType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessageChannelType_Export' );
...
} // end class WbfsysMessageChannelType_Export_Controller_Genf
