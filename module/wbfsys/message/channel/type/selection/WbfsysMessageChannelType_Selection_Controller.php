 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageChannelType_Selection' ) );
...
} // end class WbfsysMessageChannelType_Selection_Controller */
