 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_message_channel_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageChannelType_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageChannelType.show&amp;target_mask=WbfsysMessageChannelType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageChannelType.edit&amp;target_mask=WbfsysMessageChannelType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_channel_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageChannelType.delete&amp;target_mask=WbfsysMessageChannelType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_channel_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_message_channel_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.message_channel_type.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.MessageChannelType.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.message_channel_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.message_channel_type.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_channel_type_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_channel_type_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_message_channel_type_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageChannelType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected message channel Types." >{$iconDelete} Delete selected message channel Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! message channel Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageChannelType_Multi.deleteAll" >{$iconClean} Delete all message channel Types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageChannelType_Selection_Element
