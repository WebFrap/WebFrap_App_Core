 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageChannelType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageChannelType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageChannelType_Selection_Element
    (
      'selectionWbfsysMessageChannelType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection message channel Types', 'wbfsys.message_channel_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageChannelType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageChannelType',
      'WbfsysMessageChannelType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageChannelType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageChannelType_Selection_Ui
