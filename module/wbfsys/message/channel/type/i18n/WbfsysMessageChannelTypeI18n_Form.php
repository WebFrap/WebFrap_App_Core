 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_channel_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageChannelTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysMessageChannelTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysMessageChannelTypeI18n';
   ...
   *
   * @var WbfsysMessageChannelTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysMessageChannelTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageChannelTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageChannelTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.message_channel_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_message_channel_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_message_channel_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysMessageChannelType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysMessageChannelType not exists' );

      Log::warn('Looks like the Entity: WbfsysMessageChannelType is missing');
      ...
      //p: Window
      $objidWbfsysMessageChannelType = $this->entity->getData('id_wbfsys_message_channel_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysMessageChannelType
          || !$entityWbfsysMessageChannelType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysMessageChannelType = $this->db->orm->newEntity( 'WbfsysMessageChannelType' );
      }

      $inputIdWbfsysMessageChannelType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysMessageChannelType', 'Window' );
      $inputIdWbfsysMessageChannelType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_message_channel_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_message_channel_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Message Channel Type (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysMessageChannelType->assignedForm = $this->assignedForm;

      $inputIdWbfsysMessageChannelType->setWidth( 'medium' );

      $inputIdWbfsysMessageChannelType->setData( $this->entity->getData( 'id_wbfsys_message_channel_type' )  );
      $inputIdWbfsysMessageChannelType->setReadOnly( $this->isReadOnly( 'id_wbfsys_message_channel_type' ) );
      $inputIdWbfsysMessageChannelType->setLabel( $this->view->i18n->l( 'Wbfsys Message Channel Type', 'wbfsys.message_channel_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.MessageChannelType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_message_channel_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysMessageChannelType->setListUrl ( $listUrl );
      $inputIdWbfsysMessageChannelType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysMessageChannelType->setEntityUrl( 'maintab.php?c=Wbfsys.MessageChannelType.edit' );
      $inputIdWbfsysMessageChannelType->conEntity         = $entityWbfsysMessageChannelType;
      $inputIdWbfsysMessageChannelType->refresh           = $this->refresh;
      $inputIdWbfsysMessageChannelType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysMessageChannelType->view = $this->view;
      $inputIdWbfsysMessageChannelType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_message_channel_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysMessageChannelType );
  ...
  }//end public function input_id_wbfsys_message_channel_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.message_channel_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.message_channel_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_channel_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_channel_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_channel_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_channel_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_channel_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_channel_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_channel_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Message Channel Type I18n)', 'wbfsys.message_channel_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_channel_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_channel_type_i18n_m_role_change';
...
}//end class WbfsysMessageChannelTypeI18n_Form */
