 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageChannelType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageChannelType = $this->model->getEntityWbfsysMessageChannelType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show message channel Type: {@text@}',
      'wbfsys.message_channel_type.label',
      array( 'text' => $entityWbfsysMessageChannelType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageChannelType.show  &amp;objid='.$entityWbfsysMessageChannelType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageChannelType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_channel_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_channel_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageChannelType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MessageChannelType.showMeta&objid={$objid}');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageChannelType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageChannelType_Crud_Show_Maintab_View
