 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageChannelType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageChannelType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageChannelType_Entity */
      $entity = $orm->get( 'WbfsysMessageChannelType', $rootId );
    }
...
}//end class WbfsysMessageChannelType_Crud_Access_Root
