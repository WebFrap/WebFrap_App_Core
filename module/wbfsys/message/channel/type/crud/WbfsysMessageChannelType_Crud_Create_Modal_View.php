 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageChannelType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageChannelType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageChannelType.insert';
    $params->formId       = 'wgt-form-wbfsys_message_channel_type';
    $params->namespace   = 'wbfsys_message_channel_type-create';
    ...
    $this->setTemplate( 'wbfsys/message_channel_type/modal/crud/form_create' );
...
}//end class WbfsysMessageChannelType_Crud_Create_Modal_View
