 ...
 * @licence WebFrap.net
 */
class WbfsysMessageChannelType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageChannelType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageChannelType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit message channel Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageChannelType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageChannelType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageChannelType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_channel_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_channel_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageChannelType_Crud_Edit' );
...
}//end class WbfsysMessageChannelType_Crud_Edit_Maintab_View
