 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_References_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Message_Ref_References.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysMessage_Ref_References_Table_Ajax_View
