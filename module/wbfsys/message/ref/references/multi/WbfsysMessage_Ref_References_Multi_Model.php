 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_References_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listReferences = $this->getRegisterd('listRefReferences'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listReferences was not registered'
        );
      }

      foreach( $listReferences as $entityWbfsysMessage )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefReferences',$listWbfsysMessageReferences);
      return true;
...
}//end class WbfsysMessage_Ref_References_Multi_Model
