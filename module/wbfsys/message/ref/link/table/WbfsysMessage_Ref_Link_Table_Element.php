 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Link_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message-link';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDataLink_Table_Query
   */
  public $data = null;
   ...
   */
  public $namespace   = 'WbfsysMessage_Ref_Link';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DataLink.show&amp;target_mask=WbfsysMessage_Ref_Link&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink.delete&amp;target_mask=WbfsysMessage_Ref_Link&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.data_link.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_data_link_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.DataLink.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_data_index_name'])).'</a></td>'.NL;
...
}//end class WbfsysMessage_Ref_Link_Table_Element
