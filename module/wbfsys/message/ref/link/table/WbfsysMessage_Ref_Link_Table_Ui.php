 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Link_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessage_Ref_Link_Table_Element
   */
  public function createListItem( $idWbfsysMessage, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessage_Ref_Link_Table_Element
    (
      'tableLink',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_message-conref-link'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-link-'.$idWbfsysMessage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message-ref-link-search-'
        .$idWbfsysMessage;
    ...
    $tabPanel->searchKey = 'wbfsys_message-ref-link';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.DataLink.create&refid='.$params->refId.'&target_mask=WbfsysMessage_Ref_Link&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_data_link[id_message]\':\''.$params->refIdLink.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdLink', $idWbfsysMessage );
    $view->addVar
    (
      'searchFormActionLink',
      'ajax.php?c=Wbfsys.Message_Ref_Link.search&amp;target_id='
...
}//end class WbfsysMessage_Ref_Link_Table_Ui
