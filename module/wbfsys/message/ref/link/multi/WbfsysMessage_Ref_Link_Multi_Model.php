 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Link_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listLink = $this->getRegisterd('listRefLink'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listLink was not registered'
        );
      }

      foreach( $listLink as $entityWbfsysMessage )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefLink',$listWbfsysDataLink);
      return true;
...
}//end class WbfsysMessage_Ref_Link_Multi_Model
