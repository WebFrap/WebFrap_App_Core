 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Tags_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.Message_Ref_Tags.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_message-ref-tags-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/message/ref_tags/tab_table' );

    $ui = $this->loadUi( 'WbfsysMessage_Ref_Tags_Table' );
...
}//end class WbfsysMessage_Ref_Tags_Table_Modal_View
