 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Tags_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessage_Ref_Tags_Table_Element
   */
  public function createListItem( $idWbfsysMessage, $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessage_Ref_Tags_Table_Element
    (
      'tableTags',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_message-conref-tags'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-tags-'.$idWbfsysMessage;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message-ref-tags-search-'
        .$idWbfsysMessage;
    ...
    $tabPanel->searchKey = 'wbfsys_message-ref-tags';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Tag',
            '$R.get(\'modal.php?c=Wbfsys.Tag.selection&exclude=wbfsys_entity_tag-vid-id_tag&objid='.$params->refId.'&target_mask=WbfsysMessage_Ref_Tags&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdTags', $idWbfsysMessage );
    $view->addVar
    (
      'searchFormActionTags',
      'ajax.php?c=Wbfsys.Message_Ref_Tags.search&amp;target_id='
...
}//end class WbfsysMessage_Ref_Tags_Table_Ui
