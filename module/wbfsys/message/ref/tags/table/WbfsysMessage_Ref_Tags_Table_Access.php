 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Tags_Table_Access
  extends LibAclPermissionList
{
  /**
   * @param TFlag $params
   * @param Entity: wbfsys_entity_tag Attributes: vid; id_entity; id_tag; rowid; m_time_created; m_role_create; m_time_changed; m_role_change; m_version; m_uuid_Entity $entity
   */
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_message-ref-tags' );
  ...
  /**
   * @param WbfsysMessage_Ref_Tags_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_entity_tag.rowid ",
      'acls'
    );
...
}//end class WbfsysMessage_Ref_Tags_Table_Access
