 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Tags_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysMessage, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysMessage_Ref_Tags_Table' );
    /* @var $query WbfsysMessage_Ref_Tags_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_tag.vid = '.$idWbfsysMessage );
...
}//end class WbfsysMessage_Ref_Tags_Table_Model
