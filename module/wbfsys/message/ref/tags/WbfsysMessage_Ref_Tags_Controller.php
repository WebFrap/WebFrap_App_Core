 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Tags_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMessage_Ref_Tags_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_message-ref-tags';
    ...
    (
      $params->tabId,
      'WbfsysMessage_Ref_Tags_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMessage_Ref_Tags_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_message-ref-tags-'.$listType.'-ajax',
    	'WbfsysMessage_Ref_Tags_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysTag to a WbfsysMessage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysMessage_Ref_Tags_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMessage_Ref_Tags_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMessage_Ref_Tags_'.$listType );
...
} // end WbfsysMessage_Ref_Tags_Controller
