 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Attachments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.Message_Ref_Attachments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message-ref-attachments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Attachments' );

    // set the default table template
    $this->setTemplate( 'wbfsys/message/ref_attachments/tab_table' );

    $ui = $this->loadUi( 'WbfsysMessage_Ref_Attachments_Table' );
...
}//end class WbfsysMessage_Ref_Attachments_Table_Modal_View
