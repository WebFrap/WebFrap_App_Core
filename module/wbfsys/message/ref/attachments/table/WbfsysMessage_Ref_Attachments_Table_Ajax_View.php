 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Attachments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Message_Ref_Attachments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysMessage_Ref_Attachments_Table_Ajax_View
