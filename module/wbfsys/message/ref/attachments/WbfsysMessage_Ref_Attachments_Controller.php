 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_Attachments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysMessage_Ref_Attachments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_message-ref-attachments';
    ...
    (
      $params->tabId,
      'WbfsysMessage_Ref_Attachments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysMessage_Ref_Attachments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_message-ref-attachments-'.$listType.'-ajax',
    	'WbfsysMessage_Ref_Attachments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysFile to a WbfsysMessage
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_message-ref-attachments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysMessage_Ref_Attachments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysMessage_Ref_Attachments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysMessage_Ref_Attachments_'.$listType );
...
} // end WbfsysMessage_Ref_Attachments_Controller
