 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_SendWay_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $params->searchFormAction = 'ajax.php?c=Wbfsys.Message_Ref_SendWay.search&amp;objid='.$objid;

    // add the id to the form
    $params->searchFormId = 'wgt-form-table-wbfsys_message-ref-send_way-search-'.$objid;
    ...
    $this->setTemplate( 'wbfsys/message/ref_send_way/tab_table' );

    $ui = $this->loadUi( 'WbfsysMessage_Ref_SendWay_Table' );
...
}//end class WbfsysMessage_Ref_SendWay_Table_Modal_View
