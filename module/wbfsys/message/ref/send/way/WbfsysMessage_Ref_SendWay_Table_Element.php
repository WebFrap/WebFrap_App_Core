 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Ref_SendWay_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message-send_way';
   ...
   */
  public $namespace   = 'WbfsysMessage_Ref_SendWay';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageSendway.show&amp;target_mask=WbfsysMessage_Ref_SendWay&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageSendway.delete&amp;target_mask=WbfsysMessage_Ref_SendWay&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_sendway.label',
        Acl::DELETE
...
}//end class WbfsysMessage_Ref_SendWay_Table_Element
