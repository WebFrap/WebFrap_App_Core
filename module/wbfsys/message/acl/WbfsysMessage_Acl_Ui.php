...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessage_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessage_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_message-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Message', 'wbfsys.message.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_acl';
...
} // end class WbfsysMessage_Acl_Ui */
