 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessage_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message-acl-qfdu-aAjax',
      'WbfsysMessage_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessage_Acl_Qfdu_Controller */
