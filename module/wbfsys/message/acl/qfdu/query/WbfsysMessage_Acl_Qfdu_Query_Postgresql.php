 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_message.title) like upper('{$safeVal}%') ";
    }
  ...
  SELECT
    ...
    wbfsys_message.title as value,
    wbfsys_message.title as label
  FROM
    wbfsys_message
  WHERE
    {$sqlWhere}
...
} // end class WbfsysMessage_Acl_Qfdu_Query_Postgresql */
