 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessage = $orm->get('WbfsysMessage', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_message_title']  = $refEntityWbfsysMessage->title;

    }
    $tabData['wbfsys_message_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessage_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessage_Acl' );
    /* @var $query WbfsysMessage_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessage_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessage_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessage_Acl_Qfdu' );
    /* @var $query WbfsysMessage_Acl_Qfdu_Query  */
...
} // end class WbfsysMessage_Acl_Qfdu_Model */
