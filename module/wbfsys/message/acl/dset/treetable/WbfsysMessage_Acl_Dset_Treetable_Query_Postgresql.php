 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessage_Acl_Dset_Treetable_Query_Postgresql */
