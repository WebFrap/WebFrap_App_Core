 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessage_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessage = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessage_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessage, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessage_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message-acl-dset', 
    	'WbfsysMessage_Acl_Dset',
...
} // end class WbfsysMessage_Acl_Dset_Controller */
