 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessage', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessage_Acl_Dset' );
    /* @var $query WbfsysMessage_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessage_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessage_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessage_Acl_Dset_Model */
