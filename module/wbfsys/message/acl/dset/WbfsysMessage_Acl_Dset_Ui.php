 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessage_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessage_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessage, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message-acl-dset' );
    ...
    else
    {
      ...
      (
        'Message "{@label@}" User Access',
        'wbfsys.message.label',
        array
        (
          'label' => $entityWbfsysMessage->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessage_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessage_Acl_Dset_Ui */
