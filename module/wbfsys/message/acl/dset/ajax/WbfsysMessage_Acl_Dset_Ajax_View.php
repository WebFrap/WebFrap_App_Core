 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessage_Acl_Dset' );
    ...
    $entityWbfsysMessage = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessage_Acl_Dset_Ajax_View */
