 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessage
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessage_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysMessage_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessage_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_acl_masks_listing',
      'WbfsysMessage_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessage_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessage_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessage_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessage_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessage_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessage_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message-acl-qfdu',
    	'WbfsysMessage_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessage_Acl_Controller */
