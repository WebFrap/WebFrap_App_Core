 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Message_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Message_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Message', 'wbfsys.message.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessage_Acl' );
...
} // end class WbfsysMessage_Acl_Maintab_View */
