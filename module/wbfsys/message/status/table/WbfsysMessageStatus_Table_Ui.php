 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für message receiver Status
  *
  ...
  *  }
  *
  * @return WbfsysMessageStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageStatus_Table_Element( 'tableWbfsysMessageStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'message receiver Status', 'wbfsys.message_status.label' );
      //$tabPanel->searchKey = 'wbfsys_message_status';
      ...
      $searchElement->searchKey = 'wbfsys_message_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageStatus listing maske
   *
   * @param WbfsysMessageStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageStatus  = $model->getEntityWbfsysMessageStatus();
    ...
    $formWbfsysMessageStatus->setKeyName( 'wbfsys_message_status' );
...
}//end class WbfsysMessageStatus_Table_Ui
