 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageStatus_Selection' ) );
...
} // end class WbfsysMessageStatus_Selection_Controller */
