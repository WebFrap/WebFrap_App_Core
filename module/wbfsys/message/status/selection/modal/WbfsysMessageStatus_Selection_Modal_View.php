 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageStatus_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysMessageStatus_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_status/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'message receiver Status', 'wbfsys.message_status.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageStatus.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_message_status-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysMessageStatus_Selection' );
...
}//end class WbfsysMessageStatus_Selection_Modal_View
