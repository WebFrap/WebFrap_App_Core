 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageStatus_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_message_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_status.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageStatus_Selection_Access
