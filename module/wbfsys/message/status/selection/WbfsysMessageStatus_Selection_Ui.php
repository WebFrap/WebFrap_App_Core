 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageStatus_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageStatus_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageStatus_Selection_Element
    (
      'selectionWbfsysMessageStatus',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection message receiver Status', 'wbfsys.message_status.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageStatus.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageStatus',
      'WbfsysMessageStatus_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageStatus_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageStatus_Selection_Ui
