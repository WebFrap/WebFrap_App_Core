 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_message_status';
    $params->namespace   = 'wbfsys_message_status-create';
    ...
    $this->setTemplate( 'wbfsys/message_status/modal/crud/form_create' );
...
}//end class WbfsysMessageStatus_Crud_Create_Modal_View
