 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageStatus Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new message receiver Status',
      'wbfsys.message_status.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New message receiver Status',
      'wbfsys.message_status.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_status-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_status/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageStatus.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_status';
    ...
    $form = $this->newForm( 'WbfsysMessageStatus_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageStatus.create');}});
});
...
}//end class WbfsysMessageStatus_Crud_Create_Maintab_View
