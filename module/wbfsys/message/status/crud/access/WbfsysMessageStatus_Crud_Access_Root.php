 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageStatus_Entity */
      $entity = $orm->get( 'WbfsysMessageStatus', $rootId );
    }
...
}//end class WbfsysMessageStatus_Crud_Access_Root
