 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageStatus_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMessageStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageStatus = $this->model->getEntityWbfsysMessageStatus();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show message receiver Status: {@text@}',
      'wbfsys.message_status.label',
      array( 'text' => $entityWbfsysMessageStatus->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'message receiver Status: {@text@}',
      'wbfsys.message_status.label',
      array( 'text' => $entityWbfsysMessageStatus->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageStatus.show  &amp;objid='.$entityWbfsysMessageStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageStatus.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_status-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_status/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMessageStatus_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.MessageStatus.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_status' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_message_status a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.MessageStatus.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.MessageStatus.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMessageStatus_Crud_Show_Maintab_View
