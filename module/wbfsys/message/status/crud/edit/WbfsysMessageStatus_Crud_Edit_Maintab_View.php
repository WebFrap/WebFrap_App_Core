 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit message receiver Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageStatus_Crud_Edit' );
...
}//end class WbfsysMessageStatus_Crud_Edit_Maintab_View
