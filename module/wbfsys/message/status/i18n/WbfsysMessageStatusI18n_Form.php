 ...
 * @licence WebFrap.net
 */
class WbfsysMessageStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysMessageStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysMessageStatusI18n';
   ...
   *
   * @var WbfsysMessageStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysMessageStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.message_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_message_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_message_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysMessageStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysMessageStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysMessageStatus is missing');
      ...
      //p: Window
      $objidWbfsysMessageStatus = $this->entity->getData('id_wbfsys_message_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysMessageStatus
          || !$entityWbfsysMessageStatus = $this->db->orm->get
          (
            'WbfsysMessageStatus',
            $objidWbfsysMessageStatus
          )
      ...
      {
        $entityWbfsysMessageStatus = $this->db->orm->newEntity( 'WbfsysMessageStatus' );
      }

      $inputIdWbfsysMessageStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysMessageStatus', 'Window' );
      $inputIdWbfsysMessageStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_message_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_message_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Message Status (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysMessageStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysMessageStatus->setWidth( 'medium' );

      $inputIdWbfsysMessageStatus->setData( $this->entity->getData( 'id_wbfsys_message_status' )  );
      $inputIdWbfsysMessageStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_message_status' ) );
      $inputIdWbfsysMessageStatus->setLabel( $this->view->i18n->l( 'Wbfsys Message Status', 'wbfsys.message_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.MessageStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_message_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysMessageStatus->setListUrl ( $listUrl );
      $inputIdWbfsysMessageStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysMessageStatus->setEntityUrl( 'maintab.php?c=Wbfsys.MessageStatus.edit' );
      $inputIdWbfsysMessageStatus->conEntity         = $entityWbfsysMessageStatus;
      $inputIdWbfsysMessageStatus->refresh           = $this->refresh;
      $inputIdWbfsysMessageStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysMessageStatus->view = $this->view;
      $inputIdWbfsysMessageStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_message_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysMessageStatus );
  ...
  }//end public function input_id_wbfsys_message_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.message_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.message_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Message Status I18n)', 'wbfsys.message_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_status_i18n_m_role_change';
...
}//end class WbfsysMessageStatusI18n_Form */
