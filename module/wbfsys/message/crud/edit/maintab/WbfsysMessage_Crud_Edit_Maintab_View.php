 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessage = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Message.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Message.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessage_Crud_Edit' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_my_message").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=My.Message.edit&objid={$objid}');
    });
