 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Message.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Message.insert';
    $params->formId       = 'wgt-form-wbfsys_message';
    $params->namespace   = 'wbfsys_message-create';
    ...
    $this->setTemplate( 'wbfsys/message/modal/crud/form_create' );
...
}//end class WbfsysMessage_Crud_Create_Modal_View
