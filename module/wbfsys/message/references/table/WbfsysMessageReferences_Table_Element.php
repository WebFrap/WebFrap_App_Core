 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_references';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageReferences_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageReferences.show&amp;target_mask=WbfsysMessageReferences&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageReferences.edit&amp;target_mask=WbfsysMessageReferences&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_references.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageReferences.delete&amp;target_mask=WbfsysMessageReferences&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_references.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_references_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageReferences_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.MessageReferences_Multi.deleteAll" >{$iconClean} Delete all Nachrichten Quelles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageReferences_Table_Element
