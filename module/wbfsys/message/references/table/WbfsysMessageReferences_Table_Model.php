 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    if( $free = $httpRequest->param( 'free_search' , Validator::TEXT ) )
      ...
      if( $mRoleCreate = $httpRequest->param( 'search_wbfsys_message_references', Validator::EID, 'm_role_create'   ) )
        $condition['wbfsys_message_references']['m_role_create'] = $mRoleCreate;

      if( $mRoleChange = $httpRequest->param( 'search_wbfsys_message_references', Validator::EID, 'm_role_change'   ) )
        $condition['wbfsys_message_references']['m_role_change'] = $mRoleChange;

      if( $mTimeCreatedBefore = $httpRequest->param( 'search_wbfsys_message_references', Validator::DATE, 'm_time_created_before'   ) )
        $condition['wbfsys_message_references']['m_time_created_before'] = $mTimeCreatedBefore;

      if( $mTimeCreatedAfter = $httpRequest->param( 'search_wbfsys_message_references', Validator::DATE, 'm_time_created_after'   ) )
        $condition['wbfsys_message_references']['m_time_created_after'] = $mTimeCreatedAfter;

      if( $mTimeChangedBefore = $httpRequest->param( 'search_wbfsys_message_references', Validator::DATE, 'm_time_changed_before'   ) )
        $condition['wbfsys_message_references']['m_time_changed_before'] = $mTimeChangedBefore;

      if( $mTimeChangedAfter = $httpRequest->param( 'search_wbfsys_message_references}', Validator::DATE, 'm_time_changed_after'   ) )
        $condition['wbfsys_message_references']['m_time_changed_after'] = $mTimeChangedAfter;

      if( $mRowid = $httpRequest->param( 'search_wbfsys_message_references', Validator::EID, 'm_rowid'   ) )
        $condition['wbfsys_message_references']['m_rowid'] = $mRowid;

      if( $mUuid = $httpRequest->param( 'search_wbfsys_message_references', Validator::TEXT, 'm_uuid'    ) )
        $condition['wbfsys_message_references']['m_uuid'] = $mUuid;
    ...
    $query = $db->newQuery( 'WbfsysMessageReferences_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMessageReferences_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
    ...
    if( $params->exclude )
    {
      ...
      $excludeCond = ' wbfsys_message_references.rowid NOT IN '
...
}//end class WbfsysMessageReferences_Table_Model
