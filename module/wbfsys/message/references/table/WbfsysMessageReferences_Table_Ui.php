 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysMessageReferences_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageReferences_Table_Element( 'tableWbfsysMessageReferences', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Nachrichten Quelles', 'wbfsys.message_references.label' );
      //$tabPanel->searchKey = 'wbfsys_message_references';
      ...
      $searchElement->searchKey = 'wbfsys_message_references';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageReferences_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageReferences', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageReferences listing maske
   *
   * @param WbfsysMessageReferences_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageReferences_Table_Ui
