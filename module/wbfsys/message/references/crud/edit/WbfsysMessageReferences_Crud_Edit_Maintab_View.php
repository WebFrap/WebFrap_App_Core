 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageReferences Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageReferences = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Nachrichten Quelle: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageReferences.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageReferences
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageReferences.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_references-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_references/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageReferences_Crud_Edit' );
...
}//end class WbfsysMessageReferences_Crud_Edit_Maintab_View
