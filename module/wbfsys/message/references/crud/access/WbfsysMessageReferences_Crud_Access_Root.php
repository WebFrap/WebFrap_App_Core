 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageReferences_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageReferences_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageReferences_Entity */
      $entity = $orm->get( 'WbfsysMessageReferences', $rootId );
    }
...
}//end class WbfsysMessageReferences_Crud_Access_Root
