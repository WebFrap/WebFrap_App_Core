 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageReferences entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageReferences.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageReferences.insert';
    $params->formId       = 'wgt-form-wbfsys_message_references';
    $params->namespace   = 'wbfsys_message_references-create';
    ...
    $this->setTemplate( 'wbfsys/message_references/modal/crud/form_create' );
...
}//end class WbfsysMessageReferences_Crud_Create_Modal_View
