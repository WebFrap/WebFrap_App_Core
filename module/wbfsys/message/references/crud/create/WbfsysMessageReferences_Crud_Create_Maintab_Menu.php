 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Crud_Create_Maintab_Menu
  extends WgtDropmenu
{
////////////////////////////////////////////////////////////////////////////////
// menu: create
    ...
    <div class="wgt-dropdownbox" id="{$this->id}-cruddropbox" >
      ...
      <ul>
        <li><a
          ...
          title="Create the new Nachrichten Quelle and close the Tab after saving" >{$iconCreateCl} {$view->i18n->l('Create & Close','wbf.label')}</a></li>
        <li><a
          class="wcm wgtac_create_a_next wcm_ui_tip-top"
          title="Create the new Nachrichten Quelle and open a new create mask" >{$iconCreateCl} {$view->i18n->l('Create & Next','wbf.label')}</a></li>
      </ul>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_message_references-create" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class WbfsysMessageReferences_Crud_Create_Maintab_Menu
