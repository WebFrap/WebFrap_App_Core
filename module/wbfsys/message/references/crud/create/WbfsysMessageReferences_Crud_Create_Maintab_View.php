 ...
 * @licence WebFrap.net
 */
class WbfsysMessageReferences_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageReferences Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Nachrichten Quelle',
      'wbfsys.message_references.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Nachrichten Quelle',
      'wbfsys.message_references.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_references-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_references/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageReferences.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_references';
    ...
    $form = $this->newForm( 'WbfsysMessageReferences_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageReferences.create');}});
});
...
}//end class WbfsysMessageReferences_Crud_Create_Maintab_View
