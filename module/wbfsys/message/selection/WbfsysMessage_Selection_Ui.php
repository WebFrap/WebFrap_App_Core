 ...
 * @licence WebFrap.net
 */
class WbfsysMessage_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessage_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessage_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessage_Selection_Element
    (
      'selectionWbfsysMessage',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Messages', 'wbfsys.message.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Message.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysMessage',
      'WbfsysMessage_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessage_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessage_Selection_Ui
