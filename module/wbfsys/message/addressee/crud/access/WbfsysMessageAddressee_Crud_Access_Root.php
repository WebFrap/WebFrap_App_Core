 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageAddressee_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageAddressee_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageAddressee_Entity */
      $entity = $orm->get( 'WbfsysMessageAddressee', $rootId );
    }
...
}//end class WbfsysMessageAddressee_Crud_Access_Root
