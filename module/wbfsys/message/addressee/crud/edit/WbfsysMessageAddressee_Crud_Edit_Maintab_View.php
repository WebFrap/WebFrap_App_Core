 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageAddressee Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageAddressee = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Message Addressee: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageAddressee.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageAddressee
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageAddressee.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_addressee-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_addressee/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageAddressee_Crud_Edit' );
...
}//end class WbfsysMessageAddressee_Crud_Edit_Maintab_View
