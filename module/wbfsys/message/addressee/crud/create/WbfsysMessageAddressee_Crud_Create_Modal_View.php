 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageAddressee entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageAddressee.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageAddressee.insert';
    $params->formId       = 'wgt-form-wbfsys_message_addressee';
    $params->namespace   = 'wbfsys_message_addressee-create';
    ...
    $this->setTemplate( 'wbfsys/message_addressee/modal/crud/form_create' );
...
}//end class WbfsysMessageAddressee_Crud_Create_Modal_View
