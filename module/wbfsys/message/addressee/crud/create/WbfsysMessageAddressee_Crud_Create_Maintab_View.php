 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageAddressee Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Message Addressee',
      'wbfsys.message_addressee.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Message Addressee',
      'wbfsys.message_addressee.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_addressee-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_addressee/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageAddressee.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_addressee';
    ...
    $form = $this->newForm( 'WbfsysMessageAddressee_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageAddressee.create');}});
});
...
}//end class WbfsysMessageAddressee_Crud_Create_Maintab_View
