 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysMessageAddresseeType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_message_addressee_type.rowid as id',
      'wbfsys_message_addressee_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_message_addressee_type.m_order as "wbfsys_message_addressee_type-m_order-order"' );

    $criteria->from( 'wbfsys_message_addressee_type' );



      $criteria->orderBy( 'wbfsys_message_addressee_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_message_addressee_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_message_addressee_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysMessageAddresseeType_Selectbox_Query_Postgresql
