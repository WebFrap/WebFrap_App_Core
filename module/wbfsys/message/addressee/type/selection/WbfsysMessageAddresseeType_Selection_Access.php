 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageAddresseeType_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_message_addressee_type.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message_addressee_type') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_message_addressee_type.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageAddresseeType_Selection_Access
