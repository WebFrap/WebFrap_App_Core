 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageAddresseeType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageAddresseeType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageAddresseeType_Selection_Element
    (
      'selectionWbfsysMessageAddresseeType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection message addressee Types', 'wbfsys.message_addressee_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageAddresseeType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageAddresseeType',
      'WbfsysMessageAddresseeType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageAddresseeType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageAddresseeType_Selection_Ui
