 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageAddresseeType_Selection' ) );
...
} // end class WbfsysMessageAddresseeType_Selection_Controller */
