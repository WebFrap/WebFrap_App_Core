 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message_addressee_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessageAddresseeType_Acl_Dset_Treetable_Query_Postgresql */
