 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessageAddresseeType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message_addressee_type-acl-qfdu-aAjax',
      'WbfsysMessageAddresseeType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessageAddresseeType_Acl_Qfdu_Controller */
