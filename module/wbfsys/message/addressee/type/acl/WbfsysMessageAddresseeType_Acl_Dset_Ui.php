 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessageAddresseeType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessageAddresseeType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessageAddresseeType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessageAddresseeType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message_addressee_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'message addressee Type "{@label@}" User Access',
        'wbfsys.message_addressee_type.label',
        array
        (
          'label' => $entityWbfsysMessageAddresseeType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_addressee_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessageAddresseeType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessageAddresseeType_Acl_Dset_Ui */
