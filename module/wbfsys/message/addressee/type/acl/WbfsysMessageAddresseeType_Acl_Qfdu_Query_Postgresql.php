 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_message_addressee_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_message_addressee_type.rowid as id,
    wbfsys_message_addressee_type.name as value,
    wbfsys_message_addressee_type.name as label
  FROM
...
} // end class WbfsysMessageAddresseeType_Acl_Qfdu_Query_Postgresql */
