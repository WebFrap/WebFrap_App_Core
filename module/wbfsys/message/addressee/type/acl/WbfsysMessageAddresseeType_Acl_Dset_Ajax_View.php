 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessageAddresseeType_Acl_Dset' );
    ...
    $entityWbfsysMessageAddresseeType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessageAddresseeType_Acl_Dset_Ajax_View */
