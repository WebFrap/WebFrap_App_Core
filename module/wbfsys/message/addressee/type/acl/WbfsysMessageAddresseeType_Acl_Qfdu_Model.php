 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message_addressee_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessageAddresseeType = $orm->get('WbfsysMessageAddresseeType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_message_addressee_type_name']  = $refEntityWbfsysMessageAddresseeType->name;

    }
    $tabData['wbfsys_message_addressee_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessageAddresseeType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageAddresseeType_Acl' );
    /* @var $query WbfsysMessageAddresseeType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageAddresseeType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessageAddresseeType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageAddresseeType_Acl_Qfdu' );
    /* @var $query WbfsysMessageAddresseeType_Acl_Qfdu_Query  */
...
} // end class WbfsysMessageAddresseeType_Acl_Qfdu_Model */
