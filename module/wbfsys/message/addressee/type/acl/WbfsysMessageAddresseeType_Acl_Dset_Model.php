 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message_addressee_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessageAddresseeType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageAddresseeType_Acl_Dset' );
    /* @var $query WbfsysMessageAddresseeType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageAddresseeType_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessageAddresseeType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessageAddresseeType_Acl_Dset_Model */
