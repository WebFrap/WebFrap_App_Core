 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysMessageAddresseeType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageAddresseeType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_addressee_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MessageAddresseeType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message_addressee_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message_addressee_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'message addressee Type', 'wbfsys.message_addressee_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_addressee_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessageAddresseeType_Acl' );
...
} // end class WbfsysMessageAddresseeType_Acl_Maintab_View */
