 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessageAddresseeType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageAddresseeType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL message addressee Type', 
        'wbfsys.message_addressee_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_message_addressee_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'message addressee Type', 'wbfsys.message_addressee_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_addressee_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysMessageAddresseeType_Acl_Table'
    );
...
} // end class WbfsysMessageAddresseeType_Acl_Ui */
