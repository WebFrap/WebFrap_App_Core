 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageAddresseeType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessageAddresseeType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageAddresseeType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message_addressee_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessageAddresseeType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_message_addressee_type-acl-dset', 
    	'WbfsysMessageAddresseeType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageAddresseeType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message_addressee_type-acl-dset', 
    	'WbfsysMessageAddresseeType_Acl_Dset',
...
} // end class WbfsysMessageAddresseeType_Acl_Dset_Controller */
