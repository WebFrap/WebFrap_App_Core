 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessageAddresseeType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessageAddresseeType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_message_addressee_type_acl_listing',
      'WbfsysMessageAddresseeType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysMessageAddresseeType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageAddresseeType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessageAddresseeType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_addressee_type-acl',
    	'WbfsysMessageAddresseeType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_addressee_type_acl_masks_listing',
      'WbfsysMessageAddresseeType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageAddresseeType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessageAddresseeType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessageAddresseeType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_addressee_type-acl-qfdu',
    	'WbfsysMessageAddresseeType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessageAddresseeType_Acl_Controller */
