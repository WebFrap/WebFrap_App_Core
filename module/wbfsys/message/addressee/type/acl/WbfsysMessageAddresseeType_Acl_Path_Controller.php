 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_message_addressee_type_acl_graph', 
      'WbfsysMessageAddresseeType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMessageAddresseeType_Acl_Path_Maintab_View  */
...
} // end class WbfsysMessageAddresseeType_Acl_Path_Controller */
