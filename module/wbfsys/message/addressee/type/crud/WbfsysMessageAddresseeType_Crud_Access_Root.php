 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageAddresseeType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageAddresseeType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageAddresseeType_Entity */
      $entity = $orm->get( 'WbfsysMessageAddresseeType', $rootId );
    }
...
}//end class WbfsysMessageAddresseeType_Crud_Access_Root
