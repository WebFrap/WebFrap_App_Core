 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageAddresseeType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageAddresseeType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageAddresseeType.insert';
    $params->formId       = 'wgt-form-wbfsys_message_addressee_type';
    $params->namespace   = 'wbfsys_message_addressee_type-create';
    ...
    $this->setTemplate( 'wbfsys/message_addressee_type/modal/crud/form_create' );
...
}//end class WbfsysMessageAddresseeType_Crud_Create_Modal_View
