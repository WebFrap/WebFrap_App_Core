 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMessageAddresseeType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMessageAddresseeType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit message addressee Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.MessageAddresseeType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMessageAddresseeType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.MessageAddresseeType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_message_addressee_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/message_addressee_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMessageAddresseeType_Crud_Edit' );
...
}//end class WbfsysMessageAddresseeType_Crud_Edit_Maintab_View
