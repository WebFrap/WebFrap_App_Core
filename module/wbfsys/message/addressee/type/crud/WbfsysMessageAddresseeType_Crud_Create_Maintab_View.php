 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageAddresseeType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new message addressee Type',
      'wbfsys.message_addressee_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New message addressee Type',
      'wbfsys.message_addressee_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_addressee_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_addressee_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageAddresseeType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_addressee_type';
    ...
    $form = $this->newForm( 'WbfsysMessageAddresseeType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageAddresseeType.create');}});
});
...
}//end class WbfsysMessageAddresseeType_Crud_Create_Maintab_View
