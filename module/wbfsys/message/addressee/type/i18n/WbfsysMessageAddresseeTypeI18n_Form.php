 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_addressee_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageAddresseeTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysMessageAddresseeTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysMessageAddresseeTypeI18n';
   ...
   *
   * @var WbfsysMessageAddresseeTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysMessageAddresseeTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageAddresseeTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageAddresseeTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.message_addressee_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_message_addressee_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_message_addressee_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysMessageAddresseeType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysMessageAddresseeType not exists' );

      Log::warn('Looks like the Entity: WbfsysMessageAddresseeType is missing');
      ...
      //p: Window
      $objidWbfsysMessageAddresseeType = $this->entity->getData('id_wbfsys_message_addressee_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysMessageAddresseeType
          || !$entityWbfsysMessageAddresseeType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysMessageAddresseeType = $this->db->orm->newEntity( 'WbfsysMessageAddresseeType' );
      }

      $inputIdWbfsysMessageAddresseeType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysMessageAddresseeType', 'Window' );
      $inputIdWbfsysMessageAddresseeType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_message_addressee_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_message_addressee_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Message Addressee Type (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysMessageAddresseeType->assignedForm = $this->assignedForm;

      $inputIdWbfsysMessageAddresseeType->setWidth( 'medium' );

      $inputIdWbfsysMessageAddresseeType->setData( $this->entity->getData( 'id_wbfsys_message_addressee_type' )  );
      $inputIdWbfsysMessageAddresseeType->setReadOnly( $this->isReadOnly( 'id_wbfsys_message_addressee_type' ) );
      $inputIdWbfsysMessageAddresseeType->setLabel( $this->view->i18n->l( 'Wbfsys Message Addressee Type', 'wbfsys.message_addressee_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.MessageAddresseeType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_message_addressee_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysMessageAddresseeType->setListUrl ( $listUrl );
      $inputIdWbfsysMessageAddresseeType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysMessageAddresseeType->setEntityUrl( 'maintab.php?c=Wbfsys.MessageAddresseeType.edit' );
      $inputIdWbfsysMessageAddresseeType->conEntity         = $entityWbfsysMessageAddresseeType;
      $inputIdWbfsysMessageAddresseeType->refresh           = $this->refresh;
      $inputIdWbfsysMessageAddresseeType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysMessageAddresseeType->view = $this->view;
      $inputIdWbfsysMessageAddresseeType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_message_addressee_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysMessageAddresseeType );
  ...
  }//end public function input_id_wbfsys_message_addressee_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.message_addressee_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.message_addressee_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_addressee_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_addressee_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_addressee_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_addressee_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_addressee_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_addressee_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_addressee_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Message Addressee Type I18n)', 'wbfsys.message_addressee_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_addressee_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_addressee_type_i18n_m_role_change';
...
}//end class WbfsysMessageAddresseeTypeI18n_Form */
