 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessageAddresseeType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessageAddresseeType_Export_Listing_Access';
    ...
    // create a new WbfsysMessageAddresseeType window
    $view = $this->loadView
    (
    	'export-wbfsys_message_addressee_type',
    	'WbfsysMessageAddresseeType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_Export' );
...
} // end class WbfsysMessageAddresseeType_Export_Controller_Genf
