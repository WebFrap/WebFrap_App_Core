 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für message addressee Types
  *
  ...
  *  }
  *
  * @return WbfsysMessageAddresseeType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageAddresseeType_Table_Element( 'tableWbfsysMessageAddresseeType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_addressee_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'message addressee Types', 'wbfsys.message_addressee_type.label' );
      //$tabPanel->searchKey = 'wbfsys_message_addressee_type';
      ...
      $searchElement->searchKey = 'wbfsys_message_addressee_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageAddresseeType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageAddresseeType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageAddresseeType listing maske
   *
   * @param WbfsysMessageAddresseeType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageAddresseeType  = $model->getEntityWbfsysMessageAddresseeType();
    ...
    $formWbfsysMessageAddresseeType->setKeyName( 'wbfsys_message_addressee_type' );
...
}//end class WbfsysMessageAddresseeType_Table_Ui
