 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMessageAddresseeType_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysMessageAddresseeType_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_addressee_type/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table message addressee Types',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.MessageAddresseeType.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageAddresseeType.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysMessageAddresseeType_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysMessageAddresseeType_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.MessageAddresseeType.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.MessageAddresseeType.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.MessageAddresseeType.create&amp;ltype=table');
    });
...
}//end class WbfsysMessageAddresseeType_Table_Maintab_View
