 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMessageAddresseeType_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMessageAddresseeType_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function changeOrder( $orders )
  {
    ...
    try
    {
      ...
      {
        $orm->update( "WbfsysMessageAddresseeType", $id, array( 'm_order' =>  $order ) );
      }
    }
    catch( LibDb_Exception $e )
    {
...
}//end class WbfsysMessageAddresseeType_Table_Model
