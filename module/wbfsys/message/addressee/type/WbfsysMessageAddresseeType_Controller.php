 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_message_addressee_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.MessageAddresseeType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_message_addressee_type-create';

    $access = new WbfsysMessageAddresseeType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_message_addressee_type-create',
      'WbfsysMessageAddresseeType_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysMessageAddresseeType_Crud_Model */
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.MessageAddresseeType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysMessageAddresseeType = $model->getEntityWbfsysMessageAddresseeType( $objid );
    ...
    $params->entity = $entityWbfsysMessageAddresseeType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_message_addressee_type:edit';

    $access = new WbfsysMessageAddresseeType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageAddresseeType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_message_addressee_type-edit-'.$objid,
      'WbfsysMessageAddresseeType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_message_addressee_type-edit',
          $entityWbfsysMessageAddresseeType,
          'Edit message addressee Type :'.$entityWbfsysMessageAddresseeType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_message_addressee_type';
      $params->maskRoot      = 'wbfsys_message_addressee_type:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_message_addressee_type';
      $params->aclNode       = 'mgmt-wbfsys_message_addressee_type';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_message_addressee_type-edit-'.$objid,
      'WbfsysMessageAddresseeType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_message_addressee_type-show',
          $entityWbfsysMessageAddresseeType,
          'Show message addressee Type :'.$entityWbfsysMessageAddresseeType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_message_addressee_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.MessageAddresseeType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-insert';

    $access = new WbfsysMessageAddresseeType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysMessageAddresseeType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_message_addressee_type-update-'.$entityWbfsysMessageAddresseeType;
      ...
      {
        $access = new WbfsysMessageAddresseeType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysMessageAddresseeType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysMessageAddresseeType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_message_addressee_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysMessageAddresseeType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.MessageAddresseeType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysMessageAddresseeType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysMessageAddresseeType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageAddresseeType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-delete-'.$objid;

    $access = new WbfsysMessageAddresseeType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysMessageAddresseeType );
    ...
    $error = $model->delete( $entityWbfsysMessageAddresseeType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysMessageAddresseeType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.MessageAddresseeType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.MessageAddresseeType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-listing';
    ...
    $containerClass = 'WbfsysMessageAddresseeType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_message_addressee_type',
      'WbfsysMessageAddresseeType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysMessageAddresseeType_Table_Model */
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_message_addressee_type-'.$params->ltype,
          'WbfsysMessageAddresseeType',
          'List of message addressee Types'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysMessageAddresseeType
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysMessageAddresseeType_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_message_addressee_type',
      'WbfsysMessageAddresseeType_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.MessageAddresseeType.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageAddresseeType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysMessageAddresseeType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_message_addressee_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_message_addressee_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_message_addressee_type',
      'WbfsysMessageAddresseeType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysMessageAddresseeType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysMessageAddresseeType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysMessageAddresseeType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_message_addressee_type-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysMessageAddresseeType_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysMessageAddresseeType, $params );
   ...
   * @return boolean
   */
  public function service_changeOrder( $request, $response )
  {
    ...
    if( !$access->update )
    {
      ...
      (
        $response->i18n->l
        (
          'You have no permission to update {@resource@}',
          'wbf.message',
          array
          (
            'resource'  => $response->i18n->l( 'message addressee Type', 'wbfsys.message_addressee_type.label' )
    ...
    $orders = $request->data( 'order', Validator::INT );
    ...
    $model = $this->loadModel( 'WbfsysMessageAddresseeType_'.$listType );
    $model->setAccess( $access );
    $error = $model->changeOrder( $orders );
  ...
  }//end public function service_changeOrder */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_message_addressee_type' );
...
} // end class WbfsysMessageAddresseeType_Controller */
