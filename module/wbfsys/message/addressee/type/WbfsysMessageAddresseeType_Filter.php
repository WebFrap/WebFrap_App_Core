 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddresseeType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message_addressee_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_message_addressee_type.{$fieldName}
...
}//end class WbfsysMessageAddresseeType_Filter
