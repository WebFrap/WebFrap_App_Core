 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_message_addressee';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysMessageAddressee';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysMessageAddressee' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysMessageAddressee entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  public function input_id_message( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMessage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Message (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ));
      ...
      $inputIdMessage->setLabel( $this->view->i18n->l( 'Message', 'wbfsys.message_addressee.label' ) );
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysMessageAddresseeType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysMessageAddresseeType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (Message Addressee)', 'wbfsys.message_addressee.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.message_addressee.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_message_addressee_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.MessageAddresseeType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_area'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Area (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ));
      ...
      $inputIdArea->setLabel( $this->view->i18n->l( 'Area', 'wbfsys.message_addressee.label' ) );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Message Addressee)', 'wbfsys.message_addressee.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Message Addressee)', 'wbfsys.message_addressee.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Message Addressee)', 'wbfsys.message_addressee.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.message_addressee.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.message_addressee.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.message_addressee.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.message_addressee.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Message Addressee)', 'wbfsys.message_addressee.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.message_addressee.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Message Addressee)', 'wbfsys.message_addressee.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.message_addressee.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Message Addressee)', 'wbfsys.message_addressee.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.message_addressee.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysMessageAddresseeType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Type (Message Addressee)', 'wbfsys.message_addressee.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_addressee_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_message_addressee_m_role_change';
...
}//end class WbfsysMessageAddressee_Form */
