 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_addressee';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageAddressee_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageAddressee.show&amp;target_mask=WbfsysMessageAddressee&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageAddressee.edit&amp;target_mask=WbfsysMessageAddressee&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_addressee.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageAddressee.delete&amp;target_mask=WbfsysMessageAddressee&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_addressee.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.message_addressee.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_addressee_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.MessageAddresseeType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_message_addressee_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageAddressee_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Message Addressees." >{$iconDelete} Delete selected Message Addressees</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Message Addressees. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageAddressee_Multi.deleteAll" >{$iconClean} Delete all Message Addressees</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageAddressee_Table_Element
