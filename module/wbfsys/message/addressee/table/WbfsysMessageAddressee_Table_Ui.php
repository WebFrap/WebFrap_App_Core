 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Message Addressees
  *
  ...
  *  }
  *
  * @return WbfsysMessageAddressee_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageAddressee_Table_Element( 'tableWbfsysMessageAddressee', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_addressee-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Message Addressees', 'wbfsys.message_addressee.label' );
      //$tabPanel->searchKey = 'wbfsys_message_addressee';
      ...
      $searchElement->searchKey = 'wbfsys_message_addressee';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageAddressee_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageAddressee', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageAddressee listing maske
   *
   * @param WbfsysMessageAddressee_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageAddressee  = $model->getEntityWbfsysMessageAddressee();
    ...
    $formWbfsysMessageAddressee->setKeyName( 'wbfsys_message_addressee' );
...
}//end class WbfsysMessageAddressee_Table_Ui
