 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMessageAddressee_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_message_addressee.rowid ",
      'acls'
    );
...
}//end class WbfsysMessageAddressee_Table_Access
