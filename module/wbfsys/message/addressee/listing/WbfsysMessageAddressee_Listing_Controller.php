 ...
 * @licence WebFrap.net
 */
class WbfsysMessageAddressee_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageAddressee_'.$listType ) );
...
} // end class WbfsysMessageAddressee_Listing_Controller */
