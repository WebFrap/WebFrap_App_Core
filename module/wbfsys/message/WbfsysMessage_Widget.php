  ...
  extends WgtWidget
{
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $access = new WbfsysMessage_Widget_Access( null, null, $this );
    ...
    $query  = $db->newQuery( 'WbfsysMessage_Widget' );
    ...
    $table = new WbfsysMessage_Widget_Table_Element( 'tableWbfsysMessageItem', $view );
    $table->setId( 'wgt-table-wbfsys_message-widget' );
    ...
    $params->searchFormId = 'wgt-form-wbfsys_message-widget-search';
    ...
    // simple Suchfeld
    $tabPanel = new WbfsysMessage_Widget_Table_Panel( $table );
    ...
    if( $access->insert )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Create',
          '$R.get(\'maintab.php?c=Wbfsys.Message.create&amp;ltab=table&amp;target_mask=WbfsysMessage_Widget\');return false;',
          'control/new.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    if( $access->admin )
    {
      ...
      (
        ...
        (
          Wgt::ACTION_JS,
          'Rights',
          '$R.get(\'maintab.php?c=Wbfsys.Message_Acl.listing\');return false;',
          'control/rights.png',
          'wcm wcm_ui_button',
          'wbf.label'
        )
    ...
    $html = <<<HTML
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="Wbfsys Message"  >
      <form
        id="wgt-form-wbfsys_message-widget-search"
        class="wcm wcm_req_ajax"
        action="ajax.php?c=Widget.WbfsysMessage.reload" 
        method="get" ></form>
      {$table}
...
HTML;
  ...
  public function runReload( $tabSize = 'medium' )
  {
    ...
    $table->setPagingId( 'wgt-form-wbfsys_message-widget-search' );
...
WGTJS;
  ...
  public function append(  $tabSize = 'medium' )
  {
    ...
    $table = new WbfsysMessage_Widget_Table_Element
    (
      'tableWbfsysMessageItem',
      $view
    );
...
}// end class WbfsysMessage_Widget
