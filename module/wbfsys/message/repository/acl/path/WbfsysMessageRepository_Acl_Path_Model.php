 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysMessageRepository_Acl_Path' );
    /* @var $query WbfsysMessageRepository_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('WbfsysMessageRepository_Acl_Path');
    /* @var $dropQuery WbfsysMessageRepository_Acl_Path_Query  */
...
} // end class WbfsysMessageRepository_Acl_Path_Model */
