 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/message_repository/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'Message Repositorys' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_repository-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_message_repository-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysMessageRepository_Acl_Path_Maintab_View */
