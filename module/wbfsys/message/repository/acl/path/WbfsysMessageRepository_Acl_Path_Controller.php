 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_message_repository_acl_graph', 
      'WbfsysMessageRepository_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysMessageRepository_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysMessageRepository_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysMessageRepository_Acl_Path_Maintab_View  */
...
} // end class WbfsysMessageRepository_Acl_Path_Controller */
