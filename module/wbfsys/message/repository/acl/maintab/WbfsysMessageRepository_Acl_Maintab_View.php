 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysMessageRepository_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.MessageRepository_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_repository-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.MessageRepository_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_message_repository-acl-update';
    ...
    $this->setTemplate( 'wbfsys/message_repository/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Message Repository', 'wbfsys.message_repository.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_message_repository_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysMessageRepository_Acl' );
...
} // end class WbfsysMessageRepository_Acl_Maintab_View */
