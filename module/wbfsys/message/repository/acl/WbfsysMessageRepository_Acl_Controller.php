 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysMessageRepository
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysMessageRepository_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_message_repository_acl_listing',
      'WbfsysMessageRepository_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysMessageRepository_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageRepository_Acl_Model */
    $model   = $this->loadModel( 'WbfsysMessageRepository_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_repository-acl',
    	'WbfsysMessageRepository_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_message_repository_acl_masks_listing',
      'WbfsysMessageRepository_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysMessageRepository_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysMessageRepository_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageRepository_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysMessageRepository_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysMessageRepository_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysMessageRepository_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_message_repository-acl-qfdu',
    	'WbfsysMessageRepository_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysMessageRepository_Acl_Controller */
