 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_message_repository.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysMessageRepository_Acl_Dset_Treetable_Query_Postgresql */
