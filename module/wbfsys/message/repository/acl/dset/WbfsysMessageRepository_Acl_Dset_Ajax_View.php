 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysMessageRepository_Acl_Dset' );
    ...
    $entityWbfsysMessageRepository = $this->model->getEntity( $dsetId );
...
} // end class WbfsysMessageRepository_Acl_Dset_Ajax_View */
