 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysMessageRepository_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysMessageRepository_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysMessageRepository = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageRepository_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_message_repository-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysMessageRepository, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_message_repository-acl-dset', 
    	'WbfsysMessageRepository_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysMessageRepository_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_message_repository-acl-dset', 
    	'WbfsysMessageRepository_Acl_Dset',
...
} // end class WbfsysMessageRepository_Acl_Dset_Controller */
