 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_message_repository'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysMessageRepository', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageRepository_Acl_Dset' );
    /* @var $query WbfsysMessageRepository_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageRepository_Acl_Dset_Treetable' );
    /* @var $query WbfsysMessageRepository_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysMessageRepository_Acl_Dset_Model */
