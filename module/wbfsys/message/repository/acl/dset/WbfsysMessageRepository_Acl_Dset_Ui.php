 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysMessageRepository_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysMessageRepository_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysMessageRepository, $areaId, $access, $params  )
  {

    $listObj = new WbfsysMessageRepository_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_message_repository-acl-dset' );
    ...
    else
    {
      ...
      (
        'Message Repository "{@label@}" User Access',
        'wbfsys.message_repository.label',
        array
        (
          'label' => $entityWbfsysMessageRepository->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_message_repository_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysMessageRepository_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysMessageRepository_Acl_Dset_Ui */
