 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_message_repository.rowid as "wbfsys_message_repository_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_message_repository on wbfsys_group_users.vid = wbfsys_message_repository.rowid'
    );
...
} // end class WbfsysMessageRepository_Acl_Qfdu_Treetable_Query_Postgresql */
