 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysMessageRepository_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_message_repository-acl-qfdu-aAjax',
      'WbfsysMessageRepository_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysMessageRepository_Acl_Qfdu_Controller */
