 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_message_repository')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysMessageRepository = $orm->get('WbfsysMessageRepository', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_message_repository_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysMessageRepository_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageRepository_Acl' );
    /* @var $query WbfsysMessageRepository_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageRepository_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysMessageRepository_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysMessageRepository_Acl_Qfdu' );
    /* @var $query WbfsysMessageRepository_Acl_Qfdu_Query  */
...
} // end class WbfsysMessageRepository_Acl_Qfdu_Model */
