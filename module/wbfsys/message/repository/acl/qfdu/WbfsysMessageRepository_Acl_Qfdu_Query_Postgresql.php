 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_message_repository.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_message_repository.rowid as id,
    wbfsys_message_repository.rowid as value,
    wbfsys_message_repository.rowid as label
  FROM
...
} // end class WbfsysMessageRepository_Acl_Qfdu_Query_Postgresql */
