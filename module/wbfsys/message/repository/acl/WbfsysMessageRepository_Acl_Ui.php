 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysMessageRepository_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageRepository_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL Message Repository', 
        'wbfsys.message_repository.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_message_repository-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Message Repository', 'wbfsys.message_repository.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_message_repository_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysMessageRepository_Acl_Table'
    );
...
} // end class WbfsysMessageRepository_Acl_Ui */
