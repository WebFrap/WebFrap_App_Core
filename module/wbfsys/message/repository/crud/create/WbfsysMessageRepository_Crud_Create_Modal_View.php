 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMessageRepository entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.MessageRepository.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageRepository.insert';
    $params->formId       = 'wgt-form-wbfsys_message_repository';
    $params->namespace   = 'wbfsys_message_repository-create';
    ...
    $this->setTemplate( 'wbfsys/message_repository/modal/crud/form_create' );
...
}//end class WbfsysMessageRepository_Crud_Create_Modal_View
