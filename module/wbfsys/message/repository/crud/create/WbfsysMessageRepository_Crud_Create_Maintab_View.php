 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysMessageRepository Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_message_repository-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/message_repository/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.MessageRepository.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_message_repository';
    ...
    $form = $this->newForm( 'WbfsysMessageRepository_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.MessageRepository.create');}});
});
...
}//end class WbfsysMessageRepository_Crud_Create_Maintab_View
