 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMessageRepository_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMessageRepository_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMessageRepository_Entity */
      $entity = $orm->get( 'WbfsysMessageRepository', $rootId );
    }
...
}//end class WbfsysMessageRepository_Crud_Access_Root
