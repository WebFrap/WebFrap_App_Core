 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysMessageRepository_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysMessageRepository_Export_Listing_Access';
    ...
    // create a new WbfsysMessageRepository window
    $view = $this->loadView
    (
    	'export-wbfsys_message_repository',
    	'WbfsysMessageRepository_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysMessageRepository_Export' );
...
} // end class WbfsysMessageRepository_Export_Controller_Genf
