 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysMessageRepository_'.$listType ) );
...
} // end class WbfsysMessageRepository_Listing_Controller */
