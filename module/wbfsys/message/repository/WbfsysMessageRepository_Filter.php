 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_message_repository') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_message_repository.{$fieldName}
...
}//end class WbfsysMessageRepository_Filter
