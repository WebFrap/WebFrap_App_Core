 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Message Repositorys
  *
  ...
  *  }
  *
  * @return WbfsysMessageRepository_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageRepository_Table_Element( 'tableWbfsysMessageRepository', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_message_repository-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Message Repositorys', 'wbfsys.message_repository.label' );
      //$tabPanel->searchKey = 'wbfsys_message_repository';
      ...
      $searchElement->searchKey = 'wbfsys_message_repository';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMessageRepository_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMessageRepository', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMessageRepository listing maske
   *
   * @param WbfsysMessageRepository_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMessageRepository  = $model->getEntityWbfsysMessageRepository();
    ...
    $formWbfsysMessageRepository->setKeyName( 'wbfsys_message_repository' );
...
}//end class WbfsysMessageRepository_Table_Ui
