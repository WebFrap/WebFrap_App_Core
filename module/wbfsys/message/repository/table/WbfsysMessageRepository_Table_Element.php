 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_message_repository';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMessageRepository_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.MessageRepository.show&amp;target_mask=WbfsysMessageRepository&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.MessageRepository.edit&amp;target_mask=WbfsysMessageRepository&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.message_repository.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.MessageRepository.delete&amp;target_mask=WbfsysMessageRepository&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.message_repository.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_message_repository&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.message_repository.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_message_repository_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.MessageRepository_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Message Repositorys." >{$iconDelete} Delete selected Message Repositorys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Message Repositorys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.MessageRepository_Multi.deleteAll" >{$iconClean} Delete all Message Repositorys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMessageRepository_Table_Element
