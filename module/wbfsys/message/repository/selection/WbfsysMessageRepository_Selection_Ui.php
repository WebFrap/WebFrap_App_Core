 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMessageRepository_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMessageRepository_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMessageRepository_Selection_Element
    (
      'selectionWbfsysMessageRepository',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Message Repositorys', 'wbfsys.message_repository.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.MessageRepository.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMessageRepository',
      'WbfsysMessageRepository_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMessageRepository_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMessageRepository_Selection_Ui
