 ...
 * @licence WebFrap.net
 */
class WbfsysMessageRepository_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysMessageRepository_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysMessageRepository_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysMessageRepository_Selection_Model
