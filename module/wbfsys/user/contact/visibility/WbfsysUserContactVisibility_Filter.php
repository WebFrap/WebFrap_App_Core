 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Filter
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
        ...
        AND filter_area_{$key}."acl-vid" = wbfsys_user_contact_visibility.{$fieldName}
...
}//end class WbfsysUserContactVisibility_Filter
