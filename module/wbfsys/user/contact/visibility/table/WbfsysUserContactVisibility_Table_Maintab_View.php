 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserContactVisibility_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserContactVisibility_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_contact_visibility/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table message profile visibilitys',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.UserContactVisibility.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserContactVisibility.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysUserContactVisibility_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysUserContactVisibility_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.UserContactVisibility.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.UserContactVisibility.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.UserContactVisibility.create&amp;ltype=table');
    });
...
}//end class WbfsysUserContactVisibility_Table_Maintab_View
