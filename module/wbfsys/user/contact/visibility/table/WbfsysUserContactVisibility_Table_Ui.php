 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für message profile visibilitys
  *
  ...
  *  }
  *
  * @return WbfsysUserContactVisibility_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserContactVisibility_Table_Element( 'tableWbfsysUserContactVisibility', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_contact_visibility-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'message profile visibilitys', 'wbfsys.user_contact_visibility.label' );
      //$tabPanel->searchKey = 'wbfsys_user_contact_visibility';
      ...
      $searchElement->searchKey = 'wbfsys_user_contact_visibility';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserContactVisibility_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserContactVisibility', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserContactVisibility listing maske
   *
   * @param WbfsysUserContactVisibility_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserContactVisibility  = $model->getEntityWbfsysUserContactVisibility();
    ...
    $formWbfsysUserContactVisibility->setKeyName( 'wbfsys_user_contact_visibility' );
...
}//end class WbfsysUserContactVisibility_Table_Ui
