 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_user_contact_visibility
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.UserContactVisibility.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_user_contact_visibility-create';

    $access = new WbfsysUserContactVisibility_Crud_Access_Create( null, null, $this );
        ...
        (
          ...
          (
            ...
            (
              ...
              'wbfsys.user_contact_visibility.label'
            )
          )
        ),
        Response::FORBIDDEN
    ...
    (
      'form-wbfsys_user_contact_visibility-create',
      'WbfsysUserContactVisibility_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysUserContactVisibility_Crud_Model */
    $model = $this->loadModel( 'WbfsysUserContactVisibility_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.UserContactVisibility.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysUserContactVisibility = $model->getEntityWbfsysUserContactVisibility( $objid );
    ...
    $params->entity = $entityWbfsysUserContactVisibility;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_user_contact_visibility:edit';

    $access = new WbfsysUserContactVisibility_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserContactVisibility );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_user_contact_visibility-edit-'.$objid,
      'WbfsysUserContactVisibility_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_user_contact_visibility:show';
    ...
    (
      'form-wbfsys_user_contact_visibility-edit-'.$objid,
      'WbfsysUserContactVisibility_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_user_contact_visibility
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.UserContactVisibility.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-insert';

    $access = new WbfsysUserContactVisibility_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysUserContactVisibility = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_user_contact_visibility-update-'.$entityWbfsysUserContactVisibility;
      ...
      {
        $access = new WbfsysUserContactVisibility_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysUserContactVisibility );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysUserContactVisibility';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_user_contact_visibility',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysUserContactVisibility_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.UserContactVisibility.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysUserContactVisibility, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysUserContactVisibility_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.UserContactVisibility.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-delete-'.$objid;

    $access = new WbfsysUserContactVisibility_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserContactVisibility );
    ...
    $error = $model->delete( $entityWbfsysUserContactVisibility, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysUserContactVisibility, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.UserContactVisibility.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.UserContactVisibility.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-listing';
    ...
    $containerClass = 'WbfsysUserContactVisibility_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_user_contact_visibility',
      'WbfsysUserContactVisibility_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysUserContactVisibility_Table_Model */
    $model = $this->loadModel( 'WbfsysUserContactVisibility_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_user_contact_visibility-'.$params->ltype,
          'WbfsysUserContactVisibility',
          'List of message profile visibilitys'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysUserContactVisibility
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysUserContactVisibility_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_user_contact_visibility',
      'WbfsysUserContactVisibility_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysUserContactVisibility_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.UserContactVisibility.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysUserContactVisibility_Selection_Model */
    $model   = $this->loadModel( 'WbfsysUserContactVisibility_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_user_contact_visibility-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_user_contact_visibility-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_user_contact_visibility',
      'WbfsysUserContactVisibility',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysUserContactVisibility, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysUserContactVisibility_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysUserContactVisibility_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_contact_visibility-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysUserContactVisibility_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysUserContactVisibility, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_user_contact_visibility' );
...
} // end class WbfsysUserContactVisibility_Controller */
