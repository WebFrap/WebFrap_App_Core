 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibilityI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_contact_visibility_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserContactVisibilityI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysUserContactVisibilityI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysUserContactVisibilityI18n';
   ...
   *
   * @var WbfsysUserContactVisibilityI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysUserContactVisibilityI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserContactVisibilityI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserContactVisibilityI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.user_contact_visibility_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_user_contact_visibility
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_user_contact_visibility( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysUserContactVisibility_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysUserContactVisibility not exists' );

      Log::warn('Looks like the Entity: WbfsysUserContactVisibility is missing');
      ...
      //p: Window
      $objidWbfsysUserContactVisibility = $this->entity->getData('id_wbfsys_user_contact_visibility') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysUserContactVisibility
          || !$entityWbfsysUserContactVisibility = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysUserContactVisibility = $this->db->orm->newEntity( 'WbfsysUserContactVisibility' );
      }

      $inputIdWbfsysUserContactVisibility = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysUserContactVisibility', 'Window' );
      $inputIdWbfsysUserContactVisibility->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_user_contact_visibility]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_user_contact_visibility'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys User Contact Visibility (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysUserContactVisibility->assignedForm = $this->assignedForm;

      $inputIdWbfsysUserContactVisibility->setWidth( 'medium' );

      $inputIdWbfsysUserContactVisibility->setData( $this->entity->getData( 'id_wbfsys_user_contact_visibility' )  );
      $inputIdWbfsysUserContactVisibility->setReadOnly( $this->isReadOnly( 'id_wbfsys_user_contact_visibility' ) );
      $inputIdWbfsysUserContactVisibility->setLabel( $this->view->i18n->l( 'Wbfsys User Contact Visibility', 'wbfsys.user_contact_visibility_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.UserContactVisibility.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_user_contact_visibility'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysUserContactVisibility->setListUrl ( $listUrl );
      $inputIdWbfsysUserContactVisibility->setListIcon( 'control/connect.png' );
      $inputIdWbfsysUserContactVisibility->setEntityUrl( 'maintab.php?c=Wbfsys.UserContactVisibility.edit' );
      $inputIdWbfsysUserContactVisibility->conEntity         = $entityWbfsysUserContactVisibility;
      $inputIdWbfsysUserContactVisibility->refresh           = $this->refresh;
      $inputIdWbfsysUserContactVisibility->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysUserContactVisibility->view = $this->view;
      $inputIdWbfsysUserContactVisibility->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_user_contact_visibility'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysUserContactVisibility );
  ...
  }//end public function input_id_wbfsys_user_contact_visibility */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.user_contact_visibility_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.user_contact_visibility_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_contact_visibility_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_contact_visibility_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_contact_visibility_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_contact_visibility_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_contact_visibility_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_contact_visibility_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_contact_visibility_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (User Contact Visibility I18n)', 'wbfsys.user_contact_visibility_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_contact_visibility_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_contact_visibility_i18n_m_role_change';
...
}//end class WbfsysUserContactVisibilityI18n_Form */
