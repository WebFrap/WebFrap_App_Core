 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserContactVisibility_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_user_contact_visibility.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_user_contact_visibility.rowid ",
      'acls'
    );
...
}//end class WbfsysUserContactVisibility_Selection_Access
