 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserContactVisibility_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserContactVisibility_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserContactVisibility_Selection_Element
    (
      'selectionWbfsysUserContactVisibility',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection message profile visibilitys', 'wbfsys.user_contact_visibility.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserContactVisibility.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserContactVisibility',
      'WbfsysUserContactVisibility_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserContactVisibility_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserContactVisibility_Selection_Ui
