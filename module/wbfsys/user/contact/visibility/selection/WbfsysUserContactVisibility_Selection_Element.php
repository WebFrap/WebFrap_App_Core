 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_user_contact_visibility';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserContactVisibility.show&amp;target_mask=WbfsysUserContactVisibility&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserContactVisibility.edit&amp;target_mask=WbfsysUserContactVisibility&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_contact_visibility.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserContactVisibility.delete&amp;target_mask=WbfsysUserContactVisibility&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_contact_visibility.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_contact_visibility_name'])).'</td>'.NL;
...
}//end class WbfsysUserContactVisibility_Selection_Element
