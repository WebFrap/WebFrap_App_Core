 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysUserContactVisibility_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysUserContactVisibility_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysUserContactVisibility_Selection_Model
