 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserContactVisibility_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserContactVisibility_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_user_contact_visibility
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_contact_visibility/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'message profile visibility', 'wbfsys.user_contact_visibility.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserContactVisibility.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_contact_visibility-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserContactVisibility_Selection' );
...
}//end class WbfsysUserContactVisibility_Selection_Modal_View
