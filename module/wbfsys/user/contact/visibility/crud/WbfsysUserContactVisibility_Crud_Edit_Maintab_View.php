 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserContactVisibility Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserContactVisibility = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit message profile visibility: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserContactVisibility.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserContactVisibility
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserContactVisibility.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_contact_visibility-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_contact_visibility/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserContactVisibility_Crud_Edit' );
...
}//end class WbfsysUserContactVisibility_Crud_Edit_Maintab_View
