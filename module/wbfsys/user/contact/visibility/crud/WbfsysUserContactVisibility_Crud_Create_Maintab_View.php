 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserContactVisibility Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new message profile visibility',
      'wbfsys.user_contact_visibility.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New message profile visibility',
      'wbfsys.user_contact_visibility.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_contact_visibility-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_contact_visibility/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserContactVisibility.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_contact_visibility';
    ...
    $form = $this->newForm( 'WbfsysUserContactVisibility_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserContactVisibility.create');}});
});
...
}//end class WbfsysUserContactVisibility_Crud_Create_Maintab_View
