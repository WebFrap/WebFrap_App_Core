 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserContactVisibility entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserContactVisibility.create'
    );


    // laden von vordefinierten Modal settings
    $this->loadModalConf( 'small' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserContactVisibility.insert';
    $params->formId       = 'wgt-form-wbfsys_user_contact_visibility';
    $params->namespace   = 'wbfsys_user_contact_visibility-create';
    ...
    $this->setTemplate( 'wbfsys/user_contact_visibility/modal/crud/form_create' );
...
}//end class WbfsysUserContactVisibility_Crud_Create_Modal_View
