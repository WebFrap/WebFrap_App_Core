 ...
 * @licence WebFrap.net
 */
class WbfsysUserContactVisibility_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserContactVisibility_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserContactVisibility_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserContactVisibility_Entity */
      $entity = $orm->get( 'WbfsysUserContactVisibility', $rootId );
    }
...
}//end class WbfsysUserContactVisibility_Crud_Access_Root
