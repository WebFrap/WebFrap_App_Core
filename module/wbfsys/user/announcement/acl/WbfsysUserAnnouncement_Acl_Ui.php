 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysUserAnnouncement_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserAnnouncement_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL User Announcement Status', 
        'wbfsys.user_announcement.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_user_announcement-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'User Announcement Status', 'wbfsys.user_announcement.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_user_announcement_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysUserAnnouncement_Acl_Table'
    );
...
} // end class WbfsysUserAnnouncement_Acl_Ui */
