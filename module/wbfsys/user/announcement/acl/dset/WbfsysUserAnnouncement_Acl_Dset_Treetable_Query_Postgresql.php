 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_user_announcement.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysUserAnnouncement_Acl_Dset_Treetable_Query_Postgresql */
