 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysUserAnnouncement_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysUserAnnouncement_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysUserAnnouncement, $areaId, $access, $params  )
  {

    $listObj = new WbfsysUserAnnouncement_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_user_announcement-acl-dset' );
    ...
    else
    {
      ...
      (
        'User Announcement Status "{@label@}" User Access',
        'wbfsys.user_announcement.label',
        array
        (
          'label' => $entityWbfsysUserAnnouncement->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_user_announcement_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysUserAnnouncement_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysUserAnnouncement_Acl_Dset_Ui */
