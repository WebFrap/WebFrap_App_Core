 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_user_announcement'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysUserAnnouncement', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserAnnouncement_Acl_Dset' );
    /* @var $query WbfsysUserAnnouncement_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserAnnouncement_Acl_Dset_Treetable' );
    /* @var $query WbfsysUserAnnouncement_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysUserAnnouncement_Acl_Dset_Model */
