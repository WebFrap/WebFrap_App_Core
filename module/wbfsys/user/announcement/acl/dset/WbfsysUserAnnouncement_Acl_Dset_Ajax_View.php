 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysUserAnnouncement_Acl_Dset' );
    ...
    $entityWbfsysUserAnnouncement = $this->model->getEntity( $dsetId );
...
} // end class WbfsysUserAnnouncement_Acl_Dset_Ajax_View */
