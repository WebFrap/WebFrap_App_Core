 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysUserAnnouncement_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysUserAnnouncement_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysUserAnnouncement = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserAnnouncement_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_user_announcement-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysUserAnnouncement, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_user_announcement-acl-dset', 
    	'WbfsysUserAnnouncement_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserAnnouncement_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_user_announcement-acl-dset', 
    	'WbfsysUserAnnouncement_Acl_Dset',
...
} // end class WbfsysUserAnnouncement_Acl_Dset_Controller */
