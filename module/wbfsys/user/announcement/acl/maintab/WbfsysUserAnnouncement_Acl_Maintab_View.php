 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysUserAnnouncement_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserAnnouncement_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_announcement-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.UserAnnouncement_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_user_announcement-acl-update';
    ...
    $this->setTemplate( 'wbfsys/user_announcement/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Announcement Status', 'wbfsys.user_announcement.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_announcement_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysUserAnnouncement_Acl' );
...
} // end class WbfsysUserAnnouncement_Acl_Maintab_View */
