 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysUserAnnouncement_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_user_announcement-acl-qfdu-aAjax',
      'WbfsysUserAnnouncement_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysUserAnnouncement_Acl_Qfdu_Controller */
