 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_user_announcement.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_user_announcement.rowid as id,
    wbfsys_user_announcement.rowid as value,
    wbfsys_user_announcement.rowid as label
  FROM
...
} // end class WbfsysUserAnnouncement_Acl_Qfdu_Query_Postgresql */
