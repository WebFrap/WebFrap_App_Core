 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_user_announcement.rowid as "wbfsys_user_announcement_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_user_announcement on wbfsys_group_users.vid = wbfsys_user_announcement.rowid'
    );
...
} // end class WbfsysUserAnnouncement_Acl_Qfdu_Treetable_Query_Postgresql */
