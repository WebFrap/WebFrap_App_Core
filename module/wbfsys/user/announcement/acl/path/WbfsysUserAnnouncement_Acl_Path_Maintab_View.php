 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_announcement/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_announcement-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_user_announcement-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysUserAnnouncement_Acl_Path_Maintab_View */
