 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_user_announcement_acl_graph', 
      'WbfsysUserAnnouncement_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysUserAnnouncement_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysUserAnnouncement_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysUserAnnouncement_Acl_Path_Maintab_View  */
...
} // end class WbfsysUserAnnouncement_Acl_Path_Controller */
