 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysUserAnnouncement
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysUserAnnouncement_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_user_announcement_acl_listing',
      'WbfsysUserAnnouncement_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysUserAnnouncement_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysUserAnnouncement_Acl_Model */
    $model   = $this->loadModel( 'WbfsysUserAnnouncement_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_announcement-acl',
    	'WbfsysUserAnnouncement_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_user_announcement_acl_masks_listing',
      'WbfsysUserAnnouncement_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysUserAnnouncement_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysUserAnnouncement_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysUserAnnouncement_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysUserAnnouncement_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysUserAnnouncement_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysUserAnnouncement_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_announcement-acl-qfdu',
    	'WbfsysUserAnnouncement_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysUserAnnouncement_Acl_Controller */
