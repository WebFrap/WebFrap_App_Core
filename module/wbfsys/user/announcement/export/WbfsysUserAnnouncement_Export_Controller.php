 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysUserAnnouncement_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysUserAnnouncement_Export_Listing_Access';
    ...
    // create a new WbfsysUserAnnouncement window
    $view = $this->loadView
    (
    	'export-wbfsys_user_announcement',
    	'WbfsysUserAnnouncement_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysUserAnnouncement_Export' );
...
} // end class WbfsysUserAnnouncement_Export_Controller_Genf
