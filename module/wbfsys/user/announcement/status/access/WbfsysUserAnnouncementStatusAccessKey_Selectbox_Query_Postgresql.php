 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatusAccessKey_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysUserAnnouncementStatusAccessKey Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_user_announcement_status.access_key as id',
      'wbfsys_user_announcement_status.name as value'
     ));
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_user_announcement_status.access_key = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_user_announcement_status.access_key IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysUserAnnouncementStatusAccessKey_Selectbox_Query_Postgresql
