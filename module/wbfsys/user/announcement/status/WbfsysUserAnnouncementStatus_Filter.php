 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Filter
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
        ...
        AND filter_area_{$key}."acl-vid" = wbfsys_user_announcement_status.{$fieldName}
...
}//end class WbfsysUserAnnouncementStatus_Filter
