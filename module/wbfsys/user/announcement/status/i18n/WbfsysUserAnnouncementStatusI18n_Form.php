 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_announcement_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserAnnouncementStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysUserAnnouncementStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysUserAnnouncementStatusI18n';
   ...
   *
   * @var WbfsysUserAnnouncementStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysUserAnnouncementStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserAnnouncementStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserAnnouncementStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.user_announcement_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_user_announcement_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_user_announcement_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysUserAnnouncementStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysUserAnnouncementStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysUserAnnouncementStatus is missing');
      ...
      //p: Window
      $objidWbfsysUserAnnouncementStatus = $this->entity->getData('id_wbfsys_user_announcement_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysUserAnnouncementStatus
          || !$entityWbfsysUserAnnouncementStatus = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysUserAnnouncementStatus = $this->db->orm->newEntity( 'WbfsysUserAnnouncementStatus' );
      }

      $inputIdWbfsysUserAnnouncementStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysUserAnnouncementStatus', 'Window' );
      $inputIdWbfsysUserAnnouncementStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_user_announcement_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_user_announcement_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys User Announcement Status (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysUserAnnouncementStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysUserAnnouncementStatus->setWidth( 'medium' );

      $inputIdWbfsysUserAnnouncementStatus->setData( $this->entity->getData( 'id_wbfsys_user_announcement_status' )  );
      $inputIdWbfsysUserAnnouncementStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_user_announcement_status' ) );
      $inputIdWbfsysUserAnnouncementStatus->setLabel( $this->view->i18n->l( 'Wbfsys User Announcement Status', 'wbfsys.user_announcement_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.UserAnnouncementStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_user_announcement_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysUserAnnouncementStatus->setListUrl ( $listUrl );
      $inputIdWbfsysUserAnnouncementStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysUserAnnouncementStatus->setEntityUrl( 'maintab.php?c=Wbfsys.UserAnnouncementStatus.edit' );
      $inputIdWbfsysUserAnnouncementStatus->conEntity         = $entityWbfsysUserAnnouncementStatus;
      $inputIdWbfsysUserAnnouncementStatus->refresh           = $this->refresh;
      $inputIdWbfsysUserAnnouncementStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysUserAnnouncementStatus->view = $this->view;
      $inputIdWbfsysUserAnnouncementStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_user_announcement_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysUserAnnouncementStatus );
  ...
  }//end public function input_id_wbfsys_user_announcement_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.user_announcement_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.user_announcement_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_announcement_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_announcement_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_announcement_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_announcement_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_announcement_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_announcement_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_announcement_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (User Announcement Status I18n)', 'wbfsys.user_announcement_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_announcement_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_announcement_status_i18n_m_role_change';
...
}//end class WbfsysUserAnnouncementStatusI18n_Form */
