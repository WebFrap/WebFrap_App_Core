 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserAnnouncementStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserAnnouncementStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserAnnouncementStatus_Entity */
      $entity = $orm->get( 'WbfsysUserAnnouncementStatus', $rootId );
    }
...
}//end class WbfsysUserAnnouncementStatus_Crud_Access_Root
