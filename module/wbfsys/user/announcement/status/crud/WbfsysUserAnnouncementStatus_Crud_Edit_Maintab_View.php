 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserAnnouncementStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserAnnouncementStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit user announcement Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserAnnouncementStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserAnnouncementStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserAnnouncementStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_announcement_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_announcement_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserAnnouncementStatus_Crud_Edit' );
...
}//end class WbfsysUserAnnouncementStatus_Crud_Edit_Maintab_View
