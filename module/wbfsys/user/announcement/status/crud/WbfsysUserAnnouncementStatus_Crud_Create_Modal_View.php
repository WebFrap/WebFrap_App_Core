 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserAnnouncementStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserAnnouncementStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserAnnouncementStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_user_announcement_status';
    $params->namespace   = 'wbfsys_user_announcement_status-create';
    ...
    $this->setTemplate( 'wbfsys/user_announcement_status/modal/crud/form_create' );
...
}//end class WbfsysUserAnnouncementStatus_Crud_Create_Modal_View
