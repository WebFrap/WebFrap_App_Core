 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserAnnouncementStatus_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserAnnouncementStatus_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_user_announcement_status
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_announcement_status/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'user announcement Status', 'wbfsys.user_announcement_status.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserAnnouncementStatus.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_announcement_status-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserAnnouncementStatus_Selection' );
...
}//end class WbfsysUserAnnouncementStatus_Selection_Modal_View
