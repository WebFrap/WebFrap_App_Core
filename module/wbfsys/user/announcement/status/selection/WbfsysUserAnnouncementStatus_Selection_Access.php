 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserAnnouncementStatus_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_user_announcement_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_user_announcement_status.rowid ",
      'acls'
    );
...
}//end class WbfsysUserAnnouncementStatus_Selection_Access
