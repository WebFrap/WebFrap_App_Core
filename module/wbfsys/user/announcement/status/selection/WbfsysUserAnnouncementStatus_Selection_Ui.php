 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserAnnouncementStatus_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserAnnouncementStatus_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserAnnouncementStatus_Selection_Element
    (
      'selectionWbfsysUserAnnouncementStatus',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection user announcement Status', 'wbfsys.user_announcement_status.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserAnnouncementStatus.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserAnnouncementStatus',
      'WbfsysUserAnnouncementStatus_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserAnnouncementStatus_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserAnnouncementStatus_Selection_Ui
