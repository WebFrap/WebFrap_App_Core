 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysUserAnnouncementStatus_Selection' ) );
...
} // end class WbfsysUserAnnouncementStatus_Selection_Controller */
