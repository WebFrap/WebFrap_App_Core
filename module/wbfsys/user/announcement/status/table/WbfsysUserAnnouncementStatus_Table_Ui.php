 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für user announcement Status
  *
  ...
  *  }
  *
  * @return WbfsysUserAnnouncementStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserAnnouncementStatus_Table_Element( 'tableWbfsysUserAnnouncementStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_announcement_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'user announcement Status', 'wbfsys.user_announcement_status.label' );
      //$tabPanel->searchKey = 'wbfsys_user_announcement_status';
      ...
      $searchElement->searchKey = 'wbfsys_user_announcement_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserAnnouncementStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserAnnouncementStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserAnnouncementStatus listing maske
   *
   * @param WbfsysUserAnnouncementStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserAnnouncementStatus  = $model->getEntityWbfsysUserAnnouncementStatus();
    ...
    $formWbfsysUserAnnouncementStatus->setKeyName( 'wbfsys_user_announcement_status' );
...
}//end class WbfsysUserAnnouncementStatus_Table_Ui
