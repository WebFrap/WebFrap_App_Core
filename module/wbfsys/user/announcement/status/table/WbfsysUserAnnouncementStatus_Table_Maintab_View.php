 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserAnnouncementStatus_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserAnnouncementStatus_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_announcement_status/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table user announcement Status',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.UserAnnouncementStatus.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserAnnouncementStatus.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysUserAnnouncementStatus_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysUserAnnouncementStatus_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.UserAnnouncementStatus.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.UserAnnouncementStatus.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.UserAnnouncementStatus.create&amp;ltype=table');
    });
...
}//end class WbfsysUserAnnouncementStatus_Table_Maintab_View
