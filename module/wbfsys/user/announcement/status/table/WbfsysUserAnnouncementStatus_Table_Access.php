 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncementStatus_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserAnnouncementStatus_Table_Query $query
...
}//end class WbfsysUserAnnouncementStatus_Table_Access
