 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysUserAnnouncement_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserAnnouncement_Table_Element( 'tableWbfsysUserAnnouncement', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_announcement-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Announcement Status', 'wbfsys.user_announcement.label' );
      //$tabPanel->searchKey = 'wbfsys_user_announcement';
      ...
      $searchElement->searchKey = 'wbfsys_user_announcement';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserAnnouncement_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserAnnouncement', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserAnnouncement listing maske
   *
   * @param WbfsysUserAnnouncement_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserAnnouncement_Table_Ui
