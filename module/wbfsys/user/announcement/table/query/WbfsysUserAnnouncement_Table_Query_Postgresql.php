 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_user_announcement.rowid as "wbfsys_user_announcement_rowid"', // variant: def-rowid 
      'wbfsys_user_announcement_status.name as "wbfsys_user_announcement_status_name"', // variant: def-by-context  used source field wbfsys_user_announcement_status
      'wbfsys_user_announcement.id_status as "wbfsys_user_announcement_id_status"', // ref wbfsys_user_announcement def-by-context 
    );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_user_announcement.rowid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition) )
      {
        ...
        {
          $criteria->where( 'wbfsys_user_announcement.rowid = '.$condition );
        }
        else
        {
  ...
  public function checkConditions( $criteria, array $condition )
  {
      ...
      if( isset($condition['free']) && trim( $condition['free'] ) != ''  )
      {
         ...
         )
         {
            ...
            (
              '(
 wbfsys_user_announcement.rowid = \''.$part.'\' 
              )'
            );
         }
...
}//end class WbfsysUserAnnouncement_Table_Query_Postgresql
