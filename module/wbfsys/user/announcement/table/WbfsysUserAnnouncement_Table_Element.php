 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_user_announcement';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserAnnouncement.show&amp;target_mask=WbfsysUserAnnouncement&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserAnnouncement.edit&amp;target_mask=WbfsysUserAnnouncement&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_announcement.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserAnnouncement.delete&amp;target_mask=WbfsysUserAnnouncement&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_announcement.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_user_announcement&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.user_announcement.label',
        Acl::ADMIN
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserAnnouncement_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.UserAnnouncement_Multi.deleteAll" >{$iconClean} Delete all User Announcement Status</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserAnnouncement_Table_Element
