 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserAnnouncement Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserAnnouncement = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserAnnouncement.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserAnnouncement
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserAnnouncement.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_announcement-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_announcement/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserAnnouncement_Crud_Edit' );
...
}//end class WbfsysUserAnnouncement_Crud_Edit_Maintab_View
