 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserAnnouncement_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUserAnnouncement Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserAnnouncement = $this->model->getEntityWbfsysUserAnnouncement();
    ...
    (
      ...
      array( 'text' => $entityWbfsysUserAnnouncement->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserAnnouncement.show  &amp;objid='.$entityWbfsysUserAnnouncement
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserAnnouncement.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_announcement-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_announcement/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUserAnnouncement_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.UserAnnouncement.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_announcement' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_announcement a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.UserAnnouncement.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.UserAnnouncement.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUserAnnouncement_Crud_Show_Maintab_View
