 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserAnnouncement Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_announcement-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_announcement/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserAnnouncement.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_announcement';
    ...
    $form = $this->newForm( 'WbfsysUserAnnouncement_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserAnnouncement.create');}});
});
...
}//end class WbfsysUserAnnouncement_Crud_Create_Maintab_View
