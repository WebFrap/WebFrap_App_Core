 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserAnnouncement entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserAnnouncement.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserAnnouncement.insert';
    $params->formId       = 'wgt-form-wbfsys_user_announcement';
    $params->namespace   = 'wbfsys_user_announcement-create';
    ...
    $this->setTemplate( 'wbfsys/user_announcement/modal/crud/form_create' );
...
}//end class WbfsysUserAnnouncement_Crud_Create_Modal_View
