 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysUserAnnouncement_IdAnnouncement( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAnnouncement_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Announcement.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysUserAnnouncement', array_keys( $this->fields['wbfsys_user_announcement']), true ),
...
}//end class WbfsysUserAnnouncement_Crud_Create_Form */
