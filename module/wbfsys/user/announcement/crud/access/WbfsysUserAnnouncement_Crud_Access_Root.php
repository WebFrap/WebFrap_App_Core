 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserAnnouncement_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserAnnouncement_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserAnnouncement_Entity */
      $entity = $orm->get( 'WbfsysUserAnnouncement', $rootId );
    }
...
}//end class WbfsysUserAnnouncement_Crud_Access_Root
