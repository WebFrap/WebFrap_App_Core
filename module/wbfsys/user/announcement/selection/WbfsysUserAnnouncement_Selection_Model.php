 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysUserAnnouncement_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysUserAnnouncement_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysUserAnnouncement_Selection_Model
