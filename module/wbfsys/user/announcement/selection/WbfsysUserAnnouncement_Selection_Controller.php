 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysUserAnnouncement_Selection' ) );
...
} // end class WbfsysUserAnnouncement_Selection_Controller */
