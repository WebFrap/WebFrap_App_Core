 ...
 * @licence WebFrap.net
 */
class WbfsysUserAnnouncement_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserAnnouncement_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserAnnouncement_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserAnnouncement_Selection_Element
    (
      'selectionWbfsysUserAnnouncement',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Announcement Status', 'wbfsys.user_announcement.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserAnnouncement.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserAnnouncement',
      'WbfsysUserAnnouncement_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserAnnouncement_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserAnnouncement_Selection_Ui
