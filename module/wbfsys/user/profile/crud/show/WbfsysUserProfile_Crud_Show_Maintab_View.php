 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUserProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserProfile = $this->model->getEntityWbfsysUserProfile();
    ...
    (
      ...
      array( 'text' => $entityWbfsysUserProfile->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserProfile.show  &amp;objid='.$entityWbfsysUserProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserProfile.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_profile-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_profile/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUserProfile_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.UserProfile.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_profile' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_profile a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.UserProfile.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.UserProfile.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUserProfile_Crud_Show_Maintab_View
