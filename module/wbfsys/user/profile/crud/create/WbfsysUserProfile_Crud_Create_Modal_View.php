 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserProfile entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserProfile.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserProfile.insert';
    $params->formId       = 'wgt-form-wbfsys_user_profile';
    $params->namespace   = 'wbfsys_user_profile-create';
    ...
    $this->setTemplate( 'wbfsys/user_profile/modal/crud/form_create' );
...
}//end class WbfsysUserProfile_Crud_Create_Modal_View
