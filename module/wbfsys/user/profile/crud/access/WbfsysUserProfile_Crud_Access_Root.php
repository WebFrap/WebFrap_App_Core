 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserProfile_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserProfile_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserProfile_Entity */
      $entity = $orm->get( 'WbfsysUserProfile', $rootId );
    }
...
}//end class WbfsysUserProfile_Crud_Access_Root
