 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserProfile Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserProfile = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserProfile.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserProfile
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserProfile.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_profile-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_profile/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserProfile_Crud_Edit' );
...
}//end class WbfsysUserProfile_Crud_Edit_Maintab_View
