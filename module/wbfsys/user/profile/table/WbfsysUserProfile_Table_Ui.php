 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für User Profiles
  *
  ...
  *  }
  *
  * @return WbfsysUserProfile_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserProfile_Table_Element( 'tableWbfsysUserProfile', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_profile-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Profiles', 'wbfsys.user_profile.label' );
      //$tabPanel->searchKey = 'wbfsys_user_profile';
      ...
      $searchElement->searchKey = 'wbfsys_user_profile';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserProfile_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserProfile', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserProfile listing maske
   *
   * @param WbfsysUserProfile_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserProfile  = $model->getEntityWbfsysUserProfile();
    ...
    $formWbfsysUserProfile->setKeyName( 'wbfsys_user_profile' );
...
}//end class WbfsysUserProfile_Table_Ui
