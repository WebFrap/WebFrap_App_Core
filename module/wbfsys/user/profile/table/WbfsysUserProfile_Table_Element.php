 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_user_profile';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserProfile_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserProfile.show&amp;target_mask=WbfsysUserProfile&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserProfile.edit&amp;target_mask=WbfsysUserProfile&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_profile.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserProfile.delete&amp;target_mask=WbfsysUserProfile&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_profile.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_profile_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserProfile_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.UserProfile_Multi.deleteAll" >{$iconClean} Delete all User Profiles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserProfile_Table_Element
