 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserProfile_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserProfile_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_profile/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Profile', 'wbfsys.user_profile.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserProfile.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_profile-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserProfile_Selection' );
...
}//end class WbfsysUserProfile_Selection_Modal_View
