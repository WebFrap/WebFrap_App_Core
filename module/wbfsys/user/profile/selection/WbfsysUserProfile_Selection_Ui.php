 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserProfile_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserProfile_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserProfile_Selection_Element
    (
      'selectionWbfsysUserProfile',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Profiles', 'wbfsys.user_profile.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserProfile.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserProfile',
      'WbfsysUserProfile_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserProfile_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserProfile_Selection_Ui
