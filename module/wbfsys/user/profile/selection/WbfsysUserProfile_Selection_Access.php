 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfile_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserProfile_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_user_profile.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_user_profile.rowid ",
      'acls'
    );
...
}//end class WbfsysUserProfile_Selection_Access
