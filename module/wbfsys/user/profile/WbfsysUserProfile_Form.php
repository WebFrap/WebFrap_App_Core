...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_profile';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserProfile';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserProfile' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserProfile entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_key( $params )
  {

      //tpl: class ui:text
      $inputKey = $this->view->newInput( 'input'.$this->prefix.'Key' , 'Text' );
      $this->items['key'] = $inputKey;
      $inputKey->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[key]',
          'id'        => 'wgt-input-'.$this->keyName.'_key'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_cname medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Key (User Profile)', 'wbfsys.user_profile.label' ),
          'maxlength' => $this->entity->maxSize( 'key' ),
        )
      );
      $inputKey->setWidth( 'medium' );

      $inputKey->setReadOnly( $this->isReadOnly( 'key' ) );
      $inputKey->setData( $this->entity->getSecure('key') );
      $inputKey->setLabel
      (
        $this->view->i18n->l( 'Key', 'wbfsys.user_profile.label' ),
        $this->entity->required( 'key' )
      );
  ...
  public function input_id_profile( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysProfile_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Profile (User Profile)', 'wbfsys.user_profile.label' ),
      ));
      ...
      $inputIdProfile->setLabel( $this->view->i18n->l( 'Profile', 'wbfsys.user_profile.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_user'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for User (User Profile)', 'wbfsys.user_profile.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.user_profile.label' ) );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (User Profile)', 'wbfsys.user_profile.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (User Profile)', 'wbfsys.user_profile.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.user_profile.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (User Profile)', 'wbfsys.user_profile.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Profile)', 'wbfsys.user_profile.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_profile.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Profile)', 'wbfsys.user_profile.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_profile.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Profile)', 'wbfsys.user_profile.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_profile.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Profile)', 'wbfsys.user_profile.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_profile.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Profile)', 'wbfsys.user_profile.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_profile.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Profile)', 'wbfsys.user_profile.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_profile.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Profile)', 'wbfsys.user_profile.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_profile.label' ),
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create the search element for field key
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Key (User Profile)', 'wbfsys.user_profile.label' ),
          'maxlength' => $this->entity->maxSize( 'key' ),
        )
      );
      $inputKey->setWidth( 'medium' );
  ...
  }//end public function search_key */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_profile_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_profile_m_role_change';
...
}//end class WbfsysUserProfile_Form */
