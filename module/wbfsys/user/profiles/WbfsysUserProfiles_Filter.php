 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_user_profiles') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_user_profiles.{$fieldName}
...
}//end class WbfsysUserProfiles_Filter
