 ...
 *
 * Entity Class for the Database Table wbfsys_user_profiles
 * 
 * @package WebFrap
 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Entity
  extends Entity
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_user_profiles';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.UserProfiles.show';
  ...
  */
  public static $entityName  = 'WbfsysUserProfiles';
  ...
  * @var string
  */
  public static $label  = 'User Profiles';
  ...
  */
  ...
  (
    'id_user' => array
    (
      'default' => 'wbfsys.user_profiles.message.error_def_id_user',
      'wrong'   => 'wbfsys.user_profiles.message.error_wrong_id_user',
      'max'     => 'wbfsys.user_profiles.message.error_max_id_user',
      'min'     => 'wbfsys.user_profiles.message.error_min_id_user',
    ),

    'id_profile' => array
    (
      'default' => 'wbfsys.user_profiles.message.error_def_id_profile',
      'wrong'   => 'wbfsys.user_profiles.message.error_wrong_id_profile',
      'max'     => 'wbfsys.user_profiles.message.error_max_id_profile',
      'min'     => 'wbfsys.user_profiles.message.error_min_id_profile',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.user_profiles.message.error_def_rowid',
      'wrong'   => 'wbfsys.user_profiles.message.error_wrong_rowid',
      'empty'   => 'wbfsys.user_profiles.message.error_empty_rowid',
      'max'     => 'wbfsys.user_profiles.message.error_max_rowid',
      'min'     => 'wbfsys.user_profiles.message.error_min_rowid',
    ),
  );

}//end class WbfsysUserProfiles_Entity
