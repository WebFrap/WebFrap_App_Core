 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_user_profiles
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.UserProfiles.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_user_profiles-create';

    $access = new WbfsysUserProfiles_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_user_profiles-create',
      'WbfsysUserProfiles_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysUserProfiles_Crud_Model */
    $model = $this->loadModel( 'WbfsysUserProfiles_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.UserProfiles.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysUserProfiles = $model->getEntityWbfsysUserProfiles( $objid );
    ...
    $params->entity = $entityWbfsysUserProfiles;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_user_profiles:edit';

    $access = new WbfsysUserProfiles_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserProfiles );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_user_profiles-edit-'.$objid,
      'WbfsysUserProfiles_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_user_profiles-edit',
          $entityWbfsysUserProfiles,
          'Edit User Profiles :'.$entityWbfsysUserProfiles->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_user_profiles';
      $params->maskRoot      = 'wbfsys_user_profiles:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_user_profiles';
      $params->aclNode       = 'mgmt-wbfsys_user_profiles';
      $params->aclLevel      = 1;
    }
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_user_profiles-show',
          $entityWbfsysUserProfiles,
          'Show User Profiles :'.$entityWbfsysUserProfiles->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_user_profiles
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.UserProfiles.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-insert';

    $access = new WbfsysUserProfiles_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysUserProfiles = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_user_profiles-update-'.$entityWbfsysUserProfiles;
      ...
      {
        $access = new WbfsysUserProfiles_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysUserProfiles );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysUserProfiles';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_user_profiles',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysUserProfiles_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.UserProfiles.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysUserProfiles, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysUserProfiles_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.UserProfiles.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-delete-'.$objid;

    $access = new WbfsysUserProfiles_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserProfiles );
    ...
    $error = $model->delete( $entityWbfsysUserProfiles, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysUserProfiles, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.UserProfiles.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.UserProfiles.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-listing';
    ...
    $containerClass = 'WbfsysUserProfiles_'.$listType.'_Access';
    ...
    /* @var $model WbfsysUserProfiles_Table_Model */
    $model = $this->loadModel( 'WbfsysUserProfiles_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_user_profiles-'.$params->ltype,
          'WbfsysUserProfiles',
          'List of User Profiless'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysUserProfiles
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysUserProfiles_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_user_profiles',
      'WbfsysUserProfiles_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysUserProfiles_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.UserProfiles.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysUserProfiles_Selection_Model */
    $model   = $this->loadModel( 'WbfsysUserProfiles_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_user_profiles-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_user_profiles-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_user_profiles',
      'WbfsysUserProfiles',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysUserProfiles, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysUserProfiles_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysUserProfiles_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_profiles-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysUserProfiles_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysUserProfiles, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_user_profiles' );
...
} // end class WbfsysUserProfiles_Controller */
