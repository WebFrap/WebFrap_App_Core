 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysUserProfiles_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysUserProfiles_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysUserProfiles_Table_Model
