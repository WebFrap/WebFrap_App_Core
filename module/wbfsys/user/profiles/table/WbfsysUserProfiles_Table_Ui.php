 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysUserProfiles_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserProfiles_Table_Element( 'tableWbfsysUserProfiles', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_profiles-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Profiles', 'wbfsys.user_profiles.label' );
      //$tabPanel->searchKey = 'wbfsys_user_profiles';
      ...
      $searchElement->searchKey = 'wbfsys_user_profiles';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserProfiles_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserProfiles', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserProfiles listing maske
   *
   * @param WbfsysUserProfiles_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserProfiles_Table_Ui
