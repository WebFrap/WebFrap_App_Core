 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysUserProfiles
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysUserProfiles_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_user_profiles_acl_listing',
      'WbfsysUserProfiles_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysUserProfiles_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysUserProfiles_Acl_Model */
    $model   = $this->loadModel( 'WbfsysUserProfiles_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_profiles-acl',
    	'WbfsysUserProfiles_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_user_profiles_acl_masks_listing',
      'WbfsysUserProfiles_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysUserProfiles_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysUserProfiles_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysUserProfiles_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysUserProfiles_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysUserProfiles_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysUserProfiles_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_profiles-acl-qfdu',
    	'WbfsysUserProfiles_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysUserProfiles_Acl_Controller */
