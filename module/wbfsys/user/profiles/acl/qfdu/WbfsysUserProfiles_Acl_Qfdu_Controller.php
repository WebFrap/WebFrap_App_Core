 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysUserProfiles_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_user_profiles-acl-qfdu-aAjax',
      'WbfsysUserProfiles_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysUserProfiles_Acl_Qfdu_Controller */
