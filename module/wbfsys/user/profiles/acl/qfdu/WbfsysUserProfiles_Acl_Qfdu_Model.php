 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_user_profiles')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysUserProfiles = $orm->get('WbfsysUserProfiles', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_user_profiles_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysUserProfiles_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserProfiles_Acl' );
    /* @var $query WbfsysUserProfiles_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserProfiles_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysUserProfiles_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserProfiles_Acl_Qfdu' );
    /* @var $query WbfsysUserProfiles_Acl_Qfdu_Query  */
...
} // end class WbfsysUserProfiles_Acl_Qfdu_Model */
