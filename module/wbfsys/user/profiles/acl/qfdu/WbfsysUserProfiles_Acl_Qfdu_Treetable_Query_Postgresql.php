 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_user_profiles.rowid as "wbfsys_user_profiles_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_user_profiles on wbfsys_group_users.vid = wbfsys_user_profiles.rowid'
    );
...
} // end class WbfsysUserProfiles_Acl_Qfdu_Treetable_Query_Postgresql */
