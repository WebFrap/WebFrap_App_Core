 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysUserProfiles_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserProfiles_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_user_profiles-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'User Profiles', 'wbfsys.user_profiles.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_user_profiles_acl';
...
} // end class WbfsysUserProfiles_Acl_Ui */
