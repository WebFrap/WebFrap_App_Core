 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserProfiles_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_profiles-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.UserProfiles_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_user_profiles-acl-update';
    ...
    $this->setTemplate( 'wbfsys/user_profiles/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Profiles', 'wbfsys.user_profiles.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_profiles_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysUserProfiles_Acl' );
...
} // end class WbfsysUserProfiles_Acl_Maintab_View */
