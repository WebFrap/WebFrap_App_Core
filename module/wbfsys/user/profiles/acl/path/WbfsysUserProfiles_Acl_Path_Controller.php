 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_user_profiles_acl_graph', 
      'WbfsysUserProfiles_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysUserProfiles_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysUserProfiles_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysUserProfiles_Acl_Path_Maintab_View  */
...
} // end class WbfsysUserProfiles_Acl_Path_Controller */
