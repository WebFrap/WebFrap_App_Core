 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Path_Maintab_Menu
  extends WgtDropmenu
{////////////////////////////////////////////////////////////////////////////////
// build methodes
////////////////////////////////////////////////////////////////////////////////
    ...
    <span>
      <ul>
        <li><a 
          ...
          href="modal.php?c=Wbfsys.SecurityArea_Maintenance.help&amp;refer=wbfsys_user_profiles-acl-path" >{$iconHelp} Help</a>
        </li>
        <!--
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Issue.create&amp;refer=wbfsys_user_profiles-acl-path" >{$iconBug} Bug</a>
        </li>
        -->
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Faq.create&amp;refer=wbfsys_user_profiles-acl-path" >{$iconFaq} Faq</a>
        </li>
      </ul>
    </span>
  </li>
...
} // end class WbfsysUserProfiles_Acl_Path_Maintab_Menu */
