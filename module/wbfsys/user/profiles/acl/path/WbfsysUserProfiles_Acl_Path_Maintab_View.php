 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_profiles/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_profiles-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_user_profiles-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysUserProfiles_Acl_Path_Maintab_View */
