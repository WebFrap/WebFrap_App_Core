 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysUserProfiles_Acl_Dset' );
    ...
    $entityWbfsysUserProfiles = $this->model->getEntity( $dsetId );
...
} // end class WbfsysUserProfiles_Acl_Dset_Ajax_View */
