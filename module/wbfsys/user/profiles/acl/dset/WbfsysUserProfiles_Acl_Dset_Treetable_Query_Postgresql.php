 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_user_profiles.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysUserProfiles_Acl_Dset_Treetable_Query_Postgresql */
