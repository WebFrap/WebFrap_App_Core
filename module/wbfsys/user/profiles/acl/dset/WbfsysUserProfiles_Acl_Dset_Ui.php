 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysUserProfiles_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysUserProfiles_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysUserProfiles, $areaId, $access, $params  )
  {

    $listObj = new WbfsysUserProfiles_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_user_profiles-acl-dset' );
    ...
    else
    {
      ...
      (
        'User Profiles "{@label@}" User Access',
        'wbfsys.user_profiles.label',
        array
        (
          'label' => $entityWbfsysUserProfiles->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_user_profiles_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysUserProfiles_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysUserProfiles_Acl_Dset_Ui */
