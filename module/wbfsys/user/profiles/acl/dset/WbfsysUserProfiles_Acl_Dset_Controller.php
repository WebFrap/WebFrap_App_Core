 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysUserProfiles_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysUserProfiles_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysUserProfiles = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserProfiles_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_user_profiles-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysUserProfiles, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserProfiles_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_user_profiles-acl-dset', 
    	'WbfsysUserProfiles_Acl_Dset',
...
} // end class WbfsysUserProfiles_Acl_Dset_Controller */
