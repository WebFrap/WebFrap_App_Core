 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_user_profiles'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysUserProfiles', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserProfiles_Acl_Dset' );
    /* @var $query WbfsysUserProfiles_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserProfiles_Acl_Dset_Treetable' );
    /* @var $query WbfsysUserProfiles_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysUserProfiles_Acl_Dset_Model */
