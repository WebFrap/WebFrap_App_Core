 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysUserProfiles_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysUserProfiles_Export_Listing_Access';
    ...
    // create a new WbfsysUserProfiles window
    $view = $this->loadView
    (
    	'export-wbfsys_user_profiles',
    	'WbfsysUserProfiles_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysUserProfiles_Export' );
...
} // end class WbfsysUserProfiles_Export_Controller_Genf
