 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserProfiles Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserProfiles = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit User Profiles: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserProfiles.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserProfiles
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserProfiles.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_profiles-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_profiles/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserProfiles_Crud_Edit' );
...
}//end class WbfsysUserProfiles_Crud_Edit_Maintab_View
