 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserProfiles entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserProfiles.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserProfiles.insert';
    $params->formId       = 'wgt-form-wbfsys_user_profiles';
    $params->namespace   = 'wbfsys_user_profiles-create';
    ...
    $this->setTemplate( 'wbfsys/user_profiles/modal/crud/form_create' );
...
}//end class WbfsysUserProfiles_Crud_Create_Modal_View
