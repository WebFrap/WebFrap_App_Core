 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserProfiles Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_profiles-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_profiles/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserProfiles.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_profiles';
    ...
    $form = $this->newForm( 'WbfsysUserProfiles_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserProfiles.create');}});
});
...
}//end class WbfsysUserProfiles_Crud_Create_Maintab_View
