 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserProfiles_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserProfiles_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserProfiles_Entity */
      $entity = $orm->get( 'WbfsysUserProfiles', $rootId );
    }
...
}//end class WbfsysUserProfiles_Crud_Access_Root
