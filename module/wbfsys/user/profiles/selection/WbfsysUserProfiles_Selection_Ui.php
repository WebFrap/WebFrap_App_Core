 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserProfiles_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserProfiles_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserProfiles_Selection_Element
    (
      'selectionWbfsysUserProfiles',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Profiles', 'wbfsys.user_profiles.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserProfiles.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserProfiles',
      'WbfsysUserProfiles_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserProfiles_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserProfiles_Selection_Ui
