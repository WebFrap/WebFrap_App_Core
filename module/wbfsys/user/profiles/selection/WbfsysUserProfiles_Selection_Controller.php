 ...
 * @licence WebFrap.net
 */
class WbfsysUserProfiles_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysUserProfiles_Selection' ) );
...
} // end class WbfsysUserProfiles_Selection_Controller */
