 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserRelationStatus_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserRelationStatus_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserRelationStatus_Selection_Element
    (
      'selectionWbfsysUserRelationStatus',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection user relation Status', 'wbfsys.user_relation_status.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserRelationStatus.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserRelationStatus',
      'WbfsysUserRelationStatus_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserRelationStatus_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserRelationStatus_Selection_Ui
