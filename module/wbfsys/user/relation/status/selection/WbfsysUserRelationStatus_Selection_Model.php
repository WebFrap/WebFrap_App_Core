 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysUserRelationStatus_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysUserRelationStatus_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysUserRelationStatus_Selection_Model
