 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserRelationStatus_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_user_relation_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_user_relation_status.rowid ",
      'acls'
    );
...
}//end class WbfsysUserRelationStatus_Selection_Access
