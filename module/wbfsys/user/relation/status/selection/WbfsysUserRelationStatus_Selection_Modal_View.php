 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserRelationStatus_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserRelationStatus_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_user_relation_status
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_relation_status/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'user relation Status', 'wbfsys.user_relation_status.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserRelationStatus.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_relation_status-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserRelationStatus_Selection' );
...
}//end class WbfsysUserRelationStatus_Selection_Modal_View
