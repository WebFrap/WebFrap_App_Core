 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_user_relation_status';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserRelationStatus.show&amp;target_mask=WbfsysUserRelationStatus&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserRelationStatus.edit&amp;target_mask=WbfsysUserRelationStatus&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_relation_status.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserRelationStatus.delete&amp;target_mask=WbfsysUserRelationStatus&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_relation_status.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_relation_status_name'])).'</td>'.NL;
...
}//end class WbfsysUserRelationStatus_Selection_Element
