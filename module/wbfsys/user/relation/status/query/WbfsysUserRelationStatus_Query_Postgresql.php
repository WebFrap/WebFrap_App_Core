 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_user_relation_status where rowid > 0;
SQL;
...
}//end class WbfsysUserRelationStatus_Query_Postgresql
