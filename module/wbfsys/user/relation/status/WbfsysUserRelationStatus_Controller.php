 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_user_relation_status
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.UserRelationStatus.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_user_relation_status-create';

    $access = new WbfsysUserRelationStatus_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_user_relation_status-create',
      'WbfsysUserRelationStatus_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysUserRelationStatus_Crud_Model */
    $model = $this->loadModel( 'WbfsysUserRelationStatus_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.UserRelationStatus.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysUserRelationStatus = $model->getEntityWbfsysUserRelationStatus( $objid );
    ...
    if( !$entityWbfsysUserRelationStatus )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'user relation Status', 'wbfsys.user_relation_status.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysUserRelationStatus;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_user_relation_status:edit';

    $access = new WbfsysUserRelationStatus_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserRelationStatus );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_user_relation_status-edit-'.$objid,
      'WbfsysUserRelationStatus_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_user_relation_status:show';
    ...
    (
      'form-wbfsys_user_relation_status-edit-'.$objid,
      'WbfsysUserRelationStatus_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_user_relation_status
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.UserRelationStatus.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-insert';

    $access = new WbfsysUserRelationStatus_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysUserRelationStatus = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_user_relation_status-update-'.$entityWbfsysUserRelationStatus;
      ...
      {
        $access = new WbfsysUserRelationStatus_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysUserRelationStatus );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysUserRelationStatus';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_user_relation_status',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysUserRelationStatus_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.UserRelationStatus.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysUserRelationStatus, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysUserRelationStatus_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.UserRelationStatus.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-delete-'.$objid;

    $access = new WbfsysUserRelationStatus_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserRelationStatus );
    ...
    $error = $model->delete( $entityWbfsysUserRelationStatus, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysUserRelationStatus, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.UserRelationStatus.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.UserRelationStatus.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-listing';
    ...
    $containerClass = 'WbfsysUserRelationStatus_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_user_relation_status',
      'WbfsysUserRelationStatus_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysUserRelationStatus_Table_Model */
    $model = $this->loadModel( 'WbfsysUserRelationStatus_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_user_relation_status-'.$params->ltype,
          'WbfsysUserRelationStatus',
          'List of user relation Statuss'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysUserRelationStatus
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysUserRelationStatus_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_user_relation_status',
      'WbfsysUserRelationStatus_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysUserRelationStatus_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.UserRelationStatus.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysUserRelationStatus_Selection_Model */
    $model   = $this->loadModel( 'WbfsysUserRelationStatus_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_user_relation_status-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_user_relation_status-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_user_relation_status',
      'WbfsysUserRelationStatus',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysUserRelationStatus, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysUserRelationStatus_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysUserRelationStatus_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_relation_status-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysUserRelationStatus_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysUserRelationStatus, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_user_relation_status' );
...
} // end class WbfsysUserRelationStatus_Controller */
