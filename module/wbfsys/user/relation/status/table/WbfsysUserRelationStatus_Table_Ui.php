 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für user relation Status
  *
  ...
  *  }
  *
  * @return WbfsysUserRelationStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserRelationStatus_Table_Element( 'tableWbfsysUserRelationStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_relation_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'user relation Status', 'wbfsys.user_relation_status.label' );
      //$tabPanel->searchKey = 'wbfsys_user_relation_status';
      ...
      $searchElement->searchKey = 'wbfsys_user_relation_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserRelationStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserRelationStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserRelationStatus listing maske
   *
   * @param WbfsysUserRelationStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserRelationStatus  = $model->getEntityWbfsysUserRelationStatus();
    ...
    $formWbfsysUserRelationStatus->setKeyName( 'wbfsys_user_relation_status' );
...
}//end class WbfsysUserRelationStatus_Table_Ui
