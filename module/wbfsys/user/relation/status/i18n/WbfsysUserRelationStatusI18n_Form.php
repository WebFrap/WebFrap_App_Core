 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_relation_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserRelationStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysUserRelationStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysUserRelationStatusI18n';
   ...
   *
   * @var WbfsysUserRelationStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysUserRelationStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserRelationStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserRelationStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.user_relation_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_user_relation_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_user_relation_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysUserRelationStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysUserRelationStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysUserRelationStatus is missing');
      ...
      //p: Window
      $objidWbfsysUserRelationStatus = $this->entity->getData('id_wbfsys_user_relation_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysUserRelationStatus
          || !$entityWbfsysUserRelationStatus = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysUserRelationStatus = $this->db->orm->newEntity( 'WbfsysUserRelationStatus' );
      }

      $inputIdWbfsysUserRelationStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysUserRelationStatus', 'Window' );
      $inputIdWbfsysUserRelationStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_user_relation_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_user_relation_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys User Relation Status (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysUserRelationStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysUserRelationStatus->setWidth( 'medium' );

      $inputIdWbfsysUserRelationStatus->setData( $this->entity->getData( 'id_wbfsys_user_relation_status' )  );
      $inputIdWbfsysUserRelationStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_user_relation_status' ) );
      $inputIdWbfsysUserRelationStatus->setLabel( $this->view->i18n->l( 'Wbfsys User Relation Status', 'wbfsys.user_relation_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.UserRelationStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_user_relation_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysUserRelationStatus->setListUrl ( $listUrl );
      $inputIdWbfsysUserRelationStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysUserRelationStatus->setEntityUrl( 'maintab.php?c=Wbfsys.UserRelationStatus.edit' );
      $inputIdWbfsysUserRelationStatus->conEntity         = $entityWbfsysUserRelationStatus;
      $inputIdWbfsysUserRelationStatus->refresh           = $this->refresh;
      $inputIdWbfsysUserRelationStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysUserRelationStatus->view = $this->view;
      $inputIdWbfsysUserRelationStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_user_relation_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysUserRelationStatus );
  ...
  }//end public function input_id_wbfsys_user_relation_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.user_relation_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.user_relation_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_relation_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_relation_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_relation_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_relation_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_relation_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_relation_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_relation_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (User Relation Status I18n)', 'wbfsys.user_relation_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_relation_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_relation_status_i18n_m_role_change';
...
}//end class WbfsysUserRelationStatusI18n_Form */
