 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserRelationStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserRelationStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserRelationStatus_Entity */
      $entity = $orm->get( 'WbfsysUserRelationStatus', $rootId );
    }
...
}//end class WbfsysUserRelationStatus_Crud_Access_Root
