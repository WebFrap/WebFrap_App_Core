 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserRelationStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserRelationStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserRelationStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_user_relation_status';
    $params->namespace   = 'wbfsys_user_relation_status-create';
    ...
    $this->setTemplate( 'wbfsys/user_relation_status/modal/crud/form_create' );
...
}//end class WbfsysUserRelationStatus_Crud_Create_Modal_View
