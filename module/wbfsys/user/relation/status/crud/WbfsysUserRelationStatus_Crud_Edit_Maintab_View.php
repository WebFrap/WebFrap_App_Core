 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserRelationStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserRelationStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit user relation Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserRelationStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserRelationStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserRelationStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_relation_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_relation_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserRelationStatus_Crud_Edit' );
...
}//end class WbfsysUserRelationStatus_Crud_Edit_Maintab_View
