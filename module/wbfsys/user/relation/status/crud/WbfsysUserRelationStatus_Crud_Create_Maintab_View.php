 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelationStatus_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserRelationStatus Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new user relation Status',
      'wbfsys.user_relation_status.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New user relation Status',
      'wbfsys.user_relation_status.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_relation_status-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_relation_status/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserRelationStatus.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_relation_status';
    ...
    $form = $this->newForm( 'WbfsysUserRelationStatus_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserRelationStatus.create');}});
});
...
}//end class WbfsysUserRelationStatus_Crud_Create_Maintab_View
