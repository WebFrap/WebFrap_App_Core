 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_user_relation';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserRelation_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserRelation.show&amp;target_mask=WbfsysUserRelation&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserRelation.edit&amp;target_mask=WbfsysUserRelation&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_relation.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserRelation.delete&amp;target_mask=WbfsysUserRelation&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_relation.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.user_relation.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_relation_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.UserRelationStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_relation_status_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserRelation_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected User Relations." >{$iconDelete} Delete selected User Relations</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! User Relations. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.UserRelation_Multi.deleteAll" >{$iconClean} Delete all User Relations</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserRelation_Table_Element
