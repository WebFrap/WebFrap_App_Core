 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für User Relations
  *
  ...
  *  }
  *
  * @return WbfsysUserRelation_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserRelation_Table_Element( 'tableWbfsysUserRelation', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_relation-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Relations', 'wbfsys.user_relation.label' );
      //$tabPanel->searchKey = 'wbfsys_user_relation';
      ...
      $searchElement->searchKey = 'wbfsys_user_relation';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserRelation_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserRelation', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserRelation listing maske
   *
   * @param WbfsysUserRelation_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserRelation  = $model->getEntityWbfsysUserRelation();
    ...
    $formWbfsysUserRelation->setKeyName( 'wbfsys_user_relation' );
...
}//end class WbfsysUserRelation_Table_Ui
