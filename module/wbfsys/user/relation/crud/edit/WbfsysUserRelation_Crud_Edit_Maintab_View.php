 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserRelation Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserRelation = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit User Relation: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserRelation.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserRelation
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserRelation.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_relation-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_relation/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserRelation_Crud_Edit' );
...
}//end class WbfsysUserRelation_Crud_Edit_Maintab_View
