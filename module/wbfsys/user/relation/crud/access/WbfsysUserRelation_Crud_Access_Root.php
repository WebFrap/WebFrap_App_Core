 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserRelation_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserRelation_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserRelation_Entity */
      $entity = $orm->get( 'WbfsysUserRelation', $rootId );
    }
...
}//end class WbfsysUserRelation_Crud_Access_Root
