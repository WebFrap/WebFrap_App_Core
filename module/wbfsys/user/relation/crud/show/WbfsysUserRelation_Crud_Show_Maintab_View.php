 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUserRelation Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserRelation = $this->model->getEntityWbfsysUserRelation();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show User Relation: {@text@}',
      'wbfsys.user_relation.label',
      array( 'text' => $entityWbfsysUserRelation->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserRelation.show  &amp;objid='.$entityWbfsysUserRelation
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserRelation.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_relation-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_relation/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUserRelation_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.UserRelation.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_relation' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_relation a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.UserRelation.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.UserRelation.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUserRelation_Crud_Show_Maintab_View
