 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserRelation entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserRelation.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserRelation.insert';
    $params->formId       = 'wgt-form-wbfsys_user_relation';
    $params->namespace   = 'wbfsys_user_relation-create';
    ...
    $this->setTemplate( 'wbfsys/user_relation/modal/crud/form_create' );
...
}//end class WbfsysUserRelation_Crud_Create_Modal_View
