 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysUserRelation_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_user_relation.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_user_relation.rowid ",
      'acls'
    );
...
}//end class WbfsysUserRelation_Selection_Access
