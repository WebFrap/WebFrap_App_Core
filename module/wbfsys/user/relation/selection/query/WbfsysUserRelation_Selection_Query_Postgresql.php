 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Selection_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
 ...
 /**
  ...
  public function checkConditions( $criteria, array $condition )
  {
    	...
    	if( isset($condition['ids']) && !empty( $condition['ids'] ) )
    	{
				$criteria->where
        (
          'wbfsys_user_relation.rowid = IN( '. implode( ', ', $condition['ids'] ) .' ) ';
        );
    	}
...
}//end class WbfsysUserRelation_Selection_Query_Postgresql
