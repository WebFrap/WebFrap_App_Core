 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserRelation_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserRelation_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_relation/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Relation', 'wbfsys.user_relation.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserRelation.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_relation-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserRelation_Selection' );
...
}//end class WbfsysUserRelation_Selection_Modal_View
