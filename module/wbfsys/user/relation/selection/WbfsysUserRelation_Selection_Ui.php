 ...
 * @licence WebFrap.net
 */
class WbfsysUserRelation_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserRelation_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserRelation_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserRelation_Selection_Element
    (
      'selectionWbfsysUserRelation',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Relations', 'wbfsys.user_relation.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserRelation.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserRelation',
      'WbfsysUserRelation_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserRelation_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserRelation_Selection_Ui
