 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysUserSetting_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysUserSetting_Export_Listing_Access';
    ...
    // create a new WbfsysUserSetting window
    $view = $this->loadView
    (
    	'export-wbfsys_user_setting',
    	'WbfsysUserSetting_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysUserSetting_Export' );
...
} // end class WbfsysUserSetting_Export_Controller_Genf
