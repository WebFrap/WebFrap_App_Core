 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserSetting_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserSetting_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSetting_Selection_Element
    (
      'selectionWbfsysUserSetting',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Settings', 'wbfsys.user_setting.label' ) ;
      $tabPanel->searchKey = 'wbfsys_user_setting';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserSetting.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserSetting',
      'WbfsysUserSetting_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserSetting' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysUserSetting listing maske
   *
   * @param WbfsysUserSetting_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserSetting  = $model->getEntityWbfsysUserSetting();
    ...
    $formWbfsysUserSetting->setKeyName( 'wbfsys_user_setting' );
...
}//end class WbfsysUserSetting_Selection_Ui
