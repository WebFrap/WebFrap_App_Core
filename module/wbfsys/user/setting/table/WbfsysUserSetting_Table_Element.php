 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_user_setting';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserSetting_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserSetting.show&amp;target_mask=WbfsysUserSetting&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserSetting.edit&amp;target_mask=WbfsysUserSetting&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_setting.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserSetting.delete&amp;target_mask=WbfsysUserSetting&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_setting.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_user_setting&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.user_setting.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_setting_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserSetting_Multi.deleteSelection"
      ...
      <li><a 
      	...
      	href="ajax.php?c=Wbfsys.UserSetting_Multi.deleteAll" >{$iconClean} Delete all User Settings</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserSetting_Table_Element
