 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *  }
  *
  * @return WbfsysUserSetting_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSetting_Table_Element( 'tableWbfsysUserSetting', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Settings', 'wbfsys.user_setting.label' );
      ...
      $searchElement->searchKey = 'wbfsys_user_setting';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserSetting_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param WbfsysUserSetting_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserSetting_Table_Ui
