 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUserSetting Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserSetting = $this->model->getEntityWbfsysUserSetting();
    ...
    (
      ...
      array( 'text' => $entityWbfsysUserSetting->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserSetting.show  &amp;objid='.$entityWbfsysUserSetting
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserSetting.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_setting-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_setting/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUserSetting_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.UserSetting.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_setting' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_setting a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.UserSetting.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.UserSetting.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUserSetting_Crud_Show_Maintab_View
