 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserSetting Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserSetting = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserSetting.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserSetting
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserSetting.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_setting-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_setting/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserSetting_Crud_Edit' );
...
}//end class WbfsysUserSetting_Crud_Edit_Maintab_View
