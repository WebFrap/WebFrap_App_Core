 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserSetting_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserSetting_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserSetting_Entity */
      $entity = $orm->get( 'WbfsysUserSetting', $rootId );
    }
...
}//end class WbfsysUserSetting_Crud_Access_Root
