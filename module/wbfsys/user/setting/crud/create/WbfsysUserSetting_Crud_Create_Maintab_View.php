 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserSetting Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_setting-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_setting/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSetting.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_setting';
    ...
    $form = $this->newForm( 'WbfsysUserSetting_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserSetting.create');}});
});
...
}//end class WbfsysUserSetting_Crud_Create_Maintab_View
