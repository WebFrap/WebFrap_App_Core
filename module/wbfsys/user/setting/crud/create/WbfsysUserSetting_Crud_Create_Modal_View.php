 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserSetting entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserSetting.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSetting.insert';
    $params->formId       = 'wgt-form-wbfsys_user_setting';
    $params->namespace   = 'wbfsys_user_setting-create';
    ...
    $this->setTemplate( 'wbfsys/user_setting/modal/crud/form_create' );
...
}//end class WbfsysUserSetting_Crud_Create_Modal_View
