 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysUserSetting', array_keys( $this->fields['wbfsys_user_setting']), true ),
...
}//end class WbfsysUserSetting_Crud_Create_Form */
