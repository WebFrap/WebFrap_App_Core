...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_setting';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserSetting';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserSetting' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserSetting entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_user( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for User (User Setting)', 'wbfsys.user_setting.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.user_setting.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysThemeIcon_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Theme Icon (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Theme Icon', 'wbfsys.user_setting.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysThemeLayout_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Theme Layout (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Theme Layout', 'wbfsys.user_setting.label' ),
  ...
  * @return void
  */
  public function input_id_language( $params )
  {
    if( !Webfrap::classLoadable( 'CoreLanguage_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdLanguage = $this->view->newItem( 'input'.$this->prefix.'IdLanguage' , 'CoreLanguage_Selectbox' );
      $this->items['id_language'] = $inputIdLanguage;
      $inputIdLanguage->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[id_language]',
          'id'        => 'wgt-input-'.$this->keyName.'_id_language'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Language (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      $inputIdLanguage->setReadOnly( $this->isReadOnly( 'id_language' ) );
      $inputIdLanguage->setLabel
      (
        $this->view->i18n->l( 'Language', 'wbfsys.user_setting.label' ),
        $this->entity->required( 'id_language' )
      );
  ...
  }//end public function input_id_language */
  ...
  * @return void
  */
  public function input_smtp( $params )
  {

      //tpl: class ui:Checkbox
      $inputSmtp = $this->view->newInput( 'input'.$this->prefix.'Smtp' , 'Checkbox' );
      $this->items['smtp'] = $inputSmtp;
      $inputSmtp->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[smtp]',
          'id'        => 'wgt-input-'.$this->keyName.'_smtp'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Smtp (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      $inputSmtp->setWidth( 'medium' );

      $inputSmtp->setReadOnly( $this->isReadOnly( 'smtp' ) );
      $inputSmtp->setActive( $this->entity->getBoolean( 'smtp' ) );
      $inputSmtp->setLabel
      (
        $this->view->i18n->l( 'Smtp', 'wbfsys.user_setting.label' ),
        $this->entity->required( 'smtp' )
      );
  ...
  }//end public function input_smtp */
  ...
  * @return void
  */
  public function input_pop3( $params )
  {

      //tpl: class ui:Checkbox
      $inputPop3 = $this->view->newInput( 'input'.$this->prefix.'Pop3' , 'Checkbox' );
      $this->items['pop3'] = $inputPop3;
      $inputPop3->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[pop3]',
          'id'        => 'wgt-input-'.$this->keyName.'_pop3'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Pop3 (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      $inputPop3->setWidth( 'medium' );

      $inputPop3->setReadOnly( $this->isReadOnly( 'pop3' ) );
      $inputPop3->setActive( $this->entity->getBoolean( 'pop3' ) );
      $inputPop3->setLabel
      (
        $this->view->i18n->l( 'Pop3', 'wbfsys.user_setting.label' ),
        $this->entity->required( 'pop3' )
      );
  ...
  }//end public function input_pop3 */
  ...
  * @return void
  */
  public function input_imap( $params )
  {

      //tpl: class ui:Checkbox
      $inputImap = $this->view->newInput( 'input'.$this->prefix.'Imap' , 'Checkbox' );
      $this->items['imap'] = $inputImap;
      $inputImap->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[imap]',
          'id'        => 'wgt-input-'.$this->keyName.'_imap'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Imap (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      $inputImap->setWidth( 'medium' );

      $inputImap->setReadOnly( $this->isReadOnly( 'imap' ) );
      $inputImap->setActive( $this->entity->getBoolean( 'imap' ) );
      $inputImap->setLabel
      (
        $this->view->i18n->l( 'Imap', 'wbfsys.user_setting.label' ),
        $this->entity->required( 'imap' )
      );
  ...
  }//end public function input_imap */
  ...
  * @return void
  */
  public function input_sieve( $params )
  {

      //tpl: class ui:Checkbox
      $inputSieve = $this->view->newInput( 'input'.$this->prefix.'Sieve' , 'Checkbox' );
      $this->items['sieve'] = $inputSieve;
      $inputSieve->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[sieve]',
          'id'        => 'wgt-input-'.$this->keyName.'_sieve'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Sieve (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      $inputSieve->setWidth( 'medium' );

      $inputSieve->setReadOnly( $this->isReadOnly( 'sieve' ) );
      $inputSieve->setActive( $this->entity->getBoolean( 'sieve' ) );
      $inputSieve->setLabel
      (
        $this->view->i18n->l( 'Sieve', 'wbfsys.user_setting.label' ),
        $this->entity->required( 'sieve' )
      );
  ...
  }//end public function input_sieve */
/// windowref to nonexisting wbfsys_mailmanagement_maillocation in LibGenfTreeRootEntity/// windowref to nonexisting wbfsys_mailmanagement_transport in LibGenfTreeRootEntity
 /**
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_setting.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Setting)', 'wbfsys.user_setting.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_setting.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Setting)', 'wbfsys.user_setting.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_setting.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Setting)', 'wbfsys.user_setting.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_setting.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Setting)', 'wbfsys.user_setting.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_setting.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_setting.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Setting)', 'wbfsys.user_setting.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_setting.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_m_role_change';
...
}//end class WbfsysUserSetting_Form */
