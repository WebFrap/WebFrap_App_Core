 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_user_setting') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_user_setting.{$fieldName}
...
}//end class WbfsysUserSetting_Filter
