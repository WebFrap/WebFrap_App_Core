 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_setting_value';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserSettingValue';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserSettingValue' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserSettingValue entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_user( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for User (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ));
      ...
      $inputIdUser->setLabel( $this->view->i18n->l( 'User', 'wbfsys.user_setting_value.label' ) );
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysUserSettingType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysUserSettingType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (User Setting Value)', 'wbfsys.user_setting_value.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.user_setting_value.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_user_setting_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.UserSettingType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
  ...
  */
  public function input_value( $params )
  {
      ...
      //tpl: class ui:text
      $inputValue = $this->view->newInput( 'input'.$this->prefix.'Value' , 'Text' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Value (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ...
      $inputValue->setLabel
      (
        $this->view->i18n->l( 'Value', 'wbfsys.user_setting_value.label' ),
  ...
  * @return void
  */
  public function input_values( $params )
  {

      //tpl: class ui:text
      $inputValues = $this->view->newInput( 'input'.$this->prefix.'Values' , 'Text' );
      $this->items['values'] = $inputValues;
      $inputValues->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[values]',
          'id'        => 'wgt-input-'.$this->keyName.'_values'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Values (User Setting Value)', 'wbfsys.user_setting_value.label' ),
          'maxlength' => $this->entity->maxSize( 'values' ),
        )
      );
      $inputValues->setWidth( 'medium' );

      $inputValues->setReadOnly( $this->isReadOnly( 'values' ) );
      $inputValues->setData( $this->entity->getSecure('values') );
      $inputValues->setLabel
      (
        $this->view->i18n->l( 'Values', 'wbfsys.user_setting_value.label' ),
        $this->entity->required( 'values' )
      );
  ...
  }//end public function input_values */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Setting Value)', 'wbfsys.user_setting_value.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_setting_value.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_setting_value.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_setting_value.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_setting_value.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Setting Value)', 'wbfsys.user_setting_value.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_setting_value.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Setting Value)', 'wbfsys.user_setting_value.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_setting_value.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Setting Value)', 'wbfsys.user_setting_value.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_setting_value.label' ),
...
////////////////////////////////////////////////////////////////////////////////
    ...
    if( !Webfrap::classLoadable( 'WbfsysUserSettingType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Type (User Setting Value)', 'wbfsys.user_setting_value.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_value_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_value_m_role_change';
...
}//end class WbfsysUserSettingValue_Form */
