 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_user_setting_value
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.UserSettingValue.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_user_setting_value-create';

    $access = new WbfsysUserSettingValue_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_user_setting_value-create',
      'WbfsysUserSettingValue_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysUserSettingValue_Crud_Model */
    $model = $this->loadModel( 'WbfsysUserSettingValue_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.UserSettingValue.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysUserSettingValue = $model->getEntityWbfsysUserSettingValue( $objid );
    ...
    if( !$entityWbfsysUserSettingValue )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'User Setting', 'wbfsys.user_setting_value.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysUserSettingValue;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_user_setting_value:edit';

    $access = new WbfsysUserSettingValue_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingValue );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_user_setting_value-edit-'.$objid,
      'WbfsysUserSettingValue_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_user_setting_value-edit',
          $entityWbfsysUserSettingValue,
          'Edit User Setting :'.$entityWbfsysUserSettingValue->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_user_setting_value';
      $params->maskRoot      = 'wbfsys_user_setting_value:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_user_setting_value';
      $params->aclNode       = 'mgmt-wbfsys_user_setting_value';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_user_setting_value-edit-'.$objid,
      'WbfsysUserSettingValue_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_user_setting_value-show',
          $entityWbfsysUserSettingValue,
          'Show User Setting :'.$entityWbfsysUserSettingValue->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_user_setting_value
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.UserSettingValue.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-insert';

    $access = new WbfsysUserSettingValue_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysUserSettingValue = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_user_setting_value-update-'.$entityWbfsysUserSettingValue;
      ...
      {
        $access = new WbfsysUserSettingValue_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingValue );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysUserSettingValue';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_user_setting_value',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysUserSettingValue_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.UserSettingValue.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysUserSettingValue, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysUserSettingValue_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.UserSettingValue.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-delete-'.$objid;

    $access = new WbfsysUserSettingValue_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingValue );
    ...
    $error = $model->delete( $entityWbfsysUserSettingValue, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysUserSettingValue, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.UserSettingValue.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.UserSettingValue.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-listing';
    ...
    $containerClass = 'WbfsysUserSettingValue_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_user_setting_value',
      'WbfsysUserSettingValue_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysUserSettingValue_Table_Model */
    $model = $this->loadModel( 'WbfsysUserSettingValue_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_user_setting_value-'.$params->ltype,
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysUserSettingValue
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysUserSettingValue_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_user_setting_value',
      'WbfsysUserSettingValue_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysUserSettingValue_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.UserSettingValue.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingValue_Selection_Model */
    $model   = $this->loadModel( 'WbfsysUserSettingValue_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_user_setting_value-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_user_setting_value-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_user_setting_value',
      'WbfsysUserSettingValue',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysUserSettingValue, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysUserSettingValue_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysUserSettingValue_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_value-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_user_setting_value' );
...
} // end class WbfsysUserSettingValue_Controller */
