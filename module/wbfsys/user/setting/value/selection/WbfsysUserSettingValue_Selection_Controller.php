 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysUserSettingValue_Selection' ) );
...
} // end class WbfsysUserSettingValue_Selection_Controller */
