 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysUserSettingValue_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysUserSettingValue_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysUserSettingValue_Selection_Model
