 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserSettingValue_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysUserSettingValue_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_user_setting_value
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserSettingValue.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_user_setting_value-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysUserSettingValue_Selection' );
...
}//end class WbfsysUserSettingValue_Selection_Modal_View
