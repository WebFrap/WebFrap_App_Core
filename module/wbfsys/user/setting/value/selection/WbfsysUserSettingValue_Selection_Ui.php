 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserSettingValue_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserSettingValue_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingValue_Selection_Element
    (
      'selectionWbfsysUserSettingValue',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection User Settings', 'wbfsys.user_setting_value.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserSettingValue.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserSettingValue',
      'WbfsysUserSettingValue_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserSettingValue_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserSettingValue_Selection_Ui
