  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.UserSettingValue_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.user_setting_value.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.UserSettingType.listing" >'.Validator::sanitizeHtml($row['wbfsys_user_setting_type_name']).'</a></td>'.NL;
