 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_user_setting_value';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserSettingValue_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserSettingValue.show&amp;target_mask=WbfsysUserSettingValue&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserSettingValue.edit&amp;target_mask=WbfsysUserSettingValue&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_setting_value.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserSettingValue.delete&amp;target_mask=WbfsysUserSettingValue&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_setting_value.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_user_setting_value&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.user_setting_value.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.user_setting_value.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_setting_value_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.UserSettingType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_setting_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserSettingValue_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected User Settings." >{$iconDelete} Delete selected User Settings</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! User Settings. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.UserSettingValue_Multi.deleteAll" >{$iconClean} Delete all User Settings</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserSettingValue_Table_Element
