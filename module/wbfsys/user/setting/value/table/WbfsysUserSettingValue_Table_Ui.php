 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für User Settings
  *
  ...
  *  }
  *
  * @return WbfsysUserSettingValue_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingValue_Table_Element( 'tableWbfsysUserSettingValue', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_setting_value-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'User Settings', 'wbfsys.user_setting_value.label' );
      //$tabPanel->searchKey = 'wbfsys_user_setting_value';
      ...
      $searchElement->searchKey = 'wbfsys_user_setting_value';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserSettingValue_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserSettingValue', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserSettingValue listing maske
   *
   * @param WbfsysUserSettingValue_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserSettingValue  = $model->getEntityWbfsysUserSettingValue();
    ...
    $formWbfsysUserSettingValue->setKeyName( 'wbfsys_user_setting_value' );
...
}//end class WbfsysUserSettingValue_Table_Ui
