 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserSettingValue Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserSettingValue = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit User Setting: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserSettingValue.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserSettingValue
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserSettingValue.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_setting_value-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserSettingValue_Crud_Edit' );
...
}//end class WbfsysUserSettingValue_Crud_Edit_Maintab_View
