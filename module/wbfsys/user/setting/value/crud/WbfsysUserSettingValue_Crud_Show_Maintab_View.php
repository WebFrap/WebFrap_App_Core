 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysUserSettingValue_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysUserSettingValue Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserSettingValue = $this->model->getEntityWbfsysUserSettingValue();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show User Setting: {@text@}',
      'wbfsys.user_setting_value.label',
      array( 'text' => $entityWbfsysUserSettingValue->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserSettingValue.show  &amp;objid='.$entityWbfsysUserSettingValue
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserSettingValue.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_setting_value-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysUserSettingValue_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.UserSettingValue.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_setting_value' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_user_setting_value a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.UserSettingValue.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.UserSettingValue.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysUserSettingValue_Crud_Show_Maintab_View
