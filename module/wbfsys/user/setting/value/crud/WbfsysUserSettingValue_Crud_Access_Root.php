 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserSettingValue_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserSettingValue_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserSettingValue_Entity */
      $entity = $orm->get( 'WbfsysUserSettingValue', $rootId );
    }
...
}//end class WbfsysUserSettingValue_Crud_Access_Root
