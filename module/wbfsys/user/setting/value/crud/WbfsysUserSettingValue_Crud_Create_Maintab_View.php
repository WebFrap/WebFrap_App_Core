 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserSettingValue Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_setting_value-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_setting_value/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSettingValue.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_setting_value';
    ...
    $form = $this->newForm( 'WbfsysUserSettingValue_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserSettingValue.create');}});
});
...
}//end class WbfsysUserSettingValue_Crud_Create_Maintab_View
