 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysUserSettingValue', array_keys( $this->fields['wbfsys_user_setting_value']), true ),
...
}//end class WbfsysUserSettingValue_Crud_Create_Form */
