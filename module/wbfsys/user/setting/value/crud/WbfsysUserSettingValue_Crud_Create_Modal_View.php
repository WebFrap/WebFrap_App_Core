 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserSettingValue entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserSettingValue.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSettingValue.insert';
    $params->formId       = 'wgt-form-wbfsys_user_setting_value';
    $params->namespace   = 'wbfsys_user_setting_value-create';
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/modal/crud/form_create' );
...
}//end class WbfsysUserSettingValue_Crud_Create_Modal_View
