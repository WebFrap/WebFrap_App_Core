 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_user_setting_value.rowid as "wbfsys_user_setting_value_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_user_setting_value on wbfsys_group_users.vid = wbfsys_user_setting_value.rowid'
    );
...
} // end class WbfsysUserSettingValue_Acl_Qfdu_Treetable_Query_Postgresql */
