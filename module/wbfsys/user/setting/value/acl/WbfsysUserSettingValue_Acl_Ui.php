 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysUserSettingValue_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingValue_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_user_setting_value-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'User Setting', 'wbfsys.user_setting_value.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_user_setting_value_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysUserSettingValue_Acl_Table'
    );
...
} // end class WbfsysUserSettingValue_Acl_Ui */
