 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingValue_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysUserSettingValue_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysUserSettingValue = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSettingValue_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_user_setting_value-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysUserSettingValue, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_value-acl-dset', 
    	'WbfsysUserSettingValue_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSettingValue_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_value-acl-dset', 
    	'WbfsysUserSettingValue_Acl_Dset',
...
} // end class WbfsysUserSettingValue_Acl_Dset_Controller */
