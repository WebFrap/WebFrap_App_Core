 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysUserSettingValue
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysUserSettingValue_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_user_setting_value_acl_listing',
      'WbfsysUserSettingValue_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysUserSettingValue_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingValue_Acl_Model */
    $model   = $this->loadModel( 'WbfsysUserSettingValue_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting_value-acl',
    	'WbfsysUserSettingValue_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_user_setting_value_acl_masks_listing',
      'WbfsysUserSettingValue_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysUserSettingValue_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysUserSettingValue_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingValue_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysUserSettingValue_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysUserSettingValue_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysUserSettingValue_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting_value-acl-qfdu',
    	'WbfsysUserSettingValue_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysUserSettingValue_Acl_Controller */
