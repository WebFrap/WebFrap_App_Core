 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysUserSettingValue_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysUserSettingValue_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysUserSettingValue, $areaId, $access, $params  )
  {

    $listObj = new WbfsysUserSettingValue_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_user_setting_value-acl-dset' );
    ...
    else
    {
      ...
      (
        ...
        array
        (
          'label' => $entityWbfsysUserSettingValue->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_user_setting_value_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysUserSettingValue_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysUserSettingValue_Acl_Dset_Ui */
