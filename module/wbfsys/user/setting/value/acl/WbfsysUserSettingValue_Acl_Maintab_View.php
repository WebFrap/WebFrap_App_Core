 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysUserSettingValue_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserSettingValue_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_setting_value-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.UserSettingValue_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_user_setting_value-acl-update';
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Setting', 'wbfsys.user_setting_value.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_setting_value_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysUserSettingValue_Acl' );
...
} // end class WbfsysUserSettingValue_Acl_Maintab_View */
