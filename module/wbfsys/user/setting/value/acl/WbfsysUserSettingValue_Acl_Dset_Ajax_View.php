 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysUserSettingValue_Acl_Dset' );
    ...
    $entityWbfsysUserSettingValue = $this->model->getEntity( $dsetId );
...
} // end class WbfsysUserSettingValue_Acl_Dset_Ajax_View */
