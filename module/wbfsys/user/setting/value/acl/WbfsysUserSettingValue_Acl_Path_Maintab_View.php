 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_setting_value/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_setting_value-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_user_setting_value-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysUserSettingValue_Acl_Path_Maintab_View */
