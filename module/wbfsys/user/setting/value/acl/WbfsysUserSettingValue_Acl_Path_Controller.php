 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_user_setting_value_acl_graph', 
      'WbfsysUserSettingValue_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysUserSettingValue_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysUserSettingValue_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysUserSettingValue_Acl_Path_Maintab_View  */
...
} // end class WbfsysUserSettingValue_Acl_Path_Controller */
