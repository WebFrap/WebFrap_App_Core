 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_user_setting_value.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysUserSettingValue_Acl_Dset_Treetable_Query_Postgresql */
