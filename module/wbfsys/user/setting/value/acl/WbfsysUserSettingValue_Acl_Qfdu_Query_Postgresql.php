 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_user_setting_value.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_user_setting_value.rowid as id,
    wbfsys_user_setting_value.rowid as value,
    wbfsys_user_setting_value.rowid as label
  FROM
...
} // end class WbfsysUserSettingValue_Acl_Qfdu_Query_Postgresql */
