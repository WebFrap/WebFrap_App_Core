 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_user_setting_value'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysUserSettingValue', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingValue_Acl_Dset' );
    /* @var $query WbfsysUserSettingValue_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingValue_Acl_Dset_Treetable' );
    /* @var $query WbfsysUserSettingValue_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysUserSettingValue_Acl_Dset_Model */
