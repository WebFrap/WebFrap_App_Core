 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysUserSettingValue_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_value-acl-qfdu-aAjax',
      'WbfsysUserSettingValue_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysUserSettingValue_Acl_Qfdu_Controller */
