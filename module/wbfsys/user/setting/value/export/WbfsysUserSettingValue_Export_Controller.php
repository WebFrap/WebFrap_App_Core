 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingValue_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysUserSettingValue_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysUserSettingValue_Export_Listing_Access';
    ...
    // create a new WbfsysUserSettingValue window
    $view = $this->loadView
    (
    	'export-wbfsys_user_setting_value',
    	'WbfsysUserSettingValue_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysUserSettingValue_Export' );
...
} // end class WbfsysUserSettingValue_Export_Controller_Genf
