 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/user_setting_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'user setting value types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_setting_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_user_setting_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysUserSettingType_Acl_Path_Maintab_View */
