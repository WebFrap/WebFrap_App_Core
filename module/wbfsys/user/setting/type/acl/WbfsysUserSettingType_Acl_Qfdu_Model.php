 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_user_setting_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysUserSettingType = $orm->get('WbfsysUserSettingType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_user_setting_type_name']  = $refEntityWbfsysUserSettingType->name;

    }
    $tabData['wbfsys_user_setting_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysUserSettingType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingType_Acl' );
    /* @var $query WbfsysUserSettingType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysUserSettingType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingType_Acl_Qfdu' );
    /* @var $query WbfsysUserSettingType_Acl_Qfdu_Query  */
...
} // end class WbfsysUserSettingType_Acl_Qfdu_Model */
