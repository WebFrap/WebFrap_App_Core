 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_user_setting_type_acl_graph', 
      'WbfsysUserSettingType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysUserSettingType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysUserSettingType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysUserSettingType_Acl_Path_Maintab_View  */
...
} // end class WbfsysUserSettingType_Acl_Path_Controller */
