 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_user_setting_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysUserSettingType_Acl_Dset_Treetable_Query_Postgresql */
