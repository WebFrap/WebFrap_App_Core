 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysUserSettingType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_type-acl-qfdu-aAjax',
      'WbfsysUserSettingType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysUserSettingType_Acl_Qfdu_Controller */
