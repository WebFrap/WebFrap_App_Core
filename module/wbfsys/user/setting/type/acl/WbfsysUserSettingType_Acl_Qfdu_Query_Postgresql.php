 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_user_setting_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_user_setting_type.rowid as id,
    wbfsys_user_setting_type.name as value,
    wbfsys_user_setting_type.name as label
  FROM
...
} // end class WbfsysUserSettingType_Acl_Qfdu_Query_Postgresql */
