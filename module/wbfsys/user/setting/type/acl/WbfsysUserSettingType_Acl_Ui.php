 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysUserSettingType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL user setting value type', 
        'wbfsys.user_setting_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_user_setting_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'user setting value type', 'wbfsys.user_setting_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_user_setting_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysUserSettingType_Acl_Table'
    );
...
} // end class WbfsysUserSettingType_Acl_Ui */
