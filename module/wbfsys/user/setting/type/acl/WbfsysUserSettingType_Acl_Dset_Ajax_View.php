 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysUserSettingType_Acl_Dset' );
    ...
    $entityWbfsysUserSettingType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysUserSettingType_Acl_Dset_Ajax_View */
