 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysUserSettingType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysUserSettingType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSettingType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_user_setting_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysUserSettingType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_type-acl-dset', 
    	'WbfsysUserSettingType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSettingType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting_type-acl-dset', 
    	'WbfsysUserSettingType_Acl_Dset',
...
} // end class WbfsysUserSettingType_Acl_Dset_Controller */
