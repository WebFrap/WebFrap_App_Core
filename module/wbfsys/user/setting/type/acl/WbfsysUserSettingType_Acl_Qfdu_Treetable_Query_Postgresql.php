 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_user_setting_type.name as "wbfsys_user_setting_type_name"',
      'wbfsys_user_setting_type.rowid as "wbfsys_user_setting_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_user_setting_type on wbfsys_group_users.vid = wbfsys_user_setting_type.rowid'
    );
...
} // end class WbfsysUserSettingType_Acl_Qfdu_Treetable_Query_Postgresql */
