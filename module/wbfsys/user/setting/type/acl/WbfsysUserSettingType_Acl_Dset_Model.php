 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_user_setting_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysUserSettingType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingType_Acl_Dset' );
    /* @var $query WbfsysUserSettingType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSettingType_Acl_Dset_Treetable' );
    /* @var $query WbfsysUserSettingType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysUserSettingType_Acl_Dset_Model */
