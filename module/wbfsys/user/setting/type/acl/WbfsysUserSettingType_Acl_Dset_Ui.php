 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysUserSettingType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysUserSettingType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysUserSettingType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysUserSettingType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_user_setting_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'user setting value type "{@label@}" User Access',
        'wbfsys.user_setting_type.label',
        array
        (
          'label' => $entityWbfsysUserSettingType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_user_setting_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysUserSettingType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysUserSettingType_Acl_Dset_Ui */
