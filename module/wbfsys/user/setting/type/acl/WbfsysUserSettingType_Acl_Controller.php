 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysUserSettingType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysUserSettingType_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_user_setting_type_acl_listing',
      'WbfsysUserSettingType_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysUserSettingType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysUserSettingType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting_type-acl',
    	'WbfsysUserSettingType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_user_setting_type_acl_masks_listing',
      'WbfsysUserSettingType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysUserSettingType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysUserSettingType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysUserSettingType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysUserSettingType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysUserSettingType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting_type-acl-qfdu',
    	'WbfsysUserSettingType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysUserSettingType_Acl_Controller */
