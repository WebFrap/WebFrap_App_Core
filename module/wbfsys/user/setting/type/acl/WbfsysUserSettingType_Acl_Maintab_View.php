 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysUserSettingType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserSettingType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_setting_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.UserSettingType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_user_setting_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/user_setting_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'user setting value type', 'wbfsys.user_setting_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_setting_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysUserSettingType_Acl' );
...
} // end class WbfsysUserSettingType_Acl_Maintab_View */
