 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysUserSettingType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_user_setting_type.rowid as id',
      'wbfsys_user_setting_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_user_setting_type.m_order as "wbfsys_user_setting_type-m_order-order"' );

    $criteria->from( 'wbfsys_user_setting_type' );



      $criteria->orderBy( 'wbfsys_user_setting_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_user_setting_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_user_setting_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysUserSettingType_Selectbox_Query_Postgresql
