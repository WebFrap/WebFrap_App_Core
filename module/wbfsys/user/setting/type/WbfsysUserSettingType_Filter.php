 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_user_setting_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_user_setting_type.{$fieldName}
...
}//end class WbfsysUserSettingType_Filter
