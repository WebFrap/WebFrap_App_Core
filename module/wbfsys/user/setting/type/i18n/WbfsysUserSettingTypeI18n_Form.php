 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_user_setting_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysUserSettingTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysUserSettingTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysUserSettingTypeI18n';
   ...
   *
   * @var WbfsysUserSettingTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysUserSettingTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysUserSettingTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysUserSettingTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.user_setting_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_user_setting_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_user_setting_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysUserSettingType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysUserSettingType not exists' );

      Log::warn('Looks like the Entity: WbfsysUserSettingType is missing');
      ...
      //p: Window
      $objidWbfsysUserSettingType = $this->entity->getData('id_wbfsys_user_setting_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysUserSettingType
          || !$entityWbfsysUserSettingType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysUserSettingType = $this->db->orm->newEntity( 'WbfsysUserSettingType' );
      }

      $inputIdWbfsysUserSettingType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysUserSettingType', 'Window' );
      $inputIdWbfsysUserSettingType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_user_setting_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_user_setting_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys User Setting Type (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysUserSettingType->assignedForm = $this->assignedForm;

      $inputIdWbfsysUserSettingType->setWidth( 'medium' );

      $inputIdWbfsysUserSettingType->setData( $this->entity->getData( 'id_wbfsys_user_setting_type' )  );
      $inputIdWbfsysUserSettingType->setReadOnly( $this->isReadOnly( 'id_wbfsys_user_setting_type' ) );
      $inputIdWbfsysUserSettingType->setLabel( $this->view->i18n->l( 'Wbfsys User Setting Type', 'wbfsys.user_setting_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.UserSettingType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_user_setting_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysUserSettingType->setListUrl ( $listUrl );
      $inputIdWbfsysUserSettingType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysUserSettingType->setEntityUrl( 'maintab.php?c=Wbfsys.UserSettingType.edit' );
      $inputIdWbfsysUserSettingType->conEntity         = $entityWbfsysUserSettingType;
      $inputIdWbfsysUserSettingType->refresh           = $this->refresh;
      $inputIdWbfsysUserSettingType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysUserSettingType->view = $this->view;
      $inputIdWbfsysUserSettingType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_user_setting_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysUserSettingType );
  ...
  }//end public function input_id_wbfsys_user_setting_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.user_setting_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.user_setting_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.user_setting_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.user_setting_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.user_setting_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.user_setting_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.user_setting_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.user_setting_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.user_setting_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (User Setting Type I18n)', 'wbfsys.user_setting_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_user_setting_type_i18n_m_role_change';
...
}//end class WbfsysUserSettingTypeI18n_Form */
