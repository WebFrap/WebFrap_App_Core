 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysUserSettingType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysUserSettingType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingType_Selection_Element
    (
      'selectionWbfsysUserSettingType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection user setting value types', 'wbfsys.user_setting_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.UserSettingType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysUserSettingType',
      'WbfsysUserSettingType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysUserSettingType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysUserSettingType_Selection_Ui
