 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_user_setting_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysUserSettingType_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.UserSettingType.show&amp;target_mask=WbfsysUserSettingType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.UserSettingType.edit&amp;target_mask=WbfsysUserSettingType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.user_setting_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.UserSettingType.delete&amp;target_mask=WbfsysUserSettingType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.user_setting_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_user_setting_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.user_setting_type.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.UserSettingType.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.user_setting_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.user_setting_type.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_user_setting_type_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_user_setting_type_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_user_setting_type_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.UserSettingType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected user setting value types." >{$iconDelete} Delete selected user setting value types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! user setting value types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.UserSettingType_Multi.deleteAll" >{$iconClean} Delete all user setting value types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysUserSettingType_Selection_Element
