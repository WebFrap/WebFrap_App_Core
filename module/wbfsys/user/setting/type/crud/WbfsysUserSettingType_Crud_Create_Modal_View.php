 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysUserSettingType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.UserSettingType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSettingType.insert';
    $params->formId       = 'wgt-form-wbfsys_user_setting_type';
    $params->namespace   = 'wbfsys_user_setting_type-create';
    ...
    $this->setTemplate( 'wbfsys/user_setting_type/modal/crud/form_create' );
...
}//end class WbfsysUserSettingType_Crud_Create_Modal_View
