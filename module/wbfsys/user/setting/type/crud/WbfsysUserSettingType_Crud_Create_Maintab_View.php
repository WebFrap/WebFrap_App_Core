 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysUserSettingType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new user setting value type',
      'wbfsys.user_setting_type.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New user setting value type',
      'wbfsys.user_setting_type.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_user_setting_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/user_setting_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.UserSettingType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_user_setting_type';
    ...
    $form = $this->newForm( 'WbfsysUserSettingType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.UserSettingType.create');}});
});
...
}//end class WbfsysUserSettingType_Crud_Create_Maintab_View
