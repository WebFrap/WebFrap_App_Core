 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysUserSettingType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysUserSettingType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit user setting value type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.UserSettingType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysUserSettingType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.UserSettingType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_user_setting_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/user_setting_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysUserSettingType_Crud_Edit' );
...
}//end class WbfsysUserSettingType_Crud_Edit_Maintab_View
