 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysUserSettingType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysUserSettingType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysUserSettingType_Entity */
      $entity = $orm->get( 'WbfsysUserSettingType', $rootId );
    }
...
}//end class WbfsysUserSettingType_Crud_Access_Root
