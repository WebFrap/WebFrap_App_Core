 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_user_setting_type
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.UserSettingType.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_user_setting_type-create';

    $access = new WbfsysUserSettingType_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_user_setting_type-create',
      'WbfsysUserSettingType_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysUserSettingType_Crud_Model */
    $model = $this->loadModel( 'WbfsysUserSettingType_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.UserSettingType.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysUserSettingType = $model->getEntityWbfsysUserSettingType( $objid );
    ...
    $params->entity = $entityWbfsysUserSettingType;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_user_setting_type:edit';

    $access = new WbfsysUserSettingType_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingType );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_user_setting_type-edit-'.$objid,
      'WbfsysUserSettingType_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_user_setting_type-edit',
          $entityWbfsysUserSettingType,
          'Edit user setting value type :'.$entityWbfsysUserSettingType->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_user_setting_type';
      $params->maskRoot      = 'wbfsys_user_setting_type:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_user_setting_type';
      $params->aclNode       = 'mgmt-wbfsys_user_setting_type';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_user_setting_type-edit-'.$objid,
      'WbfsysUserSettingType_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_user_setting_type-show',
          $entityWbfsysUserSettingType,
          'Show user setting value type :'.$entityWbfsysUserSettingType->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_user_setting_type
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.UserSettingType.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-insert';

    $access = new WbfsysUserSettingType_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysUserSettingType = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_user_setting_type-update-'.$entityWbfsysUserSettingType;
      ...
      {
        $access = new WbfsysUserSettingType_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingType );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysUserSettingType';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_user_setting_type',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysUserSettingType_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.UserSettingType.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysUserSettingType, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysUserSettingType_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.UserSettingType.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-delete-'.$objid;

    $access = new WbfsysUserSettingType_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysUserSettingType );
    ...
    $error = $model->delete( $entityWbfsysUserSettingType, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysUserSettingType, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.UserSettingType.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.UserSettingType.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-listing';
    ...
    $containerClass = 'WbfsysUserSettingType_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_user_setting_type',
      'WbfsysUserSettingType_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysUserSettingType_Table_Model */
    $model = $this->loadModel( 'WbfsysUserSettingType_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_user_setting_type-'.$params->ltype,
          'WbfsysUserSettingType',
          'List of user setting value types'
        );
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSettingType_Selection_Model */
    $model   = $this->loadModel( 'WbfsysUserSettingType_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_user_setting_type-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_user_setting_type-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_user_setting_type',
      'WbfsysUserSettingType',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysUserSettingType, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysUserSettingType_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysUserSettingType_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_user_setting_type-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_user_setting_type' );
...
} // end class WbfsysUserSettingType_Controller */
