 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysUserSettingType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysUserSettingType_Export_Listing_Access';
    ...
    // create a new WbfsysUserSettingType window
    $view = $this->loadView
    (
    	'export-wbfsys_user_setting_type',
    	'WbfsysUserSettingType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysUserSettingType_Export' );
...
} // end class WbfsysUserSettingType_Export_Controller_Genf
