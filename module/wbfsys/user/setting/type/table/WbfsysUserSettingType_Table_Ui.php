 ...
 * @licence WebFrap.net
 */
class WbfsysUserSettingType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für user setting value types
  *
  ...
  *  }
  *
  * @return WbfsysUserSettingType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSettingType_Table_Element( 'tableWbfsysUserSettingType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_setting_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'user setting value types', 'wbfsys.user_setting_type.label' );
      //$tabPanel->searchKey = 'wbfsys_user_setting_type';
      ...
      $searchElement->searchKey = 'wbfsys_user_setting_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysUserSettingType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysUserSettingType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysUserSettingType listing maske
   *
   * @param WbfsysUserSettingType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysUserSettingType  = $model->getEntityWbfsysUserSettingType();
    ...
    $formWbfsysUserSettingType->setKeyName( 'wbfsys_user_setting_type' );
...
}//end class WbfsysUserSettingType_Table_Ui
