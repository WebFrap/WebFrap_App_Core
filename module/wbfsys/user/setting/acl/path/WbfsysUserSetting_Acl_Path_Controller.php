 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_user_setting_acl_graph', 
      'WbfsysUserSetting_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysUserSetting_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysUserSetting_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysUserSetting_Acl_Path_Maintab_View  */
...
} // end class WbfsysUserSetting_Acl_Path_Controller */
