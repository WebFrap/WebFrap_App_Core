 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.UserSetting_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_user_setting-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.UserSetting_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_user_setting-acl-update';
    ...
    $this->setTemplate( 'wbfsys/user_setting/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'User Setting', 'wbfsys.user_setting.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_user_setting_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysUserSetting_Acl' );
...
} // end class WbfsysUserSetting_Acl_Maintab_View */
