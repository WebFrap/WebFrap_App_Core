 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysUserSetting_Acl_Dset' );
    ...
    $entityWbfsysUserSetting = $this->model->getEntity( $dsetId );
...
} // end class WbfsysUserSetting_Acl_Dset_Ajax_View */
