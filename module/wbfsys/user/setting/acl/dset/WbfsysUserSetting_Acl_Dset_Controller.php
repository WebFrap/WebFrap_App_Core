 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSetting_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysUserSetting_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysUserSetting = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSetting_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_user_setting-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysUserSetting, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysUserSetting_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting-acl-dset', 
    	'WbfsysUserSetting_Acl_Dset',
...
} // end class WbfsysUserSetting_Acl_Dset_Controller */
