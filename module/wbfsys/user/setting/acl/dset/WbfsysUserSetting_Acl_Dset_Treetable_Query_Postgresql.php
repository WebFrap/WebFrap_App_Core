 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_user_setting.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysUserSetting_Acl_Dset_Treetable_Query_Postgresql */
