 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysUserSetting_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysUserSetting_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysUserSetting, $areaId, $access, $params  )
  {

    $listObj = new WbfsysUserSetting_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_user_setting-acl-dset' );
    ...
    else
    {
      ...
      (
        'User Setting "{@label@}" User Access',
        'wbfsys.user_setting.label',
        array
        (
          'label' => $entityWbfsysUserSetting->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_user_setting_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysUserSetting_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysUserSetting_Acl_Dset_Ui */
