 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_user_setting'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysUserSetting', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSetting_Acl_Dset' );
    /* @var $query WbfsysUserSetting_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSetting_Acl_Dset_Treetable' );
    /* @var $query WbfsysUserSetting_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysUserSetting_Acl_Dset_Model */
