 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysUserSetting
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysUserSetting_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_user_setting_acl_listing',
      'WbfsysUserSetting_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysUserSetting_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSetting_Acl_Model */
    $model   = $this->loadModel( 'WbfsysUserSetting_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting-acl',
    	'WbfsysUserSetting_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_user_setting_acl_masks_listing',
      'WbfsysUserSetting_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysUserSetting_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysUserSetting_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysUserSetting_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysUserSetting_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysUserSetting_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysUserSetting_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_user_setting-acl-qfdu',
    	'WbfsysUserSetting_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysUserSetting_Acl_Controller */
