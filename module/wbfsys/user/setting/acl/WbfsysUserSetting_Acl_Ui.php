 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysUserSetting_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysUserSetting_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_user_setting-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'User Setting', 'wbfsys.user_setting.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_user_setting_acl';
...
} // end class WbfsysUserSetting_Acl_Ui */
