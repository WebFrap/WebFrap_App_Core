 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysUserSetting_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_user_setting-acl-qfdu-aAjax',
      'WbfsysUserSetting_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysUserSetting_Acl_Qfdu_Controller */
