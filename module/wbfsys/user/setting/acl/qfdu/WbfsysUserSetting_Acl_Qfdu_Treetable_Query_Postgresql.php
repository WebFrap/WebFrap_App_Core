 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_user_setting.rowid as "wbfsys_user_setting_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_user_setting on wbfsys_group_users.vid = wbfsys_user_setting.rowid'
    );
...
} // end class WbfsysUserSetting_Acl_Qfdu_Treetable_Query_Postgresql */
