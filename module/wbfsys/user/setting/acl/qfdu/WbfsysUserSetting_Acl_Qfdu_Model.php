 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_user_setting')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysUserSetting = $orm->get('WbfsysUserSetting', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_user_setting_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysUserSetting_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSetting_Acl' );
    /* @var $query WbfsysUserSetting_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSetting_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysUserSetting_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysUserSetting_Acl_Qfdu' );
    /* @var $query WbfsysUserSetting_Acl_Qfdu_Query  */
...
} // end class WbfsysUserSetting_Acl_Qfdu_Model */
