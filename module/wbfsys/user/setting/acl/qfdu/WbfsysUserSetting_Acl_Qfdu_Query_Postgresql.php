 ...
 * @licence WebFrap.net
 */
class WbfsysUserSetting_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_user_setting.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_user_setting.rowid as id,
    wbfsys_user_setting.rowid as value,
    wbfsys_user_setting.rowid as label
  FROM
    wbfsys_user_setting
  WHERE
    {$sqlWhere}
...
} // end class WbfsysUserSetting_Acl_Qfdu_Query_Postgresql */
