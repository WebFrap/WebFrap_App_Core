 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_priority';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysPriority_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Priority.show&amp;target_mask=WbfsysPriority&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Priority.edit&amp;target_mask=WbfsysPriority&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.priority.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Priority.delete&amp;target_mask=WbfsysPriority&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.priority.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_priority&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.priority.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.Priority.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.priority.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.priority.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_priority_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_priority_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_priority_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Priority_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected issue prioritys." >{$iconDelete} Delete selected issue prioritys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! issue prioritys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Priority_Multi.deleteAll" >{$iconClean} Delete all issue prioritys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysPriority_Selection_Element
