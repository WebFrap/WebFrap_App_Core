 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysPriority_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysPriority_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPriority_Selection_Element
    (
      'selectionWbfsysPriority',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection issue prioritys', 'wbfsys.priority.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Priority.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysPriority',
      'WbfsysPriority_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysPriority_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysPriority_Selection_Ui
