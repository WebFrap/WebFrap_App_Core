...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für issue prioritys
  *
  ...
  *  }
  *
  * @return WbfsysPriority_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPriority_Table_Element( 'tableWbfsysPriority', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_priority-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'issue prioritys', 'wbfsys.priority.label' );
      //$tabPanel->searchKey = 'wbfsys_priority';
      ...
      $searchElement->searchKey = 'wbfsys_priority';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysPriority_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysPriority', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysPriority listing maske
   *
   * @param WbfsysPriority_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysPriority  = $model->getEntityWbfsysPriority();
    ...
    $formWbfsysPriority->setKeyName( 'wbfsys_priority' );
...
}//end class WbfsysPriority_Table_Ui
