 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysPriority_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysPriority_Export_Listing_Access';
    ...
    // create a new WbfsysPriority window
    $view = $this->loadView
    (
    	'export-wbfsys_priority',
    	'WbfsysPriority_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysPriority_Export' );
...
} // end class WbfsysPriority_Export_Controller_Genf
