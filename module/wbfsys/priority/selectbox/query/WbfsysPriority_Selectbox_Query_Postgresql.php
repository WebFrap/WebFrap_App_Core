 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysPriority Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_priority.rowid as id',
      'wbfsys_priority.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_priority.m_order as "wbfsys_priority-m_order-order"' );

    $criteria->from( 'wbfsys_priority' );



      $criteria->orderBy( 'wbfsys_priority.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_priority.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_priority.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysPriority_Selectbox_Query_Postgresql
