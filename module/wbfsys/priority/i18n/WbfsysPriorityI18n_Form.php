...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_priority_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysPriorityI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysPriorityI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysPriorityI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysPriorityI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysPriorityI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysPriorityI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.priority_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_priority
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_priority( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysPriority_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysPriority not exists' );

      Log::warn('Looks like the Entity: WbfsysPriority is missing');
      ...
      //p: Window
      $objidWbfsysPriority = $this->entity->getData('id_wbfsys_priority') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysPriority
          || !$entityWbfsysPriority = $this->db->orm->get
          (
            'WbfsysPriority',
            $objidWbfsysPriority
          )
      ...
      {
        $entityWbfsysPriority = $this->db->orm->newEntity( 'WbfsysPriority' );
      }

      $inputIdWbfsysPriority = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysPriority', 'Window' );
      $inputIdWbfsysPriority->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_priority]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_priority'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Priority (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysPriority->assignedForm = $this->assignedForm;

      $inputIdWbfsysPriority->setWidth( 'medium' );

      $inputIdWbfsysPriority->setData( $this->entity->getData( 'id_wbfsys_priority' )  );
      $inputIdWbfsysPriority->setReadOnly( $this->isReadOnly( 'id_wbfsys_priority' ) );
      $inputIdWbfsysPriority->setLabel( $this->view->i18n->l( 'Wbfsys Priority', 'wbfsys.priority_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Priority.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_priority'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysPriority->setListUrl ( $listUrl );
      $inputIdWbfsysPriority->setListIcon( 'control/connect.png' );
      $inputIdWbfsysPriority->setEntityUrl( 'maintab.php?c=Wbfsys.Priority.edit' );
      $inputIdWbfsysPriority->conEntity         = $entityWbfsysPriority;
      $inputIdWbfsysPriority->refresh           = $this->refresh;
      $inputIdWbfsysPriority->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysPriority->view = $this->view;
      $inputIdWbfsysPriority->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_priority'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysPriority );
  ...
  }//end public function input_id_wbfsys_priority */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.priority_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Priority I18n)', 'wbfsys.priority_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.priority_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Priority I18n)', 'wbfsys.priority_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.priority_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.priority_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.priority_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.priority_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Priority I18n)', 'wbfsys.priority_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.priority_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Priority I18n)', 'wbfsys.priority_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.priority_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Priority I18n)', 'wbfsys.priority_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.priority_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Priority I18n)', 'wbfsys.priority_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Priority I18n)', 'wbfsys.priority_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_priority_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_priority_i18n_m_role_change';
...
}//end class WbfsysPriorityI18n_Form */
