 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysPriority entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Priority.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Priority.insert';
    $params->formId       = 'wgt-form-wbfsys_priority';
    $params->namespace   = 'wbfsys_priority-create';
    ...
    $this->setTemplate( 'wbfsys/priority/modal/crud/form_create' );
...
}//end class WbfsysPriority_Crud_Create_Modal_View
