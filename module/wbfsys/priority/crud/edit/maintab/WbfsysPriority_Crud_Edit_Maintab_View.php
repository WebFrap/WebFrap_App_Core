 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysPriority Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysPriority = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit issue priority: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Priority.edit&amp;utf8=✓&amp;objid='.$entityWbfsysPriority
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Priority.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_priority-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/priority/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysPriority_Crud_Edit' );
...
}//end class WbfsysPriority_Crud_Edit_Maintab_View
