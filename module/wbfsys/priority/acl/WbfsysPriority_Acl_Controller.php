 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysPriority
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysPriority_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysPriority_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysPriority_Acl_Model */
    $model   = $this->loadModel( 'WbfsysPriority_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_priority_acl_masks_listing',
      'WbfsysPriority_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysPriority_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysPriority_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysPriority_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysPriority_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysPriority_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysPriority_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_priority-acl-qfdu',
    	'WbfsysPriority_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysPriority_Acl_Controller */
