 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_priority'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysPriority', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPriority_Acl_Dset' );
    /* @var $query WbfsysPriority_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPriority_Acl_Dset_Treetable' );
    /* @var $query WbfsysPriority_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysPriority_Acl_Dset_Model */
