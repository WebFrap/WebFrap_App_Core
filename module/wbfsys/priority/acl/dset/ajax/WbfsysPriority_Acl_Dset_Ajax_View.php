 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysPriority_Acl_Dset' );
    ...
    $entityWbfsysPriority = $this->model->getEntity( $dsetId );
...
} // end class WbfsysPriority_Acl_Dset_Ajax_View */
