 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_priority.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysPriority_Acl_Dset_Treetable_Query_Postgresql */
