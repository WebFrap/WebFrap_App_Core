 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysPriority_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysPriority_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysPriority, $areaId, $access, $params  )
  {

    $listObj = new WbfsysPriority_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_priority-acl-dset' );
    ...
    else
    {
      ...
      (
        'issue priority "{@label@}" User Access',
        'wbfsys.priority.label',
        array
        (
          'label' => $entityWbfsysPriority->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_priority_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysPriority_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysPriority_Acl_Dset_Ui */
