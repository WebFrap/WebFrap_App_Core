 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysPriority_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysPriority_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysPriority = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPriority_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_priority-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysPriority, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysPriority_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_priority-acl-dset', 
    	'WbfsysPriority_Acl_Dset',
...
} // end class WbfsysPriority_Acl_Dset_Controller */
