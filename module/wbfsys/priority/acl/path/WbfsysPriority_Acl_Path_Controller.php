 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_priority_acl_graph', 
      'WbfsysPriority_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysPriority_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysPriority_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysPriority_Acl_Path_Maintab_View  */
...
} // end class WbfsysPriority_Acl_Path_Controller */
