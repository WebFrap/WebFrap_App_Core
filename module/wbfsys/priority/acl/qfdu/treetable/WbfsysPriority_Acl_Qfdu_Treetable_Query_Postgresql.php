 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_priority.name as "wbfsys_priority_name"',
      'wbfsys_priority.rowid as "wbfsys_priority_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_priority on wbfsys_group_users.vid = wbfsys_priority.rowid'
    );
...
} // end class WbfsysPriority_Acl_Qfdu_Treetable_Query_Postgresql */
