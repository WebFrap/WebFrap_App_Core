 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysPriority_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_priority-acl-qfdu-aAjax',
      'WbfsysPriority_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysPriority_Acl_Qfdu_Controller */
