 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_priority.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_priority.rowid as id,
    wbfsys_priority.name as value,
    wbfsys_priority.name as label
  FROM
    wbfsys_priority
  WHERE
    {$sqlWhere}
...
} // end class WbfsysPriority_Acl_Qfdu_Query_Postgresql */
