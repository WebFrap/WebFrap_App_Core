 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_priority')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysPriority = $orm->get('WbfsysPriority', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_priority_name']  = $refEntityWbfsysPriority->name;

    }
    $tabData['wbfsys_priority_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysPriority_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPriority_Acl' );
    /* @var $query WbfsysPriority_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPriority_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysPriority_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysPriority_Acl_Qfdu' );
    /* @var $query WbfsysPriority_Acl_Qfdu_Query  */
...
} // end class WbfsysPriority_Acl_Qfdu_Model */
