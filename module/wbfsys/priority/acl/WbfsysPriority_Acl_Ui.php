...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysPriority_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysPriority_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_priority-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'issue priority', 'wbfsys.priority.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_priority_acl';
...
} // end class WbfsysPriority_Acl_Ui */
