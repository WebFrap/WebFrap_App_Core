 ...
 * @licence WebFrap.net
 */
class WbfsysPriority_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Priority_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_priority-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Priority_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_priority-acl-update';
    ...
    $this->setTemplate( 'wbfsys/priority/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'issue priority', 'wbfsys.priority.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_priority_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysPriority_Acl' );
...
} // end class WbfsysPriority_Acl_Maintab_View */
