 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_data_index';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysDataIndex_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DataIndex.show&amp;target_mask=WbfsysDataIndex&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DataIndex.edit&amp;target_mask=WbfsysDataIndex&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.data_index.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataIndex.delete&amp;target_mask=WbfsysDataIndex&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.data_index.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.data_index.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.data_index.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_data_index_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.DataIndex.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_data_index_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_data_index_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DataIndex_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Data Indexs." >{$iconDelete} Delete selected Data Indexs</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Data Indexs. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DataIndex_Multi.deleteAll" >{$iconClean} Delete all Data Indexs</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDataIndex_Table_Element
