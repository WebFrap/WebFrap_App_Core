 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysDataIndex_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_data_index.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_data_index.rowid ",
      'acls'
    );
...
}//end class WbfsysDataIndex_Table_Access
