 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Data Indexs
  *
  ...
  *  }
  *
  * @return WbfsysDataIndex_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDataIndex_Table_Element( 'tableWbfsysDataIndex', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_data_index-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Data Indexs', 'wbfsys.data_index.label' );
      //$tabPanel->searchKey = 'wbfsys_data_index';
      ...
      $searchElement->searchKey = 'wbfsys_data_index';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDataIndex_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDataIndex', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDataIndex listing maske
   *
   * @param WbfsysDataIndex_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysDataIndex  = $model->getEntityWbfsysDataIndex();
    ...
    $formWbfsysDataIndex->setKeyName( 'wbfsys_data_index' );
...
}//end class WbfsysDataIndex_Table_Ui
