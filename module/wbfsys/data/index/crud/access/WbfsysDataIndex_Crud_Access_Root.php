 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDataIndex_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDataIndex_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDataIndex_Entity */
      $entity = $orm->get( 'WbfsysDataIndex', $rootId );
    }
...
}//end class WbfsysDataIndex_Crud_Access_Root
