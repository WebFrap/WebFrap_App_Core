 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDataIndex Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDataIndex = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Data Index: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DataIndex.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDataIndex
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DataIndex.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_data_index-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/data_index/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDataIndex_Crud_Edit' );
...
}//end class WbfsysDataIndex_Crud_Edit_Maintab_View
