 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDataIndex Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDataIndex = $this->model->getEntityWbfsysDataIndex();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Data Index: {@text@}',
      'wbfsys.data_index.label',
      array( 'text' => $entityWbfsysDataIndex->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DataIndex.show  &amp;objid='.$entityWbfsysDataIndex
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DataIndex.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_data_index-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/data_index/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDataIndex_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DataIndex.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_data_index' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_data_index a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DataIndex.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DataIndex.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDataIndex_Crud_Show_Maintab_View
