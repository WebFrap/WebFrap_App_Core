 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDataIndex entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DataIndex.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DataIndex.insert';
    $params->formId       = 'wgt-form-wbfsys_data_index';
    $params->namespace   = 'wbfsys_data_index-create';
    ...
    $this->setTemplate( 'wbfsys/data_index/modal/crud/form_create' );
...
}//end class WbfsysDataIndex_Crud_Create_Modal_View
