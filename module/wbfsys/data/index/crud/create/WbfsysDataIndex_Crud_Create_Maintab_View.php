 ...
 * @licence WebFrap.net
 */
class WbfsysDataIndex_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDataIndex Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_data_index-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/data_index/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DataIndex.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_data_index';
    ...
    $form = $this->newForm( 'WbfsysDataIndex_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.DataIndex.create');}});
});
...
}//end class WbfsysDataIndex_Crud_Create_Maintab_View
