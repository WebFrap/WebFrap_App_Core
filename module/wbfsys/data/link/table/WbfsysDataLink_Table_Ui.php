...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Data Links
  *
  ...
  *  }
  *
  * @return WbfsysDataLink_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDataLink_Table_Element( 'tableWbfsysDataLink', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Data Links', 'wbfsys.data_link.label' );
      //$tabPanel->searchKey = 'wbfsys_data_link';
      ...
      $searchElement->searchKey = 'wbfsys_data_link';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysDataLink_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysDataLink', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysDataLink listing maske
   *
   * @param WbfsysDataLink_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDataLink_Table_Ui
