 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new Data Link"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_data_link-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_data_link-table-help hidden" >
    	      
<p>This is the Data Link table.</p>
...
HTML;
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolEntity&dkey=wbfsys_data_link" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
      </li>


      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsEntity&dkey=wbfsys_data_link" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
      </li>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_data_link-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
HTML;
  ...
  protected function entriesAcl( $params )
  {
    ...
    <li>
      ...
      <span>
      <ul>
                  <li><a class="wcm wcm_req_ajax" href="maintab.php?c=Acl.Mgmt.listing&amp;dkey=wbfsys_data_link" >{$iconMgmt} {$this->view->i18n->l( 'ACLs Entity', 'wbf.label' )}</a></li>
      </ul>
      </span>
    </li>
...
}//end class WbfsysDataLink_Table_Maintab_Menu
