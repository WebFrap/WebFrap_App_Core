 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_data_link';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.DataLink.show&amp;target_mask=WbfsysDataLink&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.DataLink.edit&amp;target_mask=WbfsysDataLink&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.data_link.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink.delete&amp;target_mask=WbfsysDataLink&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.data_link.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_data_link&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.data_link.label',
        Acl::ADMIN
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.DataLink_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Data Links." >{$iconDelete} Delete selected Data Links</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Data Links. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.DataLink_Multi.deleteAll" >{$iconClean} Delete all Data Links</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysDataLink_Table_Element
