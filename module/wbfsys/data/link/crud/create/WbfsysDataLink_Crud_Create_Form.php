 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysDataLink_IdLink( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDataIndex_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.DataIndex.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysDataLink', array_keys( $this->fields['wbfsys_data_link']), true ),
...
}//end class WbfsysDataLink_Crud_Create_Form */
