 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysDataLink entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.DataLink.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DataLink.insert';
    $params->formId       = 'wgt-form-wbfsys_data_link';
    $params->namespace   = 'wbfsys_data_link-create';
    ...
    $this->setTemplate( 'wbfsys/data_link/modal/crud/form_create' );
...
}//end class WbfsysDataLink_Crud_Create_Modal_View
