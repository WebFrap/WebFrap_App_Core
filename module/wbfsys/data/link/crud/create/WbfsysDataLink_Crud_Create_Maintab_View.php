 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysDataLink Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_data_link-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/data_link/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.DataLink.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_data_link';
    ...
    $form = $this->newForm( 'WbfsysDataLink_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.DataLink.create');}});
});
...
}//end class WbfsysDataLink_Crud_Create_Maintab_View
