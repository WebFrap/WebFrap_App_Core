 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysDataLink Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDataLink = $this->model->getEntityWbfsysDataLink();
    ...
    (
      ...
      array( 'text' => $entityWbfsysDataLink->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DataLink.show  &amp;objid='.$entityWbfsysDataLink
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DataLink.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_data_link-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/data_link/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysDataLink_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.DataLink.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_data_link' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_data_link a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.DataLink.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.DataLink.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysDataLink_Crud_Show_Maintab_View
