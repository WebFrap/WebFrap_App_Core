 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Model
  extends Model
{
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getRequestedEntity( $request )
  {
    ...
    if( $val = $request->data( 'wbfsys_data_link', Validator::EID, 'objid' ) )
    {
      $objid = $val;
    }
    ...
    if( $objid )
    {
      $searchId = $objid;
      $keyType  = 'rowid';
      $entity   = $orm->get( 'WbfsysDataLink', $objid );
    }
    else if( $uuid )
    {
      $searchId = $uuid;
      $keyType  = 'uuid';
      $entity   = $orm->getByUuid( 'WbfsysDataLink', $uuid );
    }
    else if( $accessKey )
    {
      $searchId = $accessKey;
      $keyType  = 'access_key';
      $entity   = $orm->getByKey( 'WbfsysDataLink', $accessKey );
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function insert( $params )
  {
    ...
    try
    {
      if( !$entityWbfsysDataLink = $this->getRegisterd( 'entityWbfsysDataLink' ) )
      {
        ...
        (
          ...
          (
            ...
            'wbf.message',
            array( 'key' => 'entityWbfsysDataLink' )
          )
        );
      }
      ...
      else
      {
        ...
        if( $saveSrc )
          $orm->update( $entityWbfsysDataLink );
      }
    ...
    try
    {
      ...
      if( !$orm->update( $entityWbfsysDataLink ) )
      {
        ...
        (
          $response->i18n->l
          (
            'Failed to update Data Link {@label@}',
            'wbfsys.data_link.message',
            array
            (
              'label' =>  $entityText
      ...
      else
      {
        ...
        (
          $response->i18n->l
          (
            'Successfully updated Data Link {@label@}',
            'wbfsys.data_link.message',
            array
            (
              'label' =>  $entityText
   ...
   */
  public function delete( $entityWbfsysDataLink, $params  )
  {
    ...
    $delId     = $entityWbfsysDataLink->getId();
    ...
    try
    {
      ...
      $orm->delete( $entityWbfsysDataLink );

      $response->addMessage
      (
        $response->i18n->l
        (
          'Successfully deleted Data Link {@label@}',
          'wbfsys.data_link.message',
          array( 'label' => $entityText )
        )
      );
        ...
        $this->protocol
        (
          'Deleted Data Link: '.$entityText,
          'delete',
          array( 'WbfsysDataLink', $delId )
        );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchInsertData(  $params )
  {
    ...
    try
    {
      ...
      {
        if( isset( $fields['wbfsys_data_link'] )  )
          $params->fieldsWbfsysDataLink  = $fields['wbfsys_data_link'];
        else
          $params->fieldsWbfsysDataLink  = array();
      }
   ...
   * @return boolean
   */
  public function fetchUpdateData( $entityWbfsysDataLink, $params )
  {
  ...
  public function fetchPostData( $params, $id = null )
  {
    ...
    else
    {
      ...
      if(!$entityWbfsysDataLink = $orm->get( 'WbfsysDataLink',  $id ))
      {
        $response->addError
        (
          $response->i18n->l
          (
            'There is no Data Link with the id: {@id@}',
            'wbfsys.data_link.message',
            array
            (
              'id' => $id
    ...
    if( !$params->fieldsWbfsysDataLink )
      $params->fieldsWbfsysDataLink  = $entityWbfsysDataLink->getCols
      (
        $params->categories
      );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getInsertFields()
  {
    ...
    $saveFields = array();
    $saveFields['wbfsys_data_link'] = array();
    $saveFields['wbfsys_data_link'][] = 'id_message';
        $saveFields['wbfsys_data_link'][] = 'id_link';
        $saveFields['wbfsys_data_link'][] = 'm_version';
