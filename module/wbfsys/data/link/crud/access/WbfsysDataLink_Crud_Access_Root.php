 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysDataLink_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysDataLink_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysDataLink_Entity */
      $entity = $orm->get( 'WbfsysDataLink', $rootId );
    }
...
}//end class WbfsysDataLink_Crud_Access_Root
