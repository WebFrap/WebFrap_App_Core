 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysDataLink Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysDataLink = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.DataLink.edit&amp;utf8=✓&amp;objid='.$entityWbfsysDataLink
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.DataLink.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_data_link-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/data_link/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysDataLink_Crud_Edit' );
...
}//end class WbfsysDataLink_Crud_Edit_Maintab_View
