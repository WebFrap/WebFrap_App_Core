...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_data_link';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysDataLink';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysDataLink' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysDataLink entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_message( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysMessage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Message (Data Link)', 'wbfsys.data_link.label' ),
      ));
      ...
      $inputIdMessage->setLabel( $this->view->i18n->l( 'Message', 'wbfsys.data_link.label' ) );
  ...
  * @return void
  */
  public function input_id_link( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysDataIndex_Entity' ) )
    {
      ...
      $inputIdLink = $this->view->newInput( 'input'.$this->prefix.'IdLink', 'Window' );
      $inputIdLink->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_link]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_link'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Link (Data Link)', 'wbfsys.data_link.label' ),
      ));
      ...
      $inputIdLink->setReadOnly( $this->isReadOnly( 'id_link' ) );
      $inputIdLink->setLabel( $this->view->i18n->l( 'Link', 'wbfsys.data_link.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.DataIndex.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_link'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdLink->buildJavascript( 'wgt-input-'.$this->keyName.'_id_link'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_link */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Data Link)', 'wbfsys.data_link.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.data_link.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Data Link)', 'wbfsys.data_link.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.data_link.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Data Link)', 'wbfsys.data_link.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.data_link.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Data Link)', 'wbfsys.data_link.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.data_link.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Data Link)', 'wbfsys.data_link.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.data_link.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Data Link)', 'wbfsys.data_link.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.data_link.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Data Link)', 'wbfsys.data_link.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.data_link.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_data_link_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_data_link_m_role_change';
