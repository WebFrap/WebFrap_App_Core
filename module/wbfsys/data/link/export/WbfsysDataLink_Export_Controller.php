 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysDataLink_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysDataLink_Export_Listing_Access';
    ...
    // create a new WbfsysDataLink window
    $view = $this->loadView
    (
    	'export-wbfsys_data_link',
    	'WbfsysDataLink_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysDataLink_Export' );
...
} // end class WbfsysDataLink_Export_Controller_Genf
