 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysDataLink_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysDataLink_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDataLink_Selection_Element
    (
      'selectionWbfsysDataLink',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Data Links', 'wbfsys.data_link.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.DataLink.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysDataLink',
      'WbfsysDataLink_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysDataLink_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysDataLink_Selection_Ui
