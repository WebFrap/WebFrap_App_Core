 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_data_link.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysDataLink_Acl_Dset_Treetable_Query_Postgresql */
