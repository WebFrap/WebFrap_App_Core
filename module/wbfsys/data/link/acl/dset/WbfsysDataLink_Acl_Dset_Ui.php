 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysDataLink_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysDataLink_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysDataLink, $areaId, $access, $params  )
  {

    $listObj = new WbfsysDataLink_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_data_link-acl-dset' );
    ...
    else
    {
      ...
      (
        'Data Link "{@label@}" User Access',
        'wbfsys.data_link.label',
        array
        (
          'label' => $entityWbfsysDataLink->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_data_link_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysDataLink_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysDataLink_Acl_Dset_Ui */
