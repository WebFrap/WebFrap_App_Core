 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_data_link'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysDataLink', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDataLink_Acl_Dset' );
    /* @var $query WbfsysDataLink_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysDataLink_Acl_Dset_Treetable' );
    /* @var $query WbfsysDataLink_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysDataLink_Acl_Dset_Model */
