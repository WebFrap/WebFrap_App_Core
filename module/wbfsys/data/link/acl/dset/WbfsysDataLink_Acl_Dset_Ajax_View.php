 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysDataLink_Acl_Dset' );
    ...
    $entityWbfsysDataLink = $this->model->getEntity( $dsetId );
...
} // end class WbfsysDataLink_Acl_Dset_Ajax_View */
