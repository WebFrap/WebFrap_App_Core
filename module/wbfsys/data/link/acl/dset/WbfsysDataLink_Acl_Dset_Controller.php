 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysDataLink_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysDataLink_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysDataLink = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDataLink_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_data_link-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysDataLink, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysDataLink_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_data_link-acl-dset', 
    	'WbfsysDataLink_Acl_Dset',
...
} // end class WbfsysDataLink_Acl_Dset_Controller */
