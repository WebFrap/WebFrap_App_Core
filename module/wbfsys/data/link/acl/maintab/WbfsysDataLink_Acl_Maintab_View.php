 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.DataLink_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_data_link-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.DataLink_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_data_link-acl-update';
    ...
    $this->setTemplate( 'wbfsys/data_link/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Data Link', 'wbfsys.data_link.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_data_link_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysDataLink_Acl' );
...
} // end class WbfsysDataLink_Acl_Maintab_View */
