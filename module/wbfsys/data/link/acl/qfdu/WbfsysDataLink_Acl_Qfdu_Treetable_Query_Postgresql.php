 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_data_link.rowid as "wbfsys_data_link_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_data_link on wbfsys_group_users.vid = wbfsys_data_link.rowid'
    );
...
} // end class WbfsysDataLink_Acl_Qfdu_Treetable_Query_Postgresql */
