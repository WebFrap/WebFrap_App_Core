 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Qfdu_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-wbfsys_data_link-acl-qfdu';
   ...
   *
   * @var WbfsysDataLink_Acl_Table_Query
   */
  public $data        = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink_Acl.cleanQfduGroup&amp;objid=',
        'control/clean.png',
        '',
        'wbf.label',
        Acl::ADMIN
      ...
      (
        ...
        'Inherit Rights',
        'maintab.php?c=Wbfsys.DataLink_Acl_Path.showGraph&amp;objid=',
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink_Acl.deleteQfdUser&amp;objid=',
        'control/delete.png',
        '',
        'wbf.label',
        Acl::ADMIN
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink_Acl.cleanQfdUser&amp;objid=',
        'control/clean.png',
        '',
        'wbf.label',
        Acl::ADMIN
    ...
    (
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.DataLink_Acl.deleteQfduDataset&amp;objid=',
        'control/delete.png',
        '',
        'wbf.label',
        Acl::ADMIN
 ...
 /**
      ...
      else
      {
        ...
        $body .= '<td valign="top" >'
          .'<input
            ...
            id="wgt-input-acl-wbfsys_data_link-qfdu-'.$objid.'-date_start"
        ...
        $body .= '<td valign="top" >'
          .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
            id="wgt-input-acl-wbfsys_data_link-qfdu-'.$objid.'-date_end"
  ...
  public function buildDatasetNode( $groupId, $userId, $groupPos, $userPos  )
  {
    ...
    foreach( $childs as $row )
    {
      ...
      $body .= '<td valign="top" class="ind2" >'.$this->icon( 'control/entity.png', 'Entity' ).' <a href="maintab.php?c=Wbfsys.DataLink.edit&amp;objid='.$row['wbfsys_data_link_rowid'].'" class="wcm wcm_req_ajax" >Data Link: '.$row['wbfsys_data_link_rowid'].'</a></td>'.NL;
      $body .= '<td valign="top" >'
        .'<input
            type="text"
            class="'.$this->editForm.' wcm wcm_ui_date show small"
...
} // end class WbfsysDataLink_Acl_Qfdu_Treetable_Element */
