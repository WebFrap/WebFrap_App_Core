 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_data_link.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_data_link.rowid as id,
    wbfsys_data_link.rowid as value,
    wbfsys_data_link.rowid as label
  FROM
    wbfsys_data_link
  WHERE
    {$sqlWhere}
...
} // end class WbfsysDataLink_Acl_Qfdu_Query_Postgresql */
