 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysDataLink_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_data_link-acl-qfdu-aAjax',
      'WbfsysDataLink_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysDataLink_Acl_Qfdu_Controller */
