 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysDataLink
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysDataLink_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysDataLink_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysDataLink_Acl_Model */
    $model   = $this->loadModel( 'WbfsysDataLink_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_data_link-acl',
    	'WbfsysDataLink_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_data_link_acl_masks_listing',
      'WbfsysDataLink_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysDataLink_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysDataLink_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysDataLink_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysDataLink_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysDataLink_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysDataLink_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_data_link-acl-qfdu',
    	'WbfsysDataLink_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysDataLink_Acl_Controller */
