...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysDataLink_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysDataLink_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_data_link-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Data Link', 'wbfsys.data_link.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_data_link_acl';
...
} // end class WbfsysDataLink_Acl_Ui */
