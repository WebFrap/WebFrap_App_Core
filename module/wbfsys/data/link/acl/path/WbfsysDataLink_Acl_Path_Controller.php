 ...
 * @licence WebFrap.net
 */
class WbfsysDataLink_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_data_link_acl_graph', 
      'WbfsysDataLink_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysDataLink_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysDataLink_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysDataLink_Acl_Path_Maintab_View  */
...
} // end class WbfsysDataLink_Acl_Path_Controller */
