 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_entity where rowid > 0;
SQL;
  ...
  public function fetchAutocomplete( $key )
  {
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_entity.rowid as id,
    wbfsys_entity.name as value

  FROM
    wbfsys_entity

  WHERE
    upper(wbfsys_entity.name) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysEntity_Query_Postgresql
