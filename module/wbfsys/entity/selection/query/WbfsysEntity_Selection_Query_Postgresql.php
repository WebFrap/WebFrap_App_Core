 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Selection_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
          ...
          if( strpos( $condition['free'], ',' ) )
          {
            ...
            foreach( $parts as $part )
            {
              ...
              ('(
                ...
                UPPER(wbfsys_entity.name) like UPPER(\'%'.$part.'%\')
              )');
...
}//end class WbfsysEntity_Selection_Query_Postgresql
