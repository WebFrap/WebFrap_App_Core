 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntity_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntity_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntity_Selection_Element
    (
      'selectionWbfsysEntity',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entitys', 'wbfsys.entity.label' ) ;
      $tabPanel->searchKey = 'wbfsys_entity';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Entity.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowWbfsysEntity',
      'WbfsysEntity_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntity' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysEntity listing maske
   *
   * @param WbfsysEntity_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntity_Selection_Ui
