 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_FileType_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntity_Ref_FileType_".$listType."_Access";
    ...
    (
      $params->tabId,
      'WbfsysEntity_Ref_FileType_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysEntity_Ref_FileType_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity-ref-file_type-'.$listType.'-ajax',
    	'WbfsysEntity_Ref_FileType_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysFileType to a WbfsysEntity
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysEntity_Ref_FileType_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysEntity_Ref_FileType_'.$listType );
      $listModel = $this->loadModel( 'WbfsysEntity_Ref_FileType_'.$listType );
...
} // end WbfsysEntity_Ref_FileType_Controller
