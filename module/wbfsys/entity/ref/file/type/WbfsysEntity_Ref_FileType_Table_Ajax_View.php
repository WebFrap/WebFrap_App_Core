 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_FileType_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Entity_Ref_FileType.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysEntity_Ref_FileType_Table_Ajax_View
