 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Managements_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des managements Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntity_Ref_Managements_".$listType."_Access";
    ...
    $accessManagements = new $containerClass( );
    $accessManagements->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-managements';

    $params->accessManagements = $accessManagements;
    $params->paramsManagements = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessManagements->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysEntity_Ref_Managements_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelManagements = $this->loadModel
    (
      'WbfsysEntity_Ref_Managements_'.$listType
    );
    $modelManagements->setAccess( $accessManagements );
    
    $view->setModel( $modelManagements );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdManagements = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysEntity_Ref_Managements_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity-ref-managements-'.$listType.'-ajax',
    	'WbfsysEntity_Ref_Managements_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
} // end WbfsysEntity_Ref_Managements_Controller
