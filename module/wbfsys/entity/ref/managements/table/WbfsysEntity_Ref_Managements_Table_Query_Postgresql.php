 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Managements_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_management.rowid as "wbfsys_management_rowid"', // variant:  
      'wbfsys_management.name as "wbfsys_management_name"', // variant:  
      'wbfsys_entity.name as "wbfsys_entity_name"', // variant:   used source field wbfsys_entity
      'wbfsys_management.id_entity as "wbfsys_management_id_entity"', // ref wbfsys_management  
      'wbfsys_module.name as "wbfsys_module_name"', // variant:   used source field wbfsys_module
      'wbfsys_management.id_module as "wbfsys_management_id_module"', // ref wbfsys_management  
      'wbfsys_security_area.name as "wbfsys_security_area_name"', // variant:   used source field wbfsys_security_area
      'wbfsys_management.id_security_area as "wbfsys_management_id_security_area"', // ref wbfsys_management  
    );
...
}//end class WbfsysEntity_Ref_Managements_Table_Query_Postgresql
