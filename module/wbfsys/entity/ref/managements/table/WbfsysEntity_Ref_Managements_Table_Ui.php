 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Managements_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntity_Ref_Managements_Table_Element
   */
  public function createListItem( $idWbfsysEntity, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysEntity_Ref_Managements_Table_Element
    (
      'tableManagements',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-managements-'.$idWbfsysEntity;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity-ref-managements-search-'
        .$idWbfsysEntity;
    ...
    $tabPanel->searchKey = 'wbfsys_entity-ref-managements';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.Management.create&refid='.$params->refId.'&target_mask=WbfsysEntity_Ref_Managements&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_management[id_entity]\':\''.$params->refIdManagements.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabManagements', true );
    $view->addVar( 'refIdManagements', $idWbfsysEntity );
    $view->addVar
    (
      'searchFormActionManagements',
      'ajax.php?c=Wbfsys.Entity_Ref_Managements.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysEntity, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowManagements' , $table->buildAjax() );
...
}//end class WbfsysEntity_Ref_Managements_Table_Ui
