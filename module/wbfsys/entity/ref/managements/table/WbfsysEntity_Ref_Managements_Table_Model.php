 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Managements_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  { 
    ...
    $query = $db->newQuery( 'WbfsysEntity_Ref_Managements_Table' );
    /* @var $query WbfsysEntity_Ref_Managements_Table_Query  */

    // hard condition
    $query->setCondition( 'wbfsys_management.id_entity = '.$idWbfsysEntity );
...
}//end class WbfsysEntity_Ref_Managements_Table_Model
