 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Managements_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Entity_Ref_Managements.search&amp;objid='.$params->refId,
        $params
      );
    }
...
}//end class WbfsysEntity_Ref_Managements_Table_Ajax_View
