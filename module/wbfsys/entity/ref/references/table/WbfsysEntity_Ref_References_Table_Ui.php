 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_References_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntity_Ref_References_Table_Element
   */
  public function createListItem( $idWbfsysEntity, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysEntity_Ref_References_Table_Element
    (
      'tableReferences',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-references-'.$idWbfsysEntity;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity-ref-references-search-'
        .$idWbfsysEntity;
    ...
    $tabPanel->searchKey = 'wbfsys_entity-ref-references';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.EntityReference.create&refid='.$params->refId.'&target_mask=WbfsysEntity_Ref_References&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_reference[id_from]\':\''.$params->refIdReferences.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdReferences', $idWbfsysEntity );
    $view->addVar
    (
      'searchFormActionReferences',
      'ajax.php?c=Wbfsys.Entity_Ref_References.search&amp;target_id='
...
}//end class WbfsysEntity_Ref_References_Table_Ui
