 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_References_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntity_Ref_References_".$listType."_Access";
    ...
    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-references';
    ...
    (
      $params->tabId,
      'WbfsysEntity_Ref_References_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdReferences = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysEntity_Ref_References_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity-ref-references-'.$listType.'-ajax',
    	'WbfsysEntity_Ref_References_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysEntityReference by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_entity_reference' ); //def wbfsys_entity_reference


  } // end public function cleanPost */

} // end WbfsysEntity_Ref_References_Controller
