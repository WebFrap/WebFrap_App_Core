 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Categories_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des categories Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntity_Ref_Categories_".$listType."_Access";
    ...
    $accessCategories = new $containerClass( );
    $accessCategories->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-categories';

    $params->accessCategories = $accessCategories;
    $params->paramsCategories = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessCategories->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysEntity_Ref_Categories_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelCategories = $this->loadModel
    (
      'WbfsysEntity_Ref_Categories_'.$listType
    );
    $modelCategories->setAccess( $accessCategories );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdCategories = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysEntity_Ref_Categories_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity-ref-categories-'.$listType.'-ajax',
    	'WbfsysEntity_Ref_Categories_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysEntityCategory by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_entity_category' ); //def wbfsys_entity_category


  } // end public function cleanPost */

} // end WbfsysEntity_Ref_Categories_Controller
