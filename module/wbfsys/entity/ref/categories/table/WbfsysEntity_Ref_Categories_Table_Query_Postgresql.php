 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Categories_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_entity_category.rowid as "wbfsys_entity_category_rowid"', // variant:  
      'wbfsys_entity_category.name as "wbfsys_entity_category_name"', // variant:  
      'wbfsys_entity_category.access_key as "wbfsys_entity_category_access_key"', // variant:  
    );
...
}//end class WbfsysEntity_Ref_Categories_Table_Query_Postgresql
