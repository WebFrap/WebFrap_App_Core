 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntity_Ref_Aliases_Table_Element
   */
  public function createListItem( $idWbfsysEntity, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysEntity_Ref_Aliases_Table_Element
    (
      'tableAliases',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-aliases-'.$idWbfsysEntity;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity-ref-aliases-search-'
        .$idWbfsysEntity;
    ...
    $tabPanel->searchKey = 'wbfsys_entity-ref-aliases';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.EntityAlias.create&refid='.$params->refId.'&target_mask=WbfsysEntity_Ref_Aliases&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_alias[id_entity]\':\''.$params->refIdAliases.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabAliases', true );
    $view->addVar( 'refIdAliases', $idWbfsysEntity );
    $view->addVar
    (
      'searchFormActionAliases',
      'ajax.php?c=Wbfsys.Entity_Ref_Aliases.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysEntity, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowAliases' , $table->buildAjax() );
...
JSCODE;
  ...
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysEntityAlias  = $model->getEntityWbfsysEntityAlias();
    ...
    $formWbfsysEntityAlias->setKeyName( 'wbfsys_entity_alias' );
...
}//end class WbfsysEntity_Ref_Aliases_Table_Ui
