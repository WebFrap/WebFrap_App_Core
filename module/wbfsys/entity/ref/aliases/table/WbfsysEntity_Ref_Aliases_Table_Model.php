 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  { 
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityAlias_Entity' ) )
    {
      $response->addError
      (
        'tried so search for a nonexisting entity: wbfsys_entity_alias with the expected source wbfsys_entity_alias'
      );
      return array();
    }
    ...
    $query = $db->newQuery( 'WbfsysEntity_Ref_Aliases_Table' );
    /* @var $query WbfsysEntity_Ref_Aliases_Table_Query  */

    // hard condition
    $query->setCondition( 'wbfsys_entity_alias.id_entity = '.$idWbfsysEntity );
...
}//end class WbfsysEntity_Ref_Aliases_Table_Model
