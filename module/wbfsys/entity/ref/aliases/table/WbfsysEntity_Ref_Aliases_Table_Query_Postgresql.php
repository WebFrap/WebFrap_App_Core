 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_entity_alias.rowid as "wbfsys_entity_alias_rowid"', // variant:  
      'wbfsys_entity_alias.name as "wbfsys_entity_alias_name"', // variant:  
    );
...
}//end class WbfsysEntity_Ref_Aliases_Table_Query_Postgresql
