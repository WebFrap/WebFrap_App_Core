 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'index.php?c=Wbfsys.Entity_Ref_Aliases.search&amp;objid='.$params->refId,
        $params
      );
    }
    ...
    $ui  = $this->loadUi( 'WbfsysEntity_Ref_Aliases_Table' );
...
}//end class WbfsysEntity_Ref_Aliases_Table_Ajax_View
