 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listAliases = $this->getRegisterd('listRefAliases'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listAliases was not registered'
        );
      }

      foreach( $listAliases as $entityWbfsysEntity )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefAliases',$listWbfsysEntityAlias);
      return true;
...
}//end class WbfsysEntity_Ref_Aliases_Multi_Model
