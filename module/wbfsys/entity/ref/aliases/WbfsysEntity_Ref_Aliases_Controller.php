 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Aliases_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des aliases Referenztabs
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntity_Ref_Aliases_".$listType."_Access";
    ...
    $accessAliases = new $containerClass( );
    $accessAliases->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-aliases';

    $params->accessAliases = $accessAliases;
    $params->paramsAliases = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessAliases->listing  )
    {
    ...
    (
      $params->tabId,
      'WbfsysEntity_Ref_Aliases_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelAliases = $this->loadModel
    (
      'WbfsysEntity_Ref_Aliases_'.$listType
    );
    $modelAliases->setAccess( $accessAliases );
    
    $view->setModel( $modelAliases );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdAliases = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysEntity_Ref_Aliases_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity-ref-aliases-'.$listType.'-ajax',
    	'WbfsysEntity_Ref_Aliases_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysEntityAlias by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_entity_alias' ); //def wbfsys_entity_alias


  } // end public function cleanPost */

} // end WbfsysEntity_Ref_Aliases_Controller
