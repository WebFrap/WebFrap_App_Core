 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Attributes_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    // fix the target id
		$params->targetId = 'wgt-table-modal-ref-attributes-'.$objid;
...
}//end class WbfsysEntity_Ref_Attributes_Table_Modal_View
