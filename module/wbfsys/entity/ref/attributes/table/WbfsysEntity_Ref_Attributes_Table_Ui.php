 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Attributes_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntity_Ref_Attributes_Table_Element
   */
  public function createListItem( $idWbfsysEntity, $data, $access, $params  )
  {
    ...
    $table     = new WbfsysEntity_Ref_Attributes_Table_Element
    (
      'tableAttributes',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-attributes-'.$idWbfsysEntity;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity-ref-attributes-search-'
        .$idWbfsysEntity;
    ...
    $tabPanel->searchKey = 'wbfsys_entity-ref-attributes';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            ...
            '$R.post(\'maintab.php?c=Wbfsys.EntityAttribute.create&refid='.$params->refId.'&target_mask=WbfsysEntity_Ref_Attributes&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_attribute[id_entity]\':\''.$params->refIdAttributes.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabAttributes', true );
    $view->addVar( 'refIdAttributes', $idWbfsysEntity );
    $view->addVar
    (
      'searchFormActionAttributes',
      'ajax.php?c=Wbfsys.Entity_Ref_Attributes.search&amp;target_id='
  ...
  public function listEntry( $idWbfsysEntity, $access, $params, $insertMode )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowAttributes' , $table->buildAjax() );
...
JSCODE;
  ...
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysEntityAttribute  = $model->getEntityWbfsysEntityAttribute();
    ...
    $formWbfsysEntityAttribute->setKeyName( 'wbfsys_entity_attribute' );
...
}//end class WbfsysEntity_Ref_Attributes_Table_Ui
