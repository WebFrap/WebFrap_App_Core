 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Ref_Attributes_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      if(!$listAttributes = $this->getRegisterd('listRefAttributes'))
      {
        throw new Model_Exception
        (
          'Internal Error',
          'listAttributes was not registered'
        );
      }

      foreach( $listAttributes as $entityWbfsysEntity )
      {
  ...
  public function fetchInsertData( $params  )
  {
    ...
    try
    {
      ...
      $this->register('listRefAttributes',$listWbfsysEntityAttribute);
      return true;
...
}//end class WbfsysEntity_Ref_Attributes_Multi_Model
