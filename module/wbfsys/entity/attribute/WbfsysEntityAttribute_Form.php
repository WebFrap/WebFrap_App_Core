 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_attribute';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityAttribute';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityAttribute' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityAttribute entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.entity_attribute.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.entity_attribute.label' ),
  ...
  * @return void
  */
  public function input_id_entity( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      $inputIdEntity = $this->view->newInput( 'input'.$this->prefix.'IdEntity', 'Window' );
      $inputIdEntity->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_entity]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Entity (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ));
      ...
      $inputIdEntity->setReadOnly( $this->isReadOnly( 'id_entity' ) );
      $inputIdEntity->setLabel( $this->view->i18n->l( 'Entity', 'wbfsys.entity_attribute.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Entity.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_entity'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdEntity->buildJavascript( 'wgt-input-'.$this->keyName.'_id_entity'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_entity */
  ...
  */
  public function input_id_category( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityCategory_Entity' ) )
    {
      ...
      $inputIdCategory = $this->view->newInput( 'input'.$this->prefix.'IdCategory', 'Window' );
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_category'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Category (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ));
      ...
      $inputIdCategory->setLabel( $this->view->i18n->l( 'Category', 'wbfsys.entity_attribute.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityCategory.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_category'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdCategory->buildJavascript( 'wgt-input-'.$this->keyName.'_id_category'.($this->suffix?'-'.$this->suffix:'') );
  ...
  */
  public function input_id_type( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysEntityAttributeType_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdType = $this->view->newItem( 'input'.$this->prefix.'IdType' , 'WbfsysEntityAttributeType_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Type (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Type', 'wbfsys.entity_attribute.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mgmt-wbfsys_entity_attribute_type:insert' ) )
      {
        ...
        $inputIdType->editUrl = 'index.php?c=Wbfsys.EntityAttributeType.listing&amp;target='.$this->namespace.'&amp;field=id_type&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_type'.$this->suffix;
      }
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.entity_attribute.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.entity_attribute.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_attribute.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_attribute.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_attribute.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_attribute.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_attribute.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_attribute.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_attribute.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityAttributeType_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_id_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Type (Entity Attribute)', 'wbfsys.entity_attribute.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_attribute_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_attribute_m_role_change';
...
}//end class WbfsysEntityAttribute_Form */
