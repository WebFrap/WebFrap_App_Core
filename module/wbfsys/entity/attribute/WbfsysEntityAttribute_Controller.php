 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_entity_attribute
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.EntityAttribute.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_entity_attribute-create';

    $access = new WbfsysEntityAttribute_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_entity_attribute-create',
      'WbfsysEntityAttribute_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysEntityAttribute_Crud_Model */
    $model = $this->loadModel( 'WbfsysEntityAttribute_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.EntityAttribute.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysEntityAttribute = $model->getEntityWbfsysEntityAttribute( $objid );
    ...
    if( !$entityWbfsysEntityAttribute )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Entity Attribute', 'wbfsys.entity_attribute.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityWbfsysEntityAttribute;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_entity_attribute:edit';

    $access = new WbfsysEntityAttribute_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityAttribute );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_entity_attribute-edit-'.$objid,
      'WbfsysEntityAttribute_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_entity_attribute-edit',
          $entityWbfsysEntityAttribute,
          'Edit Entity Attribute :'.$entityWbfsysEntityAttribute->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_entity_attribute:show';
    ...
    (
      'form-wbfsys_entity_attribute-edit-'.$objid,
      'WbfsysEntityAttribute_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_entity_attribute-show',
          $entityWbfsysEntityAttribute,
          'Show Entity Attribute :'.$entityWbfsysEntityAttribute->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_entity_attribute
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.EntityAttribute.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-insert';

    $access = new WbfsysEntityAttribute_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysEntityAttribute = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_entity_attribute-update-'.$entityWbfsysEntityAttribute;
      ...
      {
        $access = new WbfsysEntityAttribute_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysEntityAttribute );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysEntityAttribute';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_entity_attribute',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysEntityAttribute_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.EntityAttribute.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysEntityAttribute, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysEntityAttribute_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityAttribute.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-delete-'.$objid;

    $access = new WbfsysEntityAttribute_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityAttribute );
    ...
    $error = $model->delete( $entityWbfsysEntityAttribute, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysEntityAttribute, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityAttribute.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.EntityAttribute.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-listing';
    ...
    $containerClass = 'WbfsysEntityAttribute_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_entity_attribute',
      'WbfsysEntityAttribute_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysEntityAttribute_Table_Model */
    $model = $this->loadModel( 'WbfsysEntityAttribute_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_entity_attribute-'.$params->ltype,
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysEntityAttribute
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysEntityAttribute_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_entity_attribute',
      'WbfsysEntityAttribute_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysEntityAttribute_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.EntityAttribute.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityAttribute_Selection_Model */
    $model   = $this->loadModel( 'WbfsysEntityAttribute_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_entity_attribute-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_entity_attribute-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_entity_attribute',
      'WbfsysEntityAttribute',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysEntityAttribute, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysEntityAttribute_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysEntityAttribute_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysEntityAttribute_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysEntityAttribute, $params );
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_attribute-autocomplete';

    $view  = $response->loadView
    (
    	'wbfsys_entity_attribute-ajax', 
    	'WbfsysEntityAttribute',
    	'displayAutocomplete',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_entity_attribute' ); //def wbfsys_entity_attribute
...
} // end class WbfsysEntityAttribute_Controller */
