 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Attributes
  *
  ...
  *  }
  *
  * @return WbfsysEntityAttribute_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttribute_Table_Element( 'tableWbfsysEntityAttribute', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_attribute-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Attributes', 'wbfsys.entity_attribute.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_attribute';
      ...
      $searchElement->searchKey = 'wbfsys_entity_attribute';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityAttribute_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityAttribute', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityAttribute listing maske
   *
...
}//end class WbfsysEntityAttribute_Table_Ui
