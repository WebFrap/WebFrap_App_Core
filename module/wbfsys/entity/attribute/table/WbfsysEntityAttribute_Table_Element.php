 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_attribute';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityAttribute_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityAttribute.show&amp;target_mask=WbfsysEntityAttribute&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityAttribute.edit&amp;target_mask=WbfsysEntityAttribute&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_attribute.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.EntityAttribute_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity_attribute.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityAttribute.delete&amp;target_mask=WbfsysEntityAttribute&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_attribute.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.entity_attribute.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.entity_attribute.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'wbfsys.entity_attribute.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_attribute_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.EntityAttribute.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_attribute_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_attribute_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.EntityAttributeType.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_attribute_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityAttribute_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Attributes." >{$iconDelete} Delete selected Entity Attributes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Attributes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityAttribute_Multi.deleteAll" >{$iconClean} Delete all Entity Attributes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityAttribute_Table_Element
