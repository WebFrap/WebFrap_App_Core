 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityAttribute Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityAttribute = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Attribute: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityAttribute.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityAttribute
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityAttribute.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_attribute-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_attribute/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityAttribute_Crud_Edit' );
...
}//end class WbfsysEntityAttribute_Crud_Edit_Maintab_View
