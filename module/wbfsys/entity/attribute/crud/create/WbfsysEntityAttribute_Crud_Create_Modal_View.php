 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityAttribute entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityAttribute.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityAttribute.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_attribute';
    $params->namespace   = 'wbfsys_entity_attribute-create';
    ...
    $this->setTemplate( 'wbfsys/entity_attribute/modal/crud/form_create' );
...
}//end class WbfsysEntityAttribute_Crud_Create_Modal_View
