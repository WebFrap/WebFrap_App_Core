 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityAttribute_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityAttribute_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityAttribute_Entity */
      $entity = $orm->get( 'WbfsysEntityAttribute', $rootId );
    }
...
}//end class WbfsysEntityAttribute_Crud_Access_Root
