 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysEntityAttribute
   *
   * @param int $idWbfsysEntityAttribute the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysEntityAttribute, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityAttribute_Ref_Comments_Table' );
    /* @var $query WbfsysEntityAttribute_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysEntityAttribute );
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Model
