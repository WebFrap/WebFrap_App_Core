 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.EntityAttribute_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Ajax_View
