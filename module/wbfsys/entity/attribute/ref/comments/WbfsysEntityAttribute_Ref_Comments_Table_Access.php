 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mod-wbfsys-cat-core_data-ref-comments' );
  ...
  /**
   * @param WbfsysEntityAttribute_Ref_Comments_Table_Query $query
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Access
