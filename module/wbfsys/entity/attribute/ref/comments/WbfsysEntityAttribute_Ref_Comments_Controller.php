 ...
 * If you want to extend this class write your coden in ControllerWbfsysEntityAttribute
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_entity_attribute management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntityAttribute_Ref_Comments_".$listType."_Access";
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_entity_attribute-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysEntityAttribute_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysEntityAttribute_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity_attribute-ref-comments-'.$listType.'-ajax',
    	'WbfsysEntityAttribute_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysEntityAttribute
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysEntityAttribute_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysEntityAttribute_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysEntityAttribute_Ref_Comments_'.$listType );
...
} // end WbfsysEntityAttribute_Ref_Comments_Controller
