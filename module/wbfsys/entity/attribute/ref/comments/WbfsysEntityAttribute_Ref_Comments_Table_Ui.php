 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysEntityAttribute
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysEntityAttribute_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysEntityAttribute, $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttribute_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysEntityAttribute;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_attribute-ref-comments-search-'
        .$idWbfsysEntityAttribute;
    ...
    $tabPanel->searchKey = 'wbfsys_entity_attribute-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Append new Comment',
            '$R.get(\'modal.php?c=Wbfsys.Comment.selection&exclude=wbfsys_entity_comment-vid-id_comment&objid='.$params->refId.'&target_mask=WbfsysEntityAttribute_Ref_Comments&target='.$params->searchFormId.$table->accessPath.'\');return false;',
            'control/search.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysEntityAttribute );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.EntityAttribute_Ref_Comments.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysEntityAttribute
    );
   ...
   * @return WbfsysEntityAttribute_Ref_Comments_Table_Element
   */
  public function getListItem( $idWbfsysEntityAttribute, $data, $access, $params  )
  {
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysEntityAttribute_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Ui
