 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Multi_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// crud methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function save( $params   )
  {
    ...
    try
    {
      ...
      foreach( $listComments as $entityWbfsysEntityAttribute )
      {
        if(!$orm->save( $entityWbfsysEntityAttribute) )
        {
          ...
          (
            $view->i18n->l
            (
              'Failed to save Entity Attribute '.$entityText,
        ...
        else
        {
          ...
          (
            $view->i18n->l
            (
              'Successfully saved Entity Attribute '.$entityText,
              'wbfsys.entity_attribute.message',
              array($entityText)
            )
          );
  ...
  public function update( $params   )
  {
    ...
    try
    {
      ...
      (
        $view->i18n->l
        (
          'Successfully saved Entity Attribute: '.$textSaved,
          'wbfsys.entity_attribute.message',
          array($textSaved)
        )
      );
...
}//end class WbfsysEntityAttribute_Ref_Comments_Multi_Model
