 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.EntityAttribute_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_attribute-ref-comments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Comments' );

    // set the default table template
    $this->setTemplate( 'wbfsys/entity_attribute/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysEntityAttribute_Ref_Comments_Table' );
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Modal_View
