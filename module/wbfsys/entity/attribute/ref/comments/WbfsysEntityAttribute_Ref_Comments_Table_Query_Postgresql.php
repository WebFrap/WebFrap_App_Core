 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ref_Comments_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_entity_comment.rowid as "wbfsys_entity_comment_rowid"', // variant:  
      'wbfsys_comment.title as "wbfsys_comment_title"', // variant:  
      'wbfsys_comment.rowid as "wbfsys_comment_rowid"', // variant:  
    );
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_comment.vid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_entity_comment.vid = '.$condition );
        }
        else
        {
...
}//end class WbfsysEntityAttribute_Ref_Comments_Table_Query_Postgresql
