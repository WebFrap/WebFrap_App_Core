 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysEntityAttribute, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysEntityAttribute, $params );
    }
    else
    {
...
}//end class WbfsysEntityAttribute_Ajax_View
