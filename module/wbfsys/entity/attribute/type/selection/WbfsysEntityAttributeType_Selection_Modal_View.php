 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityAttributeType_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysEntityAttributeType_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_entity_attribute_type
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityAttributeType.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_entity_attribute_type-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysEntityAttributeType_Selection' );
...
}//end class WbfsysEntityAttributeType_Selection_Modal_View
