 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityAttributeType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityAttributeType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttributeType_Selection_Element
    (
      'selectionWbfsysEntityAttributeType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection entity attribute Types', 'wbfsys.entity_attribute_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityAttributeType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityAttributeType',
      'WbfsysEntityAttributeType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityAttributeType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityAttributeType_Selection_Ui
