 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_entity_attribute_type';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityAttributeType_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityAttributeType.show&amp;target_mask=WbfsysEntityAttributeType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityAttributeType.edit&amp;target_mask=WbfsysEntityAttributeType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_attribute_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityAttributeType.delete&amp;target_mask=WbfsysEntityAttributeType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_attribute_type.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_entity_attribute_type&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.entity_attribute_type.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.EntityAttributeType.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.entity_attribute_type.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.entity_attribute_type.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_attribute_type_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_attribute_type_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_entity_attribute_type_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityAttributeType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected entity attribute Types." >{$iconDelete} Delete selected entity attribute Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! entity attribute Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityAttributeType_Multi.deleteAll" >{$iconClean} Delete all entity attribute Types</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityAttributeType_Selection_Element
