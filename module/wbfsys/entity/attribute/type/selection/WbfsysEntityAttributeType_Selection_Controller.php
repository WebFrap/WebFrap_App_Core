 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityAttributeType_Selection' ) );
...
} // end class WbfsysEntityAttributeType_Selection_Controller */
