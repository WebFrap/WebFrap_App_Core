 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysEntityAttributeType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysEntityAttributeType_Export_Listing_Access';
    ...
    // create a new WbfsysEntityAttributeType window
    $view = $this->loadView
    (
    	'export-wbfsys_entity_attribute_type',
    	'WbfsysEntityAttributeType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysEntityAttributeType_Export' );
...
} // end class WbfsysEntityAttributeType_Export_Controller_Genf
