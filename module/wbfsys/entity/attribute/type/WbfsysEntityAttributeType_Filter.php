 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_entity_attribute_type') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_entity_attribute_type.{$fieldName}
...
}//end class WbfsysEntityAttributeType_Filter
