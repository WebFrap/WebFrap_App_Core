 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_entity_attribute_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysEntityAttributeType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityAttributeType_Acl_Dset' );
    /* @var $query WbfsysEntityAttributeType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityAttributeType_Acl_Dset_Treetable' );
    /* @var $query WbfsysEntityAttributeType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysEntityAttributeType_Acl_Dset_Model */
