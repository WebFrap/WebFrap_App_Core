 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysEntityAttributeType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntityAttributeType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysEntityAttributeType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysEntityAttributeType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_entity_attribute_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'entity attribute Type "{@label@}" User Access',
        'wbfsys.entity_attribute_type.label',
        array
        (
          'label' => $entityWbfsysEntityAttributeType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_entity_attribute_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysEntityAttributeType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysEntityAttributeType_Acl_Dset_Ui */
