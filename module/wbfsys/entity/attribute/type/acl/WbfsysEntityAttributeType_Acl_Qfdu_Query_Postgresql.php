 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_entity_attribute_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_entity_attribute_type.rowid as id,
    wbfsys_entity_attribute_type.name as value,
    wbfsys_entity_attribute_type.name as label
  FROM
...
} // end class WbfsysEntityAttributeType_Acl_Qfdu_Query_Postgresql */
