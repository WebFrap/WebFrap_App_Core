 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysEntityAttributeType_Acl_Dset' );
    ...
    $entityWbfsysEntityAttributeType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysEntityAttributeType_Acl_Dset_Ajax_View */
