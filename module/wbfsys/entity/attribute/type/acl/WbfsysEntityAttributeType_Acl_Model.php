 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_entity_attribute_type' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_entity_attribute_type' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysEntityAttributeType_Acl_Table' );
    /* @var $query WbfsysEntityAttributeType_Acl_Table_Query  */
...
} // end class WbfsysEntityAttributeType_Acl_Model */
