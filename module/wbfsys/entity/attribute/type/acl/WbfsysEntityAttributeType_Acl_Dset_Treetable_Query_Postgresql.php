 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_entity_attribute_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysEntityAttributeType_Acl_Dset_Treetable_Query_Postgresql */
