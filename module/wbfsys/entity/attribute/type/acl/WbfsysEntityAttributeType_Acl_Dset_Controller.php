 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysEntityAttributeType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysEntityAttributeType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysEntityAttributeType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_entity_attribute_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysEntityAttributeType, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_entity_attribute_type-acl-dset', 
    	'WbfsysEntityAttributeType_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysEntityAttributeType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_entity_attribute_type-acl-dset', 
    	'WbfsysEntityAttributeType_Acl_Dset',
...
} // end class WbfsysEntityAttributeType_Acl_Dset_Controller */
