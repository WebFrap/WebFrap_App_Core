 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_entity_attribute_type.name as "wbfsys_entity_attribute_type_name"',
      'wbfsys_entity_attribute_type.rowid as "wbfsys_entity_attribute_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_entity_attribute_type on wbfsys_group_users.vid = wbfsys_entity_attribute_type.rowid'
    );
...
} // end class WbfsysEntityAttributeType_Acl_Qfdu_Treetable_Query_Postgresql */
