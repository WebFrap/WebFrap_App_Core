 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_entity_attribute_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysEntityAttributeType = $orm->get('WbfsysEntityAttributeType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_entity_attribute_type_name']  = $refEntityWbfsysEntityAttributeType->name;

    }
    $tabData['wbfsys_entity_attribute_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysEntityAttributeType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityAttributeType_Acl' );
    /* @var $query WbfsysEntityAttributeType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityAttributeType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysEntityAttributeType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityAttributeType_Acl_Qfdu' );
    /* @var $query WbfsysEntityAttributeType_Acl_Qfdu_Query  */
...
} // end class WbfsysEntityAttributeType_Acl_Qfdu_Model */
