 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/maintab/acl/acl_graph' );
    ...
    (
      ...
      'wbf.label',
      array( 'label' => 'entity attribute Types' )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_entity_attribute_type-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_entity_attribute_type-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysEntityAttributeType_Acl_Path_Maintab_View */
