 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysEntityAttributeType_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityAttributeType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_attribute_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.EntityAttributeType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_entity_attribute_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'entity attribute Type', 'wbfsys.entity_attribute_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_entity_attribute_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysEntityAttributeType_Acl' );
...
} // end class WbfsysEntityAttributeType_Acl_Maintab_View */
