 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    (
      'wbfsys_entity_attribute_type_acl_listing',
    ...
    $view->setModel( $this->loadModel('WbfsysEntityAttributeType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityAttributeType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysEntityAttributeType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_entity_attribute_type-acl',
    	'WbfsysEntityAttributeType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_entity_attribute_type_acl_masks_listing',
      'WbfsysEntityAttributeType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysEntityAttributeType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysEntityAttributeType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    $view    = $response->loadView
    ( 
    	'wbfsys_entity_attribute_type-acl-qfdu',
    	'WbfsysEntityAttributeType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysEntityAttributeType_Acl_Controller */
