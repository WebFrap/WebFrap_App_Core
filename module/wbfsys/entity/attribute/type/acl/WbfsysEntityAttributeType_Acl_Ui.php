 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysEntityAttributeType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttributeType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL entity attribute Type', 
        'wbfsys.entity_attribute_type.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_entity_attribute_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'entity attribute Type', 'wbfsys.entity_attribute_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_entity_attribute_type_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysEntityAttributeType_Acl_Table'
    );
...
} // end class WbfsysEntityAttributeType_Acl_Ui */
