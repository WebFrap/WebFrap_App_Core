 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityAttributeType_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysEntityAttributeType_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table entity attribute Types',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.EntityAttributeType.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityAttributeType.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysEntityAttributeType_Table' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenuListing( $params )
  {
    ...
    (
      $this->id.'_dropmenu',
      'WbfsysEntityAttributeType_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityAttributeType.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityAttributeType.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.EntityAttributeType.create&amp;ltype=table');
    });
...
}//end class WbfsysEntityAttributeType_Table_Maintab_View
