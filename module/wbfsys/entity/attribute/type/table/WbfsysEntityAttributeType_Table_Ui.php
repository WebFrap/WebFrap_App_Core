 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für entity attribute Types
  *
  ...
  *  }
  *
  * @return WbfsysEntityAttributeType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttributeType_Table_Element( 'tableWbfsysEntityAttributeType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_attribute_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'entity attribute Types', 'wbfsys.entity_attribute_type.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_attribute_type';
      ...
      $searchElement->searchKey = 'wbfsys_entity_attribute_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityAttributeType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityAttributeType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityAttributeType listing maske
   *
   * @param WbfsysEntityAttributeType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityAttributeType  = $model->getEntityWbfsysEntityAttributeType();
    ...
    $formWbfsysEntityAttributeType->setKeyName( 'wbfsys_entity_attribute_type' );
...
}//end class WbfsysEntityAttributeType_Table_Ui
