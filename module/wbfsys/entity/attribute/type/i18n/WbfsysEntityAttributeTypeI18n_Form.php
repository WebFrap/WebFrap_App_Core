 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeTypeI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_attribute_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityAttributeTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysEntityAttributeTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysEntityAttributeTypeI18n';
   ...
   *
   * @var WbfsysEntityAttributeTypeI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysEntityAttributeTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityAttributeTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityAttributeTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.entity_attribute_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_entity_attribute_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_entity_attribute_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysEntityAttributeType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysEntityAttributeType not exists' );

      Log::warn('Looks like the Entity: WbfsysEntityAttributeType is missing');
      ...
      //p: Window
      $objidWbfsysEntityAttributeType = $this->entity->getData('id_wbfsys_entity_attribute_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysEntityAttributeType
          || !$entityWbfsysEntityAttributeType = $this->db->orm->get
          (
      ...
      {
        $entityWbfsysEntityAttributeType = $this->db->orm->newEntity( 'WbfsysEntityAttributeType' );
      }

      $inputIdWbfsysEntityAttributeType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysEntityAttributeType', 'Window' );
      $inputIdWbfsysEntityAttributeType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_entity_attribute_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_entity_attribute_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Entity Attribute Type (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysEntityAttributeType->assignedForm = $this->assignedForm;

      $inputIdWbfsysEntityAttributeType->setWidth( 'medium' );

      $inputIdWbfsysEntityAttributeType->setData( $this->entity->getData( 'id_wbfsys_entity_attribute_type' )  );
      $inputIdWbfsysEntityAttributeType->setReadOnly( $this->isReadOnly( 'id_wbfsys_entity_attribute_type' ) );
      $inputIdWbfsysEntityAttributeType->setLabel( $this->view->i18n->l( 'Wbfsys Entity Attribute Type', 'wbfsys.entity_attribute_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityAttributeType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_entity_attribute_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysEntityAttributeType->setListUrl ( $listUrl );
      $inputIdWbfsysEntityAttributeType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysEntityAttributeType->setEntityUrl( 'maintab.php?c=Wbfsys.EntityAttributeType.edit' );
      $inputIdWbfsysEntityAttributeType->conEntity         = $entityWbfsysEntityAttributeType;
      $inputIdWbfsysEntityAttributeType->refresh           = $this->refresh;
      $inputIdWbfsysEntityAttributeType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysEntityAttributeType->view = $this->view;
      $inputIdWbfsysEntityAttributeType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_entity_attribute_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysEntityAttributeType );
  ...
  }//end public function input_id_wbfsys_entity_attribute_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.entity_attribute_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.entity_attribute_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_attribute_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_attribute_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_attribute_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_attribute_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_attribute_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_attribute_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_attribute_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Entity Attribute Type I18n)', 'wbfsys.entity_attribute_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_attribute_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_attribute_type_i18n_m_role_change';
...
}//end class WbfsysEntityAttributeTypeI18n_Form */
