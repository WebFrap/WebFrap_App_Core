 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityAttributeType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityAttributeType = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit entity attribute Type: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityAttributeType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityAttributeType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityAttributeType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_attribute_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityAttributeType_Crud_Edit' );
...
}//end class WbfsysEntityAttributeType_Crud_Edit_Maintab_View
