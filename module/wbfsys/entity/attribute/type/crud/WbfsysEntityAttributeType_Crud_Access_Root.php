 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityAttributeType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityAttributeType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityAttributeType_Entity */
      $entity = $orm->get( 'WbfsysEntityAttributeType', $rootId );
    }
...
}//end class WbfsysEntityAttributeType_Crud_Access_Root
