 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityAttributeType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityAttributeType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityAttributeType.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_attribute_type';
    $params->namespace   = 'wbfsys_entity_attribute_type-create';
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/modal/crud/form_create' );
...
}//end class WbfsysEntityAttributeType_Crud_Create_Modal_View
