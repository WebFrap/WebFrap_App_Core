 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityAttributeType_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityAttributeType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityAttributeType = $this->model->getEntityWbfsysEntityAttributeType();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show entity attribute Type: {@text@}',
      'wbfsys.entity_attribute_type.label',
      array( 'text' => $entityWbfsysEntityAttributeType->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'entity attribute Type: {@text@}',
      'wbfsys.entity_attribute_type.label',
      array( 'text' => $entityWbfsysEntityAttributeType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityAttributeType.show  &amp;objid='.$entityWbfsysEntityAttributeType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityAttributeType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_attribute_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_attribute_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityAttributeType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityAttributeType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_attribute_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_attribute_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityAttributeType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityAttributeType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityAttributeType_Crud_Show_Maintab_View
