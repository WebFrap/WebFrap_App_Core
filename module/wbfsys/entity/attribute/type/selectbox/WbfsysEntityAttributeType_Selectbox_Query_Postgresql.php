 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttributeType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysEntityAttributeType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_entity_attribute_type.rowid as id',
      'wbfsys_entity_attribute_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_entity_attribute_type.m_order as "wbfsys_entity_attribute_type-m_order-order"' );

    $criteria->from( 'wbfsys_entity_attribute_type' );



      $criteria->orderBy( 'wbfsys_entity_attribute_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_entity_attribute_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_entity_attribute_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysEntityAttributeType_Selectbox_Query_Postgresql
