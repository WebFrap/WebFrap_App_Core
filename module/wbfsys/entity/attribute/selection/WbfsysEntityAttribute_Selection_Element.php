 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_entity_attribute';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityAttribute.show&amp;target_mask=WbfsysEntityAttribute&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityAttribute.edit&amp;target_mask=WbfsysEntityAttribute&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_attribute.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityAttribute.delete&amp;target_mask=WbfsysEntityAttribute&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_attribute.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_attribute_name'])).'</td>'.NL;
...
}//end class WbfsysEntityAttribute_Selection_Element
