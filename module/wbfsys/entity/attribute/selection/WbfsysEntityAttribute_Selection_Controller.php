 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityAttribute_Selection' ) );
...
} // end class WbfsysEntityAttribute_Selection_Controller */
