 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityAttribute_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityAttribute_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttribute_Selection_Element
    (
      'selectionWbfsysEntityAttribute',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Attributes', 'wbfsys.entity_attribute.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityAttribute.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityAttribute',
      'WbfsysEntityAttribute_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityAttribute_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityAttribute_Selection_Ui
