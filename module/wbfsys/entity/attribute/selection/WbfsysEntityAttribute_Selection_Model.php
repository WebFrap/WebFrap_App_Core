 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttribute_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityAttribute_Selection' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityAttribute_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysEntityAttribute_Selection_Model
