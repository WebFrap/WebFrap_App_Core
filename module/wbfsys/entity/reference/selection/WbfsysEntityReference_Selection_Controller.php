 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityReference_Selection' ) );
...
} // end class WbfsysEntityReference_Selection_Controller */
