 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityReference_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityReference_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityReference_Selection_Element
    (
      'selectionWbfsysEntityReference',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity References', 'wbfsys.entity_reference.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityReference.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityReference',
      'WbfsysEntityReference_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityReference_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityReference_Selection_Ui
