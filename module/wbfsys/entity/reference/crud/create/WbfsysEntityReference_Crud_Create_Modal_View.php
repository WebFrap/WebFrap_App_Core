 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityReference entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityReference.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityReference.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_reference';
    $params->namespace   = 'wbfsys_entity_reference-create';
    ...
    $this->setTemplate( 'wbfsys/entity_reference/modal/crud/form_create' );
...
}//end class WbfsysEntityReference_Crud_Create_Modal_View
