 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_reference';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityReference';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityReference' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityReference entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.entity_reference.label' ),
  ...
  public function input_id_from( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for From (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputIdFrom->setLabel( $this->view->i18n->l( 'From', 'wbfsys.entity_reference.label' ) );
  ...
  * @return void
  */
  public function input_id_field_from( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityAttribute_Entity' ) )
    {
      ...
      $inputIdFieldFrom = $this->view->newInput( 'input'.$this->prefix.'IdFieldFrom', 'Window' );
      $inputIdFieldFrom->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_field_from]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_field_from'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Field From (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputIdFieldFrom->setReadOnly( $this->isReadOnly( 'id_field_from' ) );
      $inputIdFieldFrom->setLabel( $this->view->i18n->l( 'Field From', 'wbfsys.entity_reference.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityAttribute.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_field_from'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdFieldFrom->buildJavascript( 'wgt-input-'.$this->keyName.'_id_field_from'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_field_from */
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_to'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for To (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputIdTo->setLabel( $this->view->i18n->l( 'To', 'wbfsys.entity_reference.label' ) );
  ...
  * @return void
  */
  public function input_id_field_to( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityAttribute_Entity' ) )
    {
      ...
      $inputIdFieldTo = $this->view->newInput( 'input'.$this->prefix.'IdFieldTo', 'Window' );
      $inputIdFieldTo->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_field_to]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_field_to'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Field To (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputIdFieldTo->setReadOnly( $this->isReadOnly( 'id_field_to' ) );
      $inputIdFieldTo->setLabel( $this->view->i18n->l( 'Field To', 'wbfsys.entity_reference.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EntityAttribute.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_field_to'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdFieldTo->buildJavascript( 'wgt-input-'.$this->keyName.'_id_field_to'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_field_to */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Entity Reference)', 'wbfsys.entity_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.entity_reference.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Entity Reference)', 'wbfsys.entity_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.entity_reference.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity Reference)', 'wbfsys.entity_reference.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_reference.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_reference.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity Reference)', 'wbfsys.entity_reference.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_reference.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity Reference)', 'wbfsys.entity_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_reference.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity Reference)', 'wbfsys.entity_reference.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_reference.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Entity Reference)', 'wbfsys.entity_reference.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_reference_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_reference_m_role_change';
...
}//end class WbfsysEntityReference_Form */
