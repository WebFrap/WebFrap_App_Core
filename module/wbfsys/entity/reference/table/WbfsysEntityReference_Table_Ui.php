 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity References
  *
  ...
  *  }
  *
  * @return WbfsysEntityReference_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityReference_Table_Element( 'tableWbfsysEntityReference', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_reference-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity References', 'wbfsys.entity_reference.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_reference';
      ...
      $searchElement->searchKey = 'wbfsys_entity_reference';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityReference_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityReference', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityReference listing maske
   *
   * @param WbfsysEntityReference_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityReference  = $model->getEntityWbfsysEntityReference();
    ...
    $formWbfsysEntityReference->setKeyName( 'wbfsys_entity_reference' );
...
}//end class WbfsysEntityReference_Table_Ui
