 ...
 * @licence WebFrap.net
 */
class WbfsysEntityReference_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_reference';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityReference_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityReference.show&amp;target_mask=WbfsysEntityReference&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityReference.edit&amp;target_mask=WbfsysEntityReference&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_reference.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityReference.delete&amp;target_mask=WbfsysEntityReference&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_reference.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_reference_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityReference_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity References." >{$iconDelete} Delete selected Entity References</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity References. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityReference_Multi.deleteAll" >{$iconClean} Delete all Entity References</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityReference_Table_Element
