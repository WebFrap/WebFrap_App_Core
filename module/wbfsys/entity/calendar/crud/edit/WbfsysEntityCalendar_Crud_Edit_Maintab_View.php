 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityCalendar Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityCalendar = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Calendar: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityCalendar.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityCalendar
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityCalendar.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_calendar-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_calendar/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityCalendar_Crud_Edit' );
...
}//end class WbfsysEntityCalendar_Crud_Edit_Maintab_View
