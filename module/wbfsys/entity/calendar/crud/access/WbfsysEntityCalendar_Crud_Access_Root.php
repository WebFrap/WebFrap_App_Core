 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityCalendar_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityCalendar_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityCalendar_Entity */
      $entity = $orm->get( 'WbfsysEntityCalendar', $rootId );
    }
...
}//end class WbfsysEntityCalendar_Crud_Access_Root
