 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityCalendar entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityCalendar.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityCalendar.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_calendar';
    $params->namespace   = 'wbfsys_entity_calendar-create';
    ...
    $this->setTemplate( 'wbfsys/entity_calendar/modal/crud/form_create' );
...
}//end class WbfsysEntityCalendar_Crud_Create_Modal_View
