 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityCalendar Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_calendar-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_calendar/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityCalendar.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_calendar';
    ...
    $form = $this->newForm( 'WbfsysEntityCalendar_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityCalendar.create');}});
});
...
}//end class WbfsysEntityCalendar_Crud_Create_Maintab_View
