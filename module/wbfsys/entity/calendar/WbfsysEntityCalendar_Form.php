 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_calendar';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityCalendar';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityCalendar' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityCalendar entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
  ...
  * @return void
  */
  public function input_id_calendar( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysCalendar_Entity' ) )
    {
      ...
      $inputIdCalendar = $this->view->newInput( 'input'.$this->prefix.'IdCalendar', 'Window' );
      $inputIdCalendar->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_calendar]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_calendar'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Calendar (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
      ));
      ...
      $inputIdCalendar->setReadOnly( $this->isReadOnly( 'id_calendar' ) );
      $inputIdCalendar->setLabel( $this->view->i18n->l( 'Calendar', 'wbfsys.entity_calendar.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Calendar.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_calendar'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdCalendar->buildJavascript( 'wgt-input-'.$this->keyName.'_id_calendar'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_calendar */
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_calendar.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_calendar.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_calendar.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_calendar.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_calendar.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_calendar.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity Calendar)', 'wbfsys.entity_calendar.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_calendar.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_calendar_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_calendar_m_role_change';
...
}//end class WbfsysEntityCalendar_Form */
