 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_calendar';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityCalendar_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityCalendar.show&amp;target_mask=WbfsysEntityCalendar&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityCalendar.edit&amp;target_mask=WbfsysEntityCalendar&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_calendar.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityCalendar.delete&amp;target_mask=WbfsysEntityCalendar&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_calendar.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_calendar_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityCalendar_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Calendars." >{$iconDelete} Delete selected Entity Calendars</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Calendars. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityCalendar_Multi.deleteAll" >{$iconClean} Delete all Entity Calendars</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityCalendar_Table_Element
