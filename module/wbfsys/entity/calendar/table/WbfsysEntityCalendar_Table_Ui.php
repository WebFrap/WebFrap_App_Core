 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Calendars
  *
  ...
  *  }
  *
  * @return WbfsysEntityCalendar_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityCalendar_Table_Element( 'tableWbfsysEntityCalendar', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_calendar-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Calendars', 'wbfsys.entity_calendar.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_calendar';
      ...
      $searchElement->searchKey = 'wbfsys_entity_calendar';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityCalendar_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityCalendar', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityCalendar listing maske
   *
   * @param WbfsysEntityCalendar_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityCalendar  = $model->getEntityWbfsysEntityCalendar();
    ...
    $formWbfsysEntityCalendar->setKeyName( 'wbfsys_entity_calendar' );
...
}//end class WbfsysEntityCalendar_Table_Ui
