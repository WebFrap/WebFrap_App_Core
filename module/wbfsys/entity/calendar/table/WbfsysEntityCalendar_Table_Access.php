 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCalendar_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityCalendar_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_entity_calendar.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_entity_calendar.rowid ",
      'acls'
    );
...
}//end class WbfsysEntityCalendar_Table_Access
