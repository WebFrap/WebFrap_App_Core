 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntity_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Entity.show&amp;target_mask=WbfsysEntity&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.entity.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Entity.edit&amp;target_mask=WbfsysEntity&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Aliases',
            'modal.php?c=Wbfsys.Entity_Ref_Aliases.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attributes',
            'modal.php?c=Wbfsys.Entity_Ref_Attributes.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Categories',
            'modal.php?c=Wbfsys.Entity_Ref_Categories.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'References',
            'modal.php?c=Wbfsys.Entity_Ref_References.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Managements',
            'modal.php?c=Wbfsys.Entity_Ref_Managements.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'File Types',
            'modal.php?c=Wbfsys.Entity_Ref_FileType.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Entity.delete&amp;target_mask=WbfsysEntity&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.entity.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Access Key', 'wbfsys.entity.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Relevance', 'wbfsys.entity.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Module', 'wbfsys.entity.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Entity.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_access_key'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_relevance'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Entity_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entitys." >{$iconDelete} Delete selected Entitys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entitys. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Entity_Multi.deleteAll" >{$iconClean} Delete all Entitys</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntity_Table_Element
