...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entitys
  *
  ...
  *  }
  *
  * @return WbfsysEntity_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntity_Table_Element( 'tableWbfsysEntity', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entitys', 'wbfsys.entity.label' );
      ...
      $searchElement->searchKey = 'wbfsys_entity';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntity_Table_Element( null,$view );
...
}//end class WbfsysEntity_Table_Ui
