 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntity entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Entity.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Entity.insert';
    $params->formId       = 'wgt-form-wbfsys_entity';
    $params->namespace   = 'wbfsys_entity-create';
    ...
    $this->setTemplate( 'wbfsys/entity/modal/crud/form_create' );
...
}//end class WbfsysEntity_Crud_Create_Modal_View
