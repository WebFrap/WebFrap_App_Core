 ...
 * @licence WebFrap.net
 */
class WbfsysEntity_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntity Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Entity.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity';
    ...
    $form = $this->newForm( 'WbfsysEntity_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Entity.create');}});
});
...
}//end class WbfsysEntity_Crud_Create_Maintab_View
