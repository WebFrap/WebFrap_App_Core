 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityAlias_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityAlias Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityAlias = $this->model->getEntityWbfsysEntityAlias();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Entity Alias: {@text@}',
      'wbfsys.entity_alias.label',
      array( 'text' => $entityWbfsysEntityAlias->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityAlias.show  &amp;objid='.$entityWbfsysEntityAlias
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityAlias.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_alias-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_alias/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityAlias_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityAlias.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_alias' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_alias a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityAlias.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityAlias.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityAlias_Crud_Show_Maintab_View
