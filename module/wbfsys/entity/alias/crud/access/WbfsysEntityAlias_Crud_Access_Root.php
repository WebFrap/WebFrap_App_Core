 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityAlias_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityAlias_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityAlias_Entity */
      $entity = $orm->get( 'WbfsysEntityAlias', $rootId );
    }
...
}//end class WbfsysEntityAlias_Crud_Access_Root
