 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityAlias entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityAlias.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityAlias.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_alias';
    $params->namespace   = 'wbfsys_entity_alias-create';
    ...
    $this->setTemplate( 'wbfsys/entity_alias/modal/crud/form_create' );
...
}//end class WbfsysEntityAlias_Crud_Create_Modal_View
