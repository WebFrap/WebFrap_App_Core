 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityAlias Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_alias-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_alias/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityAlias.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_alias';
    ...
    $form = $this->newForm( 'WbfsysEntityAlias_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityAlias.create');}});
});
...
}//end class WbfsysEntityAlias_Crud_Create_Maintab_View
