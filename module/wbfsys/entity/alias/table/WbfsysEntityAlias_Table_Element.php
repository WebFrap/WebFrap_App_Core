 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_alias';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityAlias_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityAlias.show&amp;target_mask=WbfsysEntityAlias&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityAlias.edit&amp;target_mask=WbfsysEntityAlias&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_alias.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityAlias.delete&amp;target_mask=WbfsysEntityAlias&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_alias.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.entity_alias.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_alias_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.EntityAlias.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_alias_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityAlias_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Alias." >{$iconDelete} Delete selected Entity Alias</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Alias. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityAlias_Multi.deleteAll" >{$iconClean} Delete all Entity Alias</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityAlias_Table_Element
