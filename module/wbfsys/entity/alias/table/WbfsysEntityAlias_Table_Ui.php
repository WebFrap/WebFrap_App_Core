 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Alias
  *
  ...
  *  }
  *
  * @return WbfsysEntityAlias_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAlias_Table_Element( 'tableWbfsysEntityAlias', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_alias-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Alias', 'wbfsys.entity_alias.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_alias';
      ...
      $searchElement->searchKey = 'wbfsys_entity_alias';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityAlias_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityAlias', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityAlias listing maske
   *
   * @param WbfsysEntityAlias_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityAlias_Table_Ui
