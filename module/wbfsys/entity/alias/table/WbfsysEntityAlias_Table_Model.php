 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityAlias_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityAlias_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysEntityAlias_Table_Model
