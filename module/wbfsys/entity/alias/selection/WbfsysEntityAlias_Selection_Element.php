 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_entity_alias';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityAlias.show&amp;target_mask=WbfsysEntityAlias&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityAlias.edit&amp;target_mask=WbfsysEntityAlias&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_alias.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityAlias.delete&amp;target_mask=WbfsysEntityAlias&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_alias.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_alias_name'])).'</td>'.NL;
...
}//end class WbfsysEntityAlias_Selection_Element
