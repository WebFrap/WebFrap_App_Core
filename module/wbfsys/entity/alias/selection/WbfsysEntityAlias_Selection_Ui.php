 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAlias_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityAlias_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityAlias_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAlias_Selection_Element
    (
      'selectionWbfsysEntityAlias',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Alias', 'wbfsys.entity_alias.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityAlias.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityAlias',
      'WbfsysEntityAlias_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityAlias_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityAlias_Selection_Ui
