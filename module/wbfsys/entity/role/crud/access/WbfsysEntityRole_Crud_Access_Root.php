 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityRole_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityRole_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityRole_Entity */
      $entity = $orm->get( 'WbfsysEntityRole', $rootId );
    }
...
}//end class WbfsysEntityRole_Crud_Access_Root
