 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityRole Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_role-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_role/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityRole.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_role';
    ...
    $form = $this->newForm( 'WbfsysEntityRole_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityRole.create');}});
});
...
}//end class WbfsysEntityRole_Crud_Create_Maintab_View
