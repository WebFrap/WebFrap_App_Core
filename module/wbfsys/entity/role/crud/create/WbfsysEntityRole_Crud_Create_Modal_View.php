 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityRole entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityRole.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityRole.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_role';
    $params->namespace   = 'wbfsys_entity_role-create';
    ...
    $this->setTemplate( 'wbfsys/entity_role/modal/crud/form_create' );
...
}//end class WbfsysEntityRole_Crud_Create_Modal_View
