 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityRole Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityRole = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Role: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityRole.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityRole
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityRole.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_role-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_role/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityRole_Crud_Edit' );
...
}//end class WbfsysEntityRole_Crud_Edit_Maintab_View
