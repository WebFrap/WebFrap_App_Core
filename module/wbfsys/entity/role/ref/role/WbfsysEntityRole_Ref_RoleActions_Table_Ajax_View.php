 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Ref_RoleActions_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.EntityRole_Ref_RoleActions.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysEntityRole_Ref_RoleActions_Table_Ajax_View
