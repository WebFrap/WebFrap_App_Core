 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Ref_RoleActions_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   *
   * @param int $idWbfsysEntityRole
   * @param LibSqlQuery $data
   * @param LibAclContainer $access
   * @param TFlag $params named parameters
   *
   * @return WbfsysEntityRole_Ref_RoleActions_Table_Element
   */
  public function createListItem( $idWbfsysEntityRole, $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityRole_Ref_RoleActions_Table_Element
    (
      'tableRoleActions',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mod-wbfsys-cat-core_data-conref-role_actions'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-role_actions-'.$idWbfsysEntityRole;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_role-ref-role_actions-search-'
        .$idWbfsysEntityRole;
    ...
    $tabPanel->searchKey = 'wbfsys_entity_role-ref-role_actions';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Acl Action',
            '$R.post(\'maintab.php?c=Wbfsys.EntityRoleActions.create&refid='.$params->refId.'&target_mask=WbfsysEntityRole_Ref_RoleActions&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_role_actions[id_role]\':\''.$params->refIdRoleActions.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'showTabRoleActions', true );
    $view->addVar( 'refIdRoleActions', $idWbfsysEntityRole );
    $view->addVar
    (
      'searchFormActionRoleActions',
      'ajax.php?c=Wbfsys.EntityRole_Ref_RoleActions.search&amp;target_id='
        .$table->id.'&amp;objid='.$idWbfsysEntityRole
    );
   ...
   * @return WbfsysEntityRole_Ref_RoleActions_Table_Element
   */
  public function getListItem( $idWbfsysEntityRole, $data, $access, $params  )
  {
   ...
   * @return WbfsysEntityRole_Ref_RoleActions_Table_Element
   */
  public function listEntry( $idRoleActions, $access, $params, $insertMode )
  {
    ...
    // if a table id is given use it for the table
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-role_actions-'.$idRoleActions;
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowRoleActions', $table->buildAjax() );
...
JSCODE;
   ...
   *
   * @param int $objid
   * @param WbfsysEntityRole_Table_Model $model
   * @param TFlag $params
   * @return boolean
   */
  public function searchForm( $objid, $model, $params = null )
  {
    ...
    $entityWbfsysEntityRoleActions  = $model->getEntityWbfsysEntityRoleActions();
    ...
    $formWbfsysEntityRoleActions->setKeyName( 'wbfsys_entity_role_actions' );
...
}//end class WbfsysEntityRole_Ref_RoleActions_Table_Ui
