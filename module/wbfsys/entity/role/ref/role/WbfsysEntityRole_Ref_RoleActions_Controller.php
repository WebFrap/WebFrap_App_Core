 ...
 * If you want to extend this class write your coden in ControllerWbfsysEntityRole
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Ref_RoleActions_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des role_actions Referenztabs
  * für den wbfsys_entity_role management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysEntityRole_Ref_RoleActions_".$listType."_Access";
    ...
    $accessRoleActions = new $containerClass( );
    $accessRoleActions->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-role_actions';

    $params->accessRoleActions = $accessRoleActions;
    $params->paramsRoleActions = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessRoleActions->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_entity_role-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysEntityRole_Ref_RoleActions_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelRoleActions = $this->loadModel
    (
      'WbfsysEntityRole_Ref_RoleActions_'.$listType
    );
    $modelRoleActions->setAccess( $accessRoleActions );
    
    $view->setModel( $modelRoleActions );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysEntityRole_Ref_RoleActions_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_entity_role-ref-role_actions-'.$listType.'-ajax',
    	'WbfsysEntityRole_Ref_RoleActions_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysEntityRoleActions by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_acl_action' ); //def wbfsys_acl_action
    $this->request->removePost( 'wbfsys_entity_role_actions' ); //def wbfsys_entity_role_actions


  } // end public function cleanPost */

 /**
  * connect existining WbfsysAclAction to a WbfsysEntityRole
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mod-wbfsys-cat-core_data-ref-role_actions'
    );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-role_actions';

    $params->accessRoleActions = $access;
    $params->paramsRoleActions = $params;

    $model  = $this->loadModel( 'WbfsysEntityRole_Ref_RoleActions_Crud' );
    ...
    $entityWbfsysAclAction = $orm->get( 'WbfsysAclAction', $refId );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysEntityRole_Ref_RoleActions_'.$listType );
      $listModel = $this->loadModel( 'WbfsysEntityRole_Ref_RoleActions_'.$listType );
      $listModel->setAccess( $access );
      $ui->setModel( $listModel );

      if( !$ui->listEntry
      ( 
        $conEntiy->getData( 'id_action' ), 
        $access, 
        $params, 
        true 
      ))
...
} // end WbfsysEntityRole_Ref_RoleActions_Controller
