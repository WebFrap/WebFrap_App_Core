 ...
 *
 * @package WebFrap
 * @subpackage ModEntityRole
 * @author Dominik Bonsch <dominik.bonsch@s-db.de>
 * @copyright Softwareentwicklung Dominik Bonsch <contact@webfrap.de>
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_entity_role
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.EntityRole.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_entity_role-create';

    $access = new WbfsysEntityRole_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_entity_role-create',
      'WbfsysEntityRole_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysEntityRole_Crud_Model */
    $model = $this->loadModel( 'WbfsysEntityRole_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.EntityRole.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysEntityRole = $model->getEntityWbfsysEntityRole( $objid );
    ...
    $params->entity = $entityWbfsysEntityRole;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_entity_role:edit';

    $access = new WbfsysEntityRole_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRole );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_entity_role-edit-'.$objid,
      'WbfsysEntityRole_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'wbfsys_entity_role:show';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_entity_role
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.EntityRole.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-insert';

    $access = new WbfsysEntityRole_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysEntityRole = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_entity_role-update-'.$entityWbfsysEntityRole;
      ...
      {
        $access = new WbfsysEntityRole_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRole );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysEntityRole';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_entity_role',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysEntityRole_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.EntityRole.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysEntityRole, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysEntityRole_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityRole.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-delete-'.$objid;

    $access = new WbfsysEntityRole_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRole );
    ...
    $error = $model->delete( $entityWbfsysEntityRole, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysEntityRole, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityRole.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.EntityRole.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-listing';
    ...
    $containerClass = 'WbfsysEntityRole_'.$listType.'_Access';
    ...
    /* @var $model WbfsysEntityRole_Table_Model */
    $model = $this->loadModel( 'WbfsysEntityRole_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysEntityRole
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysEntityRole_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_entity_role',
      'WbfsysEntityRole_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysEntityRole_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.EntityRole.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityRole_Selection_Model */
    $model   = $this->loadModel( 'WbfsysEntityRole_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_entity_role-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_entity_role-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_entity_role',
      'WbfsysEntityRole',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysEntityRole, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysEntityRole_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysEntityRole_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysEntityRole_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysEntityRole, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_entity_role' ); //def wbfsys_entity_role
...
} // end class WbfsysEntityRole_Controller */
