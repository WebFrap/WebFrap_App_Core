 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_role_actions';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityRoleActions';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityRoleActions' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityRoleActions entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_role( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityRole_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Role (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ));
      ...
      $inputIdRole->setLabel( $this->view->i18n->l( 'Role', 'wbfsys.entity_role_actions.label' ) );
  ...
  * @return void
  */
  public function input_id_action( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAclAction_Entity' ) )
    {
      ...
      $inputIdAction = $this->view->newInput( 'input'.$this->prefix.'IdAction', 'Window' );
      $inputIdAction->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_action]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_action'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Action (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ));
      ...
      $inputIdAction->setReadOnly( $this->isReadOnly( 'id_action' ) );
      $inputIdAction->setLabel( $this->view->i18n->l( 'Action', 'wbfsys.entity_role_actions.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.AclAction.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_action'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdAction->buildJavascript( 'wgt-input-'.$this->keyName.'_id_action'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_action */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_role_actions.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_role_actions.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_role_actions.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_role_actions.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_role_actions.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_role_actions.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity Role Actions)', 'wbfsys.entity_role_actions.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_role_actions.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_role_actions_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_role_actions_m_role_change';
...
}//end class WbfsysEntityRoleActions_Form */
