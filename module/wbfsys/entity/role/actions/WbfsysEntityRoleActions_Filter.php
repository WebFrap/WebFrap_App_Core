 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_entity_role_actions') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = wbfsys_entity_role_actions.{$fieldName}
...
}//end class WbfsysEntityRoleActions_Filter
