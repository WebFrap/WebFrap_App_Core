 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityRoleActions Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityRoleActions = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Role Actions: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityRoleActions.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityRoleActions
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityRoleActions.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_role_actions-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_role_actions/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityRoleActions_Crud_Edit' );
...
}//end class WbfsysEntityRoleActions_Crud_Edit_Maintab_View
