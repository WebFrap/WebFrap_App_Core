 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityRoleActions entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityRoleActions.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityRoleActions.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_role_actions';
    $params->namespace   = 'wbfsys_entity_role_actions-create';
    ...
    $this->setTemplate( 'wbfsys/entity_role_actions/modal/crud/form_create' );
...
}//end class WbfsysEntityRoleActions_Crud_Create_Modal_View
