 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysEntityRoleActions_IdRole( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntityRole_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.EntityRole.selection&amp;context=create'
  ...
  */
  public function input_WbfsysEntityRoleActions_IdAction( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysAclAction_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.AclAction.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysEntityRoleActions', array_keys( $this->fields['wbfsys_entity_role_actions']), true ),
...
}//end class WbfsysEntityRoleActions_Crud_Create_Form */
