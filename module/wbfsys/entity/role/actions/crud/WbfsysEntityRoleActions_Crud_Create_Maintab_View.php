 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityRoleActions Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Entity Role Actions',
      'wbfsys.entity_role_actions.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Entity Role Actions',
      'wbfsys.entity_role_actions.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_role_actions-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_role_actions/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityRoleActions.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_role_actions';
    ...
    $form = $this->newForm( 'WbfsysEntityRoleActions_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityRoleActions.create');}});
});
...
}//end class WbfsysEntityRoleActions_Crud_Create_Maintab_View
