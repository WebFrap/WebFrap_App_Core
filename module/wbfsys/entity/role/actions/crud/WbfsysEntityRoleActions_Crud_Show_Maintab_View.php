 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityRoleActions Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityRoleActions = $this->model->getEntityWbfsysEntityRoleActions();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Entity Role Actions: {@text@}',
      'wbfsys.entity_role_actions.label',
      array( 'text' => $entityWbfsysEntityRoleActions->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Entity Role Actions: {@text@}',
      'wbfsys.entity_role_actions.label',
      array( 'text' => $entityWbfsysEntityRoleActions->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityRoleActions.show  &amp;objid='.$entityWbfsysEntityRoleActions
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityRoleActions.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_role_actions-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_role_actions/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityRoleActions_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityRoleActions.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_role_actions' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_role_actions a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityRoleActions.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityRoleActions.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityRoleActions_Crud_Show_Maintab_View
