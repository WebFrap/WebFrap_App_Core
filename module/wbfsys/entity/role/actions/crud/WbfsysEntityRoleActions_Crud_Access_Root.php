 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityRoleActions_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityRoleActions_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityRoleActions_Entity */
      $entity = $orm->get( 'WbfsysEntityRoleActions', $rootId );
    }
...
}//end class WbfsysEntityRoleActions_Crud_Access_Root
