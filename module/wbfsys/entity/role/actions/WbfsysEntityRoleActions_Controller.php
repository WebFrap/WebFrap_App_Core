 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_entity_role_actions
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.EntityRoleActions.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_entity_role_actions-create';

    $access = new WbfsysEntityRoleActions_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_entity_role_actions-create',
      'WbfsysEntityRoleActions_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysEntityRoleActions_Crud_Model */
    $model = $this->loadModel( 'WbfsysEntityRoleActions_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.EntityRoleActions.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysEntityRoleActions = $model->getEntityWbfsysEntityRoleActions( $objid );
    ...
    $params->entity = $entityWbfsysEntityRoleActions;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_entity_role_actions:edit';

    $access = new WbfsysEntityRoleActions_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRoleActions );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_entity_role_actions-edit-'.$objid,
      'WbfsysEntityRoleActions_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_entity_role_actions-edit',
          $entityWbfsysEntityRoleActions,
          'Edit Entity Role Actions :'.$entityWbfsysEntityRoleActions->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_entity_role_actions';
      $params->maskRoot      = 'wbfsys_entity_role_actions:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_entity_role_actions';
      $params->aclNode       = 'mgmt-wbfsys_entity_role_actions';
      $params->aclLevel      = 1;
    }
    ...
    (
      'form-wbfsys_entity_role_actions-edit-'.$objid,
      'WbfsysEntityRoleActions_Crud_Show',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_entity_role_actions-show',
          $entityWbfsysEntityRoleActions,
          'Show Entity Role Actions :'.$entityWbfsysEntityRoleActions->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_entity_role_actions
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.EntityRoleActions.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-insert';

    $access = new WbfsysEntityRoleActions_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysEntityRoleActions = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_entity_role_actions-update-'.$entityWbfsysEntityRoleActions;
      ...
      {
        $access = new WbfsysEntityRoleActions_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRoleActions );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysEntityRoleActions';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_entity_role_actions',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysEntityRoleActions_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.EntityRoleActions.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysEntityRoleActions, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysEntityRoleActions_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityRoleActions.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-delete-'.$objid;

    $access = new WbfsysEntityRoleActions_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysEntityRoleActions );
    ...
    $error = $model->delete( $entityWbfsysEntityRoleActions, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysEntityRoleActions, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.EntityRoleActions.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.EntityRoleActions.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-listing';
    ...
    $containerClass = 'WbfsysEntityRoleActions_'.$listType.'_Access';
    ...
    (
      'listing_wbfsys_entity_role_actions',
      'WbfsysEntityRoleActions_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model WbfsysEntityRoleActions_Table_Model */
    $model = $this->loadModel( 'WbfsysEntityRoleActions_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_entity_role_actions-'.$params->ltype,
          'WbfsysEntityRoleActions',
          'List of Entity Role Actionss'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysEntityRoleActions
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysEntityRoleActions_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_entity_role_actions',
      'WbfsysEntityRoleActions_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysEntityRoleActions_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.EntityRoleActions.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityRoleActions_Selection_Model */
    $model   = $this->loadModel( 'WbfsysEntityRoleActions_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_entity_role_actions-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_entity_role_actions-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_entity_role_actions',
      'WbfsysEntityRoleActions',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysEntityRoleActions, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysEntityRoleActions_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysEntityRoleActions_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_entity_role_actions-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysEntityRoleActions_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysEntityRoleActions, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_entity_role_actions' );
...
} // end class WbfsysEntityRoleActions_Controller */
