 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_entity_role_actions.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysEntityRoleActions_Acl_Dset_Treetable_Query_Postgresql */
