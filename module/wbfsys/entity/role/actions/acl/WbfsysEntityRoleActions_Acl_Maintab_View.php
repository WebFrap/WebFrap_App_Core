 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var WbfsysEntityRoleActions_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityRoleActions_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_role_actions-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.EntityRoleActions_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_entity_role_actions-acl-update';
    ...
    $this->setTemplate( 'wbfsys/entity_role_actions/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Entity Role Actions', 'wbfsys.entity_role_actions.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_entity_role_actions_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysEntityRoleActions_Acl' );
...
} // end class WbfsysEntityRoleActions_Acl_Maintab_View */
