 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysEntityRoleActions_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityRoleActions_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL Entity Role Actions', 
        'wbfsys.entity_role_actions.label' 
      ) 
    );
    $table->setSearchKey( 'wbfsys_entity_role_actions-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Entity Role Actions', 'wbfsys.entity_role_actions.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_entity_role_actions_acl';
...
WGTJS;
  ...
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    (
      'listingAclTable',
      'WbfsysEntityRoleActions_Acl_Table'
    );
...
} // end class WbfsysEntityRoleActions_Acl_Ui */
