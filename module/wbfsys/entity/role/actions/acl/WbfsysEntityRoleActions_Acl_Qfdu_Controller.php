 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysEntityRoleActions_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_entity_role_actions-acl-qfdu-aAjax',
      'WbfsysEntityRoleActions_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysEntityRoleActions_Acl_Qfdu_Controller */
