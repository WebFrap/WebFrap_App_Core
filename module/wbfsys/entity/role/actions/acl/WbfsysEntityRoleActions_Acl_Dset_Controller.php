 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityRoleActions_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysEntityRoleActions_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysEntityRoleActions = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysEntityRoleActions_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_entity_role_actions-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysEntityRoleActions, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'wbfsys_entity_role_actions-acl-dset', 
    	'WbfsysEntityRoleActions_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysEntityRoleActions_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_entity_role_actions-acl-dset', 
    	'WbfsysEntityRoleActions_Acl_Dset',
...
} // end class WbfsysEntityRoleActions_Acl_Dset_Controller */
