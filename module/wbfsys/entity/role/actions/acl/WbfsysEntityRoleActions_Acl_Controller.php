 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysEntityRoleActions
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysEntityRoleActions_Acl_Access_Container( null, null, $this );
    ...
    (
      'wbfsys_entity_role_actions_acl_listing',
      'WbfsysEntityRoleActions_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('WbfsysEntityRoleActions_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityRoleActions_Acl_Model */
    $model   = $this->loadModel( 'WbfsysEntityRoleActions_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_entity_role_actions-acl',
    	'WbfsysEntityRoleActions_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_entity_role_actions_acl_masks_listing',
      'WbfsysEntityRoleActions_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysEntityRoleActions_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysEntityRoleActions_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysEntityRoleActions_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysEntityRoleActions_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysEntityRoleActions_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysEntityRoleActions_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_entity_role_actions-acl-qfdu',
    	'WbfsysEntityRoleActions_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysEntityRoleActions_Acl_Controller */
