 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysEntityRoleActions_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysEntityRoleActions_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysEntityRoleActions, $areaId, $access, $params  )
  {

    $listObj = new WbfsysEntityRoleActions_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_entity_role_actions-acl-dset' );
    ...
    else
    {
      ...
      (
        'Entity Role Actions "{@label@}" User Access',
        'wbfsys.entity_role_actions.label',
        array
        (
          'label' => $entityWbfsysEntityRoleActions->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_entity_role_actions_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysEntityRoleActions_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysEntityRoleActions_Acl_Dset_Ui */
