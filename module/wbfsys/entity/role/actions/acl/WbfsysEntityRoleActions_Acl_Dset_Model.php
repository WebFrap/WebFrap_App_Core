 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_entity_role_actions'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysEntityRoleActions', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityRoleActions_Acl_Dset' );
    /* @var $query WbfsysEntityRoleActions_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityRoleActions_Acl_Dset_Treetable' );
    /* @var $query WbfsysEntityRoleActions_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysEntityRoleActions_Acl_Dset_Model */
