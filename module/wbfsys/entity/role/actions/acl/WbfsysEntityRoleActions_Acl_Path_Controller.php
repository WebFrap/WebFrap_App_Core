 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_entity_role_actions_acl_graph', 
      'WbfsysEntityRoleActions_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysEntityRoleActions_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysEntityRoleActions_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysEntityRoleActions_Acl_Path_Maintab_View  */
...
} // end class WbfsysEntityRoleActions_Acl_Path_Controller */
