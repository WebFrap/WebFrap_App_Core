 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_entity_role_actions.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_entity_role_actions.rowid as id,
    wbfsys_entity_role_actions.rowid as value,
    wbfsys_entity_role_actions.rowid as label
  FROM
...
} // end class WbfsysEntityRoleActions_Acl_Qfdu_Query_Postgresql */
