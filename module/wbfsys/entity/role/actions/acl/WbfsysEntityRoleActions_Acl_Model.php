 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_entity_role_actions' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-wbfsys_entity_role_actions' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WbfsysEntityRoleActions_Acl_Table' );
    /* @var $query WbfsysEntityRoleActions_Acl_Table_Query  */
...
} // end class WbfsysEntityRoleActions_Acl_Model */
