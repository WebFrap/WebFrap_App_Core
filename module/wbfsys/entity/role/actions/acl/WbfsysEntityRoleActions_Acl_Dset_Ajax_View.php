 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysEntityRoleActions_Acl_Dset' );
    ...
    $entityWbfsysEntityRoleActions = $this->model->getEntity( $dsetId );
...
} // end class WbfsysEntityRoleActions_Acl_Dset_Ajax_View */
