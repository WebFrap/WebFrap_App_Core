 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_role_actions/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_entity_role_actions-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-wbfsys_entity_role_actions-acl-path-access_level',
      'class' => 'medium',
...
} // end class WbfsysEntityRoleActions_Acl_Path_Maintab_View */
