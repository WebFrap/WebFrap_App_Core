 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_entity_role_actions')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysEntityRoleActions = $orm->get('WbfsysEntityRoleActions', $data['wbfsys_group_users']->vid);

    }
    $tabData['wbfsys_entity_role_actions_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysEntityRoleActions_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityRoleActions_Acl' );
    /* @var $query WbfsysEntityRoleActions_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityRoleActions_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysEntityRoleActions_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysEntityRoleActions_Acl_Qfdu' );
    /* @var $query WbfsysEntityRoleActions_Acl_Qfdu_Query  */
...
} // end class WbfsysEntityRoleActions_Acl_Qfdu_Model */
