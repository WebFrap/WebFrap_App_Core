 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysEntityRoleActions_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysEntityRoleActions_Export_Listing_Access';
    ...
    // create a new WbfsysEntityRoleActions window
    $view = $this->loadView
    (
    	'export-wbfsys_entity_role_actions',
    	'WbfsysEntityRoleActions_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysEntityRoleActions_Export' );
...
} // end class WbfsysEntityRoleActions_Export_Controller_Genf
