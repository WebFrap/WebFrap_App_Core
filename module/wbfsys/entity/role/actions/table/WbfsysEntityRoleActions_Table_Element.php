 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_role_actions';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityRoleActions_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityRoleActions.show&amp;target_mask=WbfsysEntityRoleActions&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityRoleActions.edit&amp;target_mask=WbfsysEntityRoleActions&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_role_actions.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityRoleActions.delete&amp;target_mask=WbfsysEntityRoleActions&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_role_actions.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_entity_role_actions&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.entity_role_actions.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_role_actions_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityRoleActions_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Role Actions." >{$iconDelete} Delete selected Entity Role Actions</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Role Actions. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityRoleActions_Multi.deleteAll" >{$iconClean} Delete all Entity Role Actions</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityRoleActions_Table_Element
