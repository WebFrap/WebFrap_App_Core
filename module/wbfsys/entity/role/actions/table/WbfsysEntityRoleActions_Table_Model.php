 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityRoleActions_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityRoleActions_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysEntityRoleActions_Table_Model
