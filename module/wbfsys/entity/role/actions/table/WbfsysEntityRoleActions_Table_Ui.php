 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Role Actions
  *
  ...
  *  }
  *
  * @return WbfsysEntityRoleActions_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityRoleActions_Table_Element( 'tableWbfsysEntityRoleActions', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_role_actions-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Role Actions', 'wbfsys.entity_role_actions.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_role_actions';
      ...
      $searchElement->searchKey = 'wbfsys_entity_role_actions';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityRoleActions_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityRoleActions', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityRoleActions listing maske
   *
   * @param WbfsysEntityRoleActions_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityRoleActions_Table_Ui
