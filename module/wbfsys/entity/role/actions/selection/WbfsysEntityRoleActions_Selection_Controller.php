 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityRoleActions_Selection' ) );
...
} // end class WbfsysEntityRoleActions_Selection_Controller */
