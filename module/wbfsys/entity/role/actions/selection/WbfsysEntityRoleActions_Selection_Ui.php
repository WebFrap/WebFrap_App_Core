 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityRoleActions_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityRoleActions_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityRoleActions_Selection_Element
    (
      'selectionWbfsysEntityRoleActions',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Role Actions', 'wbfsys.entity_role_actions.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityRoleActions.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityRoleActions',
      'WbfsysEntityRoleActions_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityRoleActions_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityRoleActions_Selection_Ui
