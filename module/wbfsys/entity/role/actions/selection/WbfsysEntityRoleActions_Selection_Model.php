 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRoleActions_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    if( $free = $httpRequest->param( 'free_search' , Validator::TEXT ) )
      ...
      if( $mRoleCreate = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::EID, 'm_role_create'   ) )
        $condition['wbfsys_entity_role_actions']['m_role_create'] = $mRoleCreate;

      if( $mRoleChange = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::EID, 'm_role_change'   ) )
        $condition['wbfsys_entity_role_actions']['m_role_change'] = $mRoleChange;

      if( $mTimeCreatedBefore = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::DATE, 'm_time_created_before'   ) )
        $condition['wbfsys_entity_role_actions']['m_time_created_before'] = $mTimeCreatedBefore;

      if( $mTimeCreatedAfter = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::DATE, 'm_time_created_after'   ) )
        $condition['wbfsys_entity_role_actions']['m_time_created_after'] = $mTimeCreatedAfter;

      if( $mTimeChangedBefore = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::DATE, 'm_time_changed_before'   ) )
        $condition['wbfsys_entity_role_actions']['m_time_changed_before'] = $mTimeChangedBefore;

      if( $mTimeChangedAfter = $httpRequest->param( 'search_wbfsys_entity_role_actions}', Validator::DATE, 'm_time_changed_after'   ) )
        $condition['wbfsys_entity_role_actions']['m_time_changed_after'] = $mTimeChangedAfter;

      if( $mRowid = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::EID, 'm_rowid'   ) )
        $condition['wbfsys_entity_role_actions']['m_rowid'] = $mRowid;

      if( $mUuid = $httpRequest->param( 'search_wbfsys_entity_role_actions', Validator::TEXT, 'm_uuid'    ) )
        $condition['wbfsys_entity_role_actions']['m_uuid'] = $mUuid;
    ...
    $query = $db->newQuery( 'WbfsysEntityRoleActions_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityRoleActions_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
    ...
    if( $params->exclude )
    {
      ...
      $excludeCond = ' wbfsys_entity_role_actions.rowid NOT IN '
  ...
  public function searchForm( $view )
  {
    ...
    $formWbfsysEntityRoleActions->setNamespace( 'WbfsysEntityRoleActions' );
    $formWbfsysEntityRoleActions->setPrefix( 'WbfsysEntityRoleActions' );
    $formWbfsysEntityRoleActions->createSearchForm
    (
      $entityWbfsysEntityRoleActions,
      ( isset($searchFields['wbfsys_entity_role_actions'])?$searchFields['wbfsys_entity_role_actions']:array() )
    );
...
}//end class WbfsysEntityRoleActions_Selection_Model
