 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_role';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityRole_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityRole.show&amp;target_mask=WbfsysEntityRole&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityRole.edit&amp;target_mask=WbfsysEntityRole&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_role.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Actions',
            'modal.php?c=Wbfsys.EntityRole_Ref_RoleActions.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.entity_role.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityRole.delete&amp;target_mask=WbfsysEntityRole&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_role.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_role_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityRole_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Roles." >{$iconDelete} Delete selected Entity Roles</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Roles. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityRole_Multi.deleteAll" >{$iconClean} Delete all Entity Roles</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityRole_Table_Element
