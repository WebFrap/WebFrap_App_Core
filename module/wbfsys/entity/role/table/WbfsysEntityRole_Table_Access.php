 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityRole_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_entity_role.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_entity_role.rowid ",
      'acls'
    );
...
}//end class WbfsysEntityRole_Table_Access
