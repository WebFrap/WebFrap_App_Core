 ...
 * @licence WebFrap.net
 */
class WbfsysEntityRole_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Roles
  *
  ...
  *  }
  *
  * @return WbfsysEntityRole_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityRole_Table_Element( 'tableWbfsysEntityRole', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_role-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Roles', 'wbfsys.entity_role.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_role';
      ...
      $searchElement->searchKey = 'wbfsys_entity_role';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityRole_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityRole', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityRole listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityRole  = $model->getEntityWbfsysEntityRole();
    ...
    $formWbfsysEntityRole->setKeyName( 'wbfsys_entity_role' );
...
}//end class WbfsysEntityRole_Table_Ui
