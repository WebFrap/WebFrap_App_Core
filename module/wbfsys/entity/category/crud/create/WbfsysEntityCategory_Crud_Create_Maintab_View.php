 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityCategory Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_category-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_category/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityCategory.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_category';
    ...
    $form = $this->newForm( 'WbfsysEntityCategory_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityCategory.create');}});
});
...
}//end class WbfsysEntityCategory_Crud_Create_Maintab_View
