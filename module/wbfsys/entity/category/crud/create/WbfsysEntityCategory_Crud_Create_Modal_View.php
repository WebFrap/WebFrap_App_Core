 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityCategory entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityCategory.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityCategory.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_category';
    $params->namespace   = 'wbfsys_entity_category-create';
    ...
    $this->setTemplate( 'wbfsys/entity_category/modal/crud/form_create' );
...
}//end class WbfsysEntityCategory_Crud_Create_Modal_View
