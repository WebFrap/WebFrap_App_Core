 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityCategory_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityCategory_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityCategory_Entity */
      $entity = $orm->get( 'WbfsysEntityCategory', $rootId );
    }
...
}//end class WbfsysEntityCategory_Crud_Access_Root
