 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityCategory_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityCategory Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityCategory = $this->model->getEntityWbfsysEntityCategory();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Entity Category: {@text@}',
      'wbfsys.entity_category.label',
      array( 'text' => $entityWbfsysEntityCategory->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityCategory.show  &amp;objid='.$entityWbfsysEntityCategory
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityCategory.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_category-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_category/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityCategory_Crud_Show' );
    ...
    if( $params->access->getPathLevel( 'mod-wbfsys-cat-core_data-ref-comments' ) || $params->access->getPathLevel( 'mgmt-wbfsys_entity_category-ref-comments' ) )
    {
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityCategory.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_category' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_category a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityCategory.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityCategory.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityCategory_Crud_Show_Maintab_View
