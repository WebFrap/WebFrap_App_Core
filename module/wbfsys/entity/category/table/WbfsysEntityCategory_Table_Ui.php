 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Categorys
  *
  ...
  *  }
  *
  * @return WbfsysEntityCategory_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityCategory_Table_Element( 'tableWbfsysEntityCategory', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Categorys', 'wbfsys.entity_category.label' );
      ...
      $searchElement->searchKey = 'wbfsys_entity_category';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityCategory_Table_Element( null,$view );
...
}//end class WbfsysEntityCategory_Table_Ui
