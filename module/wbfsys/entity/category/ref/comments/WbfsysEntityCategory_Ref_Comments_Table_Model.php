 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Ref_Comments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * table to list all connected WbfsysEntityCategory
   *
   * @param int $idWbfsysEntityCategory the id for the reference entity
   * @param TFlag $params named parameters
   */
  public function search( $idWbfsysEntityCategory, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityCategory_Ref_Comments_Table' );
    /* @var $query WbfsysEntityCategory_Ref_Comments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_comment.vid = '.$idWbfsysEntityCategory );
...
}//end class WbfsysEntityCategory_Ref_Comments_Table_Model
