 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.EntityCategory_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysEntityCategory_Ref_Comments_Table_Ajax_View
