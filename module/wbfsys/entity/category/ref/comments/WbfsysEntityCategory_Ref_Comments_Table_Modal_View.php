 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Ref_Comments_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'ajax.php?c=Wbfsys.EntityCategory_Ref_Comments.search&amp;objid='.$objid;

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_category-ref-comments-search-'.$objid;

    // fill the relevant data for the search form
    $this->setSearchFormData( $params, 'Comments' );

    // set the default table template
    $this->setTemplate( 'wbfsys/entity_category/ref_comments/tab_table' );

    $ui = $this->loadUi( 'WbfsysEntityCategory_Ref_Comments_Table' );
...
}//end class WbfsysEntityCategory_Ref_Comments_Table_Modal_View
