 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Ref_Comments_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityCategory_Ref_Comments_Table_Query $query
...
}//end class WbfsysEntityCategory_Ref_Comments_Table_Access
