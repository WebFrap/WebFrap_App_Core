 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityCategory_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityCategory_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityCategory_Selection_Element
    (
      'selectionWbfsysEntityCategory',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Categorys', 'wbfsys.entity_category.label' ) ;
      $tabPanel->searchKey = 'wbfsys_entity_category';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityCategory.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityCategory',
      'WbfsysEntityCategory_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityCategory' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysEntityCategory listing maske
   *
   * @param WbfsysEntityCategory_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityCategory_Selection_Ui
