 ...
 * @licence WebFrap.net
 */
class WbfsysEntityCategory_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_entity_category';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityCategory.show&amp;target_mask=WbfsysEntityCategory&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityCategory.edit&amp;target_mask=WbfsysEntityCategory&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_category.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityCategory.delete&amp;target_mask=WbfsysEntityCategory&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_category.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_entity_category_name'])).'</td>'.NL;
...
}//end class WbfsysEntityCategory_Selection_Element
