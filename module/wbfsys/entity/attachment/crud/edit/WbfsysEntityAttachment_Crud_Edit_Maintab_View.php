 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityAttachment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityAttachment = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Attachment: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityAttachment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityAttachment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityAttachment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_attachment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_attachment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityAttachment_Crud_Edit' );
...
}//end class WbfsysEntityAttachment_Crud_Edit_Maintab_View
