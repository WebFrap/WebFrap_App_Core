 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityAttachment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityAttachment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityAttachment.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_attachment';
    $params->namespace   = 'wbfsys_entity_attachment-create';
  ...
  $form->setEntityEntityFile( $this->model->getEntityEntityFile( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/entity_attachment/modal/crud/form_create' );
...
}//end class WbfsysEntityAttachment_Crud_Create_Modal_View
