 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityAttachment_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityAttachment_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityAttachment_Entity */
      $entity = $orm->get( 'WbfsysEntityAttachment', $rootId );
    }
...
}//end class WbfsysEntityAttachment_Crud_Access_Root
