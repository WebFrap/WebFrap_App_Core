 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Crud_Show_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysEntityAttachment';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysEntityAttachment';
   ...
   *
   * @var WbfsysEntityAttachment_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysEntityAttachment entity
  *
  ...
  */
  public function renderForm( $params = null  )
  {
    ...
    $this->view->addVar( 'entityWbfsysEntityAttachment', $this->entity );
  $this->view->addVar( 'entityEntityFile',  $this->entityEntityFile ) ;
    ...
    if( $this->target )
      ...
      $sendTo = 'wgt-input-wbfsys_entity_attachment'.($this->suffix?'-'.$this->suffix:'').'-tostring';
    ...
    (
      array
      (
        'name'  => 'wbfsys_entity_attachment[id_wbfsys_entity_attachment-tostring]',
        'id'    => $sendTo,
    ...
    $this->input_WbfsysEntityAttachment_Vid( $params );
    $this->input_WbfsysEntityAttachment_IdEntity( $params );
    $this->input_WbfsysEntityAttachment_IdFile( $params );
    $this->input_WbfsysEntityAttachment_Rowid( $params );
    $this->input_WbfsysEntityAttachment_MTimeCreated( $params );
    $this->input_WbfsysEntityAttachment_MRoleCreate( $params );
    $this->input_WbfsysEntityAttachment_MTimeChanged( $params );
    $this->input_WbfsysEntityAttachment_MRoleChange( $params );
    $this->input_WbfsysEntityAttachment_MVersion( $params );
    $this->input_WbfsysEntityAttachment_MUuid( $params );
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_Vid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputVid = $this->view->newInput( 'inputWbfsysEntityAttachmentVid', 'Hidden' );
      $this->items['wbfsys_entity_attachment-vid'] = $inputVid;
      $inputVid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[vid]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_vid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Vid', 'src' => 'Entity Attachment' ) ),
  ...
  }//end public function input_WbfsysEntityAttachment_Vid */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_IdEntity( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdEntity = $this->view->newInput( 'inputWbfsysEntityAttachmentIdEntity', 'Hidden' );
      $this->items['wbfsys_entity_attachment-id_entity'] = $inputIdEntity;
      $inputIdEntity->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[id_entity]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Entity', 'src' => 'Entity Attachment' ) ),
  ...
  }//end public function input_WbfsysEntityAttachment_IdEntity */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_IdFile( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdFile = $this->view->newInput( 'inputWbfsysEntityAttachmentIdFile', 'Hidden' );
      $this->items['wbfsys_entity_attachment-id_file'] = $inputIdFile;
      $inputIdFile->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[id_file]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_id_file'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'File', 'src' => 'Entity Attachment' ) ),
  ...
  }//end public function input_WbfsysEntityAttachment_IdFile */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_Rowid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputRowid = $this->view->newInput( 'inputWbfsysEntityAttachmentRowid' , 'int' );
      $this->items['wbfsys_entity_attachment-rowid'] = $inputRowid;
      $inputRowid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[rowid]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_rowid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip wcm_valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Rowid', 'src' => 'Entity Attachment' ) ),
        )
      );
      $inputRowid->setWidth( 'medium' );

      $inputRowid->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'rowid' ) );
      $inputRowid->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'rowid' ) );
      $inputRowid->setData( $this->entity->getId() );
      $inputRowid->setLabel( $i18n->l( 'Rowid', 'wbfsys.entity_attachment.label' ) );
  ...
  }//end public function input_WbfsysEntityAttachment_Rowid */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MTimeCreated( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeCreated = $this->view->newInput( 'inputWbfsysEntityAttachmentMTimeCreated' , 'Date' );
      $this->items['wbfsys_entity_attachment-m_time_created'] = $inputMTimeCreated;
      $inputMTimeCreated->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[m_time_created]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_m_time_created'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Time Created', 'src' => 'Entity Attachment' ) ),
          'maxlength' => $this->entity->maxSize( 'm_time_created' ),
        )
      );
      $inputMTimeCreated->setWidth( 'small' );

      $inputMTimeCreated->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_time_created' ) );
      $inputMTimeCreated->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_time_created' ) );
      $inputMTimeCreated->setData( $this->entity->getDate( 'm_time_created' ) );
      $inputMTimeCreated->setLabel( $i18n->l( 'Time Created', 'wbfsys.entity_attachment.label' ) );
  ...
  }//end public function input_WbfsysEntityAttachment_MTimeCreated */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MRoleCreate( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleCreate = $this->view->newInput( 'inputWbfsysEntityAttachmentMRoleCreate', 'Window' );
      $this->items['wbfsys_entity_attachment-m_role_create'] = $inputMRoleCreate;
      $inputMRoleCreate->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_entity_attachment[m_role_create]',
        'id'        => 'wgt-input-wbfsys_entity_attachment_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Role Create', 'src' => 'Entity Attachment' ) ),
      ));
      ...
      $inputMRoleCreate->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_role_create' ) );
      $inputMRoleCreate->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_role_create' ) );
      $inputMRoleCreate->setLabel( $i18n->l( 'Role Create', 'wbfsys.entity_attachment.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_entity_attachment_m_role_create'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleCreate->buildJavascript( 'wgt-input-wbfsys_entity_attachment_m_role_create'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysEntityAttachment_MRoleCreate */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MTimeChanged( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeChanged = $this->view->newInput( 'inputWbfsysEntityAttachmentMTimeChanged' , 'Date' );
      $this->items['wbfsys_entity_attachment-m_time_changed'] = $inputMTimeChanged;
      $inputMTimeChanged->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[m_time_changed]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_m_time_changed'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Time Changed', 'src' => 'Entity Attachment' ) ),
          'maxlength' => $this->entity->maxSize( 'm_time_changed' ),
        )
      );
      $inputMTimeChanged->setWidth( 'small' );

      $inputMTimeChanged->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_time_changed' ) );
      $inputMTimeChanged->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_time_changed' ) );
      $inputMTimeChanged->setData( $this->entity->getDate( 'm_time_changed' ) );
      $inputMTimeChanged->setLabel( $i18n->l( 'Time Changed', 'wbfsys.entity_attachment.label' ) );
  ...
  }//end public function input_WbfsysEntityAttachment_MTimeChanged */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MRoleChange( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleChange = $this->view->newInput( 'inputWbfsysEntityAttachmentMRoleChange', 'Window' );
      $this->items['wbfsys_entity_attachment-m_role_change'] = $inputMRoleChange;
      $inputMRoleChange->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_entity_attachment[m_role_change]',
        'id'        => 'wgt-input-wbfsys_entity_attachment_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Role Change', 'src' => 'Entity Attachment' ) ),
      ));
      ...
      $inputMRoleChange->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_role_change' ) );
      $inputMRoleChange->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_role_change' ) );
      $inputMRoleChange->setLabel( $i18n->l( 'Role Change', 'wbfsys.entity_attachment.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_entity_attachment_m_role_change'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleChange->buildJavascript( 'wgt-input-wbfsys_entity_attachment_m_role_change'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysEntityAttachment_MRoleChange */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MVersion( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMVersion = $this->view->newInput( 'inputWbfsysEntityAttachmentMVersion' , 'int' );
      $this->items['wbfsys_entity_attachment-m_version'] = $inputMVersion;
      $inputMVersion->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[m_version]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_m_version'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip wcm_valid_int medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Version', 'src' => 'Entity Attachment' ) ),
        )
      );
      $inputMVersion->setWidth( 'medium' );

      $inputMVersion->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_version' ) );
      $inputMVersion->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_version' ) );
      $inputMVersion->setData( $this->entity->getSecure( 'm_version' ) );
      $inputMVersion->setLabel( $i18n->l( 'Version', 'wbfsys.entity_attachment.label' ) );
  ...
  }//end public function input_WbfsysEntityAttachment_MVersion */
  ...
  * @return void
  */
  public function input_WbfsysEntityAttachment_MUuid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMUuid = $this->view->newInput( 'inputWbfsysEntityAttachmentMUuid' , 'Text' );
      $this->items['wbfsys_entity_attachment-m_uuid'] = $inputMUuid;
      $inputMUuid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_attachment[m_uuid]',
          'id'        => 'wgt-input-wbfsys_entity_attachment_m_uuid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Uuid', 'src' => 'Entity Attachment' ) ),
        )
      );
      $inputMUuid->setWidth( 'medium' );

      $inputMUuid->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_attachment', 'm_uuid' ) );
      $inputMUuid->setRequired( $this->fieldRequired( 'wbfsys_entity_attachment', 'm_uuid' ) );
      $inputMUuid->setData( $this->entity->getSecure( 'm_uuid' ) );
      $inputMUuid->setLabel( $i18n->l( 'Uuid', 'wbfsys.entity_attachment.label' ) );
  ...
  }//end public function input_WbfsysEntityAttachment_MUuid */
...
}//end class WbfsysEntityAttachment_Crud_Show_Form */
