 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Attachments
  *
  ...
  *  }
  *
  * @return WbfsysEntityAttachment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityAttachment_Table_Element( 'tableWbfsysEntityAttachment', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Attachments', 'wbfsys.entity_attachment.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_attachment';
      ...
      $searchElement->searchKey = 'wbfsys_entity_attachment';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityAttachment_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityAttachment', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityAttachment listing maske
   *
   * @param WbfsysEntityAttachment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityAttachment_Table_Ui
