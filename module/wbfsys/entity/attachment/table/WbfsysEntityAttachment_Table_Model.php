 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    if( $free = $httpRequest->param( 'free_search' , Validator::TEXT ) )
      ...
      if( $mRoleCreate = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::EID, 'm_role_create'   ) )
        $condition['wbfsys_entity_attachment']['m_role_create'] = $mRoleCreate;

      if( $mRoleChange = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::EID, 'm_role_change'   ) )
        $condition['wbfsys_entity_attachment']['m_role_change'] = $mRoleChange;

      if( $mTimeCreatedBefore = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::DATE, 'm_time_created_before'   ) )
        $condition['wbfsys_entity_attachment']['m_time_created_before'] = $mTimeCreatedBefore;

      if( $mTimeCreatedAfter = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::DATE, 'm_time_created_after'   ) )
        $condition['wbfsys_entity_attachment']['m_time_created_after'] = $mTimeCreatedAfter;

      if( $mTimeChangedBefore = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::DATE, 'm_time_changed_before'   ) )
        $condition['wbfsys_entity_attachment']['m_time_changed_before'] = $mTimeChangedBefore;

      if( $mTimeChangedAfter = $httpRequest->param( 'search_wbfsys_entity_attachment}', Validator::DATE, 'm_time_changed_after'   ) )
        $condition['wbfsys_entity_attachment']['m_time_changed_after'] = $mTimeChangedAfter;

      if( $mRowid = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::EID, 'm_rowid'   ) )
        $condition['wbfsys_entity_attachment']['m_rowid'] = $mRowid;

      if( $mUuid = $httpRequest->param( 'search_wbfsys_entity_attachment', Validator::TEXT, 'm_uuid'    ) )
        $condition['wbfsys_entity_attachment']['m_uuid'] = $mUuid;
    ...
    $query = $db->newQuery( 'WbfsysEntityAttachment_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityAttachment_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
    ...
    if( $params->exclude )
    {
      ...
      $excludeCond = ' wbfsys_entity_attachment.rowid NOT IN '
...
}//end class WbfsysEntityAttachment_Table_Model
