 ...
 * @licence WebFrap.net
 */
class WbfsysEntityAttachment_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityAttachment_'.$listType ) );
...
} // end class WbfsysEntityAttachment_Listing_Controller */
