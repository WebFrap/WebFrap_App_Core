 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityComment entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityComment.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityComment.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_comment';
    $params->namespace   = 'wbfsys_entity_comment-create';
  ...
  $form->setEntityEmbedComment( $this->model->getEntityEmbedComment( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/entity_comment/modal/crud/form_create' );
...
}//end class WbfsysEntityComment_Crud_Create_Modal_View
