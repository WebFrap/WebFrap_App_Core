 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityComment Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityComment = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Comment: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityComment.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityComment
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityComment.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_comment-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_comment/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityComment_Crud_Edit' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_entity_comment-simple").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityComment_Simple.edit&objid={$objid}');
    });
...
}//end class WbfsysEntityComment_Crud_Edit_Maintab_View
