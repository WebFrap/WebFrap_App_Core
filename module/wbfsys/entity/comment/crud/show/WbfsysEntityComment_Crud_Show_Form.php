 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Crud_Show_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  $this->view->addVar( 'entityEmbedComment',  $this->entityEmbedComment ) ;
    ...
    $this->input_WbfsysEntityComment_IdEntity( $params );
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_IdEntity( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdEntity = $this->view->newInput( 'inputWbfsysEntityCommentIdEntity', 'Hidden' );
      $this->items['wbfsys_entity_comment-id_entity'] = $inputIdEntity;
      $inputIdEntity->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment[id_entity]',
          'id'        => 'wgt-input-wbfsys_entity_comment_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $i18n->l( 'Insert value for {@attr@} ({@src@})', 'wbf.label', array( 'attr' => 'Entity', 'src' => 'Entity Comment' ) ),
  ...
  }//end public function input_WbfsysEntityComment_IdEntity */
...
}//end class WbfsysEntityComment_Crud_Show_Form */
