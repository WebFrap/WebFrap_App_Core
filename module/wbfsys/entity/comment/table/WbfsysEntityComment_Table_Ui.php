 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Comments
  *
  ...
  *  }
  *
  * @return WbfsysEntityComment_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityComment_Table_Element( 'tableWbfsysEntityComment', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Comments', 'wbfsys.entity_comment.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_comment';
      ...
      $searchElement->searchKey = 'wbfsys_entity_comment';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityComment_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityComment', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityComment listing maske
   *
   * @param WbfsysEntityComment_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityComment_Table_Ui
