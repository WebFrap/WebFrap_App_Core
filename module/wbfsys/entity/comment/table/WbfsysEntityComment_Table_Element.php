 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_comment';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityComment_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityComment.show&amp;target_mask=WbfsysEntityComment&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityComment.edit&amp;target_mask=WbfsysEntityComment&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_comment.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityComment.delete&amp;target_mask=WbfsysEntityComment&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_comment.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_comment_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityComment_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Comments." >{$iconDelete} Delete selected Entity Comments</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Comments. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityComment_Multi.deleteAll" >{$iconClean} Delete all Entity Comments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityComment_Table_Element
