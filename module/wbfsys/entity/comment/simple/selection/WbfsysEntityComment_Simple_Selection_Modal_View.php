 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityComment_Simple_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysEntityComment_Simple_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * Type: wbfsys_entity_comment-simple
  *
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_comment-simple/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Comment', 'wbfsys.entity_comment_simple.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityComment_Simple.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_entity_comment-simple-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysEntityComment_Simple_Selection' );
...
}//end class WbfsysEntityComment_Simple_Selection_Modal_View
