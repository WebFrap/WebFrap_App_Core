 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityComment_Simple_Selection_Query $query
...
}//end class WbfsysEntityComment_Simple_Selection_Access
