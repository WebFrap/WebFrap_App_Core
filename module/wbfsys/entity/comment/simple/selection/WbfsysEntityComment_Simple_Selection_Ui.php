 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityComment_Simple_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityComment_Simple_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityComment_Simple_Selection_Element
    (
      'selectionWbfsysEntityComment_Simple',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Comments', 'wbfsys.entity_comment_simple.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityComment_Simple.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityComment_Simple',
      'WbfsysEntityComment_Simple_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityComment_Simple_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityComment_Simple_Selection_Ui
