 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityComment_Simple_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityComment_Simple_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysEntityComment_Simple_Table_Model
