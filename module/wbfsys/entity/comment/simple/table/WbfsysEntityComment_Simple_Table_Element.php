 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_comment-simple';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityComment_Simple_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityComment_Simple.show&amp;target_mask=WbfsysEntityComment_Simple&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityComment_Simple.edit&amp;target_mask=WbfsysEntityComment_Simple&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_comment_simple.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityComment_Simple.delete&amp;target_mask=WbfsysEntityComment_Simple&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_comment_simple.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.comment.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_comment-simple_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['embed_comment_title'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityComment_Simple_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Comments." >{$iconDelete} Delete selected Comments</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Comments. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityComment_Simple_Multi.deleteAll" >{$iconClean} Delete all Comments</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityComment_Simple_Table_Element
