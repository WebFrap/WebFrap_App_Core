 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Comments
  *
  ...
  *  }
  *
  * @return WbfsysEntityComment_Simple_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityComment_Simple_Table_Element( 'tableWbfsysEntityComment_Simple', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_comment-simple-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Comments', 'wbfsys.entity_comment_simple.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_comment-simple';
      ...
      $searchElement->searchKey = 'wbfsys_entity_comment-simple';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityComment_Simple_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityComment_Simple', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityComment_Simple listing maske
   *
   * @param WbfsysEntityComment_Simple_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityComment_Simple  = $model->getEntityWbfsysEntityComment_Simple();
    ...
    $formWbfsysEntityComment_Simple->setKeyName( 'wbfsys_entity_comment-simple' );
...
}//end class WbfsysEntityComment_Simple_Table_Ui
