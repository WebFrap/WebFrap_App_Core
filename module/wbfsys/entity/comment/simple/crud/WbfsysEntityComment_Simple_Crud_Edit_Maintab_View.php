 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityComment_Simple Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityComment_Simple = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityComment_Simple.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityComment_Simple
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityComment_Simple.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_comment-simple-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_comment-simple/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityComment_Simple_Crud_Edit' );
...
{$codeGoUp}
    ...
    self.getObject().find(".wgtac_mask_wbfsys_entity_comment").click(function(){
      ...
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityComment.edit&objid={$objid}');
    });
...
}//end class WbfsysEntityComment_Simple_Crud_Edit_Maintab_View
