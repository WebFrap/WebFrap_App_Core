 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityComment_Simple Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityComment_Simple = $this->model->getEntityWbfsysEntityComment_Simple();
    ...
    (
      ...
      array( 'text' => $entityWbfsysEntityComment_Simple->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityComment_Simple.show  &amp;objid='.$entityWbfsysEntityComment_Simple
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityComment_Simple.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_comment-simple-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_comment-simple/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityComment_Simple_Crud_Show' );
    $this->addVar( 'crudForm', $form );
    
    $entity = $this->model->getEntity();
    $form->setEntity( $entity );
  $form->setEntityEmbedComment( $this->model->getEntityEmbedComment( $entity ) );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityComment_Simple.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_comment-simple' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_comment-simple a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityComment_Simple.listing' );
      }
    });
    

    self.getObject().find(".wgtac_mask_wbfsys_entity_comment").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityComment.show&objid={$objid}');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityComment_Simple.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityComment_Simple_Crud_Show_Maintab_View
