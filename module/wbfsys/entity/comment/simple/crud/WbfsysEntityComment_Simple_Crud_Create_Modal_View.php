 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityComment_Simple entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityComment_Simple.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityComment_Simple.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_comment-simple';
    $params->namespace   = 'wbfsys_entity_comment-simple-create';
  ...
  $form->setEntityEmbedComment( $this->model->getEntityEmbedComment( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/entity_comment-simple/modal/crud/form_create' );
...
}//end class WbfsysEntityComment_Simple_Crud_Create_Modal_View
