 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityComment_Simple Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_comment-simple-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_comment-simple/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityComment_Simple.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_comment-simple';
    ...
    $form = $this->newForm( 'WbfsysEntityComment_Simple_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityComment_Simple.create');}});
});
...
}//end class WbfsysEntityComment_Simple_Crud_Create_Maintab_View
