 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityComment_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityComment_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityComment_Entity */
      $entity = $orm->get( 'WbfsysEntityComment', $rootId );
    }
...
}//end class WbfsysEntityComment_Simple_Crud_Access_Root
