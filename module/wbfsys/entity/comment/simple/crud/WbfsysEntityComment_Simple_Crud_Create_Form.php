 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Simple_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysEntityComment_Simple';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysEntityComment_Simple';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function renderForm( $params = null  )
  {
    ...
    $this->view->addVar( 'entityWbfsysEntityComment_Simple', $this->entity );
  $this->view->addVar( 'entityEmbedComment',  $this->entityEmbedComment ) ;
    ...
    if( $this->target )
      ...
      $sendTo = 'wgt-input-wbfsys_entity_comment-simple'.($this->suffix?'-'.$this->suffix:'').'-tostring';
    ...
    (
      array
      (
        'name'  => 'wbfsys_entity_comment-simple[id_wbfsys_entity_comment-simple-tostring]',
        'id'    => $sendTo,
    ...
    $this->input_WbfsysEntityComment_Simple_Rowid( $params );
    $this->input_EmbedComment_Title( $params );
    $this->input_EmbedComment_Content( $params );
    $this->input_WbfsysEntityComment_Simple_MTimeCreated( $params );
    $this->input_WbfsysEntityComment_Simple_MRoleCreate( $params );
    $this->input_WbfsysEntityComment_Simple_MTimeChanged( $params );
    $this->input_WbfsysEntityComment_Simple_MRoleChange( $params );
    $this->input_WbfsysEntityComment_Simple_MVersion( $params );
    $this->input_WbfsysEntityComment_Simple_MUuid( $params );
    ...
    $this->input_WbfsysEntityComment_Simple_Vid( $params );
    $this->input_WbfsysEntityComment_Simple_IdComment( $params );
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_Rowid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputRowid = $this->view->newInput( 'inputWbfsysEntityComment_SimpleRowid' , 'int' );
      $this->items['wbfsys_entity_comment-simple-rowid'] = $inputRowid;
      $inputRowid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[rowid]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_rowid'.($this->suffix?'-'.$this->suffix:''),
      ...
      $inputRowid->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'rowid' ) );
      $inputRowid->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'rowid' ) );
  ...
  }//end public function input_WbfsysEntityComment_Simple_Rowid */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MTimeCreated( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeCreated = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMTimeCreated' , 'Date' );
      $this->items['wbfsys_entity_comment-simple-m_time_created'] = $inputMTimeCreated;
      $inputMTimeCreated->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[m_time_created]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_time_created'.($this->suffix?'-'.$this->suffix:''),
      ...
      $inputMTimeCreated->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_time_created' ) );
      $inputMTimeCreated->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_time_created' ) );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MTimeCreated */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MRoleCreate( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleCreate = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMRoleCreate', 'Window' );
      $this->items['wbfsys_entity_comment-simple-m_role_create'] = $inputMRoleCreate;
      $inputMRoleCreate->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_entity_comment-simple[m_role_create]',
        'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_role_create'.($this->suffix?'-'.$this->suffix:''),
      ...
      $inputMRoleCreate->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_role_create' ) );
      $inputMRoleCreate->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_role_create' ) );
      ...
      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_entity_comment-simple_m_role_create'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleCreate->buildJavascript( 'wgt-input-wbfsys_entity_comment-simple_m_role_create'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MRoleCreate */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MTimeChanged( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:date
      $inputMTimeChanged = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMTimeChanged' , 'Date' );
      $this->items['wbfsys_entity_comment-simple-m_time_changed'] = $inputMTimeChanged;
      $inputMTimeChanged->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[m_time_changed]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_time_changed'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMTimeChanged->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_time_changed' ) );
      $inputMTimeChanged->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_time_changed' ) );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MTimeChanged */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MRoleChange( $params )
  {
    $i18n     = $this->view->i18n;
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      $inputMRoleChange = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMRoleChange', 'Window' );
      $this->items['wbfsys_entity_comment-simple-m_role_change'] = $inputMRoleChange;
      $inputMRoleChange->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => 'wbfsys_entity_comment-simple[m_role_change]',
        'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMRoleChange->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_role_change' ) );
      $inputMRoleChange->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_role_change' ) );
      $inputMRoleChange->setLabel( $i18n->l( 'Role Change', 'wbfsys.entity_comment.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;context=create'
        .'&amp;suffix='.$this->suffix.'&amp;input=wbfsys_entity_comment-simple_m_role_change'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputMRoleChange->buildJavascript( 'wgt-input-wbfsys_entity_comment-simple_m_role_change'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MRoleChange */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MVersion( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMVersion = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMVersion' , 'int' );
      $this->items['wbfsys_entity_comment-simple-m_version'] = $inputMVersion;
      $inputMVersion->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[m_version]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_version'.($this->suffix?'-'.$this->suffix:''),
      ...
      $inputMVersion->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_version' ) );
      $inputMVersion->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_version' ) );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MVersion */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_MUuid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui: guess
      $inputMUuid = $this->view->newInput( 'inputWbfsysEntityComment_SimpleMUuid' , 'Text' );
      $this->items['wbfsys_entity_comment-simple-m_uuid'] = $inputMUuid;
      $inputMUuid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[m_uuid]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_m_uuid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
      ...
      $inputMUuid->setReadonly( $this->fieldReadOnly( 'wbfsys_entity_comment-simple', 'm_uuid' ) );
      $inputMUuid->setRequired( $this->fieldRequired( 'wbfsys_entity_comment-simple', 'm_uuid' ) );
  ...
  }//end public function input_WbfsysEntityComment_Simple_MUuid */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_Vid( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputVid = $this->view->newInput( 'inputWbfsysEntityComment_SimpleVid', 'Hidden' );
      $this->items['wbfsys_entity_comment-simple-vid'] = $inputVid;
      $inputVid->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[vid]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_vid'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
  ...
  }//end public function input_WbfsysEntityComment_Simple_Vid */
  ...
  * @return void
  */
  public function input_WbfsysEntityComment_Simple_IdComment( $params )
  {
    $i18n     = $this->view->i18n;

      //tpl: class ui:hidden
      $inputIdComment = $this->view->newInput( 'inputWbfsysEntityComment_SimpleIdComment', 'Hidden' );
      $this->items['wbfsys_entity_comment-simple-id_comment'] = $inputIdComment;
      $inputIdComment->addAttributes
      (
        array
        (
          'name'      => 'wbfsys_entity_comment-simple[id_comment]',
          'id'        => 'wgt-input-wbfsys_entity_comment-simple_id_comment'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
  ...
  }//end public function input_WbfsysEntityComment_Simple_IdComment */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysEntityComment', array_keys( $this->fields['wbfsys_entity_comment-simple']), true ),
    ...
    // Extrahieren der Daten für die embed_comment Referenz
    $filterEmbedComment = $request->checkFormInput
    (
      $orm->getValidationData( 'WbfsysComment', array_keys( $this->fields['embed_comment'] ), true ),
      $orm->getErrorMessages( 'WbfsysComment' ),
      'embed_comment'
    );
    
    $tmpEmbedComment  = $filterEmbedComment->getData();
    $dataEmbedComment = array();
    
    // es werden nur daten gesetzt die tatsächlich übergeben wurden, sonst
    // würden default werte in den entities überschrieben werden
    foreach( $tmpEmbedComment as $key => $value   )
    {
      if( !is_null( $value ) )
        $dataEmbedComment[$key] = $value;
    }

    $this->entityEmbedComment->addData( $dataEmbedComment );
...
}//end class WbfsysEntityComment_Simple_Crud_Create_Form */
