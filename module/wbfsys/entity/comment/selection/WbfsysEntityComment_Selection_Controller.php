 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityComment_Selection' ) );
...
} // end class WbfsysEntityComment_Selection_Controller */
