 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityComment_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityComment_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityComment_Selection_Element
    (
      'selectionWbfsysEntityComment',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Comments', 'wbfsys.entity_comment.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityComment.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityComment',
      'WbfsysEntityComment_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityComment_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityComment_Selection_Ui
