 ...
 * @licence WebFrap.net
 */
class WbfsysEntityComment_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityComment_'.$listType ) );
...
} // end class WbfsysEntityComment_Listing_Controller */
