 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Tags
  *
  ...
  *  }
  *
  * @return WbfsysEntityTag_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityTag_Table_Element( 'tableWbfsysEntityTag', $view );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Tags', 'wbfsys.entity_tag.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_tag';
      ...
      $searchElement->searchKey = 'wbfsys_entity_tag';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityTag_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityTag', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityTag listing maske
   *
   * @param WbfsysEntityTag_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityTag_Table_Ui
