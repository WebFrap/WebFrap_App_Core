 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_tag';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityTag_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityTag.show&amp;target_mask=WbfsysEntityTag&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityTag.edit&amp;target_mask=WbfsysEntityTag&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_tag.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityTag.delete&amp;target_mask=WbfsysEntityTag&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_tag.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_tag_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.EntityTag.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['embed_tag_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityTag_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Tags." >{$iconDelete} Delete selected Entity Tags</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Tags. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityTag_Multi.deleteAll" >{$iconClean} Delete all Entity Tags</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityTag_Table_Element
