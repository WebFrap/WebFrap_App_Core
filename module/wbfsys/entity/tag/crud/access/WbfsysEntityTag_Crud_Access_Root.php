 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityTag_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityTag_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityTag_Entity */
      $entity = $orm->get( 'WbfsysEntityTag', $rootId );
    }
...
}//end class WbfsysEntityTag_Crud_Access_Root
