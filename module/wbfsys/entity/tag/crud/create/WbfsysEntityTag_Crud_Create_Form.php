 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysEntityTag', array_keys( $this->fields['wbfsys_entity_tag']), true ),
...
}//end class WbfsysEntityTag_Crud_Create_Form */
