 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityTag entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityTag.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityTag.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_tag';
    $params->namespace   = 'wbfsys_entity_tag-create';
  ...
  $form->setEntityEmbedTag( $this->model->getEntityEmbedTag( $entity ) );
    ...
    $this->setTemplate( 'wbfsys/entity_tag/modal/crud/form_create' );
...
}//end class WbfsysEntityTag_Crud_Create_Modal_View
