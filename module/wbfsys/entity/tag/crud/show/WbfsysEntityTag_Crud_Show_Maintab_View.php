 ...
 * @licence WebFrap.net
 */
class WbfsysEntityTag_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityTag_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityTag Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityTag = $this->model->getEntityWbfsysEntityTag();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Entity Tag: {@text@}',
      'wbfsys.entity_tag.label',
      array( 'text' => $entityWbfsysEntityTag->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityTag.show  &amp;objid='.$entityWbfsysEntityTag
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityTag.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_tag-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_tag/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityTag_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityTag.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_tag' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_tag a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityTag.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityTag.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityTag_Crud_Show_Maintab_View
