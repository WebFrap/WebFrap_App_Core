 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_file_storage';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityFileStorage_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityFileStorage.show&amp;target_mask=WbfsysEntityFileStorage&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityFileStorage.edit&amp;target_mask=WbfsysEntityFileStorage&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_file_storage.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityFileStorage.delete&amp;target_mask=WbfsysEntityFileStorage&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_file_storage.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_file_storage_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityFileStorage_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity File Storages." >{$iconDelete} Delete selected Entity File Storages</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity File Storages. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityFileStorage_Multi.deleteAll" >{$iconClean} Delete all Entity File Storages</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityFileStorage_Table_Element
