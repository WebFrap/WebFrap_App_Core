 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity File Storages
  *
  ...
  *  }
  *
  * @return WbfsysEntityFileStorage_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityFileStorage_Table_Element( 'tableWbfsysEntityFileStorage', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_file_storage-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity File Storages', 'wbfsys.entity_file_storage.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_file_storage';
      ...
      $searchElement->searchKey = 'wbfsys_entity_file_storage';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityFileStorage_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityFileStorage', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityFileStorage listing maske
   *
   * @param WbfsysEntityFileStorage_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityFileStorage  = $model->getEntityWbfsysEntityFileStorage();
    ...
    $formWbfsysEntityFileStorage->setKeyName( 'wbfsys_entity_file_storage' );
...
}//end class WbfsysEntityFileStorage_Table_Ui
