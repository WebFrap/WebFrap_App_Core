 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityFileStorage_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_entity_file_storage.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_entity_file_storage.rowid ",
      'acls'
    );
...
}//end class WbfsysEntityFileStorage_Table_Access
