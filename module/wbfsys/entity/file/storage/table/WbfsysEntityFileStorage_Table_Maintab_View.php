 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEntityFileStorage_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysEntityFileStorage_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/entity_file_storage/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table Entity File Storages',
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.EntityFileStorage.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EntityFileStorage.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysEntityFileStorage_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityFileStorage.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Wbfsys.EntityFileStorage.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.EntityFileStorage.create&amp;ltype=table');
    });
...
}//end class WbfsysEntityFileStorage_Table_Maintab_View
