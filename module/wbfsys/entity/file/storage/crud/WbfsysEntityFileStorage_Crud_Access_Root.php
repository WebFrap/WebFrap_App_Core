 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityFileStorage_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityFileStorage_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityFileStorage_Entity */
      $entity = $orm->get( 'WbfsysEntityFileStorage', $rootId );
    }
...
}//end class WbfsysEntityFileStorage_Crud_Access_Root
