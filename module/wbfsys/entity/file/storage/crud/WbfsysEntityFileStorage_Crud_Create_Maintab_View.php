 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityFileStorage Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Entity File Storage',
      'wbfsys.entity_file_storage.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Entity File Storage',
      'wbfsys.entity_file_storage.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_file_storage-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_file_storage/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityFileStorage.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_file_storage';
    ...
    $form = $this->newForm( 'WbfsysEntityFileStorage_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityFileStorage.create');}});
});
...
}//end class WbfsysEntityFileStorage_Crud_Create_Maintab_View
