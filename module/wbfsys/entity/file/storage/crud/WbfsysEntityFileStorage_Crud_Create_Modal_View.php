 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityFileStorage entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityFileStorage.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityFileStorage.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_file_storage';
    $params->namespace   = 'wbfsys_entity_file_storage-create';
    ...
    $this->setTemplate( 'wbfsys/entity_file_storage/modal/crud/form_create' );
...
}//end class WbfsysEntityFileStorage_Crud_Create_Modal_View
