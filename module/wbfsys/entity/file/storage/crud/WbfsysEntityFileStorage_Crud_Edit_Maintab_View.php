 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityFileStorage Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityFileStorage = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity File Storage: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityFileStorage.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityFileStorage
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityFileStorage.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_file_storage-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_file_storage/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityFileStorage_Crud_Edit' );
...
}//end class WbfsysEntityFileStorage_Crud_Edit_Maintab_View
