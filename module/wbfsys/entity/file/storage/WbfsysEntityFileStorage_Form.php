 ...
 * @licence WebFrap.net
 */
class WbfsysEntityFileStorage_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_entity_file_storage';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntityFileStorage';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntityFileStorage' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntityFileStorage entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for VID (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
  ...
  */
  public function input_id_storage( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysFileStorage_Entity' ) )
    {
      ...
      $inputIdStorage = $this->view->newInput( 'input'.$this->prefix.'IdStorage', 'Window' );
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_storage'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Storage (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
      ));
      ...
      $inputIdStorage->setLabel( $this->view->i18n->l( 'Storage', 'wbfsys.entity_file_storage.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.FileStorage.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_storage'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdStorage->buildJavascript( 'wgt-input-'.$this->keyName.'_id_storage'.($this->suffix?'-'.$this->suffix:'') );
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity_file_storage.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity_file_storage.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity_file_storage.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity_file_storage.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity_file_storage.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity_file_storage.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity File Storage)', 'wbfsys.entity_file_storage.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity_file_storage.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_file_storage_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_file_storage_m_role_change';
...
}//end class WbfsysEntityFileStorage_Form */
