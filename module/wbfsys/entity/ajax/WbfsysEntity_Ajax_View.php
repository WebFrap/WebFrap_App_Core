...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TArray $params
   */
  public function displayData( $entityWbfsysEntity, $params )
  {
    ...
    if( 'true' == $params->fullLoad )
    {
      ...
      $ui->ajaxForm( $entityWbfsysEntity, $params );
    }
    else
    {
...
}//end class WbfsysEntity_Ajax_View
