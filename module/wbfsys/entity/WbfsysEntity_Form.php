...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEntity';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEntity' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEntity entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Entity)', 'wbfsys.entity.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.entity.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Entity)', 'wbfsys.entity.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.entity.label' ),
  ...
  * @return void
  */
  public function input_flag_index( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagIndex = $this->view->newInput( 'input'.$this->prefix.'FlagIndex' , 'Checkbox' );
      $this->items['flag_index'] = $inputFlagIndex;
      $inputFlagIndex->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_index]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_index'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Index (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputFlagIndex->setWidth( 'medium' );

      $inputFlagIndex->setReadOnly( $this->isReadOnly( 'flag_index' ) );
      $inputFlagIndex->setActive( $this->entity->getBoolean( 'flag_index' ) );
      $inputFlagIndex->setLabel
      (
        $this->view->i18n->l( 'Index', 'wbfsys.entity.label' ),
        $this->entity->required( 'flag_index' )
      );
  ...
  }//end public function input_flag_index */
  ...
  * @return void
  */
  public function input_default_create( $params )
  {

      //tpl: class ui: guess
      $inputDefaultCreate = $this->view->newInput( 'input'.$this->prefix.'DefaultCreate' , 'text' );
      $this->items['default_create'] = $inputDefaultCreate;
      $inputDefaultCreate->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[default_create]',
          'id'        => 'wgt-input-'.$this->keyName.'_default_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Default create (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultCreate->setWidth( 'medium' );

      $inputDefaultCreate->setReadOnly( $this->isReadOnly( 'default_create' ) );
      $inputDefaultCreate->setData( $this->entity->getSecure('default_create') );
      $inputDefaultCreate->setLabel
      (
        $this->view->i18n->l( 'Default create', 'wbfsys.entity.label' ),
        $this->entity->required( 'default_create' )
      );
  ...
  }//end public function input_default_create */
  ...
  * @return void
  */
  public function input_default_edit( $params )
  {

      //tpl: class ui: guess
      $inputDefaultEdit = $this->view->newInput( 'input'.$this->prefix.'DefaultEdit' , 'text' );
      $this->items['default_edit'] = $inputDefaultEdit;
      $inputDefaultEdit->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[default_edit]',
          'id'        => 'wgt-input-'.$this->keyName.'_default_edit'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Default edit (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultEdit->setWidth( 'medium' );

      $inputDefaultEdit->setReadOnly( $this->isReadOnly( 'default_edit' ) );
      $inputDefaultEdit->setData( $this->entity->getSecure('default_edit') );
      $inputDefaultEdit->setLabel
      (
        $this->view->i18n->l( 'Default edit', 'wbfsys.entity.label' ),
        $this->entity->required( 'default_edit' )
      );
  ...
  }//end public function input_default_edit */
  ...
  * @return void
  */
  public function input_default_show( $params )
  {

      //tpl: class ui: guess
      $inputDefaultShow = $this->view->newInput( 'input'.$this->prefix.'DefaultShow' , 'text' );
      $this->items['default_show'] = $inputDefaultShow;
      $inputDefaultShow->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[default_show]',
          'id'        => 'wgt-input-'.$this->keyName.'_default_show'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Default show (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultShow->setWidth( 'medium' );

      $inputDefaultShow->setReadOnly( $this->isReadOnly( 'default_show' ) );
      $inputDefaultShow->setData( $this->entity->getSecure('default_show') );
      $inputDefaultShow->setLabel
      (
        $this->view->i18n->l( 'Default show', 'wbfsys.entity.label' ),
        $this->entity->required( 'default_show' )
      );
  ...
  }//end public function input_default_show */
  ...
  * @return void
  */
  public function input_default_list( $params )
  {

      //tpl: class ui: guess
      $inputDefaultList = $this->view->newInput( 'input'.$this->prefix.'DefaultList' , 'text' );
      $this->items['default_list'] = $inputDefaultList;
      $inputDefaultList->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[default_list]',
          'id'        => 'wgt-input-'.$this->keyName.'_default_list'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Default list (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultList->setWidth( 'medium' );

      $inputDefaultList->setReadOnly( $this->isReadOnly( 'default_list' ) );
      $inputDefaultList->setData( $this->entity->getSecure('default_list') );
      $inputDefaultList->setLabel
      (
        $this->view->i18n->l( 'Default list', 'wbfsys.entity.label' ),
        $this->entity->required( 'default_list' )
      );
  ...
  }//end public function input_default_list */
  ...
  * @return void
  */
  public function input_default_selection( $params )
  {

      //tpl: class ui: guess
      $inputDefaultSelection = $this->view->newInput( 'input'.$this->prefix.'DefaultSelection' , 'text' );
      $this->items['default_selection'] = $inputDefaultSelection;
      $inputDefaultSelection->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[default_selection]',
          'id'        => 'wgt-input-'.$this->keyName.'_default_selection'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required valid_url medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Default selection (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultSelection->setWidth( 'medium' );

      $inputDefaultSelection->setReadOnly( $this->isReadOnly( 'default_selection' ) );
      $inputDefaultSelection->setData( $this->entity->getSecure('default_selection') );
      $inputDefaultSelection->setLabel
      (
        $this->view->i18n->l( 'Default selection', 'wbfsys.entity.label' ),
        $this->entity->required( 'default_selection' )
      );
  ...
  }//end public function input_default_selection */
  ...
  * @return void
  */
  public function input_relevance( $params )
  {

      //tpl: class ui:text
      $inputRelevance = $this->view->newInput( 'input'.$this->prefix.'Relevance' , 'Text' );
      $this->items['relevance'] = $inputRelevance;
      $inputRelevance->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[relevance]',
          'id'        => 'wgt-input-'.$this->keyName.'_relevance'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Relevance (Entity)', 'wbfsys.entity.label' ),
          'maxlength' => $this->entity->maxSize( 'relevance' ),
        )
      );
      $inputRelevance->setWidth( 'medium' );

      $inputRelevance->setReadOnly( $this->isReadOnly( 'relevance' ) );
      $inputRelevance->setData( $this->entity->getSecure('relevance') );
      $inputRelevance->setLabel
      (
        $this->view->i18n->l( 'Relevance', 'wbfsys.entity.label' ),
        $this->entity->required( 'relevance' )
      );
  ...
  }//end public function input_relevance */
    ...
    if( !Webfrap::classLoadable( 'WbfsysModule_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_module'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Module (Entity)', 'wbfsys.entity.label' ),
      ));
      ...
      $inputIdModule->setLabel( $this->view->i18n->l( 'Module', 'wbfsys.entity.label' ) );
  ...
  * @return void
  */
  public function input_id_security_area( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysSecurityArea_Entity' ) )
    {
      ...
      $inputIdSecurityArea = $this->view->newInput( 'input'.$this->prefix.'IdSecurityArea', 'Window' );
      $inputIdSecurityArea->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_security_area]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_security_area'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Security Area (Entity)', 'wbfsys.entity.label' ),
      ));
      ...
      $inputIdSecurityArea->setReadOnly( $this->isReadOnly( 'id_security_area' ) );
      $inputIdSecurityArea->setLabel( $this->view->i18n->l( 'Security Area', 'wbfsys.entity.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.SecurityArea.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_security_area'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdSecurityArea->buildJavascript( 'wgt-input-'.$this->keyName.'_id_security_area'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_security_area */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Entity)', 'wbfsys.entity.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.entity.label' ),
  ...
  public function input_revision( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Revision (Entity)', 'wbfsys.entity.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Revision', 'wbfsys.entity.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip valid_required medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Entity)', 'wbfsys.entity.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.entity.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Entity)', 'wbfsys.entity.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.entity.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Entity)', 'wbfsys.entity.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.entity.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Entity)', 'wbfsys.entity.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.entity.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Entity)', 'wbfsys.entity.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.entity.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Entity)', 'wbfsys.entity.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.entity.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Entity)', 'wbfsys.entity.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.entity.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Entity)', 'wbfsys.entity.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Entity)', 'wbfsys.entity.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
 ...
 /**
  * create the search element for field default_create
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_default_create( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Default create (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultCreate->setWidth( 'medium' );
  ...
  }//end public function search_default_create */

 /**
  * create the search element for field default_edit
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_default_edit( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_default_edit'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_url medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Default edit (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultEdit->setWidth( 'medium' );
  ...
  }//end public function search_default_edit */

 /**
  * create the search element for field default_show
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_default_show( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_default_show'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_url medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Default show (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultShow->setWidth( 'medium' );
  ...
  }//end public function search_default_show */

 /**
  * create the search element for field default_list
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_default_list( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_default_list'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_url medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Default list (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultList->setWidth( 'medium' );
  ...
  }//end public function search_default_list */

 /**
  * create the search element for field default_selection
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_default_selection( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_default_selection'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip valid_url medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Default selection (Entity)', 'wbfsys.entity.label' ),
        )
      );
      $inputDefaultSelection->setWidth( 'medium' );
  ...
  }//end public function search_default_selection */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_entity_m_role_change';
