 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysEntityColorScheme_Selection' ) );
...
} // end class WbfsysEntityColorScheme_Selection_Controller */
