 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEntityColorScheme_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEntityColorScheme_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityColorScheme_Selection_Element
    (
      'selectionWbfsysEntityColorScheme',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Entity Color Schemes', 'wbfsys.entity_color_scheme.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EntityColorScheme.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEntityColorScheme',
      'WbfsysEntityColorScheme_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEntityColorScheme_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEntityColorScheme_Selection_Ui
