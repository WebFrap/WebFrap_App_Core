 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEntityColorScheme_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_entity_color_scheme.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_entity_color_scheme.rowid ",
      'acls'
    );
...
}//end class WbfsysEntityColorScheme_Selection_Access
