 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEntityColorScheme_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEntityColorScheme_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysEntityColorScheme_Selection_Model
