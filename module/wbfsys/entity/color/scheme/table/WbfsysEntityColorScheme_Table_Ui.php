 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Entity Color Schemes
  *
  ...
  *  }
  *
  * @return WbfsysEntityColorScheme_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEntityColorScheme_Table_Element( 'tableWbfsysEntityColorScheme', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_entity_color_scheme-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Entity Color Schemes', 'wbfsys.entity_color_scheme.label' );
      //$tabPanel->searchKey = 'wbfsys_entity_color_scheme';
      ...
      $searchElement->searchKey = 'wbfsys_entity_color_scheme';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEntityColorScheme_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEntityColorScheme', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEntityColorScheme listing maske
   *
   * @param WbfsysEntityColorScheme_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEntityColorScheme  = $model->getEntityWbfsysEntityColorScheme();
    ...
    $formWbfsysEntityColorScheme->setKeyName( 'wbfsys_entity_color_scheme' );
...
}//end class WbfsysEntityColorScheme_Table_Ui
