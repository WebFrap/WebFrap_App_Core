 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_entity_color_scheme';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEntityColorScheme_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EntityColorScheme.show&amp;target_mask=WbfsysEntityColorScheme&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EntityColorScheme.edit&amp;target_mask=WbfsysEntityColorScheme&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.entity_color_scheme.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EntityColorScheme.delete&amp;target_mask=WbfsysEntityColorScheme&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.entity_color_scheme.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_entity_color_scheme_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EntityColorScheme_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Entity Color Schemes." >{$iconDelete} Delete selected Entity Color Schemes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Entity Color Schemes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EntityColorScheme_Multi.deleteAll" >{$iconClean} Delete all Entity Color Schemes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEntityColorScheme_Table_Element
