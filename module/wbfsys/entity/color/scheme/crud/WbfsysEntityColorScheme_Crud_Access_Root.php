 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEntityColorScheme_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEntityColorScheme_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEntityColorScheme_Entity */
      $entity = $orm->get( 'WbfsysEntityColorScheme', $rootId );
    }
...
}//end class WbfsysEntityColorScheme_Crud_Access_Root
