 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEntityColorScheme Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityColorScheme = $this->model->getEntityWbfsysEntityColorScheme();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Entity Color Scheme: {@text@}',
      'wbfsys.entity_color_scheme.label',
      array( 'text' => $entityWbfsysEntityColorScheme->text() )
    );
    $i18nLabel = $this->i18n->l
    (
      'Entity Color Scheme: {@text@}',
      'wbfsys.entity_color_scheme.label',
      array( 'text' => $entityWbfsysEntityColorScheme->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityColorScheme.show  &amp;objid='.$entityWbfsysEntityColorScheme
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityColorScheme.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_color_scheme-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_color_scheme/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEntityColorScheme_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.EntityColorScheme.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_color_scheme' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_entity_color_scheme a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.EntityColorScheme.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.EntityColorScheme.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEntityColorScheme_Crud_Show_Maintab_View
