 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEntityColorScheme Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEntityColorScheme = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Entity Color Scheme: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EntityColorScheme.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEntityColorScheme
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EntityColorScheme.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_entity_color_scheme-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/entity_color_scheme/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEntityColorScheme_Crud_Edit' );
...
}//end class WbfsysEntityColorScheme_Crud_Edit_Maintab_View
