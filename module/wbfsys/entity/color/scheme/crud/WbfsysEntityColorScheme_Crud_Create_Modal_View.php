 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEntityColorScheme entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EntityColorScheme.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityColorScheme.insert';
    $params->formId       = 'wgt-form-wbfsys_entity_color_scheme';
    $params->namespace   = 'wbfsys_entity_color_scheme-create';
    ...
    $this->setTemplate( 'wbfsys/entity_color_scheme/modal/crud/form_create' );
...
}//end class WbfsysEntityColorScheme_Crud_Create_Modal_View
