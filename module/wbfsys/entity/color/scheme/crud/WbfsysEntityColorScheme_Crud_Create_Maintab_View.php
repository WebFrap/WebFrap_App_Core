 ...
 * @licence WebFrap.net
 */
class WbfsysEntityColorScheme_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysEntityColorScheme Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      'Create a new Entity Color Scheme',
      'wbfsys.entity_color_scheme.label'
    );

    $i18nLabel = $this->i18n->l
    (
      'New Entity Color Scheme',
      'wbfsys.entity_color_scheme.label'
    );
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_entity_color_scheme-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/entity_color_scheme/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EntityColorScheme.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_entity_color_scheme';
    ...
    $form = $this->newForm( 'WbfsysEntityColorScheme_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.EntityColorScheme.create');}});
});
...
}//end class WbfsysEntityColorScheme_Crud_Create_Maintab_View
