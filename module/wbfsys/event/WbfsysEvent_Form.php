...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEvent' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEvent entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Event)', 'wbfsys.event.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.event.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.event.label' ),
  ...
  * @return void
  */
  public function input_point_of_time( $params )
  {

      //tpl: class ui:timestamp
      $inputPointOfTime = $this->view->newInput( 'input'.$this->prefix.'PointOfTime' , 'Timestamp' );
      $this->items['point_of_time'] = $inputPointOfTime;
      $inputPointOfTime->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[point_of_time]',
          'id'        => 'wgt-input-'.$this->keyName.'_point_of_time'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Point Of Time (Event)', 'wbfsys.event.label' ),
          'maxlength' => $this->entity->maxSize( 'point_of_time' ),
        )
      );
      $inputPointOfTime->setWidth( 'medium' );

      $inputPointOfTime->setReadOnly( $this->isReadOnly( 'point_of_time' ) );
      $inputPointOfTime->setData( $this->entity->getTimestamp( 'point_of_time' ) );
      $inputPointOfTime->setLabel
      (
        $this->view->i18n->l( 'Point Of Time', 'wbfsys.event.label' ),
        $this->entity->required( 'point_of_time' )
      );
  ...
  }//end public function input_point_of_time */
  ...
  * @return void
  */
  public function input_action( $params )
  {

      //p: textarea
      $inputAction = $this->view->newInput( 'input'.$this->prefix.'Action', 'Textarea' );
      $this->items['action'] = $inputAction;
      $inputAction->addAttributes
      (
        array
        (
          'name'  => $this->keyName.'[action]',
          'id'    => 'wgt-input-'.$this->keyName.'_action'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip large medium-height'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title' => $this->view->i18n->l( 'Insert value for Action (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      $inputAction->setReadOnly( $this->isReadOnly( 'action' ) );
      $inputAction->setLabel
      (
        $this->view->i18n->l( 'Action', 'wbfsys.event.label' ),
        $this->entity->required( 'action' )
      );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Event)', 'wbfsys.event.label' ),
  ...
  */
  public function input_id_status( $params )
  {
    if( !Webfrap::classLoadable( 'WbfsysEventStatus_Selectbox' ) )
    {
      ...
      //p: Selectbox
      $inputIdStatus = $this->view->newItem( 'input'.$this->prefix.'IdStatus' , 'WbfsysEventStatus_Selectbox' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Status (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Status', 'wbfsys.event.label' ),
      ...
      if( $acl->access( 'mod-wbfsys>mod-wbfsys-cat-core_data:insert' ) )
      {
        ...
        $inputIdStatus->editUrl = 'index.php?c=Wbfsys.EventStatus.listing&amp;target='.$this->namespace.'&amp;field=id_status&amp;publish=selectbox&amp;suffix='.$this->suffix.'&amp;input_id=wgt-input-'.$this->keyName.'_id_status'.$this->suffix;
      }
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Event)', 'wbfsys.event.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.event.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Event)', 'wbfsys.event.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.event.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Event)', 'wbfsys.event.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.event.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Event)', 'wbfsys.event.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.event.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Event)', 'wbfsys.event.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.event.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.event.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Event)', 'wbfsys.event.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.event.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Event)', 'wbfsys.event.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
 ...
 /**
  * create the search element for field id_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_id_status( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEventStatus_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Status (Event)', 'wbfsys.event.label' ),
          'multiple'   => 'multiple',
          'size'       => '5',
        )
      );
  ...
  }//end public function search_id_status */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_event_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_event_m_role_change';
