...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Events
  *
  ...
  *  }
  *
  * @return WbfsysEvent_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEvent_Table_Element( 'tableWbfsysEvent', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_event-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Events', 'wbfsys.event.label' );
      //$tabPanel->searchKey = 'wbfsys_event';
      ...
      $searchElement->searchKey = 'wbfsys_event';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEvent_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEvent', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEvent listing maske
   *
   * @param WbfsysEvent_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEvent_Table_Ui
