 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_event';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEvent_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Event.show&amp;target_mask=WbfsysEvent&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.event.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Event.edit&amp;target_mask=WbfsysEvent&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.event.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Event.delete&amp;target_mask=WbfsysEvent&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.event.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.event.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Status', 'wbfsys.event.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_event_title'])).'</td>'.NL;

      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Wbfsys.EventStatus.listing" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_event_status_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Event_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Events." >{$iconDelete} Delete selected Events</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Events. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Event_Multi.deleteAll" >{$iconClean} Delete all Events</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEvent_Table_Element
