 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatusI18n_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_event_status_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysEventStatusI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysEventStatusI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysEventStatusI18n';
   ...
   *
   * @var WbfsysEventStatusI18n_Entity 
   */
  public $entity      = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysEventStatusI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysEventStatusI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysEventStatusI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.event_status_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_event_status
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_event_status( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysEventStatus_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysEventStatus not exists' );

      Log::warn('Looks like the Entity: WbfsysEventStatus is missing');
      ...
      //p: Window
      $objidWbfsysEventStatus = $this->entity->getData('id_wbfsys_event_status') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysEventStatus
          || !$entityWbfsysEventStatus = $this->db->orm->get
          (
            'WbfsysEventStatus',
            $objidWbfsysEventStatus
          )
      ...
      {
        $entityWbfsysEventStatus = $this->db->orm->newEntity( 'WbfsysEventStatus' );
      }

      $inputIdWbfsysEventStatus = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysEventStatus', 'Window' );
      $inputIdWbfsysEventStatus->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_event_status]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_event_status'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Event Status (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysEventStatus->assignedForm = $this->assignedForm;

      $inputIdWbfsysEventStatus->setWidth( 'medium' );

      $inputIdWbfsysEventStatus->setData( $this->entity->getData( 'id_wbfsys_event_status' )  );
      $inputIdWbfsysEventStatus->setReadOnly( $this->isReadOnly( 'id_wbfsys_event_status' ) );
      $inputIdWbfsysEventStatus->setLabel( $this->view->i18n->l( 'Wbfsys Event Status', 'wbfsys.event_status_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.EventStatus.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_event_status'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysEventStatus->setListUrl ( $listUrl );
      $inputIdWbfsysEventStatus->setListIcon( 'control/connect.png' );
      $inputIdWbfsysEventStatus->setEntityUrl( 'maintab.php?c=Wbfsys.EventStatus.edit' );
      $inputIdWbfsysEventStatus->conEntity         = $entityWbfsysEventStatus;
      $inputIdWbfsysEventStatus->refresh           = $this->refresh;
      $inputIdWbfsysEventStatus->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysEventStatus->view = $this->view;
      $inputIdWbfsysEventStatus->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_event_status'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysEventStatus );
  ...
  }//end public function input_id_wbfsys_event_status */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.event_status_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.event_status_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.event_status_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.event_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.event_status_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.event_status_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.event_status_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.event_status_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.event_status_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Event Status I18n)', 'wbfsys.event_status_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_event_status_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_event_status_i18n_m_role_change';
...
}//end class WbfsysEventStatusI18n_Form */
