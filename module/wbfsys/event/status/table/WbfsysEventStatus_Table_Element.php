 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_event_status';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysEventStatus_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.EventStatus.show&amp;target_mask=WbfsysEventStatus&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.EventStatus.edit&amp;target_mask=WbfsysEventStatus&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.event_status.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.EventStatus.delete&amp;target_mask=WbfsysEventStatus&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.event_status.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Wbfsys.EventStatus.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.event_status.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'wbfsys.event_status.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_event_status_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.EventStatus.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_event_status_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_event_status_description']).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.EventStatus_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected event Status." >{$iconDelete} Delete selected event Status</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! event Status. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.EventStatus_Multi.deleteAll" >{$iconClean} Delete all event Status</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysEventStatus_Table_Element
