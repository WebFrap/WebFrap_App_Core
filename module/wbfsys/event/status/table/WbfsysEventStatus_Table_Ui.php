 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für event Status
  *
  ...
  *  }
  *
  * @return WbfsysEventStatus_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEventStatus_Table_Element( 'tableWbfsysEventStatus', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_event_status-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'event Status', 'wbfsys.event_status.label' );
      //$tabPanel->searchKey = 'wbfsys_event_status';
      ...
      $searchElement->searchKey = 'wbfsys_event_status';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysEventStatus_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysEventStatus', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysEventStatus listing maske
   *
   * @param WbfsysEventStatus_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysEventStatus  = $model->getEntityWbfsysEventStatus();
    ...
    $formWbfsysEventStatus->setKeyName( 'wbfsys_event_status' );
...
}//end class WbfsysEventStatus_Table_Ui
