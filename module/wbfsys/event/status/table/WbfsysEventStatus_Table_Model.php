 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysEventStatus_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysEventStatus_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function changeOrder( $orders )
  {
    ...
    try
    {
      ...
      {
        $orm->update( "WbfsysEventStatus", $id, array( 'm_order' =>  $order ) );
      }
    }
    catch( LibDb_Exception $e )
    {
...
}//end class WbfsysEventStatus_Table_Model
