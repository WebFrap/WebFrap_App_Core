 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEventStatus Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEventStatus = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit event Status: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.EventStatus.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEventStatus
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.EventStatus.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_event_status-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/event_status/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEventStatus_Crud_Edit' );
...
}//end class WbfsysEventStatus_Crud_Edit_Maintab_View
