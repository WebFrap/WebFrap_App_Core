 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEventStatus_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysEventStatus_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysEventStatus_Entity */
      $entity = $orm->get( 'WbfsysEventStatus', $rootId );
    }
...
}//end class WbfsysEventStatus_Crud_Access_Root
