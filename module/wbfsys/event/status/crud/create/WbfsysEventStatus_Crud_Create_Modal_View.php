 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEventStatus entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.EventStatus.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.EventStatus.insert';
    $params->formId       = 'wgt-form-wbfsys_event_status';
    $params->namespace   = 'wbfsys_event_status-create';
    ...
    $this->setTemplate( 'wbfsys/event_status/modal/crud/form_create' );
...
}//end class WbfsysEventStatus_Crud_Create_Modal_View
