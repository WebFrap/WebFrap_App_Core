 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEventStatus_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEventStatus_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEventStatus_Selection_Element
    (
      'selectionWbfsysEventStatus',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection event Status', 'wbfsys.event_status.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.EventStatus.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysEventStatus',
      'WbfsysEventStatus_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysEventStatus_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEventStatus_Selection_Ui
