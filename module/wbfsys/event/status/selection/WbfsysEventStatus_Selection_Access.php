 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysEventStatus_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_event_status.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_event_status.rowid ",
      'acls'
    );
...
}//end class WbfsysEventStatus_Selection_Access
