 ...
 * @licence WebFrap.net
 */
class WbfsysEventStatus_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysEventStatus_Selection_Model
    */
    public $model = null;

    /**
    * @var WbfsysEventStatus_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/event_status/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'event Status', 'wbfsys.event_status.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.EventStatus.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-wbfsys_event_status-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'WbfsysEventStatus_Selection' );
...
}//end class WbfsysEventStatus_Selection_Modal_View
