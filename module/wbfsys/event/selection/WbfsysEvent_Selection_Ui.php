 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysEvent_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysEvent_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysEvent_Selection_Element
    (
      'selectionWbfsysEvent',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Events', 'wbfsys.event.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Event.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysEvent_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysEvent_Selection_Ui
