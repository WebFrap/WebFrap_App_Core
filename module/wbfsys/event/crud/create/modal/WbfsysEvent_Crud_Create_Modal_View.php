 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysEvent entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Event.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Event.insert';
    $params->formId       = 'wgt-form-wbfsys_event';
    $params->namespace   = 'wbfsys_event-create';
    ...
    $this->setTemplate( 'wbfsys/event/modal/crud/form_create' );
...
}//end class WbfsysEvent_Crud_Create_Modal_View
