 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysEvent Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEvent = $this->model->getEntityWbfsysEvent();
    ...
    (
      'Show Event: {@text@}',
      'wbfsys.event.label',
      array( 'text' => $entityWbfsysEvent->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Event.show  &amp;objid='.$entityWbfsysEvent
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Event.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_event-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/event/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysEvent_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Event.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_event' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_event a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Event.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Event.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysEvent_Crud_Show_Maintab_View
