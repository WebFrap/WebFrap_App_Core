 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysEvent_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity WbfsysEvent_Entity */
      $entity = $orm->get( 'WbfsysEvent', $rootId );
    }
...
}//end class WbfsysEvent_Crud_Access_Root
