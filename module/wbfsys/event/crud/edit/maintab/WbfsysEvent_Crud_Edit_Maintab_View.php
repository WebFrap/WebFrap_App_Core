 ...
 * @licence WebFrap.net
 */
class WbfsysEvent_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysEvent Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysEvent = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Event.edit&amp;utf8=✓&amp;objid='.$entityWbfsysEvent
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Event.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_event-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/event/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysEvent_Crud_Edit' );
...
}//end class WbfsysEvent_Crud_Edit_Maintab_View
