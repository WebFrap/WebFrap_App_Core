 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysBookmark_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_bookmark.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_bookmark.rowid ",
      'acls'
    );
...
}//end class WbfsysBookmark_Table_Access
