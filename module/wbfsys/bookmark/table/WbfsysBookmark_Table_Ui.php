...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Bookmarks
  *
  ...
  *  }
  *
  * @return WbfsysBookmark_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBookmark_Table_Element( 'tableWbfsysBookmark', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_bookmark-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Bookmarks', 'wbfsys.bookmark.label' );
      //$tabPanel->searchKey = 'wbfsys_bookmark';
      ...
      $searchElement->searchKey = 'wbfsys_bookmark';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysBookmark_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysBookmark', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysBookmark listing maske
   *
   * @param WbfsysBookmark_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysBookmark  = $model->getEntityWbfsysBookmark();
    ...
    $formWbfsysBookmark->setKeyName( 'wbfsys_bookmark' );
...
}//end class WbfsysBookmark_Table_Ui
