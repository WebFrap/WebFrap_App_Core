 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_bookmark';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysBookmark_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Bookmark.show&amp;target_mask=WbfsysBookmark&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Bookmark.edit&amp;target_mask=WbfsysBookmark&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.bookmark.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Bookmark.delete&amp;target_mask=WbfsysBookmark&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.bookmark.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'wbfsys.bookmark.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Url', 'wbfsys.bookmark.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_bookmark_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_bookmark_title'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_bookmark_url'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Bookmark_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Bookmarks." >{$iconDelete} Delete selected Bookmarks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Bookmarks. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Bookmark_Multi.deleteAll" >{$iconClean} Delete all Bookmarks</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysBookmark_Table_Element
