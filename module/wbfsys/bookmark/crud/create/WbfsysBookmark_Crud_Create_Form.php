 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysBookmark', array_keys( $this->fields['wbfsys_bookmark']), true ),
...
}//end class WbfsysBookmark_Crud_Create_Form */
