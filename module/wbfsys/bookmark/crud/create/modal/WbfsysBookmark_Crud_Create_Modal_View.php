 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysBookmark entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Bookmark.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Bookmark.insert';
    $params->formId       = 'wgt-form-wbfsys_bookmark';
    $params->namespace   = 'wbfsys_bookmark-create';
    ...
    $this->setTemplate( 'wbfsys/bookmark/modal/crud/form_create' );
...
}//end class WbfsysBookmark_Crud_Create_Modal_View
