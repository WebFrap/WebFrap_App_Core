 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysBookmark_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysBookmark_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysBookmark_Entity */
      $entity = $orm->get( 'WbfsysBookmark', $rootId );
    }
...
}//end class WbfsysBookmark_Crud_Access_Root
