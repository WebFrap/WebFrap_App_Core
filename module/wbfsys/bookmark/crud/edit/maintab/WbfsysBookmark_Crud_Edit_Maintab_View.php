 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysBookmark Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBookmark = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Bookmark.edit&amp;utf8=✓&amp;objid='.$entityWbfsysBookmark
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Bookmark.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_bookmark-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/bookmark/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysBookmark_Crud_Edit' );
...
}//end class WbfsysBookmark_Crud_Edit_Maintab_View
