 ...
 * @licence WebFrap.net
 */
class WbfsysBookmark_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysBookmark Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBookmark = $this->model->getEntityWbfsysBookmark();
    ...
    (
      ...
      array( 'text' => $entityWbfsysBookmark->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Bookmark.show  &amp;objid='.$entityWbfsysBookmark
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Bookmark.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_bookmark-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/bookmark/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysBookmark_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Bookmark.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_bookmark' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_bookmark a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Bookmark.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Bookmark.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysBookmark_Crud_Show_Maintab_View
