...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_bookmark';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysBookmark';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysBookmark' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysBookmark entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Bookmark)', 'wbfsys.bookmark.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'wbfsys.bookmark.label' ),
  ...
  public function input_id_role( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Role (Bookmark)', 'wbfsys.bookmark.label' ),
      ));
      ...
      $inputIdRole->setLabel( $this->view->i18n->l( 'Role', 'wbfsys.bookmark.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Entity (Bookmark)', 'wbfsys.bookmark.label' ),
      ));
      ...
      $inputIdEntity->setLabel( $this->view->i18n->l( 'Entity', 'wbfsys.bookmark.label' ) );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Bookmark)', 'wbfsys.bookmark.label' ),
        )
      );
      ...
      $inputVid->setLabel
      (
        $this->view->i18n->l( 'Vid', 'wbfsys.bookmark.label' ),
  ...
  * @return void
  */
  public function input_url( $params )
  {

      //tpl: class ui:text
      $inputUrl = $this->view->newInput( 'input'.$this->prefix.'Url' , 'Text' );
      $this->items['url'] = $inputUrl;
      $inputUrl->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[url]',
          'id'        => 'wgt-input-'.$this->keyName.'_url'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Url (Bookmark)', 'wbfsys.bookmark.label' ),
          'maxlength' => $this->entity->maxSize( 'url' ),
        )
      );
      $inputUrl->setWidth( 'medium' );

      $inputUrl->setReadOnly( $this->isReadOnly( 'url' ) );
      $inputUrl->setData( $this->entity->getSecure('url') );
      $inputUrl->setLabel
      (
        $this->view->i18n->l( 'Url', 'wbfsys.bookmark.label' ),
        $this->entity->required( 'url' )
      );
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Bookmark)', 'wbfsys.bookmark.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.bookmark.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Bookmark)', 'wbfsys.bookmark.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.bookmark.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Bookmark)', 'wbfsys.bookmark.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.bookmark.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Bookmark)', 'wbfsys.bookmark.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.bookmark.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Bookmark)', 'wbfsys.bookmark.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.bookmark.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Bookmark)', 'wbfsys.bookmark.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.bookmark.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Bookmark)', 'wbfsys.bookmark.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.bookmark.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Bookmark)', 'wbfsys.bookmark.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.bookmark.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Bookmark)', 'wbfsys.bookmark.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_bookmark_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_bookmark_m_role_change';
