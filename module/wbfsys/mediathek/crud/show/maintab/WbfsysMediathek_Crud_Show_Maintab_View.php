 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysMediathek_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysMediathek Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMediathek = $this->model->getEntityWbfsysMediathek();
    ...
    (
      ...
      array( 'text' => $entityWbfsysMediathek->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Mediathek.show  &amp;objid='.$entityWbfsysMediathek
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Mediathek.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mediathek-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mediathek/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysMediathek_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Mediathek.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mediathek' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_mediathek a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Mediathek.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Mediathek.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysMediathek_Crud_Show_Maintab_View
