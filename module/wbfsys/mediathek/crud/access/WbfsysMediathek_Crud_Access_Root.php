 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysMediathek_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysMediathek_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysMediathek_Entity */
      $entity = $orm->get( 'WbfsysMediathek', $rootId );
    }
...
}//end class WbfsysMediathek_Crud_Access_Root
