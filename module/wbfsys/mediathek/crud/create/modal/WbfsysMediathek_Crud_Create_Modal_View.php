 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysMediathek entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Mediathek.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Mediathek.insert';
    $params->formId       = 'wgt-form-wbfsys_mediathek';
    $params->namespace   = 'wbfsys_mediathek-create';
    ...
    $this->setTemplate( 'wbfsys/mediathek/modal/crud/form_create' );
...
}//end class WbfsysMediathek_Crud_Create_Modal_View
