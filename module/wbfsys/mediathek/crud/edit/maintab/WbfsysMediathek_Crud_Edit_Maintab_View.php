 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysMediathek Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysMediathek = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Mediathek.edit&amp;utf8=✓&amp;objid='.$entityWbfsysMediathek
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Mediathek.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_mediathek-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/mediathek/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysMediathek_Crud_Edit' );
...
}//end class WbfsysMediathek_Crud_Edit_Maintab_View
