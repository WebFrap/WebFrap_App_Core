 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysMediathek_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysMediathek_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMediathek_Selection_Element
    (
      'selectionWbfsysMediathek',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Mediatheks', 'wbfsys.mediathek.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Mediathek.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysMediathek',
      'WbfsysMediathek_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysMediathek_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysMediathek_Selection_Ui
