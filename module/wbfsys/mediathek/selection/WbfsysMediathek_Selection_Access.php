 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysMediathek_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_mediathek.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_mediathek.rowid ",
      'acls'
    );
...
}//end class WbfsysMediathek_Selection_Access
