 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_mediathek';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Mediathek.show&amp;target_mask=WbfsysMediathek&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Mediathek.edit&amp;target_mask=WbfsysMediathek&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mediathek.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mediathek.delete&amp;target_mask=WbfsysMediathek&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mediathek.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_mediathek_name'])).'</td>'.NL;
...
}//end class WbfsysMediathek_Selection_Element
