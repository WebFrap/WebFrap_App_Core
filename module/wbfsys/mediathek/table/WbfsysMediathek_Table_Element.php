 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_mediathek';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysMediathek_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Mediathek.show&amp;target_mask=WbfsysMediathek&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Mediathek.edit&amp;target_mask=WbfsysMediathek&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.mediathek.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Mediathek.delete&amp;target_mask=WbfsysMediathek&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.mediathek.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.mediathek.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_mediathek_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Mediathek.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_mediathek_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Mediathek_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Mediatheks." >{$iconDelete} Delete selected Mediatheks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Mediatheks. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Mediathek_Multi.deleteAll" >{$iconClean} Delete all Mediatheks</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysMediathek_Table_Element
