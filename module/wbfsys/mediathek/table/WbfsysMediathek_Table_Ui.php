 ...
 * @licence WebFrap.net
 */
class WbfsysMediathek_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Mediatheks
  *
  ...
  *  }
  *
  * @return WbfsysMediathek_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysMediathek_Table_Element( 'tableWbfsysMediathek', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_mediathek-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Mediatheks', 'wbfsys.mediathek.label' );
      //$tabPanel->searchKey = 'wbfsys_mediathek';
      ...
      $searchElement->searchKey = 'wbfsys_mediathek';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysMediathek_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysMediathek', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysMediathek listing maske
   *
   * @param WbfsysMediathek_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysMediathek  = $model->getEntityWbfsysMediathek();
    ...
    $formWbfsysMediathek->setKeyName( 'wbfsys_mediathek' );
...
}//end class WbfsysMediathek_Table_Ui
