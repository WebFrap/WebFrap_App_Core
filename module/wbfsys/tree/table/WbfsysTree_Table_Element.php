 ...
 * @licence WebFrap.net
 */
class WbfsysTree_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_tree';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTree_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Tree.show&amp;target_mask=WbfsysTree&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.tree.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Tree.edit&amp;target_mask=WbfsysTree&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tree.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Tree.delete&amp;target_mask=WbfsysTree&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tree.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.tree.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Tree.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_tree_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Tree_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Trees." >{$iconDelete} Delete selected Trees</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Trees. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Tree_Multi.deleteAll" >{$iconClean} Delete all Trees</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTree_Table_Element
