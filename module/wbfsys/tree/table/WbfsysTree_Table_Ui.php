...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Trees
  *
  ...
  *  }
  *
  * @return WbfsysTree_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTree_Table_Element( 'tableWbfsysTree', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tree-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Trees', 'wbfsys.tree.label' );
      //$tabPanel->searchKey = 'wbfsys_tree';
      ...
      $searchElement->searchKey = 'wbfsys_tree';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTree_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTree', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTree listing maske
   *
   * @param WbfsysTree_Table_Model $model
   * @param TFlag $params
   * @return void
   */
