 ...
 *
 * Entity Class for the Database Table wbfsys_tree
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_tree';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.Tree.show';
  ...
  */
  public static $entityName  = 'WbfsysTree';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'wbfsys.tree.message.error_def_name',
      'wrong'   => 'wbfsys.tree.message.error_wrong_name',
      'max'     => 'wbfsys.tree.message.error_max_name',
      'min'     => 'wbfsys.tree.message.error_min_name',
    ),

    'description' => array
    (
      'default' => 'wbfsys.tree.message.error_def_description',
      'wrong'   => 'wbfsys.tree.message.error_wrong_description',
      'max'     => 'wbfsys.tree.message.error_max_description',
      'min'     => 'wbfsys.tree.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.tree.message.error_def_rowid',
      'wrong'   => 'wbfsys.tree.message.error_wrong_rowid',
      'empty'   => 'wbfsys.tree.message.error_empty_rowid',
      'max'     => 'wbfsys.tree.message.error_max_rowid',
      'min'     => 'wbfsys.tree.message.error_min_rowid',
    ),
  );

}//end class WbfsysTree_Entity
