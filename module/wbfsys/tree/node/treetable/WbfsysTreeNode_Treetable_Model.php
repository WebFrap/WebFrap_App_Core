 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Treetable_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysTreeNode_Treetable' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysTreeNode_Treetable_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysTreeNode_Treetable_Model
