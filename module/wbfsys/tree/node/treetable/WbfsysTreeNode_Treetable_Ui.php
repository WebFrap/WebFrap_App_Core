 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTreeNode_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysTreeNode_Treetable_Element
    (
      'treetableWbfsysTreeNode',
      $view
    );
...
WGTJS;
   ...
   *
   * @return WbfsysTreeNode_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTreeNode', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysTreeNode_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysTreeNode_Treetable_Ui
