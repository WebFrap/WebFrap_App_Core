 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Treetable_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    else
    {
      ...
      (
        ...
        $params->aclNode,
        null,
        false,  // Rechte für die Referenzen nicht mitladen
  ...
  /**
   * @param WbfsysTreeNode_Treetable_Query $query
  ...
  public function fetchListTreetableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_tree_node.rowid as rowid' )  );
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_tree_node') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = wbfsys_tree_node.rowid ",
      'acls'
    );
...
}//end class WbfsysTreeNode_Treetable_Access
