 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTreeNode entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TreeNode.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TreeNode.insert';
    $params->formId       = 'wgt-form-wbfsys_tree_node';
    $params->namespace   = 'wbfsys_tree_node-create';
    ...
    $this->setTemplate( 'wbfsys/tree_node/modal/crud/form_create' );
...
}//end class WbfsysTreeNode_Crud_Create_Modal_View
