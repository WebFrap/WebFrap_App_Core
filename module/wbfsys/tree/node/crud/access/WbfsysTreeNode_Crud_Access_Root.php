 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTreeNode_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTreeNode_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTreeNode_Entity */
      $entity = $orm->get( 'WbfsysTreeNode', $rootId );
    }
...
}//end class WbfsysTreeNode_Crud_Access_Root
