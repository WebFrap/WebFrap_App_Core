 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTreeNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTreeNode = $this->model->getEntityWbfsysTreeNode();
    ...
    (
      ...
      array( 'text' => $entityWbfsysTreeNode->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TreeNode.show  &amp;objid='.$entityWbfsysTreeNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TreeNode.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tree_node-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tree_node/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTreeNode_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.TreeNode.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tree_node' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tree_node a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.TreeNode.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.TreeNode.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTreeNode_Crud_Show_Maintab_View
