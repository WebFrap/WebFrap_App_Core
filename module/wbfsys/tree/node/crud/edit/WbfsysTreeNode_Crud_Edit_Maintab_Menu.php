 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Crud_Edit_Maintab_Menu
  extends WgtDropmenu
{
    ...
    <div class="wgt-dropdownbox" id="{$this->id}-cruddropbox" >
      <ul id="{$this->id}-cruddrop-menu"  >
        <li><a
          ...
          title="Save the Tree Node and close the Tab after saving" >{$iconSaveUCl} {$view->i18n->l('Save &amp; Close','wbf.label')}</a></li>
      </ul>
...
BUTTON;
    ...
    if( $params->access->admin )
    {
      ...
      $entries->entryAcls = <<<HTML
          ...
          <li>
            <a 
              href="maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_tree_node&amp;objid={$objid}" 
...
HTML;
  ...
  <div class="wgt-panel-control" >
    <button
      class="wcm wcm_ui_button wgtac_back_to_list wcm_ui_tip-top"
      title="Go back to the Tree Nodes list" >{$iconBack} {$view->i18n->l('Back to the list','wbf.label')}</button>
  </div>
      ...
      <li>
        ...
        <ul>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_tree_node-edit" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
    ...
    $html = <<<HTML
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolDataset&dkey=wbfsys_tree_node&amp;objid={$objid}" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
          </li>


          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsDataset&dkey=wbfsys_tree_node&amp;objid={$objid}" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
          </li>


          <li>
            <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.showMeta&dkey=wbfsys_tree_node&amp;objid={$objid}" >{$iconMetaData} {$this->view->i18n->l( 'Meta Data', 'wbf.label' )}</a>
          </li>
...
}//end class WbfsysTreeNode_Crud_Edit_Maintab_Menu
