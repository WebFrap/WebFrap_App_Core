 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTreeNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTreeNode = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TreeNode.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTreeNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TreeNode.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tree_node-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tree_node/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTreeNode_Crud_Edit' );
...
}//end class WbfsysTreeNode_Crud_Edit_Maintab_View
