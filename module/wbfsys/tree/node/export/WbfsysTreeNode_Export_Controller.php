 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysTreeNode_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysTreeNode_Export_Listing_Access';
    ...
    // create a new WbfsysTreeNode window
    $view = $this->loadView
    (
    	'export-wbfsys_tree_node',
    	'WbfsysTreeNode_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysTreeNode_Export' );
...
} // end class WbfsysTreeNode_Export_Controller_Genf
