 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.TreeNode_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tree_node-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.TreeNode_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_tree_node-acl-update';
    ...
    $this->setTemplate( 'wbfsys/tree_node/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Tree Node', 'wbfsys.tree_node.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_tree_node_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysTreeNode_Acl' );
...
} // end class WbfsysTreeNode_Acl_Maintab_View */
