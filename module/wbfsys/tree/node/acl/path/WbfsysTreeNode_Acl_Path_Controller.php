 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_tree_node_acl_graph', 
      'WbfsysTreeNode_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysTreeNode_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysTreeNode_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysTreeNode_Acl_Path_Maintab_View  */
...
} // end class WbfsysTreeNode_Acl_Path_Controller */
