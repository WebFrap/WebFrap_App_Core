 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Path_Maintab_Menu
  extends WgtDropmenu
{////////////////////////////////////////////////////////////////////////////////
// build methodes
////////////////////////////////////////////////////////////////////////////////
    ...
    <span>
      <ul>
        <li><a 
          ...
          href="modal.php?c=Wbfsys.SecurityArea_Maintenance.help&amp;refer=wbfsys_tree_node-acl-path" >{$iconHelp} Help</a>
        </li>
        <!--
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Issue.create&amp;refer=wbfsys_tree_node-acl-path" >{$iconBug} Bug</a>
        </li>
        -->
        <li><a 
          class="wcm wcm_req_ajax" 
          href="modal.php?c=Wbfsys.Faq.create&amp;refer=wbfsys_tree_node-acl-path" >{$iconFaq} Faq</a>
        </li>
      </ul>
    </span>
  </li>
...
} // end class WbfsysTreeNode_Acl_Path_Maintab_Menu */
