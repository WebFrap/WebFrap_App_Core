 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysTreeNode_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysTreeNode_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysTreeNode = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTreeNode_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_tree_node-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysTreeNode, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTreeNode_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_tree_node-acl-dset', 
    	'WbfsysTreeNode_Acl_Dset',
...
} // end class WbfsysTreeNode_Acl_Dset_Controller */
