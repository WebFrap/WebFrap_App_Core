 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysTreeNode_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTreeNode_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysTreeNode, $areaId, $access, $params  )
  {

    $listObj = new WbfsysTreeNode_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_tree_node-acl-dset' );
    ...
    else
    {
      ...
      (
        'Tree Node "{@label@}" User Access',
        'wbfsys.tree_node.label',
        array
        (
          'label' => $entityWbfsysTreeNode->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_tree_node_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysTreeNode_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysTreeNode_Acl_Dset_Ui */
