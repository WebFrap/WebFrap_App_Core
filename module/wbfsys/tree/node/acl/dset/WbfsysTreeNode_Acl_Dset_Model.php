 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_tree_node'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysTreeNode', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTreeNode_Acl_Dset' );
    /* @var $query WbfsysTreeNode_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTreeNode_Acl_Dset_Treetable' );
    /* @var $query WbfsysTreeNode_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysTreeNode_Acl_Dset_Model */
