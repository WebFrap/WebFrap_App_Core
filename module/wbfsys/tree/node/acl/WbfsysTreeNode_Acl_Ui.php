...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysTreeNode_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTreeNode_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_tree_node-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Tree Node', 'wbfsys.tree_node.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_tree_node_acl';
...
} // end class WbfsysTreeNode_Acl_Ui */
