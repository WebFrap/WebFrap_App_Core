 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysTreeNode_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_tree_node-acl-qfdu-aAjax',
      'WbfsysTreeNode_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysTreeNode_Acl_Qfdu_Controller */
