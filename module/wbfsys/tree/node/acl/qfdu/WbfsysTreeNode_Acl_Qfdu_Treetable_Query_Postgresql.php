 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_tree_node.name as "wbfsys_tree_node_name"',
      'wbfsys_tree_node.rowid as "wbfsys_tree_node_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_tree_node on wbfsys_group_users.vid = wbfsys_tree_node.rowid'
    );
...
} // end class WbfsysTreeNode_Acl_Qfdu_Treetable_Query_Postgresql */
