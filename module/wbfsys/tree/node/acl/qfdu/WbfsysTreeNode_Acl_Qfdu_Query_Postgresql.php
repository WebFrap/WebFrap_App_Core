 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_tree_node.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_tree_node.rowid as id,
    wbfsys_tree_node.name as value,
    wbfsys_tree_node.name as label
  FROM
    wbfsys_tree_node
  WHERE
    {$sqlWhere}
...
} // end class WbfsysTreeNode_Acl_Qfdu_Query_Postgresql */
