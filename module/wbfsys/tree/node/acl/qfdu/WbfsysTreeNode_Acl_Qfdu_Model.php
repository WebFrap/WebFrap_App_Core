 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_tree_node')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysTreeNode = $orm->get('WbfsysTreeNode', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_tree_node_name']  = $refEntityWbfsysTreeNode->name;

    }
    $tabData['wbfsys_tree_node_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysTreeNode_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTreeNode_Acl' );
    /* @var $query WbfsysTreeNode_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTreeNode_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysTreeNode_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTreeNode_Acl_Qfdu' );
    /* @var $query WbfsysTreeNode_Acl_Qfdu_Query  */
...
} // end class WbfsysTreeNode_Acl_Qfdu_Model */
