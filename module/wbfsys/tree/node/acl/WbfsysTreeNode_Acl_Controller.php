 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysTreeNode
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysTreeNode_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysTreeNode_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysTreeNode_Acl_Model */
    $model   = $this->loadModel( 'WbfsysTreeNode_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_tree_node-acl',
    	'WbfsysTreeNode_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_tree_node_acl_masks_listing',
      'WbfsysTreeNode_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysTreeNode_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysTreeNode_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysTreeNode_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysTreeNode_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysTreeNode_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysTreeNode_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_tree_node-acl-qfdu',
    	'WbfsysTreeNode_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysTreeNode_Acl_Controller */
