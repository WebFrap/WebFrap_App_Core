 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_tree_node';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TreeNode.show&amp;target_mask=WbfsysTreeNode&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TreeNode.edit&amp;target_mask=WbfsysTreeNode&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tree_node.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TreeNode.delete&amp;target_mask=WbfsysTreeNode&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tree_node.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.TreeNode_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.tree_node.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_tree_node_name']).'</td>'.NL;
...
}//end class WbfsysTreeNode_Selection_Element
