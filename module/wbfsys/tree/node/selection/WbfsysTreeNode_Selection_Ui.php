 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysTreeNode_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysTreeNode_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTreeNode_Selection_Element
    (
      'selectionWbfsysTreeNode',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Tree Nodes', 'wbfsys.tree_node.label' ) ;
      $tabPanel->searchKey = 'wbfsys_tree_node';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.TreeNode.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysTreeNode',
      'WbfsysTreeNode_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTreeNode' , $table->buildAjax() );
...
WGTJS;
   ...
   * die WbfsysTreeNode listing maske
   *
   * @param WbfsysTreeNode_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTreeNode  = $model->getEntityWbfsysTreeNode();
    ...
    $formWbfsysTreeNode->setKeyName( 'wbfsys_tree_node' );
...
}//end class WbfsysTreeNode_Selection_Ui
