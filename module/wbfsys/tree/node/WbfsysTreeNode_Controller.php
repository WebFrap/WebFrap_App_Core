 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_tree_node
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.TreeNode.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_tree_node-create';

    $access = new WbfsysTreeNode_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_tree_node-create',
      'WbfsysTreeNode_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysTreeNode_Crud_Model */
    $model = $this->loadModel( 'WbfsysTreeNode_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.TreeNode.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysTreeNode = $model->getEntityWbfsysTreeNode( $objid );
    ...
    $params->entity = $entityWbfsysTreeNode;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_tree_node:edit';

    $access = new WbfsysTreeNode_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysTreeNode );
    ...
    $view = $response->loadView
    (
      'form-wbfsys_tree_node-edit-'.$objid,
      'WbfsysTreeNode_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'wbfsys_tree_node-edit',
          $entityWbfsysTreeNode,
          'Edit Tree Node :'.$entityWbfsysTreeNode->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_tree_node';
      $params->maskRoot      = 'wbfsys_tree_node:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_tree_node';
      $params->aclNode       = 'mgmt-wbfsys_tree_node';
      $params->aclLevel      = 1;
    }
    ...
    if( $params->isAclRoot )
    {
      ...
      (
        'mod-wbfsys>mgmt-wbfsys_tree_node',
        $entityWbfsysTreeNode
      );
    }
    else
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'wbfsys_tree_node-show',
          $entityWbfsysTreeNode,
          'Show Tree Node :'.$entityWbfsysTreeNode->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_tree_node
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.TreeNode.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-insert';

    $access = new WbfsysTreeNode_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityWbfsysTreeNode = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_tree_node-update-'.$entityWbfsysTreeNode;
      ...
      {
        $access = new WbfsysTreeNode_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysTreeNode );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'WbfsysTreeNode';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_wbfsys_tree_node',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model WbfsysTreeNode_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Wbfsys.TreeNode.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysTreeNode, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysTreeNode_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.TreeNode.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-delete-'.$objid;

    $access = new WbfsysTreeNode_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysTreeNode );
    ...
    $error = $model->delete( $entityWbfsysTreeNode, $params );
    ...
    $error = $view->displayDelete( $entityWbfsysTreeNode, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.TreeNode.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.TreeNode.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-listing';
    ...
    $containerClass = 'WbfsysTreeNode_'.$listType.'_Access';
    ...
    /* @var $model WbfsysTreeNode_Table_Model */
    $model = $this->loadModel( 'WbfsysTreeNode_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_tree_node-'.$params->ltype,
          'WbfsysTreeNode',
          'List of Tree Nodes'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysTreeNode
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysTreeNode_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_tree_node',
      'WbfsysTreeNode_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysTreeNode_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.TreeNode.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysTreeNode_Selection_Model */
    $model   = $this->loadModel( 'WbfsysTreeNode_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_tree_node-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_tree_node-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-wbfsys_tree_node',
      'WbfsysTreeNode',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysTreeNode, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-append-'.$objid;
    ...
    $ui = $this->loadUi( 'WbfsysTreeNode_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysTreeNode_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_tree_node-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_tree_node' );
...
} // end class WbfsysTreeNode_Controller */
