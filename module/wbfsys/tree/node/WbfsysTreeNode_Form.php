...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_tree_node';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysTreeNode';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysTreeNode' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysTreeNode entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_m_parent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTreeNode_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Parent Node (Tree Node)', 'wbfsys.tree_node.label' ),
      ));
      ...
      $inputMParent->setLabel( $this->view->i18n->l( 'Parent Node', 'wbfsys.tree_node.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.TreeNode.selection'
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Tree Node)', 'wbfsys.tree_node.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.tree_node.label' ),
  ...
  * @return void
  */
  public function input_id_tree( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTree_Entity' ) )
    {
      ...
      $inputIdTree = $this->view->newInput( 'input'.$this->prefix.'IdTree', 'Window' );
      $inputIdTree->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_tree]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_tree'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Tree (Tree Node)', 'wbfsys.tree_node.label' ),
      ));
      ...
      $inputIdTree->setReadOnly( $this->isReadOnly( 'id_tree' ) );
      $inputIdTree->setLabel( $this->view->i18n->l( 'Tree', 'wbfsys.tree_node.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Tree.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_tree'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdTree->buildJavascript( 'wgt-input-'.$this->keyName.'_id_tree'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_tree */
  ...
  * @return void
  */
  public function input_flag_folder( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagFolder = $this->view->newInput( 'input'.$this->prefix.'FlagFolder' , 'Checkbox' );
      $this->items['flag_folder'] = $inputFlagFolder;
      $inputFlagFolder->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_folder]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_folder'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Folder (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      $inputFlagFolder->setWidth( 'medium' );

      $inputFlagFolder->setReadOnly( $this->isReadOnly( 'flag_folder' ) );
      $inputFlagFolder->setActive( $this->entity->getBoolean( 'flag_folder' ) );
      $inputFlagFolder->setLabel
      (
        $this->view->i18n->l( 'Folder', 'wbfsys.tree_node.label' ),
        $this->entity->required( 'flag_folder' )
      );
  ...
  }//end public function input_flag_folder */
  ...
  */
  public function input_vid( $params )
  {
      ...
      //tpl: class ui:int
      $inputVid = $this->view->newInput( 'input'.$this->prefix.'Vid', 'Int' );
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      ...
      $inputVid->setLabel
      (
        $this->view->i18n->l( 'Vid', 'wbfsys.tree_node.label' ),
        $this->entity->required( 'vid' )
      );
  ...
  * @return void
  */
  public function input_entity( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      $inputEntity = $this->view->newInput( 'input'.$this->prefix.'Entity', 'Window' );
      $inputEntity->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[entity]',
        'id'        => 'wgt-input-'.$this->keyName.'_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Entity (Tree Node)', 'wbfsys.tree_node.label' ),
      ));
      ...
      $inputEntity->setReadOnly( $this->isReadOnly( 'entity' ) );
      $inputEntity->setLabel( $this->view->i18n->l( 'Entity', 'wbfsys.tree_node.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Entity.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_entity'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputEntity->buildJavascript( 'wgt-input-'.$this->keyName.'_entity'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_entity */
  ...
  public function input_icon( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Icon (Tree Node)', 'wbfsys.tree_node.label' ),
      ...
      $inputIcon->setLabel
      (
        $this->view->i18n->l( 'Icon', 'wbfsys.tree_node.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.tree_node.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.tree_node.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Tree Node)', 'wbfsys.tree_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.tree_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Tree Node)', 'wbfsys.tree_node.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.tree_node.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Tree Node)', 'wbfsys.tree_node.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.tree_node.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Tree Node)', 'wbfsys.tree_node.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.tree_node.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.tree_node.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Tree Node)', 'wbfsys.tree_node.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.tree_node.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Tree Node)', 'wbfsys.tree_node.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tree_node_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tree_node_m_role_change';
