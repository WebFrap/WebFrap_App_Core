 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_tree_node';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTreeNode_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TreeNode.show&amp;target_mask=WbfsysTreeNode&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TreeNode.edit&amp;target_mask=WbfsysTreeNode&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tree_node.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TreeNode.delete&amp;target_mask=WbfsysTreeNode&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tree_node.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.tree_node.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_tree_node_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.TreeNode_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Tree Nodes." >{$iconDelete} Delete selected Tree Nodes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Tree Nodes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.TreeNode_Multi.deleteAll" >{$iconClean} Delete all Tree Nodes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTreeNode_Table_Element
