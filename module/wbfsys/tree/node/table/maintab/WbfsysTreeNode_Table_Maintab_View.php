 ...
 * @licence WebFrap.net
 */
class WbfsysTreeNode_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysTreeNode_Table_Model
    */
    public $model = null;

    /**
    * @var WbfsysTreeNode_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'wbfsys/tree_node/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Wbfsys.TreeNode.listing&amp;ltype=table'
    );
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'WbfsysTreeNode_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Wbfsys.TreeNode.create&amp;ltype=table');
    });
...
}//end class WbfsysTreeNode_Table_Maintab_View
