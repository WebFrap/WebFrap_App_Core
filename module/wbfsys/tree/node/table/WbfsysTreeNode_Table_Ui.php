...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Tree Nodes
  *
  ...
  *  }
  *
  * @return WbfsysTreeNode_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTreeNode_Table_Element( 'tableWbfsysTreeNode', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tree_node-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Tree Nodes', 'wbfsys.tree_node.label' );
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTreeNode_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param WbfsysTreeNode_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysTreeNode_Table_Ui
