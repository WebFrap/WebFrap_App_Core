 ...
 * @licence WebFrap.net
 */
class WbfsysTree_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTree Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTree = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Tree.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTree
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Tree.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tree-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tree/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTree_Crud_Edit' );
...
}//end class WbfsysTree_Crud_Edit_Maintab_View
