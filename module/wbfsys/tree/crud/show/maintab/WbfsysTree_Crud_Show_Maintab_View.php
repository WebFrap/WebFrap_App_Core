 ...
 * @licence WebFrap.net
 */
class WbfsysTree_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTree Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTree = $this->model->getEntityWbfsysTree();
    ...
    (
      'Show Tree: {@text@}',
      'wbfsys.tree.label',
      array( 'text' => $entityWbfsysTree->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Tree.show  &amp;objid='.$entityWbfsysTree
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Tree.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tree-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tree/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTree_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Tree.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tree' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tree a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Tree.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Tree.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTree_Crud_Show_Maintab_View
