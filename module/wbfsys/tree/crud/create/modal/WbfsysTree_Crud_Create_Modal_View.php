 ...
 * @licence WebFrap.net
 */
class WbfsysTree_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTree entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Tree.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Tree.insert';
    $params->formId       = 'wgt-form-wbfsys_tree';
    $params->namespace   = 'wbfsys_tree-create';
    ...
    $this->setTemplate( 'wbfsys/tree/modal/crud/form_create' );
...
}//end class WbfsysTree_Crud_Create_Modal_View
