 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_fix_id';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysFixId_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.FixId.show&amp;target_mask=WbfsysFixId&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.fix_id.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.FixId.edit&amp;target_mask=WbfsysFixId&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.fix_id.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.FixId.delete&amp;target_mask=WbfsysFixId&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.fix_id.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.FixId_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Fix Ids." >{$iconDelete} Delete selected Fix Ids</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Fix Ids. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.FixId_Multi.deleteAll" >{$iconClean} Delete all Fix Ids</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysFixId_Table_Element
