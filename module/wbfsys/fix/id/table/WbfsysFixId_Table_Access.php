 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysFixId_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_fix_id.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_fix_id.rowid ",
      'acls'
    );
...
}//end class WbfsysFixId_Table_Access
