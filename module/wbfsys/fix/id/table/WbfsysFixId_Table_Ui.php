...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Fix Ids
  *
  ...
  *  }
  *
  * @return WbfsysFixId_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysFixId_Table_Element( 'tableWbfsysFixId', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_fix_id-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Fix Ids', 'wbfsys.fix_id.label' );
      //$tabPanel->searchKey = 'wbfsys_fix_id';
      ...
      $searchElement->searchKey = 'wbfsys_fix_id';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysFixId_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysFixId', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysFixId listing maske
   *
   * @param WbfsysFixId_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysFixId_Table_Ui
