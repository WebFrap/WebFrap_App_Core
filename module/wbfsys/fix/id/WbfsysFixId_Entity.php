 ...
 *
 * Entity Class for the Database Table wbfsys_fix_id
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_fix_id';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.FixId.show';
  ...
  */
  public static $entityName  = 'WbfsysFixId';
  ...
  */
  ...
  (
    'access_key' => array
    (
      'default' => 'wbfsys.fix_id.message.error_def_access_key',
      'wrong'   => 'wbfsys.fix_id.message.error_wrong_access_key',
      'max'     => 'wbfsys.fix_id.message.error_max_access_key',
      'min'     => 'wbfsys.fix_id.message.error_min_access_key',
    ),

    'value' => array
    (
      'default' => 'wbfsys.fix_id.message.error_def_value',
      'wrong'   => 'wbfsys.fix_id.message.error_wrong_value',
      'max'     => 'wbfsys.fix_id.message.error_max_value',
      'min'     => 'wbfsys.fix_id.message.error_min_value',
    ),

    'description' => array
    (
      'default' => 'wbfsys.fix_id.message.error_def_description',
      'wrong'   => 'wbfsys.fix_id.message.error_wrong_description',
      'max'     => 'wbfsys.fix_id.message.error_max_description',
      'min'     => 'wbfsys.fix_id.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.fix_id.message.error_def_rowid',
      'wrong'   => 'wbfsys.fix_id.message.error_wrong_rowid',
      'empty'   => 'wbfsys.fix_id.message.error_empty_rowid',
      'max'     => 'wbfsys.fix_id.message.error_max_rowid',
      'min'     => 'wbfsys.fix_id.message.error_min_rowid',
    ),
  );

}//end class WbfsysFixId_Entity
