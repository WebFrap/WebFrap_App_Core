 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysFixId Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFixId = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FixId.edit&amp;utf8=✓&amp;objid='.$entityWbfsysFixId
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FixId.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_fix_id-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/fix_id/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysFixId_Crud_Edit' );
...
}//end class WbfsysFixId_Crud_Edit_Maintab_View
