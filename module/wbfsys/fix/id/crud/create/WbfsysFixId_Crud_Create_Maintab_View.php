 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysFixId Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_fix_id-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/fix_id/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FixId.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_fix_id';
    ...
    $form = $this->newForm( 'WbfsysFixId_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.FixId.create');}});
});
...
}//end class WbfsysFixId_Crud_Create_Maintab_View
