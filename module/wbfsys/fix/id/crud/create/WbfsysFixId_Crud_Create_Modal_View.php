 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysFixId entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.FixId.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.FixId.insert';
    $params->formId       = 'wgt-form-wbfsys_fix_id';
    $params->namespace   = 'wbfsys_fix_id-create';
    ...
    $this->setTemplate( 'wbfsys/fix_id/modal/crud/form_create' );
...
}//end class WbfsysFixId_Crud_Create_Modal_View
