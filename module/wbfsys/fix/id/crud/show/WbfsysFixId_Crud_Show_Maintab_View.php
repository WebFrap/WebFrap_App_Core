 ...
 * @licence WebFrap.net
 */
class WbfsysFixId_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysFixId Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysFixId = $this->model->getEntityWbfsysFixId();
    ...
    (
      'Show Fix Id: {@text@}',
      'wbfsys.fix_id.label',
      array( 'text' => $entityWbfsysFixId->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.FixId.show  &amp;objid='.$entityWbfsysFixId
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.FixId.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_fix_id-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/fix_id/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysFixId_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.FixId.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_fix_id' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_fix_id a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.FixId.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.FixId.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysFixId_Crud_Show_Maintab_View
