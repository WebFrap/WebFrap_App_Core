 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_WbfsysContext_MParent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysContext_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Wbfsys.Context.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysContext', array_keys( $this->fields['wbfsys_context']), true ),
...
}//end class WbfsysContext_Crud_Create_Form */
