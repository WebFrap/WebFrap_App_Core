 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysContext entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Context.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Context.insert';
    $params->formId       = 'wgt-form-wbfsys_context';
    $params->namespace   = 'wbfsys_context-create';
    ...
    $this->setTemplate( 'wbfsys/context/modal/crud/form_create' );
...
}//end class WbfsysContext_Crud_Create_Modal_View
