 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysContext Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysContext = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Context.edit&amp;utf8=✓&amp;objid='.$entityWbfsysContext
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Context.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_context-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/context/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysContext_Crud_Edit' );
...
}//end class WbfsysContext_Crud_Edit_Maintab_View
