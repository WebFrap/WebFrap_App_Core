 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysContext Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysContext = $this->model->getEntityWbfsysContext();
    ...
    (
      ...
      array( 'text' => $entityWbfsysContext->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Context.show  &amp;objid='.$entityWbfsysContext
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Context.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_context-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/context/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysContext_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Context.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_context' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_context a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Context.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Context.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysContext_Crud_Show_Maintab_View
