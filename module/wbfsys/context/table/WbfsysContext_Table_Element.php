 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_context';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysContext_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Context.show&amp;target_mask=WbfsysContext&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Context.edit&amp;target_mask=WbfsysContext&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.context.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Context.delete&amp;target_mask=WbfsysContext&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.context.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.context.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_context_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Context.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_context_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Context_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Contexts." >{$iconDelete} Delete selected Contexts</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Contexts. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Context_Multi.deleteAll" >{$iconClean} Delete all Contexts</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysContext_Table_Element
