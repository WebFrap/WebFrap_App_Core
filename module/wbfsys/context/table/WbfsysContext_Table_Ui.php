...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Contexts
  *
  ...
  *  }
  *
  * @return WbfsysContext_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysContext_Table_Element( 'tableWbfsysContext', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_context-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Contexts', 'wbfsys.context.label' );
      //$tabPanel->searchKey = 'wbfsys_context';
      ...
      $searchElement->searchKey = 'wbfsys_context';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysContext_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysContext', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysContext listing maske
   *
   * @param WbfsysContext_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysContext  = $model->getEntityWbfsysContext();
    ...
    $formWbfsysContext->setKeyName( 'wbfsys_context' );
...
}//end class WbfsysContext_Table_Ui
