 ...
 * @licence WebFrap.net
 */
class WbfsysContext_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_context where rowid > 0;
SQL;
  ...
  public function fetchAutocomplete( $key )
  {
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_context.rowid as id,
    wbfsys_context.name as value

  FROM
    wbfsys_context

  WHERE
    upper(wbfsys_context.name) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysContext_Query_Postgresql
