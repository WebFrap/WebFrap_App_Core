 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Ref_Version_Table_Query_Postgresql
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_browser_version.rowid as "wbfsys_browser_version_rowid"', // variant:  
      'wbfsys_browser_version.name as "wbfsys_browser_version_name"', // variant:  
      'wbfsys_browser_version.code_name as "wbfsys_browser_version_code_name"', // variant:  
    );
...
}//end class WbfsysBrowser_Ref_Version_Table_Query_Postgresql
