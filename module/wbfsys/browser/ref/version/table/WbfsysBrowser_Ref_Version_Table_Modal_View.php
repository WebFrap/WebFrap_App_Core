 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Ref_Version_Table_Modal_View
  extends WgtModal
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayTab( $objid, $params )
  {
    ...
    $this->setTemplate( 'wbfsys/browser/ref_version/tab_table' );
...
}//end class WbfsysBrowser_Ref_Version_Table_Modal_View
