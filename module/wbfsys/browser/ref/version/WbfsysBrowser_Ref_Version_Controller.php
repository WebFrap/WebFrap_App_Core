 ...
 * If you want to extend this class write your coden in ControllerWbfsysBrowser
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Ref_Version_Controller
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Service zum laden des version Referenztabs
  * für den wbfsys_browser management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysBrowser_Ref_Version_".$listType."_Access";
    ...
    $accessVersion = new $containerClass( );
    $accessVersion->load( $user->getProfileName(), $params );

    $params->aclNode = 'mod-wbfsys-cat-core_data-ref-version';

    $params->accessVersion = $accessVersion;
    $params->paramsVersion = $params;
    
    // ok wenn er nichtmal lesen darf, dann ist hier direkt schluss
    if( !$accessVersion->listing  )
    {
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_browser-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysBrowser_Ref_Version_'.$listType,
      'displayTab',
      View::AREA
    );
    ...
    $modelVersion = $this->loadModel
    (
      'WbfsysBrowser_Ref_Version_'.$listType
    );
    $modelVersion->setAccess( $accessVersion );
    
    $view->setModel( $modelVersion );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $params->refId = $objid;    $params->refIdVersion = $objid;

    // load the model and run the search
    $model   = $this->loadModel( 'WbfsysBrowser_Ref_Version_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_browser-ref-version-'.$listType.'-ajax',
    	'WbfsysBrowser_Ref_Version_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * delete a WbfsysBrowserVersion by an ajax request
   * @return boolean
   */
  public function cleanPost( )
  {

    $this->request->removePost( 'wbfsys_browser_version' ); //def wbfsys_browser_version


  } // end public function cleanPost */

} // end WbfsysBrowser_Ref_Version_Controller
