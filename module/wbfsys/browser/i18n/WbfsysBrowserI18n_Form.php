...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_browser_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysBrowserI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysBrowserI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysBrowserI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysBrowserI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysBrowserI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysBrowserI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.browser_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_browser
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_browser( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysBrowser_Entity' ) )
    {
      ...
      //p: Window
      $objidWbfsysBrowser = $this->entity->getData('id_wbfsys_browser') ;
      ...
      $inputIdWbfsysBrowser = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysBrowser', 'Window' );
      $inputIdWbfsysBrowser->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_browser]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_browser'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Browser (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysBrowser->assignedForm = $this->assignedForm;

      $inputIdWbfsysBrowser->setWidth( 'medium' );

      $inputIdWbfsysBrowser->setData( $this->entity->getData( 'id_wbfsys_browser' )  );
      $inputIdWbfsysBrowser->setReadOnly( $this->isReadOnly( 'id_wbfsys_browser' ) );
      $inputIdWbfsysBrowser->setLabel( $this->view->i18n->l( 'Wbfsys Browser', 'wbfsys.browser_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Browser.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_browser'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysBrowser->setListUrl ( $listUrl );
      $inputIdWbfsysBrowser->setListIcon( 'control/connect.png' );
      $inputIdWbfsysBrowser->setEntityUrl( 'maintab.php?c=Wbfsys.Browser.edit' );
      $inputIdWbfsysBrowser->conEntity         = $entityWbfsysBrowser;
      $inputIdWbfsysBrowser->refresh           = $this->refresh;
      $inputIdWbfsysBrowser->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysBrowser->view = $this->view;
      $inputIdWbfsysBrowser->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_browser'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysBrowser );
  ...
  }//end public function input_id_wbfsys_browser */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.browser_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Browser I18n)', 'wbfsys.browser_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.browser_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Browser I18n)', 'wbfsys.browser_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.browser_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.browser_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.browser_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.browser_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Browser I18n)', 'wbfsys.browser_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.browser_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Browser I18n)', 'wbfsys.browser_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.browser_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Browser I18n)', 'wbfsys.browser_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.browser_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Browser I18n)', 'wbfsys.browser_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Browser I18n)', 'wbfsys.browser_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_browser_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_browser_i18n_m_role_change';
...
}//end class WbfsysBrowserI18n_Form */
