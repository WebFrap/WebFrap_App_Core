 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysBrowser Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_browser.rowid as id',
      'wbfsys_browser.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_browser.m_order as "wbfsys_browser-m_order-order"' );

    $criteria->from( 'wbfsys_browser' );



      $criteria->orderBy( 'wbfsys_browser.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_browser.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_browser.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysBrowser_Selectbox_Query_Postgresql
