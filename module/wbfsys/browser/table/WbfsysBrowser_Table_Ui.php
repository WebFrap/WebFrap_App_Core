...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Browsers
  *
  ...
  *  }
  *
  * @return WbfsysBrowser_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBrowser_Table_Element( 'tableWbfsysBrowser', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_browser-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Browsers', 'wbfsys.browser.label' );
      //$tabPanel->searchKey = 'wbfsys_browser';
      ...
      $searchElement->searchKey = 'wbfsys_browser';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysBrowser_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysBrowser', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysBrowser listing maske
   *
  ...
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysBrowser  = $model->getEntityWbfsysBrowser();
    ...
    $formWbfsysBrowser->setKeyName( 'wbfsys_browser' );
...
}//end class WbfsysBrowser_Table_Ui
