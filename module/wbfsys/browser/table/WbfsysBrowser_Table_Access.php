 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysBrowser_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_browser.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_browser.rowid ",
      'acls'
    );
...
}//end class WbfsysBrowser_Table_Access
