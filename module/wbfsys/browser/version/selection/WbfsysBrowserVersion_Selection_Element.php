 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_browser_version';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.BrowserVersion.show&amp;target_mask=WbfsysBrowserVersion&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.BrowserVersion.edit&amp;target_mask=WbfsysBrowserVersion&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.browser_version.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.BrowserVersion.delete&amp;target_mask=WbfsysBrowserVersion&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.browser_version.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_browser_version_name'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_browser_version_code_name'])).'</td>'.NL;
...
}//end class WbfsysBrowserVersion_Selection_Element
