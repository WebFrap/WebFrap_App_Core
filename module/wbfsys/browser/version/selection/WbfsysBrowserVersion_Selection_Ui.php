 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysBrowserVersion_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysBrowserVersion_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysBrowserVersion_Selection_Element
    (
      'selectionWbfsysBrowserVersion',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Browser Versions', 'wbfsys.browser_version.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.BrowserVersion.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysBrowserVersion',
      'WbfsysBrowserVersion_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysBrowserVersion_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysBrowserVersion_Selection_Ui
