 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysBrowserVersion_'.$listType ) );
...
} // end class WbfsysBrowserVersion_Listing_Controller */
