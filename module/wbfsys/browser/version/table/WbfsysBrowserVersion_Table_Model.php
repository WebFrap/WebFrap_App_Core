 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysBrowserVersion_Table' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysBrowserVersion_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysBrowserVersion_Table_Model
