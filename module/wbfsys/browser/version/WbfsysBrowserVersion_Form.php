 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_browser_version';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysBrowserVersion';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysBrowserVersion' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysBrowserVersion entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.browser_version.label' ),
  ...
  public function input_code_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Code name (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Code name', 'wbfsys.browser_version.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.browser_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysBrowser_Selectbox' ) )
    {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Browser (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Browser', 'wbfsys.browser_version.label' ),
  ...
  * @return void
  */
  public function input_supported( $params )
  {

      //tpl: class ui:Checkbox
      $inputSupported = $this->view->newInput( 'input'.$this->prefix.'Supported' , 'Checkbox' );
      $this->items['supported'] = $inputSupported;
      $inputSupported->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[supported]',
          'id'        => 'wgt-input-'.$this->keyName.'_supported'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Supported (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      $inputSupported->setWidth( 'medium' );

      $inputSupported->setReadOnly( $this->isReadOnly( 'supported' ) );
      $inputSupported->setActive( $this->entity->getBoolean( 'supported' ) );
      $inputSupported->setLabel
      (
        $this->view->i18n->l( 'Supported', 'wbfsys.browser_version.label' ),
        $this->entity->required( 'supported' )
      );
  ...
  }//end public function input_supported */
  ...
  public function input_released( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Released (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Released', 'wbfsys.browser_version.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.browser_version.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.browser_version.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.browser_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Browser Version)', 'wbfsys.browser_version.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.browser_version.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Browser Version)', 'wbfsys.browser_version.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.browser_version.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Browser Version)', 'wbfsys.browser_version.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.browser_version.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.browser_version.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Browser Version)', 'wbfsys.browser_version.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.browser_version.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Browser Version)', 'wbfsys.browser_version.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_code_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_code_name'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for Code name (Browser Version)', 'wbfsys.browser_version.label' ),
          'maxlength' => $this->entity->maxSize( 'code_name' ),
        )
      );
      $inputCodeName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Browser Version)', 'wbfsys.browser_version.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_browser_version_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_browser_version_m_role_change';
...
}//end class WbfsysBrowserVersion_Form */
