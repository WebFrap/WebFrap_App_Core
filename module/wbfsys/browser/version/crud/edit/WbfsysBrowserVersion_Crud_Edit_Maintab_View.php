 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysBrowserVersion Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBrowserVersion = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Browser Version: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.BrowserVersion.edit&amp;utf8=✓&amp;objid='.$entityWbfsysBrowserVersion
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.BrowserVersion.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_browser_version-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/browser_version/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysBrowserVersion_Crud_Edit' );
...
}//end class WbfsysBrowserVersion_Crud_Edit_Maintab_View
