 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysBrowserVersion_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysBrowserVersion_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysBrowserVersion_Entity */
      $entity = $orm->get( 'WbfsysBrowserVersion', $rootId );
    }
...
}//end class WbfsysBrowserVersion_Crud_Access_Root
