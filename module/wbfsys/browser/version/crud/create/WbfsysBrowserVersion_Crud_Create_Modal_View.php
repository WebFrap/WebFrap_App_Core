 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysBrowserVersion entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.BrowserVersion.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.BrowserVersion.insert';
    $params->formId       = 'wgt-form-wbfsys_browser_version';
    $params->namespace   = 'wbfsys_browser_version-create';
    ...
    $this->setTemplate( 'wbfsys/browser_version/modal/crud/form_create' );
...
}//end class WbfsysBrowserVersion_Crud_Create_Modal_View
