 ...
 * @licence WebFrap.net
 */
class WbfsysBrowserVersion_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysBrowserVersion Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_browser_version-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/browser_version/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.BrowserVersion.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_browser_version';
    ...
    $form = $this->newForm( 'WbfsysBrowserVersion_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.BrowserVersion.create');}});
});
...
}//end class WbfsysBrowserVersion_Crud_Create_Maintab_View
