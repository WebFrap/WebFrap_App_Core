 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysBrowser_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysBrowser_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysBrowser_Entity */
      $entity = $orm->get( 'WbfsysBrowser', $rootId );
    }
...
}//end class WbfsysBrowser_Crud_Access_Root
