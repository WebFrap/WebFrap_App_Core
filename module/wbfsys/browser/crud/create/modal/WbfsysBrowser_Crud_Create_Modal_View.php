 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysBrowser entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Browser.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Browser.insert';
    $params->formId       = 'wgt-form-wbfsys_browser';
    $params->namespace   = 'wbfsys_browser-create';
    ...
    $this->setTemplate( 'wbfsys/browser/modal/crud/form_create' );
...
}//end class WbfsysBrowser_Crud_Create_Modal_View
