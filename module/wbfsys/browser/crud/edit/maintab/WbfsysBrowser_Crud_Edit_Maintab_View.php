 ...
 * @licence WebFrap.net
 */
class WbfsysBrowser_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysBrowser Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysBrowser = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Browser.edit&amp;utf8=✓&amp;objid='.$entityWbfsysBrowser
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Browser.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_browser-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/browser/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysBrowser_Crud_Edit' );
...
}//end class WbfsysBrowser_Crud_Edit_Maintab_View
