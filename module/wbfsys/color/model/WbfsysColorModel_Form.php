...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_color_model';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysColorModel';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysColorModel' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysColorModel entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Name (Color Model)', 'wbfsys.color_model.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.color_model.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Color Model)', 'wbfsys.color_model.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'wbfsys.color_model.label' ),
  ...
  * @return void
  */
  public function input_idkey( $params )
  {

      //tpl: class ui:int
      $inputIdkey = $this->view->newInput( 'input'.$this->prefix.'Idkey' , 'Int' );
      $this->items['idkey'] = $inputIdkey;
      $inputIdkey->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[idkey]',
          'id'        => 'wgt-input-'.$this->keyName.'_idkey'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for ID (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      $inputIdkey->setWidth( 'medium' );

      $inputIdkey->setReadOnly( $this->isReadOnly( 'idkey' ) );
      $inputIdkey->setData( $this->entity->getData( 'idkey' ) );
      $inputIdkey->setLabel
      (
        $this->view->i18n->l( 'ID', 'wbfsys.color_model.label' ),
        $this->entity->required( 'idkey' )
      );
  ...
  }//end public function input_idkey */
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.color_model.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.color_model.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Color Model)', 'wbfsys.color_model.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.color_model.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Color Model)', 'wbfsys.color_model.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.color_model.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Color Model)', 'wbfsys.color_model.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.color_model.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Color Model)', 'wbfsys.color_model.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.color_model.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.color_model.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.color_model.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Color Model)', 'wbfsys.color_model.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Color Model)', 'wbfsys.color_model.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
 ...
 /**
  * create the search element for field idkey
  * @param TFlag $params named parameters
  * @return void
  */
  public function search_idkey( $params )
  {
      ...
      (
        ...
        (
          ...
          'id'        => 'wgt-input-'.$this->keyName.'_idkey'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium wcm_req_search wgt-no-save'.($this->assignedForm?' fparam-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Search for ID (Color Model)', 'wbfsys.color_model.label' ),
        )
      );
      $inputIdkey->setWidth( 'medium' );
  ...
  }//end public function search_idkey */
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_color_model_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_color_model_m_role_change';
...
}//end class WbfsysColorModel_Form */
