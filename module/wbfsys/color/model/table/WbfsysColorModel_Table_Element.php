 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_color_model';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysColorModel_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ColorModel.show&amp;target_mask=WbfsysColorModel&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ColorModel.edit&amp;target_mask=WbfsysColorModel&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.color_model.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ColorModel.delete&amp;target_mask=WbfsysColorModel&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.color_model.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.color_model.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_color_model_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ColorModel.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_color_model_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ColorModel_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Color Models." >{$iconDelete} Delete selected Color Models</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Color Models. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ColorModel_Multi.deleteAll" >{$iconClean} Delete all Color Models</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysColorModel_Table_Element
