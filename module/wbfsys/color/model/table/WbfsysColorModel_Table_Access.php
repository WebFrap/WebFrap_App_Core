 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysColorModel_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_color_model.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_color_model.rowid ",
      'acls'
    );
...
}//end class WbfsysColorModel_Table_Access
