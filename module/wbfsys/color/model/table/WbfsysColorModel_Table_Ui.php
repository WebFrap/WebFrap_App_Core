 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Color Models
  *
  ...
  *  }
  *
  * @return WbfsysColorModel_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysColorModel_Table_Element( 'tableWbfsysColorModel', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_color_model-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Color Models', 'wbfsys.color_model.label' );
      //$tabPanel->searchKey = 'wbfsys_color_model';
      ...
      $searchElement->searchKey = 'wbfsys_color_model';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysColorModel_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysColorModel', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysColorModel listing maske
   *
   * @param WbfsysColorModel_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysColorModel  = $model->getEntityWbfsysColorModel();
    ...
    $formWbfsysColorModel->setKeyName( 'wbfsys_color_model' );
...
}//end class WbfsysColorModel_Table_Ui
