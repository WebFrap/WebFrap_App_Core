 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysColorModel entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ColorModel.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ColorModel.insert';
    $params->formId       = 'wgt-form-wbfsys_color_model';
    $params->namespace   = 'wbfsys_color_model-create';
    ...
    $this->setTemplate( 'wbfsys/color_model/modal/crud/form_create' );
...
}//end class WbfsysColorModel_Crud_Create_Modal_View
