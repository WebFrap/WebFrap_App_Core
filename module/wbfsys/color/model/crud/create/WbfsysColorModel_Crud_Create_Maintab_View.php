 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysColorModel Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_color_model-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/color_model/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ColorModel.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_color_model';
    ...
    $form = $this->newForm( 'WbfsysColorModel_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.ColorModel.create');}});
});
...
}//end class WbfsysColorModel_Crud_Create_Maintab_View
