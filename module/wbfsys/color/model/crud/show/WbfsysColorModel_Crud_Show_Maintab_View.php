 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysColorModel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorModel = $this->model->getEntityWbfsysColorModel();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Color Model: {@text@}',
      'wbfsys.color_model.label',
      array( 'text' => $entityWbfsysColorModel->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorModel.show  &amp;objid='.$entityWbfsysColorModel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorModel.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_model-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_model/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysColorModel_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ColorModel.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_model' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_model a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ColorModel.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ColorModel.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysColorModel_Crud_Show_Maintab_View
