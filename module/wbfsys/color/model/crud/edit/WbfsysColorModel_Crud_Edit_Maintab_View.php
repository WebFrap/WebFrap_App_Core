 ...
 * @licence WebFrap.net
 */
class WbfsysColorModel_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysColorModel Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorModel = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Color Model: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorModel.edit&amp;utf8=✓&amp;objid='.$entityWbfsysColorModel
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorModel.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_model-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_model/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysColorModel_Crud_Edit' );
...
}//end class WbfsysColorModel_Crud_Edit_Maintab_View
