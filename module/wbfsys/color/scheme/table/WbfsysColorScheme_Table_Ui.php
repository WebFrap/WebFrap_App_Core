 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Color Schemes
  *
  ...
  *  }
  *
  * @return WbfsysColorScheme_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysColorScheme_Table_Element( 'tableWbfsysColorScheme', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_color_scheme-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Color Schemes', 'wbfsys.color_scheme.label' );
      //$tabPanel->searchKey = 'wbfsys_color_scheme';
      ...
      $searchElement->searchKey = 'wbfsys_color_scheme';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysColorScheme_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysColorScheme', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysColorScheme listing maske
   *
   * @param WbfsysColorScheme_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysColorScheme  = $model->getEntityWbfsysColorScheme();
    ...
    $formWbfsysColorScheme->setKeyName( 'wbfsys_color_scheme' );
...
}//end class WbfsysColorScheme_Table_Ui
