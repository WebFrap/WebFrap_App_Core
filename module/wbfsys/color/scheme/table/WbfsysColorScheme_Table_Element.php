 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_color_scheme';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysColorScheme_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ColorScheme.show&amp;target_mask=WbfsysColorScheme&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ColorScheme.edit&amp;target_mask=WbfsysColorScheme&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.color_scheme.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ColorScheme.delete&amp;target_mask=WbfsysColorScheme&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.color_scheme.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'wbfsys.color_scheme.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_color_scheme_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ColorScheme.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_color_scheme_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.ColorScheme_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Color Schemes." >{$iconDelete} Delete selected Color Schemes</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Color Schemes. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.ColorScheme_Multi.deleteAll" >{$iconClean} Delete all Color Schemes</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysColorScheme_Table_Element
