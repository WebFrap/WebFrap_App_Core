 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysColorScheme_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_color_scheme.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_color_scheme.rowid ",
      'acls'
    );
...
}//end class WbfsysColorScheme_Table_Access
