 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysColorScheme_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysColorScheme_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysColorScheme_Entity */
      $entity = $orm->get( 'WbfsysColorScheme', $rootId );
    }
...
}//end class WbfsysColorScheme_Crud_Access_Root
