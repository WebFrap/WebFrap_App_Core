 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysColorScheme Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorScheme = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Color Scheme: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorScheme.edit&amp;utf8=✓&amp;objid='.$entityWbfsysColorScheme
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorScheme.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_scheme-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_scheme/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysColorScheme_Crud_Edit' );
...
}//end class WbfsysColorScheme_Crud_Edit_Maintab_View
