 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysColorScheme Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorScheme = $this->model->getEntityWbfsysColorScheme();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Color Scheme: {@text@}',
      'wbfsys.color_scheme.label',
      array( 'text' => $entityWbfsysColorScheme->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorScheme.show  &amp;objid='.$entityWbfsysColorScheme
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorScheme.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_scheme-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_scheme/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysColorScheme_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ColorScheme.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_scheme' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_scheme a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ColorScheme.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ColorScheme.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysColorScheme_Crud_Show_Maintab_View
