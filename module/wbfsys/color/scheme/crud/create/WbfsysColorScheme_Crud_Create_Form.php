 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysColorScheme', array_keys( $this->fields['wbfsys_color_scheme']), true ),
...
}//end class WbfsysColorScheme_Crud_Create_Form */
