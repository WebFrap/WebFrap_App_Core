 ...
 * @licence WebFrap.net
 */
class WbfsysColorScheme_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysColorScheme entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ColorScheme.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ColorScheme.insert';
    $params->formId       = 'wgt-form-wbfsys_color_scheme';
    $params->namespace   = 'wbfsys_color_scheme-create';
    ...
    $this->setTemplate( 'wbfsys/color_scheme/modal/crud/form_create' );
...
}//end class WbfsysColorScheme_Crud_Create_Modal_View
