 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_color_node';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.ColorNode.show&amp;target_mask=WbfsysColorNode&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.ColorNode.edit&amp;target_mask=WbfsysColorNode&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.color_node.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.ColorNode.delete&amp;target_mask=WbfsysColorNode&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.color_node.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_color_node_name'])).'</td>'.NL;
...
}//end class WbfsysColorNode_Selection_Element
