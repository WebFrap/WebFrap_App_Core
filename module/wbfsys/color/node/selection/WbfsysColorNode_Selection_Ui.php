 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysColorNode_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysColorNode_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysColorNode_Selection_Element
    (
      'selectionWbfsysColorNode',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Color Nodes', 'wbfsys.color_node.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.ColorNode.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysColorNode',
      'WbfsysColorNode_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysColorNode_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysColorNode_Selection_Ui
