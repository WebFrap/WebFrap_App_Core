 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_color_node')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysColorNode = $orm->get('WbfsysColorNode', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_color_node_name']  = $refEntityWbfsysColorNode->name;

    }
    $tabData['wbfsys_color_node_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysColorNode_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysColorNode_Acl' );
    /* @var $query WbfsysColorNode_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysColorNode_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysColorNode_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysColorNode_Acl_Qfdu' );
    /* @var $query WbfsysColorNode_Acl_Qfdu_Query  */
...
} // end class WbfsysColorNode_Acl_Qfdu_Model */
