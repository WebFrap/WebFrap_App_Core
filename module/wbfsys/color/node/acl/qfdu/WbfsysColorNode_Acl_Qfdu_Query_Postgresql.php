 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_color_node.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_color_node.rowid as id,
    wbfsys_color_node.name as value,
    wbfsys_color_node.name as label
  FROM
    wbfsys_color_node
  WHERE
    {$sqlWhere}
...
} // end class WbfsysColorNode_Acl_Qfdu_Query_Postgresql */
