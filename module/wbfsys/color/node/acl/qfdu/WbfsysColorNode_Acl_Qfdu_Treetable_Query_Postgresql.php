 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_color_node.name as "wbfsys_color_node_name"',
      'wbfsys_color_node.rowid as "wbfsys_color_node_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_color_node on wbfsys_group_users.vid = wbfsys_color_node.rowid'
    );
...
} // end class WbfsysColorNode_Acl_Qfdu_Treetable_Query_Postgresql */
