 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysColorNode_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_color_node-acl-qfdu-aAjax',
      'WbfsysColorNode_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysColorNode_Acl_Qfdu_Controller */
