...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysColorNode_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysColorNode_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_color_node-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Color Node', 'wbfsys.color_node.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_color_node_acl';
...
} // end class WbfsysColorNode_Acl_Ui */
