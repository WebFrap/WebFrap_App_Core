 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_color_node_acl_graph', 
      'WbfsysColorNode_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysColorNode_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysColorNode_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysColorNode_Acl_Path_Maintab_View  */
...
} // end class WbfsysColorNode_Acl_Path_Controller */
