 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_color_node.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysColorNode_Acl_Dset_Treetable_Query_Postgresql */
