 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysColorNode_Acl_Dset' );
    ...
    $entityWbfsysColorNode = $this->model->getEntity( $dsetId );
...
} // end class WbfsysColorNode_Acl_Dset_Ajax_View */
