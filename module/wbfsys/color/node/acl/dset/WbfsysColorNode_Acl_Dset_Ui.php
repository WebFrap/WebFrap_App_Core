 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysColorNode_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysColorNode_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysColorNode, $areaId, $access, $params  )
  {

    $listObj = new WbfsysColorNode_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_color_node-acl-dset' );
    ...
    else
    {
      ...
      (
        'Color Node "{@label@}" User Access',
        'wbfsys.color_node.label',
        array
        (
          'label' => $entityWbfsysColorNode->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_color_node_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysColorNode_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysColorNode_Acl_Dset_Ui */
