 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_color_node'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysColorNode', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysColorNode_Acl_Dset' );
    /* @var $query WbfsysColorNode_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysColorNode_Acl_Dset_Treetable' );
    /* @var $query WbfsysColorNode_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysColorNode_Acl_Dset_Model */
