 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysColorNode_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysColorNode_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysColorNode = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysColorNode_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_color_node-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysColorNode, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysColorNode_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_color_node-acl-dset', 
    	'WbfsysColorNode_Acl_Dset',
...
} // end class WbfsysColorNode_Acl_Dset_Controller */
