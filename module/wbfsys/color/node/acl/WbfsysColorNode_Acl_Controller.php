 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysColorNode
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysColorNode_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysColorNode_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysColorNode_Acl_Model */
    $model   = $this->loadModel( 'WbfsysColorNode_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_color_node-acl',
    	'WbfsysColorNode_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_color_node_acl_masks_listing',
      'WbfsysColorNode_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysColorNode_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysColorNode_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysColorNode_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysColorNode_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysColorNode_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysColorNode_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_color_node-acl-qfdu',
    	'WbfsysColorNode_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysColorNode_Acl_Controller */
