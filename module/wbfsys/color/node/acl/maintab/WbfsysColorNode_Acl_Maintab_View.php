 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.ColorNode_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_color_node-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.ColorNode_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_color_node-acl-update';
    ...
    $this->setTemplate( 'wbfsys/color_node/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Color Node', 'wbfsys.color_node.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_color_node_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysColorNode_Acl' );
...
} // end class WbfsysColorNode_Acl_Maintab_View */
