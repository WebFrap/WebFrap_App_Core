  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Wbfsys.ColorNode_Acl_Dset.listing&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.color_node.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.ColorNode.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.Validator::sanitizeHtml($row['wbfsys_color_node_name']).'</a></td>'.NL;
