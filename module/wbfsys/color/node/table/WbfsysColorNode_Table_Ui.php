 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Color Nodes
  *
  ...
  *  }
  *
  * @return WbfsysColorNode_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysColorNode_Table_Element( 'tableWbfsysColorNode', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_color_node-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Color Nodes', 'wbfsys.color_node.label' );
      //$tabPanel->searchKey = 'wbfsys_color_node';
      ...
      $searchElement->searchKey = 'wbfsys_color_node';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysColorNode_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysColorNode', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysColorNode listing maske
   *
   * @param WbfsysColorNode_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysColorNode  = $model->getEntityWbfsysColorNode();
    ...
    $formWbfsysColorNode->setKeyName( 'wbfsys_color_node' );
...
}//end class WbfsysColorNode_Table_Ui
