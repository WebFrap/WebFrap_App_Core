 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysColorNode entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.ColorNode.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.ColorNode.insert';
    $params->formId       = 'wgt-form-wbfsys_color_node';
    $params->namespace   = 'wbfsys_color_node-create';
    ...
    $this->setTemplate( 'wbfsys/color_node/modal/crud/form_create' );
...
}//end class WbfsysColorNode_Crud_Create_Modal_View
