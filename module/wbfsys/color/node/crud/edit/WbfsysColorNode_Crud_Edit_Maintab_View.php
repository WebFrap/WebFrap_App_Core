 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysColorNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorNode = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Color Node: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorNode.edit&amp;utf8=✓&amp;objid='.$entityWbfsysColorNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorNode.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_node-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_node/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysColorNode_Crud_Edit' );
...
}//end class WbfsysColorNode_Crud_Edit_Maintab_View
