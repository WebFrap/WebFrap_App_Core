 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysColorNode Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysColorNode = $this->model->getEntityWbfsysColorNode();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Color Node: {@text@}',
      'wbfsys.color_node.label',
      array( 'text' => $entityWbfsysColorNode->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.ColorNode.show  &amp;objid='.$entityWbfsysColorNode
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.ColorNode.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_color_node-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/color_node/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysColorNode_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.ColorNode.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_node' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_color_node a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.ColorNode.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.ColorNode.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysColorNode_Crud_Show_Maintab_View
