 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysColorNode_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysColorNode_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysColorNode_Entity */
      $entity = $orm->get( 'WbfsysColorNode', $rootId );
    }
...
}//end class WbfsysColorNode_Crud_Access_Root
