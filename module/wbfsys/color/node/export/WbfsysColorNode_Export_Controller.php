 ...
 * @licence WebFrap.net
 */
class WbfsysColorNode_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysColorNode_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysColorNode_Export_Listing_Access';
    ...
    // create a new WbfsysColorNode window
    $view = $this->loadView
    (
    	'export-wbfsys_color_node',
    	'WbfsysColorNode_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysColorNode_Export' );
...
} // end class WbfsysColorNode_Export_Controller_Genf
