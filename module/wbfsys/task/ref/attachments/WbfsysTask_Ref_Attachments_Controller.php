 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Attachments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysTask_Ref_Attachments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_task-ref-attachments';
    ...
    (
      $params->tabId,
      'WbfsysTask_Ref_Attachments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysTask_Ref_Attachments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_task-ref-attachments-'.$listType.'-ajax',
    	'WbfsysTask_Ref_Attachments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysFile to a WbfsysTask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    (
      ...
      $params->aclKey,
      $params->refId,
      'mgmt-wbfsys_task-ref-attachments'
    );
    ...
    $model  = $this->loadModel( 'WbfsysTask_Ref_Attachments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysTask_Ref_Attachments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysTask_Ref_Attachments_'.$listType );
...
} // end WbfsysTask_Ref_Attachments_Controller
