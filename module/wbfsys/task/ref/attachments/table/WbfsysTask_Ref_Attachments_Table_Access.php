 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Attachments_Table_Access
  extends LibAclPermissionList
{
  ...
  public function loadDefault( $params, $entity = null )
  {
    ...
    try 
    {
      ...
      $rootPerm = $rootContainer->getRefAccess( $params->aclRootId, $params->aclLevel, 'mgmt-wbfsys_task-ref-attachments' );
  ...
  /**
   * @param WbfsysTask_Ref_Attachments_Table_Query $query
...
}//end class WbfsysTask_Ref_Attachments_Table_Access
