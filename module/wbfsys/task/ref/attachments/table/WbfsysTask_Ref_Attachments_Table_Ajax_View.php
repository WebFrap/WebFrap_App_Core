 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Attachments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Task_Ref_Attachments.search&amp;objid='.$objid,
        $params
      );
    }
...
}//end class WbfsysTask_Ref_Attachments_Table_Ajax_View
