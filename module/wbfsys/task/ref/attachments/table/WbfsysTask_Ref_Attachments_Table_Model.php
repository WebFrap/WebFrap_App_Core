 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Attachments_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $idWbfsysTask, $access, $params  )
  {
    ...
    $query = $db->newQuery( 'WbfsysTask_Ref_Attachments_Table' );
    /* @var $query WbfsysTask_Ref_Attachments_Table_Query  */
    $query->extendedConditions = $extendedConditions;

    // hard condition
    $query->setCondition( 'wbfsys_entity_attachment.vid = '.$idWbfsysTask );
...
}//end class WbfsysTask_Ref_Attachments_Table_Model
