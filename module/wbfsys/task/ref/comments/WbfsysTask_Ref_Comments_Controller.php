 ...
 * If you want to extend this class write your coden in ControllerWbfsysTask
 *
 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Comments_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * für den wbfsys_task management knoten
  *
  ...
  */
  public function service_tab( $request, $response )
  {
    ...
    $containerClass = "WbfsysTask_Ref_Comments_".$listType."_Access";
    ...
    $params->aclNode = 'mgmt-wbfsys_task-ref-comments';
    ...
    if( !$params->saveFormId )
      $params->saveFormId = 'wgt-form-wbfsys_task-edit-'.$objid;
    ...
    (
      $params->tabId,
      'WbfsysTask_Ref_Comments_'.$listType,
      'displayTab',
      View::AREA
    );
  ...
  */
  ...
  public function service_search( $request, $response )
  {
    ...
    $model   = $this->loadModel( 'WbfsysTask_Ref_Comments_'.$listType );

    $view    = $response->loadView
    ( 
    	'wbfsys_task-ref-comments-'.$listType.'-ajax',
    	'WbfsysTask_Ref_Comments_'.$listType,
    	'displaySearch',
    	View::AJAX
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * connect existining WbfsysComment to a WbfsysTask
  *
  * @param TFlag $params named parameters
  */
  public function service_connect( $request, $response )
  {
    ...
    $model  = $this->loadModel( 'WbfsysTask_Ref_Comments_Crud' );
    ...
    if( $model->insert( $params ) )
    {
      ...
      $ui = $this->loadUi( 'WbfsysTask_Ref_Comments_'.$listType );
      $listModel = $this->loadModel( 'WbfsysTask_Ref_Comments_'.$listType );
...
} // end WbfsysTask_Ref_Comments_Controller
