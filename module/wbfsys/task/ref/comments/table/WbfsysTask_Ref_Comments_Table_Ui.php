 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Comments_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTask_Ref_Comments_Table_Element
   */
  public function createListItem( $idWbfsysTask, $data, $access, $params  )
  {
    ...
    $table = new WbfsysTask_Ref_Comments_Table_Element
    (
      'tableComments',
      $view
    );
    ...
    (
      ...
      $params->aclKey,
      $params->aclNode,
      'mgmt-wbfsys_task-conref-comments'
    );

    // if a table id is given use it for the table
    // else set the default
    if( !$params->targetId  )
      $params->targetId = 'wgt-table-ref-comments-'.$idWbfsysTask;
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task-ref-comments-search-'
        .$idWbfsysTask;
    ...
    $tabPanel->searchKey = 'wbfsys_task-ref-comments';
      ...
      if( $access->insert )
      {
        ...
        (
          ...
          (
            Wgt::ACTION_JS,
            'Create new Comment',
            '$R.post(\'maintab.php?c=Wbfsys.EntityComment.create&refid='.$params->refId.'&target_mask=WbfsysTask_Ref_Comments&target_id='.$table->id.$table->accessPath.'\',{\'wbfsys_entity_comment[vid]\':\''.$params->refIdComments.'\'});return false;',
            'control/add.png',
            'wcm wcm_ui_button',
            'wbf.label'
          )
    ...
    $view->addVar( 'refIdComments', $idWbfsysTask );
    $view->addVar
    (
      'searchFormActionComments',
      'ajax.php?c=Wbfsys.Task_Ref_Comments.search&amp;target_id='
...
}//end class WbfsysTask_Ref_Comments_Table_Ui
