 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Ref_Comments_Table_Ajax_View
  ...
  */
  public function displaySearch( $objid, $params )
  {
    ...
    if( !$params->searchFormAction )
    {
      ...
      (
        'ajax.php?c=Wbfsys.Task_Ref_Comments.search&amp;objid='.$objid,
        $params
      );
    }
    ...
    $ui  = $this->loadUi( 'WbfsysTask_Ref_Comments_Table' );
...
}//end class WbfsysTask_Ref_Comments_Table_Ajax_View
