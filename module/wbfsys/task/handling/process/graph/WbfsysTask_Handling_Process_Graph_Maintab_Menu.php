 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Handling_Process_Graph_Maintab_Menu
  extends WgtDropmenu
{
  /**
...
{$entries->support}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_task-handling-pgraph"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_task-handling-pgraph hidden" >
    	<ul>
    		<li>
...
}//end class WbfsysTask_Handling_Process_Graph_Maintab_Menu
