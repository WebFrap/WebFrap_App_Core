 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Handling_Process_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_form( $request, $response )
  {
    ...
    // build process
    $process = new WbfsysTask_Handling_Process( $db );
      
    $process->loadByStatus( $statusId, $params );
    $process->fetchServiceRequest( );
    
    // benutzer zugriff laden
    $access = new WbfsysTask_Handling_Process_Access( null, null, $this );
    ...
    ( 
      'form-wbfsys_task-handling-process-'.$statusId, 
      'WbfsysTask_Handling_Process',
      'displayForm'
    );
  ...
  public function service_dropForm( $request, $response )
  {
    ...
    $entity = $orm->get( 'WbfsysTask', $entityId );
    
    $process->load( $entity, $params );
    $process->fetchServiceRequest( );
    
    // benutzer zugriff laden
    $access = new WbfsysTask_Handling_Process_Access();
    $access->load( $user->getProfileName(), $params, $process->getEntity() );
    ...
    $view = $response->loadView
    ( 
      'dropform-wbfsys_task-handling-process-'.$entityId, 
      'WbfsysTask_Handling_Process',
      'displayDropForm'
    );
  ...
  public function service_switchStatus( $request, $response )
  {
    ...
    //Webfrap::getActive()->redirectByTripple( 'Wbfsys.Task.edit' );
...
/**
  ...
  public function service_switchStatusForm( $request, $response )
  {
    ...
    $listModel->setEntityWbfsysTask( $entity );
  ...
  public function service_showNodeGraph( $request, $response )
  {
    ...
    $view = $response->loadView
    ( 
      'form-wbfsys_task-handling-graph-'.$statusId, 
      'WbfsysTask_Handling_Process_Graph',
      'displayGraph',
      null,
      true
    );
  ...
  public function service_showResponsible( $request, $response )
  {
    ...
    $view = $response->loadView
    ( 
      'form-wbfsys_task-handling-receiver-'.$statusId, 
      'WbfsysTask_Handling_Process_Receiver',
      'displayReceiver',
      null,
      true
    );
...
} // end class WbfsysTask_Handling_Process_Controller */
