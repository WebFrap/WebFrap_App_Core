 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysTaskType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysTaskType_Export_Listing_Access';
    ...
    // create a new WbfsysTaskType window
    $view = $this->loadView
    (
    	'export-wbfsys_task_type',
    	'WbfsysTaskType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'WbfsysTaskType_Export' );
...
} // end class WbfsysTaskType_Export_Controller_Genf
