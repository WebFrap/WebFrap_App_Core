...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für task Types
  *
  ...
  *  }
  *
  * @return WbfsysTaskType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTaskType_Table_Element( 'tableWbfsysTaskType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'task Types', 'wbfsys.task_type.label' );
      //$tabPanel->searchKey = 'wbfsys_task_type';
      ...
      $searchElement->searchKey = 'wbfsys_task_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTaskType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTaskType', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTaskType listing maske
   *
   * @param WbfsysTaskType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTaskType  = $model->getEntityWbfsysTaskType();
    ...
    $formWbfsysTaskType->setKeyName( 'wbfsys_task_type' );
...
}//end class WbfsysTaskType_Table_Ui
