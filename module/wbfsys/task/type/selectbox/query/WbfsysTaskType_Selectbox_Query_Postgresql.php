 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the WbfsysTaskType Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT wbfsys_task_type.rowid as id',
      'wbfsys_task_type.name as value'
     ));
      $criteria->selectAlso( 'wbfsys_task_type.m_order as "wbfsys_task_type-m_order-order"' );

    $criteria->from( 'wbfsys_task_type' );



      $criteria->orderBy( 'wbfsys_task_type.m_order ' );
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "wbfsys_task_type.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "wbfsys_task_type.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class WbfsysTaskType_Selectbox_Query_Postgresql
