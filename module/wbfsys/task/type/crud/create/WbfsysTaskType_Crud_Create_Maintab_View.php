 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTaskType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_task_type-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/task_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_task_type';
    ...
    $form = $this->newForm( 'WbfsysTaskType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TaskType.create');}});
});
...
}//end class WbfsysTaskType_Crud_Create_Maintab_View
