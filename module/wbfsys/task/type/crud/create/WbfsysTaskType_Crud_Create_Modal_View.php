 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTaskType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TaskType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskType.insert';
    $params->formId       = 'wgt-form-wbfsys_task_type';
    $params->namespace   = 'wbfsys_task_type-create';
    ...
    $this->setTemplate( 'wbfsys/task_type/modal/crud/form_create' );
...
}//end class WbfsysTaskType_Crud_Create_Modal_View
