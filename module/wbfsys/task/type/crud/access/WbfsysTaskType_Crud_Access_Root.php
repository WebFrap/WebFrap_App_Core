 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTaskType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTaskType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTaskType_Entity */
      $entity = $orm->get( 'WbfsysTaskType', $rootId );
    }
...
}//end class WbfsysTaskType_Crud_Access_Root
