 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTaskType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskType = $this->model->getEntityWbfsysTaskType();
    ...
    (
      ...
      array( 'text' => $entityWbfsysTaskType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskType.show  &amp;objid='.$entityWbfsysTaskType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTaskType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.TaskType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.TaskType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.TaskType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTaskType_Crud_Show_Maintab_View
