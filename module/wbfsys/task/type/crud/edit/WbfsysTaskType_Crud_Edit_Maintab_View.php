 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTaskType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskType = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskType.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTaskType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTaskType_Crud_Edit' );
...
}//end class WbfsysTaskType_Crud_Edit_Maintab_View
