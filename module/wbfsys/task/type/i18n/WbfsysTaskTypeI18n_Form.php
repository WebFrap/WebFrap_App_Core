...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_task_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysTaskTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'WbfsysTaskTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'WbfsysTaskTypeI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the WbfsysTaskTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysTaskTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysTaskTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'wbfsys.task_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_wbfsys_task_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_wbfsys_task_type( $params )
  {

    if( !Webfrap::classLoadable( 'WbfsysTaskType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity WbfsysTaskType not exists' );

      Log::warn('Looks like the Entity: WbfsysTaskType is missing');
      ...
      //p: Window
      $objidWbfsysTaskType = $this->entity->getData('id_wbfsys_task_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidWbfsysTaskType
          || !$entityWbfsysTaskType = $this->db->orm->get
          (
            'WbfsysTaskType',
            $objidWbfsysTaskType
          )
      ...
      {
        $entityWbfsysTaskType = $this->db->orm->newEntity( 'WbfsysTaskType' );
      }

      $inputIdWbfsysTaskType = $this->view->newInput( 'input'.$this->prefix.'IdWbfsysTaskType', 'Window' );
      $inputIdWbfsysTaskType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_wbfsys_task_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_wbfsys_task_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Wbfsys Task Type (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdWbfsysTaskType->assignedForm = $this->assignedForm;

      $inputIdWbfsysTaskType->setWidth( 'medium' );

      $inputIdWbfsysTaskType->setData( $this->entity->getData( 'id_wbfsys_task_type' )  );
      $inputIdWbfsysTaskType->setReadOnly( $this->isReadOnly( 'id_wbfsys_task_type' ) );
      $inputIdWbfsysTaskType->setLabel( $this->view->i18n->l( 'Wbfsys Task Type', 'wbfsys.task_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.TaskType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_wbfsys_task_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdWbfsysTaskType->setListUrl ( $listUrl );
      $inputIdWbfsysTaskType->setListIcon( 'control/connect.png' );
      $inputIdWbfsysTaskType->setEntityUrl( 'maintab.php?c=Wbfsys.TaskType.edit' );
      $inputIdWbfsysTaskType->conEntity         = $entityWbfsysTaskType;
      $inputIdWbfsysTaskType->refresh           = $this->refresh;
      $inputIdWbfsysTaskType->serializeElement  = $this->sendElement;
      


      $inputIdWbfsysTaskType->view = $this->view;
      $inputIdWbfsysTaskType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_wbfsys_task_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdWbfsysTaskType );
  ...
  }//end public function input_id_wbfsys_task_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'wbfsys.task_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'wbfsys.task_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.task_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.task_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.task_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.task_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.task_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.task_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.task_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Task Type I18n)', 'wbfsys.task_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_task_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_task_type_i18n_m_role_change';
...
}//end class WbfsysTaskTypeI18n_Form */
