 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'wbfsys_task_type_acl_graph', 
      'WbfsysTaskType_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'WbfsysTaskType_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysTaskType_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysTaskType_Acl_Path_Maintab_View  */
...
} // end class WbfsysTaskType_Acl_Path_Controller */
