 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-wbfsys_task_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityWbfsysTaskType = $orm->get('WbfsysTaskType', $data['wbfsys_group_users']->vid);
      $tabData['wbfsys_task_type_name']  = $refEntityWbfsysTaskType->name;

    }
    $tabData['wbfsys_task_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein WbfsysTaskType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTaskType_Acl' );
    /* @var $query WbfsysTaskType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTaskType_Acl_Qfdu_Treetable' );
    /* @var $query WbfsysTaskType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTaskType_Acl_Qfdu' );
    /* @var $query WbfsysTaskType_Acl_Qfdu_Query  */
...
} // end class WbfsysTaskType_Acl_Qfdu_Model */
