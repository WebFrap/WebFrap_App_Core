 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_task_type.rowid as "wbfsys_task_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN wbfsys_task_type on wbfsys_group_users.vid = wbfsys_task_type.rowid'
    );
...
} // end class WbfsysTaskType_Acl_Qfdu_Treetable_Query_Postgresql */
