 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysTaskType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_task_type-acl-qfdu-aAjax',
      'WbfsysTaskType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysTaskType_Acl_Qfdu_Controller */
