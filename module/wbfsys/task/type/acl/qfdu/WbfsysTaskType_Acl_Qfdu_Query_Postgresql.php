 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(wbfsys_task_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_task_type.rowid as id,
    wbfsys_task_type.name as value,
    wbfsys_task_type.name as label
  FROM
    wbfsys_task_type
  WHERE
    {$sqlWhere}
...
} // end class WbfsysTaskType_Acl_Qfdu_Query_Postgresql */
