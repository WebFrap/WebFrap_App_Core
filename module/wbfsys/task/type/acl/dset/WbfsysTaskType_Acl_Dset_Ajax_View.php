 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'WbfsysTaskType_Acl_Dset' );
    ...
    $entityWbfsysTaskType = $this->model->getEntity( $dsetId );
...
} // end class WbfsysTaskType_Acl_Dset_Ajax_View */
