 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var WbfsysTaskType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTaskType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysTaskType, $areaId, $access, $params  )
  {

    $listObj = new WbfsysTaskType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_task_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'task Type "{@label@}" User Access',
        'wbfsys.task_type.label',
        array
        (
          'label' => $entityWbfsysTaskType->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_task_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysTaskType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysTaskType_Acl_Dset_Ui */
