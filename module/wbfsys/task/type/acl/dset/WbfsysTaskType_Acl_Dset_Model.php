 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_task_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'WbfsysTaskType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTaskType_Acl_Dset' );
    /* @var $query WbfsysTaskType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTaskType_Acl_Dset_Treetable' );
    /* @var $query WbfsysTaskType_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysTaskType_Acl_Dset_Model */
