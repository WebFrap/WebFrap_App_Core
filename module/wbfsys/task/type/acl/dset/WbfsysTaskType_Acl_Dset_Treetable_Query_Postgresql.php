 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(wbfsys_task_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class WbfsysTaskType_Acl_Dset_Treetable_Query_Postgresql */
