 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysTaskType_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysTaskType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysTaskType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTaskType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_task_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityWbfsysTaskType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTaskType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_task_type-acl-dset', 
    	'WbfsysTaskType_Acl_Dset',
...
} // end class WbfsysTaskType_Acl_Dset_Controller */
