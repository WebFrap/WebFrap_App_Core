 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysTaskType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysTaskType_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysTaskType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysTaskType_Acl_Model */
    $model   = $this->loadModel( 'WbfsysTaskType_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_task_type-acl',
    	'WbfsysTaskType_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_task_type_acl_masks_listing',
      'WbfsysTaskType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysTaskType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysTaskType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysTaskType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'WbfsysTaskType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysTaskType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysTaskType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_task_type-acl-qfdu',
    	'WbfsysTaskType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysTaskType_Acl_Controller */
