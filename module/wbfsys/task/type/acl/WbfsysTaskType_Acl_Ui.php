...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysTaskType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTaskType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_task_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'task Type', 'wbfsys.task_type.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_task_type_acl';
...
} // end class WbfsysTaskType_Acl_Ui */
