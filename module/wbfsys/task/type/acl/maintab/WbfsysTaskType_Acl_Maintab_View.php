 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.TaskType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.TaskType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_task_type-acl-update';
    ...
    $this->setTemplate( 'wbfsys/task_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'task Type', 'wbfsys.task_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_task_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'WbfsysTaskType_Acl' );
...
} // end class WbfsysTaskType_Acl_Maintab_View */
