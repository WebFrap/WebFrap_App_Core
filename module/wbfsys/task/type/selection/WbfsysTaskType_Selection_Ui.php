 ...
 * @licence WebFrap.net
 */
class WbfsysTaskType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysTaskType_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysTaskType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTaskType_Selection_Element
    (
      'selectionWbfsysTaskType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection task Types', 'wbfsys.task_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.TaskType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysTaskType',
      'WbfsysTaskType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysTaskType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysTaskType_Selection_Ui
