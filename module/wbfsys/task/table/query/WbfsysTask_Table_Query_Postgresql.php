 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_task_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetchWithAcls( $condition = null, $params = null )
  {
    ...
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys>mgmt-wbfsys_task' );
    }
    else
    {
      $acl->injectListingAcls( $criteria, 'mod-wbfsys>mgmt-wbfsys_task', true, $params->access->level  );
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_task.title as "wbfsys_task_title"', // variant: field_mgmt-attr 
      'wbfsys_task.priority as "wbfsys_task_priority"', // variant: field_mgmt-attr 
      'wbfsys_process_node.label as "wbfsys_process_node_label"', // variant: field_mgmt-attr  used source field wbfsys_process_node
      'wbfsys_task.id_status as "wbfsys_task_id_status"', // ref wbfsys_task field_mgmt-attr 
      ...
      'wbfsys_task.progress as "wbfsys_task_progress"', // variant: field_mgmt-attr 
    );
...
}//end class WbfsysTask_Table_Query_Postgresql
