 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_task';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTask_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Task.show&amp;target_mask=WbfsysTask&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.task.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Task.edit&amp;target_mask=WbfsysTask&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.task.label',
        Acl::UPDATE
      ...
      (
        ...
        (
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Comments',
            'modal.php?c=Wbfsys.Task_Ref_Comments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.task.label',
          ),
          ...
          (
            Wgt::ACTION_BUTTON_GET,
            'Attachements',
            'modal.php?c=Wbfsys.Task_Ref_Attachments.modal&amp;objid=',
            'control/table.png',
            '',
            'wbfsys.task.label',
          ),
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Task.delete&amp;target_mask=WbfsysTask&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.task.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=wbfsys_task&amp;objid=',
        'control/rights.png',
        '',
        'wbfsys.task.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:270px" >Title</th>'.NL;
    $html .= '<th style="width:175px" >Priority</th>'.NL;
    $html .= '<th style="width:175px" >Status</th>'.NL;
    $html .= '<th style="width:175px" >Progress</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_task_title'])).'</td>'.NL;
      $body .= '<td valign="top" >'.WgtInputPriority::getKeyLabel($row['wbfsys_task_priority']).'</td>'.NL;
      $body .= '<td valign="top" >      <button 
        id="wgt-button-list-table-wbfsys_task-'.$row['wbfsys_task_rowid'].'" 
        ...
        <var>{"url":"ajax.php?c=Wbfsys.Task_Handling_Process.dropForm&amp;objid='.$row['wbfsys_task_rowid'].'&amp;mask='.$this->namespace.'&amp;element='.$this->id.'&amp;mask_type=listing&amp;ltype=table'.$this->accessPath.'"}</var>
       </button>
</td>'.NL;
      $body .= '<td valign="top" >      <div class="wcm wcm_ui_progress wgt_progress" >'.(!is_null($row['wbfsys_task_progress'])?$row['wbfsys_task_progress']:0).'</div>
</td>'.NL;
      if( $this->enableNav )
      {
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Task_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Tasks." >{$iconDelete} Delete selected Tasks</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Tasks. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Task_Multi.deleteAll" >{$iconClean} Delete all Tasks</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTask_Table_Element
