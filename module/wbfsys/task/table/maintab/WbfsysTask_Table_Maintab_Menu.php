 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Table_Maintab_Menu
  extends WgtDropmenu
{
  /**
   * de:
  ...
  <div class="wgt-panel-control" >
    <button 
      ...
      title="Create a new Task"  ><div class="left ui-icon ui-icon-circle-plus"> </div> <div class="inline" > {$this->view->i18n->l('New','wbf.label')}</div></button>
  </div>
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-wbfsys_task-table-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-wbfsys_task-table-help hidden" >
    	      
<p>This is the Task table.</p>
...
HTML;
  ...
  protected function switchListingType( $params )
  {
    ...
    $html = <<<HTML
  <div class="wgt-panel-control" >
    <div id="wgt-mentry-swlt-wbfsys_task" >
      <button 
        id="wgt-mentry-swlt-wbfsys_task-table" 
        class="wcm wcm_ui_tip wgtac_view_table wgt-button wgt-active"
        tooltip="Switch to the table view."  >
        {$iconMaTab}
      </button>
      <button 
        id="wgt-mentry-swlt-wbfsys_task-treetable" 
        class="wcm wcm_ui_tip wgtac_view_treetable wgt-button" 
...
HTML;
      ...
      if( $acl->access( 'mod-wbfsys/mgmt-wbfsys_task>mgmt-my_wbfsys_task:listing' ) )
      {
        $html .= '<li><a class="wgtac_mask_my_wbfsys_task" >'.$iconMask.' '.$this->view->i18n->l('My Tasks','my.wbfsys_task.label').'</a></li>'.NL;
        ++ $numEntries;
      }
...
HTML;
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.protocolEntity&dkey=wbfsys_task" >{$iconProtocol} {$this->view->i18n->l( 'Protocol', 'wbf.label' )}</a>
      </li>


      <li>
        <a class="wcm wcm_req_ajax" href="modal.php?c=Maintenance.Entity.statsEntity&dkey=wbfsys_task" >{$iconStats} {$this->view->i18n->l( 'Stats', 'wbf.label' )}</a>
      </li>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=wbfsys_task-table" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
HTML;
  ...
  protected function entriesAcl( $params )
  {
    ...
    <li>
      ...
      <span>
      <ul>
                  <li><a class="wcm wcm_req_ajax" href="maintab.php?c=Acl.Mgmt.listing&amp;dkey=wbfsys_task" >{$iconMgmt} {$this->view->i18n->l( 'ACLs Entity', 'wbf.label' )}</a></li>
      </ul>
      </span>
    </li>
...
}//end class WbfsysTask_Table_Maintab_Menu
