 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management WbfsysTask
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new WbfsysTask_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('WbfsysTask_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model WbfsysTask_Acl_Model */
    $model   = $this->loadModel( 'WbfsysTask_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'wbfsys_task_acl_masks_listing',
      'WbfsysTask_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'WbfsysTask_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'WbfsysTask_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model WbfsysTask_Acl_Qfdu_Model */
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model WbfsysTask_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'WbfsysTask_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'wbfsys_task-acl-qfdu',
    	'WbfsysTask_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class WbfsysTask_Acl_Controller */
