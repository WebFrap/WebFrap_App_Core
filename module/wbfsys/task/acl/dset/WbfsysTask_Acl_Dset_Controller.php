 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model WbfsysTask_Acl_Dset_Model  */
    $model = $this->loadModel( 'WbfsysTask_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityWbfsysTask = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTask_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'wbfsys_task-acl-dset-listing-'.$objid,
      'WbfsysTask_Acl_Dset',
      'displayListing'
    );
    ...
    $view->displayListing( $entityWbfsysTask, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view WbfsysTask_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'wbfsys_task-acl-dset', 
    	'WbfsysTask_Acl_Dset',
...
} // end class WbfsysTask_Acl_Dset_Controller */
