 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-wbfsys_task'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTask_Acl_Dset' );
    /* @var $query WbfsysTask_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'WbfsysTask_Acl_Dset_Treetable' );
    /* @var $query WbfsysTask_Acl_Dset_Treetable_Query  */
...
} // end class WbfsysTask_Acl_Dset_Model */
