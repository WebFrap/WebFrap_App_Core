...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTask_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityWbfsysTask, $areaId, $access, $params  )
  {

    $listObj = new WbfsysTask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-wbfsys_task-acl-dset' );
    ...
    else
    {
      ...
      (
        'Task "{@label@}" User Access',
        'wbfsys.task.label',
        array
        (
          'label' => $entityWbfsysTask->text()
        )
      );
      $tabPanel->searchKey  = 'wbfsys_task_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new WbfsysTask_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class WbfsysTask_Acl_Dset_Ui */
