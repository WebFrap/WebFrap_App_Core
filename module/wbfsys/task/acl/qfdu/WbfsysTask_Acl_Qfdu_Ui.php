...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return WbfsysTask_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new WbfsysTask_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Task',
        'wbfsys.task.label'
      );
      $tabPanel->searchKey  = 'wbfsys_task_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new WbfsysTask_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class WbfsysTask_Acl_Qfdu_Ui */
