 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'wbfsys_task.title as "wbfsys_task_title"',
      'wbfsys_task.rowid as "wbfsys_task_rowid"',
...
} // end class WbfsysTask_Acl_Qfdu_Treetable_Query_Postgresql */
