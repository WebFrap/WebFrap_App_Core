 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view WbfsysTask_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'wbfsys_task-acl-qfdu-aAjax',
      'WbfsysTask_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class WbfsysTask_Acl_Qfdu_Controller */
