...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return WbfsysTask_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTask_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'wbfsys_task-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Task', 'wbfsys.task.label' )
      )
    );
    $tabPanel->searchKey  = 'wbfsys_task_acl';
