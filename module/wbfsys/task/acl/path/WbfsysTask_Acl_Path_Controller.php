 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'WbfsysTask_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'WbfsysTask_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view WbfsysTask_Acl_Path_Maintab_View  */
...
} // end class WbfsysTask_Acl_Path_Controller */
