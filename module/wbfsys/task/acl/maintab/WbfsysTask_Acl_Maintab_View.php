 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Wbfsys.Task_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Wbfsys.Task_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'wbfsys_task-acl-update';
    ...
    $this->setTemplate( 'wbfsys/task/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Task', 'wbfsys.task.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-wbfsys_task_acl_listing' );
...
} // end class WbfsysTask_Acl_Maintab_View */
