...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: wbfsys_task
  *
  ...
  *
  *   @url maintab.php?c=Wbfsys.Task.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'wbfsys_task-create';

    $access = new WbfsysTask_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-wbfsys_task-create',
      'WbfsysTask_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model WbfsysTask_Crud_Model */
    $model = $this->loadModel( 'WbfsysTask_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Wbfsys.Task.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityWbfsysTask = $model->getEntityWbfsysTask( $objid );
    ...
    $params->entity = $entityWbfsysTask;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'wbfsys_task:edit';

    $access = new WbfsysTask_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysTask );
    ...
    $process_Flow->load( $entityWbfsysTask, $params );
    ...
    $process_Flow->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'wbfsys_task-edit',
          $entityWbfsysTask,
          'Edit Task :'.$entityWbfsysTask->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-wbfsys_task';
      $params->maskRoot      = 'wbfsys_task:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-wbfsys_task';
      $params->aclNode       = 'mgmt-wbfsys_task';
      $params->aclLevel      = 1;
    }
...
$process_Flow->trigger( 'success', $params, true );
      ...
      return $error;
        ...
        (
          'wbfsys_task-show',
          $entityWbfsysTask,
          'Show Task :'.$entityWbfsysTask->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: wbfsys_task
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Wbfsys.Task.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-insert';

    $access = new WbfsysTask_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
...
$params->process_Flow = $process_Flow;
$process_Flow->setEntity( $model->getEntityWbfsysTask() );
...
$process_Flow->call( 'init', 'fail', $params );
    ...
    else
    {
    	...
    	$entityWbfsysTask = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'wbfsys_task-update-'.$entityWbfsysTask;
      ...
      {
        $access = new WbfsysTask_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityWbfsysTask );
      }
      $params->access = $access;
...
$process_Flow->call( 'init', 'sucess', $params );
      ...
      // model wird benötigt
      /* @var $model WbfsysTask_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
...
$process_Flow->call( 'init', 'after', $params );
  ...
  *
  * @call POST ajax.php?c=Wbfsys.Task.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysTask, $params, $process_Flow ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param WbfsysTask_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Wbfsys.Task.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-delete-'.$objid;

    $access = new WbfsysTask_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityWbfsysTask );
...
if( $error )
{
  return $error;
    ...
    $error = $model->delete( $entityWbfsysTask, $params );
...
$process_Flow->delete( $entityWbfsysTask, $params );
...
$process_Flow->call( 'delete', 'after', $params );
    ...
    $error = $view->displayDelete( $entityWbfsysTask, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Wbfsys.Task.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Wbfsys.Task.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-listing';
    ...
    $containerClass = 'WbfsysTask_'.$listType.'_Access';
    ...
    /* @var $model WbfsysTask_Table_Model */
    $model = $this->loadModel( 'WbfsysTask_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'wbfsys_task-'.$params->ltype,
          'WbfsysTask',
          'List of Tasks'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  WbfsysTask
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new WbfsysTask_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_wbfsys_task',
      'WbfsysTask_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'WbfsysTask_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Wbfsys.Task.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model WbfsysTask_Selection_Model */
    $model   = $this->loadModel( 'WbfsysTask_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'wbfsys_task-data-'.$objid;
    else
      $params->contextKey = 'wbfsys_task-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityWbfsysTask, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-append-'.$objid;
    ...
    // fetch the data from the http request and load it in the model registry
    // if fails stop here
    if( !$model->fetchUpdateData( $entityWbfsysTask, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
    ...
    $ui = $this->loadUi( 'WbfsysTask_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new WbfsysTask_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'wbfsys_task-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'WbfsysTask_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityWbfsysTask, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'wbfsys_task' ); //def wbfsys_task
...
} // end class WbfsysTask_Controller */
