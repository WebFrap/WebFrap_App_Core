...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysTask_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysTask_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTask_Selection_Element
    (
      'selectionWbfsysTask',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Tasks', 'wbfsys.task.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Task.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysTask_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysTask_Selection_Ui
