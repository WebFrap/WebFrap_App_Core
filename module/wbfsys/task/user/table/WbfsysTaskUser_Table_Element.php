 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_task_user';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTaskUser_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TaskUser.show&amp;target_mask=WbfsysTaskUser&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TaskUser.edit&amp;target_mask=WbfsysTaskUser&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.task_user.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TaskUser.delete&amp;target_mask=WbfsysTaskUser&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.task_user.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_task_user_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.TaskUser_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Task Users." >{$iconDelete} Delete selected Task Users</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Task Users. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.TaskUser_Multi.deleteAll" >{$iconClean} Delete all Task Users</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTaskUser_Table_Element
