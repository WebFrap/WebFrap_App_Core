...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Task Users
  *
  ...
  *  }
  *
  * @return WbfsysTaskUser_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTaskUser_Table_Element( 'tableWbfsysTaskUser', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task_user-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Task Users', 'wbfsys.task_user.label' );
      //$tabPanel->searchKey = 'wbfsys_task_user';
      ...
      $searchElement->searchKey = 'wbfsys_task_user';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTaskUser_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTaskUser', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTaskUser listing maske
   *
   * @param WbfsysTaskUser_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTaskUser  = $model->getEntityWbfsysTaskUser();
    ...
    $formWbfsysTaskUser->setKeyName( 'wbfsys_task_user' );
...
}//end class WbfsysTaskUser_Table_Ui
