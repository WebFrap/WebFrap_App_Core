 ...
 *
 * Entity Class for the Database Table wbfsys_task_user
 * 
 * @package WebFrap
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'wbfsys_task_user';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Wbfsys.TaskUser.show';
  ...
  */
  public static $entityName  = 'WbfsysTaskUser';
  ...
  */
  ...
  (
    'id_user' => array
    (
      'default' => 'wbfsys.task_user.message.error_def_id_user',
      'wrong'   => 'wbfsys.task_user.message.error_wrong_id_user',
      'max'     => 'wbfsys.task_user.message.error_max_id_user',
      'min'     => 'wbfsys.task_user.message.error_min_id_user',
    ),

    'id_task' => array
    (
      'default' => 'wbfsys.task_user.message.error_def_id_task',
      'wrong'   => 'wbfsys.task_user.message.error_wrong_id_task',
      'max'     => 'wbfsys.task_user.message.error_max_id_task',
      'min'     => 'wbfsys.task_user.message.error_min_id_task',
    ),

    'rowid' => array
    (
      'default' => 'wbfsys.task_user.message.error_def_rowid',
      'wrong'   => 'wbfsys.task_user.message.error_wrong_rowid',
      'empty'   => 'wbfsys.task_user.message.error_empty_rowid',
      'max'     => 'wbfsys.task_user.message.error_max_rowid',
      'min'     => 'wbfsys.task_user.message.error_min_rowid',
    ),
  );

}//end class WbfsysTaskUser_Entity
