 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTaskUser Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskUser = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskUser.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTaskUser
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskUser.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_user-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_user/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTaskUser_Crud_Edit' );
...
}//end class WbfsysTaskUser_Crud_Edit_Maintab_View
