 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTaskUser entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TaskUser.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskUser.insert';
    $params->formId       = 'wgt-form-wbfsys_task_user';
    $params->namespace   = 'wbfsys_task_user-create';
    ...
    $this->setTemplate( 'wbfsys/task_user/modal/crud/form_create' );
...
}//end class WbfsysTaskUser_Crud_Create_Modal_View
