 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTaskUser Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_task_user-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/task_user/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskUser.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_task_user';
    ...
    $form = $this->newForm( 'WbfsysTaskUser_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TaskUser.create');}});
});
...
}//end class WbfsysTaskUser_Crud_Create_Maintab_View
