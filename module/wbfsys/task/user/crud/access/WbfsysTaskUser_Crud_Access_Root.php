 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTaskUser_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTaskUser_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTaskUser_Entity */
      $entity = $orm->get( 'WbfsysTaskUser', $rootId );
    }
...
}//end class WbfsysTaskUser_Crud_Access_Root
