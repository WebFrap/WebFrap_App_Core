 ...
 * @licence WebFrap.net
 */
class WbfsysTaskUser_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTaskUser Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskUser = $this->model->getEntityWbfsysTaskUser();
    ...
    (
      ...
      array( 'text' => $entityWbfsysTaskUser->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskUser.show  &amp;objid='.$entityWbfsysTaskUser
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskUser.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_user-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_user/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTaskUser_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.TaskUser.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_user' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_user a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.TaskUser.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.TaskUser.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTaskUser_Crud_Show_Maintab_View
