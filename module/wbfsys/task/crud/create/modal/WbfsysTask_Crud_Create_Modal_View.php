 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTask entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Task.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Task.insert';
    $params->formId       = 'wgt-form-wbfsys_task';
    $params->namespace   = 'wbfsys_task-create';
    ...
    $this->setTemplate( 'wbfsys/task/modal/crud/form_create' );
...
}//end class WbfsysTask_Crud_Create_Modal_View
