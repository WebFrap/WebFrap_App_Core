 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTask Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTask = $this->model->getEntityWbfsysTask();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Task.show  &amp;objid='.$entityWbfsysTask
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Task.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTask_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_mask_my_wbfsys_task").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=My.WbfsysTask.show&objid={$objid}');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Task.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTask_Crud_Show_Maintab_View
