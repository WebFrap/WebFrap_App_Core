 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var WbfsysTask_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'WbfsysTask_Export_Listing_Access';
    ...
    // create a new WbfsysTask window
    $view = $this->loadView
    (
    	'export-wbfsys_task',
    	'WbfsysTask_Export',
    ...
    $model = $this->loadModel( 'WbfsysTask_Export' );
...
} // end class WbfsysTask_Export_Controller_Genf
