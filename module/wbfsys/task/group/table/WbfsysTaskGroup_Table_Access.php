 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysTaskGroup_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_task_group.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_task_group.rowid ",
      'acls'
    );
...
}//end class WbfsysTaskGroup_Table_Access
