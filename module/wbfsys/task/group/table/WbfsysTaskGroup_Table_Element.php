 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_task_group';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTaskGroup_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TaskGroup.show&amp;target_mask=WbfsysTaskGroup&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TaskGroup.edit&amp;target_mask=WbfsysTaskGroup&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.task_group.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TaskGroup.delete&amp;target_mask=WbfsysTaskGroup&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.task_group.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_task_group_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.TaskGroup_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Task Groups." >{$iconDelete} Delete selected Task Groups</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Task Groups. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.TaskGroup_Multi.deleteAll" >{$iconClean} Delete all Task Groups</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTaskGroup_Table_Element
