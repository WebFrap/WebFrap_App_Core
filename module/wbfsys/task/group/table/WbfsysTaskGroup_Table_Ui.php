 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Task Groups
  *
  ...
  *  }
  *
  * @return WbfsysTaskGroup_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTaskGroup_Table_Element( 'tableWbfsysTaskGroup', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_task_group-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Task Groups', 'wbfsys.task_group.label' );
      //$tabPanel->searchKey = 'wbfsys_task_group';
      ...
      $searchElement->searchKey = 'wbfsys_task_group';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTaskGroup_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTaskGroup', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTaskGroup listing maske
   *
   * @param WbfsysTaskGroup_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTaskGroup  = $model->getEntityWbfsysTaskGroup();
    ...
    $formWbfsysTaskGroup->setKeyName( 'wbfsys_task_group' );
...
}//end class WbfsysTaskGroup_Table_Ui
