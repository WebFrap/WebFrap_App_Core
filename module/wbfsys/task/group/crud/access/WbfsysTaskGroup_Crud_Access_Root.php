 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTaskGroup_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTaskGroup_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTaskGroup_Entity */
      $entity = $orm->get( 'WbfsysTaskGroup', $rootId );
    }
...
}//end class WbfsysTaskGroup_Crud_Access_Root
