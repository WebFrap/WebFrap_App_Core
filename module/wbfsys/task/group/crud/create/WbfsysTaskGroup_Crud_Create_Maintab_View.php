 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTaskGroup Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_task_group-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/task_group/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskGroup.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_task_group';
    ...
    $form = $this->newForm( 'WbfsysTaskGroup_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TaskGroup.create');}});
});
...
}//end class WbfsysTaskGroup_Crud_Create_Maintab_View
