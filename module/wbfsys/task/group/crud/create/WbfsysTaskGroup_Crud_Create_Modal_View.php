 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTaskGroup entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.TaskGroup.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TaskGroup.insert';
    $params->formId       = 'wgt-form-wbfsys_task_group';
    $params->namespace   = 'wbfsys_task_group-create';
    ...
    $this->setTemplate( 'wbfsys/task_group/modal/crud/form_create' );
...
}//end class WbfsysTaskGroup_Crud_Create_Modal_View
