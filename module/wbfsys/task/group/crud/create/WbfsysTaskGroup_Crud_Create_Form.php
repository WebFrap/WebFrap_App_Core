 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'WbfsysTaskGroup', array_keys( $this->fields['wbfsys_task_group']), true ),
...
}//end class WbfsysTaskGroup_Crud_Create_Form */
