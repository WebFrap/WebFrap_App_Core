 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var WbfsysTaskGroup_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTaskGroup Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskGroup = $this->model->getEntityWbfsysTaskGroup();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Task Group: {@text@}',
      'wbfsys.task_group.label',
      array( 'text' => $entityWbfsysTaskGroup->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskGroup.show  &amp;objid='.$entityWbfsysTaskGroup
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskGroup.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_group-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_group/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTaskGroup_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.TaskGroup.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_group' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_task_group a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.TaskGroup.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.TaskGroup.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTaskGroup_Crud_Show_Maintab_View
