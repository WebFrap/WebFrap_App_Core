 ...
 * @licence WebFrap.net
 */
class WbfsysTaskGroup_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTaskGroup Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTaskGroup = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Task Group: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TaskGroup.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTaskGroup
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TaskGroup.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_task_group-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/task_group/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTaskGroup_Crud_Edit' );
...
}//end class WbfsysTaskGroup_Crud_Edit_Maintab_View
