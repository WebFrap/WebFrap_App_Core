...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_task_group';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysTaskGroup';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysTaskGroup' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysTaskGroup entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_responsible( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Responsible (Task Group)', 'wbfsys.task_group.label' ),
      ));
      ...
      $inputIdResponsible->setLabel( $this->view->i18n->l( 'Responsible', 'wbfsys.task_group.label' ) );
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleGroup_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_group'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Group (Task Group)', 'wbfsys.task_group.label' ),
      ));
      ...
      $inputIdGroup->setLabel( $this->view->i18n->l( 'Group', 'wbfsys.task_group.label' ) );
  ...
  * @return void
  */
  public function input_id_task( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTask_Entity' ) )
    {
      ...
      $inputIdTask = $this->view->newInput( 'input'.$this->prefix.'IdTask', 'Window' );
      $inputIdTask->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_task]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_task'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Task (Task Group)', 'wbfsys.task_group.label' ),
      ));
      ...
      $inputIdTask->setReadOnly( $this->isReadOnly( 'id_task' ) );
      $inputIdTask->setLabel( $this->view->i18n->l( 'Task', 'wbfsys.task_group.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Task.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_task'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdTask->buildJavascript( 'wgt-input-'.$this->keyName.'_id_task'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_task */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Task Group)', 'wbfsys.task_group.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.task_group.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Task Group)', 'wbfsys.task_group.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.task_group.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Task Group)', 'wbfsys.task_group.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.task_group.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Task Group)', 'wbfsys.task_group.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.task_group.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Task Group)', 'wbfsys.task_group.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.task_group.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Task Group)', 'wbfsys.task_group.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.task_group.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Task Group)', 'wbfsys.task_group.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.task_group.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_task_group_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_task_group_m_role_change';
...
}//end class WbfsysTaskGroup_Form */
