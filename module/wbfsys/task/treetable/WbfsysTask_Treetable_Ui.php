...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new WbfsysTask_Treetable_Element
    (
      'treetableWbfsysTask',
      $view
    );
...
WGTJS;
   ...
   *
   * @return WbfsysTask_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTask', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param WbfsysTask_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysTask_Treetable_Ui
