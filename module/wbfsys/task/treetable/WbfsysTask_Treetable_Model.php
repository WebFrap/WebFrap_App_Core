 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Treetable_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'WbfsysTask_Treetable' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'WbfsysTask_Treetable_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class WbfsysTask_Treetable_Model
