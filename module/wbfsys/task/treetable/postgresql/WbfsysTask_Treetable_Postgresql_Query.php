 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Treetable_Postgresql_Query
  extends LibSqlQuery
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    while( $children = $this->loadChildren( $ids, true ) )
    {
      ...
      {
        $this->childs[$child['wbfsys_task_m_parent']][] = $child;
        $ids[] = $child['wbfsys_task_rowid'];
      }
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $access, $condition, $params = null )
  {
    ...
    while( $childIds = $access->fetchChildrenIds( $pName, 'treetable', $this, $ids, $condition, $params ) )
    {
      ...
      foreach( $children as $child )
      {
        $child['acl-level'] = $childIds[$child['wbfsys_task_rowid']];
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_task.rowid as "wbfsys_task_rowid"', // variant: def-rowid 
      'wbfsys_task.title as "wbfsys_task_title"', // variant: def-by-context 
      'wbfsys_process_node.label as "wbfsys_process_node_label"', // variant: def-by-context  used source field wbfsys_process_node
      'wbfsys_task.id_status as "wbfsys_task_id_status"', // ref wbfsys_task def-by-context 
      ...
      'wbfsys_task.m_parent as "wbfsys_task_m_parent"', // variant: def-additional 
    );
...
}//end class WbfsysTask_Treetable_Postgresql_Query
