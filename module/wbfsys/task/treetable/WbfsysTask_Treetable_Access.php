 ...
 * @licence WebFrap.net
 */
class WbfsysTask_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysTask_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mgmt-wbfsys_task') )
...
}//end class WbfsysTask_Treetable_Access
