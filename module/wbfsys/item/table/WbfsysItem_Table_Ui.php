...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Items
  *
  ...
  *  }
  *
  * @return WbfsysItem_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysItem_Table_Element( 'tableWbfsysItem', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_item-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Items', 'wbfsys.item.label' );
      //$tabPanel->searchKey = 'wbfsys_item';
      ...
      $searchElement->searchKey = 'wbfsys_item';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysItem_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysItem', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysItem listing maske
   *
   * @param WbfsysItem_Table_Model $model
   * @param TFlag $params
   * @return void
   */
