 ...
 * @licence WebFrap.net
 */
class WbfsysItem_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysItem Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysItem = $this->model->getEntityWbfsysItem();
    ...
    (
      'Show Item: {@text@}',
      'wbfsys.item.label',
      array( 'text' => $entityWbfsysItem->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Item.show  &amp;objid='.$entityWbfsysItem
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Item.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_item-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/item/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysItem_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Item.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_item' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_item a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Item.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Item.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysItem_Crud_Show_Maintab_View
