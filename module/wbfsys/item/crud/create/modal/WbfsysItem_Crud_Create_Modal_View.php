 ...
 * @licence WebFrap.net
 */
class WbfsysItem_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysItem entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Item.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Item.insert';
    $params->formId       = 'wgt-form-wbfsys_item';
    $params->namespace   = 'wbfsys_item-create';
    ...
    $this->setTemplate( 'wbfsys/item/modal/crud/form_create' );
...
}//end class WbfsysItem_Crud_Create_Modal_View
