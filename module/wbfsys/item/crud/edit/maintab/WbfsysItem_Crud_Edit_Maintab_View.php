 ...
 * @licence WebFrap.net
 */
class WbfsysItem_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysItem Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysItem = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Item.edit&amp;utf8=✓&amp;objid='.$entityWbfsysItem
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Item.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_item-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/item/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysItem_Crud_Edit' );
...
}//end class WbfsysItem_Crud_Edit_Maintab_View
