...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysItem_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysItem_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysItem_Selection_Element
    (
      'selectionWbfsysItem',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Items', 'wbfsys.item.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Item.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param WbfsysItem_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysItem_Selection_Ui
