 ...
 * @licence WebFrap.net
 */
class WbfsysItem_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-wbfsys_item';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Item.show&amp;target_mask=WbfsysItem&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.item.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Item.edit&amp;target_mask=WbfsysItem&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.item.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Item.delete&amp;target_mask=WbfsysItem&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.item.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_item_name'])).'</td>'.NL;
...
}//end class WbfsysItem_Selection_Element
