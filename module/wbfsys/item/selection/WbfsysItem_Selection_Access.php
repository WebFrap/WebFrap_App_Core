 ...
 * @licence WebFrap.net
 */
class WbfsysItem_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysItem_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_item.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_item.rowid ",
      'acls'
    );
...
}//end class WbfsysItem_Selection_Access
