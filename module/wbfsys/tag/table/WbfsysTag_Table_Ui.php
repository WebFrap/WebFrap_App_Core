...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Tags
  *
  ...
  *  }
  *
  * @return WbfsysTag_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTag_Table_Element( 'tableWbfsysTag', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tag-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Tags', 'wbfsys.tag.label' );
      //$tabPanel->searchKey = 'wbfsys_tag';
      ...
      $searchElement->searchKey = 'wbfsys_tag';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTag_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTag', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTag listing maske
   *
   * @param WbfsysTag_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTag  = $model->getEntityWbfsysTag();
