...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_tag';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTag_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Tag.show&amp;target_mask=WbfsysTag&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'wbfsys.tag.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Tag.edit&amp;target_mask=WbfsysTag&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tag.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Tag.delete&amp;target_mask=WbfsysTag&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tag.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Wbfsys.Tag.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_tag_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Tag_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Tags." >{$iconDelete} Delete selected Tags</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Tags. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Tag_Multi.deleteAll" >{$iconClean} Delete all Tags</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTag_Table_Element
