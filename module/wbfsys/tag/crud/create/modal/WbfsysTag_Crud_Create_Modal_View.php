 ...
 * @licence WebFrap.net
 */
class WbfsysTag_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysTag entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Tag.insert';
    $params->formId       = 'wgt-form-wbfsys_tag';
    $params->namespace   = 'wbfsys_tag-create';
    ...
    $this->setTemplate( 'wbfsys/tag/modal/crud/form_create' );
...
}//end class WbfsysTag_Crud_Create_Modal_View
