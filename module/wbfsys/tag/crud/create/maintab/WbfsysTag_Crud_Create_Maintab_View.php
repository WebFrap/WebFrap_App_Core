 ...
 * @licence WebFrap.net
 */
class WbfsysTag_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTag Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_tag-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/tag/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Tag.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-wbfsys_tag';
    ...
    $form = $this->newForm( 'WbfsysTag_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.Tag.create');}});
});
...
}//end class WbfsysTag_Crud_Create_Maintab_View
