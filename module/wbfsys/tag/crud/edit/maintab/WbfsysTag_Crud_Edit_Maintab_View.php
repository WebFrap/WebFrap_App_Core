 ...
 * @licence WebFrap.net
 */
class WbfsysTag_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTag Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTag = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Tag.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTag
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Tag.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tag-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tag/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTag_Crud_Edit' );
...
}//end class WbfsysTag_Crud_Edit_Maintab_View
