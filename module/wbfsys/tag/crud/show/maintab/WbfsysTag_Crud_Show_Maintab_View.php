 ...
 * @licence WebFrap.net
 */
class WbfsysTag_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysTag Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTag = $this->model->getEntityWbfsysTag();
    ...
    (
      'Show Tag: {@text@}',
      'wbfsys.tag.label',
      array( 'text' => $entityWbfsysTag->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Tag.show  &amp;objid='.$entityWbfsysTag
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Tag.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tag-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tag/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysTag_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Tag.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tag' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_tag a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Tag.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Tag.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysTag_Crud_Show_Maintab_View
