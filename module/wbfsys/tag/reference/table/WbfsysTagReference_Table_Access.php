 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Table_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysTagReference_Table_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_tag_reference.rowid ",
      'acls'
    );
...
}//end class WbfsysTagReference_Table_Access
