 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_tag_reference';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysTagReference_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.TagReference.show&amp;target_mask=WbfsysTagReference&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.TagReference.edit&amp;target_mask=WbfsysTagReference&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.tag_reference.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.TagReference.delete&amp;target_mask=WbfsysTagReference&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.tag_reference.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_tag_reference_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.TagReference_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Tag References." >{$iconDelete} Delete selected Tag References</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Tag References. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.TagReference_Multi.deleteAll" >{$iconClean} Delete all Tag References</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysTagReference_Table_Element
