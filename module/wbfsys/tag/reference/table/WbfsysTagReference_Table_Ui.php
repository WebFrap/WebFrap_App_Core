 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Tag References
  *
  ...
  *  }
  *
  * @return WbfsysTagReference_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysTagReference_Table_Element( 'tableWbfsysTagReference', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_tag_reference-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Tag References', 'wbfsys.tag_reference.label' );
      //$tabPanel->searchKey = 'wbfsys_tag_reference';
      ...
      $searchElement->searchKey = 'wbfsys_tag_reference';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysTagReference_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysTagReference', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysTagReference listing maske
   *
   * @param WbfsysTagReference_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysTagReference  = $model->getEntityWbfsysTagReference();
    ...
    $formWbfsysTagReference->setKeyName( 'wbfsys_tag_reference' );
...
}//end class WbfsysTagReference_Table_Ui
