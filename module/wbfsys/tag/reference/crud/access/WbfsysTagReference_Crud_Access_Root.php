 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysTagReference_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysTagReference_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysTagReference_Entity */
      $entity = $orm->get( 'WbfsysTagReference', $rootId );
    }
...
}//end class WbfsysTagReference_Crud_Access_Root
