 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysTagReference Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysTagReference = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Tag Reference: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.TagReference.edit&amp;utf8=✓&amp;objid='.$entityWbfsysTagReference
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.TagReference.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_tag_reference-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/tag_reference/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysTagReference_Crud_Edit' );
...
}//end class WbfsysTagReference_Crud_Edit_Maintab_View
