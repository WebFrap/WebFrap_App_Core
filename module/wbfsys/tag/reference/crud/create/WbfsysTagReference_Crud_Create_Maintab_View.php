 ...
 * @licence WebFrap.net
 */
class WbfsysTagReference_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des WbfsysTagReference Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-wbfsys_tag_reference-create' );

    // set the form template
    $this->setTemplate( 'wbfsys/tag_reference/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.TagReference.insert&amp;utf8=✓';
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Wbfsys.TagReference.create');}});
});
...
}//end class WbfsysTagReference_Crud_Create_Maintab_View
