...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'wbfsys_tag_reference';
   ...
   * @var string 
   */
  public $entityName  = 'WbfsysTagReference';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: WbfsysTagReference' );
      }
    }
 ...
 /**
  * create a search form for the WbfsysTagReference entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_tag( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysTag_Entity' ) )
    {
      ...
      $inputIdTag = $this->view->newInput( 'input'.$this->prefix.'IdTag', 'Window' );
      $inputIdTag->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_tag]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_tag'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Tag (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ));
      ...
      $inputIdTag->setReadOnly( $this->isReadOnly( 'id_tag' ) );
      $inputIdTag->setLabel( $this->view->i18n->l( 'Tag', 'wbfsys.tag_reference.label' ) );


      $listUrl = 'modal.php?c=Wbfsys.Tag.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_tag'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdTag->buildJavascript( 'wgt-input-'.$this->keyName.'_id_tag'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_tag */
    ...
    if( !Webfrap::classLoadable( 'WbfsysEntity_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_id_entity'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Entity (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ));
      ...
      $inputIdEntity->setLabel( $this->view->i18n->l( 'Entity', 'wbfsys.tag_reference.label' ) );
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Vid (Tag Reference)', 'wbfsys.tag_reference.label' ),
        )
      );
      ...
      $inputVid->setLabel
      (
        $this->view->i18n->l( 'Vid', 'wbfsys.tag_reference.label' ),
  ...
  * @return void
  */
  public function input_flag_personal( $params )
  {

      //tpl: class ui:Checkbox
      $inputFlagPersonal = $this->view->newInput( 'input'.$this->prefix.'FlagPersonal' , 'Checkbox' );
      $this->items['flag_personal'] = $inputFlagPersonal;
      $inputFlagPersonal->addAttributes
      (
        array
        (
          'name'      => $this->keyName.'[flag_personal]',
          'id'        => 'wgt-input-'.$this->keyName.'_flag_personal'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Personal (Tag Reference)', 'wbfsys.tag_reference.label' ),
        )
      );
      $inputFlagPersonal->setWidth( 'medium' );

      $inputFlagPersonal->setReadOnly( $this->isReadOnly( 'flag_personal' ) );
      $inputFlagPersonal->setActive( $this->entity->getBoolean( 'flag_personal' ) );
      $inputFlagPersonal->setLabel
      (
        $this->view->i18n->l( 'Personal', 'wbfsys.tag_reference.label' ),
        $this->entity->required( 'flag_personal' )
      );
  ...
  }//end public function input_flag_personal */
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Tag Reference)', 'wbfsys.tag_reference.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'wbfsys.tag_reference.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'wbfsys.tag_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'wbfsys.tag_reference.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'wbfsys.tag_reference.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Tag Reference)', 'wbfsys.tag_reference.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'wbfsys.tag_reference.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Tag Reference)', 'wbfsys.tag_reference.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'wbfsys.tag_reference.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Tag Reference)', 'wbfsys.tag_reference.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'wbfsys.tag_reference.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tag_reference_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=wbfsys_tag_reference_m_role_change';
...
}//end class WbfsysTagReference_Form */
