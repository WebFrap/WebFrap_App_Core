 ...
 * @licence WebFrap.net
 */
class WbfsysTag_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanResource()
  {
    ...
    $sql[] = <<<SQL
  delete from wbfsys_tag where rowid > 0;
SQL;
  ...
  public function fetchAutocomplete( $key )
  {
    ...
    $sql = <<<SQL
  SELECT
    wbfsys_tag.rowid as id,
    wbfsys_tag.name as value

  FROM
    wbfsys_tag

  WHERE
    upper(wbfsys_tag.name) like upper('{$db->addSlashes( $key )}%')
  LIMIT 10
...
}//end class WbfsysTag_Query_Postgresql
