 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param WbfsysIpaddress_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'wbfsys_ipaddress.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-wbfsys'), UPPER('mod-wbfsys-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = wbfsys_ipaddress.rowid ",
      'acls'
    );
...
}//end class WbfsysIpaddress_Selection_Access
