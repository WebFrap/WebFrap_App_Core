 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param WbfsysIpaddress_Selection_Query $data
  ...
  *  }
  *
  * @return WbfsysIpaddress_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIpaddress_Selection_Element
    (
      'selectionWbfsysIpaddress',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Ipaddress', 'wbfsys.ipaddress.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Wbfsys.Ipaddress.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowWbfsysIpaddress',
      'WbfsysIpaddress_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param WbfsysIpaddress_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class WbfsysIpaddress_Selection_Ui
