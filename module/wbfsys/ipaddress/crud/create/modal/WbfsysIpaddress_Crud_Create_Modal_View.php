 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new WbfsysIpaddress entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Wbfsys.Ipaddress.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Wbfsys.Ipaddress.insert';
    $params->formId       = 'wgt-form-wbfsys_ipaddress';
    $params->namespace   = 'wbfsys_ipaddress-create';
    ...
    $this->setTemplate( 'wbfsys/ipaddress/modal/crud/form_create' );
...
}//end class WbfsysIpaddress_Crud_Create_Modal_View
