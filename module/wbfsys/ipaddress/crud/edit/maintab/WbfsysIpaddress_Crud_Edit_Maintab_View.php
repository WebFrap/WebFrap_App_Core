 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der WbfsysIpaddress Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIpaddress = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Ipaddress.edit&amp;utf8=✓&amp;objid='.$entityWbfsysIpaddress
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Ipaddress.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ipaddress-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ipaddress/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'WbfsysIpaddress_Crud_Edit' );
...
}//end class WbfsysIpaddress_Crud_Edit_Maintab_View
