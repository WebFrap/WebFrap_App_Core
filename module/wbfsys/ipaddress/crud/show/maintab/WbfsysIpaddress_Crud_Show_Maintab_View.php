 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der WbfsysIpaddress Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityWbfsysIpaddress = $this->model->getEntityWbfsysIpaddress();
    ...
    (
      ...
      array( 'text' => $entityWbfsysIpaddress->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Wbfsys.Ipaddress.show  &amp;objid='.$entityWbfsysIpaddress
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Wbfsys.Ipaddress.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-wbfsys_ipaddress-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'wbfsys/ipaddress/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'WbfsysIpaddress_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Wbfsys.Ipaddress.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ipaddress' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_wbfsys_ipaddress a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Wbfsys.Ipaddress.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Wbfsys.Ipaddress.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class WbfsysIpaddress_Crud_Show_Maintab_View
