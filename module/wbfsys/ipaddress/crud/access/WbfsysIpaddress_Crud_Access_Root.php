 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|WbfsysIpaddress_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity WbfsysIpaddress_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity WbfsysIpaddress_Entity */
      $entity = $orm->get( 'WbfsysIpaddress', $rootId );
    }
...
}//end class WbfsysIpaddress_Crud_Access_Root
