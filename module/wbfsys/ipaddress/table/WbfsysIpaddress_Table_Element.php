 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-wbfsys_ipaddress';
  
  /**
   * the most likley class of a given query object
   *
   * @var WbfsysIpaddress_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Wbfsys.Ipaddress.show&amp;target_mask=WbfsysIpaddress&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Wbfsys.Ipaddress.edit&amp;target_mask=WbfsysIpaddress&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'wbfsys.ipaddress.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Wbfsys.Ipaddress.delete&amp;target_mask=WbfsysIpaddress&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'wbfsys.ipaddress.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Ip Address', 'wbfsys.ipaddress.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Server', 'wbfsys.ipaddress.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['wbfsys_ipaddress_rowid'];
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['wbfsys_ipaddress_ip_address'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['hosting_server_name'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Wbfsys.Ipaddress_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Ipaddress." >{$iconDelete} Delete selected Ipaddress</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Ipaddress. Please confirm that you really want to do that."
      	href="ajax.php?c=Wbfsys.Ipaddress_Multi.deleteAll" >{$iconClean} Delete all Ipaddress</a></li>
  	</ul>
 	</div>
...
}//end class WbfsysIpaddress_Table_Element
