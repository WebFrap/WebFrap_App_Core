...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['wbfsys_ipaddress_ip_address']).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['hosting_server_name']).'</td>'.NL;
