 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Ipaddress
  *
  ...
  *  }
  *
  * @return WbfsysIpaddress_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new WbfsysIpaddress_Table_Element( 'tableWbfsysIpaddress', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-wbfsys_ipaddress-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Ipaddress', 'wbfsys.ipaddress.label' );
      //$tabPanel->searchKey = 'wbfsys_ipaddress';
      ...
      $searchElement->searchKey = 'wbfsys_ipaddress';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new WbfsysIpaddress_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowWbfsysIpaddress', $table->buildAjax() );
...
JSCODE;
   ...
   * die WbfsysIpaddress listing maske
   *
   * @param WbfsysIpaddress_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityWbfsysIpaddress  = $model->getEntityWbfsysIpaddress();
    ...
    $formWbfsysIpaddress->setKeyName( 'wbfsys_ipaddress' );
...
}//end class WbfsysIpaddress_Table_Ui
