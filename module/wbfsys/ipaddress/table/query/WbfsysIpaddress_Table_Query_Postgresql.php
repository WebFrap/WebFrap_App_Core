 ...
 * @licence WebFrap.net
 */
class WbfsysIpaddress_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['wbfsys_ipaddress_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetch( $condition = null, $params = null )
  {
    ...
    if( $params->loadFullSize )
      $this->calcQuery = $criteria->count( 'count(DISTINCT wbfsys_ipaddress.'.Db::PK.' ) as '.Db::Q_SIZE );
 ...
 /**
  ...
  public function fetchInAcls( array $inKeys, $params = null )
  {
    ...
    $criteria->where
    (
      " wbfsys_ipaddress.rowid  IN( ". implode( ', ', array_keys($inKeys) ) ." )"
    );
    ...
    {
      $row['acl-level'] = $inKeys[$row['wbfsys_ipaddress_rowid']];
      $this->data[]     = $row;
    }
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    $cols = array
    (
      'DISTINCT wbfsys_ipaddress.rowid as "wbfsys_ipaddress_rowid"', // variant: def-rowid 
      'wbfsys_ipaddress.ip_address as "wbfsys_ipaddress_ip_address"', // variant: def-by-context 
      'hosting_server.name as "hosting_server_name"', // variant: def-by-context  used source field hosting_server
      'wbfsys_ipaddress.id_server as "wbfsys_ipaddress_id_server"', // ref wbfsys_ipaddress def-by-context 
    );
  ...
  public function setTables( $criteria   )
  {
    ...
    $criteria->from( 'wbfsys_ipaddress' );
    ...
    (
      ...
      null,
      'hosting_server'
    );// hosting_server  by alias hosting_server
  ...
  public function appendConditions( $criteria, $condition, $params )
  {
    ...
    if( $this->condition )
    {
      ...
      if( is_string( $this->condition ) )
      {
        ...
        {
          $criteria->where( 'wbfsys_ipaddress.rowid = '.$this->condition );
        }
        else
        {
    ...
    if( $condition )
    {
      ...
      if( is_string( $condition) )
      {
        ...
        {
          $criteria->where( 'wbfsys_ipaddress.rowid = '.$condition );
        }
        else
        {
 ...
 wbfsys_ipaddress.rowid = \''.$part.'\' 
  ...
  public function checkCharBegin( $criteria, $params )
  {
      ...
      if( $params->begin )
      {
        ...
        if( '?' == $params->begin  )
        {
          $criteria->where( "wbfsys_ipaddress.ip_address ~* '^[^a-zA-Z]'" );
        }
        else
        {
          $criteria->where( "upper(substr(wbfsys_ipaddress.ip_address,1,1)) = '".strtoupper($params->begin)."'" );
        }
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
    ...
    else // if not use the default
    {
      ...
      $envelop->groupBy( 'inner_acl."wbfsys_ipaddress-rowid-order"' );
      $envelop->selectAlso( 'inner_acl."wbfsys_ipaddress-rowid-order"' );
      $envelop->orderBy( 'inner_acl."wbfsys_ipaddress-rowid-order"' );
...
}//end class WbfsysIpaddress_Table_Query_Postgresql
