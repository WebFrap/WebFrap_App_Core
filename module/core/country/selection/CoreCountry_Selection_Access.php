 ...
 * @licence WebFrap.net
 */
class CoreCountry_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreCountry_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'core_country.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = core_country.rowid ",
      'acls'
    );
...
}//end class CoreCountry_Selection_Access
