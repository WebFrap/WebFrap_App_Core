 ...
 * @licence WebFrap.net
 */
class CoreCountry_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreCountry_Selection_Query $data
  ...
  *  }
  *
  * @return CoreCountry_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCountry_Selection_Element
    (
      'selectionCoreCountry',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Countrys', 'core.country.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Country.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param CoreCountry_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCountry_Selection_Ui
