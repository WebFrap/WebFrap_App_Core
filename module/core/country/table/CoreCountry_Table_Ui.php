...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Countrys
  *
  ...
  *  }
  *
  * @return CoreCountry_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCountry_Table_Element( 'tableCoreCountry', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_country-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Countrys', 'core.country.label' );
      //$tabPanel->searchKey = 'core_country';
      ...
      $searchElement->searchKey = 'core_country';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreCountry_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreCountry', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreCountry listing maske
   *
   * @param CoreCountry_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCountry_Table_Ui
