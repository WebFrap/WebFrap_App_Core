 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-core'), UPPER('mgmt-core_country_category') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = core_country_category.{$fieldName}
...
}//end class CoreCountryCategory_Filter
