 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreCountryCategory entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.CountryCategory.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.CountryCategory.insert';
    $params->formId       = 'wgt-form-core_country_category';
    $params->namespace   = 'core_country_category-create';
    ...
    $this->setTemplate( 'core/country_category/modal/crud/form_create' );
...
}//end class CoreCountryCategory_Crud_Create_Modal_View
