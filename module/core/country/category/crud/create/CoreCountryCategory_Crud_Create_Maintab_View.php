 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreCountryCategory Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_country_category-create' );

    // set the form template
    $this->setTemplate( 'core/country_category/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.CountryCategory.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_country_category';
    ...
    $form = $this->newForm( 'CoreCountryCategory_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.CountryCategory.create');}});
});
...
}//end class CoreCountryCategory_Crud_Create_Maintab_View
