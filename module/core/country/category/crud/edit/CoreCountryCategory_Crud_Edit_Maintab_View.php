 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreCountryCategory Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCountryCategory = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit country Category: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.CountryCategory.edit&amp;utf8=✓&amp;objid='.$entityCoreCountryCategory
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.CountryCategory.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_country_category-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/country_category/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreCountryCategory_Crud_Edit' );
...
}//end class CoreCountryCategory_Crud_Edit_Maintab_View
