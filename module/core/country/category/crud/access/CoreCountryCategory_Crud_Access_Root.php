 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreCountryCategory_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreCountryCategory_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreCountryCategory_Entity */
      $entity = $orm->get( 'CoreCountryCategory', $rootId );
    }
...
}//end class CoreCountryCategory_Crud_Access_Root
