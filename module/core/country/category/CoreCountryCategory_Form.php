 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'core_country_category';
   ...
   * @var string 
   */
  public $entityName  = 'CoreCountryCategory';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: CoreCountryCategory' );
      }
    }
 ...
 /**
  * create a search form for the CoreCountryCategory entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_parent( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CoreCountryCategory_Entity' ) )
    {
      ...
      $inputIdParent = $this->view->newInput( 'input'.$this->prefix.'IdParent', 'Window' );
      $inputIdParent->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_parent]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_parent'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Parent Node (Country Category)', 'core.country_category.label' ),
      ));
      ...
      $inputIdParent->setReadOnly( $this->isReadOnly( 'id_parent' ) );
      $inputIdParent->setLabel( $this->view->i18n->l( 'Parent Node', 'core.country_category.label' ) );


      $listUrl = 'modal.php?c=Core.CountryCategory.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_parent'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdParent->buildJavascript( 'wgt-input-'.$this->keyName.'_id_parent'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_parent */
  ...
  public function input_m_order( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Order (Country Category)', 'core.country_category.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Order', 'core.country_category.label' ),
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Country Category)', 'core.country_category.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'core.country_category.label' ),
  ...
  public function input_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Access Key (Country Category)', 'core.country_category.label' ),
      ...
      (
        $this->view->i18n->l( 'Access Key', 'core.country_category.label' ),
  ...
  public function input_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Title (Country Category)', 'core.country_category.label' ),
      ...
      $inputTitle->setLabel
      (
        $this->view->i18n->l( 'Title', 'core.country_category.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Country Category)', 'core.country_category.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'core.country_category.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Country Category)', 'core.country_category.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'core.country_category.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Country Category)', 'core.country_category.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'core.country_category.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Country Category)', 'core.country_category.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'core.country_category.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Country Category)', 'core.country_category.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'core.country_category.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Country Category)', 'core.country_category.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'core.country_category.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Country Category)', 'core.country_category.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'core.country_category.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Country Category)', 'core.country_category.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'core.country_category.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Country Category)', 'core.country_category.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_access_key( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Access Key (Country Category)', 'core.country_category.label' ),
          'maxlength' => $this->entity->maxSize( 'access_key' ),
        )
      );
      $inputAccessKey->setWidth( 'medium' );
  ...
  public function search_title( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Title (Country Category)', 'core.country_category.label' ),
          'maxlength' => $this->entity->maxSize( 'title' ),
        )
      );
      $inputTitle->setWidth( 'xxlarge' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Country Category)', 'core.country_category.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_country_category_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_country_category_m_role_change';
...
}//end class CoreCountryCategory_Form */
