 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_country_category';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreCountryCategory_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.CountryCategory.show&amp;target_mask=CoreCountryCategory&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.CountryCategory.edit&amp;target_mask=CoreCountryCategory&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.country_category.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.CountryCategory.delete&amp;target_mask=CoreCountryCategory&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.country_category.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    
    ...
    {
      $this->html .= '</table>';
      $this->html .= '<var id="'.$this->id.'-body-sortable" >{"url":"ajax.php?c=Core.CountryCategory.changeOrder&amp;ltype=table"}</var>';
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'core.country_category.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Title', 'core.country_category.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Description', 'core.country_category.label' ).'</th>'.NL;
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['core_country_category_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.CountryCategory_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected country Categorys." >{$iconDelete} Delete selected country Categorys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! country Categorys. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.CountryCategory_Multi.deleteAll" >{$iconClean} Delete all country Categorys</a></li>
  	</ul>
 	</div>
...
}//end class CoreCountryCategory_Table_Element
