 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für country Categorys
  *
  ...
  *  }
  *
  * @return CoreCountryCategory_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCountryCategory_Table_Element( 'tableCoreCountryCategory', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_country_category-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'country Categorys', 'core.country_category.label' );
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreCountryCategory_Table_Element( null,$view );
...
JSCODE;
   ...
   *
   * @param CoreCountryCategory_Table_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCountryCategory_Table_Ui
