 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreCountryCategory_Table_Model
    */
    public $model = null;

    /**
    * @var CoreCountryCategory_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'core/country_category/maintab/table/listing_table' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Table country Categorys',
    ...
    (
      $i18nText,
      'maintab.php?c=Core.CountryCategory.listing&amp;ltype=table'
    );
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'CoreCountryCategory_Table' );
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Core.CountryCategory.create&amp;ltype=table');
    });
...
}//end class CoreCountryCategory_Table_Maintab_View
