 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Table_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function getIds()
  {
    ...
    {
      $this->ids[] = $row['core_country_category_rowid'];
    }
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function fetchWithAcls( $condition = null, $params = null )
  {
    ...
    {
      $acl->injectListingAcls( $criteria, 'mod-core>mgmt-core_country_category' );
    }
    else
    {
      $acl->injectListingAcls( $criteria, 'mod-core>mgmt-core_country_category', true, $params->access->level  );
    }
...
}//end class CoreCountryCategory_Table_Query_Postgresql
