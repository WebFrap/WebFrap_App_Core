 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var CoreCountryCategory_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'CoreCountryCategory_Export_Listing_Access';
    ...
    // create a new CoreCountryCategory window
    $view = $this->loadView
    (
    	'export-core_country_category',
    	'CoreCountryCategory_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'CoreCountryCategory_Export' );
...
} // end class CoreCountryCategory_Export_Controller_Genf
