 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// CRUD Methodes
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return CoreCountryCategory_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCountryCategory_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    ( 
      $this->view->i18n->l
      ( 
        'ACL country Category', 
        'core.country_category.label' 
      ) 
    );
    $table->setSearchKey( 'core_country_category-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'country Category', 'core.country_category.label' )
      )
    );
    $tabPanel->searchKey  = 'core_country_category_acl';
...
} // end class CoreCountryCategory_Acl_Ui */
