 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management CoreCountryCategory
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new CoreCountryCategory_Acl_Access_Container( null, null, $this );
    ...
    (
      'core_country_category_acl_listing',
      'CoreCountryCategory_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('CoreCountryCategory_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model CoreCountryCategory_Acl_Model */
    $model   = $this->loadModel( 'CoreCountryCategory_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_country_category-acl',
    	'CoreCountryCategory_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'core_country_category_acl_masks_listing',
      'CoreCountryCategory_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'CoreCountryCategory_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'CoreCountryCategory_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model CoreCountryCategory_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'CoreCountryCategory_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model CoreCountryCategory_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'CoreCountryCategory_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_country_category-acl-qfdu',
    	'CoreCountryCategory_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class CoreCountryCategory_Acl_Controller */
