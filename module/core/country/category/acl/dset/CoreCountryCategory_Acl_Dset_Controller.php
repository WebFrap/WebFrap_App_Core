 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model CoreCountryCategory_Acl_Dset_Model  */
    $model = $this->loadModel( 'CoreCountryCategory_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityCoreCountryCategory = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view CoreCountryCategory_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'core_country_category-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityCoreCountryCategory, $areaId, $params );
  ...
  public function service_search( $request, $response )
  {
    ...
    $view   = $response->loadView
    (
    	'core_country_category-acl-dset', 
    	'CoreCountryCategory_Acl_Dset',
    	'displaySearch',
    	View::AJAX
   	);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view CoreCountryCategory_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'core_country_category-acl-dset', 
    	'CoreCountryCategory_Acl_Dset',
...
} // end class CoreCountryCategory_Acl_Dset_Controller */
