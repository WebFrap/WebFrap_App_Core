 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'CoreCountryCategory_Acl_Dset' );
    ...
    $entityCoreCountryCategory = $this->model->getEntity( $dsetId );
...
} // end class CoreCountryCategory_Acl_Dset_Ajax_View */
