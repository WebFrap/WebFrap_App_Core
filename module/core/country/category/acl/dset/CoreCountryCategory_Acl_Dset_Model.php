 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-core_country_category'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'CoreCountryCategory', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreCountryCategory_Acl_Dset' );
    /* @var $query CoreCountryCategory_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreCountryCategory_Acl_Dset_Treetable' );
    /* @var $query CoreCountryCategory_Acl_Dset_Treetable_Query  */
...
} // end class CoreCountryCategory_Acl_Dset_Model */
