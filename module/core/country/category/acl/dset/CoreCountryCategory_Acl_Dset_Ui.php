 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var CoreCountryCategory_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CoreCountryCategory_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityCoreCountryCategory, $areaId, $access, $params  )
  {

    $listObj = new CoreCountryCategory_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-core_country_category-acl-dset' );
    ...
    else
    {
      ...
      (
        'country Category "{@label@}" User Access',
        'core.country_category.label',
        array
        (
          'label' => $entityCoreCountryCategory->text()
        )
      );
      $tabPanel->searchKey  = 'core_country_category_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new CoreCountryCategory_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class CoreCountryCategory_Acl_Dset_Ui */
