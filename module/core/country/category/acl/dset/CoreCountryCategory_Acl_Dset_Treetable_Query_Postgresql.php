 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(core_country_category.name) like upper(\''.$condition['free'].'%\') )
...
} // end class CoreCountryCategory_Acl_Dset_Treetable_Query_Postgresql */
