 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view CoreCountryCategory_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'core_country_category-acl-qfdu-aAjax',
      'CoreCountryCategory_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class CoreCountryCategory_Acl_Qfdu_Controller */
