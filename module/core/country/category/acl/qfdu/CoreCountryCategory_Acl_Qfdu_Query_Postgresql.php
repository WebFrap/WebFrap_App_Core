 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(core_country_category.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    core_country_category.rowid as id,
    core_country_category.name as value,
    core_country_category.name as label
  FROM
...
} // end class CoreCountryCategory_Acl_Qfdu_Query_Postgresql */
