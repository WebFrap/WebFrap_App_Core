 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'core_country_category.name as "core_country_category_name"',
      'core_country_category.title as "core_country_category_title"',
      'core_country_category.rowid as "core_country_category_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN core_country_category on wbfsys_group_users.vid = core_country_category.rowid'
    );
      ...
      else
      {
        ...
        if( strpos( $condition['free'], ',' ) )
        {
          ...
          foreach( $parts as $part )
          {
            ...
            OR 
            (  upper(core_country_category.title) like upper(\''.$part.'%\') )
...
} // end class CoreCountryCategory_Acl_Qfdu_Treetable_Query_Postgresql */
