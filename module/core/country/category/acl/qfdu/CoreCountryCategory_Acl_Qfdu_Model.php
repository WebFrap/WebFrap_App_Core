 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-core_country_category')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityCoreCountryCategory = $orm->get('CoreCountryCategory', $data['wbfsys_group_users']->vid);
      $tabData['core_country_category_name']  = $refEntityCoreCountryCategory->name;
      $tabData['core_country_category_title']  = $refEntityCoreCountryCategory->title;

    }
    $tabData['core_country_category_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein CoreCountryCategory_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreCountryCategory_Acl' );
    /* @var $query CoreCountryCategory_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreCountryCategory_Acl_Qfdu_Treetable' );
    /* @var $query CoreCountryCategory_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreCountryCategory_Acl_Qfdu' );
    /* @var $query CoreCountryCategory_Acl_Qfdu_Query  */
...
} // end class CoreCountryCategory_Acl_Qfdu_Model */
