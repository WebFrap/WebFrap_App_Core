 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-core_country_category' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialMod->id_area     = $orm->getByKey( 'WbfsysSecurityArea', 'mod-core' );
        ...
        $partialEntity->id_area    = $orm->getByKey( 'WbfsysSecurityArea', 'mgmt-core_country_category' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'CoreCountryCategory_Acl_Table' );
    /* @var $query CoreCountryCategory_Acl_Table_Query  */
...
} // end class CoreCountryCategory_Acl_Model */
