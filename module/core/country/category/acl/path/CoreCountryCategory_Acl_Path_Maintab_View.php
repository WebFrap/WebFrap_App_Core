 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'core/country_category/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-core_country_category-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-core_country_category-acl-path-access_level',
      'class' => 'medium',
...
} // end class CoreCountryCategory_Acl_Path_Maintab_View */
