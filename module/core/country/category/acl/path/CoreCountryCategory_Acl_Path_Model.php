 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'CoreCountryCategory_Acl_Path' );
    /* @var $query CoreCountryCategory_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('CoreCountryCategory_Acl_Path');
    /* @var $dropQuery CoreCountryCategory_Acl_Path_Query  */
...
} // end class CoreCountryCategory_Acl_Path_Model */
