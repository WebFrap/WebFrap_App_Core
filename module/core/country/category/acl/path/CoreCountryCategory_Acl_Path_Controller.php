 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'core_country_category_acl_graph', 
      'CoreCountryCategory_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'CoreCountryCategory_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'CoreCountryCategory_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view CoreCountryCategory_Acl_Path_Maintab_View  */
...
} // end class CoreCountryCategory_Acl_Path_Controller */
