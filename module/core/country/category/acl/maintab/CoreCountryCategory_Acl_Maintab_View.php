 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Acl_Maintab_View
...
////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    /**
    * @var CoreCountryCategory_Acl_Ui
    */
    public $ui = null;
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.CountryCategory_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_country_category-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Core.CountryCategory_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'core_country_category-acl-update';
    ...
    $this->setTemplate( 'core/country_category/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'country Category', 'core.country_category.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-core_country_category_acl_listing' );
    ...
    $ui = $this->loadUi( 'CoreCountryCategory_Acl' );
...
} // end class CoreCountryCategory_Acl_Maintab_View */
