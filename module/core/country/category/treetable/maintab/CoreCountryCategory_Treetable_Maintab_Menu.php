 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Maintab_Menu
  extends WgtDropmenu
{
  /**
...
{$customButtons}
  ...
  <div class="wgt-panel-control" >
    <button
        ...
        id="wgt-help-core_country_category-treetable-help"
        tooltip="Click to open the help text."
      ><div class="left ui-icon ui-icon-info"> </div></button>
      
    <div class="wgt-help-core_country_category-treetable-help hidden" >
    	      
<p>This is the country Category treetable.</p>
      ...
      <li>
        ...
        <span>
          ...
          <li><a 
            ...
            href="modal.php?c=Webfrap.Docu.open&amp;key=core_country_category-treetable" >{$iconHelp} {$this->view->i18n->l('Help','wbf.label')}</a></li>
...
}//end class CoreCountryCategory_Treetable_Maintab_Menu
