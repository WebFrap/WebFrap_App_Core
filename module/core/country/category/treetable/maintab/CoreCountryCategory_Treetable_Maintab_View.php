 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreCountryCategory_Treeable_Model
    */
    public $model = null;

    /**
    * @var CoreCountryCategory_Treeable_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'core/country_category/maintab/treetable/listing' );

    // fetch the i18n text only one time
    $i18nText = $this->i18n->l
    (
      'Treetable country Categorys',
    ...
    (
      $i18nText,
      'maintab.php?c=Core.CountryCategory.listing&amp;ltype=treetable'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.CountryCategory.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-treetable-core_country_category-search';
...
BUTTONJS;
    ...
    ///@var CoreCountryCategory_Treetable_Ui
    $ui = $this->loadUi( 'CoreCountryCategory_Treetable' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function addMenu( $params )
  {
    ...
    ///@var CoreCountryCategory_Table_Maintab_Menu
    $menu     = $this->newMenu
    (
      $this->id.'_dropmenu',
      'CoreCountryCategory_Table'
    );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_new").click(function(){
      \$R.get('maintab.php?c=Core.CountryCategory.create&amp;ltype=treetable');
    });
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      self.close();
      \$R.get('maintab.php?c=Core.CountryCategory.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      self.close();
      \$R.get('maintab.php?c=Core.CountryCategory.listing&amp;ltype=treetable');
    });
...
}//end class CoreCountryCategory_Treetable_Maintab_View
