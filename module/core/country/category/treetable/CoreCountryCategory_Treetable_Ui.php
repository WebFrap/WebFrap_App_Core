 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// listing methodes
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CoreCountryCategory_Treetable
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $treetable = new CoreCountryCategory_Treetable_Element
    (
      'treetableCoreCountryCategory',
      $view
    );
...
WGTJS;
   ...
   *
   * @return CoreCountryCategory_Treetable_Element
   */
  public function listEntry( $access, $params, $insert = false )
  {
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreCountryCategory', $treetable->buildAjax() );
...
JSCODE;
   ...
   *
   * @param CoreCountryCategory_Treetable_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCountryCategory_Treetable_Ui
