 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreCountryCategory_Treetable_Query $query
...
SQL;
    ...
    (
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mgmt-core_country_category') )
            AND acls.\"acl-user\" = {$userId}
            AND acls.\"acl-vid\" = core_country_category.rowid ",
      'acls'
    );
...
}//end class CoreCountryCategory_Treetable_Access
