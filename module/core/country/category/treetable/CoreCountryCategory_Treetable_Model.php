 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'CoreCountryCategory_Treetable' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'CoreCountryCategory_Treetable_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class CoreCountryCategory_Treetable_Model
