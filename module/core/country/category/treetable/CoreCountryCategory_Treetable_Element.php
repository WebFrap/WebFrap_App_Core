 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Treetable_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-treetable-core_country_category';
   ...
   *
   * @var CoreCountryCategory_Treetable_Query
   */
  public $data       = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.CountryCategory.show&amp;ltype=treetable&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.CountryCategory.edit&amp;ltype=treetable&amp;objid=',
        'control/edit.png',
        '',
        'core.country_category.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.CountryCategory.delete&amp;ltype=treetable&amp;objid=',
        'control/delete.png',
        '',
        'core.country_category.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildAjaxTbody( $row  )
  {
    ...
    if( $this->insertMode )
    {
      ...
      if( $row['core_country_category_id_parent'] )
      {
        $pClass = 'child-of-'.$this->id.'_row_'.$row['core_country_category_id_parent'];
        $body = '<htmlArea selector="tr#'.$this->id.'_row_'
          .$row['core_country_category_id_parent'].'" action="after" >'
          .'<![CDATA[<tr id="'.$rowid.'" '
          .' wgt_context_menu="'.$this->id.'-cmenu" '
          .' wgt_eid="'.$objid.'" ' 
          .$rowParams
    ...
    if( $row['core_country_category_id_parent'] )
    {
      $prePos = $row['core_country_category_id_parent'].'.';
    }
    else
    {
      $prePos = '';
    ...
    if( !$this->appendMode && $row['core_country_category_id_parent'] )
    {
      $parentId = $this->id.'_row_'.$row['core_country_category_id_parent'];
...
HTML;
  ...
  protected function buildJavascript()
  {
    ...
    \$S('#{$this->id}').data('func_add',function( objid ){
      \$R.post('maintab.php?c=Core.CountryCategory.create&amp;ltype=treetable',{"core_country_category[id_parent]":objid});
    });
...
}//end class CoreCountryCategory_Treetable_Element
