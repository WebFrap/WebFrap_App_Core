 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: core_country_category
  *
  ...
  *
  *   @url maintab.php?c=Core.CountryCategory.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'core_country_category-create';

    $access = new CoreCountryCategory_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-core_country_category-create',
      'CoreCountryCategory_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model CoreCountryCategory_Crud_Model */
    $model = $this->loadModel( 'CoreCountryCategory_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Core.CountryCategory.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityCoreCountryCategory = $model->getEntityCoreCountryCategory( $objid );
    ...
    if( !$entityCoreCountryCategory )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'country Category', 'core.country_category.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityCoreCountryCategory;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'core_country_category:edit';

    $access = new CoreCountryCategory_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreCountryCategory );
    ...
    $view = $response->loadView
    (
      'form-core_country_category-edit-'.$objid,
      'CoreCountryCategory_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'core_country_category-edit',
          $entityCoreCountryCategory,
          'Edit country Category :'.$entityCoreCountryCategory->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'core_country_category:show';
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'core_country_category-show',
          $entityCoreCountryCategory,
          'Show country Category :'.$entityCoreCountryCategory->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: core_country_category
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Core.CountryCategory.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-insert';

    $access = new CoreCountryCategory_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityCoreCountryCategory = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'core_country_category-update-'.$entityCoreCountryCategory;
      ...
      {
        $access = new CoreCountryCategory_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityCoreCountryCategory );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'CoreCountryCategory';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_core_country_category',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model CoreCountryCategory_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Core.CountryCategory.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityCoreCountryCategory, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param CoreCountryCategory_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Core.CountryCategory.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-delete-'.$objid;

    $access = new CoreCountryCategory_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreCountryCategory );
    ...
    $error = $model->delete( $entityCoreCountryCategory, $params );
    ...
    $error = $view->displayDelete( $entityCoreCountryCategory, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Core.CountryCategory.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Core.CountryCategory.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-listing';
    ...
    $containerClass = 'CoreCountryCategory_'.$listType.'_Access';
    ...
    /* @var $model CoreCountryCategory_Table_Model */
    $model = $this->loadModel( 'CoreCountryCategory_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'core_country_category-'.$params->ltype,
          'CoreCountryCategory',
          'List of country Categorys'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  CoreCountryCategory
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new CoreCountryCategory_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_core_country_category',
      'CoreCountryCategory_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'CoreCountryCategory_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Core.CountryCategory.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model CoreCountryCategory_Selection_Model */
    $model   = $this->loadModel( 'CoreCountryCategory_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'core_country_category-data-'.$objid;
    else
      $params->contextKey = 'core_country_category-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-core_country_category',
      'CoreCountryCategory',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityCoreCountryCategory, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-append-'.$objid;
    ...
    $ui = $this->loadUi( 'CoreCountryCategory_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new CoreCountryCategory_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_country_category-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'CoreCountryCategory_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityCoreCountryCategory, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'core_country_category' );
...
} // end class CoreCountryCategory_Controller */
