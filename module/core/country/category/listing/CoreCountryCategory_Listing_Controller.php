 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'CoreCountryCategory_'.$listType ) );
...
} // end class CoreCountryCategory_Listing_Controller */
