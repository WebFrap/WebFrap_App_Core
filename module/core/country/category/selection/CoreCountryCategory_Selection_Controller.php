 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Selection_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_selection( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'CoreCountryCategory_Selection' ) );
...
} // end class CoreCountryCategory_Selection_Controller */
