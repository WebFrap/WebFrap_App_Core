 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreCountryCategory_Selection_Model
    */
    public $model = null;

    /**
    * @var CoreCountryCategory_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'core/country_category/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.CountryCategory.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-core_country_category-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'CoreCountryCategory_Selection' );
...
}//end class CoreCountryCategory_Selection_Modal_View
