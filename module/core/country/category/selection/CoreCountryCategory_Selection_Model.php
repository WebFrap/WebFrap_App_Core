 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Selection_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'CoreCountryCategory_Selection' );
    ...
    if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'CoreCountryCategory_Selection_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class CoreCountryCategory_Selection_Model
