 ...
 * @licence WebFrap.net
 */
class CoreCountryCategory_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreCountryCategory_Selection_Query $data
  ...
  *  }
  *
  * @return CoreCountryCategory_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCountryCategory_Selection_Element
    (
      'selectionCoreCountryCategory',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection country Categorys', 'core.country_category.label' ) ;
      $tabPanel->searchKey = 'core_country_category';
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.CountryCategory.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowCoreCountryCategory',
      'CoreCountryCategory_Selection_Element'
    );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreCountryCategory' , $table->buildAjax() );
...
WGTJS;
   ...
   * die CoreCountryCategory listing maske
   *
   * @param CoreCountryCategory_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreCountryCategory  = $model->getEntityCoreCountryCategory();
    ...
    $formCoreCountryCategory->setKeyName( 'core_country_category' );
...
}//end class CoreCountryCategory_Selection_Ui
