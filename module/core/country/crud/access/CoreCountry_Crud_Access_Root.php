 ...
 * @licence WebFrap.net
 */
class CoreCountry_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreCountry_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CoreCountry_Entity */
      $entity = $orm->get( 'CoreCountry', $rootId );
    }
...
}//end class CoreCountry_Crud_Access_Root
