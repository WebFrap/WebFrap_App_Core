 ...
 * @licence WebFrap.net
 */
class CoreCountry_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreCountry Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCountry = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Country.edit&amp;utf8=✓&amp;objid='.$entityCoreCountry
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Country.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_country-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/country/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreCountry_Crud_Edit' );
...
}//end class CoreCountry_Crud_Edit_Maintab_View
