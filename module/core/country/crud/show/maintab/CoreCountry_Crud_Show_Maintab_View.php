 ...
 * @licence WebFrap.net
 */
class CoreCountry_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreCountry Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCountry = $this->model->getEntityCoreCountry();
    ...
    (
      'Show Country: {@text@}',
      'core.country.label',
      array( 'text' => $entityCoreCountry->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Country.show  &amp;objid='.$entityCoreCountry
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Country.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_country-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/country/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreCountry_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Country.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_country' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_country a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Country.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Country.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreCountry_Crud_Show_Maintab_View
