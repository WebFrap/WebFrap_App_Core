 ...
 * @licence WebFrap.net
 */
class CoreCountry_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreCountry entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Country.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Country.insert';
    $params->formId       = 'wgt-form-core_country';
    $params->namespace   = 'core_country-create';
    ...
    $this->setTemplate( 'core/country/modal/crud/form_create' );
...
}//end class CoreCountry_Crud_Create_Modal_View
