 ...
 * @licence WebFrap.net
 */
class CoreAddress_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreAddress_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'core_address.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = core_address.rowid ",
      'acls'
    );
...
}//end class CoreAddress_Selection_Access
