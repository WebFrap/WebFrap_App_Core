 ...
 * @licence WebFrap.net
 */
class CoreAddress_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreAddress_Selection_Query $data
  ...
  *  }
  *
  * @return CoreAddress_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreAddress_Selection_Element
    (
      'selectionCoreAddress',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Address', 'core.address.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Address.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param CoreAddress_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreAddress_Selection_Ui
