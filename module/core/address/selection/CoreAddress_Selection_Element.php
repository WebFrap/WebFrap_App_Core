 ...
 * @licence WebFrap.net
 */
class CoreAddress_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_address';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Address.show&amp;target_mask=CoreAddress&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'core.address.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Address.edit&amp;target_mask=CoreAddress&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.address.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Address.delete&amp;target_mask=CoreAddress&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.address.label',
        Acl::DELETE
...
}//end class CoreAddress_Selection_Element
