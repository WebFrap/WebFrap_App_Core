 ...
 * @licence WebFrap.net
 */
class CoreAddress_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_address';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreAddress_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Address.show&amp;target_mask=CoreAddress&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.address.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Address.edit&amp;target_mask=CoreAddress&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.address.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Address.delete&amp;target_mask=CoreAddress&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.address.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_address_street'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_address_postalcode'])).'</td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_address_city'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Address_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Address." >{$iconDelete} Delete selected Address</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Address. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Address_Multi.deleteAll" >{$iconClean} Delete all Address</a></li>
  	</ul>
 	</div>
...
}//end class CoreAddress_Table_Element
