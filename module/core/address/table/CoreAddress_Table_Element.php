...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['core_address_street']).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['core_address_postalcode']).'</td>'.NL;

      $body .= '<td valign="top" >'.Validator::sanitizeHtml($row['core_address_city']).'</td>'.NL;
