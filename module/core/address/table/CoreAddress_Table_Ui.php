...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Address
  *
  ...
  *  }
  *
  * @return CoreAddress_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreAddress_Table_Element( 'tableCoreAddress', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_address-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Address', 'core.address.label' );
      //$tabPanel->searchKey = 'core_address';
      ...
      $searchElement->searchKey = 'core_address';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreAddress_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreAddress', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreAddress listing maske
   *
   * @param CoreAddress_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreAddress  = $model->getEntityCoreAddress();
...
}//end class CoreAddress_Table_Ui
