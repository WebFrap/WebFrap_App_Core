 ...
 * @licence WebFrap.net
 */
class CoreAddress_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreAddress Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_address-create' );

    // set the form template
    $this->setTemplate( 'core/address/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.Address.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_address';
    ...
    $form = $this->newForm( 'CoreAddress_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.Address.create');}});
});
...
}//end class CoreAddress_Crud_Create_Maintab_View
