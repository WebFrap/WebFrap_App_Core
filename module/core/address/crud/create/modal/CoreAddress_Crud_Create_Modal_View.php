 ...
 * @licence WebFrap.net
 */
class CoreAddress_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreAddress entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Address.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Address.insert';
    $params->formId       = 'wgt-form-core_address';
    $params->namespace   = 'core_address-create';
    ...
    $this->setTemplate( 'core/address/modal/crud/form_create' );
...
}//end class CoreAddress_Crud_Create_Modal_View
