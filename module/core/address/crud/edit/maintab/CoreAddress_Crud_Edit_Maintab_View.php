 ...
 * @licence WebFrap.net
 */
class CoreAddress_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreAddress Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreAddress = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Address.edit&amp;utf8=✓&amp;objid='.$entityCoreAddress
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Address.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_address-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/address/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreAddress_Crud_Edit' );
...
}//end class CoreAddress_Crud_Edit_Maintab_View
