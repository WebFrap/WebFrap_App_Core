 ...
 * @licence WebFrap.net
 */
class CoreAddress_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreAddress Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreAddress = $this->model->getEntityCoreAddress();
    ...
    (
      'Show Address: {@text@}',
      'core.address.label',
      array( 'text' => $entityCoreAddress->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Address.show  &amp;objid='.$entityCoreAddress
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Address.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_address-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/address/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreAddress_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Address.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_address' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_address a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Address.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Address.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreAddress_Crud_Show_Maintab_View
