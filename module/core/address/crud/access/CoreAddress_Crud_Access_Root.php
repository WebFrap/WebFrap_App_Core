 ...
 * @licence WebFrap.net
 */
class CoreAddress_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreAddress_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CoreAddress_Entity */
      $entity = $orm->get( 'CoreAddress', $rootId );
    }
...
}//end class CoreAddress_Crud_Access_Root
