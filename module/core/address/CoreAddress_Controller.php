...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: core_address
  *
  ...
  *
  *   @url maintab.php?c=Core.Address.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'core_address-create';

    $access = new CoreAddress_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-core_address-create',
      'CoreAddress_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model CoreAddress_Crud_Model */
    $model = $this->loadModel( 'CoreAddress_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Core.Address.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityCoreAddress = $model->getEntityCoreAddress( $objid );
    ...
    $params->entity = $entityCoreAddress;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'core_address:edit';

    $access = new CoreAddress_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreAddress );
    ...
    $view = $response->loadView
    (
      'form-core_address-edit-'.$objid,
      'CoreAddress_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'core_address:show';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: core_address
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Core.Address.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-insert';

    $access = new CoreAddress_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityCoreAddress = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'core_address-update-'.$entityCoreAddress;
      ...
      {
        $access = new CoreAddress_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityCoreAddress );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'CoreAddress';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_core_address',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model CoreAddress_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Core.Address.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityCoreAddress, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param CoreAddress_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Core.Address.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-delete-'.$objid;

    $access = new CoreAddress_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreAddress );
    ...
    $error = $model->delete( $entityCoreAddress, $params );
    ...
    $error = $view->displayDelete( $entityCoreAddress, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Core.Address.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Core.Address.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-listing';
    ...
    $containerClass = 'CoreAddress_'.$listType.'_Access';
    ...
    /* @var $model CoreAddress_Table_Model */
    $model = $this->loadModel( 'CoreAddress_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'core_address-'.$params->ltype,
          'CoreAddress',
          'List of Addresss'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  CoreAddress
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new CoreAddress_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_core_address',
      'CoreAddress_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'CoreAddress_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Core.Address.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model CoreAddress_Selection_Model */
    $model   = $this->loadModel( 'CoreAddress_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'core_address-data-'.$objid;
    else
      $params->contextKey = 'core_address-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityCoreAddress, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-append-'.$objid;
    ...
    $ui = $this->loadUi( 'CoreAddress_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new CoreAddress_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_address-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'CoreAddress_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityCoreAddress, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'core_address' );
...
} // end class CoreAddress_Controller */
