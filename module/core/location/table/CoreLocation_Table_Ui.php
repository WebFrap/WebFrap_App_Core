...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für locations
  *
  ...
  *  }
  *
  * @return CoreLocation_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreLocation_Table_Element( 'tableCoreLocation', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_location-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'locations', 'core.location.label' );
      //$tabPanel->searchKey = 'core_location';
      ...
      $searchElement->searchKey = 'core_location';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreLocation_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreLocation', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreLocation listing maske
   *
   * @param CoreLocation_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreLocation  = $model->getEntityCoreLocation();
    ...
    $formCoreLocation->setKeyName( 'core_location' );
...
}//end class CoreLocation_Table_Ui
