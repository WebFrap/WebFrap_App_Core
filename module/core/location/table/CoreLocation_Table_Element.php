 ...
 * @licence WebFrap.net
 */
class CoreLocation_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_location';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreLocation_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Location.show&amp;target_mask=CoreLocation&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.location.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Location.edit&amp;target_mask=CoreLocation&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.location.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Location.delete&amp;target_mask=CoreLocation&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.location.label',
        Acl::DELETE
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Location_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected locations." >{$iconDelete} Delete selected locations</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! locations. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Location_Multi.deleteAll" >{$iconClean} Delete all locations</a></li>
  	</ul>
 	</div>
...
}//end class CoreLocation_Table_Element
