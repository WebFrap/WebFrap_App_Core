 ...
 * @licence WebFrap.net
 */
class CoreLocation_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreLocation_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreLocation_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreLocation_Entity */
      $entity = $orm->get( 'CoreLocation', $rootId );
    }
...
}//end class CoreLocation_Crud_Access_Root
