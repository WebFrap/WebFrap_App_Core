 ...
 * @licence WebFrap.net
 */
class CoreLocation_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreLocation Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreLocation = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Location.edit&amp;utf8=✓&amp;objid='.$entityCoreLocation
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Location.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_location-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/location/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreLocation_Crud_Edit' );
...
}//end class CoreLocation_Crud_Edit_Maintab_View
