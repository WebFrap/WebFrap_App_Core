 ...
 * @licence WebFrap.net
 */
class CoreLocation_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreLocation entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Location.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Location.insert';
    $params->formId       = 'wgt-form-core_location';
    $params->namespace   = 'core_location-create';
    ...
    $this->setTemplate( 'core/location/modal/crud/form_create' );
...
}//end class CoreLocation_Crud_Create_Modal_View
