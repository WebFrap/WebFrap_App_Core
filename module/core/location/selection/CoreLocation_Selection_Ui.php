 ...
 * @licence WebFrap.net
 */
class CoreLocation_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreLocation_Selection_Query $data
  ...
  *  }
  *
  * @return CoreLocation_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreLocation_Selection_Element
    (
      'selectionCoreLocation',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection locations', 'core.location.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Location.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowCoreLocation',
      'CoreLocation_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param CoreLocation_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreLocation_Selection_Ui
