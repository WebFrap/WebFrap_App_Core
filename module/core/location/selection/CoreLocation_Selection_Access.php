 ...
 * @licence WebFrap.net
 */
class CoreLocation_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreLocation_Selection_Query $query
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = core_location.rowid ",
      'acls'
    );
...
}//end class CoreLocation_Selection_Access
