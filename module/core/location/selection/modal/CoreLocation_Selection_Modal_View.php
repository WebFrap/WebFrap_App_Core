 ...
 * @licence WebFrap.net
 */
class CoreLocation_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreLocation_Selection_Model
    */
    public $model = null;

    /**
    * @var CoreLocation_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'core/location/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'location', 'core.location.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.Location.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-core_location-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'CoreLocation_Selection' );
...
}//end class CoreLocation_Selection_Modal_View
