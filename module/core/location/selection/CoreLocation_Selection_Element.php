 ...
 * @licence WebFrap.net
 */
class CoreLocation_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_location';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Location.show&amp;target_mask=CoreLocation&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'core.location.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Location.edit&amp;target_mask=CoreLocation&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.location.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Location.delete&amp;target_mask=CoreLocation&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.location.label',
        Acl::DELETE
...
}//end class CoreLocation_Selection_Element
