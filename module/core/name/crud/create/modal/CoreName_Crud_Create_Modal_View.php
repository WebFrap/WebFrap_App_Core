 ...
 * @licence WebFrap.net
 */
class CoreName_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreName entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Core.Name.insert';
    $params->formId       = 'wgt-form-core_name';
    $params->namespace   = 'core_name-create';
    ...
    $this->setTemplate( 'core/name/modal/crud/form_create' );
...
}//end class CoreName_Crud_Create_Modal_View
