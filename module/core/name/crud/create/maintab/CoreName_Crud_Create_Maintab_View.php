 ...
 * @licence WebFrap.net
 */
class CoreName_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreName Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_name-create' );

    // set the form template
    $this->setTemplate( 'core/name/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.Name.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_name';
    ...
    $form = $this->newForm( 'CoreName_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.Name.create');}});
});
...
}//end class CoreName_Crud_Create_Maintab_View
