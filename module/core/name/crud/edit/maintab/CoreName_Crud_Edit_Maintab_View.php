 ...
 * @licence WebFrap.net
 */
class CoreName_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreName Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreName = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Name.edit&amp;utf8=✓&amp;objid='.$entityCoreName
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Name.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_name-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/name/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreName_Crud_Edit' );
...
}//end class CoreName_Crud_Edit_Maintab_View
