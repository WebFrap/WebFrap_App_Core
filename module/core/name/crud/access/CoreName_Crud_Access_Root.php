 ...
 * @licence WebFrap.net
 */
class CoreName_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreName_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CoreName_Entity */
      $entity = $orm->get( 'CoreName', $rootId );
    }
...
}//end class CoreName_Crud_Access_Root
