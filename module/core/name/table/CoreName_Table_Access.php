  ...
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreName_Table_Query $query
  ...
  public function fetchListTableDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'core_name.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = core_name.rowid ",
      'acls'
    );
...
}//end class CoreName_Table_Access
