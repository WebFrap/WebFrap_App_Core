...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_name';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreName_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Name.show&amp;target_mask=CoreName&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.name.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Name.edit&amp;target_mask=CoreName&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.name.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Name.delete&amp;target_mask=CoreName&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.name.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Type', 'core.name.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_ajax" href="maintab.php?c=Core.NameType.listing" >'.nl2br(Validator::sanitizeHtml($row['core_name_type_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Name_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Names." >{$iconDelete} Delete selected Names</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Names. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Name_Multi.deleteAll" >{$iconClean} Delete all Names</a></li>
  	</ul>
 	</div>
...
}//end class CoreName_Table_Element
