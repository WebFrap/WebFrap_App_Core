...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Names
  *
  ...
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreName_Table_Element( 'tableCoreName', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_name-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Names', 'core.name.label' );
      //$tabPanel->searchKey = 'core_name';
      ...
      $searchElement->searchKey = 'core_name';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreName_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreName', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreName listing maske
   *
   * @param CoreName_Table_Model $model
   * @param TFlag $params
   * @return void
   */
