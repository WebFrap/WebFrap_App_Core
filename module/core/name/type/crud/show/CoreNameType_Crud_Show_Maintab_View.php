 ...
 * @licence WebFrap.net
 */
class CoreNameType_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreNameType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreNameType = $this->model->getEntityCoreNameType();
    ...
    (
      ...
      array( 'text' => $entityCoreNameType->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.NameType.show  &amp;objid='.$entityCoreNameType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.NameType.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_name_type-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/name_type/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreNameType_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.NameType.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_name_type' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_name_type a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.NameType.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.NameType.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreNameType_Crud_Show_Maintab_View
