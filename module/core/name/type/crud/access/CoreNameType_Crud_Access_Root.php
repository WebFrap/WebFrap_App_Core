 ...
 * @licence WebFrap.net
 */
class CoreNameType_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreNameType_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreNameType_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreNameType_Entity */
      $entity = $orm->get( 'CoreNameType', $rootId );
    }
...
}//end class CoreNameType_Crud_Access_Root
