 ...
 * @licence WebFrap.net
 */
class CoreNameType_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreNameType entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.NameType.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.NameType.insert';
    $params->formId       = 'wgt-form-core_name_type';
    $params->namespace   = 'core_name_type-create';
    ...
    $this->setTemplate( 'core/name_type/modal/crud/form_create' );
...
}//end class CoreNameType_Crud_Create_Modal_View
