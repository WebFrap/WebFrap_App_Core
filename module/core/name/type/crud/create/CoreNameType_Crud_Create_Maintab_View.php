 ...
 * @licence WebFrap.net
 */
class CoreNameType_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreNameType Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_name_type-create' );

    // set the form template
    $this->setTemplate( 'core/name_type/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.NameType.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_name_type';
    ...
    $form = $this->newForm( 'CoreNameType_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.NameType.create');}});
});
...
}//end class CoreNameType_Crud_Create_Maintab_View
