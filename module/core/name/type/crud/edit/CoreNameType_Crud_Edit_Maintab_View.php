 ...
 * @licence WebFrap.net
 */
class CoreNameType_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreNameType Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreNameType = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.NameType.edit&amp;utf8=✓&amp;objid='.$entityCoreNameType
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.NameType.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_name_type-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/name_type/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreNameType_Crud_Edit' );
...
}//end class CoreNameType_Crud_Edit_Maintab_View
