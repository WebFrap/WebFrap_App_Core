...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für name Types
  *
  ...
  *  }
  *
  * @return CoreNameType_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreNameType_Table_Element( 'tableCoreNameType', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_name_type-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'name Types', 'core.name_type.label' );
      //$tabPanel->searchKey = 'core_name_type';
      ...
      $searchElement->searchKey = 'core_name_type';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreNameType_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreNameType', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreNameType listing maske
   *
   * @param CoreNameType_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreNameType  = $model->getEntityCoreNameType();
    ...
    $formCoreNameType->setKeyName( 'core_name_type' );
...
}//end class CoreNameType_Table_Ui
