 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-core_name_type')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityCoreNameType = $orm->get('CoreNameType', $data['wbfsys_group_users']->vid);
      $tabData['core_name_type_name']  = $refEntityCoreNameType->name;

    }
    $tabData['core_name_type_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein CoreNameType_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreNameType_Acl' );
    /* @var $query CoreNameType_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreNameType_Acl_Qfdu_Treetable' );
    /* @var $query CoreNameType_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreNameType_Acl_Qfdu' );
    /* @var $query CoreNameType_Acl_Qfdu_Query  */
...
} // end class CoreNameType_Acl_Qfdu_Model */
