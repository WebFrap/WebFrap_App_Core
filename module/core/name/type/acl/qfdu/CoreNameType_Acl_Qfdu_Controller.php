 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view CoreNameType_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'core_name_type-acl-qfdu-aAjax',
      'CoreNameType_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class CoreNameType_Acl_Qfdu_Controller */
