 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(core_name_type.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    core_name_type.rowid as id,
    core_name_type.name as value,
    core_name_type.name as label
  FROM
    core_name_type
  WHERE
    {$sqlWhere}
...
} // end class CoreNameType_Acl_Qfdu_Query_Postgresql */
