 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'core_name_type.name as "core_name_type_name"',
      'core_name_type.rowid as "core_name_type_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN core_name_type on wbfsys_group_users.vid = core_name_type.rowid'
    );
...
} // end class CoreNameType_Acl_Qfdu_Treetable_Query_Postgresql */
