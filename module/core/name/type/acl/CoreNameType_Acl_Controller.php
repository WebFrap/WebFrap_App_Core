 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management CoreNameType
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new CoreNameType_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('CoreNameType_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model CoreNameType_Acl_Model */
    $model   = $this->loadModel( 'CoreNameType_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'core_name_type_acl_masks_listing',
      'CoreNameType_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'CoreNameType_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'CoreNameType_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model CoreNameType_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'CoreNameType_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model CoreNameType_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'CoreNameType_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_name_type-acl-qfdu',
    	'CoreNameType_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class CoreNameType_Acl_Controller */
