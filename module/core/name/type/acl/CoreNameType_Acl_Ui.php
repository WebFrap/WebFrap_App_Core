...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return CoreNameType_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreNameType_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'core_name_type-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'name Type', 'core.name_type.label' )
      )
    );
    $tabPanel->searchKey  = 'core_name_type_acl';
