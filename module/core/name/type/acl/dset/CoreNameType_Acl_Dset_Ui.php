 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var CoreNameType_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CoreNameType_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityCoreNameType, $areaId, $access, $params  )
  {

    $listObj = new CoreNameType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-core_name_type-acl-dset' );
    ...
    else
    {
      ...
      (
        'name Type "{@label@}" User Access',
        'core.name_type.label',
        array
        (
          'label' => $entityCoreNameType->text()
        )
      );
      $tabPanel->searchKey  = 'core_name_type_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new CoreNameType_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class CoreNameType_Acl_Dset_Ui */
