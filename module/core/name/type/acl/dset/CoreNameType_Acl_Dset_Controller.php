 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model CoreNameType_Acl_Dset_Model  */
    $model = $this->loadModel( 'CoreNameType_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityCoreNameType = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view CoreNameType_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'core_name_type-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityCoreNameType, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view CoreNameType_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'core_name_type-acl-dset', 
    	'CoreNameType_Acl_Dset',
...
} // end class CoreNameType_Acl_Dset_Controller */
