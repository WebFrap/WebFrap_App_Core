 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(core_name_type.name) like upper(\''.$condition['free'].'%\') )
...
} // end class CoreNameType_Acl_Dset_Treetable_Query_Postgresql */
