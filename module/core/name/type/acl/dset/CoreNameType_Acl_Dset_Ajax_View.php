 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'CoreNameType_Acl_Dset' );
    ...
    $entityCoreNameType = $this->model->getEntity( $dsetId );
...
} // end class CoreNameType_Acl_Dset_Ajax_View */
