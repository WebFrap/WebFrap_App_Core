 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-core_name_type'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'CoreNameType', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreNameType_Acl_Dset' );
    /* @var $query CoreNameType_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreNameType_Acl_Dset_Treetable' );
    /* @var $query CoreNameType_Acl_Dset_Treetable_Query  */
...
} // end class CoreNameType_Acl_Dset_Model */
