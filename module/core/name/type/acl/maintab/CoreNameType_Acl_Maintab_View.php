 ...
 * @licence WebFrap.net
 */
class CoreNameType_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.NameType_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_name_type-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Core.NameType_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'core_name_type-acl-update';
    ...
    $this->setTemplate( 'core/name_type/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'name Type', 'core.name_type.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-core_name_type_acl_listing' );
    ...
    $ui = $this->loadUi( 'CoreNameType_Acl' );
...
} // end class CoreNameType_Acl_Maintab_View */
