 ...
 * @licence WebFrap.net
 */
class CoreNameType_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var CoreNameType_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'CoreNameType_Export_Listing_Access';
    ...
    // create a new CoreNameType window
    $view = $this->loadView
    (
    	'export-core_name_type',
    	'CoreNameType_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'CoreNameType_Export' );
...
} // end class CoreNameType_Export_Controller_Genf
