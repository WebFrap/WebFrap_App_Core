 ...
 * @licence WebFrap.net
 */
class CoreNameType_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreNameType_Selection_Model
    */
    public $model = null;

    /**
    * @var CoreNameType_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'core/name_type/modal/selection_table' );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.NameType.filter';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-selection-core_name_type-search';

    // fill the relevant data for the search form
    $this->setSearchFormData( $params );

    $ui = $this->loadUi( 'CoreNameType_Selection' );
...
}//end class CoreNameType_Selection_Modal_View
