 ...
 * @licence WebFrap.net
 */
class CoreNameType_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreNameType_Selection_Query $data
  ...
  *  }
  *
  * @return CoreNameType_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreNameType_Selection_Element
    (
      'selectionCoreNameType',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection name Types', 'core.name_type.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.NameType.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowCoreNameType',
      'CoreNameType_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param CoreNameType_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreNameType_Selection_Ui
