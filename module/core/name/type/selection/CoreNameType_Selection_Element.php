 ...
 * @licence WebFrap.net
 */
class CoreNameType_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_name_type';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.NameType.show&amp;target_mask=CoreNameType&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.NameType.edit&amp;target_mask=CoreNameType&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.name_type.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.NameType.delete&amp;target_mask=CoreNameType&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.name_type.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  {    $iconTdSwitch = $this->icon( 'control/arrow_td_switch.png', 'Sort' );  
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_name_type_name'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.NameType_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected name Types." >{$iconDelete} Delete selected name Types</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! name Types. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.NameType_Multi.deleteAll" >{$iconClean} Delete all name Types</a></li>
  	</ul>
 	</div>
...
}//end class CoreNameType_Selection_Element
