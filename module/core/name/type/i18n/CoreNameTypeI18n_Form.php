...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'core_name_type_i18n';
   ...
   * @var string 
   */
  public $entityName  = 'CoreNameTypeI18n';
   ...
   * @var string 
   */
  public $namespace  = 'CoreNameTypeI18n';
   ...
   * @var string 
   */
  public $prefix      = 'CoreNameTypeI18n';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * create an IO form for the CoreNameTypeI18n entity
  *
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: CoreNameTypeI18n' );
      }
    }
 ...
 /**
  * create a search form for the CoreNameTypeI18n entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function input_id_lang( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'WbfsysLanguage_Entity' ) )
    {
      ...
      (
        ...
        'title'     => $this->view->i18n->l( 'Insert value for Lang (Name Type I18n)', 'core.name_type_i18n.label' ),
      ));
      ...
      $inputIdLang->setLabel( $this->view->i18n->l( 'Lang', 'core.name_type_i18n.label' ) );
 ...
 /**
  * create the ui element for field id_core_name_type
  * @param TFlag $params named parameters
  * @return void
  */
  public function input_id_core_name_type( $params )
  {

    if( !Webfrap::classLoadable( 'CoreNameType_Entity' ) )
    {
      if(DEBUG)
        Debug::console( 'Entity CoreNameType not exists' );

      Log::warn('Looks like the Entity: CoreNameType is missing');
      ...
      //p: Window
      $objidCoreNameType = $this->entity->getData('id_core_name_type') ;

      // entity ids can never be 0 so thats ok
      if
      (
        !$objidCoreNameType
          || !$entityCoreNameType = $this->db->orm->get
          (
            'CoreNameType',
            $objidCoreNameType
          )
      ...
      {
        $entityCoreNameType = $this->db->orm->newEntity( 'CoreNameType' );
      }

      $inputIdCoreNameType = $this->view->newInput( 'input'.$this->prefix.'IdCoreNameType', 'Window' );
      $inputIdCoreNameType->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_core_name_type]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_core_name_type'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Core Name Type (Name Type I18n)', 'core.name_type_i18n.label' ),
      ));

      if( $this->assignedForm )
        $inputIdCoreNameType->assignedForm = $this->assignedForm;

      $inputIdCoreNameType->setWidth( 'medium' );

      $inputIdCoreNameType->setData( $this->entity->getData( 'id_core_name_type' )  );
      $inputIdCoreNameType->setReadOnly( $this->isReadOnly( 'id_core_name_type' ) );
      $inputIdCoreNameType->setLabel( $this->view->i18n->l( 'Core Name Type', 'core.name_type_i18n.label' ) );


      $listUrl = 'modal.php?c=Core.NameType.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_core_name_type'.($this->suffix?'-'.$this->suffix:'');

      $inputIdCoreNameType->setListUrl ( $listUrl );
      $inputIdCoreNameType->setListIcon( 'control/connect.png' );
      $inputIdCoreNameType->setEntityUrl( 'maintab.php?c=Core.NameType.edit' );
      $inputIdCoreNameType->conEntity         = $entityCoreNameType;
      $inputIdCoreNameType->refresh           = $this->refresh;
      $inputIdCoreNameType->serializeElement  = $this->sendElement;
      


      $inputIdCoreNameType->view = $this->view;
      $inputIdCoreNameType->buildJavascript( 'wgt-input-'.$this->keyName.'_id_core_name_type'.($this->suffix?'-'.$this->suffix:'') );
      $this->view->addJsCode( $inputIdCoreNameType );
  ...
  }//end public function input_id_core_name_type */
  ...
  public function input_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Name (Name Type I18n)', 'core.name_type_i18n.label' ),
      ...
      $inputName->setLabel
      (
        $this->view->i18n->l( 'Name', 'core.name_type_i18n.label' ),
  ...
  public function input_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Insert value for Description (Name Type I18n)', 'core.name_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Description', 'core.name_type_i18n.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Name Type I18n)', 'core.name_type_i18n.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'core.name_type_i18n.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Name Type I18n)', 'core.name_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'core.name_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Name Type I18n)', 'core.name_type_i18n.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'core.name_type_i18n.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Name Type I18n)', 'core.name_type_i18n.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'core.name_type_i18n.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Name Type I18n)', 'core.name_type_i18n.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'core.name_type_i18n.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Name Type I18n)', 'core.name_type_i18n.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'core.name_type_i18n.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Name Type I18n)', 'core.name_type_i18n.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'core.name_type_i18n.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search_name( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Search for Name (Name Type I18n)', 'core.name_type_i18n.label' ),
          'maxlength' => $this->entity->maxSize( 'name' ),
        )
      );
      $inputName->setWidth( 'medium' );
  ...
  public function search_description( $params )
  {
      ...
      (
        ...
        (
          ...
          'title' => $this->view->i18n->l( 'Search for Description (Name Type I18n)', 'core.name_type_i18n.label' ),
        )
      );
      $inputDescription->setWidth( 'full' );
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_name_type_i18n_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_name_type_i18n_m_role_change';
...
}//end class CoreNameTypeI18n_Form */
