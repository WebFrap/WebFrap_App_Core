...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: core_currency
  *
  ...
  *
  *   @url maintab.php?c=Core.Currency.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'core_currency-create';

    $access = new CoreCurrency_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-core_currency-create',
      'CoreCurrency_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model CoreCurrency_Crud_Model */
    $model = $this->loadModel( 'CoreCurrency_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Core.Currency.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityCoreCurrency = $model->getEntityCoreCurrency( $objid );
    ...
    if( !$entityCoreCurrency )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Currency', 'core.currency.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityCoreCurrency;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'core_currency:edit';

    $access = new CoreCurrency_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreCurrency );
    ...
    $view = $response->loadView
    (
      'form-core_currency-edit-'.$objid,
      'CoreCurrency_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->maskRoot      = 'core_currency:show';
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: core_currency
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Core.Currency.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-insert';

    $access = new CoreCurrency_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityCoreCurrency = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'core_currency-update-'.$entityCoreCurrency;
      ...
      {
        $access = new CoreCurrency_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityCoreCurrency );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'CoreCurrency';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_core_currency',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model CoreCurrency_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Core.Currency.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityCoreCurrency, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param CoreCurrency_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Core.Currency.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-delete-'.$objid;

    $access = new CoreCurrency_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreCurrency );
    ...
    $error = $model->delete( $entityCoreCurrency, $params );
    ...
    $error = $view->displayDelete( $entityCoreCurrency, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Core.Currency.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Core.Currency.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-listing';
    ...
    $containerClass = 'CoreCurrency_'.$listType.'_Access';
    ...
    /* @var $model CoreCurrency_Table_Model */
    $model = $this->loadModel( 'CoreCurrency_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'core_currency-'.$params->ltype,
          'CoreCurrency',
          'List of Currencys'
        );
  ...
  */
  ...
  /**
   * the default selection for the management  CoreCurrency
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new CoreCurrency_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_core_currency',
      'CoreCurrency_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'CoreCurrency_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Core.Currency.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model CoreCurrency_Selection_Model */
    $model   = $this->loadModel( 'CoreCurrency_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'core_currency-data-'.$objid;
    else
      $params->contextKey = 'core_currency-data';
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityCoreCurrency, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-append-'.$objid;
    ...
    $ui = $this->loadUi( 'CoreCurrency_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new CoreCurrency_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_currency-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'CoreCurrency_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityCoreCurrency, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'core_currency' );
...
} // end class CoreCurrency_Controller */
