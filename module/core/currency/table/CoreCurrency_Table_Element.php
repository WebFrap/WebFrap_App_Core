 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_currency';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreCurrency_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Currency.show&amp;target_mask=CoreCurrency&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.currency.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Currency.edit&amp;target_mask=CoreCurrency&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.currency.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Currency.delete&amp;target_mask=CoreCurrency&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.currency.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'core.currency.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Core.Currency.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_currency_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Currency_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Currencys." >{$iconDelete} Delete selected Currencys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Currencys. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Currency_Multi.deleteAll" >{$iconClean} Delete all Currencys</a></li>
  	</ul>
 	</div>
...
}//end class CoreCurrency_Table_Element
