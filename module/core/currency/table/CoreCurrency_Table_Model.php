 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Table_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $access, $params, $condition = array() )
  {
    ...
    $query = $db->newQuery( 'CoreCurrency_Table' );
		...
		if( $params->dynFilters )
    {
      foreach( $params->dynFilters as $dynFilter  )
      {
        try
        {
          $filter = $db->newFilter
          (
            'CoreCurrency_Table_'.SParserString::subToCamelCase( $dynFilter )
          );
...
}//end class CoreCurrency_Table_Model
