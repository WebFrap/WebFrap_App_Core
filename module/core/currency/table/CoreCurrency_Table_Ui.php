...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Currencys
  *
  ...
  *  }
  *
  * @return CoreCurrency_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCurrency_Table_Element( 'tableCoreCurrency', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_currency-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Currencys', 'core.currency.label' );
      //$tabPanel->searchKey = 'core_currency';
      ...
      $searchElement->searchKey = 'core_currency';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreCurrency_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreCurrency', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreCurrency listing maske
   *
   * @param CoreCurrency_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreCurrency  = $model->getEntityCoreCurrency();
    ...
    $formCoreCurrency->setKeyName( 'core_currency' );
...
}//end class CoreCurrency_Table_Ui
