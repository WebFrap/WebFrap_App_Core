 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreCurrency entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Currency.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Currency.insert';
    $params->formId       = 'wgt-form-core_currency';
    $params->namespace   = 'core_currency-create';
    ...
    $this->setTemplate( 'core/currency/modal/crud/form_create' );
...
}//end class CoreCurrency_Crud_Create_Modal_View
