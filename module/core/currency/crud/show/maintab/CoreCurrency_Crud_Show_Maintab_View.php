 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreCurrency Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCurrency = $this->model->getEntityCoreCurrency();
    ...
    (
      'Show Currency: {@text@}',
      'core.currency.label',
      array( 'text' => $entityCoreCurrency->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Currency.show  &amp;objid='.$entityCoreCurrency
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Currency.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_currency-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/currency/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreCurrency_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Currency.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_currency' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_currency a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Currency.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Currency.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreCurrency_Crud_Show_Maintab_View
