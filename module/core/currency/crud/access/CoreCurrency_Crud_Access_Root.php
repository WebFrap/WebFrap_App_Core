 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreCurrency_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreCurrency_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreCurrency_Entity */
      $entity = $orm->get( 'CoreCurrency', $rootId );
    }
...
}//end class CoreCurrency_Crud_Access_Root
