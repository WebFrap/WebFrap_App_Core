 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreCurrency Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCurrency = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Currency.edit&amp;utf8=✓&amp;objid='.$entityCoreCurrency
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Currency.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_currency-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/currency/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreCurrency_Crud_Edit' );
...
}//end class CoreCurrency_Crud_Edit_Maintab_View
