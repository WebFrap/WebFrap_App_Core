 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_currency';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Currency.show&amp;target_mask=CoreCurrency&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'core.currency.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Currency.edit&amp;target_mask=CoreCurrency&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.currency.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Currency.delete&amp;target_mask=CoreCurrency&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.currency.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_currency_name'])).'</td>'.NL;
...
}//end class CoreCurrency_Selection_Element
