 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreCurrency_Selection_Query $data
  ...
  *  }
  *
  * @return CoreCurrency_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCurrency_Selection_Element
    (
      'selectionCoreCurrency',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Currencys', 'core.currency.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Currency.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    (
      'tabRowCoreCurrency',
      'CoreCurrency_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param CoreCurrency_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCurrency_Selection_Ui
