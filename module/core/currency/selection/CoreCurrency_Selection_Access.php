 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Selection_Access
  extends LibAclPermissionList
{
  ...
  /**
   * @param CoreCurrency_Selection_Query $query
  ...
  public function fetchListSelectionDefault( $query, $condition, $params )
  {
    ...
    $criteria->select( array( 'core_currency.rowid as rowid' )  );
      ...
      " {$joinType} JOIN
        ...
        ON
          UPPER(acls.\"acl-area\") IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
            ...
            AND acls.\"acl-vid\" = core_currency.rowid ",
      'acls'
    );
...
}//end class CoreCurrency_Selection_Access
