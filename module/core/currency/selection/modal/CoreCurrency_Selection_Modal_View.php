 ...
 * @licence WebFrap.net
 */
class CoreCurrency_Selection_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreCurrency_Selection_Model
    */
    public $model = null;

    /**
    * @var CoreCurrency_Selection_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displaySelection( $params )
  {
    ...
    $this->setTemplate( 'core/currency/modal/selection_table' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Currency', 'core.currency.label' )
      )
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.Currency.filter';
...
}//end class CoreCurrency_Selection_Modal_View
