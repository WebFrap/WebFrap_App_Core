...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_city';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreCity_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.City.show&amp;target_mask=CoreCity&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.city.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.City.edit&amp;target_mask=CoreCity&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.city.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.City.delete&amp;target_mask=CoreCity&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.city.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'core.city.label' ).'</th>'.NL;
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Postalcode', 'core.city.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Core.City.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_city_name'])).'</a></td>'.NL;

      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_city_postalcode'])).'</td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.City_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Citys." >{$iconDelete} Delete selected Citys</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Citys. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.City_Multi.deleteAll" >{$iconClean} Delete all Citys</a></li>
  	</ul>
 	</div>
...
}//end class CoreCity_Table_Element
