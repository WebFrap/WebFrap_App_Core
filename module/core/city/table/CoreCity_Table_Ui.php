...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Citys
  *
  ...
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCity_Table_Element( 'tableCoreCity', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_city-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Citys', 'core.city.label' );
      //$tabPanel->searchKey = 'core_city';
      ...
      $searchElement->searchKey = 'core_city';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreCity_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreCity', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreCity listing maske
   *
   * @param CoreCity_Table_Model $model
   * @param TFlag $params
   * @return void
   */
