...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreCity_Selection_Query $data
  ...
  *  }
  *
  * @return CoreCity_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreCity_Selection_Element
    (
      'selectionCoreCity',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Citys', 'core.city.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.City.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param CoreCity_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreCity_Selection_Ui
