 ...
 * @licence WebFrap.net
 */
class CoreCity_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_city';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.City.show&amp;target_mask=CoreCity&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'core.city.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.City.edit&amp;target_mask=CoreCity&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.city.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.City.delete&amp;target_mask=CoreCity&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.city.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_city_name'])).'</td>'.NL;
...
}//end class CoreCity_Selection_Element
