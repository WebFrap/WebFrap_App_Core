 ...
 * @licence WebFrap.net
 */
class CoreCity_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreCity_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CoreCity_Entity */
      $entity = $orm->get( 'CoreCity', $rootId );
    }
...
}//end class CoreCity_Crud_Access_Root
