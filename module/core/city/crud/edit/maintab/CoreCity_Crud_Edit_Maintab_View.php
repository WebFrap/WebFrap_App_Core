 ...
 * @licence WebFrap.net
 */
class CoreCity_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreCity Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCity = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.City.edit&amp;utf8=✓&amp;objid='.$entityCoreCity
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.City.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_city-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/city/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreCity_Crud_Edit' );
...
}//end class CoreCity_Crud_Edit_Maintab_View
