 ...
 * @licence WebFrap.net
 */
class CoreCity_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreCity Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreCity = $this->model->getEntityCoreCity();
    ...
    (
      'Show City: {@text@}',
      'core.city.label',
      array( 'text' => $entityCoreCity->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.City.show  &amp;objid='.$entityCoreCity
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.City.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_city-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/city/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreCity_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.City.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_city' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_city a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.City.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.City.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreCity_Crud_Show_Maintab_View
