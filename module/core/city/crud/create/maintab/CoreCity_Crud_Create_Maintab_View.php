 ...
 * @licence WebFrap.net
 */
class CoreCity_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreCity Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_city-create' );

    // set the form template
    $this->setTemplate( 'core/city/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.City.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_city';
    ...
    $form = $this->newForm( 'CoreCity_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.City.create');}});
});
...
}//end class CoreCity_Crud_Create_Maintab_View
