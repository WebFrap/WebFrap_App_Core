 ...
 * @licence WebFrap.net
 */
class CoreCity_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreCity entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Core.City.insert';
    $params->formId       = 'wgt-form-core_city';
    $params->namespace   = 'core_city-create';
    ...
    $this->setTemplate( 'core/city/modal/crud/form_create' );
...
}//end class CoreCity_Crud_Create_Modal_View
