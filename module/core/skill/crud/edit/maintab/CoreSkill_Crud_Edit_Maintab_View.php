 ...
 * @licence WebFrap.net
 */
class CoreSkill_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreSkill Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreSkill = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Skill.edit&amp;utf8=✓&amp;objid='.$entityCoreSkill
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Skill.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_skill-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/skill/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreSkill_Crud_Edit' );
...
}//end class CoreSkill_Crud_Edit_Maintab_View
