 ...
 * @licence WebFrap.net
 */
class CoreSkill_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreSkill Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_skill-create' );

    // set the form template
    $this->setTemplate( 'core/skill/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.Skill.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_skill';
    ...
    $form = $this->newForm( 'CoreSkill_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.Skill.create');}});
});
...
}//end class CoreSkill_Crud_Create_Maintab_View
