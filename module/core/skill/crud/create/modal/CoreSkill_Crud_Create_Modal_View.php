 ...
 * @licence WebFrap.net
 */
class CoreSkill_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreSkill entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    $params->formAction  = 'ajax.php?c=Core.Skill.insert';
    $params->formId       = 'wgt-form-core_skill';
    $params->namespace   = 'core_skill-create';
    ...
    $this->setTemplate( 'core/skill/modal/crud/form_create' );
...
}//end class CoreSkill_Crud_Create_Modal_View
