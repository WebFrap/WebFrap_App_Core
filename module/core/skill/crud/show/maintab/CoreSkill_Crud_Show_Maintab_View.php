 ...
 * @licence WebFrap.net
 */
class CoreSkill_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreSkill Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreSkill = $this->model->getEntityCoreSkill();
    ...
    (
      'Show Skill: {@text@}',
      'core.skill.label',
      array( 'text' => $entityCoreSkill->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Skill.show  &amp;objid='.$entityCoreSkill
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Skill.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_skill-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/skill/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreSkill_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Skill.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_skill' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_skill a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Skill.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Skill.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreSkill_Crud_Show_Maintab_View
