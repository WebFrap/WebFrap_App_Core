 ...
 * @licence WebFrap.net
 */
class CoreSkill_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreSkill_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CoreSkill_Entity */
      $entity = $orm->get( 'CoreSkill', $rootId );
    }
...
}//end class CoreSkill_Crud_Access_Root
