 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Form
  extends WgtForm
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string 
   */
  public $keyName     = 'core_skill_requirement';
   ...
   * @var string 
   */
  public $entityName  = 'CoreSkillRequirement';
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createForm( $entity, $fields = array(), $params = null  )
  {
    ...
    foreach( $fields as $key )
    {
      ...
      {
        if(DEBUG)
          Debug::console( 'Call to nonexisting method: '.$method.' in Form: CoreSkillRequirement' );
      }
    }
 ...
 /**
  * create a search form for the CoreSkillRequirement entity
  *
  * @param Entity $entity
  * @param array $fields
  * @param TFlag $params
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @return void
  */
  public function input_id_skill( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CoreSkill_Entity' ) )
    {
      ...
      $inputIdSkill = $this->view->newInput( 'input'.$this->prefix.'IdSkill', 'Window' );
      $inputIdSkill->addAttributes(array
      (
        'readonly'  => 'readonly',
        'name'      => $this->keyName.'[id_skill]',
        'id'        => 'wgt-input-'.$this->keyName.'_id_skill'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Skill (Skill Requirement)', 'core.skill_requirement.label' ),
      ));
      ...
      $inputIdSkill->setReadOnly( $this->isReadOnly( 'id_skill' ) );
      $inputIdSkill->setLabel( $this->view->i18n->l( 'Skill', 'core.skill_requirement.label' ) );


      $listUrl = 'modal.php?c=Core.Skill.selection'
        .'&amp;suffix='.$this->suffix.'&amp;input='.$this->keyName.'_id_skill'.($this->suffix?'-'.$this->suffix:'');
      ...
      $inputIdSkill->buildJavascript( 'wgt-input-'.$this->keyName.'_id_skill'.($this->suffix?'-'.$this->suffix:'') );
  ...
  }//end public function input_id_skill */
  ...
  public function input_vid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for VID (Skill Requirement)', 'core.skill_requirement.label' ),
  ...
  public function input_rate( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rating (Skill Requirement)', 'core.skill_requirement.label' ),
        )
      );
      ...
      $inputRate->setLabel
      (
        $this->view->i18n->l( 'Rating', 'core.skill_requirement.label' ),
  ...
  public function input_id_vid_entity( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Entity (Skill Requirement)', 'core.skill_requirement.label' ),
  ...
  public function input_rowid( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Rowid (Skill Requirement)', 'core.skill_requirement.label' ),
        )
      );
      ...
      $inputRowid->setLabel
      (
        $this->view->i18n->l( 'Rowid', 'core.skill_requirement.label' ),
  ...
  public function input_m_time_created( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Time Created (Skill Requirement)', 'core.skill_requirement.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Created', 'core.skill_requirement.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_create'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Create (Skill Requirement)', 'core.skill_requirement.label' ),
      ));
      ...
      $inputMRoleCreate->setLabel( $this->view->i18n->l( 'Role Create', 'core.skill_requirement.label' ) );
  ...
  public function input_m_time_changed( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip small'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Time Changed (Skill Requirement)', 'core.skill_requirement.label' ),
      ...
      (
        $this->view->i18n->l( 'Time Changed', 'core.skill_requirement.label' ),
    ...
    if( !Webfrap::classLoadable( 'WbfsysRoleUser_Entity' ) )
    {
      ...
      (
        ...
        'id'        => 'wgt-input-'.$this->keyName.'_m_role_change'.($this->suffix?'-'.$this->suffix:''),
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
        'title'     => $this->view->i18n->l( 'Insert value for Role Change (Skill Requirement)', 'core.skill_requirement.label' ),
      ));
      ...
      $inputMRoleChange->setLabel( $this->view->i18n->l( 'Role Change', 'core.skill_requirement.label' ) );
  ...
  public function input_m_version( $params )
  {
      ...
      (
        ...
        (
          ...
          'title'     => $this->view->i18n->l( 'Insert value for Version (Skill Requirement)', 'core.skill_requirement.label' ),
        )
      );
      ...
      (
        $this->view->i18n->l( 'Version', 'core.skill_requirement.label' ),
  ...
  public function input_m_uuid( $params )
  {
      ...
      (
        ...
        (
          ...
          'class'     => 'wcm wcm_ui_tip medium'.($this->assignedForm?' asgd-'.$this->assignedForm:''),
          'title'     => $this->view->i18n->l( 'Insert value for Uuid (Skill Requirement)', 'core.skill_requirement.label' ),
        )
      );
      ...
      $inputMUuid->setLabel
      (
        $this->view->i18n->l( 'Uuid', 'core.skill_requirement.label' ),
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function search_m_role_create( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_skill_requirement_m_role_create';
  ...
  */
  public function search_m_role_change( $params )
  {
    ...
    $listUrl = 'modal.php?c=Wbfsys.RoleUser.selection&amp;target=core_skill_requirement_m_role_change';
...
}//end class CoreSkillRequirement_Form */
