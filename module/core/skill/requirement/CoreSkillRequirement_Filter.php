 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Filter
...
////////////////////////////////////////////////////////////////////////////////
  ...
  JOIN
    ...
    ON
      filter_area_{$key}."acl-area" IN( UPPER('mod-core'), UPPER('mod-core-cat-core_data') )
        AND filter_area_{$key}."acl-user" = {$user->getId()}
        AND filter_area_{$key}."acl-vid" = core_skill_requirement.{$fieldName}
...
}//end class CoreSkillRequirement_Filter
