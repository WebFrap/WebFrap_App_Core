 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreSkillRequirement_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreSkillRequirement_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreSkillRequirement_Entity */
      $entity = $orm->get( 'CoreSkillRequirement', $rootId );
    }
...
}//end class CoreSkillRequirement_Crud_Access_Root
