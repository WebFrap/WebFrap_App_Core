 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Crud_Create_Form
  extends WgtCrudForm
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
  ...
  */
  public function input_CoreSkillRequirement_IdSkill( $params )
  {
    ...
    if( !Webfrap::classLoadable( 'CoreSkill_Entity' ) )
    {
      ...
      $listUrl = 'modal.php?c=Core.Skill.selection&amp;context=create'
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function fetchDefaultData( $request )
  {
    ...
    (
      $orm->getValidationData( 'CoreSkillRequirement', array_keys( $this->fields['core_skill_requirement']), true ),
...
}//end class CoreSkillRequirement_Crud_Create_Form */
