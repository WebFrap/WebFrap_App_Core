 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreSkillRequirement entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.SkillRequirement.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.SkillRequirement.insert';
    $params->formId       = 'wgt-form-core_skill_requirement';
    $params->namespace   = 'core_skill_requirement-create';
    ...
    $this->setTemplate( 'core/skill_requirement/modal/crud/form_create' );
...
}//end class CoreSkillRequirement_Crud_Create_Modal_View
