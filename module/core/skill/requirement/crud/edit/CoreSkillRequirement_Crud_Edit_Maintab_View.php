 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreSkillRequirement Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreSkillRequirement = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Skill Requirement: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.SkillRequirement.edit&amp;utf8=✓&amp;objid='.$entityCoreSkillRequirement
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.SkillRequirement.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_skill_requirement-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/skill_requirement/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreSkillRequirement_Crud_Edit' );
...
}//end class CoreSkillRequirement_Crud_Edit_Maintab_View
