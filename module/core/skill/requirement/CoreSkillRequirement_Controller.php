 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: core_skill_requirement
  *
  ...
  *
  *   @url maintab.php?c=Core.SkillRequirement.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'core_skill_requirement-create';

    $access = new CoreSkillRequirement_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-core_skill_requirement-create',
      'CoreSkillRequirement_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model CoreSkillRequirement_Crud_Model */
    $model = $this->loadModel( 'CoreSkillRequirement_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Core.SkillRequirement.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    if( !$entityCoreSkillRequirement )
    {
      ...
      (
        ...
        (
          ...
          array
          (
            'resource'  => $response->i18n->l( 'Skill Requirement', 'core.skill_requirement.label' ),
            'id'        => $objid
          )
        ),
        Response::NOT_FOUND
    ...
    $params->entity = $entityCoreSkillRequirement;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'core_skill_requirement:edit';

    $access = new CoreSkillRequirement_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreSkillRequirement );
    ...
    $view = $response->loadView
    (
      'form-core_skill_requirement-edit-'.$objid,
      'CoreSkillRequirement_Crud_Edit',
      'displayForm',
      null,
      true
    );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mod-core-cat-core_data';
      $params->maskRoot      = 'core_skill_requirement:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mod-core-cat-core_data';
      $params->aclNode       = 'mod-core-cat-core_data';
      $params->aclLevel      = 1;
    }
    ...
    if( $params->isAclRoot )
    {
      ...
      (
        'mod-core>mod-core-cat-core_data',
    ...
    (
      'form-core_skill_requirement-edit-'.$objid,
      'CoreSkillRequirement_Crud_Show',
      'displayForm',
      null,
      true
    );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: core_skill_requirement
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Core.SkillRequirement.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-insert';

    $access = new CoreSkillRequirement_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityCoreSkillRequirement = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'core_skill_requirement-update-'.$entityCoreSkillRequirement;
      ...
      {
        $access = new CoreSkillRequirement_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityCoreSkillRequirement );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'CoreSkillRequirement';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_core_skill_requirement',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model CoreSkillRequirement_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Core.SkillRequirement.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityCoreSkillRequirement, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param CoreSkillRequirement_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Core.SkillRequirement.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-delete-'.$objid;

    $access = new CoreSkillRequirement_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreSkillRequirement );
    ...
    $error = $model->delete( $entityCoreSkillRequirement, $params );
    ...
    $error = $view->displayDelete( $entityCoreSkillRequirement, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Core.SkillRequirement.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Core.SkillRequirement.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-listing';
    ...
    $containerClass = 'CoreSkillRequirement_'.$listType.'_Access';
    ...
    (
      'listing_core_skill_requirement',
      'CoreSkillRequirement_'.$listType,
      'displayListing',
      null,
      true
    );
    ...
    /* @var $model CoreSkillRequirement_Table_Model */
    $model = $this->loadModel( 'CoreSkillRequirement_'.$listType );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  */
  ...
  /**
   * the default selection for the management  CoreSkillRequirement
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new CoreSkillRequirement_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_core_skill_requirement',
      'CoreSkillRequirement_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'CoreSkillRequirement_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Core.SkillRequirement.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model CoreSkillRequirement_Selection_Model */
    $model   = $this->loadModel( 'CoreSkillRequirement_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'core_skill_requirement-data-'.$objid;
    else
      $params->contextKey = 'core_skill_requirement-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-core_skill_requirement',
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityCoreSkillRequirement, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-append-'.$objid;
    ...
    $ui = $this->loadUi( 'CoreSkillRequirement_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new CoreSkillRequirement_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_skill_requirement-text_by_key_'.$objid;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'core_skill_requirement' );
...
} // end class CoreSkillRequirement_Controller */
