 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Skill Requirements
  *
  ...
  *  }
  *
  * @return CoreSkillRequirement_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreSkillRequirement_Table_Element( 'tableCoreSkillRequirement', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_skill_requirement-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Skill Requirements', 'core.skill_requirement.label' );
      //$tabPanel->searchKey = 'core_skill_requirement';
      ...
      $searchElement->searchKey = 'core_skill_requirement';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreSkillRequirement_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreSkillRequirement', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreSkillRequirement listing maske
   *
   * @param CoreSkillRequirement_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreSkillRequirement  = $model->getEntityCoreSkillRequirement();
    ...
    $formCoreSkillRequirement->setKeyName( 'core_skill_requirement' );
...
}//end class CoreSkillRequirement_Table_Ui
