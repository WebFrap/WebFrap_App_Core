 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_skill_requirement';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreSkillRequirement_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.SkillRequirement.show&amp;target_mask=CoreSkillRequirement&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.SkillRequirement.edit&amp;target_mask=CoreSkillRequirement&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.skill_requirement.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.SkillRequirement.delete&amp;target_mask=CoreSkillRequirement&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.skill_requirement.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['core_skill_requirement_rowid'];
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.SkillRequirement_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Skill Requirements." >{$iconDelete} Delete selected Skill Requirements</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Skill Requirements. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.SkillRequirement_Multi.deleteAll" >{$iconClean} Delete all Skill Requirements</a></li>
  	</ul>
 	</div>
...
}//end class CoreSkillRequirement_Table_Element
