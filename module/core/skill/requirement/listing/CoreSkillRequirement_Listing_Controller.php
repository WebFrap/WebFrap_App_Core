 ...
 * @licence WebFrap.net
 */
class CoreSkillRequirement_Listing_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'CoreSkillRequirement_'.$listType ) );
...
} // end class CoreSkillRequirement_Listing_Controller */
