 ...
 *
 * Entity Class for the Database Table core_skill
 * 
 * @package WebFrap
 * @subpackage ModCore
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'core_skill';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Core.Skill.show';
  ...
  */
  public static $entityName  = 'CoreSkill';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'core.skill.message.error_def_name',
      'wrong'   => 'core.skill.message.error_wrong_name',
      'empty'   => 'core.skill.message.error_empty_name',
      'max'     => 'core.skill.message.error_max_name',
      'min'     => 'core.skill.message.error_min_name',
    ),

    'access_key' => array
    (
      'default' => 'core.skill.message.error_def_access_key',
      'wrong'   => 'core.skill.message.error_wrong_access_key',
      'max'     => 'core.skill.message.error_max_access_key',
      'min'     => 'core.skill.message.error_min_access_key',
    ),

    'description' => array
    (
      'default' => 'core.skill.message.error_def_description',
      'wrong'   => 'core.skill.message.error_wrong_description',
      'max'     => 'core.skill.message.error_max_description',
      'min'     => 'core.skill.message.error_min_description',
    ),

    'rowid' => array
    (
      'default' => 'core.skill.message.error_def_rowid',
      'wrong'   => 'core.skill.message.error_wrong_rowid',
      'empty'   => 'core.skill.message.error_empty_rowid',
      'max'     => 'core.skill.message.error_max_rowid',
      'min'     => 'core.skill.message.error_min_rowid',
    ),
  );

}//end class CoreSkill_Entity
