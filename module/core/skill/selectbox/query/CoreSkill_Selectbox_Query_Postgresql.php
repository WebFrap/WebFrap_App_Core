 ...
 * @licence WebFrap.net
 */
class CoreSkill_Selectbox_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Fetch method for the CoreSkill Selectbox
   * @return void
   */
  public function fetchSelectbox( )
  {
    ...
    (
      'DISTINCT core_skill.rowid as id',
      'core_skill.name as value'
     ));
  ...
  public function fetchSelectboxEntry( $entryId )
  {
    ...
    $criteria->where( "core_skill.rowid = '{$entryId}'"  );
  ...
  public function fetchSelectboxEntries( $entryIds )
  {
    ...
    $criteria->where( "core_skill.rowid IN ( '".implode("', '", $entryIds )."' )"  );

    return $db->orm->select( $criteria )->getAll();

  }//end public function fetchSelectboxEntries */
  
}//end class CoreSkill_Selectbox_Query_Postgresql
