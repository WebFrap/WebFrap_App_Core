...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_skill';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreSkill_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Skill.show&amp;target_mask=CoreSkill&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
        'core.skill.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Skill.edit&amp;target_mask=CoreSkill&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.skill.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Skill.delete&amp;target_mask=CoreSkill&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.skill.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'core.skill.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Core.Skill.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_skill_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Skill_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Skills." >{$iconDelete} Delete selected Skills</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Skills. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Skill_Multi.deleteAll" >{$iconClean} Delete all Skills</a></li>
  	</ul>
 	</div>
...
}//end class CoreSkill_Table_Element
