...
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Skills
  *
  ...
  *  }
  *
  * @return CoreSkill_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreSkill_Table_Element( 'tableCoreSkill', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_skill-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Skills', 'core.skill.label' );
      //$tabPanel->searchKey = 'core_skill';
      ...
      $searchElement->searchKey = 'core_skill';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreSkill_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreSkill', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreSkill listing maske
   *
   * @param CoreSkill_Table_Model $model
   * @param TFlag $params
   * @return void
   */
