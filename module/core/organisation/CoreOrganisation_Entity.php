 ...
 *
 * Entity Class for the Database Table core_organisation
 * 
 * @package WebFrap
 * @subpackage ModCore
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @var string $table
  */
  public static $table     = 'core_organisation';
  ...
  * @var string $tablePk
  */
  public static $toUrl     = 'index.php?c=Core.Organisation.show';
  ...
  */
  public static $entityName  = 'CoreOrganisation';
  ...
  */
  ...
  (
    'name' => array
    (
      'default' => 'core.organisation.message.error_def_name',
      'wrong'   => 'core.organisation.message.error_wrong_name',
      'max'     => 'core.organisation.message.error_max_name',
      'min'     => 'core.organisation.message.error_min_name',
    ),

    'comment' => array
    (
      'default' => 'core.organisation.message.error_def_comment',
      'wrong'   => 'core.organisation.message.error_wrong_comment',
      'max'     => 'core.organisation.message.error_max_comment',
      'min'     => 'core.organisation.message.error_min_comment',
    ),

    'rowid' => array
    (
      'default' => 'core.organisation.message.error_def_rowid',
      'wrong'   => 'core.organisation.message.error_wrong_rowid',
      'empty'   => 'core.organisation.message.error_empty_rowid',
      'max'     => 'core.organisation.message.error_max_rowid',
      'min'     => 'core.organisation.message.error_min_rowid',
    ),
  );

}//end class CoreOrganisation_Entity
