 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var CoreOrganisation_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'CoreOrganisation_Export_Listing_Access';
    ...
    // create a new CoreOrganisation window
    $view = $this->loadView
    (
    	'export-core_organisation',
    	'CoreOrganisation_Export',
    	'renderExport'
    	
    );
    
    $model = $this->loadModel( 'CoreOrganisation_Export' );
...
} // end class CoreOrganisation_Export_Controller_Genf
