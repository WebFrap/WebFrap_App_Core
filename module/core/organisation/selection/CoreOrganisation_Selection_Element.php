 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_organisation';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Organisation.show&amp;target_mask=CoreOrganisation&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Organisation.edit&amp;target_mask=CoreOrganisation&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.organisation.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Organisation.delete&amp;target_mask=CoreOrganisation&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.organisation.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_organisation_name'])).'</td>'.NL;
...
}//end class CoreOrganisation_Selection_Element
