 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Selection_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// selection methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CoreOrganisation_Selection_Query $data
  ...
  *  }
  *
  * @return CoreOrganisation_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreOrganisation_Selection_Element
    (
      'selectionCoreOrganisation',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Organisations', 'core.organisation.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Organisation.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = $view->newItem
    (
      'tabRowCoreOrganisation',
      'CoreOrganisation_Selection_Element'
    );
...
WGTJS;
   ...
   *
   * @param CoreOrganisation_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CoreOrganisation_Selection_Ui
