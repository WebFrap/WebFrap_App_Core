 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Table_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreOrganisation_Table_Model
    */
    public $model = null;

    /**
    * @var CoreOrganisation_Table_Ui
    */
    public $ui = null;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayListing( $params )
  {
    ...
    $this->setTemplate( 'core/organisation/maintab/table/listing_table' );
    ...
    (
      $i18nText,
      'maintab.php?c=Core.Organisation.listing&amp;ltype=table'
    );
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.Organisation.search';
...
BUTTONJS;
    ...
    $ui = $this->loadUi( 'CoreOrganisation_Table' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_view_table").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Core.Organisation.listing&amp;ltype=table');
    });

    self.getObject().find(".wgtac_view_treetable").click(function(){
      \$S('#{$this->id}_dropmenu-control').dropdown('remove');
      self.close();
      \$R.get('maintab.php?c=Core.Organisation.listing&amp;ltype=treetable');
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_new").click(function(){
       ...
       \$R.get('maintab.php?c=Core.Organisation.create&amp;ltype=table');
    });
...
}//end class CoreOrganisation_Table_Maintab_View
