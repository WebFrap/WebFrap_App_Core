 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Table_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_table-core_organisation';
  
  /**
   * the most likley class of a given query object
   *
   * @var CoreOrganisation_Table_Query
   */
  public $data = null;
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Organisation.show&amp;target_mask=CoreOrganisation&amp;ltype=table&amp;objid=',
        'control/show.png',
        '',
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Organisation.edit&amp;target_mask=CoreOrganisation&amp;ltype=table&amp;objid=',
        'control/edit.png',
        '',
        'core.organisation.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Organisation.delete&amp;target_mask=CoreOrganisation&amp;ltype=table&amp;objid=',
        'control/delete.png',
        '',
        'core.organisation.label',
        Acl::DELETE
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Rights',
        'maintab.php?c=Acl.Mgmt_Dset.listing&amp;dkey=core_organisation&amp;objid=',
        'control/rights.png',
        '',
        'core.organisation.label',
        Acl::ADMIN
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:200px" >'.$this->view->i18n->l( 'Name', 'core.organisation.label' ).'</th>'.NL;
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row )
    {
      ...
      $objid       = $row['core_organisation_rowid'];
      ...
      $body .= '<td valign="top" ><a class="wcm wcm_req_mtab" title="Click to open" href="maintab.php?c=Core.Organisation.'.$accessActionKey.'&amp;objid='.$objid.'&amp;target_id='.$this->id.'" >'.nl2br(Validator::sanitizeHtml($row['core_organisation_name'])).'</a></td>'.NL;
  ...
  <div class="wgt-dropdownbox" id="{$this->id}-list-action-menu" >
    ...
    <ul>
      <li><a
      	...
      	href="ajax.php?c=Core.Organisation_Multi.deleteSelection"
      	wgt_elem="table#{$this->id}-table"
      	title="Please confirm that you want to delete the selected Organisations." >{$iconDelete} Delete selected Organisations</a></li>
      <li><a 
      	class="wcm wcm_req_del"
      	title="You are going to delete ALL! Organisations. Please confirm that you really want to do that."
      	href="ajax.php?c=Core.Organisation_Multi.deleteAll" >{$iconClean} Delete all Organisations</a></li>
  	</ul>
 	</div>
...
}//end class CoreOrganisation_Table_Element
