 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Table_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Listing Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  * de:
  *
  * Konfiguration eines Listenelements mit Suche für Organisations
  *
  ...
  *  }
  *
  * @return CoreOrganisation_Table_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreOrganisation_Table_Element( 'tableCoreOrganisation', $view );
    ...
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_organisation-search';
    ...
    if( 'ajax' != $view->type )
    {
      ...
      //$tabPanel->title = $view->i18n->l( 'Organisations', 'core.organisation.label' );
      //$tabPanel->searchKey = 'core_organisation';
      ...
      $searchElement->searchKey = 'core_organisation';
...
WGTJS;
  ...
  */
  public function listEntry( $access, $params, $insert = false  )
  {
    ...
    $table = new CoreOrganisation_Table_Element( null,$view );
    ...
    if( !$params->noParse )
      $view->setAreaContent( 'tabRowCoreOrganisation', $table->buildAjax() );
...
JSCODE;
   ...
   * die CoreOrganisation listing maske
   *
   * @param CoreOrganisation_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm( $model, $params = null )
  {
    ...
    $entityCoreOrganisation  = $model->getEntityCoreOrganisation();
    ...
    $formCoreOrganisation->setKeyName( 'core_organisation' );
...
}//end class CoreOrganisation_Table_Ui
