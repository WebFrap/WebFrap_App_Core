 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
    * @var CoreOrganisation_Crud_Model
    */
    public $model = null;
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CoreOrganisation Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreOrganisation = $this->model->getEntityCoreOrganisation();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Show Organisation: {@text@}',
      'core.organisation.label',
      array( 'text' => $entityCoreOrganisation->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Organisation.show  &amp;objid='.$entityCoreOrganisation
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Organisation.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_organisation-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/organisation/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CoreOrganisation_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Organisation.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_organisation' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_organisation a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Organisation.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Organisation.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CoreOrganisation_Crud_Show_Maintab_View
