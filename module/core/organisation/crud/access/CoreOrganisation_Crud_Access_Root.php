 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CoreOrganisation_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    if( is_object($rootNode) ) 
    {
      /* @var $entity CoreOrganisation_Entity */
      $entity = $rootNode;
    }
    else 
    {
      ...
      /* @var $entity CoreOrganisation_Entity */
      $entity = $orm->get( 'CoreOrganisation', $rootId );
    }
...
}//end class CoreOrganisation_Crud_Access_Root
