 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CoreOrganisation Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCoreOrganisation = $this->model->getEntity();

    // fetch the i18n text for title, status and bookmark
    $i18nTitle = $this->i18n->l
    (
      'Edit Organisation: {@text@}',
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Organisation.edit&amp;utf8=✓&amp;objid='.$entityCoreOrganisation
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Organisation.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_organisation-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/organisation/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CoreOrganisation_Crud_Edit' );
...
}//end class CoreOrganisation_Crud_Edit_Maintab_View
