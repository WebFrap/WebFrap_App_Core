 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CoreOrganisation entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Organisation.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Organisation.insert';
    $params->formId       = 'wgt-form-core_organisation';
    $params->namespace   = 'core_organisation-create';
    ...
    $this->setTemplate( 'core/organisation/modal/crud/form_create' );
...
}//end class CoreOrganisation_Crud_Create_Modal_View
