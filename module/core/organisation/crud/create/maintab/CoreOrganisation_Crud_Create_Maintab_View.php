 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Crud_Create_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Methode zum befüllen des CoreOrganisation Create Forms
  * mit Inputelementen
  *
  ...
  */
  public function displayForm( $params )
  {
    ...
    //$this->setTabId( 'wgt-tab-form-core_organisation-create' );

    // set the form template
    $this->setTemplate( 'core/organisation/maintab/crud/form_create' );
    ...
    $params->formAction  = 'ajax.php?c=Core.Organisation.insert&amp;utf8=✓';
    $params->formId       = 'wgt-form-core_organisation';
    ...
    $form = $this->newForm( 'CoreOrganisation_Crud_Create' );
...
self.getObject().find(".wgtac_create_a_next").click(function(){
  \$S('#{$this->id}_dropmenu-control').dropdown('remove');
  self.setChanged( false );
  \$R.form('{$params->formId}','&open=next',{append:true,success:function(){self.close();\$R.get('maintab.php?c=Core.Organisation.create');}});
});
...
}//end class CoreOrganisation_Crud_Create_Maintab_View
