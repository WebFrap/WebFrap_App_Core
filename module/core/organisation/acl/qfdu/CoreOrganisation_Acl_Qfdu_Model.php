 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-core_organisation')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityCoreOrganisation = $orm->get('CoreOrganisation', $data['wbfsys_group_users']->vid);
      $tabData['core_organisation_name']  = $refEntityCoreOrganisation->name;

    }
    $tabData['core_organisation_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein CoreOrganisation_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreOrganisation_Acl' );
    /* @var $query CoreOrganisation_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreOrganisation_Acl_Qfdu_Treetable' );
    /* @var $query CoreOrganisation_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreOrganisation_Acl_Qfdu' );
    /* @var $query CoreOrganisation_Acl_Qfdu_Query  */
...
} // end class CoreOrganisation_Acl_Qfdu_Model */
