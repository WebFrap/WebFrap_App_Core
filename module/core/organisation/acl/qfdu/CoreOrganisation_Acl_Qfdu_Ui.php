 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Qfdu_Ui
  extends Ui
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var CoreOrganisation_Acl_Qfdu_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CoreOrganisation_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new CoreOrganisation_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Organisation',
        'core.organisation.label'
      );
      $tabPanel->searchKey  = 'core_organisation_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new CoreOrganisation_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class CoreOrganisation_Acl_Qfdu_Ui */
