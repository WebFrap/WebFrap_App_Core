 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(core_organisation.name) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    core_organisation.rowid as id,
    core_organisation.name as value,
    core_organisation.name as label
  FROM
    core_organisation
  WHERE
    {$sqlWhere}
...
} // end class CoreOrganisation_Acl_Qfdu_Query_Postgresql */
