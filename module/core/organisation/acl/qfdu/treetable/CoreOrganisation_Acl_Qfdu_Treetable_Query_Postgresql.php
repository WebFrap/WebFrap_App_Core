 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /** inject the requested cols in the criteria
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'core_organisation.name as "core_organisation_name"',
      'core_organisation.rowid as "core_organisation_rowid"',
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN core_organisation on wbfsys_group_users.vid = core_organisation.rowid'
    );
...
} // end class CoreOrganisation_Acl_Qfdu_Treetable_Query_Postgresql */
