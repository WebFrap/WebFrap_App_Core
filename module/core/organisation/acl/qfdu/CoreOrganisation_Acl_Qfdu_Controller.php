 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view CoreOrganisation_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'core_organisation-acl-qfdu-aAjax',
      'CoreOrganisation_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class CoreOrganisation_Acl_Qfdu_Controller */
