 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management CoreOrganisation
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new CoreOrganisation_Acl_Access_Container( null, null, $this );
    ...
    (
      'core_organisation_acl_listing',
      'CoreOrganisation_Acl',
      'displayListing',
      null,
      true
    );

    $view->setModel( $this->loadModel('CoreOrganisation_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model CoreOrganisation_Acl_Model */
    $model   = $this->loadModel( 'CoreOrganisation_Acl' );
    $areaId  = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_organisation-acl',
    	'CoreOrganisation_Acl',
    	'displaySearch',
    	View::AJAX
    );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'core_organisation_acl_masks_listing',
      'CoreOrganisation_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'CoreOrganisation_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'CoreOrganisation_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model CoreOrganisation_Acl_Qfdu_Model */
    $model = $this->loadModel
    (
      'CoreOrganisation_Acl_Qfdu'
    );
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model CoreOrganisation_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'CoreOrganisation_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_organisation-acl-qfdu',
    	'CoreOrganisation_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class CoreOrganisation_Acl_Controller */
