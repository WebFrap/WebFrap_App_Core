...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return CoreOrganisation_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CoreOrganisation_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'core_organisation-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Organisation', 'core.organisation.label' )
      )
    );
    $tabPanel->searchKey  = 'core_organisation_acl';
...
} // end class CoreOrganisation_Acl_Ui */
