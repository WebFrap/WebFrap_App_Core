 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Dset_Ui
  extends Ui
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the model
   * @var CoreOrganisation_Acl_Dset_Model
   */
...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CoreOrganisation_Acl_Dset_Treetable_Element
   */
  public function createListItem( $data, $entityCoreOrganisation, $areaId, $access, $params  )
  {

    $listObj = new CoreOrganisation_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
    ...
    $listObj->setId( 'wgt-treetable-core_organisation-acl-dset' );
    ...
    else
    {
      ...
      (
        'Organisation "{@label@}" User Access',
        'core.organisation.label',
        array
        (
          'label' => $entityCoreOrganisation->text()
        )
      );
      $tabPanel->searchKey  = 'core_organisation_acl_dset';
    }
...
WGTJS;
  ...
  public function listEntry( $access, $params,  $insert )
  {
    ...
    $table = new CoreOrganisation_Acl_Dset_Treetable_Element
    (
      'listingDsetUsers',
      $this->view
    );
...
} // end class CoreOrganisation_Acl_Dset_Ui */
