 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model CoreOrganisation_Acl_Dset_Model  */
    $model = $this->loadModel( 'CoreOrganisation_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityCoreOrganisation = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view CoreOrganisation_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'core_organisation-acl-dset-listing-'.$objid,
    ...
    $view->displayListing( $entityCoreOrganisation, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view CoreOrganisation_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'core_organisation-acl-dset', 
    	'CoreOrganisation_Acl_Dset',
...
} // end class CoreOrganisation_Acl_Dset_Controller */
