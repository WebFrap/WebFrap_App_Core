 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Dset_Treetable_Query_Postgresql
  extends LibSqlQuery
{////////////////////////////////////////////////////////////////////////////////
// attributes
////////////////////////////////////////////////////////////////////////////////
      ...
      else
      {
        ...
        (
          '(
            ...
            OR
            (  upper(core_organisation.name) like upper(\''.$condition['free'].'%\') )
...
} // end class CoreOrganisation_Acl_Dset_Treetable_Query_Postgresql */
