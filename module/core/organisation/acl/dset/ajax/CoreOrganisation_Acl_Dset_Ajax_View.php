 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'CoreOrganisation_Acl_Dset' );
    ...
    $entityCoreOrganisation = $this->model->getEntity( $dsetId );
...
} // end class CoreOrganisation_Acl_Dset_Ajax_View */
