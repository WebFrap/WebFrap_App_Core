 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-core_organisation'  );
  ...
  public function getEntity( $id )
  {
    ...
    return $orm->get( 'CoreOrganisation', $id );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreOrganisation_Acl_Dset' );
    /* @var $query CoreOrganisation_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CoreOrganisation_Acl_Dset_Treetable' );
    /* @var $query CoreOrganisation_Acl_Dset_Treetable_Query  */
...
} // end class CoreOrganisation_Acl_Dset_Model */
