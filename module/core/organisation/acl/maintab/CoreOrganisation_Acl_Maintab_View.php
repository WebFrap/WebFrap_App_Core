 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.Organisation_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_organisation-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Core.Organisation_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'core_organisation-acl-update';
    ...
    $this->setTemplate( 'core/organisation/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Organisation', 'core.organisation.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-core_organisation_acl_listing' );
    ...
    $ui = $this->loadUi( 'CoreOrganisation_Acl' );
...
} // end class CoreOrganisation_Acl_Maintab_View */
