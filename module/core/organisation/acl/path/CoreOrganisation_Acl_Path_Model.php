 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Path_Model
  extends Model
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getReferences( $areaId, $idGroup, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'CoreOrganisation_Acl_Path' );
    /* @var $query CoreOrganisation_Acl_Path_Query  */
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function dropPath( $pathId )
  {
    ...
    $dropQuery = $db->newQuery('CoreOrganisation_Acl_Path');
    /* @var $dropQuery CoreOrganisation_Acl_Path_Query  */
...
} // end class CoreOrganisation_Acl_Path_Model */
