 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'core/organisation/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-core_organisation-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-core_organisation-acl-path-access_level',
      'class' => 'medium',
...
} // end class CoreOrganisation_Acl_Path_Maintab_View */
