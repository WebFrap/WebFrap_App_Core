 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    ( 
      'core_organisation_acl_graph', 
      'CoreOrganisation_Acl_Path',
      'displayGraph',
      null,
      true
    );

    $view->setModel( $this->loadModel( 'CoreOrganisation_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'CoreOrganisation_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view CoreOrganisation_Acl_Path_Maintab_View  */
...
} // end class CoreOrganisation_Acl_Path_Controller */
