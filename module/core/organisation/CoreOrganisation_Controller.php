 ...
 * @licence WebFrap.net
 */
class CoreOrganisation_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  *   Datensatzes des types: core_organisation
  *
  ...
  *
  *   @url maintab.php?c=Core.Organisation.create
  *
  *   @type UI Service
  ...
  */
  public function service_create( $request, $response )
  {
    ...
    $params->contextKey = 'core_organisation-create';

    $access = new CoreOrganisation_Crud_Access_Create( null, null, $this );
    ...
    (
      'form-core_organisation-create',
      'CoreOrganisation_Crud_Create',
      'displayForm',
      null,
      true
    );
    // laden des models und direkt übergabe in die view
    /* @var $model CoreOrganisation_Crud_Model */
    $model = $this->loadModel( 'CoreOrganisation_Crud' );
  ...
  *   @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  *   @access maintab.php?c=Core.Organisation.edit&objid=123
  *
  *   @type UI Service
  *   @param LibRequestHttp $request
  *   @param LibResponseHttp $response
  ...
  */
  public function service_edit( $request, $response )
  {
    ...
    $entityCoreOrganisation = $model->getEntityCoreOrganisation( $objid );
    ...
    $params->entity = $entityCoreOrganisation;

    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-edit-'.$objid;
    
    if( !$params->maskRoot )
    	$params->maskRoot = 'core_organisation:edit';

    $access = new CoreOrganisation_Crud_Access_Edit( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreOrganisation );
    ...
    $view = $response->loadView
    (
      'form-core_organisation-edit-'.$objid,
      'CoreOrganisation_Crud_Edit',
      'displayForm',
      null,
      true
    );
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        (
          'core_organisation-edit',
          $entityCoreOrganisation,
          'Edit Organisation :'.$entityCoreOrganisation->text()
        );
  ...
  */
  public function service_show( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-show-'.$objid;
    ...
    if( is_null($params->aclRoot) || 1 == $params->aclLevel  )
    {
      ...
      $params->aclRoot       = 'mgmt-core_organisation';
      $params->maskRoot      = 'core_organisation:show';
      $params->aclRootId     = $objid;
      $params->aclKey        = 'mgmt-core_organisation';
      $params->aclNode       = 'mgmt-core_organisation';
      $params->aclLevel      = 1;
    }
    ...
    if( $error )
    {
      ...
      return $error;
        ...
        $protocol->updateLastVisited
        (
          'core_organisation-show',
          $entityCoreOrganisation,
          'Show Organisation :'.$entityCoreOrganisation->text()
        );
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * de:
  * Service zum Erstellen neuer Datensätze des types: core_organisation
  *
  ...
  * zu erstellen.
  *
  * @call POST ajax.php?c=Core.Organisation.insert
  * {
  ...
  */
  public function service_insert( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-insert';

    $access = new CoreOrganisation_Crud_Access_Insert( null, null, $this );
    $access->load( $user->getProfileName(),  $params );
    ...
    else
    {
    	...
    	$entityCoreOrganisation = $model->getEntity();
    
      // der contextKey wird benötigt um potentielle Konflikte in der UI
      // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
      $params->contextKey = 'core_organisation-update-'.$entityCoreOrganisation;
      ...
      {
        $access = new CoreOrganisation_Crud_Access_Update( null, null, $this );
        $access->load( $user->getProfileName(), $params, $entityCoreOrganisation );
      }
      $params->access = $access;
      ...
      if( !$params->mask )
        $params->mask = 'CoreOrganisation';

      // laden der angeforderten view
      $view = $response->loadView
      (
        'listing_core_organisation',
        $params->mask.'_'.$listType,
        'displayInsert'
      );

      // model wird benötigt
      /* @var $model CoreOrganisation_Table_Model */ // nicht zwangsweise dieses model aber höchstwarhscheinlich
  ...
  *
  * @call POST ajax.php?c=Core.Organisation.update
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_update( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-update-'.$objid;
    ...
    // if fails stop here
    if( !$model->fetchUpdateData( $entityCoreOrganisation, $params ) )
    {
      // wenn die daten nicht valide sind, dann war es eine ungültige anfrage
      throw new InvalidRequest_Exception
      (
  ...
  * @param CoreOrganisation_Crud_Model $model the model
  ...
  *
  * @access DELETE ajax.php?c=Core.Organisation.delete&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  ...
  */
  public function service_delete( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-delete-'.$objid;

    $access = new CoreOrganisation_Crud_Access_Delete( null, null, $this );
    $access->load( $user->getProfileName(), $params, $entityCoreOrganisation );
    ...
    $error = $model->delete( $entityCoreOrganisation, $params );
    ...
    $error = $view->displayDelete( $entityCoreOrganisation, $params );
  ...
  */
  public function service_deleteAll( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-delete';
  ...
  * der eintrag muss direkt mit der rowid adressiert werden
  *
  * @access DELETE ajax.php?c=Core.Organisation.deleteSelection&objid=123
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  * @return boolean success flag
...
////////////////////////////////////////////////////////////////////////////////
  ...
  * @tutorial <a href="http://webfrap.net/doc/{{version}}/index.php?page=architecture.views.overview" >Tutorial Viewtypes</a>
  *
  * @url maintab.php?c=Core.Organisation.listing
  *
  * @param LibRequestHttp $request
  * @param LibResponseHttp $response
  *
  ...
  */
  public function service_listing( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-listing';
    ...
    $containerClass = 'CoreOrganisation_'.$listType.'_Access';
    ...
    /* @var $model CoreOrganisation_Table_Model */
    $model = $this->loadModel( 'CoreOrganisation_'.$listType );
    $model->setAccess( $access );

        $protocol = Protocol::getDefault();
        $protocol->updateLastVisited
        (
          'core_organisation-'.$params->ltype,
          'CoreOrganisation',
  ...
  */
  ...
  /**
   * the default selection for the management  CoreOrganisation
   * @param LibRequestHttp $request
   * @param LibResponseHttp $response
   * @return boolean
   */
  public function service_selection( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-selection';

    // ok nun kommen wir zu der zugriffskontrolle
    $access = new CoreOrganisation_Selection_Access( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    $view = $response->loadView
    (
      'selection_core_organisation',
      'CoreOrganisation_Selection',
      'displaySelection',
      null,
      true
    );
    ...
    $model = $this->loadModel( 'CoreOrganisation_Selection' );
    $model->setAccess( $access );
    $view->setModel( $model );
  ...
  *
  * @call GET/POST: maintab.php?c=Core.Organisation.filter
  * {
  *   @get_param: cname ltype, der Type der des Listenelements. Sollte sinnigerweise
  *     der gleich type wie das Listenelement sein, für das die Suche angestoßen wurde
  *
  ...
  */
  public function service_filter( $request, $response )
  {
    ...
    /* @var $model CoreOrganisation_Selection_Model */
    $model   = $this->loadModel( 'CoreOrganisation_Selection' );
    $model->setAccess( $access );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_data( $request, $response )
  {
    ...
    if( $params->context && 'create' == $params->context )
      $params->contextKey = 'core_organisation-data-'.$objid;
    else
      $params->contextKey = 'core_organisation-data';

    // laden der passenden view
    $view = $response->loadView
    (
      'tmp-core_organisation',
      'CoreOrganisation',
      'displayData'
    );
    ...
    // wenn alles glatt geht gibt die view null zurück und der keks ist gegessen
    $error = $view->displayData( $entityCoreOrganisation, $params );
  ...
  */
  public function service_append( $request, $response )
  {
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-append-'.$objid;
    ...
    $ui = $this->loadUi( 'CoreOrganisation_'.$listType );
    $model->setAccess( $access );
    $ui->setModel( $model );
  ...
  public function service_textByKey( $request, $response )
  {
    ...
    $access = new CoreOrganisation_Crud_Access_Listing( null, null, $this );
    $access->load( $user->getProfileName(), $params );
    ...
    // der contextKey wird benötigt um potentielle Konflikte in der UI
    // bei der Anzeige von mehreren Windows oder Tabs zu vermeiden
    $params->contextKey = 'core_organisation-text_by_key_'.$objid;

    $params->target = $request->param( 'target', Validator::CNAME );

    $ui = $this->loadUi( 'CoreOrganisation_Crud' );
    $model->setAccess( $access );
    $ui->setModel( $model );


    $ui->textByKey( $entityCoreOrganisation, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function cleanPost( )
  {
    ...
    $this->request->removeData( 'core_organisation' );
...
} // end class CoreOrganisation_Controller */
