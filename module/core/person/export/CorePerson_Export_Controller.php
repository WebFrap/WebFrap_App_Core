 ...
 * @licence WebFrap.net
 */
class CorePerson_Export_Controller_Genf
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var CorePerson_Export_Model $model
   */
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_exportList( $request, $response )
  {
    ...
    $containerClass = 'CorePerson_Export_Listing_Access';
    ...
    // create a new CorePerson window
    $view = $this->loadView
    (
    	'export-core_person',
    	'CorePerson_Export',
    ...
    $model = $this->loadModel( 'CorePerson_Export' );
...
} // end class CorePerson_Export_Controller_Genf
