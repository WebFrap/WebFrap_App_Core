...
////////////////////////////////////////////////////////////////////////////////
  ...
  *
  *
  * @param CorePerson_Selection_Query $data
  ...
  *  }
  *
  * @return CorePerson_Selection_Element
  */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CorePerson_Selection_Element
    (
      'selectionCorePerson',
      $view
    );
    ...
    if( 'ajax' != $view->type )
    {
      ...
      $tabPanel->title = $this->view->i18n->l( 'Selection Persons', 'core.person.label' ) ;
    ...
    \$S('input#wgt-input-{$params->input}').data('assign',function( objid ){
      ...
      \$R.get( 'ajax.php?c=Core.Person.data{$loadParam}&objid='+objid );
      \$S.modal.close();
    });
...
WGTJS;
   ...
   *
   * @param CorePerson_Selection_Model $model
   * @param TFlag $params
   * @return void
   */
...
}//end class CorePerson_Selection_Ui
