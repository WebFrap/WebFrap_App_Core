 ...
 * @licence WebFrap.net
 */
class CorePerson_Selection_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
 ...
 /**
  ...
  public function setCols( $criteria )
  {
    ...
    (
      ...
      'core_person.firstname as "core_person_firstname"', // variant: field_mgmt-attr 
      'core_person.lastname as "core_person_lastname"', // variant: field_mgmt-attr 
      'core_person.photo as "core_person_photo"', // variant: field_mgmt-attr 
      'core_person.academic_title as "core_person_academic_title"', // variant: field_mgmt-attr 
    );
 ...
 /**
  ...
  public function checkConditions( $criteria, array $condition )
  {
    	...
    	if( isset($condition['ids']) && !empty( $condition['ids'] ) )
    	{
				$criteria->where
        (
          'core_person.rowid = IN( '. implode( ', ', $condition['ids'] ) .' ) ';
        );
    	}
 ...
 core_person.rowid = \''.$part.'\'  or 
  ...
  public function checkLimitAndOrder( $criteria, $params  )
  {
     ...
     // inject the default order
      ...
      $criteria->selectAlso( 'core_person.rowid as "core_person-rowid-order"' );
  ...
  public function injectAclOrder( $criteria, $envelop, $params  )
  {
     ...
     // inject the default order
      ...
      $envelop->groupBy( 'inner_acl."core_person-rowid-order"' );
      $envelop->selectAlso( 'inner_acl."core_person-rowid-order"' );
      $envelop->orderBy( 'inner_acl."core_person-rowid-order"' );
...
}//end class CorePerson_Selection_Query_Postgresql
