 ...
 * @licence WebFrap.net
 */
class CorePerson_Selection_Element
  extends WgtTable
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id   = 'wgt_selection-core_person';
  ...
  public function loadUrl()
  {
    ...
    (
      ...
      (
        ...
        'Show',
        'maintab.php?c=Core.Person.show&amp;target_mask=CorePerson&amp;ltype=selection&amp;objid=',
        'control/show.png',
        '',
        'core.person.label',
        Acl::ACCESS,
      ...
      (
        Wgt::ACTION_BUTTON_GET,
        'Edit',
        'maintab.php?c=Core.Person.edit&amp;target_mask=CorePerson&amp;ltype=selection&amp;objid=',
        'control/edit.png',
        '',
        'core.person.label',
        Acl::UPDATE
      ...
      (
        Wgt::ACTION_DELETE,
        'Delete',
        'index.php?c=Core.Person.delete&amp;target_mask=CorePerson&amp;ltype=selection&amp;objid=',
        'control/delete.png',
        '',
        'core.person.label',
        Acl::DELETE
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    $html .= '<th style="width:175px" >Last Name</th>'.NL;
    $html .= '<th style="width:175px" >First Name</th>'.NL;
    $html .= '<th style="width:175px" >Title</th>'.NL;
  ...
  {    
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_person_lastname'])).'</td>'.NL;
      $body .= '<td valign="top" >'.nl2br(Validator::sanitizeHtml($row['core_person_firstname'])).'</td>'.NL;
...
}//end class CorePerson_Selection_Element
