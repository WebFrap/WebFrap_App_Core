...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param TFlag $params named parameters
   *
   * @return CorePerson_Acl_Table_Element
   */
  public function createListItem( $data, $access, $params  )
  {
    ...
    $table = new CorePerson_Acl_Table_Element
    (
      'listingAclTable',
      $view
    );
    ...
    $table->setSearchKey( 'core_person-acl' );
    ...
    (
      ...
      array
      (
        'label' => $view->i18n->l( 'Person', 'core.person.label' )
      )
    );
    $tabPanel->searchKey  = 'core_person_acl';
