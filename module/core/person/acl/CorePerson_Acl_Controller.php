 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * the default table for the management CorePerson
  ...
  public function service_listing( $request, $response )
  {
    ...
    $access = new CorePerson_Acl_Access_Container( null, null, $this );
    ...
    $view->setModel( $this->loadModel('CorePerson_Acl') );
  ...
  public function service_search( $request, $response )
  {
    ...
    /* @var $model CorePerson_Acl_Model */
    $model   = $this->loadModel( 'CorePerson_Acl' );
  ...
  public function service_listAllMasks( $request, $response )
  {
    ...
    $view = $response->loadView
    (
      'core_person_acl_masks_listing',
      'CorePerson_Acl_Masks',
      'displayListing',
      View::MODAL
    );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function service_updateArea( $request, $response )
  {
    ...
    {
      $modelMultiAccess = $this->loadModel( 'CorePerson_Acl_Multi' );
    ...
    {
      $modelMultiQfdu = $this->loadModel( 'CorePerson_Acl_Qfdu_Multi' );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_tabQualifiedUsers( $request, $response )
  {
    ...
    /* @var $model CorePerson_Acl_Qfdu_Model */
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    // load the default model
    /* @var $model CorePerson_Acl_Qfdu_Model */
    $model  = $this->loadModel( 'CorePerson_Acl_Qfdu' );
    $areaId = $model->getAreaId();

    // this can only be an ajax request, so we can directly load the ajax view
    $view    = $response->loadView
    ( 
    	'core_person-acl-qfdu',
    	'CorePerson_Acl_Qfdu',
    	'displaySearch',
    	View::AJAX
    );
...
} // end class CorePerson_Acl_Controller */
