 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Maintab_View
  ...
  */
  public function displayListing( $params )
  {
    ...
    if( !$params->searchFormAction )
      $params->searchFormAction = 'index.php?c=Core.Person_Acl.search';

    // add the id to the form
    if( !$params->searchFormId )
      $params->searchFormId = 'wgt-form-table-core_person-acl-search';
    ...
    if( !$params->formAction )
      $params->formAction = 'index.php?c=Core.Person_Acl.updateArea';
    ...
    if( !$params->namespace )
      $params->namespace = 'core_person-acl-update';
    ...
    $this->setTemplate( 'core/person/maintab/acl/main_group_rights' );
    ...
    (
      ...
      array
      (
        'label' => $this->i18n->l( 'Person', 'core.person.label' )
      )
    );
    ...
    //$this->setTabId( 'wgt-tab-core_person_acl_listing' );
...
} // end class CorePerson_Acl_Maintab_View */
