 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Qfdu_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// fetch methodes
...
SQL;
  ...
  public function fetchTargetEntityByKey( $areaId, $key, $params = null )
  {
    ...
    foreach( $tmp as $value )
    {
      ...
      $wheres[] = " upper(core_person.rowid) like upper('{$safeVal}%') ";
    }
    ...
    $sql = <<<SQL
  SELECT
    core_person.rowid as id,
    core_person.rowid as value,
    core_person.rowid as label
  FROM
    core_person
  WHERE
    {$sqlWhere}
...
} // end class CorePerson_Acl_Qfdu_Query_Postgresql */
