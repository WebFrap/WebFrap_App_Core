 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Qfdu_Treetable_Query_Postgresql
  extends LibSqlQuery
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  ...
  public function setTables( $criteria )
  {
    ...
    $criteria->join
    (
      'LEFT JOIN core_person on wbfsys_group_users.vid = core_person.rowid'
    );
...
} // end class CorePerson_Acl_Qfdu_Treetable_Query_Postgresql */
