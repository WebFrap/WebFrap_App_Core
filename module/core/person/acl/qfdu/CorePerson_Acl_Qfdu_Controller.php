 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Qfdu_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_searchQfdUsers( $request, $response )
  {
    ...
    /* @var $view CorePerson_Acl_Qfdu_Ajax_View */
    $view   = $response->loadView
    (
    	'core_person-acl-qfdu-aAjax',
      'CorePerson_Acl_Qfdu_Ajax',
      'displaySearch'
    );
...
} // end class CorePerson_Acl_Qfdu_Controller */
