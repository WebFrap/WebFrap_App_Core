...
////////////////////////////////////////////////////////////////////////////////
   ...
   *
   * @return CorePerson_Acl_Qfdu_Treetable_Element
   */
  public function createListItem( $data, $areaId, $access, $params  )
  {

    $listObj = new CorePerson_Acl_Qfdu_Treetable_Element
    (
    ...
    else
    {
      ...
      (
        'Qualified User Access for Person',
        'core.person.label'
      );
      $tabPanel->searchKey  = 'core_person_acl_qfdu';
    }
...
WGTJS;
  ...
  public function listEntry( $areaId, $access, $params, $insert )
  {
    ...
    $table = new CorePerson_Acl_Qfdu_Treetable_Element
    (
      'listingQualifiedUsers',
      $this->view
    );
...
} // end class CorePerson_Acl_Qfdu_Ui */
