 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Qfdu_Model
  extends Model
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId( )
  {
    ...
    {
      $orm = $this->getOrm();
      $this->areaId = $orm->get( 'WbfsysSecurityArea', "upper(access_key)=upper('mgmt-core_person')")->getid();
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getEntryWbfsysGroupUsers( $params )
  {
    ...
    {
      $refEntityCorePerson = $orm->get('CorePerson', $data['wbfsys_group_users']->vid);
      $tabData['core_person_firstname']  = $refEntityCorePerson->firstname;
      $tabData['core_person_lastname']  = $refEntityCorePerson->lastname;

    }
    $tabData['core_person_rowid'] = $data['wbfsys_group_users']->vid;
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * Die Anfrage wird über ein CorePerson_Acl_Query Objekt
  ...
  public function searchGroupsAutocomplete( $key, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CorePerson_Acl' );
    /* @var $query CorePerson_Acl_Query  */
  ...
  public function searchQualifiedUsers( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CorePerson_Acl_Qfdu_Treetable' );
    /* @var $query CorePerson_Acl_Qfdu_Treetable_Query  */
  ...
  public function getAreaGroups( $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CorePerson_Acl_Qfdu' );
    /* @var $query CorePerson_Acl_Qfdu_Query  */
...
} // end class CorePerson_Acl_Qfdu_Model */
