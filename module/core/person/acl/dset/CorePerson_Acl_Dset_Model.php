 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Dset_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function getAreaId()
  {
    ...
    return $this->loadAreaId( 'mgmt-core_person'  );
  ...
  public function getGroups( $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CorePerson_Acl_Dset' );
    /* @var $query CorePerson_Acl_Dset_Query  */
  ...
  public function searchQualifiedUsers( $dsetId, $areaId, $params )
  {
    ...
    $db     = $this->getDb();
    $query  = $db->newQuery( 'CorePerson_Acl_Dset_Treetable' );
    /* @var $query CorePerson_Acl_Dset_Treetable_Query  */
...
} // end class CorePerson_Acl_Dset_Model */
