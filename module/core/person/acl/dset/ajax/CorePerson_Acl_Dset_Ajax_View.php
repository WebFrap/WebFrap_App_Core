 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Dset_Ajax_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function displaySearch( $dsetId, $areaId, $params )
  {
    ...
    $ui = $this->tpl->loadUi( 'CorePerson_Acl_Dset' );
    ...
    $entityCorePerson = $this->model->getEntity( $dsetId );
...
} // end class CorePerson_Acl_Dset_Ajax_View */
