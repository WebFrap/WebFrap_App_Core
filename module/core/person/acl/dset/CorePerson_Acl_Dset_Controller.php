 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Dset_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_listing( $request, $response )
  {
    ...
    /* @var $model CorePerson_Acl_Dset_Model  */
    $model = $this->loadModel( 'CorePerson_Acl_Dset' );

    // dann das passende entitiy objekt für den datensatz
    $entityCorePerson = $model->getEntity( $objid );
    ...
    $params->access = $access;
		...
		/* @var $view CorePerson_Acl_Dset_Maintab_View  */
    $view = $response->loadView
    (
      'core_person-acl-dset-listing-'.$objid,
      'CorePerson_Acl_Dset',
      'displayListing'
    );
    ...
    $view->displayListing( $entityCorePerson, $areaId, $params );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocompleteUsers( $request, $response )
  {
    ...
    $params->access = $access;
		...
		/* @var $view CorePerson_Acl_Dset_Ajax_View  */
    $view   = $response->loadView
    (
    	'core_person-acl-dset', 
    	'CorePerson_Acl_Dset',
...
} // end class CorePerson_Acl_Dset_Controller */
