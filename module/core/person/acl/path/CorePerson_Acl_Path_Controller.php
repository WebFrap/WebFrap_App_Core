 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Path_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_showGraph( $request, $response )
  {
    ...
    $view->setModel( $this->loadModel( 'CorePerson_Acl_Path' ) );
  ...
  public function service_savePath( $request, $response )
  {
    ...
    $model = $this->loadModel( 'CorePerson_Acl_Path' );
  ...
  public function service_dropPath( $request, $response  )
  {
    ...
    /* @var $view CorePerson_Acl_Path_Maintab_View  */
...
} // end class CorePerson_Acl_Path_Controller */
