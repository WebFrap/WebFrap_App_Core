 ...
 * @licence WebFrap.net
 */
class CorePerson_Acl_Path_Maintab_View
  extends WgtMaintab
{////////////////////////////////////////////////////////////////////////////////
// Attributes
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayGraph( $groupId, $params )
  {
    ...
    $this->setTemplate( 'core/person/maintab/acl/acl_graph' );
    ...
    //$this->setTabId( 'wgt-tab-core_person-acl-path');
    ...
    $selectAccess->addAttributes(array(
      'id'    => 'wgt-input-core_person-acl-path-access_level',
      'class' => 'medium',
...
} // end class CorePerson_Acl_Path_Maintab_View */
