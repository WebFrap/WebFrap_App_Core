 ...
 * @licence WebFrap.net
 */
class CorePerson_Crud_Access_Root
  extends LibAclRoot
{
////////////////////////////////////////////////////////////////////////////////
// Methodes
////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * @param int|CorePerson_Entity $rootNode
   * @param int $level
   * @param string $refKey
   */
  public function getRefLevel( $rootNode, $level, $refKey )
  {
    ...
    else 
    {
      ...
      /* @var $entity CorePerson_Entity */
      $entity = $orm->get( 'CorePerson', $rootId );
    }
...
}//end class CorePerson_Crud_Access_Root
