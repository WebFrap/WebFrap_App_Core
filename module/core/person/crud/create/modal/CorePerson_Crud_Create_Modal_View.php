 ...
 * @licence WebFrap.net
 */
class CorePerson_Crud_Create_Modal_View
  extends WgtModal
{
////////////////////////////////////////////////////////////////////////////////
// attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * form to create a new CorePerson entity
  *
  * @param TFlag $params
  ...
  */
  public function displayForm( $params )
  {
    ...
    (
      $i18nText,
      'modal.php?c=Core.Person.create'
    );
    ...
    $params->formAction  = 'ajax.php?c=Core.Person.insert';
    $params->formId       = 'wgt-form-core_person';
    $params->namespace   = 'core_person-create';
    ...
    $this->setTemplate( 'core/person/modal/crud/form_create' );
...
}//end class CorePerson_Crud_Create_Modal_View
