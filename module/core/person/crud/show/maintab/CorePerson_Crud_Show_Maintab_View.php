 ...
 * @licence WebFrap.net
 */
class CorePerson_Crud_Show_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Show Form der CorePerson Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCorePerson = $this->model->getEntityCorePerson();
    ...
    (
      'Show Person: {@text@}',
      'core.person.label',
      array( 'text' => $entityCorePerson->text() )
    );
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Person.show  &amp;objid='.$entityCorePerson
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Person.update&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_person-show-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/person/maintab/crud/form_show' );
    ...
    $form = $this->newForm( 'CorePerson_Crud_Show' );
...
{$bookmark}
    ...
    self.getObject().find(".wgtac_metadata").click(function(){
      ...
      \$R.get('modal.php?c=Core.Person.showMeta&objid={$objid}');
    });

    self.getObject().find(".wgtac_back_to_list").click(function(){
      self.close();
      
      if( \$S( '#wgt-maintab_tab_wgt_tab-listing_core_person' ).length ){
        \$S( '#wgt-maintab_tab_wgt_tab-listing_core_person a' ).click();
      }
      else{
        \$R.get( 'maintab.php?c=Core.Person.listing' );
      }
    });
...
BUTTONJS;
    ...
    self.getObject().find(".wgtac_open_edit").click(function(){
      \$R.get('maintab.php?c=Core.Person.edit&objid={$objid}',{success:function(){self.close();});
...
}//end class CorePerson_Crud_Show_Maintab_View
