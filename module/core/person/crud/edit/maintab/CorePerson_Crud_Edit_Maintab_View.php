 ...
 * @licence WebFrap.net
 */
class CorePerson_Crud_Edit_Maintab_View
  extends WgtMaintab
{
////////////////////////////////////////////////////////////////////////////////
// Attributes
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * Das Edit Form der CorePerson Maske
  *
  ...
  */
  public function displayForm( $objid, $params )
  {
    ...
    $entityCorePerson = $this->model->getEntity();
    ...
    (
      $i18nTitle,
      'maintab.php?c=Core.Person.edit&amp;utf8=✓&amp;objid='.$entityCorePerson
    );

    // Control Flags setzen
    // Form Action und ID setzen
    $params->formAction = 'ajax.php?c=Core.Person.update&amp;utf8=✓&amp;objid='.$objid;
    $params->formId = 'wgt-form-core_person-edit-'.$objid;
    $params->refId  = $objid;
    ...
    $this->setTemplate( 'core/person/maintab/crud/form_edit' );
    ...
    $form = $this->newForm( 'CorePerson_Crud_Edit' );
...
}//end class CorePerson_Crud_Edit_Maintab_View
