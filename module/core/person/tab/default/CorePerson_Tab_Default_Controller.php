 ...
 * @licence WebFrap.net
 */
class CorePerson_Tab_Default_Controller
  extends Controller
{
...
////////////////////////////////////////////////////////////////////////////////
 ...
 /**
  * open tab default for management view  core_person
  ...
  */
  public function service_load( $request, $response )
  {
    ...
    $access = new CorePerson_Crud_Access_Tab( null, null, $this );
    ...
    (
      $params->tabId,
      'CorePerson_Tab_Default',
      'displayTab',
      View::AREA
    );
    $view->setPosition( '#'.$params->tabId );
    $view->setModel( $this->loadModel( 'CorePerson_Crud' ) );
...
} // end CorePerson_Tab_Default_Controller */
