...
<form
  ...
  <div class="wgt-panel" >
    ...
    <div class="inline" style="margin-left:20px;" >
      ...
      <input
        type="text"
        id="wgt-input-wbfsys_package_modules-acl-dset-id_user-tostring"
        name="key"
        class="medium wcm wcm_ui_autocomplete wgt-ignore"  />
      <var class="wgt-settings" >{
          "url":"ajax.php?c=Wbfsys.PackageModules_Acl_Dset.autocompleteUsers&amp;key=",
          "type":"entity"
      }</var>
      <input
        type="text"
        id="wgt-input-wbfsys_package_modules-acl-dset-id_user"
      ...
      <button
        ...
        onclick="$R.get('modal.php?c=Wbfsys.RoleUser.selection&input=wbfsys_package_modules-acl-dset-id_user');return false;"    >
     ...
     <div class="inline" style="margin-left:20px;" >
      <input
        type="hidden"
        id="wgt-input-wbfsys_package_modules-acl-dset-vid"
      ...
      <button
        class="wgt-button"
        id="wgt-button-wbfsys_package_modules-acl-dset-append"
        onclick="$R.form('wgt-form-wbfsys_package_modules-acl-dset-append');$UI.form.reset('wgt-form-wbfsys_package_modules-acl-dset-append');return false;" >
