  <div id="wgt-tab-form-wbfsys_image_format-create" class="wcm wcm_ui_tab" >
    ...
    <form
      ...
      <!-- Tab Details -->
      <div  
        id="<?php echo $this->id?>_tab_wbfsys_image_format_details"
        title="<?php echo $I18N->l('image format','wbfsys.image_format.label')?>"  >
