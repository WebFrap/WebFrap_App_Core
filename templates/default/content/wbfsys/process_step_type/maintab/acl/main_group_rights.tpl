...
<form
  ...
  <div 
    id="<?php echo $this->id?>-wbfsys_process_step_type-acl" 
    ...
    <div style="position:absolute;width:200px;height:100%;top:0px:bottom:0px;"   >
      ...
      <div id="<?php echo $this->id?>-wbfsys_process_step_type-acl-head" style="height:600px;" >
        ...
        <h3><a 
          tab="qfd_users" 
          wgt_src="ajax.php?c=Wbfsys.ProcessStepType_Acl.tabQualifiedUsers&amp;area_id=<?php 
          echo $VAR->entityWbfsysSecurityArea 
          ?>&amp;tabid=<?php 
            echo $this->id?>-wbfsys_process_step_type-acl-content-qfd_users" ><?php 
            echo $I18N->l( 'Qualified Users', 'wbf.label' ); ?></a></h3>
        <div>
        	
        	<p>
        		"Qualified Users" defines the relation(s) of users to the complete datasource ( the process step Type table ) and/or to a list of datasets.<br />
        	</p>
        	<label class="sub" >Example:</label>
        	<p>
        		Assumption: there's a role "Owner" with access level "Edit".<br />
        		If you assign a person in relation to the datasource (process step Types) as "Owner" the person will be able to see and edit
        		all process step Types in the list.<br />
        		As the "Owner" has only edit rights, the person is not allowed e.g. to delete process step Types.
        	</p>
        	<p>
        		To better specify grant access rights, you can also assign the "Owner" relationship in relation
        		to either one or more process step Types. The person will then only have edit rights for the assigned process step Types.
        	</p>
    ...
    <div 
      id="<?php echo $this->id?>-wbfsys_process_step_type-acl-content" 
      style="position:absolute;left:200px;right:0px;top:0px;bottom:0px;height:100%;overflow:hidden;overflow-y:auto;"  >

    <div
      class="container"
      id="<?php echo $this->id?>-wbfsys_process_step_type-acl-content-details"
    ...
    >
      ...
      <form
        method="post"
        accept-charset="utf-8"
        id="wgt-form-wbfsys_process_step_type-acl-append"
        action="ajax.php?c=Wbfsys.ProcessStepType_Acl.appendGroup" >
        ...
        <div class="wgt-panel" >
          ...
          <input
            type="text"
            id="wgt-input-wbfsys_process_step_type-acl-id_group-tostring"
            name="key"
            class="medium wcm wcm_ui_autocomplete wgt-no-save"
          />
          <var id="var-wbfsys_process_step_type-automcomplete" >
            {
              "url":"ajax.php?c=Wbfsys.ProcessStepType_Acl.loadGroups&amp;area_id=<?php 
                echo $VAR->entityWbfsysSecurityArea 
              ?>&amp;key=",
              "type":"entity"
            }
          ...
          <input
            id="wgt-input-wbfsys_process_step_type-acl-id_group"
            class="meta valid_required"
            name="wbfsys_security_access[id_group]"
            type="text"
          />
          <button
            id="wgt-input-wbfsys_process_step_type-acl-id_group-append"
          ...
          <input
            type="text"
            id="wgt-input-wbfsys_process_step_type-acl-id_area"
          ...
          <button
            ...
            id="wgt-button-wbfsys_process_step_type-acl-form-append"
    ...
    <div
      class="container"
      id="<?php echo $this->id?>-wbfsys_process_step_type-acl-content-qfd_users" >
...
$S('#<?php echo $VAR->searchFormId?>').data('connect',function( objid ){
  $R.post(
    'ajax.php?c=Wbfsys.ProcessStepType_Acl.appendGroup',{
