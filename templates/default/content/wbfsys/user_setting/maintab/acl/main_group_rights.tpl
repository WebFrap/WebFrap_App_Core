...
<form
  ...
  <div 
    id="<?php echo $this->id?>-wbfsys_user_setting-acl" 
    ...
    <div style="position:absolute;width:200px;height:100%;top:0px:bottom:0px;"   >
      ...
      <div id="<?php echo $this->id?>-wbfsys_user_setting-acl-head" style="height:600px;" >
        ...
        <h3><a 
          tab="qfd_users" 
          wgt_src="ajax.php?c=Wbfsys.UserSetting_Acl.tabQualifiedUsers&amp;area_id=<?php 
          echo $VAR->entityWbfsysSecurityArea 
          ?>&amp;tabid=<?php 
            echo $this->id?>-wbfsys_user_setting-acl-content-qfd_users" ><?php 
    ...
    <div 
      id="<?php echo $this->id?>-wbfsys_user_setting-acl-content" 
      style="position:absolute;left:200px;right:0px;top:0px;bottom:0px;height:100%;overflow:hidden;overflow-y:auto;"  >

    <div
      class="container"
      id="<?php echo $this->id?>-wbfsys_user_setting-acl-content-details"
    ...
    >
      ...
      <form
        method="post"
        accept-charset="utf-8"
        id="wgt-form-wbfsys_user_setting-acl-append"
        action="ajax.php?c=Wbfsys.UserSetting_Acl.appendGroup" >
        ...
        <div class="wgt-panel" >
          ...
          <input
            type="text"
            id="wgt-input-wbfsys_user_setting-acl-id_group-tostring"
            name="key"
            class="medium wcm wcm_ui_autocomplete wgt-no-save"
          />
          <var id="var-wbfsys_user_setting-automcomplete" >
            {
              "url":"ajax.php?c=Wbfsys.UserSetting_Acl.loadGroups&amp;area_id=<?php 
                echo $VAR->entityWbfsysSecurityArea 
              ?>&amp;key=",
              "type":"entity"
            }
          ...
          <input
            id="wgt-input-wbfsys_user_setting-acl-id_group"
            class="meta valid_required"
            name="wbfsys_security_access[id_group]"
            type="text"
          />
          <button
            id="wgt-input-wbfsys_user_setting-acl-id_group-append"
          ...
          <input
            type="text"
            id="wgt-input-wbfsys_user_setting-acl-id_area"
          ...
          <button
            ...
            id="wgt-button-wbfsys_user_setting-acl-form-append"
    ...
    <div
      class="container"
      id="<?php echo $this->id?>-wbfsys_user_setting-acl-content-qfd_users" >
...
$S('#<?php echo $VAR->searchFormId?>').data('connect',function( objid ){
  $R.post(
    'ajax.php?c=Wbfsys.UserSetting_Acl.appendGroup',{
