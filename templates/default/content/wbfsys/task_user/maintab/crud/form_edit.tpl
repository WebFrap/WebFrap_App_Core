...
<p class="hint" >If you made changes don't forget to save before closing the tab, or else your work will be lost.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_task_user-default-<?php echo $VAR->entityWbfsysTaskUser; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_task_user-default-<?php echo $VAR->entityWbfsysTaskUser; ?>" >
        <div class="left bw3" >
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_task_user-meta-<?php echo $VAR->entityWbfsysTaskUser; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_task_user-meta-<?php echo $VAR->entityWbfsysTaskUser; ?>" style="display:none" >
<div class="full" >
