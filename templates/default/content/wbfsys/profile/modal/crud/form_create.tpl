  <div id="wgt-tab-form-wbfsys_profile-create" class="wcm wcm_ui_tab" >
    ...
    <form
      ...
      <!-- Tab Details -->
      <div  
        id="<?php echo $this->id?>_tab_wbfsys_profile_details"
        title="<?php echo $I18N->l('Profiles','wbfsys.profile.label')?>"  >
