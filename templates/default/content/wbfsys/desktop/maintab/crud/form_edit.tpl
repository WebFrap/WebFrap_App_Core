...
<p>To do so click on "Create new Menu Entry".</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_desktop-default-<?php echo $VAR->entityWbfsysDesktop; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_desktop-default-<?php echo $VAR->entityWbfsysDesktop; ?>" >
        <div class="left bw3" >
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_desktop-description-<?php echo $VAR->entityWbfsysDesktop; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Description
        </legend>
        <div id="wgt-box-wbfsys_desktop-description-<?php echo $VAR->entityWbfsysDesktop; ?>" >
        <div class="left bw3" >
        </div>
        <div class="inline bw3" >
        </div>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_desktop-meta-<?php echo $VAR->entityWbfsysDesktop; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_desktop-meta-<?php echo $VAR->entityWbfsysDesktop; ?>" style="display:none" >
<div class="full" >
