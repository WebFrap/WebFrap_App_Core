  ...
  <form
    ...
    <div id="wgt-search-table-wbfsys_my_issues-advanced"  style="display:none" >

      <div id="wgt_tab-table-wbfsys_my_issues-search" class=""  >
        <div 
        	id="wgt_tab-table-wbfsys_my_issues-search-head" 
        	class="wcm wcm_ui_tab_head wgt-tab-head al"
        	wgt_body="wgt_tab-table-wbfsys_my_issues-search-content" >
          ...
          <div class="wgt-dropdownbox" id="wgt_tab-table-wbfsys_my_issues-search-overflow-cruddropbox" >
            <ul id="wgt_tab-table-wbfsys_my_issues-search-overflow-menu"  >
            </ul>
            <var id="wgt_tab-table-wbfsys_my_issues-search-overflow-cntrl-cfg-dropmenu"  >{"triggerEvent":"click","align":"right"}</var>
          </div>
        </div>

        <div id="wgt_tab-table-wbfsys_my_issues-search-content" class="wgt-content-box" >

          <div
          class="container"
          id="wgt_tab-table-wbfsys_my_issues-search-content-default"
          title="Default"
          wgt_key="default" >
           <div class="full" >
        ...
        <div
          class="container"
          id="wgt_tab-table-wbfsys_my_issues-search-content-description"
          title="Description"
          wgt_key="description" >
           <div class="left bw3" >
        </div>
        ...
        <div class="full" >
          ...
          <div
            class="container"
            id="wgt_tab-table-wbfsys_my_issues-search-content-meta"
            wgt_key="meta"
            title="Meta" >
  ...
  <?php echo $ELEMENT->tableWbfsysMyIssues; ?>
