  ...
  <form
    ...
    <div id="wgt-search-table-wbfsys_docu_tree-advanced"  style="display:none" >

      <div id="wgt_tab-table-wbfsys_docu_tree-search" class=""  >
        <div 
        	id="wgt_tab-table-wbfsys_docu_tree-search-head" 
        	class="wcm wcm_ui_tab_head wgt-tab-head al"
        	wgt_body="wgt_tab-table-wbfsys_docu_tree-search-content" >
          ...
          <div class="wgt-dropdownbox" id="wgt_tab-table-wbfsys_docu_tree-search-overflow-cruddropbox" >
            <ul id="wgt_tab-table-wbfsys_docu_tree-search-overflow-menu"  >
            </ul>
            <var id="wgt_tab-table-wbfsys_docu_tree-search-overflow-cntrl-cfg-dropmenu"  >{"triggerEvent":"click","align":"right"}</var>
          </div>
        </div>

        <div id="wgt_tab-table-wbfsys_docu_tree-search-content" class="wgt-content-box" >

          <div
          class="container"
          id="wgt_tab-table-wbfsys_docu_tree-search-content-default"
          title="Default"
          wgt_key="default" >
           <div class="full" >
        ...
        <div class="full" >
          ...
          <div
            class="container"
            id="wgt_tab-table-wbfsys_docu_tree-search-content-meta"
            wgt_key="meta"
            title="Meta" >
  ...
  <?php echo $ELEMENT->tableWbfsysDocuTree; ?>
