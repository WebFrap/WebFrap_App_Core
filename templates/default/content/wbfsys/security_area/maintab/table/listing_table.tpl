  ...
  <form
    ...
    <div id="wgt-search-table-wbfsys_security_area-advanced"  style="display:none" >

      <div id="wgt_tab-table-wbfsys_security_area-search" class=""  >
        <div 
        	id="wgt_tab-table-wbfsys_security_area-search-head" 
        	class="wcm wcm_ui_tab_head wgt-tab-head al"
        	wgt_body="wgt_tab-table-wbfsys_security_area-search-content" >
          ...
          <div class="wgt-dropdownbox" id="wgt_tab-table-wbfsys_security_area-search-overflow-cruddropbox" >
            <ul id="wgt_tab-table-wbfsys_security_area-search-overflow-menu"  >
            </ul>
            <var id="wgt_tab-table-wbfsys_security_area-search-overflow-cntrl-cfg-dropmenu"  >{"triggerEvent":"click","align":"right"}</var>
          </div>
        </div>

        <div id="wgt_tab-table-wbfsys_security_area-search-content" class="wgt-content-box" >

          <div
          class="container"
          id="wgt_tab-table-wbfsys_security_area-search-content-default"
          title="Default"
          wgt_key="default" >
           <div class="left bw3" >
        ...
        <div class="inline bw3" >
          ...
          <div
            class="container"
            id="wgt_tab-table-wbfsys_security_area-search-content-meta"
            wgt_key="meta"
            title="Meta" >
  ...
  <?php echo $ELEMENT->tableWbfsysSecurityArea; ?>
