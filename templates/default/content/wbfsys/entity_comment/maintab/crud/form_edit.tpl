...
<legend>Comment</legend>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_entity_comment-meta-<?php echo $VAR->entityWbfsysEntityComment; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_entity_comment-meta-<?php echo $VAR->entityWbfsysEntityComment; ?>" style="display:none" >
<div class="full" >
