...
<p class="hint" >If you made changes don't forget to save before closing the tab, or else your work will be lost.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_announcement_channel_subscription-default-<?php echo $VAR->entityWbfsysAnnouncementChannelSubscription; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_announcement_channel_subscription-default-<?php echo $VAR->entityWbfsysAnnouncementChannelSubscription; ?>" >
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_announcement_channel_subscription-meta-<?php echo $VAR->entityWbfsysAnnouncementChannelSubscription; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_announcement_channel_subscription-meta-<?php echo $VAR->entityWbfsysAnnouncementChannelSubscription; ?>" style="display:none" >
<div class="full" >
  Link: <strong><?php echo $this->getServerAddress() ?>maintab.php?c=Wbfsys.AnnouncementChannelSubscription.edit&amp;objid=<?php echo $VAR->entity ?></strong>
