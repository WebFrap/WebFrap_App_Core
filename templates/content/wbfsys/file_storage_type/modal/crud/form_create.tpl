  <div id="wgt-tab-form-wbfsys_file_storage_type-create" class="wcm wcm_ui_tab" >
    ...
    <form
      ...
      <!-- Tab Details -->
      <div  
        id="<?php echo $this->id?>_tab_wbfsys_file_storage_type_details"
        title="<?php echo $I18N->l('file storage Type','wbfsys.file_storage_type.label')?>"  >
