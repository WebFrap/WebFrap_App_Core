  <div id="wgt-tab-form-wbfsys_process-create" class="wcm wcm_ui_tab" >
    ...
    <form
      ...
      <!-- Tab Details -->
      <div  
        id="<?php echo $this->id?>_tab_wbfsys_process_details"
        title="<?php echo $I18N->l('Process','wbfsys.process.label')?>"  >
