...
and append it by clicking on the "connect" Action in the list entry menu.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_announcement-default-<?php echo $VAR->entityWbfsysAnnouncement; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_announcement-default-<?php echo $VAR->entityWbfsysAnnouncement; ?>" >
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_announcement-meta-<?php echo $VAR->entityWbfsysAnnouncement; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_announcement-meta-<?php echo $VAR->entityWbfsysAnnouncement; ?>" style="display:none" >
<div class="full" >
