  ...
  <div 
    ...
    <div style="position:absolute;width:200px;height:100%;top:0px:bottom:0px;"   >
      ...
      <div id="<?php echo $this->id?>-head" style="height:600px;" >
        ...
        <h3><a tab="details" ><?php echo $I18N->l('Video Variant','wbfsys.video_variant.label')?></a></h3>
        <div>
...
<p class="hint" >If you made changes don't forget to save before closing the tab, or else your work will be lost.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_video_variant-default-<?php echo $VAR->entityWbfsysVideoVariant; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_video_variant-default-<?php echo $VAR->entityWbfsysVideoVariant; ?>" >
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_video_variant-description-<?php echo $VAR->entityWbfsysVideoVariant; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Description
        </legend>
        <div id="wgt-box-wbfsys_video_variant-description-<?php echo $VAR->entityWbfsysVideoVariant; ?>" >
        <div class="left bw3" >
        </div>
        <div class="inline bw3" >
        </div>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_video_variant-meta-<?php echo $VAR->entityWbfsysVideoVariant; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_video_variant-meta-<?php echo $VAR->entityWbfsysVideoVariant; ?>" style="display:none" >
<div class="full" >
  Link: <strong><?php echo $this->getServerAddress() ?>maintab.php?c=Wbfsys.VideoVariant.edit&amp;objid=<?php echo $VAR->entity ?></strong>
