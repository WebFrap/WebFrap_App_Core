...
and append it by clicking on the "connect" Action in the list entry menu.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_message-default-<?php echo $VAR->entityWbfsysMessage; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_message-default-<?php echo $VAR->entityWbfsysMessage; ?>" >
        <div class="full" >
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_message-meta-<?php echo $VAR->entityWbfsysMessage; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_message-meta-<?php echo $VAR->entityWbfsysMessage; ?>" style="display:none" >
<div class="full" >
