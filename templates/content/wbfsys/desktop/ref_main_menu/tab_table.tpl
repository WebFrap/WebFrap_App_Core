<?php if( $ELEMENT->tableMainMenu ){ ?>

  <form
    method="get"
    action="<?php echo $VAR->searchFormActionMainMenu.$ELEMENT->tableMainMenu->getAccessPath(); ?>"
  ...
  <?php echo $ELEMENT->tableMainMenu?>

    <form
      method="post"
      action="ajax.php?c=Wbfsys.Desktop_Ref_MainMenu.append<?php echo $ELEMENT->tableMainMenu->getAccessPath();?>"
