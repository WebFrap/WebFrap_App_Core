<?php if( $ELEMENT->treetableMainTree ){ ?>

    <form
      method="get"
      action="<?php echo $VAR->searchFormActionMainTree.$ELEMENT->treetableMainTree->getAccessPath();?>"
    ...
    <form
      method="post"
      action="ajax.php?c=Wbfsys.Desktop_Ref_MainTree.append<?php echo $ELEMENT->treetableMainTree->getAccessPath();?>"
    ...
    <script type="application/javascript" >
      function append_wbfsys_desktop_main_tree_<?php echo $VAR->refIdMainTree?>( targetId ){
        ...
        <?php echo $ELEMENT->treetableMainTree?>
