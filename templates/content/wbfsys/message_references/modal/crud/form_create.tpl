  <div id="wgt-tab-form-wbfsys_message_references-create" class="wcm wcm_ui_tab" >
    ...
    <form
      ...
      <!-- Tab Details -->
      <div  
        id="<?php echo $this->id?>_tab_wbfsys_message_references_details"
        title="<?php echo $I18N->l('Nachrichten Quelle','wbfsys.message_references.label')?>"  >
