...
<legend>Description</legend>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_entity_attachment-meta-<?php echo $VAR->entityWbfsysEntityAttachment; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_entity_attachment-meta-<?php echo $VAR->entityWbfsysEntityAttachment; ?>" style="display:none" >
<div class="full" >
