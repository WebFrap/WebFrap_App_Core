  ...
  <div 
    ...
    <div style="position:absolute;width:200px;height:100%;top:0px:bottom:0px;"   >
      ...
      <div id="<?php echo $this->id?>-head" style="height:600px;" >
        ...
        <h3><a tab="details" ><?php echo $I18N->l('Mask','wbfsys.mask.label')?></a></h3>
        <div>
...
<p class="hint" >If you made changes don't forget to save before closing the tab, or else your work will be lost.</p>
    ...
    <h3>
      <a
        tab="tags"
        wgt_src="ajax.php?c=Wbfsys.Mask_Ref_Tags.tab&amp;objid=<?php
            echo $VAR->entityWbfsysMask->getId();
          ?>&tabid=<?php
            echo $this->id;
          ...
          ?>&a_node=mgmt-wbfsys_mask-ref-tags" ><?php echo $I18N->l('Tags','wbfsys.mask.label.tab_tags')?></a>
    </h3>
    <div>
      
<label>Tags</label>
<p>Here you can assign Tags to the currently selected Mask.</p>
...
and append it by clicking on the "connect" Action in the list entry menu.</p>
    ...
    <h3>
      <a
        tab="comments"
        wgt_src="ajax.php?c=Wbfsys.Mask_Ref_Comments.tab&amp;objid=<?php
            echo $VAR->entityWbfsysMask->getId();
          ?>&tabid=<?php
            echo $this->id;
          ...
          ?>&a_level=<?php
            echo (1+$VAR->params->aclLevel);
          ?>&a_node=mgmt-wbfsys_mask-ref-comments" ><?php echo $I18N->l('Comments','wbfsys.mask.label.tab_comments')?></a>
    </h3>
    <div>
      
<label>Comments</label>
<p>Here you can assign Comments to the currently selected Mask.</p>
...
and append it by clicking on the "connect" Action in the list entry menu.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_mask-default-<?php echo $VAR->entityWbfsysMask; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-wbfsys_mask-default-<?php echo $VAR->entityWbfsysMask; ?>" >
        <div class="left bw3" >
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_mask-description-<?php echo $VAR->entityWbfsysMask; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Description
        </legend>
        <div id="wgt-box-wbfsys_mask-description-<?php echo $VAR->entityWbfsysMask; ?>" >
        <div class="left bw3" >
        </div>
        <div class="inline bw3" >
        </div>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_mask-meta-<?php echo $VAR->entityWbfsysMask; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_mask-meta-<?php echo $VAR->entityWbfsysMask; ?>" style="display:none" >
<div class="full" >
  Link: <strong><?php echo $this->getServerAddress() ?>maintab.php?c=Wbfsys.Mask.edit&amp;objid=<?php echo $VAR->entity ?></strong>
