...
<legend>Description</legend>
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-wbfsys_role_user_mask_employee-meta-<?php echo $VAR->entityWbfsysRoleUserMaskEmployee; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-wbfsys_role_user_mask_employee-meta-<?php echo $VAR->entityWbfsysRoleUserMaskEmployee; ?>" style="display:none" >
<div class="full" >
