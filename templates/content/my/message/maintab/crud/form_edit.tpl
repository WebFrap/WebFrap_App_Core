...
and append it by clicking on the "connect" Action in the list entry menu.</p>
    ...
    <div 
      ...
      <fieldset class="wgt-space bw61" >
        <legend>
          <span onclick="$S('#wgt-box-my_message-default-<?php echo $VAR->entityMyMessage; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Default
        </legend>
        <div id="wgt-box-my_message-default-<?php echo $VAR->entityMyMessage; ?>" >
        <div class="full" >
      ...
      <fieldset class="wgt-space bw61" style="<?php echo $VAR->displayMeta ? '': 'display:none' ?>" >
        <legend>
          <span onclick="$S('#wgt-box-my_message-meta-<?php echo $VAR->entityMyMessage; ?>').iconToggle(this);">
            <?php echo Wgt::icon('control/opened.png','xsmall',$I18N->l('Open','wbf.label'))?>
          </span>
          Meta
        </legend>
        <div id="wgt-box-my_message-meta-<?php echo $VAR->entityMyMessage; ?>" style="display:none" >
<div class="full" >
